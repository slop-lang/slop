...
void collect_collect_types(env_TypeEnv* env, slop_list_types_SExpr_ptr ast) {
    SLOP_PRE(((env != NULL)), "(!= env nil)");
    {
        ...
        for (int64_t i = 0; i < len; i++) {
            __auto_type _mv_99 = ({ __auto_type _lst = ast; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_99.has_value) {
        ...
        for (int64_t i = 0; i < len; i++) {
            __auto_type _mv_100 = ({ __auto_type _lst = ast; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                ...
                if (_mv_106.has_value) {
                    ...
                    switch (_mv_107.tag) {
                        case types_SExpr_sym:
                        {
                            ...
                            {
                                __auto_type type_name = sym.name;
                                __auto_type _mv_108 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void collect_collect_record_fields(env_TypeEnv* env, slop_arena* arena, types_ResolvedType* resolved, types_SExpr* record_expr) {
    ...
    __auto_type _mv_116 = (*record_expr);
    switch (_mv_116.tag) {
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_116.data.lst;
            {
                ...
                for (int64_t i = 1; i < len; i++) {
                    __auto_type _mv_117 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_117.has_value) {
                        __auto_type field_form = _mv_117.value;
                        __auto_type _mv_118 = (*field_form);
                        switch (_mv_118.tag) {
                            case types_SExpr_lst:
                            {
                                __auto_type field_lst = _mv_118.data.lst;
                                {
                                    __auto_type field_items = field_lst.items;
                                    __auto_type _mv_119 = ({ __auto_type _lst = field_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    if (_mv_119.has_value) {
                                        __auto_type name_expr = _mv_119.value;
                                        __auto_type _mv_120 = (*name_expr);
                                        switch (_mv_120.tag) {
                                            case types_SExpr_sym:
                                            {
                                                __auto_type name_sym = _mv_120.data.sym;
                                                __auto_type _mv_121 = ({ __auto_type _lst = field_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_121.has_value) {
                                                    __auto_type type_expr = _mv_121.value;
                                                    {
...
types_SExpr* collect_get_type_arg(types_SExpr* type_expr, int64_t idx) {
    ...
    switch (_mv_122.tag) {
        case types_SExpr_lst:
        {
            ...
            __auto_type _mv_123 = ({ __auto_type _lst = lst.items; size_t _idx = (size_t)idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_123.has_value) {
                __auto_type arg = _mv_123.value;
                return arg;
...
uint8_t collect_is_type_param(slop_string name, slop_list_string type_params) {
    {
        ...
        uint8_t found = 0;
        for (int64_t i = 0; i < len; i++) {
            __auto_type _mv_127 = ({ __auto_type _lst = type_params; size_t _idx = (size_t)i; slop_option_string _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_127.has_value) {
                __auto_type tp = _mv_127.value;
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_128.data.lst;
            {
                ...
                if (_mv_130.has_value) {
                    __auto_type head_expr = _mv_130.value;
                    {
                        __auto_type head_name = parser_sexpr_get_symbol_name(head_expr);
                        if (string_eq(head_name, SLOP_STR("Option"))) {
                            {
...
slop_list_string collect_find_fn_type_params(slop_arena* arena, types_SExpr* fn_form) {
    SLOP_PRE(((fn_form != NULL)), "(!= fn-form nil)");
    {
        ...
        for (int64_t i = 3; i < len; i++) {
            __auto_type _mv_131 = parser_sexpr_list_get(fn_form, i);
            if (_mv_131.has_value) {
                __auto_type item = _mv_131.value;
                if (parser_is_form(item, SLOP_STR("@generic"))) {
                    __auto_type _mv_132 = parser_sexpr_list_get(item, 1);
                    if (_mv_132.has_value) {
                        __auto_type params_expr = _mv_132.value;
                        if (parser_sexpr_is_list(params_expr)) {
                            {
                                ...
                                for (int64_t j = 0; j < num_params; j++) {
                                    __auto_type _mv_133 = parser_sexpr_list_get(params_expr, j);
                                    if (_mv_133.has_value) {
                                        __auto_type param_expr = _mv_133.value;
                                        {
...
types_ResolvedType* collect_extract_spec_return_type_generic(env_TypeEnv* env, types_SExpr* spec_form, slop_list_string type_params) {
    ...
    {
        __auto_type arena = env_env_arena(env);
        __auto_type _mv_135 = parser_sexpr_list_get(spec_form, 1);
        if (_mv_135.has_value) {
            __auto_type spec_body = _mv_135.value;
            if (parser_sexpr_is_list(spec_body)) {
                {
                    __auto_type len = parser_sexpr_list_len(spec_body);
                    __auto_type _mv_136 = parser_sexpr_list_get(spec_body, (len - 1));
                    if (_mv_136.has_value) {
                        __auto_type ret_expr = _mv_136.value;
    ...
    SLOP_PRE(((fn_form != NULL)), "(!= fn-form nil)");
    {
        ...
        for (int64_t i = 3; i < len; i++) {
            ...
            if (_mv_137.has_value) {
                ...
                if (parser_is_form(item, SLOP_STR("@spec"))) {
                    __auto_type _mv_138 = parser_sexpr_list_get(item, 1);
                    if (_mv_138.has_value) {
                        __auto_type spec_body = _mv_138.value;
                        if (parser_sexpr_is_list(spec_body)) {
                            __auto_type _mv_139 = parser_sexpr_list_get(spec_body, 0);
                            if (_mv_139.has_value) {
                                __auto_type param_types_expr = _mv_139.value;
                                if (parser_sexpr_is_list(param_types_expr)) {
                                    {
                                        ...
                                        for (int64_t j = 0; j < num_ptypes; j++) {
                                            __auto_type _mv_140 = parser_sexpr_list_get(param_types_expr, j);
                                            if (_mv_140.has_value) {
                                                __auto_type ptype_expr = _mv_140.value;
                                                {
...
void collect_set_module_name_from_form(env_TypeEnv* env, types_SExpr* module_form) {
    SLOP_PRE(((env != NULL)), "(!= env nil)");
    __auto_type _mv_141 = parser_sexpr_list_get(module_form, 1);
        ...
        if (parser_sexpr_is_list(module_form)) {
            collect_set_module_name_from_form(env, module_form);
            {
                ...
                for (int64_t i = 2; i < len; i++) {
                    __auto_type _mv_142 = parser_sexpr_list_get(module_form, i);
                    if (_mv_142.has_value) {
                        __auto_type item = _mv_142.value;
    ...
    if (!(parser_sexpr_is_list(type_expr))) {
        ...
        if ((parser_sexpr_list_len(type_expr) < 2)) {
            ...
            if (_mv_145.has_value) {
                __auto_type first_elem = _mv_145.value;
                {
    ...
    if (_mv_146.has_value) {
        __auto_type first_elem = _mv_146.value;
        {
            ...
            if (string_eq(base_name, SLOP_STR("Int"))) {
                ...
                __auto_type _mv_147 = env_env_lookup_type_direct(env, SLOP_STR("Float"));
    ...
    if (parser_sexpr_is_list(union_expr)) {
        {
            ...
            for (int64_t i = 1; i < len; i++) {
                __auto_type _mv_149 = parser_sexpr_list_get(union_expr, i);
                if (_mv_149.has_value) {
                    __auto_type variant_form = _mv_149.value;
...
slop_list_types_ResolvedType_ptr collect_get_variant_payload_types(env_TypeEnv* env, types_SExpr* variant_form) {
    ...
    SLOP_PRE(((variant_form != NULL)), "(!= variant-form nil)");
    {
        ...
        for (int64_t idx = 1; idx < vlen; idx++) {
            __auto_type _mv_150 = parser_sexpr_list_get(variant_form, idx);
    ...
    if (parser_sexpr_is_list(variant_form)) {
        if ((parser_sexpr_list_len(variant_form) == 0)) {
            ...
            if (_mv_152.has_value) {
                __auto_type name_expr = _mv_152.value;
            ...
            __auto_type lst = _mv_154.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 2)) {
                    ...
                    if (_mv_155.has_value) {
                        __auto_type head = _mv_155.value;
                        __auto_type _mv_156 = (*head);
                        switch (_mv_156.tag) {
                            case types_SExpr_sym:
                            {
                                __auto_type sym = _mv_156.data.sym;
                                if (string_eq(sym.name, SLOP_STR("Option"))) {
                                    __auto_type _mv_157 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    if (_mv_157.has_value) {
                                        __auto_type inner = _mv_157.value;
...
uint8_t collect_has_recursive_value_payload(types_SExpr* variant_form, slop_string union_name) {
    SLOP_PRE(((variant_form != NULL)), "(!= variant-form nil)");
    {
        ...
        for (int64_t idx = 1; idx < vlen; idx++) {
            if (!(found)) {
                __auto_type _mv_158 = parser_sexpr_list_get(variant_form, idx);
                if (_mv_158.has_value) {
                    __auto_type type_expr = _mv_158.value;
    ...
    switch (_mv_159.tag) {
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_159.data.lst;
            {
                ...
                __auto_type len = ((int64_t)((items).len));
                for (int64_t i = 1; i < len; i++) {
                    __auto_type _mv_160 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_160.has_value) {
                        __auto_type variant_expr = _mv_160.value;
                        __auto_type _mv_161 = (*variant_expr);
                        switch (_mv_161.tag) {
                            case types_SExpr_sym:
                            {
...
void collect_collect_constants(env_TypeEnv* env, slop_list_types_SExpr_ptr ast) {
    SLOP_PRE(((env != NULL)), "(!= env nil)");
    {
        ...
        __auto_type len = ((int64_t)((ast).len));
        for (int64_t i = 0; i < len; i++) {
            __auto_type _mv_162 = ({ __auto_type _lst = ast; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_162.has_value) {
                __auto_type expr = _mv_162.value;
        ...
        if (parser_sexpr_is_list(module_form)) {
            {
                __auto_type len = parser_sexpr_list_len(module_form);
                for (int64_t i = 2; i < len; i++) {
                    __auto_type _mv_163 = parser_sexpr_list_get(module_form, i);
                    if (_mv_163.has_value) {
                        __auto_type item = _mv_163.value;
            ...
            if (_mv_164.has_value) {
                __auto_type name_expr = _mv_164.value;
                {
                    ...
                    if (!(string_eq(const_name, SLOP_STR("")))) {
                        __auto_type _mv_165 = parser_sexpr_list_get(const_form, 2);
...
types_ResolvedType* collect_get_const_type(env_TypeEnv* env, slop_arena* arena, types_SExpr* type_expr) {
    ...
    switch (_mv_166.tag) {
        case types_SExpr_sym:
        {
            ...
            {
                __auto_type type_name = sym.name;
                __auto_type _mv_167 = env_env_lookup_type_direct(env, type_name);
...
void collect_collect_functions(env_TypeEnv* env, slop_list_types_SExpr_ptr ast) {
    SLOP_PRE(((env != NULL)), "(!= env nil)");
    {
        ...
        __auto_type len = ((int64_t)((ast).len));
        for (int64_t i = 0; i < len; i++) {
            __auto_type _mv_168 = ({ __auto_type _lst = ast; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_168.has_value) {
                __auto_type expr = _mv_168.value;
...
void collect_collect_module_functions(env_TypeEnv* env, types_SExpr* module_form) {
    ...
    SLOP_PRE(((module_form != NULL)), "(!= module-form nil)");
    {
        __auto_type arena = env_env_arena(env);
        if (parser_sexpr_is_list(module_form)) {
            __auto_type _mv_169 = parser_sexpr_list_get(module_form, 1);
            if (_mv_169.has_value) {
                __auto_type name_expr = _mv_169.value;
                {
                    __auto_type mod_name = parser_sexpr_get_symbol_name(name_expr);
                    if (!(string_eq(mod_name, SLOP_STR("")))) {
                        env_env_set_module(env, (slop_option_string){.has_value = 1, .value = mod_name});
            ...
            }
            {
                __auto_type len = parser_sexpr_list_len(module_form);
                for (int64_t i = 2; i < len; i++) {
                    __auto_type _mv_170 = parser_sexpr_list_get(module_form, i);
    ...
    if (parser_sexpr_is_list(ffi_form)) {
        {
            ...
            for (int64_t i = 2; i < len; i++) {
                __auto_type _mv_171 = parser_sexpr_list_get(ffi_form, i);
                if (_mv_171.has_value) {
                    __auto_type func_decl = _mv_171.value;
            ...
            if ((decl_len >= 3)) {
                ...
                if (_mv_173.has_value) {
                    __auto_type name_expr = _mv_173.value;
                    {
                        __auto_type const_name = parser_sexpr_get_symbol_name(name_expr);
                        if (!(string_eq(const_name, SLOP_STR("")))) {
                            __auto_type _mv_174 = parser_sexpr_list_get(func_decl, 1);
...
slop_list_types_ParamInfo collect_collect_ffi_params(env_TypeEnv* env, slop_arena* arena, types_SExpr* func_decl) {
    SLOP_PRE(((env != NULL)), "(!= env nil)");
    {
        ...
        if (_mv_176.has_value) {
            __auto_type params_expr = _mv_176.value;
            if (parser_sexpr_is_list(params_expr)) {
                {
                    __auto_type num_params = parser_sexpr_list_len(params_expr);
                    for (int64_t j = 0; j < num_params; j++) {
                        __auto_type _mv_177 = parser_sexpr_list_get(params_expr, j);
                                        ...
                                        __auto_type pname_expr = _mv_178.value;
                                        {
                                            ...
                                            if (!(string_eq(param_name, SLOP_STR("")))) {
                                                ...
                                                if (_mv_179.has_value) {
                                                    __auto_type ptype_expr = _mv_179.value;
                                                    {
...
types_ResolvedType* collect_get_ffi_return_type(env_TypeEnv* env, slop_arena* arena, types_SExpr* func_decl) {
    SLOP_PRE(((env != NULL)), "(!= env nil)");
    __auto_type _mv_180 = parser_sexpr_list_get(func_decl, 2);
    if (_mv_180.has_value) {
        __auto_type ret_expr = _mv_180.value;
...
void collect_validate_main_params(env_TypeEnv* env, types_SExpr* fn_form, slop_list_types_ParamInfo params) {
    ...
    SLOP_PRE(((fn_form != NULL)), "(!= fn-form nil)");
    {
        ...
        if ((num_params == 0)) {
            ...
            __auto_type _mv_182 = ({ __auto_type _lst = params; size_t _idx = (size_t)0; slop_option_types_ParamInfo _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            ...
            __auto_type _mv_183 = ({ __auto_type _lst = params; size_t _idx = (size_t)1; slop_option_types_ParamInfo _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_list_types_ParamInfo collect_collect_fn_params(env_TypeEnv* env, slop_arena* arena, types_SExpr* fn_form) {
    ...
    {
        __auto_type params = ((slop_list_types_ParamInfo){ .data = (types_ParamInfo*)slop_arena_alloc(arena, 16 * sizeof(types_ParamInfo)), .len = 0, .cap = 16 });
        __auto_type _mv_184 = parser_sexpr_list_get(fn_form, 2);
        if (_mv_184.has_value) {
            __auto_type params_expr = _mv_184.value;
            if (parser_sexpr_is_list(params_expr)) {
                {
                    __auto_type num_params = parser_sexpr_list_len(params_expr);
                                            ...
                                            if ((parser_sexpr_list_len(param_form) >= 3)) {
                                                ...
                                                if (_mv_187.has_value) {
                                                    __auto_type name_expr = _mv_187.value;
                                                    {
                                                        ...
                                                        if (!(string_eq(param_name, SLOP_STR("")))) {
                                                            __auto_type _mv_188 = parser_sexpr_list_get(param_form, 2);
...
slop_list_types_ParamInfo collect_collect_fn_params_generic(env_TypeEnv* env, slop_arena* arena, types_SExpr* fn_form, slop_list_string type_params) {
    ...
    {
        __auto_type params = ((slop_list_types_ParamInfo){ .data = (types_ParamInfo*)slop_arena_alloc(arena, 16 * sizeof(types_ParamInfo)), .len = 0, .cap = 16 });
        __auto_type _mv_190 = parser_sexpr_list_get(fn_form, 2);
        if (_mv_190.has_value) {
            __auto_type params_expr = _mv_190.value;
            if (parser_sexpr_is_list(params_expr)) {
                {
                    __auto_type num_params = parser_sexpr_list_len(params_expr);
                    for (int64_t i = 0; i < num_params; i++) {
                                            ...
                                            if ((parser_sexpr_list_len(param_form) >= 3)) {
                                                ...
                                                if (_mv_193.has_value) {
                                                    __auto_type name_expr = _mv_193.value;
                                                    {
                                                        __auto_type param_name = parser_sexpr_get_symbol_name(name_expr);
                                                        if (!(string_eq(param_name, SLOP_STR("")))) {
                                                            __auto_type _mv_194 = parser_sexpr_list_get(param_form, 2);
...
types_ResolvedType* collect_find_fn_return_type(env_TypeEnv* env, types_SExpr* fn_form) {
    ...
    SLOP_PRE(((fn_form != NULL)), "(!= fn-form nil)");
    {
        ...
        types_ResolvedType* found_type = env_env_get_unit_type(env);
        for (int64_t i = 3; i < len; i++) {
            __auto_type _mv_196 = parser_sexpr_list_get(fn_form, i);
            if (_mv_196.has_value) {
                __auto_type item = _mv_196.value;
                if (parser_is_form(item, SLOP_STR("@spec"))) {
                    if (!(found)) {
...
types_ResolvedType* collect_checker_extract_spec_return_type(env_TypeEnv* env, types_SExpr* spec_form) {
    ...
    {
        __auto_type arena = env_env_arena(env);
        __auto_type _mv_197 = parser_sexpr_list_get(spec_form, 1);
        if (_mv_197.has_value) {
            __auto_type spec_body = _mv_197.value;
            if (parser_sexpr_is_list(spec_body)) {
                {
                    __auto_type len = parser_sexpr_list_len(spec_body);
                    __auto_type _mv_198 = parser_sexpr_list_get(spec_body, (len - 1));
                    if (_mv_198.has_value) {
                        __auto_type ret_expr = _mv_198.value;
                        return collect_get_field_type(env, arena, ret_expr);
