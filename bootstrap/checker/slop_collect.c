...
void collect_collect_types(env_TypeEnv* env, slop_list_types_SExpr_ptr ast) {
    SLOP_PRE(((env != NULL)), "(!= env nil)");
    {
        ...
        for (int64_t i = 0; i < len; i++) {
            __auto_type _mv_95 = ({ __auto_type _lst = ast; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_95.has_value) {
                __auto_type expr = _mv_95.value;
        ...
        for (int64_t i = 0; i < len; i++) {
            __auto_type _mv_96 = ({ __auto_type _lst = ast; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_96.has_value) {
                __auto_type expr = _mv_96.value;
                if (parser_is_form(expr, SLOP_STR("type"))) {
                ...
                if (_mv_102.has_value) {
                    ...
                    switch (_mv_103.tag) {
                        case types_SExpr_sym:
                        {
                            ...
                            {
                                __auto_type type_name = sym.name;
                                __auto_type _mv_104 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_104.has_value) {
                                    ...
                                    if (parser_is_form(type_expr, SLOP_STR("enum"))) {
                                        ...
                                        __auto_type _mv_108 = env_env_lookup_type_direct(env, type_name);
                                        if (_mv_108.has_value) {
                                            __auto_type resolved = _mv_108.value;
                                            {
...
void collect_collect_record_fields(env_TypeEnv* env, slop_arena* arena, types_ResolvedType* resolved, types_SExpr* record_expr) {
    ...
    __auto_type _mv_112 = (*record_expr);
    switch (_mv_112.tag) {
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_112.data.lst;
            {
                ...
                for (int64_t i = 1; i < len; i++) {
                    __auto_type _mv_113 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_113.has_value) {
                        __auto_type field_form = _mv_113.value;
                        __auto_type _mv_114 = (*field_form);
                        switch (_mv_114.tag) {
                            case types_SExpr_lst:
                            {
                                __auto_type field_lst = _mv_114.data.lst;
                                {
                                    __auto_type field_items = field_lst.items;
                                    __auto_type _mv_115 = ({ __auto_type _lst = field_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    if (_mv_115.has_value) {
                                        __auto_type name_expr = _mv_115.value;
                                        __auto_type _mv_116 = (*name_expr);
                                        switch (_mv_116.tag) {
                                            case types_SExpr_sym:
                                            {
                                                __auto_type name_sym = _mv_116.data.sym;
                                                __auto_type _mv_117 = ({ __auto_type _lst = field_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_117.has_value) {
                                                    __auto_type type_expr = _mv_117.value;
                                                    {
...
types_SExpr* collect_get_type_arg(types_SExpr* type_expr, int64_t idx) {
    ...
    __auto_type _mv_118 = (*type_expr);
    switch (_mv_118.tag) {
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_118.data.lst;
            __auto_type _mv_119 = ({ __auto_type _lst = lst.items; size_t _idx = (size_t)idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_119.has_value) {
                __auto_type arg = _mv_119.value;
                return arg;
...
types_ResolvedType* collect_get_field_type(env_TypeEnv* env, slop_arena* arena, types_SExpr* type_expr) {
    ...
    switch (_mv_120.tag) {
        case types_SExpr_sym:
        {
            ...
            {
                __auto_type type_name = sym.name;
                __auto_type _mv_121 = env_env_lookup_type_direct(env, type_name);
                if (_mv_121.has_value) {
                    __auto_type t = _mv_121.value;
                    return t;
...
uint8_t collect_is_type_param(slop_string name, slop_list_string type_params) {
    {
        ...
        uint8_t found = 0;
        for (int64_t i = 0; i < len; i++) {
            __auto_type _mv_123 = ({ __auto_type _lst = type_params; size_t _idx = (size_t)i; slop_option_string _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_123.has_value) {
                __auto_type tp = _mv_123.value;
...
types_ResolvedType* collect_get_field_type_generic(env_TypeEnv* env, slop_arena* arena, types_SExpr* type_expr, slop_list_string type_params) {
    ...
    switch (_mv_124.tag) {
        case types_SExpr_sym:
        {
            __auto_type sym = _mv_124.data.sym;
            {
                ...
                if (collect_is_type_param(type_name, type_params)) {
                    ...
                    __auto_type _mv_125 = env_env_lookup_type_direct(env, type_name);
                    if (_mv_125.has_value) {
                        __auto_type t = _mv_125.value;
                        return t;
        ...
        case types_SExpr_lst:
        {
            ...
            {
                __auto_type items = lst.items;
                __auto_type _mv_126 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_126.has_value) {
                    __auto_type head_expr = _mv_126.value;
                    {
                        __auto_type head_name = parser_sexpr_get_symbol_name(head_expr);
                        if (string_eq(head_name, SLOP_STR("Option"))) {
                            {
...
slop_list_string collect_find_fn_type_params(slop_arena* arena, types_SExpr* fn_form) {
    SLOP_PRE(((fn_form != NULL)), "(!= fn-form nil)");
    {
        ...
        for (int64_t i = 3; i < len; i++) {
            __auto_type _mv_127 = parser_sexpr_list_get(fn_form, i);
            if (_mv_127.has_value) {
                __auto_type item = _mv_127.value;
                if (parser_is_form(item, SLOP_STR("@generic"))) {
                    __auto_type _mv_128 = parser_sexpr_list_get(item, 1);
                    if (_mv_128.has_value) {
                        __auto_type params_expr = _mv_128.value;
                        if (parser_sexpr_is_list(params_expr)) {
                            {
                                ...
                                for (int64_t j = 0; j < num_params; j++) {
                                    __auto_type _mv_129 = parser_sexpr_list_get(params_expr, j);
                                    if (_mv_129.has_value) {
                                        __auto_type param_expr = _mv_129.value;
                                        {
...
types_ResolvedType* collect_find_fn_return_type_generic(env_TypeEnv* env, types_SExpr* fn_form, slop_list_string type_params) {
    ...
    SLOP_PRE(((fn_form != NULL)), "(!= fn-form nil)");
    {
        ...
        for (int64_t i = 3; i < len; i++) {
            __auto_type _mv_130 = parser_sexpr_list_get(fn_form, i);
...
types_ResolvedType* collect_extract_spec_return_type_generic(env_TypeEnv* env, types_SExpr* spec_form, slop_list_string type_params) {
    ...
    {
        __auto_type arena = env_env_arena(env);
        __auto_type _mv_131 = parser_sexpr_list_get(spec_form, 1);
        if (_mv_131.has_value) {
            __auto_type spec_body = _mv_131.value;
            if (parser_sexpr_is_list(spec_body)) {
                {
                    __auto_type len = parser_sexpr_list_len(spec_body);
                    __auto_type _mv_132 = parser_sexpr_list_get(spec_body, (len - 1));
                    if (_mv_132.has_value) {
                        __auto_type ret_expr = _mv_132.value;
...
slop_list_types_ResolvedType_ptr collect_collect_fn_spec_params(env_TypeEnv* env, slop_arena* arena, types_SExpr* fn_form, slop_list_string type_params) {
    ...
    SLOP_PRE(((fn_form != NULL)), "(!= fn-form nil)");
    {
        ...
        __auto_type len = parser_sexpr_list_len(fn_form);
        for (int64_t i = 3; i < len; i++) {
            __auto_type _mv_133 = parser_sexpr_list_get(fn_form, i);
            if (_mv_133.has_value) {
                __auto_type item = _mv_133.value;
                if (parser_is_form(item, SLOP_STR("@spec"))) {
                    __auto_type _mv_134 = parser_sexpr_list_get(item, 1);
                    if (_mv_134.has_value) {
                        __auto_type spec_body = _mv_134.value;
                        if (parser_sexpr_is_list(spec_body)) {
                            __auto_type _mv_135 = parser_sexpr_list_get(spec_body, 0);
                            if (_mv_135.has_value) {
                                __auto_type param_types_expr = _mv_135.value;
                                if (parser_sexpr_is_list(param_types_expr)) {
                                    {
                                        ...
                                        for (int64_t j = 0; j < num_ptypes; j++) {
                                            __auto_type _mv_136 = parser_sexpr_list_get(param_types_expr, j);
                                            if (_mv_136.has_value) {
                                                __auto_type ptype_expr = _mv_136.value;
                                                {
...
void collect_set_module_name_from_form(env_TypeEnv* env, types_SExpr* module_form) {
    SLOP_PRE(((env != NULL)), "(!= env nil)");
    __auto_type _mv_137 = parser_sexpr_list_get(module_form, 1);
    if (_mv_137.has_value) {
        __auto_type name_expr = _mv_137.value;
        {
        ...
        if (parser_sexpr_is_list(module_form)) {
            collect_set_module_name_from_form(env, module_form);
            {
                ...
                for (int64_t i = 2; i < len; i++) {
                    __auto_type _mv_138 = parser_sexpr_list_get(module_form, i);
    ...
    SLOP_PRE(((module_form != NULL)), "(!= module-form nil)");
    {
        ...
        if (parser_sexpr_is_list(module_form)) {
            collect_set_module_name_from_form(env, module_form);
            {
                __auto_type len = parser_sexpr_list_len(module_form);
                for (int64_t i = 2; i < len; i++) {
                    __auto_type _mv_139 = parser_sexpr_list_get(module_form, i);
                    if (_mv_139.has_value) {
                        __auto_type item = _mv_139.value;
                        if (parser_is_form(item, SLOP_STR("type"))) {
...
slop_option_types_ResolvedType_ptr collect_lookup_payload_type(env_TypeEnv* env, slop_string type_name) {
    if (string_eq(type_name, SLOP_STR(""))) {
        ...
        __auto_type _mv_140 = env_env_lookup_type_direct(env, type_name);
        if (_mv_140.has_value) {
            __auto_type t = _mv_140.value;
...
uint8_t collect_is_range_type_expr(types_SExpr* type_expr) {
    if (!(parser_sexpr_is_list(type_expr))) {
        ...
        if ((parser_sexpr_list_len(type_expr) < 2)) {
            ...
            __auto_type _mv_141 = parser_sexpr_list_get(type_expr, 0);
            if (_mv_141.has_value) {
                __auto_type first_elem = _mv_141.value;
                {
...
types_ResolvedType* collect_get_range_base_type(env_TypeEnv* env, slop_arena* arena, types_SExpr* type_expr) {
    SLOP_PRE(((env != NULL)), "(!= env nil)");
    __auto_type _mv_142 = parser_sexpr_list_get(type_expr, 0);
    if (_mv_142.has_value) {
        __auto_type first_elem = _mv_142.value;
        {
            __auto_type base_name = parser_sexpr_get_symbol_name(first_elem);
            if (string_eq(base_name, SLOP_STR("Int"))) {
                return env_env_get_int_type(env);
            } else if (string_eq(base_name, SLOP_STR("Float"))) {
                __auto_type _mv_143 = env_env_lookup_type_direct(env, SLOP_STR("Float"));
                if (_mv_143.has_value) {
                    __auto_type t = _mv_143.value;
                    return t;
    ...
    if (parser_sexpr_is_list(union_expr)) {
        {
            ...
            for (int64_t i = 1; i < len; i++) {
                __auto_type _mv_145 = parser_sexpr_list_get(union_expr, i);
                if (_mv_145.has_value) {
                    __auto_type variant_form = _mv_145.value;
...
slop_option_types_ResolvedType_ptr collect_get_variant_payload_type(env_TypeEnv* env, types_SExpr* variant_form) {
    if ((parser_sexpr_list_len(variant_form) <= 1)) {
        ...
        __auto_type _mv_146 = parser_sexpr_list_get(variant_form, 1);
...
slop_string collect_checker_get_variant_name(types_SExpr* variant_form) {
    if (parser_sexpr_is_list(variant_form)) {
        if ((parser_sexpr_list_len(variant_form) == 0)) {
            ...
            __auto_type _mv_147 = parser_sexpr_list_get(variant_form, 0);
            if (_mv_147.has_value) {
                __auto_type name_expr = _mv_147.value;
        ...
        __auto_type _mv_148 = (*variant_form);
        switch (_mv_148.tag) {
            case types_SExpr_sym:
            {
...
uint8_t collect_has_recursive_value_payload(types_SExpr* variant_form, slop_string union_name) {
    ...
    if ((parser_sexpr_list_len(variant_form) < 2)) {
        ...
        __auto_type _mv_149 = parser_sexpr_list_get(variant_form, 1);
        if (_mv_149.has_value) {
            __auto_type type_expr = _mv_149.value;
            __auto_type _mv_150 = (*type_expr);
            switch (_mv_150.tag) {
                case types_SExpr_sym:
                {
                ...
                case types_SExpr_lst:
                {
                    __auto_type lst = _mv_150.data.lst;
                    {
                        __auto_type items = lst.items;
    ...
    switch (_mv_154.tag) {
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_154.data.lst;
            {
                ...
                __auto_type len = ((int64_t)((items).len));
                for (int64_t i = 1; i < len; i++) {
                    __auto_type _mv_155 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_155.has_value) {
                        __auto_type variant_expr = _mv_155.value;
                        __auto_type _mv_156 = (*variant_expr);
                        switch (_mv_156.tag) {
                            case types_SExpr_sym:
                            {
...
void collect_collect_constants(env_TypeEnv* env, slop_list_types_SExpr_ptr ast) {
    SLOP_PRE(((env != NULL)), "(!= env nil)");
    {
        ...
        __auto_type len = ((int64_t)((ast).len));
        for (int64_t i = 0; i < len; i++) {
            __auto_type _mv_157 = ({ __auto_type _lst = ast; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_157.has_value) {
                __auto_type expr = _mv_157.value;
        ...
        if (parser_sexpr_is_list(module_form)) {
            {
                __auto_type len = parser_sexpr_list_len(module_form);
                for (int64_t i = 2; i < len; i++) {
                    __auto_type _mv_158 = parser_sexpr_list_get(module_form, i);
                    if (_mv_158.has_value) {
                        __auto_type item = _mv_158.value;
...
void collect_collect_single_constant(env_TypeEnv* env, slop_arena* arena, types_SExpr* const_form) {
    ...
    if (parser_sexpr_is_list(const_form)) {
        if ((parser_sexpr_list_len(const_form) >= 3)) {
            __auto_type _mv_159 = parser_sexpr_list_get(const_form, 1);
            if (_mv_159.has_value) {
                __auto_type name_expr = _mv_159.value;
                {
                    ...
                    if (!(string_eq(const_name, SLOP_STR("")))) {
                        __auto_type _mv_160 = parser_sexpr_list_get(const_form, 2);
                        if (_mv_160.has_value) {
                            __auto_type type_expr = _mv_160.value;
                            {
...
types_ResolvedType* collect_get_const_type(env_TypeEnv* env, slop_arena* arena, types_SExpr* type_expr) {
    ...
    switch (_mv_161.tag) {
        case types_SExpr_sym:
        {
            ...
            {
                __auto_type type_name = sym.name;
                __auto_type _mv_162 = env_env_lookup_type_direct(env, type_name);
                if (_mv_162.has_value) {
                    __auto_type t = _mv_162.value;
                    return t;
...
void collect_collect_functions(env_TypeEnv* env, slop_list_types_SExpr_ptr ast) {
    SLOP_PRE(((env != NULL)), "(!= env nil)");
    {
        ...
        __auto_type len = ((int64_t)((ast).len));
        for (int64_t i = 0; i < len; i++) {
            __auto_type _mv_163 = ({ __auto_type _lst = ast; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void collect_collect_module_functions(env_TypeEnv* env, types_SExpr* module_form) {
    ...
    SLOP_PRE(((module_form != NULL)), "(!= module-form nil)");
    {
        __auto_type arena = env_env_arena(env);
        if (parser_sexpr_is_list(module_form)) {
            __auto_type _mv_164 = parser_sexpr_list_get(module_form, 1);
            ...
            }
            {
                __auto_type len = parser_sexpr_list_len(module_form);
                for (int64_t i = 2; i < len; i++) {
                    __auto_type _mv_165 = parser_sexpr_list_get(module_form, i);
                    if (_mv_165.has_value) {
                        __auto_type item = _mv_165.value;
    ...
    if (parser_sexpr_is_list(ffi_form)) {
        {
            ...
            for (int64_t i = 2; i < len; i++) {
                __auto_type _mv_166 = parser_sexpr_list_get(ffi_form, i);
                if (_mv_166.has_value) {
                    __auto_type func_decl = _mv_166.value;
    ...
    if (parser_sexpr_is_list(func_decl)) {
        {
            ...
            if ((decl_len >= 3)) {
                __auto_type _mv_167 = parser_sexpr_list_get(func_decl, 0);
                ...
                __auto_type _mv_168 = parser_sexpr_list_get(func_decl, 0);
                if (_mv_168.has_value) {
                    __auto_type name_expr = _mv_168.value;
                    {
                        __auto_type const_name = parser_sexpr_get_symbol_name(name_expr);
                        if (!(string_eq(const_name, SLOP_STR("")))) {
                            __auto_type _mv_169 = parser_sexpr_list_get(func_decl, 1);
...
uint8_t collect_ffi_has_variadic(types_SExpr* func_decl) {
    SLOP_PRE(((func_decl != NULL)), "(!= func-decl nil)");
    {
        ...
        if ((len >= 4)) {
            __auto_type _mv_170 = parser_sexpr_list_get(func_decl, (len - 1));
            if (_mv_170.has_value) {
                __auto_type last_expr = _mv_170.value;
...
slop_list_types_ParamInfo collect_collect_ffi_params(env_TypeEnv* env, slop_arena* arena, types_SExpr* func_decl) {
    SLOP_PRE(((env != NULL)), "(!= env nil)");
    {
        ...
        __auto_type _mv_171 = parser_sexpr_list_get(func_decl, 1);
        if (_mv_171.has_value) {
            __auto_type params_expr = _mv_171.value;
            if (parser_sexpr_is_list(params_expr)) {
                {
                    __auto_type num_params = parser_sexpr_list_len(params_expr);
                    for (int64_t j = 0; j < num_params; j++) {
                        __auto_type _mv_172 = parser_sexpr_list_get(params_expr, j);
                        if (_mv_172.has_value) {
                            __auto_type param_form = _mv_172.value;
                            if (parser_sexpr_is_list(param_form)) {
                                if ((parser_sexpr_list_len(param_form) >= 2)) {
                                    __auto_type _mv_173 = parser_sexpr_list_get(param_form, 0);
                                    if (_mv_173.has_value) {
                                        __auto_type pname_expr = _mv_173.value;
                                        {
                                            __auto_type param_name = parser_sexpr_get_symbol_name(pname_expr);
                                            if (!(string_eq(param_name, SLOP_STR("")))) {
                                                __auto_type _mv_174 = parser_sexpr_list_get(param_form, 1);
                                                if (_mv_174.has_value) {
                                                    __auto_type ptype_expr = _mv_174.value;
                                                    {
...
types_ResolvedType* collect_get_ffi_return_type(env_TypeEnv* env, slop_arena* arena, types_SExpr* func_decl) {
    SLOP_PRE(((env != NULL)), "(!= env nil)");
    __auto_type _mv_175 = parser_sexpr_list_get(func_decl, 2);
    if (_mv_175.has_value) {
        __auto_type ret_expr = _mv_175.value;
...
void collect_collect_single_function(env_TypeEnv* env, slop_arena* arena, types_SExpr* fn_form) {
    ...
    if (parser_sexpr_is_list(fn_form)) {
        if ((parser_sexpr_list_len(fn_form) >= 3)) {
            __auto_type _mv_176 = parser_sexpr_list_get(fn_form, 1);
...
void collect_validate_main_params(env_TypeEnv* env, types_SExpr* fn_form, slop_list_types_ParamInfo params) {
    ...
    SLOP_PRE(((fn_form != NULL)), "(!= fn-form nil)");
    {
        ...
        if ((num_params == 0)) {
            ...
            __auto_type _mv_177 = ({ __auto_type _lst = params; size_t _idx = (size_t)0; slop_option_types_ParamInfo _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_177.has_value) {
                __auto_type p0 = _mv_177.value;
                {
            ...
            __auto_type _mv_178 = ({ __auto_type _lst = params; size_t _idx = (size_t)1; slop_option_types_ParamInfo _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_178.has_value) {
                __auto_type p1 = _mv_178.value;
                {
...
slop_list_types_ParamInfo collect_collect_fn_params(env_TypeEnv* env, slop_arena* arena, types_SExpr* fn_form) {
    ...
    {
        __auto_type params = ((slop_list_types_ParamInfo){ .data = (types_ParamInfo*)slop_arena_alloc(arena, 16 * sizeof(types_ParamInfo)), .len = 0, .cap = 16 });
        __auto_type _mv_179 = parser_sexpr_list_get(fn_form, 2);
        if (_mv_179.has_value) {
            __auto_type params_expr = _mv_179.value;
            if (parser_sexpr_is_list(params_expr)) {
                {
                    __auto_type num_params = parser_sexpr_list_len(params_expr);
                    for (int64_t i = 0; i < num_params; i++) {
                        __auto_type _mv_180 = parser_sexpr_list_get(params_expr, i);
                        if (_mv_180.has_value) {
                            __auto_type param_form = _mv_180.value;
                            if ((parser_sexpr_is_list(param_form) && (parser_sexpr_list_len(param_form) >= 2))) {
                                __auto_type _mv_181 = parser_sexpr_list_get(param_form, 0);
                                if (_mv_181.has_value) {
                                    __auto_type first_expr = _mv_181.value;
                                    {
                                        ...
                                        if (((string_eq(first_name, SLOP_STR("in"))) || (string_eq(first_name, SLOP_STR("out"))) || (string_eq(first_name, SLOP_STR("mut"))))) {
                                            if ((parser_sexpr_list_len(param_form) >= 3)) {
                                                __auto_type _mv_182 = parser_sexpr_list_get(param_form, 1);
                                                if (_mv_182.has_value) {
                                                    __auto_type name_expr = _mv_182.value;
                                                    {
                                                        __auto_type param_name = parser_sexpr_get_symbol_name(name_expr);
                                                        if (!(string_eq(param_name, SLOP_STR("")))) {
                                                            __auto_type _mv_183 = parser_sexpr_list_get(param_form, 2);
                                            ...
                                            if (!(string_eq(first_name, SLOP_STR("")))) {
                                                __auto_type _mv_184 = parser_sexpr_list_get(param_form, 1);
                                                if (_mv_184.has_value) {
                                                    __auto_type type_expr = _mv_184.value;
                                                    {
                                                        __auto_type param_type = collect_get_field_type(env, arena, type_expr);
...
slop_list_types_ParamInfo collect_collect_fn_params_generic(env_TypeEnv* env, slop_arena* arena, types_SExpr* fn_form, slop_list_string type_params) {
    ...
    {
        __auto_type params = ((slop_list_types_ParamInfo){ .data = (types_ParamInfo*)slop_arena_alloc(arena, 16 * sizeof(types_ParamInfo)), .len = 0, .cap = 16 });
        __auto_type _mv_185 = parser_sexpr_list_get(fn_form, 2);
        if (_mv_185.has_value) {
            __auto_type params_expr = _mv_185.value;
            if (parser_sexpr_is_list(params_expr)) {
                {
                    __auto_type num_params = parser_sexpr_list_len(params_expr);
                    for (int64_t i = 0; i < num_params; i++) {
                        __auto_type _mv_186 = parser_sexpr_list_get(params_expr, i);
                        if (_mv_186.has_value) {
                            __auto_type param_form = _mv_186.value;
                            if ((parser_sexpr_is_list(param_form) && (parser_sexpr_list_len(param_form) >= 2))) {
                                __auto_type _mv_187 = parser_sexpr_list_get(param_form, 0);
                                if (_mv_187.has_value) {
                                    __auto_type first_expr = _mv_187.value;
                                    {
                                        __auto_type first_name = parser_sexpr_get_symbol_name(first_expr);
                                        if (((string_eq(first_name, SLOP_STR("in"))) || (string_eq(first_name, SLOP_STR("out"))) || (string_eq(first_name, SLOP_STR("mut"))))) {
                                            if ((parser_sexpr_list_len(param_form) >= 3)) {
                                                __auto_type _mv_188 = parser_sexpr_list_get(param_form, 1);
                                                if (_mv_188.has_value) {
                                                    __auto_type name_expr = _mv_188.value;
                                                    {
                                                        __auto_type param_name = parser_sexpr_get_symbol_name(name_expr);
                                                        if (!(string_eq(param_name, SLOP_STR("")))) {
                                                            __auto_type _mv_189 = parser_sexpr_list_get(param_form, 2);
                                            ...
                                            if (!(string_eq(first_name, SLOP_STR("")))) {
                                                __auto_type _mv_190 = parser_sexpr_list_get(param_form, 1);
...
types_ResolvedType* collect_find_fn_return_type(env_TypeEnv* env, types_SExpr* fn_form) {
    ...
    SLOP_PRE(((fn_form != NULL)), "(!= fn-form nil)");
    {
        ...
        types_ResolvedType* found_type = env_env_get_unit_type(env);
        for (int64_t i = 3; i < len; i++) {
            __auto_type _mv_191 = parser_sexpr_list_get(fn_form, i);
            if (_mv_191.has_value) {
                __auto_type item = _mv_191.value;
                if (parser_is_form(item, SLOP_STR("@spec"))) {
                    if (!(found)) {
...
types_ResolvedType* collect_checker_extract_spec_return_type(env_TypeEnv* env, types_SExpr* spec_form) {
    ...
    {
        __auto_type arena = env_env_arena(env);
        __auto_type _mv_192 = parser_sexpr_list_get(spec_form, 1);
        if (_mv_192.has_value) {
            __auto_type spec_body = _mv_192.value;
            if (parser_sexpr_is_list(spec_body)) {
                {
                    __auto_type len = parser_sexpr_list_len(spec_body);
                    __auto_type _mv_193 = parser_sexpr_list_get(spec_body, (len - 1));
                    if (_mv_193.has_value) {
                        __auto_type ret_expr = _mv_193.value;
                        return collect_get_field_type(env, arena, ret_expr);
