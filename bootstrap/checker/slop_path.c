...
slop_string path_path_dirname(slop_arena* arena, slop_string path) {
    {
        ...
        if ((len == 0)) {
            ...
            __auto_type _mv_188 = strlib_last_index_of(path, SLOP_STR("/"));
            if (_mv_188.has_value) {
                __auto_type idx = _mv_188.value;
                if ((idx == 0)) {
                    return SLOP_STR("/");
                } else {
...
slop_string path_path_basename(slop_arena* arena, slop_string path) {
    {
        ...
        if ((len == 0)) {
            ...
            __auto_type _mv_189 = strlib_last_index_of(path, SLOP_STR("/"));
...
slop_string path_path_extension(slop_arena* arena, slop_string path) {
    {
        ...
        if ((len == 0)) {
            ...
            __auto_type _mv_190 = strlib_last_index_of(path, SLOP_STR("."));
            if (_mv_190.has_value) {
                __auto_type idx = _mv_190.value;
                {
