...
slop_string path_path_dirname(slop_arena* arena, slop_string path) {
    {
        ...
        if ((len == 0)) {
            ...
            __auto_type _mv_162 = strlib_last_index_of(path, SLOP_STR("/"));
            if (_mv_162.has_value) {
                __auto_type idx = _mv_162.value;
                if ((idx == 0)) {
                    return SLOP_STR("/");
                } else {
...
slop_string path_path_basename(slop_arena* arena, slop_string path) {
    {
        ...
        if ((len == 0)) {
            ...
            __auto_type _mv_163 = strlib_last_index_of(path, SLOP_STR("/"));
            if (_mv_163.has_value) {
                __auto_type idx = _mv_163.value;
                {
...
slop_string path_path_extension(slop_arena* arena, slop_string path) {
    {
        ...
        if ((len == 0)) {
            ...
            __auto_type _mv_164 = strlib_last_index_of(path, SLOP_STR("."));
            if (_mv_164.has_value) {
                __auto_type idx = _mv_164.value;
                {
