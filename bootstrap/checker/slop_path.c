...
slop_string path_path_dirname(slop_arena* arena, slop_string path) {
    {
        ...
        if ((len == 0)) {
            ...
            __auto_type _mv_199 = strlib_last_index_of(path, SLOP_STR("/"));
            if (_mv_199.has_value) {
                __auto_type idx = _mv_199.value;
                if ((idx == 0)) {
                    return SLOP_STR("/");
                } else {
...
slop_string path_path_basename(slop_arena* arena, slop_string path) {
    {
        ...
        if ((len == 0)) {
            ...
            __auto_type _mv_200 = strlib_last_index_of(path, SLOP_STR("/"));
            if (_mv_200.has_value) {
                __auto_type idx = _mv_200.value;
                {
...
slop_string path_path_extension(slop_arena* arena, slop_string path) {
    {
        ...
        if ((len == 0)) {
            ...
            __auto_type _mv_201 = strlib_last_index_of(path, SLOP_STR("."));
            if (_mv_201.has_value) {
                __auto_type idx = _mv_201.value;
                {
