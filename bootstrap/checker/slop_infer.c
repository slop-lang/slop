...
slop_option_types_ResolvedType_ptr infer_find_binding(slop_list_string bind_names, slop_list_types_ResolvedType_ptr bind_types, slop_string name) {
    {
        ...
        for (int64_t i = 0; i < len; i++) {
            __auto_type _mv_93 = ({ __auto_type _lst = bind_names; size_t _idx = (size_t)i; slop_option_string _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_93.has_value) {
                __auto_type bn = _mv_93.value;
                if (string_eq(bn, name)) {
                    __auto_type _mv_94 = ({ __auto_type _lst = bind_types; size_t _idx = (size_t)i; slop_option_types_ResolvedType_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_94.has_value) {
                        __auto_type bt = _mv_94.value;
        ...
        if ((f_kind == types_ResolvedTypeKind_rk_typevar)) {
            {
                ...
                __auto_type _mv_95 = infer_find_binding(bind_names, bind_types, tv_name);
                if (_mv_95.has_value) {
                    __auto_type existing = _mv_95.value;
            ...
            if (((*actual).kind == types_ResolvedTypeKind_rk_ptr)) {
                __auto_type _mv_96 = (*formal).inner_type;
                if (_mv_96.has_value) {
                    __auto_type f_inner = _mv_96.value;
                    __auto_type _mv_97 = (*actual).inner_type;
                    if (_mv_97.has_value) {
                        __auto_type a_inner = _mv_97.value;
            ...
            if (((*actual).kind == types_ResolvedTypeKind_rk_chan)) {
                __auto_type _mv_98 = (*formal).inner_type;
                if (_mv_98.has_value) {
                    __auto_type f_inner = _mv_98.value;
                    __auto_type _mv_99 = (*actual).inner_type;
                    if (_mv_99.has_value) {
                        __auto_type a_inner = _mv_99.value;
                        infer_unify_types(arena, f_inner, a_inner, bind_names, bind_types);
            ...
            if (((*actual).kind == types_ResolvedTypeKind_rk_thread)) {
                __auto_type _mv_100 = (*formal).inner_type;
                if (_mv_100.has_value) {
                    __auto_type f_inner = _mv_100.value;
                    __auto_type _mv_101 = (*actual).inner_type;
                    if (_mv_101.has_value) {
                        __auto_type a_inner = _mv_101.value;
                        infer_unify_types(arena, f_inner, a_inner, bind_names, bind_types);
            ...
            if (((*actual).kind == types_ResolvedTypeKind_rk_list)) {
                __auto_type _mv_102 = (*formal).inner_type;
                if (_mv_102.has_value) {
                    __auto_type f_inner = _mv_102.value;
                    __auto_type _mv_103 = (*actual).inner_type;
                    if (_mv_103.has_value) {
                        __auto_type a_inner = _mv_103.value;
                        infer_unify_types(arena, f_inner, a_inner, bind_names, bind_types);
            ...
            if (((*actual).kind == types_ResolvedTypeKind_rk_option)) {
                __auto_type _mv_104 = (*formal).inner_type;
                if (_mv_104.has_value) {
                    __auto_type f_inner = _mv_104.value;
                    __auto_type _mv_105 = (*actual).inner_type;
                    if (_mv_105.has_value) {
                        __auto_type a_inner = _mv_105.value;
                        infer_unify_types(arena, f_inner, a_inner, bind_names, bind_types);
            ...
            if (((*actual).kind == types_ResolvedTypeKind_rk_result)) {
                __auto_type _mv_106 = (*formal).inner_type;
                if (_mv_106.has_value) {
                    __auto_type f_inner = _mv_106.value;
                    __auto_type _mv_107 = (*actual).inner_type;
                    if (_mv_107.has_value) {
                        __auto_type a_inner = _mv_107.value;
                        infer_unify_types(arena, f_inner, a_inner, bind_names, bind_types);
                    } else if (!_mv_107.has_value) {
                    }
                } else if (!_mv_106.has_value) {
                }
                __auto_type _mv_108 = (*formal).inner_type2;
                if (_mv_108.has_value) {
                    __auto_type f_inner2 = _mv_108.value;
                    __auto_type _mv_109 = (*actual).inner_type2;
                    if (_mv_109.has_value) {
                        __auto_type a_inner2 = _mv_109.value;
        ...
        if ((kind == types_ResolvedTypeKind_rk_typevar)) {
            {
                ...
                __auto_type _mv_110 = infer_find_binding(bind_names, bind_types, tv_name);
                if (_mv_110.has_value) {
                    __auto_type bound = _mv_110.value;
                    return bound;
            ...
            __auto_type _mv_111 = (*t).inner_type;
            if (_mv_111.has_value) {
                __auto_type inner = _mv_111.value;
                {
            ...
            __auto_type _mv_112 = (*t).inner_type;
            ...
            __auto_type _mv_113 = (*t).inner_type;
            if (_mv_113.has_value) {
                __auto_type inner = _mv_113.value;
                {
                    __auto_type new_inner = infer_substitute_type_vars(arena, inner, bind_names, bind_types);
            ...
            __auto_type _mv_114 = (*t).inner_type;
            if (_mv_114.has_value) {
                __auto_type inner = _mv_114.value;
                {
                    __auto_type new_inner = infer_substitute_type_vars(arena, inner, bind_names, bind_types);
            ...
            __auto_type _mv_115 = (*t).inner_type;
        ...
        if (parser_sexpr_is_list(expr)) {
            {
                ...
                }
                {
                    ...
                    for (int64_t i = 0; i < limit; i++) {
                        __auto_type _mv_116 = parser_sexpr_list_get(expr, (i + 1));
                        if (_mv_116.has_value) {
                            __auto_type arg_expr = _mv_116.value;
                            {
                                __auto_type actual_type = infer_infer_expr(env, arg_expr);
                                __auto_type _mv_117 = ({ __auto_type _lst = params; size_t _idx = (size_t)i; slop_option_types_ParamInfo _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_117.has_value) {
                                    __auto_type param_info = _mv_117.value;
                                    {
...
void infer_sexpr_set_resolved_type(types_SExpr* expr, types_ResolvedType* t) {
    ...
    switch (_mv_120.tag) {
        ...
        {
            __auto_type str = _mv_120.data.str;
            ...
            case types_SExpr_sym:
            {
                __auto_type sym = _mv_121.data.sym;
                {
                    ...
                    if ((string_eq(name, SLOP_STR("true")) || string_eq(name, SLOP_STR("false")))) {
                        ...
                        __auto_type _mv_122 = env_env_lookup_var(env, name);
                        if (_mv_122.has_value) {
                            __auto_type t = _mv_122.value;
                            return t;
                        } else if (!_mv_122.has_value) {
                            __auto_type _mv_123 = env_env_lookup_constant(env, name);
                            if (_mv_123.has_value) {
                                __auto_type t = _mv_123.value;
                                return t;
                            } else if (!_mv_123.has_value) {
                                __auto_type _mv_124 = env_env_lookup_function(env, name);
                                if (_mv_124.has_value) {
                                    __auto_type sig = _mv_124.value;
                                    ...
                                    if (infer_string_contains_char(name, 46)) {
                                        {
                                            ...
                                            __auto_type _mv_125 = env_env_lookup_var(env, base_name);
                                            if (_mv_125.has_value) {
                                                __auto_type obj_type = _mv_125.value;
                                                return infer_check_field_exists(env, obj_type, field_name, line, col);
                                            } else if (!_mv_125.has_value) {
                                                __auto_type _mv_126 = env_env_lookup_type(env, base_name);
                                                if (_mv_126.has_value) {
                                                    __auto_type type_info = _mv_126.value;
                                                    return type_info;
                                        ...
                                        __auto_type _mv_127 = env_env_lookup_type(env, name);
                                        if (_mv_127.has_value) {
                                            __auto_type type_info = _mv_127.value;
                                            return type_info;
...
types_ResolvedType* infer_infer_list_expr(env_TypeEnv* env, types_SExpr* expr, types_SExprList lst) {
    ...
    SLOP_PRE(((expr != NULL)), "(!= expr nil)");
    {
        ...
        if ((len == 0)) {
            ...
            __auto_type _mv_128 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (!_mv_128.has_value) {
                return env_env_get_unit_type(env);
            } else if (_mv_128.has_value) {
                __auto_type head = _mv_128.value;
                __auto_type _mv_129 = (*head);
                switch (_mv_129.tag) {
                    case types_SExpr_sym:
                    {
...
types_ResolvedType* infer_infer_special_form(env_TypeEnv* env, types_SExpr* expr, types_SExprList lst, slop_string op) {
    SLOP_PRE(((env != NULL)), "(!= env nil)");
    {
        ...
        if (string_eq(op, SLOP_STR("if"))) {
            if ((len >= 4)) {
                __auto_type _mv_130 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_130.has_value) {
                    __auto_type cond_expr = _mv_130.value;
                    {
                        __auto_type _ = infer_infer_expr(env, cond_expr);
                    }
                } else if (!_mv_130.has_value) {
                }
                __auto_type _mv_131 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_131.has_value) {
                    __auto_type then_expr = _mv_131.value;
                    {
                        __auto_type then_type = infer_infer_expr(env, then_expr);
                        __auto_type _mv_132 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_132.has_value) {
                            __auto_type else_expr = _mv_132.value;
                            {
            ...
            if ((len > 1)) {
                __auto_type _mv_133 = ({ __auto_type _lst = items; size_t _idx = (size_t)(len - 1); slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_133.has_value) {
                    __auto_type last = _mv_133.value;
            ...
            if ((len >= 2)) {
                ...
                if (_mv_134.has_value) {
                    __auto_type binding_form = _mv_134.value;
                    if (parser_sexpr_is_list(binding_form)) {
                        {
                            __auto_type bind_len = parser_sexpr_list_len(binding_form);
                            if ((bind_len >= 3)) {
                                __auto_type _mv_135 = parser_sexpr_list_get(binding_form, 0);
                                if (_mv_135.has_value) {
                                    __auto_type var_expr = _mv_135.value;
                                    {
                                        ...
                                        if (!(string_eq(var_name, SLOP_STR("")))) {
                                            ...
                                            __auto_type _mv_136 = parser_sexpr_list_get(binding_form, 1);
                                            if (_mv_136.has_value) {
                                                __auto_type start_expr = _mv_136.value;
                                                {
                                                    __auto_type _ = infer_infer_expr(env, start_expr);
                                                }
                                            } else if (!_mv_136.has_value) {
                                            }
                                            __auto_type _mv_137 = parser_sexpr_list_get(binding_form, 2);
                                            if (_mv_137.has_value) {
                                                __auto_type end_expr = _mv_137.value;
                                                {
            ...
            if ((len >= 3)) {
                ...
                if (_mv_138.has_value) {
                    __auto_type binding_form = _mv_138.value;
                    if (parser_sexpr_is_list(binding_form)) {
                        {
                            __auto_type bind_len = parser_sexpr_list_len(binding_form);
                            if ((bind_len >= 2)) {
                                __auto_type _mv_139 = parser_sexpr_list_get(binding_form, 0);
                                if (_mv_139.has_value) {
                                    __auto_type var_expr = _mv_139.value;
                                    {
                                        __auto_type var_name = parser_sexpr_get_symbol_name(var_expr);
                                        if (string_eq(var_name, SLOP_STR(""))) {
                                            return env_env_get_unit_type(env);
                                        } else {
                                            __auto_type _mv_140 = parser_sexpr_list_get(binding_form, 1);
                                            if (_mv_140.has_value) {
                                                __auto_type coll_expr = _mv_140.value;
                                                {
            ...
            if ((len >= 4)) {
                __auto_type _mv_141 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_141.has_value) {
                    __auto_type val_expr = _mv_141.value;
                    {
                ...
                __auto_type _mv_142 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_142.has_value) {
                    __auto_type val_expr = _mv_142.value;
                    {
                        __auto_type _ = infer_infer_expr(env, val_expr);
                    }
            ...
            if ((len >= 2)) {
                ...
                if (_mv_143.has_value) {
                    __auto_type ret_expr = _mv_143.value;
            ...
            if ((len >= 2)) {
                __auto_type _mv_144 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_144.has_value) {
                    __auto_type ptr_expr = _mv_144.value;
                    {
                        __auto_type ptr_type = infer_infer_expr(env, ptr_expr);
                        if (types_resolved_type_is_pointer(ptr_type)) {
                            __auto_type _mv_145 = (*ptr_type).inner_type;
                            if (_mv_145.has_value) {
                                __auto_type inner = _mv_145.value;
                                return inner;
            ...
            if ((len >= 2)) {
                __auto_type _mv_146 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_146.has_value) {
                    __auto_type inner_expr = _mv_146.value;
                    {
            ...
            if ((len >= 2)) {
                __auto_type _mv_147 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_147.has_value) {
                    __auto_type type_expr = _mv_147.value;
                    {
                        ...
                        if (string_eq(type_name, SLOP_STR(""))) {
                            if (parser_sexpr_is_list(type_expr)) {
                                ...
                                if (_mv_148.has_value) {
                                    __auto_type head_expr = _mv_148.value;
                                    {
                            ...
                            __auto_type _mv_149 = env_env_lookup_type(env, type_name);
                            if (_mv_149.has_value) {
                                __auto_type t = _mv_149.value;
                                return t;
            ...
            if ((len >= 2)) {
                ...
                if (_mv_150.has_value) {
                    __auto_type variant_expr = _mv_150.value;
                    {
                        __auto_type variant_name = parser_sexpr_get_symbol_name(variant_expr);
                        if (string_eq(variant_name, SLOP_STR(""))) {
                            return env_env_get_unknown_type(env);
                        } else {
                            __auto_type _mv_151 = env_env_lookup_variant(env, variant_name);
                            if (_mv_151.has_value) {
                                __auto_type enum_name = _mv_151.value;
                                __auto_type _mv_152 = env_env_lookup_type(env, enum_name);
                                if (_mv_152.has_value) {
                                    __auto_type enum_type = _mv_152.value;
                                    return enum_type;
            ...
            if ((len >= 2)) {
                ...
                if (_mv_153.has_value) {
                    __auto_type inner_expr = _mv_153.value;
                    {
                        __auto_type inner_type = infer_infer_expr(env, inner_expr);
            ...
            for (int64_t fi = 2; fi < len; fi++) {
                __auto_type _mv_154 = ({ __auto_type _lst = items; size_t _idx = (size_t)fi; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_154.has_value) {
                    __auto_type field_pair = _mv_154.value;
                    if ((parser_sexpr_is_list(field_pair) && (parser_sexpr_list_len(field_pair) >= 2))) {
                        __auto_type _mv_155 = parser_sexpr_list_get(field_pair, 1);
                        if (_mv_155.has_value) {
                            __auto_type val_expr = _mv_155.value;
                            {
                                __auto_type _ = infer_infer_expr(env, val_expr);
                            }
            ...
            if ((len >= 2)) {
                ...
                if (_mv_156.has_value) {
                    __auto_type type_expr = _mv_156.value;
                    {
                        __auto_type type_name = parser_sexpr_get_symbol_name(type_expr);
                        if (string_eq(type_name, SLOP_STR(""))) {
                            return env_env_get_unit_type(env);
            ...
            if ((len >= 4)) {
                __auto_type _mv_158 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_158.has_value) {
                    __auto_type val_expr = _mv_158.value;
                    {
                        __auto_type _ = infer_infer_expr(env, val_expr);
                    }
            ...
            if ((len >= 2)) {
                __auto_type _mv_159 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_159.has_value) {
                    __auto_type type_expr = _mv_159.value;
                    {
                        __auto_type type_name = parser_sexpr_get_symbol_name(type_expr);
                        if (string_eq(type_name, SLOP_STR(""))) {
                            return env_env_get_unit_type(env);
                        } else {
                            __auto_type _mv_160 = env_env_lookup_type(env, type_name);
                            if (_mv_160.has_value) {
                                __auto_type t = _mv_160.value;
                                return t;
            ...
            __auto_type _mv_161 = env_env_lookup_function(env, op);
            if (_mv_161.has_value) {
                __auto_type sig = _mv_161.value;
                ...
                __auto_type _mv_162 = env_env_lookup_type(env, op);
                if (_mv_162.has_value) {
                    __auto_type the_type = _mv_162.value;
                    return the_type;
                    ...
                    if (string_eq(op, SLOP_STR("list-get"))) {
                        ...
                        if ((len < 3)) {
                            ...
                            __auto_type _mv_165 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_165.has_value) {
                                __auto_type type_expr = _mv_165.value;
                                {
                                    __auto_type type_name = parser_sexpr_get_symbol_name(type_expr);
                                    if (string_eq(type_name, SLOP_STR(""))) {
                                        return env_env_get_int_type(env);
                                    } else {
                                        __auto_type _mv_166 = env_env_lookup_type(env, type_name);
                                        if (_mv_166.has_value) {
                                            __auto_type resolved = _mv_166.value;
                        ...
                        infer_check_builtin_args(env, SLOP_STR("list-new"), 2, (len - 1), line, col);
                        {
                            ...
                            if ((len >= 3)) {
                                ...
                                if (_mv_167.has_value) {
                                    __auto_type type_expr = _mv_167.value;
                                    {
                    ...
                    } else if (string_eq(op, SLOP_STR("ok"))) {
                        {
                            ...
                            if ((len >= 2)) {
                                __auto_type _mv_168 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_168.has_value) {
                                    __auto_type val_expr = _mv_168.value;
                                    {
                    ...
                    } else if (string_eq(op, SLOP_STR("error"))) {
                        {
                            ...
                            if ((len >= 2)) {
                                ...
                                if (_mv_169.has_value) {
                                    __auto_type val_expr = _mv_169.value;
                                    {
                                        __auto_type val_type = infer_infer_expr(env, val_expr);
                        ...
                        if ((len >= 2)) {
                            ...
                            if (_mv_170.has_value) {
                                __auto_type ptr_expr = _mv_170.value;
                                {
                                    __auto_type ptr_type = infer_infer_expr(env, ptr_expr);
                                    if (types_resolved_type_is_pointer(ptr_type)) {
                                        __auto_type _mv_171 = (*ptr_type).inner_type;
                                        if (_mv_171.has_value) {
                                            __auto_type inner = _mv_171.value;
                                            return inner;
                        ...
                        infer_check_builtin_args(env, SLOP_STR("map-new"), 3, (len - 1), line, col);
                        {
                            ...
                            if ((len >= 3)) {
                                ...
                                if (_mv_172.has_value) {
                                    __auto_type type_expr = _mv_172.value;
                                    {
                                        __auto_type type_name = parser_sexpr_get_symbol_name(type_expr);
                                        if (!(string_eq(type_name, SLOP_STR("")))) {
                                            __auto_type _mv_173 = env_env_lookup_type(env, type_name);
                                            if (_mv_173.has_value) {
                                                __auto_type t = _mv_173.value;
                                                key_type = t;
                            ...
                            if ((len >= 4)) {
                                __auto_type _mv_174 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_174.has_value) {
                                    __auto_type type_expr = _mv_174.value;
                                    {
                                        __auto_type type_name = parser_sexpr_get_symbol_name(type_expr);
                                        if (!(string_eq(type_name, SLOP_STR("")))) {
                                            __auto_type _mv_175 = env_env_lookup_type(env, type_name);
                                            if (_mv_175.has_value) {
                                                __auto_type t = _mv_175.value;
                                                val_type = t;
                        ...
                        infer_check_builtin_args(env, SLOP_STR("map-get"), 2, (len - 1), line, col);
                        {
                            types_ResolvedType* val_type = NULL;
                            if ((len >= 2)) {
                                __auto_type _mv_176 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_176.has_value) {
                                    __auto_type map_expr = _mv_176.value;
                                    {
                                        __auto_type map_type = infer_infer_expr(env, map_expr);
                                        __auto_type _mv_177 = (*map_type).inner_type2;
                                        if (_mv_177.has_value) {
                                            __auto_type inner = _mv_177.value;
                                            val_type = inner;
                        ...
                        if ((len >= 2)) {
                            ...
                            if (_mv_178.has_value) {
                                __auto_type map_expr = _mv_178.value;
                                {
                                    __auto_type map_type = infer_infer_expr(env, map_expr);
                        ...
                        infer_check_builtin_args(env, SLOP_STR("map-keys"), 1, (len - 1), line, col);
                        {
                            ...
                            if ((len >= 2)) {
                                ...
                                if (_mv_179.has_value) {
                                    __auto_type map_expr = _mv_179.value;
                                    {
                                        __auto_type map_type = infer_infer_expr(env, map_expr);
                                        __auto_type _mv_180 = (*map_type).inner_type;
                                        if (_mv_180.has_value) {
                                            __auto_type inner = _mv_180.value;
                                            key_type = inner;
                        ...
                        infer_check_builtin_args(env, SLOP_STR("set-new"), 2, (len - 1), line, col);
                        {
                            ...
                            if ((len >= 3)) {
                                ...
                                if (_mv_181.has_value) {
                                    __auto_type type_expr = _mv_181.value;
                                    {
                                        __auto_type type_name = parser_sexpr_get_symbol_name(type_expr);
                                        if (!(string_eq(type_name, SLOP_STR("")))) {
                                            __auto_type _mv_182 = env_env_lookup_type(env, type_name);
                                            if (_mv_182.has_value) {
                                                __auto_type t = _mv_182.value;
                                                elem_type = t;
                        ...
                        infer_check_builtin_args(env, SLOP_STR("set-elements"), 1, (len - 1), line, col);
                        {
                            ...
                            if ((len >= 2)) {
                                ...
                                if (_mv_183.has_value) {
                                    __auto_type set_expr = _mv_183.value;
                                    {
                                        __auto_type set_type = infer_infer_expr(env, set_expr);
                                        __auto_type _mv_184 = (*set_type).inner_type;
                        ...
                        {
                            __auto_type arena = env_env_arena(env);
                            __auto_type _mv_185 = env_env_lookup_variant(env, op);
                            if (_mv_185.has_value) {
                                __auto_type parent_type = _mv_185.value;
                                {
                                ...
                                if ((strlib_starts_with(op, SLOP_STR("set-")) || (strlib_starts_with(op, SLOP_STR("map-")) || (strlib_starts_with(op, SLOP_STR("list-")) || strlib_starts_with(op, SLOP_STR("arena-")))))) {
                                    ...
                                    __auto_type _mv_186 = env_env_lookup_var(env, op);
                                    if (_mv_186.has_value) {
                                        __auto_type var_type = _mv_186.value;
                                        infer_infer_builtin_args(env, expr);
                                        return var_type;
...
void infer_check_single_arg(env_TypeEnv* env, types_FnSignature* sig, types_SExpr* expr, int64_t arg_idx, int64_t line, int64_t col) {
    ...
    SLOP_PRE(((sig != NULL)), "(!= sig nil)");
    {
        ...
        __auto_type fn_name = (*sig).name;
        __auto_type arena = env_env_arena(env);
        __auto_type _mv_187 = ({ __auto_type _lst = params; size_t _idx = (size_t)arg_idx; slop_option_types_ParamInfo _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        if (_mv_187.has_value) {
            __auto_type param_info = _mv_187.value;
            {
                __auto_type expected_type = param_info.param_type;
                __auto_type _mv_188 = parser_sexpr_list_get(expr, (arg_idx + 1));
    ...
    if (parser_sexpr_is_list(expr)) {
        {
            ...
            for (int64_t i = 1; i < len; i++) {
                __auto_type _mv_189 = parser_sexpr_list_get(expr, i);
                if (_mv_189.has_value) {
                    __auto_type arg_expr = _mv_189.value;
                    {
    ...
    if (parser_sexpr_is_list(expr)) {
        {
            ...
            for (int64_t i = start_idx; i < len; i++) {
                __auto_type _mv_190 = parser_sexpr_list_get(expr, i);
                if (_mv_190.has_value) {
                    __auto_type body_expr = _mv_190.value;
                    {
...
types_ResolvedType* infer_check_field_exists(env_TypeEnv* env, types_ResolvedType* obj_type, slop_string field_name, int64_t line, int64_t col) {
    ...
    SLOP_PRE(((obj_type != NULL)), "(!= obj-type nil)");
    {
        ...
        if (types_resolved_type_is_record(obj_type)) {
            __auto_type _mv_194 = types_resolved_type_get_field_type(obj_type, field_name);
            if (_mv_194.has_value) {
                __auto_type field_type = _mv_194.value;
                return field_type;
...
types_ResolvedType* infer_infer_cond_expr(env_TypeEnv* env, types_SExpr* expr, types_SExprList lst) {
    SLOP_PRE(((env != NULL)), "(!= env nil)");
    {
        ...
        __auto_type i = 1;
        while ((i < len)) {
            __auto_type _mv_195 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_195.has_value) {
                __auto_type clause = _mv_195.value;
                __auto_type _mv_196 = (*clause);
                switch (_mv_196.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type clause_lst = _mv_196.data.lst;
                        {
                            ...
                            if ((clause_len > 1)) {
                                ...
                                __auto_type _mv_197 = ({ __auto_type _lst = clause_items; size_t _idx = (size_t)(clause_len - 1); slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_197.has_value) {
                                    __auto_type body = _mv_197.value;
                                    {
...
void infer_bind_match_pattern(env_TypeEnv* env, types_ResolvedType* scrutinee_type, types_SExpr* pattern) {
    ...
    if (parser_sexpr_is_list(pattern)) {
        if ((parser_sexpr_list_len(pattern) > 0)) {
            __auto_type _mv_198 = parser_sexpr_list_get(pattern, 0);
            if (_mv_198.has_value) {
                __auto_type variant_expr = _mv_198.value;
                {
                    __auto_type variant_name = parser_sexpr_get_symbol_name(variant_expr);
                    if (!(string_eq(variant_name, SLOP_STR("")))) {
                        if ((parser_sexpr_list_len(pattern) > 1)) {
                            __auto_type _mv_199 = parser_sexpr_list_get(pattern, 1);
                            if (_mv_199.has_value) {
                                __auto_type binding_expr = _mv_199.value;
                                {
                                    ...
                                    if (!(string_eq(binding_name, SLOP_STR("")))) {
                                        {
                                            ...
                                            if (string_eq(scrutinee_name, SLOP_STR("T"))) {
                                                ...
                                                if (((scrutinee_kind == types_ResolvedTypeKind_rk_option) && string_eq(variant_name, SLOP_STR("some")))) {
                                                    __auto_type _mv_200 = (*scrutinee_type).inner_type;
                                                    if (_mv_200.has_value) {
                                                        __auto_type inner = _mv_200.value;
                                                    ...
                                                    if ((scrutinee_kind == types_ResolvedTypeKind_rk_result)) {
                                                        if (string_eq(variant_name, SLOP_STR("ok"))) {
                                                            __auto_type _mv_201 = (*scrutinee_type).inner_type;
                                                            if (_mv_201.has_value) {
                                                                __auto_type inner = _mv_201.value;
                                                                env_env_bind_var(env, binding_name, inner);
                                                            } else if (!_mv_201.has_value) {
                                                                env_env_bind_var(env, binding_name, env_env_get_generic_type(env));
                                                            }
                                                        } else if (string_eq(variant_name, SLOP_STR("error"))) {
                                                            __auto_type _mv_202 = (*scrutinee_type).inner_type2;
                                                            if (_mv_202.has_value) {
                                                                __auto_type inner2 = _mv_202.value;
                                                        ...
                                                        __auto_type _mv_203 = types_resolved_type_get_variant_payload(scrutinee_type, variant_name);
                                                        if (_mv_203.has_value) {
                                                            __auto_type payload_type = _mv_203.value;
...
types_ResolvedType* infer_infer_match_expr(env_TypeEnv* env, types_SExpr* expr, types_SExprList lst) {
    SLOP_PRE(((env != NULL)), "(!= env nil)");
    {
        ...
        __auto_type i = 2;
        while ((i < len)) {
            __auto_type _mv_204 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_204.has_value) {
                __auto_type clause = _mv_204.value;
                __auto_type _mv_205 = (*clause);
                switch (_mv_205.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type clause_lst = _mv_205.data.lst;
                        {
                            __auto_type clause_items = clause_lst.items;
                            __auto_type clause_len = ((int64_t)((clause_items).len));
                            if ((clause_len > 1)) {
                                env_env_push_scope(env);
                                __auto_type _mv_206 = ({ __auto_type _lst = clause_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_206.has_value) {
                                    __auto_type pattern = _mv_206.value;
                                ...
                                __auto_type _mv_207 = ({ __auto_type _lst = clause_items; size_t _idx = (size_t)(clause_len - 1); slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_207.has_value) {
                                    __auto_type body = _mv_207.value;
                                    {
                                        __auto_type body_type = infer_infer_expr(env, body);
                                        if (!(has_result)) {
                                            result_type = body_type;
...
void infer_check_return_type(env_TypeEnv* env, types_SExpr* fn_form, slop_string fn_name, types_ResolvedType* inferred_type, int64_t fn_line, int64_t fn_col) {
    ...
    __auto_type _mv_208 = (*fn_form);
    switch (_mv_208.tag) {
        case types_SExpr_lst:
        {
            __auto_type fn_lst = _mv_208.data.lst;
            {
...
void infer_check_spec_return_type(env_TypeEnv* env, types_SExpr* spec_form, slop_string fn_name, types_ResolvedType* inferred_type, int64_t fn_line, int64_t fn_col) {
    ...
    __auto_type _mv_209 = (*spec_form);
    switch (_mv_209.tag) {
        case types_SExpr_lst:
        {
            __auto_type spec_lst = _mv_209.data.lst;
            {
                __auto_type spec_items = spec_lst.items;
                __auto_type _mv_210 = ({ __auto_type _lst = spec_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_210.has_value) {
                    __auto_type spec_body = _mv_210.value;
...
void infer_check_spec_body_return(env_TypeEnv* env, types_SExpr* spec_body, slop_string fn_name, types_ResolvedType* inferred_type, int64_t fn_line, int64_t fn_col) {
    ...
    __auto_type _mv_211 = (*spec_body);
    switch (_mv_211.tag) {
        case types_SExpr_lst:
        {
            __auto_type body_lst = _mv_211.data.lst;
            {
                __auto_type body_items = body_lst.items;
                __auto_type body_len = ((int64_t)((body_items).len));
                __auto_type _mv_212 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)(body_len - 1); slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_212.has_value) {
                    __auto_type ret_expr = _mv_212.value;
...
void infer_check_return_expr(env_TypeEnv* env, types_SExpr* ret_expr, slop_string fn_name, types_ResolvedType* inferred_type, int64_t fn_line, int64_t fn_col) {
    ...
    __auto_type _mv_213 = (*ret_expr);
    switch (_mv_213.tag) {
        case types_SExpr_sym:
        {
            __auto_type ret_sym = _mv_213.data.sym;
            {
...
void infer_bind_param_from_form(env_TypeEnv* env, types_SExpr* param_form) {
    ...
    if ((parser_sexpr_is_list(param_form) && (parser_sexpr_list_len(param_form) >= 2))) {
        __auto_type _mv_214 = parser_sexpr_list_get(param_form, 0);
        if (_mv_214.has_value) {
            __auto_type first_expr = _mv_214.value;
            {
                ...
                if (((string_eq(first_name, SLOP_STR("in"))) || (string_eq(first_name, SLOP_STR("out"))) || (string_eq(first_name, SLOP_STR("mut"))))) {
                    if ((parser_sexpr_list_len(param_form) >= 3)) {
                        __auto_type _mv_215 = parser_sexpr_list_get(param_form, 1);
                        if (_mv_215.has_value) {
                            __auto_type name_expr = _mv_215.value;
                            {
...
types_ResolvedType* infer_get_param_type_from_form(env_TypeEnv* env, types_SExpr* param_form) {
    ...
    SLOP_PRE(((param_form != NULL)), "(!= param-form nil)");
    {
        ...
        __auto_type _mv_216 = parser_sexpr_list_get(param_form, type_pos);
...
types_ResolvedType* infer_resolve_complex_type_expr(env_TypeEnv* env, types_SExpr* type_expr) {
    ...
    __auto_type _mv_217 = parser_sexpr_list_get(type_expr, 0);
    if (_mv_217.has_value) {
        __auto_type head_expr = _mv_217.value;
        {
            __auto_type head_name = parser_sexpr_get_symbol_name(head_expr);
            if (string_eq(head_name, SLOP_STR("Option"))) {
            ...
            } else if (string_eq(head_name, SLOP_STR("Map"))) {
                {
                    ...
                    if ((parser_sexpr_list_len(type_expr) >= 3)) {
                        __auto_type _mv_218 = parser_sexpr_list_get(type_expr, 2);
            ...
            } else if (string_eq(head_name, SLOP_STR("Result"))) {
                {
                    ...
                    if ((parser_sexpr_list_len(type_expr) >= 2)) {
                        __auto_type _mv_219 = parser_sexpr_list_get(type_expr, 1);
                        if (_mv_219.has_value) {
                            __auto_type ok_expr = _mv_219.value;
                            {
                    ...
                    if ((parser_sexpr_list_len(type_expr) >= 3)) {
                        __auto_type _mv_220 = parser_sexpr_list_get(type_expr, 2);
                        if (_mv_220.has_value) {
                            __auto_type err_expr = _mv_220.value;
                            {
                ...
                __auto_type _mv_221 = env_env_lookup_type(env, head_name);
...
types_ResolvedType* infer_resolve_option_inner_type(env_TypeEnv* env, types_SExpr* type_expr) {
    ...
    if ((parser_sexpr_list_len(type_expr) < 2)) {
        ...
        __auto_type _mv_222 = parser_sexpr_list_get(type_expr, 1);
        if (_mv_222.has_value) {
            __auto_type inner_expr = _mv_222.value;
            {
...
types_ResolvedType* infer_resolve_ptr_inner_type(env_TypeEnv* env, types_SExpr* type_expr) {
    ...
    if ((parser_sexpr_list_len(type_expr) < 2)) {
        ...
        __auto_type _mv_223 = parser_sexpr_list_get(type_expr, 1);
        if (_mv_223.has_value) {
            __auto_type inner_expr = _mv_223.value;
            {
                __auto_type inner_name = parser_sexpr_get_symbol_name(inner_expr);
                if (string_eq(inner_name, SLOP_STR(""))) {
...
types_ResolvedType* infer_resolve_type_lenient(env_TypeEnv* env, slop_string type_name) {
    SLOP_PRE(((env != NULL)), "(!= env nil)");
    __auto_type _mv_224 = env_env_lookup_type(env, type_name);
    if (_mv_224.has_value) {
        __auto_type t = _mv_224.value;
        return t;
...
types_ResolvedType* infer_resolve_simple_type(env_TypeEnv* env, slop_string type_name) {
    SLOP_PRE(((env != NULL)), "(!= env nil)");
    __auto_type _mv_225 = env_env_lookup_type(env, type_name);
    if (_mv_225.has_value) {
        __auto_type t = _mv_225.value;
        return t;
...
void infer_bind_let_binding(env_TypeEnv* env, types_SExpr* binding_form) {
    ...
    if ((parser_sexpr_is_list(binding_form) && (parser_sexpr_list_len(binding_form) >= 2))) {
        __auto_type _mv_226 = parser_sexpr_list_get(binding_form, 0);
            ...
            __auto_type first_expr = _mv_226.value;
            {
                ...
                if (string_eq(first_name, SLOP_STR("mut"))) {
                    if ((parser_sexpr_list_len(binding_form) >= 3)) {
                        __auto_type _mv_227 = parser_sexpr_list_get(binding_form, 1);
                        if (_mv_227.has_value) {
                            __auto_type name_expr = _mv_227.value;
                            {
                                __auto_type var_name = parser_sexpr_get_symbol_name(name_expr);
                                if (!(string_eq(var_name, SLOP_STR("")))) {
                                    {
                                        __auto_type binding_len = parser_sexpr_list_len(binding_form);
                                        __auto_type _mv_228 = parser_sexpr_list_get(binding_form, (binding_len - 1));
                    ...
                    if (!(string_eq(first_name, SLOP_STR("")))) {
                        {
                            __auto_type binding_len = parser_sexpr_list_len(binding_form);
                            if ((binding_len == 3)) {
                                __auto_type _mv_229 = parser_sexpr_list_get(binding_form, 2);
                                if (_mv_229.has_value) {
                                    __auto_type val_expr = _mv_229.value;
                                    {
                                        __auto_type val_type = infer_infer_expr(env, val_expr);
                                ...
                                __auto_type _mv_230 = parser_sexpr_list_get(binding_form, 1);
                                if (_mv_230.has_value) {
                                    __auto_type val_expr = _mv_230.value;
                                    {
                                        __auto_type val_type = infer_infer_expr(env, val_expr);
                                        env_env_bind_var(env, first_name, val_type);
                                    }
...
types_ResolvedType* infer_infer_let_expr(env_TypeEnv* env, types_SExpr* expr) {
    ...
    env_env_push_scope(env);
    if (parser_sexpr_is_list(expr)) {
        __auto_type _mv_231 = parser_sexpr_list_get(expr, 1);
        if (_mv_231.has_value) {
            __auto_type bindings_expr = _mv_231.value;
...
types_ResolvedType* infer_infer_with_arena_expr(env_TypeEnv* env, types_SExpr* expr) {
    ...
    SLOP_PRE(((expr != NULL)), "(!= expr nil)");
    {
        ...
        if ((len < 2)) {
            ...
            __auto_type _mv_232 = parser_sexpr_list_get(expr, 1);
            if (_mv_232.has_value) {
                __auto_type size_expr = _mv_232.value;
                __auto_type _mv_233 = (*size_expr);
                switch (_mv_233.tag) {
                    case types_SExpr_num:
                    {
                        __auto_type num = _mv_233.data.num;
                        if ((num.int_value <= 0)) {
            ...
            env_env_bind_var(env, SLOP_STR("arena"), env_env_get_arena_type(env));
            {
                ...
                for (int64_t i = 2; i < len; i++) {
                    __auto_type _mv_234 = parser_sexpr_list_get(expr, i);
                    if (_mv_234.has_value) {
                        __auto_type body_expr = _mv_234.value;
...
slop_string infer_get_fn_name(types_SExpr* fn_form) {
    ...
    if (!(parser_sexpr_is_list(fn_form))) {
        ...
        if ((parser_sexpr_list_len(fn_form) < 2)) {
            ...
            __auto_type _mv_235 = parser_sexpr_list_get(fn_form, 1);
            if (_mv_235.has_value) {
                __auto_type name_expr = _mv_235.value;
                {
...
types_ResolvedType* infer_resolve_hole_type(env_TypeEnv* env, slop_list_types_SExpr_ptr items, int64_t len) {
    ...
    if ((len < 2)) {
        ...
        if (_mv_236.has_value) {
            __auto_type type_expr = _mv_236.value;
            {
                __auto_type type_name = parser_sexpr_get_symbol_name(type_expr);
                if (string_eq(type_name, SLOP_STR(""))) {
                    return env_env_get_unit_type(env);
                } else {
                    __auto_type _mv_237 = env_env_lookup_type(env, type_name);
                    if (_mv_237.has_value) {
                        __auto_type t = _mv_237.value;
                        return t;
...
slop_string infer_get_hole_prompt(slop_list_types_SExpr_ptr items, int64_t len) {
    if ((len < 3)) {
        ...
        if (_mv_238.has_value) {
            __auto_type prompt_expr = _mv_238.value;
            __auto_type _mv_239 = (*prompt_expr);
            switch (_mv_239.tag) {
                case types_SExpr_str:
                {
                    __auto_type str = _mv_239.data.str;
                    return str.value;
                }
                default: {
                    return SLOP_STR("(no description)");
...
uint8_t infer_is_c_name_related(slop_list_types_SExpr_ptr items, int64_t idx) {
    __auto_type _mv_240 = ({ __auto_type _lst = items; size_t _idx = (size_t)idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    if (_mv_240.has_value) {
        __auto_type item = _mv_240.value;
        __auto_type _mv_241 = (*item);
        switch (_mv_241.tag) {
            case types_SExpr_sym:
            {
            ...
            case types_SExpr_str:
            {
                ...
                if ((idx > 0)) {
                    __auto_type _mv_242 = ({ __auto_type _lst = items; size_t _idx = (size_t)(idx - 1); slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_242.has_value) {
                        __auto_type prev = _mv_242.value;
                        __auto_type _mv_243 = (*prev);
                        switch (_mv_243.tag) {
                            case types_SExpr_sym:
                            {
...
uint8_t infer_is_annotation_expr(types_SExpr* expr) {
    SLOP_PRE(((expr != NULL)), "(!= expr nil)");
    if (parser_sexpr_is_list(expr)) {
        __auto_type _mv_244 = parser_sexpr_list_get(expr, 0);
        if (_mv_244.has_value) {
            __auto_type head = _mv_244.value;
            __auto_type _mv_245 = (*head);
            switch (_mv_245.tag) {
                case types_SExpr_sym:
                {
        ...
        if (parser_sexpr_is_list(fn_form)) {
            {
                ...
                if ((params_len > 2)) {
                    __auto_type _mv_246 = parser_sexpr_list_get(fn_form, 2);
                    if (_mv_246.has_value) {
                        __auto_type params_expr = _mv_246.value;
    ...
    if (types_resolved_type_is_union(scrutinee_type)) {
        {
            ...
            for (int64_t i = 0; i < num_patterns; i++) {
                __auto_type _mv_247 = ({ __auto_type _lst = patterns; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_247.has_value) {
                    __auto_type pattern_case = _mv_247.value;
                    __auto_type _mv_248 = (*pattern_case);
                    switch (_mv_248.tag) {
                        case types_SExpr_lst:
                        {
                            __auto_type pattern_list = _mv_248.data.lst;
                            if ((((int64_t)((pattern_list.items).len)) > 0)) {
                                __auto_type _mv_249 = ({ __auto_type _lst = pattern_list.items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_249.has_value) {
                                    __auto_type pattern_expr = _mv_249.value;
                                    __auto_type _mv_250 = (*pattern_expr);
                                    switch (_mv_250.tag) {
                                        case types_SExpr_lst:
                                        {
                                            __auto_type variant_list = _mv_250.data.lst;
                                            {
                                                __auto_type variant_items = variant_list.items;
                                                if ((((int64_t)((variant_items).len)) > 0)) {
                                                    __auto_type _mv_251 = ({ __auto_type _lst = variant_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_251.has_value) {
                                                        __auto_type variant_name_expr = _mv_251.value;
                                                        __auto_type _mv_252 = (*variant_name_expr);
                                                        switch (_mv_252.tag) {
                                                            case types_SExpr_sym:
                                                            {
                                                                __auto_type variant_sym = _mv_252.data.sym;
                                                                {
                                                                    __auto_type variant_name = variant_sym.name;
                                                                    __auto_type _mv_253 = types_resolved_type_get_variant_payload(scrutinee_type, variant_name);
                                                                    if (_mv_253.has_value) {
                                                                        __auto_type payload_type = _mv_253.value;
                                                                        if ((((int64_t)((variant_items).len)) > 1)) {
                                                                            __auto_type _mv_254 = ({ __auto_type _lst = variant_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                                            if (_mv_254.has_value) {
                                                                                __auto_type binding_expr = _mv_254.value;
                                                                                __auto_type _mv_255 = (*binding_expr);
                                                                                switch (_mv_255.tag) {
                                                                                    case types_SExpr_sym:
                                                                                    {
                                                                                        __auto_type binding_sym = _mv_255.data.sym;
                                                                        ...
                                                                        __auto_type _mv_256 = types_resolved_type_get_variant_index(scrutinee_type, variant_name);
