...
slop_option_types_ResolvedType_ptr infer_find_binding(slop_list_string bind_names, slop_list_types_ResolvedType_ptr bind_types, slop_string name) {
    {
        ...
        for (int64_t i = 0; i < len; i++) {
            __auto_type _mv_202 = ({ __auto_type _lst = bind_names; size_t _idx = (size_t)i; slop_option_string _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_202.has_value) {
                __auto_type bn = _mv_202.value;
                if (string_eq(bn, name)) {
                    __auto_type _mv_203 = ({ __auto_type _lst = bind_types; size_t _idx = (size_t)i; slop_option_types_ResolvedType_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_203.has_value) {
                        __auto_type bt = _mv_203.value;
        ...
        if ((f_kind == types_ResolvedTypeKind_rk_typevar)) {
            {
                ...
                if (_mv_204.has_value) {
                    __auto_type existing = _mv_204.value;
            ...
            if (((*actual).kind == types_ResolvedTypeKind_rk_ptr)) {
                ...
                if (_mv_205.has_value) {
                    ...
                    __auto_type _mv_206 = (*actual).inner_type;
                    if (_mv_206.has_value) {
                        __auto_type a_inner = _mv_206.value;
            ...
            if (((*actual).kind == types_ResolvedTypeKind_rk_chan)) {
                ...
                if (_mv_207.has_value) {
                    ...
                    __auto_type _mv_208 = (*actual).inner_type;
                    if (_mv_208.has_value) {
                        __auto_type a_inner = _mv_208.value;
                        infer_unify_types(arena, f_inner, a_inner, bind_names, bind_types);
            ...
            if (((*actual).kind == types_ResolvedTypeKind_rk_thread)) {
                ...
                if (_mv_209.has_value) {
                    ...
                    __auto_type _mv_210 = (*actual).inner_type;
                    if (_mv_210.has_value) {
                        __auto_type a_inner = _mv_210.value;
                        infer_unify_types(arena, f_inner, a_inner, bind_names, bind_types);
            ...
            if (((*actual).kind == types_ResolvedTypeKind_rk_list)) {
                ...
                if (_mv_211.has_value) {
                    ...
                    __auto_type _mv_212 = (*actual).inner_type;
                    if (_mv_212.has_value) {
                        __auto_type a_inner = _mv_212.value;
                        infer_unify_types(arena, f_inner, a_inner, bind_names, bind_types);
            ...
            if (((*actual).kind == types_ResolvedTypeKind_rk_option)) {
                ...
                if (_mv_213.has_value) {
                    ...
                    __auto_type _mv_214 = (*actual).inner_type;
                    if (_mv_214.has_value) {
                        __auto_type a_inner = _mv_214.value;
                        infer_unify_types(arena, f_inner, a_inner, bind_names, bind_types);
            ...
            if (((*actual).kind == types_ResolvedTypeKind_rk_result)) {
                ...
                if (_mv_215.has_value) {
                    ...
                    __auto_type _mv_216 = (*actual).inner_type;
                    if (_mv_216.has_value) {
                        __auto_type a_inner = _mv_216.value;
                        infer_unify_types(arena, f_inner, a_inner, bind_names, bind_types);
                    } else if (!_mv_216.has_value) {
                    }
                } else if (!_mv_215.has_value) {
                }
                __auto_type _mv_217 = (*formal).inner_type2;
                if (_mv_217.has_value) {
                    __auto_type f_inner2 = _mv_217.value;
                    __auto_type _mv_218 = (*actual).inner_type2;
                    if (_mv_218.has_value) {
                        __auto_type a_inner2 = _mv_218.value;
        ...
        if ((kind == types_ResolvedTypeKind_rk_typevar)) {
            {
                ...
                if (_mv_219.has_value) {
                    __auto_type bound = _mv_219.value;
                    return bound;
        ...
        if (parser_sexpr_is_list(expr)) {
            {
                ...
                }
                {
                    ...
                    for (int64_t i = 0; i < limit; i++) {
                        __auto_type _mv_225 = parser_sexpr_list_get(expr, (i + 1));
                        if (_mv_225.has_value) {
                            __auto_type arg_expr = _mv_225.value;
                            {
                                __auto_type actual_type = infer_infer_expr(env, arg_expr);
                                __auto_type _mv_226 = ({ __auto_type _lst = params; size_t _idx = (size_t)i; slop_option_types_ParamInfo _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_226.has_value) {
                                    __auto_type param_info = _mv_226.value;
                                    {
...
void infer_sexpr_set_resolved_type(types_SExpr* expr, types_ResolvedType* t) {
    ...
    switch (_mv_229.tag) {
        ...
        {
            __auto_type str = _mv_229.data.str;
        ...
        {
            __auto_type num = _mv_229.data.num;
...
types_ResolvedType* infer_infer_expr_inner(env_TypeEnv* env, types_SExpr* expr) {
    ...
    SLOP_PRE(((expr != NULL)), "(!= expr nil)");
    {
        ...
        switch (_mv_230.tag) {
            case types_SExpr_sym:
            {
                __auto_type sym = _mv_230.data.sym;
                {
                    ...
                    if ((string_eq(name, SLOP_STR("true")) || string_eq(name, SLOP_STR("false")))) {
                        ...
                        __auto_type _mv_231 = env_env_lookup_var(env, name);
                        if (_mv_231.has_value) {
                            __auto_type t = _mv_231.value;
                            return t;
                        } else if (!_mv_231.has_value) {
                            __auto_type _mv_232 = env_env_lookup_constant(env, name);
                            if (_mv_232.has_value) {
                                __auto_type t = _mv_232.value;
                                return t;
                            } else if (!_mv_232.has_value) {
                                __auto_type _mv_233 = env_env_lookup_function(env, name);
                                if (_mv_233.has_value) {
                                    __auto_type sig = _mv_233.value;
                                    ...
                                    if (infer_string_contains_char(name, 46)) {
                                        {
                                            ...
                                            __auto_type _mv_234 = env_env_lookup_var(env, base_name);
                                            if (_mv_234.has_value) {
                                                __auto_type obj_type = _mv_234.value;
                                                return infer_check_field_exists(env, obj_type, field_name, line, col);
                                            } else if (!_mv_234.has_value) {
                                                __auto_type _mv_235 = env_env_lookup_type(env, base_name);
                                                if (_mv_235.has_value) {
                                                    __auto_type type_info = _mv_235.value;
                                                    return type_info;
                                        ...
                                        if (_mv_236.has_value) {
                                            __auto_type type_info = _mv_236.value;
                                            return type_info;
            ...
            case types_SExpr_str:
            {
                __auto_type str = _mv_230.data.str;
                return env_env_get_string_type(env);
            }
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_230.data.lst;
...
types_ResolvedType* infer_infer_list_expr(env_TypeEnv* env, types_SExpr* expr, types_SExprList lst) {
    ...
    SLOP_PRE(((expr != NULL)), "(!= expr nil)");
    {
        ...
        if ((len == 0)) {
            ...
            __auto_type _mv_237 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (!_mv_237.has_value) {
                return env_env_get_unit_type(env);
            } else if (_mv_237.has_value) {
                __auto_type head = _mv_237.value;
                __auto_type _mv_238 = (*head);
                switch (_mv_238.tag) {
                    case types_SExpr_sym:
                    {
...
types_ResolvedType* infer_infer_special_form(env_TypeEnv* env, types_SExpr* expr, types_SExprList lst, slop_string op) {
    SLOP_PRE(((env != NULL)), "(!= env nil)");
    {
        ...
        if (string_eq(op, SLOP_STR("if"))) {
            if ((len >= 4)) {
                ...
                if (_mv_240.has_value) {
                    __auto_type then_expr = _mv_240.value;
                    {
                        ...
                        __auto_type _mv_241 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            ...
            if ((len > 1)) {
                __auto_type _mv_242 = ({ __auto_type _lst = items; size_t _idx = (size_t)(len - 1); slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_242.has_value) {
                    __auto_type last = _mv_242.value;
            ...
            if ((len >= 2)) {
                ...
                if (_mv_243.has_value) {
                    __auto_type binding_form = _mv_243.value;
                    if (parser_sexpr_is_list(binding_form)) {
                        {
                            __auto_type bind_len = parser_sexpr_list_len(binding_form);
                            if ((bind_len >= 3)) {
                                __auto_type _mv_244 = parser_sexpr_list_get(binding_form, 0);
                                if (_mv_244.has_value) {
                                    __auto_type var_expr = _mv_244.value;
                                    {
                                        ...
                                        if (!(string_eq(var_name, SLOP_STR("")))) {
                                            ...
                                            __auto_type _mv_245 = parser_sexpr_list_get(binding_form, 1);
                                            if (_mv_245.has_value) {
                                                __auto_type start_expr = _mv_245.value;
                                                {
                                                    __auto_type _ = infer_infer_expr(env, start_expr);
                                                }
                                            } else if (!_mv_245.has_value) {
                                            }
                                            __auto_type _mv_246 = parser_sexpr_list_get(binding_form, 2);
                                            if (_mv_246.has_value) {
                                                __auto_type end_expr = _mv_246.value;
                                                {
                                            ...
                                            for (int64_t body_idx = 2; body_idx < len; body_idx++) {
                                                __auto_type _mv_247 = ({ __auto_type _lst = items; size_t _idx = (size_t)body_idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_247.has_value) {
                                                    __auto_type body_expr = _mv_247.value;
                                                    {
            ...
            if ((len >= 3)) {
                ...
                if (_mv_248.has_value) {
                    __auto_type binding_form = _mv_248.value;
                    if (parser_sexpr_is_list(binding_form)) {
                        {
                            __auto_type bind_len = parser_sexpr_list_len(binding_form);
                            if ((bind_len >= 2)) {
                                __auto_type _mv_249 = parser_sexpr_list_get(binding_form, 0);
                                if (_mv_249.has_value) {
                                    __auto_type var_expr = _mv_249.value;
                                    {
                                        __auto_type var_name = parser_sexpr_get_symbol_name(var_expr);
                                        if (string_eq(var_name, SLOP_STR(""))) {
                                            return env_env_get_unit_type(env);
                                        } else {
                                            __auto_type _mv_250 = parser_sexpr_list_get(binding_form, 1);
                                            if (_mv_250.has_value) {
                                                __auto_type coll_expr = _mv_250.value;
                                                {
                                                    ...
                                                    __auto_type coll_col = parser_sexpr_col(coll_expr);
                                                    {
                                                        ...
                                                        for (int64_t body_idx = 2; body_idx < len; body_idx++) {
                                                            __auto_type _mv_251 = ({ __auto_type _lst = items; size_t _idx = (size_t)body_idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                            if (_mv_251.has_value) {
                                                                __auto_type body_expr = _mv_251.value;
                                                                {
                                                                    __auto_type _ = infer_infer_expr(env, body_expr);
                                                                }
            ...
            if ((len >= 2)) {
                ...
                if (_mv_252.has_value) {
                    __auto_type params_expr = _mv_252.value;
                    if (parser_sexpr_is_list(params_expr)) {
                        {
                            ...
                            for (int64_t k = 0; k < num_params; k++) {
                                __auto_type _mv_253 = parser_sexpr_list_get(params_expr, k);
                                if (_mv_253.has_value) {
                                    __auto_type param_form = _mv_253.value;
            ...
            if ((len >= 4)) {
                __auto_type _mv_254 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            ...
            if ((len >= 2)) {
                ...
                if (_mv_256.has_value) {
                    __auto_type ret_expr = _mv_256.value;
                    {
            ...
            if ((len >= 2)) {
                ...
                if (_mv_259.has_value) {
                    __auto_type inner_expr = _mv_259.value;
                    {
                    ...
                    __auto_type type_expr = _mv_260.value;
                    {
                        ...
                        if (string_eq(type_name, SLOP_STR(""))) {
                            if (parser_sexpr_is_list(type_expr)) {
                                __auto_type _mv_261 = parser_sexpr_list_get(type_expr, 0);
                                if (_mv_261.has_value) {
                                    __auto_type head_expr = _mv_261.value;
                                    {
                            ...
                            __auto_type _mv_262 = env_env_lookup_type(env, type_name);
            ...
            if ((len >= 2)) {
                ...
                if (_mv_263.has_value) {
                    __auto_type variant_expr = _mv_263.value;
                    {
                        __auto_type variant_name = parser_sexpr_get_symbol_name(variant_expr);
                        if (string_eq(variant_name, SLOP_STR(""))) {
                            return env_env_get_unknown_type(env);
                        } else {
                            __auto_type _mv_264 = env_env_lookup_variant(env, variant_name);
                            if (_mv_264.has_value) {
                                __auto_type enum_name = _mv_264.value;
                                __auto_type _mv_265 = env_env_lookup_type(env, enum_name);
                                if (_mv_265.has_value) {
                                    __auto_type enum_type = _mv_265.value;
                                    return enum_type;
            ...
            if ((len >= 2)) {
                ...
                if (_mv_266.has_value) {
                    __auto_type inner_expr = _mv_266.value;
                    {
                        __auto_type inner_type = infer_infer_expr(env, inner_expr);
            ...
            for (int64_t fi = 2; fi < len; fi++) {
                __auto_type _mv_267 = ({ __auto_type _lst = items; size_t _idx = (size_t)fi; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_267.has_value) {
                    __auto_type field_pair = _mv_267.value;
                    if ((parser_sexpr_is_list(field_pair) && (parser_sexpr_list_len(field_pair) >= 2))) {
                        __auto_type _mv_268 = parser_sexpr_list_get(field_pair, 1);
            ...
            if ((len >= 2)) {
                ...
                if (_mv_269.has_value) {
                    __auto_type type_expr = _mv_269.value;
                    {
                        __auto_type type_name = parser_sexpr_get_symbol_name(type_expr);
                        if (string_eq(type_name, SLOP_STR(""))) {
                            return env_env_get_unit_type(env);
                        } else {
                            __auto_type _mv_270 = env_env_lookup_type(env, type_name);
                            if (_mv_270.has_value) {
                                __auto_type t = _mv_270.value;
                                return t;
            ...
            if ((len >= 4)) {
                __auto_type _mv_271 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            ...
            if ((len >= 2)) {
                ...
                if (_mv_272.has_value) {
                    __auto_type type_expr = _mv_272.value;
                    {
                        __auto_type type_name = parser_sexpr_get_symbol_name(type_expr);
                        if (string_eq(type_name, SLOP_STR(""))) {
                            return env_env_get_unit_type(env);
                        } else {
                            __auto_type _mv_273 = env_env_lookup_type(env, type_name);
                            if (_mv_273.has_value) {
                                __auto_type t = _mv_273.value;
                                return t;
            ...
            __auto_type _mv_274 = env_env_lookup_function(env, op);
            if (_mv_274.has_value) {
                __auto_type sig = _mv_274.value;
                ...
                __auto_type _mv_275 = env_env_lookup_type(env, op);
                if (_mv_275.has_value) {
                    __auto_type the_type = _mv_275.value;
                    return the_type;
                    ...
                    if (string_eq(op, SLOP_STR("list-get"))) {
                        ...
                        if ((len < 3)) {
                            ...
                            if (_mv_278.has_value) {
                                __auto_type type_expr = _mv_278.value;
                                {
                                    ...
                                    if (string_eq(type_name, SLOP_STR(""))) {
                                        if (parser_sexpr_is_list(type_expr)) {
                                            __auto_type _mv_279 = parser_sexpr_list_get(type_expr, 0);
                                            if (_mv_279.has_value) {
                                                __auto_type head_expr = _mv_279.value;
                                                if (string_eq(parser_sexpr_get_symbol_name(head_expr), SLOP_STR("sizeof"))) {
                                                    __auto_type _mv_280 = parser_sexpr_list_get(type_expr, 1);
                                                    if (_mv_280.has_value) {
                                                        __auto_type sizeof_type_expr = _mv_280.value;
                                                        {
                                                            __auto_type sizeof_type_name = parser_sexpr_get_symbol_name(sizeof_type_expr);
                                                            if (string_eq(sizeof_type_name, SLOP_STR(""))) {
                                                                return env_env_get_int_type(env);
                                                            } else {
                                                                __auto_type _mv_281 = env_env_lookup_type(env, sizeof_type_name);
                                                                if (_mv_281.has_value) {
                                                                    __auto_type resolved = _mv_281.value;
                                        ...
                                        __auto_type _mv_282 = env_env_lookup_type(env, type_name);
                                        if (_mv_282.has_value) {
                                            __auto_type resolved = _mv_282.value;
                                            return env_env_make_ptr_type(env, resolved);
                    ...
                    } else if (string_eq(op, SLOP_STR("ok"))) {
                        {
                            ...
                            if ((len >= 2)) {
                                __auto_type _mv_284 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        ...
                        if ((len >= 2)) {
                            ...
                            if (_mv_286.has_value) {
                                __auto_type ptr_expr = _mv_286.value;
                                {
                                    __auto_type ptr_type = infer_infer_expr(env, ptr_expr);
                                    if (types_resolved_type_is_pointer(ptr_type)) {
                                        __auto_type _mv_287 = (*ptr_type).inner_type;
                                        if (_mv_287.has_value) {
                                            __auto_type inner = _mv_287.value;
                                            return inner;
                        ...
                        infer_check_builtin_args(env, SLOP_STR("map-new"), 3, (len - 1), line, col);
                        {
                            ...
                            if ((len >= 3)) {
                                __auto_type _mv_288 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_288.has_value) {
                                    __auto_type type_expr = _mv_288.value;
                                    {
                                        __auto_type type_name = parser_sexpr_get_symbol_name(type_expr);
                                        if (!(string_eq(type_name, SLOP_STR("")))) {
                                            __auto_type _mv_289 = env_env_lookup_type(env, type_name);
                                            if (_mv_289.has_value) {
                                                __auto_type t = _mv_289.value;
                                                key_type = t;
                            ...
                            if ((len >= 4)) {
                                __auto_type _mv_290 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_290.has_value) {
                                    __auto_type type_expr = _mv_290.value;
                                    {
                                        __auto_type type_name = parser_sexpr_get_symbol_name(type_expr);
                                        if (!(string_eq(type_name, SLOP_STR("")))) {
                                            __auto_type _mv_291 = env_env_lookup_type(env, type_name);
                        ...
                        infer_check_builtin_args(env, SLOP_STR("map-get"), 2, (len - 1), line, col);
                        {
                            ...
                            if ((len >= 2)) {
                                ...
                                if (_mv_292.has_value) {
                                    __auto_type map_expr = _mv_292.value;
                                    {
                                        __auto_type map_type = infer_infer_expr(env, map_expr);
                                        __auto_type _mv_293 = (*map_type).inner_type2;
                        ...
                        infer_check_builtin_args(env, SLOP_STR("map-keys"), 1, (len - 1), line, col);
                        {
                            ...
                            types_ResolvedType* key_type = NULL;
                            if ((len >= 2)) {
                                __auto_type _mv_295 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_295.has_value) {
                                    __auto_type map_expr = _mv_295.value;
                                    {
                                        __auto_type map_type = infer_infer_expr(env, map_expr);
                                        __auto_type _mv_296 = (*map_type).inner_type;
                                        if (_mv_296.has_value) {
                                            __auto_type inner = _mv_296.value;
                                            key_type = inner;
                        ...
                        infer_check_builtin_args(env, SLOP_STR("set-new"), 2, (len - 1), line, col);
                        {
                            ...
                            types_ResolvedType* elem_type = NULL;
                            if ((len >= 3)) {
                                __auto_type _mv_297 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_297.has_value) {
                                    __auto_type type_expr = _mv_297.value;
                                    {
                                        __auto_type type_name = parser_sexpr_get_symbol_name(type_expr);
                                        if (!(string_eq(type_name, SLOP_STR("")))) {
                        ...
                        infer_check_builtin_args(env, SLOP_STR("set-elements"), 1, (len - 1), line, col);
                        {
                            ...
                            types_ResolvedType* elem_type = NULL;
                            if ((len >= 2)) {
                                __auto_type _mv_299 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_299.has_value) {
                                    __auto_type set_expr = _mv_299.value;
                                    {
                                        __auto_type set_type = infer_infer_expr(env, set_expr);
                                        __auto_type _mv_300 = (*set_type).inner_type;
                                        if (_mv_300.has_value) {
                                            __auto_type inner = _mv_300.value;
                                            elem_type = inner;
                        ...
                        {
                            __auto_type arena = env_env_arena(env);
                            __auto_type _mv_301 = env_env_lookup_variant(env, op);
                            if (_mv_301.has_value) {
                                __auto_type parent_type = _mv_301.value;
                                {
                                ...
                                if ((strlib_starts_with(op, SLOP_STR("set-")) || (strlib_starts_with(op, SLOP_STR("map-")) || (strlib_starts_with(op, SLOP_STR("list-")) || strlib_starts_with(op, SLOP_STR("arena-")))))) {
                                    ...
                                    __auto_type _mv_302 = env_env_lookup_var(env, op);
                                    if (_mv_302.has_value) {
                                        __auto_type var_type = _mv_302.value;
                                        infer_infer_builtin_args(env, expr);
                                        return var_type;
...
void infer_check_single_arg(env_TypeEnv* env, types_FnSignature* sig, types_SExpr* expr, int64_t arg_idx, int64_t line, int64_t col) {
    ...
    SLOP_PRE(((sig != NULL)), "(!= sig nil)");
    {
        ...
        __auto_type fn_name = (*sig).name;
        __auto_type arena = env_env_arena(env);
        __auto_type _mv_303 = ({ __auto_type _lst = params; size_t _idx = (size_t)arg_idx; slop_option_types_ParamInfo _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        if (_mv_303.has_value) {
            __auto_type param_info = _mv_303.value;
            {
                __auto_type expected_type = param_info.param_type;
                __auto_type _mv_304 = parser_sexpr_list_get(expr, (arg_idx + 1));
                if (_mv_304.has_value) {
                    __auto_type arg_expr = _mv_304.value;
                    {
                        __auto_type actual_type = infer_infer_expr(env, arg_expr);
    ...
    if (parser_sexpr_is_list(expr)) {
        {
            ...
            for (int64_t i = 1; i < len; i++) {
                __auto_type _mv_305 = parser_sexpr_list_get(expr, i);
                if (_mv_305.has_value) {
                    __auto_type arg_expr = _mv_305.value;
                    {
    ...
    if (parser_sexpr_is_list(expr)) {
        {
            ...
            for (int64_t i = start_idx; i < len; i++) {
                __auto_type _mv_306 = parser_sexpr_list_get(expr, i);
...
types_ResolvedType* infer_infer_field_access(env_TypeEnv* env, types_SExpr* expr, types_SExprList lst, int64_t line, int64_t col) {
    SLOP_PRE(((env != NULL)), "(!= env nil)");
    {
        ...
        if ((len < 3)) {
            ...
            __auto_type _mv_307 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (!_mv_307.has_value) {
                return env_env_get_unit_type(env);
            } else if (_mv_307.has_value) {
                __auto_type obj_expr = _mv_307.value;
                {
                    __auto_type obj_type = infer_infer_expr(env, obj_expr);
                    __auto_type _mv_308 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (!_mv_308.has_value) {
                        return env_env_get_unit_type(env);
                    } else if (_mv_308.has_value) {
                        __auto_type field_expr = _mv_308.value;
                        __auto_type _mv_309 = (*field_expr);
                        switch (_mv_309.tag) {
                            case types_SExpr_sym:
                            {
                                __auto_type field_sym = _mv_309.data.sym;
                                {
...
types_ResolvedType* infer_check_field_exists(env_TypeEnv* env, types_ResolvedType* obj_type, slop_string field_name, int64_t line, int64_t col) {
    ...
    SLOP_PRE(((obj_type != NULL)), "(!= obj-type nil)");
    {
        ...
        if (types_resolved_type_is_record(obj_type)) {
            __auto_type _mv_310 = types_resolved_type_get_field_type(obj_type, field_name);
            if (_mv_310.has_value) {
                __auto_type field_type = _mv_310.value;
                return field_type;
                ...
                if (string_eq(type_name, SLOP_STR("String"))) {
                    ...
                    if (string_eq(type_name, SLOP_STR("Unknown"))) {
                        ...
                        if (types_resolved_type_is_pointer(obj_type)) {
                            __auto_type _mv_311 = (*obj_type).inner_type;
                            if (_mv_311.has_value) {
                                __auto_type inner_type = _mv_311.value;
    ...
    SLOP_PRE(((env != NULL)), "(!= env nil)");
    {
        ...
        while ((i < len)) {
            ...
            if (_mv_312.has_value) {
                __auto_type clause = _mv_312.value;
                __auto_type _mv_313 = (*clause);
                switch (_mv_313.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type clause_lst = _mv_313.data.lst;
                        {
                            ...
                            if ((clause_len > 1)) {
                                for (int64_t ci = 0; ci < (clause_len - 1); ci++) {
                                    __auto_type _mv_314 = ({ __auto_type _lst = clause_items; size_t _idx = (size_t)ci; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    if (_mv_314.has_value) {
                                        __auto_type clause_elem = _mv_314.value;
                                        {
                                ...
                                if (_mv_315.has_value) {
                                    __auto_type body = _mv_315.value;
                                    {
...
void infer_bind_match_pattern(env_TypeEnv* env, types_ResolvedType* scrutinee_type, types_SExpr* pattern) {
    ...
    if (parser_sexpr_is_list(pattern)) {
        if ((parser_sexpr_list_len(pattern) > 0)) {
            __auto_type _mv_316 = parser_sexpr_list_get(pattern, 0);
            if (_mv_316.has_value) {
                __auto_type variant_expr = _mv_316.value;
                {
                    __auto_type variant_name = parser_sexpr_get_symbol_name(variant_expr);
                    if (!(string_eq(variant_name, SLOP_STR("")))) {
                        if ((parser_sexpr_list_len(pattern) > 1)) {
                            __auto_type _mv_317 = parser_sexpr_list_get(pattern, 1);
                            if (_mv_317.has_value) {
                                __auto_type binding_expr = _mv_317.value;
                                {
                                    ...
                                    if (!(string_eq(binding_name, SLOP_STR("")))) {
                                        {
                                            ...
                                            if (string_eq(scrutinee_name, SLOP_STR("T"))) {
                                                ...
                                                if (((scrutinee_kind == types_ResolvedTypeKind_rk_option) && string_eq(variant_name, SLOP_STR("some")))) {
                                                    __auto_type _mv_318 = (*scrutinee_type).inner_type;
                                                    if (_mv_318.has_value) {
                                                        __auto_type inner = _mv_318.value;
                                                    ...
                                                    if ((scrutinee_kind == types_ResolvedTypeKind_rk_result)) {
                                                        if (string_eq(variant_name, SLOP_STR("ok"))) {
                                                            __auto_type _mv_319 = (*scrutinee_type).inner_type;
                                                            ...
                                                            __auto_type _mv_320 = (*scrutinee_type).inner_type2;
                                                            if (_mv_320.has_value) {
                                                                __auto_type inner2 = _mv_320.value;
                                                    ...
                                                    } else {
                                                        {
                                                            ...
                                                            if ((((int64_t)((payload_types).len)) > 0)) {
                                                                if ((!(string_eq(binding_name, SLOP_STR("true"))) && !(string_eq(binding_name, SLOP_STR("false"))))) {
                                                                    __auto_type _mv_321 = ({ __auto_type _lst = payload_types; size_t _idx = (size_t)0; slop_option_types_ResolvedType_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                                    if (_mv_321.has_value) {
                                                                        __auto_type first_type = _mv_321.value;
                                                                ...
                                                                }
                                                                {
                                                                    ...
                                                                    for (int64_t pi = 2; pi < pat_len; pi++) {
                                                                        __auto_type _mv_322 = parser_sexpr_list_get(pattern, pi);
                                                                        if (_mv_322.has_value) {
                                                                            __auto_type extra_binding = _mv_322.value;
                                                                            {
                                                                                ...
                                                                                if (((!(string_eq(extra_name, SLOP_STR("")))) && (!(string_eq(extra_name, SLOP_STR("_")))) && (!(string_eq(extra_name, SLOP_STR("true")))) && (!(string_eq(extra_name, SLOP_STR("false")))))) {
                                                                                    {
                                                                                        ...
                                                                                        if ((type_idx < num_types)) {
                                                                                            __auto_type _mv_323 = ({ __auto_type _lst = payload_types; size_t _idx = (size_t)type_idx; slop_option_types_ResolvedType_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                                                            if (_mv_323.has_value) {
                                                                                                __auto_type pt = _mv_323.value;
    ...
    SLOP_PRE(((env != NULL)), "(!= env nil)");
    {
        ...
        while ((i < len)) {
            ...
            if (_mv_324.has_value) {
                __auto_type clause = _mv_324.value;
                __auto_type _mv_325 = (*clause);
                switch (_mv_325.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type clause_lst = _mv_325.data.lst;
                        {
                            __auto_type clause_items = clause_lst.items;
                            __auto_type clause_len = ((int64_t)((clause_items).len));
                            if ((clause_len > 1)) {
                                env_env_push_scope(env);
                                __auto_type _mv_326 = ({ __auto_type _lst = clause_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                ...
                                for (int64_t bi = 1; bi < (clause_len - 1); bi++) {
                                    __auto_type _mv_327 = ({ __auto_type _lst = clause_items; size_t _idx = (size_t)bi; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                ...
                                __auto_type _mv_328 = ({ __auto_type _lst = clause_items; size_t _idx = (size_t)(clause_len - 1); slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void infer_check_return_type(env_TypeEnv* env, types_SExpr* fn_form, slop_string fn_name, types_ResolvedType* inferred_type, int64_t fn_line, int64_t fn_col) {
    ...
    __auto_type _mv_329 = (*fn_form);
    switch (_mv_329.tag) {
        case types_SExpr_lst:
        {
            __auto_type fn_lst = _mv_329.data.lst;
            {
                __auto_type items = fn_lst.items;
                __auto_type len = ((int64_t)((items).len));
                for (int64_t i = 3; i < len; i++) {
                    __auto_type _mv_330 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_330.has_value) {
                        __auto_type item = _mv_330.value;
...
void infer_check_spec_return_type(env_TypeEnv* env, types_SExpr* spec_form, slop_string fn_name, types_ResolvedType* inferred_type, int64_t fn_line, int64_t fn_col) {
    ...
    __auto_type _mv_331 = (*spec_form);
    switch (_mv_331.tag) {
        case types_SExpr_lst:
        {
            __auto_type spec_lst = _mv_331.data.lst;
            {
                __auto_type spec_items = spec_lst.items;
                __auto_type _mv_332 = ({ __auto_type _lst = spec_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_332.has_value) {
                    __auto_type spec_body = _mv_332.value;
...
void infer_check_spec_body_return(env_TypeEnv* env, types_SExpr* spec_body, slop_string fn_name, types_ResolvedType* inferred_type, int64_t fn_line, int64_t fn_col) {
    ...
    __auto_type _mv_333 = (*spec_body);
    switch (_mv_333.tag) {
        case types_SExpr_lst:
        {
            __auto_type body_lst = _mv_333.data.lst;
            {
                __auto_type body_items = body_lst.items;
                __auto_type body_len = ((int64_t)((body_items).len));
                __auto_type _mv_334 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)(body_len - 1); slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_334.has_value) {
                    __auto_type ret_expr = _mv_334.value;
...
void infer_check_return_expr(env_TypeEnv* env, types_SExpr* ret_expr, slop_string fn_name, types_ResolvedType* inferred_type, int64_t fn_line, int64_t fn_col) {
    ...
    __auto_type _mv_335 = (*ret_expr);
    switch (_mv_335.tag) {
        case types_SExpr_sym:
        {
            __auto_type ret_sym = _mv_335.data.sym;
            {
...
void infer_bind_param_from_form(env_TypeEnv* env, types_SExpr* param_form) {
    ...
    if ((parser_sexpr_is_list(param_form) && (parser_sexpr_list_len(param_form) >= 2))) {
        __auto_type _mv_336 = parser_sexpr_list_get(param_form, 0);
        if (_mv_336.has_value) {
            __auto_type first_expr = _mv_336.value;
            {
                ...
                if (((string_eq(first_name, SLOP_STR("in"))) || (string_eq(first_name, SLOP_STR("out"))) || (string_eq(first_name, SLOP_STR("mut"))))) {
                    if ((parser_sexpr_list_len(param_form) >= 3)) {
                        __auto_type _mv_337 = parser_sexpr_list_get(param_form, 1);
                        if (_mv_337.has_value) {
                            __auto_type name_expr = _mv_337.value;
                            {
...
types_ResolvedType* infer_get_param_type_from_form(env_TypeEnv* env, types_SExpr* param_form) {
    ...
    SLOP_PRE(((param_form != NULL)), "(!= param-form nil)");
    {
        ...
        __auto_type _mv_338 = parser_sexpr_list_get(param_form, type_pos);
            ...
            if (string_eq(head_name, SLOP_STR("Option"))) {
            ...
            } else if (string_eq(head_name, SLOP_STR("Map"))) {
                {
                    ...
                    if ((parser_sexpr_list_len(type_expr) >= 3)) {
                        __auto_type _mv_340 = parser_sexpr_list_get(type_expr, 2);
            ...
            } else if (string_eq(head_name, SLOP_STR("Result"))) {
                {
                    ...
                    if ((parser_sexpr_list_len(type_expr) >= 2)) {
                        __auto_type _mv_341 = parser_sexpr_list_get(type_expr, 1);
                        if (_mv_341.has_value) {
                            __auto_type ok_expr = _mv_341.value;
                            {
                    ...
                    if ((parser_sexpr_list_len(type_expr) >= 3)) {
                        ...
                        if (_mv_342.has_value) {
                            __auto_type err_expr = _mv_342.value;
                            {
                ...
                __auto_type _mv_343 = env_env_lookup_type(env, head_name);
                if (_mv_343.has_value) {
                    __auto_type t = _mv_343.value;
                    return t;
...
types_ResolvedType* infer_resolve_option_inner_type(env_TypeEnv* env, types_SExpr* type_expr) {
    ...
    if ((parser_sexpr_list_len(type_expr) < 2)) {
        ...
        __auto_type _mv_344 = parser_sexpr_list_get(type_expr, 1);
        if (_mv_344.has_value) {
            __auto_type inner_expr = _mv_344.value;
            {
...
types_ResolvedType* infer_resolve_ptr_inner_type(env_TypeEnv* env, types_SExpr* type_expr) {
    ...
    if ((parser_sexpr_list_len(type_expr) < 2)) {
        ...
        __auto_type _mv_345 = parser_sexpr_list_get(type_expr, 1);
...
types_ResolvedType* infer_resolve_type_lenient(env_TypeEnv* env, slop_string type_name) {
    SLOP_PRE(((env != NULL)), "(!= env nil)");
    __auto_type _mv_346 = env_env_lookup_type(env, type_name);
    if (_mv_346.has_value) {
        __auto_type t = _mv_346.value;
        return t;
...
void infer_bind_let_binding(env_TypeEnv* env, types_SExpr* binding_form) {
    ...
    if ((parser_sexpr_is_list(binding_form) && (parser_sexpr_list_len(binding_form) >= 2))) {
        __auto_type _mv_348 = parser_sexpr_list_get(binding_form, 0);
        if (_mv_348.has_value) {
            __auto_type first_expr = _mv_348.value;
            {
                __auto_type first_name = parser_sexpr_get_symbol_name(first_expr);
                if (string_eq(first_name, SLOP_STR("mut"))) {
                    if ((parser_sexpr_list_len(binding_form) >= 3)) {
                        __auto_type _mv_349 = parser_sexpr_list_get(binding_form, 1);
                        if (_mv_349.has_value) {
                            __auto_type name_expr = _mv_349.value;
                            {
                                __auto_type var_name = parser_sexpr_get_symbol_name(name_expr);
                                if (!(string_eq(var_name, SLOP_STR("")))) {
                                    {
                                        __auto_type binding_len = parser_sexpr_list_len(binding_form);
                                        __auto_type _mv_350 = parser_sexpr_list_get(binding_form, (binding_len - 1));
                    ...
                    if (!(string_eq(first_name, SLOP_STR("")))) {
                        {
                            __auto_type binding_len = parser_sexpr_list_len(binding_form);
                            if ((binding_len == 3)) {
                                __auto_type _mv_351 = parser_sexpr_list_get(binding_form, 2);
                                ...
                                __auto_type _mv_352 = parser_sexpr_list_get(binding_form, 1);
...
types_ResolvedType* infer_infer_let_expr(env_TypeEnv* env, types_SExpr* expr) {
    ...
    env_env_push_scope(env);
    if (parser_sexpr_is_list(expr)) {
        __auto_type _mv_353 = parser_sexpr_list_get(expr, 1);
        if (_mv_353.has_value) {
            __auto_type bindings_expr = _mv_353.value;
            if (parser_sexpr_is_list(bindings_expr)) {
                {
                    ...
                    for (int64_t i = 0; i < num_bindings; i++) {
                        __auto_type _mv_354 = parser_sexpr_list_get(bindings_expr, i);
                        if (_mv_354.has_value) {
                            __auto_type binding = _mv_354.value;
        ...
        if ((len < 2)) {
        ...
        } else {
            {
                ...
                if ((is_named && (len < 4))) {
                    ...
                    __auto_type _mv_355 = parser_sexpr_list_get(expr, size_idx);
                    if (_mv_355.has_value) {
                        __auto_type size_expr = _mv_355.value;
                        __auto_type _mv_356 = (*size_expr);
                        switch (_mv_356.tag) {
                            case types_SExpr_num:
                            {
                    ...
                    env_env_bind_var(env, arena_name, env_env_get_arena_type(env));
                    {
                        ...
                        for (int64_t i = body_start; i < len; i++) {
                            __auto_type _mv_357 = parser_sexpr_list_get(expr, i);
...
slop_string infer_get_fn_name(types_SExpr* fn_form) {
    ...
    if (!(parser_sexpr_is_list(fn_form))) {
        ...
        if ((parser_sexpr_list_len(fn_form) < 2)) {
            ...
            __auto_type _mv_358 = parser_sexpr_list_get(fn_form, 1);
            if (_mv_358.has_value) {
                __auto_type name_expr = _mv_358.value;
                {
...
slop_string infer_get_hole_prompt(slop_list_types_SExpr_ptr items, int64_t len) {
    if ((len < 3)) {
        ...
        __auto_type _mv_361 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        if (_mv_361.has_value) {
            __auto_type prompt_expr = _mv_361.value;
            __auto_type _mv_362 = (*prompt_expr);
            switch (_mv_362.tag) {
                case types_SExpr_str:
                {
                    __auto_type str = _mv_362.data.str;
                    return str.value;
                }
                default: {
                    return SLOP_STR("(no description)");
...
uint8_t infer_is_c_name_related(slop_list_types_SExpr_ptr items, int64_t idx) {
    __auto_type _mv_363 = ({ __auto_type _lst = items; size_t _idx = (size_t)idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    if (_mv_363.has_value) {
        __auto_type item = _mv_363.value;
        __auto_type _mv_364 = (*item);
        switch (_mv_364.tag) {
            case types_SExpr_sym:
            {
            ...
            case types_SExpr_str:
            {
                __auto_type _ = _mv_364.data.str;
                if ((idx > 0)) {
                    __auto_type _mv_365 = ({ __auto_type _lst = items; size_t _idx = (size_t)(idx - 1); slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_365.has_value) {
                        __auto_type prev = _mv_365.value;
                        __auto_type _mv_366 = (*prev);
                        switch (_mv_366.tag) {
                            case types_SExpr_sym:
                            {
...
uint8_t infer_is_annotation_expr(types_SExpr* expr) {
    SLOP_PRE(((expr != NULL)), "(!= expr nil)");
    if (parser_sexpr_is_list(expr)) {
        __auto_type _mv_367 = parser_sexpr_list_get(expr, 0);
        if (_mv_367.has_value) {
            __auto_type head = _mv_367.value;
            __auto_type _mv_368 = (*head);
            switch (_mv_368.tag) {
                case types_SExpr_sym:
                {
        ...
        if (parser_sexpr_is_list(fn_form)) {
            {
                ...
                if ((params_len > 2)) {
                    __auto_type _mv_369 = parser_sexpr_list_get(fn_form, 2);
                    if (_mv_369.has_value) {
                        __auto_type params_expr = _mv_369.value;
                        if (parser_sexpr_is_list(params_expr)) {
                            {
                                __auto_type num_params = parser_sexpr_list_len(params_expr);
                                for (int64_t k = 0; k < num_params; k++) {
                                    __auto_type _mv_370 = parser_sexpr_list_get(params_expr, k);
                                    if (_mv_370.has_value) {
                                        __auto_type param_form = _mv_370.value;
                                        infer_bind_param_from_form(env, param_form);
    ...
    if (types_resolved_type_is_union(scrutinee_type)) {
        {
            ...
            for (int64_t i = 0; i < num_patterns; i++) {
                __auto_type _mv_371 = ({ __auto_type _lst = patterns; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_371.has_value) {
                    __auto_type pattern_case = _mv_371.value;
                    __auto_type _mv_372 = (*pattern_case);
                    switch (_mv_372.tag) {
                        case types_SExpr_lst:
                        {
                            __auto_type pattern_list = _mv_372.data.lst;
                            if ((((int64_t)((pattern_list.items).len)) > 0)) {
                                __auto_type _mv_373 = ({ __auto_type _lst = pattern_list.items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_373.has_value) {
                                    __auto_type pattern_expr = _mv_373.value;
                                    __auto_type _mv_374 = (*pattern_expr);
                                    switch (_mv_374.tag) {
                                        case types_SExpr_lst:
                                        {
                                            __auto_type variant_list = _mv_374.data.lst;
                                            {
                                                __auto_type variant_items = variant_list.items;
                                                if ((((int64_t)((variant_items).len)) > 0)) {
                                                    __auto_type _mv_375 = ({ __auto_type _lst = variant_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_375.has_value) {
                                                        __auto_type variant_name_expr = _mv_375.value;
                                                        __auto_type _mv_376 = (*variant_name_expr);
                                                        switch (_mv_376.tag) {
                                                            case types_SExpr_sym:
                                                            {
                                                                __auto_type variant_sym = _mv_376.data.sym;
                                                                {
                                                                        ...
                                                                        if ((num_pt > 0)) {
                                                                            {
                                                                                ...
                                                                                for (int64_t vi = 1; vi < num_vt; vi++) {
                                                                                    __auto_type _mv_377 = ({ __auto_type _lst = variant_items; size_t _idx = (size_t)vi; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                                                    if (_mv_377.has_value) {
                                                                                        __auto_type binding_expr = _mv_377.value;
                                                                                        __auto_type _mv_378 = (*binding_expr);
                                                                                        switch (_mv_378.tag) {
                                                                                            case types_SExpr_sym:
                                                                                            {
                                                                                                __auto_type binding_sym = _mv_378.data.sym;
                                                                                                {
                                                                                                    __auto_type bname = binding_sym.name;
                                                                                                    __auto_type type_idx = (vi - 1);
                                                                                                    if ((!(string_eq(bname, SLOP_STR("_"))) && !(string_eq(bname, SLOP_STR(""))))) {
                                                                                                        if ((type_idx < num_pt)) {
                                                                                                            __auto_type _mv_379 = ({ __auto_type _lst = payload_types; size_t _idx = (size_t)type_idx; slop_option_types_ResolvedType_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                                                                            if (_mv_379.has_value) {
                                                                                                                __auto_type pt = _mv_379.value;
                                                                            ...
                                                                            __auto_type _mv_380 = types_resolved_type_get_variant_index(scrutinee_type, variant_name);
                                                                            if (_mv_380.has_value) {
                                                                                __auto_type _ = _mv_380.value;
