                                ...
                                if (_mv_233.has_value) {
                                    ...
                                    if (infer_string_contains_char(name, 46)) {
                                        ...
                                        if (_mv_236.has_value) {
                                            ...
                                            __auto_type _mv_237 = env_env_lookup_variant(env, name);
                                            if (_mv_237.has_value) {
                                                __auto_type enum_name = _mv_237.value;
                                                __auto_type _mv_238 = env_env_lookup_type(env, enum_name);
                                                if (_mv_238.has_value) {
                                                    __auto_type t = _mv_238.value;
                                                    return t;
        ...
        if (string_eq(op, SLOP_STR("if"))) {
            if (len >= 4) {
                ...
                if (_mv_242.has_value) {
                    __auto_type then_expr = _mv_242.value;
                    {
                        __auto_type then_type = infer_infer_expr(env, then_expr);
                        __auto_type _mv_243 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_243.has_value) {
                            __auto_type else_expr = _mv_243.value;
                            {
                                ...
                                if (_mv_246.has_value) {
                                    __auto_type var_expr = _mv_246.value;
                                    {
                                        ...
                                        if (!(string_eq(var_name, SLOP_STR("")))) {
                                            ...
                                            __auto_type _mv_247 = parser_sexpr_list_get(binding_form, 1);
                                            if (_mv_247.has_value) {
                                                __auto_type start_expr = _mv_247.value;
                                                {
                                                    __auto_type _ = infer_infer_expr(env, start_expr);
                                                }
                                            } else if (!_mv_247.has_value) {
                                            }
                                            __auto_type _mv_248 = parser_sexpr_list_get(binding_form, 2);
                                            if (_mv_248.has_value) {
                                                __auto_type end_expr = _mv_248.value;
                                                {
                                            ...
                                            for (int64_t body_idx = 2; body_idx < len; body_idx++) {
                                                __auto_type _mv_249 = ({ __auto_type _lst = items; size_t _idx = (size_t)body_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_249.has_value) {
                                                    __auto_type body_expr = _mv_249.value;
                                                    {
                                ...
                                if (_mv_251.has_value) {
                                    __auto_type var_expr = _mv_251.value;
                                    {
                                        ...
                                        if (string_eq(var_name, SLOP_STR(""))) {
                                            ...
                                            __auto_type _mv_252 = parser_sexpr_list_get(binding_form, 1);
                                            if (_mv_252.has_value) {
                                                __auto_type coll_expr = _mv_252.value;
                                                {
                                                    ...
                                                    __auto_type coll_col = parser_sexpr_col(coll_expr);
                                                    {
                                                        ...
                                                        for (int64_t body_idx = 2; body_idx < len; body_idx++) {
                                                            __auto_type _mv_253 = ({ __auto_type _lst = items; size_t _idx = (size_t)body_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    ...
                    if (parser_sexpr_is_list(params_expr)) {
                        {
                            ...
                            for (int64_t k = 0; k < num_params; k++) {
                                __auto_type _mv_255 = parser_sexpr_list_get(params_expr, k);
                                if (_mv_255.has_value) {
                                    __auto_type param_form = _mv_255.value;
                ...
                if (_mv_259.has_value) {
                    __auto_type ptr_expr = _mv_259.value;
                    {
                        ...
                        if (types_resolved_type_is_pointer(ptr_type)) {
                            __auto_type _mv_260 = (*ptr_type).inner_type;
                            if (_mv_260.has_value) {
                                __auto_type inner = _mv_260.value;
                                return inner;
                    ...
                    __auto_type type_expr = _mv_262.value;
                    {
                        ...
                        if (string_eq(type_name, SLOP_STR(""))) {
                            if (parser_sexpr_is_list(type_expr)) {
                                __auto_type _mv_263 = parser_sexpr_list_get(type_expr, 0);
                                if (_mv_263.has_value) {
                                    __auto_type head_expr = _mv_263.value;
                                    {
                            ...
                            __auto_type _mv_264 = env_env_lookup_type(env, type_name);
                ...
                if (_mv_265.has_value) {
                    __auto_type variant_expr = _mv_265.value;
                    {
                        ...
                        if (string_eq(variant_name, SLOP_STR(""))) {
                            ...
                            __auto_type _mv_266 = env_env_lookup_variant(env, variant_name);
                            if (_mv_266.has_value) {
                                ...
                                if (_mv_267.has_value) {
                                    __auto_type enum_type = _mv_267.value;
                                    return enum_type;
            ...
            if (_mv_276.has_value) {
                ...
                __auto_type _mv_277 = env_env_lookup_type(env, op);
                if (_mv_277.has_value) {
                    __auto_type the_type = _mv_277.value;
                    return the_type;
                    ...
                    if (string_eq(op, SLOP_STR("list-get"))) {
                        ...
                        if (len < 3) {
                            ...
                            if (_mv_280.has_value) {
                                __auto_type type_expr = _mv_280.value;
                                {
                                    ...
                                    if (string_eq(type_name, SLOP_STR(""))) {
                                        if (parser_sexpr_is_list(type_expr)) {
                                            __auto_type _mv_281 = parser_sexpr_list_get(type_expr, 0);
                                            if (_mv_281.has_value) {
                                                __auto_type head_expr = _mv_281.value;
                                                if (string_eq(parser_sexpr_get_symbol_name(head_expr), SLOP_STR("sizeof"))) {
                                                    __auto_type _mv_282 = parser_sexpr_list_get(type_expr, 1);
                                                    if (_mv_282.has_value) {
                                                        __auto_type sizeof_type_expr = _mv_282.value;
                                                        {
                                                            __auto_type sizeof_type_name = parser_sexpr_get_symbol_name(sizeof_type_expr);
                                                            if (string_eq(sizeof_type_name, SLOP_STR(""))) {
                                                                return env_env_get_int_type(env);
                                                            } else {
                                                                __auto_type _mv_283 = env_env_lookup_type(env, sizeof_type_name);
                                                                if (_mv_283.has_value) {
                                                                    __auto_type resolved = _mv_283.value;
                                        ...
                                        if (_mv_284.has_value) {
                                            __auto_type resolved = _mv_284.value;
                                            return env_env_make_ptr_type(env, resolved);
                            ...
                            if (len >= 2) {
                                ...
                                if (_mv_294.has_value) {
                                    __auto_type map_expr = _mv_294.value;
                                    {
                                        ...
                                        __auto_type _mv_295 = (*map_type).inner_type2;
                        ...
                        infer_check_builtin_args(env, SLOP_STR("map-keys"), 1, (len - 1), line, col);
                        {
                            ...
                            if (len >= 2) {
                                ...
                                if (_mv_297.has_value) {
                                    ...
                                    {
                                        __auto_type map_type = infer_infer_expr(env, map_expr);
                                        __auto_type _mv_298 = (*map_type).inner_type;
                                        if (_mv_298.has_value) {
                                            __auto_type inner = _mv_298.value;
                                            key_type = inner;
                            ...
                            if (len >= 3) {
                                ...
                                if (_mv_299.has_value) {
                                    __auto_type type_expr = _mv_299.value;
                                    {
                                        __auto_type type_name = parser_sexpr_get_symbol_name(type_expr);
                                        if (!(string_eq(type_name, SLOP_STR("")))) {
                                            __auto_type _mv_300 = env_env_lookup_type(env, type_name);
                                            if (_mv_300.has_value) {
                                                __auto_type t = _mv_300.value;
                                                elem_type = t;
                            ...
                            if (len >= 2) {
                                ...
                                if (_mv_301.has_value) {
                                    __auto_type set_expr = _mv_301.value;
                                    {
                                        ...
                                        __auto_type _mv_302 = (*set_type).inner_type;
                                        if (_mv_302.has_value) {
                                            __auto_type inner = _mv_302.value;
                                            elem_type = inner;
                        ...
                        {
                            __auto_type arena = env_env_arena(env);
                            __auto_type _mv_303 = env_env_lookup_variant(env, op);
                            if (_mv_303.has_value) {
                                __auto_type parent_type = _mv_303.value;
                                {
                                ...
                                if (strlib_starts_with(op, SLOP_STR("set-")) || (strlib_starts_with(op, SLOP_STR("map-")) || (strlib_starts_with(op, SLOP_STR("list-")) || strlib_starts_with(op, SLOP_STR("arena-"))))) {
                                    ...
                                    __auto_type _mv_304 = env_env_lookup_var(env, op);
                                    if (_mv_304.has_value) {
                                        __auto_type var_type = _mv_304.value;
                                        infer_infer_builtin_args(env, expr);
                                        return var_type;
...
void infer_check_single_arg(env_TypeEnv* env, types_FnSignature* sig, types_SExpr* expr, int64_t arg_idx, int64_t line, int64_t col) {
    ...
    SLOP_PRE(((sig != NULL)), "(!= sig nil)");
    {
        ...
        __auto_type fn_name = (*sig).name;
        __auto_type arena = env_env_arena(env);
        __auto_type _mv_305 = ({ __auto_type _lst = params; size_t _idx = (size_t)arg_idx; slop_option_types_ParamInfo _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        if (_mv_305.has_value) {
            __auto_type param_info = _mv_305.value;
            {
                __auto_type expected_type = param_info.param_type;
                __auto_type _mv_306 = parser_sexpr_list_get(expr, (arg_idx + 1));
                if (_mv_306.has_value) {
                    __auto_type arg_expr = _mv_306.value;
                    {
                        __auto_type actual_type = infer_infer_expr(env, arg_expr);
    ...
    if (parser_sexpr_is_list(expr)) {
        {
            ...
            for (int64_t i = 1; i < len; i++) {
                __auto_type _mv_308 = parser_sexpr_list_get(expr, i);
                if (_mv_308.has_value) {
                    __auto_type arg_expr = _mv_308.value;
                    {
    ...
    if (parser_sexpr_is_list(expr)) {
        {
            ...
            for (int64_t i = start_idx; i < len; i++) {
                __auto_type _mv_309 = parser_sexpr_list_get(expr, i);
                if (_mv_309.has_value) {
                    __auto_type body_expr = _mv_309.value;
                    {
                        __auto_type _ = infer_infer_expr(env, body_expr);
                    }
    ...
    SLOP_PRE(((env != NULL)), "(!= env nil)");
    {
        ...
        if (len < 3) {
            ...
            if (!_mv_310.has_value) {
                ...
                __auto_type obj_expr = _mv_310.value;
                {
                    ...
                    if (!_mv_311.has_value) {
                        ...
                        __auto_type field_expr = _mv_311.value;
                        __auto_type _mv_312 = (*field_expr);
                        switch (_mv_312.tag) {
                            case types_SExpr_sym:
                            {
                                __auto_type field_sym = _mv_312.data.sym;
                                {
    ...
    SLOP_PRE(((obj_type != NULL)), "(!= obj-type nil)");
    {
        ...
        if (infer_type_is_null_pointer(obj_type)) {
            ...
            if (types_resolved_type_is_record(obj_type)) {
                __auto_type _mv_313 = types_resolved_type_get_field_type(obj_type, field_name);
                if (_mv_313.has_value) {
                    __auto_type field_type = _mv_313.value;
                    return field_type;
                    ...
                    if (string_eq(type_name, SLOP_STR("String"))) {
                        ...
                        if (string_eq(type_name, SLOP_STR("Unknown"))) {
                            ...
                            if (types_resolved_type_is_pointer(obj_type)) {
                                __auto_type _mv_314 = (*obj_type).inner_type;
                                if (_mv_314.has_value) {
                                    __auto_type inner_type = _mv_314.value;
...
types_ResolvedType* infer_infer_cond_expr(env_TypeEnv* env, types_SExpr* expr, types_SExprList lst) {
    SLOP_PRE(((env != NULL)), "(!= env nil)");
    {
        ...
        int64_t i = 1;
        while (i < len) {
            __auto_type _mv_315 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_315.has_value) {
                __auto_type clause = _mv_315.value;
                __auto_type _mv_316 = (*clause);
                switch (_mv_316.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type clause_lst = _mv_316.data.lst;
                        {
                            ...
                            if (clause_len > 1) {
                                for (int64_t ci = 0; ci < (clause_len - 1); ci++) {
                                    __auto_type _mv_317 = ({ __auto_type _lst = clause_items; size_t _idx = (size_t)ci; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    if (_mv_317.has_value) {
                                        __auto_type clause_elem = _mv_317.value;
                                        {
                                ...
                                __auto_type _mv_318 = ({ __auto_type _lst = clause_items; size_t _idx = (size_t)(clause_len - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_318.has_value) {
                                    __auto_type body = _mv_318.value;
                                    {
...
void infer_bind_match_pattern(env_TypeEnv* env, types_ResolvedType* scrutinee_type, types_SExpr* pattern) {
    ...
    if (parser_sexpr_is_list(pattern)) {
        if (parser_sexpr_list_len(pattern) > 0) {
            __auto_type _mv_319 = parser_sexpr_list_get(pattern, 0);
            if (_mv_319.has_value) {
                __auto_type variant_expr = _mv_319.value;
                {
                    __auto_type variant_name = parser_sexpr_get_symbol_name(variant_expr);
                    if (!(string_eq(variant_name, SLOP_STR("")))) {
                        if (parser_sexpr_list_len(pattern) > 1) {
                            __auto_type _mv_320 = parser_sexpr_list_get(pattern, 1);
                            if (_mv_320.has_value) {
                                __auto_type binding_expr = _mv_320.value;
                                {
                                                ...
                                                if ((scrutinee_kind == types_ResolvedTypeKind_rk_option) && string_eq(variant_name, SLOP_STR("some"))) {
                                                    ...
                                                    if (scrutinee_kind == types_ResolvedTypeKind_rk_result) {
                                                        if (string_eq(variant_name, SLOP_STR("ok"))) {
                                                            __auto_type _mv_322 = (*scrutinee_type).inner_type;
                                                            ...
                                                            __auto_type _mv_323 = (*scrutinee_type).inner_type2;
                                                            if (_mv_323.has_value) {
                                                                __auto_type inner2 = _mv_323.value;
                                                    ...
                                                    } else {
                                                        {
                                                            ...
                                                            if (((int64_t)((payload_types).len)) > 0) {
                                                                if (!(string_eq(binding_name, SLOP_STR("true"))) && !(string_eq(binding_name, SLOP_STR("false")))) {
                                                                    __auto_type _mv_324 = ({ __auto_type _lst = payload_types; size_t _idx = (size_t)0; slop_option_types_ResolvedType_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                                    if (_mv_324.has_value) {
                                                                        __auto_type first_type = _mv_324.value;
                                                                ...
                                                                }
                                                                {
                                                                    ...
                                                                    for (int64_t pi = 2; pi < pat_len; pi++) {
                                                                        __auto_type _mv_325 = parser_sexpr_list_get(pattern, pi);
                                                                        if (_mv_325.has_value) {
                                                                            __auto_type extra_binding = _mv_325.value;
                                                                            {
                                                                                ...
                                                                                if ((!(string_eq(extra_name, SLOP_STR("")))) && (!(string_eq(extra_name, SLOP_STR("_")))) && (!(string_eq(extra_name, SLOP_STR("true")))) && (!(string_eq(extra_name, SLOP_STR("false"))))) {
                                                                                    {
                                                                                        ...
                                                                                        if (type_idx < num_types) {
                                                                                            __auto_type _mv_326 = ({ __auto_type _lst = payload_types; size_t _idx = (size_t)type_idx; slop_option_types_ResolvedType_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                                                            if (_mv_326.has_value) {
                                                                                                __auto_type pt = _mv_326.value;
...
slop_string infer_match_pattern_head(types_SExpr* pattern) {
    ...
    if (parser_sexpr_is_list(pattern)) {
        if (parser_sexpr_list_len(pattern) > 0) {
            __auto_type _mv_327 = parser_sexpr_list_get(pattern, 0);
...
uint8_t infer_string_list_contains(slop_list_string names, slop_string name) {
    {
        ...
        uint8_t found = 0;
        while ((i < n) && !(found)) {
            __auto_type _mv_328 = ({ __auto_type _lst = names; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_328.has_value) {
                __auto_type existing = _mv_328.value;
        ...
        if ((kind == types_ResolvedTypeKind_rk_union) || (kind == types_ResolvedTypeKind_rk_enum)) {
            {
                ...
                int64_t i = 0;
                while (i < n) {
                    __auto_type _mv_329 = ({ __auto_type _lst = variants; size_t _idx = (size_t)i; slop_option_types_ResolvedVariant _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_329.has_value) {
                        __auto_type v = _mv_329.value;
            ...
            if ((((int64_t)((expected).len)) > 0) && !(string_eq(type_name, SLOP_STR("T")))) {
                {
                    ...
                    while (i < n) {
                        __auto_type _mv_330 = ({ __auto_type _lst = covered; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    ...
                    if (all_known) {
                        {
                            ...
                            int64_t j = 0;
                            while (j < e_len) {
                                __auto_type _mv_331 = ({ __auto_type _lst = expected; size_t _idx = (size_t)j; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_331.has_value) {
                                    __auto_type want = _mv_331.value;
    ...
    SLOP_PRE(((env != NULL)), "(!= env nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_332.has_value) {
                __auto_type clause = _mv_332.value;
                __auto_type _mv_333 = (*clause);
                switch (_mv_333.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type clause_lst = _mv_333.data.lst;
                        {
                            __auto_type clause_items = clause_lst.items;
                            __auto_type clause_len = ((int64_t)((clause_items).len));
                            if (clause_len > 0) {
                            ...
                            if (clause_len > 1) {
                                env_env_push_scope(env);
                                __auto_type _mv_335 = ({ __auto_type _lst = clause_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                ...
                                for (int64_t bi = 1; bi < (clause_len - 1); bi++) {
                                    __auto_type _mv_336 = ({ __auto_type _lst = clause_items; size_t _idx = (size_t)bi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                ...
                                __auto_type _mv_337 = ({ __auto_type _lst = clause_items; size_t _idx = (size_t)(clause_len - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_337.has_value) {
                                    __auto_type body = _mv_337.value;
                                    {
                                        __auto_type body_type = infer_infer_expr(env, body);
                                        if (!(has_result)) {
                                            result_type = body_type;
...
void infer_check_return_type(env_TypeEnv* env, types_SExpr* fn_form, slop_string fn_name, types_ResolvedType* inferred_type, int64_t fn_line, int64_t fn_col) {
    ...
    __auto_type _mv_338 = (*fn_form);
    switch (_mv_338.tag) {
        case types_SExpr_lst:
        {
            __auto_type fn_lst = _mv_338.data.lst;
            {
                ...
                for (int64_t i = 3; i < len; i++) {
                    ...
                    if (_mv_339.has_value) {
                        __auto_type item = _mv_339.value;
...
void infer_check_spec_return_type(env_TypeEnv* env, types_SExpr* spec_form, slop_string fn_name, types_ResolvedType* inferred_type, int64_t fn_line, int64_t fn_col) {
    ...
    __auto_type _mv_340 = (*spec_form);
    switch (_mv_340.tag) {
        case types_SExpr_lst:
        {
            __auto_type spec_lst = _mv_340.data.lst;
            {
                __auto_type spec_items = spec_lst.items;
                __auto_type _mv_341 = ({ __auto_type _lst = spec_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_341.has_value) {
                    __auto_type spec_body = _mv_341.value;
...
void infer_check_spec_body_return(env_TypeEnv* env, types_SExpr* spec_body, slop_string fn_name, types_ResolvedType* inferred_type, int64_t fn_line, int64_t fn_col) {
    ...
    __auto_type _mv_342 = (*spec_body);
    switch (_mv_342.tag) {
        case types_SExpr_lst:
        {
            __auto_type body_lst = _mv_342.data.lst;
            {
                __auto_type body_items = body_lst.items;
                __auto_type body_len = ((int64_t)((body_items).len));
                __auto_type _mv_343 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)(body_len - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_343.has_value) {
                    __auto_type ret_expr = _mv_343.value;
...
void infer_check_return_expr(env_TypeEnv* env, types_SExpr* ret_expr, slop_string fn_name, types_ResolvedType* inferred_type, int64_t fn_line, int64_t fn_col) {
    ...
    __auto_type _mv_344 = (*ret_expr);
    switch (_mv_344.tag) {
        case types_SExpr_sym:
        {
            __auto_type ret_sym = _mv_344.data.sym;
            {
...
void infer_bind_param_from_form(env_TypeEnv* env, types_SExpr* param_form) {
    ...
    if (parser_sexpr_is_list(param_form) && (parser_sexpr_list_len(param_form) >= 2)) {
        __auto_type _mv_345 = parser_sexpr_list_get(param_form, 0);
        if (_mv_345.has_value) {
            __auto_type first_expr = _mv_345.value;
            {
                ...
                if ((string_eq(first_name, SLOP_STR("in"))) || (string_eq(first_name, SLOP_STR("out"))) || (string_eq(first_name, SLOP_STR("mut")))) {
                    if (parser_sexpr_list_len(param_form) >= 3) {
                        __auto_type _mv_346 = parser_sexpr_list_get(param_form, 1);
                        if (_mv_346.has_value) {
                            __auto_type name_expr = _mv_346.value;
                            {
...
types_ResolvedType* infer_get_param_type_from_form(env_TypeEnv* env, types_SExpr* param_form) {
    ...
    SLOP_PRE(((param_form != NULL)), "(!= param-form nil)");
    {
        ...
        __auto_type _mv_347 = parser_sexpr_list_get(param_form, type_pos);
        if (_mv_347.has_value) {
            __auto_type type_expr = _mv_347.value;
            {
                __auto_type type_name = parser_sexpr_get_symbol_name(type_expr);
                if (string_eq(type_name, SLOP_STR(""))) {
                    if (parser_sexpr_is_list(type_expr)) {
...
types_ResolvedType* infer_resolve_complex_type_expr(env_TypeEnv* env, types_SExpr* type_expr) {
    ...
    __auto_type _mv_348 = parser_sexpr_list_get(type_expr, 0);
    if (_mv_348.has_value) {
        __auto_type head_expr = _mv_348.value;
        {
            __auto_type head_name = parser_sexpr_get_symbol_name(head_expr);
            if (string_eq(head_name, SLOP_STR("Option"))) {
            ...
            } else if (string_eq(head_name, SLOP_STR("Map"))) {
                {
                    ...
                    if (parser_sexpr_list_len(type_expr) >= 3) {
                        __auto_type _mv_349 = parser_sexpr_list_get(type_expr, 2);
            ...
            } else if (string_eq(head_name, SLOP_STR("Result"))) {
                {
                    ...
                    if (parser_sexpr_list_len(type_expr) >= 2) {
                        __auto_type _mv_350 = parser_sexpr_list_get(type_expr, 1);
                        if (_mv_350.has_value) {
                            __auto_type ok_expr = _mv_350.value;
                            {
                    ...
                    if (parser_sexpr_list_len(type_expr) >= 3) {
                        __auto_type _mv_351 = parser_sexpr_list_get(type_expr, 2);
                        if (_mv_351.has_value) {
                            __auto_type err_expr = _mv_351.value;
                            {
                ...
                __auto_type _mv_352 = env_env_lookup_type(env, head_name);
...
types_ResolvedType* infer_resolve_ptr_inner_type(env_TypeEnv* env, types_SExpr* type_expr) {
    ...
    if (parser_sexpr_list_len(type_expr) < 2) {
        ...
        __auto_type _mv_354 = parser_sexpr_list_get(type_expr, 1);
        if (_mv_354.has_value) {
            __auto_type inner_expr = _mv_354.value;
            {
                __auto_type inner_name = parser_sexpr_get_symbol_name(inner_expr);
                if (string_eq(inner_name, SLOP_STR(""))) {
...
void infer_bind_let_binding(env_TypeEnv* env, types_SExpr* binding_form) {
    ...
    if (parser_sexpr_is_list(binding_form) && (parser_sexpr_list_len(binding_form) >= 2)) {
        __auto_type _mv_357 = parser_sexpr_list_get(binding_form, 0);
        if (_mv_357.has_value) {
            __auto_type first_expr = _mv_357.value;
            {
                __auto_type first_name = parser_sexpr_get_symbol_name(first_expr);
                if (string_eq(first_name, SLOP_STR("mut"))) {
                    if (parser_sexpr_list_len(binding_form) >= 3) {
                        __auto_type _mv_358 = parser_sexpr_list_get(binding_form, 1);
                                ...
                                if (!(string_eq(var_name, SLOP_STR("")))) {
                                    {
                                        ...
                                        __auto_type _mv_359 = parser_sexpr_list_get(binding_form, (binding_len - 1));
                    ...
                    if (!(string_eq(first_name, SLOP_STR("")))) {
                        {
                            __auto_type binding_len = parser_sexpr_list_len(binding_form);
                            if (binding_len == 3) {
                                __auto_type _mv_360 = parser_sexpr_list_get(binding_form, 2);
                                ...
                                __auto_type _mv_361 = parser_sexpr_list_get(binding_form, 1);
                                if (_mv_361.has_value) {
                                    __auto_type val_expr = _mv_361.value;
                                    {
                                        __auto_type val_type = infer_infer_expr(env, val_expr);
                                        env_env_bind_var(env, first_name, val_type);
                                    }
...
types_ResolvedType* infer_infer_let_expr(env_TypeEnv* env, types_SExpr* expr) {
    ...
    env_env_push_scope(env);
    if (parser_sexpr_is_list(expr)) {
        __auto_type _mv_362 = parser_sexpr_list_get(expr, 1);
        if (_mv_362.has_value) {
            __auto_type bindings_expr = _mv_362.value;
            if (parser_sexpr_is_list(bindings_expr)) {
                {
                    ...
                    for (int64_t i = 0; i < num_bindings; i++) {
                        __auto_type _mv_363 = parser_sexpr_list_get(bindings_expr, i);
                        if (_mv_363.has_value) {
                            __auto_type binding = _mv_363.value;
        ...
        if (len < 2) {
        ...
        } else {
            {
                ...
                if (is_named && (len < 4)) {
                    ...
                    __auto_type _mv_364 = parser_sexpr_list_get(expr, size_idx);
                    if (_mv_364.has_value) {
                        __auto_type size_expr = _mv_364.value;
                        __auto_type _mv_365 = (*size_expr);
                        switch (_mv_365.tag) {
                            case types_SExpr_num:
                            {
                                __auto_type num = _mv_365.data.num;
                                if (num.int_value <= 0) {
                    ...
                    env_env_bind_var(env, arena_name, env_env_get_arena_type(env));
                    {
                        ...
                        for (int64_t i = body_start; i < len; i++) {
                            __auto_type _mv_366 = parser_sexpr_list_get(expr, i);
...
slop_string infer_get_fn_name(types_SExpr* fn_form) {
    ...
    if (!(parser_sexpr_is_list(fn_form))) {
        ...
        if (parser_sexpr_list_len(fn_form) < 2) {
            ...
            __auto_type _mv_367 = parser_sexpr_list_get(fn_form, 1);
            if (_mv_367.has_value) {
                __auto_type name_expr = _mv_367.value;
                {
        ...
        if (_mv_368.has_value) {
            __auto_type type_expr = _mv_368.value;
            {
                ...
                if (string_eq(type_name, SLOP_STR(""))) {
                    ...
                    __auto_type _mv_369 = env_env_lookup_type(env, type_name);
                    if (_mv_369.has_value) {
                        __auto_type t = _mv_369.value;
                        return t;
...
slop_string infer_get_hole_prompt(slop_list_types_SExpr_ptr items, int64_t len) {
    if (len < 3) {
        ...
        if (_mv_370.has_value) {
            __auto_type prompt_expr = _mv_370.value;
            __auto_type _mv_371 = (*prompt_expr);
            switch (_mv_371.tag) {
                case types_SExpr_str:
                {
                    __auto_type str = _mv_371.data.str;
                    return str.value;
                }
                default: {
                    return SLOP_STR("(no description)");
...
uint8_t infer_is_c_name_related(slop_list_types_SExpr_ptr items, int64_t idx) {
    __auto_type _mv_372 = ({ __auto_type _lst = items; size_t _idx = (size_t)idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    if (_mv_372.has_value) {
        __auto_type item = _mv_372.value;
        __auto_type _mv_373 = (*item);
        switch (_mv_373.tag) {
            case types_SExpr_sym:
            {
            ...
            case types_SExpr_str:
            {
                __auto_type _ = _mv_373.data.str;
                if (idx > 0) {
                    __auto_type _mv_374 = ({ __auto_type _lst = items; size_t _idx = (size_t)(idx - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_374.has_value) {
                        __auto_type prev = _mv_374.value;
                        __auto_type _mv_375 = (*prev);
                        switch (_mv_375.tag) {
                            case types_SExpr_sym:
                            {
...
uint8_t infer_is_annotation_expr(types_SExpr* expr) {
    SLOP_PRE(((expr != NULL)), "(!= expr nil)");
    if (parser_sexpr_is_list(expr)) {
        __auto_type _mv_376 = parser_sexpr_list_get(expr, 0);
...
uint8_t infer_is_checkable_annotation(types_SExpr* expr) {
    if (parser_sexpr_is_list(expr)) {
        __auto_type _mv_378 = parser_sexpr_list_get(expr, 0);
        if (_mv_378.has_value) {
            __auto_type head = _mv_378.value;
            __auto_type _mv_379 = (*head);
            switch (_mv_379.tag) {
                case types_SExpr_sym:
                {
        ...
        if (parser_sexpr_is_list(fn_form)) {
            {
                ...
                if (params_len > 2) {
                    __auto_type _mv_380 = parser_sexpr_list_get(fn_form, 2);
                    if (_mv_380.has_value) {
                        __auto_type params_expr = _mv_380.value;
                        if (parser_sexpr_is_list(params_expr)) {
                            {
                                __auto_type num_params = parser_sexpr_list_len(params_expr);
                                for (int64_t k = 0; k < num_params; k++) {
                                    __auto_type _mv_381 = parser_sexpr_list_get(params_expr, k);
                                    if (_mv_381.has_value) {
                                        __auto_type param_form = _mv_381.value;
                                        infer_bind_param_from_form(env, param_form);
    ...
    if (types_resolved_type_is_union(scrutinee_type)) {
        {
            ...
            for (int64_t i = 0; i < num_patterns; i++) {
                __auto_type _mv_382 = ({ __auto_type _lst = patterns; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_382.has_value) {
                    __auto_type pattern_case = _mv_382.value;
                    __auto_type _mv_383 = (*pattern_case);
                    switch (_mv_383.tag) {
                        case types_SExpr_lst:
                        {
                            __auto_type pattern_list = _mv_383.data.lst;
                            if (((int64_t)((pattern_list.items).len)) > 0) {
                                __auto_type _mv_384 = ({ __auto_type _lst = pattern_list.items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_384.has_value) {
                                    __auto_type pattern_expr = _mv_384.value;
                                    __auto_type _mv_385 = (*pattern_expr);
                                    switch (_mv_385.tag) {
                                        case types_SExpr_lst:
                                        {
                                            __auto_type variant_list = _mv_385.data.lst;
                                            {
                                                __auto_type variant_items = variant_list.items;
                                                if (((int64_t)((variant_items).len)) > 0) {
                                                    __auto_type _mv_386 = ({ __auto_type _lst = variant_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_386.has_value) {
                                                        __auto_type variant_name_expr = _mv_386.value;
                                                        __auto_type _mv_387 = (*variant_name_expr);
                                                        switch (_mv_387.tag) {
                                                            case types_SExpr_sym:
                                                            {
                                                                __auto_type variant_sym = _mv_387.data.sym;
                                                                {
                                                                        ...
                                                                        if (num_pt > 0) {
                                                                            {
                                                                                ...
                                                                                for (int64_t vi = 1; vi < num_vt; vi++) {
                                                                                    __auto_type _mv_388 = ({ __auto_type _lst = variant_items; size_t _idx = (size_t)vi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                                                    if (_mv_388.has_value) {
                                                                                        __auto_type binding_expr = _mv_388.value;
                                                                                        __auto_type _mv_389 = (*binding_expr);
                                                                                        switch (_mv_389.tag) {
                                                                                            case types_SExpr_sym:
                                                                                            {
                                                                                                __auto_type binding_sym = _mv_389.data.sym;
                                                                                                {
                                                                                                    __auto_type bname = binding_sym.name;
                                                                                                    __auto_type type_idx = (vi - 1);
                                                                                                    if (!(string_eq(bname, SLOP_STR("_"))) && !(string_eq(bname, SLOP_STR("")))) {
                                                                                                        if (type_idx < num_pt) {
                                                                                                            __auto_type _mv_390 = ({ __auto_type _lst = payload_types; size_t _idx = (size_t)type_idx; slop_option_types_ResolvedType_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                                                                            if (_mv_390.has_value) {
                                                                                                                __auto_type pt = _mv_390.value;
                                                                            ...
                                                                            __auto_type _mv_391 = types_resolved_type_get_variant_index(scrutinee_type, variant_name);
                                                                            if (_mv_391.has_value) {
                                                                                __auto_type _ = _mv_391.value;
