...
slop_option_types_ResolvedType_ptr infer_find_binding(slop_list_string bind_names, slop_list_types_ResolvedType_ptr bind_types, slop_string name) {
    {
        ...
        for (int64_t i = 0; i < len; i++) {
            __auto_type _mv_192 = ({ __auto_type _lst = bind_names; size_t _idx = (size_t)i; slop_option_string _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_192.has_value) {
                __auto_type bn = _mv_192.value;
                if (string_eq(bn, name)) {
                    __auto_type _mv_193 = ({ __auto_type _lst = bind_types; size_t _idx = (size_t)i; slop_option_types_ResolvedType_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_193.has_value) {
                        __auto_type bt = _mv_193.value;
        ...
        if ((f_kind == types_ResolvedTypeKind_rk_typevar)) {
            {
                ...
                __auto_type _mv_194 = infer_find_binding(bind_names, bind_types, tv_name);
                if (_mv_194.has_value) {
                    __auto_type existing = _mv_194.value;
            ...
            if (((*actual).kind == types_ResolvedTypeKind_rk_ptr)) {
                __auto_type _mv_195 = (*formal).inner_type;
                if (_mv_195.has_value) {
                    __auto_type f_inner = _mv_195.value;
                    __auto_type _mv_196 = (*actual).inner_type;
                    if (_mv_196.has_value) {
                        __auto_type a_inner = _mv_196.value;
            ...
            if (((*actual).kind == types_ResolvedTypeKind_rk_chan)) {
                __auto_type _mv_197 = (*formal).inner_type;
                if (_mv_197.has_value) {
                    __auto_type f_inner = _mv_197.value;
                    __auto_type _mv_198 = (*actual).inner_type;
                    if (_mv_198.has_value) {
                        __auto_type a_inner = _mv_198.value;
                        infer_unify_types(arena, f_inner, a_inner, bind_names, bind_types);
            ...
            if (((*actual).kind == types_ResolvedTypeKind_rk_thread)) {
                __auto_type _mv_199 = (*formal).inner_type;
                if (_mv_199.has_value) {
                    __auto_type f_inner = _mv_199.value;
                    __auto_type _mv_200 = (*actual).inner_type;
                    if (_mv_200.has_value) {
                        __auto_type a_inner = _mv_200.value;
                        infer_unify_types(arena, f_inner, a_inner, bind_names, bind_types);
            ...
            if (((*actual).kind == types_ResolvedTypeKind_rk_list)) {
                __auto_type _mv_201 = (*formal).inner_type;
                if (_mv_201.has_value) {
                    __auto_type f_inner = _mv_201.value;
                    __auto_type _mv_202 = (*actual).inner_type;
                    if (_mv_202.has_value) {
                        __auto_type a_inner = _mv_202.value;
                        infer_unify_types(arena, f_inner, a_inner, bind_names, bind_types);
            ...
            if (((*actual).kind == types_ResolvedTypeKind_rk_option)) {
                __auto_type _mv_203 = (*formal).inner_type;
                if (_mv_203.has_value) {
                    __auto_type f_inner = _mv_203.value;
                    __auto_type _mv_204 = (*actual).inner_type;
                    if (_mv_204.has_value) {
                        __auto_type a_inner = _mv_204.value;
                        infer_unify_types(arena, f_inner, a_inner, bind_names, bind_types);
            ...
            if (((*actual).kind == types_ResolvedTypeKind_rk_result)) {
                ...
                __auto_type _mv_207 = (*formal).inner_type2;
                if (_mv_207.has_value) {
                    __auto_type f_inner2 = _mv_207.value;
                    __auto_type _mv_208 = (*actual).inner_type2;
                    if (_mv_208.has_value) {
                        __auto_type a_inner2 = _mv_208.value;
        ...
        if ((kind == types_ResolvedTypeKind_rk_typevar)) {
            {
                ...
                __auto_type _mv_209 = infer_find_binding(bind_names, bind_types, tv_name);
                if (_mv_209.has_value) {
                    __auto_type bound = _mv_209.value;
                    return bound;
            ...
            __auto_type _mv_214 = (*t).inner_type;
        ...
        if (parser_sexpr_is_list(expr)) {
            {
                ...
                }
                {
                    ...
                    for (int64_t i = 0; i < limit; i++) {
                        __auto_type _mv_215 = parser_sexpr_list_get(expr, (i + 1));
                        if (_mv_215.has_value) {
                            __auto_type arg_expr = _mv_215.value;
                            {
                                __auto_type actual_type = infer_infer_expr(env, arg_expr);
                                __auto_type _mv_216 = ({ __auto_type _lst = params; size_t _idx = (size_t)i; slop_option_types_ParamInfo _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_216.has_value) {
                                    __auto_type param_info = _mv_216.value;
                                    {
...
uint8_t infer_types_compatible_with_range(types_ResolvedType* a, types_ResolvedType* b) {
    ...
    SLOP_PRE(((b != NULL)), "(!= b nil)");
    {
        ...
        if ((a_kind == types_ResolvedTypeKind_rk_range)) {
            __auto_type _mv_217 = (*a).inner_type;
            ...
            __auto_type _mv_218 = (*b).inner_type;
            if (_mv_218.has_value) {
                __auto_type base = _mv_218.value;
...
types_ResolvedType* infer_infer_expr_inner(env_TypeEnv* env, types_SExpr* expr) {
    ...
    SLOP_PRE(((expr != NULL)), "(!= expr nil)");
    {
        ...
        switch (_mv_220.tag) {
            case types_SExpr_sym:
            {
                __auto_type sym = _mv_220.data.sym;
                {
                    ...
                    if ((string_eq(name, SLOP_STR("true")) || string_eq(name, SLOP_STR("false")))) {
                        ...
                        __auto_type _mv_221 = env_env_lookup_var(env, name);
                        if (_mv_221.has_value) {
                            __auto_type t = _mv_221.value;
                            return t;
                        } else if (!_mv_221.has_value) {
                            __auto_type _mv_222 = env_env_lookup_constant(env, name);
                            if (_mv_222.has_value) {
                                __auto_type t = _mv_222.value;
                                return t;
                            } else if (!_mv_222.has_value) {
                                __auto_type _mv_223 = env_env_lookup_function(env, name);
                                if (_mv_223.has_value) {
                                    __auto_type sig = _mv_223.value;
                                    ...
                                    if (infer_string_contains_char(name, 46)) {
                                        {
                                            ...
                                            __auto_type _mv_224 = env_env_lookup_var(env, base_name);
                                            if (_mv_224.has_value) {
                                                __auto_type obj_type = _mv_224.value;
                                                return infer_check_field_exists(env, obj_type, field_name, line, col);
                                            } else if (!_mv_224.has_value) {
                                                __auto_type _mv_225 = env_env_lookup_type(env, base_name);
                                        ...
                                        __auto_type _mv_226 = env_env_lookup_type(env, name);
                                        if (_mv_226.has_value) {
                                            __auto_type type_info = _mv_226.value;
                                            return type_info;
            ...
            case types_SExpr_num:
            {
                __auto_type num = _mv_220.data.num;
                return env_env_get_int_type(env);
            }
            case types_SExpr_str:
            {
                __auto_type str = _mv_220.data.str;
    ...
    SLOP_PRE(((expr != NULL)), "(!= expr nil)");
    {
        ...
        if ((len == 0)) {
            ...
            if (!_mv_227.has_value) {
                ...
                __auto_type head = _mv_227.value;
                __auto_type _mv_228 = (*head);
                switch (_mv_228.tag) {
                    case types_SExpr_sym:
                    {
        ...
        if (string_eq(op, SLOP_STR("if"))) {
            if ((len >= 4)) {
                ...
                if (_mv_229.has_value) {
                    __auto_type cond_expr = _mv_229.value;
                    {
                ...
                if (_mv_230.has_value) {
                    __auto_type then_expr = _mv_230.value;
                    {
                        ...
                        if (_mv_231.has_value) {
                            __auto_type else_expr = _mv_231.value;
                            {
            ...
            if ((len > 1)) {
                __auto_type _mv_232 = ({ __auto_type _lst = items; size_t _idx = (size_t)(len - 1); slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_232.has_value) {
                    __auto_type last = _mv_232.value;
            ...
            if ((len >= 2)) {
                ...
                if (_mv_233.has_value) {
                    __auto_type binding_form = _mv_233.value;
                    if (parser_sexpr_is_list(binding_form)) {
                        {
                            __auto_type bind_len = parser_sexpr_list_len(binding_form);
                            if ((bind_len >= 3)) {
                                __auto_type _mv_234 = parser_sexpr_list_get(binding_form, 0);
                                if (_mv_234.has_value) {
                                    __auto_type var_expr = _mv_234.value;
                                    {
                                        ...
                                        if (!(string_eq(var_name, SLOP_STR("")))) {
                                            ...
                                            __auto_type _mv_235 = parser_sexpr_list_get(binding_form, 1);
                                            if (_mv_235.has_value) {
                                                __auto_type start_expr = _mv_235.value;
                                                {
                                                    __auto_type _ = infer_infer_expr(env, start_expr);
                                                }
                                            } else if (!_mv_235.has_value) {
                                            }
                                            __auto_type _mv_236 = parser_sexpr_list_get(binding_form, 2);
                                            if (_mv_236.has_value) {
                                                __auto_type end_expr = _mv_236.value;
                                                {
                                            ...
                                            for (int64_t body_idx = 2; body_idx < len; body_idx++) {
                                                __auto_type _mv_237 = ({ __auto_type _lst = items; size_t _idx = (size_t)body_idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_237.has_value) {
                                                    __auto_type body_expr = _mv_237.value;
                                                    {
                                    ...
                                    __auto_type var_expr = _mv_239.value;
                                    {
                                        ...
                                        if (string_eq(var_name, SLOP_STR(""))) {
                                            ...
                                            if (_mv_240.has_value) {
                                                __auto_type coll_expr = _mv_240.value;
                                                {
                                                    ...
                                                    __auto_type coll_col = parser_sexpr_col(coll_expr);
                                                    {
                                                        ...
                                                        for (int64_t body_idx = 2; body_idx < len; body_idx++) {
                                                            __auto_type _mv_241 = ({ __auto_type _lst = items; size_t _idx = (size_t)body_idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                            if (_mv_241.has_value) {
                                                                __auto_type body_expr = _mv_241.value;
                                                                {
                                                                    __auto_type _ = infer_infer_expr(env, body_expr);
                                                                }
            ...
            if ((len >= 2)) {
                ...
                if (_mv_242.has_value) {
                    __auto_type params_expr = _mv_242.value;
                    if (parser_sexpr_is_list(params_expr)) {
                        {
                            ...
                            for (int64_t k = 0; k < num_params; k++) {
                                __auto_type _mv_243 = parser_sexpr_list_get(params_expr, k);
                                if (_mv_243.has_value) {
                                    __auto_type param_form = _mv_243.value;
            ...
            if ((len >= 4)) {
                __auto_type _mv_244 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            ...
            if ((len >= 2)) {
                ...
                if (_mv_246.has_value) {
                    __auto_type ret_expr = _mv_246.value;
                    {
            ...
            if ((len >= 2)) {
                ...
                if (_mv_249.has_value) {
                    __auto_type inner_expr = _mv_249.value;
                    {
            ...
            if ((len >= 2)) {
                ...
                if (_mv_250.has_value) {
                    __auto_type type_expr = _mv_250.value;
                    {
                        ...
                        if (string_eq(type_name, SLOP_STR(""))) {
                            if (parser_sexpr_is_list(type_expr)) {
                                __auto_type _mv_251 = parser_sexpr_list_get(type_expr, 0);
                            ...
                            __auto_type _mv_252 = env_env_lookup_type(env, type_name);
                            if (_mv_252.has_value) {
                                __auto_type t = _mv_252.value;
                                return t;
            ...
            if ((len >= 2)) {
                ...
                if (_mv_253.has_value) {
                    __auto_type variant_expr = _mv_253.value;
                    {
                        __auto_type variant_name = parser_sexpr_get_symbol_name(variant_expr);
                        if (string_eq(variant_name, SLOP_STR(""))) {
                            return env_env_get_unknown_type(env);
                        } else {
                            __auto_type _mv_254 = env_env_lookup_variant(env, variant_name);
                            if (_mv_254.has_value) {
                                __auto_type enum_name = _mv_254.value;
                                __auto_type _mv_255 = env_env_lookup_type(env, enum_name);
                                if (_mv_255.has_value) {
                                    __auto_type enum_type = _mv_255.value;
                                    return enum_type;
            ...
            if ((len >= 2)) {
                ...
                if (_mv_256.has_value) {
                    __auto_type inner_expr = _mv_256.value;
                    {
                        __auto_type inner_type = infer_infer_expr(env, inner_expr);
            ...
            for (int64_t fi = 2; fi < len; fi++) {
                __auto_type _mv_257 = ({ __auto_type _lst = items; size_t _idx = (size_t)fi; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_257.has_value) {
                    __auto_type field_pair = _mv_257.value;
                    if ((parser_sexpr_is_list(field_pair) && (parser_sexpr_list_len(field_pair) >= 2))) {
                        __auto_type _mv_258 = parser_sexpr_list_get(field_pair, 1);
                ...
                if (_mv_259.has_value) {
                    __auto_type type_expr = _mv_259.value;
                    {
                        ...
                        if (string_eq(type_name, SLOP_STR(""))) {
                            ...
                            __auto_type _mv_260 = env_env_lookup_type(env, type_name);
                            if (_mv_260.has_value) {
                                __auto_type t = _mv_260.value;
                                return t;
                ...
                if (_mv_262.has_value) {
                    __auto_type type_expr = _mv_262.value;
                    {
                        ...
                        if (string_eq(type_name, SLOP_STR(""))) {
                            ...
                            __auto_type _mv_263 = env_env_lookup_type(env, type_name);
            ...
            __auto_type _mv_264 = env_env_lookup_function(env, op);
            if (_mv_264.has_value) {
                ...
                __auto_type _mv_265 = env_env_lookup_type(env, op);
                if (_mv_265.has_value) {
                    __auto_type the_type = _mv_265.value;
                    return the_type;
                    ...
                    if (string_eq(op, SLOP_STR("list-get"))) {
                        ...
                        if ((len < 3)) {
                            ...
                            if (_mv_268.has_value) {
                                __auto_type type_expr = _mv_268.value;
                                {
                                    ...
                                    if (string_eq(type_name, SLOP_STR(""))) {
                                        if (parser_sexpr_is_list(type_expr)) {
                                            __auto_type _mv_269 = parser_sexpr_list_get(type_expr, 0);
                                            if (_mv_269.has_value) {
                                                __auto_type head_expr = _mv_269.value;
                                                if (string_eq(parser_sexpr_get_symbol_name(head_expr), SLOP_STR("sizeof"))) {
                                                    __auto_type _mv_270 = parser_sexpr_list_get(type_expr, 1);
                                                    if (_mv_270.has_value) {
                                                        __auto_type sizeof_type_expr = _mv_270.value;
                                                        {
                                                            __auto_type sizeof_type_name = parser_sexpr_get_symbol_name(sizeof_type_expr);
                                                            if (string_eq(sizeof_type_name, SLOP_STR(""))) {
                                                                return env_env_get_int_type(env);
                                                            } else {
                                                                __auto_type _mv_271 = env_env_lookup_type(env, sizeof_type_name);
                                                                if (_mv_271.has_value) {
                                                                    __auto_type resolved = _mv_271.value;
                                        ...
                                        __auto_type _mv_272 = env_env_lookup_type(env, type_name);
                                        if (_mv_272.has_value) {
                                            __auto_type resolved = _mv_272.value;
                                            return env_env_make_ptr_type(env, resolved);
                        ...
                        if ((len >= 2)) {
                            ...
                            if (_mv_276.has_value) {
                                __auto_type ptr_expr = _mv_276.value;
                                {
                                    __auto_type ptr_type = infer_infer_expr(env, ptr_expr);
                                    if (types_resolved_type_is_pointer(ptr_type)) {
                                        __auto_type _mv_277 = (*ptr_type).inner_type;
                            ...
                            if ((len >= 3)) {
                                ...
                                if (_mv_278.has_value) {
                                    __auto_type type_expr = _mv_278.value;
                                    {
                                        __auto_type type_name = parser_sexpr_get_symbol_name(type_expr);
                                        if (!(string_eq(type_name, SLOP_STR("")))) {
                                            __auto_type _mv_279 = env_env_lookup_type(env, type_name);
                                            if (_mv_279.has_value) {
                                                __auto_type t = _mv_279.value;
                                                key_type = t;
                            ...
                            if ((len >= 4)) {
                                ...
                                if (_mv_280.has_value) {
                                    __auto_type type_expr = _mv_280.value;
                                    {
                                        __auto_type type_name = parser_sexpr_get_symbol_name(type_expr);
                                        if (!(string_eq(type_name, SLOP_STR("")))) {
                                            __auto_type _mv_281 = env_env_lookup_type(env, type_name);
                                            if (_mv_281.has_value) {
                                                __auto_type t = _mv_281.value;
                                                val_type = t;
                        ...
                        infer_check_builtin_args(env, SLOP_STR("map-get"), 2, (len - 1), line, col);
                        {
                            ...
                            if ((len >= 2)) {
                                ...
                                if (_mv_282.has_value) {
                                    __auto_type map_expr = _mv_282.value;
                                    {
                                        __auto_type map_type = infer_infer_expr(env, map_expr);
                                        __auto_type _mv_283 = (*map_type).inner_type2;
                                        if (_mv_283.has_value) {
                                            __auto_type inner = _mv_283.value;
                                            val_type = inner;
                        ...
                        if ((len >= 2)) {
                            ...
                            if (_mv_284.has_value) {
                                __auto_type map_expr = _mv_284.value;
                                {
                                    __auto_type map_type = infer_infer_expr(env, map_expr);
                        ...
                        infer_check_builtin_args(env, SLOP_STR("map-keys"), 1, (len - 1), line, col);
                        {
                            ...
                            if ((len >= 2)) {
                                ...
                                if (_mv_285.has_value) {
                                    __auto_type map_expr = _mv_285.value;
                                    {
                                        __auto_type map_type = infer_infer_expr(env, map_expr);
                                        __auto_type _mv_286 = (*map_type).inner_type;
                            ...
                            if ((len >= 3)) {
                                ...
                                if (_mv_287.has_value) {
                                    __auto_type type_expr = _mv_287.value;
                                    {
                                        __auto_type type_name = parser_sexpr_get_symbol_name(type_expr);
                                        if (!(string_eq(type_name, SLOP_STR("")))) {
                                            __auto_type _mv_288 = env_env_lookup_type(env, type_name);
                        ...
                        infer_check_builtin_args(env, SLOP_STR("set-elements"), 1, (len - 1), line, col);
                        {
                            ...
                            if ((len >= 2)) {
                                ...
                                if (_mv_289.has_value) {
                                    __auto_type set_expr = _mv_289.value;
                                    {
                                        __auto_type set_type = infer_infer_expr(env, set_expr);
                                        __auto_type _mv_290 = (*set_type).inner_type;
                        ...
                        {
                            __auto_type arena = env_env_arena(env);
                            __auto_type _mv_291 = env_env_lookup_variant(env, op);
                            if (_mv_291.has_value) {
                                __auto_type parent_type = _mv_291.value;
                                {
                                ...
                                if ((strlib_starts_with(op, SLOP_STR("set-")) || (strlib_starts_with(op, SLOP_STR("map-")) || (strlib_starts_with(op, SLOP_STR("list-")) || strlib_starts_with(op, SLOP_STR("arena-")))))) {
                                    ...
                                    __auto_type _mv_292 = env_env_lookup_var(env, op);
                                    if (_mv_292.has_value) {
                                        __auto_type var_type = _mv_292.value;
                                        infer_infer_builtin_args(env, expr);
                                        return var_type;
...
void infer_check_single_arg(env_TypeEnv* env, types_FnSignature* sig, types_SExpr* expr, int64_t arg_idx, int64_t line, int64_t col) {
    ...
    SLOP_PRE(((sig != NULL)), "(!= sig nil)");
    {
        ...
        __auto_type fn_name = (*sig).name;
        __auto_type arena = env_env_arena(env);
        __auto_type _mv_293 = ({ __auto_type _lst = params; size_t _idx = (size_t)arg_idx; slop_option_types_ParamInfo _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        if (_mv_293.has_value) {
            __auto_type param_info = _mv_293.value;
            {
                __auto_type expected_type = param_info.param_type;
                __auto_type _mv_294 = parser_sexpr_list_get(expr, (arg_idx + 1));
    ...
    if (parser_sexpr_is_list(expr)) {
        {
            ...
            for (int64_t i = 1; i < len; i++) {
                __auto_type _mv_295 = parser_sexpr_list_get(expr, i);
                if (_mv_295.has_value) {
                    __auto_type arg_expr = _mv_295.value;
                    {
    ...
    if (parser_sexpr_is_list(expr)) {
        {
            ...
            for (int64_t i = start_idx; i < len; i++) {
                __auto_type _mv_296 = parser_sexpr_list_get(expr, i);
    ...
    SLOP_PRE(((env != NULL)), "(!= env nil)");
    {
        ...
        if ((len < 3)) {
            ...
            if (!_mv_297.has_value) {
                ...
                __auto_type obj_expr = _mv_297.value;
                {
                    __auto_type obj_type = infer_infer_expr(env, obj_expr);
                    __auto_type _mv_298 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (!_mv_298.has_value) {
                        return env_env_get_unit_type(env);
                    } else if (_mv_298.has_value) {
                        __auto_type field_expr = _mv_298.value;
                        __auto_type _mv_299 = (*field_expr);
                        switch (_mv_299.tag) {
                            case types_SExpr_sym:
                            {
                                __auto_type field_sym = _mv_299.data.sym;
                                {
...
types_ResolvedType* infer_check_field_exists(env_TypeEnv* env, types_ResolvedType* obj_type, slop_string field_name, int64_t line, int64_t col) {
    ...
    SLOP_PRE(((obj_type != NULL)), "(!= obj-type nil)");
    {
        ...
        if (types_resolved_type_is_record(obj_type)) {
            __auto_type _mv_300 = types_resolved_type_get_field_type(obj_type, field_name);
            if (_mv_300.has_value) {
                __auto_type field_type = _mv_300.value;
                return field_type;
    ...
    SLOP_PRE(((env != NULL)), "(!= env nil)");
    {
        ...
        while ((i < len)) {
            ...
            if (_mv_301.has_value) {
                __auto_type clause = _mv_301.value;
                __auto_type _mv_302 = (*clause);
                switch (_mv_302.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type clause_lst = _mv_302.data.lst;
                        {
                            ...
                            if ((clause_len > 1)) {
                                for (int64_t ci = 0; ci < (clause_len - 1); ci++) {
                                    __auto_type _mv_303 = ({ __auto_type _lst = clause_items; size_t _idx = (size_t)ci; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    if (_mv_303.has_value) {
                                        __auto_type clause_elem = _mv_303.value;
                                        {
                                ...
                                __auto_type _mv_304 = ({ __auto_type _lst = clause_items; size_t _idx = (size_t)(clause_len - 1); slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_304.has_value) {
                                    __auto_type body = _mv_304.value;
                                    {
...
void infer_bind_match_pattern(env_TypeEnv* env, types_ResolvedType* scrutinee_type, types_SExpr* pattern) {
    ...
    if (parser_sexpr_is_list(pattern)) {
        if ((parser_sexpr_list_len(pattern) > 0)) {
            __auto_type _mv_305 = parser_sexpr_list_get(pattern, 0);
            if (_mv_305.has_value) {
                __auto_type variant_expr = _mv_305.value;
                {
                    __auto_type variant_name = parser_sexpr_get_symbol_name(variant_expr);
                    if (!(string_eq(variant_name, SLOP_STR("")))) {
                        if ((parser_sexpr_list_len(pattern) > 1)) {
                            __auto_type _mv_306 = parser_sexpr_list_get(pattern, 1);
                            if (_mv_306.has_value) {
                                __auto_type binding_expr = _mv_306.value;
                                {
                                    ...
                                    if (!(string_eq(binding_name, SLOP_STR("")))) {
                                        {
                                            ...
                                            if (string_eq(scrutinee_name, SLOP_STR("T"))) {
                                                ...
                                                if (((scrutinee_kind == types_ResolvedTypeKind_rk_option) && string_eq(variant_name, SLOP_STR("some")))) {
                                                    __auto_type _mv_307 = (*scrutinee_type).inner_type;
                                                    if (_mv_307.has_value) {
                                                        __auto_type inner = _mv_307.value;
                                                    ...
                                                    if ((scrutinee_kind == types_ResolvedTypeKind_rk_result)) {
                                                        if (string_eq(variant_name, SLOP_STR("ok"))) {
                                                            __auto_type _mv_308 = (*scrutinee_type).inner_type;
                                                            if (_mv_308.has_value) {
                                                                __auto_type inner = _mv_308.value;
                                                                env_env_bind_var(env, binding_name, inner);
                                                            } else if (!_mv_308.has_value) {
                                                                env_env_bind_var(env, binding_name, env_env_get_generic_type(env));
                                                            }
                                                        } else if (string_eq(variant_name, SLOP_STR("error"))) {
                                                            __auto_type _mv_309 = (*scrutinee_type).inner_type2;
                                                            if (_mv_309.has_value) {
                                                                __auto_type inner2 = _mv_309.value;
                                                        ...
                                                        __auto_type _mv_310 = types_resolved_type_get_variant_payload(scrutinee_type, variant_name);
                                                        if (_mv_310.has_value) {
                                                            __auto_type payload_type = _mv_310.value;
    ...
    SLOP_PRE(((env != NULL)), "(!= env nil)");
    {
        ...
        while ((i < len)) {
            ...
            if (_mv_311.has_value) {
                __auto_type clause = _mv_311.value;
                __auto_type _mv_312 = (*clause);
                switch (_mv_312.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type clause_lst = _mv_312.data.lst;
                        {
                            ...
                            if ((clause_len > 1)) {
                                ...
                                for (int64_t bi = 1; bi < (clause_len - 1); bi++) {
                                    __auto_type _mv_314 = ({ __auto_type _lst = clause_items; size_t _idx = (size_t)bi; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void infer_check_return_type(env_TypeEnv* env, types_SExpr* fn_form, slop_string fn_name, types_ResolvedType* inferred_type, int64_t fn_line, int64_t fn_col) {
    ...
    __auto_type _mv_316 = (*fn_form);
    switch (_mv_316.tag) {
        case types_SExpr_lst:
        {
            __auto_type fn_lst = _mv_316.data.lst;
            {
                ...
                for (int64_t i = 3; i < len; i++) {
                    ...
                    if (_mv_317.has_value) {
                        __auto_type item = _mv_317.value;
...
void infer_check_spec_return_type(env_TypeEnv* env, types_SExpr* spec_form, slop_string fn_name, types_ResolvedType* inferred_type, int64_t fn_line, int64_t fn_col) {
    ...
    __auto_type _mv_318 = (*spec_form);
    switch (_mv_318.tag) {
        case types_SExpr_lst:
        {
            __auto_type spec_lst = _mv_318.data.lst;
            {
                __auto_type spec_items = spec_lst.items;
                __auto_type _mv_319 = ({ __auto_type _lst = spec_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_319.has_value) {
                    __auto_type spec_body = _mv_319.value;
...
void infer_check_spec_body_return(env_TypeEnv* env, types_SExpr* spec_body, slop_string fn_name, types_ResolvedType* inferred_type, int64_t fn_line, int64_t fn_col) {
    ...
    __auto_type _mv_320 = (*spec_body);
    switch (_mv_320.tag) {
        case types_SExpr_lst:
        {
            __auto_type body_lst = _mv_320.data.lst;
            {
                __auto_type body_items = body_lst.items;
                __auto_type body_len = ((int64_t)((body_items).len));
                __auto_type _mv_321 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)(body_len - 1); slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_321.has_value) {
                    __auto_type ret_expr = _mv_321.value;
...
void infer_check_return_expr(env_TypeEnv* env, types_SExpr* ret_expr, slop_string fn_name, types_ResolvedType* inferred_type, int64_t fn_line, int64_t fn_col) {
    ...
    __auto_type _mv_322 = (*ret_expr);
    switch (_mv_322.tag) {
        case types_SExpr_sym:
        {
            __auto_type ret_sym = _mv_322.data.sym;
            {
...
void infer_bind_param_from_form(env_TypeEnv* env, types_SExpr* param_form) {
    ...
    if ((parser_sexpr_is_list(param_form) && (parser_sexpr_list_len(param_form) >= 2))) {
        __auto_type _mv_323 = parser_sexpr_list_get(param_form, 0);
        if (_mv_323.has_value) {
            __auto_type first_expr = _mv_323.value;
            {
                ...
                if (((string_eq(first_name, SLOP_STR("in"))) || (string_eq(first_name, SLOP_STR("out"))) || (string_eq(first_name, SLOP_STR("mut"))))) {
                    if ((parser_sexpr_list_len(param_form) >= 3)) {
                        __auto_type _mv_324 = parser_sexpr_list_get(param_form, 1);
                        if (_mv_324.has_value) {
                            __auto_type name_expr = _mv_324.value;
                            {
...
types_ResolvedType* infer_get_param_type_from_form(env_TypeEnv* env, types_SExpr* param_form) {
    ...
    SLOP_PRE(((param_form != NULL)), "(!= param-form nil)");
    {
        ...
        __auto_type _mv_325 = parser_sexpr_list_get(param_form, type_pos);
...
types_ResolvedType* infer_resolve_complex_type_expr(env_TypeEnv* env, types_SExpr* type_expr) {
    ...
    __auto_type _mv_326 = parser_sexpr_list_get(type_expr, 0);
    if (_mv_326.has_value) {
        __auto_type head_expr = _mv_326.value;
        {
            __auto_type head_name = parser_sexpr_get_symbol_name(head_expr);
            if (string_eq(head_name, SLOP_STR("Option"))) {
            ...
            } else if (string_eq(head_name, SLOP_STR("Map"))) {
                {
                    ...
                    if ((parser_sexpr_list_len(type_expr) >= 3)) {
                        __auto_type _mv_327 = parser_sexpr_list_get(type_expr, 2);
            ...
            } else if (string_eq(head_name, SLOP_STR("Result"))) {
                {
                    ...
                    if ((parser_sexpr_list_len(type_expr) >= 2)) {
                        ...
                        if (_mv_328.has_value) {
                            __auto_type ok_expr = _mv_328.value;
                            {
                    ...
                    if ((parser_sexpr_list_len(type_expr) >= 3)) {
                        __auto_type _mv_329 = parser_sexpr_list_get(type_expr, 2);
                        if (_mv_329.has_value) {
                            __auto_type err_expr = _mv_329.value;
                            {
                ...
                __auto_type _mv_330 = env_env_lookup_type(env, head_name);
...
types_ResolvedType* infer_resolve_option_inner_type(env_TypeEnv* env, types_SExpr* type_expr) {
    ...
    if ((parser_sexpr_list_len(type_expr) < 2)) {
        ...
        __auto_type _mv_331 = parser_sexpr_list_get(type_expr, 1);
        if (_mv_331.has_value) {
            __auto_type inner_expr = _mv_331.value;
            {
...
types_ResolvedType* infer_resolve_ptr_inner_type(env_TypeEnv* env, types_SExpr* type_expr) {
    ...
    if ((parser_sexpr_list_len(type_expr) < 2)) {
        ...
        __auto_type _mv_332 = parser_sexpr_list_get(type_expr, 1);
        if (_mv_332.has_value) {
            __auto_type inner_expr = _mv_332.value;
            {
                __auto_type inner_name = parser_sexpr_get_symbol_name(inner_expr);
                if (string_eq(inner_name, SLOP_STR(""))) {
...
types_ResolvedType* infer_resolve_simple_type(env_TypeEnv* env, slop_string type_name) {
    SLOP_PRE(((env != NULL)), "(!= env nil)");
    __auto_type _mv_334 = env_env_lookup_type(env, type_name);
    if (_mv_334.has_value) {
        __auto_type t = _mv_334.value;
        return t;
...
void infer_bind_let_binding(env_TypeEnv* env, types_SExpr* binding_form) {
    ...
    if ((parser_sexpr_is_list(binding_form) && (parser_sexpr_list_len(binding_form) >= 2))) {
        ...
        if (_mv_335.has_value) {
            __auto_type first_expr = _mv_335.value;
            {
                __auto_type first_name = parser_sexpr_get_symbol_name(first_expr);
                    ...
                    if (!(string_eq(first_name, SLOP_STR("")))) {
                        {
                            __auto_type binding_len = parser_sexpr_list_len(binding_form);
                            if ((binding_len == 3)) {
                                __auto_type _mv_338 = parser_sexpr_list_get(binding_form, 2);
                                ...
                                __auto_type _mv_339 = parser_sexpr_list_get(binding_form, 1);
                                if (_mv_339.has_value) {
                                    __auto_type val_expr = _mv_339.value;
                                    {
                                        __auto_type val_type = infer_infer_expr(env, val_expr);
                                        env_env_bind_var(env, first_name, val_type);
                                    }
...
types_ResolvedType* infer_infer_let_expr(env_TypeEnv* env, types_SExpr* expr) {
    ...
    env_env_push_scope(env);
    if (parser_sexpr_is_list(expr)) {
        __auto_type _mv_340 = parser_sexpr_list_get(expr, 1);
        if (_mv_340.has_value) {
            __auto_type bindings_expr = _mv_340.value;
            if (parser_sexpr_is_list(bindings_expr)) {
                {
                    ...
                    for (int64_t i = 0; i < num_bindings; i++) {
                        __auto_type _mv_341 = parser_sexpr_list_get(bindings_expr, i);
        ...
        if ((len < 2)) {
        ...
        } else {
            {
                ...
                if ((is_named && (len < 4))) {
                    ...
                    __auto_type _mv_342 = parser_sexpr_list_get(expr, size_idx);
                    if (_mv_342.has_value) {
                        __auto_type size_expr = _mv_342.value;
                        __auto_type _mv_343 = (*size_expr);
                        switch (_mv_343.tag) {
                            case types_SExpr_num:
                            {
                                __auto_type num = _mv_343.data.num;
                                if ((num.int_value <= 0)) {
                    ...
                    env_env_bind_var(env, arena_name, env_env_get_arena_type(env));
                    {
                        ...
                        for (int64_t i = body_start; i < len; i++) {
                            __auto_type _mv_344 = parser_sexpr_list_get(expr, i);
...
slop_string infer_get_fn_name(types_SExpr* fn_form) {
    ...
    if (!(parser_sexpr_is_list(fn_form))) {
        ...
        if ((parser_sexpr_list_len(fn_form) < 2)) {
            ...
            __auto_type _mv_345 = parser_sexpr_list_get(fn_form, 1);
...
slop_string infer_get_hole_prompt(slop_list_types_SExpr_ptr items, int64_t len) {
    if ((len < 3)) {
        ...
        if (_mv_348.has_value) {
            __auto_type prompt_expr = _mv_348.value;
            __auto_type _mv_349 = (*prompt_expr);
            switch (_mv_349.tag) {
                case types_SExpr_str:
                {
                    __auto_type str = _mv_349.data.str;
                    return str.value;
                }
                default: {
                    return SLOP_STR("(no description)");
...
uint8_t infer_is_c_name_related(slop_list_types_SExpr_ptr items, int64_t idx) {
    __auto_type _mv_350 = ({ __auto_type _lst = items; size_t _idx = (size_t)idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    if (_mv_350.has_value) {
        __auto_type item = _mv_350.value;
        __auto_type _mv_351 = (*item);
        switch (_mv_351.tag) {
            case types_SExpr_sym:
            {
            ...
            case types_SExpr_str:
            {
                __auto_type _ = _mv_351.data.str;
                if ((idx > 0)) {
                    __auto_type _mv_352 = ({ __auto_type _lst = items; size_t _idx = (size_t)(idx - 1); slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_352.has_value) {
                        __auto_type prev = _mv_352.value;
                        __auto_type _mv_353 = (*prev);
                        switch (_mv_353.tag) {
                            case types_SExpr_sym:
                            {
...
uint8_t infer_is_annotation_expr(types_SExpr* expr) {
    SLOP_PRE(((expr != NULL)), "(!= expr nil)");
    if (parser_sexpr_is_list(expr)) {
        __auto_type _mv_354 = parser_sexpr_list_get(expr, 0);
        ...
        if (parser_sexpr_is_list(fn_form)) {
            {
                ...
                if ((params_len > 2)) {
                    __auto_type _mv_356 = parser_sexpr_list_get(fn_form, 2);
                    if (_mv_356.has_value) {
                        __auto_type params_expr = _mv_356.value;
                        if (parser_sexpr_is_list(params_expr)) {
                            {
                                __auto_type num_params = parser_sexpr_list_len(params_expr);
                                for (int64_t k = 0; k < num_params; k++) {
                                    __auto_type _mv_357 = parser_sexpr_list_get(params_expr, k);
                                    if (_mv_357.has_value) {
                                        __auto_type param_form = _mv_357.value;
                                        infer_bind_param_from_form(env, param_form);
    ...
    if (types_resolved_type_is_union(scrutinee_type)) {
        {
            ...
            for (int64_t i = 0; i < num_patterns; i++) {
                __auto_type _mv_358 = ({ __auto_type _lst = patterns; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_358.has_value) {
                    __auto_type pattern_case = _mv_358.value;
                    __auto_type _mv_359 = (*pattern_case);
                    switch (_mv_359.tag) {
                        case types_SExpr_lst:
                        {
                            __auto_type pattern_list = _mv_359.data.lst;
                            if ((((int64_t)((pattern_list.items).len)) > 0)) {
                                __auto_type _mv_360 = ({ __auto_type _lst = pattern_list.items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_360.has_value) {
                                    __auto_type pattern_expr = _mv_360.value;
                                    __auto_type _mv_361 = (*pattern_expr);
                                    switch (_mv_361.tag) {
                                        case types_SExpr_lst:
                                        {
                                            __auto_type variant_list = _mv_361.data.lst;
                                            {
                                                __auto_type variant_items = variant_list.items;
                                                if ((((int64_t)((variant_items).len)) > 0)) {
                                                    __auto_type _mv_362 = ({ __auto_type _lst = variant_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_362.has_value) {
                                                        __auto_type variant_name_expr = _mv_362.value;
                                                        __auto_type _mv_363 = (*variant_name_expr);
                                                        switch (_mv_363.tag) {
                                                            case types_SExpr_sym:
                                                            {
                                                                __auto_type variant_sym = _mv_363.data.sym;
                                                                {
                                                                    __auto_type variant_name = variant_sym.name;
                                                                    __auto_type _mv_364 = types_resolved_type_get_variant_payload(scrutinee_type, variant_name);
                                                                    if (_mv_364.has_value) {
                                                                        __auto_type payload_type = _mv_364.value;
                                                                        if ((((int64_t)((variant_items).len)) > 1)) {
                                                                            __auto_type _mv_365 = ({ __auto_type _lst = variant_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                                            if (_mv_365.has_value) {
                                                                                __auto_type binding_expr = _mv_365.value;
                                                                                __auto_type _mv_366 = (*binding_expr);
                                                                                switch (_mv_366.tag) {
                                                                                    case types_SExpr_sym:
                                                                                    {
                                                                                        __auto_type binding_sym = _mv_366.data.sym;
                                                                        ...
                                                                        __auto_type _mv_367 = types_resolved_type_get_variant_index(scrutinee_type, variant_name);
                                                                        if (_mv_367.has_value) {
                                                                            __auto_type _ = _mv_367.value;
