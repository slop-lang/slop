...
slop_option_types_ResolvedType_ptr infer_find_binding(slop_list_string bind_names, slop_list_types_ResolvedType_ptr bind_types, slop_string name) {
    {
        ...
        for (int64_t i = 0; i < len; i++) {
            __auto_type _mv_232 = ({ __auto_type _lst = bind_names; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_232.has_value) {
                __auto_type bn = _mv_232.value;
                if (string_eq(bn, name)) {
                    __auto_type _mv_233 = ({ __auto_type _lst = bind_types; size_t _idx = (size_t)i; slop_option_types_ResolvedType_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_233.has_value) {
                        __auto_type bt = _mv_233.value;
        ...
        if (f_kind == types_ResolvedTypeKind_rk_typevar) {
            {
                ...
                __auto_type _mv_234 = infer_find_binding(bind_names, bind_types, tv_name);
                if (_mv_234.has_value) {
                    __auto_type existing = _mv_234.value;
            ...
            if ((*actual).kind == types_ResolvedTypeKind_rk_ptr) {
                __auto_type _mv_235 = (*formal).inner_type;
                if (_mv_235.has_value) {
                    __auto_type f_inner = _mv_235.value;
                    __auto_type _mv_236 = (*actual).inner_type;
                    if (_mv_236.has_value) {
                        __auto_type a_inner = _mv_236.value;
            ...
            if ((*actual).kind == types_ResolvedTypeKind_rk_chan) {
                __auto_type _mv_237 = (*formal).inner_type;
                if (_mv_237.has_value) {
                    __auto_type f_inner = _mv_237.value;
                    __auto_type _mv_238 = (*actual).inner_type;
                    if (_mv_238.has_value) {
                        __auto_type a_inner = _mv_238.value;
                        infer_unify_types(arena, f_inner, a_inner, bind_names, bind_types);
            ...
            if ((*actual).kind == types_ResolvedTypeKind_rk_thread) {
                __auto_type _mv_239 = (*formal).inner_type;
                if (_mv_239.has_value) {
                    __auto_type f_inner = _mv_239.value;
                    __auto_type _mv_240 = (*actual).inner_type;
                    if (_mv_240.has_value) {
                        __auto_type a_inner = _mv_240.value;
                        infer_unify_types(arena, f_inner, a_inner, bind_names, bind_types);
            ...
            if ((*actual).kind == types_ResolvedTypeKind_rk_list) {
                __auto_type _mv_241 = (*formal).inner_type;
                if (_mv_241.has_value) {
                    __auto_type f_inner = _mv_241.value;
                    __auto_type _mv_242 = (*actual).inner_type;
                    if (_mv_242.has_value) {
                        __auto_type a_inner = _mv_242.value;
                        infer_unify_types(arena, f_inner, a_inner, bind_names, bind_types);
            ...
            if ((*actual).kind == types_ResolvedTypeKind_rk_option) {
                __auto_type _mv_243 = (*formal).inner_type;
                if (_mv_243.has_value) {
                    __auto_type f_inner = _mv_243.value;
                    __auto_type _mv_244 = (*actual).inner_type;
                    if (_mv_244.has_value) {
                        __auto_type a_inner = _mv_244.value;
                        infer_unify_types(arena, f_inner, a_inner, bind_names, bind_types);
            ...
            if ((*actual).kind == types_ResolvedTypeKind_rk_result) {
                __auto_type _mv_245 = (*formal).inner_type;
                if (_mv_245.has_value) {
                    __auto_type f_inner = _mv_245.value;
                    __auto_type _mv_246 = (*actual).inner_type;
                    if (_mv_246.has_value) {
                        __auto_type a_inner = _mv_246.value;
                        infer_unify_types(arena, f_inner, a_inner, bind_names, bind_types);
                    } else if (!_mv_246.has_value) {
                    }
                } else if (!_mv_245.has_value) {
                }
                __auto_type _mv_247 = (*formal).inner_type2;
                if (_mv_247.has_value) {
                    __auto_type f_inner2 = _mv_247.value;
                    __auto_type _mv_248 = (*actual).inner_type2;
                    if (_mv_248.has_value) {
                        __auto_type a_inner2 = _mv_248.value;
        ...
        if (kind == types_ResolvedTypeKind_rk_typevar) {
            {
                ...
                __auto_type _mv_249 = infer_find_binding(bind_names, bind_types, tv_name);
                if (_mv_249.has_value) {
                    __auto_type bound = _mv_249.value;
                    return bound;
        ...
        if (parser_sexpr_is_list(expr)) {
            {
                ...
                }
                {
                    ...
                    for (int64_t i = 0; i < limit; i++) {
                        __auto_type _mv_255 = parser_sexpr_list_get(expr, (i + 1));
                        if (_mv_255.has_value) {
                            __auto_type arg_expr = _mv_255.value;
                            {
                                __auto_type actual_type = infer_infer_expr(env, arg_expr);
                                __auto_type _mv_256 = ({ __auto_type _lst = params; size_t _idx = (size_t)i; slop_option_types_ParamInfo _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_256.has_value) {
                                    __auto_type param_info = _mv_256.value;
                                    {
...
uint8_t infer_types_compatible_with_range(types_ResolvedType* a, types_ResolvedType* b) {
    ...
    SLOP_PRE(((b != NULL)), "(!= b nil)");
    {
        ...
        if (a_kind == types_ResolvedTypeKind_rk_range) {
            __auto_type _mv_257 = (*a).inner_type;
            if (_mv_257.has_value) {
                __auto_type base = _mv_257.value;
            ...
            __auto_type _mv_258 = (*b).inner_type;
...
void infer_sexpr_set_resolved_type(types_SExpr* expr, types_ResolvedType* t) {
    ...
    switch (_mv_259.tag) {
        ...
        {
            __auto_type num = _mv_259.data.num;
        ...
        {
            __auto_type lst = _mv_259.data.lst;
            ...
            case types_SExpr_sym:
            {
                __auto_type sym = _mv_260.data.sym;
                {
                    ...
                    if (string_eq(name, SLOP_STR("true")) || string_eq(name, SLOP_STR("false"))) {
                        ...
                        __auto_type _mv_261 = env_env_lookup_var(env, name);
                        if (_mv_261.has_value) {
                            __auto_type t = _mv_261.value;
                            return t;
                        } else if (!_mv_261.has_value) {
                            __auto_type _mv_262 = env_env_lookup_constant(env, name);
                            if (_mv_262.has_value) {
                                __auto_type t = _mv_262.value;
                                return t;
                            } else if (!_mv_262.has_value) {
                                __auto_type _mv_263 = env_env_lookup_function(env, name);
                                    ...
                                    if (infer_string_contains_char(name, 46)) {
                                        {
                                            ...
                                            __auto_type _mv_264 = env_env_lookup_var(env, base_name);
                                            if (_mv_264.has_value) {
                                                __auto_type obj_type = _mv_264.value;
                                                return infer_check_field_exists(env, obj_type, field_name, line, col);
                                            } else if (!_mv_264.has_value) {
                                                __auto_type _mv_265 = env_env_lookup_type(env, base_name);
                                                if (_mv_265.has_value) {
                                                    __auto_type type_info = _mv_265.value;
                                                    return type_info;
                                        ...
                                        __auto_type _mv_266 = env_env_lookup_type(env, name);
                                        if (_mv_266.has_value) {
                                            __auto_type type_info = _mv_266.value;
                                            return type_info;
                                        } else if (!_mv_266.has_value) {
                                            __auto_type _mv_267 = env_env_lookup_variant(env, name);
                                            if (_mv_267.has_value) {
                                                __auto_type enum_name = _mv_267.value;
                                                __auto_type _mv_268 = env_env_lookup_type(env, enum_name);
...
types_ResolvedType* infer_infer_list_expr(env_TypeEnv* env, types_SExpr* expr, types_SExprList lst) {
    ...
    SLOP_PRE(((expr != NULL)), "(!= expr nil)");
    {
        ...
        if (len == 0) {
            ...
            __auto_type _mv_269 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (!_mv_269.has_value) {
                return env_env_get_unit_type(env);
            } else if (_mv_269.has_value) {
                __auto_type head = _mv_269.value;
                __auto_type _mv_270 = (*head);
                switch (_mv_270.tag) {
                    case types_SExpr_sym:
                    {
                        __auto_type sym = _mv_270.data.sym;
                        {
...
types_ResolvedType* infer_infer_special_form(env_TypeEnv* env, types_SExpr* expr, types_SExprList lst, slop_string op) {
    SLOP_PRE(((env != NULL)), "(!= env nil)");
    {
        ...
        if (string_eq(op, SLOP_STR("if"))) {
            ...
            if (len > 1) {
                __auto_type _mv_274 = ({ __auto_type _lst = items; size_t _idx = (size_t)(len - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_274.has_value) {
                    __auto_type last = _mv_274.value;
            ...
            if (len >= 2) {
                ...
                if (_mv_275.has_value) {
                    __auto_type binding_form = _mv_275.value;
                    if (parser_sexpr_is_list(binding_form)) {
                        {
                            __auto_type bind_len = parser_sexpr_list_len(binding_form);
                            if (bind_len >= 3) {
                                __auto_type _mv_276 = parser_sexpr_list_get(binding_form, 0);
                                if (_mv_276.has_value) {
                                    __auto_type var_expr = _mv_276.value;
                                    {
                                        ...
                                        if (!(string_eq(var_name, SLOP_STR("")))) {
                                            ...
                                            __auto_type _mv_277 = parser_sexpr_list_get(binding_form, 1);
                                            if (_mv_277.has_value) {
                                                __auto_type start_expr = _mv_277.value;
                                                {
                                                    __auto_type _ = infer_infer_expr(env, start_expr);
                                                }
                                            } else if (!_mv_277.has_value) {
                                            }
                                            __auto_type _mv_278 = parser_sexpr_list_get(binding_form, 2);
                                            if (_mv_278.has_value) {
                                                __auto_type end_expr = _mv_278.value;
                                                {
                                            ...
                                            for (int64_t body_idx = 2; body_idx < len; body_idx++) {
                                                __auto_type _mv_279 = ({ __auto_type _lst = items; size_t _idx = (size_t)body_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            ...
            if (len >= 3) {
                ...
                if (_mv_280.has_value) {
                    __auto_type binding_form = _mv_280.value;
                    if (parser_sexpr_is_list(binding_form)) {
                        {
                            __auto_type bind_len = parser_sexpr_list_len(binding_form);
                            if (bind_len >= 2) {
                                __auto_type _mv_281 = parser_sexpr_list_get(binding_form, 0);
                                if (_mv_281.has_value) {
                                    __auto_type var_expr = _mv_281.value;
                                    {
                                        __auto_type var_name = parser_sexpr_get_symbol_name(var_expr);
                                        if (string_eq(var_name, SLOP_STR(""))) {
                                            return env_env_get_unit_type(env);
                                        } else {
                                            __auto_type _mv_282 = parser_sexpr_list_get(binding_form, 1);
                                            if (_mv_282.has_value) {
                                                __auto_type coll_expr = _mv_282.value;
                                                {
                                                    ...
                                                    __auto_type coll_col = parser_sexpr_col(coll_expr);
                                                    {
                                                        ...
                                                        for (int64_t body_idx = 2; body_idx < len; body_idx++) {
                                                            __auto_type _mv_283 = ({ __auto_type _lst = items; size_t _idx = (size_t)body_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                            if (_mv_283.has_value) {
                                                                __auto_type body_expr = _mv_283.value;
                                                                {
                                                                    __auto_type _ = infer_infer_expr(env, body_expr);
                                                                }
            ...
            if (len >= 2) {
                ...
                if (_mv_284.has_value) {
                    __auto_type params_expr = _mv_284.value;
                    if (parser_sexpr_is_list(params_expr)) {
                        {
                            ...
                            for (int64_t k = 0; k < num_params; k++) {
                                __auto_type _mv_285 = parser_sexpr_list_get(params_expr, k);
                                if (_mv_285.has_value) {
                                    __auto_type param_form = _mv_285.value;
            ...
            if (len >= 4) {
                __auto_type _mv_286 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            ...
            if (len >= 2) {
                ...
                if (_mv_288.has_value) {
                    __auto_type ret_expr = _mv_288.value;
                    {
            ...
            if (len >= 2) {
                ...
                if (_mv_291.has_value) {
                    __auto_type inner_expr = _mv_291.value;
                    {
                    ...
                    __auto_type type_expr = _mv_292.value;
                    {
                        ...
                        if (string_eq(type_name, SLOP_STR(""))) {
                            if (parser_sexpr_is_list(type_expr)) {
                                __auto_type _mv_293 = parser_sexpr_list_get(type_expr, 0);
                                if (_mv_293.has_value) {
                                    __auto_type head_expr = _mv_293.value;
                                    {
                            ...
                            __auto_type _mv_294 = env_env_lookup_type(env, type_name);
            ...
            if (len >= 2) {
                ...
                if (_mv_295.has_value) {
                    __auto_type variant_expr = _mv_295.value;
                    {
                        __auto_type variant_name = parser_sexpr_get_symbol_name(variant_expr);
                        if (string_eq(variant_name, SLOP_STR(""))) {
                            return env_env_get_unknown_type(env);
                        } else {
                            __auto_type _mv_296 = env_env_lookup_variant(env, variant_name);
                            if (_mv_296.has_value) {
                                __auto_type enum_name = _mv_296.value;
                                __auto_type _mv_297 = env_env_lookup_type(env, enum_name);
            ...
            if (len >= 2) {
                ...
                if (_mv_298.has_value) {
                    __auto_type inner_expr = _mv_298.value;
                    {
                        __auto_type inner_type = infer_infer_expr(env, inner_expr);
            ...
            for (int64_t fi = 2; fi < len; fi++) {
                __auto_type _mv_299 = ({ __auto_type _lst = items; size_t _idx = (size_t)fi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_299.has_value) {
                    __auto_type field_pair = _mv_299.value;
                    if (parser_sexpr_is_list(field_pair) && (parser_sexpr_list_len(field_pair) >= 2)) {
                        __auto_type _mv_300 = parser_sexpr_list_get(field_pair, 1);
            ...
            if (len >= 2) {
                ...
                if (_mv_301.has_value) {
                    __auto_type type_expr = _mv_301.value;
                    {
                        __auto_type type_name = parser_sexpr_get_symbol_name(type_expr);
                        if (string_eq(type_name, SLOP_STR(""))) {
                            return env_env_get_unit_type(env);
                        } else {
                            __auto_type _mv_302 = env_env_lookup_type(env, type_name);
                            if (_mv_302.has_value) {
                                __auto_type t = _mv_302.value;
                                return t;
            ...
            __auto_type _mv_306 = env_env_lookup_function(env, op);
            if (_mv_306.has_value) {
                __auto_type sig = _mv_306.value;
                ...
                __auto_type _mv_307 = env_env_lookup_type(env, op);
                if (_mv_307.has_value) {
                    __auto_type the_type = _mv_307.value;
                    return the_type;
                    ...
                    if (string_eq(op, SLOP_STR("list-get"))) {
                        ...
                        if (len < 3) {
                            ...
                            if (_mv_310.has_value) {
                                __auto_type type_expr = _mv_310.value;
                                {
                                    ...
                                    if (string_eq(type_name, SLOP_STR(""))) {
                                        if (parser_sexpr_is_list(type_expr)) {
                                            __auto_type _mv_311 = parser_sexpr_list_get(type_expr, 0);
                                            if (_mv_311.has_value) {
                                                __auto_type head_expr = _mv_311.value;
                                                if (string_eq(parser_sexpr_get_symbol_name(head_expr), SLOP_STR("sizeof"))) {
                                                    __auto_type _mv_312 = parser_sexpr_list_get(type_expr, 1);
                                                    if (_mv_312.has_value) {
                                                        __auto_type sizeof_type_expr = _mv_312.value;
                                                        {
                                                            __auto_type sizeof_type_name = parser_sexpr_get_symbol_name(sizeof_type_expr);
                                                            if (string_eq(sizeof_type_name, SLOP_STR(""))) {
                                                                return env_env_get_int_type(env);
                                                            } else {
                                                                __auto_type _mv_313 = env_env_lookup_type(env, sizeof_type_name);
                                                                if (_mv_313.has_value) {
                                                                    __auto_type resolved = _mv_313.value;
                                        ...
                                        __auto_type _mv_314 = env_env_lookup_type(env, type_name);
                        ...
                        infer_check_builtin_args(env, SLOP_STR("list-new"), 2, (len - 1), line, col);
                        {
                            ...
                            if (len >= 3) {
                                ...
                                if (_mv_315.has_value) {
                                    __auto_type type_expr = _mv_315.value;
                                    {
                            ...
                            if (len >= 3) {
                                ...
                                if (_mv_320.has_value) {
                                    __auto_type type_expr = _mv_320.value;
                                    {
                                        __auto_type type_name = parser_sexpr_get_symbol_name(type_expr);
                                        if (!(string_eq(type_name, SLOP_STR("")))) {
                                            __auto_type _mv_321 = env_env_lookup_type(env, type_name);
                                            if (_mv_321.has_value) {
                                                __auto_type t = _mv_321.value;
                                                key_type = t;
                        ...
                        infer_check_builtin_args(env, SLOP_STR("map-get"), 2, (len - 1), line, col);
                        {
                            ...
                            if (len >= 2) {
                                ...
                                if (_mv_324.has_value) {
                                    __auto_type map_expr = _mv_324.value;
                                    {
                                        __auto_type map_type = infer_infer_expr(env, map_expr);
                                        __auto_type _mv_325 = (*map_type).inner_type2;
                                        if (_mv_325.has_value) {
                                            __auto_type inner = _mv_325.value;
                                            val_type = inner;
                        ...
                        if (len >= 2) {
                            ...
                            if (_mv_326.has_value) {
                                __auto_type map_expr = _mv_326.value;
                                {
                                    __auto_type map_type = infer_infer_expr(env, map_expr);
                        ...
                        infer_check_builtin_args(env, SLOP_STR("map-keys"), 1, (len - 1), line, col);
                        {
                            ...
                            if (len >= 2) {
                                ...
                                if (_mv_327.has_value) {
                                    ...
                                    {
                                        __auto_type map_type = infer_infer_expr(env, map_expr);
                                        __auto_type _mv_328 = (*map_type).inner_type;
                        ...
                        infer_check_builtin_args(env, SLOP_STR("set-elements"), 1, (len - 1), line, col);
                        {
                            ...
                            if (len >= 2) {
                                ...
                                if (_mv_331.has_value) {
                                    __auto_type set_expr = _mv_331.value;
                                    {
                                        __auto_type set_type = infer_infer_expr(env, set_expr);
                                        __auto_type _mv_332 = (*set_type).inner_type;
                                        if (_mv_332.has_value) {
                                            __auto_type inner = _mv_332.value;
                                            elem_type = inner;
                        ...
                        {
                            __auto_type arena = env_env_arena(env);
                            __auto_type _mv_333 = env_env_lookup_variant(env, op);
                            if (_mv_333.has_value) {
                                __auto_type parent_type = _mv_333.value;
                                {
                                ...
                                if (strlib_starts_with(op, SLOP_STR("set-")) || (strlib_starts_with(op, SLOP_STR("map-")) || (strlib_starts_with(op, SLOP_STR("list-")) || strlib_starts_with(op, SLOP_STR("arena-"))))) {
                                    ...
                                    __auto_type _mv_334 = env_env_lookup_var(env, op);
                                    if (_mv_334.has_value) {
                                        __auto_type var_type = _mv_334.value;
                                        infer_infer_builtin_args(env, expr);
                                        return var_type;
...
void infer_check_single_arg(env_TypeEnv* env, types_FnSignature* sig, types_SExpr* expr, int64_t arg_idx, int64_t line, int64_t col) {
    ...
    SLOP_PRE(((sig != NULL)), "(!= sig nil)");
    {
        ...
        __auto_type fn_name = (*sig).name;
        __auto_type arena = env_env_arena(env);
        __auto_type _mv_335 = ({ __auto_type _lst = params; size_t _idx = (size_t)arg_idx; slop_option_types_ParamInfo _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        if (_mv_335.has_value) {
            __auto_type param_info = _mv_335.value;
            {
                __auto_type expected_type = param_info.param_type;
                __auto_type _mv_336 = parser_sexpr_list_get(expr, (arg_idx + 1));
                if (_mv_336.has_value) {
                    __auto_type arg_expr = _mv_336.value;
                    {
                        __auto_type actual_type = infer_infer_expr(env, arg_expr);
    ...
    SLOP_PRE(((t != NULL)), "(!= t nil)");
    {
        ...
        while (!(done) && (steps < 64)) {
            if (((*cur).kind == types_ResolvedTypeKind_rk_primitive) && !(strlib_ends_with((*cur).c_name, SLOP_STR("*")))) {
                __auto_type _mv_337 = (*cur).inner_type;
                if (_mv_337.has_value) {
                    __auto_type next = _mv_337.value;
                    cur = next;
                    steps = (steps + 1);
    ...
    if (parser_sexpr_is_list(expr)) {
        {
            ...
            for (int64_t i = 1; i < len; i++) {
                __auto_type _mv_339 = parser_sexpr_list_get(expr, i);
                if (_mv_339.has_value) {
                    __auto_type arg_expr = _mv_339.value;
                    {
    ...
    SLOP_PRE(((env != NULL)), "(!= env nil)");
    {
        ...
        if (len < 3) {
            ...
            if (!_mv_341.has_value) {
                ...
                __auto_type obj_expr = _mv_341.value;
                {
                    ...
                    if (!_mv_342.has_value) {
                        ...
                        __auto_type field_expr = _mv_342.value;
                        __auto_type _mv_343 = (*field_expr);
                        switch (_mv_343.tag) {
                            case types_SExpr_sym:
                            {
                                __auto_type field_sym = _mv_343.data.sym;
                                {
    ...
    SLOP_PRE(((obj_type != NULL)), "(!= obj-type nil)");
    {
        ...
        if (infer_type_is_null_pointer(obj_type)) {
            ...
            if (types_resolved_type_is_record(obj_type)) {
                __auto_type _mv_344 = types_resolved_type_get_field_type(obj_type, field_name);
                if (_mv_344.has_value) {
                    __auto_type field_type = _mv_344.value;
                    return field_type;
                    ...
                    if (string_eq(type_name, SLOP_STR("String"))) {
                        ...
                        if (string_eq(type_name, SLOP_STR("Unknown"))) {
                            ...
                            if (types_resolved_type_is_pointer(obj_type)) {
                                __auto_type _mv_345 = (*obj_type).inner_type;
                                if (_mv_345.has_value) {
                                    __auto_type inner_type = _mv_345.value;
...
types_ResolvedType* infer_infer_cond_expr(env_TypeEnv* env, types_SExpr* expr, types_SExprList lst) {
    SLOP_PRE(((env != NULL)), "(!= env nil)");
    {
        ...
        int64_t i = 1;
        while (i < len) {
            __auto_type _mv_346 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_346.has_value) {
                __auto_type clause = _mv_346.value;
                __auto_type _mv_347 = (*clause);
                switch (_mv_347.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type clause_lst = _mv_347.data.lst;
                        {
                            ...
                            if (clause_len > 1) {
                                for (int64_t ci = 0; ci < (clause_len - 1); ci++) {
                                    __auto_type _mv_348 = ({ __auto_type _lst = clause_items; size_t _idx = (size_t)ci; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    if (_mv_348.has_value) {
                                        __auto_type clause_elem = _mv_348.value;
                                        {
                                ...
                                if (_mv_349.has_value) {
                                    __auto_type body = _mv_349.value;
                                    {
...
void infer_bind_match_pattern(env_TypeEnv* env, types_ResolvedType* scrutinee_type, types_SExpr* pattern) {
    ...
    if (parser_sexpr_is_list(pattern)) {
        if (parser_sexpr_list_len(pattern) > 0) {
            __auto_type _mv_350 = parser_sexpr_list_get(pattern, 0);
            if (_mv_350.has_value) {
                __auto_type variant_expr = _mv_350.value;
                {
                    __auto_type variant_name = parser_sexpr_get_symbol_name(variant_expr);
                    if (!(string_eq(variant_name, SLOP_STR("")))) {
                        if (parser_sexpr_list_len(pattern) > 1) {
                            __auto_type _mv_351 = parser_sexpr_list_get(pattern, 1);
                            if (_mv_351.has_value) {
                                __auto_type binding_expr = _mv_351.value;
                                {
                                    ...
                                    if (!(string_eq(binding_name, SLOP_STR("")))) {
                                        {
                                            ...
                                            if (string_eq(scrutinee_name, SLOP_STR("T"))) {
                                                ...
                                                if ((scrutinee_kind == types_ResolvedTypeKind_rk_option) && string_eq(variant_name, SLOP_STR("some"))) {
                                                    __auto_type _mv_352 = (*scrutinee_type).inner_type;
                                                    ...
                                                    if (scrutinee_kind == types_ResolvedTypeKind_rk_result) {
                                                        if (string_eq(variant_name, SLOP_STR("ok"))) {
                                                            __auto_type _mv_353 = (*scrutinee_type).inner_type;
                                                            if (_mv_353.has_value) {
                                                                __auto_type inner = _mv_353.value;
                                                                env_env_bind_var(env, binding_name, inner);
                                                            } else if (!_mv_353.has_value) {
                                                                env_env_bind_var(env, binding_name, env_env_get_generic_type(env));
                                                            }
                                                        } else if (string_eq(variant_name, SLOP_STR("error"))) {
                                                            __auto_type _mv_354 = (*scrutinee_type).inner_type2;
                                                            if (_mv_354.has_value) {
                                                                __auto_type inner2 = _mv_354.value;
                                                    ...
                                                    } else {
                                                        {
                                                            ...
                                                            if (((int64_t)((payload_types).len)) > 0) {
                                                                if (!(string_eq(binding_name, SLOP_STR("true"))) && !(string_eq(binding_name, SLOP_STR("false")))) {
                                                                    __auto_type _mv_355 = ({ __auto_type _lst = payload_types; size_t _idx = (size_t)0; slop_option_types_ResolvedType_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                                    if (_mv_355.has_value) {
                                                                        __auto_type first_type = _mv_355.value;
                                                                ...
                                                                }
                                                                {
                                                                    ...
                                                                    for (int64_t pi = 2; pi < pat_len; pi++) {
                                                                        __auto_type _mv_356 = parser_sexpr_list_get(pattern, pi);
                                                                        if (_mv_356.has_value) {
                                                                            __auto_type extra_binding = _mv_356.value;
                                                                            {
                                                                                ...
                                                                                if ((!(string_eq(extra_name, SLOP_STR("")))) && (!(string_eq(extra_name, SLOP_STR("_")))) && (!(string_eq(extra_name, SLOP_STR("true")))) && (!(string_eq(extra_name, SLOP_STR("false"))))) {
                                                                                    {
                                                                                        ...
                                                                                        if (type_idx < num_types) {
                                                                                            __auto_type _mv_357 = ({ __auto_type _lst = payload_types; size_t _idx = (size_t)type_idx; slop_option_types_ResolvedType_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                                                            if (_mv_357.has_value) {
                                                                                                __auto_type pt = _mv_357.value;
...
slop_string infer_match_pattern_head(types_SExpr* pattern) {
    ...
    if (parser_sexpr_is_list(pattern)) {
        if (parser_sexpr_list_len(pattern) > 0) {
            __auto_type _mv_358 = parser_sexpr_list_get(pattern, 0);
...
uint8_t infer_string_list_contains(slop_list_string names, slop_string name) {
    {
        ...
        uint8_t found = 0;
        while ((i < n) && !(found)) {
            __auto_type _mv_359 = ({ __auto_type _lst = names; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_359.has_value) {
                __auto_type existing = _mv_359.value;
        ...
        if ((kind == types_ResolvedTypeKind_rk_union) || (kind == types_ResolvedTypeKind_rk_enum)) {
            {
                ...
                int64_t i = 0;
                while (i < n) {
                    __auto_type _mv_360 = ({ __auto_type _lst = variants; size_t _idx = (size_t)i; slop_option_types_ResolvedVariant _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_360.has_value) {
                        __auto_type v = _mv_360.value;
            ...
            if ((((int64_t)((expected).len)) > 0) && !(string_eq(type_name, SLOP_STR("T")))) {
                {
                    ...
                    while (i < n) {
                        __auto_type _mv_361 = ({ __auto_type _lst = covered; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    ...
                    if (all_known) {
                        {
                            ...
                            int64_t j = 0;
                            while (j < e_len) {
                                __auto_type _mv_362 = ({ __auto_type _lst = expected; size_t _idx = (size_t)j; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_362.has_value) {
                                    __auto_type want = _mv_362.value;
...
types_ResolvedType* infer_infer_match_expr(env_TypeEnv* env, types_SExpr* expr, types_SExprList lst) {
    SLOP_PRE(((env != NULL)), "(!= env nil)");
    {
        ...
        int64_t i = 2;
        while (i < len) {
            __auto_type _mv_363 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_363.has_value) {
                __auto_type clause = _mv_363.value;
                __auto_type _mv_364 = (*clause);
                switch (_mv_364.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type clause_lst = _mv_364.data.lst;
                        {
                            ...
                            __auto_type clause_len = ((int64_t)((clause_items).len));
                            if (clause_len > 0) {
                                __auto_type _mv_365 = ({ __auto_type _lst = clause_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_365.has_value) {
                                    __auto_type pattern = _mv_365.value;
                                    {
                            ...
                            if (clause_len > 1) {
                                env_env_push_scope(env);
                                __auto_type _mv_366 = ({ __auto_type _lst = clause_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                ...
                                for (int64_t bi = 1; bi < (clause_len - 1); bi++) {
                                    __auto_type _mv_367 = ({ __auto_type _lst = clause_items; size_t _idx = (size_t)bi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                ...
                                __auto_type _mv_368 = ({ __auto_type _lst = clause_items; size_t _idx = (size_t)(clause_len - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void infer_check_return_type(env_TypeEnv* env, types_SExpr* fn_form, slop_string fn_name, types_ResolvedType* inferred_type, int64_t fn_line, int64_t fn_col) {
    ...
    __auto_type _mv_369 = (*fn_form);
    switch (_mv_369.tag) {
        case types_SExpr_lst:
        {
            __auto_type fn_lst = _mv_369.data.lst;
            {
                ...
                for (int64_t i = 3; i < len; i++) {
                    ...
                    if (_mv_370.has_value) {
                        __auto_type item = _mv_370.value;
...
void infer_check_spec_return_type(env_TypeEnv* env, types_SExpr* spec_form, slop_string fn_name, types_ResolvedType* inferred_type, int64_t fn_line, int64_t fn_col) {
    ...
    __auto_type _mv_371 = (*spec_form);
    switch (_mv_371.tag) {
        case types_SExpr_lst:
        {
            __auto_type spec_lst = _mv_371.data.lst;
            {
                __auto_type spec_items = spec_lst.items;
                __auto_type _mv_372 = ({ __auto_type _lst = spec_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_372.has_value) {
                    __auto_type spec_body = _mv_372.value;
...
void infer_check_spec_body_return(env_TypeEnv* env, types_SExpr* spec_body, slop_string fn_name, types_ResolvedType* inferred_type, int64_t fn_line, int64_t fn_col) {
    ...
    __auto_type _mv_373 = (*spec_body);
    switch (_mv_373.tag) {
        case types_SExpr_lst:
        {
            __auto_type body_lst = _mv_373.data.lst;
            {
                __auto_type body_items = body_lst.items;
                __auto_type body_len = ((int64_t)((body_items).len));
                __auto_type _mv_374 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)(body_len - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_374.has_value) {
                    __auto_type ret_expr = _mv_374.value;
...
void infer_check_return_expr(env_TypeEnv* env, types_SExpr* ret_expr, slop_string fn_name, types_ResolvedType* inferred_type, int64_t fn_line, int64_t fn_col) {
    ...
    __auto_type _mv_375 = (*ret_expr);
    switch (_mv_375.tag) {
        case types_SExpr_sym:
        {
            __auto_type ret_sym = _mv_375.data.sym;
            {
...
void infer_bind_param_from_form(env_TypeEnv* env, types_SExpr* param_form) {
    ...
    if (parser_sexpr_is_list(param_form) && (parser_sexpr_list_len(param_form) >= 2)) {
        __auto_type _mv_376 = parser_sexpr_list_get(param_form, 0);
        if (_mv_376.has_value) {
            __auto_type first_expr = _mv_376.value;
            {
                ...
                if ((string_eq(first_name, SLOP_STR("in"))) || (string_eq(first_name, SLOP_STR("out"))) || (string_eq(first_name, SLOP_STR("mut")))) {
                    if (parser_sexpr_list_len(param_form) >= 3) {
                        __auto_type _mv_377 = parser_sexpr_list_get(param_form, 1);
...
types_ResolvedType* infer_get_param_type_from_form(env_TypeEnv* env, types_SExpr* param_form) {
    ...
    SLOP_PRE(((param_form != NULL)), "(!= param-form nil)");
    {
        ...
        __auto_type _mv_378 = parser_sexpr_list_get(param_form, type_pos);
...
types_ResolvedType* infer_resolve_complex_type_expr(env_TypeEnv* env, types_SExpr* type_expr) {
    ...
    __auto_type _mv_379 = parser_sexpr_list_get(type_expr, 0);
    if (_mv_379.has_value) {
        __auto_type head_expr = _mv_379.value;
        {
            __auto_type head_name = parser_sexpr_get_symbol_name(head_expr);
            if (string_eq(head_name, SLOP_STR("Option"))) {
            ...
            } else if (string_eq(head_name, SLOP_STR("Map"))) {
                {
                    ...
                    if (parser_sexpr_list_len(type_expr) >= 3) {
                        __auto_type _mv_380 = parser_sexpr_list_get(type_expr, 2);
            ...
            } else if (string_eq(head_name, SLOP_STR("Result"))) {
                {
                    ...
                    if (parser_sexpr_list_len(type_expr) >= 2) {
                        __auto_type _mv_381 = parser_sexpr_list_get(type_expr, 1);
                        if (_mv_381.has_value) {
                            __auto_type ok_expr = _mv_381.value;
                            {
                    ...
                    if (parser_sexpr_list_len(type_expr) >= 3) {
                        __auto_type _mv_382 = parser_sexpr_list_get(type_expr, 2);
                        if (_mv_382.has_value) {
                            __auto_type err_expr = _mv_382.value;
                            {
                ...
                __auto_type _mv_383 = env_env_lookup_type(env, head_name);
                if (_mv_383.has_value) {
                    __auto_type t = _mv_383.value;
                    return t;
...
types_ResolvedType* infer_resolve_option_inner_type(env_TypeEnv* env, types_SExpr* type_expr) {
    ...
    if (parser_sexpr_list_len(type_expr) < 2) {
        ...
        __auto_type _mv_384 = parser_sexpr_list_get(type_expr, 1);
        if (_mv_384.has_value) {
            __auto_type inner_expr = _mv_384.value;
            {
...
types_ResolvedType* infer_resolve_ptr_inner_type(env_TypeEnv* env, types_SExpr* type_expr) {
    ...
    if (parser_sexpr_list_len(type_expr) < 2) {
        ...
        __auto_type _mv_385 = parser_sexpr_list_get(type_expr, 1);
        if (_mv_385.has_value) {
            __auto_type inner_expr = _mv_385.value;
            {
                __auto_type inner_name = parser_sexpr_get_symbol_name(inner_expr);
                if (string_eq(inner_name, SLOP_STR(""))) {
...
types_ResolvedType* infer_resolve_simple_type(env_TypeEnv* env, slop_string type_name) {
    SLOP_PRE(((env != NULL)), "(!= env nil)");
    __auto_type _mv_387 = env_env_lookup_type(env, type_name);
    if (_mv_387.has_value) {
        __auto_type t = _mv_387.value;
        return t;
...
void infer_bind_let_binding(env_TypeEnv* env, types_SExpr* binding_form) {
    ...
    if (parser_sexpr_is_list(binding_form) && (parser_sexpr_list_len(binding_form) >= 2)) {
        __auto_type _mv_388 = parser_sexpr_list_get(binding_form, 0);
        if (_mv_388.has_value) {
            __auto_type first_expr = _mv_388.value;
            {
                __auto_type first_name = parser_sexpr_get_symbol_name(first_expr);
                if (string_eq(first_name, SLOP_STR("mut"))) {
                    if (parser_sexpr_list_len(binding_form) >= 3) {
                        __auto_type _mv_389 = parser_sexpr_list_get(binding_form, 1);
                                ...
                                if (!(string_eq(var_name, SLOP_STR("")))) {
                                    {
                                        ...
                                        __auto_type _mv_390 = parser_sexpr_list_get(binding_form, (binding_len - 1));
                    ...
                    if (!(string_eq(first_name, SLOP_STR("")))) {
                        {
                            __auto_type binding_len = parser_sexpr_list_len(binding_form);
                            if (binding_len == 3) {
                                __auto_type _mv_391 = parser_sexpr_list_get(binding_form, 2);
                                if (_mv_391.has_value) {
                                    __auto_type val_expr = _mv_391.value;
                                    {
                                        __auto_type val_type = infer_infer_expr(env, val_expr);
                                ...
                                __auto_type _mv_392 = parser_sexpr_list_get(binding_form, 1);
...
types_ResolvedType* infer_infer_let_expr(env_TypeEnv* env, types_SExpr* expr) {
    ...
    env_env_push_scope(env);
    if (parser_sexpr_is_list(expr)) {
        __auto_type _mv_393 = parser_sexpr_list_get(expr, 1);
        if (_mv_393.has_value) {
            __auto_type bindings_expr = _mv_393.value;
            if (parser_sexpr_is_list(bindings_expr)) {
                {
                    ...
                    for (int64_t i = 0; i < num_bindings; i++) {
                        __auto_type _mv_394 = parser_sexpr_list_get(bindings_expr, i);
        ...
        if (len < 2) {
        ...
        } else {
            {
                ...
                if (is_named && (len < 4)) {
                    ...
                    __auto_type _mv_395 = parser_sexpr_list_get(expr, size_idx);
                    if (_mv_395.has_value) {
                        __auto_type size_expr = _mv_395.value;
                        __auto_type _mv_396 = (*size_expr);
                        switch (_mv_396.tag) {
                            case types_SExpr_num:
                            {
                                __auto_type num = _mv_396.data.num;
                                if (num.int_value <= 0) {
                    ...
                    env_env_bind_var(env, arena_name, env_env_get_arena_type(env));
                    {
                        ...
                        for (int64_t i = body_start; i < len; i++) {
                            __auto_type _mv_397 = parser_sexpr_list_get(expr, i);
                            if (_mv_397.has_value) {
                                __auto_type body_expr = _mv_397.value;
...
slop_string infer_get_fn_name(types_SExpr* fn_form) {
    ...
    if (!(parser_sexpr_is_list(fn_form))) {
        ...
        if (parser_sexpr_list_len(fn_form) < 2) {
            ...
            __auto_type _mv_398 = parser_sexpr_list_get(fn_form, 1);
...
slop_string infer_get_hole_prompt(slop_list_types_SExpr_ptr items, int64_t len) {
    if (len < 3) {
        ...
        __auto_type _mv_401 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        if (_mv_401.has_value) {
            __auto_type prompt_expr = _mv_401.value;
            __auto_type _mv_402 = (*prompt_expr);
            switch (_mv_402.tag) {
                case types_SExpr_str:
                {
                    __auto_type str = _mv_402.data.str;
                    return str.value;
                }
                default: {
                    return SLOP_STR("(no description)");
...
uint8_t infer_is_c_name_related(slop_list_types_SExpr_ptr items, int64_t idx) {
    __auto_type _mv_403 = ({ __auto_type _lst = items; size_t _idx = (size_t)idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    if (_mv_403.has_value) {
        __auto_type item = _mv_403.value;
        __auto_type _mv_404 = (*item);
        switch (_mv_404.tag) {
            case types_SExpr_sym:
            {
            ...
            case types_SExpr_str:
            {
                __auto_type _ = _mv_404.data.str;
                if (idx > 0) {
                    __auto_type _mv_405 = ({ __auto_type _lst = items; size_t _idx = (size_t)(idx - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_405.has_value) {
                        __auto_type prev = _mv_405.value;
                        __auto_type _mv_406 = (*prev);
                        switch (_mv_406.tag) {
                            case types_SExpr_sym:
                            {
...
uint8_t infer_is_annotation_expr(types_SExpr* expr) {
    SLOP_PRE(((expr != NULL)), "(!= expr nil)");
    if (parser_sexpr_is_list(expr)) {
        __auto_type _mv_407 = parser_sexpr_list_get(expr, 0);
...
uint8_t infer_is_checkable_annotation(types_SExpr* expr) {
    if (parser_sexpr_is_list(expr)) {
        __auto_type _mv_409 = parser_sexpr_list_get(expr, 0);
        ...
        if (parser_sexpr_is_list(fn_form)) {
            {
                ...
                if (params_len > 2) {
                    __auto_type _mv_411 = parser_sexpr_list_get(fn_form, 2);
                    if (_mv_411.has_value) {
                        __auto_type params_expr = _mv_411.value;
                        if (parser_sexpr_is_list(params_expr)) {
                            {
                                __auto_type num_params = parser_sexpr_list_len(params_expr);
                                for (int64_t k = 0; k < num_params; k++) {
                                    __auto_type _mv_412 = parser_sexpr_list_get(params_expr, k);
                                    if (_mv_412.has_value) {
                                        __auto_type param_form = _mv_412.value;
                                        infer_bind_param_from_form(env, param_form);
    ...
    if (types_resolved_type_is_union(scrutinee_type)) {
        {
            ...
            for (int64_t i = 0; i < num_patterns; i++) {
                __auto_type _mv_413 = ({ __auto_type _lst = patterns; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_413.has_value) {
                    __auto_type pattern_case = _mv_413.value;
                    __auto_type _mv_414 = (*pattern_case);
                    switch (_mv_414.tag) {
                        case types_SExpr_lst:
                        {
                            __auto_type pattern_list = _mv_414.data.lst;
                            if (((int64_t)((pattern_list.items).len)) > 0) {
                                __auto_type _mv_415 = ({ __auto_type _lst = pattern_list.items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_415.has_value) {
                                    __auto_type pattern_expr = _mv_415.value;
                                    __auto_type _mv_416 = (*pattern_expr);
                                    switch (_mv_416.tag) {
                                        case types_SExpr_lst:
                                        {
                                            __auto_type variant_list = _mv_416.data.lst;
                                            {
                                                __auto_type variant_items = variant_list.items;
                                                if (((int64_t)((variant_items).len)) > 0) {
                                                    __auto_type _mv_417 = ({ __auto_type _lst = variant_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_417.has_value) {
                                                        __auto_type variant_name_expr = _mv_417.value;
                                                        __auto_type _mv_418 = (*variant_name_expr);
                                                        switch (_mv_418.tag) {
                                                            case types_SExpr_sym:
                                                            {
                                                                __auto_type variant_sym = _mv_418.data.sym;
                                                                {
                                                                        ...
                                                                        if (num_pt > 0) {
                                                                            {
                                                                                ...
                                                                                for (int64_t vi = 1; vi < num_vt; vi++) {
                                                                                    __auto_type _mv_419 = ({ __auto_type _lst = variant_items; size_t _idx = (size_t)vi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                                                    if (_mv_419.has_value) {
                                                                                        __auto_type binding_expr = _mv_419.value;
                                                                                        __auto_type _mv_420 = (*binding_expr);
                                                                                        switch (_mv_420.tag) {
                                                                                            case types_SExpr_sym:
                                                                                            {
                                                                                                __auto_type binding_sym = _mv_420.data.sym;
                                                                                                {
                                                                                                    __auto_type bname = binding_sym.name;
                                                                                                    __auto_type type_idx = (vi - 1);
                                                                                                    if (!(string_eq(bname, SLOP_STR("_"))) && !(string_eq(bname, SLOP_STR("")))) {
                                                                                                        if (type_idx < num_pt) {
                                                                                                            __auto_type _mv_421 = ({ __auto_type _lst = payload_types; size_t _idx = (size_t)type_idx; slop_option_types_ResolvedType_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                                                                            if (_mv_421.has_value) {
                                                                                                                __auto_type pt = _mv_421.value;
                                                                            ...
                                                                            __auto_type _mv_422 = types_resolved_type_get_variant_index(scrutinee_type, variant_name);
