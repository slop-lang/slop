                    ...
                    case types_SExpr_lst:
                    {
                        __auto_type lst = _mv_1252.data.lst;
                        {
                            ...
                            if (((int64_t)((sub_items).len)) >= 1) {
                                __auto_type _mv_1253 = ({ __auto_type _lst = sub_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        ...
                                        case types_SExpr_sym:
                                        {
                                            ...
                                            if (string_eq(sym.name, SLOP_STR("@generic"))) {
                                                if (((int64_t)((sub_items).len)) >= 2) {
                                                    __auto_type _mv_1255 = ({ __auto_type _lst = sub_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_1255.has_value) {
                                                        __auto_type params_expr = _mv_1255.value;
                                                        __auto_type _mv_1256 = (*params_expr);
                                                        switch (_mv_1256.tag) {
                                                            case types_SExpr_lst:
                                                            {
                                                                __auto_type params_lst = _mv_1256.data.lst;
                                                                {
                                                                    __auto_type param_items = params_lst.items;
                                                                    __auto_type param_len = ((int64_t)((param_items).len));
                                                                    __auto_type j = 0;
                                                                    while (j < param_len) {
                                                                        __auto_type _mv_1257 = ({ __auto_type _lst = param_items; size_t _idx = (size_t)j; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                                        if (_mv_1257.has_value) {
                                                                            __auto_type param = _mv_1257.value;
                                                                            __auto_type _mv_1258 = (*param);
                                                                            switch (_mv_1258.tag) {
                                                                                case types_SExpr_sym:
                                                                                {
                                                                                    __auto_type param_sym = _mv_1258.data.sym;
                                                            ...
                                                            case types_SExpr_sym:
                                                            {
                                                                __auto_type single_sym = _mv_1256.data.sym;
...
void transpiler_prescan_type(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (((int64_t)((items).len)) >= 2) {
            __auto_type _mv_1263 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1263.has_value) {
                __auto_type name_expr = _mv_1263.value;
                __auto_type _mv_1264 = (*name_expr);
                switch (_mv_1264.tag) {
                    case types_SExpr_sym:
                    {
                            ...
                            __auto_type c_name = ((context_ctx_prefixing_enabled(ctx)) ? ({ __auto_type _mv = context_ctx_get_module(ctx); _mv.has_value ? ({ __auto_type mod_name = _mv.value; context_ctx_str(ctx, ctype_to_c_name(arena, mod_name), context_ctx_str(ctx, SLOP_STR("_"), base_c_name)); }) : (base_c_name); }) : base_c_name);
                            {
                                ...
                                if (((int64_t)((items).len)) >= 3) {
                                    ...
                                    if (_mv_1267.has_value) {
                                        __auto_type body_expr = _mv_1267.value;
            ...
            switch (_mv_1269.tag) {
                case types_SExpr_lst:
                {
                    __auto_type def_lst = _mv_1269.data.lst;
                    {
                        ...
                        __auto_type i = 1;
                        while (i < len) {
                            __auto_type _mv_1270 = ({ __auto_type _lst = def_items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_1270.has_value) {
                                __auto_type variant_expr = _mv_1270.value;
                                __auto_type _mv_1271 = (*variant_expr);
                                switch (_mv_1271.tag) {
                                    case types_SExpr_sym:
                                    {
                                    ...
                                    case types_SExpr_lst:
                                    {
                                        __auto_type variant_lst = _mv_1271.data.lst;
                                        if (((int64_t)((variant_lst.items).len)) > 0) {
                                            __auto_type _mv_1272 = ({ __auto_type _lst = variant_lst.items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_1272.has_value) {
                                                ...
                                                switch (_mv_1273.tag) {
                                                    case types_SExpr_sym:
                                                    {
                                                        __auto_type name_sym = _mv_1273.data.sym;
                                                        ...
                                                        switch (_mv_1279.tag) {
                                                            case types_SExpr_sym:
                                                            {
                                                                __auto_type name_sym = _mv_1279.data.sym;
                                                                {
                                                                    ...
                                                                    context_ctx_register_enum_variant(ctx, variant_name, union_name);
                                                                    __auto_type _mv_1280 = ({ __auto_type _lst = vl_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                                    ...
                                                                    if (vl_len >= 3) {
                                                                        ...
                                                                        for (int64_t fi = 1; fi < vl_len; fi++) {
                                                                            __auto_type _mv_1281 = ({ __auto_type _lst = vl_items; size_t _idx = (size_t)fi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    ...
                                    switch (_mv_1289.tag) {
                                        case types_SExpr_sym:
                                        {
                                            ...
                                            if (string_eq(sym.name, SLOP_STR("@spec"))) {
                                                __auto_type _mv_1290 = ({ __auto_type _lst = sub_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_1290.has_value) {
                                                    __auto_type spec_body = _mv_1290.value;
                                                    __auto_type _mv_1291 = (*spec_body);
                                                    switch (_mv_1291.tag) {
                                                        case types_SExpr_lst:
                                                        {
                                                            __auto_type body_lst = _mv_1291.data.lst;
                                                            {
                                                                __auto_type body_items = body_lst.items;
                                                                __auto_type body_len = ((int64_t)((body_items).len));
                                                                if (body_len >= 1) {
                                                                    __auto_type _mv_1292 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)(body_len - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                                    if (_mv_1292.has_value) {
                                                                        __auto_type ret_type = _mv_1292.value;
                                                                        __auto_type _mv_1293 = (*ret_type);
                                                                        switch (_mv_1293.tag) {
                                                                            case types_SExpr_sym:
                                                                            {
                                                                                __auto_type ret_sym = _mv_1293.data.sym;
...
void transpiler_prescan_fn_params(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    ...
    if (((int64_t)((items).len)) >= 3) {
        ...
        if (_mv_1301.has_value) {
            __auto_type params_expr = _mv_1301.value;
            __auto_type _mv_1302 = (*params_expr);
            switch (_mv_1302.tag) {
                case types_SExpr_lst:
                {
                    __auto_type params_lst = _mv_1302.data.lst;
                    {
                        __auto_type params = params_lst.items;
                        __auto_type param_count = ((int64_t)((params).len));
                        __auto_type i = 0;
                        while (i < param_count) {
                            __auto_type _mv_1303 = ({ __auto_type _lst = params; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_1303.has_value) {
                                __auto_type param_expr = _mv_1303.value;
                                __auto_type _mv_1304 = (*param_expr);
                                switch (_mv_1304.tag) {
                                    case types_SExpr_lst:
                                    {
                                        __auto_type param_lst = _mv_1304.data.lst;
                                        {
                                            __auto_type param_items = param_lst.items;
                                            if (((int64_t)((param_items).len)) >= 2) {
                                                __auto_type _mv_1305 = ({ __auto_type _lst = param_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (((int64_t)((items).len)) >= 3) {
            ...
            if (_mv_1306.has_value) {
                __auto_type params_expr = _mv_1306.value;
                __auto_type _mv_1307 = (*params_expr);
                switch (_mv_1307.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type params_lst = _mv_1307.data.lst;
                        {
                            __auto_type params = params_lst.items;
                            __auto_type param_count = ((int64_t)((params).len));
                            __auto_type i = 0;
                            while (i < param_count) {
                                __auto_type _mv_1308 = ({ __auto_type _lst = params; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1308.has_value) {
                                    __auto_type param_expr = _mv_1308.value;
                                    {
                ...
                __auto_type lst = _mv_1309.data.lst;
                {
                    ...
                    if (len < 2) {
                    ...
                    } else {
                        {
                            ...
                            __auto_type _mv_1310 = ({ __auto_type _lst = items; size_t _idx = (size_t)type_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
uint8_t transpiler_prescan_is_param_mode(slop_list_types_SExpr_ptr items) {
    if (((int64_t)((items).len)) < 1) {
        ...
        if (_mv_1311.has_value) {
            __auto_type first = _mv_1311.value;
            __auto_type _mv_1312 = (*first);
            switch (_mv_1312.tag) {
                case types_SExpr_sym:
                {
...
void transpiler_extract_result_type(context_TranspileContext* ctx, types_SExpr* spec_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1317 = (*spec_expr);
        switch (_mv_1317.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1317.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) >= 2) {
                        ...
                        if (_mv_1318.has_value) {
                            __auto_type spec_body = _mv_1318.value;
                            __auto_type _mv_1319 = (*spec_body);
                            switch (_mv_1319.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type body_lst = _mv_1319.data.lst;
                                    {
                                        __auto_type body_items = body_lst.items;
                                        __auto_type body_len = ((int64_t)((body_items).len));
                                        if (body_len >= 1) {
                                            __auto_type _mv_1320 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)(body_len - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_1320.has_value) {
                                                __auto_type ret_type = _mv_1320.value;
...
void transpiler_check_and_register_result_type(context_TranspileContext* ctx, types_SExpr* type_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1321 = (*type_expr);
        switch (_mv_1321.tag) {
            case types_SExpr_lst:
            {
                                ...
                                case types_SExpr_sym:
                                {
                                    ...
                                    if (string_eq(sym.name, SLOP_STR("Result"))) {
                                        ...
                                        if (_mv_1324.has_value) {
                                            __auto_type ok_type_expr = _mv_1324.value;
                                            ...
                                            if (_mv_1325.has_value) {
                                                __auto_type err_type_expr = _mv_1325.value;
                                                {
                                    ...
                                    if (string_eq(name, SLOP_STR("map-new"))) {
                                        if (len >= 3) {
                                            ...
                                            if (_mv_1330.has_value) {
                                                __auto_type key_type_expr = _mv_1330.value;
                                        ...
                                        if (len >= 3) {
                                            ...
                                            if (_mv_1331.has_value) {
                                                __auto_type elem_type_expr = _mv_1331.value;
                                        ...
                                        if (len >= 4) {
                                            ...
                                            if (_mv_1332.has_value) {
                                                __auto_type type_expr = _mv_1332.value;
                                                {
                                        ...
                                        if (len >= 3) {
                                            ...
                                            if (_mv_1333.has_value) {
                                                __auto_type type_expr = _mv_1333.value;
                                                {
                                                    __auto_type elem_c = context_to_c_type_prefixed(ctx, type_expr);
                                                    __auto_type elem_id = ctype_type_to_identifier((*ctx).arena, elem_c);
                                                    __auto_type c_name = context_ctx_str(ctx, SLOP_STR("slop_chan_"), elem_id);
                                    ...
                                    } else {
                                        {
                                            ...
                                            while (i < len) {
                                                ...
                                                if (_mv_1334.has_value) {
                                                    __auto_type child = _mv_1334.value;
                            ...
                            default: {
                                {
                                    ...
                                    while (i < len) {
                                        ...
                                        if (_mv_1335.has_value) {
                                            __auto_type child = _mv_1335.value;
                                            transpiler_prescan_expr_for_struct_keys(ctx, child);
...
void transpiler_prescan_register_struct_key_type(context_TranspileContext* ctx, types_SExpr* type_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1336 = (*type_expr);
        switch (_mv_1336.tag) {
            case types_SExpr_sym:
            {
                __auto_type sym = _mv_1336.data.sym;
                {
                    ...
                    if (!(transpiler_is_builtin_map_key_type(name))) {
                        __auto_type _mv_1337 = context_ctx_lookup_type(ctx, name);
                        if (_mv_1337.has_value) {
                            ...
                            __auto_type _mv_1338 = context_ctx_get_module(ctx);
                            if (_mv_1338.has_value) {
                                __auto_type mod = _mv_1338.value;
                                {
                                    __auto_type prefixed = context_ctx_str3(ctx, mod, SLOP_STR("_"), name);
                                    __auto_type _mv_1339 = context_ctx_lookup_type(ctx, prefixed);
                                    if (_mv_1339.has_value) {
                                        __auto_type type_entry = _mv_1339.value;
                                        context_ctx_register_struct_key_type(ctx, type_entry.c_name);
...
void transpiler_check_and_register_result_alias(context_TranspileContext* ctx, slop_string alias_name, types_SExpr* body_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1340 = (*body_expr);
        switch (_mv_1340.tag) {
            case types_SExpr_lst:
            {
                                ...
                                case types_SExpr_sym:
                                {
                                    ...
                                    if (string_eq(sym.name, SLOP_STR("Result"))) {
                                        ...
                                        if (_mv_1343.has_value) {
                                            __auto_type ok_type_expr = _mv_1343.value;
                                            ...
                                            if (_mv_1344.has_value) {
                                                __auto_type err_type_expr = _mv_1344.value;
                                                {
                                                    __auto_type ok_c_type = context_to_c_type_prefixed(ctx, ok_type_expr);
                                                    __auto_type err_c_type = context_to_c_type_prefixed(ctx, err_type_expr);
                                                    __auto_type result_name = transpiler_build_result_type_name(ctx, ok_c_type, err_c_type);
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len >= 2) {
            ...
            if (_mv_1345.has_value) {
                __auto_type header_expr = _mv_1345.value;
                __auto_type _mv_1346 = (*header_expr);
                switch (_mv_1346.tag) {
                    case types_SExpr_str:
                    {
                        __auto_type str = _mv_1346.data.str;
            ...
            }
            {
                ...
                while (i < len) {
                    ...
                    if (_mv_1347.has_value) {
                        __auto_type func_decl = _mv_1347.value;
...
void transpiler_prescan_import(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    ...
    if (((int64_t)((items).len)) >= 3) {
        ...
        if (_mv_1348.has_value) {
            __auto_type mod_expr = _mv_1348.value;
            __auto_type _mv_1349 = (*mod_expr);
            switch (_mv_1349.tag) {
                case types_SExpr_sym:
                {
                    __auto_type mod_sym = _mv_1349.data.sym;
                    {
                        ...
                        if (_mv_1350.has_value) {
                            __auto_type symbols_expr = _mv_1350.value;
                            __auto_type _mv_1351 = (*symbols_expr);
                            switch (_mv_1351.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type symbols_lst = _mv_1351.data.lst;
                                    {
                                        __auto_type syms = symbols_lst.items;
                                        __auto_type sym_len = ((int64_t)((syms).len));
                                        __auto_type j = 0;
                                        while (j < sym_len) {
                                            __auto_type _mv_1352 = ({ __auto_type _lst = syms; size_t _idx = (size_t)j; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_1352.has_value) {
                                                __auto_type sym_item = _mv_1352.value;
                                                __auto_type _mv_1353 = (*sym_item);
                                                switch (_mv_1353.tag) {
                                                    case types_SExpr_sym:
                                                    {
                                                        __auto_type s = _mv_1353.data.sym;
                                                        {
...
void transpiler_register_ffi_function(context_TranspileContext* ctx, types_SExpr* func_decl) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1356 = (*func_decl);
        switch (_mv_1356.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1356.data.lst;
                {
                    ...
                    __auto_type len = ((int64_t)((items).len));
                    if (len >= 1) {
                        __auto_type _mv_1357 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (((int64_t)((items).len)) >= 2) {
            ...
            if (_mv_1359.has_value) {
                __auto_type params_expr = _mv_1359.value;
                __auto_type _mv_1360 = (*params_expr);
                switch (_mv_1360.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type params_lst = _mv_1360.data.lst;
                        {
                            __auto_type params = params_lst.items;
                            __auto_type param_count = ((int64_t)((params).len));
                            __auto_type i = 0;
                            while (i < param_count) {
                                __auto_type _mv_1361 = ({ __auto_type _lst = params; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1361.has_value) {
                                    __auto_type param_expr = _mv_1361.value;
                                    {
                                        __auto_type c_type = transpiler_prescan_get_param_c_type(ctx, param_expr);
                                        __auto_type param_info = ((context_FuncParamType*)(({ __auto_type _alloc = (context_FuncParamType*)slop_arena_alloc(arena, sizeof(context_FuncParamType)); if (_alloc == NULL) { fprintf(stderr, "SLOP: arena alloc failed at %s:%d\n", __FILE__, __LINE__); abort(); } _alloc; })));
                                        (*param_info).c_type = c_type;
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_1362.has_value) {
                __auto_type item_expr = _mv_1362.value;
                __auto_type _mv_1363 = (*item_expr);
                switch (_mv_1363.tag) {
                    case types_SExpr_sym:
                    {
                        __auto_type sym = _mv_1363.data.sym;
                        if (string_eq(sym.name, SLOP_STR(":c-name"))) {
                            __auto_type _mv_1364 = ({ __auto_type _lst = items; size_t _idx = (size_t)(i + 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_1364.has_value) {
                                __auto_type c_name_expr = _mv_1364.value;
                                __auto_type _mv_1365 = (*c_name_expr);
                                switch (_mv_1365.tag) {
                                    case types_SExpr_sym:
                                    {
                                        __auto_type c_sym = _mv_1365.data.sym;
                                        c_name = c_sym.name;
                                        found_c_name = 1;
                                        break;
                                    }
        ...
        if (len >= 2) {
            {
                ...
                if (len >= (name_idx + 1)) {
                    __auto_type _mv_1368 = ({ __auto_type _lst = items; size_t _idx = (size_t)name_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_string transpiler_get_ffi_struct_c_name(slop_arena* arena, slop_list_types_SExpr_ptr items, int64_t name_idx, slop_string default_name) {
    {
        ...
        if (len >= (modifier_idx + 2)) {
            __auto_type _mv_1370 = ({ __auto_type _lst = items; size_t _idx = (size_t)modifier_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1370.has_value) {
                __auto_type mod_expr = _mv_1370.value;
                __auto_type _mv_1371 = (*mod_expr);
                switch (_mv_1371.tag) {
                    case types_SExpr_sym:
                    {
                        __auto_type sym = _mv_1371.data.sym;
                        if (string_eq(sym.name, SLOP_STR(":c-name"))) {
                            __auto_type _mv_1372 = ({ __auto_type _lst = items; size_t _idx = (size_t)(modifier_idx + 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_1372.has_value) {
                                __auto_type cname_expr = _mv_1372.value;
                                __auto_type _mv_1373 = (*cname_expr);
                                switch (_mv_1373.tag) {
                                    case types_SExpr_str:
                                    {
...
uint8_t transpiler_is_ffi_string_item(slop_list_types_SExpr_ptr items, int64_t idx) {
    __auto_type _mv_1374 = ({ __auto_type _lst = items; size_t _idx = (size_t)idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    if (_mv_1374.has_value) {
        ...
        switch (_mv_1375.tag) {
            case types_SExpr_str:
            {
                __auto_type _ = _mv_1375.data.str;
                return 1;
            }
            default: {
                return 0;
                ...
                case types_SExpr_lst:
                {
                    __auto_type body_lst = _mv_1389.data.lst;
                    {
                        ...
                        if (((int64_t)((body_items).len)) < 2) {
                            ...
                            __auto_type _mv_1390 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                ...
                                switch (_mv_1391.tag) {
                                    case types_SExpr_sym:
                                    {
                                        ...
                                        if (string_eq(sym.name, SLOP_STR("Array"))) {
                                            __auto_type _mv_1392 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_1392.has_value) {
                                                __auto_type elem_expr = _mv_1392.value;
                                                {
...
void transpiler_transpile_module(context_TranspileContext* ctx, types_SExpr* module_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1407 = (*module_expr);
        switch (_mv_1407.tag) {
            case types_SExpr_lst:
            {
...
int64_t transpiler_get_body_start(slop_list_types_SExpr_ptr items) {
    if (((int64_t)((items).len)) < 3) {
        ...
        if (_mv_1410.has_value) {
            __auto_type third = _mv_1410.value;
            __auto_type _mv_1411 = (*third);
            switch (_mv_1411.tag) {
                case types_SExpr_lst:
                {
                                            ...
                                            if (string_eq(sym.name, SLOP_STR("export"))) {
                                                {
                                                    ...
                                                    __auto_type j = 1;
                                                    while (j < export_len) {
                                                        __auto_type _mv_1418 = ({ __auto_type _lst = sub_items; size_t _idx = (size_t)j; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
uint8_t transpiler_list_contains_str(slop_list_string lst, slop_string needle) {
    {
        ...
        uint8_t found = 0;
        while ((i < len) && !(found)) {
            __auto_type _mv_1420 = ({ __auto_type _lst = lst; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1420.has_value) {
                __auto_type s = _mv_1420.value;
...
void transpiler_scan_type_for_generics(context_TranspileContext* ctx, types_SExpr* type_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1422 = (*type_expr);
        switch (_mv_1422.tag) {
            case types_SExpr_lst:
            {
                                        ...
                                        if (string_eq(op, SLOP_STR("Option"))) {
                                            ...
                                            if (len >= 2) {
                                                ...
                                                if (_mv_1427.has_value) {
                                                    __auto_type inner = _mv_1427.value;
                                                    transpiler_scan_type_for_generics(ctx, inner);
                                            ...
                                            if (len >= 3) {
                                                ...
                                                if (_mv_1428.has_value) {
                                                    __auto_type ok_type = _mv_1428.value;
                                                    ...
                                                    if (_mv_1429.has_value) {
                                                        __auto_type err_type = _mv_1429.value;
                                                        {
                                            ...
                                            if (len >= 2) {
                                                ...
                                                if (_mv_1431.has_value) {
                                                    __auto_type result = _mv_1431.value;
                                                    {
                                            ...
                                            if (len >= 3) {
                                                ...
                                                if (_mv_1432.has_value) {
                                                    __auto_type key_type = _mv_1432.value;
                                                    {
                                                        ...
                                                        if (_mv_1433.has_value) {
                                                            __auto_type val_type = _mv_1433.value;
                                                            {
                                            ...
                                            if (len >= 2) {
                                                ...
                                                if (_mv_1434.has_value) {
                                                    __auto_type elem_type = _mv_1434.value;
                                                    {
                    ...
                    case types_SExpr_lst:
                    {
                        __auto_type field_lst = _mv_1436.data.lst;
                        {
                            ...
                            if (((int64_t)((field_items).len)) >= 2) {
                                __auto_type _mv_1437 = ({ __auto_type _lst = field_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void transpiler_emit_ffi_includes(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1438 = ({ __auto_type _lst = includes; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1438.has_value) {
                __auto_type header = _mv_1438.value;
...
void transpiler_emit_ffi_includes_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1439 = ({ __auto_type _lst = includes; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1439.has_value) {
                __auto_type header = _mv_1439.value;
...
void transpiler_emit_header_guard_open(context_TranspileContext* ctx) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1440 = context_ctx_get_module(ctx);
        if (_mv_1440.has_value) {
            __auto_type mod_name = _mv_1440.value;
            {
...
void transpiler_emit_header_dependency_includes(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1441 = ({ __auto_type _lst = imports; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1441.has_value) {
                __auto_type mod_name = _mv_1441.value;
                {
                    __auto_type c_name = ctype_to_c_name(arena, mod_name);
        ...
        while (i < len) {
            ...
            if (_mv_1442.has_value) {
                ...
                if (transpiler_is_type_def(item) && transpiler_is_struct_type_def(item)) {
                    __auto_type _mv_1443 = transpiler_get_type_name(item);
                    if (_mv_1443.has_value) {
                        __auto_type type_name = _mv_1443.value;
                        {
        ...
        while ((i < len) && !(found)) {
            ...
            if (_mv_1449.has_value) {
                ...
                switch (_mv_1450.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type _ = _mv_1450.data.lst;
                        found = 1;
                        break;
                    }
                    default: {
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1451.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 3) {
                    ...
                    __auto_type _mv_1452 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_1452.has_value) {
                        __auto_type def_expr = _mv_1452.value;
                        __auto_type _mv_1453 = (*def_expr);
                        switch (_mv_1453.tag) {
                            case types_SExpr_sym:
                            {
                                __auto_type _ = _mv_1453.data.sym;
                                return 1;
                            }
                            case types_SExpr_lst:
                            {
                                __auto_type def_lst = _mv_1453.data.lst;
                                {
                                    __auto_type def_items = def_lst.items;
                                    if (((int64_t)((def_items).len)) < 1) {
                                        return 0;
                                    } else {
                                        __auto_type _mv_1454 = ({ __auto_type _lst = def_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_1454.has_value) {
                                            __auto_type head = _mv_1454.value;
                                            __auto_type _mv_1455 = (*head);
                                            switch (_mv_1455.tag) {
                                                case types_SExpr_sym:
                                                {
            ...
            __auto_type lst = _mv_1456.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 3) {
                    ...
                    if (_mv_1457.has_value) {
                        __auto_type def_expr = _mv_1457.value;
                        __auto_type _mv_1458 = (*def_expr);
                        switch (_mv_1458.tag) {
                            case types_SExpr_lst:
                            {
                                __auto_type def_lst = _mv_1458.data.lst;
                                {
                                    __auto_type def_items = def_lst.items;
                                    if (((int64_t)((def_items).len)) < 1) {
                                        return 0;
                                    } else {
                                        __auto_type _mv_1459 = ({ __auto_type _lst = def_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_1459.has_value) {
                                            __auto_type head = _mv_1459.value;
                                            __auto_type _mv_1460 = (*head);
                                            switch (_mv_1460.tag) {
                                                case types_SExpr_sym:
                                                {
                            ...
                            switch (_mv_1463.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_1463.data.sym;
                                    {
                                        ...
                                        __auto_type _mv_1464 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_1464.has_value) {
                                            __auto_type body_expr = _mv_1464.value;
...
uint8_t transpiler_is_array_type_body(types_SExpr* body_expr) {
    SLOP_PRE(((body_expr != NULL)), "(!= body-expr nil)");
    __auto_type _mv_1465 = (*body_expr);
    switch (_mv_1465.tag) {
        case types_SExpr_lst:
        {
                ...
                __auto_type lst = _mv_1468.data.lst;
                {
                    ...
                    if (len < 3) {
                        ...
                        if (_mv_1469.has_value) {
                            __auto_type elem_type_expr = _mv_1469.value;
                            ...
                            if (_mv_1470.has_value) {
                                __auto_type size_expr = _mv_1470.value;
                                {
...
slop_string transpiler_get_array_size_string(types_SExpr* expr) {
    SLOP_PRE(((expr != NULL)), "(!= expr nil)");
    __auto_type _mv_1471 = (*expr);
    switch (_mv_1471.tag) {
        case types_SExpr_num:
        {
            __auto_type num = _mv_1471.data.num;
            return num.raw;
        }
        default: {
            return SLOP_STR("0");
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_1478.has_value) {
                ...
                if (transpiler_is_type_def(item) && transpiler_is_struct_type_def(item)) {
                    __auto_type _mv_1479 = transpiler_get_type_name(item);
                    if (_mv_1479.has_value) {
                        __auto_type type_name = _mv_1479.value;
                        {
...
void transpiler_emit_c_name_aliases(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len > 0) {
            ...
            while (i < len) {
                __auto_type _mv_1482 = ({ __auto_type _lst = aliases; size_t _idx = (size_t)i; slop_option_context_FuncCNameAlias _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_1482.has_value) {
                    __auto_type alias = _mv_1482.value;
                            ...
                            switch (_mv_1485.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_1485.data.sym;
                                    {
                                        ...
                                        __auto_type _mv_1486 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_1486.has_value) {
                                            __auto_type params_expr = _mv_1486.value;
                                            {
...
void transpiler_emit_result_types(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1494 = ({ __auto_type _lst = result_types; size_t _idx = (size_t)i; slop_option_context_ResultType _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1494.has_value) {
                __auto_type rt = _mv_1494.value;
...
void transpiler_emit_result_types_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1495 = ({ __auto_type _lst = result_types; size_t _idx = (size_t)i; slop_option_context_ResultType _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1495.has_value) {
                __auto_type rt = _mv_1495.value;
...
void transpiler_emit_inline_records_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1496 = ({ __auto_type _lst = inline_records; size_t _idx = (size_t)i; slop_option_context_InlineRecord _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1496.has_value) {
                __auto_type ir = _mv_1496.value;
                {
...
void transpiler_emit_complex_value_option_types_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1499 = ({ __auto_type _lst = option_types; size_t _idx = (size_t)i; slop_option_context_OptionType _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1499.has_value) {
                __auto_type ot = _mv_1499.value;
                if (!(transpiler_is_pointer_elem_type(ot.inner_type))) {
                    transpiler_emit_single_option_type_header(ctx, ot);
                }
...
void transpiler_emit_list_types_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1500 = ({ __auto_type _lst = list_types; size_t _idx = (size_t)i; slop_option_context_ListType _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
uint8_t transpiler_is_range_type_alias(context_TranspileContext* ctx, slop_string slop_type) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    __auto_type _mv_1510 = context_ctx_lookup_type_alias(ctx, slop_type);
    if (_mv_1510.has_value) {
        __auto_type underlying = _mv_1510.value;
...
void transpiler_emit_struct_key_types_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < ((int64_t)((struct_key_types).len))) {
            __auto_type _mv_1515 = ({ __auto_type _lst = struct_key_types; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1515.has_value) {
                __auto_type c_type = _mv_1515.value;
                {
                    __auto_type guard_name = context_ctx_str3(ctx, transpiler_uppercase_name(ctx, c_type), SLOP_STR("_HASH_EQ_DEFINED"), SLOP_STR(""));
...
void transpiler_emit_chan_types_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1516 = ({ __auto_type _lst = chan_types; size_t _idx = (size_t)i; slop_option_context_ChanType _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1516.has_value) {
                __auto_type ct = _mv_1516.value;
                {
...
void transpiler_emit_chan_funcs_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1517 = ({ __auto_type _lst = chan_types; size_t _idx = (size_t)i; slop_option_context_ChanType _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1517.has_value) {
                __auto_type ct = _mv_1517.value;
                {
                    __auto_type elem_type = ct.elem_type;
                    __auto_type c_name = ct.c_name;
...
void transpiler_emit_thread_types_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1518 = ({ __auto_type _lst = thread_types; size_t _idx = (size_t)i; slop_option_context_ThreadType _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1518.has_value) {
                __auto_type tt = _mv_1518.value;
                {
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1519.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 3) {
                    ...
                    __auto_type _mv_1520 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_1520.has_value) {
                        __auto_type def_expr = _mv_1520.value;
                        __auto_type _mv_1521 = (*def_expr);
                        switch (_mv_1521.tag) {
                            case types_SExpr_lst:
                            {
                                __auto_type def_lst = _mv_1521.data.lst;
                                {
                                    __auto_type def_items = def_lst.items;
                                    if (((int64_t)((def_items).len)) < 1) {
                                        return 0;
                                    } else {
                                        __auto_type _mv_1522 = ({ __auto_type _lst = def_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void transpiler_emit_option_by_c_name(context_TranspileContext* ctx, slop_string c_name) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1531 = ({ __auto_type _lst = option_types; size_t _idx = (size_t)i; slop_option_context_OptionType _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1531.has_value) {
                __auto_type ot = _mv_1531.value;
                    ...
                    if (transpiler_is_type_def(item) && transpiler_is_struct_type_def(item)) {
                        {
                            ...
                            __auto_type j = 0;
                            while (j < dep_len) {
                                __auto_type _mv_1537 = ({ __auto_type _lst = blocking_deps; size_t _idx = (size_t)j; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1537.has_value) {
                                    __auto_type dep_name = _mv_1537.value;
...
slop_list_string transpiler_find_blocking_list_deps(context_TranspileContext* ctx, types_SExpr* type_def) {
    ...
    SLOP_PRE(((type_def != NULL)), "(!= type-def nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1538 = ({ __auto_type _lst = field_types; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1538.has_value) {
                __auto_type field_type = _mv_1538.value;
...
uint8_t transpiler_index_in_list(slop_list_int lst, int64_t idx) {
    {
        ...
        uint8_t found = 0;
        while ((i < len) && !(found)) {
            __auto_type _mv_1540 = ({ __auto_type _lst = lst; size_t _idx = (size_t)i; slop_option_int _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1540.has_value) {
                __auto_type v = _mv_1540.value;
                if (v == idx) {
                    found = 1;
                }
        ...
        switch (_mv_1542.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1542.data.lst;
                {
                    __auto_type items = lst.items;
                    if (((int64_t)((items).len)) >= 3) {
                        __auto_type _mv_1543 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_1543.has_value) {
                            __auto_type def_expr = _mv_1543.value;
                            __auto_type _mv_1544 = (*def_expr);
                            switch (_mv_1544.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type def_lst = _mv_1544.data.lst;
                                    {
                                        __auto_type def_items = def_lst.items;
                                        __auto_type def_len = ((int64_t)((def_items).len));
                                        if (def_len > 0) {
                                            __auto_type _mv_1545 = ({ __auto_type _lst = def_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_1545.has_value) {
                                                __auto_type head = _mv_1545.value;
                                                __auto_type _mv_1546 = (*head);
                                                switch (_mv_1546.tag) {
                                                    case types_SExpr_sym:
                                                    {
...
slop_list_string transpiler_extract_record_field_types(context_TranspileContext* ctx, slop_list_types_SExpr_ptr def_items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 1;
        while (i < len) {
            __auto_type _mv_1547 = ({ __auto_type _lst = def_items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1547.has_value) {
                __auto_type field_expr = _mv_1547.value;
                __auto_type _mv_1548 = (*field_expr);
                switch (_mv_1548.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type field_lst = _mv_1548.data.lst;
                        if (((int64_t)((field_lst.items).len)) >= 2) {
                            __auto_type _mv_1549 = ({ __auto_type _lst = field_lst.items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_1549.has_value) {
                                __auto_type type_expr = _mv_1549.value;
                                {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_1550.has_value) {
                __auto_type variant_expr = _mv_1550.value;
                __auto_type _mv_1551 = (*variant_expr);
                switch (_mv_1551.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type variant_lst = _mv_1551.data.lst;
                        if (((int64_t)((variant_lst.items).len)) >= 2) {
                            __auto_type _mv_1552 = ({ __auto_type _lst = variant_lst.items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_string transpiler_get_field_type_string(context_TranspileContext* ctx, types_SExpr* type_expr) {
    ...
    SLOP_PRE(((type_expr != NULL)), "(!= type-expr nil)");
    {
        ...
        switch (_mv_1553.tag) {
            case types_SExpr_sym:
            {
                __auto_type sym = _mv_1553.data.sym;
                {
                    __auto_type name = sym.name;
                    __auto_type _mv_1554 = context_ctx_lookup_type(ctx, name);
                    if (_mv_1554.has_value) {
                        __auto_type entry = _mv_1554.value;
                        return entry.c_name;
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1553.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) < 1) {
                        ...
                        __auto_type _mv_1555 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                ...
                                case types_SExpr_sym:
                                {
                                    __auto_type sym = _mv_1556.data.sym;
                                    {
                                        ...
                                        if (string_eq(kind, SLOP_STR("Ptr"))) {
                                            ...
                                            if (((int64_t)((items).len)) >= 2) {
                                                __auto_type _mv_1557 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_1557.has_value) {
                                                    __auto_type inner = _mv_1557.value;
                                                    {
                                            ...
                                            if (((int64_t)((items).len)) >= 2) {
                                                ...
                                                if (_mv_1558.has_value) {
                                                    __auto_type inner = _mv_1558.value;
                                                    {
                                                        __auto_type inner_str = transpiler_get_field_type_string(ctx, inner);
                                                        if (string_eq(inner_str, SLOP_STR(""))) {
                                                            return SLOP_STR("");
                    ...
                    if (_mv_1560.has_value) {
                        ...
                        switch (_mv_1561.tag) {
                            case types_SExpr_sym:
                            {
                                ...
                                {
                                    __auto_type name = sym.name;
                                    __auto_type _mv_1562 = context_ctx_lookup_type(ctx, name);
        ...
        if (!(found)) {
            {
                ...
                int64_t j = 0;
                while ((j < len2) && !(found)) {
                    __auto_type _mv_1566 = ({ __auto_type _lst = option_types; size_t _idx = (size_t)j; slop_option_context_OptionType _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
uint8_t transpiler_is_imported_type(context_TranspileContext* ctx, slop_string type_name) {
    ...
    if (strlib_starts_with(type_name, SLOP_STR("slop_list_")) || strlib_starts_with(type_name, SLOP_STR("slop_option_"))) {
        ...
        __auto_type _mv_1571 = context_ctx_get_module(ctx);
        if (_mv_1571.has_value) {
            __auto_type current_mod = _mv_1571.value;
            {
                __auto_type arena = (*ctx).arena;
                ...
                __auto_type lst = _mv_1574.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) < 3) {
                        ...
                        if (_mv_1575.has_value) {
                            __auto_type body_expr = _mv_1575.value;
                ...
                __auto_type lst = _mv_1576.data.lst;
                {
                    ...
                    while ((i < len) && !(found)) {
                        ...
                        if (_mv_1577.has_value) {
                            __auto_type field_expr = _mv_1577.value;
...
uint8_t transpiler_field_uses_typename(context_TranspileContext* ctx, types_SExpr* field_expr, slop_string typename) {
    ...
    __auto_type _mv_1578 = (*field_expr);
    switch (_mv_1578.tag) {
        case types_SExpr_lst:
        {
                    ...
                    if (len >= 3) {
                        ...
                        if (_mv_1581.has_value) {
                            ...
                            switch (_mv_1582.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_1582.data.sym;
                                    {
                                        __auto_type type_name = name_sym.name;
                                        __auto_type base_name = ctype_to_c_name(arena, type_name);
                                        __auto_type c_name = ((context_ctx_prefixing_enabled(ctx)) ? ({ __auto_type _mv = context_ctx_get_module(ctx); _mv.has_value ? ({ __auto_type mod_name = _mv.value; context_ctx_str(ctx, ctype_to_c_name(arena, mod_name), context_ctx_str(ctx, SLOP_STR("_"), base_name)); }) : (base_name); }) : base_name);
                                        __auto_type _mv_1583 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_1583.has_value) {
                                            __auto_type body_expr = _mv_1583.value;
...
void transpiler_emit_type_body_to_header(context_TranspileContext* ctx, slop_string raw_type_name, slop_string c_name, types_SExpr* body_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1584 = (*body_expr);
        switch (_mv_1584.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1584.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) < 1) {
                        ...
                        if (_mv_1585.has_value) {
                            __auto_type kind_expr = _mv_1585.value;
                            __auto_type _mv_1586 = (*kind_expr);
                            switch (_mv_1586.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type kind_sym = _mv_1586.data.sym;
                                    {
        ...
        while (i < len) {
            ...
            if (_mv_1587.has_value) {
                ...
                switch (_mv_1588.tag) {
                    case types_SExpr_sym:
                    {
                        __auto_type variant_sym = _mv_1588.data.sym;
                        {
            ...
            __auto_type lst = _mv_1594.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 1) {
                    ...
                    if (_mv_1595.has_value) {
                        __auto_type head = _mv_1595.value;
                        __auto_type _mv_1596 = (*head);
                        switch (_mv_1596.tag) {
                            case types_SExpr_sym:
                            {
        ...
        context_ctx_emit_header(ctx, SLOP_STR("    union {"));
        {
            ...
            while (i < len) {
                ...
                if (_mv_1598.has_value) {
                    __auto_type variant_expr = _mv_1598.value;
...
slop_string transpiler_get_variant_name(types_SExpr* variant_expr) {
    ...
    __auto_type _mv_1599 = (*variant_expr);
    switch (_mv_1599.tag) {
        case types_SExpr_sym:
        {
                                    ...
                                    __auto_type name_sym = _mv_1604.data.sym;
                                    {
                                        ...
                                        if (num_items == 2) {
                                            ...
                                            for (int64_t fi = 1; fi < num_items; fi++) {
                                                __auto_type _mv_1606 = ({ __auto_type _lst = items; size_t _idx = (size_t)fi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_1606.has_value) {
                                                    __auto_type type_expr = _mv_1606.value;
                                                    {
                                                        __auto_type c_type = context_to_c_type_prefixed(ctx, type_expr);
                                                        {
                                                            __auto_type actual_type = ((string_eq(c_type, SLOP_STR("void"))) ? SLOP_STR("int") : c_type);
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1612.data.lst;
            {
                ...
                if (((int64_t)((const_items).len)) < 4) {
                    ...
                    __auto_type _mv_1613 = ({ __auto_type _lst = const_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            ...
                            case types_SExpr_sym:
                            {
                                __auto_type name_sym = _mv_1614.data.sym;
                                {
                                    ...
                                    if (!(transpiler_list_contains_str(exports, raw_name))) {
                                        ...
                                        __auto_type _mv_1615 = ({ __auto_type _lst = const_items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void transpiler_emit_all_lambdas(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (count > 0) {
            while (i < count) {
                __auto_type _mv_1617 = ({ __auto_type _lst = lambdas; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_1617.has_value) {
                    __auto_type lambda_code = _mv_1617.value;
...
slop_string transpiler_generate_c_output(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1618 = ({ __auto_type _lst = output_lines; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1618.has_value) {
                __auto_type line = _mv_1618.value;
...
void transpiler_transpile_file(context_TranspileContext* ctx, slop_list_types_SExpr_ptr exprs) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len > 0) && transpiler_is_module_expr(exprs)) {
            __auto_type _mv_1619 = ({ __auto_type _lst = exprs; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1619.has_value) {
                __auto_type module_expr = _mv_1619.value;
...
uint8_t transpiler_is_module_expr(slop_list_types_SExpr_ptr exprs) {
    if (((int64_t)((exprs).len)) < 1) {
        ...
        if (_mv_1620.has_value) {
            __auto_type first = _mv_1620.value;
            __auto_type _mv_1621 = (*first);
            switch (_mv_1621.tag) {
                case types_SExpr_lst:
                {
                    __auto_type lst = _mv_1621.data.lst;
                    {
                        ...
                        if (((int64_t)((items).len)) < 1) {
                            ...
                            if (_mv_1622.has_value) {
                                __auto_type head = _mv_1622.value;
                                __auto_type _mv_1623 = (*head);
                                switch (_mv_1623.tag) {
                                    case types_SExpr_sym:
                                    {
