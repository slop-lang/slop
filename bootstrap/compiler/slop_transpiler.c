                    ...
                    case types_SExpr_lst:
                    {
                        __auto_type lst = _mv_1273.data.lst;
                        {
                            ...
                            if (((int64_t)((sub_items).len)) >= 1) {
                                __auto_type _mv_1274 = ({ __auto_type _lst = sub_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        ...
                                        case types_SExpr_sym:
                                        {
                                            ...
                                            if (string_eq(sym.name, SLOP_STR("@generic"))) {
                                                if (((int64_t)((sub_items).len)) >= 2) {
                                                    __auto_type _mv_1276 = ({ __auto_type _lst = sub_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_1276.has_value) {
                                                        __auto_type params_expr = _mv_1276.value;
                                                        __auto_type _mv_1277 = (*params_expr);
                                                        switch (_mv_1277.tag) {
                                                            case types_SExpr_lst:
                                                            {
                                                                __auto_type params_lst = _mv_1277.data.lst;
                                                                {
                                                                    __auto_type param_items = params_lst.items;
                                                                    __auto_type param_len = ((int64_t)((param_items).len));
                                                                    __auto_type j = 0;
                                                                    while (j < param_len) {
                                                                        __auto_type _mv_1278 = ({ __auto_type _lst = param_items; size_t _idx = (size_t)j; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                                        if (_mv_1278.has_value) {
                                                                            __auto_type param = _mv_1278.value;
                                                                            __auto_type _mv_1279 = (*param);
                                                                            switch (_mv_1279.tag) {
                                                                                case types_SExpr_sym:
                                                                                {
                                                                                    __auto_type param_sym = _mv_1279.data.sym;
                                                            ...
                                                            case types_SExpr_sym:
                                                            {
                                                                __auto_type single_sym = _mv_1277.data.sym;
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (((int64_t)((items).len)) >= 2) {
            ...
            if (_mv_1284.has_value) {
                __auto_type name_expr = _mv_1284.value;
                __auto_type _mv_1285 = (*name_expr);
                switch (_mv_1285.tag) {
                    case types_SExpr_sym:
                    {
                            ...
                            __auto_type c_name = ((context_ctx_prefixing_enabled(ctx)) ? ({ __auto_type _mv = context_ctx_get_module(ctx); _mv.has_value ? ({ __auto_type mod_name = _mv.value; context_ctx_str(ctx, ctype_to_c_name(arena, mod_name), context_ctx_str(ctx, SLOP_STR("_"), base_c_name)); }) : (base_c_name); }) : base_c_name);
                            {
                                ...
                                if (((int64_t)((items).len)) >= 3) {
                                    ...
                                    if (_mv_1288.has_value) {
                                        __auto_type body_expr = _mv_1288.value;
...
void transpiler_register_enum_variants(context_TranspileContext* ctx, slop_string enum_name, slop_list_types_SExpr_ptr items) {
    ...
    if (((int64_t)((items).len)) >= 3) {
        ...
        if (_mv_1289.has_value) {
            __auto_type def_expr = _mv_1289.value;
            __auto_type _mv_1290 = (*def_expr);
            switch (_mv_1290.tag) {
                case types_SExpr_lst:
                {
                    __auto_type def_lst = _mv_1290.data.lst;
                    {
                        __auto_type def_items = def_lst.items;
                        __auto_type len = ((int64_t)((def_items).len));
                        __auto_type i = 1;
                        while (i < len) {
                            __auto_type _mv_1291 = ({ __auto_type _lst = def_items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_1291.has_value) {
                                __auto_type variant_expr = _mv_1291.value;
                                __auto_type _mv_1292 = (*variant_expr);
                                switch (_mv_1292.tag) {
                                    case types_SExpr_sym:
                                    {
                                    ...
                                    case types_SExpr_lst:
                                    {
                                        __auto_type variant_lst = _mv_1292.data.lst;
                                        if (((int64_t)((variant_lst.items).len)) > 0) {
                                            __auto_type _mv_1293 = ({ __auto_type _lst = variant_lst.items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_1293.has_value) {
                                                ...
                                                switch (_mv_1294.tag) {
                                                    case types_SExpr_sym:
                                                    {
                                                        __auto_type name_sym = _mv_1294.data.sym;
                ...
                switch (_mv_1296.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type def_lst = _mv_1296.data.lst;
                        {
                            ...
                            __auto_type i = 1;
                            while (i < len) {
                                __auto_type _mv_1297 = ({ __auto_type _lst = def_items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1297.has_value) {
                                    __auto_type variant_expr = _mv_1297.value;
                                    __auto_type _mv_1298 = (*variant_expr);
                                    switch (_mv_1298.tag) {
                                        case types_SExpr_sym:
                                        {
                                        ...
                                        case types_SExpr_lst:
                                        {
                                            __auto_type variant_lst = _mv_1298.data.lst;
                                            {
                                                __auto_type vl_items = variant_lst.items;
                                                __auto_type vl_len = ((int64_t)((vl_items).len));
                                                if (vl_len >= 2) {
                                                    __auto_type _mv_1299 = ({ __auto_type _lst = vl_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                        ...
                                                        switch (_mv_1300.tag) {
                                                            case types_SExpr_sym:
                                                            {
                                                                __auto_type name_sym = _mv_1300.data.sym;
                                                                {
                                                                    ...
                                                                    context_ctx_register_enum_variant(ctx, variant_name, union_name);
                                                                    __auto_type _mv_1301 = ({ __auto_type _lst = vl_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                                    ...
                                                                    if (vl_len >= 3) {
                                                                        ...
                                                                        for (int64_t fi = 1; fi < vl_len; fi++) {
                                                                            __auto_type _mv_1302 = ({ __auto_type _lst = vl_items; size_t _idx = (size_t)fi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    ...
                                                    if (((int64_t)((vl_items).len)) == 1) {
                                                        __auto_type _mv_1303 = ({ __auto_type _lst = vl_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                        if (_mv_1303.has_value) {
                                                            __auto_type name_expr = _mv_1303.value;
                                                            __auto_type _mv_1304 = (*name_expr);
                                                            switch (_mv_1304.tag) {
                                                                case types_SExpr_sym:
                                                                {
                                                                    __auto_type name_sym = _mv_1304.data.sym;
                                                                    {
                                                                        __auto_type variant_name = name_sym.name;
                                                                        context_ctx_register_enum_variant(ctx, variant_name, union_name);
                                                                        context_ctx_register_union_variant(ctx, variant_name, union_name, ctype_to_c_name(arena, variant_name), SLOP_STR(""), SLOP_STR(""));
                                                            ...
                                                            __auto_type body_lst = _mv_1312.data.lst;
                                                            {
                                                                ...
                                                                if (body_len >= 1) {
                                                                    ...
                                                                    if (_mv_1313.has_value) {
                                                                        ...
                                                                        __auto_type _mv_1314 = (*ret_type);
                                                                        switch (_mv_1314.tag) {
                                                                            case types_SExpr_sym:
                                                                            {
                                                                                __auto_type ret_sym = _mv_1314.data.sym;
                ...
                switch (_mv_1316.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type lst = _mv_1316.data.lst;
                        {
                            __auto_type sub_items = lst.items;
                            if (((int64_t)((sub_items).len)) >= 2) {
                                __auto_type _mv_1317 = ({ __auto_type _lst = sub_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1317.has_value) {
                                    ...
                                    switch (_mv_1318.tag) {
                                        case types_SExpr_sym:
                                        {
                                            ...
                                            if (string_eq(sym.name, SLOP_STR("@spec"))) {
                                                __auto_type _mv_1319 = ({ __auto_type _lst = sub_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_1319.has_value) {
                                                    __auto_type spec_body = _mv_1319.value;
                                                    __auto_type _mv_1320 = (*spec_body);
                                                    switch (_mv_1320.tag) {
                                                        case types_SExpr_lst:
                                                        {
                                                            __auto_type body_lst = _mv_1320.data.lst;
                                                            {
                                                                __auto_type body_items = body_lst.items;
                                                                __auto_type body_len = ((int64_t)((body_items).len));
                                                                if (body_len >= 1) {
                                                                    __auto_type _mv_1321 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)(body_len - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                                    if (_mv_1321.has_value) {
                                                                        __auto_type ret_type = _mv_1321.value;
...
void transpiler_prescan_fn_params(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    ...
    if (((int64_t)((items).len)) >= 3) {
        ...
        if (_mv_1322.has_value) {
            __auto_type params_expr = _mv_1322.value;
            __auto_type _mv_1323 = (*params_expr);
            switch (_mv_1323.tag) {
                case types_SExpr_lst:
                {
                    __auto_type params_lst = _mv_1323.data.lst;
                    {
                        __auto_type params = params_lst.items;
                        __auto_type param_count = ((int64_t)((params).len));
                        __auto_type i = 0;
                        while (i < param_count) {
                            __auto_type _mv_1324 = ({ __auto_type _lst = params; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_1324.has_value) {
                                __auto_type param_expr = _mv_1324.value;
                                __auto_type _mv_1325 = (*param_expr);
                                switch (_mv_1325.tag) {
                                    case types_SExpr_lst:
                                    {
                                        __auto_type param_lst = _mv_1325.data.lst;
                                        {
                                            __auto_type param_items = param_lst.items;
                                            if (((int64_t)((param_items).len)) >= 2) {
                                                __auto_type _mv_1326 = ({ __auto_type _lst = param_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_1326.has_value) {
                                                    __auto_type type_expr = _mv_1326.value;
                ...
                __auto_type lst = _mv_1330.data.lst;
                {
                    ...
                    if (len < 2) {
                    ...
                    } else {
                        {
                            ...
                            __auto_type _mv_1331 = ({ __auto_type _lst = items; size_t _idx = (size_t)type_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
uint8_t transpiler_prescan_is_param_mode(slop_list_types_SExpr_ptr items) {
    if (((int64_t)((items).len)) < 1) {
        ...
        if (_mv_1332.has_value) {
            __auto_type first = _mv_1332.value;
            __auto_type _mv_1333 = (*first);
            switch (_mv_1333.tag) {
                case types_SExpr_sym:
                {
...
void transpiler_extract_result_type(context_TranspileContext* ctx, types_SExpr* spec_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1338 = (*spec_expr);
        switch (_mv_1338.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1338.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) >= 2) {
                        ...
                        if (_mv_1339.has_value) {
                            __auto_type spec_body = _mv_1339.value;
                            __auto_type _mv_1340 = (*spec_body);
                            switch (_mv_1340.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type body_lst = _mv_1340.data.lst;
                                    {
                                        __auto_type body_items = body_lst.items;
                                        __auto_type body_len = ((int64_t)((body_items).len));
                                        if (body_len >= 1) {
                                            __auto_type _mv_1341 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)(body_len - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_1341.has_value) {
                                                __auto_type ret_type = _mv_1341.value;
                                ...
                                case types_SExpr_sym:
                                {
                                    ...
                                    if (string_eq(sym.name, SLOP_STR("Result"))) {
                                        ...
                                        if (_mv_1345.has_value) {
                                            __auto_type ok_type_expr = _mv_1345.value;
                                            ...
                                            if (_mv_1346.has_value) {
                                                __auto_type err_type_expr = _mv_1346.value;
                                                {
                                    ...
                                    if (string_eq(name, SLOP_STR("map-new"))) {
                                        if (len >= 3) {
                                            ...
                                            if (_mv_1351.has_value) {
                                                __auto_type key_type_expr = _mv_1351.value;
                                        ...
                                        if (len >= 3) {
                                            ...
                                            if (_mv_1352.has_value) {
                                                __auto_type elem_type_expr = _mv_1352.value;
                                        ...
                                        if (len >= 3) {
                                            ...
                                            if (_mv_1354.has_value) {
                                                __auto_type type_expr = _mv_1354.value;
                                                {
                                                    __auto_type elem_c = context_to_c_type_prefixed(ctx, type_expr);
                                                    __auto_type elem_id = ctype_type_to_identifier((*ctx).arena, elem_c);
                                                    __auto_type c_name = context_ctx_str(ctx, SLOP_STR("slop_chan_"), elem_id);
                                    ...
                                    } else {
                                        {
                                            ...
                                            while (i < len) {
                                                ...
                                                if (_mv_1355.has_value) {
                                                    __auto_type child = _mv_1355.value;
                            ...
                            default: {
                                {
                                    ...
                                    while (i < len) {
                                        ...
                                        if (_mv_1356.has_value) {
                                            __auto_type child = _mv_1356.value;
                                            transpiler_prescan_expr_for_struct_keys(ctx, child);
...
void transpiler_prescan_register_struct_key_type(context_TranspileContext* ctx, types_SExpr* type_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1357 = (*type_expr);
        switch (_mv_1357.tag) {
            case types_SExpr_sym:
            {
                __auto_type sym = _mv_1357.data.sym;
                {
                    ...
                    if (!(transpiler_is_builtin_map_key_type(name))) {
                        ...
                        if (_mv_1358.has_value) {
                            __auto_type type_entry = _mv_1358.value;
                            context_ctx_register_struct_key_type(ctx, type_entry.c_name);
                        } else if (!_mv_1358.has_value) {
                            __auto_type _mv_1359 = context_ctx_get_module(ctx);
                            if (_mv_1359.has_value) {
                                __auto_type mod = _mv_1359.value;
                                {
                                    __auto_type prefixed = context_ctx_str3(ctx, mod, SLOP_STR("_"), name);
                                    __auto_type _mv_1360 = context_ctx_lookup_type(ctx, prefixed);
                                    if (_mv_1360.has_value) {
                                        __auto_type type_entry = _mv_1360.value;
                                        context_ctx_register_struct_key_type(ctx, type_entry.c_name);
        ...
        switch (_mv_1361.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1361.data.lst;
                {
                    __auto_type items = lst.items;
                    if (((int64_t)((items).len)) >= 3) {
                        __auto_type _mv_1362 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                ...
                                case types_SExpr_sym:
                                {
                                    ...
                                    if (string_eq(sym.name, SLOP_STR("Result"))) {
                                        ...
                                        if (_mv_1364.has_value) {
                                            __auto_type ok_type_expr = _mv_1364.value;
                                            ...
                                            if (_mv_1365.has_value) {
                                                __auto_type err_type_expr = _mv_1365.value;
                                                {
                                                    __auto_type ok_c_type = context_to_c_type_prefixed(ctx, ok_type_expr);
                                                    __auto_type err_c_type = context_to_c_type_prefixed(ctx, err_type_expr);
                                                    __auto_type result_name = transpiler_build_result_type_name(ctx, ok_c_type, err_c_type);
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len >= 2) {
            ...
            if (_mv_1366.has_value) {
                __auto_type header_expr = _mv_1366.value;
                __auto_type _mv_1367 = (*header_expr);
                switch (_mv_1367.tag) {
                    case types_SExpr_str:
                    {
                        __auto_type str = _mv_1367.data.str;
            ...
            }
            {
                ...
                while (i < len) {
                    ...
                    if (_mv_1368.has_value) {
                        __auto_type func_decl = _mv_1368.value;
...
void transpiler_prescan_import(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    ...
    if (((int64_t)((items).len)) >= 3) {
        ...
        if (_mv_1369.has_value) {
            __auto_type mod_expr = _mv_1369.value;
            __auto_type _mv_1370 = (*mod_expr);
            switch (_mv_1370.tag) {
                case types_SExpr_sym:
                {
                    __auto_type mod_sym = _mv_1370.data.sym;
                    {
                        ...
                        if (_mv_1371.has_value) {
                            __auto_type symbols_expr = _mv_1371.value;
                            __auto_type _mv_1372 = (*symbols_expr);
                            switch (_mv_1372.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type symbols_lst = _mv_1372.data.lst;
                                    {
                                        __auto_type syms = symbols_lst.items;
                                        __auto_type sym_len = ((int64_t)((syms).len));
                                        __auto_type j = 0;
                                        while (j < sym_len) {
                                            __auto_type _mv_1373 = ({ __auto_type _lst = syms; size_t _idx = (size_t)j; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_1373.has_value) {
                                                __auto_type sym_item = _mv_1373.value;
                                                __auto_type _mv_1374 = (*sym_item);
                                                switch (_mv_1374.tag) {
                                                    case types_SExpr_sym:
                                                    {
                                                        __auto_type s = _mv_1374.data.sym;
                                                        {
...
void transpiler_register_ffi_function(context_TranspileContext* ctx, types_SExpr* func_decl) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1377 = (*func_decl);
        switch (_mv_1377.tag) {
            case types_SExpr_lst:
            {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (((int64_t)((items).len)) >= 2) {
            ...
            if (_mv_1380.has_value) {
                __auto_type params_expr = _mv_1380.value;
                __auto_type _mv_1381 = (*params_expr);
                switch (_mv_1381.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type params_lst = _mv_1381.data.lst;
                        {
                            __auto_type params = params_lst.items;
                            __auto_type param_count = ((int64_t)((params).len));
                            __auto_type i = 0;
                            while (i < param_count) {
                                __auto_type _mv_1382 = ({ __auto_type _lst = params; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1382.has_value) {
                                    __auto_type param_expr = _mv_1382.value;
                                    {
                                        __auto_type c_type = transpiler_prescan_get_param_c_type(ctx, param_expr);
                                        __auto_type param_info = ((context_FuncParamType*)(({ __auto_type _alloc = (context_FuncParamType*)slop_arena_alloc(arena, sizeof(context_FuncParamType)); if (_alloc == NULL) { fprintf(stderr, "SLOP: arena alloc failed at %s:%d\n", __FILE__, __LINE__); abort(); } _alloc; })));
                                        (*param_info).c_type = c_type;
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_1383.has_value) {
                __auto_type item_expr = _mv_1383.value;
                __auto_type _mv_1384 = (*item_expr);
                switch (_mv_1384.tag) {
                    case types_SExpr_sym:
                    {
                        __auto_type sym = _mv_1384.data.sym;
                        if (string_eq(sym.name, SLOP_STR(":c-name"))) {
                            __auto_type _mv_1385 = ({ __auto_type _lst = items; size_t _idx = (size_t)(i + 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_1385.has_value) {
                                __auto_type c_name_expr = _mv_1385.value;
                                __auto_type _mv_1386 = (*c_name_expr);
                                switch (_mv_1386.tag) {
                                    case types_SExpr_sym:
                                    {
                                        __auto_type c_sym = _mv_1386.data.sym;
                                        c_name = c_sym.name;
                                        found_c_name = 1;
                                        break;
                                    }
        ...
        if (len >= 2) {
            {
                ...
                if (has_header) {
                    ...
                    if (_mv_1387.has_value) {
                        __auto_type header_expr = _mv_1387.value;
                        __auto_type _mv_1388 = (*header_expr);
                        switch (_mv_1388.tag) {
                            case types_SExpr_str:
                            {
                                __auto_type str = _mv_1388.data.str;
                                context_ctx_add_include(ctx, str.value);
                                break;
                            }
                            default: {
                ...
                if (len >= (name_idx + 1)) {
                    __auto_type _mv_1389 = ({ __auto_type _lst = items; size_t _idx = (size_t)name_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_string transpiler_get_ffi_struct_c_name(slop_arena* arena, slop_list_types_SExpr_ptr items, int64_t name_idx, slop_string default_name) {
    {
        ...
        if (len >= (modifier_idx + 2)) {
            __auto_type _mv_1391 = ({ __auto_type _lst = items; size_t _idx = (size_t)modifier_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1391.has_value) {
                __auto_type mod_expr = _mv_1391.value;
                __auto_type _mv_1392 = (*mod_expr);
                switch (_mv_1392.tag) {
                    case types_SExpr_sym:
                    {
                        __auto_type sym = _mv_1392.data.sym;
                        if (string_eq(sym.name, SLOP_STR(":c-name"))) {
                            __auto_type _mv_1393 = ({ __auto_type _lst = items; size_t _idx = (size_t)(modifier_idx + 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_1393.has_value) {
                                __auto_type cname_expr = _mv_1393.value;
                                __auto_type _mv_1394 = (*cname_expr);
                                switch (_mv_1394.tag) {
                                    case types_SExpr_str:
                                    {
                                        __auto_type str = _mv_1394.data.str;
...
uint8_t transpiler_is_ffi_string_item(slop_list_types_SExpr_ptr items, int64_t idx) {
    __auto_type _mv_1395 = ({ __auto_type _lst = items; size_t _idx = (size_t)idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    if (_mv_1395.has_value) {
        ...
        switch (_mv_1396.tag) {
            case types_SExpr_str:
            {
                __auto_type _ = _mv_1396.data.str;
                return 1;
            }
            default: {
                return 0;
...
slop_string transpiler_get_array_c_type(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items, slop_string default_c_type) {
    ...
    if (((int64_t)((items).len)) < 3) {
        ...
        if (_mv_1409.has_value) {
            __auto_type body_expr = _mv_1409.value;
            __auto_type _mv_1410 = (*body_expr);
            switch (_mv_1410.tag) {
                case types_SExpr_lst:
                {
                    __auto_type body_lst = _mv_1410.data.lst;
                    {
                        __auto_type body_items = body_lst.items;
                        if (((int64_t)((body_items).len)) < 2) {
                            return default_c_type;
                        } else {
                            __auto_type _mv_1411 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                ...
                                switch (_mv_1412.tag) {
                                    case types_SExpr_sym:
                                    {
                                        ...
                                        if (string_eq(sym.name, SLOP_STR("Array"))) {
                                            __auto_type _mv_1413 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_1413.has_value) {
                                                __auto_type elem_expr = _mv_1413.value;
                                                {
            ...
            __auto_type lst = _mv_1416.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 3) {
                    ...
                    if (_mv_1417.has_value) {
                        __auto_type def_expr = _mv_1417.value;
                        __auto_type _mv_1418 = (*def_expr);
                        switch (_mv_1418.tag) {
                            case types_SExpr_lst:
                            {
                                __auto_type def_lst = _mv_1418.data.lst;
                                {
                                    __auto_type def_items = def_lst.items;
                                    if (((int64_t)((def_items).len)) < 1) {
                                        return 0;
                                    } else {
                                        __auto_type _mv_1419 = ({ __auto_type _lst = def_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void transpiler_transpile_module(context_TranspileContext* ctx, types_SExpr* module_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1428 = (*module_expr);
        switch (_mv_1428.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1428.data.lst;
                {
                    ...
                    if (len >= 2) {
                        ...
                        if (_mv_1429.has_value) {
                            __auto_type name_expr = _mv_1429.value;
                            __auto_type _mv_1430 = (*name_expr);
                            switch (_mv_1430.tag) {
                                case types_SExpr_sym:
                                {
...
int64_t transpiler_get_body_start(slop_list_types_SExpr_ptr items) {
    if (((int64_t)((items).len)) < 3) {
        ...
        if (_mv_1431.has_value) {
            __auto_type third = _mv_1431.value;
            __auto_type _mv_1432 = (*third);
            switch (_mv_1432.tag) {
                case types_SExpr_lst:
                {
                    __auto_type lst = _mv_1432.data.lst;
                    {
                        ...
                        if (((int64_t)((sub_items).len)) < 1) {
                            ...
                            __auto_type _mv_1433 = ({ __auto_type _lst = sub_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                ...
                switch (_mv_1436.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type lst = _mv_1436.data.lst;
                        {
                            __auto_type sub_items = lst.items;
                            if (((int64_t)((sub_items).len)) >= 1) {
                                __auto_type _mv_1437 = ({ __auto_type _lst = sub_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            ...
                                            if (string_eq(sym.name, SLOP_STR("export"))) {
                                                {
                                                    ...
                                                    __auto_type j = 1;
                                                    while (j < export_len) {
                                                        __auto_type _mv_1439 = ({ __auto_type _lst = sub_items; size_t _idx = (size_t)j; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                        if (_mv_1439.has_value) {
                                                            ...
                                                            switch (_mv_1440.tag) {
                                                                case types_SExpr_sym:
                                                                {
                                                                    __auto_type name_sym = _mv_1440.data.sym;
...
uint8_t transpiler_list_contains_str(slop_list_string lst, slop_string needle) {
    {
        ...
        uint8_t found = 0;
        while ((i < len) && !(found)) {
            __auto_type _mv_1441 = ({ __auto_type _lst = lst; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1441.has_value) {
                __auto_type s = _mv_1441.value;
                                        ...
                                        if (string_eq(op, SLOP_STR("Option"))) {
                                            ...
                                            if (len >= 2) {
                                                ...
                                                if (_mv_1447.has_value) {
                                                    __auto_type elem = _mv_1447.value;
                                                    {
                                            ...
                                            if (len >= 2) {
                                                ...
                                                if (_mv_1448.has_value) {
                                                    __auto_type inner = _mv_1448.value;
                                                    transpiler_scan_type_for_generics(ctx, inner);
                                            ...
                                            if (len >= 3) {
                                                ...
                                                if (_mv_1449.has_value) {
                                                    __auto_type ok_type = _mv_1449.value;
                                                    ...
                                                    if (_mv_1450.has_value) {
                                                        __auto_type err_type = _mv_1450.value;
                                                        {
                                            ...
                                            if (len >= 2) {
                                                ...
                                                if (_mv_1451.has_value) {
                                                    __auto_type elem = _mv_1451.value;
                                                    {
                                                        __auto_type elem_c = context_to_c_type_prefixed(ctx, elem);
                                                        __auto_type elem_id = ctype_type_to_identifier(arena, elem_c);
                                                        __auto_type c_name = context_ctx_str(ctx, SLOP_STR("slop_chan_"), elem_id);
                                            ...
                                            if (len >= 2) {
                                                ...
                                                if (_mv_1452.has_value) {
                                                    __auto_type result = _mv_1452.value;
                                                    {
                                            ...
                                            if (len >= 3) {
                                                ...
                                                if (_mv_1453.has_value) {
                                                    __auto_type key_type = _mv_1453.value;
                                                    {
                                                        ...
                                                        __auto_type _mv_1454 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                        if (_mv_1454.has_value) {
                                                            __auto_type val_type = _mv_1454.value;
                                                            {
                                            ...
                                            if (len >= 2) {
                                                ...
                                                if (_mv_1455.has_value) {
                                                    __auto_type elem_type = _mv_1455.value;
                                                    {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_1456.has_value) {
                __auto_type field_expr = _mv_1456.value;
                __auto_type _mv_1457 = (*field_expr);
                switch (_mv_1457.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type field_lst = _mv_1457.data.lst;
                        {
                            __auto_type field_items = field_lst.items;
                            if (((int64_t)((field_items).len)) >= 2) {
                                __auto_type _mv_1458 = ({ __auto_type _lst = field_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void transpiler_emit_ffi_includes(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1459 = ({ __auto_type _lst = includes; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1459.has_value) {
                __auto_type header = _mv_1459.value;
...
void transpiler_emit_ffi_includes_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1460 = ({ __auto_type _lst = includes; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1460.has_value) {
                __auto_type header = _mv_1460.value;
...
void transpiler_emit_header_guard_open(context_TranspileContext* ctx) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1461 = context_ctx_get_module(ctx);
        if (_mv_1461.has_value) {
            __auto_type mod_name = _mv_1461.value;
            {
...
void transpiler_emit_header_dependency_includes(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1462 = ({ __auto_type _lst = imports; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1462.has_value) {
                __auto_type mod_name = _mv_1462.value;
                {
                    __auto_type c_name = ctype_to_c_name(arena, mod_name);
        ...
        while (i < len) {
            ...
            if (_mv_1463.has_value) {
                ...
                if (transpiler_is_type_def(item) && transpiler_is_struct_type_def(item)) {
                    __auto_type _mv_1464 = transpiler_get_type_name(item);
                    if (_mv_1464.has_value) {
                        __auto_type type_name = _mv_1464.value;
                        {
        ...
        while ((i < len) && !(found)) {
            ...
            if (_mv_1470.has_value) {
                ...
                switch (_mv_1471.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type _ = _mv_1471.data.lst;
                        found = 1;
                        break;
                    }
                    default: {
                ...
                if (((int64_t)((items).len)) < 3) {
                    ...
                    if (_mv_1473.has_value) {
                        ...
                        switch (_mv_1474.tag) {
                            case types_SExpr_sym:
                            {
                                __auto_type _ = _mv_1474.data.sym;
                                return 1;
                            }
                            case types_SExpr_lst:
                            {
                                ...
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_1489.data.sym;
                                    {
                                        ...
                                        if (_mv_1490.has_value) {
                                            __auto_type body_expr = _mv_1490.value;
                ...
                __auto_type lst = _mv_1494.data.lst;
                {
                    ...
                    if (len < 3) {
                        ...
                        if (_mv_1495.has_value) {
                            __auto_type elem_type_expr = _mv_1495.value;
                            __auto_type _mv_1496 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_1496.has_value) {
                                __auto_type size_expr = _mv_1496.value;
                                {
...
slop_string transpiler_get_array_size_string(types_SExpr* expr) {
    SLOP_PRE(((expr != NULL)), "(!= expr nil)");
    __auto_type _mv_1497 = (*expr);
    switch (_mv_1497.tag) {
        case types_SExpr_num:
        {
            __auto_type num = _mv_1497.data.num;
            return num.raw;
        }
        default: {
            return SLOP_STR("0");
...
transpiler_RangeBoundsHeader transpiler_parse_range_bounds_header(types_SExpr* body_expr) {
    SLOP_PRE(((body_expr != NULL)), "(!= body-expr nil)");
    {
        ...
        __auto_type _mv_1501 = (*body_expr);
        switch (_mv_1501.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1501.data.lst;
                {
                    ...
                    while (i < len) {
                        ...
                        if (_mv_1502.has_value) {
                            ...
                            __auto_type _mv_1503 = (*item);
                            switch (_mv_1503.tag) {
                                case types_SExpr_num:
                                {
                                    __auto_type num = _mv_1503.data.num;
                                    if (!(found_dots)) {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_1504.has_value) {
                ...
                if (transpiler_is_type_def(item) && transpiler_is_struct_type_def(item)) {
                    __auto_type _mv_1505 = transpiler_get_type_name(item);
                    if (_mv_1505.has_value) {
                        __auto_type type_name = _mv_1505.value;
                        {
...
void transpiler_emit_c_name_aliases(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len > 0) {
            ...
            while (i < len) {
                __auto_type _mv_1508 = ({ __auto_type _lst = aliases; size_t _idx = (size_t)i; slop_option_context_FuncCNameAlias _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_1508.has_value) {
                    __auto_type alias = _mv_1508.value;
                ...
                __auto_type lst = _mv_1509.data.lst;
                {
                    ...
                    if (len >= 3) {
                        ...
                        if (_mv_1510.has_value) {
                            __auto_type name_expr = _mv_1510.value;
                            __auto_type _mv_1511 = (*name_expr);
                            switch (_mv_1511.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_1511.data.sym;
                                    {
                                        ...
                                        if (_mv_1512.has_value) {
                                            __auto_type params_expr = _mv_1512.value;
                                            {
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1513.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 2) {
                    ...
                    __auto_type _mv_1514 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_1514.has_value) {
                        __auto_type name_expr = _mv_1514.value;
                        __auto_type _mv_1515 = (*name_expr);
                        switch (_mv_1515.tag) {
                            case types_SExpr_sym:
                            {
...
void transpiler_emit_struct_types(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items, int64_t start) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = start;
        while (i < len) {
            __auto_type _mv_1519 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1519.has_value) {
                __auto_type item = _mv_1519.value;
                if (transpiler_is_type_def(item) && transpiler_is_struct_type_def(item)) {
                    defn_transpile_type(ctx, item);
                    context_ctx_emit(ctx, SLOP_STR(""));
                }
...
void transpiler_emit_result_types(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1520 = ({ __auto_type _lst = result_types; size_t _idx = (size_t)i; slop_option_context_ResultType _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1520.has_value) {
                __auto_type rt = _mv_1520.value;
...
void transpiler_emit_result_types_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1521 = ({ __auto_type _lst = result_types; size_t _idx = (size_t)i; slop_option_context_ResultType _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1521.has_value) {
                __auto_type rt = _mv_1521.value;
...
void transpiler_emit_inline_records_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1522 = ({ __auto_type _lst = inline_records; size_t _idx = (size_t)i; slop_option_context_InlineRecord _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1522.has_value) {
                __auto_type ir = _mv_1522.value;
                {
...
void transpiler_emit_imported_list_types_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1529 = ({ __auto_type _lst = list_types; size_t _idx = (size_t)i; slop_option_context_ListType _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1529.has_value) {
                __auto_type lt = _mv_1529.value;
...
void transpiler_emit_record_field_dependencies(context_TranspileContext* ctx, slop_list_context_FieldEntry fields) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1536 = ({ __auto_type _lst = fields; size_t _idx = (size_t)i; slop_option_context_FieldEntry _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1536.has_value) {
                __auto_type field = _mv_1536.value;
                {
...
uint8_t transpiler_is_range_type_alias(context_TranspileContext* ctx, slop_string slop_type) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    __auto_type _mv_1537 = context_ctx_lookup_type_alias(ctx, slop_type);
    if (_mv_1537.has_value) {
        __auto_type underlying = _mv_1537.value;
...
slop_string transpiler_resolve_payload_slop_type(context_TranspileContext* ctx, slop_string slop_type) {
    ...
    if (transpiler_is_range_type_alias(ctx, slop_type)) {
        __auto_type _mv_1538 = context_ctx_lookup_type_alias(ctx, slop_type);
        if (_mv_1538.has_value) {
            __auto_type underlying = _mv_1538.value;
            return underlying;
...
slop_list_transpiler_PayloadSlot transpiler_union_variant_payloads(context_TranspileContext* ctx, slop_string union_name, slop_string variant_name) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        __auto_type _mv_1539 = context_ctx_lookup_field_type(ctx, union_name, count_key);
        if (_mv_1539.has_value) {
            __auto_type _ = _mv_1539.value;
            {
                __auto_type i = 0;
                __auto_type more = 1;
                while (more) {
                    {
                        ...
                        __auto_type _mv_1540 = context_ctx_lookup_field_type(ctx, union_name, key);
                        if (_mv_1540.has_value) {
                            __auto_type slot_c_type = _mv_1540.value;
                            {
...
void transpiler_emit_union_hash_fn(context_TranspileContext* ctx, slop_string c_type, slop_list_context_UnionVariantEntry variants) {
    ...
    context_ctx_emit_header(ctx, SLOP_STR("    switch (_k->tag) {"));
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1541 = ({ __auto_type _lst = variants; size_t _idx = (size_t)i; slop_option_context_UnionVariantEntry _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1541.has_value) {
                __auto_type variant = _mv_1541.value;
...
void transpiler_emit_multi_payload_hash(context_TranspileContext* ctx, slop_string c_variant_name, slop_list_transpiler_PayloadSlot payloads) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            __auto_type _mv_1542 = ({ __auto_type _lst = payloads; size_t _idx = (size_t)i; slop_option_transpiler_PayloadSlot _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1542.has_value) {
                __auto_type slot = _mv_1542.value;
                {
...
void transpiler_emit_union_eq_fn(context_TranspileContext* ctx, slop_string c_type, slop_list_context_UnionVariantEntry variants) {
    ...
    context_ctx_emit_header(ctx, SLOP_STR("    switch (_a->tag) {"));
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1543 = ({ __auto_type _lst = variants; size_t _idx = (size_t)i; slop_option_context_UnionVariantEntry _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1543.has_value) {
                __auto_type variant = _mv_1543.value;
...
void transpiler_emit_multi_payload_eq(context_TranspileContext* ctx, slop_string c_variant_name, slop_list_transpiler_PayloadSlot payloads) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        context_ctx_emit_header(ctx, SLOP_STR("            return true"));
        while (i < len) {
            __auto_type _mv_1544 = ({ __auto_type _lst = payloads; size_t _idx = (size_t)i; slop_option_transpiler_PayloadSlot _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1544.has_value) {
                __auto_type slot = _mv_1544.value;
                {
    ...
    context_ctx_emit_header(ctx, context_ctx_str(ctx, context_ctx_str4(ctx, SLOP_STR("    const "), c_type, SLOP_STR("* _b = (const "), c_type), SLOP_STR("*)b;")));
    {
        ...
        if (len == 0) {
            ...
            context_ctx_emit_header(ctx, SLOP_STR("    return true"));
            {
                int64_t i = 0;
                while (i < len) {
                    __auto_type _mv_1546 = ({ __auto_type _lst = fields; size_t _idx = (size_t)i; slop_option_context_FieldEntry _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_1546.has_value) {
                        __auto_type field = _mv_1546.value;
...
void transpiler_emit_struct_key_types_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < ((int64_t)((struct_key_types).len))) {
            __auto_type _mv_1547 = ({ __auto_type _lst = struct_key_types; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1547.has_value) {
                __auto_type c_type = _mv_1547.value;
                {
...
void transpiler_emit_chan_types_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1548 = ({ __auto_type _lst = chan_types; size_t _idx = (size_t)i; slop_option_context_ChanType _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1548.has_value) {
                __auto_type ct = _mv_1548.value;
                {
...
void transpiler_emit_chan_funcs_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1549 = ({ __auto_type _lst = chan_types; size_t _idx = (size_t)i; slop_option_context_ChanType _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1549.has_value) {
                __auto_type ct = _mv_1549.value;
                {
                    __auto_type elem_type = ct.elem_type;
                    __auto_type c_name = ct.c_name;
...
void transpiler_emit_thread_types_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1550 = ({ __auto_type _lst = thread_types; size_t _idx = (size_t)i; slop_option_context_ThreadType _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1550.has_value) {
                __auto_type tt = _mv_1550.value;
                {
...
void transpiler_emit_option_by_c_name(context_TranspileContext* ctx, slop_string c_name) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1563 = ({ __auto_type _lst = option_types; size_t _idx = (size_t)i; slop_option_context_OptionType _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1563.has_value) {
                __auto_type ot = _mv_1563.value;
                    ...
                    if (transpiler_is_type_def(item) && transpiler_is_struct_type_def(item)) {
                        {
                            ...
                            __auto_type j = 0;
                            while (j < dep_len) {
                                __auto_type _mv_1569 = ({ __auto_type _lst = blocking_deps; size_t _idx = (size_t)j; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1569.has_value) {
                                    __auto_type dep_name = _mv_1569.value;
...
uint8_t transpiler_index_in_list(slop_list_int lst, int64_t idx) {
    {
        ...
        uint8_t found = 0;
        while ((i < len) && !(found)) {
            __auto_type _mv_1572 = ({ __auto_type _lst = lst; size_t _idx = (size_t)i; slop_option_int _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1572.has_value) {
                __auto_type v = _mv_1572.value;
                if (v == idx) {
                    found = 1;
                }
        ...
        switch (_mv_1574.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1574.data.lst;
                {
                    __auto_type items = lst.items;
                    if (((int64_t)((items).len)) >= 3) {
                        __auto_type _mv_1575 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_1575.has_value) {
                            __auto_type def_expr = _mv_1575.value;
                            __auto_type _mv_1576 = (*def_expr);
                            switch (_mv_1576.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type def_lst = _mv_1576.data.lst;
                                    {
                                        __auto_type def_items = def_lst.items;
                                        __auto_type def_len = ((int64_t)((def_items).len));
                                        if (def_len > 0) {
                                            __auto_type _mv_1577 = ({ __auto_type _lst = def_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_1577.has_value) {
                                                __auto_type head = _mv_1577.value;
                                                __auto_type _mv_1578 = (*head);
                                                switch (_mv_1578.tag) {
                                                    case types_SExpr_sym:
                                                    {
        ...
        while (i < len) {
            ...
            if (_mv_1579.has_value) {
                ...
                switch (_mv_1580.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type field_lst = _mv_1580.data.lst;
                        if (((int64_t)((field_lst.items).len)) >= 2) {
                            __auto_type _mv_1581 = ({ __auto_type _lst = field_lst.items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_list_string transpiler_extract_union_variant_types(context_TranspileContext* ctx, slop_list_types_SExpr_ptr def_items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 1;
        while (i < len) {
            __auto_type _mv_1582 = ({ __auto_type _lst = def_items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1582.has_value) {
                __auto_type variant_expr = _mv_1582.value;
                __auto_type _mv_1583 = (*variant_expr);
                switch (_mv_1583.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type variant_lst = _mv_1583.data.lst;
                        if (((int64_t)((variant_lst.items).len)) >= 2) {
                            __auto_type _mv_1584 = ({ __auto_type _lst = variant_lst.items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_string transpiler_get_field_type_string(context_TranspileContext* ctx, types_SExpr* type_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1585 = (*type_expr);
        switch (_mv_1585.tag) {
            case types_SExpr_sym:
            {
                ...
                __auto_type lst = _mv_1585.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) < 1) {
                        ...
                        if (_mv_1587.has_value) {
                            __auto_type head = _mv_1587.value;
                            __auto_type _mv_1588 = (*head);
                            switch (_mv_1588.tag) {
                                case types_SExpr_sym:
                                {
                    ...
                    if (_mv_1592.has_value) {
                        ...
                        switch (_mv_1593.tag) {
                            case types_SExpr_sym:
                            {
                                ...
                                {
                                    __auto_type name = sym.name;
                                    __auto_type _mv_1594 = context_ctx_lookup_type(ctx, name);
        ...
        if (!(found)) {
            {
                ...
                int64_t j = 0;
                while ((j < len2) && !(found)) {
                    __auto_type _mv_1598 = ({ __auto_type _lst = option_types; size_t _idx = (size_t)j; slop_option_context_OptionType _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_1598.has_value) {
                        __auto_type ot = _mv_1598.value;
...
void transpiler_emit_struct_dependent_list_types(context_TranspileContext* ctx, types_SExpr* type_def) {
    ...
    SLOP_PRE(((type_def != NULL)), "(!= type-def nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1599 = ({ __auto_type _lst = list_types; size_t _idx = (size_t)i; slop_option_context_ListType _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1599.has_value) {
                __auto_type lt = _mv_1599.value;
                if (!(transpiler_is_pointer_elem_type(lt.elem_type)) && transpiler_struct_uses_list_type(ctx, type_def, lt.c_name)) {
                    transpiler_emit_single_list_type_header(ctx, lt);
                }
...
uint8_t transpiler_is_imported_type(context_TranspileContext* ctx, slop_string type_name) {
    ...
    if (strlib_starts_with(type_name, SLOP_STR("slop_list_")) || strlib_starts_with(type_name, SLOP_STR("slop_option_"))) {
        ...
        __auto_type _mv_1603 = context_ctx_get_module(ctx);
        if (_mv_1603.has_value) {
            __auto_type current_mod = _mv_1603.value;
            {
                __auto_type arena = (*ctx).arena;
...
uint8_t transpiler_struct_uses_list_type(context_TranspileContext* ctx, types_SExpr* type_def, slop_string list_type_name) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1606 = (*type_def);
        switch (_mv_1606.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1606.data.lst;
                {
                    __auto_type items = lst.items;
                    if (((int64_t)((items).len)) < 3) {
                        return 0;
                ...
                __auto_type lst = _mv_1608.data.lst;
                {
                    ...
                    while ((i < len) && !(found)) {
                        ...
                        if (_mv_1609.has_value) {
                            __auto_type field_expr = _mv_1609.value;
...
uint8_t transpiler_field_uses_typename(context_TranspileContext* ctx, types_SExpr* field_expr, slop_string typename) {
    ...
    __auto_type _mv_1610 = (*field_expr);
    switch (_mv_1610.tag) {
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1610.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 2) {
                    ...
                    if (_mv_1611.has_value) {
                        __auto_type type_expr = _mv_1611.value;
                        {
                            __auto_type c_type = context_to_c_type_prefixed(ctx, type_expr);
                            ...
                            switch (_mv_1614.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_1614.data.sym;
                                    {
                                        ...
                                        __auto_type base_name = ctype_to_c_name(arena, type_name);
                                        __auto_type c_name = ((context_ctx_prefixing_enabled(ctx)) ? ({ __auto_type _mv = context_ctx_get_module(ctx); _mv.has_value ? ({ __auto_type mod_name = _mv.value; context_ctx_str(ctx, ctype_to_c_name(arena, mod_name), context_ctx_str(ctx, SLOP_STR("_"), base_name)); }) : (base_name); }) : base_name);
                                        __auto_type _mv_1615 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_1615.has_value) {
                                            __auto_type body_expr = _mv_1615.value;
...
void transpiler_emit_type_body_to_header(context_TranspileContext* ctx, slop_string raw_type_name, slop_string c_name, types_SExpr* body_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1616 = (*body_expr);
        switch (_mv_1616.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1616.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) < 1) {
                        ...
                        if (_mv_1617.has_value) {
                            __auto_type kind_expr = _mv_1617.value;
                            __auto_type _mv_1618 = (*kind_expr);
                            switch (_mv_1618.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type kind_sym = _mv_1618.data.sym;
                                    {
        ...
        while (i < len) {
            ...
            if (_mv_1619.has_value) {
                ...
                switch (_mv_1620.tag) {
                    case types_SExpr_sym:
                    {
                        __auto_type variant_sym = _mv_1620.data.sym;
                        {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_1621.has_value) {
                __auto_type field_expr = _mv_1621.value;
...
void transpiler_emit_field_to_header(context_TranspileContext* ctx, slop_string raw_type_name, slop_string c_type_name, types_SExpr* field_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1622 = (*field_expr);
        switch (_mv_1622.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1622.data.lst;
                {
                    __auto_type items = lst.items;
                    if (((int64_t)((items).len)) >= 2) {
                        __auto_type _mv_1623 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            ...
                            switch (_mv_1624.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_1624.data.sym;
                                    {
                                        ...
                                        __auto_type _mv_1625 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
uint8_t transpiler_is_pointer_type_expr_header(types_SExpr* type_expr) {
    SLOP_PRE(((type_expr != NULL)), "(!= type-expr nil)");
    __auto_type _mv_1626 = (*type_expr);
    switch (_mv_1626.tag) {
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1626.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 1) {
                    ...
                    if (_mv_1627.has_value) {
                        __auto_type head = _mv_1627.value;
                        __auto_type _mv_1628 = (*head);
                        switch (_mv_1628.tag) {
                            case types_SExpr_sym:
                            {
...
void transpiler_emit_union_to_header(context_TranspileContext* ctx, slop_string c_name, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        context_ctx_emit_header(ctx, SLOP_STR("typedef enum {"));
        {
            int64_t i = 1;
            while (i < len) {
                __auto_type _mv_1629 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_1629.has_value) {
                    __auto_type variant_expr = _mv_1629.value;
                    {
...
void transpiler_emit_union_variant_to_header(context_TranspileContext* ctx, types_SExpr* variant_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1634 = (*variant_expr);
        switch (_mv_1634.tag) {
            case types_SExpr_sym:
            {
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1634.data.lst;
                {
                    ...
                    if (num_items >= 2) {
                        __auto_type _mv_1635 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_1635.has_value) {
                            __auto_type name_expr = _mv_1635.value;
                            __auto_type _mv_1636 = (*name_expr);
                            switch (_mv_1636.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_1636.data.sym;
                                    {
                                        __auto_type variant_name = name_sym.name;
                                        __auto_type c_field = ctype_to_c_name(arena, variant_name);
                                        if (num_items == 2) {
                                            __auto_type _mv_1637 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_1637.has_value) {
                                                __auto_type type_expr = _mv_1637.value;
                                                {
                                                    __auto_type c_type = context_to_c_type_prefixed(ctx, type_expr);
                                                    {
                                            ...
                                            for (int64_t fi = 1; fi < num_items; fi++) {
                                                __auto_type _mv_1638 = ({ __auto_type _lst = items; size_t _idx = (size_t)fi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_1638.has_value) {
                                                    __auto_type type_expr = _mv_1638.value;
                                                    {
                                                        __auto_type c_type = context_to_c_type_prefixed(ctx, type_expr);
                                                        {
                                                            __auto_type actual_type = ((string_eq(c_type, SLOP_STR("void"))) ? SLOP_STR("int") : c_type);
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1640.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 2) {
                    ...
                    __auto_type _mv_1641 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
uint8_t transpiler_emit_const_header_if_exported(context_TranspileContext* ctx, types_SExpr* item, slop_list_string exports) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    SLOP_PRE(((item != NULL)), "(!= item nil)");
    __auto_type _mv_1644 = (*item);
    switch (_mv_1644.tag) {
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1644.data.lst;
            {
                __auto_type const_items = lst.items;
                if (((int64_t)((const_items).len)) < 4) {
                    return 0;
                } else {
                    __auto_type _mv_1645 = ({ __auto_type _lst = const_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_1645.has_value) {
                        __auto_type name_expr = _mv_1645.value;
                        __auto_type _mv_1646 = (*name_expr);
                        switch (_mv_1646.tag) {
                            case types_SExpr_sym:
                            {
                                __auto_type name_sym = _mv_1646.data.sym;
                                {
                                    __auto_type raw_name = name_sym.name;
                                    if (!(transpiler_list_contains_str(exports, raw_name))) {
                                        return 0;
                                    } else {
                                        __auto_type _mv_1647 = ({ __auto_type _lst = const_items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void transpiler_emit_all_lambdas(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (count > 0) {
            while (i < count) {
                __auto_type _mv_1649 = ({ __auto_type _lst = lambdas; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_1649.has_value) {
                    __auto_type lambda_code = _mv_1649.value;
...
slop_string transpiler_generate_c_output(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1650 = ({ __auto_type _lst = output_lines; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1650.has_value) {
                __auto_type line = _mv_1650.value;
...
void transpiler_transpile_file(context_TranspileContext* ctx, slop_list_types_SExpr_ptr exprs) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len > 0) && transpiler_is_module_expr(exprs)) {
            __auto_type _mv_1651 = ({ __auto_type _lst = exprs; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1651.has_value) {
                __auto_type module_expr = _mv_1651.value;
...
uint8_t transpiler_is_module_expr(slop_list_types_SExpr_ptr exprs) {
    if (((int64_t)((exprs).len)) < 1) {
        ...
        __auto_type _mv_1652 = ({ __auto_type _lst = exprs; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        if (_mv_1652.has_value) {
            __auto_type first = _mv_1652.value;
            __auto_type _mv_1653 = (*first);
            switch (_mv_1653.tag) {
                case types_SExpr_lst:
                {
                    __auto_type lst = _mv_1653.data.lst;
                    {
                        ...
                        if (((int64_t)((items).len)) < 1) {
                            ...
                            __auto_type _mv_1654 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_1654.has_value) {
                                __auto_type head = _mv_1654.value;
                                __auto_type _mv_1655 = (*head);
                                switch (_mv_1655.tag) {
                                    case types_SExpr_sym:
                                    {
