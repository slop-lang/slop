                    ...
                    case types_SExpr_lst:
                    {
                        __auto_type lst = _mv_1259.data.lst;
                        {
                            ...
                            if (((int64_t)((sub_items).len)) >= 1) {
                                __auto_type _mv_1260 = ({ __auto_type _lst = sub_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        ...
                                        case types_SExpr_sym:
                                        {
                                            ...
                                            if (string_eq(sym.name, SLOP_STR("@generic"))) {
                                                if (((int64_t)((sub_items).len)) >= 2) {
                                                    __auto_type _mv_1262 = ({ __auto_type _lst = sub_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_1262.has_value) {
                                                        __auto_type params_expr = _mv_1262.value;
                                                        __auto_type _mv_1263 = (*params_expr);
                                                        switch (_mv_1263.tag) {
                                                            case types_SExpr_lst:
                                                            {
                                                                __auto_type params_lst = _mv_1263.data.lst;
                                                                {
                                                                    __auto_type param_items = params_lst.items;
                                                                    __auto_type param_len = ((int64_t)((param_items).len));
                                                                    __auto_type j = 0;
                                                                    while (j < param_len) {
                                                                        __auto_type _mv_1264 = ({ __auto_type _lst = param_items; size_t _idx = (size_t)j; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                                        if (_mv_1264.has_value) {
                                                                            __auto_type param = _mv_1264.value;
                                                                            __auto_type _mv_1265 = (*param);
                                                                            switch (_mv_1265.tag) {
                                                                                case types_SExpr_sym:
                                                                                {
                                                                                    __auto_type param_sym = _mv_1265.data.sym;
                                                            ...
                                                            case types_SExpr_sym:
                                                            {
                                                                __auto_type single_sym = _mv_1263.data.sym;
                            ...
                            __auto_type c_name = ((context_ctx_prefixing_enabled(ctx)) ? ({ __auto_type _mv = context_ctx_get_module(ctx); _mv.has_value ? ({ __auto_type mod_name = _mv.value; context_ctx_str(ctx, ctype_to_c_name(arena, mod_name), context_ctx_str(ctx, SLOP_STR("_"), base_c_name)); }) : (base_c_name); }) : base_c_name);
                            {
                                ...
                                if (((int64_t)((items).len)) >= 3) {
                                    ...
                                    if (_mv_1274.has_value) {
                                        __auto_type body_expr = _mv_1274.value;
            ...
            switch (_mv_1276.tag) {
                case types_SExpr_lst:
                {
                    __auto_type def_lst = _mv_1276.data.lst;
                    {
                        ...
                        __auto_type i = 1;
                        while (i < len) {
                            __auto_type _mv_1277 = ({ __auto_type _lst = def_items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_1277.has_value) {
                                __auto_type variant_expr = _mv_1277.value;
                                __auto_type _mv_1278 = (*variant_expr);
                                switch (_mv_1278.tag) {
                                    case types_SExpr_sym:
                                    {
                                    ...
                                    case types_SExpr_lst:
                                    {
                                        __auto_type variant_lst = _mv_1278.data.lst;
                                        if (((int64_t)((variant_lst.items).len)) > 0) {
                                            __auto_type _mv_1279 = ({ __auto_type _lst = variant_lst.items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            ...
                                            __auto_type variant_lst = _mv_1284.data.lst;
                                            {
                                                ...
                                                if (vl_len >= 2) {
                                                        ...
                                                        switch (_mv_1286.tag) {
                                                            case types_SExpr_sym:
                                                            {
                                                                __auto_type name_sym = _mv_1286.data.sym;
                                                                {
                                                                    ...
                                                                    context_ctx_register_enum_variant(ctx, variant_name, union_name);
                                                                    __auto_type _mv_1287 = ({ __auto_type _lst = vl_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                                    ...
                                                                    if (vl_len >= 3) {
                                                                        ...
                                                                        for (int64_t fi = 1; fi < vl_len; fi++) {
                                                                            __auto_type _mv_1288 = ({ __auto_type _lst = vl_items; size_t _idx = (size_t)fi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    ...
                                                    if (((int64_t)((vl_items).len)) == 1) {
                                                        __auto_type _mv_1289 = ({ __auto_type _lst = vl_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                        if (_mv_1289.has_value) {
                                                            ...
                                                            switch (_mv_1290.tag) {
                                                                case types_SExpr_sym:
                                                                {
                                                                    __auto_type name_sym = _mv_1290.data.sym;
                                                                    {
                                                                        __auto_type variant_name = name_sym.name;
                                                                        context_ctx_register_enum_variant(ctx, variant_name, union_name);
                                                                        context_ctx_register_union_variant(ctx, variant_name, union_name, ctype_to_c_name(arena, variant_name), SLOP_STR(""), SLOP_STR(""));
                                    ...
                                    switch (_mv_1296.tag) {
                                        case types_SExpr_sym:
                                        {
                                            ...
                                            if (string_eq(sym.name, SLOP_STR("@spec"))) {
                                                __auto_type _mv_1297 = ({ __auto_type _lst = sub_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_1297.has_value) {
                                                    __auto_type spec_body = _mv_1297.value;
                                                    __auto_type _mv_1298 = (*spec_body);
                                                    switch (_mv_1298.tag) {
                                                        case types_SExpr_lst:
                                                        {
                                                            __auto_type body_lst = _mv_1298.data.lst;
                                                            {
                                                                __auto_type body_items = body_lst.items;
                                                                __auto_type body_len = ((int64_t)((body_items).len));
                                                                if (body_len >= 1) {
                                                                    __auto_type _mv_1299 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)(body_len - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                                    if (_mv_1299.has_value) {
                                                                        __auto_type ret_type = _mv_1299.value;
                                                                        __auto_type _mv_1300 = (*ret_type);
                                                                        switch (_mv_1300.tag) {
                                                                            case types_SExpr_sym:
                                                                            {
                                                                                __auto_type ret_sym = _mv_1300.data.sym;
                ...
                switch (_mv_1302.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type lst = _mv_1302.data.lst;
                        {
                            __auto_type sub_items = lst.items;
                            if (((int64_t)((sub_items).len)) >= 2) {
                                __auto_type _mv_1303 = ({ __auto_type _lst = sub_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1303.has_value) {
                                    ...
                                    switch (_mv_1304.tag) {
                                        case types_SExpr_sym:
                                        {
                                            ...
                                            if (string_eq(sym.name, SLOP_STR("@spec"))) {
                                                __auto_type _mv_1305 = ({ __auto_type _lst = sub_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void transpiler_prescan_fn_params(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    ...
    if (((int64_t)((items).len)) >= 3) {
        ...
        if (_mv_1308.has_value) {
            __auto_type params_expr = _mv_1308.value;
            __auto_type _mv_1309 = (*params_expr);
            switch (_mv_1309.tag) {
                case types_SExpr_lst:
                {
                    __auto_type params_lst = _mv_1309.data.lst;
                    {
                        __auto_type params = params_lst.items;
                        __auto_type param_count = ((int64_t)((params).len));
                        __auto_type i = 0;
                        while (i < param_count) {
                            __auto_type _mv_1310 = ({ __auto_type _lst = params; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_1310.has_value) {
                                __auto_type param_expr = _mv_1310.value;
                                __auto_type _mv_1311 = (*param_expr);
                                switch (_mv_1311.tag) {
                                    case types_SExpr_lst:
                                    {
                                        __auto_type param_lst = _mv_1311.data.lst;
                                        {
                                            __auto_type param_items = param_lst.items;
                                            if (((int64_t)((param_items).len)) >= 2) {
                                                __auto_type _mv_1312 = ({ __auto_type _lst = param_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (((int64_t)((items).len)) >= 3) {
            ...
            if (_mv_1313.has_value) {
                __auto_type params_expr = _mv_1313.value;
                __auto_type _mv_1314 = (*params_expr);
                switch (_mv_1314.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type params_lst = _mv_1314.data.lst;
                        {
                            __auto_type params = params_lst.items;
                            __auto_type param_count = ((int64_t)((params).len));
                            __auto_type i = 0;
                            while (i < param_count) {
                                __auto_type _mv_1315 = ({ __auto_type _lst = params; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1315.has_value) {
                                    __auto_type param_expr = _mv_1315.value;
                                    {
                ...
                __auto_type lst = _mv_1316.data.lst;
                {
                    ...
                    if (len < 2) {
                    ...
                    } else {
                        {
                            ...
                            __auto_type _mv_1317 = ({ __auto_type _lst = items; size_t _idx = (size_t)type_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_1317.has_value) {
                                __auto_type type_expr = _mv_1317.value;
...
uint8_t transpiler_prescan_is_param_mode(slop_list_types_SExpr_ptr items) {
    if (((int64_t)((items).len)) < 1) {
        ...
        if (_mv_1318.has_value) {
            __auto_type first = _mv_1318.value;
            __auto_type _mv_1319 = (*first);
            switch (_mv_1319.tag) {
                case types_SExpr_sym:
                {
...
void transpiler_extract_result_type(context_TranspileContext* ctx, types_SExpr* spec_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1324 = (*spec_expr);
        switch (_mv_1324.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1324.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) >= 2) {
                        ...
                        if (_mv_1325.has_value) {
                            __auto_type spec_body = _mv_1325.value;
                            __auto_type _mv_1326 = (*spec_body);
                            switch (_mv_1326.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type body_lst = _mv_1326.data.lst;
                                    {
                                        __auto_type body_items = body_lst.items;
                                        __auto_type body_len = ((int64_t)((body_items).len));
                                        if (body_len >= 1) {
                                            __auto_type _mv_1327 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)(body_len - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_1327.has_value) {
                                                __auto_type ret_type = _mv_1327.value;
...
void transpiler_check_and_register_result_type(context_TranspileContext* ctx, types_SExpr* type_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1328 = (*type_expr);
        switch (_mv_1328.tag) {
            case types_SExpr_lst:
            {
                                ...
                                case types_SExpr_sym:
                                {
                                    ...
                                    if (string_eq(sym.name, SLOP_STR("Result"))) {
                                        ...
                                        if (_mv_1331.has_value) {
                                            __auto_type ok_type_expr = _mv_1331.value;
                                            ...
                                            if (_mv_1332.has_value) {
                                                __auto_type err_type_expr = _mv_1332.value;
                                                {
                                    ...
                                    if (string_eq(name, SLOP_STR("map-new"))) {
                                        if (len >= 3) {
                                            ...
                                            if (_mv_1337.has_value) {
                                                __auto_type key_type_expr = _mv_1337.value;
...
void transpiler_prescan_register_struct_key_type(context_TranspileContext* ctx, types_SExpr* type_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1343 = (*type_expr);
        switch (_mv_1343.tag) {
            case types_SExpr_sym:
            {
                __auto_type sym = _mv_1343.data.sym;
                {
                    ...
                    if (!(transpiler_is_builtin_map_key_type(name))) {
                        __auto_type _mv_1344 = context_ctx_lookup_type(ctx, name);
                        if (_mv_1344.has_value) {
                            __auto_type type_entry = _mv_1344.value;
                            context_ctx_register_struct_key_type(ctx, type_entry.c_name);
                        } else if (!_mv_1344.has_value) {
                            __auto_type _mv_1345 = context_ctx_get_module(ctx);
                            if (_mv_1345.has_value) {
                                __auto_type mod = _mv_1345.value;
                                {
                                    __auto_type prefixed = context_ctx_str3(ctx, mod, SLOP_STR("_"), name);
                                    __auto_type _mv_1346 = context_ctx_lookup_type(ctx, prefixed);
                                    if (_mv_1346.has_value) {
                                        __auto_type type_entry = _mv_1346.value;
                                        context_ctx_register_struct_key_type(ctx, type_entry.c_name);
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len >= 2) {
            ...
            if (_mv_1352.has_value) {
                __auto_type header_expr = _mv_1352.value;
                __auto_type _mv_1353 = (*header_expr);
                switch (_mv_1353.tag) {
                    case types_SExpr_str:
                    {
                        __auto_type str = _mv_1353.data.str;
            ...
            }
            {
                ...
                while (i < len) {
                    ...
                    if (_mv_1354.has_value) {
                        __auto_type func_decl = _mv_1354.value;
...
void transpiler_prescan_import(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    ...
    if (((int64_t)((items).len)) >= 3) {
        ...
        if (_mv_1355.has_value) {
            __auto_type mod_expr = _mv_1355.value;
            __auto_type _mv_1356 = (*mod_expr);
            switch (_mv_1356.tag) {
                case types_SExpr_sym:
                {
                    __auto_type mod_sym = _mv_1356.data.sym;
                    {
                        ...
                        if (_mv_1357.has_value) {
                            __auto_type symbols_expr = _mv_1357.value;
                            __auto_type _mv_1358 = (*symbols_expr);
                            switch (_mv_1358.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type symbols_lst = _mv_1358.data.lst;
                                    {
                                        __auto_type syms = symbols_lst.items;
                                        __auto_type sym_len = ((int64_t)((syms).len));
                                        __auto_type j = 0;
                                        while (j < sym_len) {
                                            __auto_type _mv_1359 = ({ __auto_type _lst = syms; size_t _idx = (size_t)j; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_1359.has_value) {
                                                __auto_type sym_item = _mv_1359.value;
                                                __auto_type _mv_1360 = (*sym_item);
                                                switch (_mv_1360.tag) {
                                                    case types_SExpr_sym:
                                                    {
                                                        __auto_type s = _mv_1360.data.sym;
                                                        {
...
void transpiler_register_ffi_function(context_TranspileContext* ctx, types_SExpr* func_decl) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1363 = (*func_decl);
        switch (_mv_1363.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1363.data.lst;
                {
                    ...
                    __auto_type len = ((int64_t)((items).len));
                    if (len >= 1) {
                        __auto_type _mv_1364 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_1369.has_value) {
                __auto_type item_expr = _mv_1369.value;
                __auto_type _mv_1370 = (*item_expr);
                switch (_mv_1370.tag) {
                    case types_SExpr_sym:
                    {
                        __auto_type sym = _mv_1370.data.sym;
                        if (string_eq(sym.name, SLOP_STR(":c-name"))) {
                            __auto_type _mv_1371 = ({ __auto_type _lst = items; size_t _idx = (size_t)(i + 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_1371.has_value) {
                                __auto_type c_name_expr = _mv_1371.value;
                                __auto_type _mv_1372 = (*c_name_expr);
                                switch (_mv_1372.tag) {
                                    case types_SExpr_sym:
                                    {
                                        __auto_type c_sym = _mv_1372.data.sym;
                                        c_name = c_sym.name;
                                        found_c_name = 1;
                                        break;
                                    }
        ...
        if (len >= 2) {
            {
                ...
                if (has_header) {
                    ...
                    if (_mv_1373.has_value) {
                        __auto_type header_expr = _mv_1373.value;
                        __auto_type _mv_1374 = (*header_expr);
                        switch (_mv_1374.tag) {
                            case types_SExpr_str:
                            {
                                __auto_type str = _mv_1374.data.str;
                                context_ctx_add_include(ctx, str.value);
                                break;
                            }
                            default: {
                ...
                if (len >= (name_idx + 1)) {
                    __auto_type _mv_1375 = ({ __auto_type _lst = items; size_t _idx = (size_t)name_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_string transpiler_get_ffi_struct_c_name(slop_arena* arena, slop_list_types_SExpr_ptr items, int64_t name_idx, slop_string default_name) {
    {
        ...
        if (len >= (modifier_idx + 2)) {
            __auto_type _mv_1377 = ({ __auto_type _lst = items; size_t _idx = (size_t)modifier_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1377.has_value) {
                __auto_type mod_expr = _mv_1377.value;
                __auto_type _mv_1378 = (*mod_expr);
                switch (_mv_1378.tag) {
                    case types_SExpr_sym:
                    {
                        __auto_type sym = _mv_1378.data.sym;
                        if (string_eq(sym.name, SLOP_STR(":c-name"))) {
                            __auto_type _mv_1379 = ({ __auto_type _lst = items; size_t _idx = (size_t)(modifier_idx + 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_1379.has_value) {
                                __auto_type cname_expr = _mv_1379.value;
                                __auto_type _mv_1380 = (*cname_expr);
                                switch (_mv_1380.tag) {
                                    case types_SExpr_str:
                                    {
...
uint8_t transpiler_is_ffi_string_item(slop_list_types_SExpr_ptr items, int64_t idx) {
    __auto_type _mv_1381 = ({ __auto_type _lst = items; size_t _idx = (size_t)idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    if (_mv_1381.has_value) {
        ...
        switch (_mv_1382.tag) {
            case types_SExpr_str:
            {
                __auto_type _ = _mv_1382.data.str;
                return 1;
            }
            default: {
                return 0;
...
uint8_t transpiler_is_union_def(slop_list_types_SExpr_ptr items) {
    if (((int64_t)((items).len)) < 3) {
        ...
        if (_mv_1391.has_value) {
            __auto_type def_expr = _mv_1391.value;
            __auto_type _mv_1392 = (*def_expr);
            switch (_mv_1392.tag) {
                case types_SExpr_lst:
                {
                    __auto_type def_lst = _mv_1392.data.lst;
                    {
                        __auto_type def_items = def_lst.items;
                        if (((int64_t)((def_items).len)) < 1) {
                            return 0;
                        } else {
                            __auto_type _mv_1393 = ({ __auto_type _lst = def_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_string transpiler_get_array_c_type(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items, slop_string default_c_type) {
    ...
    if (((int64_t)((items).len)) < 3) {
        ...
        if (_mv_1395.has_value) {
            __auto_type body_expr = _mv_1395.value;
            __auto_type _mv_1396 = (*body_expr);
            switch (_mv_1396.tag) {
                case types_SExpr_lst:
                {
                    __auto_type body_lst = _mv_1396.data.lst;
                    {
                        __auto_type body_items = body_lst.items;
                        if (((int64_t)((body_items).len)) < 2) {
                            return default_c_type;
                        } else {
                            __auto_type _mv_1397 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                ...
                                switch (_mv_1398.tag) {
                                    case types_SExpr_sym:
                                    {
                                        ...
                                        if (string_eq(sym.name, SLOP_STR("Array"))) {
                                            __auto_type _mv_1399 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_1399.has_value) {
                                                __auto_type elem_expr = _mv_1399.value;
                                                {
...
void transpiler_transpile_module(context_TranspileContext* ctx, types_SExpr* module_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1414 = (*module_expr);
        switch (_mv_1414.tag) {
            case types_SExpr_lst:
            {
...
int64_t transpiler_get_body_start(slop_list_types_SExpr_ptr items) {
    if (((int64_t)((items).len)) < 3) {
        ...
        if (_mv_1417.has_value) {
            __auto_type third = _mv_1417.value;
            __auto_type _mv_1418 = (*third);
            switch (_mv_1418.tag) {
                case types_SExpr_lst:
                {
                ...
                switch (_mv_1422.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type lst = _mv_1422.data.lst;
                        {
                            __auto_type sub_items = lst.items;
                            if (((int64_t)((sub_items).len)) >= 1) {
                                __auto_type _mv_1423 = ({ __auto_type _lst = sub_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            ...
                                            if (string_eq(sym.name, SLOP_STR("export"))) {
                                                {
                                                    ...
                                                    __auto_type j = 1;
                                                    while (j < export_len) {
                                                        __auto_type _mv_1425 = ({ __auto_type _lst = sub_items; size_t _idx = (size_t)j; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
uint8_t transpiler_list_contains_str(slop_list_string lst, slop_string needle) {
    {
        ...
        uint8_t found = 0;
        while ((i < len) && !(found)) {
            __auto_type _mv_1427 = ({ __auto_type _lst = lst; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1427.has_value) {
                __auto_type s = _mv_1427.value;
                                        ...
                                        if (string_eq(op, SLOP_STR("Option"))) {
                                            ...
                                            if (len >= 3) {
                                                ...
                                                if (_mv_1435.has_value) {
                                                    __auto_type ok_type = _mv_1435.value;
                                                    ...
                                                    if (_mv_1436.has_value) {
                                                        __auto_type err_type = _mv_1436.value;
                                                        {
                                            ...
                                            if (len >= 2) {
                                                ...
                                                if (_mv_1437.has_value) {
                                                    __auto_type elem = _mv_1437.value;
                                                    {
                                                        __auto_type elem_c = context_to_c_type_prefixed(ctx, elem);
                                                        __auto_type elem_id = ctype_type_to_identifier(arena, elem_c);
                                                        __auto_type c_name = context_ctx_str(ctx, SLOP_STR("slop_chan_"), elem_id);
                                            ...
                                            if (len >= 2) {
                                                ...
                                                if (_mv_1438.has_value) {
                                                    __auto_type result = _mv_1438.value;
                                                    {
                                            ...
                                            if (len >= 3) {
                                                ...
                                                if (_mv_1439.has_value) {
                                                    __auto_type key_type = _mv_1439.value;
                                                    {
                                                        ...
                                                        if (_mv_1440.has_value) {
                                                            __auto_type val_type = _mv_1440.value;
                                                            {
                                            ...
                                            if (len >= 2) {
                                                ...
                                                if (_mv_1441.has_value) {
                                                    __auto_type elem_type = _mv_1441.value;
                                                    {
        ...
        while (i < len) {
            ...
            if (_mv_1442.has_value) {
                ...
                switch (_mv_1443.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type field_lst = _mv_1443.data.lst;
                        {
                            __auto_type field_items = field_lst.items;
                            if (((int64_t)((field_items).len)) >= 2) {
                                __auto_type _mv_1444 = ({ __auto_type _lst = field_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void transpiler_emit_header_dependency_includes(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1448 = ({ __auto_type _lst = imports; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        while (i < len) {
            ...
            if (_mv_1449.has_value) {
                ...
                if (transpiler_is_type_def(item) && transpiler_is_struct_type_def(item)) {
                    __auto_type _mv_1450 = transpiler_get_type_name(item);
                    if (_mv_1450.has_value) {
                        __auto_type type_name = _mv_1450.value;
                        {
        ...
        while ((i < len) && !(found)) {
            ...
            if (_mv_1456.has_value) {
                ...
                switch (_mv_1457.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type _ = _mv_1457.data.lst;
                        found = 1;
                        break;
                    }
                    default: {
                ...
                if (((int64_t)((items).len)) < 3) {
                    ...
                    if (_mv_1459.has_value) {
                        ...
                        switch (_mv_1460.tag) {
                            case types_SExpr_sym:
                            {
                                __auto_type _ = _mv_1460.data.sym;
                                return 1;
                            }
                            case types_SExpr_lst:
                            {
            ...
            __auto_type lst = _mv_1463.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 3) {
                    ...
                    if (_mv_1464.has_value) {
                        __auto_type def_expr = _mv_1464.value;
                        __auto_type _mv_1465 = (*def_expr);
                        switch (_mv_1465.tag) {
                            case types_SExpr_lst:
                            {
                                __auto_type def_lst = _mv_1465.data.lst;
                                {
                                    __auto_type def_items = def_lst.items;
                                    if (((int64_t)((def_items).len)) < 1) {
                                        return 0;
                                    } else {
                                        __auto_type _mv_1466 = ({ __auto_type _lst = def_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                ...
                __auto_type lst = _mv_1475.data.lst;
                {
                    ...
                    if (len < 3) {
                        ...
                        if (_mv_1476.has_value) {
                            __auto_type elem_type_expr = _mv_1476.value;
                            ...
                            if (_mv_1477.has_value) {
                                __auto_type size_expr = _mv_1477.value;
                                {
...
slop_string transpiler_get_array_size_string(types_SExpr* expr) {
    SLOP_PRE(((expr != NULL)), "(!= expr nil)");
    __auto_type _mv_1478 = (*expr);
    switch (_mv_1478.tag) {
        case types_SExpr_num:
        {
            __auto_type num = _mv_1478.data.num;
            return num.raw;
        }
        default: {
            return SLOP_STR("0");
                    ...
                    while (i < len) {
                        ...
                        if (_mv_1483.has_value) {
                            ...
                            switch (_mv_1484.tag) {
                                case types_SExpr_num:
                                {
                                    __auto_type num = _mv_1484.data.num;
                                    if (!(found_dots)) {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_1485.has_value) {
                ...
                if (transpiler_is_type_def(item) && transpiler_is_struct_type_def(item)) {
                    __auto_type _mv_1486 = transpiler_get_type_name(item);
                    if (_mv_1486.has_value) {
                        __auto_type type_name = _mv_1486.value;
                        {
...
void transpiler_emit_c_name_aliases(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len > 0) {
            ...
            while (i < len) {
                __auto_type _mv_1489 = ({ __auto_type _lst = aliases; size_t _idx = (size_t)i; slop_option_context_FuncCNameAlias _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_1489.has_value) {
                    __auto_type alias = _mv_1489.value;
                                ...
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_1492.data.sym;
                                    {
                                        ...
                                        if (_mv_1493.has_value) {
                                            __auto_type params_expr = _mv_1493.value;
                                            {
...
void transpiler_emit_inline_records_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1503 = ({ __auto_type _lst = inline_records; size_t _idx = (size_t)i; slop_option_context_InlineRecord _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1503.has_value) {
                __auto_type ir = _mv_1503.value;
                {
...
void transpiler_emit_imported_option_types_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1511 = ({ __auto_type _lst = option_types; size_t _idx = (size_t)i; slop_option_context_OptionType _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1511.has_value) {
                __auto_type ot = _mv_1511.value;
...
void transpiler_emit_union_payload_hash_eq(context_TranspileContext* ctx, slop_list_context_UnionVariantEntry variants) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1516 = ({ __auto_type _lst = variants; size_t _idx = (size_t)i; slop_option_context_UnionVariantEntry _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1516.has_value) {
                __auto_type variant = _mv_1516.value;
                {
...
slop_list_transpiler_PayloadSlot transpiler_union_variant_payloads(context_TranspileContext* ctx, slop_string union_name, slop_string variant_name) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        __auto_type _mv_1520 = context_ctx_lookup_field_type(ctx, union_name, count_key);
        if (_mv_1520.has_value) {
            __auto_type _ = _mv_1520.value;
            {
                __auto_type i = 0;
                __auto_type more = 1;
                while (more) {
                    {
                        ...
                        __auto_type _mv_1521 = context_ctx_lookup_field_type(ctx, union_name, key);
                        if (_mv_1521.has_value) {
                            __auto_type slot_c_type = _mv_1521.value;
                            {
...
void transpiler_emit_union_hash_fn(context_TranspileContext* ctx, slop_string c_type, slop_list_context_UnionVariantEntry variants) {
    ...
    context_ctx_emit_header(ctx, SLOP_STR("    switch (_k->tag) {"));
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1522 = ({ __auto_type _lst = variants; size_t _idx = (size_t)i; slop_option_context_UnionVariantEntry _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1522.has_value) {
                __auto_type variant = _mv_1522.value;
...
void transpiler_emit_multi_payload_hash(context_TranspileContext* ctx, slop_string c_variant_name, slop_list_transpiler_PayloadSlot payloads) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            __auto_type _mv_1523 = ({ __auto_type _lst = payloads; size_t _idx = (size_t)i; slop_option_transpiler_PayloadSlot _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1523.has_value) {
                __auto_type slot = _mv_1523.value;
                {
...
void transpiler_emit_multi_payload_eq(context_TranspileContext* ctx, slop_string c_variant_name, slop_list_transpiler_PayloadSlot payloads) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        context_ctx_emit_header(ctx, SLOP_STR("            return true"));
        while (i < len) {
            __auto_type _mv_1525 = ({ __auto_type _lst = payloads; size_t _idx = (size_t)i; slop_option_transpiler_PayloadSlot _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1525.has_value) {
                __auto_type slot = _mv_1525.value;
                {
...
void transpiler_emit_struct_key_types_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < ((int64_t)((struct_key_types).len))) {
            __auto_type _mv_1528 = ({ __auto_type _lst = struct_key_types; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1528.has_value) {
                __auto_type c_type = _mv_1528.value;
                {
...
void transpiler_emit_thread_types_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1531 = ({ __auto_type _lst = thread_types; size_t _idx = (size_t)i; slop_option_context_ThreadType _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1531.has_value) {
                __auto_type tt = _mv_1531.value;
                {
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1532.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 3) {
                    ...
                    __auto_type _mv_1533 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_1533.has_value) {
                        __auto_type def_expr = _mv_1533.value;
                        __auto_type _mv_1534 = (*def_expr);
                        switch (_mv_1534.tag) {
                            case types_SExpr_lst:
                            {
                                __auto_type def_lst = _mv_1534.data.lst;
                                {
                                    __auto_type def_items = def_lst.items;
                                    if (((int64_t)((def_items).len)) < 1) {
                                        return 0;
                                    } else {
                                        __auto_type _mv_1535 = ({ __auto_type _lst = def_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_1535.has_value) {
                                            __auto_type head = _mv_1535.value;
                                            __auto_type _mv_1536 = (*head);
                                            switch (_mv_1536.tag) {
                                                case types_SExpr_sym:
                                                {
                    ...
                    if (transpiler_is_type_def(item) && transpiler_is_struct_type_def(item)) {
                        {
                            ...
                            __auto_type j = 0;
                            while (j < dep_len) {
                                __auto_type _mv_1550 = ({ __auto_type _lst = blocking_deps; size_t _idx = (size_t)j; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1550.has_value) {
                                    __auto_type dep_name = _mv_1550.value;
...
uint8_t transpiler_index_in_list(slop_list_int lst, int64_t idx) {
    {
        ...
        uint8_t found = 0;
        while ((i < len) && !(found)) {
            __auto_type _mv_1553 = ({ __auto_type _lst = lst; size_t _idx = (size_t)i; slop_option_int _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1553.has_value) {
                __auto_type v = _mv_1553.value;
                if (v == idx) {
                    found = 1;
                }
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_1560.has_value) {
                __auto_type field_expr = _mv_1560.value;
                __auto_type _mv_1561 = (*field_expr);
                switch (_mv_1561.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type field_lst = _mv_1561.data.lst;
                        if (((int64_t)((field_lst.items).len)) >= 2) {
                            __auto_type _mv_1562 = ({ __auto_type _lst = field_lst.items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_1563.has_value) {
                __auto_type variant_expr = _mv_1563.value;
                __auto_type _mv_1564 = (*variant_expr);
                switch (_mv_1564.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type variant_lst = _mv_1564.data.lst;
                        if (((int64_t)((variant_lst.items).len)) >= 2) {
                            __auto_type _mv_1565 = ({ __auto_type _lst = variant_lst.items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_string transpiler_get_field_type_string(context_TranspileContext* ctx, types_SExpr* type_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1566 = (*type_expr);
        switch (_mv_1566.tag) {
            case types_SExpr_sym:
            {
                ...
                {
                    __auto_type name = sym.name;
                    __auto_type _mv_1567 = context_ctx_lookup_type(ctx, name);
                    if (_mv_1567.has_value) {
                        __auto_type entry = _mv_1567.value;
                        return entry.c_name;
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1566.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) < 1) {
                        ...
                        __auto_type _mv_1568 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_1568.has_value) {
                            __auto_type head = _mv_1568.value;
                            __auto_type _mv_1569 = (*head);
                            switch (_mv_1569.tag) {
                                case types_SExpr_sym:
                                {
            ...
            __auto_type lst = _mv_1572.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 2) {
                    ...
                    if (_mv_1573.has_value) {
                        __auto_type name_expr = _mv_1573.value;
                        __auto_type _mv_1574 = (*name_expr);
                        switch (_mv_1574.tag) {
                            case types_SExpr_sym:
                            {
        ...
        if (!(found)) {
            {
                ...
                int64_t j = 0;
                while ((j < len2) && !(found)) {
                    __auto_type _mv_1579 = ({ __auto_type _lst = option_types; size_t _idx = (size_t)j; slop_option_context_OptionType _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
uint8_t transpiler_is_imported_type(context_TranspileContext* ctx, slop_string type_name) {
    ...
    if (strlib_starts_with(type_name, SLOP_STR("slop_list_")) || strlib_starts_with(type_name, SLOP_STR("slop_option_"))) {
        ...
        __auto_type _mv_1584 = context_ctx_get_module(ctx);
        if (_mv_1584.has_value) {
            __auto_type current_mod = _mv_1584.value;
            {
                __auto_type arena = (*ctx).arena;
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1587.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) < 3) {
                        ...
                        __auto_type _mv_1588 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_1588.has_value) {
                            __auto_type body_expr = _mv_1588.value;
...
uint8_t transpiler_type_body_uses_typename(context_TranspileContext* ctx, types_SExpr* body_expr, slop_string typename) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1589 = (*body_expr);
        switch (_mv_1589.tag) {
            case types_SExpr_lst:
            {
                ...
                __auto_type lst = _mv_1597.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) < 1) {
                        ...
                        if (_mv_1598.has_value) {
                            __auto_type kind_expr = _mv_1598.value;
                            __auto_type _mv_1599 = (*kind_expr);
                            switch (_mv_1599.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type kind_sym = _mv_1599.data.sym;
                                    {
        ...
        while (i < len) {
            ...
            if (_mv_1600.has_value) {
                ...
                switch (_mv_1601.tag) {
                    case types_SExpr_sym:
                    {
                        __auto_type variant_sym = _mv_1601.data.sym;
                        {
                ...
                __auto_type lst = _mv_1603.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) >= 2) {
                        ...
                        if (_mv_1604.has_value) {
                            __auto_type name_expr = _mv_1604.value;
                            __auto_type _mv_1605 = (*name_expr);
                            switch (_mv_1605.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_1605.data.sym;
                                    {
...
uint8_t transpiler_is_pointer_type_expr_header(types_SExpr* type_expr) {
    SLOP_PRE(((type_expr != NULL)), "(!= type-expr nil)");
    __auto_type _mv_1607 = (*type_expr);
    switch (_mv_1607.tag) {
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1607.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 1) {
                    ...
                    __auto_type _mv_1608 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_1608.has_value) {
                        __auto_type head = _mv_1608.value;
                        __auto_type _mv_1609 = (*head);
                        switch (_mv_1609.tag) {
                            case types_SExpr_sym:
                            {
                                    ...
                                    __auto_type name_sym = _mv_1617.data.sym;
                                    {
                                        ...
                                        if (num_items == 2) {
                                            ...
                                            for (int64_t fi = 1; fi < num_items; fi++) {
                                                __auto_type _mv_1619 = ({ __auto_type _lst = items; size_t _idx = (size_t)fi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1625.data.lst;
            {
                ...
                if (((int64_t)((const_items).len)) < 4) {
                    ...
                    __auto_type _mv_1626 = ({ __auto_type _lst = const_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_1626.has_value) {
                        __auto_type name_expr = _mv_1626.value;
                        __auto_type _mv_1627 = (*name_expr);
                        switch (_mv_1627.tag) {
                            case types_SExpr_sym:
                            {
                                __auto_type name_sym = _mv_1627.data.sym;
                                {
                                    __auto_type raw_name = name_sym.name;
                                    if (!(transpiler_list_contains_str(exports, raw_name))) {
                                        return 0;
                                    } else {
                                        __auto_type _mv_1628 = ({ __auto_type _lst = const_items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void transpiler_emit_all_lambdas(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (count > 0) {
            while (i < count) {
                __auto_type _mv_1630 = ({ __auto_type _lst = lambdas; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_1630.has_value) {
                    __auto_type lambda_code = _mv_1630.value;
...
slop_string transpiler_generate_c_output(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1631 = ({ __auto_type _lst = output_lines; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1631.has_value) {
                __auto_type line = _mv_1631.value;
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len > 0) && transpiler_is_module_expr(exprs)) {
            ...
            if (_mv_1632.has_value) {
                __auto_type module_expr = _mv_1632.value;
...
uint8_t transpiler_is_module_expr(slop_list_types_SExpr_ptr exprs) {
    if (((int64_t)((exprs).len)) < 1) {
        ...
        if (_mv_1633.has_value) {
            __auto_type first = _mv_1633.value;
            __auto_type _mv_1634 = (*first);
            switch (_mv_1634.tag) {
                case types_SExpr_lst:
                {
