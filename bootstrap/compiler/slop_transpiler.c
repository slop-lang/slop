...
transpiler_GenericInfo transpiler_extract_generic_info(slop_arena* arena, slop_list_types_SExpr_ptr items) {
    {
        ...
        while ((i < len)) {
            __auto_type _mv_1240 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1240.has_value) {
                __auto_type item = _mv_1240.value;
                __auto_type _mv_1241 = (*item);
                switch (_mv_1241.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type lst = _mv_1241.data.lst;
                        {
                            ...
                            if ((((int64_t)((sub_items).len)) >= 1)) {
                                __auto_type _mv_1242 = ({ __auto_type _lst = sub_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        ...
                                        case types_SExpr_sym:
                                        {
                                            ...
                                            if (string_eq(sym.name, SLOP_STR("@generic"))) {
                                                if ((((int64_t)((sub_items).len)) >= 2)) {
                                                    __auto_type _mv_1244 = ({ __auto_type _lst = sub_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                        ...
                                                        switch (_mv_1245.tag) {
                                                            case types_SExpr_lst:
                                                            {
                                                                __auto_type params_lst = _mv_1245.data.lst;
                                                                {
                                                                    ...
                                                                    __auto_type j = 0;
                                                                    while ((j < param_len)) {
                                                                        __auto_type _mv_1246 = ({ __auto_type _lst = param_items; size_t _idx = (size_t)j; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                                        if (_mv_1246.has_value) {
                                                                            __auto_type param = _mv_1246.value;
                                                                            __auto_type _mv_1247 = (*param);
                                                                            switch (_mv_1247.tag) {
                                                                                case types_SExpr_sym:
                                                                                {
                                                                                    __auto_type param_sym = _mv_1247.data.sym;
                                                            ...
                                                            case types_SExpr_sym:
                                                            {
                                                                __auto_type single_sym = _mv_1245.data.sym;
...
void transpiler_prescan_module(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1248 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1249.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) >= 1)) {
                    __auto_type _mv_1250 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            ...
                            __auto_type c_name = ((context_ctx_prefixing_enabled(ctx)) ? ({ __auto_type _mv = context_ctx_get_module(ctx); _mv.has_value ? ({ __auto_type mod_name = _mv.value; context_ctx_str(ctx, ctype_to_c_name(arena, mod_name), context_ctx_str(ctx, SLOP_STR("_"), base_c_name)); }) : (base_c_name); }) : base_c_name);
                            {
                                ...
                                if ((((int64_t)((items).len)) >= 3)) {
                                    ...
                                    if (_mv_1256.has_value) {
                                        __auto_type body_expr = _mv_1256.value;
            ...
            switch (_mv_1258.tag) {
                case types_SExpr_lst:
                {
                    __auto_type def_lst = _mv_1258.data.lst;
                    {
                        ...
                        __auto_type i = 1;
                        while ((i < len)) {
                            __auto_type _mv_1259 = ({ __auto_type _lst = def_items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_1259.has_value) {
                                __auto_type variant_expr = _mv_1259.value;
                                __auto_type _mv_1260 = (*variant_expr);
                                switch (_mv_1260.tag) {
                                    case types_SExpr_sym:
                                    {
                                    ...
                                    case types_SExpr_lst:
                                    {
                                        __auto_type variant_lst = _mv_1260.data.lst;
                                        if ((((int64_t)((variant_lst.items).len)) > 0)) {
                                            __auto_type _mv_1261 = ({ __auto_type _lst = variant_lst.items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_1261.has_value) {
                                                __auto_type name_expr = _mv_1261.value;
                                                __auto_type _mv_1262 = (*name_expr);
                                                switch (_mv_1262.tag) {
                                                    case types_SExpr_sym:
                                                    {
                                                        __auto_type name_sym = _mv_1262.data.sym;
                ...
                switch (_mv_1264.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type def_lst = _mv_1264.data.lst;
                        {
                            ...
                            __auto_type i = 1;
                            while ((i < len)) {
                                __auto_type _mv_1265 = ({ __auto_type _lst = def_items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1265.has_value) {
                                    __auto_type variant_expr = _mv_1265.value;
                                    __auto_type _mv_1266 = (*variant_expr);
                                    switch (_mv_1266.tag) {
                                        case types_SExpr_sym:
                                        {
                                        ...
                                        case types_SExpr_lst:
                                        {
                                            __auto_type variant_lst = _mv_1266.data.lst;
                                            {
                                                __auto_type vl_items = variant_lst.items;
                                                __auto_type vl_len = ((int64_t)((vl_items).len));
                                                if ((vl_len >= 2)) {
                                                    __auto_type _mv_1267 = ({ __auto_type _lst = vl_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                        ...
                                                        switch (_mv_1268.tag) {
                                                            case types_SExpr_sym:
                                                            {
                                                                __auto_type name_sym = _mv_1268.data.sym;
                                                                {
                                                                    ...
                                                                    context_ctx_register_enum_variant(ctx, variant_name, union_name);
                                                                    __auto_type _mv_1269 = ({ __auto_type _lst = vl_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                                    ...
                                                                    if ((vl_len >= 3)) {
                                                                        ...
                                                                        for (int64_t fi = 1; fi < vl_len; fi++) {
                                                                            __auto_type _mv_1270 = ({ __auto_type _lst = vl_items; size_t _idx = (size_t)fi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    ...
                                                    if ((((int64_t)((vl_items).len)) == 1)) {
                                                        __auto_type _mv_1271 = ({ __auto_type _lst = vl_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                        if (_mv_1271.has_value) {
                                                            ...
                                                            switch (_mv_1272.tag) {
                                                                case types_SExpr_sym:
                                                                {
                                                                    __auto_type name_sym = _mv_1272.data.sym;
                                                                    {
                                                                        __auto_type variant_name = name_sym.name;
                                                                        context_ctx_register_enum_variant(ctx, variant_name, union_name);
                                                                        context_ctx_register_union_variant(ctx, variant_name, union_name, ctype_to_c_name(arena, variant_name), SLOP_STR(""), SLOP_STR(""));
                                    ...
                                    switch (_mv_1278.tag) {
                                        case types_SExpr_sym:
                                        {
                                            ...
                                            if (string_eq(sym.name, SLOP_STR("@spec"))) {
                                                __auto_type _mv_1279 = ({ __auto_type _lst = sub_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_1279.has_value) {
                                                    __auto_type spec_body = _mv_1279.value;
                                                    __auto_type _mv_1280 = (*spec_body);
                                                    switch (_mv_1280.tag) {
                                                        case types_SExpr_lst:
                                                        {
                                                            __auto_type body_lst = _mv_1280.data.lst;
                                                            {
                                                                __auto_type body_items = body_lst.items;
                                                                __auto_type body_len = ((int64_t)((body_items).len));
                                                                if ((body_len >= 1)) {
                                                                    __auto_type _mv_1281 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)(body_len - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                                    if (_mv_1281.has_value) {
                                                                        __auto_type ret_type = _mv_1281.value;
                                                                        __auto_type _mv_1282 = (*ret_type);
                                                                        switch (_mv_1282.tag) {
                                                                            case types_SExpr_sym:
                                                                            {
                                                                                __auto_type ret_sym = _mv_1282.data.sym;
                                        ...
                                        case types_SExpr_sym:
                                        {
                                            ...
                                            if (string_eq(sym.name, SLOP_STR("@spec"))) {
                                                ...
                                                if (_mv_1287.has_value) {
                                                    ...
                                                    __auto_type _mv_1288 = (*spec_body);
                                                    switch (_mv_1288.tag) {
                                                        case types_SExpr_lst:
                                                        {
                                                            __auto_type body_lst = _mv_1288.data.lst;
                                                            {
                                                                __auto_type body_items = body_lst.items;
                                                                __auto_type body_len = ((int64_t)((body_items).len));
                                                                if ((body_len >= 1)) {
                                                                    __auto_type _mv_1289 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)(body_len - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                                    if (_mv_1289.has_value) {
                                                                        __auto_type ret_type = _mv_1289.value;
...
void transpiler_prescan_fn_params(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    ...
    if ((((int64_t)((items).len)) >= 3)) {
        ...
        if (_mv_1290.has_value) {
            __auto_type params_expr = _mv_1290.value;
            __auto_type _mv_1291 = (*params_expr);
            switch (_mv_1291.tag) {
                case types_SExpr_lst:
                {
                    __auto_type params_lst = _mv_1291.data.lst;
                    {
                        __auto_type params = params_lst.items;
                        __auto_type param_count = ((int64_t)((params).len));
                        __auto_type i = 0;
                        while ((i < param_count)) {
                            __auto_type _mv_1292 = ({ __auto_type _lst = params; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_1292.has_value) {
                                __auto_type param_expr = _mv_1292.value;
                                __auto_type _mv_1293 = (*param_expr);
                                switch (_mv_1293.tag) {
                                    case types_SExpr_lst:
                                    {
                                        __auto_type param_lst = _mv_1293.data.lst;
                                        {
                                            __auto_type param_items = param_lst.items;
                                            if ((((int64_t)((param_items).len)) >= 2)) {
                                                __auto_type _mv_1294 = ({ __auto_type _lst = param_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_list_context_FuncParamType_ptr transpiler_prescan_collect_param_types(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((((int64_t)((items).len)) >= 3)) {
            __auto_type _mv_1295 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                ...
                switch (_mv_1296.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type params_lst = _mv_1296.data.lst;
                        {
                            ...
                            __auto_type i = 0;
                            while ((i < param_count)) {
                                __auto_type _mv_1297 = ({ __auto_type _lst = params; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                ...
                __auto_type lst = _mv_1298.data.lst;
                {
                    ...
                    if ((len < 2)) {
                    ...
                    } else {
                        {
                            ...
                            __auto_type _mv_1299 = ({ __auto_type _lst = items; size_t _idx = (size_t)type_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
uint8_t transpiler_prescan_is_param_mode(slop_list_types_SExpr_ptr items) {
    if ((((int64_t)((items).len)) < 1)) {
        ...
        if (_mv_1300.has_value) {
            __auto_type first = _mv_1300.value;
            __auto_type _mv_1301 = (*first);
            switch (_mv_1301.tag) {
                case types_SExpr_sym:
                {
...
void transpiler_prescan_fn_result_type(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 3;
        while ((i < len)) {
            __auto_type _mv_1302 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1303.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    __auto_type _mv_1304 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void transpiler_extract_result_type(context_TranspileContext* ctx, types_SExpr* spec_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1306 = (*spec_expr);
        switch (_mv_1306.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1306.data.lst;
                {
                    ...
                    if ((((int64_t)((items).len)) >= 2)) {
                        ...
                        if (_mv_1307.has_value) {
                            __auto_type spec_body = _mv_1307.value;
                            __auto_type _mv_1308 = (*spec_body);
                            switch (_mv_1308.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type body_lst = _mv_1308.data.lst;
                                    {
                                        __auto_type body_items = body_lst.items;
                                        __auto_type body_len = ((int64_t)((body_items).len));
                                        if ((body_len >= 1)) {
                                            __auto_type _mv_1309 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)(body_len - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_1309.has_value) {
                                                __auto_type ret_type = _mv_1309.value;
...
void transpiler_check_and_register_result_type(context_TranspileContext* ctx, types_SExpr* type_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1310 = (*type_expr);
        switch (_mv_1310.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1310.data.lst;
                {
                    __auto_type items = lst.items;
                    if ((((int64_t)((items).len)) >= 3)) {
                        __auto_type _mv_1311 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                ...
                                case types_SExpr_sym:
                                {
                                    ...
                                    if (string_eq(sym.name, SLOP_STR("Result"))) {
                                        ...
                                        if (_mv_1313.has_value) {
                                            __auto_type ok_type_expr = _mv_1313.value;
                                            ...
                                            if (_mv_1314.has_value) {
                                                __auto_type err_type_expr = _mv_1314.value;
                                                {
    ...
    switch (_mv_1316.tag) {
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1316.data.lst;
            {
                ...
                __auto_type len = ((int64_t)((items).len));
                if ((len >= 1)) {
                    __auto_type _mv_1317 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    ...
                                    if (string_eq(name, SLOP_STR("map-new"))) {
                                        if ((len >= 3)) {
                                            ...
                                            if (_mv_1319.has_value) {
                                                __auto_type key_type_expr = _mv_1319.value;
                                        ...
                                        if ((len >= 4)) {
                                            ...
                                            if (_mv_1321.has_value) {
                                                __auto_type type_expr = _mv_1321.value;
                                                {
                                    ...
                                    } else {
                                        {
                                            ...
                                            while ((i < len)) {
                                                ...
                                                if (_mv_1323.has_value) {
                                                    __auto_type child = _mv_1323.value;
                            ...
                            default: {
                                {
                                    ...
                                    while ((i < len)) {
                                        ...
                                        if (_mv_1324.has_value) {
                                            __auto_type child = _mv_1324.value;
                                            transpiler_prescan_expr_for_struct_keys(ctx, child);
            ...
            case types_SExpr_sym:
            {
                __auto_type sym = _mv_1325.data.sym;
                {
                    ...
                    if (!(transpiler_is_builtin_map_key_type(name))) {
                        __auto_type _mv_1326 = context_ctx_lookup_type(ctx, name);
                        if (_mv_1326.has_value) {
                            ...
                            __auto_type _mv_1327 = context_ctx_get_module(ctx);
                            if (_mv_1327.has_value) {
                                __auto_type mod = _mv_1327.value;
                                {
                                    __auto_type prefixed = context_ctx_str3(ctx, mod, SLOP_STR("_"), name);
                                    __auto_type _mv_1328 = context_ctx_lookup_type(ctx, prefixed);
                                    if (_mv_1328.has_value) {
                                        __auto_type type_entry = _mv_1328.value;
                                        context_ctx_register_struct_key_type(ctx, type_entry.c_name);
        ...
        switch (_mv_1329.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1329.data.lst;
                {
                    __auto_type items = lst.items;
                    if ((((int64_t)((items).len)) >= 3)) {
                        __auto_type _mv_1330 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                ...
                                case types_SExpr_sym:
                                {
                                    ...
                                    if (string_eq(sym.name, SLOP_STR("Result"))) {
                                        ...
                                        if (_mv_1332.has_value) {
                                            __auto_type ok_type_expr = _mv_1332.value;
                                            ...
                                            if (_mv_1333.has_value) {
                                                __auto_type err_type_expr = _mv_1333.value;
                                                {
                                                    __auto_type ok_c_type = context_to_c_type_prefixed(ctx, ok_type_expr);
                                                    __auto_type err_c_type = context_to_c_type_prefixed(ctx, err_type_expr);
                                                    __auto_type result_name = transpiler_build_result_type_name(ctx, ok_c_type, err_c_type);
...
void transpiler_prescan_ffi(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        __auto_type len = ((int64_t)((items).len));
        if ((len >= 2)) {
            __auto_type _mv_1334 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1334.has_value) {
                __auto_type header_expr = _mv_1334.value;
                __auto_type _mv_1335 = (*header_expr);
                switch (_mv_1335.tag) {
                    case types_SExpr_str:
                    {
                        __auto_type str = _mv_1335.data.str;
            ...
            }
            {
                ...
                while ((i < len)) {
                    ...
                    if (_mv_1336.has_value) {
                        __auto_type func_decl = _mv_1336.value;
...
void transpiler_prescan_import(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    ...
    if ((((int64_t)((items).len)) >= 3)) {
        ...
        if (_mv_1337.has_value) {
            __auto_type mod_expr = _mv_1337.value;
            __auto_type _mv_1338 = (*mod_expr);
            switch (_mv_1338.tag) {
                case types_SExpr_sym:
                {
                    __auto_type mod_sym = _mv_1338.data.sym;
                    {
                        ...
                        if (_mv_1339.has_value) {
                            __auto_type symbols_expr = _mv_1339.value;
                            __auto_type _mv_1340 = (*symbols_expr);
                            switch (_mv_1340.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type symbols_lst = _mv_1340.data.lst;
                                    {
                                        __auto_type syms = symbols_lst.items;
                                        __auto_type sym_len = ((int64_t)((syms).len));
                                        __auto_type j = 0;
                                        while ((j < sym_len)) {
                                            __auto_type _mv_1341 = ({ __auto_type _lst = syms; size_t _idx = (size_t)j; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_1341.has_value) {
                                                __auto_type sym_item = _mv_1341.value;
                                                __auto_type _mv_1342 = (*sym_item);
                                                switch (_mv_1342.tag) {
                                                    case types_SExpr_sym:
                                                    {
                                                        __auto_type s = _mv_1342.data.sym;
                                                        {
...
void transpiler_register_ffi_function(context_TranspileContext* ctx, types_SExpr* func_decl) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1345 = (*func_decl);
        switch (_mv_1345.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1345.data.lst;
                {
                    ...
                    __auto_type len = ((int64_t)((items).len));
                    if ((len >= 1)) {
                        __auto_type _mv_1346 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_1346.has_value) {
                            __auto_type name_expr = _mv_1346.value;
                            __auto_type _mv_1347 = (*name_expr);
                            switch (_mv_1347.tag) {
                                case types_SExpr_sym:
                                {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((((int64_t)((items).len)) >= 2)) {
            ...
            if (_mv_1348.has_value) {
                __auto_type params_expr = _mv_1348.value;
                __auto_type _mv_1349 = (*params_expr);
                switch (_mv_1349.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type params_lst = _mv_1349.data.lst;
                        {
                            __auto_type params = params_lst.items;
                            __auto_type param_count = ((int64_t)((params).len));
                            __auto_type i = 0;
                            while ((i < param_count)) {
                                __auto_type _mv_1350 = ({ __auto_type _lst = params; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1350.has_value) {
                                    __auto_type param_expr = _mv_1350.value;
                                    {
                                        __auto_type c_type = transpiler_prescan_get_param_c_type(ctx, param_expr);
                                        __auto_type param_info = ((context_FuncParamType*)(({ __auto_type _alloc = (uint8_t*)slop_arena_alloc(arena, 64); if (_alloc == NULL) { fprintf(stderr, "SLOP: arena alloc failed at %s:%d\n", __FILE__, __LINE__); abort(); } _alloc; })));
                                        (*param_info).c_type = c_type;
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while ((i < len)) {
            ...
            if (_mv_1351.has_value) {
                __auto_type item_expr = _mv_1351.value;
                __auto_type _mv_1352 = (*item_expr);
                switch (_mv_1352.tag) {
                    case types_SExpr_sym:
                    {
                        __auto_type sym = _mv_1352.data.sym;
                        if (string_eq(sym.name, SLOP_STR(":c-name"))) {
                            __auto_type _mv_1353 = ({ __auto_type _lst = items; size_t _idx = (size_t)(i + 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_1353.has_value) {
                                __auto_type c_name_expr = _mv_1353.value;
                                __auto_type _mv_1354 = (*c_name_expr);
                                switch (_mv_1354.tag) {
                                    case types_SExpr_sym:
                                    {
                                        __auto_type c_sym = _mv_1354.data.sym;
                                        c_name = c_sym.name;
                                        found_c_name = 1;
                                        break;
                                    }
        ...
        if ((len >= 2)) {
            {
                ...
                if (has_header) {
                    ...
                    if (_mv_1355.has_value) {
                        __auto_type header_expr = _mv_1355.value;
                        __auto_type _mv_1356 = (*header_expr);
                        switch (_mv_1356.tag) {
                            case types_SExpr_str:
                            {
                                __auto_type str = _mv_1356.data.str;
                                context_ctx_add_include(ctx, str.value);
                                break;
                            }
                            default: {
                ...
                if ((len >= (name_idx + 1))) {
                    __auto_type _mv_1357 = ({ __auto_type _lst = items; size_t _idx = (size_t)name_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_string transpiler_get_ffi_struct_c_name(slop_arena* arena, slop_list_types_SExpr_ptr items, int64_t name_idx, slop_string default_name) {
    {
        ...
        if ((len >= (modifier_idx + 2))) {
            __auto_type _mv_1359 = ({ __auto_type _lst = items; size_t _idx = (size_t)modifier_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1359.has_value) {
                __auto_type mod_expr = _mv_1359.value;
                __auto_type _mv_1360 = (*mod_expr);
                switch (_mv_1360.tag) {
                    case types_SExpr_sym:
                    {
                        __auto_type sym = _mv_1360.data.sym;
                        if (string_eq(sym.name, SLOP_STR(":c-name"))) {
                            __auto_type _mv_1361 = ({ __auto_type _lst = items; size_t _idx = (size_t)(modifier_idx + 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_1361.has_value) {
                                __auto_type cname_expr = _mv_1361.value;
                                __auto_type _mv_1362 = (*cname_expr);
                                switch (_mv_1362.tag) {
                                    case types_SExpr_str:
                                    {
                                        __auto_type str = _mv_1362.data.str;
...
uint8_t transpiler_is_ffi_string_item(slop_list_types_SExpr_ptr items, int64_t idx) {
    __auto_type _mv_1363 = ({ __auto_type _lst = items; size_t _idx = (size_t)idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    if (_mv_1363.has_value) {
        ...
        switch (_mv_1364.tag) {
            case types_SExpr_str:
            {
                __auto_type _ = _mv_1364.data.str;
                return 1;
            }
            default: {
                return 0;
...
uint8_t transpiler_is_enum_def(slop_list_types_SExpr_ptr items) {
    if ((((int64_t)((items).len)) < 3)) {
        ...
        __auto_type _mv_1365 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        if (_mv_1365.has_value) {
            __auto_type def_expr = _mv_1365.value;
            __auto_type _mv_1366 = (*def_expr);
            switch (_mv_1366.tag) {
                case types_SExpr_lst:
                {
                    __auto_type def_lst = _mv_1366.data.lst;
                    {
                        __auto_type def_items = def_lst.items;
                        if ((((int64_t)((def_items).len)) < 1)) {
                            return 0;
                        } else {
                            __auto_type _mv_1367 = ({ __auto_type _lst = def_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
uint8_t transpiler_is_record_def(slop_list_types_SExpr_ptr items) {
    if ((((int64_t)((items).len)) < 3)) {
        ...
        __auto_type _mv_1369 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        if (_mv_1369.has_value) {
            __auto_type def_expr = _mv_1369.value;
            __auto_type _mv_1370 = (*def_expr);
            switch (_mv_1370.tag) {
                case types_SExpr_lst:
                {
                    __auto_type def_lst = _mv_1370.data.lst;
                    {
                        __auto_type def_items = def_lst.items;
                        if ((((int64_t)((def_items).len)) < 1)) {
                            return 0;
                        } else {
                            __auto_type _mv_1371 = ({ __auto_type _lst = def_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
uint8_t transpiler_is_union_def(slop_list_types_SExpr_ptr items) {
    if ((((int64_t)((items).len)) < 3)) {
        ...
        if (_mv_1373.has_value) {
            __auto_type def_expr = _mv_1373.value;
            __auto_type _mv_1374 = (*def_expr);
            switch (_mv_1374.tag) {
                case types_SExpr_lst:
                {
                    __auto_type def_lst = _mv_1374.data.lst;
                    {
                        __auto_type def_items = def_lst.items;
                        if ((((int64_t)((def_items).len)) < 1)) {
                            return 0;
                        } else {
                            __auto_type _mv_1375 = ({ __auto_type _lst = def_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_string transpiler_get_array_c_type(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items, slop_string default_c_type) {
    ...
    if ((((int64_t)((items).len)) < 3)) {
        ...
        __auto_type _mv_1377 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        if (_mv_1377.has_value) {
            __auto_type body_expr = _mv_1377.value;
            __auto_type _mv_1378 = (*body_expr);
            switch (_mv_1378.tag) {
                case types_SExpr_lst:
                {
                    __auto_type body_lst = _mv_1378.data.lst;
                    {
                        __auto_type body_items = body_lst.items;
                        if ((((int64_t)((body_items).len)) < 2)) {
                            return default_c_type;
                        } else {
                            __auto_type _mv_1379 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                ...
                                switch (_mv_1380.tag) {
                                    case types_SExpr_sym:
                                    {
                                        ...
                                        if (string_eq(sym.name, SLOP_STR("Array"))) {
                                            __auto_type _mv_1381 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_1381.has_value) {
                                                __auto_type elem_expr = _mv_1381.value;
                                                {
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1389.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    __auto_type _mv_1390 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1393.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    __auto_type _mv_1394 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void transpiler_transpile_module(context_TranspileContext* ctx, types_SExpr* module_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1396 = (*module_expr);
        switch (_mv_1396.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1396.data.lst;
                {
                    ...
                    __auto_type len = ((int64_t)((items).len));
                    if ((len >= 2)) {
                        __auto_type _mv_1397 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
int64_t transpiler_get_body_start(slop_list_types_SExpr_ptr items) {
    if ((((int64_t)((items).len)) < 3)) {
        ...
        if (_mv_1399.has_value) {
            __auto_type third = _mv_1399.value;
            __auto_type _mv_1400 = (*third);
            switch (_mv_1400.tag) {
                case types_SExpr_lst:
                {
                    __auto_type lst = _mv_1400.data.lst;
                    {
                        ...
                        if ((((int64_t)((sub_items).len)) < 1)) {
                            ...
                            __auto_type _mv_1401 = ({ __auto_type _lst = sub_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                ...
                switch (_mv_1404.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type lst = _mv_1404.data.lst;
                        {
                            __auto_type sub_items = lst.items;
                            if ((((int64_t)((sub_items).len)) >= 1)) {
                                __auto_type _mv_1405 = ({ __auto_type _lst = sub_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            ...
                                            if (string_eq(sym.name, SLOP_STR("export"))) {
                                                {
                                                    ...
                                                    __auto_type j = 1;
                                                    while ((j < export_len)) {
                                                        __auto_type _mv_1407 = ({ __auto_type _lst = sub_items; size_t _idx = (size_t)j; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                        if (_mv_1407.has_value) {
                                                            __auto_type name_expr = _mv_1407.value;
                                                            __auto_type _mv_1408 = (*name_expr);
                                                            switch (_mv_1408.tag) {
                                                                case types_SExpr_sym:
                                                                {
                                                                    __auto_type name_sym = _mv_1408.data.sym;
...
uint8_t transpiler_list_contains_str(slop_list_string lst, slop_string needle) {
    {
        ...
        uint8_t found = 0;
        while (((i < len) && !(found))) {
            __auto_type _mv_1409 = ({ __auto_type _lst = lst; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1409.has_value) {
                __auto_type s = _mv_1409.value;
                                        ...
                                        if (string_eq(op, SLOP_STR("Option"))) {
                                            ...
                                            if ((len >= 2)) {
                                                ...
                                                if (_mv_1415.has_value) {
                                                    __auto_type elem = _mv_1415.value;
                                                    {
                                            ...
                                            if ((len >= 2)) {
                                                ...
                                                if (_mv_1416.has_value) {
                                                    __auto_type inner = _mv_1416.value;
                                                    transpiler_scan_type_for_generics(ctx, inner);
                                            ...
                                            if ((len >= 3)) {
                                                __auto_type _mv_1417 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_1417.has_value) {
                                                    __auto_type ok_type = _mv_1417.value;
                                                    ...
                                                    if (_mv_1418.has_value) {
                                                        __auto_type err_type = _mv_1418.value;
                                                        {
                                            ...
                                            if ((len >= 2)) {
                                                ...
                                                if (_mv_1419.has_value) {
                                                    __auto_type elem = _mv_1419.value;
                                                    {
                                                        __auto_type elem_c = context_to_c_type_prefixed(ctx, elem);
                                                        __auto_type elem_id = ctype_type_to_identifier(arena, elem_c);
                                                        __auto_type c_name = context_ctx_str(ctx, SLOP_STR("slop_chan_"), elem_id);
                                            ...
                                            if ((len >= 2)) {
                                                ...
                                                if (_mv_1420.has_value) {
                                                    __auto_type result = _mv_1420.value;
                                                    {
                                            ...
                                            if ((len >= 3)) {
                                                ...
                                                if (_mv_1421.has_value) {
                                                    __auto_type key_type = _mv_1421.value;
                                                    {
                                                        ...
                                                        if (_mv_1422.has_value) {
                                                            __auto_type val_type = _mv_1422.value;
                                                            {
                                            ...
                                            if ((len >= 2)) {
                                                ...
                                                if (_mv_1423.has_value) {
                                                    __auto_type elem_type = _mv_1423.value;
                                                    {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while ((i < len)) {
            ...
            if (_mv_1424.has_value) {
                __auto_type field_expr = _mv_1424.value;
                __auto_type _mv_1425 = (*field_expr);
                switch (_mv_1425.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type field_lst = _mv_1425.data.lst;
                        {
                            __auto_type field_items = field_lst.items;
                            if ((((int64_t)((field_items).len)) >= 2)) {
                                __auto_type _mv_1426 = ({ __auto_type _lst = field_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1426.has_value) {
                                    __auto_type type_expr = _mv_1426.value;
                                    transpiler_scan_type_for_generics(ctx, type_expr);
...
void transpiler_emit_ffi_includes(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1427 = ({ __auto_type _lst = includes; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1427.has_value) {
                __auto_type header = _mv_1427.value;
...
void transpiler_emit_ffi_includes_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1428 = ({ __auto_type _lst = includes; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1428.has_value) {
                __auto_type header = _mv_1428.value;
...
void transpiler_emit_header_guard_open(context_TranspileContext* ctx) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1429 = context_ctx_get_module(ctx);
        if (_mv_1429.has_value) {
            __auto_type mod_name = _mv_1429.value;
            {
...
void transpiler_emit_header_dependency_includes(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1430 = ({ __auto_type _lst = imports; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1430.has_value) {
                __auto_type mod_name = _mv_1430.value;
                {
                    __auto_type c_name = ctype_to_c_name(arena, mod_name);
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while ((i < len)) {
            ...
            if (_mv_1431.has_value) {
                __auto_type item = _mv_1431.value;
                if ((transpiler_is_type_def(item) && transpiler_is_struct_type_def(item))) {
                    __auto_type _mv_1432 = transpiler_get_type_name(item);
                    if (_mv_1432.has_value) {
                        __auto_type type_name = _mv_1432.value;
                        {
            ...
            __auto_type lst = _mv_1433.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 3)) {
                    ...
                    if (_mv_1434.has_value) {
                        __auto_type def_expr = _mv_1434.value;
                        __auto_type _mv_1435 = (*def_expr);
                        switch (_mv_1435.tag) {
                            case types_SExpr_lst:
                            {
                                __auto_type def_lst = _mv_1435.data.lst;
                                {
                                    __auto_type def_items = def_lst.items;
                                    if ((((int64_t)((def_items).len)) < 1)) {
                                        return 0;
                                    } else {
                                        __auto_type _mv_1436 = ({ __auto_type _lst = def_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
uint8_t transpiler_has_enum_payload_variants(slop_list_types_SExpr_ptr items) {
    {
        ...
        while (((i < len) && !(found))) {
            ...
            if (_mv_1438.has_value) {
                __auto_type item = _mv_1438.value;
                __auto_type _mv_1439 = (*item);
                switch (_mv_1439.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type _ = _mv_1439.data.lst;
                        found = 1;
                        break;
                    }
                    default: {
                ...
                if ((((int64_t)((items).len)) < 3)) {
                    ...
                    if (_mv_1441.has_value) {
                        ...
                        switch (_mv_1442.tag) {
                            case types_SExpr_sym:
                            {
                                __auto_type _ = _mv_1442.data.sym;
                                return 1;
                            }
                            case types_SExpr_lst:
                            {
            ...
            __auto_type lst = _mv_1445.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 3)) {
                    ...
                    if (_mv_1446.has_value) {
                        __auto_type def_expr = _mv_1446.value;
                        __auto_type _mv_1447 = (*def_expr);
                        switch (_mv_1447.tag) {
                            case types_SExpr_lst:
                            {
                                __auto_type def_lst = _mv_1447.data.lst;
                                {
                                    __auto_type def_items = def_lst.items;
                                    if ((((int64_t)((def_items).len)) < 1)) {
                                        return 0;
                                    } else {
                                        __auto_type _mv_1448 = ({ __auto_type _lst = def_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    ...
                    if ((((int64_t)((items).len)) >= 3)) {
                        ...
                        if (_mv_1451.has_value) {
                            ...
                            switch (_mv_1452.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_1452.data.sym;
                                    {
...
void transpiler_emit_array_typedef_to_header(context_TranspileContext* ctx, slop_string c_name, types_SExpr* body_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1457 = (*body_expr);
        switch (_mv_1457.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1457.data.lst;
                {
                    ...
                    if ((len < 3)) {
                        ...
                        if (_mv_1458.has_value) {
                            __auto_type elem_type_expr = _mv_1458.value;
                            ...
                            if (_mv_1459.has_value) {
                                __auto_type size_expr = _mv_1459.value;
                                {
...
slop_string transpiler_get_array_size_string(types_SExpr* expr) {
    SLOP_PRE(((expr != NULL)), "(!= expr nil)");
    __auto_type _mv_1460 = (*expr);
    switch (_mv_1460.tag) {
        case types_SExpr_num:
        {
            __auto_type num = _mv_1460.data.num;
            return num.raw;
        }
        default: {
            return SLOP_STR("0");
...
uint8_t transpiler_is_range_type_body(types_SExpr* body_expr) {
    SLOP_PRE(((body_expr != NULL)), "(!= body-expr nil)");
    __auto_type _mv_1461 = (*body_expr);
    switch (_mv_1461.tag) {
        case types_SExpr_lst:
        {
                    ...
                    while ((i < len)) {
                        ...
                        if (_mv_1465.has_value) {
                            ...
                            switch (_mv_1466.tag) {
                                case types_SExpr_num:
                                {
                                    __auto_type num = _mv_1466.data.num;
                                    if (!(found_dots)) {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while ((i < len)) {
            ...
            if (_mv_1467.has_value) {
                ...
                if ((transpiler_is_type_def(item) && transpiler_is_struct_type_def(item))) {
                    __auto_type _mv_1468 = transpiler_get_type_name(item);
                    if (_mv_1468.has_value) {
                        __auto_type type_name = _mv_1468.value;
                        {
...
void transpiler_emit_c_name_aliases(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len > 0)) {
            ...
            while ((i < len)) {
                __auto_type _mv_1471 = ({ __auto_type _lst = aliases; size_t _idx = (size_t)i; slop_option_context_FuncCNameAlias _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_1471.has_value) {
                    __auto_type alias = _mv_1471.value;
                    ...
                    if ((len >= 3)) {
                        ...
                        if (_mv_1473.has_value) {
                            ...
                            switch (_mv_1474.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_1474.data.sym;
                                    {
                                        ...
                                        if (_mv_1475.has_value) {
                                            __auto_type params_expr = _mv_1475.value;
                                            {
...
void transpiler_emit_result_types(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1483 = ({ __auto_type _lst = result_types; size_t _idx = (size_t)i; slop_option_context_ResultType _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1483.has_value) {
                __auto_type rt = _mv_1483.value;
...
void transpiler_emit_result_types_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1484 = ({ __auto_type _lst = result_types; size_t _idx = (size_t)i; slop_option_context_ResultType _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1484.has_value) {
                __auto_type rt = _mv_1484.value;
...
void transpiler_emit_inline_records_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1485 = ({ __auto_type _lst = inline_records; size_t _idx = (size_t)i; slop_option_context_InlineRecord _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1485.has_value) {
                __auto_type ir = _mv_1485.value;
                {
...
void transpiler_emit_option_types_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1486 = ({ __auto_type _lst = option_types; size_t _idx = (size_t)i; slop_option_context_OptionType _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void transpiler_emit_value_option_types_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1487 = ({ __auto_type _lst = option_types; size_t _idx = (size_t)i; slop_option_context_OptionType _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1487.has_value) {
                __auto_type ot = _mv_1487.value;
...
void transpiler_emit_complex_value_option_types_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1488 = ({ __auto_type _lst = option_types; size_t _idx = (size_t)i; slop_option_context_OptionType _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1488.has_value) {
                __auto_type ot = _mv_1488.value;
                if (!(transpiler_is_pointer_elem_type(ot.inner_type))) {
                    transpiler_emit_single_option_type_header(ctx, ot);
                }
...
void transpiler_emit_list_types_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1489 = ({ __auto_type _lst = list_types; size_t _idx = (size_t)i; slop_option_context_ListType _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1489.has_value) {
                __auto_type lt = _mv_1489.value;
...
void transpiler_emit_primitive_list_types_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1490 = ({ __auto_type _lst = list_types; size_t _idx = (size_t)i; slop_option_context_ListType _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void transpiler_emit_primitive_option_types_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1491 = ({ __auto_type _lst = option_types; size_t _idx = (size_t)i; slop_option_context_OptionType _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void transpiler_emit_imported_list_types_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1492 = ({ __auto_type _lst = list_types; size_t _idx = (size_t)i; slop_option_context_ListType _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void transpiler_emit_imported_option_types_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1493 = ({ __auto_type _lst = option_types; size_t _idx = (size_t)i; slop_option_context_OptionType _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void transpiler_emit_late_registered_option_types_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1494 = ({ __auto_type _lst = option_types; size_t _idx = (size_t)i; slop_option_context_OptionType _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1494.has_value) {
                __auto_type ot = _mv_1494.value;
                transpiler_emit_single_option_type_header(ctx, ot);
...
void transpiler_emit_value_list_types_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1495 = ({ __auto_type _lst = list_types; size_t _idx = (size_t)i; slop_option_context_ListType _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void transpiler_emit_complex_value_list_types_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1496 = ({ __auto_type _lst = list_types; size_t _idx = (size_t)i; slop_option_context_ListType _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void transpiler_emit_union_payload_hash_eq(context_TranspileContext* ctx, slop_list_context_UnionVariantEntry variants) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1497 = ({ __auto_type _lst = variants; size_t _idx = (size_t)i; slop_option_context_UnionVariantEntry _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1497.has_value) {
                __auto_type variant = _mv_1497.value;
                {
...
void transpiler_emit_record_field_dependencies(context_TranspileContext* ctx, slop_list_context_FieldEntry fields) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1498 = ({ __auto_type _lst = fields; size_t _idx = (size_t)i; slop_option_context_FieldEntry _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1498.has_value) {
                __auto_type field = _mv_1498.value;
                {
...
uint8_t transpiler_is_range_type_alias(context_TranspileContext* ctx, slop_string slop_type) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    __auto_type _mv_1499 = context_ctx_lookup_type_alias(ctx, slop_type);
    if (_mv_1499.has_value) {
        __auto_type underlying = _mv_1499.value;
...
void transpiler_emit_union_hash_fn(context_TranspileContext* ctx, slop_string c_type, slop_list_context_UnionVariantEntry variants) {
    ...
    context_ctx_emit_header(ctx, SLOP_STR("    switch (_k->tag) {"));
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1500 = ({ __auto_type _lst = variants; size_t _idx = (size_t)i; slop_option_context_UnionVariantEntry _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1500.has_value) {
                __auto_type variant = _mv_1500.value;
...
void transpiler_emit_union_eq_fn(context_TranspileContext* ctx, slop_string c_type, slop_list_context_UnionVariantEntry variants) {
    ...
    context_ctx_emit_header(ctx, SLOP_STR("    switch (_a->tag) {"));
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1501 = ({ __auto_type _lst = variants; size_t _idx = (size_t)i; slop_option_context_UnionVariantEntry _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1501.has_value) {
                __auto_type variant = _mv_1501.value;
...
void transpiler_emit_struct_hash_fn(context_TranspileContext* ctx, slop_string c_type, slop_list_context_FieldEntry fields) {
    ...
    context_ctx_emit_header(ctx, SLOP_STR("    uint64_t hash = 14695981039346656037ULL;"));
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1502 = ({ __auto_type _lst = fields; size_t _idx = (size_t)i; slop_option_context_FieldEntry _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1502.has_value) {
                __auto_type field = _mv_1502.value;
    ...
    context_ctx_emit_header(ctx, context_ctx_str(ctx, context_ctx_str4(ctx, SLOP_STR("    const "), c_type, SLOP_STR("* _b = (const "), c_type), SLOP_STR("*)b;")));
    {
        ...
        if ((len == 0)) {
            ...
            context_ctx_emit_header(ctx, SLOP_STR("    return true"));
            {
                int64_t i = 0;
                while ((i < len)) {
                    __auto_type _mv_1503 = ({ __auto_type _lst = fields; size_t _idx = (size_t)i; slop_option_context_FieldEntry _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_1503.has_value) {
                        __auto_type field = _mv_1503.value;
...
void transpiler_emit_struct_key_types_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while ((i < ((int64_t)((struct_key_types).len)))) {
            __auto_type _mv_1504 = ({ __auto_type _lst = struct_key_types; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1504.has_value) {
                __auto_type c_type = _mv_1504.value;
                {
                    __auto_type guard_name = context_ctx_str3(ctx, transpiler_uppercase_name(ctx, c_type), SLOP_STR("_HASH_EQ_DEFINED"), SLOP_STR(""));
...
void transpiler_emit_chan_types_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1505 = ({ __auto_type _lst = chan_types; size_t _idx = (size_t)i; slop_option_context_ChanType _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1505.has_value) {
                __auto_type ct = _mv_1505.value;
                {
...
void transpiler_emit_chan_funcs_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1506 = ({ __auto_type _lst = chan_types; size_t _idx = (size_t)i; slop_option_context_ChanType _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1506.has_value) {
                __auto_type ct = _mv_1506.value;
                {
                    __auto_type elem_type = ct.elem_type;
                    __auto_type c_name = ct.c_name;
...
void transpiler_emit_thread_types_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1507 = ({ __auto_type _lst = thread_types; size_t _idx = (size_t)i; slop_option_context_ThreadType _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1507.has_value) {
                __auto_type tt = _mv_1507.value;
                {
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1508.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 3)) {
                    ...
                    __auto_type _mv_1509 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_1509.has_value) {
                        __auto_type def_expr = _mv_1509.value;
                        __auto_type _mv_1510 = (*def_expr);
                        switch (_mv_1510.tag) {
                            case types_SExpr_lst:
                            {
                                __auto_type def_lst = _mv_1510.data.lst;
                                {
                                    __auto_type def_items = def_lst.items;
                                    if ((((int64_t)((def_items).len)) < 1)) {
                                        return 0;
                                    } else {
                                        __auto_type _mv_1511 = ({ __auto_type _lst = def_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_1511.has_value) {
                                            __auto_type head = _mv_1511.value;
                                            __auto_type _mv_1512 = (*head);
                                            switch (_mv_1512.tag) {
                                                case types_SExpr_sym:
                                                {
...
void transpiler_emit_pending_container_deps(context_TranspileContext* ctx, types_SExpr* type_def) {
    ...
    SLOP_PRE(((type_def != NULL)), "(!= type-def nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1519 = ({ __auto_type _lst = field_types; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1519.has_value) {
                __auto_type field_type = _mv_1519.value;
...
void transpiler_break_list_cycles(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items, int64_t start, int64_t len, slop_list_int emitted) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while ((i < len)) {
            if (!(transpiler_index_in_list(emitted, i))) {
                __auto_type _mv_1525 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    ...
                    if ((transpiler_is_type_def(item) && transpiler_is_struct_type_def(item))) {
                        {
                            ...
                            __auto_type j = 0;
                            while ((j < dep_len)) {
                                __auto_type _mv_1526 = ({ __auto_type _lst = blocking_deps; size_t _idx = (size_t)j; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1526.has_value) {
                                    __auto_type dep_name = _mv_1526.value;
...
slop_list_string transpiler_find_blocking_list_deps(context_TranspileContext* ctx, types_SExpr* type_def) {
    ...
    SLOP_PRE(((type_def != NULL)), "(!= type-def nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1527 = ({ __auto_type _lst = field_types; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1527.has_value) {
                __auto_type field_type = _mv_1527.value;
...
void transpiler_emit_list_declare_by_c_name(context_TranspileContext* ctx, slop_string c_name) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1528 = ({ __auto_type _lst = list_types; size_t _idx = (size_t)i; slop_option_context_ListType _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
uint8_t transpiler_index_in_list(slop_list_int lst, int64_t idx) {
    {
        ...
        uint8_t found = 0;
        while (((i < len) && !(found))) {
            __auto_type _mv_1529 = ({ __auto_type _lst = lst; size_t _idx = (size_t)i; slop_option_int _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1529.has_value) {
                __auto_type v = _mv_1529.value;
                if ((v == idx)) {
                    found = 1;
                }
...
uint8_t transpiler_type_deps_satisfied(context_TranspileContext* ctx, types_SExpr* type_def) {
    ...
    SLOP_PRE(((type_def != NULL)), "(!= type-def nil)");
    {
        ...
        while (((i < len) && all_satisfied)) {
            __auto_type _mv_1530 = ({ __auto_type _lst = field_types; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1530.has_value) {
                __auto_type field_type = _mv_1530.value;
                ...
                __auto_type lst = _mv_1531.data.lst;
                {
                    ...
                    if ((((int64_t)((items).len)) >= 3)) {
                        ...
                        if (_mv_1532.has_value) {
                            __auto_type def_expr = _mv_1532.value;
                            __auto_type _mv_1533 = (*def_expr);
                            switch (_mv_1533.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type def_lst = _mv_1533.data.lst;
                                    {
                                        __auto_type def_items = def_lst.items;
                                        __auto_type def_len = ((int64_t)((def_items).len));
                                        if ((def_len > 0)) {
                                            __auto_type _mv_1534 = ({ __auto_type _lst = def_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_1534.has_value) {
                                                __auto_type head = _mv_1534.value;
                                                __auto_type _mv_1535 = (*head);
                                                switch (_mv_1535.tag) {
                                                    case types_SExpr_sym:
                                                    {
...
slop_list_string transpiler_extract_record_field_types(context_TranspileContext* ctx, slop_list_types_SExpr_ptr def_items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 1;
        while ((i < len)) {
            __auto_type _mv_1536 = ({ __auto_type _lst = def_items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                ...
                switch (_mv_1537.tag) {
                    case types_SExpr_lst:
                    {
                        ...
                        if ((((int64_t)((field_lst.items).len)) >= 2)) {
                            __auto_type _mv_1538 = ({ __auto_type _lst = field_lst.items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_list_string transpiler_extract_union_variant_types(context_TranspileContext* ctx, slop_list_types_SExpr_ptr def_items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 1;
        while ((i < len)) {
            __auto_type _mv_1539 = ({ __auto_type _lst = def_items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1539.has_value) {
                __auto_type variant_expr = _mv_1539.value;
                __auto_type _mv_1540 = (*variant_expr);
                switch (_mv_1540.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type variant_lst = _mv_1540.data.lst;
                        if ((((int64_t)((variant_lst.items).len)) >= 2)) {
                            __auto_type _mv_1541 = ({ __auto_type _lst = variant_lst.items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_string transpiler_get_field_type_string(context_TranspileContext* ctx, types_SExpr* type_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1542 = (*type_expr);
        switch (_mv_1542.tag) {
            case types_SExpr_sym:
            {
                __auto_type sym = _mv_1542.data.sym;
                {
                    __auto_type name = sym.name;
                    __auto_type _mv_1543 = context_ctx_lookup_type(ctx, name);
                    if (_mv_1543.has_value) {
                        __auto_type entry = _mv_1543.value;
                        return entry.c_name;
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1542.data.lst;
                {
                    ...
                    if ((((int64_t)((items).len)) < 1)) {
                        ...
                        __auto_type _mv_1544 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_1544.has_value) {
                            __auto_type head = _mv_1544.value;
                            __auto_type _mv_1545 = (*head);
                            switch (_mv_1545.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type sym = _mv_1545.data.sym;
                                    {
                                        __auto_type kind = sym.name;
                                        if (string_eq(kind, SLOP_STR("Ptr"))) {
                                            ...
                                            if ((((int64_t)((items).len)) >= 2)) {
                                                ...
                                                if (_mv_1546.has_value) {
                                                    __auto_type inner = _mv_1546.value;
                                                    {
                                            ...
                                            if ((((int64_t)((items).len)) >= 2)) {
                                                __auto_type _mv_1547 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_1547.has_value) {
                                                    __auto_type inner = _mv_1547.value;
                                                    {
                                                        __auto_type inner_str = transpiler_get_field_type_string(ctx, inner);
                                                        if (string_eq(inner_str, SLOP_STR(""))) {
                                                            return SLOP_STR("");
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1548.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 2)) {
                    ...
                    __auto_type _mv_1549 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_1549.has_value) {
                        ...
                        switch (_mv_1550.tag) {
                            case types_SExpr_sym:
                            {
                                __auto_type sym = _mv_1550.data.sym;
                                {
                                    __auto_type name = sym.name;
                                    __auto_type _mv_1551 = context_ctx_lookup_type(ctx, name);
                                    if (_mv_1551.has_value) {
                                        __auto_type entry = _mv_1551.value;
                                        return entry.c_name;
...
void transpiler_emit_option_for_inner_type(context_TranspileContext* ctx, slop_string inner_c_name) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1552 = ({ __auto_type _lst = option_types; size_t _idx = (size_t)i; slop_option_context_OptionType _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1552.has_value) {
                __auto_type ot = _mv_1552.value;
...
void transpiler_emit_list_for_elem_type(context_TranspileContext* ctx, slop_string elem_c_name) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1553 = ({ __auto_type _lst = list_types; size_t _idx = (size_t)i; slop_option_context_ListType _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1553.has_value) {
                __auto_type lt = _mv_1553.value;
...
uint8_t transpiler_struct_uses_value_list_or_option(context_TranspileContext* ctx, types_SExpr* type_def) {
    ...
    SLOP_PRE(((type_def != NULL)), "(!= type-def nil)");
    {
        ...
        uint8_t found = 0;
        {
            ...
            int64_t i = 0;
            while (((i < len) && !(found))) {
                __auto_type _mv_1554 = ({ __auto_type _lst = list_types; size_t _idx = (size_t)i; slop_option_context_ListType _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        if (!(found)) {
            {
                ...
                int64_t j = 0;
                while (((j < len2) && !(found))) {
                    __auto_type _mv_1555 = ({ __auto_type _lst = option_types; size_t _idx = (size_t)j; slop_option_context_OptionType _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void transpiler_emit_struct_dependent_option_types(context_TranspileContext* ctx, types_SExpr* type_def) {
    ...
    SLOP_PRE(((type_def != NULL)), "(!= type-def nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1557 = ({ __auto_type _lst = option_types; size_t _idx = (size_t)i; slop_option_context_OptionType _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void transpiler_emit_struct_dependent_list_types_safe(context_TranspileContext* ctx, types_SExpr* type_def) {
    ...
    SLOP_PRE(((type_def != NULL)), "(!= type-def nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1558 = ({ __auto_type _lst = list_types; size_t _idx = (size_t)i; slop_option_context_ListType _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1558.has_value) {
                __auto_type lt = _mv_1558.value;
                if ((!(transpiler_is_pointer_elem_type(lt.elem_type)) && transpiler_struct_uses_list_type(ctx, type_def, lt.c_name))) {
...
void transpiler_emit_struct_dependent_option_types_safe(context_TranspileContext* ctx, types_SExpr* type_def) {
    ...
    SLOP_PRE(((type_def != NULL)), "(!= type-def nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1559 = ({ __auto_type _lst = option_types; size_t _idx = (size_t)i; slop_option_context_OptionType _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1559.has_value) {
                __auto_type ot = _mv_1559.value;
                if ((!(transpiler_is_pointer_elem_type(ot.inner_type)) && transpiler_struct_uses_option_type(ctx, type_def, ot.c_name))) {
...
uint8_t transpiler_is_imported_type(context_TranspileContext* ctx, slop_string type_name) {
    ...
    if ((strlib_starts_with(type_name, SLOP_STR("slop_list_")) || strlib_starts_with(type_name, SLOP_STR("slop_option_")))) {
        ...
        __auto_type _mv_1560 = context_ctx_get_module(ctx);
        if (_mv_1560.has_value) {
            __auto_type current_mod = _mv_1560.value;
            {
                __auto_type arena = (*ctx).arena;
    ...
    if (strlib_starts_with(inner_type, SLOP_STR("slop_list_"))) {
        {
            ...
            int64_t i = 0;
            while ((i < len)) {
                __auto_type _mv_1561 = ({ __auto_type _lst = list_types; size_t _idx = (size_t)i; slop_option_context_ListType _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_1561.has_value) {
                    __auto_type lt = _mv_1561.value;
    ...
    if (strlib_starts_with(inner_type, SLOP_STR("slop_list_"))) {
        {
            ...
            int64_t i = 0;
            while ((i < len)) {
                __auto_type _mv_1562 = ({ __auto_type _lst = list_types; size_t _idx = (size_t)i; slop_option_context_ListType _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_1562.has_value) {
                    __auto_type lt = _mv_1562.value;
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1563.data.lst;
                {
                    ...
                    if ((((int64_t)((items).len)) < 3)) {
                        ...
                        __auto_type _mv_1564 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_1564.has_value) {
                            __auto_type body_expr = _mv_1564.value;
...
uint8_t transpiler_type_body_uses_typename(context_TranspileContext* ctx, types_SExpr* body_expr, slop_string typename) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1565 = (*body_expr);
        switch (_mv_1565.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1565.data.lst;
                {
                    ...
                    while (((i < len) && !(found))) {
                        ...
                        if (_mv_1566.has_value) {
                            __auto_type field_expr = _mv_1566.value;
...
uint8_t transpiler_field_uses_typename(context_TranspileContext* ctx, types_SExpr* field_expr, slop_string typename) {
    ...
    __auto_type _mv_1567 = (*field_expr);
    switch (_mv_1567.tag) {
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1567.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 2)) {
                    ...
                    if (_mv_1568.has_value) {
                        __auto_type type_expr = _mv_1568.value;
                        {
                            __auto_type c_type = context_to_c_type_prefixed(ctx, type_expr);
                    ...
                    if ((len >= 3)) {
                        ...
                        if (_mv_1570.has_value) {
                            ...
                            switch (_mv_1571.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_1571.data.sym;
                                    {
                                        __auto_type type_name = name_sym.name;
                                        __auto_type base_name = ctype_to_c_name(arena, type_name);
                                        __auto_type c_name = ((context_ctx_prefixing_enabled(ctx)) ? ({ __auto_type _mv = context_ctx_get_module(ctx); _mv.has_value ? ({ __auto_type mod_name = _mv.value; context_ctx_str(ctx, ctype_to_c_name(arena, mod_name), context_ctx_str(ctx, SLOP_STR("_"), base_name)); }) : (base_name); }) : base_name);
                                        __auto_type _mv_1572 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_1572.has_value) {
                                            __auto_type body_expr = _mv_1572.value;
...
void transpiler_emit_type_body_to_header(context_TranspileContext* ctx, slop_string raw_type_name, slop_string c_name, types_SExpr* body_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1573 = (*body_expr);
        switch (_mv_1573.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1573.data.lst;
                {
                    ...
                    if ((((int64_t)((items).len)) < 1)) {
                        ...
                        if (_mv_1574.has_value) {
                            __auto_type kind_expr = _mv_1574.value;
                            __auto_type _mv_1575 = (*kind_expr);
                            switch (_mv_1575.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type kind_sym = _mv_1575.data.sym;
                                    {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while ((i < len)) {
            ...
            if (_mv_1576.has_value) {
                __auto_type variant_expr = _mv_1576.value;
                __auto_type _mv_1577 = (*variant_expr);
                switch (_mv_1577.tag) {
                    case types_SExpr_sym:
                    {
                        __auto_type variant_sym = _mv_1577.data.sym;
                        {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while ((i < len)) {
            ...
            if (_mv_1578.has_value) {
                __auto_type field_expr = _mv_1578.value;
...
void transpiler_emit_field_to_header(context_TranspileContext* ctx, slop_string raw_type_name, slop_string c_type_name, types_SExpr* field_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1579 = (*field_expr);
        switch (_mv_1579.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1579.data.lst;
                {
                    __auto_type items = lst.items;
                    if ((((int64_t)((items).len)) >= 2)) {
                        __auto_type _mv_1580 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_1580.has_value) {
                            __auto_type name_expr = _mv_1580.value;
                            __auto_type _mv_1581 = (*name_expr);
                            switch (_mv_1581.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_1581.data.sym;
                                    {
...
uint8_t transpiler_is_pointer_type_expr_header(types_SExpr* type_expr) {
    SLOP_PRE(((type_expr != NULL)), "(!= type-expr nil)");
    __auto_type _mv_1583 = (*type_expr);
    switch (_mv_1583.tag) {
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1583.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    __auto_type _mv_1584 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_1584.has_value) {
                        __auto_type head = _mv_1584.value;
                        __auto_type _mv_1585 = (*head);
                        switch (_mv_1585.tag) {
                            case types_SExpr_sym:
                            {
            ...
            __auto_type lst = _mv_1588.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    if (_mv_1589.has_value) {
                        __auto_type name_expr = _mv_1589.value;
                        __auto_type _mv_1590 = (*name_expr);
                        switch (_mv_1590.tag) {
                            case types_SExpr_sym:
                            {
                                __auto_type name_sym = _mv_1590.data.sym;
...
void transpiler_emit_union_variant_to_header(context_TranspileContext* ctx, types_SExpr* variant_expr) {
    ...
    SLOP_PRE(((variant_expr != NULL)), "(!= variant-expr nil)");
    {
        ...
        switch (_mv_1591.tag) {
            case types_SExpr_sym:
            {
                __auto_type sym = _mv_1591.data.sym;
                break;
            }
            case types_SExpr_lst:
            {
                    ...
                    if ((num_items >= 2)) {
                        ...
                        if (_mv_1592.has_value) {
                            ...
                            switch (_mv_1593.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_1593.data.sym;
                                    {
                                        __auto_type variant_name = name_sym.name;
                                        ...
                                        if ((num_items == 2)) {
                                            ...
                                            if (_mv_1594.has_value) {
                                                __auto_type type_expr = _mv_1594.value;
                                                {
                                                    __auto_type c_type = context_to_c_type_prefixed(ctx, type_expr);
                                                    {
                                            ...
                                            for (int64_t fi = 1; fi < num_items; fi++) {
                                                __auto_type _mv_1595 = ({ __auto_type _lst = items; size_t _idx = (size_t)fi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            ...
            __auto_type lst = _mv_1597.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 2)) {
                    ...
                    if (_mv_1598.has_value) {
                        __auto_type name_expr = _mv_1598.value;
                        __auto_type _mv_1599 = (*name_expr);
                        switch (_mv_1599.tag) {
                            case types_SExpr_sym:
                            {
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1601.data.lst;
            {
                ...
                if ((((int64_t)((const_items).len)) < 4)) {
                    ...
                    __auto_type _mv_1602 = ({ __auto_type _lst = const_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            ...
                            case types_SExpr_sym:
                            {
                                __auto_type name_sym = _mv_1603.data.sym;
                                {
                                    ...
                                    if (!(transpiler_list_contains_str(exports, raw_name))) {
                                        ...
                                        __auto_type _mv_1604 = ({ __auto_type _lst = const_items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_1604.has_value) {
                                            __auto_type type_expr = _mv_1604.value;
...
void transpiler_emit_all_lambdas(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((count > 0)) {
            while ((i < count)) {
                __auto_type _mv_1606 = ({ __auto_type _lst = lambdas; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_1606.has_value) {
                    __auto_type lambda_code = _mv_1606.value;
...
slop_string transpiler_generate_c_output(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1607 = ({ __auto_type _lst = output_lines; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void transpiler_transpile_file(context_TranspileContext* ctx, slop_list_types_SExpr_ptr exprs) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (((len > 0) && transpiler_is_module_expr(exprs))) {
            __auto_type _mv_1608 = ({ __auto_type _lst = exprs; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1608.has_value) {
                __auto_type module_expr = _mv_1608.value;
...
uint8_t transpiler_is_module_expr(slop_list_types_SExpr_ptr exprs) {
    if ((((int64_t)((exprs).len)) < 1)) {
        ...
        if (_mv_1609.has_value) {
            __auto_type first = _mv_1609.value;
            __auto_type _mv_1610 = (*first);
            switch (_mv_1610.tag) {
                case types_SExpr_lst:
                {
