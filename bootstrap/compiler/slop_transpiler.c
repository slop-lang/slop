                    ...
                    case types_SExpr_lst:
                    {
                        __auto_type lst = _mv_1254.data.lst;
                        {
                            ...
                            if (((int64_t)((sub_items).len)) >= 1) {
                                __auto_type _mv_1255 = ({ __auto_type _lst = sub_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        ...
                                        case types_SExpr_sym:
                                        {
                                            ...
                                            if (string_eq(sym.name, SLOP_STR("@generic"))) {
                                                if (((int64_t)((sub_items).len)) >= 2) {
                                                    __auto_type _mv_1257 = ({ __auto_type _lst = sub_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_1257.has_value) {
                                                        __auto_type params_expr = _mv_1257.value;
                                                        __auto_type _mv_1258 = (*params_expr);
                                                        switch (_mv_1258.tag) {
                                                            case types_SExpr_lst:
                                                            {
                                                                __auto_type params_lst = _mv_1258.data.lst;
                                                                {
                                                                    __auto_type param_items = params_lst.items;
                                                                    __auto_type param_len = ((int64_t)((param_items).len));
                                                                    __auto_type j = 0;
                                                                    while (j < param_len) {
                                                                        __auto_type _mv_1259 = ({ __auto_type _lst = param_items; size_t _idx = (size_t)j; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                                        if (_mv_1259.has_value) {
                                                                            __auto_type param = _mv_1259.value;
                                                                            __auto_type _mv_1260 = (*param);
                                                                            switch (_mv_1260.tag) {
                                                                                case types_SExpr_sym:
                                                                                {
                                                                                    __auto_type param_sym = _mv_1260.data.sym;
                                                            ...
                                                            case types_SExpr_sym:
                                                            {
                                                                __auto_type single_sym = _mv_1258.data.sym;
                                ...
                                switch (_mv_1273.tag) {
                                    ...
                                    case types_SExpr_lst:
                                    {
                                        ...
                                        if (((int64_t)((variant_lst.items).len)) > 0) {
                                            __auto_type _mv_1274 = ({ __auto_type _lst = variant_lst.items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                        ...
                                                        switch (_mv_1281.tag) {
                                                            case types_SExpr_sym:
                                                            {
                                                                __auto_type name_sym = _mv_1281.data.sym;
                                                                {
                                                                    ...
                                                                    context_ctx_register_enum_variant(ctx, variant_name, union_name);
                                                                    __auto_type _mv_1282 = ({ __auto_type _lst = vl_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                                    ...
                                                                    if (vl_len >= 3) {
                                                                        ...
                                                                        for (int64_t fi = 1; fi < vl_len; fi++) {
                                                                            __auto_type _mv_1283 = ({ __auto_type _lst = vl_items; size_t _idx = (size_t)fi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                ...
                switch (_mv_1289.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type lst = _mv_1289.data.lst;
                        {
                            __auto_type sub_items = lst.items;
                            if (((int64_t)((sub_items).len)) >= 2) {
                                __auto_type _mv_1290 = ({ __auto_type _lst = sub_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1290.has_value) {
                                    __auto_type head = _mv_1290.value;
                                    __auto_type _mv_1291 = (*head);
                                    switch (_mv_1291.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type sym = _mv_1291.data.sym;
                                            if (string_eq(sym.name, SLOP_STR("@spec"))) {
                                                __auto_type _mv_1292 = ({ __auto_type _lst = sub_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_1292.has_value) {
                                                    __auto_type spec_body = _mv_1292.value;
                                                    __auto_type _mv_1293 = (*spec_body);
                                                    switch (_mv_1293.tag) {
                                                        case types_SExpr_lst:
                                                        {
                                                            __auto_type body_lst = _mv_1293.data.lst;
                                                            {
                                                                __auto_type body_items = body_lst.items;
                                                                __auto_type body_len = ((int64_t)((body_items).len));
                                                                if (body_len >= 1) {
                                                                    __auto_type _mv_1294 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)(body_len - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                                    if (_mv_1294.has_value) {
                                                                        __auto_type ret_type = _mv_1294.value;
                                                                        __auto_type _mv_1295 = (*ret_type);
                                                                        switch (_mv_1295.tag) {
                                                                            case types_SExpr_sym:
                                                                            {
                                                                                __auto_type ret_sym = _mv_1295.data.sym;
...
void transpiler_prescan_fn_params(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    ...
    if (((int64_t)((items).len)) >= 3) {
        ...
        if (_mv_1303.has_value) {
            __auto_type params_expr = _mv_1303.value;
            __auto_type _mv_1304 = (*params_expr);
            switch (_mv_1304.tag) {
                case types_SExpr_lst:
                {
                    __auto_type params_lst = _mv_1304.data.lst;
                    {
                        __auto_type params = params_lst.items;
                        __auto_type param_count = ((int64_t)((params).len));
                        __auto_type i = 0;
                        while (i < param_count) {
                            __auto_type _mv_1305 = ({ __auto_type _lst = params; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_1305.has_value) {
                                __auto_type param_expr = _mv_1305.value;
                                __auto_type _mv_1306 = (*param_expr);
                                switch (_mv_1306.tag) {
                                    case types_SExpr_lst:
                                    {
                                        __auto_type param_lst = _mv_1306.data.lst;
                                        {
                                            __auto_type param_items = param_lst.items;
                                            if (((int64_t)((param_items).len)) >= 2) {
                                                __auto_type _mv_1307 = ({ __auto_type _lst = param_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                ...
                __auto_type lst = _mv_1311.data.lst;
                {
                    ...
                    if (len < 2) {
                    ...
                    } else {
                        {
                            ...
                            __auto_type _mv_1312 = ({ __auto_type _lst = items; size_t _idx = (size_t)type_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
uint8_t transpiler_prescan_is_param_mode(slop_list_types_SExpr_ptr items) {
    if (((int64_t)((items).len)) < 1) {
        ...
        if (_mv_1313.has_value) {
            __auto_type first = _mv_1313.value;
            __auto_type _mv_1314 = (*first);
            switch (_mv_1314.tag) {
                case types_SExpr_sym:
                {
...
void transpiler_extract_result_type(context_TranspileContext* ctx, types_SExpr* spec_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1319 = (*spec_expr);
        switch (_mv_1319.tag) {
            case types_SExpr_lst:
            {
                                ...
                                case types_SExpr_sym:
                                {
                                    ...
                                    if (string_eq(sym.name, SLOP_STR("Result"))) {
                                        ...
                                        if (_mv_1326.has_value) {
                                            __auto_type ok_type_expr = _mv_1326.value;
                                            ...
                                            if (_mv_1327.has_value) {
                                                __auto_type err_type_expr = _mv_1327.value;
                                                {
                                    ...
                                    if (string_eq(name, SLOP_STR("map-new"))) {
                                        if (len >= 3) {
                                            ...
                                            if (_mv_1332.has_value) {
                                                __auto_type key_type_expr = _mv_1332.value;
                                        ...
                                        if (len >= 3) {
                                            ...
                                            if (_mv_1333.has_value) {
                                                __auto_type elem_type_expr = _mv_1333.value;
                                        ...
                                        if (len >= 4) {
                                            ...
                                            if (_mv_1334.has_value) {
                                                __auto_type type_expr = _mv_1334.value;
                                                {
                                    ...
                                    } else {
                                        {
                                            ...
                                            while (i < len) {
                                                ...
                                                if (_mv_1336.has_value) {
                                                    __auto_type child = _mv_1336.value;
...
void transpiler_prescan_register_struct_key_type(context_TranspileContext* ctx, types_SExpr* type_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1338 = (*type_expr);
        switch (_mv_1338.tag) {
            case types_SExpr_sym:
            {
                __auto_type sym = _mv_1338.data.sym;
                {
                    ...
                    if (!(transpiler_is_builtin_map_key_type(name))) {
                        __auto_type _mv_1339 = context_ctx_lookup_type(ctx, name);
                        if (_mv_1339.has_value) {
                            ...
                            __auto_type _mv_1340 = context_ctx_get_module(ctx);
                            if (_mv_1340.has_value) {
                                __auto_type mod = _mv_1340.value;
                                {
                                    __auto_type prefixed = context_ctx_str3(ctx, mod, SLOP_STR("_"), name);
                                    __auto_type _mv_1341 = context_ctx_lookup_type(ctx, prefixed);
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len >= 2) {
            ...
            if (_mv_1347.has_value) {
                __auto_type header_expr = _mv_1347.value;
                __auto_type _mv_1348 = (*header_expr);
                switch (_mv_1348.tag) {
                    case types_SExpr_str:
                    {
                        __auto_type str = _mv_1348.data.str;
            ...
            }
            {
                ...
                while (i < len) {
                    ...
                    if (_mv_1349.has_value) {
                        __auto_type func_decl = _mv_1349.value;
...
void transpiler_prescan_import(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    ...
    if (((int64_t)((items).len)) >= 3) {
        ...
        if (_mv_1350.has_value) {
            __auto_type mod_expr = _mv_1350.value;
            __auto_type _mv_1351 = (*mod_expr);
            switch (_mv_1351.tag) {
                case types_SExpr_sym:
                {
                    __auto_type mod_sym = _mv_1351.data.sym;
                    {
                        ...
                        if (_mv_1352.has_value) {
                            __auto_type symbols_expr = _mv_1352.value;
                            __auto_type _mv_1353 = (*symbols_expr);
                            switch (_mv_1353.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type symbols_lst = _mv_1353.data.lst;
                                    {
                                        __auto_type syms = symbols_lst.items;
                                        __auto_type sym_len = ((int64_t)((syms).len));
                                        __auto_type j = 0;
                                        while (j < sym_len) {
                                            __auto_type _mv_1354 = ({ __auto_type _lst = syms; size_t _idx = (size_t)j; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_1354.has_value) {
                                                __auto_type sym_item = _mv_1354.value;
                                                __auto_type _mv_1355 = (*sym_item);
                                                switch (_mv_1355.tag) {
                                                    case types_SExpr_sym:
                                                    {
                                                        __auto_type s = _mv_1355.data.sym;
                                                        {
...
void transpiler_register_ffi_function(context_TranspileContext* ctx, types_SExpr* func_decl) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1358 = (*func_decl);
        switch (_mv_1358.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1358.data.lst;
                {
                    ...
                    if (len >= 1) {
                        ...
                        if (_mv_1359.has_value) {
                            __auto_type name_expr = _mv_1359.value;
                            __auto_type _mv_1360 = (*name_expr);
                            switch (_mv_1360.tag) {
                                case types_SExpr_sym:
                                {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (((int64_t)((items).len)) >= 2) {
            ...
            if (_mv_1361.has_value) {
                __auto_type params_expr = _mv_1361.value;
                __auto_type _mv_1362 = (*params_expr);
                switch (_mv_1362.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type params_lst = _mv_1362.data.lst;
                        {
                            __auto_type params = params_lst.items;
                            __auto_type param_count = ((int64_t)((params).len));
                            __auto_type i = 0;
                            while (i < param_count) {
                                __auto_type _mv_1363 = ({ __auto_type _lst = params; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1363.has_value) {
                                    __auto_type param_expr = _mv_1363.value;
                                    {
                                        __auto_type c_type = transpiler_prescan_get_param_c_type(ctx, param_expr);
                                        __auto_type param_info = ((context_FuncParamType*)(({ __auto_type _alloc = (context_FuncParamType*)slop_arena_alloc(arena, sizeof(context_FuncParamType)); if (_alloc == NULL) { fprintf(stderr, "SLOP: arena alloc failed at %s:%d\n", __FILE__, __LINE__); abort(); } _alloc; })));
                                        (*param_info).c_type = c_type;
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_1364.has_value) {
                __auto_type item_expr = _mv_1364.value;
                __auto_type _mv_1365 = (*item_expr);
                switch (_mv_1365.tag) {
                    case types_SExpr_sym:
                    {
                        __auto_type sym = _mv_1365.data.sym;
                        if (string_eq(sym.name, SLOP_STR(":c-name"))) {
                            __auto_type _mv_1366 = ({ __auto_type _lst = items; size_t _idx = (size_t)(i + 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_1366.has_value) {
                                __auto_type c_name_expr = _mv_1366.value;
                                __auto_type _mv_1367 = (*c_name_expr);
                                switch (_mv_1367.tag) {
                                    case types_SExpr_sym:
                                    {
                                        __auto_type c_sym = _mv_1367.data.sym;
                                        c_name = c_sym.name;
                                        found_c_name = 1;
                                        break;
                                    }
        ...
        if (len >= 2) {
            {
                ...
                if (has_header) {
                    ...
                    if (_mv_1368.has_value) {
                        __auto_type header_expr = _mv_1368.value;
                        __auto_type _mv_1369 = (*header_expr);
                        switch (_mv_1369.tag) {
                            case types_SExpr_str:
                            {
                ...
                if (len >= (name_idx + 1)) {
                    __auto_type _mv_1370 = ({ __auto_type _lst = items; size_t _idx = (size_t)name_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_string transpiler_get_ffi_struct_c_name(slop_arena* arena, slop_list_types_SExpr_ptr items, int64_t name_idx, slop_string default_name) {
    {
        ...
        if (len >= (modifier_idx + 2)) {
            __auto_type _mv_1372 = ({ __auto_type _lst = items; size_t _idx = (size_t)modifier_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1372.has_value) {
                __auto_type mod_expr = _mv_1372.value;
                __auto_type _mv_1373 = (*mod_expr);
                switch (_mv_1373.tag) {
                    case types_SExpr_sym:
                    {
                        __auto_type sym = _mv_1373.data.sym;
                        if (string_eq(sym.name, SLOP_STR(":c-name"))) {
                            __auto_type _mv_1374 = ({ __auto_type _lst = items; size_t _idx = (size_t)(modifier_idx + 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_1374.has_value) {
                                __auto_type cname_expr = _mv_1374.value;
                                __auto_type _mv_1375 = (*cname_expr);
                                switch (_mv_1375.tag) {
                                    case types_SExpr_str:
                                    {
...
uint8_t transpiler_is_ffi_string_item(slop_list_types_SExpr_ptr items, int64_t idx) {
    __auto_type _mv_1376 = ({ __auto_type _lst = items; size_t _idx = (size_t)idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    if (_mv_1376.has_value) {
        ...
        switch (_mv_1377.tag) {
            case types_SExpr_str:
            {
                __auto_type _ = _mv_1377.data.str;
                return 1;
            }
            default: {
                return 0;
...
slop_string transpiler_get_array_c_type(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items, slop_string default_c_type) {
    ...
    if (((int64_t)((items).len)) < 3) {
        ...
        if (_mv_1390.has_value) {
            __auto_type body_expr = _mv_1390.value;
            __auto_type _mv_1391 = (*body_expr);
            switch (_mv_1391.tag) {
                case types_SExpr_lst:
                {
                    __auto_type body_lst = _mv_1391.data.lst;
                    {
                        ...
                        if (((int64_t)((body_items).len)) < 2) {
                            ...
                            __auto_type _mv_1392 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                ...
                                switch (_mv_1393.tag) {
                                    case types_SExpr_sym:
                                    {
                                        ...
                                        if (string_eq(sym.name, SLOP_STR("Array"))) {
                                            __auto_type _mv_1394 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_1394.has_value) {
                                                __auto_type elem_expr = _mv_1394.value;
                                                {
...
void transpiler_transpile_module(context_TranspileContext* ctx, types_SExpr* module_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1409 = (*module_expr);
        switch (_mv_1409.tag) {
            case types_SExpr_lst:
            {
...
int64_t transpiler_get_body_start(slop_list_types_SExpr_ptr items) {
    if (((int64_t)((items).len)) < 3) {
        ...
        if (_mv_1412.has_value) {
            __auto_type third = _mv_1412.value;
            __auto_type _mv_1413 = (*third);
            switch (_mv_1413.tag) {
                case types_SExpr_lst:
                {
                                            ...
                                            if (string_eq(sym.name, SLOP_STR("export"))) {
                                                {
                                                    ...
                                                    __auto_type j = 1;
                                                    while (j < export_len) {
                                                        __auto_type _mv_1420 = ({ __auto_type _lst = sub_items; size_t _idx = (size_t)j; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
uint8_t transpiler_list_contains_str(slop_list_string lst, slop_string needle) {
    {
        ...
        uint8_t found = 0;
        while ((i < len) && !(found)) {
            __auto_type _mv_1422 = ({ __auto_type _lst = lst; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1422.has_value) {
                __auto_type s = _mv_1422.value;
...
void transpiler_scan_type_for_generics(context_TranspileContext* ctx, types_SExpr* type_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1424 = (*type_expr);
        switch (_mv_1424.tag) {
            case types_SExpr_lst:
            {
                                        ...
                                        if (string_eq(op, SLOP_STR("Option"))) {
                                            ...
                                            if (len >= 3) {
                                                ...
                                                if (_mv_1430.has_value) {
                                                    __auto_type ok_type = _mv_1430.value;
                                                    ...
                                                    if (_mv_1431.has_value) {
                                                        __auto_type err_type = _mv_1431.value;
                                                        {
                                            ...
                                            if (len >= 2) {
                                                ...
                                                if (_mv_1433.has_value) {
                                                    __auto_type result = _mv_1433.value;
                                                    {
                                            ...
                                            if (len >= 3) {
                                                ...
                                                if (_mv_1434.has_value) {
                                                    __auto_type key_type = _mv_1434.value;
                                                    {
                                                        ...
                                                        if (_mv_1435.has_value) {
                                                            __auto_type val_type = _mv_1435.value;
                                                            {
                                            ...
                                            if (len >= 2) {
                                                ...
                                                if (_mv_1436.has_value) {
                                                    __auto_type elem_type = _mv_1436.value;
                                                    {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_1437.has_value) {
                __auto_type field_expr = _mv_1437.value;
                __auto_type _mv_1438 = (*field_expr);
                switch (_mv_1438.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type field_lst = _mv_1438.data.lst;
                        {
                            __auto_type field_items = field_lst.items;
                            if (((int64_t)((field_items).len)) >= 2) {
                                __auto_type _mv_1439 = ({ __auto_type _lst = field_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1439.has_value) {
                                    __auto_type type_expr = _mv_1439.value;
                                    transpiler_scan_type_for_generics(ctx, type_expr);
...
void transpiler_emit_ffi_includes(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1440 = ({ __auto_type _lst = includes; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1440.has_value) {
                __auto_type header = _mv_1440.value;
...
void transpiler_emit_header_guard_open(context_TranspileContext* ctx) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1442 = context_ctx_get_module(ctx);
        if (_mv_1442.has_value) {
            __auto_type mod_name = _mv_1442.value;
            {
...
void transpiler_emit_header_dependency_includes(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1443 = ({ __auto_type _lst = imports; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        while (i < len) {
            ...
            if (_mv_1444.has_value) {
                ...
                if (transpiler_is_type_def(item) && transpiler_is_struct_type_def(item)) {
                    __auto_type _mv_1445 = transpiler_get_type_name(item);
                    if (_mv_1445.has_value) {
                        __auto_type type_name = _mv_1445.value;
                        {
        ...
        while ((i < len) && !(found)) {
            ...
            if (_mv_1451.has_value) {
                ...
                switch (_mv_1452.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type _ = _mv_1452.data.lst;
                        found = 1;
                        break;
                    }
                    default: {
            ...
            __auto_type lst = _mv_1453.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 3) {
                    ...
                    if (_mv_1454.has_value) {
                        __auto_type def_expr = _mv_1454.value;
                        __auto_type _mv_1455 = (*def_expr);
                        switch (_mv_1455.tag) {
                            case types_SExpr_sym:
                            {
                                __auto_type _ = _mv_1455.data.sym;
                                return 1;
                            }
                            case types_SExpr_lst:
                            {
                                __auto_type def_lst = _mv_1455.data.lst;
                                {
                                    __auto_type def_items = def_lst.items;
                                    if (((int64_t)((def_items).len)) < 1) {
                                        return 0;
                                    } else {
                                        __auto_type _mv_1456 = ({ __auto_type _lst = def_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_1456.has_value) {
                                            __auto_type head = _mv_1456.value;
                                            __auto_type _mv_1457 = (*head);
                                            switch (_mv_1457.tag) {
                                                case types_SExpr_sym:
                                                {
                ...
                __auto_type lst = _mv_1470.data.lst;
                {
                    ...
                    if (len < 3) {
                        ...
                        if (_mv_1471.has_value) {
                            __auto_type elem_type_expr = _mv_1471.value;
                            ...
                            if (_mv_1472.has_value) {
                                __auto_type size_expr = _mv_1472.value;
                                {
...
transpiler_RangeBoundsHeader transpiler_parse_range_bounds_header(types_SExpr* body_expr) {
    SLOP_PRE(((body_expr != NULL)), "(!= body-expr nil)");
    {
        ...
        __auto_type _mv_1477 = (*body_expr);
        switch (_mv_1477.tag) {
            case types_SExpr_lst:
            {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_1480.has_value) {
                ...
                if (transpiler_is_type_def(item) && transpiler_is_struct_type_def(item)) {
                    __auto_type _mv_1481 = transpiler_get_type_name(item);
                    if (_mv_1481.has_value) {
                        __auto_type type_name = _mv_1481.value;
                        {
...
void transpiler_emit_c_name_aliases(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len > 0) {
            ...
            while (i < len) {
                __auto_type _mv_1484 = ({ __auto_type _lst = aliases; size_t _idx = (size_t)i; slop_option_context_FuncCNameAlias _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_1484.has_value) {
                    __auto_type alias = _mv_1484.value;
                                ...
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_1487.data.sym;
                                    {
                                        ...
                                        if (_mv_1488.has_value) {
                                            __auto_type params_expr = _mv_1488.value;
                                            {
...
void transpiler_emit_result_types(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1496 = ({ __auto_type _lst = result_types; size_t _idx = (size_t)i; slop_option_context_ResultType _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void transpiler_emit_inline_records_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1498 = ({ __auto_type _lst = inline_records; size_t _idx = (size_t)i; slop_option_context_InlineRecord _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1498.has_value) {
                __auto_type ir = _mv_1498.value;
                {
                                        ...
                                        if (string_eq(kind, SLOP_STR("Ptr"))) {
                                            ...
                                            if (((int64_t)((items).len)) >= 2) {
                                                ...
                                                if (_mv_1560.has_value) {
                                                    __auto_type inner = _mv_1560.value;
                                                    {
