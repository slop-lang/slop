            ...
            __auto_type lst = _mv_821.data.lst;
            {
                ...
                while (i < len) {
                    ...
                    if (_mv_822.has_value) {
                        __auto_type item_expr = _mv_822.value;
                        {
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_823.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) >= 3) {
                        __auto_type _mv_824 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_824.has_value) {
                            __auto_type head_ptr = _mv_824.value;
                            __auto_type _mv_825 = (*head_ptr);
                            switch (_mv_825.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type head_sym = _mv_825.data.sym;
                                    {
                                        ...
                                        if (string_eq(op, SLOP_STR("arena-alloc"))) {
                                            ...
                                            if (_mv_826.has_value) {
                                                __auto_type size_expr = _mv_826.value;
                                            ...
                                            if (_mv_827.has_value) {
                                                __auto_type inner_expr = _mv_827.value;
            ...
            __auto_type lst = _mv_833.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 1) {
                    ...
                    if (_mv_834.has_value) {
                        __auto_type head_expr = _mv_834.value;
                        __auto_type _mv_835 = (*head_expr);
                        switch (_mv_835.tag) {
                            case types_SExpr_sym:
                            {
                ...
                __auto_type lst = _mv_836.data.lst;
                {
                    ...
                    if (len < 2) {
                        ...
                        if (_mv_837.has_value) {
                            __auto_type bindings_expr = _mv_837.value;
                            __auto_type _mv_838 = (*bindings_expr);
                            switch (_mv_838.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type bindings_lst = _mv_838.data.lst;
                        ...
                        }
                        {
                            __auto_type i = 2;
                            while (i < len) {
                                __auto_type _mv_839 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_839.has_value) {
                                    __auto_type body_expr = _mv_839.value;
                                    {
...
void stmt_transpile_bindings(context_TranspileContext* ctx, slop_list_types_SExpr_ptr bindings) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_840 = ({ __auto_type _lst = bindings; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_840.has_value) {
                __auto_type binding_expr = _mv_840.value;
...
void stmt_transpile_single_binding(context_TranspileContext* ctx, types_SExpr* binding) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_841 = (*binding);
        switch (_mv_841.tag) {
            case types_SExpr_lst:
            {
                __auto_type binding_lst = _mv_841.data.lst;
                {
                    ...
                    __auto_type len = ((int64_t)((items).len));
                    {
                        ...
                        if ((len - start_idx) < 2) {
                            ...
                            __auto_type _mv_842 = ({ __auto_type _lst = items; size_t _idx = (size_t)start_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_842.has_value) {
                                ...
                                switch (_mv_843.tag) {
                                    case types_SExpr_sym:
                                    {
                                        __auto_type name_sym = _mv_843.data.sym;
                                        {
                                            __auto_type raw_name = name_sym.name;
                                            __auto_type var_name = ctype_to_c_name(arena, raw_name);
                                            if ((len - start_idx) >= 3) {
                                                __auto_type _mv_844 = ({ __auto_type _lst = items; size_t _idx = (size_t)(start_idx + 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_844.has_value) {
                                                    __auto_type type_expr = _mv_844.value;
                                                    __auto_type _mv_845 = ({ __auto_type _lst = items; size_t _idx = (size_t)(start_idx + 2); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_845.has_value) {
                                                        __auto_type init_expr = _mv_845.value;
                                                        {
                                                            __auto_type c_type = context_to_c_type_prefixed(ctx, type_expr);
                                                            {
                                                ...
                                                __auto_type _mv_846 = ({ __auto_type _lst = items; size_t _idx = (size_t)(start_idx + 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_846.has_value) {
                                                    __auto_type init_expr = _mv_846.value;
                                                    {
                                                        ...
                                                        __auto_type _mv_847 = ptr_type_opt;
                                                        if (_mv_847.has_value) {
                                                            __auto_type ptr_type = _mv_847.value;
...
uint8_t stmt_binding_has_mut(slop_list_types_SExpr_ptr items) {
    if (((int64_t)((items).len)) < 1) {
        ...
        if (_mv_848.has_value) {
            __auto_type first = _mv_848.value;
            __auto_type _mv_849 = (*first);
            switch (_mv_849.tag) {
                case types_SExpr_sym:
                {
                ...
                __auto_type lst = _mv_850.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) >= 2) {
                        ...
                        if (_mv_851.has_value) {
                            __auto_type head_expr = _mv_851.value;
                            __auto_type _mv_852 = (*head_expr);
                            switch (_mv_852.tag) {
                                case types_SExpr_sym:
                                {
            ...
            __auto_type lst = _mv_857.data.lst;
            {
                ...
                if (len < 3) {
                    ...
                    if (_mv_858.has_value) {
                        __auto_type cond_expr = _mv_858.value;
                        {
                            ...
                            if (_mv_859.has_value) {
                                __auto_type then_expr = _mv_859.value;
                            ...
                            if (len >= 4) {
                                ...
                                if (_mv_860.has_value) {
                                    __auto_type else_expr = _mv_860.value;
            ...
            __auto_type lst = _mv_861.data.lst;
            {
                ...
                if (len < 3) {
                    ...
                    if (_mv_862.has_value) {
                        __auto_type cond_expr = _mv_862.value;
                        {
                            __auto_type cond_c = context_ctx_strip_cond_parens(ctx, expr_transpile_expr(ctx, cond_expr));
                            context_ctx_emit(ctx, context_ctx_str3(ctx, SLOP_STR("if ("), cond_c, SLOP_STR(") {")));
                            context_ctx_indent(ctx);
                            {
                                ...
                                while (i < len) {
                                    ...
                                    if (_mv_863.has_value) {
                                        __auto_type body_expr = _mv_863.value;
            ...
            __auto_type lst = _mv_864.data.lst;
            {
                ...
                if (len < 3) {
                    ...
                    if (_mv_865.has_value) {
                        __auto_type cond_expr = _mv_865.value;
                        {
                            __auto_type cond_c = context_ctx_strip_cond_parens(ctx, expr_transpile_expr(ctx, cond_expr));
                            ...
                            context_ctx_indent(ctx);
                            {
                                __auto_type i = 2;
                                while (i < len) {
                                    __auto_type _mv_866 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    if (_mv_866.has_value) {
                                        __auto_type body_expr = _mv_866.value;
                                        stmt_transpile_stmt(ctx, body_expr, 0);
                            ...
                            if (_mv_869.has_value) {
                                __auto_type value_expr = _mv_869.value;
                                {
                                    ...
                                    if (_mv_870.has_value) {
                                        ...
                                        {
                                            __auto_type some_val_opt = stmt_get_some_value(value_expr);
                                            __auto_type _mv_872 = some_val_opt;
...
slop_option_string stmt_get_var_c_type(context_TranspileContext* ctx, types_SExpr* expr) {
    ...
    switch (_mv_874.tag) {
        case types_SExpr_sym:
        {
            ...
            {
                __auto_type name = sym.name;
                __auto_type _mv_875 = context_ctx_lookup_var(ctx, name);
                if (_mv_875.has_value) {
                    __auto_type var_entry = _mv_875.value;
...
uint8_t stmt_is_pointer_target(context_TranspileContext* ctx, types_SExpr* expr) {
    ...
    switch (_mv_876.tag) {
        case types_SExpr_sym:
        {
            ...
            {
                __auto_type name = sym.name;
                __auto_type _mv_877 = context_ctx_lookup_var(ctx, name);
                if (_mv_877.has_value) {
                    __auto_type var_entry = _mv_877.value;
...
void stmt_transpile_field_set(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (_mv_878.has_value) {
            __auto_type target_expr = _mv_878.value;
            __auto_type _mv_879 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_879.has_value) {
                __auto_type field_expr = _mv_879.value;
                __auto_type _mv_880 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_880.has_value) {
                    __auto_type value_expr = _mv_880.value;
                    {
...
void stmt_transpile_typed_field_set(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_881 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        if (_mv_881.has_value) {
            __auto_type target_expr = _mv_881.value;
            __auto_type _mv_882 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_882.has_value) {
                __auto_type field_expr = _mv_882.value;
                __auto_type _mv_883 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_883.has_value) {
                    __auto_type type_expr = _mv_883.value;
                    __auto_type _mv_884 = ({ __auto_type _lst = items; size_t _idx = (size_t)4; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_884.has_value) {
                        __auto_type value_expr = _mv_884.value;
                        {
                            __auto_type field_name = stmt_get_symbol_name(arena, field_expr);
                            __auto_type c_type = ctype_to_c_type(arena, type_expr);
                            {
                                ...
                                if (context_ctx_is_option_c_type(ctx, c_type)) {
                                    if (stmt_is_none_form(value_expr)) {
                                        ...
                                        __auto_type _mv_885 = stmt_get_some_value(value_expr);
                                        if (_mv_885.has_value) {
                                            __auto_type inner_val = _mv_885.value;
                                            {
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_886.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 1) {
                    ...
                    __auto_type _mv_887 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
types_SExpr* stmt_get_deref_inner(types_SExpr* expr) {
    ...
    switch (_mv_889.tag) {
        case types_SExpr_lst:
        {
            ...
            {
                __auto_type items = lst.items;
                __auto_type _mv_890 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_890.has_value) {
                    __auto_type inner = _mv_890.value;
                    return inner;
                ...
                if (len < 2) {
                ...
                } else {
                    {
                        ...
                        if (is_named && (len < 4)) {
                            ...
                            context_ctx_indent(ctx);
                            context_ctx_push_scope(ctx);
                            __auto_type _mv_895 = ({ __auto_type _lst = items; size_t _idx = (size_t)size_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_895.has_value) {
                                __auto_type size_expr = _mv_895.value;
                                {
                            ...
                            context_ctx_bind_var(ctx, (context_VarEntry){arena_name, c_arena_name, SLOP_STR("slop_arena*"), SLOP_STR(""), 1, 0, 0, SLOP_STR(""), SLOP_STR("")});
                            {
                                ...
                                while (i < len) {
                                    __auto_type _mv_896 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    if (_mv_896.has_value) {
                                        __auto_type body_expr = _mv_896.value;
                                        {
                                            __auto_type is_last = (i == (len - 1));
                                            stmt_transpile_stmt(ctx, body_expr, (is_return && is_last));
                                        }
            ...
            __auto_type lst = _mv_897.data.lst;
            {
                ...
                while (i < len) {
                    ...
                    if (_mv_898.has_value) {
                        __auto_type clause_expr = _mv_898.value;
                        __auto_type _mv_899 = (*clause_expr);
                        switch (_mv_899.tag) {
                            case types_SExpr_lst:
                            {
                                __auto_type clause_lst = _mv_899.data.lst;
                                {
                                    ...
                                    if (clause_len < 1) {
                                        ...
                                        __auto_type _mv_900 = ({ __auto_type _lst = clause_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_900.has_value) {
                                            __auto_type test_expr = _mv_900.value;
                                            __auto_type _mv_901 = (*test_expr);
                                            switch (_mv_901.tag) {
                                                case types_SExpr_sym:
                                                {
                                                    __auto_type sym = _mv_901.data.sym;
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_903.data.lst;
                {
                    ...
                    if (len < 2) {
                        ...
                        __auto_type _mv_904 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_904.has_value) {
                            __auto_type binding_expr = _mv_904.value;
                            __auto_type _mv_905 = (*binding_expr);
                            switch (_mv_905.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type binding_lst = _mv_905.data.lst;
                                    {
                                        ...
                                        if (binding_len < 3) {
                                            ...
                                            __auto_type _mv_906 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_906.has_value) {
                                                __auto_type var_expr = _mv_906.value;
                                                __auto_type _mv_907 = (*var_expr);
                                                switch (_mv_907.tag) {
                                                    case types_SExpr_sym:
                                                    {
                                                        __auto_type var_sym = _mv_907.data.sym;
                                                        {
                                                            __auto_type var_name = ctype_to_c_name(arena, var_sym.name);
                                                            __auto_type _mv_908 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                            if (_mv_908.has_value) {
                                                                __auto_type start_expr = _mv_908.value;
                                                                __auto_type _mv_909 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                                if (_mv_909.has_value) {
                                                                    __auto_type end_expr = _mv_909.value;
                                                                    {
...
void stmt_transpile_for_each_set(context_TranspileContext* ctx, slop_string var_name, types_SExprSymbol var_sym, slop_string coll_c, slop_string resolved_type, slop_list_types_SExpr_ptr items, int64_t len) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        context_ctx_bind_var(ctx, (context_VarEntry){var_sym.name, var_name, elem_c_type, elem_slop_type, 0, 0, 0, SLOP_STR(""), SLOP_STR("")});
        {
            int64_t i = 2;
            while (i < len) {
                __auto_type _mv_911 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_911.has_value) {
                    __auto_type body_expr = _mv_911.value;
                    stmt_transpile_stmt(ctx, body_expr, 0);
...
void stmt_transpile_for_each_map_kv(context_TranspileContext* ctx, slop_list_types_SExpr_ptr binding_items, slop_list_types_SExpr_ptr items, int64_t len) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_913 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        if (_mv_913.has_value) {
            __auto_type kv_list_expr = _mv_913.value;
            __auto_type _mv_914 = (*kv_list_expr);
            switch (_mv_914.tag) {
                case types_SExpr_lst:
                {
                    __auto_type kv_lst = _mv_914.data.lst;
                    {
                        __auto_type kv_items = kv_lst.items;
                        if (((int64_t)((kv_items).len)) < 2) {
                            context_ctx_add_error(ctx, SLOP_STR("Map for-each needs ((k v) map)"));
                        } else {
                            __auto_type _mv_915 = ({ __auto_type _lst = kv_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_915.has_value) {
                                __auto_type k_expr = _mv_915.value;
                                __auto_type _mv_916 = ({ __auto_type _lst = kv_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_916.has_value) {
                                    __auto_type v_expr = _mv_916.value;
                                    __auto_type _mv_917 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    if (_mv_917.has_value) {
                                        __auto_type map_expr = _mv_917.value;
                                        __auto_type _mv_918 = (*k_expr);
                                        switch (_mv_918.tag) {
                                            case types_SExpr_sym:
                                            {
                                                __auto_type k_sym = _mv_918.data.sym;
                                                __auto_type _mv_919 = (*v_expr);
                                                switch (_mv_919.tag) {
                                                    case types_SExpr_sym:
                                                    {
                                                        __auto_type v_sym = _mv_919.data.sym;
                                                        {
                ...
                __auto_type lst = _mv_921.data.lst;
                {
                    ...
                    if (len < 2) {
                        ...
                        if (_mv_922.has_value) {
                            __auto_type binding_expr = _mv_922.value;
                            __auto_type _mv_923 = (*binding_expr);
                            switch (_mv_923.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type binding_lst = _mv_923.data.lst;
                                    {
                                        __auto_type binding_items = binding_lst.items;
                                        __auto_type binding_len = ((int64_t)((binding_items).len));
                                        if (binding_len < 2) {
                                            ...
                                            __auto_type _mv_924 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_924.has_value) {
                                                __auto_type first_elem = _mv_924.value;
                                                __auto_type _mv_925 = (*first_elem);
                                                switch (_mv_925.tag) {
                                                    case types_SExpr_lst:
                                                    {
                                                        __auto_type _ = _mv_925.data.lst;
                                                        stmt_transpile_for_each_map_kv(ctx, binding_items, items, len);
                                                        break;
                                                    }
                                                    case types_SExpr_sym:
                                                    {
                                                        __auto_type var_sym = _mv_925.data.sym;
                                                        {
                                                            __auto_type var_name = ctype_to_c_name(arena, var_sym.name);
                                                            __auto_type _mv_926 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                            if (_mv_926.has_value) {
                                                                __auto_type coll_expr = _mv_926.value;
                                                                {
                                                                    ...
                                                                    if (expr_is_set_type(resolved_type)) {
                                                                    ...
                                                                    } else {
                                                                        {
                                                                            ...
                                                                            }
                                                                            {
                                                                                __auto_type i = 2;
                                                                                while (i < len) {
                                                                                    __auto_type _mv_927 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                                                    if (_mv_927.has_value) {
                                                                                        __auto_type body_expr = _mv_927.value;
                                                                                        stmt_transpile_stmt(ctx, body_expr, 0);
            ...
            __auto_type lst = _mv_928.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 1) {
                    ...
                    if (_mv_929.has_value) {
                        __auto_type head_expr = _mv_929.value;
                        __auto_type _mv_930 = (*head_expr);
                        switch (_mv_930.tag) {
                            case types_SExpr_sym:
                            {
                                __auto_type sym = _mv_930.data.sym;
                                {
                                    ...
                                    if (string_eq(op, SLOP_STR("let")) || string_eq(op, SLOP_STR("let*"))) {
                                        ...
                                        if (((int64_t)((items).len)) < 2) {
                                            ...
                                            __auto_type _mv_931 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_931.has_value) {
                                                __auto_type val_expr = _mv_931.value;
                            ...
                            case types_SExpr_sym:
                            {
                                __auto_type sym = _mv_934.data.sym;
                                {
                                    ...
                                    if (string_eq(op, SLOP_STR("some"))) {
                                        __auto_type _mv_935 = context_ctx_get_current_return_type(ctx);
                                        if (_mv_935.has_value) {
                                            __auto_type ret_type = _mv_935.value;
                                            if (context_ctx_is_option_c_type(ctx, ret_type)) {
                                                if (((int64_t)((items).len)) < 2) {
                                                    stmt_emit_return_with_typed_none(ctx, expr_transpile_expr(ctx, expr));
                                                } else {
                                                    ...
                                                    if (_mv_936.has_value) {
                                                        __auto_type inner_expr = _mv_936.value;
                                                        {
                                                            __auto_type inner_c = expr_transpile_expr(ctx, inner_expr);
                                        ...
                                        __auto_type _mv_937 = context_ctx_get_current_return_type(ctx);
...
void stmt_emit_return_with_typed_none(context_TranspileContext* ctx, slop_string code) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (string_eq(code, SLOP_STR("none"))) {
            __auto_type _mv_938 = context_ctx_get_current_return_type(ctx);
            if (_mv_938.has_value) {
                __auto_type ret_type = _mv_938.value;
                if (context_ctx_is_option_c_type(ctx, ret_type)) {
            ...
            __auto_type _mv_939 = context_ctx_get_current_return_type(ctx);
            if (_mv_939.has_value) {
                __auto_type ret_type = _mv_939.value;
                if (context_ctx_is_option_c_type(ctx, ret_type)) {
                    __auto_type _mv_940 = context_ctx_lookup_var(ctx, code);
                    if (_mv_940.has_value) {
                        __auto_type var_entry = _mv_940.value;
                        {
