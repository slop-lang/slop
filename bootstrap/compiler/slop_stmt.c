            ...
            __auto_type lst = _mv_762.data.lst;
            {
                ...
                while ((i < len)) {
                    ...
                    if (_mv_763.has_value) {
                        __auto_type item_expr = _mv_763.value;
                        {
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_764.data.lst;
                {
                    ...
                    if ((((int64_t)((items).len)) >= 3)) {
                        __auto_type _mv_765 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_765.has_value) {
                            __auto_type head_ptr = _mv_765.value;
                            __auto_type _mv_766 = (*head_ptr);
                            switch (_mv_766.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type head_sym = _mv_766.data.sym;
        ...
        switch (_mv_768.tag) {
            case types_SExpr_sym:
            {
                __auto_type sym = _mv_768.data.sym;
                {
                    ...
                    __auto_type _mv_769 = context_ctx_lookup_type(ctx, type_name);
                    if (_mv_769.has_value) {
                        __auto_type entry = _mv_769.value;
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_768.data.lst;
                {
                    ...
                    if ((((int64_t)((items).len)) >= 2)) {
                        __auto_type _mv_770 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_770.has_value) {
                            __auto_type head_ptr = _mv_770.value;
                            __auto_type _mv_771 = (*head_ptr);
                            switch (_mv_771.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type head_sym = _mv_771.data.sym;
                                    if (string_eq(head_sym.name, SLOP_STR("sizeof"))) {
                                        ...
                                        if (_mv_772.has_value) {
                                            __auto_type type_expr = _mv_772.value;
                                            {
                ...
                __auto_type lst = _mv_776.data.lst;
                {
                    ...
                    if ((len < 2)) {
                        ...
                        if (_mv_777.has_value) {
                            __auto_type bindings_expr = _mv_777.value;
                            __auto_type _mv_778 = (*bindings_expr);
                            switch (_mv_778.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type bindings_lst = _mv_778.data.lst;
                        ...
                        }
                        {
                            ...
                            while ((i < len)) {
                                ...
                                if (_mv_779.has_value) {
                                    __auto_type body_expr = _mv_779.value;
                                    {
...
void stmt_transpile_bindings(context_TranspileContext* ctx, slop_list_types_SExpr_ptr bindings) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_780 = ({ __auto_type _lst = bindings; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void stmt_transpile_single_binding(context_TranspileContext* ctx, types_SExpr* binding) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_781 = (*binding);
        switch (_mv_781.tag) {
            case types_SExpr_lst:
            {
                __auto_type binding_lst = _mv_781.data.lst;
                {
                    ...
                    __auto_type len = ((int64_t)((items).len));
                    {
                        ...
                        if (((len - start_idx) < 2)) {
                            ...
                            __auto_type _mv_782 = ({ __auto_type _lst = items; size_t _idx = (size_t)start_idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_782.has_value) {
                                __auto_type name_expr = _mv_782.value;
                                __auto_type _mv_783 = (*name_expr);
                                switch (_mv_783.tag) {
                                    case types_SExpr_sym:
                                    {
                                        __auto_type name_sym = _mv_783.data.sym;
                                        {
                                            __auto_type raw_name = name_sym.name;
                                            __auto_type var_name = ctype_to_c_name(arena, raw_name);
                                            if (((len - start_idx) >= 3)) {
                                                __auto_type _mv_784 = ({ __auto_type _lst = items; size_t _idx = (size_t)(start_idx + 1); slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_784.has_value) {
                                                    __auto_type type_expr = _mv_784.value;
                                                    __auto_type _mv_785 = ({ __auto_type _lst = items; size_t _idx = (size_t)(start_idx + 2); slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_785.has_value) {
                                                        __auto_type init_expr = _mv_785.value;
                                                        {
                                                            __auto_type c_type = context_to_c_type_prefixed(ctx, type_expr);
                                                            {
                                                ...
                                                __auto_type _mv_786 = ({ __auto_type _lst = items; size_t _idx = (size_t)(start_idx + 1); slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_786.has_value) {
                                                    __auto_type init_expr = _mv_786.value;
                                                    {
                                                        ...
                                                        __auto_type _mv_787 = ptr_type_opt;
                                                        if (_mv_787.has_value) {
                                                            __auto_type ptr_type = _mv_787.value;
...
uint8_t stmt_binding_has_mut(slop_list_types_SExpr_ptr items) {
    if ((((int64_t)((items).len)) < 1)) {
        ...
        if (_mv_788.has_value) {
            __auto_type first = _mv_788.value;
            __auto_type _mv_789 = (*first);
            switch (_mv_789.tag) {
                case types_SExpr_sym:
                {
        ...
        switch (_mv_790.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_790.data.lst;
                {
                    __auto_type items = lst.items;
                    if ((((int64_t)((items).len)) >= 2)) {
                        __auto_type _mv_791 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_791.has_value) {
                            __auto_type head_expr = _mv_791.value;
                            __auto_type _mv_792 = (*head_expr);
                            switch (_mv_792.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type sym = _mv_792.data.sym;
                                    if (string_eq(sym.name, SLOP_STR("some"))) {
                                        __auto_type _mv_793 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_793.has_value) {
                                            __auto_type val = _mv_793.value;
    ...
    switch (_mv_794.tag) {
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_794.data.lst;
            {
                __auto_type items = lst.items;
                if ((((int64_t)((items).len)) == 1)) {
                    __auto_type _mv_795 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                ...
                if ((len < 3)) {
                    ...
                    if (_mv_798.has_value) {
                        __auto_type cond_expr = _mv_798.value;
                        {
                            ...
                            context_ctx_indent(ctx);
                            __auto_type _mv_799 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_799.has_value) {
                                __auto_type then_expr = _mv_799.value;
                            ...
                            if ((len >= 4)) {
                                ...
                                context_ctx_indent(ctx);
                                __auto_type _mv_800 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_800.has_value) {
                                    __auto_type else_expr = _mv_800.value;
            ...
            __auto_type lst = _mv_801.data.lst;
            {
                ...
                if ((len < 3)) {
                    ...
                    if (_mv_802.has_value) {
                        __auto_type cond_expr = _mv_802.value;
                        {
                            __auto_type cond_c = expr_transpile_expr(ctx, cond_expr);
                            context_ctx_emit(ctx, context_ctx_str3(ctx, SLOP_STR("if ("), cond_c, SLOP_STR(") {")));
                            context_ctx_indent(ctx);
            ...
            __auto_type lst = _mv_804.data.lst;
            {
                ...
                if ((len < 3)) {
                    ...
                    if (_mv_805.has_value) {
                        __auto_type cond_expr = _mv_805.value;
                        {
                            __auto_type cond_c = expr_transpile_expr(ctx, cond_expr);
                            ...
                            context_ctx_indent(ctx);
                            {
                                __auto_type i = 2;
                                while ((i < len)) {
                                    __auto_type _mv_806 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    if (_mv_806.has_value) {
                                        __auto_type body_expr = _mv_806.value;
                                        stmt_transpile_stmt(ctx, body_expr, 0);
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_807.data.lst;
                {
                    ...
                    if ((len == 5)) {
                        ...
                        __auto_type _mv_808 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_808.has_value) {
                            __auto_type target_expr = _mv_808.value;
                            __auto_type _mv_809 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_809.has_value) {
                                __auto_type value_expr = _mv_809.value;
                                {
                                    __auto_type target_c = expr_transpile_expr(ctx, target_expr);
                                    __auto_type target_type_opt = stmt_get_var_c_type(ctx, target_expr);
                                    __auto_type _mv_810 = target_type_opt;
                                    if (_mv_810.has_value) {
                                        __auto_type target_type = _mv_810.value;
                                        if (strlib_starts_with(target_type, SLOP_STR("slop_option_"))) {
                                            {
                                                __auto_type some_val_opt = stmt_get_some_value(value_expr);
                                                __auto_type _mv_811 = some_val_opt;
                                                if (_mv_811.has_value) {
                                                    __auto_type val_expr = _mv_811.value;
                                                    {
                                        ...
                                        {
                                            __auto_type some_val_opt = stmt_get_some_value(value_expr);
                                            __auto_type _mv_812 = some_val_opt;
                                            if (_mv_812.has_value) {
                                                __auto_type inner_expr = _mv_812.value;
                                                {
...
uint8_t stmt_is_pointer_target(context_TranspileContext* ctx, types_SExpr* expr) {
    ...
    switch (_mv_816.tag) {
        case types_SExpr_sym:
        {
            ...
            {
                __auto_type name = sym.name;
                __auto_type _mv_817 = context_ctx_lookup_var(ctx, name);
                if (_mv_817.has_value) {
                    __auto_type var_entry = _mv_817.value;
                    {
...
void stmt_transpile_field_set(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (_mv_818.has_value) {
            __auto_type target_expr = _mv_818.value;
            __auto_type _mv_819 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_819.has_value) {
                __auto_type field_expr = _mv_819.value;
                __auto_type _mv_820 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_820.has_value) {
                    __auto_type value_expr = _mv_820.value;
                    {
...
void stmt_transpile_typed_field_set(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_821 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        if (_mv_821.has_value) {
            __auto_type target_expr = _mv_821.value;
            __auto_type _mv_822 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_822.has_value) {
                __auto_type field_expr = _mv_822.value;
                __auto_type _mv_823 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_823.has_value) {
                    __auto_type type_expr = _mv_823.value;
                    __auto_type _mv_824 = ({ __auto_type _lst = items; size_t _idx = (size_t)4; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_824.has_value) {
                        __auto_type value_expr = _mv_824.value;
                        {
                            __auto_type field_name = stmt_get_symbol_name(arena, field_expr);
                            __auto_type c_type = ctype_to_c_type(arena, type_expr);
                            {
                                ...
                                if (strlib_starts_with(c_type, SLOP_STR("slop_option_"))) {
                                    if (stmt_is_none_form(value_expr)) {
                                        ...
                                        __auto_type _mv_825 = stmt_get_some_value(value_expr);
                                        if (_mv_825.has_value) {
                                            __auto_type inner_val = _mv_825.value;
                                            {
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_826.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    __auto_type _mv_827 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_827.has_value) {
                        __auto_type head = _mv_827.value;
                        __auto_type _mv_828 = (*head);
                        switch (_mv_828.tag) {
                            case types_SExpr_sym:
                            {
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_829.data.lst;
            {
                ...
                if (_mv_830.has_value) {
                    __auto_type inner = _mv_830.value;
                    return inner;
            ...
            __auto_type lst = _mv_832.data.lst;
            {
                ...
                while ((i < len)) {
                    ...
                    if (_mv_833.has_value) {
                        __auto_type body_expr = _mv_833.value;
                        {
                            __auto_type is_last = (i == (len - 1));
                            stmt_transpile_stmt(ctx, body_expr, (is_return && is_last));
                        }
                ...
                if ((len < 2)) {
                ...
                } else {
                    {
                        ...
                        if ((is_named && (len < 4))) {
                            ...
                            context_ctx_indent(ctx);
                            context_ctx_push_scope(ctx);
                            __auto_type _mv_835 = ({ __auto_type _lst = items; size_t _idx = (size_t)size_idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_835.has_value) {
                                __auto_type size_expr = _mv_835.value;
                                {
            ...
            __auto_type lst = _mv_837.data.lst;
            {
                ...
                while ((i < len)) {
                    ...
                    if (_mv_838.has_value) {
                        __auto_type clause_expr = _mv_838.value;
                        __auto_type _mv_839 = (*clause_expr);
                        switch (_mv_839.tag) {
                            case types_SExpr_lst:
                            {
                                __auto_type clause_lst = _mv_839.data.lst;
                                {
                                    ...
                                    if ((clause_len < 1)) {
                                        ...
                                        __auto_type _mv_840 = ({ __auto_type _lst = clause_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_840.has_value) {
                                            __auto_type test_expr = _mv_840.value;
                                            __auto_type _mv_841 = (*test_expr);
                                            switch (_mv_841.tag) {
                                                case types_SExpr_sym:
                                                {
...
void stmt_transpile_cond_body(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items, int64_t start, uint8_t is_return) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = start;
        while ((i < len)) {
            __auto_type _mv_842 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_843.data.lst;
                {
                    ...
                    if ((len < 2)) {
                        ...
                        __auto_type _mv_844 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_844.has_value) {
                            __auto_type binding_expr = _mv_844.value;
                            __auto_type _mv_845 = (*binding_expr);
                            switch (_mv_845.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type binding_lst = _mv_845.data.lst;
                                    {
                                        ...
                                        if ((binding_len < 3)) {
                                            ...
                                            if (_mv_846.has_value) {
                                                __auto_type var_expr = _mv_846.value;
                                                __auto_type _mv_847 = (*var_expr);
                                                switch (_mv_847.tag) {
                                                    case types_SExpr_sym:
                                                    {
                                                        __auto_type var_sym = _mv_847.data.sym;
                                                        {
                                                            __auto_type var_name = ctype_to_c_name(arena, var_sym.name);
                                                            __auto_type _mv_848 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                            if (_mv_848.has_value) {
                                                                __auto_type start_expr = _mv_848.value;
                                                                __auto_type _mv_849 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                                if (_mv_849.has_value) {
                                                                    __auto_type end_expr = _mv_849.value;
                                                                    {
                                                                        ...
                                                                        context_ctx_bind_var(ctx, (context_VarEntry){var_sym.name, var_name, SLOP_STR("int64_t"), SLOP_STR(""), 0, 0, 0, SLOP_STR(""), SLOP_STR("")});
                                                                        {
                                                                            __auto_type i = 2;
                                                                            while ((i < len)) {
                                                                                __auto_type _mv_850 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        context_ctx_bind_var(ctx, (context_VarEntry){var_sym.name, var_name, key_c_type, key_slop_type, 0, 0, 0, SLOP_STR(""), SLOP_STR("")});
        {
            ...
            while ((i < len)) {
                ...
                if (_mv_852.has_value) {
                    __auto_type body_expr = _mv_852.value;
                    stmt_transpile_stmt(ctx, body_expr, 0);
...
void stmt_transpile_for_each_map_kv(context_TranspileContext* ctx, slop_list_types_SExpr_ptr binding_items, slop_list_types_SExpr_ptr items, int64_t len) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_853 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        if (_mv_853.has_value) {
            __auto_type kv_list_expr = _mv_853.value;
            __auto_type _mv_854 = (*kv_list_expr);
            switch (_mv_854.tag) {
                case types_SExpr_lst:
                {
                    __auto_type kv_lst = _mv_854.data.lst;
                    {
                        __auto_type kv_items = kv_lst.items;
                        if ((((int64_t)((kv_items).len)) < 2)) {
                            context_ctx_add_error(ctx, SLOP_STR("Map for-each needs ((k v) map)"));
                        } else {
                            __auto_type _mv_855 = ({ __auto_type _lst = kv_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_855.has_value) {
                                __auto_type k_expr = _mv_855.value;
                                __auto_type _mv_856 = ({ __auto_type _lst = kv_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_856.has_value) {
                                    __auto_type v_expr = _mv_856.value;
                                    __auto_type _mv_857 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    if (_mv_857.has_value) {
                                        __auto_type map_expr = _mv_857.value;
                                        __auto_type _mv_858 = (*k_expr);
                                        switch (_mv_858.tag) {
                                            case types_SExpr_sym:
                                            {
                                                __auto_type k_sym = _mv_858.data.sym;
                                                __auto_type _mv_859 = (*v_expr);
                                                switch (_mv_859.tag) {
                                                    case types_SExpr_sym:
                                                    {
                                                        __auto_type v_sym = _mv_859.data.sym;
                                                        {
                                ...
                                case types_SExpr_lst:
                                {
                                    __auto_type binding_lst = _mv_863.data.lst;
                                    {
                                        ...
                                        if ((binding_len < 2)) {
                                            ...
                                            __auto_type _mv_864 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_864.has_value) {
                                                ...
                                                switch (_mv_865.tag) {
                                                    ...
                                                    case types_SExpr_sym:
                                                    {
                                                        ...
                                                        {
                                                            __auto_type var_name = ctype_to_c_name(arena, var_sym.name);
                                                            __auto_type _mv_866 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                                            ...
                                                                            }
                                                                            {
                                                                                ...
                                                                                while ((i < len)) {
                                                                                    ...
                                                                                    if (_mv_867.has_value) {
                                                                                        __auto_type body_expr = _mv_867.value;
                                                                                        stmt_transpile_stmt(ctx, body_expr, 0);
            ...
            __auto_type lst = _mv_868.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    if (_mv_869.has_value) {
                        __auto_type head_expr = _mv_869.value;
                        __auto_type _mv_870 = (*head_expr);
                        switch (_mv_870.tag) {
                            case types_SExpr_sym:
                            {
                                    ...
                                    if ((string_eq(op, SLOP_STR("let")) || string_eq(op, SLOP_STR("let*")))) {
                                        ...
                                        if ((((int64_t)((items).len)) < 2)) {
                                            ...
                                            if (_mv_871.has_value) {
                                                __auto_type val_expr = _mv_871.value;
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_872.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    __auto_type _mv_873 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            ...
                            case types_SExpr_sym:
                            {
                                __auto_type sym = _mv_874.data.sym;
                                {
                                    ...
                                    if (string_eq(op, SLOP_STR("some"))) {
                                        __auto_type _mv_875 = context_ctx_get_current_return_type(ctx);
                                        if (_mv_875.has_value) {
                                            __auto_type ret_type = _mv_875.value;
                                            if (strlib_starts_with(ret_type, SLOP_STR("slop_option_"))) {
                                                if ((((int64_t)((items).len)) < 2)) {
                                                    stmt_emit_return_with_typed_none(ctx, expr_transpile_expr(ctx, expr));
                                                } else {
                                                    __auto_type _mv_876 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_876.has_value) {
                                                        __auto_type inner_expr = _mv_876.value;
                                                        {
                                                            __auto_type inner_c = expr_transpile_expr(ctx, inner_expr);
                                        ...
                                        __auto_type _mv_877 = context_ctx_get_current_return_type(ctx);
                                        if (_mv_877.has_value) {
                                            __auto_type ret_type = _mv_877.value;
                                            if (strlib_starts_with(ret_type, SLOP_STR("slop_option_"))) {
...
void stmt_emit_return_with_typed_none(context_TranspileContext* ctx, slop_string code) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (string_eq(code, SLOP_STR("none"))) {
            __auto_type _mv_878 = context_ctx_get_current_return_type(ctx);
            if (_mv_878.has_value) {
                __auto_type ret_type = _mv_878.value;
                if (strlib_starts_with(ret_type, SLOP_STR("slop_option_"))) {
            ...
            if (_mv_879.has_value) {
                ...
                if (strlib_starts_with(ret_type, SLOP_STR("slop_option_"))) {
                    __auto_type _mv_880 = context_ctx_lookup_var(ctx, code);
                    if (_mv_880.has_value) {
                        __auto_type var_entry = _mv_880.value;
                        {
