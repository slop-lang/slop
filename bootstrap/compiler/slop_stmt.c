            ...
            __auto_type lst = _mv_804.data.lst;
            {
                ...
                while (i < len) {
                    ...
                    if (_mv_805.has_value) {
                        __auto_type item_expr = _mv_805.value;
                        {
                ...
                __auto_type lst = _mv_806.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) >= 3) {
                        ...
                        if (_mv_807.has_value) {
                            __auto_type head_ptr = _mv_807.value;
                            __auto_type _mv_808 = (*head_ptr);
                            switch (_mv_808.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type head_sym = _mv_808.data.sym;
                                    {
                                        ...
                                        if (string_eq(op, SLOP_STR("arena-alloc"))) {
                                            ...
                                            if (_mv_809.has_value) {
                                                __auto_type size_expr = _mv_809.value;
                                            ...
                                            __auto_type _mv_810 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_810.has_value) {
                                                __auto_type inner_expr = _mv_810.value;
        ...
        switch (_mv_811.tag) {
            case types_SExpr_sym:
            {
                __auto_type sym = _mv_811.data.sym;
                {
                    ...
                    __auto_type _mv_812 = context_ctx_lookup_type(ctx, type_name);
                    if (_mv_812.has_value) {
                        __auto_type entry = _mv_812.value;
                ...
                __auto_type lst = _mv_811.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) >= 2) {
                        ...
                        if (_mv_813.has_value) {
                            __auto_type head_ptr = _mv_813.value;
                            __auto_type _mv_814 = (*head_ptr);
                            switch (_mv_814.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type head_sym = _mv_814.data.sym;
                                    if (string_eq(head_sym.name, SLOP_STR("sizeof"))) {
                                        __auto_type _mv_815 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_815.has_value) {
                                            __auto_type type_expr = _mv_815.value;
                                            {
            ...
            __auto_type lst = _mv_816.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 1) {
                    ...
                    if (_mv_817.has_value) {
                        __auto_type head_expr = _mv_817.value;
                        __auto_type _mv_818 = (*head_expr);
                        switch (_mv_818.tag) {
                            case types_SExpr_sym:
                            {
                ...
                __auto_type lst = _mv_819.data.lst;
                {
                    ...
                    if (len < 2) {
                        ...
                        if (_mv_820.has_value) {
                            __auto_type bindings_expr = _mv_820.value;
                            __auto_type _mv_821 = (*bindings_expr);
                            switch (_mv_821.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type bindings_lst = _mv_821.data.lst;
...
void stmt_transpile_bindings(context_TranspileContext* ctx, slop_list_types_SExpr_ptr bindings) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_823 = ({ __auto_type _lst = bindings; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void stmt_transpile_single_binding(context_TranspileContext* ctx, types_SExpr* binding) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_824 = (*binding);
        switch (_mv_824.tag) {
            case types_SExpr_lst:
            {
                __auto_type binding_lst = _mv_824.data.lst;
                {
                    ...
                    __auto_type len = ((int64_t)((items).len));
                    {
                        ...
                        if ((len - start_idx) < 2) {
                            ...
                            __auto_type _mv_825 = ({ __auto_type _lst = items; size_t _idx = (size_t)start_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_825.has_value) {
                                __auto_type name_expr = _mv_825.value;
                                __auto_type _mv_826 = (*name_expr);
                                switch (_mv_826.tag) {
                                    case types_SExpr_sym:
                                    {
                                        __auto_type name_sym = _mv_826.data.sym;
                                        {
                                            __auto_type raw_name = name_sym.name;
                                            __auto_type var_name = ctype_to_c_name(arena, raw_name);
                                            if ((len - start_idx) >= 3) {
                                                __auto_type _mv_827 = ({ __auto_type _lst = items; size_t _idx = (size_t)(start_idx + 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_827.has_value) {
                                                    __auto_type type_expr = _mv_827.value;
                                                    __auto_type _mv_828 = ({ __auto_type _lst = items; size_t _idx = (size_t)(start_idx + 2); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                ...
                                                __auto_type _mv_829 = ({ __auto_type _lst = items; size_t _idx = (size_t)(start_idx + 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_829.has_value) {
                                                    __auto_type init_expr = _mv_829.value;
                                                    {
                                                        ...
                                                        __auto_type _mv_830 = ptr_type_opt;
                                                        if (_mv_830.has_value) {
                                                            __auto_type ptr_type = _mv_830.value;
...
uint8_t stmt_binding_has_mut(slop_list_types_SExpr_ptr items) {
    if (((int64_t)((items).len)) < 1) {
        ...
        if (_mv_831.has_value) {
            __auto_type first = _mv_831.value;
            __auto_type _mv_832 = (*first);
            switch (_mv_832.tag) {
                case types_SExpr_sym:
                {
                    ...
                    if (_mv_841.has_value) {
                        __auto_type cond_expr = _mv_841.value;
                        {
                            ...
                            if (_mv_842.has_value) {
                                __auto_type then_expr = _mv_842.value;
                            ...
                            if (len >= 4) {
                                ...
                                context_ctx_indent(ctx);
                                __auto_type _mv_843 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_843.has_value) {
                                    __auto_type else_expr = _mv_843.value;
                            ...
                            context_ctx_indent(ctx);
                            {
                                ...
                                while (i < len) {
                                    ...
                                    if (_mv_849.has_value) {
                                        __auto_type body_expr = _mv_849.value;
                                        stmt_transpile_stmt(ctx, body_expr, 0);
                ...
                __auto_type lst = _mv_850.data.lst;
                {
                    ...
                    if (expr_set_is_self_assign(items)) {
                        ...
                        if (_mv_851.has_value) {
                            __auto_type target_expr = _mv_851.value;
                            __auto_type _mv_852 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_852.has_value) {
                                __auto_type value_expr = _mv_852.value;
                                {
                                    ...
                                    __auto_type _mv_853 = target_type_opt;
                                    if (_mv_853.has_value) {
                                        __auto_type target_type = _mv_853.value;
                                        if (strlib_starts_with(target_type, SLOP_STR("slop_option_"))) {
                                            {
                                                ...
                                                if (_mv_854.has_value) {
                                                    __auto_type val_expr = _mv_854.value;
                                                    {
                                    ...
                                    } else if (!_mv_853.has_value) {
                                        {
                                            ...
                                            if (_mv_855.has_value) {
                                                ...
                                                if (stmt_is_none_form(value_expr)) {
                                                    __auto_type _mv_856 = context_ctx_get_current_return_type(ctx);
                                                    if (_mv_856.has_value) {
                                                        __auto_type ret_type = _mv_856.value;
...
slop_option_string stmt_get_var_c_type(context_TranspileContext* ctx, types_SExpr* expr) {
    ...
    switch (_mv_857.tag) {
        case types_SExpr_sym:
        {
            ...
            {
                __auto_type name = sym.name;
                __auto_type _mv_858 = context_ctx_lookup_var(ctx, name);
                if (_mv_858.has_value) {
                    __auto_type var_entry = _mv_858.value;
...
uint8_t stmt_is_pointer_target(context_TranspileContext* ctx, types_SExpr* expr) {
    ...
    switch (_mv_859.tag) {
        case types_SExpr_sym:
        {
            ...
            {
                __auto_type name = sym.name;
                __auto_type _mv_860 = context_ctx_lookup_var(ctx, name);
                if (_mv_860.has_value) {
                    __auto_type var_entry = _mv_860.value;
...
void stmt_transpile_typed_field_set(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (_mv_864.has_value) {
            __auto_type target_expr = _mv_864.value;
            ...
            if (_mv_865.has_value) {
                __auto_type field_expr = _mv_865.value;
                ...
                if (_mv_866.has_value) {
                    __auto_type type_expr = _mv_866.value;
                    __auto_type _mv_867 = ({ __auto_type _lst = items; size_t _idx = (size_t)4; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            ...
                            __auto_type c_type = ctype_to_c_type(arena, type_expr);
                            {
                                ...
                                if (strlib_starts_with(c_type, SLOP_STR("slop_option_"))) {
                                    if (stmt_is_none_form(value_expr)) {
                                        ...
                                        __auto_type _mv_868 = stmt_get_some_value(value_expr);
                                        if (_mv_868.has_value) {
                                            __auto_type inner_val = _mv_868.value;
                                            {
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_869.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 1) {
                    ...
                    __auto_type _mv_870 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_870.has_value) {
                        __auto_type head = _mv_870.value;
                        __auto_type _mv_871 = (*head);
                        switch (_mv_871.tag) {
                            case types_SExpr_sym:
                            {
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_872.data.lst;
            {
                ...
                if (_mv_873.has_value) {
                    __auto_type inner = _mv_873.value;
                    return inner;
                ...
                if (len < 2) {
                ...
                } else {
                    {
                        ...
                        if (is_named && (len < 4)) {
                            ...
                            context_ctx_indent(ctx);
                            context_ctx_push_scope(ctx);
                            __auto_type _mv_878 = ({ __auto_type _lst = items; size_t _idx = (size_t)size_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_878.has_value) {
                                __auto_type size_expr = _mv_878.value;
                                {
                            ...
                            context_ctx_bind_var(ctx, (context_VarEntry){arena_name, c_arena_name, SLOP_STR("slop_arena*"), SLOP_STR(""), 1, 0, 0, SLOP_STR(""), SLOP_STR("")});
                            {
                                ...
                                while (i < len) {
                                    __auto_type _mv_879 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    if (_mv_879.has_value) {
                                        __auto_type body_expr = _mv_879.value;
                                        {
                                            __auto_type is_last = (i == (len - 1));
                                            stmt_transpile_stmt(ctx, body_expr, (is_return && is_last));
                                        }
            ...
            __auto_type lst = _mv_880.data.lst;
            {
                ...
                while (i < len) {
                    ...
                    if (_mv_881.has_value) {
                        __auto_type clause_expr = _mv_881.value;
                        __auto_type _mv_882 = (*clause_expr);
                        switch (_mv_882.tag) {
                            case types_SExpr_lst:
                            {
                                __auto_type clause_lst = _mv_882.data.lst;
                                {
                                    ...
                                    if (clause_len < 1) {
                                        ...
                                        __auto_type _mv_883 = ({ __auto_type _lst = clause_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_883.has_value) {
                                            __auto_type test_expr = _mv_883.value;
                                            __auto_type _mv_884 = (*test_expr);
                                            switch (_mv_884.tag) {
                                                case types_SExpr_sym:
                                                {
                                    ...
                                    __auto_type binding_lst = _mv_888.data.lst;
                                    {
                                        ...
                                        if (binding_len < 3) {
                                            ...
                                            if (_mv_889.has_value) {
                                                __auto_type var_expr = _mv_889.value;
                                                __auto_type _mv_890 = (*var_expr);
                                                switch (_mv_890.tag) {
                                                    case types_SExpr_sym:
                                                    {
                                                        __auto_type var_sym = _mv_890.data.sym;
                                                        {
                                                            ...
                                                            if (_mv_891.has_value) {
                                                                __auto_type start_expr = _mv_891.value;
                                                                __auto_type _mv_892 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                                if (_mv_892.has_value) {
                                                                    __auto_type end_expr = _mv_892.value;
                                                                    {
...
void stmt_transpile_for_each_map_keys(context_TranspileContext* ctx, slop_string var_name, types_SExprSymbol var_sym, slop_string coll_c, slop_string resolved_type, slop_list_types_SExpr_ptr items, int64_t len) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        context_ctx_bind_var(ctx, (context_VarEntry){var_sym.name, var_name, key_c_type, key_slop_type, 0, 0, 0, SLOP_STR(""), SLOP_STR("")});
        {
            int64_t i = 2;
            while (i < len) {
                __auto_type _mv_895 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_895.has_value) {
                    __auto_type body_expr = _mv_895.value;
                    stmt_transpile_stmt(ctx, body_expr, 0);
...
void stmt_transpile_for_each_map_kv(context_TranspileContext* ctx, slop_list_types_SExpr_ptr binding_items, slop_list_types_SExpr_ptr items, int64_t len) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (_mv_896.has_value) {
            __auto_type kv_list_expr = _mv_896.value;
            __auto_type _mv_897 = (*kv_list_expr);
            switch (_mv_897.tag) {
                case types_SExpr_lst:
                {
                    __auto_type kv_lst = _mv_897.data.lst;
                    {
                        __auto_type kv_items = kv_lst.items;
                        if (((int64_t)((kv_items).len)) < 2) {
                            context_ctx_add_error(ctx, SLOP_STR("Map for-each needs ((k v) map)"));
                        } else {
                            __auto_type _mv_898 = ({ __auto_type _lst = kv_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_898.has_value) {
                                __auto_type k_expr = _mv_898.value;
                                __auto_type _mv_899 = ({ __auto_type _lst = kv_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_899.has_value) {
                                    __auto_type v_expr = _mv_899.value;
                                    ...
                                    if (_mv_900.has_value) {
                                        __auto_type map_expr = _mv_900.value;
                                        __auto_type _mv_901 = (*k_expr);
                                        switch (_mv_901.tag) {
                                            case types_SExpr_sym:
                                            {
                                                __auto_type k_sym = _mv_901.data.sym;
                                                __auto_type _mv_902 = (*v_expr);
                                                switch (_mv_902.tag) {
                                                    case types_SExpr_sym:
                                                    {
                                                        __auto_type v_sym = _mv_902.data.sym;
                                                        {
                ...
                __auto_type lst = _mv_904.data.lst;
                {
                    ...
                    if (len < 2) {
                        ...
                        if (_mv_905.has_value) {
                            __auto_type binding_expr = _mv_905.value;
                            __auto_type _mv_906 = (*binding_expr);
                            switch (_mv_906.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type binding_lst = _mv_906.data.lst;
                                    {
                                        __auto_type binding_items = binding_lst.items;
                                        __auto_type binding_len = ((int64_t)((binding_items).len));
                                        if (binding_len < 2) {
                                            ...
                                            __auto_type _mv_907 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_907.has_value) {
                                                __auto_type first_elem = _mv_907.value;
                                                __auto_type _mv_908 = (*first_elem);
                                                switch (_mv_908.tag) {
                                                    case types_SExpr_lst:
                                                    {
                                                    ...
                                                    case types_SExpr_sym:
                                                    {
                                                        __auto_type var_sym = _mv_908.data.sym;
                                                        {
                                                            __auto_type var_name = ctype_to_c_name(arena, var_sym.name);
                                                            ...
                                                            if (_mv_909.has_value) {
                                                                __auto_type coll_expr = _mv_909.value;
                                                                {
            ...
            __auto_type lst = _mv_911.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 1) {
                    ...
                    if (_mv_912.has_value) {
                        __auto_type head_expr = _mv_912.value;
                        __auto_type _mv_913 = (*head_expr);
                        switch (_mv_913.tag) {
                            case types_SExpr_sym:
                            {
                                    ...
                                    if (string_eq(op, SLOP_STR("let")) || string_eq(op, SLOP_STR("let*"))) {
                                        ...
                                        if (((int64_t)((items).len)) < 2) {
                                            ...
                                            if (_mv_914.has_value) {
                                                __auto_type val_expr = _mv_914.value;
                                            ...
                                            if (strlib_starts_with(ret_type, SLOP_STR("slop_option_"))) {
                                                if (((int64_t)((items).len)) < 2) {
                                                    ...
                                                    if (_mv_919.has_value) {
                                                        __auto_type inner_expr = _mv_919.value;
                                                        {
                                                            __auto_type inner_c = expr_transpile_expr(ctx, inner_expr);
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (string_eq(code, SLOP_STR("none"))) {
            ...
            if (_mv_922.has_value) {
                ...
                if (strlib_starts_with(ret_type, SLOP_STR("slop_option_"))) {
                    __auto_type _mv_923 = context_ctx_lookup_var(ctx, code);
                    if (_mv_923.has_value) {
                        __auto_type var_entry = _mv_923.value;
                        {
