                    ...
                    if (string_eq(op, SLOP_STR("list-get"))) {
                    ...
                    } else {
                        {
                            ...
                            if (_mv_1753.has_value) {
                                ...
                                __auto_type _mv_1754 = infer_env_lookup_callable(env, op);
...
slop_option_types_ResolvedType_ptr infer_env_lookup_callable(env_TypeEnv* env, slop_string name) {
    SLOP_PRE(((env != NULL)), "(!= env nil)");
    __auto_type _mv_1757 = env_env_lookup_var(env, name);
    if (_mv_1757.has_value) {
        __auto_type var_type = _mv_1757.value;
...
void infer_check_list_operands(env_TypeEnv* env, slop_string op, slop_list_types_SExpr_ptr items, uint8_t has_index, int64_t line, int64_t col) {
    SLOP_PRE(((env != NULL)), "(!= env nil)");
    __auto_type _mv_1758 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    if (_mv_1758.has_value) {
        __auto_type list_arg = _mv_1758.value;
        {
            __auto_type list_type = infer_infer_expr(env, list_arg);
            ...
            } else {
                {
                    ...
                    if (has_index) {
                        ...
                        if (_mv_1759.has_value) {
                            __auto_type idx_arg = _mv_1759.value;
                            {
                    ...
                    __auto_type _mv_1760 = (*list_type).inner_type;
                    if (_mv_1760.has_value) {
                        __auto_type elem_type = _mv_1760.value;
                        __auto_type _mv_1761 = ({ __auto_type _lst = items; size_t _idx = (size_t)elem_index; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_1761.has_value) {
                            __auto_type value_arg = _mv_1761.value;
                            {
    ...
    SLOP_PRE(((t != NULL)), "(!= t nil)");
    {
        ...
        while (!(done) && (steps < 64)) {
            if (((*cur).kind == types_ResolvedTypeKind_rk_primitive) && !(strlib_ends_with((*cur).c_name, SLOP_STR("*")))) {
                __auto_type _mv_1764 = (*cur).inner_type;
                if (_mv_1764.has_value) {
                    __auto_type next = _mv_1764.value;
                    cur = next;
                    steps = (steps + 1);
...
void infer_check_option_predicate_arg(env_TypeEnv* env, slop_string op, slop_list_types_SExpr_ptr items, int64_t len, int64_t line, int64_t col) {
    ...
    if (len >= 2) {
        ...
        if (_mv_1765.has_value) {
            __auto_type arg = _mv_1765.value;
            {
    ...
    SLOP_PRE(((env != NULL)), "(!= env nil)");
    {
        ...
        if (len < 3) {
            ...
            if (!_mv_1768.has_value) {
                ...
                __auto_type obj_expr = _mv_1768.value;
                {
                    __auto_type obj_type = infer_infer_expr(env, obj_expr);
                    __auto_type _mv_1769 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (!_mv_1769.has_value) {
                        return env_env_get_unit_type(env);
                    } else if (_mv_1769.has_value) {
                        __auto_type field_expr = _mv_1769.value;
                        __auto_type _mv_1770 = (*field_expr);
                        switch (_mv_1770.tag) {
                            case types_SExpr_sym:
                            {
                                __auto_type field_sym = _mv_1770.data.sym;
                                {
    ...
    SLOP_PRE(((obj_type != NULL)), "(!= obj-type nil)");
    {
        ...
        if (infer_type_is_null_pointer(obj_type)) {
            ...
            if (types_resolved_type_is_record(obj_type)) {
                __auto_type _mv_1771 = types_resolved_type_get_field_type(obj_type, field_name);
                if (_mv_1771.has_value) {
                    __auto_type field_type = _mv_1771.value;
                    return field_type;
                    ...
                    if (string_eq(type_name, SLOP_STR("String"))) {
                        ...
                        if (string_eq(type_name, SLOP_STR("Unknown"))) {
                            ...
                            if (types_resolved_type_is_pointer(obj_type)) {
                                __auto_type _mv_1772 = (*obj_type).inner_type;
                                if (_mv_1772.has_value) {
                                    __auto_type inner_type = _mv_1772.value;
                        ...
                        __auto_type clause_lst = _mv_1774.data.lst;
                        {
                            ...
                            if (clause_len > 1) {
                                for (int64_t ci = 0; ci < (clause_len - 1); ci++) {
                                    __auto_type _mv_1775 = ({ __auto_type _lst = clause_items; size_t _idx = (size_t)ci; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    if (_mv_1775.has_value) {
                                        __auto_type clause_elem = _mv_1775.value;
                                        {
                                ...
                                __auto_type _mv_1776 = ({ __auto_type _lst = clause_items; size_t _idx = (size_t)(clause_len - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1776.has_value) {
                                    __auto_type body = _mv_1776.value;
                                    {
...
void infer_bind_match_pattern(env_TypeEnv* env, types_ResolvedType* scrutinee_type, types_SExpr* pattern) {
    ...
    if (parser_sexpr_is_list(pattern)) {
        if (parser_sexpr_list_len(pattern) > 0) {
            __auto_type _mv_1777 = parser_sexpr_list_get(pattern, 0);
            if (_mv_1777.has_value) {
                __auto_type variant_expr = _mv_1777.value;
                {
                    __auto_type variant_name = parser_sexpr_get_symbol_name(variant_expr);
                    if (!(string_eq(variant_name, SLOP_STR("")))) {
                        if (parser_sexpr_list_len(pattern) > 1) {
                            __auto_type _mv_1778 = parser_sexpr_list_get(pattern, 1);
                            if (_mv_1778.has_value) {
                                __auto_type binding_expr = _mv_1778.value;
                                {
                                    ...
                                    if (!(string_eq(binding_name, SLOP_STR("")))) {
                                        {
                                            ...
                                            if (string_eq(scrutinee_name, SLOP_STR("T"))) {
                                                ...
                                                if ((scrutinee_kind == types_ResolvedTypeKind_rk_option) && string_eq(variant_name, SLOP_STR("some"))) {
                                                    __auto_type _mv_1779 = (*scrutinee_type).inner_type;
                                                    if (_mv_1779.has_value) {
                                                        __auto_type inner = _mv_1779.value;
                                                    ...
                                                    if (scrutinee_kind == types_ResolvedTypeKind_rk_result) {
                                                        if (string_eq(variant_name, SLOP_STR("ok"))) {
                                                            ...
                                                            __auto_type _mv_1781 = (*scrutinee_type).inner_type2;
                                                            if (_mv_1781.has_value) {
                                                                __auto_type inner2 = _mv_1781.value;
                                                    ...
                                                    } else {
                                                        {
                                                            ...
                                                            if (((int64_t)((payload_types).len)) > 0) {
                                                                if (!(string_eq(binding_name, SLOP_STR("true"))) && !(string_eq(binding_name, SLOP_STR("false")))) {
                                                                    __auto_type _mv_1782 = ({ __auto_type _lst = payload_types; size_t _idx = (size_t)0; slop_option_types_ResolvedType_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                                    if (_mv_1782.has_value) {
                                                                        __auto_type first_type = _mv_1782.value;
                                                                ...
                                                                }
                                                                {
                                                                    ...
                                                                    for (int64_t pi = 2; pi < pat_len; pi++) {
                                                                        __auto_type _mv_1783 = parser_sexpr_list_get(pattern, pi);
                                                                        if (_mv_1783.has_value) {
                                                                            __auto_type extra_binding = _mv_1783.value;
                                                                            {
                                                                                ...
                                                                                if ((!(string_eq(extra_name, SLOP_STR("")))) && (!(string_eq(extra_name, SLOP_STR("_")))) && (!(string_eq(extra_name, SLOP_STR("true")))) && (!(string_eq(extra_name, SLOP_STR("false"))))) {
                                                                                    {
                                                                                        ...
                                                                                        if (type_idx < num_types) {
                                                                                            __auto_type _mv_1784 = ({ __auto_type _lst = payload_types; size_t _idx = (size_t)type_idx; slop_option_types_ResolvedType_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                                                            if (_mv_1784.has_value) {
                                                                                                __auto_type pt = _mv_1784.value;
    ...
    if (parser_sexpr_is_list(pattern)) {
        if (parser_sexpr_list_len(pattern) > 0) {
            ...
            if (_mv_1785.has_value) {
                __auto_type head = _mv_1785.value;
...
uint8_t infer_string_list_contains(slop_list_string names, slop_string name) {
    {
        ...
        uint8_t found = 0;
        while ((i < n) && !(found)) {
            __auto_type _mv_1786 = ({ __auto_type _lst = names; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1786.has_value) {
                __auto_type existing = _mv_1786.value;
        ...
        if ((kind == types_ResolvedTypeKind_rk_union) || (kind == types_ResolvedTypeKind_rk_enum)) {
            {
                ...
                int64_t i = 0;
                while (i < n) {
                    __auto_type _mv_1787 = ({ __auto_type _lst = variants; size_t _idx = (size_t)i; slop_option_types_ResolvedVariant _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_1787.has_value) {
                        __auto_type v = _mv_1787.value;
            ...
            if ((((int64_t)((expected).len)) > 0) && !(string_eq(type_name, SLOP_STR("T")))) {
                {
                    ...
                    while (i < n) {
                        __auto_type _mv_1788 = ({ __auto_type _lst = covered; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_1788.has_value) {
                            __auto_type head = _mv_1788.value;
                    ...
                    if (all_known) {
                        {
                            ...
                            int64_t j = 0;
                            while (j < e_len) {
                                __auto_type _mv_1789 = ({ __auto_type _lst = expected; size_t _idx = (size_t)j; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1789.has_value) {
                                    __auto_type want = _mv_1789.value;
                ...
                switch (_mv_1791.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type clause_lst = _mv_1791.data.lst;
                        {
                            ...
                            __auto_type clause_len = ((int64_t)((clause_items).len));
                            if (clause_len > 0) {
                                __auto_type _mv_1792 = ({ __auto_type _lst = clause_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1792.has_value) {
                                    __auto_type pattern = _mv_1792.value;
                                    {
                            ...
                            if (clause_len > 1) {
                                ...
                                for (int64_t bi = 1; bi < (clause_len - 1); bi++) {
                                    __auto_type _mv_1794 = ({ __auto_type _lst = clause_items; size_t _idx = (size_t)bi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    if (_mv_1794.has_value) {
                                        __auto_type body_expr = _mv_1794.value;
                                        {
                                            __auto_type _ = infer_infer_expr(env, body_expr);
                                        }
...
void infer_check_return_type(env_TypeEnv* env, types_SExpr* fn_form, slop_string fn_name, types_ResolvedType* inferred_type, int64_t fn_line, int64_t fn_col) {
    ...
    __auto_type _mv_1796 = (*fn_form);
    switch (_mv_1796.tag) {
        case types_SExpr_lst:
        {
            __auto_type fn_lst = _mv_1796.data.lst;
            {
                __auto_type items = fn_lst.items;
                __auto_type len = ((int64_t)((items).len));
                for (int64_t i = 3; i < len; i++) {
                    __auto_type _mv_1797 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_1797.has_value) {
                        __auto_type item = _mv_1797.value;
...
void infer_check_spec_return_type(env_TypeEnv* env, types_SExpr* spec_form, slop_string fn_name, types_ResolvedType* inferred_type, int64_t fn_line, int64_t fn_col) {
    ...
    __auto_type _mv_1798 = (*spec_form);
    switch (_mv_1798.tag) {
        case types_SExpr_lst:
        {
            __auto_type spec_lst = _mv_1798.data.lst;
            {
                __auto_type spec_items = spec_lst.items;
                __auto_type _mv_1799 = ({ __auto_type _lst = spec_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_1799.has_value) {
                    __auto_type spec_body = _mv_1799.value;
...
void infer_check_spec_body_return(env_TypeEnv* env, types_SExpr* spec_body, slop_string fn_name, types_ResolvedType* inferred_type, int64_t fn_line, int64_t fn_col) {
    ...
    __auto_type _mv_1800 = (*spec_body);
    switch (_mv_1800.tag) {
        case types_SExpr_lst:
        {
            __auto_type body_lst = _mv_1800.data.lst;
            {
                __auto_type body_items = body_lst.items;
                __auto_type body_len = ((int64_t)((body_items).len));
                __auto_type _mv_1801 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)(body_len - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_1801.has_value) {
                    __auto_type ret_expr = _mv_1801.value;
...
void infer_check_return_expr(env_TypeEnv* env, types_SExpr* ret_expr, slop_string fn_name, types_ResolvedType* inferred_type, int64_t fn_line, int64_t fn_col) {
    ...
    __auto_type _mv_1802 = (*ret_expr);
    switch (_mv_1802.tag) {
        case types_SExpr_sym:
        {
            __auto_type ret_sym = _mv_1802.data.sym;
            {
...
void infer_bind_param_from_form(env_TypeEnv* env, types_SExpr* param_form) {
    ...
    if (parser_sexpr_is_list(param_form) && (parser_sexpr_list_len(param_form) >= 2)) {
        __auto_type _mv_1803 = parser_sexpr_list_get(param_form, 0);
            ...
            __auto_type first_expr = _mv_1803.value;
            {
                ...
                if ((string_eq(first_name, SLOP_STR("in"))) || (string_eq(first_name, SLOP_STR("out"))) || (string_eq(first_name, SLOP_STR("mut")))) {
                    if (parser_sexpr_list_len(param_form) >= 3) {
                        __auto_type _mv_1804 = parser_sexpr_list_get(param_form, 1);
...
types_ResolvedType* infer_get_param_type_from_form(env_TypeEnv* env, types_SExpr* param_form) {
    ...
    SLOP_PRE(((param_form != NULL)), "(!= param-form nil)");
    {
        ...
        __auto_type _mv_1805 = parser_sexpr_list_get(param_form, type_pos);
...
types_ResolvedType* infer_resolve_complex_type_expr(env_TypeEnv* env, types_SExpr* type_expr) {
    ...
    __auto_type _mv_1806 = parser_sexpr_list_get(type_expr, 0);
    if (_mv_1806.has_value) {
        __auto_type head_expr = _mv_1806.value;
        {
            __auto_type head_name = parser_sexpr_get_symbol_name(head_expr);
            if (string_eq(head_name, SLOP_STR("Option"))) {
            ...
            } else if (string_eq(head_name, SLOP_STR("Result"))) {
                {
                    ...
                    if (parser_sexpr_list_len(type_expr) >= 2) {
                        __auto_type _mv_1808 = parser_sexpr_list_get(type_expr, 1);
                        if (_mv_1808.has_value) {
                            __auto_type ok_expr = _mv_1808.value;
                            {
                    ...
                    if (parser_sexpr_list_len(type_expr) >= 3) {
                        __auto_type _mv_1809 = parser_sexpr_list_get(type_expr, 2);
                        if (_mv_1809.has_value) {
                            __auto_type err_expr = _mv_1809.value;
                            {
                ...
                __auto_type _mv_1810 = env_env_lookup_type(env, head_name);
...
types_ResolvedType* infer_resolve_option_inner_type(env_TypeEnv* env, types_SExpr* type_expr) {
    ...
    if (parser_sexpr_list_len(type_expr) < 2) {
        ...
        __auto_type _mv_1811 = parser_sexpr_list_get(type_expr, 1);
        if (_mv_1811.has_value) {
            __auto_type inner_expr = _mv_1811.value;
            {
...
void infer_bind_let_binding(env_TypeEnv* env, types_SExpr* binding_form) {
    ...
    if (parser_sexpr_is_list(binding_form) && (parser_sexpr_list_len(binding_form) >= 2)) {
        __auto_type _mv_1815 = parser_sexpr_list_get(binding_form, 0);
        if (_mv_1815.has_value) {
            __auto_type first_expr = _mv_1815.value;
            {
                __auto_type first_name = parser_sexpr_get_symbol_name(first_expr);
                if (string_eq(first_name, SLOP_STR("mut"))) {
                    if (parser_sexpr_list_len(binding_form) >= 3) {
                        __auto_type _mv_1816 = parser_sexpr_list_get(binding_form, 1);
                                ...
                                if (!(string_eq(var_name, SLOP_STR("")))) {
                                    {
                                        ...
                                        __auto_type _mv_1817 = parser_sexpr_list_get(binding_form, (binding_len - 1));
                    ...
                    if (!(string_eq(first_name, SLOP_STR("")))) {
                        {
                            __auto_type binding_len = parser_sexpr_list_len(binding_form);
                            if (binding_len == 3) {
                                __auto_type _mv_1818 = parser_sexpr_list_get(binding_form, 2);
                                ...
                                __auto_type _mv_1819 = parser_sexpr_list_get(binding_form, 1);
...
types_ResolvedType* infer_infer_let_expr(env_TypeEnv* env, types_SExpr* expr) {
    ...
    env_env_push_scope(env);
    if (parser_sexpr_is_list(expr)) {
        __auto_type _mv_1820 = parser_sexpr_list_get(expr, 1);
        if (_mv_1820.has_value) {
            __auto_type bindings_expr = _mv_1820.value;
            if (parser_sexpr_is_list(bindings_expr)) {
                {
                    ...
                    for (int64_t i = 0; i < num_bindings; i++) {
                        __auto_type _mv_1821 = parser_sexpr_list_get(bindings_expr, i);
                        if (_mv_1821.has_value) {
                            __auto_type binding = _mv_1821.value;
        ...
        if (len < 2) {
        ...
        } else {
            {
                ...
                if (is_named && (len < 4)) {
                    ...
                    __auto_type _mv_1822 = parser_sexpr_list_get(expr, size_idx);
                    if (_mv_1822.has_value) {
                        __auto_type size_expr = _mv_1822.value;
                        __auto_type _mv_1823 = (*size_expr);
                        switch (_mv_1823.tag) {
                            case types_SExpr_num:
                            {
                                __auto_type num = _mv_1823.data.num;
                                if (num.int_value <= 0) {
                    ...
                    env_env_bind_var(env, arena_name, env_env_get_arena_type(env));
                    {
                        ...
                        for (int64_t i = body_start; i < len; i++) {
                            __auto_type _mv_1824 = parser_sexpr_list_get(expr, i);
                            if (_mv_1824.has_value) {
                                __auto_type body_expr = _mv_1824.value;
...
slop_string infer_get_fn_name(types_SExpr* fn_form) {
    ...
    if (!(parser_sexpr_is_list(fn_form))) {
        ...
        if (parser_sexpr_list_len(fn_form) < 2) {
            ...
            __auto_type _mv_1825 = parser_sexpr_list_get(fn_form, 1);
...
slop_string infer_get_hole_prompt(slop_list_types_SExpr_ptr items, int64_t len) {
    if (len < 3) {
        ...
        if (_mv_1828.has_value) {
            __auto_type prompt_expr = _mv_1828.value;
            __auto_type _mv_1829 = (*prompt_expr);
            switch (_mv_1829.tag) {
                case types_SExpr_str:
                {
                    __auto_type str = _mv_1829.data.str;
                    return str.value;
                }
                default: {
                    return SLOP_STR("(no description)");
...
uint8_t infer_is_c_name_related(slop_list_types_SExpr_ptr items, int64_t idx) {
    __auto_type _mv_1830 = ({ __auto_type _lst = items; size_t _idx = (size_t)idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    if (_mv_1830.has_value) {
        __auto_type item = _mv_1830.value;
        __auto_type _mv_1831 = (*item);
        switch (_mv_1831.tag) {
            case types_SExpr_sym:
            {
            ...
            case types_SExpr_str:
            {
                __auto_type _ = _mv_1831.data.str;
                if (idx > 0) {
                    __auto_type _mv_1832 = ({ __auto_type _lst = items; size_t _idx = (size_t)(idx - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_1832.has_value) {
                        __auto_type prev = _mv_1832.value;
                        __auto_type _mv_1833 = (*prev);
                        switch (_mv_1833.tag) {
                            case types_SExpr_sym:
                            {
...
uint8_t infer_is_checkable_annotation(types_SExpr* expr) {
    if (parser_sexpr_is_list(expr)) {
        __auto_type _mv_1836 = parser_sexpr_list_get(expr, 0);
        ...
        if (parser_sexpr_is_list(fn_form)) {
            {
                ...
                if (params_len > 2) {
                    __auto_type _mv_1838 = parser_sexpr_list_get(fn_form, 2);
                    if (_mv_1838.has_value) {
                        __auto_type params_expr = _mv_1838.value;
                        if (parser_sexpr_is_list(params_expr)) {
                            {
                                __auto_type num_params = parser_sexpr_list_len(params_expr);
                                for (int64_t k = 0; k < num_params; k++) {
                                    __auto_type _mv_1839 = parser_sexpr_list_get(params_expr, k);
                                    if (_mv_1839.has_value) {
                                        __auto_type param_form = _mv_1839.value;
                                        infer_bind_param_from_form(env, param_form);
    ...
    if (types_resolved_type_is_union(scrutinee_type)) {
        {
            ...
            for (int64_t i = 0; i < num_patterns; i++) {
                __auto_type _mv_1840 = ({ __auto_type _lst = patterns; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_1840.has_value) {
                    __auto_type pattern_case = _mv_1840.value;
                    __auto_type _mv_1841 = (*pattern_case);
                    switch (_mv_1841.tag) {
                        case types_SExpr_lst:
                        {
                            __auto_type pattern_list = _mv_1841.data.lst;
                            if (((int64_t)((pattern_list.items).len)) > 0) {
                                __auto_type _mv_1842 = ({ __auto_type _lst = pattern_list.items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1842.has_value) {
                                    __auto_type pattern_expr = _mv_1842.value;
                                    __auto_type _mv_1843 = (*pattern_expr);
                                    switch (_mv_1843.tag) {
                                        case types_SExpr_lst:
                                        {
                                            __auto_type variant_list = _mv_1843.data.lst;
                                            {
                                                __auto_type variant_items = variant_list.items;
                                                if (((int64_t)((variant_items).len)) > 0) {
                                                    __auto_type _mv_1844 = ({ __auto_type _lst = variant_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_1844.has_value) {
                                                        __auto_type variant_name_expr = _mv_1844.value;
                                                        __auto_type _mv_1845 = (*variant_name_expr);
                                                        switch (_mv_1845.tag) {
                                                            case types_SExpr_sym:
                                                            {
                                                                __auto_type variant_sym = _mv_1845.data.sym;
                                                                {
                                                                        ...
                                                                        if (num_pt > 0) {
                                                                            {
                                                                                ...
                                                                                for (int64_t vi = 1; vi < num_vt; vi++) {
                                                                                    __auto_type _mv_1846 = ({ __auto_type _lst = variant_items; size_t _idx = (size_t)vi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                                                    if (_mv_1846.has_value) {
                                                                                        __auto_type binding_expr = _mv_1846.value;
                                                                                        __auto_type _mv_1847 = (*binding_expr);
                                                                                        switch (_mv_1847.tag) {
                                                                                            case types_SExpr_sym:
                                                                                            {
                                                                                                __auto_type binding_sym = _mv_1847.data.sym;
                                                                                                {
                                                                                                    __auto_type bname = binding_sym.name;
                                                                                                    __auto_type type_idx = (vi - 1);
                                                                                                    if (!(string_eq(bname, SLOP_STR("_"))) && !(string_eq(bname, SLOP_STR("")))) {
                                                                                                        if (type_idx < num_pt) {
                                                                                                            __auto_type _mv_1848 = ({ __auto_type _lst = payload_types; size_t _idx = (size_t)type_idx; slop_option_types_ResolvedType_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                                                                            if (_mv_1848.has_value) {
                                                                                                                __auto_type pt = _mv_1848.value;
                                                                            ...
                                                                            __auto_type _mv_1849 = types_resolved_type_get_variant_index(scrutinee_type, variant_name);
                                                                            if (_mv_1849.has_value) {
                                                                                __auto_type _ = _mv_1849.value;
