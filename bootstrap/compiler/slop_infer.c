...
slop_option_types_ResolvedType_ptr infer_find_binding(slop_list_string bind_names, slop_list_types_ResolvedType_ptr bind_types, slop_string name) {
    {
        ...
        for (int64_t i = 0; i < len; i++) {
            __auto_type _mv_1624 = ({ __auto_type _lst = bind_names; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1624.has_value) {
                __auto_type bn = _mv_1624.value;
                if (string_eq(bn, name)) {
                    __auto_type _mv_1625 = ({ __auto_type _lst = bind_types; size_t _idx = (size_t)i; slop_option_types_ResolvedType_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_1625.has_value) {
                        __auto_type bt = _mv_1625.value;
        ...
        if (f_kind == types_ResolvedTypeKind_rk_typevar) {
            {
                ...
                __auto_type _mv_1626 = infer_find_binding(bind_names, bind_types, tv_name);
                if (_mv_1626.has_value) {
                    __auto_type existing = _mv_1626.value;
            ...
            if ((*actual).kind == types_ResolvedTypeKind_rk_result) {
                ...
                __auto_type _mv_1639 = (*formal).inner_type2;
                if (_mv_1639.has_value) {
                    __auto_type f_inner2 = _mv_1639.value;
                    __auto_type _mv_1640 = (*actual).inner_type2;
                    if (_mv_1640.has_value) {
                        __auto_type a_inner2 = _mv_1640.value;
        ...
        if (kind == types_ResolvedTypeKind_rk_typevar) {
            {
                ...
                __auto_type _mv_1641 = infer_find_binding(bind_names, bind_types, tv_name);
                if (_mv_1641.has_value) {
                    __auto_type bound = _mv_1641.value;
                    return bound;
        ...
        if (parser_sexpr_is_list(expr)) {
            {
                ...
                }
                {
                    ...
                    for (int64_t i = 0; i < limit; i++) {
                        __auto_type _mv_1647 = parser_sexpr_list_get(expr, (i + 1));
                        if (_mv_1647.has_value) {
                            __auto_type arg_expr = _mv_1647.value;
                            {
                                __auto_type actual_type = infer_infer_expr(env, arg_expr);
                                __auto_type _mv_1648 = ({ __auto_type _lst = params; size_t _idx = (size_t)i; slop_option_types_ParamInfo _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void infer_sexpr_set_resolved_type(types_SExpr* expr, types_ResolvedType* t) {
    ...
    switch (_mv_1651.tag) {
        ...
        {
            __auto_type str = _mv_1651.data.str;
        ...
        {
            __auto_type num = _mv_1651.data.num;
...
types_ResolvedType* infer_infer_expr_inner(env_TypeEnv* env, types_SExpr* expr) {
    ...
    SLOP_PRE(((expr != NULL)), "(!= expr nil)");
    {
        ...
        switch (_mv_1652.tag) {
            case types_SExpr_sym:
            {
                __auto_type sym = _mv_1652.data.sym;
                {
                    ...
                    if (string_eq(name, SLOP_STR("true")) || string_eq(name, SLOP_STR("false"))) {
                        ...
                        __auto_type _mv_1653 = env_env_lookup_var(env, name);
                        if (_mv_1653.has_value) {
                            __auto_type t = _mv_1653.value;
                            return t;
                        } else if (!_mv_1653.has_value) {
                            __auto_type _mv_1654 = env_env_lookup_constant(env, name);
                            if (_mv_1654.has_value) {
                                __auto_type t = _mv_1654.value;
                                return t;
                            } else if (!_mv_1654.has_value) {
                                __auto_type _mv_1655 = env_env_lookup_function(env, name);
                                if (_mv_1655.has_value) {
                                    __auto_type sig = _mv_1655.value;
                                    ...
                                    if (infer_string_contains_char(name, 46)) {
                                        {
                                            ...
                                            __auto_type _mv_1656 = env_env_lookup_var(env, base_name);
                                            if (_mv_1656.has_value) {
                                                __auto_type obj_type = _mv_1656.value;
                                                return infer_check_field_exists(env, obj_type, field_name, line, col);
                                            } else if (!_mv_1656.has_value) {
                                                __auto_type _mv_1657 = env_env_lookup_type(env, base_name);
                                                if (_mv_1657.has_value) {
                                                    __auto_type type_info = _mv_1657.value;
                                                    return type_info;
                                        ...
                                        __auto_type _mv_1658 = env_env_lookup_type(env, name);
                                        if (_mv_1658.has_value) {
                                            __auto_type type_info = _mv_1658.value;
                                            return type_info;
                                        } else if (!_mv_1658.has_value) {
                                            __auto_type _mv_1659 = env_env_lookup_variant(env, name);
                                            if (_mv_1659.has_value) {
                                                __auto_type enum_name = _mv_1659.value;
                                                __auto_type _mv_1660 = env_env_lookup_type(env, enum_name);
                                                if (_mv_1660.has_value) {
                                                    __auto_type t = _mv_1660.value;
                                                    return t;
            ...
            case types_SExpr_num:
            {
                __auto_type num = _mv_1652.data.num;
                return env_env_get_int_type(env);
            }
            case types_SExpr_str:
            {
                __auto_type str = _mv_1652.data.str;
    ...
    SLOP_PRE(((expr != NULL)), "(!= expr nil)");
    {
        ...
        if (len == 0) {
            ...
            if (!_mv_1661.has_value) {
                ...
                __auto_type head = _mv_1661.value;
                __auto_type _mv_1662 = (*head);
                switch (_mv_1662.tag) {
                    case types_SExpr_sym:
                    {
        ...
        if (string_eq(op, SLOP_STR("if"))) {
            if (len >= 4) {
                ...
                if (_mv_1663.has_value) {
                    __auto_type cond_expr = _mv_1663.value;
                    {
                ...
                if (_mv_1664.has_value) {
                    __auto_type then_expr = _mv_1664.value;
                    {
                        __auto_type then_type = infer_infer_expr(env, then_expr);
                        __auto_type _mv_1665 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_1665.has_value) {
                            __auto_type else_expr = _mv_1665.value;
                            {
            ...
            if (len > 1) {
                __auto_type _mv_1666 = ({ __auto_type _lst = items; size_t _idx = (size_t)(len - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_1666.has_value) {
                    __auto_type last = _mv_1666.value;
            ...
            if (len >= 2) {
                ...
                if (_mv_1667.has_value) {
                    __auto_type binding_form = _mv_1667.value;
                    if (parser_sexpr_is_list(binding_form)) {
                        {
                            __auto_type bind_len = parser_sexpr_list_len(binding_form);
                            if (bind_len >= 3) {
                                __auto_type _mv_1668 = parser_sexpr_list_get(binding_form, 0);
                                if (_mv_1668.has_value) {
                                    __auto_type var_expr = _mv_1668.value;
                                    {
                                        ...
                                        if (!(string_eq(var_name, SLOP_STR("")))) {
                                            ...
                                            __auto_type _mv_1669 = parser_sexpr_list_get(binding_form, 1);
                                            if (_mv_1669.has_value) {
                                                __auto_type start_expr = _mv_1669.value;
                                                {
                                                    __auto_type _ = infer_infer_expr(env, start_expr);
                                                }
                                            } else if (!_mv_1669.has_value) {
                                            }
                                            __auto_type _mv_1670 = parser_sexpr_list_get(binding_form, 2);
                                            if (_mv_1670.has_value) {
                                                __auto_type end_expr = _mv_1670.value;
                                                {
            ...
            if (len >= 3) {
                ...
                if (_mv_1672.has_value) {
                    __auto_type binding_form = _mv_1672.value;
                    if (parser_sexpr_is_list(binding_form)) {
                        {
                            __auto_type bind_len = parser_sexpr_list_len(binding_form);
                            if (bind_len >= 2) {
                                __auto_type _mv_1673 = parser_sexpr_list_get(binding_form, 0);
                                if (_mv_1673.has_value) {
                                    __auto_type var_expr = _mv_1673.value;
                                    {
                                        __auto_type var_name = parser_sexpr_get_symbol_name(var_expr);
                                        if (string_eq(var_name, SLOP_STR(""))) {
                                            return env_env_get_unit_type(env);
                                        } else {
                                            __auto_type _mv_1674 = parser_sexpr_list_get(binding_form, 1);
                                            if (_mv_1674.has_value) {
                                                __auto_type coll_expr = _mv_1674.value;
                                                {
                                                    ...
                                                    __auto_type coll_col = parser_sexpr_col(coll_expr);
                                                    {
                                                        ...
                                                        for (int64_t body_idx = 2; body_idx < len; body_idx++) {
                                                            __auto_type _mv_1675 = ({ __auto_type _lst = items; size_t _idx = (size_t)body_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            ...
            if (len >= 2) {
                ...
                if (_mv_1676.has_value) {
                    __auto_type params_expr = _mv_1676.value;
                    if (parser_sexpr_is_list(params_expr)) {
                        {
                            ...
                            for (int64_t k = 0; k < num_params; k++) {
                                __auto_type _mv_1677 = parser_sexpr_list_get(params_expr, k);
                                if (_mv_1677.has_value) {
                                    __auto_type param_form = _mv_1677.value;
            ...
            if (len >= 4) {
                ...
                if (_mv_1678.has_value) {
                    __auto_type val_expr = _mv_1678.value;
                    {
                ...
                __auto_type _mv_1679 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_1679.has_value) {
                    __auto_type val_expr = _mv_1679.value;
                    {
                        __auto_type _ = infer_infer_expr(env, val_expr);
                    }
            ...
            if (len >= 2) {
                ...
                if (_mv_1680.has_value) {
                    __auto_type ret_expr = _mv_1680.value;
                    {
            ...
            if (len >= 2) {
                ...
                if (_mv_1683.has_value) {
                    __auto_type inner_expr = _mv_1683.value;
                    {
            ...
            if (len >= 2) {
                ...
                if (_mv_1684.has_value) {
                    __auto_type type_expr = _mv_1684.value;
                    {
                        ...
                        if (string_eq(type_name, SLOP_STR(""))) {
                            if (parser_sexpr_is_list(type_expr)) {
                                __auto_type _mv_1685 = parser_sexpr_list_get(type_expr, 0);
                                if (_mv_1685.has_value) {
                                    __auto_type head_expr = _mv_1685.value;
                                    {
                ...
                if (_mv_1687.has_value) {
                    __auto_type variant_expr = _mv_1687.value;
                    {
                        ...
                        if (string_eq(variant_name, SLOP_STR(""))) {
                            ...
                            __auto_type _mv_1688 = env_env_lookup_variant(env, variant_name);
                            if (_mv_1688.has_value) {
                                __auto_type enum_name = _mv_1688.value;
                                __auto_type _mv_1689 = env_env_lookup_type(env, enum_name);
                                if (_mv_1689.has_value) {
                                    __auto_type enum_type = _mv_1689.value;
                                    return enum_type;
            ...
            if (len >= 2) {
                ...
                if (_mv_1690.has_value) {
                    __auto_type inner_expr = _mv_1690.value;
                    {
                        __auto_type inner_type = infer_infer_expr(env, inner_expr);
            ...
            for (int64_t fi = 2; fi < len; fi++) {
                __auto_type _mv_1691 = ({ __auto_type _lst = items; size_t _idx = (size_t)fi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_1691.has_value) {
                    __auto_type field_pair = _mv_1691.value;
                    if (parser_sexpr_is_list(field_pair) && (parser_sexpr_list_len(field_pair) >= 2)) {
                        __auto_type _mv_1692 = parser_sexpr_list_get(field_pair, 1);
            ...
            if (len >= 4) {
                __auto_type _mv_1695 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            ...
            __auto_type _mv_1698 = env_env_lookup_function(env, op);
            if (_mv_1698.has_value) {
                ...
                __auto_type _mv_1699 = env_env_lookup_type(env, op);
                if (_mv_1699.has_value) {
                    __auto_type the_type = _mv_1699.value;
                    return the_type;
                    ...
                    if (string_eq(op, SLOP_STR("list-get"))) {
                                ...
                                __auto_type type_expr = _mv_1702.value;
                                {
                                    ...
                                    if (string_eq(type_name, SLOP_STR(""))) {
                                        if (parser_sexpr_is_list(type_expr)) {
                                            ...
                                            if (_mv_1703.has_value) {
                                                ...
                                                if (string_eq(parser_sexpr_get_symbol_name(head_expr), SLOP_STR("sizeof"))) {
                                                    __auto_type _mv_1704 = parser_sexpr_list_get(type_expr, 1);
                                                    if (_mv_1704.has_value) {
                                                        __auto_type sizeof_type_expr = _mv_1704.value;
                                                        {
                                                            __auto_type sizeof_type_name = parser_sexpr_get_symbol_name(sizeof_type_expr);
                                                            if (string_eq(sizeof_type_name, SLOP_STR(""))) {
                                                                return env_env_get_int_type(env);
                                                            } else {
                                                                __auto_type _mv_1705 = env_env_lookup_type(env, sizeof_type_name);
                                                                if (_mv_1705.has_value) {
                                                                    __auto_type resolved = _mv_1705.value;
                                        ...
                                        if (_mv_1706.has_value) {
                                            __auto_type resolved = _mv_1706.value;
                                            return env_env_make_ptr_type(env, resolved);
                        ...
                        if (len >= 2) {
                            ...
                            if (_mv_1710.has_value) {
                                __auto_type ptr_expr = _mv_1710.value;
                                {
                                    __auto_type ptr_type = infer_infer_expr(env, ptr_expr);
                                    if (types_resolved_type_is_pointer(ptr_type)) {
                                        __auto_type _mv_1711 = (*ptr_type).inner_type;
                        ...
                        infer_check_builtin_args(env, SLOP_STR("map-new"), 3, (len - 1), line, col);
                        {
                            ...
                            if (len >= 4) {
                                __auto_type _mv_1714 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            ...
                            if (len >= 2) {
                                ...
                                if (_mv_1716.has_value) {
                                    __auto_type map_expr = _mv_1716.value;
                                    {
                                        ...
                                        __auto_type _mv_1717 = (*map_type).inner_type2;
                                        if (_mv_1717.has_value) {
                                            __auto_type inner = _mv_1717.value;
                                            val_type = inner;
                        ...
                        infer_check_builtin_args(env, SLOP_STR("map-keys"), 1, (len - 1), line, col);
                        {
                            ...
                            if (len >= 2) {
                                ...
                                if (_mv_1719.has_value) {
                                    ...
                                    {
                                        __auto_type map_type = infer_infer_expr(env, map_expr);
                                        __auto_type _mv_1720 = (*map_type).inner_type;
                        ...
                        infer_check_builtin_args(env, SLOP_STR("set-elements"), 1, (len - 1), line, col);
                        {
                            ...
                            if (len >= 2) {
                                ...
                                if (_mv_1723.has_value) {
                                    __auto_type set_expr = _mv_1723.value;
                                    {
                                        __auto_type set_type = infer_infer_expr(env, set_expr);
                                        __auto_type _mv_1724 = (*set_type).inner_type;
                        ...
                        {
                            __auto_type arena = env_env_arena(env);
                            __auto_type _mv_1725 = env_env_lookup_variant(env, op);
                            if (_mv_1725.has_value) {
                                __auto_type parent_type = _mv_1725.value;
                                {
                                ...
                                if (strlib_starts_with(op, SLOP_STR("set-")) || (strlib_starts_with(op, SLOP_STR("map-")) || (strlib_starts_with(op, SLOP_STR("list-")) || strlib_starts_with(op, SLOP_STR("arena-"))))) {
                                    ...
                                    __auto_type _mv_1726 = env_env_lookup_var(env, op);
                                    if (_mv_1726.has_value) {
                                        __auto_type var_type = _mv_1726.value;
                                        infer_infer_builtin_args(env, expr);
                                        return var_type;
...
void infer_check_single_arg(env_TypeEnv* env, types_FnSignature* sig, types_SExpr* expr, int64_t arg_idx, int64_t line, int64_t col) {
    ...
    SLOP_PRE(((sig != NULL)), "(!= sig nil)");
    {
        ...
        __auto_type fn_name = (*sig).name;
        __auto_type arena = env_env_arena(env);
        __auto_type _mv_1727 = ({ __auto_type _lst = params; size_t _idx = (size_t)arg_idx; slop_option_types_ParamInfo _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        if (_mv_1727.has_value) {
            __auto_type param_info = _mv_1727.value;
            {
                __auto_type expected_type = param_info.param_type;
                __auto_type _mv_1728 = parser_sexpr_list_get(expr, (arg_idx + 1));
                if (_mv_1728.has_value) {
                    __auto_type arg_expr = _mv_1728.value;
                    {
                        __auto_type actual_type = infer_infer_expr(env, arg_expr);
    ...
    if (parser_sexpr_is_list(expr)) {
        {
            ...
            for (int64_t i = 1; i < len; i++) {
                __auto_type _mv_1729 = parser_sexpr_list_get(expr, i);
                if (_mv_1729.has_value) {
                    __auto_type arg_expr = _mv_1729.value;
                    {
    ...
    if (parser_sexpr_is_list(expr)) {
        {
            ...
            for (int64_t i = start_idx; i < len; i++) {
                __auto_type _mv_1730 = parser_sexpr_list_get(expr, i);
                if (_mv_1730.has_value) {
                    __auto_type body_expr = _mv_1730.value;
                    {
                        __auto_type _ = infer_infer_expr(env, body_expr);
                    }
    ...
    SLOP_PRE(((env != NULL)), "(!= env nil)");
    {
        ...
        if (len < 3) {
            ...
            if (!_mv_1731.has_value) {
                ...
                __auto_type obj_expr = _mv_1731.value;
                {
                    __auto_type obj_type = infer_infer_expr(env, obj_expr);
                    __auto_type _mv_1732 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (!_mv_1732.has_value) {
                        return env_env_get_unit_type(env);
                    } else if (_mv_1732.has_value) {
                        __auto_type field_expr = _mv_1732.value;
                        __auto_type _mv_1733 = (*field_expr);
                        switch (_mv_1733.tag) {
                            case types_SExpr_sym:
                            {
                                __auto_type field_sym = _mv_1733.data.sym;
                                {
...
types_ResolvedType* infer_check_field_exists(env_TypeEnv* env, types_ResolvedType* obj_type, slop_string field_name, int64_t line, int64_t col) {
    ...
    SLOP_PRE(((obj_type != NULL)), "(!= obj-type nil)");
    {
        ...
        if (types_resolved_type_is_record(obj_type)) {
            __auto_type _mv_1734 = types_resolved_type_get_field_type(obj_type, field_name);
            if (_mv_1734.has_value) {
                __auto_type field_type = _mv_1734.value;
                return field_type;
                ...
                if (string_eq(type_name, SLOP_STR("String"))) {
                    ...
                    if (string_eq(type_name, SLOP_STR("Unknown"))) {
                        ...
                        if (types_resolved_type_is_pointer(obj_type)) {
                            __auto_type _mv_1735 = (*obj_type).inner_type;
                            if (_mv_1735.has_value) {
                                __auto_type inner_type = _mv_1735.value;
...
types_ResolvedType* infer_infer_cond_expr(env_TypeEnv* env, types_SExpr* expr, types_SExprList lst) {
    SLOP_PRE(((env != NULL)), "(!= env nil)");
    {
        ...
        int64_t i = 1;
        while (i < len) {
            __auto_type _mv_1736 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1736.has_value) {
                __auto_type clause = _mv_1736.value;
                __auto_type _mv_1737 = (*clause);
                switch (_mv_1737.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type clause_lst = _mv_1737.data.lst;
                        {
                            ...
                            if (clause_len > 1) {
                                for (int64_t ci = 0; ci < (clause_len - 1); ci++) {
                                    __auto_type _mv_1738 = ({ __auto_type _lst = clause_items; size_t _idx = (size_t)ci; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    if (_mv_1738.has_value) {
                                        __auto_type clause_elem = _mv_1738.value;
                                        {
                                ...
                                __auto_type _mv_1739 = ({ __auto_type _lst = clause_items; size_t _idx = (size_t)(clause_len - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1739.has_value) {
                                    __auto_type body = _mv_1739.value;
                                    {
...
void infer_bind_match_pattern(env_TypeEnv* env, types_ResolvedType* scrutinee_type, types_SExpr* pattern) {
    ...
    if (parser_sexpr_is_list(pattern)) {
        if (parser_sexpr_list_len(pattern) > 0) {
            __auto_type _mv_1740 = parser_sexpr_list_get(pattern, 0);
            if (_mv_1740.has_value) {
                __auto_type variant_expr = _mv_1740.value;
                {
                    __auto_type variant_name = parser_sexpr_get_symbol_name(variant_expr);
                    if (!(string_eq(variant_name, SLOP_STR("")))) {
                        if (parser_sexpr_list_len(pattern) > 1) {
                            __auto_type _mv_1741 = parser_sexpr_list_get(pattern, 1);
                            if (_mv_1741.has_value) {
                                __auto_type binding_expr = _mv_1741.value;
                                {
                                    ...
                                    if (!(string_eq(binding_name, SLOP_STR("")))) {
                                        {
                                            ...
                                            if (string_eq(scrutinee_name, SLOP_STR("T"))) {
                                                ...
                                                if ((scrutinee_kind == types_ResolvedTypeKind_rk_option) && string_eq(variant_name, SLOP_STR("some"))) {
                                                    __auto_type _mv_1742 = (*scrutinee_type).inner_type;
                                                    ...
                                                    if (scrutinee_kind == types_ResolvedTypeKind_rk_result) {
                                                        if (string_eq(variant_name, SLOP_STR("ok"))) {
                                                            __auto_type _mv_1743 = (*scrutinee_type).inner_type;
                                                            ...
                                                            __auto_type _mv_1744 = (*scrutinee_type).inner_type2;
                                                            if (_mv_1744.has_value) {
                                                                __auto_type inner2 = _mv_1744.value;
                                                    ...
                                                    } else {
                                                        {
                                                            ...
                                                            if (((int64_t)((payload_types).len)) > 0) {
                                                                if (!(string_eq(binding_name, SLOP_STR("true"))) && !(string_eq(binding_name, SLOP_STR("false")))) {
                                                                    __auto_type _mv_1745 = ({ __auto_type _lst = payload_types; size_t _idx = (size_t)0; slop_option_types_ResolvedType_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                                    if (_mv_1745.has_value) {
                                                                        __auto_type first_type = _mv_1745.value;
                                                                ...
                                                                }
                                                                {
                                                                    ...
                                                                    for (int64_t pi = 2; pi < pat_len; pi++) {
                                                                        __auto_type _mv_1746 = parser_sexpr_list_get(pattern, pi);
                                                                        if (_mv_1746.has_value) {
                                                                            __auto_type extra_binding = _mv_1746.value;
                                                                            {
                                                                                ...
                                                                                if ((!(string_eq(extra_name, SLOP_STR("")))) && (!(string_eq(extra_name, SLOP_STR("_")))) && (!(string_eq(extra_name, SLOP_STR("true")))) && (!(string_eq(extra_name, SLOP_STR("false"))))) {
                                                                                    {
                                                                                        ...
                                                                                        if (type_idx < num_types) {
                                                                                            __auto_type _mv_1747 = ({ __auto_type _lst = payload_types; size_t _idx = (size_t)type_idx; slop_option_types_ResolvedType_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                                                            if (_mv_1747.has_value) {
                                                                                                __auto_type pt = _mv_1747.value;
                ...
                switch (_mv_1749.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type clause_lst = _mv_1749.data.lst;
                        {
                            ...
                            if (clause_len > 1) {
                                env_env_push_scope(env);
                                __auto_type _mv_1750 = ({ __auto_type _lst = clause_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1750.has_value) {
                                    __auto_type pattern = _mv_1750.value;
                                    infer_bind_match_pattern(env, scrutinee_type, pattern);
                                } else if (!_mv_1750.has_value) {
                                }
                                for (int64_t bi = 1; bi < (clause_len - 1); bi++) {
                                    __auto_type _mv_1751 = ({ __auto_type _lst = clause_items; size_t _idx = (size_t)bi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    if (_mv_1751.has_value) {
                                        __auto_type body_expr = _mv_1751.value;
                                        {
                                            __auto_type _ = infer_infer_expr(env, body_expr);
                                        }
                                ...
                                __auto_type _mv_1752 = ({ __auto_type _lst = clause_items; size_t _idx = (size_t)(clause_len - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1752.has_value) {
                                    __auto_type body = _mv_1752.value;
                                    {
                                        __auto_type body_type = infer_infer_expr(env, body);
                                        if (!(has_result)) {
                                            result_type = body_type;
...
void infer_check_return_type(env_TypeEnv* env, types_SExpr* fn_form, slop_string fn_name, types_ResolvedType* inferred_type, int64_t fn_line, int64_t fn_col) {
    ...
    __auto_type _mv_1753 = (*fn_form);
    switch (_mv_1753.tag) {
        case types_SExpr_lst:
        {
            __auto_type fn_lst = _mv_1753.data.lst;
            {
                __auto_type items = fn_lst.items;
                __auto_type len = ((int64_t)((items).len));
                for (int64_t i = 3; i < len; i++) {
                    __auto_type _mv_1754 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_1754.has_value) {
                        __auto_type item = _mv_1754.value;
...
void infer_check_spec_return_type(env_TypeEnv* env, types_SExpr* spec_form, slop_string fn_name, types_ResolvedType* inferred_type, int64_t fn_line, int64_t fn_col) {
    ...
    __auto_type _mv_1755 = (*spec_form);
    switch (_mv_1755.tag) {
        case types_SExpr_lst:
        {
            __auto_type spec_lst = _mv_1755.data.lst;
            {
                __auto_type spec_items = spec_lst.items;
                __auto_type _mv_1756 = ({ __auto_type _lst = spec_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_1756.has_value) {
                    __auto_type spec_body = _mv_1756.value;
...
void infer_check_spec_body_return(env_TypeEnv* env, types_SExpr* spec_body, slop_string fn_name, types_ResolvedType* inferred_type, int64_t fn_line, int64_t fn_col) {
    ...
    __auto_type _mv_1757 = (*spec_body);
    switch (_mv_1757.tag) {
        case types_SExpr_lst:
        {
            __auto_type body_lst = _mv_1757.data.lst;
            {
                __auto_type body_items = body_lst.items;
                __auto_type body_len = ((int64_t)((body_items).len));
                __auto_type _mv_1758 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)(body_len - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_1758.has_value) {
                    __auto_type ret_expr = _mv_1758.value;
...
void infer_check_return_expr(env_TypeEnv* env, types_SExpr* ret_expr, slop_string fn_name, types_ResolvedType* inferred_type, int64_t fn_line, int64_t fn_col) {
    ...
    __auto_type _mv_1759 = (*ret_expr);
    switch (_mv_1759.tag) {
        case types_SExpr_sym:
        {
            __auto_type ret_sym = _mv_1759.data.sym;
            {
...
void infer_bind_param_from_form(env_TypeEnv* env, types_SExpr* param_form) {
    ...
    if (parser_sexpr_is_list(param_form) && (parser_sexpr_list_len(param_form) >= 2)) {
        __auto_type _mv_1760 = parser_sexpr_list_get(param_form, 0);
        if (_mv_1760.has_value) {
            __auto_type first_expr = _mv_1760.value;
            {
                ...
                if ((string_eq(first_name, SLOP_STR("in"))) || (string_eq(first_name, SLOP_STR("out"))) || (string_eq(first_name, SLOP_STR("mut")))) {
                    if (parser_sexpr_list_len(param_form) >= 3) {
                        __auto_type _mv_1761 = parser_sexpr_list_get(param_form, 1);
                        if (_mv_1761.has_value) {
                            __auto_type name_expr = _mv_1761.value;
                            {
...
types_ResolvedType* infer_get_param_type_from_form(env_TypeEnv* env, types_SExpr* param_form) {
    ...
    SLOP_PRE(((param_form != NULL)), "(!= param-form nil)");
    {
        ...
        __auto_type _mv_1762 = parser_sexpr_list_get(param_form, type_pos);
...
types_ResolvedType* infer_resolve_complex_type_expr(env_TypeEnv* env, types_SExpr* type_expr) {
    ...
    __auto_type _mv_1763 = parser_sexpr_list_get(type_expr, 0);
    if (_mv_1763.has_value) {
        __auto_type head_expr = _mv_1763.value;
        {
            __auto_type head_name = parser_sexpr_get_symbol_name(head_expr);
            if (string_eq(head_name, SLOP_STR("Option"))) {
            ...
            } else if (string_eq(head_name, SLOP_STR("Result"))) {
                {
                    ...
                    if (parser_sexpr_list_len(type_expr) >= 2) {
                        ...
                        if (_mv_1765.has_value) {
                            __auto_type ok_expr = _mv_1765.value;
                            {
                    ...
                    if (parser_sexpr_list_len(type_expr) >= 3) {
                        ...
                        if (_mv_1766.has_value) {
                            __auto_type err_expr = _mv_1766.value;
                            {
                ...
                __auto_type _mv_1767 = env_env_lookup_type(env, head_name);
...
types_ResolvedType* infer_resolve_option_inner_type(env_TypeEnv* env, types_SExpr* type_expr) {
    ...
    if (parser_sexpr_list_len(type_expr) < 2) {
        ...
        if (_mv_1768.has_value) {
            __auto_type inner_expr = _mv_1768.value;
            {
...
types_ResolvedType* infer_resolve_ptr_inner_type(env_TypeEnv* env, types_SExpr* type_expr) {
    ...
    if (parser_sexpr_list_len(type_expr) < 2) {
        ...
        __auto_type _mv_1769 = parser_sexpr_list_get(type_expr, 1);
        if (_mv_1769.has_value) {
            __auto_type inner_expr = _mv_1769.value;
            {
                __auto_type inner_name = parser_sexpr_get_symbol_name(inner_expr);
                if (string_eq(inner_name, SLOP_STR(""))) {
...
types_ResolvedType* infer_resolve_type_lenient(env_TypeEnv* env, slop_string type_name) {
    SLOP_PRE(((env != NULL)), "(!= env nil)");
    __auto_type _mv_1770 = env_env_lookup_type(env, type_name);
...
types_ResolvedType* infer_resolve_simple_type(env_TypeEnv* env, slop_string type_name) {
    SLOP_PRE(((env != NULL)), "(!= env nil)");
    __auto_type _mv_1771 = env_env_lookup_type(env, type_name);
    if (_mv_1771.has_value) {
        __auto_type t = _mv_1771.value;
        return t;
...
void infer_bind_let_binding(env_TypeEnv* env, types_SExpr* binding_form) {
    ...
    if (parser_sexpr_is_list(binding_form) && (parser_sexpr_list_len(binding_form) >= 2)) {
        __auto_type _mv_1772 = parser_sexpr_list_get(binding_form, 0);
        if (_mv_1772.has_value) {
            __auto_type first_expr = _mv_1772.value;
            {
                __auto_type first_name = parser_sexpr_get_symbol_name(first_expr);
                if (string_eq(first_name, SLOP_STR("mut"))) {
                    if (parser_sexpr_list_len(binding_form) >= 3) {
                        __auto_type _mv_1773 = parser_sexpr_list_get(binding_form, 1);
                        if (_mv_1773.has_value) {
                            __auto_type name_expr = _mv_1773.value;
                            {
                                __auto_type var_name = parser_sexpr_get_symbol_name(name_expr);
                                if (!(string_eq(var_name, SLOP_STR("")))) {
                                    {
                                        __auto_type binding_len = parser_sexpr_list_len(binding_form);
                                        __auto_type _mv_1774 = parser_sexpr_list_get(binding_form, (binding_len - 1));
                    ...
                    if (!(string_eq(first_name, SLOP_STR("")))) {
                        {
                            __auto_type binding_len = parser_sexpr_list_len(binding_form);
                            if (binding_len == 3) {
                                __auto_type _mv_1775 = parser_sexpr_list_get(binding_form, 2);
                                if (_mv_1775.has_value) {
                                    __auto_type val_expr = _mv_1775.value;
                                    {
                                        __auto_type val_type = infer_infer_expr(env, val_expr);
...
types_ResolvedType* infer_infer_let_expr(env_TypeEnv* env, types_SExpr* expr) {
    ...
    env_env_push_scope(env);
    if (parser_sexpr_is_list(expr)) {
        __auto_type _mv_1777 = parser_sexpr_list_get(expr, 1);
        if (_mv_1777.has_value) {
            __auto_type bindings_expr = _mv_1777.value;
            if (parser_sexpr_is_list(bindings_expr)) {
                {
                    ...
                    for (int64_t i = 0; i < num_bindings; i++) {
                        __auto_type _mv_1778 = parser_sexpr_list_get(bindings_expr, i);
                        if (_mv_1778.has_value) {
                            __auto_type binding = _mv_1778.value;
        ...
        if (len < 2) {
        ...
        } else {
            {
                ...
                if (is_named && (len < 4)) {
                    ...
                    __auto_type _mv_1779 = parser_sexpr_list_get(expr, size_idx);
                    if (_mv_1779.has_value) {
                        __auto_type size_expr = _mv_1779.value;
                        __auto_type _mv_1780 = (*size_expr);
                        switch (_mv_1780.tag) {
                            case types_SExpr_num:
                            {
                                __auto_type num = _mv_1780.data.num;
                                if (num.int_value <= 0) {
                    ...
                    env_env_bind_var(env, arena_name, env_env_get_arena_type(env));
                    {
                        ...
                        for (int64_t i = body_start; i < len; i++) {
                            __auto_type _mv_1781 = parser_sexpr_list_get(expr, i);
                            if (_mv_1781.has_value) {
                                __auto_type body_expr = _mv_1781.value;
...
slop_string infer_get_fn_name(types_SExpr* fn_form) {
    ...
    if (!(parser_sexpr_is_list(fn_form))) {
        ...
        if (parser_sexpr_list_len(fn_form) < 2) {
            ...
            __auto_type _mv_1782 = parser_sexpr_list_get(fn_form, 1);
        ...
        if (_mv_1783.has_value) {
            __auto_type type_expr = _mv_1783.value;
            {
                ...
                if (string_eq(type_name, SLOP_STR(""))) {
                    ...
                    __auto_type _mv_1784 = env_env_lookup_type(env, type_name);
...
slop_string infer_get_hole_prompt(slop_list_types_SExpr_ptr items, int64_t len) {
    if (len < 3) {
        ...
        __auto_type _mv_1785 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        if (_mv_1785.has_value) {
            __auto_type prompt_expr = _mv_1785.value;
            __auto_type _mv_1786 = (*prompt_expr);
            switch (_mv_1786.tag) {
                case types_SExpr_str:
                {
                    __auto_type str = _mv_1786.data.str;
                    return str.value;
                }
                default: {
                    return SLOP_STR("(no description)");
...
uint8_t infer_is_c_name_related(slop_list_types_SExpr_ptr items, int64_t idx) {
    __auto_type _mv_1787 = ({ __auto_type _lst = items; size_t _idx = (size_t)idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    if (_mv_1787.has_value) {
        __auto_type item = _mv_1787.value;
        __auto_type _mv_1788 = (*item);
        switch (_mv_1788.tag) {
            case types_SExpr_sym:
            {
            ...
            case types_SExpr_str:
            {
                __auto_type _ = _mv_1788.data.str;
                if (idx > 0) {
                    __auto_type _mv_1789 = ({ __auto_type _lst = items; size_t _idx = (size_t)(idx - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_1789.has_value) {
                        __auto_type prev = _mv_1789.value;
                        __auto_type _mv_1790 = (*prev);
                        switch (_mv_1790.tag) {
                            case types_SExpr_sym:
                            {
        ...
        if (parser_sexpr_is_list(fn_form)) {
            {
                ...
                if (params_len > 2) {
                    __auto_type _mv_1795 = parser_sexpr_list_get(fn_form, 2);
                    if (_mv_1795.has_value) {
                        __auto_type params_expr = _mv_1795.value;
                        if (parser_sexpr_is_list(params_expr)) {
                            {
                                __auto_type num_params = parser_sexpr_list_len(params_expr);
                                for (int64_t k = 0; k < num_params; k++) {
                                    __auto_type _mv_1796 = parser_sexpr_list_get(params_expr, k);
                                    if (_mv_1796.has_value) {
                                        __auto_type param_form = _mv_1796.value;
                                        infer_bind_param_from_form(env, param_form);
    ...
    if (types_resolved_type_is_union(scrutinee_type)) {
        {
            ...
            for (int64_t i = 0; i < num_patterns; i++) {
                __auto_type _mv_1797 = ({ __auto_type _lst = patterns; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_1797.has_value) {
                    __auto_type pattern_case = _mv_1797.value;
                    __auto_type _mv_1798 = (*pattern_case);
                    switch (_mv_1798.tag) {
                        case types_SExpr_lst:
                        {
                            __auto_type pattern_list = _mv_1798.data.lst;
                            if (((int64_t)((pattern_list.items).len)) > 0) {
                                __auto_type _mv_1799 = ({ __auto_type _lst = pattern_list.items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1799.has_value) {
                                    __auto_type pattern_expr = _mv_1799.value;
                                    __auto_type _mv_1800 = (*pattern_expr);
                                    switch (_mv_1800.tag) {
                                        case types_SExpr_lst:
                                        {
                                            __auto_type variant_list = _mv_1800.data.lst;
                                            {
                                                __auto_type variant_items = variant_list.items;
                                                if (((int64_t)((variant_items).len)) > 0) {
                                                    __auto_type _mv_1801 = ({ __auto_type _lst = variant_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_1801.has_value) {
                                                        __auto_type variant_name_expr = _mv_1801.value;
                                                        __auto_type _mv_1802 = (*variant_name_expr);
                                                        switch (_mv_1802.tag) {
                                                            case types_SExpr_sym:
                                                            {
                                                                __auto_type variant_sym = _mv_1802.data.sym;
                                                                {
                                                                        ...
                                                                        if (num_pt > 0) {
                                                                            {
                                                                                ...
                                                                                for (int64_t vi = 1; vi < num_vt; vi++) {
                                                                                    __auto_type _mv_1803 = ({ __auto_type _lst = variant_items; size_t _idx = (size_t)vi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                                                    if (_mv_1803.has_value) {
                                                                                        __auto_type binding_expr = _mv_1803.value;
                                                                                        __auto_type _mv_1804 = (*binding_expr);
                                                                                        switch (_mv_1804.tag) {
                                                                                            case types_SExpr_sym:
                                                                                            {
                                                                                                __auto_type binding_sym = _mv_1804.data.sym;
                                                                                                {
                                                                                                    __auto_type bname = binding_sym.name;
                                                                                                    __auto_type type_idx = (vi - 1);
                                                                                                    if (!(string_eq(bname, SLOP_STR("_"))) && !(string_eq(bname, SLOP_STR("")))) {
                                                                                                        if (type_idx < num_pt) {
                                                                                                            __auto_type _mv_1805 = ({ __auto_type _lst = payload_types; size_t _idx = (size_t)type_idx; slop_option_types_ResolvedType_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                                                                            if (_mv_1805.has_value) {
                                                                                                                __auto_type pt = _mv_1805.value;
                                                                            ...
                                                                            __auto_type _mv_1806 = types_resolved_type_get_variant_index(scrutinee_type, variant_name);
                                                                            if (_mv_1806.has_value) {
                                                                                __auto_type _ = _mv_1806.value;
