...
slop_option_types_ResolvedType_ptr infer_find_binding(slop_list_string bind_names, slop_list_types_ResolvedType_ptr bind_types, slop_string name) {
    {
        ...
        for (int64_t i = 0; i < len; i++) {
            __auto_type _mv_1661 = ({ __auto_type _lst = bind_names; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1661.has_value) {
                __auto_type bn = _mv_1661.value;
                if (string_eq(bn, name)) {
                    __auto_type _mv_1662 = ({ __auto_type _lst = bind_types; size_t _idx = (size_t)i; slop_option_types_ResolvedType_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_1662.has_value) {
                        __auto_type bt = _mv_1662.value;
        ...
        if (f_kind == types_ResolvedTypeKind_rk_typevar) {
            {
                ...
                __auto_type _mv_1663 = infer_find_binding(bind_names, bind_types, tv_name);
                if (_mv_1663.has_value) {
                    __auto_type existing = _mv_1663.value;
            ...
            if ((*actual).kind == types_ResolvedTypeKind_rk_result) {
                ...
                __auto_type _mv_1676 = (*formal).inner_type2;
                if (_mv_1676.has_value) {
                    __auto_type f_inner2 = _mv_1676.value;
                    __auto_type _mv_1677 = (*actual).inner_type2;
                    if (_mv_1677.has_value) {
                        __auto_type a_inner2 = _mv_1677.value;
        ...
        if (kind == types_ResolvedTypeKind_rk_typevar) {
            {
                ...
                __auto_type _mv_1678 = infer_find_binding(bind_names, bind_types, tv_name);
                if (_mv_1678.has_value) {
                    __auto_type bound = _mv_1678.value;
                    return bound;
            ...
            __auto_type _mv_1679 = (*t).inner_type;
            if (_mv_1679.has_value) {
                __auto_type inner = _mv_1679.value;
                {
            ...
            __auto_type _mv_1680 = (*t).inner_type;
            if (_mv_1680.has_value) {
                __auto_type inner = _mv_1680.value;
                {
                    __auto_type new_inner = infer_substitute_type_vars(arena, inner, bind_names, bind_types);
            ...
            __auto_type _mv_1681 = (*t).inner_type;
            if (_mv_1681.has_value) {
                __auto_type inner = _mv_1681.value;
                {
                    __auto_type new_inner = infer_substitute_type_vars(arena, inner, bind_names, bind_types);
            ...
            __auto_type _mv_1682 = (*t).inner_type;
            if (_mv_1682.has_value) {
                __auto_type inner = _mv_1682.value;
                {
                    __auto_type new_inner = infer_substitute_type_vars(arena, inner, bind_names, bind_types);
        ...
        if (parser_sexpr_is_list(expr)) {
            {
                ...
                }
                {
                    ...
                    for (int64_t i = 0; i < limit; i++) {
                        __auto_type _mv_1684 = parser_sexpr_list_get(expr, (i + 1));
                        if (_mv_1684.has_value) {
                            __auto_type arg_expr = _mv_1684.value;
                            {
                                __auto_type actual_type = infer_infer_expr(env, arg_expr);
                                __auto_type _mv_1685 = ({ __auto_type _lst = params; size_t _idx = (size_t)i; slop_option_types_ParamInfo _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1685.has_value) {
                                    __auto_type param_info = _mv_1685.value;
                                    {
...
uint8_t infer_container_inners_equal(types_ResolvedType* a, types_ResolvedType* b) {
    ...
    SLOP_PRE(((b != NULL)), "(!= b nil)");
    {
        ...
        uint8_t result = 1;
        while (!(done) && (steps < 32)) {
            __auto_type _mv_1686 = (*ca).inner_type;
            if (_mv_1686.has_value) {
                __auto_type a_inner = _mv_1686.value;
                __auto_type _mv_1687 = (*cb).inner_type;
                if (_mv_1687.has_value) {
                    __auto_type b_inner = _mv_1687.value;
...
uint8_t infer_types_compatible_with_range(types_ResolvedType* a, types_ResolvedType* b) {
    ...
    SLOP_PRE(((b != NULL)), "(!= b nil)");
    {
        ...
        if (a_kind == types_ResolvedTypeKind_rk_range) {
            __auto_type _mv_1688 = (*a).inner_type;
            if (_mv_1688.has_value) {
                __auto_type base = _mv_1688.value;
            ...
            __auto_type _mv_1689 = (*b).inner_type;
            if (_mv_1689.has_value) {
                __auto_type base = _mv_1689.value;
...
void infer_sexpr_set_resolved_type(types_SExpr* expr, types_ResolvedType* t) {
    ...
    switch (_mv_1690.tag) {
        ...
        {
            __auto_type sym = _mv_1690.data.sym;
        ...
        {
            __auto_type str = _mv_1690.data.str;
        ...
        {
            __auto_type num = _mv_1690.data.num;
...
types_ResolvedType* infer_infer_expr_inner(env_TypeEnv* env, types_SExpr* expr) {
    ...
    SLOP_PRE(((expr != NULL)), "(!= expr nil)");
    {
        ...
        switch (_mv_1691.tag) {
            case types_SExpr_sym:
            {
                __auto_type sym = _mv_1691.data.sym;
                {
                    ...
                    if (string_eq(name, SLOP_STR("true")) || string_eq(name, SLOP_STR("false"))) {
                        ...
                        __auto_type _mv_1692 = env_env_lookup_var(env, name);
                        if (_mv_1692.has_value) {
                            __auto_type t = _mv_1692.value;
                            return t;
                        } else if (!_mv_1692.has_value) {
                            __auto_type _mv_1693 = env_env_lookup_constant(env, name);
                            if (_mv_1693.has_value) {
                                __auto_type t = _mv_1693.value;
                                return t;
                            } else if (!_mv_1693.has_value) {
                                __auto_type _mv_1694 = env_env_lookup_function(env, name);
                                if (_mv_1694.has_value) {
                                    __auto_type sig = _mv_1694.value;
                                    ...
                                    if (infer_string_contains_char(name, 46)) {
                                        {
                                            ...
                                            __auto_type _mv_1695 = env_env_lookup_var(env, base_name);
                                            if (_mv_1695.has_value) {
                                                __auto_type obj_type = _mv_1695.value;
                                                return infer_check_field_exists(env, obj_type, field_name, line, col);
                                            } else if (!_mv_1695.has_value) {
                                                __auto_type _mv_1696 = env_env_lookup_type(env, base_name);
                                                if (_mv_1696.has_value) {
                                                    __auto_type type_info = _mv_1696.value;
                                                    return type_info;
                                        ...
                                        __auto_type _mv_1697 = env_env_lookup_type(env, name);
                                        if (_mv_1697.has_value) {
                                            __auto_type type_info = _mv_1697.value;
                                            return type_info;
                                        } else if (!_mv_1697.has_value) {
                                            __auto_type _mv_1698 = env_env_lookup_variant(env, name);
            ...
            case types_SExpr_num:
            {
                __auto_type num = _mv_1691.data.num;
                if (num.is_float) {
            ...
            case types_SExpr_str:
            {
                __auto_type str = _mv_1691.data.str;
...
types_ResolvedType* infer_infer_list_expr(env_TypeEnv* env, types_SExpr* expr, types_SExprList lst) {
    ...
    SLOP_PRE(((expr != NULL)), "(!= expr nil)");
    {
        ...
        if (len == 0) {
            ...
            __auto_type _mv_1700 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (!_mv_1700.has_value) {
                return env_env_get_unit_type(env);
            } else if (_mv_1700.has_value) {
                __auto_type head = _mv_1700.value;
                __auto_type _mv_1701 = (*head);
                switch (_mv_1701.tag) {
                    case types_SExpr_sym:
                    {
                        __auto_type sym = _mv_1701.data.sym;
                        {
        ...
        if (string_eq(op, SLOP_STR("if"))) {
            if (len >= 4) {
                ...
                if (_mv_1702.has_value) {
                    __auto_type cond_expr = _mv_1702.value;
                    {
                        __auto_type _ = infer_infer_expr(env, cond_expr);
                    }
                } else if (!_mv_1702.has_value) {
                }
                __auto_type _mv_1703 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_1703.has_value) {
                    __auto_type then_expr = _mv_1703.value;
                    {
                        ...
                        if (_mv_1704.has_value) {
                            __auto_type else_expr = _mv_1704.value;
                            {
            ...
            if (len > 1) {
                __auto_type _mv_1705 = ({ __auto_type _lst = items; size_t _idx = (size_t)(len - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_1705.has_value) {
                    __auto_type last = _mv_1705.value;
                                    ...
                                    __auto_type var_expr = _mv_1707.value;
                                    {
                                        ...
                                        if (!(string_eq(var_name, SLOP_STR("")))) {
                                            ...
                                            if (_mv_1708.has_value) {
                                                __auto_type start_expr = _mv_1708.value;
                                                {
                                                    __auto_type _ = infer_infer_expr(env, start_expr);
                                                }
                                            } else if (!_mv_1708.has_value) {
                                            }
                                            __auto_type _mv_1709 = parser_sexpr_list_get(binding_form, 2);
                                            if (_mv_1709.has_value) {
                                                __auto_type end_expr = _mv_1709.value;
                                                {
                                            ...
                                            for (int64_t body_idx = 2; body_idx < len; body_idx++) {
                                                __auto_type _mv_1710 = ({ __auto_type _lst = items; size_t _idx = (size_t)body_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_1710.has_value) {
                                                    __auto_type body_expr = _mv_1710.value;
                                                    {
            ...
            if (len >= 3) {
                ...
                if (_mv_1711.has_value) {
                    __auto_type binding_form = _mv_1711.value;
                    if (parser_sexpr_is_list(binding_form)) {
                        {
                            __auto_type bind_len = parser_sexpr_list_len(binding_form);
                            if (bind_len >= 2) {
                                __auto_type _mv_1712 = parser_sexpr_list_get(binding_form, 0);
                                if (_mv_1712.has_value) {
                                    __auto_type var_expr = _mv_1712.value;
                                    {
                                        __auto_type var_name = parser_sexpr_get_symbol_name(var_expr);
                                        if (string_eq(var_name, SLOP_STR(""))) {
                                            return env_env_get_unit_type(env);
                                        } else {
                                            __auto_type _mv_1713 = parser_sexpr_list_get(binding_form, 1);
                                            if (_mv_1713.has_value) {
                                                __auto_type coll_expr = _mv_1713.value;
                                                {
            ...
            if (len >= 2) {
                ...
                if (_mv_1715.has_value) {
                    __auto_type params_expr = _mv_1715.value;
                    if (parser_sexpr_is_list(params_expr)) {
                        {
                            ...
                            for (int64_t k = 0; k < num_params; k++) {
                                __auto_type _mv_1716 = parser_sexpr_list_get(params_expr, k);
                                if (_mv_1716.has_value) {
                                    __auto_type param_form = _mv_1716.value;
            ...
            if (len >= 4) {
                ...
                __auto_type _mv_1718 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            ...
            if (len >= 2) {
                ...
                if (_mv_1719.has_value) {
                    __auto_type ret_expr = _mv_1719.value;
                    {
            ...
            if (len >= 2) {
                ...
                if (_mv_1722.has_value) {
                    __auto_type inner_expr = _mv_1722.value;
                    {
                    ...
                    __auto_type type_expr = _mv_1723.value;
                    {
                        ...
                        if (string_eq(type_name, SLOP_STR(""))) {
                            if (parser_sexpr_is_list(type_expr)) {
                                __auto_type _mv_1724 = parser_sexpr_list_get(type_expr, 0);
                                if (_mv_1724.has_value) {
                                    __auto_type head_expr = _mv_1724.value;
                                    {
            ...
            if (len >= 2) {
                ...
                if (_mv_1726.has_value) {
                    __auto_type variant_expr = _mv_1726.value;
                    {
                        __auto_type variant_name = parser_sexpr_get_symbol_name(variant_expr);
                        if (string_eq(variant_name, SLOP_STR(""))) {
                            return env_env_get_unknown_type(env);
                        } else {
                            __auto_type _mv_1727 = env_env_lookup_variant(env, variant_name);
                            if (_mv_1727.has_value) {
                                __auto_type enum_name = _mv_1727.value;
                                __auto_type _mv_1728 = env_env_lookup_type(env, enum_name);
                                if (_mv_1728.has_value) {
                                    __auto_type enum_type = _mv_1728.value;
                                    return enum_type;
            ...
            if (len >= 2) {
                ...
                if (_mv_1729.has_value) {
                    __auto_type inner_expr = _mv_1729.value;
                    {
                        __auto_type inner_type = infer_infer_expr(env, inner_expr);
            ...
            for (int64_t fi = 2; fi < len; fi++) {
                __auto_type _mv_1730 = ({ __auto_type _lst = items; size_t _idx = (size_t)fi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_1730.has_value) {
                    __auto_type field_pair = _mv_1730.value;
                    if (parser_sexpr_is_list(field_pair) && (parser_sexpr_list_len(field_pair) >= 2)) {
                        __auto_type _mv_1731 = parser_sexpr_list_get(field_pair, 1);
                        if (_mv_1731.has_value) {
                            __auto_type val_expr = _mv_1731.value;
                            {
                                __auto_type _ = infer_infer_expr(env, val_expr);
                            }
            ...
            if (len >= 2) {
                ...
                if (_mv_1732.has_value) {
                    __auto_type type_expr = _mv_1732.value;
                    {
                        __auto_type type_name = parser_sexpr_get_symbol_name(type_expr);
                        if (string_eq(type_name, SLOP_STR(""))) {
                            return env_env_get_unit_type(env);
                        } else {
                            __auto_type _mv_1733 = env_env_lookup_type(env, type_name);
                            if (_mv_1733.has_value) {
                                __auto_type t = _mv_1733.value;
                                return t;
            ...
            if (len >= 4) {
                __auto_type _mv_1734 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_1734.has_value) {
                    __auto_type val_expr = _mv_1734.value;
                    {
                        __auto_type _ = infer_infer_expr(env, val_expr);
                    }
                ...
                if (_mv_1735.has_value) {
                    __auto_type type_expr = _mv_1735.value;
                    {
                        ...
                        if (string_eq(type_name, SLOP_STR(""))) {
                            ...
                            __auto_type _mv_1736 = env_env_lookup_type(env, type_name);
                            if (_mv_1736.has_value) {
                                __auto_type t = _mv_1736.value;
                                return t;
            ...
            __auto_type _mv_1737 = env_env_lookup_function(env, op);
            if (_mv_1737.has_value) {
                __auto_type sig = _mv_1737.value;
                ...
                __auto_type _mv_1738 = env_env_lookup_type(env, op);
                if (_mv_1738.has_value) {
                    __auto_type the_type = _mv_1738.value;
                    return the_type;
                    ...
                    if (string_eq(op, SLOP_STR("list-get"))) {
                                ...
                                if (_mv_1739.has_value) {
                                    __auto_type list_arg = _mv_1739.value;
                                    {
                                        ...
                                        if ((*list_type).kind == types_ResolvedTypeKind_rk_list) {
                                            __auto_type _mv_1740 = (*list_type).inner_type;
                                            if (_mv_1740.has_value) {
                                                __auto_type inner = _mv_1740.value;
                                                elem_type = inner;
                        ...
                        if (len < 3) {
                            ...
                            if (_mv_1741.has_value) {
                                __auto_type type_expr = _mv_1741.value;
                                {
                                    ...
                                    if (string_eq(type_name, SLOP_STR(""))) {
                                        if (parser_sexpr_is_list(type_expr)) {
                                            __auto_type _mv_1742 = parser_sexpr_list_get(type_expr, 0);
                                            if (_mv_1742.has_value) {
                                                __auto_type head_expr = _mv_1742.value;
                                                if (string_eq(parser_sexpr_get_symbol_name(head_expr), SLOP_STR("sizeof"))) {
                                                    __auto_type _mv_1743 = parser_sexpr_list_get(type_expr, 1);
                                                    if (_mv_1743.has_value) {
                                                        __auto_type sizeof_type_expr = _mv_1743.value;
                                                        {
                                                            __auto_type sizeof_type_name = parser_sexpr_get_symbol_name(sizeof_type_expr);
                                                            if (string_eq(sizeof_type_name, SLOP_STR(""))) {
                                                                return env_env_get_int_type(env);
                                                            } else {
                                                                __auto_type _mv_1744 = env_env_lookup_type(env, sizeof_type_name);
                                                                if (_mv_1744.has_value) {
                                                                    __auto_type resolved = _mv_1744.value;
                                        ...
                                        __auto_type _mv_1745 = env_env_lookup_type(env, type_name);
                                        if (_mv_1745.has_value) {
                                            __auto_type resolved = _mv_1745.value;
                                            return env_env_make_ptr_type(env, resolved);
                        ...
                        if (_mv_1746.has_value) {
                            __auto_type list_arg = _mv_1746.value;
                        ...
                        if (_mv_1747.has_value) {
                            __auto_type list_arg = _mv_1747.value;
                    ...
                    } else if (string_eq(op, SLOP_STR("ok"))) {
                        {
                            ...
                            if (len >= 2) {
                                ...
                                if (_mv_1749.has_value) {
                                    __auto_type val_expr = _mv_1749.value;
                                    {
                    ...
                    } else if (string_eq(op, SLOP_STR("error"))) {
                        {
                            ...
                            if (len >= 2) {
                                ...
                                if (_mv_1750.has_value) {
                                    __auto_type val_expr = _mv_1750.value;
                                    {
                                        __auto_type val_type = infer_infer_expr(env, val_expr);
                        ...
                        if (len >= 2) {
                            ...
                            if (_mv_1751.has_value) {
                                __auto_type ptr_expr = _mv_1751.value;
                                {
                                    __auto_type ptr_type = infer_infer_expr(env, ptr_expr);
                                    if (types_resolved_type_is_pointer(ptr_type)) {
                                        __auto_type _mv_1752 = (*ptr_type).inner_type;
                        ...
                        infer_check_builtin_args(env, SLOP_STR("map-new"), 3, (len - 1), line, col);
                        {
                            ...
                            if (len >= 3) {
                                __auto_type _mv_1753 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1753.has_value) {
                                    __auto_type type_expr = _mv_1753.value;
                                    {
                                        __auto_type type_name = parser_sexpr_get_symbol_name(type_expr);
                                        if (!(string_eq(type_name, SLOP_STR("")))) {
                                            __auto_type _mv_1754 = env_env_lookup_type(env, type_name);
                                            if (_mv_1754.has_value) {
                                                __auto_type t = _mv_1754.value;
                                                key_type = t;
                            ...
                            if (len >= 4) {
                                __auto_type _mv_1755 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1755.has_value) {
                                    __auto_type type_expr = _mv_1755.value;
                                    {
                                        __auto_type type_name = parser_sexpr_get_symbol_name(type_expr);
                                        if (!(string_eq(type_name, SLOP_STR("")))) {
                                            __auto_type _mv_1756 = env_env_lookup_type(env, type_name);
                                            if (_mv_1756.has_value) {
                                                __auto_type t = _mv_1756.value;
                                                val_type = t;
                        ...
                        infer_check_builtin_args(env, SLOP_STR("map-get"), 2, (len - 1), line, col);
                        {
                            ...
                            if (len >= 2) {
                                ...
                                if (_mv_1757.has_value) {
                                    __auto_type map_expr = _mv_1757.value;
                                    {
                                        __auto_type map_type = infer_infer_expr(env, map_expr);
                                        __auto_type _mv_1758 = (*map_type).inner_type2;
                        ...
                        if (len >= 2) {
                            ...
                            if (_mv_1759.has_value) {
                                __auto_type map_expr = _mv_1759.value;
                                {
                                    __auto_type map_type = infer_infer_expr(env, map_expr);
                        ...
                        infer_check_builtin_args(env, SLOP_STR("map-keys"), 1, (len - 1), line, col);
                        {
                            ...
                            types_ResolvedType* key_type = NULL;
                            if (len >= 2) {
                                __auto_type _mv_1760 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1760.has_value) {
                                    __auto_type map_expr = _mv_1760.value;
                                    {
                                        __auto_type map_type = infer_infer_expr(env, map_expr);
                                        __auto_type _mv_1761 = (*map_type).inner_type;
                        ...
                        infer_check_builtin_args(env, SLOP_STR("set-new"), 2, (len - 1), line, col);
                        {
                            ...
                            types_ResolvedType* elem_type = NULL;
                            if (len >= 3) {
                                __auto_type _mv_1762 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1762.has_value) {
                                    __auto_type type_expr = _mv_1762.value;
                                    {
                                        __auto_type type_name = parser_sexpr_get_symbol_name(type_expr);
                                        if (!(string_eq(type_name, SLOP_STR("")))) {
                                            __auto_type _mv_1763 = env_env_lookup_type(env, type_name);
                                            if (_mv_1763.has_value) {
                                                __auto_type t = _mv_1763.value;
                                                elem_type = t;
                        ...
                        infer_check_builtin_args(env, SLOP_STR("set-elements"), 1, (len - 1), line, col);
                        {
                            ...
                            if (len >= 2) {
                                ...
                                if (_mv_1764.has_value) {
                                    __auto_type set_expr = _mv_1764.value;
                                    {
                                        __auto_type set_type = infer_infer_expr(env, set_expr);
                                        __auto_type _mv_1765 = (*set_type).inner_type;
                        ...
                        {
                            __auto_type arena = env_env_arena(env);
                            __auto_type _mv_1766 = env_env_lookup_variant(env, op);
                            if (_mv_1766.has_value) {
                                __auto_type parent_type = _mv_1766.value;
                                {
                                ...
                                __auto_type _mv_1767 = infer_env_lookup_callable(env, op);
                                if (_mv_1767.has_value) {
                                    __auto_type var_type = _mv_1767.value;
                                    infer_infer_builtin_args(env, expr);
                                    return var_type;
...
void infer_check_single_arg(env_TypeEnv* env, types_FnSignature* sig, types_SExpr* expr, int64_t arg_idx, int64_t line, int64_t col) {
    ...
    SLOP_PRE(((sig != NULL)), "(!= sig nil)");
    {
        ...
        __auto_type fn_name = (*sig).name;
        __auto_type arena = env_env_arena(env);
        __auto_type _mv_1768 = ({ __auto_type _lst = params; size_t _idx = (size_t)arg_idx; slop_option_types_ParamInfo _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        if (_mv_1768.has_value) {
            __auto_type param_info = _mv_1768.value;
            {
                __auto_type expected_type = param_info.param_type;
                __auto_type _mv_1769 = parser_sexpr_list_get(expr, (arg_idx + 1));
                if (_mv_1769.has_value) {
                    __auto_type arg_expr = _mv_1769.value;
                    {
                        __auto_type actual_type = infer_infer_expr(env, arg_expr);
...
slop_option_types_ResolvedType_ptr infer_env_lookup_callable(env_TypeEnv* env, slop_string name) {
    SLOP_PRE(((env != NULL)), "(!= env nil)");
    __auto_type _mv_1770 = env_env_lookup_var(env, name);
    if (_mv_1770.has_value) {
        __auto_type var_type = _mv_1770.value;
...
void infer_check_list_operands(env_TypeEnv* env, slop_string op, slop_list_types_SExpr_ptr items, uint8_t has_index, int64_t line, int64_t col) {
    SLOP_PRE(((env != NULL)), "(!= env nil)");
    __auto_type _mv_1771 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    if (_mv_1771.has_value) {
        __auto_type list_arg = _mv_1771.value;
        {
            __auto_type list_type = infer_infer_expr(env, list_arg);
            ...
            if ((((*list_type).kind != types_ResolvedTypeKind_rk_list)) && (!(string_eq(list_name, SLOP_STR("Unknown")))) && (!(string_eq(list_name, SLOP_STR("T"))))) {
            ...
            } else {
                {
                    ...
                    if (has_index) {
                        __auto_type _mv_1772 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_1772.has_value) {
                            __auto_type idx_arg = _mv_1772.value;
                            {
                    ...
                    __auto_type _mv_1773 = (*list_type).inner_type;
                    if (_mv_1773.has_value) {
                        __auto_type elem_type = _mv_1773.value;
                        __auto_type _mv_1774 = ({ __auto_type _lst = items; size_t _idx = (size_t)elem_index; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_1774.has_value) {
                            __auto_type value_arg = _mv_1774.value;
                            {
    ...
    SLOP_PRE(((t != NULL)), "(!= t nil)");
    {
        ...
        while (!(done) && (steps < 64)) {
            if (((*cur).kind == types_ResolvedTypeKind_rk_primitive) && !(strlib_ends_with((*cur).c_name, SLOP_STR("*")))) {
                __auto_type _mv_1777 = (*cur).inner_type;
                if (_mv_1777.has_value) {
                    __auto_type next = _mv_1777.value;
                    cur = next;
                    steps = (steps + 1);
...
void infer_check_option_predicate_arg(env_TypeEnv* env, slop_string op, slop_list_types_SExpr_ptr items, int64_t len, int64_t line, int64_t col) {
    SLOP_PRE(((env != NULL)), "(!= env nil)");
    if (len >= 2) {
        __auto_type _mv_1778 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        if (_mv_1778.has_value) {
            __auto_type arg = _mv_1778.value;
            {
    ...
    if (parser_sexpr_is_list(expr)) {
        {
            ...
            for (int64_t i = 1; i < len; i++) {
                __auto_type _mv_1779 = parser_sexpr_list_get(expr, i);
                if (_mv_1779.has_value) {
                    __auto_type arg_expr = _mv_1779.value;
                    {
    ...
    if (parser_sexpr_is_list(expr)) {
        {
            ...
            for (int64_t i = start_idx; i < len; i++) {
                __auto_type _mv_1780 = parser_sexpr_list_get(expr, i);
                if (_mv_1780.has_value) {
                    __auto_type body_expr = _mv_1780.value;
                    {
                        __auto_type _ = infer_infer_expr(env, body_expr);
                    }
...
types_ResolvedType* infer_infer_field_access(env_TypeEnv* env, types_SExpr* expr, types_SExprList lst, int64_t line, int64_t col) {
    SLOP_PRE(((env != NULL)), "(!= env nil)");
    {
        ...
        if (len < 3) {
            ...
            __auto_type _mv_1781 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (!_mv_1781.has_value) {
                return env_env_get_unit_type(env);
            } else if (_mv_1781.has_value) {
                __auto_type obj_expr = _mv_1781.value;
                {
                    __auto_type obj_type = infer_infer_expr(env, obj_expr);
                    __auto_type _mv_1782 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (!_mv_1782.has_value) {
                        return env_env_get_unit_type(env);
                    } else if (_mv_1782.has_value) {
                        __auto_type field_expr = _mv_1782.value;
                        __auto_type _mv_1783 = (*field_expr);
                        switch (_mv_1783.tag) {
                            case types_SExpr_sym:
                            {
                                __auto_type field_sym = _mv_1783.data.sym;
                                {
    ...
    SLOP_PRE(((obj_type != NULL)), "(!= obj-type nil)");
    {
        ...
        if (infer_type_is_null_pointer(obj_type)) {
            ...
            if (types_resolved_type_is_record(obj_type)) {
                __auto_type _mv_1784 = types_resolved_type_get_field_type(obj_type, field_name);
                if (_mv_1784.has_value) {
                    __auto_type field_type = _mv_1784.value;
                    return field_type;
                    ...
                    if (string_eq(type_name, SLOP_STR("String"))) {
                        ...
                        if (string_eq(type_name, SLOP_STR("Unknown"))) {
                            ...
                            if (types_resolved_type_is_pointer(obj_type)) {
                                __auto_type _mv_1785 = (*obj_type).inner_type;
                                if (_mv_1785.has_value) {
                                    __auto_type inner_type = _mv_1785.value;
...
types_ResolvedType* infer_infer_cond_expr(env_TypeEnv* env, types_SExpr* expr, types_SExprList lst) {
    SLOP_PRE(((env != NULL)), "(!= env nil)");
    {
        ...
        int64_t i = 1;
        while (i < len) {
            __auto_type _mv_1786 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1786.has_value) {
                __auto_type clause = _mv_1786.value;
                __auto_type _mv_1787 = (*clause);
                switch (_mv_1787.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type clause_lst = _mv_1787.data.lst;
                        {
                            ...
                            if (clause_len > 1) {
                                for (int64_t ci = 0; ci < (clause_len - 1); ci++) {
                                    __auto_type _mv_1788 = ({ __auto_type _lst = clause_items; size_t _idx = (size_t)ci; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    if (_mv_1788.has_value) {
                                        __auto_type clause_elem = _mv_1788.value;
                                        {
    ...
    if (parser_sexpr_is_list(pattern)) {
        if (parser_sexpr_list_len(pattern) > 0) {
            ...
            if (_mv_1790.has_value) {
                __auto_type variant_expr = _mv_1790.value;
                {
                    __auto_type variant_name = parser_sexpr_get_symbol_name(variant_expr);
                    if (!(string_eq(variant_name, SLOP_STR("")))) {
                        if (parser_sexpr_list_len(pattern) > 1) {
                            __auto_type _mv_1791 = parser_sexpr_list_get(pattern, 1);
                            if (_mv_1791.has_value) {
                                __auto_type binding_expr = _mv_1791.value;
                                {
                                    ...
                                    if (!(string_eq(binding_name, SLOP_STR("")))) {
                                        {
                                            ...
                                            if (string_eq(scrutinee_name, SLOP_STR("T"))) {
                                                ...
                                                if ((scrutinee_kind == types_ResolvedTypeKind_rk_option) && string_eq(variant_name, SLOP_STR("some"))) {
                                                    __auto_type _mv_1792 = (*scrutinee_type).inner_type;
                                                    ...
                                                    if (scrutinee_kind == types_ResolvedTypeKind_rk_result) {
                                                        if (string_eq(variant_name, SLOP_STR("ok"))) {
                                                            __auto_type _mv_1793 = (*scrutinee_type).inner_type;
                                                            ...
                                                            __auto_type _mv_1794 = (*scrutinee_type).inner_type2;
                                                            if (_mv_1794.has_value) {
                                                                __auto_type inner2 = _mv_1794.value;
                                                    ...
                                                    } else {
                                                        {
                                                            ...
                                                            if (((int64_t)((payload_types).len)) > 0) {
                                                                if (!(string_eq(binding_name, SLOP_STR("true"))) && !(string_eq(binding_name, SLOP_STR("false")))) {
                                                                    __auto_type _mv_1795 = ({ __auto_type _lst = payload_types; size_t _idx = (size_t)0; slop_option_types_ResolvedType_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                                    if (_mv_1795.has_value) {
                                                                        __auto_type first_type = _mv_1795.value;
                                                                ...
                                                                }
                                                                {
                                                                    ...
                                                                    for (int64_t pi = 2; pi < pat_len; pi++) {
                                                                        __auto_type _mv_1796 = parser_sexpr_list_get(pattern, pi);
                                                                        if (_mv_1796.has_value) {
                                                                            __auto_type extra_binding = _mv_1796.value;
                                                                            {
                                                                                ...
                                                                                if ((!(string_eq(extra_name, SLOP_STR("")))) && (!(string_eq(extra_name, SLOP_STR("_")))) && (!(string_eq(extra_name, SLOP_STR("true")))) && (!(string_eq(extra_name, SLOP_STR("false"))))) {
                                                                                    {
                                                                                        ...
                                                                                        if (type_idx < num_types) {
                                                                                            __auto_type _mv_1797 = ({ __auto_type _lst = payload_types; size_t _idx = (size_t)type_idx; slop_option_types_ResolvedType_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                                                            if (_mv_1797.has_value) {
                                                                                                __auto_type pt = _mv_1797.value;
...
slop_string infer_match_pattern_head(types_SExpr* pattern) {
    ...
    if (parser_sexpr_is_list(pattern)) {
        if (parser_sexpr_list_len(pattern) > 0) {
            __auto_type _mv_1798 = parser_sexpr_list_get(pattern, 0);
            if (_mv_1798.has_value) {
                __auto_type head = _mv_1798.value;
...
uint8_t infer_string_list_contains(slop_list_string names, slop_string name) {
    {
        ...
        uint8_t found = 0;
        while ((i < n) && !(found)) {
            __auto_type _mv_1799 = ({ __auto_type _lst = names; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1799.has_value) {
                __auto_type existing = _mv_1799.value;
        ...
        if ((kind == types_ResolvedTypeKind_rk_union) || (kind == types_ResolvedTypeKind_rk_enum)) {
            {
                ...
                int64_t i = 0;
                while (i < n) {
                    __auto_type _mv_1800 = ({ __auto_type _lst = variants; size_t _idx = (size_t)i; slop_option_types_ResolvedVariant _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_1800.has_value) {
                        __auto_type v = _mv_1800.value;
            ...
            if ((((int64_t)((expected).len)) > 0) && !(string_eq(type_name, SLOP_STR("T")))) {
                {
                    ...
                    while (i < n) {
                        __auto_type _mv_1801 = ({ __auto_type _lst = covered; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_1801.has_value) {
                            __auto_type head = _mv_1801.value;
                    ...
                    if (all_known) {
                        {
                            ...
                            int64_t j = 0;
                            while (j < e_len) {
                                __auto_type _mv_1802 = ({ __auto_type _lst = expected; size_t _idx = (size_t)j; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1802.has_value) {
                                    __auto_type want = _mv_1802.value;
...
types_ResolvedType* infer_infer_match_expr(env_TypeEnv* env, types_SExpr* expr, types_SExprList lst) {
    SLOP_PRE(((env != NULL)), "(!= env nil)");
    {
        ...
        int64_t i = 2;
        while (i < len) {
            __auto_type _mv_1803 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1803.has_value) {
                __auto_type clause = _mv_1803.value;
                __auto_type _mv_1804 = (*clause);
                switch (_mv_1804.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type clause_lst = _mv_1804.data.lst;
                        {
                            __auto_type clause_items = clause_lst.items;
                            __auto_type clause_len = ((int64_t)((clause_items).len));
                            if (clause_len > 0) {
                                __auto_type _mv_1805 = ({ __auto_type _lst = clause_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1805.has_value) {
                                    __auto_type pattern = _mv_1805.value;
                                    {
                            ...
                            if (clause_len > 1) {
                                env_env_push_scope(env);
                                __auto_type _mv_1806 = ({ __auto_type _lst = clause_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1806.has_value) {
                                    __auto_type pattern = _mv_1806.value;
                                    infer_bind_match_pattern(env, scrutinee_type, pattern);
                                } else if (!_mv_1806.has_value) {
                                }
                                for (int64_t bi = 1; bi < (clause_len - 1); bi++) {
                                    __auto_type _mv_1807 = ({ __auto_type _lst = clause_items; size_t _idx = (size_t)bi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    if (_mv_1807.has_value) {
                                        __auto_type body_expr = _mv_1807.value;
                                        {
                                            __auto_type _ = infer_infer_expr(env, body_expr);
                                        }
                                ...
                                __auto_type _mv_1808 = ({ __auto_type _lst = clause_items; size_t _idx = (size_t)(clause_len - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1808.has_value) {
                                    __auto_type body = _mv_1808.value;
                                    {
                                        __auto_type body_type = infer_infer_expr(env, body);
                                        if (!(has_result)) {
                                            result_type = body_type;
...
void infer_check_return_type(env_TypeEnv* env, types_SExpr* fn_form, slop_string fn_name, types_ResolvedType* inferred_type, int64_t fn_line, int64_t fn_col) {
    ...
    __auto_type _mv_1809 = (*fn_form);
    switch (_mv_1809.tag) {
        case types_SExpr_lst:
        {
            __auto_type fn_lst = _mv_1809.data.lst;
            {
                __auto_type items = fn_lst.items;
                __auto_type len = ((int64_t)((items).len));
                for (int64_t i = 3; i < len; i++) {
                    __auto_type _mv_1810 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void infer_check_spec_return_type(env_TypeEnv* env, types_SExpr* spec_form, slop_string fn_name, types_ResolvedType* inferred_type, int64_t fn_line, int64_t fn_col) {
    ...
    __auto_type _mv_1811 = (*spec_form);
    switch (_mv_1811.tag) {
        case types_SExpr_lst:
        {
            __auto_type spec_lst = _mv_1811.data.lst;
            {
                __auto_type spec_items = spec_lst.items;
                __auto_type _mv_1812 = ({ __auto_type _lst = spec_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_1812.has_value) {
                    __auto_type spec_body = _mv_1812.value;
...
void infer_check_spec_body_return(env_TypeEnv* env, types_SExpr* spec_body, slop_string fn_name, types_ResolvedType* inferred_type, int64_t fn_line, int64_t fn_col) {
    ...
    __auto_type _mv_1813 = (*spec_body);
    switch (_mv_1813.tag) {
        case types_SExpr_lst:
        {
            __auto_type body_lst = _mv_1813.data.lst;
            {
                __auto_type body_items = body_lst.items;
                __auto_type body_len = ((int64_t)((body_items).len));
                __auto_type _mv_1814 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)(body_len - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_1814.has_value) {
                    __auto_type ret_expr = _mv_1814.value;
...
void infer_check_return_expr(env_TypeEnv* env, types_SExpr* ret_expr, slop_string fn_name, types_ResolvedType* inferred_type, int64_t fn_line, int64_t fn_col) {
    ...
    __auto_type _mv_1815 = (*ret_expr);
    switch (_mv_1815.tag) {
        case types_SExpr_sym:
        {
            __auto_type ret_sym = _mv_1815.data.sym;
            {
...
void infer_bind_param_from_form(env_TypeEnv* env, types_SExpr* param_form) {
    ...
    if (parser_sexpr_is_list(param_form) && (parser_sexpr_list_len(param_form) >= 2)) {
        __auto_type _mv_1816 = parser_sexpr_list_get(param_form, 0);
        if (_mv_1816.has_value) {
            __auto_type first_expr = _mv_1816.value;
            {
                ...
                if ((string_eq(first_name, SLOP_STR("in"))) || (string_eq(first_name, SLOP_STR("out"))) || (string_eq(first_name, SLOP_STR("mut")))) {
                    if (parser_sexpr_list_len(param_form) >= 3) {
                        __auto_type _mv_1817 = parser_sexpr_list_get(param_form, 1);
...
types_ResolvedType* infer_get_param_type_from_form(env_TypeEnv* env, types_SExpr* param_form) {
    ...
    SLOP_PRE(((param_form != NULL)), "(!= param-form nil)");
    {
        ...
        __auto_type _mv_1818 = parser_sexpr_list_get(param_form, type_pos);
        if (_mv_1818.has_value) {
            __auto_type type_expr = _mv_1818.value;
            {
                __auto_type type_name = parser_sexpr_get_symbol_name(type_expr);
                if (string_eq(type_name, SLOP_STR(""))) {
                    if (parser_sexpr_is_list(type_expr)) {
...
types_ResolvedType* infer_resolve_complex_type_expr(env_TypeEnv* env, types_SExpr* type_expr) {
    ...
    __auto_type _mv_1819 = parser_sexpr_list_get(type_expr, 0);
    if (_mv_1819.has_value) {
        __auto_type head_expr = _mv_1819.value;
        {
            __auto_type head_name = parser_sexpr_get_symbol_name(head_expr);
            if (string_eq(head_name, SLOP_STR("Option"))) {
            ...
            } else if (string_eq(head_name, SLOP_STR("Map"))) {
                {
                    ...
                    if (parser_sexpr_list_len(type_expr) >= 3) {
                        __auto_type _mv_1820 = parser_sexpr_list_get(type_expr, 2);
            ...
            } else if (string_eq(head_name, SLOP_STR("Result"))) {
                {
                    ...
                    if (parser_sexpr_list_len(type_expr) >= 2) {
                        __auto_type _mv_1821 = parser_sexpr_list_get(type_expr, 1);
                        if (_mv_1821.has_value) {
                            __auto_type ok_expr = _mv_1821.value;
                            {
                    ...
                    if (parser_sexpr_list_len(type_expr) >= 3) {
                        __auto_type _mv_1822 = parser_sexpr_list_get(type_expr, 2);
                        if (_mv_1822.has_value) {
                            __auto_type err_expr = _mv_1822.value;
                            {
                ...
                __auto_type _mv_1823 = env_env_lookup_type(env, head_name);
                if (_mv_1823.has_value) {
                    __auto_type t = _mv_1823.value;
                    return t;
...
types_ResolvedType* infer_resolve_option_inner_type(env_TypeEnv* env, types_SExpr* type_expr) {
    ...
    if (parser_sexpr_list_len(type_expr) < 2) {
        ...
        __auto_type _mv_1824 = parser_sexpr_list_get(type_expr, 1);
        if (_mv_1824.has_value) {
            __auto_type inner_expr = _mv_1824.value;
            {
...
types_ResolvedType* infer_resolve_ptr_inner_type(env_TypeEnv* env, types_SExpr* type_expr) {
    ...
    if (parser_sexpr_list_len(type_expr) < 2) {
        ...
        __auto_type _mv_1825 = parser_sexpr_list_get(type_expr, 1);
        if (_mv_1825.has_value) {
            __auto_type inner_expr = _mv_1825.value;
            {
                __auto_type inner_name = parser_sexpr_get_symbol_name(inner_expr);
                if (string_eq(inner_name, SLOP_STR(""))) {
...
types_ResolvedType* infer_resolve_type_lenient(env_TypeEnv* env, slop_string type_name) {
    SLOP_PRE(((env != NULL)), "(!= env nil)");
    __auto_type _mv_1826 = env_env_lookup_type(env, type_name);
...
types_ResolvedType* infer_resolve_simple_type(env_TypeEnv* env, slop_string type_name) {
    SLOP_PRE(((env != NULL)), "(!= env nil)");
    __auto_type _mv_1827 = env_env_lookup_type(env, type_name);
                                ...
                                if (!(string_eq(var_name, SLOP_STR("")))) {
                                    {
                                        ...
                                        __auto_type _mv_1830 = parser_sexpr_list_get(binding_form, (binding_len - 1));
                    ...
                    if (!(string_eq(first_name, SLOP_STR("")))) {
                        {
                            __auto_type binding_len = parser_sexpr_list_len(binding_form);
                            if (binding_len == 3) {
                                __auto_type _mv_1831 = parser_sexpr_list_get(binding_form, 2);
                                ...
                                __auto_type _mv_1832 = parser_sexpr_list_get(binding_form, 1);
                                if (_mv_1832.has_value) {
                                    __auto_type val_expr = _mv_1832.value;
                                    {
                                        __auto_type val_type = infer_infer_expr(env, val_expr);
                                        env_env_bind_var(env, first_name, val_type);
                                    }
...
types_ResolvedType* infer_infer_let_expr(env_TypeEnv* env, types_SExpr* expr) {
    ...
    env_env_push_scope(env);
    if (parser_sexpr_is_list(expr)) {
        __auto_type _mv_1833 = parser_sexpr_list_get(expr, 1);
        if (_mv_1833.has_value) {
            __auto_type bindings_expr = _mv_1833.value;
            if (parser_sexpr_is_list(bindings_expr)) {
                {
                    ...
                    for (int64_t i = 0; i < num_bindings; i++) {
                        __auto_type _mv_1834 = parser_sexpr_list_get(bindings_expr, i);
                        if (_mv_1834.has_value) {
                            __auto_type binding = _mv_1834.value;
        ...
        if (len < 2) {
        ...
        } else {
            {
                ...
                if (is_named && (len < 4)) {
                    ...
                    __auto_type _mv_1835 = parser_sexpr_list_get(expr, size_idx);
                    if (_mv_1835.has_value) {
                        __auto_type size_expr = _mv_1835.value;
                        __auto_type _mv_1836 = (*size_expr);
                        switch (_mv_1836.tag) {
                            case types_SExpr_num:
                            {
                                __auto_type num = _mv_1836.data.num;
                                if (num.int_value <= 0) {
                    ...
                    env_env_bind_var(env, arena_name, env_env_get_arena_type(env));
                    {
                        ...
                        for (int64_t i = body_start; i < len; i++) {
                            __auto_type _mv_1837 = parser_sexpr_list_get(expr, i);
                            if (_mv_1837.has_value) {
                                __auto_type body_expr = _mv_1837.value;
...
slop_string infer_get_fn_name(types_SExpr* fn_form) {
    ...
    if (!(parser_sexpr_is_list(fn_form))) {
        ...
        if (parser_sexpr_list_len(fn_form) < 2) {
            ...
            __auto_type _mv_1838 = parser_sexpr_list_get(fn_form, 1);
...
types_ResolvedType* infer_resolve_hole_type(env_TypeEnv* env, slop_list_types_SExpr_ptr items, int64_t len) {
    ...
    if (len < 2) {
        ...
        if (_mv_1839.has_value) {
            __auto_type type_expr = _mv_1839.value;
            {
                __auto_type type_name = parser_sexpr_get_symbol_name(type_expr);
                if (string_eq(type_name, SLOP_STR(""))) {
                    return env_env_get_unit_type(env);
                } else {
                    __auto_type _mv_1840 = env_env_lookup_type(env, type_name);
                    if (_mv_1840.has_value) {
                        __auto_type t = _mv_1840.value;
                        return t;
...
slop_string infer_get_hole_prompt(slop_list_types_SExpr_ptr items, int64_t len) {
    if (len < 3) {
        ...
        __auto_type _mv_1841 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        if (_mv_1841.has_value) {
            __auto_type prompt_expr = _mv_1841.value;
            __auto_type _mv_1842 = (*prompt_expr);
            switch (_mv_1842.tag) {
                case types_SExpr_str:
                {
                    __auto_type str = _mv_1842.data.str;
                    return str.value;
                }
                default: {
                    return SLOP_STR("(no description)");
...
uint8_t infer_is_c_name_related(slop_list_types_SExpr_ptr items, int64_t idx) {
    __auto_type _mv_1843 = ({ __auto_type _lst = items; size_t _idx = (size_t)idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    if (_mv_1843.has_value) {
        __auto_type item = _mv_1843.value;
        __auto_type _mv_1844 = (*item);
        switch (_mv_1844.tag) {
            case types_SExpr_sym:
            {
                __auto_type sym = _mv_1844.data.sym;
                return string_eq(sym.name, SLOP_STR(":c-name"));
            }
            case types_SExpr_str:
            {
                __auto_type _ = _mv_1844.data.str;
                if (idx > 0) {
                    __auto_type _mv_1845 = ({ __auto_type _lst = items; size_t _idx = (size_t)(idx - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_1845.has_value) {
                        __auto_type prev = _mv_1845.value;
                        __auto_type _mv_1846 = (*prev);
                        switch (_mv_1846.tag) {
                            case types_SExpr_sym:
                            {
                                __auto_type sym = _mv_1846.data.sym;
                                return string_eq(sym.name, SLOP_STR(":c-name"));
                            }
                            default: {
                                return 0;
...
uint8_t infer_is_annotation_expr(types_SExpr* expr) {
    SLOP_PRE(((expr != NULL)), "(!= expr nil)");
    if (parser_sexpr_is_list(expr)) {
        __auto_type _mv_1847 = parser_sexpr_list_get(expr, 0);
        if (_mv_1847.has_value) {
            __auto_type head = _mv_1847.value;
            __auto_type _mv_1848 = (*head);
            switch (_mv_1848.tag) {
                case types_SExpr_sym:
                {
                    __auto_type sym = _mv_1848.data.sym;
...
uint8_t infer_is_checkable_annotation(types_SExpr* expr) {
    if (parser_sexpr_is_list(expr)) {
        __auto_type _mv_1849 = parser_sexpr_list_get(expr, 0);
        if (_mv_1849.has_value) {
            __auto_type head = _mv_1849.value;
            __auto_type _mv_1850 = (*head);
            switch (_mv_1850.tag) {
                case types_SExpr_sym:
                {
        ...
        if (parser_sexpr_is_list(fn_form)) {
            {
                ...
                if (params_len > 2) {
                    __auto_type _mv_1851 = parser_sexpr_list_get(fn_form, 2);
                    if (_mv_1851.has_value) {
                        __auto_type params_expr = _mv_1851.value;
                        if (parser_sexpr_is_list(params_expr)) {
                            {
                                __auto_type num_params = parser_sexpr_list_len(params_expr);
                                for (int64_t k = 0; k < num_params; k++) {
                                    __auto_type _mv_1852 = parser_sexpr_list_get(params_expr, k);
                                    if (_mv_1852.has_value) {
                                        __auto_type param_form = _mv_1852.value;
                                        infer_bind_param_from_form(env, param_form);
    ...
    if (types_resolved_type_is_union(scrutinee_type)) {
        {
            ...
            for (int64_t i = 0; i < num_patterns; i++) {
                __auto_type _mv_1853 = ({ __auto_type _lst = patterns; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_1853.has_value) {
                    __auto_type pattern_case = _mv_1853.value;
                    __auto_type _mv_1854 = (*pattern_case);
                    switch (_mv_1854.tag) {
                        case types_SExpr_lst:
                        {
                            __auto_type pattern_list = _mv_1854.data.lst;
                            if (((int64_t)((pattern_list.items).len)) > 0) {
                                __auto_type _mv_1855 = ({ __auto_type _lst = pattern_list.items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1855.has_value) {
                                    __auto_type pattern_expr = _mv_1855.value;
                                    __auto_type _mv_1856 = (*pattern_expr);
                                    switch (_mv_1856.tag) {
                                        case types_SExpr_lst:
                                        {
                                            __auto_type variant_list = _mv_1856.data.lst;
                                            {
                                                __auto_type variant_items = variant_list.items;
                                                if (((int64_t)((variant_items).len)) > 0) {
                                                    __auto_type _mv_1857 = ({ __auto_type _lst = variant_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_1857.has_value) {
                                                        __auto_type variant_name_expr = _mv_1857.value;
                                                        __auto_type _mv_1858 = (*variant_name_expr);
                                                        switch (_mv_1858.tag) {
                                                            case types_SExpr_sym:
                                                            {
                                                                __auto_type variant_sym = _mv_1858.data.sym;
                                                                {
                                                                        ...
                                                                        if (num_pt > 0) {
                                                                            {
                                                                                ...
                                                                                for (int64_t vi = 1; vi < num_vt; vi++) {
                                                                                    __auto_type _mv_1859 = ({ __auto_type _lst = variant_items; size_t _idx = (size_t)vi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                                                    if (_mv_1859.has_value) {
                                                                                        __auto_type binding_expr = _mv_1859.value;
                                                                                        __auto_type _mv_1860 = (*binding_expr);
                                                                                        switch (_mv_1860.tag) {
                                                                                            case types_SExpr_sym:
                                                                                            {
                                                                                                __auto_type binding_sym = _mv_1860.data.sym;
                                                                                                {
                                                                                                    __auto_type bname = binding_sym.name;
                                                                                                    __auto_type type_idx = (vi - 1);
                                                                                                    if (!(string_eq(bname, SLOP_STR("_"))) && !(string_eq(bname, SLOP_STR("")))) {
                                                                                                        if (type_idx < num_pt) {
                                                                                                            __auto_type _mv_1861 = ({ __auto_type _lst = payload_types; size_t _idx = (size_t)type_idx; slop_option_types_ResolvedType_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                                                                            if (_mv_1861.has_value) {
                                                                                                                __auto_type pt = _mv_1861.value;
                                                                            ...
                                                                            __auto_type _mv_1862 = types_resolved_type_get_variant_index(scrutinee_type, variant_name);
                                                                            if (_mv_1862.has_value) {
                                                                                __auto_type _ = _mv_1862.value;
