...
slop_option_types_ResolvedType_ptr infer_find_binding(slop_list_string bind_names, slop_list_types_ResolvedType_ptr bind_types, slop_string name) {
    {
        ...
        for (int64_t i = 0; i < len; i++) {
            __auto_type _mv_1467 = ({ __auto_type _lst = bind_names; size_t _idx = (size_t)i; slop_option_string _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1467.has_value) {
                __auto_type bn = _mv_1467.value;
                if (string_eq(bn, name)) {
                    __auto_type _mv_1468 = ({ __auto_type _lst = bind_types; size_t _idx = (size_t)i; slop_option_types_ResolvedType_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_1468.has_value) {
                        __auto_type bt = _mv_1468.value;
        ...
        if ((f_kind == types_ResolvedTypeKind_rk_typevar)) {
            {
                ...
                __auto_type _mv_1469 = infer_find_binding(bind_names, bind_types, tv_name);
                if (_mv_1469.has_value) {
                    __auto_type existing = _mv_1469.value;
            ...
            if (((*actual).kind == types_ResolvedTypeKind_rk_ptr)) {
                __auto_type _mv_1470 = (*formal).inner_type;
                if (_mv_1470.has_value) {
                    __auto_type f_inner = _mv_1470.value;
                    __auto_type _mv_1471 = (*actual).inner_type;
                    if (_mv_1471.has_value) {
                        __auto_type a_inner = _mv_1471.value;
            ...
            if (((*actual).kind == types_ResolvedTypeKind_rk_chan)) {
                __auto_type _mv_1472 = (*formal).inner_type;
                if (_mv_1472.has_value) {
                    __auto_type f_inner = _mv_1472.value;
                    __auto_type _mv_1473 = (*actual).inner_type;
                    if (_mv_1473.has_value) {
                        __auto_type a_inner = _mv_1473.value;
                        infer_unify_types(arena, f_inner, a_inner, bind_names, bind_types);
            ...
            if (((*actual).kind == types_ResolvedTypeKind_rk_thread)) {
                __auto_type _mv_1474 = (*formal).inner_type;
                if (_mv_1474.has_value) {
                    __auto_type f_inner = _mv_1474.value;
                    __auto_type _mv_1475 = (*actual).inner_type;
                    if (_mv_1475.has_value) {
                        __auto_type a_inner = _mv_1475.value;
                        infer_unify_types(arena, f_inner, a_inner, bind_names, bind_types);
            ...
            if (((*actual).kind == types_ResolvedTypeKind_rk_list)) {
                __auto_type _mv_1476 = (*formal).inner_type;
                if (_mv_1476.has_value) {
                    __auto_type f_inner = _mv_1476.value;
                    __auto_type _mv_1477 = (*actual).inner_type;
                    if (_mv_1477.has_value) {
                        __auto_type a_inner = _mv_1477.value;
                        infer_unify_types(arena, f_inner, a_inner, bind_names, bind_types);
            ...
            if (((*actual).kind == types_ResolvedTypeKind_rk_option)) {
                __auto_type _mv_1478 = (*formal).inner_type;
                if (_mv_1478.has_value) {
                    __auto_type f_inner = _mv_1478.value;
                    __auto_type _mv_1479 = (*actual).inner_type;
                    if (_mv_1479.has_value) {
                        __auto_type a_inner = _mv_1479.value;
                        infer_unify_types(arena, f_inner, a_inner, bind_names, bind_types);
            ...
            if (((*actual).kind == types_ResolvedTypeKind_rk_result)) {
                __auto_type _mv_1480 = (*formal).inner_type;
                if (_mv_1480.has_value) {
                    __auto_type f_inner = _mv_1480.value;
                    __auto_type _mv_1481 = (*actual).inner_type;
                    if (_mv_1481.has_value) {
                        __auto_type a_inner = _mv_1481.value;
                        infer_unify_types(arena, f_inner, a_inner, bind_names, bind_types);
                    } else if (!_mv_1481.has_value) {
                    }
                } else if (!_mv_1480.has_value) {
                }
                __auto_type _mv_1482 = (*formal).inner_type2;
                if (_mv_1482.has_value) {
                    __auto_type f_inner2 = _mv_1482.value;
                    __auto_type _mv_1483 = (*actual).inner_type2;
                    if (_mv_1483.has_value) {
                        __auto_type a_inner2 = _mv_1483.value;
        ...
        if ((kind == types_ResolvedTypeKind_rk_typevar)) {
            {
                ...
                __auto_type _mv_1484 = infer_find_binding(bind_names, bind_types, tv_name);
                if (_mv_1484.has_value) {
                    __auto_type bound = _mv_1484.value;
                    return bound;
            ...
            __auto_type _mv_1485 = (*t).inner_type;
            ...
            __auto_type _mv_1486 = (*t).inner_type;
            if (_mv_1486.has_value) {
                __auto_type inner = _mv_1486.value;
                {
                    __auto_type new_inner = infer_substitute_type_vars(arena, inner, bind_names, bind_types);
            ...
            __auto_type _mv_1487 = (*t).inner_type;
            ...
            __auto_type _mv_1488 = (*t).inner_type;
            ...
            __auto_type _mv_1489 = (*t).inner_type;
            if (_mv_1489.has_value) {
                __auto_type inner = _mv_1489.value;
                {
                    __auto_type new_inner = infer_substitute_type_vars(arena, inner, bind_names, bind_types);
                    __auto_type inner_name = (*new_inner).name;
        ...
        if (parser_sexpr_is_list(expr)) {
            {
                ...
                }
                {
                    ...
                    for (int64_t i = 0; i < limit; i++) {
                        __auto_type _mv_1490 = parser_sexpr_list_get(expr, (i + 1));
                        if (_mv_1490.has_value) {
                            __auto_type arg_expr = _mv_1490.value;
                            {
                                __auto_type actual_type = infer_infer_expr(env, arg_expr);
                                __auto_type _mv_1491 = ({ __auto_type _lst = params; size_t _idx = (size_t)i; slop_option_types_ParamInfo _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1491.has_value) {
                                    __auto_type param_info = _mv_1491.value;
                                    {
...
void infer_sexpr_set_resolved_type(types_SExpr* expr, types_ResolvedType* t) {
    ...
    switch (_mv_1494.tag) {
        ...
        {
            __auto_type str = _mv_1494.data.str;
...
types_ResolvedType* infer_infer_expr_inner(env_TypeEnv* env, types_SExpr* expr) {
    ...
    SLOP_PRE(((expr != NULL)), "(!= expr nil)");
    {
        ...
        switch (_mv_1495.tag) {
            case types_SExpr_sym:
            {
                __auto_type sym = _mv_1495.data.sym;
                {
                    ...
                    if ((string_eq(name, SLOP_STR("true")) || string_eq(name, SLOP_STR("false")))) {
                        ...
                        __auto_type _mv_1496 = env_env_lookup_var(env, name);
                        if (_mv_1496.has_value) {
                            __auto_type t = _mv_1496.value;
                            return t;
                        } else if (!_mv_1496.has_value) {
                            __auto_type _mv_1497 = env_env_lookup_constant(env, name);
                            if (_mv_1497.has_value) {
                                __auto_type t = _mv_1497.value;
                                return t;
                            } else if (!_mv_1497.has_value) {
                                __auto_type _mv_1498 = env_env_lookup_function(env, name);
                                if (_mv_1498.has_value) {
                                    __auto_type sig = _mv_1498.value;
                                    ...
                                    if (infer_string_contains_char(name, 46)) {
                                        {
                                            ...
                                            __auto_type _mv_1499 = env_env_lookup_var(env, base_name);
                                            if (_mv_1499.has_value) {
                                                __auto_type obj_type = _mv_1499.value;
                                                return infer_check_field_exists(env, obj_type, field_name, line, col);
                                            } else if (!_mv_1499.has_value) {
                                                __auto_type _mv_1500 = env_env_lookup_type(env, base_name);
                                                if (_mv_1500.has_value) {
                                                    __auto_type type_info = _mv_1500.value;
                                                    return type_info;
                                        ...
                                        __auto_type _mv_1501 = env_env_lookup_type(env, name);
                                        if (_mv_1501.has_value) {
                                            __auto_type type_info = _mv_1501.value;
                                            return type_info;
            ...
            case types_SExpr_str:
            {
                __auto_type str = _mv_1495.data.str;
...
types_ResolvedType* infer_infer_list_expr(env_TypeEnv* env, types_SExpr* expr, types_SExprList lst) {
    ...
    SLOP_PRE(((expr != NULL)), "(!= expr nil)");
    {
        ...
        if ((len == 0)) {
            ...
            __auto_type _mv_1502 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
types_ResolvedType* infer_infer_special_form(env_TypeEnv* env, types_SExpr* expr, types_SExprList lst, slop_string op) {
    SLOP_PRE(((env != NULL)), "(!= env nil)");
    {
        ...
        if (string_eq(op, SLOP_STR("if"))) {
            if ((len >= 4)) {
                __auto_type _mv_1504 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_1504.has_value) {
                    __auto_type cond_expr = _mv_1504.value;
                    {
                ...
                if (_mv_1505.has_value) {
                    __auto_type then_expr = _mv_1505.value;
                    {
                        __auto_type then_type = infer_infer_expr(env, then_expr);
                        __auto_type _mv_1506 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_1506.has_value) {
                            __auto_type else_expr = _mv_1506.value;
                            {
            ...
            if ((len > 1)) {
                __auto_type _mv_1507 = ({ __auto_type _lst = items; size_t _idx = (size_t)(len - 1); slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_1507.has_value) {
                    __auto_type last = _mv_1507.value;
            ...
            if ((len >= 2)) {
                ...
                if (_mv_1508.has_value) {
                    __auto_type binding_form = _mv_1508.value;
                    if (parser_sexpr_is_list(binding_form)) {
                        {
                            __auto_type bind_len = parser_sexpr_list_len(binding_form);
                            if ((bind_len >= 3)) {
                                __auto_type _mv_1509 = parser_sexpr_list_get(binding_form, 0);
                                if (_mv_1509.has_value) {
                                    __auto_type var_expr = _mv_1509.value;
                                    {
                                        ...
                                        if (!(string_eq(var_name, SLOP_STR("")))) {
                                            ...
                                            __auto_type _mv_1510 = parser_sexpr_list_get(binding_form, 1);
                                            if (_mv_1510.has_value) {
                                                __auto_type start_expr = _mv_1510.value;
                                                {
                                                    __auto_type _ = infer_infer_expr(env, start_expr);
                                                }
                                            } else if (!_mv_1510.has_value) {
                                            }
                                            __auto_type _mv_1511 = parser_sexpr_list_get(binding_form, 2);
                                            if (_mv_1511.has_value) {
                                                __auto_type end_expr = _mv_1511.value;
                                                {
            ...
            if ((len >= 3)) {
                __auto_type _mv_1512 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_1512.has_value) {
                    __auto_type binding_form = _mv_1512.value;
                    if (parser_sexpr_is_list(binding_form)) {
                        {
                            __auto_type bind_len = parser_sexpr_list_len(binding_form);
                            if ((bind_len >= 2)) {
                                __auto_type _mv_1513 = parser_sexpr_list_get(binding_form, 0);
                                if (_mv_1513.has_value) {
                                    __auto_type var_expr = _mv_1513.value;
                                    {
                                        __auto_type var_name = parser_sexpr_get_symbol_name(var_expr);
                                        if (string_eq(var_name, SLOP_STR(""))) {
                                            return env_env_get_unit_type(env);
                                        } else {
                                            __auto_type _mv_1514 = parser_sexpr_list_get(binding_form, 1);
                                            if (_mv_1514.has_value) {
                                                __auto_type coll_expr = _mv_1514.value;
                                                {
            ...
            env_env_push_scope(env);
            if ((len >= 2)) {
                __auto_type _mv_1515 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_1515.has_value) {
                    __auto_type params_expr = _mv_1515.value;
            ...
            if ((len >= 4)) {
                __auto_type _mv_1516 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_1516.has_value) {
                    __auto_type val_expr = _mv_1516.value;
                    {
                ...
                __auto_type _mv_1517 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_1517.has_value) {
                    __auto_type val_expr = _mv_1517.value;
                    {
                        __auto_type _ = infer_infer_expr(env, val_expr);
                    }
            ...
            if ((len >= 2)) {
                ...
                if (_mv_1518.has_value) {
                    __auto_type ret_expr = _mv_1518.value;
                    {
            ...
            if ((len >= 2)) {
                __auto_type _mv_1521 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_1521.has_value) {
                    __auto_type inner_expr = _mv_1521.value;
                    {
            ...
            if ((len >= 2)) {
                __auto_type _mv_1522 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_1522.has_value) {
                    __auto_type type_expr = _mv_1522.value;
                    {
                        ...
                        if (string_eq(type_name, SLOP_STR(""))) {
                            if (parser_sexpr_is_list(type_expr)) {
                                __auto_type _mv_1523 = parser_sexpr_list_get(type_expr, 0);
                                if (_mv_1523.has_value) {
                                    __auto_type head_expr = _mv_1523.value;
                                    {
                            ...
                            __auto_type _mv_1524 = env_env_lookup_type(env, type_name);
                            if (_mv_1524.has_value) {
                                __auto_type t = _mv_1524.value;
                                return t;
            ...
            if ((len >= 2)) {
                __auto_type _mv_1525 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_1525.has_value) {
                    __auto_type variant_expr = _mv_1525.value;
                    {
                        ...
                        if (string_eq(variant_name, SLOP_STR(""))) {
                            ...
                            __auto_type _mv_1526 = env_env_lookup_variant(env, variant_name);
                            if (_mv_1526.has_value) {
                                __auto_type enum_name = _mv_1526.value;
                                __auto_type _mv_1527 = env_env_lookup_type(env, enum_name);
                                if (_mv_1527.has_value) {
                                    __auto_type enum_type = _mv_1527.value;
                                    return enum_type;
            ...
            if ((len >= 2)) {
                __auto_type _mv_1528 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_1528.has_value) {
                    __auto_type inner_expr = _mv_1528.value;
                    {
                        __auto_type inner_type = infer_infer_expr(env, inner_expr);
            ...
            for (int64_t fi = 2; fi < len; fi++) {
                __auto_type _mv_1529 = ({ __auto_type _lst = items; size_t _idx = (size_t)fi; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_1529.has_value) {
                    __auto_type field_pair = _mv_1529.value;
                    if ((parser_sexpr_is_list(field_pair) && (parser_sexpr_list_len(field_pair) >= 2))) {
                        __auto_type _mv_1530 = parser_sexpr_list_get(field_pair, 1);
                        if (_mv_1530.has_value) {
                            __auto_type val_expr = _mv_1530.value;
                            {
                                __auto_type _ = infer_infer_expr(env, val_expr);
                            }
            ...
            if ((len >= 2)) {
                __auto_type _mv_1531 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_1531.has_value) {
                    __auto_type type_expr = _mv_1531.value;
                    {
                        __auto_type type_name = parser_sexpr_get_symbol_name(type_expr);
                        if (string_eq(type_name, SLOP_STR(""))) {
                            return env_env_get_unit_type(env);
                        } else {
                            __auto_type _mv_1532 = env_env_lookup_type(env, type_name);
                            if (_mv_1532.has_value) {
                                __auto_type t = _mv_1532.value;
                                return t;
            ...
            if ((len >= 4)) {
                __auto_type _mv_1533 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_1533.has_value) {
                    __auto_type val_expr = _mv_1533.value;
                    {
                        __auto_type _ = infer_infer_expr(env, val_expr);
                    }
            ...
            if ((len >= 2)) {
                __auto_type _mv_1534 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_1534.has_value) {
                    __auto_type type_expr = _mv_1534.value;
                    {
                        __auto_type type_name = parser_sexpr_get_symbol_name(type_expr);
                        if (string_eq(type_name, SLOP_STR(""))) {
                            return env_env_get_unit_type(env);
                        } else {
                            __auto_type _mv_1535 = env_env_lookup_type(env, type_name);
                            if (_mv_1535.has_value) {
                                __auto_type t = _mv_1535.value;
                                return t;
            ...
            __auto_type _mv_1536 = env_env_lookup_function(env, op);
            if (_mv_1536.has_value) {
                ...
                __auto_type _mv_1537 = env_env_lookup_type(env, op);
                if (_mv_1537.has_value) {
                    __auto_type the_type = _mv_1537.value;
                    return the_type;
                    ...
                    if (string_eq(op, SLOP_STR("list-get"))) {
                        ...
                        if ((len < 3)) {
                            ...
                            __auto_type _mv_1540 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_1540.has_value) {
                                __auto_type type_expr = _mv_1540.value;
                                {
                                    __auto_type type_name = parser_sexpr_get_symbol_name(type_expr);
                                    if (string_eq(type_name, SLOP_STR(""))) {
                                        return env_env_get_int_type(env);
                                    } else {
                                        __auto_type _mv_1541 = env_env_lookup_type(env, type_name);
                                        if (_mv_1541.has_value) {
                                            __auto_type resolved = _mv_1541.value;
                    ...
                    } else if (string_eq(op, SLOP_STR("ok"))) {
                        {
                            ...
                            if ((len >= 2)) {
                                __auto_type _mv_1543 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1543.has_value) {
                                    __auto_type val_expr = _mv_1543.value;
                                    {
                    ...
                    } else if (string_eq(op, SLOP_STR("error"))) {
                        {
                            ...
                            if ((len >= 2)) {
                                ...
                                if (_mv_1544.has_value) {
                                    __auto_type val_expr = _mv_1544.value;
                                    {
                                        __auto_type val_type = infer_infer_expr(env, val_expr);
                        ...
                        if ((len >= 2)) {
                            ...
                            if (_mv_1545.has_value) {
                                __auto_type ptr_expr = _mv_1545.value;
                                {
                                    __auto_type ptr_type = infer_infer_expr(env, ptr_expr);
                                    if (types_resolved_type_is_pointer(ptr_type)) {
                                        __auto_type _mv_1546 = (*ptr_type).inner_type;
                        ...
                        infer_check_builtin_args(env, SLOP_STR("map-new"), 3, (len - 1), line, col);
                        {
                            ...
                            if ((len >= 3)) {
                                __auto_type _mv_1547 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1547.has_value) {
                                    __auto_type type_expr = _mv_1547.value;
                                    {
                                        __auto_type type_name = parser_sexpr_get_symbol_name(type_expr);
                                        if (!(string_eq(type_name, SLOP_STR("")))) {
                                            __auto_type _mv_1548 = env_env_lookup_type(env, type_name);
                                            if (_mv_1548.has_value) {
                                                __auto_type t = _mv_1548.value;
                                                key_type = t;
                            ...
                            if ((len >= 4)) {
                                __auto_type _mv_1549 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1549.has_value) {
                                    __auto_type type_expr = _mv_1549.value;
                                    {
                                        __auto_type type_name = parser_sexpr_get_symbol_name(type_expr);
                                        if (!(string_eq(type_name, SLOP_STR("")))) {
                                            __auto_type _mv_1550 = env_env_lookup_type(env, type_name);
                                            if (_mv_1550.has_value) {
                                                __auto_type t = _mv_1550.value;
                                                val_type = t;
                        ...
                        infer_check_builtin_args(env, SLOP_STR("map-get"), 2, (len - 1), line, col);
                        {
                            types_ResolvedType* val_type = NULL;
                            if ((len >= 2)) {
                                __auto_type _mv_1551 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1551.has_value) {
                                    __auto_type map_expr = _mv_1551.value;
                                    {
                                        __auto_type map_type = infer_infer_expr(env, map_expr);
                                        __auto_type _mv_1552 = (*map_type).inner_type2;
                                        if (_mv_1552.has_value) {
                                            __auto_type inner = _mv_1552.value;
                                            val_type = inner;
                        ...
                        if ((len >= 2)) {
                            __auto_type _mv_1553 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_1553.has_value) {
                                __auto_type map_expr = _mv_1553.value;
                                {
                                    __auto_type map_type = infer_infer_expr(env, map_expr);
                        ...
                        infer_check_builtin_args(env, SLOP_STR("map-keys"), 1, (len - 1), line, col);
                        {
                            ...
                            types_ResolvedType* key_type = NULL;
                            if ((len >= 2)) {
                                __auto_type _mv_1554 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1554.has_value) {
                                    __auto_type map_expr = _mv_1554.value;
                                    {
                                        __auto_type map_type = infer_infer_expr(env, map_expr);
                                        __auto_type _mv_1555 = (*map_type).inner_type;
                        ...
                        infer_check_builtin_args(env, SLOP_STR("set-new"), 2, (len - 1), line, col);
                        {
                            ...
                            types_ResolvedType* elem_type = NULL;
                            if ((len >= 3)) {
                                __auto_type _mv_1556 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1556.has_value) {
                                    __auto_type type_expr = _mv_1556.value;
                                    {
                                        __auto_type type_name = parser_sexpr_get_symbol_name(type_expr);
                                        if (!(string_eq(type_name, SLOP_STR("")))) {
                                            __auto_type _mv_1557 = env_env_lookup_type(env, type_name);
                                            if (_mv_1557.has_value) {
                                                __auto_type t = _mv_1557.value;
                                                elem_type = t;
                        ...
                        infer_check_builtin_args(env, SLOP_STR("set-elements"), 1, (len - 1), line, col);
                        {
                            ...
                            types_ResolvedType* elem_type = NULL;
                            if ((len >= 2)) {
                                __auto_type _mv_1558 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1558.has_value) {
                                    __auto_type set_expr = _mv_1558.value;
                                    {
                                        __auto_type set_type = infer_infer_expr(env, set_expr);
                                        __auto_type _mv_1559 = (*set_type).inner_type;
                        ...
                        {
                            __auto_type arena = env_env_arena(env);
                            __auto_type _mv_1560 = env_env_lookup_variant(env, op);
                            if (_mv_1560.has_value) {
                                __auto_type parent_type = _mv_1560.value;
                                {
                                ...
                                if ((strlib_starts_with(op, SLOP_STR("set-")) || (strlib_starts_with(op, SLOP_STR("map-")) || (strlib_starts_with(op, SLOP_STR("list-")) || strlib_starts_with(op, SLOP_STR("arena-")))))) {
                                    ...
                                    __auto_type _mv_1561 = env_env_lookup_var(env, op);
                                    if (_mv_1561.has_value) {
                                        __auto_type var_type = _mv_1561.value;
                                        infer_infer_builtin_args(env, expr);
                                        return var_type;
...
void infer_check_single_arg(env_TypeEnv* env, types_FnSignature* sig, types_SExpr* expr, int64_t arg_idx, int64_t line, int64_t col) {
    ...
    SLOP_PRE(((sig != NULL)), "(!= sig nil)");
    {
        ...
        __auto_type fn_name = (*sig).name;
        __auto_type arena = env_env_arena(env);
        __auto_type _mv_1562 = ({ __auto_type _lst = params; size_t _idx = (size_t)arg_idx; slop_option_types_ParamInfo _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        if (_mv_1562.has_value) {
            __auto_type param_info = _mv_1562.value;
            {
                __auto_type expected_type = param_info.param_type;
                __auto_type _mv_1563 = parser_sexpr_list_get(expr, (arg_idx + 1));
                if (_mv_1563.has_value) {
                    __auto_type arg_expr = _mv_1563.value;
                    {
                        __auto_type actual_type = infer_infer_expr(env, arg_expr);
    ...
    if (parser_sexpr_is_list(expr)) {
        {
            ...
            for (int64_t i = 1; i < len; i++) {
                __auto_type _mv_1564 = parser_sexpr_list_get(expr, i);
                if (_mv_1564.has_value) {
                    __auto_type arg_expr = _mv_1564.value;
                    {
    ...
    if (parser_sexpr_is_list(expr)) {
        {
            ...
            for (int64_t i = start_idx; i < len; i++) {
                __auto_type _mv_1565 = parser_sexpr_list_get(expr, i);
                if (_mv_1565.has_value) {
                    __auto_type body_expr = _mv_1565.value;
                    {
    ...
    SLOP_PRE(((env != NULL)), "(!= env nil)");
    {
        ...
        if ((len < 3)) {
            ...
            if (!_mv_1566.has_value) {
                ...
                __auto_type obj_expr = _mv_1566.value;
                {
                    __auto_type obj_type = infer_infer_expr(env, obj_expr);
                    __auto_type _mv_1567 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (!_mv_1567.has_value) {
                        return env_env_get_unit_type(env);
                    } else if (_mv_1567.has_value) {
                        __auto_type field_expr = _mv_1567.value;
                        __auto_type _mv_1568 = (*field_expr);
                        switch (_mv_1568.tag) {
                            case types_SExpr_sym:
                            {
                                __auto_type field_sym = _mv_1568.data.sym;
                                {
...
types_ResolvedType* infer_check_field_exists(env_TypeEnv* env, types_ResolvedType* obj_type, slop_string field_name, int64_t line, int64_t col) {
    ...
    SLOP_PRE(((obj_type != NULL)), "(!= obj-type nil)");
    {
        ...
        if (types_resolved_type_is_record(obj_type)) {
            __auto_type _mv_1569 = types_resolved_type_get_field_type(obj_type, field_name);
            if (_mv_1569.has_value) {
                __auto_type field_type = _mv_1569.value;
                return field_type;
...
types_ResolvedType* infer_infer_cond_expr(env_TypeEnv* env, types_SExpr* expr, types_SExprList lst) {
    SLOP_PRE(((env != NULL)), "(!= env nil)");
    {
        ...
        __auto_type i = 1;
        while ((i < len)) {
            __auto_type _mv_1570 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1570.has_value) {
                __auto_type clause = _mv_1570.value;
                __auto_type _mv_1571 = (*clause);
                switch (_mv_1571.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type clause_lst = _mv_1571.data.lst;
                        {
                            ...
                            if ((clause_len > 1)) {
                                ...
                                __auto_type _mv_1572 = ({ __auto_type _lst = clause_items; size_t _idx = (size_t)(clause_len - 1); slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1572.has_value) {
                                    __auto_type body = _mv_1572.value;
                                    {
...
void infer_bind_match_pattern(env_TypeEnv* env, types_ResolvedType* scrutinee_type, types_SExpr* pattern) {
    ...
    if (parser_sexpr_is_list(pattern)) {
        if ((parser_sexpr_list_len(pattern) > 0)) {
            __auto_type _mv_1573 = parser_sexpr_list_get(pattern, 0);
            if (_mv_1573.has_value) {
                __auto_type variant_expr = _mv_1573.value;
                {
                    __auto_type variant_name = parser_sexpr_get_symbol_name(variant_expr);
                    if (!(string_eq(variant_name, SLOP_STR("")))) {
                        if ((parser_sexpr_list_len(pattern) > 1)) {
                            __auto_type _mv_1574 = parser_sexpr_list_get(pattern, 1);
                            if (_mv_1574.has_value) {
                                __auto_type binding_expr = _mv_1574.value;
                                {
                                    ...
                                    if (!(string_eq(binding_name, SLOP_STR("")))) {
                                        {
                                            ...
                                            if (string_eq(scrutinee_name, SLOP_STR("T"))) {
                                                ...
                                                if (((scrutinee_kind == types_ResolvedTypeKind_rk_option) && string_eq(variant_name, SLOP_STR("some")))) {
                                                    __auto_type _mv_1575 = (*scrutinee_type).inner_type;
                                                    ...
                                                    if ((scrutinee_kind == types_ResolvedTypeKind_rk_result)) {
                                                        if (string_eq(variant_name, SLOP_STR("ok"))) {
                                                            __auto_type _mv_1576 = (*scrutinee_type).inner_type;
                                                            if (_mv_1576.has_value) {
                                                                __auto_type inner = _mv_1576.value;
                                                                env_env_bind_var(env, binding_name, inner);
                                                            } else if (!_mv_1576.has_value) {
                                                                env_env_bind_var(env, binding_name, env_env_get_generic_type(env));
                                                            }
                                                        } else if (string_eq(variant_name, SLOP_STR("error"))) {
                                                            __auto_type _mv_1577 = (*scrutinee_type).inner_type2;
                                                            if (_mv_1577.has_value) {
                                                                __auto_type inner2 = _mv_1577.value;
                                                        ...
                                                        __auto_type _mv_1578 = types_resolved_type_get_variant_payload(scrutinee_type, variant_name);
                                                        if (_mv_1578.has_value) {
                                                            __auto_type payload_type = _mv_1578.value;
...
types_ResolvedType* infer_infer_match_expr(env_TypeEnv* env, types_SExpr* expr, types_SExprList lst) {
    SLOP_PRE(((env != NULL)), "(!= env nil)");
    {
        ...
        __auto_type i = 2;
        while ((i < len)) {
            __auto_type _mv_1579 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1579.has_value) {
                __auto_type clause = _mv_1579.value;
                __auto_type _mv_1580 = (*clause);
                switch (_mv_1580.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type clause_lst = _mv_1580.data.lst;
                        {
                            __auto_type clause_items = clause_lst.items;
                            __auto_type clause_len = ((int64_t)((clause_items).len));
                            if ((clause_len > 1)) {
                                env_env_push_scope(env);
                                __auto_type _mv_1581 = ({ __auto_type _lst = clause_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1581.has_value) {
                                    __auto_type pattern = _mv_1581.value;
                                ...
                                __auto_type _mv_1582 = ({ __auto_type _lst = clause_items; size_t _idx = (size_t)(clause_len - 1); slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1582.has_value) {
                                    __auto_type body = _mv_1582.value;
                                    {
                                        __auto_type body_type = infer_infer_expr(env, body);
                                        if (!(has_result)) {
                                            result_type = body_type;
...
void infer_check_return_type(env_TypeEnv* env, types_SExpr* fn_form, slop_string fn_name, types_ResolvedType* inferred_type, int64_t fn_line, int64_t fn_col) {
    ...
    __auto_type _mv_1583 = (*fn_form);
    switch (_mv_1583.tag) {
        case types_SExpr_lst:
        {
            __auto_type fn_lst = _mv_1583.data.lst;
            {
...
void infer_check_spec_return_type(env_TypeEnv* env, types_SExpr* spec_form, slop_string fn_name, types_ResolvedType* inferred_type, int64_t fn_line, int64_t fn_col) {
    ...
    __auto_type _mv_1584 = (*spec_form);
    switch (_mv_1584.tag) {
        case types_SExpr_lst:
        {
            __auto_type spec_lst = _mv_1584.data.lst;
            {
                __auto_type spec_items = spec_lst.items;
                __auto_type _mv_1585 = ({ __auto_type _lst = spec_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_1585.has_value) {
                    __auto_type spec_body = _mv_1585.value;
...
void infer_check_spec_body_return(env_TypeEnv* env, types_SExpr* spec_body, slop_string fn_name, types_ResolvedType* inferred_type, int64_t fn_line, int64_t fn_col) {
    ...
    __auto_type _mv_1586 = (*spec_body);
    switch (_mv_1586.tag) {
        case types_SExpr_lst:
        {
            __auto_type body_lst = _mv_1586.data.lst;
            {
                __auto_type body_items = body_lst.items;
                __auto_type body_len = ((int64_t)((body_items).len));
                __auto_type _mv_1587 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)(body_len - 1); slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_1587.has_value) {
                    __auto_type ret_expr = _mv_1587.value;
...
void infer_check_return_expr(env_TypeEnv* env, types_SExpr* ret_expr, slop_string fn_name, types_ResolvedType* inferred_type, int64_t fn_line, int64_t fn_col) {
    ...
    __auto_type _mv_1588 = (*ret_expr);
    switch (_mv_1588.tag) {
        case types_SExpr_sym:
        {
            __auto_type ret_sym = _mv_1588.data.sym;
            {
...
void infer_bind_param_from_form(env_TypeEnv* env, types_SExpr* param_form) {
    ...
    if ((parser_sexpr_is_list(param_form) && (parser_sexpr_list_len(param_form) >= 2))) {
        __auto_type _mv_1589 = parser_sexpr_list_get(param_form, 0);
        if (_mv_1589.has_value) {
            __auto_type first_expr = _mv_1589.value;
            {
                ...
                if (((string_eq(first_name, SLOP_STR("in"))) || (string_eq(first_name, SLOP_STR("out"))) || (string_eq(first_name, SLOP_STR("mut"))))) {
                    if ((parser_sexpr_list_len(param_form) >= 3)) {
                        __auto_type _mv_1590 = parser_sexpr_list_get(param_form, 1);
...
types_ResolvedType* infer_get_param_type_from_form(env_TypeEnv* env, types_SExpr* param_form) {
    ...
    SLOP_PRE(((param_form != NULL)), "(!= param-form nil)");
    {
        ...
        __auto_type _mv_1591 = parser_sexpr_list_get(param_form, type_pos);
...
types_ResolvedType* infer_resolve_complex_type_expr(env_TypeEnv* env, types_SExpr* type_expr) {
    ...
    __auto_type _mv_1592 = parser_sexpr_list_get(type_expr, 0);
    if (_mv_1592.has_value) {
        __auto_type head_expr = _mv_1592.value;
        {
            __auto_type head_name = parser_sexpr_get_symbol_name(head_expr);
            if (string_eq(head_name, SLOP_STR("Option"))) {
            ...
            } else if (string_eq(head_name, SLOP_STR("Map"))) {
                {
                    ...
                    if ((parser_sexpr_list_len(type_expr) >= 3)) {
                        __auto_type _mv_1593 = parser_sexpr_list_get(type_expr, 2);
                        if (_mv_1593.has_value) {
                            __auto_type val_expr = _mv_1593.value;
                            {
            ...
            } else if (string_eq(head_name, SLOP_STR("Result"))) {
                {
                    ...
                    if ((parser_sexpr_list_len(type_expr) >= 2)) {
                        __auto_type _mv_1594 = parser_sexpr_list_get(type_expr, 1);
                        if (_mv_1594.has_value) {
                            __auto_type ok_expr = _mv_1594.value;
                            {
                    ...
                    if ((parser_sexpr_list_len(type_expr) >= 3)) {
                        __auto_type _mv_1595 = parser_sexpr_list_get(type_expr, 2);
                        if (_mv_1595.has_value) {
                            __auto_type err_expr = _mv_1595.value;
                            {
                ...
                __auto_type _mv_1596 = env_env_lookup_type(env, head_name);
                if (_mv_1596.has_value) {
                    __auto_type t = _mv_1596.value;
                    return t;
...
types_ResolvedType* infer_resolve_option_inner_type(env_TypeEnv* env, types_SExpr* type_expr) {
    ...
    if ((parser_sexpr_list_len(type_expr) < 2)) {
        ...
        __auto_type _mv_1597 = parser_sexpr_list_get(type_expr, 1);
        if (_mv_1597.has_value) {
            __auto_type inner_expr = _mv_1597.value;
            {
...
types_ResolvedType* infer_resolve_ptr_inner_type(env_TypeEnv* env, types_SExpr* type_expr) {
    ...
    if ((parser_sexpr_list_len(type_expr) < 2)) {
        ...
        __auto_type _mv_1598 = parser_sexpr_list_get(type_expr, 1);
        if (_mv_1598.has_value) {
            __auto_type inner_expr = _mv_1598.value;
            {
                __auto_type inner_name = parser_sexpr_get_symbol_name(inner_expr);
                if (string_eq(inner_name, SLOP_STR(""))) {
...
types_ResolvedType* infer_resolve_type_lenient(env_TypeEnv* env, slop_string type_name) {
    SLOP_PRE(((env != NULL)), "(!= env nil)");
    __auto_type _mv_1599 = env_env_lookup_type(env, type_name);
    if (_mv_1599.has_value) {
        __auto_type t = _mv_1599.value;
        return t;
...
types_ResolvedType* infer_resolve_simple_type(env_TypeEnv* env, slop_string type_name) {
    SLOP_PRE(((env != NULL)), "(!= env nil)");
    __auto_type _mv_1600 = env_env_lookup_type(env, type_name);
    if (_mv_1600.has_value) {
        __auto_type t = _mv_1600.value;
        return t;
...
void infer_bind_let_binding(env_TypeEnv* env, types_SExpr* binding_form) {
    ...
    if ((parser_sexpr_is_list(binding_form) && (parser_sexpr_list_len(binding_form) >= 2))) {
        __auto_type _mv_1601 = parser_sexpr_list_get(binding_form, 0);
            ...
            __auto_type first_expr = _mv_1601.value;
            {
                ...
                if (string_eq(first_name, SLOP_STR("mut"))) {
                    if ((parser_sexpr_list_len(binding_form) >= 3)) {
                        __auto_type _mv_1602 = parser_sexpr_list_get(binding_form, 1);
                                ...
                                if (!(string_eq(var_name, SLOP_STR("")))) {
                                    {
                                        ...
                                        __auto_type _mv_1603 = parser_sexpr_list_get(binding_form, (binding_len - 1));
                    ...
                    if (!(string_eq(first_name, SLOP_STR("")))) {
                        {
                            ...
                            if ((binding_len == 3)) {
                                ...
                                if (_mv_1604.has_value) {
                                    __auto_type val_expr = _mv_1604.value;
                                    {
                                        __auto_type val_type = infer_infer_expr(env, val_expr);
                                ...
                                __auto_type _mv_1605 = parser_sexpr_list_get(binding_form, 1);
...
types_ResolvedType* infer_infer_let_expr(env_TypeEnv* env, types_SExpr* expr) {
    ...
    env_env_push_scope(env);
    if (parser_sexpr_is_list(expr)) {
        __auto_type _mv_1606 = parser_sexpr_list_get(expr, 1);
        if (_mv_1606.has_value) {
            __auto_type bindings_expr = _mv_1606.value;
        ...
        if ((len < 2)) {
        ...
        } else {
            {
                ...
                if ((is_named && (len < 4))) {
                    ...
                    __auto_type _mv_1607 = parser_sexpr_list_get(expr, size_idx);
                    if (_mv_1607.has_value) {
                        __auto_type size_expr = _mv_1607.value;
                        __auto_type _mv_1608 = (*size_expr);
                        switch (_mv_1608.tag) {
                            case types_SExpr_num:
                            {
                                __auto_type num = _mv_1608.data.num;
                                if ((num.int_value <= 0)) {
                    ...
                    env_env_bind_var(env, arena_name, env_env_get_arena_type(env));
                    {
                        ...
                        for (int64_t i = body_start; i < len; i++) {
                            __auto_type _mv_1609 = parser_sexpr_list_get(expr, i);
...
slop_string infer_get_fn_name(types_SExpr* fn_form) {
    ...
    if (!(parser_sexpr_is_list(fn_form))) {
        ...
        if ((parser_sexpr_list_len(fn_form) < 2)) {
            ...
            __auto_type _mv_1610 = parser_sexpr_list_get(fn_form, 1);
        ...
        if (_mv_1611.has_value) {
            __auto_type type_expr = _mv_1611.value;
            {
                ...
                if (string_eq(type_name, SLOP_STR(""))) {
                    ...
                    __auto_type _mv_1612 = env_env_lookup_type(env, type_name);
...
slop_string infer_get_hole_prompt(slop_list_types_SExpr_ptr items, int64_t len) {
    if ((len < 3)) {
        ...
        if (_mv_1613.has_value) {
            __auto_type prompt_expr = _mv_1613.value;
            __auto_type _mv_1614 = (*prompt_expr);
            switch (_mv_1614.tag) {
                case types_SExpr_str:
                {
                    __auto_type str = _mv_1614.data.str;
                    return str.value;
                }
                default: {
                    return SLOP_STR("(no description)");
...
uint8_t infer_is_c_name_related(slop_list_types_SExpr_ptr items, int64_t idx) {
    __auto_type _mv_1615 = ({ __auto_type _lst = items; size_t _idx = (size_t)idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    if (_mv_1615.has_value) {
        __auto_type item = _mv_1615.value;
        __auto_type _mv_1616 = (*item);
        switch (_mv_1616.tag) {
            case types_SExpr_sym:
            {
            ...
            case types_SExpr_str:
            {
                __auto_type _ = _mv_1616.data.str;
                if ((idx > 0)) {
                    __auto_type _mv_1617 = ({ __auto_type _lst = items; size_t _idx = (size_t)(idx - 1); slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_1617.has_value) {
                        __auto_type prev = _mv_1617.value;
                        __auto_type _mv_1618 = (*prev);
                        switch (_mv_1618.tag) {
                            case types_SExpr_sym:
                            {
...
uint8_t infer_is_annotation_expr(types_SExpr* expr) {
    SLOP_PRE(((expr != NULL)), "(!= expr nil)");
    if (parser_sexpr_is_list(expr)) {
        __auto_type _mv_1619 = parser_sexpr_list_get(expr, 0);
        ...
        if (parser_sexpr_is_list(fn_form)) {
            {
                ...
                if ((params_len > 2)) {
                    __auto_type _mv_1621 = parser_sexpr_list_get(fn_form, 2);
                    if (_mv_1621.has_value) {
                        __auto_type params_expr = _mv_1621.value;
                        if (parser_sexpr_is_list(params_expr)) {
                            {
                                __auto_type num_params = parser_sexpr_list_len(params_expr);
                                ({ for (int64_t k = 0; k < num_params; k++) { ({ __auto_type _mv = parser_sexpr_list_get(params_expr, k); if (_mv.has_value) { __auto_type param_form = _mv.value; infer_bind_param_from_form(env, param_form); } else { ({ (void)0; }); } (void)0; }); } 0; });
    ...
    if (types_resolved_type_is_union(scrutinee_type)) {
        {
            ...
            for (int64_t i = 0; i < num_patterns; i++) {
                __auto_type _mv_1622 = ({ __auto_type _lst = patterns; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_1622.has_value) {
                    __auto_type pattern_case = _mv_1622.value;
                    __auto_type _mv_1623 = (*pattern_case);
                    switch (_mv_1623.tag) {
                        case types_SExpr_lst:
                        {
                            __auto_type pattern_list = _mv_1623.data.lst;
                            if ((((int64_t)((pattern_list.items).len)) > 0)) {
                                __auto_type _mv_1624 = ({ __auto_type _lst = pattern_list.items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1624.has_value) {
                                    __auto_type pattern_expr = _mv_1624.value;
                                    __auto_type _mv_1625 = (*pattern_expr);
                                    switch (_mv_1625.tag) {
                                        case types_SExpr_lst:
                                        {
                                            __auto_type variant_list = _mv_1625.data.lst;
                                            {
                                                __auto_type variant_items = variant_list.items;
                                                if ((((int64_t)((variant_items).len)) > 0)) {
                                                    __auto_type _mv_1626 = ({ __auto_type _lst = variant_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_1626.has_value) {
                                                        __auto_type variant_name_expr = _mv_1626.value;
                                                        __auto_type _mv_1627 = (*variant_name_expr);
                                                        switch (_mv_1627.tag) {
                                                            case types_SExpr_sym:
                                                            {
                                                                __auto_type variant_sym = _mv_1627.data.sym;
                                                                {
                                                                    __auto_type variant_name = variant_sym.name;
                                                                    __auto_type _mv_1628 = types_resolved_type_get_variant_payload(scrutinee_type, variant_name);
                                                                    if (_mv_1628.has_value) {
                                                                        __auto_type payload_type = _mv_1628.value;
                                                                        if ((((int64_t)((variant_items).len)) > 1)) {
                                                                            __auto_type _mv_1629 = ({ __auto_type _lst = variant_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                                            if (_mv_1629.has_value) {
                                                                                __auto_type binding_expr = _mv_1629.value;
                                                                                __auto_type _mv_1630 = (*binding_expr);
                                                                                switch (_mv_1630.tag) {
                                                                                    case types_SExpr_sym:
                                                                                    {
                                                                                        __auto_type binding_sym = _mv_1630.data.sym;
                                                                        ...
                                                                        __auto_type _mv_1631 = types_resolved_type_get_variant_index(scrutinee_type, variant_name);
                                                                        if (_mv_1631.has_value) {
                                                                            __auto_type _ = _mv_1631.value;
