...
slop_string path_path_basename(slop_arena* arena, slop_string path) {
    {
        ...
        if (len == 0) {
            ...
            __auto_type _mv_1259 = strlib_last_index_of(path, SLOP_STR("/"));
            if (_mv_1259.has_value) {
                __auto_type idx = _mv_1259.value;
                {
...
slop_string path_path_extension(slop_arena* arena, slop_string path) {
    {
        ...
        if (len == 0) {
            ...
            __auto_type _mv_1260 = strlib_last_index_of(path, SLOP_STR("."));
            if (_mv_1260.has_value) {
                __auto_type idx = _mv_1260.value;
                {
