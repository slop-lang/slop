                    ...
                    case types_SExpr_lst:
                    {
                        __auto_type lst = _mv_993.data.lst;
                        {
                            ...
                            if (((int64_t)((sub_items).len)) > 0) {
                                __auto_type _mv_994 = ({ __auto_type _lst = sub_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                ...
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_1001.data.sym;
                                    {
                                        ...
                                        if (_mv_1002.has_value) {
                                            __auto_type type_expr = _mv_1002.value;
                                            {
                                                ...
                                                __auto_type _mv_1003 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_1003.has_value) {
                                                    __auto_type value_expr = _mv_1003.value;
        ...
        if (ctype_is_int_type(type_name)) {
        ...
        } else {
            {
                ...
                if (string_eq(type_name, SLOP_STR("String"))) {
                    __auto_type _mv_1004 = (*value_expr);
                    switch (_mv_1004.tag) {
                        case types_SExpr_str:
                        {
                            __auto_type str = _mv_1004.data.str;
...
uint8_t defn_is_string_expr(slop_list_types_SExpr_ptr items, int64_t idx) {
    __auto_type _mv_1010 = ({ __auto_type _lst = items; size_t _idx = (size_t)idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    if (_mv_1010.has_value) {
        ...
        switch (_mv_1011.tag) {
            case types_SExpr_str:
            {
                __auto_type _ = _mv_1011.data.str;
                return 1;
            }
            default: {
                return 0;
                                ...
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_1014.data.sym;
                                    {
                                        ...
                                        if (_mv_1015.has_value) {
                                            __auto_type type_def = _mv_1015.value;
...
void defn_dispatch_type_def(context_TranspileContext* ctx, slop_string raw_name, slop_string qualified_name, types_SExpr* type_def) {
    ...
    __auto_type _mv_1016 = (*type_def);
    switch (_mv_1016.tag) {
        case types_SExpr_lst:
        {
            __auto_type def_lst = _mv_1016.data.lst;
            {
        ...
        while ((i < len) && !(found)) {
            ...
            if (_mv_1019.has_value) {
                ...
                switch (_mv_1020.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type _ = _mv_1020.data.lst;
                        found = 1;
                        break;
                    }
                    default: {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_1022.has_value) {
                __auto_type field_expr = _mv_1022.value;
...
void defn_emit_record_field(context_TranspileContext* ctx, slop_string raw_type_name, slop_string qualified_type_name, types_SExpr* field) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1023 = (*field);
        switch (_mv_1023.tag) {
            case types_SExpr_lst:
            {
                __auto_type field_lst = _mv_1023.data.lst;
                {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_1028.has_value) {
                __auto_type val_expr = _mv_1028.value;
                __auto_type _mv_1029 = (*val_expr);
                switch (_mv_1029.tag) {
                    case types_SExpr_sym:
                    {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_1031.has_value) {
                __auto_type variant_expr = _mv_1031.value;
                __auto_type _mv_1032 = (*variant_expr);
                switch (_mv_1032.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type var_lst = _mv_1032.data.lst;
                        {
                            __auto_type var_items = var_lst.items;
                            __auto_type var_len = ((int64_t)((var_items).len));
                            if (var_len >= 1) {
                                __auto_type _mv_1033 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1033.has_value) {
                                    __auto_type tag_expr = _mv_1033.value;
                                    __auto_type _mv_1034 = (*tag_expr);
                                    switch (_mv_1034.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type tag_sym = _mv_1034.data.sym;
                                            {
                                                ...
                                                if (var_len == 2) {
                                                    ...
                                                    for (int64_t fi = 1; fi < var_len; fi++) {
                                                        __auto_type _mv_1036 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)fi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_1041.has_value) {
                __auto_type variant_expr = _mv_1041.value;
                __auto_type _mv_1042 = (*variant_expr);
                switch (_mv_1042.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type var_lst = _mv_1042.data.lst;
                        {
                            __auto_type var_items = var_lst.items;
                            __auto_type var_len = ((int64_t)((var_items).len));
                            if (var_len >= 2) {
                                __auto_type _mv_1043 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1043.has_value) {
                                    __auto_type tag_expr = _mv_1043.value;
                                    __auto_type _mv_1044 = (*tag_expr);
                                    switch (_mv_1044.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type tag_sym = _mv_1044.data.sym;
                                            {
                                                __auto_type tag_name = tag_sym.name;
                                                if (var_len == 2) {
                                                    __auto_type _mv_1045 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    ...
                                                    for (int64_t fi = 1; fi < var_len; fi++) {
                                                        __auto_type _mv_1046 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)fi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                ...
                __auto_type lst = _mv_1051.data.lst;
                {
                    ...
                    if (len < 3) {
                        ...
                        if (_mv_1052.has_value) {
                            __auto_type elem_type_expr = _mv_1052.value;
                            ...
                            if (_mv_1053.has_value) {
                                __auto_type size_expr = _mv_1053.value;
                                {
...
slop_string defn_get_number_as_string(types_SExpr* expr) {
    ...
    switch (_mv_1054.tag) {
        case types_SExpr_num:
        {
            __auto_type num = _mv_1054.data.num;
            return num.raw;
        }
        default: {
            return SLOP_STR("0");
                    ...
                    while (i < len) {
                        ...
                        if (_mv_1059.has_value) {
                            ...
                            switch (_mv_1060.tag) {
                                case types_SExpr_num:
                                {
                                    __auto_type num = _mv_1060.data.num;
                                    if (!(found_dots)) {
                            ...
                            switch (_mv_1063.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_1063.data.sym;
                                    {
                                        ...
                                        __auto_type _mv_1064 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_1064.has_value) {
                                            __auto_type params_expr = _mv_1064.value;
...
void defn_bind_params_to_scope(context_TranspileContext* ctx, types_SExpr* params_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1067 = (*params_expr);
        switch (_mv_1067.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1067.data.lst;
                {
                    ...
                    while (i < len) {
                        ...
                        if (_mv_1068.has_value) {
                            __auto_type param = _mv_1068.value;
                    ...
                    if (len >= 2) {
                        {
                            ...
                            __auto_type _mv_1070 = ({ __auto_type _lst = items; size_t _idx = (size_t)name_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_1070.has_value) {
                                ...
                                switch (_mv_1071.tag) {
                                    case types_SExpr_sym:
                                    {
                                        ...
                                        __auto_type _mv_1072 = ({ __auto_type _lst = items; size_t _idx = (size_t)type_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_1072.has_value) {
                                            __auto_type type_expr = _mv_1072.value;
                                            {
...
slop_list_context_FuncParamType_ptr defn_collect_param_types(context_TranspileContext* ctx, types_SExpr* params_expr) {
    ...
    SLOP_PRE(((params_expr != NULL)), "(!= params-expr nil)");
    {
        ...
        __auto_type _mv_1076 = (*params_expr);
        switch (_mv_1076.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1076.data.lst;
                {
                    ...
                    while (i < len) {
                        ...
                        if (_mv_1077.has_value) {
                            __auto_type param = _mv_1077.value;
                            {
                ...
                __auto_type lst = _mv_1078.data.lst;
                {
                    ...
                    if (len < 2) {
                    ...
                    } else {
                        {
                            __auto_type has_mode = ((len >= 3) && defn_is_param_mode(items));
                            __auto_type type_idx = ((has_mode) ? 2 : 1);
                            __auto_type _mv_1079 = ({ __auto_type _lst = items; size_t _idx = (size_t)type_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    ...
                    if (len >= 3) {
                        ...
                        if (_mv_1081.has_value) {
                            ...
                            switch (_mv_1082.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_1082.data.sym;
                                    {
                                        __auto_type raw_name = name_sym.name;
                                        __auto_type base_name = ctype_to_c_name(arena, raw_name);
                                        ...
                                        __auto_type _mv_1083 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_1083.has_value) {
                                            __auto_type params_expr = _mv_1083.value;
                                            {
                                                __auto_type result_type_opt = defn_get_result_type_name(ctx, items);
                                                __auto_type raw_return = defn_get_return_type(ctx, items);
                                                {
...
slop_string defn_extract_spec_slop_return_type(context_TranspileContext* ctx, types_SExpr* spec_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1092 = (*spec_expr);
        switch (_mv_1092.tag) {
            case types_SExpr_lst:
            {
                                ...
                                case types_SExpr_lst:
                                {
                                    __auto_type body_lst = _mv_1094.data.lst;
                                    {
                                        ...
                                        if (body_len < 1) {
                                            ...
                                            __auto_type _mv_1095 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)(body_len - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_option_string defn_extract_result_type_name(context_TranspileContext* ctx, types_SExpr* spec_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1098 = (*spec_expr);
        switch (_mv_1098.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1098.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) < 2) {
                        ...
                        if (_mv_1099.has_value) {
                            __auto_type spec_body = _mv_1099.value;
                            __auto_type _mv_1100 = (*spec_body);
                            switch (_mv_1100.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type body_lst = _mv_1100.data.lst;
                                    {
                                        __auto_type body_items = body_lst.items;
                                        __auto_type body_len = ((int64_t)((body_items).len));
                                        if (body_len < 1) {
                                            ...
                                            __auto_type _mv_1101 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)(body_len - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_1101.has_value) {
                                                __auto_type ret_type = _mv_1101.value;
    ...
    SLOP_PRE(((type_expr != NULL)), "(!= type-expr nil)");
    {
        ...
        switch (_mv_1102.tag) {
            case types_SExpr_sym:
            {
                ...
                {
                    __auto_type type_name = sym.name;
                    __auto_type _mv_1103 = context_ctx_lookup_result_type_alias(ctx, type_name);
                    if (_mv_1103.has_value) {
                        __auto_type alias_result = _mv_1103.value;
                        return (slop_option_string){.has_value = 1, .value = alias_result};
                    } else if (!_mv_1103.has_value) {
                        __auto_type _mv_1104 = context_ctx_lookup_type(ctx, type_name);
                        if (_mv_1104.has_value) {
                            __auto_type entry = _mv_1104.value;
                                ...
                                case types_SExpr_sym:
                                {
                                    ...
                                    if (string_eq(sym.name, SLOP_STR("Result"))) {
                                        ...
                                        if (_mv_1107.has_value) {
                                            __auto_type ok_type_expr = _mv_1107.value;
                                            ...
                                            if (_mv_1108.has_value) {
                                                __auto_type err_type_expr = _mv_1108.value;
                                                {
                ...
                __auto_type lst = _mv_1111.data.lst;
                {
                    ...
                    if (len < 2) {
                    ...
                    } else {
                        {
                            ...
                            __auto_type _mv_1112 = ({ __auto_type _lst = items; size_t _idx = (size_t)name_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_1112.has_value) {
                                ...
                                switch (_mv_1113.tag) {
                                    case types_SExpr_sym:
                                    {
                                        ...
                                        __auto_type _mv_1114 = ({ __auto_type _lst = items; size_t _idx = (size_t)type_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    ...
                    } else {
                        {
                            ...
                            if (len == 2) {
                                ...
                                if (_mv_1121.has_value) {
                                    __auto_type args_expr = _mv_1121.value;
                                    {
...
slop_string defn_build_fn_args_str_for_param(context_TranspileContext* ctx, types_SExpr* args_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1122 = (*args_expr);
        switch (_mv_1122.tag) {
            case types_SExpr_lst:
            {
                __auto_type args_list = _mv_1122.data.lst;
                {
                    ...
                    if (arg_count == 0) {
                    ...
                    } else {
                        {
                            ...
                            __auto_type i = 0;
                            while (i < arg_count) {
                                __auto_type _mv_1123 = ({ __auto_type _lst = arg_items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1123.has_value) {
                                    __auto_type arg_expr = _mv_1123.value;
                                    {
...
uint8_t defn_is_c_name_attr_at(slop_list_types_SExpr_ptr items, int64_t idx) {
    __auto_type _mv_1127 = ({ __auto_type _lst = items; size_t _idx = (size_t)idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1145.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 1) {
                    ...
                    __auto_type _mv_1146 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_1146.has_value) {
                        __auto_type head = _mv_1146.value;
                        __auto_type _mv_1147 = (*head);
                        switch (_mv_1147.tag) {
                            case types_SExpr_sym:
                            {
                ...
                __auto_type lst = _mv_1152.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) >= 2) {
                        ...
                        if (_mv_1153.has_value) {
                            __auto_type val = _mv_1153.value;
        ...
        while (i < len) {
            ...
            if (_mv_1156.has_value) {
                ...
                if (defn_is_post_form(item)) {
                    __auto_type _mv_1157 = defn_get_annotation_condition(item);
                    if (_mv_1157.has_value) {
                        __auto_type cond = _mv_1157.value;
                        ({ __auto_type _lst_p = &(result); __auto_type _item = (cond); if (_lst_p->len >= _lst_p->cap) { size_t _new_cap = _lst_p->cap == 0 ? 16 : _lst_p->cap * 2; __typeof__(_lst_p->data) _new_data = (__typeof__(_lst_p->data))slop_arena_alloc(arena, _new_cap * sizeof(*_lst_p->data)); if (_lst_p->len > 0) memcpy(_new_data, _lst_p->data, _lst_p->len * sizeof(*_lst_p->data)); _lst_p->data = _new_data; _lst_p->cap = _new_cap; } _lst_p->data[_lst_p->len++] = _item; (void)0; });
        ...
        while (i < len) {
            ...
            if (_mv_1158.has_value) {
                ...
                if (defn_is_assume_form(item)) {
                    __auto_type _mv_1159 = defn_get_annotation_condition(item);
                    if (_mv_1159.has_value) {
                        __auto_type cond = _mv_1159.value;
                        ({ __auto_type _lst_p = &(result); __auto_type _item = (cond); if (_lst_p->len >= _lst_p->cap) { size_t _new_cap = _lst_p->cap == 0 ? 16 : _lst_p->cap * 2; __typeof__(_lst_p->data) _new_data = (__typeof__(_lst_p->data))slop_arena_alloc(arena, _new_cap * sizeof(*_lst_p->data)); if (_lst_p->len > 0) memcpy(_new_data, _lst_p->data, _lst_p->len * sizeof(*_lst_p->data)); _lst_p->data = _new_data; _lst_p->cap = _new_cap; } _lst_p->data[_lst_p->len++] = _item; (void)0; });
...
uint8_t defn_has_postconditions(slop_list_types_SExpr_ptr items) {
    {
        ...
        uint8_t found = 0;
        while ((i < len) && !(found)) {
            __auto_type _mv_1160 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1160.has_value) {
                __auto_type item = _mv_1160.value;
...
void defn_emit_preconditions(context_TranspileContext* ctx, slop_list_types_SExpr_ptr preconditions) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1161 = ({ __auto_type _lst = preconditions; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1161.has_value) {
                __auto_type cond_expr = _mv_1161.value;
                {
...
void defn_emit_postconditions(context_TranspileContext* ctx, slop_list_types_SExpr_ptr postconditions) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1162 = ({ __auto_type _lst = postconditions; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1162.has_value) {
                __auto_type cond_expr = _mv_1162.value;
...
void defn_emit_assumptions(context_TranspileContext* ctx, slop_list_types_SExpr_ptr assumptions) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1163 = ({ __auto_type _lst = assumptions; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1163.has_value) {
                __auto_type cond_expr = _mv_1163.value;
                if (!(defn_is_verification_only_expr(cond_expr))) {
                    {
                        __auto_type cond_c = expr_transpile_expr(ctx, cond_expr);
                        __auto_type expr_str = parser_pretty_print(arena, cond_expr);
