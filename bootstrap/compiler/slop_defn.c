                    ...
                    case types_SExpr_lst:
                    {
                        __auto_type lst = _mv_1001.data.lst;
                        {
                            ...
                            if (((int64_t)((sub_items).len)) > 0) {
                                __auto_type _mv_1002 = ({ __auto_type _lst = sub_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    ...
                                    __auto_type name_sym = _mv_1009.data.sym;
                                    {
                                        ...
                                        if (_mv_1010.has_value) {
                                            __auto_type type_expr = _mv_1010.value;
                                            {
                                                ...
                                                __auto_type _mv_1011 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_1011.has_value) {
                                                    __auto_type value_expr = _mv_1011.value;
        ...
        if (ctype_is_int_type(type_name)) {
        ...
        } else {
            {
                ...
                if (string_eq(type_name, SLOP_STR("String"))) {
                    __auto_type _mv_1012 = (*value_expr);
                    switch (_mv_1012.tag) {
                        case types_SExpr_str:
                        {
                            __auto_type str = _mv_1012.data.str;
...
slop_string defn_get_type_name_str(types_SExpr* type_expr) {
    SLOP_PRE(((type_expr != NULL)), "(!= type-expr nil)");
    __auto_type _mv_1013 = (*type_expr);
    switch (_mv_1013.tag) {
        case types_SExpr_sym:
        {
...
slop_string defn_eval_const_value(context_TranspileContext* ctx, types_SExpr* expr) {
    ...
    SLOP_PRE(((expr != NULL)), "(!= expr nil)");
    {
        ...
        switch (_mv_1014.tag) {
            ...
            {
                __auto_type num = _mv_1014.data.num;
                return num.raw;
            }
            case types_SExpr_str:
            {
                __auto_type str = _mv_1014.data.str;
...
uint8_t defn_is_string_expr(slop_list_types_SExpr_ptr items, int64_t idx) {
    __auto_type _mv_1018 = ({ __auto_type _lst = items; size_t _idx = (size_t)idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    if (_mv_1018.has_value) {
        ...
        switch (_mv_1019.tag) {
            case types_SExpr_str:
            {
                __auto_type _ = _mv_1019.data.str;
                return 1;
            }
            default: {
                return 0;
                                ...
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_1022.data.sym;
                                    {
                                        ...
                                        if (_mv_1023.has_value) {
                                            __auto_type type_def = _mv_1023.value;
        ...
        while ((i < len) && !(found)) {
            ...
            if (_mv_1027.has_value) {
                ...
                switch (_mv_1028.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type _ = _mv_1028.data.lst;
                        found = 1;
                        break;
                    }
                    default: {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_1030.has_value) {
                __auto_type field_expr = _mv_1030.value;
...
void defn_emit_record_field(context_TranspileContext* ctx, slop_string raw_type_name, slop_string qualified_type_name, types_SExpr* field) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1031 = (*field);
        switch (_mv_1031.tag) {
            case types_SExpr_lst:
            {
                __auto_type field_lst = _mv_1031.data.lst;
                {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_1036.has_value) {
                __auto_type val_expr = _mv_1036.value;
                __auto_type _mv_1037 = (*val_expr);
                switch (_mv_1037.tag) {
                    case types_SExpr_sym:
                    {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_1039.has_value) {
                __auto_type variant_expr = _mv_1039.value;
                __auto_type _mv_1040 = (*variant_expr);
                switch (_mv_1040.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type var_lst = _mv_1040.data.lst;
                        {
                            __auto_type var_items = var_lst.items;
                            __auto_type var_len = ((int64_t)((var_items).len));
                            if (var_len >= 1) {
                                __auto_type _mv_1041 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1041.has_value) {
                                    __auto_type tag_expr = _mv_1041.value;
                                    __auto_type _mv_1042 = (*tag_expr);
                                    switch (_mv_1042.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type tag_sym = _mv_1042.data.sym;
                                            {
                                                ...
                                                if (var_len == 2) {
                                                    ...
                                                    for (int64_t fi = 1; fi < var_len; fi++) {
                                                        __auto_type _mv_1044 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)fi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                        if (_mv_1044.has_value) {
                                                            __auto_type type_expr = _mv_1044.value;
                                                            {
                                                                __auto_type c_type = context_to_c_type_prefixed(ctx, type_expr);
                                                                {
                                                                    __auto_type actual_type = ((string_eq(c_type, SLOP_STR("void"))) ? SLOP_STR("int") : c_type);
                                    ...
                                    switch (_mv_1052.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type tag_sym = _mv_1052.data.sym;
                                            {
                                                __auto_type tag_name = tag_sym.name;
                                                if (var_len == 2) {
                                                    __auto_type _mv_1053 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_1053.has_value) {
                                                        __auto_type type_expr = _mv_1053.value;
                                                        {
                                                            __auto_type c_type = context_to_c_type_prefixed(ctx, type_expr);
                                                            __auto_type slop_type_str = parser_pretty_print(arena, type_expr);
                                                            __auto_type is_ptr = defn_is_pointer_type_expr(type_expr);
                                                    ...
                                                    for (int64_t fi = 1; fi < var_len; fi++) {
                                                        __auto_type _mv_1054 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)fi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    ...
                                                    __auto_type _mv_1055 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                ...
                __auto_type lst = _mv_1059.data.lst;
                {
                    ...
                    if (len < 3) {
                        ...
                        if (_mv_1060.has_value) {
                            __auto_type elem_type_expr = _mv_1060.value;
                            __auto_type _mv_1061 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_1061.has_value) {
                                __auto_type size_expr = _mv_1061.value;
                                {
...
slop_string defn_get_number_as_string(types_SExpr* expr) {
    ...
    switch (_mv_1062.tag) {
        case types_SExpr_num:
        {
            __auto_type num = _mv_1062.data.num;
            return num.raw;
        }
        default: {
            return SLOP_STR("0");
                                ...
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_1071.data.sym;
                                    {
                                        ...
                                        if (_mv_1072.has_value) {
                                            __auto_type params_expr = _mv_1072.value;
...
void defn_bind_params_to_scope(context_TranspileContext* ctx, types_SExpr* params_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1075 = (*params_expr);
        switch (_mv_1075.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1075.data.lst;
                {
                    ...
                    while (i < len) {
                        ...
                        if (_mv_1076.has_value) {
                            __auto_type param = _mv_1076.value;
                    ...
                    if (len >= 2) {
                        {
                            ...
                            __auto_type _mv_1078 = ({ __auto_type _lst = items; size_t _idx = (size_t)name_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_1078.has_value) {
                                ...
                                switch (_mv_1079.tag) {
                                    case types_SExpr_sym:
                                    {
                                        ...
                                        __auto_type _mv_1080 = ({ __auto_type _lst = items; size_t _idx = (size_t)type_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_list_context_FuncParamType_ptr defn_collect_param_types(context_TranspileContext* ctx, types_SExpr* params_expr) {
    ...
    SLOP_PRE(((params_expr != NULL)), "(!= params-expr nil)");
    {
        ...
        __auto_type _mv_1084 = (*params_expr);
        switch (_mv_1084.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1084.data.lst;
                {
                    ...
                    while (i < len) {
                        ...
                        if (_mv_1085.has_value) {
                            __auto_type param = _mv_1085.value;
                            {
                ...
                __auto_type lst = _mv_1088.data.lst;
                {
                    ...
                    if (len >= 3) {
                        ...
                        if (_mv_1089.has_value) {
                            __auto_type name_expr = _mv_1089.value;
                            __auto_type _mv_1090 = (*name_expr);
                            switch (_mv_1090.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_1090.data.sym;
                                    {
                                        __auto_type raw_name = name_sym.name;
                                        __auto_type base_name = ctype_to_c_name(arena, raw_name);
                                        ...
                                        __auto_type _mv_1091 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_1091.has_value) {
                                            __auto_type params_expr = _mv_1091.value;
                                            {
                                                __auto_type result_type_opt = defn_get_result_type_name(ctx, items);
                                                __auto_type raw_return = defn_get_return_type(ctx, items);
                                                {
...
slop_string defn_extract_spec_return_type(context_TranspileContext* ctx, types_SExpr* spec_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1096 = (*spec_expr);
        switch (_mv_1096.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1096.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) < 2) {
                        ...
                        if (_mv_1097.has_value) {
                            __auto_type spec_body = _mv_1097.value;
                            __auto_type _mv_1098 = (*spec_body);
                            switch (_mv_1098.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type body_lst = _mv_1098.data.lst;
                                    {
                                        ...
                                        if (body_len < 1) {
                                            ...
                                            __auto_type _mv_1099 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)(body_len - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_1099.has_value) {
                                                __auto_type ret_type = _mv_1099.value;
    ...
    SLOP_PRE(((type_expr != NULL)), "(!= type-expr nil)");
    {
        ...
        switch (_mv_1110.tag) {
            case types_SExpr_sym:
            {
                ...
                {
                    __auto_type type_name = sym.name;
                    __auto_type _mv_1111 = context_ctx_lookup_result_type_alias(ctx, type_name);
                    if (_mv_1111.has_value) {
                        __auto_type alias_result = _mv_1111.value;
                        return (slop_option_string){.has_value = 1, .value = alias_result};
                    } else if (!_mv_1111.has_value) {
                        __auto_type _mv_1112 = context_ctx_lookup_type(ctx, type_name);
                        if (_mv_1112.has_value) {
                            __auto_type entry = _mv_1112.value;
                            ...
                            switch (_mv_1114.tag) {
                                case types_SExpr_sym:
                                {
                                    ...
                                    if (string_eq(sym.name, SLOP_STR("Result"))) {
                                        __auto_type _mv_1115 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_1115.has_value) {
                                            __auto_type ok_type_expr = _mv_1115.value;
                                            ...
                                            if (_mv_1116.has_value) {
                                                __auto_type err_type_expr = _mv_1116.value;
                                                {
                ...
                __auto_type lst = _mv_1119.data.lst;
                {
                    ...
                    if (len < 2) {
                    ...
                    } else {
                        {
                            ...
                            __auto_type _mv_1120 = ({ __auto_type _lst = items; size_t _idx = (size_t)name_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_1120.has_value) {
                                ...
                                switch (_mv_1121.tag) {
                                    case types_SExpr_sym:
                                    {
                                        ...
                                        __auto_type _mv_1122 = ({ __auto_type _lst = items; size_t _idx = (size_t)type_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
uint8_t defn_is_param_mode(slop_list_types_SExpr_ptr items) {
    if (((int64_t)((items).len)) < 1) {
        ...
        if (_mv_1123.has_value) {
            __auto_type first = _mv_1123.value;
            __auto_type _mv_1124 = (*first);
            switch (_mv_1124.tag) {
                case types_SExpr_sym:
                {
            ...
            __auto_type lst = _mv_1125.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 1) {
                    ...
                    if (_mv_1126.has_value) {
                        __auto_type first = _mv_1126.value;
                        __auto_type _mv_1127 = (*first);
                        switch (_mv_1127.tag) {
                            case types_SExpr_sym:
                            {
                    ...
                    } else {
                        {
                            ...
                            if (len == 2) {
                                ...
                                if (_mv_1129.has_value) {
                                    __auto_type args_expr = _mv_1129.value;
                                    {
...
slop_string defn_build_fn_args_str_for_param(context_TranspileContext* ctx, types_SExpr* args_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1130 = (*args_expr);
        switch (_mv_1130.tag) {
            case types_SExpr_lst:
            {
                __auto_type args_list = _mv_1130.data.lst;
                {
                    ...
                    if (arg_count == 0) {
                    ...
                    } else {
                        {
                            ...
                            __auto_type i = 0;
                            while (i < arg_count) {
                                __auto_type _mv_1131 = ({ __auto_type _lst = arg_items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1131.has_value) {
                                    __auto_type arg_expr = _mv_1131.value;
                                    {
...
uint8_t defn_is_c_name_attr_at(slop_list_types_SExpr_ptr items, int64_t idx) {
    __auto_type _mv_1135 = ({ __auto_type _lst = items; size_t _idx = (size_t)idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                ...
                __auto_type lst = _mv_1156.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) >= 2) {
                        ...
                        if (_mv_1157.has_value) {
                            __auto_type val = _mv_1157.value;
                            __auto_type _mv_1158 = (*val);
                            switch (_mv_1158.tag) {
                                case types_SExpr_str:
                                {
                                    __auto_type str = _mv_1158.data.str;
        ...
        while (i < len) {
            ...
            if (_mv_1162.has_value) {
                ...
                if (defn_is_pre_form(item)) {
                    __auto_type _mv_1163 = defn_get_annotation_condition(item);
                    if (_mv_1163.has_value) {
                        __auto_type cond = _mv_1163.value;
        ...
        while (i < len) {
            ...
            if (_mv_1164.has_value) {
                ...
                if (defn_is_post_form(item)) {
                    __auto_type _mv_1165 = defn_get_annotation_condition(item);
                    if (_mv_1165.has_value) {
                        __auto_type cond = _mv_1165.value;
                        ({ __auto_type _lst_p = &(result); __auto_type _item = (cond); if (_lst_p->len >= _lst_p->cap) { size_t _new_cap = _lst_p->cap == 0 ? 16 : _lst_p->cap * 2; __typeof__(_lst_p->data) _new_data = (__typeof__(_lst_p->data))slop_arena_alloc(arena, _new_cap * sizeof(*_lst_p->data)); if (_lst_p->len > 0) memcpy(_new_data, _lst_p->data, _lst_p->len * sizeof(*_lst_p->data)); _lst_p->data = _new_data; _lst_p->cap = _new_cap; } _lst_p->data[_lst_p->len++] = _item; (void)0; });
...
void defn_emit_preconditions(context_TranspileContext* ctx, slop_list_types_SExpr_ptr preconditions) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1169 = ({ __auto_type _lst = preconditions; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1169.has_value) {
                __auto_type cond_expr = _mv_1169.value;
                {
...
void defn_emit_postconditions(context_TranspileContext* ctx, slop_list_types_SExpr_ptr postconditions) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1170 = ({ __auto_type _lst = postconditions; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1170.has_value) {
                __auto_type cond_expr = _mv_1170.value;
...
void defn_emit_assumptions(context_TranspileContext* ctx, slop_list_types_SExpr_ptr assumptions) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1171 = ({ __auto_type _lst = assumptions; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1171.has_value) {
                __auto_type cond_expr = _mv_1171.value;
                if (!(defn_is_verification_only_expr(cond_expr))) {
                    {
                        __auto_type cond_c = expr_transpile_expr(ctx, cond_expr);
                        __auto_type expr_str = parser_pretty_print(arena, cond_expr);
