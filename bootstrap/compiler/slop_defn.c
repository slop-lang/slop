        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_911.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    __auto_type _mv_912 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_914.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    __auto_type _mv_915 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_915.has_value) {
                        __auto_type head = _mv_915.value;
                        __auto_type _mv_916 = (*head);
                        switch (_mv_916.tag) {
                            case types_SExpr_sym:
                            {
                                __auto_type sym = _mv_916.data.sym;
...
uint8_t defn_is_const_form(types_SExpr* expr) {
    SLOP_PRE(((expr != NULL)), "(!= expr nil)");
    __auto_type _mv_917 = (*expr);
    switch (_mv_917.tag) {
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_917.data.lst;
            {
                __auto_type items = lst.items;
                if ((((int64_t)((items).len)) < 1)) {
                    return 0;
                } else {
                    __auto_type _mv_918 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_918.has_value) {
                        __auto_type head = _mv_918.value;
                        __auto_type _mv_919 = (*head);
                        switch (_mv_919.tag) {
                            case types_SExpr_sym:
                            {
...
uint8_t defn_has_generic_annotation(slop_list_types_SExpr_ptr items) {
    {
        ...
        __auto_type found = 0;
        while (((i < len) && !(found))) {
            __auto_type _mv_926 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_926.has_value) {
                __auto_type item = _mv_926.value;
                __auto_type _mv_927 = (*item);
                switch (_mv_927.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type lst = _mv_927.data.lst;
                        {
                            ...
                            if ((((int64_t)((sub_items).len)) > 0)) {
                                __auto_type _mv_928 = ({ __auto_type _lst = sub_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_930.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    __auto_type _mv_931 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_933.data.lst;
                {
                    ...
                    if ((len < 4)) {
                        ...
                        __auto_type _mv_934 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_934.has_value) {
                            __auto_type name_expr = _mv_934.value;
                            __auto_type _mv_935 = (*name_expr);
                            switch (_mv_935.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_935.data.sym;
                                    {
                                        ...
                                        if (_mv_936.has_value) {
                                            __auto_type type_expr = _mv_936.value;
                                            {
                                                ...
                                                __auto_type _mv_937 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        if (ctype_is_int_type(type_name)) {
        ...
        } else {
            {
                ...
                if (string_eq(type_name, SLOP_STR("String"))) {
                    __auto_type _mv_938 = (*value_expr);
                    switch (_mv_938.tag) {
...
slop_string defn_eval_const_value(context_TranspileContext* ctx, types_SExpr* expr) {
    ...
    SLOP_PRE(((expr != NULL)), "(!= expr nil)");
    {
        ...
        switch (_mv_940.tag) {
            ...
            {
                __auto_type num = _mv_940.data.num;
                return num.raw;
            }
            case types_SExpr_str:
            {
                __auto_type str = _mv_940.data.str;
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_941.data.lst;
                {
                    ...
                    __auto_type len = ((int64_t)((items).len));
                    {
                        ...
                        if ((len >= (name_idx + 1))) {
                            __auto_type _mv_942 = ({ __auto_type _lst = items; size_t _idx = (size_t)name_idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
uint8_t defn_is_string_expr(slop_list_types_SExpr_ptr items, int64_t idx) {
    __auto_type _mv_944 = ({ __auto_type _lst = items; size_t _idx = (size_t)idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    if (_mv_944.has_value) {
        __auto_type item = _mv_944.value;
        __auto_type _mv_945 = (*item);
        switch (_mv_945.tag) {
            case types_SExpr_str:
            {
                __auto_type _ = _mv_945.data.str;
                return 1;
            }
            default: {
                return 0;
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_946.data.lst;
                {
                    ...
                    if ((len < 3)) {
                        ...
                        __auto_type _mv_947 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            ...
                            switch (_mv_948.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_948.data.sym;
                                    {
                                        ...
                                        __auto_type _mv_949 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_949.has_value) {
                                            __auto_type type_def = _mv_949.value;
...
void defn_dispatch_type_def(context_TranspileContext* ctx, slop_string raw_name, slop_string qualified_name, types_SExpr* type_def) {
    ...
    __auto_type _mv_950 = (*type_def);
    switch (_mv_950.tag) {
        case types_SExpr_lst:
        {
            __auto_type def_lst = _mv_950.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    if (_mv_951.has_value) {
                        __auto_type head = _mv_951.value;
                        __auto_type _mv_952 = (*head);
                        switch (_mv_952.tag) {
                            case types_SExpr_sym:
                            {
        ...
        while (((i < len) && !(found))) {
            ...
            if (_mv_953.has_value) {
                ...
                switch (_mv_954.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type _ = _mv_954.data.lst;
                        found = 1;
                        break;
                    }
                    default: {
...
void defn_emit_record_fields(context_TranspileContext* ctx, slop_string raw_type_name, slop_string qualified_type_name, slop_list_types_SExpr_ptr items, int64_t start_idx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = start_idx;
        while ((i < len)) {
            __auto_type _mv_956 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_956.has_value) {
                __auto_type field_expr = _mv_956.value;
...
void defn_emit_record_field(context_TranspileContext* ctx, slop_string raw_type_name, slop_string qualified_type_name, types_SExpr* field) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_957 = (*field);
        switch (_mv_957.tag) {
            case types_SExpr_lst:
            {
                __auto_type field_lst = _mv_957.data.lst;
                {
                    ...
                    if ((len < 2)) {
                        ...
                        if (_mv_958.has_value) {
                            __auto_type name_expr = _mv_958.value;
                            __auto_type _mv_959 = (*name_expr);
                            switch (_mv_959.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_959.data.sym;
                                    ...
                                    if (_mv_960.has_value) {
                                        __auto_type type_expr = _mv_960.value;
                                        {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while ((i < len)) {
            ...
            if (_mv_962.has_value) {
                __auto_type val_expr = _mv_962.value;
                __auto_type _mv_963 = (*val_expr);
                switch (_mv_963.tag) {
                    case types_SExpr_sym:
                    {
...
void defn_emit_union_variants(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items, int64_t start_idx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = start_idx;
        while ((i < len)) {
            __auto_type _mv_965 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_965.has_value) {
                __auto_type variant_expr = _mv_965.value;
                __auto_type _mv_966 = (*variant_expr);
                switch (_mv_966.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type var_lst = _mv_966.data.lst;
                        {
                            __auto_type var_items = var_lst.items;
                            __auto_type var_len = ((int64_t)((var_items).len));
                            if ((var_len >= 1)) {
                                __auto_type _mv_967 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_967.has_value) {
                                    __auto_type tag_expr = _mv_967.value;
                                    __auto_type _mv_968 = (*tag_expr);
                                    switch (_mv_968.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type tag_sym = _mv_968.data.sym;
                                            {
                                                __auto_type tag_name = tag_sym.name;
                                                if ((var_len >= 2)) {
                                                    __auto_type _mv_969 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while ((i < len)) {
            ...
            if (_mv_970.has_value) {
                __auto_type variant_expr = _mv_970.value;
                __auto_type _mv_971 = (*variant_expr);
                switch (_mv_971.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type var_lst = _mv_971.data.lst;
                        {
                            __auto_type var_items = var_lst.items;
                            if ((((int64_t)((var_items).len)) >= 1)) {
                                __auto_type _mv_972 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_972.has_value) {
                                    __auto_type tag_expr = _mv_972.value;
                                    __auto_type _mv_973 = (*tag_expr);
                                    switch (_mv_973.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type tag_sym = _mv_973.data.sym;
                                            {
                                                __auto_type tag_name = tag_sym.name;
...
void defn_register_union_variant_fields(context_TranspileContext* ctx, slop_string raw_name, slop_string qualified_name, slop_list_types_SExpr_ptr items, int64_t start_idx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = start_idx;
        while ((i < len)) {
            __auto_type _mv_974 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                ...
                switch (_mv_975.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type var_lst = _mv_975.data.lst;
                        {
                            ...
                            __auto_type var_len = ((int64_t)((var_items).len));
                            if ((var_len >= 2)) {
                                __auto_type _mv_976 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_976.has_value) {
                                    ...
                                    switch (_mv_977.tag) {
                                        case types_SExpr_sym:
                                        {
                                            ...
                                            {
                                                __auto_type tag_name = tag_sym.name;
                                                __auto_type _mv_978 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                ...
                __auto_type lst = _mv_982.data.lst;
                {
                    ...
                    if ((len < 3)) {
                        ...
                        if (_mv_983.has_value) {
                            __auto_type elem_type_expr = _mv_983.value;
                            ...
                            if (_mv_984.has_value) {
                                __auto_type size_expr = _mv_984.value;
                                {
...
slop_string defn_get_number_as_string(types_SExpr* expr) {
    SLOP_PRE(((expr != NULL)), "(!= expr nil)");
    __auto_type _mv_985 = (*expr);
    switch (_mv_985.tag) {
        case types_SExpr_num:
        {
            __auto_type num = _mv_985.data.num;
            return num.raw;
        }
        default: {
            return SLOP_STR("0");
                    ...
                    while ((i < len)) {
                        ...
                        if (_mv_990.has_value) {
                            ...
                            switch (_mv_991.tag) {
                                case types_SExpr_num:
                                {
                                    __auto_type num = _mv_991.data.num;
                                    if (!(found_dots)) {
                ...
                __auto_type lst = _mv_992.data.lst;
                {
                    ...
                    if ((len < 3)) {
                        ...
                        if (_mv_993.has_value) {
                            __auto_type name_expr = _mv_993.value;
                            __auto_type _mv_994 = (*name_expr);
                            switch (_mv_994.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_994.data.sym;
                                    {
                                        __auto_type raw_name = name_sym.name;
                                        __auto_type base_name = ctype_to_c_name(arena, raw_name);
                                        ...
                                        __auto_type _mv_995 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_995.has_value) {
                                            __auto_type params_expr = _mv_995.value;
...
void defn_bind_params_to_scope(context_TranspileContext* ctx, types_SExpr* params_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_998 = (*params_expr);
        switch (_mv_998.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_998.data.lst;
                {
                    ...
                    while ((i < len)) {
                        ...
                        if (_mv_999.has_value) {
                            __auto_type param = _mv_999.value;
                            ...
                            if (_mv_1001.has_value) {
                                ...
                                switch (_mv_1002.tag) {
                                    case types_SExpr_sym:
                                    {
                                        ...
                                        __auto_type _mv_1003 = ({ __auto_type _lst = items; size_t _idx = (size_t)type_idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_1003.has_value) {
                                            __auto_type type_expr = _mv_1003.value;
                                            {
...
uint8_t defn_is_pointer_type(types_SExpr* type_expr) {
    SLOP_PRE(((type_expr != NULL)), "(!= type-expr nil)");
    __auto_type _mv_1004 = (*type_expr);
    switch (_mv_1004.tag) {
        case types_SExpr_lst:
        {
...
slop_list_context_FuncParamType_ptr defn_collect_param_types(context_TranspileContext* ctx, types_SExpr* params_expr) {
    ...
    SLOP_PRE(((params_expr != NULL)), "(!= params-expr nil)");
    {
        ...
        __auto_type _mv_1007 = (*params_expr);
        switch (_mv_1007.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1007.data.lst;
                {
                    ...
                    while ((i < len)) {
                        ...
                        if (_mv_1008.has_value) {
                            __auto_type param = _mv_1008.value;
                            {
                ...
                __auto_type lst = _mv_1009.data.lst;
                {
                    ...
                    if ((len < 2)) {
                    ...
                    } else {
                        {
                            __auto_type has_mode = ((len >= 3) && defn_is_param_mode(items));
                            __auto_type type_idx = ((has_mode) ? 2 : 1);
                            __auto_type _mv_1010 = ({ __auto_type _lst = items; size_t _idx = (size_t)type_idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_1010.has_value) {
                                __auto_type type_expr = _mv_1010.value;
                                ...
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_1013.data.sym;
                                    {
                                        ...
                                        if (_mv_1014.has_value) {
                                            __auto_type params_expr = _mv_1014.value;
                                            {
                                                __auto_type result_type_opt = defn_get_result_type_name(ctx, items);
                                                __auto_type raw_return = defn_get_return_type(ctx, items);
                                                {
...
slop_string defn_extract_spec_slop_return_type(context_TranspileContext* ctx, types_SExpr* spec_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1023 = (*spec_expr);
        switch (_mv_1023.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1023.data.lst;
                {
                    ...
                    if ((((int64_t)((items).len)) < 2)) {
                        ...
                        if (_mv_1024.has_value) {
                            __auto_type spec_body = _mv_1024.value;
                            __auto_type _mv_1025 = (*spec_body);
                            switch (_mv_1025.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type body_lst = _mv_1025.data.lst;
                                    {
                                        __auto_type body_items = body_lst.items;
                                        __auto_type body_len = ((int64_t)((body_items).len));
                                        if ((body_len < 1)) {
                                            ...
                                            __auto_type _mv_1026 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)(body_len - 1); slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_option_string defn_get_result_type_name(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (((i < len) && ({ __auto_type _mv = result; _mv.has_value ? ({ __auto_type _ = _mv.value; 0; }) : (1); }))) {
            __auto_type _mv_1028 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_option_string defn_extract_result_type_name(context_TranspileContext* ctx, types_SExpr* spec_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1029 = (*spec_expr);
        switch (_mv_1029.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1029.data.lst;
                {
                    ...
                    if ((((int64_t)((items).len)) < 2)) {
                        ...
                        if (_mv_1030.has_value) {
                            __auto_type spec_body = _mv_1030.value;
                            __auto_type _mv_1031 = (*spec_body);
                            switch (_mv_1031.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type body_lst = _mv_1031.data.lst;
                                    {
                                        __auto_type body_items = body_lst.items;
                                        __auto_type body_len = ((int64_t)((body_items).len));
                                        if ((body_len < 1)) {
                                            ...
                                            __auto_type _mv_1032 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)(body_len - 1); slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_1032.has_value) {
                                                __auto_type ret_type = _mv_1032.value;
    ...
    SLOP_PRE(((type_expr != NULL)), "(!= type-expr nil)");
    {
        ...
        switch (_mv_1033.tag) {
            case types_SExpr_sym:
            {
                ...
                {
                    __auto_type type_name = sym.name;
                    __auto_type _mv_1034 = context_ctx_lookup_result_type_alias(ctx, type_name);
                    if (_mv_1034.has_value) {
                        __auto_type alias_result = _mv_1034.value;
                        return (slop_option_string){.has_value = 1, .value = alias_result};
                    } else if (!_mv_1034.has_value) {
                        __auto_type _mv_1035 = context_ctx_lookup_type(ctx, type_name);
                        if (_mv_1035.has_value) {
                            __auto_type entry = _mv_1035.value;
                                ...
                                case types_SExpr_sym:
                                {
                                    ...
                                    if (string_eq(sym.name, SLOP_STR("Result"))) {
                                        ...
                                        if (_mv_1038.has_value) {
                                            __auto_type ok_type_expr = _mv_1038.value;
                                            __auto_type _mv_1039 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_1039.has_value) {
                                                __auto_type err_type_expr = _mv_1039.value;
                                                {
...
slop_string defn_build_param_str(context_TranspileContext* ctx, types_SExpr* params_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1040 = (*params_expr);
        switch (_mv_1040.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1040.data.lst;
                {
                    ...
                    while ((i < len)) {
                        ...
                        if (_mv_1041.has_value) {
                            __auto_type param = _mv_1041.value;
                            {
                ...
                __auto_type lst = _mv_1042.data.lst;
                {
                    ...
                    if ((len < 2)) {
                    ...
                    } else {
                        {
                            ...
                            __auto_type _mv_1043 = ({ __auto_type _lst = items; size_t _idx = (size_t)name_idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_1043.has_value) {
                                ...
                                switch (_mv_1044.tag) {
                                    case types_SExpr_sym:
                                    {
                                        __auto_type name_sym = _mv_1044.data.sym;
                                        __auto_type _mv_1045 = ({ __auto_type _lst = items; size_t _idx = (size_t)type_idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
uint8_t defn_is_param_mode(slop_list_types_SExpr_ptr items) {
    if ((((int64_t)((items).len)) < 1)) {
        ...
        __auto_type _mv_1046 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        if (_mv_1046.has_value) {
            __auto_type first = _mv_1046.value;
            __auto_type _mv_1047 = (*first);
            switch (_mv_1047.tag) {
                case types_SExpr_sym:
                {
...
uint8_t defn_is_fn_type(types_SExpr* type_expr) {
    __auto_type _mv_1048 = (*type_expr);
    switch (_mv_1048.tag) {
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1048.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    __auto_type _mv_1049 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_1049.has_value) {
                        __auto_type first = _mv_1049.value;
                        __auto_type _mv_1050 = (*first);
                        switch (_mv_1050.tag) {
                            case types_SExpr_sym:
                            {
                    ...
                    } else {
                        {
                            ...
                            if ((len == 2)) {
                                ...
                                if (_mv_1052.has_value) {
                                    __auto_type args_expr = _mv_1052.value;
                                    {
...
slop_string defn_build_fn_args_str_for_param(context_TranspileContext* ctx, types_SExpr* args_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1053 = (*args_expr);
        switch (_mv_1053.tag) {
            case types_SExpr_lst:
            {
                __auto_type args_list = _mv_1053.data.lst;
                {
                    ...
                    if ((arg_count == 0)) {
                    ...
                    } else {
                        {
                            ...
                            __auto_type i = 0;
                            while ((i < arg_count)) {
                                __auto_type _mv_1054 = ({ __auto_type _lst = arg_items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1054.has_value) {
                                    __auto_type arg_expr = _mv_1054.value;
                                    {
...
uint8_t defn_is_c_name_attr_at(slop_list_types_SExpr_ptr items, int64_t idx) {
    __auto_type _mv_1058 = ({ __auto_type _lst = items; size_t _idx = (size_t)idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1063.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    __auto_type _mv_1064 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1066.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    __auto_type _mv_1067 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1069.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    __auto_type _mv_1070 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_1070.has_value) {
                        __auto_type head = _mv_1070.value;
                        __auto_type _mv_1071 = (*head);
                        switch (_mv_1071.tag) {
                            case types_SExpr_sym:
                            {
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1076.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    __auto_type _mv_1077 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                ...
                __auto_type lst = _mv_1083.data.lst;
                {
                    ...
                    if ((((int64_t)((items).len)) >= 2)) {
                        ...
                        if (_mv_1084.has_value) {
                            __auto_type val = _mv_1084.value;
        ...
        while ((i < len)) {
            ...
            if (_mv_1089.has_value) {
                ...
                if (defn_is_assume_form(item)) {
                    __auto_type _mv_1090 = defn_get_annotation_condition(item);
                    if (_mv_1090.has_value) {
                        __auto_type cond = _mv_1090.value;
                        ({ __auto_type _lst_p = &(result); __auto_type _item = (cond); if (_lst_p->len >= _lst_p->cap) { size_t _new_cap = _lst_p->cap == 0 ? 16 : _lst_p->cap * 2; __typeof__(_lst_p->data) _new_data = (__typeof__(_lst_p->data))slop_arena_alloc(arena, _new_cap * sizeof(*_lst_p->data)); if (_lst_p->len > 0) memcpy(_new_data, _lst_p->data, _lst_p->len * sizeof(*_lst_p->data)); _lst_p->data = _new_data; _lst_p->cap = _new_cap; } _lst_p->data[_lst_p->len++] = _item; (void)0; });
...
void defn_emit_preconditions(context_TranspileContext* ctx, slop_list_types_SExpr_ptr preconditions) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1092 = ({ __auto_type _lst = preconditions; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void defn_emit_postconditions(context_TranspileContext* ctx, slop_list_types_SExpr_ptr postconditions) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1093 = ({ __auto_type _lst = postconditions; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1093.has_value) {
                __auto_type cond_expr = _mv_1093.value;
...
void defn_emit_assumptions(context_TranspileContext* ctx, slop_list_types_SExpr_ptr assumptions) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1094 = ({ __auto_type _lst = assumptions; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1094.has_value) {
                __auto_type cond_expr = _mv_1094.value;
                if (!(defn_is_verification_only_expr(cond_expr))) {
                    {
                        __auto_type cond_c = expr_transpile_expr(ctx, cond_expr);
                        __auto_type expr_str = parser_pretty_print(arena, cond_expr);
