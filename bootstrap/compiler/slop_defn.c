        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_979.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 1) {
                    ...
                    __auto_type _mv_980 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_985.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 1) {
                    ...
                    __auto_type _mv_986 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_986.has_value) {
                        __auto_type head = _mv_986.value;
                        __auto_type _mv_987 = (*head);
                        switch (_mv_987.tag) {
                            case types_SExpr_sym:
                            {
                    ...
                    case types_SExpr_lst:
                    {
                        __auto_type lst = _mv_989.data.lst;
                        {
                            ...
                            if (((int64_t)((sub_items).len)) > 0) {
                                __auto_type _mv_990 = ({ __auto_type _lst = sub_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    ...
                    if (len < 4) {
                        ...
                        if (_mv_996.has_value) {
                            ...
                            switch (_mv_997.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_997.data.sym;
                                    {
                                        ...
                                        __auto_type _mv_998 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_998.has_value) {
                                            __auto_type type_expr = _mv_998.value;
                                            {
                                                ...
                                                __auto_type _mv_999 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_999.has_value) {
                                                    __auto_type value_expr = _mv_999.value;
        ...
        if (ctype_is_int_type(type_name)) {
        ...
        } else {
            {
                ...
                if (string_eq(type_name, SLOP_STR("String"))) {
                    __auto_type _mv_1000 = (*value_expr);
                    switch (_mv_1000.tag) {
...
slop_string defn_eval_const_value(context_TranspileContext* ctx, types_SExpr* expr) {
    ...
    SLOP_PRE(((expr != NULL)), "(!= expr nil)");
    {
        ...
        switch (_mv_1002.tag) {
            ...
            case types_SExpr_str:
            {
                __auto_type str = _mv_1002.data.str;
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1003.data.lst;
                {
                    ...
                    __auto_type len = ((int64_t)((items).len));
                    {
                        ...
                        if (len >= (name_idx + 1)) {
                            __auto_type _mv_1004 = ({ __auto_type _lst = items; size_t _idx = (size_t)name_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
uint8_t defn_is_string_expr(slop_list_types_SExpr_ptr items, int64_t idx) {
    __auto_type _mv_1006 = ({ __auto_type _lst = items; size_t _idx = (size_t)idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    if (_mv_1006.has_value) {
        ...
        switch (_mv_1007.tag) {
            case types_SExpr_str:
            {
                __auto_type _ = _mv_1007.data.str;
                return 1;
            }
            default: {
                return 0;
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1008.data.lst;
                {
                    ...
                    if (len < 3) {
                        ...
                        __auto_type _mv_1009 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_1009.has_value) {
                            __auto_type name_expr = _mv_1009.value;
                            __auto_type _mv_1010 = (*name_expr);
                            switch (_mv_1010.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_1010.data.sym;
                                    {
                                        __auto_type raw_name = name_sym.name;
                                        __auto_type base_name = ctype_to_c_name(arena, raw_name);
                                        ...
                                        __auto_type _mv_1011 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_1011.has_value) {
                                            __auto_type type_def = _mv_1011.value;
...
void defn_dispatch_type_def(context_TranspileContext* ctx, slop_string raw_name, slop_string qualified_name, types_SExpr* type_def) {
    ...
    __auto_type _mv_1012 = (*type_def);
    switch (_mv_1012.tag) {
        case types_SExpr_lst:
        {
            __auto_type def_lst = _mv_1012.data.lst;
            {
...
uint8_t defn_has_payload_variants(slop_list_types_SExpr_ptr items) {
    {
        ...
        while ((i < len) && !(found)) {
            ...
            if (_mv_1015.has_value) {
                ...
                __auto_type _mv_1016 = (*item);
                switch (_mv_1016.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type _ = _mv_1016.data.lst;
                        found = 1;
                        break;
                    }
                    default: {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_1018.has_value) {
                __auto_type field_expr = _mv_1018.value;
...
void defn_emit_record_field(context_TranspileContext* ctx, slop_string raw_type_name, slop_string qualified_type_name, types_SExpr* field) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1019 = (*field);
        switch (_mv_1019.tag) {
            case types_SExpr_lst:
            {
                __auto_type field_lst = _mv_1019.data.lst;
                {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_1024.has_value) {
                __auto_type val_expr = _mv_1024.value;
                __auto_type _mv_1025 = (*val_expr);
                switch (_mv_1025.tag) {
                    case types_SExpr_sym:
                    {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_1033.has_value) {
                __auto_type variant_expr = _mv_1033.value;
                __auto_type _mv_1034 = (*variant_expr);
                switch (_mv_1034.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type var_lst = _mv_1034.data.lst;
                        {
                            __auto_type var_items = var_lst.items;
                            if (((int64_t)((var_items).len)) >= 1) {
                                __auto_type _mv_1035 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1035.has_value) {
                                    __auto_type tag_expr = _mv_1035.value;
                                    __auto_type _mv_1036 = (*tag_expr);
                                    switch (_mv_1036.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type tag_sym = _mv_1036.data.sym;
                                            {
                                                __auto_type tag_name = tag_sym.name;
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_1037.has_value) {
                __auto_type variant_expr = _mv_1037.value;
                __auto_type _mv_1038 = (*variant_expr);
                switch (_mv_1038.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type var_lst = _mv_1038.data.lst;
                        {
                            __auto_type var_items = var_lst.items;
                            __auto_type var_len = ((int64_t)((var_items).len));
                            if (var_len >= 2) {
                                __auto_type _mv_1039 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1039.has_value) {
                                    __auto_type tag_expr = _mv_1039.value;
                                    __auto_type _mv_1040 = (*tag_expr);
                                    switch (_mv_1040.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type tag_sym = _mv_1040.data.sym;
                                            {
                                                __auto_type tag_name = tag_sym.name;
                                                if (var_len == 2) {
                                                    __auto_type _mv_1041 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    ...
                                                    for (int64_t fi = 1; fi < var_len; fi++) {
                                                        __auto_type _mv_1042 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)fi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    ...
                                                    __auto_type _mv_1043 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                ...
                __auto_type lst = _mv_1047.data.lst;
                {
                    ...
                    if (len < 3) {
                        ...
                        if (_mv_1048.has_value) {
                            __auto_type elem_type_expr = _mv_1048.value;
                            __auto_type _mv_1049 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_1049.has_value) {
                                __auto_type size_expr = _mv_1049.value;
                                {
...
slop_string defn_get_number_as_string(types_SExpr* expr) {
    ...
    switch (_mv_1050.tag) {
        case types_SExpr_num:
        {
            __auto_type num = _mv_1050.data.num;
            return num.raw;
        }
        default: {
            return SLOP_STR("0");
                ...
                __auto_type lst = _mv_1054.data.lst;
                {
                    ...
                    while (i < len) {
                        ...
                        if (_mv_1055.has_value) {
                            ...
                            __auto_type _mv_1056 = (*item);
                            switch (_mv_1056.tag) {
                                case types_SExpr_num:
                                {
                                    __auto_type num = _mv_1056.data.num;
                                    if (!(found_dots)) {
                            ...
                            switch (_mv_1059.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_1059.data.sym;
                                    {
                                        ...
                                        __auto_type _mv_1060 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_1060.has_value) {
                                            __auto_type params_expr = _mv_1060.value;
                    ...
                    if (len >= 2) {
                        {
                            ...
                            __auto_type _mv_1066 = ({ __auto_type _lst = items; size_t _idx = (size_t)name_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_1066.has_value) {
                                ...
                                switch (_mv_1067.tag) {
                                    case types_SExpr_sym:
                                    {
                                        ...
                                        __auto_type _mv_1068 = ({ __auto_type _lst = items; size_t _idx = (size_t)type_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_1068.has_value) {
                                            __auto_type type_expr = _mv_1068.value;
                                            {
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1069.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 1) {
                    ...
                    __auto_type _mv_1070 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_list_context_FuncParamType_ptr defn_collect_param_types(context_TranspileContext* ctx, types_SExpr* params_expr) {
    ...
    SLOP_PRE(((params_expr != NULL)), "(!= params-expr nil)");
    {
        ...
        __auto_type _mv_1072 = (*params_expr);
        switch (_mv_1072.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1072.data.lst;
                {
                    ...
                    while (i < len) {
                        ...
                        if (_mv_1073.has_value) {
                            __auto_type param = _mv_1073.value;
                            {
...
slop_string defn_extract_spec_slop_return_type(context_TranspileContext* ctx, types_SExpr* spec_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1088 = (*spec_expr);
        switch (_mv_1088.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1088.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) < 2) {
                        ...
                        if (_mv_1089.has_value) {
                            __auto_type spec_body = _mv_1089.value;
                            __auto_type _mv_1090 = (*spec_body);
                            switch (_mv_1090.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type body_lst = _mv_1090.data.lst;
                                    {
                                        __auto_type body_items = body_lst.items;
                                        __auto_type body_len = ((int64_t)((body_items).len));
                                        if (body_len < 1) {
                                            ...
                                            __auto_type _mv_1091 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)(body_len - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_1091.has_value) {
                                                __auto_type ret_type = _mv_1091.value;
...
slop_option_string defn_extract_result_type_name(context_TranspileContext* ctx, types_SExpr* spec_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1094 = (*spec_expr);
        switch (_mv_1094.tag) {
            case types_SExpr_lst:
            {
                                ...
                                case types_SExpr_lst:
                                {
                                    __auto_type body_lst = _mv_1096.data.lst;
                                    {
                                        ...
                                        if (body_len < 1) {
                                            ...
                                            __auto_type _mv_1097 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)(body_len - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_option_string defn_check_result_type(context_TranspileContext* ctx, types_SExpr* type_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1098 = (*type_expr);
        switch (_mv_1098.tag) {
            case types_SExpr_sym:
            {
                ...
                {
                    __auto_type type_name = sym.name;
                    __auto_type _mv_1099 = context_ctx_lookup_result_type_alias(ctx, type_name);
                    if (_mv_1099.has_value) {
                        __auto_type alias_result = _mv_1099.value;
                        return (slop_option_string){.has_value = 1, .value = alias_result};
                    } else if (!_mv_1099.has_value) {
                        __auto_type _mv_1100 = context_ctx_lookup_type(ctx, type_name);
                        if (_mv_1100.has_value) {
                            __auto_type entry = _mv_1100.value;
                                ...
                                case types_SExpr_sym:
                                {
                                    ...
                                    if (string_eq(sym.name, SLOP_STR("Result"))) {
                                        ...
                                        if (_mv_1103.has_value) {
                                            __auto_type ok_type_expr = _mv_1103.value;
                                            __auto_type _mv_1104 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_1104.has_value) {
                                                __auto_type err_type_expr = _mv_1104.value;
                                                {
                ...
                __auto_type lst = _mv_1107.data.lst;
                {
                    ...
                    if (len < 2) {
                    ...
                    } else {
                        {
                            ...
                            __auto_type _mv_1108 = ({ __auto_type _lst = items; size_t _idx = (size_t)name_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_1108.has_value) {
                                __auto_type name_expr = _mv_1108.value;
                                __auto_type _mv_1109 = (*name_expr);
                                switch (_mv_1109.tag) {
                                    case types_SExpr_sym:
                                    {
                                        __auto_type name_sym = _mv_1109.data.sym;
                                        __auto_type _mv_1110 = ({ __auto_type _lst = items; size_t _idx = (size_t)type_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
uint8_t defn_is_param_mode(slop_list_types_SExpr_ptr items) {
    if (((int64_t)((items).len)) < 1) {
        ...
        __auto_type _mv_1111 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        if (_mv_1111.has_value) {
            __auto_type first = _mv_1111.value;
            __auto_type _mv_1112 = (*first);
            switch (_mv_1112.tag) {
                case types_SExpr_sym:
                {
...
uint8_t defn_is_fn_type(types_SExpr* type_expr) {
    __auto_type _mv_1113 = (*type_expr);
    switch (_mv_1113.tag) {
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1113.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 1) {
                    ...
                    if (_mv_1114.has_value) {
                        __auto_type first = _mv_1114.value;
                        __auto_type _mv_1115 = (*first);
                        switch (_mv_1115.tag) {
                            case types_SExpr_sym:
                            {
                    ...
                    } else {
                        {
                            ...
                            if (len == 2) {
                                ...
                                if (_mv_1117.has_value) {
                                    __auto_type args_expr = _mv_1117.value;
                                    {
...
slop_string defn_build_fn_args_str_for_param(context_TranspileContext* ctx, types_SExpr* args_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1118 = (*args_expr);
        switch (_mv_1118.tag) {
            case types_SExpr_lst:
            {
                __auto_type args_list = _mv_1118.data.lst;
                {
                    ...
                    if (arg_count == 0) {
                    ...
                    } else {
                        {
                            ...
                            __auto_type i = 0;
                            while (i < arg_count) {
                                __auto_type _mv_1119 = ({ __auto_type _lst = arg_items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1119.has_value) {
                                    __auto_type arg_expr = _mv_1119.value;
                                    {
...
uint8_t defn_is_c_name_attr_at(slop_list_types_SExpr_ptr items, int64_t idx) {
    __auto_type _mv_1123 = ({ __auto_type _lst = items; size_t _idx = (size_t)idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                ...
                __auto_type lst = _mv_1144.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) >= 2) {
                        ...
                        if (_mv_1145.has_value) {
                            __auto_type val = _mv_1145.value;
                            __auto_type _mv_1146 = (*val);
                            switch (_mv_1146.tag) {
                                case types_SExpr_str:
                                {
                                    __auto_type str = _mv_1146.data.str;
                ...
                __auto_type lst = _mv_1148.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) >= 2) {
                        ...
                        if (_mv_1149.has_value) {
                            __auto_type val = _mv_1149.value;
        ...
        while (i < len) {
            ...
            if (_mv_1150.has_value) {
                ...
                if (defn_is_pre_form(item)) {
                    __auto_type _mv_1151 = defn_get_annotation_condition(item);
                    if (_mv_1151.has_value) {
                        __auto_type cond = _mv_1151.value;
...
slop_list_types_SExpr_ptr defn_collect_postconditions(slop_arena* arena, slop_list_types_SExpr_ptr items) {
    {
        ...
        int64_t i = 3;
        while (i < len) {
            __auto_type _mv_1152 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1152.has_value) {
                __auto_type item = _mv_1152.value;
                if (defn_is_post_form(item)) {
                    __auto_type _mv_1153 = defn_get_annotation_condition(item);
                    if (_mv_1153.has_value) {
                        __auto_type cond = _mv_1153.value;
                        ({ __auto_type _lst_p = &(result); __auto_type _item = (cond); if (_lst_p->len >= _lst_p->cap) { size_t _new_cap = _lst_p->cap == 0 ? 16 : _lst_p->cap * 2; __typeof__(_lst_p->data) _new_data = (__typeof__(_lst_p->data))slop_arena_alloc(arena, _new_cap * sizeof(*_lst_p->data)); if (_lst_p->len > 0) memcpy(_new_data, _lst_p->data, _lst_p->len * sizeof(*_lst_p->data)); _lst_p->data = _new_data; _lst_p->cap = _new_cap; } _lst_p->data[_lst_p->len++] = _item; (void)0; });
        ...
        while (i < len) {
            ...
            if (_mv_1154.has_value) {
                ...
                if (defn_is_assume_form(item)) {
                    __auto_type _mv_1155 = defn_get_annotation_condition(item);
                    if (_mv_1155.has_value) {
                        __auto_type cond = _mv_1155.value;
                        ({ __auto_type _lst_p = &(result); __auto_type _item = (cond); if (_lst_p->len >= _lst_p->cap) { size_t _new_cap = _lst_p->cap == 0 ? 16 : _lst_p->cap * 2; __typeof__(_lst_p->data) _new_data = (__typeof__(_lst_p->data))slop_arena_alloc(arena, _new_cap * sizeof(*_lst_p->data)); if (_lst_p->len > 0) memcpy(_new_data, _lst_p->data, _lst_p->len * sizeof(*_lst_p->data)); _lst_p->data = _new_data; _lst_p->cap = _new_cap; } _lst_p->data[_lst_p->len++] = _item; (void)0; });
...
void defn_emit_preconditions(context_TranspileContext* ctx, slop_list_types_SExpr_ptr preconditions) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1157 = ({ __auto_type _lst = preconditions; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void defn_emit_postconditions(context_TranspileContext* ctx, slop_list_types_SExpr_ptr postconditions) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1158 = ({ __auto_type _lst = postconditions; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void defn_emit_assumptions(context_TranspileContext* ctx, slop_list_types_SExpr_ptr assumptions) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1159 = ({ __auto_type _lst = assumptions; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1159.has_value) {
                __auto_type cond_expr = _mv_1159.value;
                if (!(defn_is_verification_only_expr(cond_expr))) {
                    {
                        __auto_type cond_c = expr_transpile_expr(ctx, cond_expr);
                        __auto_type expr_str = parser_pretty_print(arena, cond_expr);
