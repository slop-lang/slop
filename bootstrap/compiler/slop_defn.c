        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_909.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    __auto_type _mv_910 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_910.has_value) {
                        __auto_type head = _mv_910.value;
                        __auto_type _mv_911 = (*head);
                        switch (_mv_911.tag) {
                            case types_SExpr_sym:
                            {
                                __auto_type sym = _mv_911.data.sym;
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_912.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    __auto_type _mv_913 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_915.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    __auto_type _mv_916 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_916.has_value) {
                        __auto_type head = _mv_916.value;
                        __auto_type _mv_917 = (*head);
                        switch (_mv_917.tag) {
                            case types_SExpr_sym:
                            {
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_918.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    __auto_type _mv_919 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_921.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    __auto_type _mv_922 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
uint8_t defn_has_generic_annotation(slop_list_types_SExpr_ptr items) {
    {
        ...
        __auto_type found = 0;
        while (((i < len) && !(found))) {
            __auto_type _mv_924 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_924.has_value) {
                __auto_type item = _mv_924.value;
                __auto_type _mv_925 = (*item);
                switch (_mv_925.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type lst = _mv_925.data.lst;
                        {
                            ...
                            if ((((int64_t)((sub_items).len)) > 0)) {
                                __auto_type _mv_926 = ({ __auto_type _lst = sub_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_926.has_value) {
                                    __auto_type head = _mv_926.value;
                                    __auto_type _mv_927 = (*head);
                                    switch (_mv_927.tag) {
                                        case types_SExpr_sym:
                                        {
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_928.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    __auto_type _mv_929 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_929.has_value) {
                        __auto_type head = _mv_929.value;
                        __auto_type _mv_930 = (*head);
                        switch (_mv_930.tag) {
                            case types_SExpr_sym:
                            {
                    ...
                    if ((len < 4)) {
                        ...
                        if (_mv_932.has_value) {
                            ...
                            switch (_mv_933.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_933.data.sym;
                                    {
                                        ...
                                        if (_mv_934.has_value) {
                                            __auto_type type_expr = _mv_934.value;
                                            {
                                                ...
                                                __auto_type _mv_935 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_935.has_value) {
                                                    __auto_type value_expr = _mv_935.value;
        ...
        if (ctype_is_int_type(type_name)) {
        ...
        } else {
            {
                ...
                if (string_eq(type_name, SLOP_STR("String"))) {
                    __auto_type _mv_936 = (*value_expr);
                    switch (_mv_936.tag) {
                        case types_SExpr_str:
                        {
                            __auto_type str = _mv_936.data.str;
...
slop_string defn_eval_const_value(context_TranspileContext* ctx, types_SExpr* expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_938 = (*expr);
        switch (_mv_938.tag) {
            case types_SExpr_num:
            {
                __auto_type num = _mv_938.data.num;
                return num.raw;
            }
            case types_SExpr_str:
            {
                __auto_type str = _mv_938.data.str;
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_939.data.lst;
                {
                    ...
                    __auto_type len = ((int64_t)((items).len));
                    {
                        ...
                        if ((len >= (name_idx + 1))) {
                            __auto_type _mv_940 = ({ __auto_type _lst = items; size_t _idx = (size_t)name_idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
uint8_t defn_is_string_expr(slop_list_types_SExpr_ptr items, int64_t idx) {
    __auto_type _mv_942 = ({ __auto_type _lst = items; size_t _idx = (size_t)idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    if (_mv_942.has_value) {
        __auto_type item = _mv_942.value;
        __auto_type _mv_943 = (*item);
        switch (_mv_943.tag) {
            case types_SExpr_str:
            {
                __auto_type _ = _mv_943.data.str;
                return 1;
            }
            default: {
                return 0;
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_944.data.lst;
                {
                    ...
                    if ((len < 3)) {
                        ...
                        __auto_type _mv_945 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_945.has_value) {
                            __auto_type name_expr = _mv_945.value;
                            __auto_type _mv_946 = (*name_expr);
                            switch (_mv_946.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_946.data.sym;
                                    {
                                        __auto_type raw_name = name_sym.name;
                                        __auto_type base_name = ctype_to_c_name(arena, raw_name);
                                        ...
                                        __auto_type _mv_947 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_947.has_value) {
                                            __auto_type type_def = _mv_947.value;
...
void defn_dispatch_type_def(context_TranspileContext* ctx, slop_string raw_name, slop_string qualified_name, types_SExpr* type_def) {
    ...
    __auto_type _mv_948 = (*type_def);
    switch (_mv_948.tag) {
        case types_SExpr_lst:
        {
            __auto_type def_lst = _mv_948.data.lst;
            {
...
uint8_t defn_has_payload_variants(slop_list_types_SExpr_ptr items) {
    {
        ...
        uint8_t found = 0;
        while (((i < len) && !(found))) {
            __auto_type _mv_951 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_951.has_value) {
                __auto_type item = _mv_951.value;
                __auto_type _mv_952 = (*item);
                switch (_mv_952.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type _ = _mv_952.data.lst;
                        found = 1;
                        break;
                    }
                    default: {
...
void defn_emit_record_fields(context_TranspileContext* ctx, slop_string raw_type_name, slop_string qualified_type_name, slop_list_types_SExpr_ptr items, int64_t start_idx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = start_idx;
        while ((i < len)) {
            __auto_type _mv_954 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void defn_emit_record_field(context_TranspileContext* ctx, slop_string raw_type_name, slop_string qualified_type_name, types_SExpr* field) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_955 = (*field);
        switch (_mv_955.tag) {
            case types_SExpr_lst:
            {
                __auto_type field_lst = _mv_955.data.lst;
                {
                    ...
                    if ((len < 2)) {
                        ...
                        __auto_type _mv_956 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_956.has_value) {
                            ...
                            switch (_mv_957.tag) {
                                case types_SExpr_sym:
                                {
                                    ...
                                    __auto_type _mv_958 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while ((i < len)) {
            ...
            if (_mv_960.has_value) {
                __auto_type val_expr = _mv_960.value;
                __auto_type _mv_961 = (*val_expr);
                switch (_mv_961.tag) {
                    case types_SExpr_sym:
                    {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while ((i < len)) {
            ...
            if (_mv_963.has_value) {
                __auto_type variant_expr = _mv_963.value;
                __auto_type _mv_964 = (*variant_expr);
                switch (_mv_964.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type var_lst = _mv_964.data.lst;
                        {
                            __auto_type var_items = var_lst.items;
                            __auto_type var_len = ((int64_t)((var_items).len));
                            if ((var_len >= 1)) {
                                __auto_type _mv_965 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_965.has_value) {
                                    __auto_type tag_expr = _mv_965.value;
                                    __auto_type _mv_966 = (*tag_expr);
                                    switch (_mv_966.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type tag_sym = _mv_966.data.sym;
                                            {
                                                __auto_type tag_name = tag_sym.name;
                                                if ((var_len >= 2)) {
                                                    __auto_type _mv_967 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_967.has_value) {
                                                        __auto_type type_expr = _mv_967.value;
                                                        {
                                                            __auto_type c_type = context_to_c_type_prefixed(ctx, type_expr);
                                                            {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while ((i < len)) {
            ...
            if (_mv_968.has_value) {
                __auto_type variant_expr = _mv_968.value;
                __auto_type _mv_969 = (*variant_expr);
                switch (_mv_969.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type var_lst = _mv_969.data.lst;
                        {
                            __auto_type var_items = var_lst.items;
                            if ((((int64_t)((var_items).len)) >= 1)) {
                                __auto_type _mv_970 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_970.has_value) {
                                    __auto_type tag_expr = _mv_970.value;
                                    __auto_type _mv_971 = (*tag_expr);
                                    switch (_mv_971.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type tag_sym = _mv_971.data.sym;
                                            {
                                                __auto_type tag_name = tag_sym.name;
        ...
        while ((i < len)) {
            ...
            if (_mv_972.has_value) {
                ...
                switch (_mv_973.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type var_lst = _mv_973.data.lst;
                        {
                            __auto_type var_items = var_lst.items;
                            __auto_type var_len = ((int64_t)((var_items).len));
                            if ((var_len >= 2)) {
                                __auto_type _mv_974 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_974.has_value) {
                                    __auto_type tag_expr = _mv_974.value;
                                    __auto_type _mv_975 = (*tag_expr);
                                    switch (_mv_975.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type tag_sym = _mv_975.data.sym;
                                            {
                                                __auto_type tag_name = tag_sym.name;
                                                __auto_type _mv_976 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_977.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    __auto_type _mv_978 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_980.data.lst;
                {
                    ...
                    if ((len < 3)) {
                        ...
                        __auto_type _mv_981 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_981.has_value) {
                            __auto_type elem_type_expr = _mv_981.value;
                            __auto_type _mv_982 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_982.has_value) {
                                __auto_type size_expr = _mv_982.value;
                                {
...
slop_string defn_get_number_as_string(types_SExpr* expr) {
    ...
    switch (_mv_983.tag) {
        case types_SExpr_num:
        {
            __auto_type num = _mv_983.data.num;
            return num.raw;
        }
        default: {
            return SLOP_STR("0");
        ...
        switch (_mv_987.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_987.data.lst;
                {
                    ...
                    __auto_type i = 1;
                    while ((i < len)) {
                        __auto_type _mv_988 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_988.has_value) {
                            __auto_type item = _mv_988.value;
                            __auto_type _mv_989 = (*item);
                            switch (_mv_989.tag) {
                                case types_SExpr_num:
                                {
                                    __auto_type num = _mv_989.data.num;
                                    if (!(found_dots)) {
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_990.data.lst;
                {
                    ...
                    if ((len < 3)) {
                        ...
                        __auto_type _mv_991 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_991.has_value) {
                            __auto_type name_expr = _mv_991.value;
                            __auto_type _mv_992 = (*name_expr);
                            switch (_mv_992.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_992.data.sym;
                                    {
                                        __auto_type raw_name = name_sym.name;
                                        __auto_type base_name = ctype_to_c_name(arena, raw_name);
                                        ...
                                        __auto_type _mv_993 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_993.has_value) {
                                            __auto_type params_expr = _mv_993.value;
...
void defn_bind_params_to_scope(context_TranspileContext* ctx, types_SExpr* params_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_996 = (*params_expr);
        switch (_mv_996.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_996.data.lst;
                {
                    ...
                    while ((i < len)) {
                        ...
                        if (_mv_997.has_value) {
                            __auto_type param = _mv_997.value;
                    ...
                    if ((len >= 2)) {
                        {
                            ...
                            __auto_type _mv_999 = ({ __auto_type _lst = items; size_t _idx = (size_t)name_idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_999.has_value) {
                                __auto_type name_expr = _mv_999.value;
                                __auto_type _mv_1000 = (*name_expr);
                                switch (_mv_1000.tag) {
                                    case types_SExpr_sym:
                                    {
                                        __auto_type name_sym = _mv_1000.data.sym;
                                        __auto_type _mv_1001 = ({ __auto_type _lst = items; size_t _idx = (size_t)type_idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_1001.has_value) {
                                            __auto_type type_expr = _mv_1001.value;
                                            {
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1002.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    __auto_type _mv_1003 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_1003.has_value) {
                        __auto_type head = _mv_1003.value;
                        __auto_type _mv_1004 = (*head);
                        switch (_mv_1004.tag) {
                            case types_SExpr_sym:
                            {
        ...
        switch (_mv_1005.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1005.data.lst;
                {
                    ...
                    __auto_type i = 0;
                    while ((i < len)) {
                        __auto_type _mv_1006 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                ...
                __auto_type lst = _mv_1007.data.lst;
                {
                    ...
                    if ((len < 2)) {
                    ...
                    } else {
                        {
                            __auto_type has_mode = ((len >= 3) && defn_is_param_mode(items));
                            __auto_type type_idx = ((has_mode) ? 2 : 1);
                            __auto_type _mv_1008 = ({ __auto_type _lst = items; size_t _idx = (size_t)type_idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_1008.has_value) {
                                __auto_type type_expr = _mv_1008.value;
        ...
        switch (_mv_1009.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1009.data.lst;
                {
                    ...
                    __auto_type len = ((int64_t)((items).len));
                    if ((len >= 3)) {
                        __auto_type _mv_1010 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_1010.has_value) {
                            __auto_type name_expr = _mv_1010.value;
                            __auto_type _mv_1011 = (*name_expr);
                            switch (_mv_1011.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_1011.data.sym;
                                    {
                                        __auto_type raw_name = name_sym.name;
                                        __auto_type base_name = ctype_to_c_name(arena, raw_name);
                                        ...
                                        if (_mv_1012.has_value) {
                                            __auto_type params_expr = _mv_1012.value;
                                            {
                                                __auto_type result_type_opt = defn_get_result_type_name(ctx, items);
                                                __auto_type raw_return = defn_get_return_type(ctx, items);
                                                {
...
slop_string defn_get_return_type(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while ((i < len)) {
            __auto_type _mv_1013 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_string defn_extract_spec_return_type(context_TranspileContext* ctx, types_SExpr* spec_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1017 = (*spec_expr);
        switch (_mv_1017.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1017.data.lst;
                {
                    ...
                    if ((((int64_t)((items).len)) < 2)) {
                        ...
                        __auto_type _mv_1018 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_1018.has_value) {
                            __auto_type spec_body = _mv_1018.value;
                            __auto_type _mv_1019 = (*spec_body);
                            switch (_mv_1019.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type body_lst = _mv_1019.data.lst;
                                    {
                                        ...
                                        if ((body_len < 1)) {
                                            ...
                                            __auto_type _mv_1020 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)(body_len - 1); slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_1020.has_value) {
                                                __auto_type ret_type = _mv_1020.value;
...
slop_string defn_extract_spec_slop_return_type(context_TranspileContext* ctx, types_SExpr* spec_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1021 = (*spec_expr);
        switch (_mv_1021.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1021.data.lst;
                {
                    ...
                    if ((((int64_t)((items).len)) < 2)) {
                        ...
                        __auto_type _mv_1022 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_1022.has_value) {
                            __auto_type spec_body = _mv_1022.value;
                            __auto_type _mv_1023 = (*spec_body);
                            switch (_mv_1023.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type body_lst = _mv_1023.data.lst;
                                    {
                                        __auto_type body_items = body_lst.items;
                                        __auto_type body_len = ((int64_t)((body_items).len));
                                        if ((body_len < 1)) {
                                            ...
                                            __auto_type _mv_1024 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)(body_len - 1); slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_option_string defn_extract_result_type_name(context_TranspileContext* ctx, types_SExpr* spec_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1027 = (*spec_expr);
        switch (_mv_1027.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1027.data.lst;
                {
                    ...
                    if ((((int64_t)((items).len)) < 2)) {
                        ...
                        if (_mv_1028.has_value) {
                            __auto_type spec_body = _mv_1028.value;
                            __auto_type _mv_1029 = (*spec_body);
                            switch (_mv_1029.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type body_lst = _mv_1029.data.lst;
                                    {
                                        __auto_type body_items = body_lst.items;
                                        __auto_type body_len = ((int64_t)((body_items).len));
                                        if ((body_len < 1)) {
                                            ...
                                            __auto_type _mv_1030 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)(body_len - 1); slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_1030.has_value) {
                                                __auto_type ret_type = _mv_1030.value;
...
slop_option_string defn_check_result_type(context_TranspileContext* ctx, types_SExpr* type_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1031 = (*type_expr);
        switch (_mv_1031.tag) {
            case types_SExpr_sym:
            {
                ...
                {
                    __auto_type type_name = sym.name;
                    __auto_type _mv_1032 = context_ctx_lookup_result_type_alias(ctx, type_name);
                    if (_mv_1032.has_value) {
                        __auto_type alias_result = _mv_1032.value;
                        return (slop_option_string){.has_value = 1, .value = alias_result};
                    } else if (!_mv_1032.has_value) {
                        __auto_type _mv_1033 = context_ctx_lookup_type(ctx, type_name);
                        if (_mv_1033.has_value) {
                            __auto_type entry = _mv_1033.value;
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1031.data.lst;
                {
                    ...
                    if ((((int64_t)((items).len)) < 3)) {
                        ...
                        __auto_type _mv_1034 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            ...
                            switch (_mv_1035.tag) {
                                case types_SExpr_sym:
                                {
                                    ...
                                    if (string_eq(sym.name, SLOP_STR("Result"))) {
                                        __auto_type _mv_1036 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_1036.has_value) {
                                            __auto_type ok_type_expr = _mv_1036.value;
                                            __auto_type _mv_1037 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_1037.has_value) {
                                                __auto_type err_type_expr = _mv_1037.value;
                                                {
...
uint8_t defn_is_param_mode(slop_list_types_SExpr_ptr items) {
    if ((((int64_t)((items).len)) < 1)) {
        ...
        __auto_type _mv_1044 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        if (_mv_1044.has_value) {
            __auto_type first = _mv_1044.value;
            __auto_type _mv_1045 = (*first);
            switch (_mv_1045.tag) {
                case types_SExpr_sym:
                {
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1046.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    __auto_type _mv_1047 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_1047.has_value) {
                        __auto_type first = _mv_1047.value;
                        __auto_type _mv_1048 = (*first);
                        switch (_mv_1048.tag) {
                            case types_SExpr_sym:
                            {
...
slop_string defn_emit_fn_param_type(context_TranspileContext* ctx, types_SExpr* type_expr, slop_string param_name) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1049 = (*type_expr);
        switch (_mv_1049.tag) {
            case types_SExpr_lst:
            {
                    ...
                    if ((len < 2)) {
                    ...
                    } else {
                        {
                            ...
                            if ((len == 2)) {
                                ...
                                __auto_type _mv_1050 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1050.has_value) {
                                    __auto_type args_expr = _mv_1050.value;
                                    {
...
slop_string defn_build_fn_args_str_for_param(context_TranspileContext* ctx, types_SExpr* args_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1051 = (*args_expr);
        switch (_mv_1051.tag) {
            case types_SExpr_lst:
            {
                __auto_type args_list = _mv_1051.data.lst;
                {
                    ...
                    if ((arg_count == 0)) {
                    ...
                    } else {
                        {
                            ...
                            __auto_type i = 0;
                            while ((i < arg_count)) {
                                __auto_type _mv_1052 = ({ __auto_type _lst = arg_items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1052.has_value) {
                                    __auto_type arg_expr = _mv_1052.value;
                                    {
...
void defn_emit_function_body(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        i = body_start;
        while ((i < len)) {
            __auto_type _mv_1053 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1053.has_value) {
                __auto_type item = _mv_1053.value;
...
uint8_t defn_is_c_name_attr_at(slop_list_types_SExpr_ptr items, int64_t idx) {
    __auto_type _mv_1056 = ({ __auto_type _lst = items; size_t _idx = (size_t)idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1064.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    __auto_type _mv_1065 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_1065.has_value) {
                        __auto_type head = _mv_1065.value;
                        __auto_type _mv_1066 = (*head);
                        switch (_mv_1066.tag) {
                            case types_SExpr_sym:
                            {
            ...
            __auto_type lst = _mv_1070.data.lst;
            {
                ...
                if ((len < 1)) {
                ...
                } else {
                    {
                        __auto_type found = 0;
                        __auto_type i = 0;
                        __auto_type _mv_1071 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                ...
                __auto_type lst = _mv_1077.data.lst;
                {
                    ...
                    if ((((int64_t)((items).len)) >= 2)) {
                        ...
                        if (_mv_1078.has_value) {
                            __auto_type val = _mv_1078.value;
                            __auto_type _mv_1079 = (*val);
                            switch (_mv_1079.tag) {
                                case types_SExpr_str:
                                {
                                    __auto_type str = _mv_1079.data.str;
...
slop_option_string defn_collect_doc_string(slop_arena* arena, slop_list_types_SExpr_ptr items) {
    {
        ...
        while (((i < len) && ({ __auto_type _mv = result; _mv.has_value ? (0) : (1); }))) {
            __auto_type _mv_1080 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1080.has_value) {
                __auto_type item = _mv_1080.value;
                ...
                __auto_type lst = _mv_1081.data.lst;
                {
                    ...
                    if ((((int64_t)((items).len)) >= 2)) {
                        ...
                        if (_mv_1082.has_value) {
                            __auto_type val = _mv_1082.value;
        ...
        while ((i < len)) {
            ...
            if (_mv_1083.has_value) {
                ...
                if (defn_is_pre_form(item)) {
                    __auto_type _mv_1084 = defn_get_annotation_condition(item);
                    if (_mv_1084.has_value) {
                        __auto_type cond = _mv_1084.value;
...
slop_list_types_SExpr_ptr defn_collect_postconditions(slop_arena* arena, slop_list_types_SExpr_ptr items) {
    {
        ...
        int64_t i = 3;
        while ((i < len)) {
            __auto_type _mv_1085 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1085.has_value) {
                __auto_type item = _mv_1085.value;
                if (defn_is_post_form(item)) {
                    __auto_type _mv_1086 = defn_get_annotation_condition(item);
                    if (_mv_1086.has_value) {
                        __auto_type cond = _mv_1086.value;
                        ({ __auto_type _lst_p = &(result); __auto_type _item = (cond); if (_lst_p->len >= _lst_p->cap) { size_t _new_cap = _lst_p->cap == 0 ? 16 : _lst_p->cap * 2; __typeof__(_lst_p->data) _new_data = (__typeof__(_lst_p->data))slop_arena_alloc(arena, _new_cap * sizeof(*_lst_p->data)); if (_lst_p->len > 0) memcpy(_new_data, _lst_p->data, _lst_p->len * sizeof(*_lst_p->data)); _lst_p->data = _new_data; _lst_p->cap = _new_cap; } _lst_p->data[_lst_p->len++] = _item; (void)0; });
...
slop_list_types_SExpr_ptr defn_collect_assumptions(slop_arena* arena, slop_list_types_SExpr_ptr items) {
    {
        ...
        int64_t i = 3;
        while ((i < len)) {
            __auto_type _mv_1087 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1087.has_value) {
                __auto_type item = _mv_1087.value;
                if (defn_is_assume_form(item)) {
                    __auto_type _mv_1088 = defn_get_annotation_condition(item);
                    if (_mv_1088.has_value) {
                        __auto_type cond = _mv_1088.value;
                        ({ __auto_type _lst_p = &(result); __auto_type _item = (cond); if (_lst_p->len >= _lst_p->cap) { size_t _new_cap = _lst_p->cap == 0 ? 16 : _lst_p->cap * 2; __typeof__(_lst_p->data) _new_data = (__typeof__(_lst_p->data))slop_arena_alloc(arena, _new_cap * sizeof(*_lst_p->data)); if (_lst_p->len > 0) memcpy(_new_data, _lst_p->data, _lst_p->len * sizeof(*_lst_p->data)); _lst_p->data = _new_data; _lst_p->cap = _new_cap; } _lst_p->data[_lst_p->len++] = _item; (void)0; });
...
void defn_emit_preconditions(context_TranspileContext* ctx, slop_list_types_SExpr_ptr preconditions) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1090 = ({ __auto_type _lst = preconditions; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1090.has_value) {
                __auto_type cond_expr = _mv_1090.value;
                {
...
void defn_emit_postconditions(context_TranspileContext* ctx, slop_list_types_SExpr_ptr postconditions) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1091 = ({ __auto_type _lst = postconditions; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1091.has_value) {
                __auto_type cond_expr = _mv_1091.value;
...
void defn_emit_assumptions(context_TranspileContext* ctx, slop_list_types_SExpr_ptr assumptions) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1092 = ({ __auto_type _lst = assumptions; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1092.has_value) {
                __auto_type cond_expr = _mv_1092.value;
                if (!(defn_is_verification_only_expr(cond_expr))) {
                    {
                        __auto_type cond_c = expr_transpile_expr(ctx, cond_expr);
                        __auto_type expr_str = parser_pretty_print(arena, cond_expr);
