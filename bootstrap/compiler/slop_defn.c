            ...
            __auto_type lst = _mv_948.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    if (_mv_949.has_value) {
                        __auto_type head = _mv_949.value;
                        __auto_type _mv_950 = (*head);
                        switch (_mv_950.tag) {
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_951.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    __auto_type _mv_952 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_954.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    __auto_type _mv_955 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_957.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    __auto_type _mv_958 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    ...
                    case types_SExpr_lst:
                    {
                        __auto_type lst = _mv_964.data.lst;
                        {
                            ...
                            if ((((int64_t)((sub_items).len)) > 0)) {
                                __auto_type _mv_965 = ({ __auto_type _lst = sub_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_967.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    __auto_type _mv_968 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_970.data.lst;
                {
                    ...
                    if ((len < 4)) {
                        ...
                        __auto_type _mv_971 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_971.has_value) {
                            __auto_type name_expr = _mv_971.value;
                            __auto_type _mv_972 = (*name_expr);
                            switch (_mv_972.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_972.data.sym;
                                    {
                                        ...
                                        __auto_type _mv_973 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_973.has_value) {
                                            __auto_type type_expr = _mv_973.value;
                                            {
                                                ...
                                                __auto_type _mv_974 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_974.has_value) {
                                                    __auto_type value_expr = _mv_974.value;
        ...
        if (ctype_is_int_type(type_name)) {
        ...
        } else {
            {
                ...
                if (string_eq(type_name, SLOP_STR("String"))) {
                    __auto_type _mv_975 = (*value_expr);
                    switch (_mv_975.tag) {
                        case types_SExpr_str:
                        {
                            __auto_type str = _mv_975.data.str;
...
slop_string defn_eval_const_value(context_TranspileContext* ctx, types_SExpr* expr) {
    ...
    SLOP_PRE(((expr != NULL)), "(!= expr nil)");
    {
        ...
        switch (_mv_977.tag) {
            ...
            {
                __auto_type num = _mv_977.data.num;
                return num.raw;
            }
            case types_SExpr_str:
            {
                __auto_type str = _mv_977.data.str;
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_978.data.lst;
                {
                    ...
                    __auto_type len = ((int64_t)((items).len));
                    {
                        ...
                        if ((len >= (name_idx + 1))) {
                            __auto_type _mv_979 = ({ __auto_type _lst = items; size_t _idx = (size_t)name_idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_979.has_value) {
                                __auto_type name_expr = _mv_979.value;
                                __auto_type _mv_980 = (*name_expr);
                                switch (_mv_980.tag) {
                                    case types_SExpr_sym:
                                    {
...
uint8_t defn_is_string_expr(slop_list_types_SExpr_ptr items, int64_t idx) {
    __auto_type _mv_981 = ({ __auto_type _lst = items; size_t _idx = (size_t)idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    if (_mv_981.has_value) {
        __auto_type item = _mv_981.value;
        __auto_type _mv_982 = (*item);
        switch (_mv_982.tag) {
            case types_SExpr_str:
            {
                __auto_type _ = _mv_982.data.str;
                return 1;
            }
            default: {
                return 0;
                    ...
                    if ((len < 3)) {
                        ...
                        if (_mv_984.has_value) {
                            ...
                            switch (_mv_985.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_985.data.sym;
                                    {
                                        __auto_type raw_name = name_sym.name;
                                        __auto_type base_name = ctype_to_c_name(arena, raw_name);
                                        ...
                                        if (_mv_986.has_value) {
                                            __auto_type type_def = _mv_986.value;
...
void defn_dispatch_type_def(context_TranspileContext* ctx, slop_string raw_name, slop_string qualified_name, types_SExpr* type_def) {
    ...
    __auto_type _mv_987 = (*type_def);
    switch (_mv_987.tag) {
        case types_SExpr_lst:
        {
            __auto_type def_lst = _mv_987.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    __auto_type _mv_988 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        while (((i < len) && !(found))) {
            ...
            if (_mv_990.has_value) {
                ...
                switch (_mv_991.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type _ = _mv_991.data.lst;
                        found = 1;
                        break;
                    }
                    default: {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while ((i < len)) {
            ...
            if (_mv_993.has_value) {
                __auto_type field_expr = _mv_993.value;
...
void defn_emit_record_field(context_TranspileContext* ctx, slop_string raw_type_name, slop_string qualified_type_name, types_SExpr* field) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_994 = (*field);
        switch (_mv_994.tag) {
            case types_SExpr_lst:
            {
                __auto_type field_lst = _mv_994.data.lst;
                {
                    ...
                    if ((len < 2)) {
                        ...
                        __auto_type _mv_995 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_995.has_value) {
                            ...
                            switch (_mv_996.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_996.data.sym;
                                    ...
                                    if (_mv_997.has_value) {
                                        __auto_type type_expr = _mv_997.value;
                                        {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while ((i < len)) {
            ...
            if (_mv_1002.has_value) {
                __auto_type variant_expr = _mv_1002.value;
                __auto_type _mv_1003 = (*variant_expr);
                switch (_mv_1003.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type var_lst = _mv_1003.data.lst;
                        {
                            __auto_type var_items = var_lst.items;
                            __auto_type var_len = ((int64_t)((var_items).len));
                            if ((var_len >= 1)) {
                                __auto_type _mv_1004 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1004.has_value) {
                                    __auto_type tag_expr = _mv_1004.value;
                                    __auto_type _mv_1005 = (*tag_expr);
                                    switch (_mv_1005.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type tag_sym = _mv_1005.data.sym;
                                            {
                                                __auto_type tag_name = tag_sym.name;
                                                __auto_type c_tag = ctype_to_c_name(arena, tag_name);
                                                if ((var_len == 2)) {
                                                    __auto_type _mv_1006 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_1006.has_value) {
                                                        __auto_type type_expr = _mv_1006.value;
                                                        {
                                                            __auto_type c_type = context_to_c_type_prefixed(ctx, type_expr);
                                                            {
                                                    ...
                                                    for (int64_t fi = 1; fi < var_len; fi++) {
                                                        __auto_type _mv_1007 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)fi; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                        if (_mv_1007.has_value) {
                                                            __auto_type type_expr = _mv_1007.value;
                                                            {
                                                                __auto_type c_type = context_to_c_type_prefixed(ctx, type_expr);
                                                                {
                                                                    __auto_type actual_type = ((string_eq(c_type, SLOP_STR("void"))) ? SLOP_STR("int") : c_type);
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while ((i < len)) {
            ...
            if (_mv_1008.has_value) {
                __auto_type variant_expr = _mv_1008.value;
                __auto_type _mv_1009 = (*variant_expr);
                switch (_mv_1009.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type var_lst = _mv_1009.data.lst;
                        {
                            __auto_type var_items = var_lst.items;
                            if ((((int64_t)((var_items).len)) >= 1)) {
                                __auto_type _mv_1010 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1010.has_value) {
                                    __auto_type tag_expr = _mv_1010.value;
                                    __auto_type _mv_1011 = (*tag_expr);
                                    switch (_mv_1011.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type tag_sym = _mv_1011.data.sym;
                                            {
                                                __auto_type tag_name = tag_sym.name;
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while ((i < len)) {
            ...
            if (_mv_1012.has_value) {
                __auto_type variant_expr = _mv_1012.value;
                __auto_type _mv_1013 = (*variant_expr);
                switch (_mv_1013.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type var_lst = _mv_1013.data.lst;
                        {
                            __auto_type var_items = var_lst.items;
                            __auto_type var_len = ((int64_t)((var_items).len));
                            if ((var_len >= 2)) {
                                __auto_type _mv_1014 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1014.has_value) {
                                    __auto_type tag_expr = _mv_1014.value;
                                    __auto_type _mv_1015 = (*tag_expr);
                                    switch (_mv_1015.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type tag_sym = _mv_1015.data.sym;
                                            {
                                                __auto_type tag_name = tag_sym.name;
                                                if ((var_len == 2)) {
                                                    __auto_type _mv_1016 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                ...
                                                } else if ((var_len >= 3)) {
                                                    {
                                                        ...
                                                        context_ctx_register_field_type(ctx, raw_name, count_key, count_str, SLOP_STR(""), 0);
                                                        context_ctx_register_field_type(ctx, qualified_name, count_key, count_str, SLOP_STR(""), 0);
                                                    }
                                                    for (int64_t fi = 1; fi < var_len; fi++) {
                                                        __auto_type _mv_1017 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)fi; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                        if (_mv_1017.has_value) {
                                                            __auto_type type_expr = _mv_1017.value;
                                                            {
                                                                __auto_type c_type = context_to_c_type_prefixed(ctx, type_expr);
                                                                __auto_type slop_type_str = parser_pretty_print(arena, type_expr);
                                                                __auto_type is_ptr = defn_is_pointer_type_expr(type_expr);
                                                    ...
                                                    __auto_type _mv_1018 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_1018.has_value) {
                                                        __auto_type type_expr = _mv_1018.value;
                                                        {
                                                            __auto_type c_type = context_to_c_type_prefixed(ctx, type_expr);
                                                            __auto_type slop_type_str = parser_pretty_print(arena, type_expr);
                                                            __auto_type is_ptr = defn_is_pointer_type_expr(type_expr);
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1019.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    __auto_type _mv_1020 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void defn_emit_array_typedef(context_TranspileContext* ctx, slop_string qualified_name, types_SExpr* type_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1022 = (*type_expr);
        switch (_mv_1022.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1022.data.lst;
                {
                    ...
                    if ((len < 3)) {
                        ...
                        if (_mv_1023.has_value) {
                            __auto_type elem_type_expr = _mv_1023.value;
                            ...
                            if (_mv_1024.has_value) {
                                __auto_type size_expr = _mv_1024.value;
                                {
...
slop_string defn_get_number_as_string(types_SExpr* expr) {
    SLOP_PRE(((expr != NULL)), "(!= expr nil)");
    __auto_type _mv_1025 = (*expr);
    switch (_mv_1025.tag) {
        case types_SExpr_num:
        {
            __auto_type num = _mv_1025.data.num;
            return num.raw;
        }
        default: {
            return SLOP_STR("0");
...
uint8_t defn_is_range_type(types_SExpr* type_expr) {
    SLOP_PRE(((type_expr != NULL)), "(!= type-expr nil)");
    __auto_type _mv_1026 = (*type_expr);
    switch (_mv_1026.tag) {
        case types_SExpr_lst:
        {
...
types_RangeBounds defn_parse_range_bounds(types_SExpr* type_expr) {
    SLOP_PRE(((type_expr != NULL)), "(!= type-expr nil)");
    {
        ...
        __auto_type _mv_1029 = (*type_expr);
        switch (_mv_1029.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1029.data.lst;
                {
                    ...
                    while ((i < len)) {
                        ...
                        if (_mv_1030.has_value) {
                            ...
                            __auto_type _mv_1031 = (*item);
                            switch (_mv_1031.tag) {
                                case types_SExpr_num:
                                {
                                    __auto_type num = _mv_1031.data.num;
                                    if (!(found_dots)) {
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1032.data.lst;
                {
                    ...
                    if ((len < 3)) {
                        ...
                        __auto_type _mv_1033 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_1033.has_value) {
                            __auto_type name_expr = _mv_1033.value;
                            __auto_type _mv_1034 = (*name_expr);
                            switch (_mv_1034.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_1034.data.sym;
                                    {
                                        __auto_type raw_name = name_sym.name;
                                        __auto_type base_name = ctype_to_c_name(arena, raw_name);
                                        ...
                                        __auto_type _mv_1035 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_1035.has_value) {
                                            __auto_type params_expr = _mv_1035.value;
...
void defn_bind_params_to_scope(context_TranspileContext* ctx, types_SExpr* params_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1038 = (*params_expr);
        switch (_mv_1038.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1038.data.lst;
                {
                    ...
                    __auto_type i = 0;
                    while ((i < len)) {
                        __auto_type _mv_1039 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_1039.has_value) {
                            __auto_type param = _mv_1039.value;
                    ...
                    if ((len >= 2)) {
                        {
                            ...
                            __auto_type _mv_1041 = ({ __auto_type _lst = items; size_t _idx = (size_t)name_idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_1041.has_value) {
                                ...
                                switch (_mv_1042.tag) {
                                    case types_SExpr_sym:
                                    {
                                        __auto_type name_sym = _mv_1042.data.sym;
                                        __auto_type _mv_1043 = ({ __auto_type _lst = items; size_t _idx = (size_t)type_idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_1043.has_value) {
                                            __auto_type type_expr = _mv_1043.value;
                                            {
...
uint8_t defn_is_pointer_type(types_SExpr* type_expr) {
    SLOP_PRE(((type_expr != NULL)), "(!= type-expr nil)");
    __auto_type _mv_1044 = (*type_expr);
    switch (_mv_1044.tag) {
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1044.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    __auto_type _mv_1045 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_list_context_FuncParamType_ptr defn_collect_param_types(context_TranspileContext* ctx, types_SExpr* params_expr) {
    ...
    SLOP_PRE(((params_expr != NULL)), "(!= params-expr nil)");
    {
        ...
        __auto_type _mv_1047 = (*params_expr);
        switch (_mv_1047.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1047.data.lst;
                {
                    __auto_type items = lst.items;
                    __auto_type len = ((int64_t)((items).len));
                    __auto_type i = 0;
                    while ((i < len)) {
                        __auto_type _mv_1048 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_1048.has_value) {
                            __auto_type param = _mv_1048.value;
                            {
                ...
                __auto_type lst = _mv_1049.data.lst;
                {
                    ...
                    if ((len < 2)) {
                    ...
                    } else {
                        {
                            __auto_type has_mode = ((len >= 3) && defn_is_param_mode(items));
                            __auto_type type_idx = ((has_mode) ? 2 : 1);
                            __auto_type _mv_1050 = ({ __auto_type _lst = items; size_t _idx = (size_t)type_idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        switch (_mv_1051.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1051.data.lst;
                {
                    ...
                    __auto_type len = ((int64_t)((items).len));
                    if ((len >= 3)) {
                        __auto_type _mv_1052 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_1052.has_value) {
                            ...
                            switch (_mv_1053.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_1053.data.sym;
                                    {
                                        __auto_type raw_name = name_sym.name;
                                        __auto_type base_name = ctype_to_c_name(arena, raw_name);
                                        ...
                                        __auto_type _mv_1054 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_string defn_extract_spec_return_type(context_TranspileContext* ctx, types_SExpr* spec_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1059 = (*spec_expr);
        switch (_mv_1059.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1059.data.lst;
                {
                    ...
                    if ((((int64_t)((items).len)) < 2)) {
                        ...
                        __auto_type _mv_1060 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_1060.has_value) {
                            __auto_type spec_body = _mv_1060.value;
                            __auto_type _mv_1061 = (*spec_body);
                            switch (_mv_1061.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type body_lst = _mv_1061.data.lst;
                                    {
                                        ...
                                        if ((body_len < 1)) {
                                            ...
                                            __auto_type _mv_1062 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)(body_len - 1); slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_1062.has_value) {
                                                __auto_type ret_type = _mv_1062.value;
...
slop_option_string defn_extract_result_type_name(context_TranspileContext* ctx, types_SExpr* spec_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1069 = (*spec_expr);
        switch (_mv_1069.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1069.data.lst;
                {
                    ...
                    if ((((int64_t)((items).len)) < 2)) {
                        ...
                        if (_mv_1070.has_value) {
                            ...
                            __auto_type _mv_1071 = (*spec_body);
                            switch (_mv_1071.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type body_lst = _mv_1071.data.lst;
                                    {
                                        __auto_type body_items = body_lst.items;
                                        __auto_type body_len = ((int64_t)((body_items).len));
                                        if ((body_len < 1)) {
                                            ...
                                            __auto_type _mv_1072 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)(body_len - 1); slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_1072.has_value) {
                                                __auto_type ret_type = _mv_1072.value;
...
slop_option_string defn_check_result_type(context_TranspileContext* ctx, types_SExpr* type_expr) {
    ...
    SLOP_PRE(((type_expr != NULL)), "(!= type-expr nil)");
    {
        ...
        switch (_mv_1073.tag) {
            case types_SExpr_sym:
            {
                __auto_type sym = _mv_1073.data.sym;
                {
                    __auto_type type_name = sym.name;
                    __auto_type _mv_1074 = context_ctx_lookup_result_type_alias(ctx, type_name);
                    if (_mv_1074.has_value) {
                        __auto_type alias_result = _mv_1074.value;
                        return (slop_option_string){.has_value = 1, .value = alias_result};
                    } else if (!_mv_1074.has_value) {
                        __auto_type _mv_1075 = context_ctx_lookup_type(ctx, type_name);
                        if (_mv_1075.has_value) {
                            __auto_type entry = _mv_1075.value;
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1073.data.lst;
                {
                    ...
                    if ((((int64_t)((items).len)) < 3)) {
                        ...
                        __auto_type _mv_1076 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            ...
                            switch (_mv_1077.tag) {
                                case types_SExpr_sym:
                                {
                                    ...
                                    if (string_eq(sym.name, SLOP_STR("Result"))) {
                                        __auto_type _mv_1078 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_1078.has_value) {
                                            __auto_type ok_type_expr = _mv_1078.value;
                                            ...
                                            if (_mv_1079.has_value) {
                                                __auto_type err_type_expr = _mv_1079.value;
                                                {
                ...
                __auto_type lst = _mv_1080.data.lst;
                {
                    ...
                    while ((i < len)) {
                        ...
                        if (_mv_1081.has_value) {
                            __auto_type param = _mv_1081.value;
                            {
                ...
                __auto_type lst = _mv_1082.data.lst;
                {
                    ...
                    if ((len < 2)) {
                    ...
                    } else {
                        {
                            ...
                            __auto_type _mv_1083 = ({ __auto_type _lst = items; size_t _idx = (size_t)name_idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_1083.has_value) {
                                __auto_type name_expr = _mv_1083.value;
                                __auto_type _mv_1084 = (*name_expr);
                                switch (_mv_1084.tag) {
                                    case types_SExpr_sym:
                                    {
                                        __auto_type name_sym = _mv_1084.data.sym;
                                        __auto_type _mv_1085 = ({ __auto_type _lst = items; size_t _idx = (size_t)type_idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_1085.has_value) {
                                            __auto_type type_expr = _mv_1085.value;
                                            {
...
uint8_t defn_is_param_mode(slop_list_types_SExpr_ptr items) {
    if ((((int64_t)((items).len)) < 1)) {
        ...
        __auto_type _mv_1086 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        if (_mv_1086.has_value) {
            __auto_type first = _mv_1086.value;
            __auto_type _mv_1087 = (*first);
            switch (_mv_1087.tag) {
                case types_SExpr_sym:
                {
...
uint8_t defn_is_fn_type(types_SExpr* type_expr) {
    __auto_type _mv_1088 = (*type_expr);
    switch (_mv_1088.tag) {
        case types_SExpr_lst:
        {
...
slop_string defn_emit_fn_param_type(context_TranspileContext* ctx, types_SExpr* type_expr, slop_string param_name) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1091 = (*type_expr);
        switch (_mv_1091.tag) {
            case types_SExpr_lst:
            {
                    ...
                    } else {
                        {
                            ...
                            if ((len == 2)) {
                                ...
                                if (_mv_1092.has_value) {
                                    __auto_type args_expr = _mv_1092.value;
                                    {
...
slop_string defn_build_fn_args_str_for_param(context_TranspileContext* ctx, types_SExpr* args_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1093 = (*args_expr);
        switch (_mv_1093.tag) {
            case types_SExpr_lst:
            {
                __auto_type args_list = _mv_1093.data.lst;
                {
                    ...
                    if ((arg_count == 0)) {
                    ...
                    } else {
                        {
                            ...
                            __auto_type i = 0;
                            while ((i < arg_count)) {
                                __auto_type _mv_1094 = ({ __auto_type _lst = arg_items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1094.has_value) {
                                    __auto_type arg_expr = _mv_1094.value;
                                    {
...
uint8_t defn_is_c_name_attr_at(slop_list_types_SExpr_ptr items, int64_t idx) {
    __auto_type _mv_1098 = ({ __auto_type _lst = items; size_t _idx = (size_t)idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1103.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    __auto_type _mv_1104 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1106.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    __auto_type _mv_1107 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            ...
            __auto_type lst = _mv_1112.data.lst;
            {
                ...
                if ((len < 1)) {
                ...
                } else {
                    {
                        __auto_type found = 0;
                        __auto_type i = 0;
                        __auto_type _mv_1113 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        ...
                        while (((i < len) && !(found))) {
                            __auto_type _mv_1115 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                ...
                __auto_type lst = _mv_1119.data.lst;
                {
                    ...
                    if ((((int64_t)((items).len)) >= 2)) {
                        ...
                        if (_mv_1120.has_value) {
                            __auto_type val = _mv_1120.value;
                            __auto_type _mv_1121 = (*val);
                            switch (_mv_1121.tag) {
                                case types_SExpr_str:
                                {
                                    __auto_type str = _mv_1121.data.str;
                ...
                __auto_type lst = _mv_1123.data.lst;
                {
                    ...
                    if ((((int64_t)((items).len)) >= 2)) {
                        ...
                        if (_mv_1124.has_value) {
                            __auto_type val = _mv_1124.value;
        ...
        while ((i < len)) {
            ...
            if (_mv_1125.has_value) {
                ...
                if (defn_is_pre_form(item)) {
                    __auto_type _mv_1126 = defn_get_annotation_condition(item);
                    if (_mv_1126.has_value) {
                        __auto_type cond = _mv_1126.value;
...
slop_list_types_SExpr_ptr defn_collect_postconditions(slop_arena* arena, slop_list_types_SExpr_ptr items) {
    {
        ...
        int64_t i = 3;
        while ((i < len)) {
            __auto_type _mv_1127 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1127.has_value) {
                __auto_type item = _mv_1127.value;
                if (defn_is_post_form(item)) {
                    __auto_type _mv_1128 = defn_get_annotation_condition(item);
                    if (_mv_1128.has_value) {
                        __auto_type cond = _mv_1128.value;
                        ({ __auto_type _lst_p = &(result); __auto_type _item = (cond); if (_lst_p->len >= _lst_p->cap) { size_t _new_cap = _lst_p->cap == 0 ? 16 : _lst_p->cap * 2; __typeof__(_lst_p->data) _new_data = (__typeof__(_lst_p->data))slop_arena_alloc(arena, _new_cap * sizeof(*_lst_p->data)); if (_lst_p->len > 0) memcpy(_new_data, _lst_p->data, _lst_p->len * sizeof(*_lst_p->data)); _lst_p->data = _new_data; _lst_p->cap = _new_cap; } _lst_p->data[_lst_p->len++] = _item; (void)0; });
        ...
        while ((i < len)) {
            ...
            if (_mv_1129.has_value) {
                ...
                if (defn_is_assume_form(item)) {
                    __auto_type _mv_1130 = defn_get_annotation_condition(item);
                    if (_mv_1130.has_value) {
                        __auto_type cond = _mv_1130.value;
                        ({ __auto_type _lst_p = &(result); __auto_type _item = (cond); if (_lst_p->len >= _lst_p->cap) { size_t _new_cap = _lst_p->cap == 0 ? 16 : _lst_p->cap * 2; __typeof__(_lst_p->data) _new_data = (__typeof__(_lst_p->data))slop_arena_alloc(arena, _new_cap * sizeof(*_lst_p->data)); if (_lst_p->len > 0) memcpy(_new_data, _lst_p->data, _lst_p->len * sizeof(*_lst_p->data)); _lst_p->data = _new_data; _lst_p->cap = _new_cap; } _lst_p->data[_lst_p->len++] = _item; (void)0; });
...
void defn_emit_preconditions(context_TranspileContext* ctx, slop_list_types_SExpr_ptr preconditions) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1132 = ({ __auto_type _lst = preconditions; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1132.has_value) {
                __auto_type cond_expr = _mv_1132.value;
                {
...
void defn_emit_postconditions(context_TranspileContext* ctx, slop_list_types_SExpr_ptr postconditions) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1133 = ({ __auto_type _lst = postconditions; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1133.has_value) {
                __auto_type cond_expr = _mv_1133.value;
...
void defn_emit_assumptions(context_TranspileContext* ctx, slop_list_types_SExpr_ptr assumptions) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1134 = ({ __auto_type _lst = assumptions; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1134.has_value) {
                __auto_type cond_expr = _mv_1134.value;
                if (!(defn_is_verification_only_expr(cond_expr))) {
                    {
                        __auto_type cond_c = expr_transpile_expr(ctx, cond_expr);
                        __auto_type expr_str = parser_pretty_print(arena, cond_expr);
