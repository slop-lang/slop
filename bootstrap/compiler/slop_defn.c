        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_925.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    __auto_type _mv_926 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_931.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    __auto_type _mv_932 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_932.has_value) {
                        __auto_type head = _mv_932.value;
                        __auto_type _mv_933 = (*head);
                        switch (_mv_933.tag) {
                            case types_SExpr_sym:
                            {
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_934.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    __auto_type _mv_935 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_935.has_value) {
                        __auto_type head = _mv_935.value;
                        __auto_type _mv_936 = (*head);
                        switch (_mv_936.tag) {
                            case types_SExpr_sym:
                            {
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_937.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    __auto_type _mv_938 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
uint8_t defn_has_generic_annotation(slop_list_types_SExpr_ptr items) {
    {
        ...
        __auto_type found = 0;
        while (((i < len) && !(found))) {
            __auto_type _mv_940 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_940.has_value) {
                __auto_type item = _mv_940.value;
                __auto_type _mv_941 = (*item);
                switch (_mv_941.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type lst = _mv_941.data.lst;
                        {
                            __auto_type sub_items = lst.items;
                            if ((((int64_t)((sub_items).len)) > 0)) {
                                __auto_type _mv_942 = ({ __auto_type _lst = sub_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_942.has_value) {
                                    __auto_type head = _mv_942.value;
                                    __auto_type _mv_943 = (*head);
                                    switch (_mv_943.tag) {
                                        case types_SExpr_sym:
                                        {
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_947.data.lst;
                {
                    ...
                    if ((len < 4)) {
                        ...
                        __auto_type _mv_948 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_948.has_value) {
                            __auto_type name_expr = _mv_948.value;
                            __auto_type _mv_949 = (*name_expr);
                            switch (_mv_949.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_949.data.sym;
                                    {
                                        ...
                                        __auto_type _mv_950 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_950.has_value) {
                                            __auto_type type_expr = _mv_950.value;
                                            {
                                                ...
                                                __auto_type _mv_951 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_951.has_value) {
                                                    __auto_type value_expr = _mv_951.value;
        ...
        if (ctype_is_int_type(type_name)) {
        ...
        } else {
            {
                ...
                if (string_eq(type_name, SLOP_STR("String"))) {
                    __auto_type _mv_952 = (*value_expr);
                    switch (_mv_952.tag) {
                        case types_SExpr_str:
                        {
                            __auto_type str = _mv_952.data.str;
...
slop_string defn_eval_const_value(context_TranspileContext* ctx, types_SExpr* expr) {
    ...
    SLOP_PRE(((expr != NULL)), "(!= expr nil)");
    {
        ...
        switch (_mv_954.tag) {
            ...
            case types_SExpr_str:
            {
                __auto_type str = _mv_954.data.str;
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_955.data.lst;
                {
                    ...
                    __auto_type len = ((int64_t)((items).len));
                    {
                        ...
                        if ((len >= (name_idx + 1))) {
                            __auto_type _mv_956 = ({ __auto_type _lst = items; size_t _idx = (size_t)name_idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_956.has_value) {
                                ...
                                switch (_mv_957.tag) {
                                    case types_SExpr_sym:
                                    {
                                        __auto_type sym = _mv_957.data.sym;
                                        {
...
uint8_t defn_is_string_expr(slop_list_types_SExpr_ptr items, int64_t idx) {
    ...
    if (_mv_958.has_value) {
        ...
        __auto_type _mv_959 = (*item);
        switch (_mv_959.tag) {
            case types_SExpr_str:
            {
                __auto_type _ = _mv_959.data.str;
                return 1;
            }
            default: {
                return 0;
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_960.data.lst;
                {
                    ...
                    if ((len < 3)) {
                        ...
                        __auto_type _mv_961 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_961.has_value) {
                            __auto_type name_expr = _mv_961.value;
                            __auto_type _mv_962 = (*name_expr);
                            switch (_mv_962.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_962.data.sym;
                                    {
                                        __auto_type raw_name = name_sym.name;
                                        __auto_type base_name = ctype_to_c_name(arena, raw_name);
                                        ...
                                        __auto_type _mv_963 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_963.has_value) {
                                            __auto_type type_def = _mv_963.value;
...
void defn_dispatch_type_def(context_TranspileContext* ctx, slop_string raw_name, slop_string qualified_name, types_SExpr* type_def) {
    ...
    __auto_type _mv_964 = (*type_def);
    switch (_mv_964.tag) {
        case types_SExpr_lst:
        {
            __auto_type def_lst = _mv_964.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    __auto_type _mv_965 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
uint8_t defn_has_payload_variants(slop_list_types_SExpr_ptr items) {
    {
        ...
        while (((i < len) && !(found))) {
            ...
            if (_mv_967.has_value) {
                ...
                __auto_type _mv_968 = (*item);
                switch (_mv_968.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type _ = _mv_968.data.lst;
                        found = 1;
                        break;
                    }
                    default: {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while ((i < len)) {
            ...
            if (_mv_970.has_value) {
                __auto_type field_expr = _mv_970.value;
...
void defn_emit_record_field(context_TranspileContext* ctx, slop_string raw_type_name, slop_string qualified_type_name, types_SExpr* field) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_971 = (*field);
        switch (_mv_971.tag) {
            case types_SExpr_lst:
            {
                __auto_type field_lst = _mv_971.data.lst;
                {
                    ...
                    if ((len < 2)) {
                        ...
                        __auto_type _mv_972 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_972.has_value) {
                            __auto_type name_expr = _mv_972.value;
                            __auto_type _mv_973 = (*name_expr);
                            switch (_mv_973.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_973.data.sym;
                                    __auto_type _mv_974 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void defn_emit_enum_values(context_TranspileContext* ctx, slop_string type_name, slop_list_types_SExpr_ptr items, int64_t start_idx, int64_t len) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = start_idx;
        while ((i < len)) {
            __auto_type _mv_976 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_976.has_value) {
                __auto_type val_expr = _mv_976.value;
                __auto_type _mv_977 = (*val_expr);
                switch (_mv_977.tag) {
                    case types_SExpr_sym:
                    {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while ((i < len)) {
            ...
            if (_mv_979.has_value) {
                __auto_type variant_expr = _mv_979.value;
                __auto_type _mv_980 = (*variant_expr);
                switch (_mv_980.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type var_lst = _mv_980.data.lst;
                        {
                            __auto_type var_items = var_lst.items;
                            __auto_type var_len = ((int64_t)((var_items).len));
                            if ((var_len >= 1)) {
                                __auto_type _mv_981 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_981.has_value) {
                                    __auto_type tag_expr = _mv_981.value;
                                    __auto_type _mv_982 = (*tag_expr);
                                    switch (_mv_982.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type tag_sym = _mv_982.data.sym;
                                            {
                                                __auto_type tag_name = tag_sym.name;
                                                if ((var_len >= 2)) {
                                                    __auto_type _mv_983 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void defn_emit_tag_constants(context_TranspileContext* ctx, slop_string type_name, slop_list_types_SExpr_ptr items, int64_t start_idx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t tag_idx = 0;
        while ((i < len)) {
            __auto_type _mv_984 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    ...
                    case types_SExpr_lst:
                    {
                        __auto_type var_lst = _mv_985.data.lst;
                        {
                            ...
                            if ((((int64_t)((var_items).len)) >= 1)) {
                                __auto_type _mv_986 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while ((i < len)) {
            ...
            if (_mv_988.has_value) {
                __auto_type variant_expr = _mv_988.value;
                __auto_type _mv_989 = (*variant_expr);
                switch (_mv_989.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type var_lst = _mv_989.data.lst;
                        {
                            __auto_type var_items = var_lst.items;
                            __auto_type var_len = ((int64_t)((var_items).len));
                            if ((var_len >= 2)) {
                                __auto_type _mv_990 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_990.has_value) {
                                    __auto_type tag_expr = _mv_990.value;
                                    __auto_type _mv_991 = (*tag_expr);
                                    switch (_mv_991.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type tag_sym = _mv_991.data.sym;
                                            {
                                                __auto_type tag_name = tag_sym.name;
                                                __auto_type _mv_992 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_992.has_value) {
                                                    __auto_type type_expr = _mv_992.value;
                                                    {
                                                        __auto_type c_type = context_to_c_type_prefixed(ctx, type_expr);
                                                        __auto_type slop_type_str = parser_pretty_print(arena, type_expr);
                                                        __auto_type is_ptr = defn_is_pointer_type_expr(type_expr);
                ...
                __auto_type lst = _mv_996.data.lst;
                {
                    ...
                    if ((len < 3)) {
                        ...
                        if (_mv_997.has_value) {
                            ...
                            __auto_type _mv_998 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_998.has_value) {
                                __auto_type size_expr = _mv_998.value;
                                {
...
slop_string defn_get_number_as_string(types_SExpr* expr) {
    ...
    switch (_mv_999.tag) {
        case types_SExpr_num:
        {
            __auto_type num = _mv_999.data.num;
            return num.raw;
        }
        default: {
            return SLOP_STR("0");
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1000.data.lst;
            {
                ...
                while (((i < len) && !(found_dots))) {
                    __auto_type _mv_1001 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_1001.has_value) {
                        __auto_type item = _mv_1001.value;
                        __auto_type _mv_1002 = (*item);
                        switch (_mv_1002.tag) {
                            case types_SExpr_sym:
                            {
...
types_RangeBounds defn_parse_range_bounds(types_SExpr* type_expr) {
    SLOP_PRE(((type_expr != NULL)), "(!= type-expr nil)");
    {
        ...
        __auto_type _mv_1003 = (*type_expr);
        switch (_mv_1003.tag) {
            case types_SExpr_lst:
            {
                    ...
                    while ((i < len)) {
                        ...
                        if (_mv_1004.has_value) {
                            ...
                            switch (_mv_1005.tag) {
                                case types_SExpr_num:
                                {
                                    __auto_type num = _mv_1005.data.num;
                                    if (!(found_dots)) {
                    ...
                    if ((len < 3)) {
                        ...
                        if (_mv_1007.has_value) {
                            ...
                            switch (_mv_1008.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_1008.data.sym;
                                    {
                                        __auto_type raw_name = name_sym.name;
                                        __auto_type base_name = ctype_to_c_name(arena, raw_name);
                                        ...
                                        if (_mv_1009.has_value) {
                                            __auto_type params_expr = _mv_1009.value;
...
void defn_bind_params_to_scope(context_TranspileContext* ctx, types_SExpr* params_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1012 = (*params_expr);
        switch (_mv_1012.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1012.data.lst;
                {
                    ...
                    while ((i < len)) {
                        ...
                        if (_mv_1013.has_value) {
                            __auto_type param = _mv_1013.value;
                    ...
                    if ((len >= 2)) {
                        {
                            ...
                            __auto_type _mv_1015 = ({ __auto_type _lst = items; size_t _idx = (size_t)name_idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_1015.has_value) {
                                __auto_type name_expr = _mv_1015.value;
                                __auto_type _mv_1016 = (*name_expr);
                                switch (_mv_1016.tag) {
                                    case types_SExpr_sym:
                                    {
                                        __auto_type name_sym = _mv_1016.data.sym;
                                        __auto_type _mv_1017 = ({ __auto_type _lst = items; size_t _idx = (size_t)type_idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
uint8_t defn_is_pointer_type(types_SExpr* type_expr) {
    SLOP_PRE(((type_expr != NULL)), "(!= type-expr nil)");
    __auto_type _mv_1018 = (*type_expr);
    switch (_mv_1018.tag) {
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1018.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    __auto_type _mv_1019 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_list_context_FuncParamType_ptr defn_collect_param_types(context_TranspileContext* ctx, types_SExpr* params_expr) {
    ...
    SLOP_PRE(((params_expr != NULL)), "(!= params-expr nil)");
    {
        ...
        __auto_type _mv_1021 = (*params_expr);
        switch (_mv_1021.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1021.data.lst;
                {
                    ...
                    while ((i < len)) {
                        ...
                        if (_mv_1022.has_value) {
                            __auto_type param = _mv_1022.value;
                            {
                ...
                __auto_type lst = _mv_1023.data.lst;
                {
                    ...
                    if ((len < 2)) {
                    ...
                    } else {
                        {
                            __auto_type has_mode = ((len >= 3) && defn_is_param_mode(items));
                            __auto_type type_idx = ((has_mode) ? 2 : 1);
                            __auto_type _mv_1024 = ({ __auto_type _lst = items; size_t _idx = (size_t)type_idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                ...
                __auto_type lst = _mv_1025.data.lst;
                {
                    ...
                    if ((len >= 3)) {
                        ...
                        if (_mv_1026.has_value) {
                            __auto_type name_expr = _mv_1026.value;
                            __auto_type _mv_1027 = (*name_expr);
                            switch (_mv_1027.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_1027.data.sym;
                                    {
                                        __auto_type raw_name = name_sym.name;
                                        __auto_type base_name = ctype_to_c_name(arena, raw_name);
                                        ...
                                        __auto_type _mv_1028 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_1028.has_value) {
                                            __auto_type params_expr = _mv_1028.value;
                                            {
                                                __auto_type result_type_opt = defn_get_result_type_name(ctx, items);
                                                __auto_type raw_return = defn_get_return_type(ctx, items);
                                                {
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1030.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    __auto_type _mv_1031 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_string defn_extract_spec_return_type(context_TranspileContext* ctx, types_SExpr* spec_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1033 = (*spec_expr);
        switch (_mv_1033.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1033.data.lst;
                {
                    ...
                    if ((((int64_t)((items).len)) < 2)) {
                        ...
                        if (_mv_1034.has_value) {
                            __auto_type spec_body = _mv_1034.value;
                            __auto_type _mv_1035 = (*spec_body);
                            switch (_mv_1035.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type body_lst = _mv_1035.data.lst;
                                    {
                                        ...
                                        if ((body_len < 1)) {
                                            ...
                                            __auto_type _mv_1036 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)(body_len - 1); slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_string defn_extract_spec_slop_return_type(context_TranspileContext* ctx, types_SExpr* spec_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1037 = (*spec_expr);
        switch (_mv_1037.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1037.data.lst;
                {
                    ...
                    if ((((int64_t)((items).len)) < 2)) {
                        ...
                        __auto_type _mv_1038 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_1038.has_value) {
                            __auto_type spec_body = _mv_1038.value;
                            __auto_type _mv_1039 = (*spec_body);
                            switch (_mv_1039.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type body_lst = _mv_1039.data.lst;
                                    {
                                        __auto_type body_items = body_lst.items;
                                        __auto_type body_len = ((int64_t)((body_items).len));
                                        if ((body_len < 1)) {
                                            ...
                                            __auto_type _mv_1040 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)(body_len - 1); slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_string defn_get_slop_return_type(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while ((i < len)) {
            __auto_type _mv_1041 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_option_string defn_get_result_type_name(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (((i < len) && ({ __auto_type _mv = result; _mv.has_value ? ({ __auto_type _ = _mv.value; 0; }) : (1); }))) {
            __auto_type _mv_1042 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1042.has_value) {
                __auto_type item = _mv_1042.value;
                if (defn_is_spec_form(item)) {
...
slop_option_string defn_extract_result_type_name(context_TranspileContext* ctx, types_SExpr* spec_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1043 = (*spec_expr);
        switch (_mv_1043.tag) {
            case types_SExpr_lst:
            {
    ...
    SLOP_PRE(((type_expr != NULL)), "(!= type-expr nil)");
    {
        ...
        switch (_mv_1047.tag) {
            case types_SExpr_sym:
            {
                ...
                {
                    __auto_type type_name = sym.name;
                    __auto_type _mv_1048 = context_ctx_lookup_result_type_alias(ctx, type_name);
                    if (_mv_1048.has_value) {
                        __auto_type alias_result = _mv_1048.value;
                        return (slop_option_string){.has_value = 1, .value = alias_result};
                    } else if (!_mv_1048.has_value) {
                        __auto_type _mv_1049 = context_ctx_lookup_type(ctx, type_name);
                        if (_mv_1049.has_value) {
                            __auto_type entry = _mv_1049.value;
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1047.data.lst;
                {
                    ...
                    if ((((int64_t)((items).len)) < 3)) {
                        ...
                        __auto_type _mv_1050 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_1050.has_value) {
                            __auto_type head = _mv_1050.value;
                            __auto_type _mv_1051 = (*head);
                            switch (_mv_1051.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type sym = _mv_1051.data.sym;
                                    if (string_eq(sym.name, SLOP_STR("Result"))) {
                                        ...
                                        if (_mv_1052.has_value) {
                                            __auto_type ok_type_expr = _mv_1052.value;
                                            __auto_type _mv_1053 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_1053.has_value) {
                                                __auto_type err_type_expr = _mv_1053.value;
                                                {
                ...
                __auto_type lst = _mv_1056.data.lst;
                {
                    ...
                    if ((len < 2)) {
                    ...
                    } else {
                        {
                            ...
                            __auto_type _mv_1057 = ({ __auto_type _lst = items; size_t _idx = (size_t)name_idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_1057.has_value) {
                                ...
                                switch (_mv_1058.tag) {
                                    case types_SExpr_sym:
                                    {
                                        ...
                                        __auto_type _mv_1059 = ({ __auto_type _lst = items; size_t _idx = (size_t)type_idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
uint8_t defn_is_param_mode(slop_list_types_SExpr_ptr items) {
    if ((((int64_t)((items).len)) < 1)) {
        ...
        if (_mv_1060.has_value) {
            __auto_type first = _mv_1060.value;
            __auto_type _mv_1061 = (*first);
            switch (_mv_1061.tag) {
                case types_SExpr_sym:
                {
            ...
            __auto_type lst = _mv_1062.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    if (_mv_1063.has_value) {
                        __auto_type first = _mv_1063.value;
                        __auto_type _mv_1064 = (*first);
                        switch (_mv_1064.tag) {
                            case types_SExpr_sym:
                            {
                    ...
                    if ((len < 2)) {
                    ...
                    } else {
                        {
                            ...
                            if ((len == 2)) {
                                ...
                                __auto_type _mv_1066 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1066.has_value) {
                                    __auto_type args_expr = _mv_1066.value;
                                    {
...
slop_string defn_build_fn_args_str_for_param(context_TranspileContext* ctx, types_SExpr* args_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1067 = (*args_expr);
        switch (_mv_1067.tag) {
            case types_SExpr_lst:
            {
                __auto_type args_list = _mv_1067.data.lst;
                {
                    ...
                    if ((arg_count == 0)) {
                    ...
                    } else {
                        {
                            ...
                            __auto_type i = 0;
                            while ((i < arg_count)) {
                                __auto_type _mv_1068 = ({ __auto_type _lst = arg_items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1068.has_value) {
                                    __auto_type arg_expr = _mv_1068.value;
                                    {
...
uint8_t defn_is_c_name_attr_at(slop_list_types_SExpr_ptr items, int64_t idx) {
    __auto_type _mv_1072 = ({ __auto_type _lst = items; size_t _idx = (size_t)idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1077.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    __auto_type _mv_1078 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1080.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    __auto_type _mv_1081 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1083.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    __auto_type _mv_1084 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_1084.has_value) {
                        __auto_type head = _mv_1084.value;
                        __auto_type _mv_1085 = (*head);
                        switch (_mv_1085.tag) {
                            case types_SExpr_sym:
                            {
            ...
            __auto_type lst = _mv_1086.data.lst;
            {
                ...
                if ((len < 1)) {
                ...
                } else {
                    {
                        __auto_type found = 0;
                        __auto_type i = 0;
                        __auto_type _mv_1087 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1090.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    __auto_type _mv_1091 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        switch (_mv_1093.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1093.data.lst;
                {
                    __auto_type items = lst.items;
                    if ((((int64_t)((items).len)) >= 2)) {
                        __auto_type _mv_1094 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_1094.has_value) {
                            __auto_type val = _mv_1094.value;
                            __auto_type _mv_1095 = (*val);
                            switch (_mv_1095.tag) {
                                case types_SExpr_str:
                                {
                                    __auto_type str = _mv_1095.data.str;
        ...
        switch (_mv_1097.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1097.data.lst;
                {
                    __auto_type items = lst.items;
                    if ((((int64_t)((items).len)) >= 2)) {
                        __auto_type _mv_1098 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_1098.has_value) {
                            __auto_type val = _mv_1098.value;
...
slop_list_types_SExpr_ptr defn_collect_postconditions(slop_arena* arena, slop_list_types_SExpr_ptr items) {
    {
        ...
        int64_t i = 3;
        while ((i < len)) {
            __auto_type _mv_1101 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_list_types_SExpr_ptr defn_collect_assumptions(slop_arena* arena, slop_list_types_SExpr_ptr items) {
    {
        ...
        int64_t i = 3;
        while ((i < len)) {
            __auto_type _mv_1103 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1103.has_value) {
                __auto_type item = _mv_1103.value;
                if (defn_is_assume_form(item)) {
                    __auto_type _mv_1104 = defn_get_annotation_condition(item);
                    if (_mv_1104.has_value) {
                        __auto_type cond = _mv_1104.value;
                        ({ __auto_type _lst_p = &(result); __auto_type _item = (cond); if (_lst_p->len >= _lst_p->cap) { size_t _new_cap = _lst_p->cap == 0 ? 16 : _lst_p->cap * 2; __typeof__(_lst_p->data) _new_data = (__typeof__(_lst_p->data))slop_arena_alloc(arena, _new_cap * sizeof(*_lst_p->data)); if (_lst_p->len > 0) memcpy(_new_data, _lst_p->data, _lst_p->len * sizeof(*_lst_p->data)); _lst_p->data = _new_data; _lst_p->cap = _new_cap; } _lst_p->data[_lst_p->len++] = _item; (void)0; });
...
uint8_t defn_has_postconditions(slop_list_types_SExpr_ptr items) {
    {
        ...
        uint8_t found = 0;
        while (((i < len) && !(found))) {
            __auto_type _mv_1105 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1105.has_value) {
                __auto_type item = _mv_1105.value;
...
void defn_emit_preconditions(context_TranspileContext* ctx, slop_list_types_SExpr_ptr preconditions) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1106 = ({ __auto_type _lst = preconditions; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void defn_emit_postconditions(context_TranspileContext* ctx, slop_list_types_SExpr_ptr postconditions) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1107 = ({ __auto_type _lst = postconditions; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void defn_emit_assumptions(context_TranspileContext* ctx, slop_list_types_SExpr_ptr assumptions) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1108 = ({ __auto_type _lst = assumptions; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1108.has_value) {
                __auto_type cond_expr = _mv_1108.value;
                if (!(defn_is_verification_only_expr(cond_expr))) {
                    {
                        __auto_type cond_c = expr_transpile_expr(ctx, cond_expr);
                        __auto_type expr_str = parser_pretty_print(arena, cond_expr);
