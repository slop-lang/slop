        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_956.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    __auto_type _mv_957 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_962.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    __auto_type _mv_963 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    ...
                    case types_SExpr_lst:
                    {
                        __auto_type lst = _mv_966.data.lst;
                        {
                            ...
                            if ((((int64_t)((sub_items).len)) > 0)) {
                                __auto_type _mv_967 = ({ __auto_type _lst = sub_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                ...
                __auto_type lst = _mv_972.data.lst;
                {
                    ...
                    if ((len < 4)) {
                        ...
                        if (_mv_973.has_value) {
                            __auto_type name_expr = _mv_973.value;
                            __auto_type _mv_974 = (*name_expr);
                            switch (_mv_974.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_974.data.sym;
                                    {
                                        ...
                                        __auto_type _mv_975 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_975.has_value) {
                                            __auto_type type_expr = _mv_975.value;
                                            {
                                                ...
                                                __auto_type _mv_976 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        if (ctype_is_int_type(type_name)) {
        ...
        } else {
            {
                ...
                if (string_eq(type_name, SLOP_STR("String"))) {
                    __auto_type _mv_977 = (*value_expr);
                    switch (_mv_977.tag) {
...
slop_string defn_eval_const_value(context_TranspileContext* ctx, types_SExpr* expr) {
    ...
    SLOP_PRE(((expr != NULL)), "(!= expr nil)");
    {
        ...
        switch (_mv_979.tag) {
            ...
            {
                __auto_type num = _mv_979.data.num;
                return num.raw;
            }
            case types_SExpr_str:
            {
                __auto_type str = _mv_979.data.str;
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_980.data.lst;
                {
                    ...
                    __auto_type len = ((int64_t)((items).len));
                    {
                        ...
                        if ((len >= (name_idx + 1))) {
                            __auto_type _mv_981 = ({ __auto_type _lst = items; size_t _idx = (size_t)name_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
uint8_t defn_is_string_expr(slop_list_types_SExpr_ptr items, int64_t idx) {
    __auto_type _mv_983 = ({ __auto_type _lst = items; size_t _idx = (size_t)idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    if (_mv_983.has_value) {
        ...
        switch (_mv_984.tag) {
            case types_SExpr_str:
            {
                __auto_type _ = _mv_984.data.str;
                return 1;
            }
            default: {
                return 0;
                                ...
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_987.data.sym;
                                    {
                                        ...
                                        if (_mv_988.has_value) {
                                            __auto_type type_def = _mv_988.value;
...
void defn_dispatch_type_def(context_TranspileContext* ctx, slop_string raw_name, slop_string qualified_name, types_SExpr* type_def) {
    ...
    __auto_type _mv_989 = (*type_def);
    switch (_mv_989.tag) {
        case types_SExpr_lst:
        {
            __auto_type def_lst = _mv_989.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    __auto_type _mv_990 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while ((i < len)) {
            ...
            if (_mv_995.has_value) {
                __auto_type field_expr = _mv_995.value;
...
void defn_emit_record_field(context_TranspileContext* ctx, slop_string raw_type_name, slop_string qualified_type_name, types_SExpr* field) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_996 = (*field);
        switch (_mv_996.tag) {
            case types_SExpr_lst:
            {
                __auto_type field_lst = _mv_996.data.lst;
                {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while ((i < len)) {
            ...
            if (_mv_1001.has_value) {
                __auto_type val_expr = _mv_1001.value;
                __auto_type _mv_1002 = (*val_expr);
                switch (_mv_1002.tag) {
                    case types_SExpr_sym:
                    {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while ((i < len)) {
            ...
            if (_mv_1004.has_value) {
                __auto_type variant_expr = _mv_1004.value;
                __auto_type _mv_1005 = (*variant_expr);
                switch (_mv_1005.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type var_lst = _mv_1005.data.lst;
                        {
                            __auto_type var_items = var_lst.items;
                            __auto_type var_len = ((int64_t)((var_items).len));
                            if ((var_len >= 1)) {
                                __auto_type _mv_1006 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1006.has_value) {
                                    __auto_type tag_expr = _mv_1006.value;
                                    __auto_type _mv_1007 = (*tag_expr);
                                    switch (_mv_1007.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type tag_sym = _mv_1007.data.sym;
                                            {
                                                __auto_type tag_name = tag_sym.name;
                                                __auto_type c_tag = ctype_to_c_name(arena, tag_name);
                                                if ((var_len == 2)) {
                                                    __auto_type _mv_1008 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    ...
                                                    for (int64_t fi = 1; fi < var_len; fi++) {
                                                        __auto_type _mv_1009 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)fi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while ((i < len)) {
            ...
            if (_mv_1010.has_value) {
                __auto_type variant_expr = _mv_1010.value;
                __auto_type _mv_1011 = (*variant_expr);
                switch (_mv_1011.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type var_lst = _mv_1011.data.lst;
                        {
                            __auto_type var_items = var_lst.items;
                            if ((((int64_t)((var_items).len)) >= 1)) {
                                __auto_type _mv_1012 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1012.has_value) {
                                    __auto_type tag_expr = _mv_1012.value;
                                    __auto_type _mv_1013 = (*tag_expr);
                                    switch (_mv_1013.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type tag_sym = _mv_1013.data.sym;
                                            {
                                                __auto_type tag_name = tag_sym.name;
        ...
        while ((i < len)) {
            ...
            if (_mv_1014.has_value) {
                ...
                switch (_mv_1015.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type var_lst = _mv_1015.data.lst;
                        {
                            __auto_type var_items = var_lst.items;
                            __auto_type var_len = ((int64_t)((var_items).len));
                            if ((var_len >= 2)) {
                                __auto_type _mv_1016 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1016.has_value) {
                                    __auto_type tag_expr = _mv_1016.value;
                                    __auto_type _mv_1017 = (*tag_expr);
                                    switch (_mv_1017.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type tag_sym = _mv_1017.data.sym;
                                            {
                                                __auto_type tag_name = tag_sym.name;
                                                if ((var_len == 2)) {
                                                    __auto_type _mv_1018 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    ...
                                                    for (int64_t fi = 1; fi < var_len; fi++) {
                                                        __auto_type _mv_1019 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)fi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                        if (_mv_1019.has_value) {
                                                            __auto_type type_expr = _mv_1019.value;
                                                            {
                                                                __auto_type c_type = context_to_c_type_prefixed(ctx, type_expr);
                                                                __auto_type slop_type_str = parser_pretty_print(arena, type_expr);
                                                                __auto_type is_ptr = defn_is_pointer_type_expr(type_expr);
                                                    ...
                                                    __auto_type _mv_1020 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_1020.has_value) {
                                                        __auto_type type_expr = _mv_1020.value;
                                                        {
                                                            __auto_type c_type = context_to_c_type_prefixed(ctx, type_expr);
                                                            __auto_type slop_type_str = parser_pretty_print(arena, type_expr);
                                                            __auto_type is_ptr = defn_is_pointer_type_expr(type_expr);
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1021.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    __auto_type _mv_1022 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                ...
                __auto_type lst = _mv_1024.data.lst;
                {
                    ...
                    if ((len < 3)) {
                        ...
                        if (_mv_1025.has_value) {
                            __auto_type elem_type_expr = _mv_1025.value;
                            ...
                            if (_mv_1026.has_value) {
                                __auto_type size_expr = _mv_1026.value;
                                {
...
slop_string defn_get_number_as_string(types_SExpr* expr) {
    ...
    switch (_mv_1027.tag) {
        case types_SExpr_num:
        {
            __auto_type num = _mv_1027.data.num;
            return num.raw;
        }
        default: {
            return SLOP_STR("0");
                    ...
                    while ((i < len)) {
                        ...
                        if (_mv_1032.has_value) {
                            ...
                            switch (_mv_1033.tag) {
                                case types_SExpr_num:
                                {
                                    __auto_type num = _mv_1033.data.num;
                                    if (!(found_dots)) {
                                ...
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_1036.data.sym;
                                    {
                                        ...
                                        if (_mv_1037.has_value) {
                                            __auto_type params_expr = _mv_1037.value;
                    ...
                    if ((len >= 2)) {
                        {
                            ...
                            __auto_type _mv_1043 = ({ __auto_type _lst = items; size_t _idx = (size_t)name_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_1043.has_value) {
                                ...
                                switch (_mv_1044.tag) {
                                    case types_SExpr_sym:
                                    {
                                        ...
                                        __auto_type _mv_1045 = ({ __auto_type _lst = items; size_t _idx = (size_t)type_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_list_context_FuncParamType_ptr defn_collect_param_types(context_TranspileContext* ctx, types_SExpr* params_expr) {
    ...
    SLOP_PRE(((params_expr != NULL)), "(!= params-expr nil)");
    {
        ...
        __auto_type _mv_1049 = (*params_expr);
        switch (_mv_1049.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1049.data.lst;
                {
                    ...
                    __auto_type i = 0;
                    while ((i < len)) {
                        __auto_type _mv_1050 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_1050.has_value) {
                            __auto_type param = _mv_1050.value;
                            {
                ...
                __auto_type lst = _mv_1051.data.lst;
                {
                    ...
                    if ((len < 2)) {
                    ...
                    } else {
                        {
                            __auto_type has_mode = ((len >= 3) && defn_is_param_mode(items));
                            __auto_type type_idx = ((has_mode) ? 2 : 1);
                            __auto_type _mv_1052 = ({ __auto_type _lst = items; size_t _idx = (size_t)type_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        switch (_mv_1053.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1053.data.lst;
                {
                    ...
                    __auto_type len = ((int64_t)((items).len));
                    if ((len >= 3)) {
                        __auto_type _mv_1054 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                ...
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_1055.data.sym;
                                    {
                                        ...
                                        if (_mv_1056.has_value) {
                                            __auto_type params_expr = _mv_1056.value;
                                            {
                                                __auto_type result_type_opt = defn_get_result_type_name(ctx, items);
                                                __auto_type raw_return = defn_get_return_type(ctx, items);
                                                {
...
slop_string defn_extract_spec_return_type(context_TranspileContext* ctx, types_SExpr* spec_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1061 = (*spec_expr);
        switch (_mv_1061.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1061.data.lst;
                {
                    ...
                    if ((((int64_t)((items).len)) < 2)) {
                        ...
                        __auto_type _mv_1062 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_1062.has_value) {
                            __auto_type spec_body = _mv_1062.value;
                            __auto_type _mv_1063 = (*spec_body);
                            switch (_mv_1063.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type body_lst = _mv_1063.data.lst;
                                    {
                                        ...
                                        if ((body_len < 1)) {
                                            ...
                                            __auto_type _mv_1064 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)(body_len - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_1064.has_value) {
                                                __auto_type ret_type = _mv_1064.value;
...
slop_string defn_extract_spec_slop_return_type(context_TranspileContext* ctx, types_SExpr* spec_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1065 = (*spec_expr);
        switch (_mv_1065.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1065.data.lst;
                {
                    ...
                    if ((((int64_t)((items).len)) < 2)) {
                        ...
                        if (_mv_1066.has_value) {
                            __auto_type spec_body = _mv_1066.value;
                            __auto_type _mv_1067 = (*spec_body);
                            switch (_mv_1067.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type body_lst = _mv_1067.data.lst;
                                    {
                                        __auto_type body_items = body_lst.items;
                                        __auto_type body_len = ((int64_t)((body_items).len));
                                        if ((body_len < 1)) {
                                            ...
                                            __auto_type _mv_1068 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)(body_len - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_1068.has_value) {
                                                __auto_type ret_type = _mv_1068.value;
...
slop_option_string defn_extract_result_type_name(context_TranspileContext* ctx, types_SExpr* spec_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1071 = (*spec_expr);
        switch (_mv_1071.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1071.data.lst;
                {
                    ...
                    if ((((int64_t)((items).len)) < 2)) {
                        ...
                        if (_mv_1072.has_value) {
                            __auto_type spec_body = _mv_1072.value;
                            __auto_type _mv_1073 = (*spec_body);
                            switch (_mv_1073.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type body_lst = _mv_1073.data.lst;
                                    {
                                        __auto_type body_items = body_lst.items;
                                        __auto_type body_len = ((int64_t)((body_items).len));
                                        if ((body_len < 1)) {
                                            ...
                                            __auto_type _mv_1074 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)(body_len - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_1074.has_value) {
                                                __auto_type ret_type = _mv_1074.value;
    ...
    SLOP_PRE(((type_expr != NULL)), "(!= type-expr nil)");
    {
        ...
        switch (_mv_1075.tag) {
            case types_SExpr_sym:
            {
                ...
                {
                    __auto_type type_name = sym.name;
                    __auto_type _mv_1076 = context_ctx_lookup_result_type_alias(ctx, type_name);
                    if (_mv_1076.has_value) {
                        __auto_type alias_result = _mv_1076.value;
                        return (slop_option_string){.has_value = 1, .value = alias_result};
                    } else if (!_mv_1076.has_value) {
                        __auto_type _mv_1077 = context_ctx_lookup_type(ctx, type_name);
                        if (_mv_1077.has_value) {
                            __auto_type entry = _mv_1077.value;
                                ...
                                case types_SExpr_sym:
                                {
                                    ...
                                    if (string_eq(sym.name, SLOP_STR("Result"))) {
                                        ...
                                        if (_mv_1080.has_value) {
                                            __auto_type ok_type_expr = _mv_1080.value;
                                            ...
                                            if (_mv_1081.has_value) {
                                                __auto_type err_type_expr = _mv_1081.value;
                                                {
...
slop_string defn_build_param_str(context_TranspileContext* ctx, types_SExpr* params_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1082 = (*params_expr);
        switch (_mv_1082.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1082.data.lst;
                {
                    ...
                    while ((i < len)) {
                        ...
                        if (_mv_1083.has_value) {
                            __auto_type param = _mv_1083.value;
                            {
                            ...
                            if (_mv_1085.has_value) {
                                ...
                                switch (_mv_1086.tag) {
                                    case types_SExpr_sym:
                                    {
                                        ...
                                        __auto_type _mv_1087 = ({ __auto_type _lst = items; size_t _idx = (size_t)type_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
uint8_t defn_is_param_mode(slop_list_types_SExpr_ptr items) {
    if ((((int64_t)((items).len)) < 1)) {
        ...
        if (_mv_1088.has_value) {
            __auto_type first = _mv_1088.value;
            __auto_type _mv_1089 = (*first);
            switch (_mv_1089.tag) {
                case types_SExpr_sym:
                {
            ...
            __auto_type lst = _mv_1090.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    if (_mv_1091.has_value) {
                        __auto_type first = _mv_1091.value;
                        __auto_type _mv_1092 = (*first);
                        switch (_mv_1092.tag) {
                            case types_SExpr_sym:
                            {
...
slop_string defn_emit_fn_param_type(context_TranspileContext* ctx, types_SExpr* type_expr, slop_string param_name) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1093 = (*type_expr);
        switch (_mv_1093.tag) {
            case types_SExpr_lst:
            {
                    ...
                    } else {
                        {
                            ...
                            if ((len == 2)) {
                                ...
                                if (_mv_1094.has_value) {
                                    __auto_type args_expr = _mv_1094.value;
                                    {
...
slop_string defn_build_fn_args_str_for_param(context_TranspileContext* ctx, types_SExpr* args_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1095 = (*args_expr);
        switch (_mv_1095.tag) {
            case types_SExpr_lst:
            {
                __auto_type args_list = _mv_1095.data.lst;
                {
                    ...
                    if ((arg_count == 0)) {
                    ...
                    } else {
                        {
                            ...
                            __auto_type i = 0;
                            while ((i < arg_count)) {
                                __auto_type _mv_1096 = ({ __auto_type _lst = arg_items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1096.has_value) {
                                    __auto_type arg_expr = _mv_1096.value;
                                    {
...
uint8_t defn_is_c_name_attr_at(slop_list_types_SExpr_ptr items, int64_t idx) {
    __auto_type _mv_1100 = ({ __auto_type _lst = items; size_t _idx = (size_t)idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1108.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    __auto_type _mv_1109 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            ...
            __auto_type lst = _mv_1114.data.lst;
            {
                ...
                if ((len < 1)) {
                ...
                } else {
                    {
                        ...
                        while (((i < len) && !(found))) {
                            __auto_type _mv_1117 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                ...
                __auto_type lst = _mv_1121.data.lst;
                {
                    ...
                    if ((((int64_t)((items).len)) >= 2)) {
                        ...
                        if (_mv_1122.has_value) {
                            __auto_type val = _mv_1122.value;
                            __auto_type _mv_1123 = (*val);
                            switch (_mv_1123.tag) {
                                case types_SExpr_str:
                                {
                                    __auto_type str = _mv_1123.data.str;
                ...
                __auto_type lst = _mv_1125.data.lst;
                {
                    ...
                    if ((((int64_t)((items).len)) >= 2)) {
                        ...
                        if (_mv_1126.has_value) {
                            __auto_type val = _mv_1126.value;
        ...
        while ((i < len)) {
            ...
            if (_mv_1131.has_value) {
                ...
                if (defn_is_assume_form(item)) {
                    __auto_type _mv_1132 = defn_get_annotation_condition(item);
                    if (_mv_1132.has_value) {
                        __auto_type cond = _mv_1132.value;
                        ({ __auto_type _lst_p = &(result); __auto_type _item = (cond); if (_lst_p->len >= _lst_p->cap) { size_t _new_cap = _lst_p->cap == 0 ? 16 : _lst_p->cap * 2; __typeof__(_lst_p->data) _new_data = (__typeof__(_lst_p->data))slop_arena_alloc(arena, _new_cap * sizeof(*_lst_p->data)); if (_lst_p->len > 0) memcpy(_new_data, _lst_p->data, _lst_p->len * sizeof(*_lst_p->data)); _lst_p->data = _new_data; _lst_p->cap = _new_cap; } _lst_p->data[_lst_p->len++] = _item; (void)0; });
...
void defn_emit_preconditions(context_TranspileContext* ctx, slop_list_types_SExpr_ptr preconditions) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1134 = ({ __auto_type _lst = preconditions; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void defn_emit_postconditions(context_TranspileContext* ctx, slop_list_types_SExpr_ptr postconditions) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1135 = ({ __auto_type _lst = postconditions; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1135.has_value) {
                __auto_type cond_expr = _mv_1135.value;
...
void defn_emit_assumptions(context_TranspileContext* ctx, slop_list_types_SExpr_ptr assumptions) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1136 = ({ __auto_type _lst = assumptions; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1136.has_value) {
                __auto_type cond_expr = _mv_1136.value;
                if (!(defn_is_verification_only_expr(cond_expr))) {
                    {
                        __auto_type cond_c = expr_transpile_expr(ctx, cond_expr);
                        __auto_type expr_str = parser_pretty_print(arena, cond_expr);
