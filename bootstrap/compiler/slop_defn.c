...
uint8_t defn_has_generic_annotation(slop_list_types_SExpr_ptr items) {
    {
        ...
        while ((i < len) && !(found)) {
            ...
            if (_mv_976.has_value) {
                __auto_type item = _mv_976.value;
                __auto_type _mv_977 = (*item);
                switch (_mv_977.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type lst = _mv_977.data.lst;
                        {
                            ...
                            if (((int64_t)((sub_items).len)) > 0) {
                                __auto_type _mv_978 = ({ __auto_type _lst = sub_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    ...
                                    __auto_type name_sym = _mv_985.data.sym;
                                    {
                                        ...
                                        if (_mv_986.has_value) {
                                            __auto_type type_expr = _mv_986.value;
                                            {
                                                ...
                                                __auto_type _mv_987 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_987.has_value) {
                                                    __auto_type value_expr = _mv_987.value;
        ...
        if (ctype_is_int_type(type_name)) {
        ...
        } else {
            {
                ...
                if (string_eq(type_name, SLOP_STR("String"))) {
                    __auto_type _mv_988 = (*value_expr);
                    switch (_mv_988.tag) {
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_991.data.lst;
                {
                    ...
                    __auto_type len = ((int64_t)((items).len));
                    {
                        ...
                        if (len >= (name_idx + 1)) {
                            __auto_type _mv_992 = ({ __auto_type _lst = items; size_t _idx = (size_t)name_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
uint8_t defn_is_string_expr(slop_list_types_SExpr_ptr items, int64_t idx) {
    __auto_type _mv_994 = ({ __auto_type _lst = items; size_t _idx = (size_t)idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    if (_mv_994.has_value) {
        ...
        switch (_mv_995.tag) {
            case types_SExpr_str:
            {
                __auto_type _ = _mv_995.data.str;
                return 1;
            }
            default: {
                return 0;
                                ...
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_998.data.sym;
                                    {
                                        ...
                                        if (_mv_999.has_value) {
                                            __auto_type type_def = _mv_999.value;
...
void defn_dispatch_type_def(context_TranspileContext* ctx, slop_string raw_name, slop_string qualified_name, types_SExpr* type_def) {
    ...
    __auto_type _mv_1000 = (*type_def);
    switch (_mv_1000.tag) {
        case types_SExpr_lst:
        {
            __auto_type def_lst = _mv_1000.data.lst;
            {
        ...
        while ((i < len) && !(found)) {
            ...
            if (_mv_1003.has_value) {
                ...
                switch (_mv_1004.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type _ = _mv_1004.data.lst;
                        found = 1;
                        break;
                    }
                    default: {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_1006.has_value) {
                __auto_type field_expr = _mv_1006.value;
...
void defn_emit_record_field(context_TranspileContext* ctx, slop_string raw_type_name, slop_string qualified_type_name, types_SExpr* field) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1007 = (*field);
        switch (_mv_1007.tag) {
            case types_SExpr_lst:
            {
                __auto_type field_lst = _mv_1007.data.lst;
                {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_1012.has_value) {
                __auto_type val_expr = _mv_1012.value;
                __auto_type _mv_1013 = (*val_expr);
                switch (_mv_1013.tag) {
                    case types_SExpr_sym:
                    {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_1015.has_value) {
                __auto_type variant_expr = _mv_1015.value;
                __auto_type _mv_1016 = (*variant_expr);
                switch (_mv_1016.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type var_lst = _mv_1016.data.lst;
                        {
                            __auto_type var_items = var_lst.items;
                            __auto_type var_len = ((int64_t)((var_items).len));
                            if (var_len >= 1) {
                                __auto_type _mv_1017 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1017.has_value) {
                                    __auto_type tag_expr = _mv_1017.value;
                                    __auto_type _mv_1018 = (*tag_expr);
                                    switch (_mv_1018.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type tag_sym = _mv_1018.data.sym;
                                            {
                                                __auto_type tag_name = tag_sym.name;
                                                __auto_type c_tag = ctype_to_c_name(arena, tag_name);
                                                if (var_len == 2) {
                                                    __auto_type _mv_1019 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    ...
                                                    for (int64_t fi = 1; fi < var_len; fi++) {
                                                        __auto_type _mv_1020 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)fi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        ...
                                        case types_SExpr_sym:
                                        {
                                            __auto_type tag_sym = _mv_1028.data.sym;
                                            {
                                                ...
                                                if (var_len == 2) {
                                                    ...
                                                    for (int64_t fi = 1; fi < var_len; fi++) {
                                                        __auto_type _mv_1030 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)fi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                ...
                __auto_type lst = _mv_1035.data.lst;
                {
                    ...
                    if (len < 3) {
                        ...
                        if (_mv_1036.has_value) {
                            __auto_type elem_type_expr = _mv_1036.value;
                            ...
                            if (_mv_1037.has_value) {
                                __auto_type size_expr = _mv_1037.value;
                                {
...
slop_string defn_get_number_as_string(types_SExpr* expr) {
    ...
    switch (_mv_1038.tag) {
        case types_SExpr_num:
        {
            __auto_type num = _mv_1038.data.num;
            return num.raw;
        }
        default: {
            return SLOP_STR("0");
                ...
                __auto_type lst = _mv_1045.data.lst;
                {
                    ...
                    if (len < 3) {
                        ...
                        if (_mv_1046.has_value) {
                            __auto_type name_expr = _mv_1046.value;
                            __auto_type _mv_1047 = (*name_expr);
                            switch (_mv_1047.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_1047.data.sym;
                                    {
                                        __auto_type raw_name = name_sym.name;
                                        __auto_type base_name = ctype_to_c_name(arena, raw_name);
                                        ...
                                        if (_mv_1048.has_value) {
                                            __auto_type params_expr = _mv_1048.value;
...
slop_option_string defn_check_result_type(context_TranspileContext* ctx, types_SExpr* type_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1086 = (*type_expr);
        switch (_mv_1086.tag) {
            case types_SExpr_sym:
            {
                ...
                {
                    __auto_type type_name = sym.name;
                    __auto_type _mv_1087 = context_ctx_lookup_result_type_alias(ctx, type_name);
                    if (_mv_1087.has_value) {
                        __auto_type alias_result = _mv_1087.value;
                        return (slop_option_string){.has_value = 1, .value = alias_result};
                    } else if (!_mv_1087.has_value) {
                        __auto_type _mv_1088 = context_ctx_lookup_type(ctx, type_name);
                        if (_mv_1088.has_value) {
                            __auto_type entry = _mv_1088.value;
                                ...
                                case types_SExpr_sym:
                                {
                                    ...
                                    if (string_eq(sym.name, SLOP_STR("Result"))) {
                                        ...
                                        if (_mv_1091.has_value) {
                                            __auto_type ok_type_expr = _mv_1091.value;
                                            ...
                                            if (_mv_1092.has_value) {
                                                __auto_type err_type_expr = _mv_1092.value;
                                                {
...
slop_string defn_build_param_str(context_TranspileContext* ctx, types_SExpr* params_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1093 = (*params_expr);
        switch (_mv_1093.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1093.data.lst;
                {
                    ...
                    while (i < len) {
                        ...
                        if (_mv_1094.has_value) {
                            __auto_type param = _mv_1094.value;
                            {
                ...
                __auto_type lst = _mv_1095.data.lst;
                {
                    ...
                    if (len < 2) {
                    ...
                    } else {
                        {
                            ...
                            __auto_type _mv_1096 = ({ __auto_type _lst = items; size_t _idx = (size_t)name_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_1096.has_value) {
                                __auto_type name_expr = _mv_1096.value;
                                __auto_type _mv_1097 = (*name_expr);
                                switch (_mv_1097.tag) {
                                    case types_SExpr_sym:
                                    {
                                        __auto_type name_sym = _mv_1097.data.sym;
                                        __auto_type _mv_1098 = ({ __auto_type _lst = items; size_t _idx = (size_t)type_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_1098.has_value) {
                                            __auto_type type_expr = _mv_1098.value;
                                            {
...
uint8_t defn_is_param_mode(slop_list_types_SExpr_ptr items) {
    if (((int64_t)((items).len)) < 1) {
        ...
        if (_mv_1099.has_value) {
            __auto_type first = _mv_1099.value;
            __auto_type _mv_1100 = (*first);
            switch (_mv_1100.tag) {
                case types_SExpr_sym:
                {
                    ...
                    } else {
                        {
                            ...
                            if (len == 2) {
                                ...
                                if (_mv_1105.has_value) {
                                    __auto_type args_expr = _mv_1105.value;
                                    {
...
slop_string defn_build_fn_args_str_for_param(context_TranspileContext* ctx, types_SExpr* args_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1106 = (*args_expr);
        switch (_mv_1106.tag) {
            case types_SExpr_lst:
            {
                __auto_type args_list = _mv_1106.data.lst;
                {
                    ...
                    if (arg_count == 0) {
                    ...
                    } else {
                        {
                            ...
                            __auto_type i = 0;
                            while (i < arg_count) {
                                __auto_type _mv_1107 = ({ __auto_type _lst = arg_items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1107.has_value) {
                                    __auto_type arg_expr = _mv_1107.value;
                                    {
...
uint8_t defn_is_c_name_attr_at(slop_list_types_SExpr_ptr items, int64_t idx) {
    __auto_type _mv_1111 = ({ __auto_type _lst = items; size_t _idx = (size_t)idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                ...
                __auto_type lst = _mv_1132.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) >= 2) {
                        ...
                        if (_mv_1133.has_value) {
                            ...
                            __auto_type _mv_1134 = (*val);
                            switch (_mv_1134.tag) {
                                case types_SExpr_str:
                                {
                                    __auto_type str = _mv_1134.data.str;
...
void defn_emit_preconditions(context_TranspileContext* ctx, slop_list_types_SExpr_ptr preconditions) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1145 = ({ __auto_type _lst = preconditions; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void defn_emit_postconditions(context_TranspileContext* ctx, slop_list_types_SExpr_ptr postconditions) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1146 = ({ __auto_type _lst = postconditions; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1146.has_value) {
                __auto_type cond_expr = _mv_1146.value;
...
void defn_emit_assumptions(context_TranspileContext* ctx, slop_list_types_SExpr_ptr assumptions) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1147 = ({ __auto_type _lst = assumptions; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
