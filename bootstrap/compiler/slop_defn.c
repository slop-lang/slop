        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_888.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    __auto_type _mv_889 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_889.has_value) {
                        __auto_type head = _mv_889.value;
                        __auto_type _mv_890 = (*head);
                        switch (_mv_890.tag) {
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_891.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    __auto_type _mv_892 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_892.has_value) {
                        __auto_type head = _mv_892.value;
                        __auto_type _mv_893 = (*head);
                        switch (_mv_893.tag) {
                            case types_SExpr_sym:
                            {
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_894.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    __auto_type _mv_895 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_900.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    __auto_type _mv_901 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
uint8_t defn_has_generic_annotation(slop_list_types_SExpr_ptr items) {
    {
        ...
        __auto_type found = 0;
        while (((i < len) && !(found))) {
            __auto_type _mv_903 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_903.has_value) {
                __auto_type item = _mv_903.value;
                __auto_type _mv_904 = (*item);
                switch (_mv_904.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type lst = _mv_904.data.lst;
                        {
                            ...
                            if ((((int64_t)((sub_items).len)) > 0)) {
                                __auto_type _mv_905 = ({ __auto_type _lst = sub_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_910.data.lst;
                {
                    ...
                    if ((len < 4)) {
                        ...
                        __auto_type _mv_911 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_911.has_value) {
                            __auto_type name_expr = _mv_911.value;
                            __auto_type _mv_912 = (*name_expr);
                            switch (_mv_912.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_912.data.sym;
                                    {
                                        ...
                                        __auto_type _mv_913 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_913.has_value) {
                                            __auto_type type_expr = _mv_913.value;
                                            {
                                                ...
                                                __auto_type _mv_914 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_914.has_value) {
                                                    __auto_type value_expr = _mv_914.value;
        ...
        if (ctype_is_int_type(type_name)) {
        ...
        } else {
            {
                ...
                if (string_eq(type_name, SLOP_STR("String"))) {
                    __auto_type _mv_915 = (*value_expr);
                    switch (_mv_915.tag) {
                        case types_SExpr_str:
                        {
                            __auto_type str = _mv_915.data.str;
...
slop_string defn_eval_const_value(context_TranspileContext* ctx, types_SExpr* expr) {
    ...
    SLOP_PRE(((expr != NULL)), "(!= expr nil)");
    {
        ...
        switch (_mv_917.tag) {
            ...
            {
                __auto_type num = _mv_917.data.num;
                return num.raw;
            }
            case types_SExpr_str:
            {
                __auto_type str = _mv_917.data.str;
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_918.data.lst;
                {
                    ...
                    __auto_type len = ((int64_t)((items).len));
                    {
                        ...
                        if ((len >= (name_idx + 1))) {
                            __auto_type _mv_919 = ({ __auto_type _lst = items; size_t _idx = (size_t)name_idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
uint8_t defn_is_string_expr(slop_list_types_SExpr_ptr items, int64_t idx) {
    __auto_type _mv_921 = ({ __auto_type _lst = items; size_t _idx = (size_t)idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    if (_mv_921.has_value) {
        __auto_type item = _mv_921.value;
        __auto_type _mv_922 = (*item);
        switch (_mv_922.tag) {
            case types_SExpr_str:
            {
                __auto_type _ = _mv_922.data.str;
                return 1;
            }
            default: {
                return 0;
                ...
                __auto_type lst = _mv_923.data.lst;
                {
                    ...
                    if ((len < 3)) {
                        ...
                        if (_mv_924.has_value) {
                            __auto_type name_expr = _mv_924.value;
                            __auto_type _mv_925 = (*name_expr);
                            switch (_mv_925.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_925.data.sym;
                                    {
                                        __auto_type raw_name = name_sym.name;
                                        __auto_type base_name = ctype_to_c_name(arena, raw_name);
                                        ...
                                        __auto_type _mv_926 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_926.has_value) {
                                            __auto_type type_def = _mv_926.value;
...
void defn_dispatch_type_def(context_TranspileContext* ctx, slop_string raw_name, slop_string qualified_name, types_SExpr* type_def) {
    ...
    __auto_type _mv_927 = (*type_def);
    switch (_mv_927.tag) {
        case types_SExpr_lst:
        {
            __auto_type def_lst = _mv_927.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    __auto_type _mv_928 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        while (((i < len) && !(found))) {
            ...
            if (_mv_930.has_value) {
                ...
                switch (_mv_931.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type _ = _mv_931.data.lst;
                        found = 1;
                        break;
                    }
                    default: {
...
void defn_emit_record_field(context_TranspileContext* ctx, slop_string raw_type_name, slop_string qualified_type_name, types_SExpr* field) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_934 = (*field);
        switch (_mv_934.tag) {
            case types_SExpr_lst:
            {
                __auto_type field_lst = _mv_934.data.lst;
                {
                        ...
                        if (_mv_935.has_value) {
                            ...
                            switch (_mv_936.tag) {
                                case types_SExpr_sym:
                                {
                                    ...
                                    __auto_type _mv_937 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void defn_emit_union_variants(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items, int64_t start_idx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = start_idx;
        while ((i < len)) {
            __auto_type _mv_942 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_942.has_value) {
                __auto_type variant_expr = _mv_942.value;
                __auto_type _mv_943 = (*variant_expr);
                switch (_mv_943.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type var_lst = _mv_943.data.lst;
                        {
                            __auto_type var_items = var_lst.items;
                            __auto_type var_len = ((int64_t)((var_items).len));
                            if ((var_len >= 1)) {
                                __auto_type _mv_944 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_944.has_value) {
                                    __auto_type tag_expr = _mv_944.value;
                                    __auto_type _mv_945 = (*tag_expr);
                                    switch (_mv_945.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type tag_sym = _mv_945.data.sym;
                                            {
                                                __auto_type tag_name = tag_sym.name;
                                                if ((var_len >= 2)) {
                                                    __auto_type _mv_946 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void defn_emit_tag_constants(context_TranspileContext* ctx, slop_string type_name, slop_list_types_SExpr_ptr items, int64_t start_idx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t tag_idx = 0;
        while ((i < len)) {
            __auto_type _mv_947 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_947.has_value) {
                __auto_type variant_expr = _mv_947.value;
                __auto_type _mv_948 = (*variant_expr);
                switch (_mv_948.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type var_lst = _mv_948.data.lst;
                        {
                            __auto_type var_items = var_lst.items;
                            if ((((int64_t)((var_items).len)) >= 1)) {
                                __auto_type _mv_949 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_949.has_value) {
                                    __auto_type tag_expr = _mv_949.value;
                                    __auto_type _mv_950 = (*tag_expr);
                                    switch (_mv_950.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type tag_sym = _mv_950.data.sym;
                                            {
                                                __auto_type tag_name = tag_sym.name;
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while ((i < len)) {
            ...
            if (_mv_951.has_value) {
                __auto_type variant_expr = _mv_951.value;
                __auto_type _mv_952 = (*variant_expr);
                switch (_mv_952.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type var_lst = _mv_952.data.lst;
                        {
                            __auto_type var_items = var_lst.items;
                            __auto_type var_len = ((int64_t)((var_items).len));
                            if ((var_len >= 2)) {
                                __auto_type _mv_953 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_953.has_value) {
                                    __auto_type tag_expr = _mv_953.value;
                                    __auto_type _mv_954 = (*tag_expr);
                                    switch (_mv_954.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type tag_sym = _mv_954.data.sym;
                                            {
                                                __auto_type tag_name = tag_sym.name;
                                                __auto_type _mv_955 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                ...
                __auto_type lst = _mv_959.data.lst;
                {
                    ...
                    if ((len < 3)) {
                        ...
                        if (_mv_960.has_value) {
                            __auto_type elem_type_expr = _mv_960.value;
                            __auto_type _mv_961 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_961.has_value) {
                                __auto_type size_expr = _mv_961.value;
                                {
...
slop_string defn_get_number_as_string(types_SExpr* expr) {
    ...
    switch (_mv_962.tag) {
        case types_SExpr_num:
        {
            __auto_type num = _mv_962.data.num;
            return num.raw;
        }
        default: {
            return SLOP_STR("0");
                    ...
                    while ((i < len)) {
                        ...
                        if (_mv_967.has_value) {
                            ...
                            switch (_mv_968.tag) {
                                case types_SExpr_num:
                                {
                                    __auto_type num = _mv_968.data.num;
                                    if (!(found_dots)) {
                ...
                __auto_type lst = _mv_969.data.lst;
                {
                    ...
                    if ((len < 3)) {
                        ...
                        if (_mv_970.has_value) {
                            __auto_type name_expr = _mv_970.value;
                            __auto_type _mv_971 = (*name_expr);
                            switch (_mv_971.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_971.data.sym;
                                    {
                                        __auto_type raw_name = name_sym.name;
                                        __auto_type base_name = ctype_to_c_name(arena, raw_name);
...
void defn_bind_params_to_scope(context_TranspileContext* ctx, types_SExpr* params_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_975 = (*params_expr);
        switch (_mv_975.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_975.data.lst;
                {
                    ...
                    while ((i < len)) {
                        ...
                        if (_mv_976.has_value) {
                            __auto_type param = _mv_976.value;
                    ...
                    if ((len >= 2)) {
                        {
                            ...
                            __auto_type _mv_978 = ({ __auto_type _lst = items; size_t _idx = (size_t)name_idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_978.has_value) {
                                __auto_type name_expr = _mv_978.value;
                                __auto_type _mv_979 = (*name_expr);
                                switch (_mv_979.tag) {
                                    case types_SExpr_sym:
                                    {
                                        __auto_type name_sym = _mv_979.data.sym;
                                        __auto_type _mv_980 = ({ __auto_type _lst = items; size_t _idx = (size_t)type_idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_list_context_FuncParamType_ptr defn_collect_param_types(context_TranspileContext* ctx, types_SExpr* params_expr) {
    ...
    SLOP_PRE(((params_expr != NULL)), "(!= params-expr nil)");
    {
        ...
        __auto_type _mv_984 = (*params_expr);
        switch (_mv_984.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_984.data.lst;
                {
                    ...
                    while ((i < len)) {
                        ...
                        if (_mv_985.has_value) {
                            __auto_type param = _mv_985.value;
                            {
                ...
                __auto_type lst = _mv_986.data.lst;
                {
                    ...
                    if ((len < 2)) {
                    ...
                    } else {
                        {
                            __auto_type has_mode = ((len >= 3) && defn_is_param_mode(items));
                            __auto_type type_idx = ((has_mode) ? 2 : 1);
                            __auto_type _mv_987 = ({ __auto_type _lst = items; size_t _idx = (size_t)type_idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_987.has_value) {
                                __auto_type type_expr = _mv_987.value;
...
slop_string defn_extract_spec_slop_return_type(context_TranspileContext* ctx, types_SExpr* spec_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1000 = (*spec_expr);
        switch (_mv_1000.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1000.data.lst;
                {
                    ...
                    if ((((int64_t)((items).len)) < 2)) {
                        ...
                        if (_mv_1001.has_value) {
                            __auto_type spec_body = _mv_1001.value;
                            __auto_type _mv_1002 = (*spec_body);
                            switch (_mv_1002.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type body_lst = _mv_1002.data.lst;
                                    {
                                        __auto_type body_items = body_lst.items;
                                        __auto_type body_len = ((int64_t)((body_items).len));
                                        if ((body_len < 1)) {
                                            ...
                                            __auto_type _mv_1003 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)(body_len - 1); slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_option_string defn_get_result_type_name(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (((i < len) && ({ __auto_type _mv = result; _mv.has_value ? ({ __auto_type _ = _mv.value; 0; }) : (1); }))) {
            __auto_type _mv_1005 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1005.has_value) {
                __auto_type item = _mv_1005.value;
                if (defn_is_spec_form(item)) {
...
slop_option_string defn_extract_result_type_name(context_TranspileContext* ctx, types_SExpr* spec_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1006 = (*spec_expr);
        switch (_mv_1006.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1006.data.lst;
                {
                    ...
                    if ((((int64_t)((items).len)) < 2)) {
                        ...
                        if (_mv_1007.has_value) {
                            __auto_type spec_body = _mv_1007.value;
                            __auto_type _mv_1008 = (*spec_body);
                            switch (_mv_1008.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type body_lst = _mv_1008.data.lst;
                                    {
                                        __auto_type body_items = body_lst.items;
                                        __auto_type body_len = ((int64_t)((body_items).len));
                                        if ((body_len < 1)) {
                                            ...
                                            __auto_type _mv_1009 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)(body_len - 1); slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_1009.has_value) {
                                                __auto_type ret_type = _mv_1009.value;
    ...
    SLOP_PRE(((type_expr != NULL)), "(!= type-expr nil)");
    {
        ...
        switch (_mv_1010.tag) {
            case types_SExpr_sym:
            {
                ...
                {
                    __auto_type type_name = sym.name;
                    __auto_type _mv_1011 = context_ctx_lookup_result_type_alias(ctx, type_name);
                    if (_mv_1011.has_value) {
                        __auto_type alias_result = _mv_1011.value;
                        return (slop_option_string){.has_value = 1, .value = alias_result};
                    } else if (!_mv_1011.has_value) {
                        __auto_type _mv_1012 = context_ctx_lookup_type(ctx, type_name);
                        if (_mv_1012.has_value) {
                            __auto_type entry = _mv_1012.value;
                                ...
                                case types_SExpr_sym:
                                {
                                    ...
                                    if (string_eq(sym.name, SLOP_STR("Result"))) {
                                        ...
                                        if (_mv_1015.has_value) {
                                            __auto_type ok_type_expr = _mv_1015.value;
                                            ...
                                            if (_mv_1016.has_value) {
                                                __auto_type err_type_expr = _mv_1016.value;
                                                {
...
slop_string defn_build_param_str(context_TranspileContext* ctx, types_SExpr* params_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1017 = (*params_expr);
        switch (_mv_1017.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1017.data.lst;
                {
                    ...
                    while ((i < len)) {
                        ...
                        if (_mv_1018.has_value) {
                            __auto_type param = _mv_1018.value;
                            {
                ...
                __auto_type lst = _mv_1019.data.lst;
                {
                    ...
                    if ((len < 2)) {
                    ...
                    } else {
                        {
                            ...
                            __auto_type _mv_1020 = ({ __auto_type _lst = items; size_t _idx = (size_t)name_idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_1020.has_value) {
                                ...
                                switch (_mv_1021.tag) {
                                    case types_SExpr_sym:
                                    {
                                        __auto_type name_sym = _mv_1021.data.sym;
                                        __auto_type _mv_1022 = ({ __auto_type _lst = items; size_t _idx = (size_t)type_idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
uint8_t defn_is_param_mode(slop_list_types_SExpr_ptr items) {
    if ((((int64_t)((items).len)) < 1)) {
        ...
        __auto_type _mv_1023 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        if (_mv_1023.has_value) {
            __auto_type first = _mv_1023.value;
            __auto_type _mv_1024 = (*first);
            switch (_mv_1024.tag) {
                case types_SExpr_sym:
                {
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1025.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    __auto_type _mv_1026 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_1026.has_value) {
                        __auto_type first = _mv_1026.value;
                        __auto_type _mv_1027 = (*first);
                        switch (_mv_1027.tag) {
                            case types_SExpr_sym:
                            {
...
slop_string defn_emit_fn_param_type(context_TranspileContext* ctx, types_SExpr* type_expr, slop_string param_name) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1028 = (*type_expr);
        switch (_mv_1028.tag) {
            case types_SExpr_lst:
            {
                    ...
                    } else {
                        {
                            ...
                            if ((len == 2)) {
                                ...
                                if (_mv_1029.has_value) {
                                    __auto_type args_expr = _mv_1029.value;
                                    {
...
slop_string defn_build_fn_args_str_for_param(context_TranspileContext* ctx, types_SExpr* args_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1030 = (*args_expr);
        switch (_mv_1030.tag) {
            case types_SExpr_lst:
            {
                __auto_type args_list = _mv_1030.data.lst;
                {
                    ...
                    if ((arg_count == 0)) {
                    ...
                    } else {
                        {
                            ...
                            __auto_type i = 0;
                            while ((i < arg_count)) {
                                __auto_type _mv_1031 = ({ __auto_type _lst = arg_items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1031.has_value) {
                                    __auto_type arg_expr = _mv_1031.value;
                                    {
...
uint8_t defn_is_c_name_attr_at(slop_list_types_SExpr_ptr items, int64_t idx) {
    __auto_type _mv_1035 = ({ __auto_type _lst = items; size_t _idx = (size_t)idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1040.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    __auto_type _mv_1041 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_1041.has_value) {
                        __auto_type head = _mv_1041.value;
                        __auto_type _mv_1042 = (*head);
                        switch (_mv_1042.tag) {
                            case types_SExpr_sym:
                            {
            ...
            __auto_type lst = _mv_1046.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    if (_mv_1047.has_value) {
                        __auto_type head = _mv_1047.value;
                        __auto_type _mv_1048 = (*head);
                        switch (_mv_1048.tag) {
                            case types_SExpr_sym:
                            {
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1053.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    __auto_type _mv_1054 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_1054.has_value) {
                        __auto_type head = _mv_1054.value;
                        __auto_type _mv_1055 = (*head);
                        switch (_mv_1055.tag) {
                            case types_SExpr_sym:
                            {
                                __auto_type sym = _mv_1055.data.sym;
        ...
        switch (_mv_1056.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1056.data.lst;
                {
                    __auto_type items = lst.items;
                    if ((((int64_t)((items).len)) >= 2)) {
                        __auto_type _mv_1057 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_1057.has_value) {
                            __auto_type val = _mv_1057.value;
                            __auto_type _mv_1058 = (*val);
                            switch (_mv_1058.tag) {
                                case types_SExpr_str:
                                {
                                    __auto_type str = _mv_1058.data.str;
                ...
                __auto_type lst = _mv_1060.data.lst;
                {
                    ...
                    if ((((int64_t)((items).len)) >= 2)) {
                        ...
                        if (_mv_1061.has_value) {
                            __auto_type val = _mv_1061.value;
...
slop_list_types_SExpr_ptr defn_collect_preconditions(slop_arena* arena, slop_list_types_SExpr_ptr items) {
    {
        ...
        int64_t i = 3;
        while ((i < len)) {
            __auto_type _mv_1062 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1062.has_value) {
                __auto_type item = _mv_1062.value;
                if (defn_is_pre_form(item)) {
                    __auto_type _mv_1063 = defn_get_annotation_condition(item);
                    if (_mv_1063.has_value) {
                        __auto_type cond = _mv_1063.value;
        ...
        while ((i < len)) {
            ...
            if (_mv_1064.has_value) {
                ...
                if (defn_is_post_form(item)) {
                    __auto_type _mv_1065 = defn_get_annotation_condition(item);
                    if (_mv_1065.has_value) {
                        __auto_type cond = _mv_1065.value;
                        ({ __auto_type _lst_p = &(result); __auto_type _item = (cond); if (_lst_p->len >= _lst_p->cap) { size_t _new_cap = _lst_p->cap == 0 ? 16 : _lst_p->cap * 2; __typeof__(_lst_p->data) _new_data = (__typeof__(_lst_p->data))slop_arena_alloc(arena, _new_cap * sizeof(*_lst_p->data)); if (_lst_p->len > 0) memcpy(_new_data, _lst_p->data, _lst_p->len * sizeof(*_lst_p->data)); _lst_p->data = _new_data; _lst_p->cap = _new_cap; } _lst_p->data[_lst_p->len++] = _item; (void)0; });
        ...
        while ((i < len)) {
            ...
            if (_mv_1066.has_value) {
                ...
                if (defn_is_assume_form(item)) {
                    __auto_type _mv_1067 = defn_get_annotation_condition(item);
                    if (_mv_1067.has_value) {
                        __auto_type cond = _mv_1067.value;
                        ({ __auto_type _lst_p = &(result); __auto_type _item = (cond); if (_lst_p->len >= _lst_p->cap) { size_t _new_cap = _lst_p->cap == 0 ? 16 : _lst_p->cap * 2; __typeof__(_lst_p->data) _new_data = (__typeof__(_lst_p->data))slop_arena_alloc(arena, _new_cap * sizeof(*_lst_p->data)); if (_lst_p->len > 0) memcpy(_new_data, _lst_p->data, _lst_p->len * sizeof(*_lst_p->data)); _lst_p->data = _new_data; _lst_p->cap = _new_cap; } _lst_p->data[_lst_p->len++] = _item; (void)0; });
...
void defn_emit_preconditions(context_TranspileContext* ctx, slop_list_types_SExpr_ptr preconditions) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1069 = ({ __auto_type _lst = preconditions; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1069.has_value) {
                __auto_type cond_expr = _mv_1069.value;
                {
...
void defn_emit_postconditions(context_TranspileContext* ctx, slop_list_types_SExpr_ptr postconditions) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1070 = ({ __auto_type _lst = postconditions; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1070.has_value) {
                __auto_type cond_expr = _mv_1070.value;
...
void defn_emit_assumptions(context_TranspileContext* ctx, slop_list_types_SExpr_ptr assumptions) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1071 = ({ __auto_type _lst = assumptions; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1071.has_value) {
                __auto_type cond_expr = _mv_1071.value;
                if (!(defn_is_verification_only_expr(cond_expr))) {
                    {
                        __auto_type cond_c_raw = expr_transpile_expr(ctx, cond_expr);
                        __auto_type cond_c = strlib_replace(arena, strlib_replace(arena, cond_c_raw, SLOP_STR("_result"), SLOP_STR("_retval")), SLOP_STR("$result"), SLOP_STR("_retval"));
