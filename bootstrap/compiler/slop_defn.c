        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_963.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 1) {
                    ...
                    __auto_type _mv_964 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_969.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 1) {
                    ...
                    __auto_type _mv_970 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    ...
                    case types_SExpr_lst:
                    {
                        __auto_type lst = _mv_979.data.lst;
                        {
                            ...
                            if (((int64_t)((sub_items).len)) > 0) {
                                __auto_type _mv_980 = ({ __auto_type _lst = sub_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            ...
            __auto_type lst = _mv_982.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 1) {
                    ...
                    if (_mv_983.has_value) {
                        __auto_type head = _mv_983.value;
                        __auto_type _mv_984 = (*head);
                        switch (_mv_984.tag) {
                            case types_SExpr_sym:
                            {
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_985.data.lst;
                {
                    ...
                    if (len < 4) {
                        ...
                        __auto_type _mv_986 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_986.has_value) {
                            __auto_type name_expr = _mv_986.value;
                            __auto_type _mv_987 = (*name_expr);
                            switch (_mv_987.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_987.data.sym;
                                    {
                                        ...
                                        __auto_type _mv_988 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_988.has_value) {
                                            __auto_type type_expr = _mv_988.value;
                                            {
                                                ...
                                                __auto_type _mv_989 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_989.has_value) {
                                                    __auto_type value_expr = _mv_989.value;
        ...
        if (ctype_is_int_type(type_name)) {
        ...
        } else {
            {
                ...
                if (string_eq(type_name, SLOP_STR("String"))) {
                    __auto_type _mv_990 = (*value_expr);
                    switch (_mv_990.tag) {
                        case types_SExpr_str:
                        {
                            __auto_type str = _mv_990.data.str;
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_993.data.lst;
                {
                    ...
                    __auto_type len = ((int64_t)((items).len));
                    {
                        ...
                        if (len >= (name_idx + 1)) {
                            __auto_type _mv_994 = ({ __auto_type _lst = items; size_t _idx = (size_t)name_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
uint8_t defn_is_string_expr(slop_list_types_SExpr_ptr items, int64_t idx) {
    __auto_type _mv_996 = ({ __auto_type _lst = items; size_t _idx = (size_t)idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    if (_mv_996.has_value) {
        __auto_type item = _mv_996.value;
        __auto_type _mv_997 = (*item);
        switch (_mv_997.tag) {
            case types_SExpr_str:
            {
                __auto_type _ = _mv_997.data.str;
                return 1;
            }
            default: {
                return 0;
                            ...
                            switch (_mv_1000.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_1000.data.sym;
                                    {
                                        ...
                                        __auto_type _mv_1001 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_1001.has_value) {
                                            __auto_type type_def = _mv_1001.value;
...
void defn_dispatch_type_def(context_TranspileContext* ctx, slop_string raw_name, slop_string qualified_name, types_SExpr* type_def) {
    ...
    __auto_type _mv_1002 = (*type_def);
    switch (_mv_1002.tag) {
        case types_SExpr_lst:
        {
            __auto_type def_lst = _mv_1002.data.lst;
            {
        ...
        while ((i < len) && !(found)) {
            ...
            if (_mv_1005.has_value) {
                ...
                switch (_mv_1006.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type _ = _mv_1006.data.lst;
                        found = 1;
                        break;
                    }
                    default: {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_1008.has_value) {
                __auto_type field_expr = _mv_1008.value;
...
void defn_emit_record_field(context_TranspileContext* ctx, slop_string raw_type_name, slop_string qualified_type_name, types_SExpr* field) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1009 = (*field);
        switch (_mv_1009.tag) {
            case types_SExpr_lst:
            {
                __auto_type field_lst = _mv_1009.data.lst;
                {
                            ...
                            switch (_mv_1011.tag) {
                                case types_SExpr_sym:
                                {
                                    ...
                                    if (_mv_1012.has_value) {
                                        __auto_type type_expr = _mv_1012.value;
                                        {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_1014.has_value) {
                __auto_type val_expr = _mv_1014.value;
                __auto_type _mv_1015 = (*val_expr);
                switch (_mv_1015.tag) {
                    case types_SExpr_sym:
                    {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_1017.has_value) {
                __auto_type variant_expr = _mv_1017.value;
                __auto_type _mv_1018 = (*variant_expr);
                switch (_mv_1018.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type var_lst = _mv_1018.data.lst;
                        {
                            __auto_type var_items = var_lst.items;
                            __auto_type var_len = ((int64_t)((var_items).len));
                            if (var_len >= 1) {
                                __auto_type _mv_1019 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1019.has_value) {
                                    __auto_type tag_expr = _mv_1019.value;
                                    __auto_type _mv_1020 = (*tag_expr);
                                    switch (_mv_1020.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type tag_sym = _mv_1020.data.sym;
                                            {
                                                __auto_type tag_name = tag_sym.name;
                                                __auto_type c_tag = ctype_to_c_name(arena, tag_name);
                                                if (var_len == 2) {
                                                    __auto_type _mv_1021 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    ...
                                                    for (int64_t fi = 1; fi < var_len; fi++) {
                                                        __auto_type _mv_1022 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)fi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_1023.has_value) {
                __auto_type variant_expr = _mv_1023.value;
                __auto_type _mv_1024 = (*variant_expr);
                switch (_mv_1024.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type var_lst = _mv_1024.data.lst;
                        {
                            __auto_type var_items = var_lst.items;
                            if (((int64_t)((var_items).len)) >= 1) {
                                __auto_type _mv_1025 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1025.has_value) {
                                    __auto_type tag_expr = _mv_1025.value;
                                    __auto_type _mv_1026 = (*tag_expr);
                                    switch (_mv_1026.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type tag_sym = _mv_1026.data.sym;
                                            {
                                                __auto_type tag_name = tag_sym.name;
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_1027.has_value) {
                __auto_type variant_expr = _mv_1027.value;
                __auto_type _mv_1028 = (*variant_expr);
                switch (_mv_1028.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type var_lst = _mv_1028.data.lst;
                        {
                            __auto_type var_items = var_lst.items;
                            __auto_type var_len = ((int64_t)((var_items).len));
                            if (var_len >= 2) {
                                __auto_type _mv_1029 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1029.has_value) {
                                    __auto_type tag_expr = _mv_1029.value;
                                    __auto_type _mv_1030 = (*tag_expr);
                                    switch (_mv_1030.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type tag_sym = _mv_1030.data.sym;
                                            {
                                                __auto_type tag_name = tag_sym.name;
                                                if (var_len == 2) {
                                                    __auto_type _mv_1031 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    ...
                                                    for (int64_t fi = 1; fi < var_len; fi++) {
                                                        __auto_type _mv_1032 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)fi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1034.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 1) {
                    ...
                    __auto_type _mv_1035 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                ...
                __auto_type lst = _mv_1037.data.lst;
                {
                    ...
                    if (len < 3) {
                        ...
                        if (_mv_1038.has_value) {
                            __auto_type elem_type_expr = _mv_1038.value;
                            __auto_type _mv_1039 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_1039.has_value) {
                                __auto_type size_expr = _mv_1039.value;
                                {
...
slop_string defn_get_number_as_string(types_SExpr* expr) {
    ...
    switch (_mv_1040.tag) {
        case types_SExpr_num:
        {
            __auto_type num = _mv_1040.data.num;
            return num.raw;
        }
        default: {
            return SLOP_STR("0");
                ...
                __auto_type lst = _mv_1044.data.lst;
                {
                    ...
                    while (i < len) {
                        ...
                        if (_mv_1045.has_value) {
                            ...
                            __auto_type _mv_1046 = (*item);
                            switch (_mv_1046.tag) {
                                case types_SExpr_num:
                                {
                                    __auto_type num = _mv_1046.data.num;
                                    if (!(found_dots)) {
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1047.data.lst;
                {
                    ...
                    if (len < 3) {
                        ...
                        __auto_type _mv_1048 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_1048.has_value) {
                            __auto_type name_expr = _mv_1048.value;
                            __auto_type _mv_1049 = (*name_expr);
                            switch (_mv_1049.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_1049.data.sym;
                                    {
                                        __auto_type raw_name = name_sym.name;
                                        __auto_type base_name = ctype_to_c_name(arena, raw_name);
                                        ...
                                        if (_mv_1050.has_value) {
                                            __auto_type params_expr = _mv_1050.value;
                ...
                __auto_type lst = _mv_1066.data.lst;
                {
                    ...
                    if (len >= 3) {
                        ...
                        if (_mv_1067.has_value) {
                            __auto_type name_expr = _mv_1067.value;
                            __auto_type _mv_1068 = (*name_expr);
                            switch (_mv_1068.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_1068.data.sym;
                                    {
                                        __auto_type raw_name = name_sym.name;
                                        __auto_type base_name = ctype_to_c_name(arena, raw_name);
                                        ...
                                        __auto_type _mv_1069 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_string defn_extract_spec_return_type(context_TranspileContext* ctx, types_SExpr* spec_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1074 = (*spec_expr);
        switch (_mv_1074.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1074.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) < 2) {
                        ...
                        if (_mv_1075.has_value) {
                            __auto_type spec_body = _mv_1075.value;
                            __auto_type _mv_1076 = (*spec_body);
                            switch (_mv_1076.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type body_lst = _mv_1076.data.lst;
                                    {
                                        ...
                                        if (body_len < 1) {
                                            ...
                                            __auto_type _mv_1077 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)(body_len - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_1077.has_value) {
                                                __auto_type ret_type = _mv_1077.value;
...
slop_string defn_extract_spec_slop_return_type(context_TranspileContext* ctx, types_SExpr* spec_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1078 = (*spec_expr);
        switch (_mv_1078.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1078.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) < 2) {
                        ...
                        if (_mv_1079.has_value) {
                            __auto_type spec_body = _mv_1079.value;
                            __auto_type _mv_1080 = (*spec_body);
                            switch (_mv_1080.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type body_lst = _mv_1080.data.lst;
                                    {
                                        __auto_type body_items = body_lst.items;
                                        __auto_type body_len = ((int64_t)((body_items).len));
                                        if (body_len < 1) {
                                            ...
                                            __auto_type _mv_1081 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)(body_len - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_1081.has_value) {
                                                __auto_type ret_type = _mv_1081.value;
...
slop_option_string defn_extract_result_type_name(context_TranspileContext* ctx, types_SExpr* spec_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1084 = (*spec_expr);
        switch (_mv_1084.tag) {
            case types_SExpr_lst:
            {
                                ...
                                case types_SExpr_lst:
                                {
                                    __auto_type body_lst = _mv_1086.data.lst;
                                    {
                                        ...
                                        if (body_len < 1) {
                                            ...
                                            __auto_type _mv_1087 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)(body_len - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    ...
    SLOP_PRE(((type_expr != NULL)), "(!= type-expr nil)");
    {
        ...
        switch (_mv_1088.tag) {
            case types_SExpr_sym:
            {
                ...
                {
                    __auto_type type_name = sym.name;
                    __auto_type _mv_1089 = context_ctx_lookup_result_type_alias(ctx, type_name);
                    if (_mv_1089.has_value) {
                        __auto_type alias_result = _mv_1089.value;
                        return (slop_option_string){.has_value = 1, .value = alias_result};
                    } else if (!_mv_1089.has_value) {
                        __auto_type _mv_1090 = context_ctx_lookup_type(ctx, type_name);
                        if (_mv_1090.has_value) {
                            __auto_type entry = _mv_1090.value;
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1088.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) < 3) {
                        ...
                        __auto_type _mv_1091 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                ...
                                case types_SExpr_sym:
                                {
                                    ...
                                    if (string_eq(sym.name, SLOP_STR("Result"))) {
                                        ...
                                        if (_mv_1093.has_value) {
                                            __auto_type ok_type_expr = _mv_1093.value;
                                            ...
                                            if (_mv_1094.has_value) {
                                                __auto_type err_type_expr = _mv_1094.value;
                                                {
...
slop_string defn_build_param_str(context_TranspileContext* ctx, types_SExpr* params_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1095 = (*params_expr);
        switch (_mv_1095.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1095.data.lst;
                {
                    ...
                    while (i < len) {
                        ...
                        if (_mv_1096.has_value) {
                            __auto_type param = _mv_1096.value;
                            {
                ...
                __auto_type lst = _mv_1097.data.lst;
                {
                    ...
                    if (len < 2) {
                    ...
                    } else {
                        {
                            ...
                            __auto_type _mv_1098 = ({ __auto_type _lst = items; size_t _idx = (size_t)name_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_1098.has_value) {
                                __auto_type name_expr = _mv_1098.value;
                                __auto_type _mv_1099 = (*name_expr);
                                switch (_mv_1099.tag) {
                                    case types_SExpr_sym:
                                    {
                                        __auto_type name_sym = _mv_1099.data.sym;
                                        __auto_type _mv_1100 = ({ __auto_type _lst = items; size_t _idx = (size_t)type_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
uint8_t defn_is_param_mode(slop_list_types_SExpr_ptr items) {
    if (((int64_t)((items).len)) < 1) {
        ...
        if (_mv_1101.has_value) {
            __auto_type first = _mv_1101.value;
            __auto_type _mv_1102 = (*first);
            switch (_mv_1102.tag) {
                case types_SExpr_sym:
                {
...
uint8_t defn_is_fn_type(types_SExpr* type_expr) {
    __auto_type _mv_1103 = (*type_expr);
    switch (_mv_1103.tag) {
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1103.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 1) {
                    ...
                    if (_mv_1104.has_value) {
                        __auto_type first = _mv_1104.value;
                        __auto_type _mv_1105 = (*first);
                        switch (_mv_1105.tag) {
                            case types_SExpr_sym:
                            {
...
slop_string defn_emit_fn_param_type(context_TranspileContext* ctx, types_SExpr* type_expr, slop_string param_name) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1106 = (*type_expr);
        switch (_mv_1106.tag) {
            case types_SExpr_lst:
            {
                    ...
                    } else {
                        {
                            ...
                            if (len == 2) {
                                ...
                                if (_mv_1107.has_value) {
                                    __auto_type args_expr = _mv_1107.value;
                                    {
...
slop_string defn_build_fn_args_str_for_param(context_TranspileContext* ctx, types_SExpr* args_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1108 = (*args_expr);
        switch (_mv_1108.tag) {
            case types_SExpr_lst:
            {
                __auto_type args_list = _mv_1108.data.lst;
                {
                    ...
                    if (arg_count == 0) {
                    ...
                    } else {
                        {
                            ...
                            __auto_type i = 0;
                            while (i < arg_count) {
                                __auto_type _mv_1109 = ({ __auto_type _lst = arg_items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1109.has_value) {
                                    __auto_type arg_expr = _mv_1109.value;
                                    {
...
uint8_t defn_is_c_name_attr_at(slop_list_types_SExpr_ptr items, int64_t idx) {
    __auto_type _mv_1113 = ({ __auto_type _lst = items; size_t _idx = (size_t)idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            ...
            __auto_type lst = _mv_1127.data.lst;
            {
                ...
                if (len < 1) {
                ...
                } else {
                    {
                        ...
                        while ((i < len) && !(found)) {
                            __auto_type _mv_1130 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                ...
                __auto_type lst = _mv_1134.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) >= 2) {
                        ...
                        if (_mv_1135.has_value) {
                            __auto_type val = _mv_1135.value;
                            __auto_type _mv_1136 = (*val);
                            switch (_mv_1136.tag) {
                                case types_SExpr_str:
                                {
                                    __auto_type str = _mv_1136.data.str;
                ...
                __auto_type lst = _mv_1138.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) >= 2) {
                        ...
                        if (_mv_1139.has_value) {
                            __auto_type val = _mv_1139.value;
        ...
        while (i < len) {
            ...
            if (_mv_1140.has_value) {
                ...
                if (defn_is_pre_form(item)) {
                    __auto_type _mv_1141 = defn_get_annotation_condition(item);
                    if (_mv_1141.has_value) {
                        __auto_type cond = _mv_1141.value;
...
void defn_emit_preconditions(context_TranspileContext* ctx, slop_list_types_SExpr_ptr preconditions) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1147 = ({ __auto_type _lst = preconditions; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1147.has_value) {
                __auto_type cond_expr = _mv_1147.value;
                {
...
void defn_emit_postconditions(context_TranspileContext* ctx, slop_list_types_SExpr_ptr postconditions) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1148 = ({ __auto_type _lst = postconditions; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void defn_emit_assumptions(context_TranspileContext* ctx, slop_list_types_SExpr_ptr assumptions) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1149 = ({ __auto_type _lst = assumptions; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
