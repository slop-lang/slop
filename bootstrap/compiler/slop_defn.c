                    ...
                    case types_SExpr_lst:
                    {
                        __auto_type lst = _mv_934.data.lst;
                        {
                            ...
                            if ((((int64_t)((sub_items).len)) > 0)) {
                                __auto_type _mv_935 = ({ __auto_type _lst = sub_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_940.data.lst;
                {
                    ...
                    if ((len < 4)) {
                        ...
                        __auto_type _mv_941 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    ...
                                    __auto_type name_sym = _mv_942.data.sym;
                                    {
                                        ...
                                        if (_mv_943.has_value) {
                                            __auto_type type_expr = _mv_943.value;
                                            {
                                                ...
                                                __auto_type _mv_944 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        if (ctype_is_int_type(type_name)) {
        ...
        } else {
            {
                ...
                if (string_eq(type_name, SLOP_STR("String"))) {
                    __auto_type _mv_945 = (*value_expr);
                    switch (_mv_945.tag) {
                        case types_SExpr_str:
                        {
                            __auto_type str = _mv_945.data.str;
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_948.data.lst;
                {
                    ...
                    __auto_type len = ((int64_t)((items).len));
                    {
                        ...
                        if ((len >= (name_idx + 1))) {
                            __auto_type _mv_949 = ({ __auto_type _lst = items; size_t _idx = (size_t)name_idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
uint8_t defn_is_string_expr(slop_list_types_SExpr_ptr items, int64_t idx) {
    __auto_type _mv_951 = ({ __auto_type _lst = items; size_t _idx = (size_t)idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    if (_mv_951.has_value) {
        ...
        switch (_mv_952.tag) {
            case types_SExpr_str:
            {
                __auto_type _ = _mv_952.data.str;
                return 1;
            }
            default: {
                return 0;
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_953.data.lst;
                {
                    ...
                    if ((len < 3)) {
                        ...
                        __auto_type _mv_954 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_954.has_value) {
                            __auto_type name_expr = _mv_954.value;
                            __auto_type _mv_955 = (*name_expr);
                            switch (_mv_955.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_955.data.sym;
                                    {
                                        __auto_type raw_name = name_sym.name;
                                        __auto_type base_name = ctype_to_c_name(arena, raw_name);
                                        ...
                                        if (_mv_956.has_value) {
                                            __auto_type type_def = _mv_956.value;
        ...
        while (((i < len) && !(found))) {
            ...
            if (_mv_960.has_value) {
                ...
                switch (_mv_961.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type _ = _mv_961.data.lst;
                        found = 1;
                        break;
                    }
                    default: {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while ((i < len)) {
            ...
            if (_mv_963.has_value) {
                __auto_type field_expr = _mv_963.value;
...
void defn_emit_record_field(context_TranspileContext* ctx, slop_string raw_type_name, slop_string qualified_type_name, types_SExpr* field) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_964 = (*field);
        switch (_mv_964.tag) {
            case types_SExpr_lst:
            {
                __auto_type field_lst = _mv_964.data.lst;
                {
                    ...
                    if ((len < 2)) {
                        ...
                        if (_mv_965.has_value) {
                            ...
                            switch (_mv_966.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_966.data.sym;
                                    __auto_type _mv_967 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void defn_emit_tag_constants(context_TranspileContext* ctx, slop_string type_name, slop_list_types_SExpr_ptr items, int64_t start_idx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t tag_idx = 0;
        while ((i < len)) {
            __auto_type _mv_977 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_977.has_value) {
                __auto_type variant_expr = _mv_977.value;
                __auto_type _mv_978 = (*variant_expr);
                switch (_mv_978.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type var_lst = _mv_978.data.lst;
                        {
                            __auto_type var_items = var_lst.items;
                            if ((((int64_t)((var_items).len)) >= 1)) {
                                __auto_type _mv_979 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_979.has_value) {
                                    __auto_type tag_expr = _mv_979.value;
                                    __auto_type _mv_980 = (*tag_expr);
                                    switch (_mv_980.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type tag_sym = _mv_980.data.sym;
                                            {
                                                __auto_type tag_name = tag_sym.name;
                ...
                switch (_mv_982.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type var_lst = _mv_982.data.lst;
                        {
                            ...
                            __auto_type var_len = ((int64_t)((var_items).len));
                            if ((var_len >= 2)) {
                                __auto_type _mv_983 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_983.has_value) {
                                    ...
                                    switch (_mv_984.tag) {
                                        case types_SExpr_sym:
                                        {
                                            ...
                                            {
                                                __auto_type tag_name = tag_sym.name;
                                                __auto_type _mv_985 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_986.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    __auto_type _mv_987 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_989.data.lst;
                {
                    ...
                    if ((len < 3)) {
                        ...
                        __auto_type _mv_990 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_990.has_value) {
                            __auto_type elem_type_expr = _mv_990.value;
                            ...
                            if (_mv_991.has_value) {
                                __auto_type size_expr = _mv_991.value;
                                {
...
slop_string defn_get_number_as_string(types_SExpr* expr) {
    ...
    switch (_mv_992.tag) {
        case types_SExpr_num:
        {
            __auto_type num = _mv_992.data.num;
            return num.raw;
        }
        default: {
            return SLOP_STR("0");
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_999.data.lst;
                {
                    ...
                    if ((len < 3)) {
                        ...
                        __auto_type _mv_1000 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                ...
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_1001.data.sym;
                                    {
                                        ...
                                        if (_mv_1002.has_value) {
                                            __auto_type params_expr = _mv_1002.value;
                    ...
                    if ((len >= 2)) {
                        {
                            ...
                            __auto_type _mv_1008 = ({ __auto_type _lst = items; size_t _idx = (size_t)name_idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_list_context_FuncParamType_ptr defn_collect_param_types(context_TranspileContext* ctx, types_SExpr* params_expr) {
    ...
    SLOP_PRE(((params_expr != NULL)), "(!= params-expr nil)");
    {
        ...
        __auto_type _mv_1014 = (*params_expr);
        switch (_mv_1014.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1014.data.lst;
                {
                    ...
                    while ((i < len)) {
                        ...
                        if (_mv_1015.has_value) {
                            __auto_type param = _mv_1015.value;
                            {
        ...
        switch (_mv_1018.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1018.data.lst;
                {
                    ...
                    __auto_type len = ((int64_t)((items).len));
                    if ((len >= 3)) {
                        __auto_type _mv_1019 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_1019.has_value) {
                            ...
                            switch (_mv_1020.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_1020.data.sym;
                                    {
                                        __auto_type raw_name = name_sym.name;
                                        __auto_type base_name = ctype_to_c_name(arena, raw_name);
...
slop_string defn_extract_spec_return_type(context_TranspileContext* ctx, types_SExpr* spec_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1026 = (*spec_expr);
        switch (_mv_1026.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1026.data.lst;
                {
                    ...
                    if ((((int64_t)((items).len)) < 2)) {
                        ...
                        __auto_type _mv_1027 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_1027.has_value) {
                            __auto_type spec_body = _mv_1027.value;
                            __auto_type _mv_1028 = (*spec_body);
                            switch (_mv_1028.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type body_lst = _mv_1028.data.lst;
                                    {
                                        ...
                                        if ((body_len < 1)) {
                                            ...
                                            __auto_type _mv_1029 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)(body_len - 1); slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_1029.has_value) {
                                                __auto_type ret_type = _mv_1029.value;
...
slop_string defn_extract_spec_slop_return_type(context_TranspileContext* ctx, types_SExpr* spec_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1030 = (*spec_expr);
        switch (_mv_1030.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1030.data.lst;
                {
                    ...
                    if ((((int64_t)((items).len)) < 2)) {
                        ...
                        __auto_type _mv_1031 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1036.data.lst;
                {
                    ...
                    if ((((int64_t)((items).len)) < 2)) {
                        ...
                        __auto_type _mv_1037 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                ...
                                case types_SExpr_lst:
                                {
                                    __auto_type body_lst = _mv_1038.data.lst;
                                    {
                                        ...
                                        if ((body_len < 1)) {
                                            ...
                                            __auto_type _mv_1039 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)(body_len - 1); slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_option_string defn_check_result_type(context_TranspileContext* ctx, types_SExpr* type_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1040 = (*type_expr);
        switch (_mv_1040.tag) {
            case types_SExpr_sym:
            {
                __auto_type sym = _mv_1040.data.sym;
                {
                    __auto_type type_name = sym.name;
                    __auto_type _mv_1041 = context_ctx_lookup_result_type_alias(ctx, type_name);
                    if (_mv_1041.has_value) {
                        __auto_type alias_result = _mv_1041.value;
                        return (slop_option_string){.has_value = 1, .value = alias_result};
                    } else if (!_mv_1041.has_value) {
                        __auto_type _mv_1042 = context_ctx_lookup_type(ctx, type_name);
                        if (_mv_1042.has_value) {
                            __auto_type entry = _mv_1042.value;
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1040.data.lst;
                {
                    ...
                    if ((((int64_t)((items).len)) < 3)) {
                        ...
                        __auto_type _mv_1043 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_1043.has_value) {
                            __auto_type head = _mv_1043.value;
                            __auto_type _mv_1044 = (*head);
                            switch (_mv_1044.tag) {
                                case types_SExpr_sym:
                                {
                                    ...
                                    if (string_eq(sym.name, SLOP_STR("Result"))) {
                                        ...
                                        if (_mv_1045.has_value) {
                                            __auto_type ok_type_expr = _mv_1045.value;
                                            ...
                                            if (_mv_1046.has_value) {
                                                __auto_type err_type_expr = _mv_1046.value;
                                                {
                ...
                __auto_type lst = _mv_1049.data.lst;
                {
                    ...
                    if ((len < 2)) {
                    ...
                    } else {
                        {
                            ...
                            __auto_type _mv_1050 = ({ __auto_type _lst = items; size_t _idx = (size_t)name_idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_1050.has_value) {
                                ...
                                switch (_mv_1051.tag) {
                                    case types_SExpr_sym:
                                    {
                                        ...
                                        __auto_type _mv_1052 = ({ __auto_type _lst = items; size_t _idx = (size_t)type_idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_1052.has_value) {
                                            __auto_type type_expr = _mv_1052.value;
                                            {
...
uint8_t defn_is_param_mode(slop_list_types_SExpr_ptr items) {
    if ((((int64_t)((items).len)) < 1)) {
        ...
        __auto_type _mv_1053 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        if (_mv_1053.has_value) {
            __auto_type first = _mv_1053.value;
            __auto_type _mv_1054 = (*first);
            switch (_mv_1054.tag) {
                case types_SExpr_sym:
                {
            ...
            __auto_type lst = _mv_1055.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    if (_mv_1056.has_value) {
                        __auto_type first = _mv_1056.value;
                        __auto_type _mv_1057 = (*first);
                        switch (_mv_1057.tag) {
                            case types_SExpr_sym:
                            {
                    ...
                    } else {
                        {
                            ...
                            if ((len == 2)) {
                                ...
                                if (_mv_1059.has_value) {
                                    __auto_type args_expr = _mv_1059.value;
                                    {
...
slop_string defn_build_fn_args_str_for_param(context_TranspileContext* ctx, types_SExpr* args_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1060 = (*args_expr);
        switch (_mv_1060.tag) {
            case types_SExpr_lst:
            {
                __auto_type args_list = _mv_1060.data.lst;
                {
                    ...
                    if ((arg_count == 0)) {
                    ...
                    } else {
                        {
                            ...
                            __auto_type i = 0;
                            while ((i < arg_count)) {
                                __auto_type _mv_1061 = ({ __auto_type _lst = arg_items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1061.has_value) {
                                    __auto_type arg_expr = _mv_1061.value;
                                    {
...
uint8_t defn_is_c_name_attr_at(slop_list_types_SExpr_ptr items, int64_t idx) {
    __auto_type _mv_1065 = ({ __auto_type _lst = items; size_t _idx = (size_t)idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                ...
                __auto_type lst = _mv_1086.data.lst;
                {
                    ...
                    if ((((int64_t)((items).len)) >= 2)) {
                        ...
                        if (_mv_1087.has_value) {
                            __auto_type val = _mv_1087.value;
                            __auto_type _mv_1088 = (*val);
                            switch (_mv_1088.tag) {
                                case types_SExpr_str:
                                {
                                    __auto_type str = _mv_1088.data.str;
        ...
        switch (_mv_1090.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1090.data.lst;
                {
                    __auto_type items = lst.items;
                    if ((((int64_t)((items).len)) >= 2)) {
                        __auto_type _mv_1091 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_1091.has_value) {
                            __auto_type val = _mv_1091.value;
        ...
        while ((i < len)) {
            ...
            if (_mv_1092.has_value) {
                ...
                if (defn_is_pre_form(item)) {
                    __auto_type _mv_1093 = defn_get_annotation_condition(item);
                    if (_mv_1093.has_value) {
                        __auto_type cond = _mv_1093.value;
        ...
        while ((i < len)) {
            ...
            if (_mv_1094.has_value) {
                ...
                if (defn_is_post_form(item)) {
                    __auto_type _mv_1095 = defn_get_annotation_condition(item);
                    if (_mv_1095.has_value) {
                        __auto_type cond = _mv_1095.value;
                        ({ __auto_type _lst_p = &(result); __auto_type _item = (cond); if (_lst_p->len >= _lst_p->cap) { size_t _new_cap = _lst_p->cap == 0 ? 16 : _lst_p->cap * 2; __typeof__(_lst_p->data) _new_data = (__typeof__(_lst_p->data))slop_arena_alloc(arena, _new_cap * sizeof(*_lst_p->data)); if (_lst_p->len > 0) memcpy(_new_data, _lst_p->data, _lst_p->len * sizeof(*_lst_p->data)); _lst_p->data = _new_data; _lst_p->cap = _new_cap; } _lst_p->data[_lst_p->len++] = _item; (void)0; });
        ...
        while ((i < len)) {
            ...
            if (_mv_1096.has_value) {
                ...
                if (defn_is_assume_form(item)) {
                    __auto_type _mv_1097 = defn_get_annotation_condition(item);
                    if (_mv_1097.has_value) {
                        __auto_type cond = _mv_1097.value;
                        ({ __auto_type _lst_p = &(result); __auto_type _item = (cond); if (_lst_p->len >= _lst_p->cap) { size_t _new_cap = _lst_p->cap == 0 ? 16 : _lst_p->cap * 2; __typeof__(_lst_p->data) _new_data = (__typeof__(_lst_p->data))slop_arena_alloc(arena, _new_cap * sizeof(*_lst_p->data)); if (_lst_p->len > 0) memcpy(_new_data, _lst_p->data, _lst_p->len * sizeof(*_lst_p->data)); _lst_p->data = _new_data; _lst_p->cap = _new_cap; } _lst_p->data[_lst_p->len++] = _item; (void)0; });
...
void defn_emit_preconditions(context_TranspileContext* ctx, slop_list_types_SExpr_ptr preconditions) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1099 = ({ __auto_type _lst = preconditions; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1099.has_value) {
                __auto_type cond_expr = _mv_1099.value;
                {
...
void defn_emit_postconditions(context_TranspileContext* ctx, slop_list_types_SExpr_ptr postconditions) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1100 = ({ __auto_type _lst = postconditions; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1100.has_value) {
                __auto_type cond_expr = _mv_1100.value;
...
void defn_emit_assumptions(context_TranspileContext* ctx, slop_list_types_SExpr_ptr assumptions) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1101 = ({ __auto_type _lst = assumptions; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1101.has_value) {
                __auto_type cond_expr = _mv_1101.value;
                if (!(defn_is_verification_only_expr(cond_expr))) {
                    {
                        __auto_type cond_c = expr_transpile_expr(ctx, cond_expr);
                        __auto_type expr_str = parser_pretty_print(arena, cond_expr);
