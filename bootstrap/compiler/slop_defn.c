                    ...
                    case types_SExpr_lst:
                    {
                        __auto_type lst = _mv_985.data.lst;
                        {
                            ...
                            if (((int64_t)((sub_items).len)) > 0) {
                                __auto_type _mv_986 = ({ __auto_type _lst = sub_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_988.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 1) {
                    ...
                    __auto_type _mv_989 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_991.data.lst;
                {
                    ...
                    if (len < 4) {
                        ...
                        __auto_type _mv_992 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            ...
                            switch (_mv_993.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_993.data.sym;
                                    {
                                        ...
                                        __auto_type _mv_994 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_994.has_value) {
                                            __auto_type type_expr = _mv_994.value;
                                            {
                                                ...
                                                __auto_type _mv_995 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_995.has_value) {
                                                    __auto_type value_expr = _mv_995.value;
        ...
        if (ctype_is_int_type(type_name)) {
        ...
        } else {
            {
                ...
                if (string_eq(type_name, SLOP_STR("String"))) {
                    __auto_type _mv_996 = (*value_expr);
                    switch (_mv_996.tag) {
                        case types_SExpr_str:
                        {
                            __auto_type str = _mv_996.data.str;
...
slop_string defn_eval_const_value(context_TranspileContext* ctx, types_SExpr* expr) {
    ...
    SLOP_PRE(((expr != NULL)), "(!= expr nil)");
    {
        ...
        switch (_mv_998.tag) {
            ...
            case types_SExpr_str:
            {
                __auto_type str = _mv_998.data.str;
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_999.data.lst;
                {
                    ...
                    __auto_type len = ((int64_t)((items).len));
                    {
                        ...
                        if (len >= (name_idx + 1)) {
                            __auto_type _mv_1000 = ({ __auto_type _lst = items; size_t _idx = (size_t)name_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
uint8_t defn_is_string_expr(slop_list_types_SExpr_ptr items, int64_t idx) {
    __auto_type _mv_1002 = ({ __auto_type _lst = items; size_t _idx = (size_t)idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    if (_mv_1002.has_value) {
        ...
        switch (_mv_1003.tag) {
            case types_SExpr_str:
            {
                __auto_type _ = _mv_1003.data.str;
                return 1;
            }
            default: {
                return 0;
                                ...
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_1006.data.sym;
                                    {
                                        ...
                                        if (_mv_1007.has_value) {
                                            __auto_type type_def = _mv_1007.value;
...
void defn_dispatch_type_def(context_TranspileContext* ctx, slop_string raw_name, slop_string qualified_name, types_SExpr* type_def) {
    ...
    __auto_type _mv_1008 = (*type_def);
    switch (_mv_1008.tag) {
        case types_SExpr_lst:
        {
            __auto_type def_lst = _mv_1008.data.lst;
            {
...
uint8_t defn_has_payload_variants(slop_list_types_SExpr_ptr items) {
    {
        ...
        while ((i < len) && !(found)) {
            ...
            if (_mv_1011.has_value) {
                ...
                __auto_type _mv_1012 = (*item);
                switch (_mv_1012.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type _ = _mv_1012.data.lst;
                        found = 1;
                        break;
                    }
                    default: {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_1014.has_value) {
                __auto_type field_expr = _mv_1014.value;
...
void defn_emit_record_field(context_TranspileContext* ctx, slop_string raw_type_name, slop_string qualified_type_name, types_SExpr* field) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1015 = (*field);
        switch (_mv_1015.tag) {
            case types_SExpr_lst:
            {
                __auto_type field_lst = _mv_1015.data.lst;
                {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_1020.has_value) {
                __auto_type val_expr = _mv_1020.value;
                __auto_type _mv_1021 = (*val_expr);
                switch (_mv_1021.tag) {
                    case types_SExpr_sym:
                    {
                                    ...
                                    switch (_mv_1026.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type tag_sym = _mv_1026.data.sym;
                                            {
                                                ...
                                                if (var_len == 2) {
                                                    __auto_type _mv_1027 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_1027.has_value) {
                                                        __auto_type type_expr = _mv_1027.value;
                                                        {
                                                            __auto_type c_type = context_to_c_type_prefixed(ctx, type_expr);
                                                            {
                                                    ...
                                                    for (int64_t fi = 1; fi < var_len; fi++) {
                                                        __auto_type _mv_1028 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)fi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                        if (_mv_1028.has_value) {
                                                            __auto_type type_expr = _mv_1028.value;
                                                            {
                                                                __auto_type c_type = context_to_c_type_prefixed(ctx, type_expr);
                                                                {
                                                                    __auto_type actual_type = ((string_eq(c_type, SLOP_STR("void"))) ? SLOP_STR("int") : c_type);
                                    ...
                                    switch (_mv_1036.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type tag_sym = _mv_1036.data.sym;
                                            {
                                                __auto_type tag_name = tag_sym.name;
                                                if (var_len == 2) {
                                                    __auto_type _mv_1037 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_1037.has_value) {
                                                        __auto_type type_expr = _mv_1037.value;
                                                        {
                                                            __auto_type c_type = context_to_c_type_prefixed(ctx, type_expr);
                                                            __auto_type slop_type_str = parser_pretty_print(arena, type_expr);
                                                            __auto_type is_ptr = defn_is_pointer_type_expr(type_expr);
                                                    ...
                                                    for (int64_t fi = 1; fi < var_len; fi++) {
                                                        __auto_type _mv_1038 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)fi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    ...
                                                    __auto_type _mv_1039 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                ...
                __auto_type lst = _mv_1043.data.lst;
                {
                    ...
                    if (len < 3) {
                        ...
                        if (_mv_1044.has_value) {
                            __auto_type elem_type_expr = _mv_1044.value;
                            __auto_type _mv_1045 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_1045.has_value) {
                                __auto_type size_expr = _mv_1045.value;
                                {
                    ...
                    while (i < len) {
                        ...
                        if (_mv_1051.has_value) {
                            ...
                            switch (_mv_1052.tag) {
                                case types_SExpr_num:
                                {
                                    __auto_type num = _mv_1052.data.num;
                                    if (!(found_dots)) {
...
void defn_bind_params_to_scope(context_TranspileContext* ctx, types_SExpr* params_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1059 = (*params_expr);
        switch (_mv_1059.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1059.data.lst;
                {
                    ...
                    while (i < len) {
                        ...
                        if (_mv_1060.has_value) {
                            __auto_type param = _mv_1060.value;
                    ...
                    if (len >= 2) {
                        {
                            ...
                            __auto_type _mv_1062 = ({ __auto_type _lst = items; size_t _idx = (size_t)name_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_1062.has_value) {
                                ...
                                switch (_mv_1063.tag) {
                                    case types_SExpr_sym:
                                    {
                                        __auto_type name_sym = _mv_1063.data.sym;
                                        __auto_type _mv_1064 = ({ __auto_type _lst = items; size_t _idx = (size_t)type_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_list_context_FuncParamType_ptr defn_collect_param_types(context_TranspileContext* ctx, types_SExpr* params_expr) {
    ...
    SLOP_PRE(((params_expr != NULL)), "(!= params-expr nil)");
    {
        ...
        __auto_type _mv_1068 = (*params_expr);
        switch (_mv_1068.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1068.data.lst;
                {
                    ...
                    while (i < len) {
                        ...
                        if (_mv_1069.has_value) {
                            __auto_type param = _mv_1069.value;
                            {
                ...
                __auto_type lst = _mv_1070.data.lst;
                {
                    ...
                    if (len < 2) {
                    ...
                    } else {
                        {
                            __auto_type has_mode = ((len >= 3) && defn_is_param_mode(items));
                            __auto_type type_idx = ((has_mode) ? 2 : 1);
                            __auto_type _mv_1071 = ({ __auto_type _lst = items; size_t _idx = (size_t)type_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_1071.has_value) {
                                __auto_type type_expr = _mv_1071.value;
        ...
        switch (_mv_1072.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1072.data.lst;
                {
                    ...
                    __auto_type len = ((int64_t)((items).len));
                    if (len >= 3) {
                        __auto_type _mv_1073 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            ...
                            switch (_mv_1074.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_1074.data.sym;
                                    {
                                        ...
                                        __auto_type _mv_1075 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_1075.has_value) {
                                            __auto_type params_expr = _mv_1075.value;
                                            {
                                                __auto_type result_type_opt = defn_get_result_type_name(ctx, items);
                                                __auto_type raw_return = defn_get_return_type(ctx, items);
                                                {
...
slop_string defn_get_return_type(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            __auto_type _mv_1076 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_option_string defn_extract_result_type_name(context_TranspileContext* ctx, types_SExpr* spec_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1090 = (*spec_expr);
        switch (_mv_1090.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1090.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) < 2) {
                        ...
                        if (_mv_1091.has_value) {
                            __auto_type spec_body = _mv_1091.value;
                            __auto_type _mv_1092 = (*spec_body);
                            switch (_mv_1092.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type body_lst = _mv_1092.data.lst;
                                    {
                                        __auto_type body_items = body_lst.items;
                                        __auto_type body_len = ((int64_t)((body_items).len));
                                        if (body_len < 1) {
                                            ...
                                            __auto_type _mv_1093 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)(body_len - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_1093.has_value) {
                                                __auto_type ret_type = _mv_1093.value;
...
slop_option_string defn_check_result_type(context_TranspileContext* ctx, types_SExpr* type_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1094 = (*type_expr);
        switch (_mv_1094.tag) {
            case types_SExpr_sym:
            {
                ...
                {
                    __auto_type type_name = sym.name;
                    __auto_type _mv_1095 = context_ctx_lookup_result_type_alias(ctx, type_name);
                    if (_mv_1095.has_value) {
                        __auto_type alias_result = _mv_1095.value;
                        return (slop_option_string){.has_value = 1, .value = alias_result};
                    } else if (!_mv_1095.has_value) {
                        __auto_type _mv_1096 = context_ctx_lookup_type(ctx, type_name);
                        if (_mv_1096.has_value) {
                            __auto_type entry = _mv_1096.value;
                            ...
                            switch (_mv_1098.tag) {
                                case types_SExpr_sym:
                                {
                                    ...
                                    if (string_eq(sym.name, SLOP_STR("Result"))) {
                                        __auto_type _mv_1099 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_1099.has_value) {
                                            __auto_type ok_type_expr = _mv_1099.value;
                                            __auto_type _mv_1100 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_1100.has_value) {
                                                __auto_type err_type_expr = _mv_1100.value;
                                                {
...
slop_string defn_build_param_str(context_TranspileContext* ctx, types_SExpr* params_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1101 = (*params_expr);
        switch (_mv_1101.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1101.data.lst;
                {
                    ...
                    while (i < len) {
                        ...
                        if (_mv_1102.has_value) {
                            __auto_type param = _mv_1102.value;
                            {
                ...
                __auto_type lst = _mv_1103.data.lst;
                {
                    ...
                    if (len < 2) {
                    ...
                    } else {
                        {
                            ...
                            __auto_type _mv_1104 = ({ __auto_type _lst = items; size_t _idx = (size_t)name_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_1104.has_value) {
                                __auto_type name_expr = _mv_1104.value;
                                __auto_type _mv_1105 = (*name_expr);
                                switch (_mv_1105.tag) {
                                    case types_SExpr_sym:
                                    {
                                        __auto_type name_sym = _mv_1105.data.sym;
                                        __auto_type _mv_1106 = ({ __auto_type _lst = items; size_t _idx = (size_t)type_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_1106.has_value) {
                                            __auto_type type_expr = _mv_1106.value;
                                            {
...
uint8_t defn_is_param_mode(slop_list_types_SExpr_ptr items) {
    if (((int64_t)((items).len)) < 1) {
        ...
        if (_mv_1107.has_value) {
            __auto_type first = _mv_1107.value;
            __auto_type _mv_1108 = (*first);
            switch (_mv_1108.tag) {
                case types_SExpr_sym:
                {
...
uint8_t defn_is_fn_type(types_SExpr* type_expr) {
    __auto_type _mv_1109 = (*type_expr);
    switch (_mv_1109.tag) {
        case types_SExpr_lst:
        {
                    ...
                    } else {
                        {
                            ...
                            if (len == 2) {
                                ...
                                if (_mv_1113.has_value) {
                                    __auto_type args_expr = _mv_1113.value;
                                    {
...
slop_string defn_build_fn_args_str_for_param(context_TranspileContext* ctx, types_SExpr* args_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1114 = (*args_expr);
        switch (_mv_1114.tag) {
            case types_SExpr_lst:
            {
                __auto_type args_list = _mv_1114.data.lst;
                {
                    ...
                    if (arg_count == 0) {
                    ...
                    } else {
                        {
                            ...
                            __auto_type i = 0;
                            while (i < arg_count) {
                                __auto_type _mv_1115 = ({ __auto_type _lst = arg_items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1115.has_value) {
                                    __auto_type arg_expr = _mv_1115.value;
                                    {
...
uint8_t defn_is_c_name_attr_at(slop_list_types_SExpr_ptr items, int64_t idx) {
    __auto_type _mv_1119 = ({ __auto_type _lst = items; size_t _idx = (size_t)idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                ...
                __auto_type lst = _mv_1140.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) >= 2) {
                        ...
                        if (_mv_1141.has_value) {
                            ...
                            __auto_type _mv_1142 = (*val);
                            switch (_mv_1142.tag) {
                                case types_SExpr_str:
                                {
                                    __auto_type str = _mv_1142.data.str;
        ...
        while (i < len) {
            ...
            if (_mv_1148.has_value) {
                ...
                if (defn_is_post_form(item)) {
                    __auto_type _mv_1149 = defn_get_annotation_condition(item);
                    if (_mv_1149.has_value) {
                        __auto_type cond = _mv_1149.value;
                        ({ __auto_type _lst_p = &(result); __auto_type _item = (cond); if (_lst_p->len >= _lst_p->cap) { size_t _new_cap = _lst_p->cap == 0 ? 16 : _lst_p->cap * 2; __typeof__(_lst_p->data) _new_data = (__typeof__(_lst_p->data))slop_arena_alloc(arena, _new_cap * sizeof(*_lst_p->data)); if (_lst_p->len > 0) memcpy(_new_data, _lst_p->data, _lst_p->len * sizeof(*_lst_p->data)); _lst_p->data = _new_data; _lst_p->cap = _new_cap; } _lst_p->data[_lst_p->len++] = _item; (void)0; });
...
void defn_emit_preconditions(context_TranspileContext* ctx, slop_list_types_SExpr_ptr preconditions) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1153 = ({ __auto_type _lst = preconditions; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1153.has_value) {
                __auto_type cond_expr = _mv_1153.value;
                {
...
void defn_emit_postconditions(context_TranspileContext* ctx, slop_list_types_SExpr_ptr postconditions) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1154 = ({ __auto_type _lst = postconditions; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1154.has_value) {
                __auto_type cond_expr = _mv_1154.value;
...
void defn_emit_assumptions(context_TranspileContext* ctx, slop_list_types_SExpr_ptr assumptions) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1155 = ({ __auto_type _lst = assumptions; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1155.has_value) {
                __auto_type cond_expr = _mv_1155.value;
                if (!(defn_is_verification_only_expr(cond_expr))) {
                    {
                        __auto_type cond_c = expr_transpile_expr(ctx, cond_expr);
                        __auto_type expr_str = parser_pretty_print(arena, cond_expr);
