                    ...
                    case types_SExpr_lst:
                    {
                        __auto_type lst = _mv_973.data.lst;
                        {
                            ...
                            if (((int64_t)((sub_items).len)) > 0) {
                                __auto_type _mv_974 = ({ __auto_type _lst = sub_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_979.data.lst;
                {
                    ...
                    if (len < 4) {
                        ...
                        __auto_type _mv_980 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        ...
                                        if (_mv_982.has_value) {
                                            __auto_type type_expr = _mv_982.value;
                                            {
                                                ...
                                                if (_mv_983.has_value) {
                                                    __auto_type value_expr = _mv_983.value;
        ...
        if (ctype_is_int_type(type_name)) {
        ...
        } else {
            {
                ...
                if (string_eq(type_name, SLOP_STR("String"))) {
                    __auto_type _mv_984 = (*value_expr);
                    switch (_mv_984.tag) {
                        case types_SExpr_str:
                        {
                            __auto_type str = _mv_984.data.str;
...
slop_string defn_eval_const_value(context_TranspileContext* ctx, types_SExpr* expr) {
    ...
    SLOP_PRE(((expr != NULL)), "(!= expr nil)");
    {
        ...
        switch (_mv_986.tag) {
            ...
            {
                __auto_type num = _mv_986.data.num;
                return num.raw;
            }
            case types_SExpr_str:
            {
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_987.data.lst;
                {
                    ...
                    __auto_type len = ((int64_t)((items).len));
                    {
                        ...
                        if (len >= (name_idx + 1)) {
                            __auto_type _mv_988 = ({ __auto_type _lst = items; size_t _idx = (size_t)name_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
uint8_t defn_is_string_expr(slop_list_types_SExpr_ptr items, int64_t idx) {
    __auto_type _mv_990 = ({ __auto_type _lst = items; size_t _idx = (size_t)idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    if (_mv_990.has_value) {
        ...
        switch (_mv_991.tag) {
            case types_SExpr_str:
            {
                __auto_type _ = _mv_991.data.str;
                return 1;
            }
            default: {
                return 0;
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_992.data.lst;
                {
                    ...
                    if (len < 3) {
                        ...
                        __auto_type _mv_993 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                ...
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_994.data.sym;
                                    {
                                        ...
                                        if (_mv_995.has_value) {
                                            __auto_type type_def = _mv_995.value;
...
void defn_dispatch_type_def(context_TranspileContext* ctx, slop_string raw_name, slop_string qualified_name, types_SExpr* type_def) {
    ...
    __auto_type _mv_996 = (*type_def);
    switch (_mv_996.tag) {
        case types_SExpr_lst:
        {
            __auto_type def_lst = _mv_996.data.lst;
            {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_1002.has_value) {
                __auto_type field_expr = _mv_1002.value;
...
void defn_emit_record_field(context_TranspileContext* ctx, slop_string raw_type_name, slop_string qualified_type_name, types_SExpr* field) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1003 = (*field);
        switch (_mv_1003.tag) {
            case types_SExpr_lst:
            {
                __auto_type field_lst = _mv_1003.data.lst;
                {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_1008.has_value) {
                __auto_type val_expr = _mv_1008.value;
                __auto_type _mv_1009 = (*val_expr);
                switch (_mv_1009.tag) {
                    case types_SExpr_sym:
                    {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_1021.has_value) {
                __auto_type variant_expr = _mv_1021.value;
                __auto_type _mv_1022 = (*variant_expr);
                switch (_mv_1022.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type var_lst = _mv_1022.data.lst;
                        {
                            __auto_type var_items = var_lst.items;
                            __auto_type var_len = ((int64_t)((var_items).len));
                            if (var_len >= 2) {
                                __auto_type _mv_1023 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1023.has_value) {
                                    __auto_type tag_expr = _mv_1023.value;
                                    __auto_type _mv_1024 = (*tag_expr);
                                    switch (_mv_1024.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type tag_sym = _mv_1024.data.sym;
                                            {
                                                __auto_type tag_name = tag_sym.name;
                                                if (var_len == 2) {
                                                    __auto_type _mv_1025 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_1025.has_value) {
                                                        __auto_type type_expr = _mv_1025.value;
                                                        {
                                                            __auto_type c_type = context_to_c_type_prefixed(ctx, type_expr);
                                                            __auto_type slop_type_str = parser_pretty_print(arena, type_expr);
                                                            __auto_type is_ptr = defn_is_pointer_type_expr(type_expr);
                                                    ...
                                                    for (int64_t fi = 1; fi < var_len; fi++) {
                                                        __auto_type _mv_1026 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)fi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                        if (_mv_1026.has_value) {
                                                            __auto_type type_expr = _mv_1026.value;
                                                            {
                                                                __auto_type c_type = context_to_c_type_prefixed(ctx, type_expr);
                                                                __auto_type slop_type_str = parser_pretty_print(arena, type_expr);
                                                                __auto_type is_ptr = defn_is_pointer_type_expr(type_expr);
                ...
                __auto_type lst = _mv_1031.data.lst;
                {
                    ...
                    if (len < 3) {
                        ...
                        if (_mv_1032.has_value) {
                            __auto_type elem_type_expr = _mv_1032.value;
                            __auto_type _mv_1033 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_1033.has_value) {
                                __auto_type size_expr = _mv_1033.value;
                                {
...
slop_string defn_get_number_as_string(types_SExpr* expr) {
    ...
    switch (_mv_1034.tag) {
        case types_SExpr_num:
        {
            __auto_type num = _mv_1034.data.num;
            return num.raw;
        }
        default: {
            return SLOP_STR("0");
                                ...
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_1043.data.sym;
                                    {
                                        ...
                                        if (_mv_1044.has_value) {
                                            __auto_type params_expr = _mv_1044.value;
                    ...
                    if (len >= 2) {
                        {
                            ...
                            __auto_type _mv_1050 = ({ __auto_type _lst = items; size_t _idx = (size_t)name_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    ...
                    if (len >= 3) {
                        ...
                        if (_mv_1061.has_value) {
                            ...
                            switch (_mv_1062.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_1062.data.sym;
                                    {
                                        __auto_type raw_name = name_sym.name;
                                        __auto_type base_name = ctype_to_c_name(arena, raw_name);
                                        ...
                                        __auto_type _mv_1063 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_1063.has_value) {
                                            __auto_type params_expr = _mv_1063.value;
                                            {
                                                __auto_type result_type_opt = defn_get_result_type_name(ctx, items);
                                                __auto_type raw_return = defn_get_return_type(ctx, items);
                                                {
...
slop_string defn_extract_spec_slop_return_type(context_TranspileContext* ctx, types_SExpr* spec_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1072 = (*spec_expr);
        switch (_mv_1072.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1072.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) < 2) {
                        ...
                        if (_mv_1073.has_value) {
                            ...
                            __auto_type _mv_1074 = (*spec_body);
                            switch (_mv_1074.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type body_lst = _mv_1074.data.lst;
                                    {
                                        __auto_type body_items = body_lst.items;
                                        __auto_type body_len = ((int64_t)((body_items).len));
                                        if (body_len < 1) {
                                            ...
                                            __auto_type _mv_1075 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)(body_len - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_1075.has_value) {
                                                __auto_type ret_type = _mv_1075.value;
    ...
    SLOP_PRE(((type_expr != NULL)), "(!= type-expr nil)");
    {
        ...
        switch (_mv_1082.tag) {
            case types_SExpr_sym:
            {
                ...
                {
                    __auto_type type_name = sym.name;
                    __auto_type _mv_1083 = context_ctx_lookup_result_type_alias(ctx, type_name);
                    if (_mv_1083.has_value) {
                        __auto_type alias_result = _mv_1083.value;
                        return (slop_option_string){.has_value = 1, .value = alias_result};
                    } else if (!_mv_1083.has_value) {
                        __auto_type _mv_1084 = context_ctx_lookup_type(ctx, type_name);
                        if (_mv_1084.has_value) {
                            __auto_type entry = _mv_1084.value;
                                ...
                                case types_SExpr_sym:
                                {
                                    ...
                                    if (string_eq(sym.name, SLOP_STR("Result"))) {
                                        ...
                                        if (_mv_1087.has_value) {
                                            ...
                                            __auto_type _mv_1088 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_string defn_build_param_str(context_TranspileContext* ctx, types_SExpr* params_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1089 = (*params_expr);
        switch (_mv_1089.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1089.data.lst;
                {
                    ...
                    while (i < len) {
                        ...
                        if (_mv_1090.has_value) {
                            __auto_type param = _mv_1090.value;
                            {
                ...
                __auto_type lst = _mv_1091.data.lst;
                {
                    ...
                    if (len < 2) {
                    ...
                    } else {
                        {
                            ...
                            __auto_type _mv_1092 = ({ __auto_type _lst = items; size_t _idx = (size_t)name_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_1092.has_value) {
                                ...
                                switch (_mv_1093.tag) {
                                    case types_SExpr_sym:
                                    {
                                        ...
                                        __auto_type _mv_1094 = ({ __auto_type _lst = items; size_t _idx = (size_t)type_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
uint8_t defn_is_param_mode(slop_list_types_SExpr_ptr items) {
    if (((int64_t)((items).len)) < 1) {
        ...
        if (_mv_1095.has_value) {
            __auto_type first = _mv_1095.value;
            __auto_type _mv_1096 = (*first);
            switch (_mv_1096.tag) {
                case types_SExpr_sym:
                {
            ...
            __auto_type lst = _mv_1097.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 1) {
                    ...
                    if (_mv_1098.has_value) {
                        __auto_type first = _mv_1098.value;
                        __auto_type _mv_1099 = (*first);
                        switch (_mv_1099.tag) {
                            case types_SExpr_sym:
                            {
...
slop_string defn_emit_fn_param_type(context_TranspileContext* ctx, types_SExpr* type_expr, slop_string param_name) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1100 = (*type_expr);
        switch (_mv_1100.tag) {
            case types_SExpr_lst:
            {
                    ...
                    } else {
                        {
                            ...
                            if (len == 2) {
                                ...
                                if (_mv_1101.has_value) {
                                    __auto_type args_expr = _mv_1101.value;
                                    {
...
slop_string defn_build_fn_args_str_for_param(context_TranspileContext* ctx, types_SExpr* args_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1102 = (*args_expr);
        switch (_mv_1102.tag) {
            case types_SExpr_lst:
            {
                __auto_type args_list = _mv_1102.data.lst;
                {
                    ...
                    if (arg_count == 0) {
                    ...
                    } else {
                        {
                            ...
                            __auto_type i = 0;
                            while (i < arg_count) {
                                __auto_type _mv_1103 = ({ __auto_type _lst = arg_items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1103.has_value) {
                                    __auto_type arg_expr = _mv_1103.value;
                                    {
...
uint8_t defn_is_c_name_attr_at(slop_list_types_SExpr_ptr items, int64_t idx) {
    __auto_type _mv_1107 = ({ __auto_type _lst = items; size_t _idx = (size_t)idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                ...
                __auto_type lst = _mv_1128.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) >= 2) {
                        ...
                        if (_mv_1129.has_value) {
                            __auto_type val = _mv_1129.value;
                            __auto_type _mv_1130 = (*val);
                            switch (_mv_1130.tag) {
                                case types_SExpr_str:
                                {
                                    __auto_type str = _mv_1130.data.str;
                ...
                __auto_type lst = _mv_1132.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) >= 2) {
                        ...
                        if (_mv_1133.has_value) {
                            __auto_type val = _mv_1133.value;
        ...
        while (i < len) {
            ...
            if (_mv_1134.has_value) {
                ...
                if (defn_is_pre_form(item)) {
                    __auto_type _mv_1135 = defn_get_annotation_condition(item);
                    if (_mv_1135.has_value) {
                        __auto_type cond = _mv_1135.value;
...
void defn_emit_preconditions(context_TranspileContext* ctx, slop_list_types_SExpr_ptr preconditions) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1141 = ({ __auto_type _lst = preconditions; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1141.has_value) {
                __auto_type cond_expr = _mv_1141.value;
                {
...
void defn_emit_postconditions(context_TranspileContext* ctx, slop_list_types_SExpr_ptr postconditions) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1142 = ({ __auto_type _lst = postconditions; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1142.has_value) {
                __auto_type cond_expr = _mv_1142.value;
...
void defn_emit_assumptions(context_TranspileContext* ctx, slop_list_types_SExpr_ptr assumptions) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1143 = ({ __auto_type _lst = assumptions; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
