                    ...
                    case types_SExpr_lst:
                    {
                        __auto_type lst = _mv_975.data.lst;
                        {
                            ...
                            if (((int64_t)((sub_items).len)) > 0) {
                                __auto_type _mv_976 = ({ __auto_type _lst = sub_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            ...
                            switch (_mv_983.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_983.data.sym;
                                    {
                                        ...
                                        __auto_type _mv_984 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_984.has_value) {
                                            __auto_type type_expr = _mv_984.value;
                                            {
                                                ...
                                                __auto_type _mv_985 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_985.has_value) {
                                                    __auto_type value_expr = _mv_985.value;
        ...
        if (ctype_is_int_type(type_name)) {
        ...
        } else {
            {
                ...
                if (string_eq(type_name, SLOP_STR("String"))) {
                    __auto_type _mv_986 = (*value_expr);
                    switch (_mv_986.tag) {
...
slop_string defn_eval_const_value(context_TranspileContext* ctx, types_SExpr* expr) {
    ...
    SLOP_PRE(((expr != NULL)), "(!= expr nil)");
    {
        ...
        switch (_mv_988.tag) {
            ...
            {
                __auto_type num = _mv_988.data.num;
                return num.raw;
            }
            case types_SExpr_str:
            {
                __auto_type str = _mv_988.data.str;
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_989.data.lst;
                {
                    ...
                    __auto_type len = ((int64_t)((items).len));
                    {
                        ...
                        if (len >= (name_idx + 1)) {
                            __auto_type _mv_990 = ({ __auto_type _lst = items; size_t _idx = (size_t)name_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
uint8_t defn_is_string_expr(slop_list_types_SExpr_ptr items, int64_t idx) {
    __auto_type _mv_992 = ({ __auto_type _lst = items; size_t _idx = (size_t)idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    if (_mv_992.has_value) {
        ...
        switch (_mv_993.tag) {
            case types_SExpr_str:
            {
                __auto_type _ = _mv_993.data.str;
                return 1;
            }
            default: {
                return 0;
                                ...
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_996.data.sym;
                                    {
                                        ...
                                        if (_mv_997.has_value) {
                                            __auto_type type_def = _mv_997.value;
...
void defn_dispatch_type_def(context_TranspileContext* ctx, slop_string raw_name, slop_string qualified_name, types_SExpr* type_def) {
    ...
    __auto_type _mv_998 = (*type_def);
    switch (_mv_998.tag) {
        case types_SExpr_lst:
        {
            __auto_type def_lst = _mv_998.data.lst;
            {
        ...
        while ((i < len) && !(found)) {
            ...
            if (_mv_1001.has_value) {
                ...
                switch (_mv_1002.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type _ = _mv_1002.data.lst;
                        found = 1;
                        break;
                    }
                    default: {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_1004.has_value) {
                __auto_type field_expr = _mv_1004.value;
...
void defn_emit_record_field(context_TranspileContext* ctx, slop_string raw_type_name, slop_string qualified_type_name, types_SExpr* field) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1005 = (*field);
        switch (_mv_1005.tag) {
            case types_SExpr_lst:
            {
                __auto_type field_lst = _mv_1005.data.lst;
                {
                    ...
                    if (len < 2) {
                        ...
                        __auto_type _mv_1006 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_1010.has_value) {
                __auto_type val_expr = _mv_1010.value;
                __auto_type _mv_1011 = (*val_expr);
                switch (_mv_1011.tag) {
                    case types_SExpr_sym:
                    {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_1013.has_value) {
                __auto_type variant_expr = _mv_1013.value;
                __auto_type _mv_1014 = (*variant_expr);
                switch (_mv_1014.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type var_lst = _mv_1014.data.lst;
                        {
                            __auto_type var_items = var_lst.items;
                            __auto_type var_len = ((int64_t)((var_items).len));
                            if (var_len >= 1) {
                                __auto_type _mv_1015 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1015.has_value) {
                                    __auto_type tag_expr = _mv_1015.value;
                                    __auto_type _mv_1016 = (*tag_expr);
                                    switch (_mv_1016.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type tag_sym = _mv_1016.data.sym;
                                            {
                                                ...
                                                if (var_len == 2) {
                                                    ...
                                                    for (int64_t fi = 1; fi < var_len; fi++) {
                                                        __auto_type _mv_1018 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)fi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        ...
                                        case types_SExpr_sym:
                                        {
                                            __auto_type tag_sym = _mv_1026.data.sym;
                                            {
                                                ...
                                                if (var_len == 2) {
                                                    ...
                                                    __auto_type _mv_1029 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
uint8_t defn_is_array_type(types_SExpr* type_expr) {
    SLOP_PRE(((type_expr != NULL)), "(!= type-expr nil)");
    __auto_type _mv_1030 = (*type_expr);
    switch (_mv_1030.tag) {
        case types_SExpr_lst:
        {
                ...
                __auto_type lst = _mv_1033.data.lst;
                {
                    ...
                    if (len < 3) {
                        ...
                        if (_mv_1034.has_value) {
                            __auto_type elem_type_expr = _mv_1034.value;
                            ...
                            if (_mv_1035.has_value) {
                                __auto_type size_expr = _mv_1035.value;
                                {
...
slop_string defn_get_number_as_string(types_SExpr* expr) {
    ...
    switch (_mv_1036.tag) {
        case types_SExpr_num:
        {
            __auto_type num = _mv_1036.data.num;
            return num.raw;
        }
        default: {
            return SLOP_STR("0");
                            ...
                            switch (_mv_1045.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_1045.data.sym;
                                    {
                                        ...
                                        __auto_type _mv_1046 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_1046.has_value) {
                                            __auto_type params_expr = _mv_1046.value;
                    ...
                    if (len >= 2) {
                        {
                            ...
                            __auto_type _mv_1052 = ({ __auto_type _lst = items; size_t _idx = (size_t)name_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_1052.has_value) {
                                ...
                                switch (_mv_1053.tag) {
                                    case types_SExpr_sym:
                                    {
                                        ...
                                        __auto_type _mv_1054 = ({ __auto_type _lst = items; size_t _idx = (size_t)type_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_1054.has_value) {
                                            __auto_type type_expr = _mv_1054.value;
                                            {
...
slop_list_context_FuncParamType_ptr defn_collect_param_types(context_TranspileContext* ctx, types_SExpr* params_expr) {
    ...
    SLOP_PRE(((params_expr != NULL)), "(!= params-expr nil)");
    {
        ...
        __auto_type _mv_1058 = (*params_expr);
        switch (_mv_1058.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1058.data.lst;
                {
                    ...
                    while (i < len) {
                        ...
                        if (_mv_1059.has_value) {
                            __auto_type param = _mv_1059.value;
                            {
                ...
                __auto_type lst = _mv_1060.data.lst;
                {
                    ...
                    if (len < 2) {
                    ...
                    } else {
                        {
                            __auto_type has_mode = ((len >= 3) && defn_is_param_mode(items));
                            __auto_type type_idx = ((has_mode) ? 2 : 1);
                            __auto_type _mv_1061 = ({ __auto_type _lst = items; size_t _idx = (size_t)type_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                ...
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_1064.data.sym;
                                    {
                                        ...
                                        if (_mv_1065.has_value) {
                                            __auto_type params_expr = _mv_1065.value;
                                            {
                                                __auto_type result_type_opt = defn_get_result_type_name(ctx, items);
                                                __auto_type raw_return = defn_get_return_type(ctx, items);
                                                {
...
slop_string defn_extract_spec_return_type(context_TranspileContext* ctx, types_SExpr* spec_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1070 = (*spec_expr);
        switch (_mv_1070.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1070.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) < 2) {
                        ...
                        if (_mv_1071.has_value) {
                            __auto_type spec_body = _mv_1071.value;
                            __auto_type _mv_1072 = (*spec_body);
                            switch (_mv_1072.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type body_lst = _mv_1072.data.lst;
                                    {
                                        ...
                                        if (body_len < 1) {
                                            ...
                                            __auto_type _mv_1073 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)(body_len - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_1073.has_value) {
                                                __auto_type ret_type = _mv_1073.value;
    ...
    SLOP_PRE(((type_expr != NULL)), "(!= type-expr nil)");
    {
        ...
        switch (_mv_1084.tag) {
            case types_SExpr_sym:
            {
                ...
                {
                    __auto_type type_name = sym.name;
                    __auto_type _mv_1085 = context_ctx_lookup_result_type_alias(ctx, type_name);
                    if (_mv_1085.has_value) {
                        __auto_type alias_result = _mv_1085.value;
                        return (slop_option_string){.has_value = 1, .value = alias_result};
                    } else if (!_mv_1085.has_value) {
                        __auto_type _mv_1086 = context_ctx_lookup_type(ctx, type_name);
                        if (_mv_1086.has_value) {
                            __auto_type entry = _mv_1086.value;
                                ...
                                case types_SExpr_sym:
                                {
                                    ...
                                    if (string_eq(sym.name, SLOP_STR("Result"))) {
                                        ...
                                        if (_mv_1089.has_value) {
                                            __auto_type ok_type_expr = _mv_1089.value;
                                            __auto_type _mv_1090 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_1090.has_value) {
                                                __auto_type err_type_expr = _mv_1090.value;
                                                {
                ...
                __auto_type lst = _mv_1091.data.lst;
                {
                    ...
                    while (i < len) {
                        ...
                        if (_mv_1092.has_value) {
                            __auto_type param = _mv_1092.value;
                            {
                ...
                __auto_type lst = _mv_1093.data.lst;
                {
                    ...
                    if (len < 2) {
                    ...
                    } else {
                        {
                            ...
                            __auto_type _mv_1094 = ({ __auto_type _lst = items; size_t _idx = (size_t)name_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_1094.has_value) {
                                ...
                                switch (_mv_1095.tag) {
                                    case types_SExpr_sym:
                                    {
                                        __auto_type name_sym = _mv_1095.data.sym;
                                        __auto_type _mv_1096 = ({ __auto_type _lst = items; size_t _idx = (size_t)type_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_1096.has_value) {
                                            __auto_type type_expr = _mv_1096.value;
                                            {
...
uint8_t defn_is_param_mode(slop_list_types_SExpr_ptr items) {
    if (((int64_t)((items).len)) < 1) {
        ...
        if (_mv_1097.has_value) {
            __auto_type first = _mv_1097.value;
            __auto_type _mv_1098 = (*first);
            switch (_mv_1098.tag) {
                case types_SExpr_sym:
                {
            ...
            __auto_type lst = _mv_1099.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 1) {
                    ...
                    if (_mv_1100.has_value) {
                        __auto_type first = _mv_1100.value;
                        __auto_type _mv_1101 = (*first);
                        switch (_mv_1101.tag) {
                            case types_SExpr_sym:
                            {
                    ...
                    } else {
                        {
                            ...
                            if (len == 2) {
                                ...
                                if (_mv_1103.has_value) {
                                    __auto_type args_expr = _mv_1103.value;
                                    {
...
slop_string defn_build_fn_args_str_for_param(context_TranspileContext* ctx, types_SExpr* args_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1104 = (*args_expr);
        switch (_mv_1104.tag) {
            case types_SExpr_lst:
            {
                __auto_type args_list = _mv_1104.data.lst;
                {
                    ...
                    if (arg_count == 0) {
                    ...
                    } else {
                        {
                            ...
                            __auto_type i = 0;
                            while (i < arg_count) {
                                __auto_type _mv_1105 = ({ __auto_type _lst = arg_items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1105.has_value) {
                                    __auto_type arg_expr = _mv_1105.value;
                                    {
...
uint8_t defn_is_c_name_attr_at(slop_list_types_SExpr_ptr items, int64_t idx) {
    __auto_type _mv_1109 = ({ __auto_type _lst = items; size_t _idx = (size_t)idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                ...
                __auto_type lst = _mv_1130.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) >= 2) {
                        ...
                        if (_mv_1131.has_value) {
                            __auto_type val = _mv_1131.value;
                            __auto_type _mv_1132 = (*val);
                            switch (_mv_1132.tag) {
                                case types_SExpr_str:
                                {
                                    __auto_type str = _mv_1132.data.str;
        ...
        while (i < len) {
            ...
            if (_mv_1136.has_value) {
                ...
                if (defn_is_pre_form(item)) {
                    __auto_type _mv_1137 = defn_get_annotation_condition(item);
                    if (_mv_1137.has_value) {
                        __auto_type cond = _mv_1137.value;
        ...
        while (i < len) {
            ...
            if (_mv_1138.has_value) {
                ...
                if (defn_is_post_form(item)) {
                    __auto_type _mv_1139 = defn_get_annotation_condition(item);
                    if (_mv_1139.has_value) {
                        __auto_type cond = _mv_1139.value;
                        ({ __auto_type _lst_p = &(result); __auto_type _item = (cond); if (_lst_p->len >= _lst_p->cap) { size_t _new_cap = _lst_p->cap == 0 ? 16 : _lst_p->cap * 2; __typeof__(_lst_p->data) _new_data = (__typeof__(_lst_p->data))slop_arena_alloc(arena, _new_cap * sizeof(*_lst_p->data)); if (_lst_p->len > 0) memcpy(_new_data, _lst_p->data, _lst_p->len * sizeof(*_lst_p->data)); _lst_p->data = _new_data; _lst_p->cap = _new_cap; } _lst_p->data[_lst_p->len++] = _item; (void)0; });
...
void defn_emit_preconditions(context_TranspileContext* ctx, slop_list_types_SExpr_ptr preconditions) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1143 = ({ __auto_type _lst = preconditions; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1143.has_value) {
                __auto_type cond_expr = _mv_1143.value;
                {
...
void defn_emit_postconditions(context_TranspileContext* ctx, slop_list_types_SExpr_ptr postconditions) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1144 = ({ __auto_type _lst = postconditions; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1144.has_value) {
                __auto_type cond_expr = _mv_1144.value;
...
void defn_emit_assumptions(context_TranspileContext* ctx, slop_list_types_SExpr_ptr assumptions) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1145 = ({ __auto_type _lst = assumptions; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1145.has_value) {
                __auto_type cond_expr = _mv_1145.value;
                if (!(defn_is_verification_only_expr(cond_expr))) {
                    {
                        __auto_type cond_c = expr_transpile_expr(ctx, cond_expr);
                        __auto_type expr_str = parser_pretty_print(arena, cond_expr);
