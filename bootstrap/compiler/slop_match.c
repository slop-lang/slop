...
uint8_t match_is_result_match(slop_list_types_SExpr_ptr patterns) {
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_674 = ({ __auto_type _lst = patterns; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_674.has_value) {
                __auto_type pat_expr = _mv_674.value;
                {
                    __auto_type tag = match_get_pattern_tag(pat_expr);
        ...
        while ((i < len) && !(has_literal)) {
            ...
            if (_mv_677.has_value) {
                ...
                switch (_mv_678.tag) {
                    ...
                    {
                        __auto_type _ = _mv_678.data.num;
                        has_literal = 1;
                        break;
                    }
                    case types_SExpr_str:
                    {
                        __auto_type _ = _mv_678.data.str;
                        has_literal = 1;
                        break;
                    }
                    default: {
            ...
            if (_mv_679.has_value) {
                __auto_type pat_expr = _mv_679.value;
                {
                    ...
                    if ((!(string_eq(tag, SLOP_STR("")))) && (!(string_eq(tag, SLOP_STR("some")))) && (!(string_eq(tag, SLOP_STR("none")))) && (!(string_eq(tag, SLOP_STR("ok")))) && (!(string_eq(tag, SLOP_STR("error")))) && (!(string_eq(tag, SLOP_STR("else")))) && (!(string_eq(tag, SLOP_STR("_"))))) {
                        __auto_type _mv_680 = context_ctx_lookup_enum_variant(ctx, tag);
                        if (_mv_680.has_value) {
                            __auto_type _ = _mv_680.value;
                            has_union_variant = 1;
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_681.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 1) {
                    ...
                    __auto_type _mv_682 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_682.has_value) {
                        __auto_type head = _mv_682.value;
                        __auto_type _mv_683 = (*head);
                        switch (_mv_683.tag) {
                            case types_SExpr_sym:
                            {
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_684.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 2) {
                    ...
                    __auto_type _mv_685 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_685.has_value) {
                        __auto_type binding = _mv_685.value;
                        __auto_type _mv_686 = (*binding);
                        switch (_mv_686.tag) {
                            case types_SExpr_sym:
                            {
                ...
                __auto_type lst = _mv_688.data.lst;
                {
                    ...
                    if (len < 3) {
                        ...
                        if (_mv_689.has_value) {
                            __auto_type scrutinee = _mv_689.value;
                            {
...
void match_transpile_result_match(context_TranspileContext* ctx, slop_string scrutinee_c, types_SExpr* scrutinee_expr, slop_list_types_SExpr_ptr patterns, slop_list_types_SExpr_ptr items, uint8_t is_return) {
    ...
    SLOP_PRE(((scrutinee_expr != NULL)), "(!= scrutinee-expr nil)");
    {
        ...
        uint8_t has_else = 0;
        while (i < len) {
            __auto_type _mv_697 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_697.has_value) {
                __auto_type branch = _mv_697.value;
                __auto_type _mv_698 = (*branch);
                switch (_mv_698.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type branch_lst = _mv_698.data.lst;
                        {
                            __auto_type branch_items = branch_lst.items;
                            if (((int64_t)((branch_items).len)) >= 2) {
                                __auto_type _mv_699 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_699.has_value) {
                                    __auto_type pattern = _mv_699.value;
                                    {
                                        __auto_type tag = match_get_pattern_tag(pattern);
                                        if (expr_pattern_has_literal_payload(pattern)) {
                                            expr_unsupported_payload_literal(ctx, pattern);
...
void match_emit_result_ok_branch(context_TranspileContext* ctx, slop_string scrutinee_c, types_SExpr* scrutinee_expr, types_SExpr* pattern, slop_list_types_SExpr_ptr branch_items, uint8_t is_return, uint8_t first) {
    ...
    SLOP_PRE(((pattern != NULL)), "(!= pattern nil)");
    {
        ...
        context_ctx_indent(ctx);
        context_ctx_push_scope(ctx);
        __auto_type _mv_700 = match_extract_binding_name(pattern);
        if (_mv_700.has_value) {
            __auto_type binding_name = _mv_700.value;
            {
                __auto_type c_name = ctype_to_c_name(arena, binding_name);
...
void match_emit_result_error_branch(context_TranspileContext* ctx, slop_string scrutinee_c, types_SExpr* scrutinee_expr, types_SExpr* pattern, slop_list_types_SExpr_ptr branch_items, uint8_t is_return, uint8_t first) {
    ...
    SLOP_PRE(((pattern != NULL)), "(!= pattern nil)");
    {
        ...
        context_ctx_indent(ctx);
        context_ctx_push_scope(ctx);
        __auto_type _mv_701 = match_extract_binding_name(pattern);
        if (_mv_701.has_value) {
            __auto_type binding_name = _mv_701.value;
            {
                __auto_type c_name = ctype_to_c_name(arena, binding_name);
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_702.has_value) {
                __auto_type branch = _mv_702.value;
                __auto_type _mv_703 = (*branch);
                switch (_mv_703.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type branch_lst = _mv_703.data.lst;
                        {
                            __auto_type branch_items = branch_lst.items;
                            if (((int64_t)((branch_items).len)) >= 2) {
                                __auto_type _mv_704 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_704.has_value) {
                                    __auto_type pattern = _mv_704.value;
                                    {
                                        __auto_type tag = match_get_pattern_tag(pattern);
...
void match_emit_enum_case(context_TranspileContext* ctx, types_SExpr* pattern, slop_list_types_SExpr_ptr branch_items, uint8_t is_return) {
    ...
    SLOP_PRE(((pattern != NULL)), "(!= pattern nil)");
    {
        ...
        if (string_eq(tag, SLOP_STR("else")) || string_eq(tag, SLOP_STR("_"))) {
            ...
            __auto_type _mv_705 = context_ctx_lookup_enum_variant(ctx, tag);
            if (_mv_705.has_value) {
                __auto_type type_name = _mv_705.value;
                {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_706.has_value) {
                __auto_type branch = _mv_706.value;
                __auto_type _mv_707 = (*branch);
                switch (_mv_707.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type branch_lst = _mv_707.data.lst;
                        {
                            __auto_type branch_items = branch_lst.items;
                            if (((int64_t)((branch_items).len)) >= 2) {
                                __auto_type _mv_708 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_708.has_value) {
                                    __auto_type pattern = _mv_708.value;
                                    {
                                    ...
                                    if (_mv_711.has_value) {
                                        __auto_type pattern = _mv_711.value;
                                        {
                                            ...
                                            if (string_eq(tag, SLOP_STR("else")) || string_eq(tag, SLOP_STR("_"))) {
                                                ...
                                                __auto_type _mv_712 = context_ctx_lookup_enum_variant(ctx, tag);
                                                if (_mv_712.has_value) {
                                                    __auto_type union_type_name = _mv_712.value;
    ...
    SLOP_PRE(((pattern != NULL)), "(!= pattern nil)");
    {
        ...
        context_ctx_push_scope(ctx);
        {
            ...
            if (!(string_eq(multi_field_count, SLOP_STR("")))) {
                __auto_type _mv_713 = (*pattern);
                switch (_mv_713.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type pat_lst = _mv_713.data.lst;
                        {
                            __auto_type pat_items = pat_lst.items;
                            __auto_type pat_len = ((int64_t)((pat_items).len));
                            for (int64_t bi = 1; bi < pat_len; bi++) {
                                __auto_type _mv_714 = ({ __auto_type _lst = pat_items; size_t _idx = (size_t)bi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_714.has_value) {
                                    __auto_type binding_expr = _mv_714.value;
                                    {
                ...
                __auto_type _mv_715 = match_extract_binding_name(pattern);
                if (_mv_715.has_value) {
                    __auto_type binding_name = _mv_715.value;
                    {
                        __auto_type c_binding = ctype_to_c_name(arena, binding_name);
...
void match_emit_branch_body(context_TranspileContext* ctx, slop_list_types_SExpr_ptr branch_items, uint8_t is_return) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 1;
        while (i < len) {
            __auto_type _mv_716 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_716.has_value) {
                __auto_type body_expr = _mv_716.value;
                {
                ...
                __auto_type lst = _mv_717.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) < 1) {
                        ...
                        if (_mv_718.has_value) {
                            __auto_type head_expr = _mv_718.value;
                            __auto_type _mv_719 = (*head_expr);
                            switch (_mv_719.tag) {
                                case types_SExpr_sym:
                                {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 2) {
            ...
            if (_mv_720.has_value) {
                __auto_type bindings_expr = _mv_720.value;
            ...
            }
            {
                ...
                while (i < len) {
                    ...
                    if (_mv_721.has_value) {
                        __auto_type body_item = _mv_721.value;
                        {
...
void match_emit_inline_bindings(context_TranspileContext* ctx, types_SExpr* bindings_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_722 = (*bindings_expr);
        switch (_mv_722.tag) {
            case types_SExpr_lst:
            {
                __auto_type bindings_lst = _mv_722.data.lst;
                {
                    __auto_type bindings = bindings_lst.items;
                    __auto_type len = ((int64_t)((bindings).len));
                    __auto_type i = 0;
                    while (i < len) {
                        __auto_type _mv_723 = ({ __auto_type _lst = bindings; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_723.has_value) {
                            __auto_type binding = _mv_723.value;
                ...
                __auto_type binding_lst = _mv_724.data.lst;
                {
                    ...
                    __auto_type len = ((int64_t)((items).len));
                    {
                        ...
                        if ((len - start_idx) < 2) {
                            ...
                            __auto_type _mv_725 = ({ __auto_type _lst = items; size_t _idx = (size_t)start_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_725.has_value) {
                                __auto_type name_expr = _mv_725.value;
                                __auto_type _mv_726 = (*name_expr);
                                switch (_mv_726.tag) {
                                    case types_SExpr_sym:
                                    {
                                        __auto_type name_sym = _mv_726.data.sym;
                                        {
                                            ...
                                            if ((len - start_idx) >= 3) {
                                                {
                                                    ...
                                                    __auto_type _mv_727 = ({ __auto_type _lst = items; size_t _idx = (size_t)type_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_727.has_value) {
                                                        __auto_type type_expr = _mv_727.value;
                                                        if (match_is_type_expr(type_expr)) {
                                                            __auto_type _mv_728 = ({ __auto_type _lst = items; size_t _idx = (size_t)val_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                            if (_mv_728.has_value) {
                                                                __auto_type val_expr = _mv_728.value;
                                                                {
                                                            ...
                                                            if (_mv_729.has_value) {
                                                                __auto_type val_expr = _mv_729.value;
                                                                {
                                                                    ...
                                                                    __auto_type _mv_730 = ptr_type_opt;
                                                                    if (_mv_730.has_value) {
                                                                        __auto_type ptr_type = _mv_730.value;
...
uint8_t match_is_type_expr(types_SExpr* expr) {
    ...
    switch (_mv_735.tag) {
        ...
        case types_SExpr_lst:
        {
            __auto_type _ = _mv_735.data.lst;
            return 1;
        }
        default: {
            return 0;
                ...
                __auto_type lst = _mv_739.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) >= 3) {
                        ...
                        if (_mv_740.has_value) {
                            __auto_type head_ptr = _mv_740.value;
                            __auto_type _mv_741 = (*head_ptr);
                            switch (_mv_741.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type head_sym = _mv_741.data.sym;
                                    if (string_eq(head_sym.name, SLOP_STR("arena-alloc"))) {
                                        ...
                                        if (_mv_742.has_value) {
                                            __auto_type size_expr = _mv_742.value;
        ...
        switch (_mv_743.tag) {
            case types_SExpr_sym:
            {
                __auto_type sym = _mv_743.data.sym;
                {
                    ...
                    __auto_type _mv_744 = context_ctx_lookup_type(ctx, type_name);
                    if (_mv_744.has_value) {
                        __auto_type entry = _mv_744.value;
                ...
                __auto_type lst = _mv_743.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) >= 2) {
                        ...
                        if (_mv_745.has_value) {
                            __auto_type head_ptr = _mv_745.value;
                            __auto_type _mv_746 = (*head_ptr);
                            switch (_mv_746.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type head_sym = _mv_746.data.sym;
                                    if (string_eq(head_sym.name, SLOP_STR("sizeof"))) {
                                        ...
                                        if (_mv_747.has_value) {
                                            __auto_type type_expr = _mv_747.value;
                                            {
                                                __auto_type c_type = context_to_c_type_prefixed(ctx, type_expr);
...
void match_emit_inline_do(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items, uint8_t is_return, uint8_t is_last) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 1;
        while (i < len) {
            __auto_type _mv_748 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_748.has_value) {
                __auto_type item = _mv_748.value;
                {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 3) {
            ...
            if (_mv_749.has_value) {
                __auto_type cond_expr = _mv_749.value;
                {
            ...
            if (_mv_750.has_value) {
                __auto_type then_expr = _mv_750.value;
            ...
            if (len >= 4) {
                context_ctx_emit(ctx, SLOP_STR("} else {"));
                context_ctx_indent(ctx);
                __auto_type _mv_751 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_751.has_value) {
                    __auto_type else_expr = _mv_751.value;
...
slop_option_string match_get_var_c_type_inline(context_TranspileContext* ctx, types_SExpr* expr) {
    ...
    switch (_mv_753.tag) {
        case types_SExpr_sym:
        {
            ...
            {
                __auto_type name = sym.name;
                __auto_type _mv_754 = context_ctx_lookup_var(ctx, name);
                if (_mv_754.has_value) {
                    __auto_type var_entry = _mv_754.value;
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (expr_set_is_self_assign(items)) {
            ...
            if (_mv_759.has_value) {
                __auto_type target_expr = _mv_759.value;
                __auto_type _mv_760 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_760.has_value) {
                    __auto_type field_expr = _mv_760.value;
                    __auto_type _mv_761 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_761.has_value) {
                        __auto_type type_expr = _mv_761.value;
                        __auto_type _mv_762 = ({ __auto_type _lst = items; size_t _idx = (size_t)4; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_762.has_value) {
                            __auto_type value_expr = _mv_762.value;
                            {
                                ...
                                __auto_type c_type = ctype_to_c_type(arena, type_expr);
                                {
                                    ...
                                    if (context_ctx_is_option_c_type(ctx, c_type)) {
                                        if (match_is_none_form_inline(value_expr)) {
                                            ...
                                            __auto_type _mv_763 = match_get_some_value_inline(value_expr);
                                            if (_mv_763.has_value) {
                                                __auto_type inner_val = _mv_763.value;
                                                {
            ...
            __auto_type _mv_764 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_764.has_value) {
                __auto_type target_expr = _mv_764.value;
                __auto_type _mv_765 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_765.has_value) {
                    __auto_type field_expr = _mv_765.value;
                    __auto_type _mv_766 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_766.has_value) {
                        __auto_type value_expr = _mv_766.value;
                        {
                            __auto_type field_name = match_get_field_name_inline(ctx, field_expr);
                ...
                if (_mv_768.has_value) {
                    __auto_type val_expr = _mv_768.value;
                    {
                        ...
                        if (_mv_769.has_value) {
                            ...
                            {
                                __auto_type some_val_opt = match_get_some_value_inline(val_expr);
                                __auto_type _mv_771 = some_val_opt;
                                if (_mv_771.has_value) {
                                    __auto_type inner_expr = _mv_771.value;
                                    {
                                        __auto_type inner_c = expr_transpile_expr(ctx, inner_expr);
                                    ...
                                    if (match_is_none_form_inline(val_expr)) {
                                        __auto_type _mv_772 = context_ctx_get_current_return_type(ctx);
                                        if (_mv_772.has_value) {
                                            __auto_type ret_type = _mv_772.value;
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_773.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 2) {
                    ...
                    __auto_type _mv_774 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_774.has_value) {
                        __auto_type head = _mv_774.value;
                        __auto_type _mv_775 = (*head);
                        switch (_mv_775.tag) {
                            case types_SExpr_sym:
                            {
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_776.data.lst;
            {
                ...
                if (_mv_777.has_value) {
                    __auto_type inner = _mv_777.value;
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 2) {
            ...
            if (_mv_779.has_value) {
                __auto_type cond_expr = _mv_779.value;
                {
                    __auto_type cond_c = context_ctx_strip_cond_parens(ctx, expr_transpile_expr(ctx, cond_expr));
                    context_ctx_emit(ctx, context_ctx_str3(ctx, SLOP_STR("if ("), cond_c, SLOP_STR(") {")));
                }
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_780.has_value) {
                __auto_type clause_expr = _mv_780.value;
                __auto_type _mv_781 = (*clause_expr);
                switch (_mv_781.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type clause_lst = _mv_781.data.lst;
                        {
                            ...
                            if (clause_len < 1) {
                                ...
                                __auto_type _mv_782 = ({ __auto_type _lst = clause_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_782.has_value) {
                                    __auto_type test_expr = _mv_782.value;
                                    __auto_type _mv_783 = (*test_expr);
                                    switch (_mv_783.tag) {
                                        case types_SExpr_sym:
                                        {
...
void match_emit_inline_cond_body(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items, int64_t start, uint8_t is_return, uint8_t is_last) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = start;
        while (i < len) {
            __auto_type _mv_784 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_784.has_value) {
                __auto_type body_expr = _mv_784.value;
                {
        ...
        if (len < 2) {
        ...
        } else {
            {
                ...
                if (is_named && (len < 4)) {
                    ...
                    context_ctx_indent(ctx);
                    context_ctx_push_scope(ctx);
                    __auto_type _mv_785 = ({ __auto_type _lst = items; size_t _idx = (size_t)size_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_785.has_value) {
                        __auto_type size_expr = _mv_785.value;
                        {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 2) {
            ...
            if (_mv_788.has_value) {
                ...
                __auto_type _mv_789 = (*binding_expr);
                switch (_mv_789.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type binding_lst = _mv_789.data.lst;
                        {
                            ...
                            if (binding_len < 3) {
                                ...
                                __auto_type _mv_790 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_790.has_value) {
                                    __auto_type var_expr = _mv_790.value;
                                    __auto_type _mv_791 = (*var_expr);
                                    switch (_mv_791.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type var_sym = _mv_791.data.sym;
                                            {
                                                ...
                                                if (_mv_792.has_value) {
                                                    __auto_type start_expr = _mv_792.value;
                                                    __auto_type _mv_793 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_793.has_value) {
                                                        __auto_type end_expr = _mv_793.value;
                                                        {
...
void match_emit_inline_for_each_map_kv(context_TranspileContext* ctx, slop_list_types_SExpr_ptr binding_items, slop_list_types_SExpr_ptr items, int64_t len) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_794 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        if (_mv_794.has_value) {
            __auto_type kv_list_expr = _mv_794.value;
            __auto_type _mv_795 = (*kv_list_expr);
            switch (_mv_795.tag) {
                case types_SExpr_lst:
                {
                    __auto_type kv_lst = _mv_795.data.lst;
                    {
                        __auto_type kv_items = kv_lst.items;
                        if (((int64_t)((kv_items).len)) < 2) {
                            context_ctx_add_error(ctx, SLOP_STR("Map for-each needs ((k v) map)"));
                        } else {
                            __auto_type _mv_796 = ({ __auto_type _lst = kv_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_796.has_value) {
                                __auto_type k_expr = _mv_796.value;
                                __auto_type _mv_797 = ({ __auto_type _lst = kv_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_797.has_value) {
                                    __auto_type v_expr = _mv_797.value;
                                    __auto_type _mv_798 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    if (_mv_798.has_value) {
                                        __auto_type map_expr = _mv_798.value;
                                        __auto_type _mv_799 = (*k_expr);
                                        switch (_mv_799.tag) {
                                            case types_SExpr_sym:
                                            {
                                                __auto_type k_sym = _mv_799.data.sym;
                                                __auto_type _mv_800 = (*v_expr);
                                                switch (_mv_800.tag) {
                                                    case types_SExpr_sym:
                                                    {
                                                        __auto_type v_sym = _mv_800.data.sym;
                                                        {
...
void match_emit_inline_for_each(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 2) {
            ...
            __auto_type _mv_801 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_801.has_value) {
                __auto_type binding_expr = _mv_801.value;
                __auto_type _mv_802 = (*binding_expr);
                switch (_mv_802.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type binding_lst = _mv_802.data.lst;
                        {
                            __auto_type binding_items = binding_lst.items;
                            __auto_type binding_len = ((int64_t)((binding_items).len));
                            if (binding_len < 2) {
                                ...
                                __auto_type _mv_803 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_803.has_value) {
                                    __auto_type first_elem = _mv_803.value;
                                    __auto_type _mv_804 = (*first_elem);
                                    switch (_mv_804.tag) {
                                        case types_SExpr_lst:
                                        {
                                        ...
                                        case types_SExpr_sym:
                                        {
                                            __auto_type var_sym = _mv_804.data.sym;
                                            {
                                                __auto_type var_name = ctype_to_c_name(arena, var_sym.name);
                                                __auto_type _mv_805 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_805.has_value) {
                                                    __auto_type coll_expr = _mv_805.value;
                                                    {
...
void match_emit_inline_return(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 2) {
            ...
            __auto_type _mv_806 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_807.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 1) {
                    ...
                    __auto_type _mv_808 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
uint8_t match_is_pattern_literal(types_SExpr* expr) {
    ...
    switch (_mv_813.tag) {
        ...
        case types_SExpr_num:
        {
            __auto_type _ = _mv_813.data.num;
            return 1;
        }
        case types_SExpr_str:
        {
            __auto_type _ = _mv_813.data.str;
            return 1;
        }
        default: {
            return 0;
...
slop_string match_pattern_literal_to_c(types_SExpr* expr) {
    ...
    switch (_mv_814.tag) {
        ...
        case types_SExpr_num:
        {
            __auto_type n = _mv_814.data.num;
            return n.raw;
        }
        default: {
            return SLOP_STR("");
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_815.data.lst;
            {
                ...
                for (int64_t i = 1; i < len; i++) {
                    if (!(found)) {
                        __auto_type _mv_816 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
uint8_t match_has_literal_in_patterns(slop_list_types_SExpr_ptr patterns) {
    {
        ...
        int64_t i = 0;
        while ((i < len) && !(found)) {
            __auto_type _mv_817 = ({ __auto_type _lst = patterns; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_817.has_value) {
                __auto_type pat_expr = _mv_817.value;
...
slop_string match_build_literal_guard_cond(context_TranspileContext* ctx, slop_string scrutinee_c, slop_string c_tag, slop_string tag_cond, types_SExpr* pattern, uint8_t is_multi) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_818 = (*pattern);
        switch (_mv_818.tag) {
            case types_SExpr_lst:
            {
                __auto_type pat_lst = _mv_818.data.lst;
                {
                    __auto_type pat_items = pat_lst.items;
                    __auto_type pat_len = ((int64_t)((pat_items).len));
                    __auto_type cond = tag_cond;
                    for (int64_t bi = 1; bi < pat_len; bi++) {
                        __auto_type _mv_819 = ({ __auto_type _lst = pat_items; size_t _idx = (size_t)bi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void match_emit_union_literal_bindings(context_TranspileContext* ctx, slop_string scrutinee_c, types_SExpr* pattern, slop_string tag, slop_string union_type_name, slop_string c_tag, uint8_t is_multi) {
    ...
    SLOP_PRE(((pattern != NULL)), "(!= pattern nil)");
    {
        ...
        if (is_multi) {
                    ...
                    __auto_type pat_lst = _mv_820.data.lst;
                    {
                        ...
                        for (int64_t bi = 1; bi < pat_len; bi++) {
                            ...
                            if (_mv_821.has_value) {
                                __auto_type binding_expr = _mv_821.value;
            ...
            __auto_type _mv_822 = match_extract_binding_name(pattern);
            if (_mv_822.has_value) {
                __auto_type binding_name = _mv_822.value;
...
void match_transpile_union_match_with_literals(context_TranspileContext* ctx, slop_string scrutinee_c, slop_list_types_SExpr_ptr patterns, slop_list_types_SExpr_ptr items, uint8_t is_return) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        uint8_t has_else = 0;
        while (i < len) {
            __auto_type _mv_823 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_823.has_value) {
                __auto_type branch = _mv_823.value;
                __auto_type _mv_824 = (*branch);
                switch (_mv_824.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type branch_lst = _mv_824.data.lst;
                        {
                            __auto_type branch_items = branch_lst.items;
                            if (((int64_t)((branch_items).len)) >= 2) {
                                __auto_type _mv_825 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_825.has_value) {
                                    __auto_type pattern = _mv_825.value;
                                    {
                                        __auto_type tag = match_get_pattern_tag(pattern);
                                        if (string_eq(tag, SLOP_STR("else")) || string_eq(tag, SLOP_STR("_"))) {
                                            has_else = 1;
                                            ...
                                            __auto_type _mv_826 = context_ctx_lookup_enum_variant(ctx, tag);
                                            if (_mv_826.has_value) {
                                                __auto_type union_type_name = _mv_826.value;
                                                {
                                                    __auto_type c_tag = ctype_to_c_name(arena, tag);
