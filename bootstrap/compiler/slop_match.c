...
uint8_t match_is_option_match(slop_list_types_SExpr_ptr patterns) {
    {
        ...
        __auto_type i = 0;
        while ((i < len)) {
            __auto_type _mv_524 = ({ __auto_type _lst = patterns; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_524.has_value) {
                __auto_type pat_expr = _mv_524.value;
                {
...
uint8_t match_is_result_match(slop_list_types_SExpr_ptr patterns) {
    {
        ...
        __auto_type i = 0;
        while ((i < len)) {
            __auto_type _mv_525 = ({ __auto_type _lst = patterns; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_525.has_value) {
                __auto_type pat_expr = _mv_525.value;
                {
                    __auto_type tag = match_get_pattern_tag(pat_expr);
...
uint8_t match_is_enum_match(slop_list_types_SExpr_ptr patterns) {
    {
        ...
        while (((i < len) && all_symbols)) {
            __auto_type _mv_526 = ({ __auto_type _lst = patterns; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_526.has_value) {
                __auto_type pat_expr = _mv_526.value;
                __auto_type _mv_527 = (*pat_expr);
                switch (_mv_527.tag) {
                    case types_SExpr_sym:
                    {
                        __auto_type _ = _mv_527.data.sym;
                        break;
                    }
                    default: {
                        all_symbols = 0;
...
uint8_t match_is_literal_match(slop_list_types_SExpr_ptr patterns) {
    {
        ...
        while (((i < len) && !(has_literal))) {
            __auto_type _mv_528 = ({ __auto_type _lst = patterns; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_528.has_value) {
                __auto_type pat_expr = _mv_528.value;
                __auto_type _mv_529 = (*pat_expr);
                switch (_mv_529.tag) {
                    case types_SExpr_num:
                    {
                        __auto_type _ = _mv_529.data.num;
                        has_literal = 1;
                        break;
                    }
                    case types_SExpr_str:
                    {
                        __auto_type _ = _mv_529.data.str;
                        has_literal = 1;
                        break;
                    }
                    default: {
...
uint8_t match_is_union_match(context_TranspileContext* ctx, slop_list_types_SExpr_ptr patterns) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (((i < len) && !(has_union_variant))) {
            __auto_type _mv_530 = ({ __auto_type _lst = patterns; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_530.has_value) {
                __auto_type pat_expr = _mv_530.value;
                {
                    __auto_type tag = match_get_pattern_tag(pat_expr);
                    if (((!(string_eq(tag, SLOP_STR("")))) && (!(string_eq(tag, SLOP_STR("some")))) && (!(string_eq(tag, SLOP_STR("none")))) && (!(string_eq(tag, SLOP_STR("ok")))) && (!(string_eq(tag, SLOP_STR("error")))) && (!(string_eq(tag, SLOP_STR("else")))) && (!(string_eq(tag, SLOP_STR("_")))))) {
                        __auto_type _mv_531 = context_ctx_lookup_enum_variant(ctx, tag);
...
slop_string match_get_pattern_tag(types_SExpr* pat_expr) {
    ...
    switch (_mv_532.tag) {
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_532.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    __auto_type _mv_533 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_533.has_value) {
                        __auto_type head = _mv_533.value;
                        __auto_type _mv_534 = (*head);
                        switch (_mv_534.tag) {
                            case types_SExpr_sym:
                            {
        ...
        case types_SExpr_sym:
        {
            __auto_type sym = _mv_532.data.sym;
            return sym.name;
        }
        default: {
            return SLOP_STR("");
...
slop_option_string match_extract_binding_name(types_SExpr* pat_expr) {
    SLOP_PRE(((pat_expr != NULL)), "(!= pat-expr nil)");
    __auto_type _mv_535 = (*pat_expr);
    switch (_mv_535.tag) {
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_535.data.lst;
            {
                __auto_type items = lst.items;
                if ((((int64_t)((items).len)) < 2)) {
                    ...
                    if (_mv_536.has_value) {
                        __auto_type binding = _mv_536.value;
                        __auto_type _mv_537 = (*binding);
                        switch (_mv_537.tag) {
                            case types_SExpr_sym:
                            {
...
void match_transpile_match(context_TranspileContext* ctx, types_SExpr* expr, uint8_t is_return) {
    ...
    SLOP_PRE(((expr != NULL)), "(!= expr nil)");
    {
        ...
        __auto_type _mv_538 = (*expr);
        switch (_mv_538.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_538.data.lst;
                {
                    __auto_type items = lst.items;
                    ...
                    if ((len < 3)) {
                        ...
                        __auto_type _mv_539 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_539.has_value) {
                            __auto_type scrutinee = _mv_539.value;
                            {
                    ...
                    case types_SExpr_lst:
                    {
                        __auto_type branch_lst = _mv_541.data.lst;
                        {
                            ...
                            if ((((int64_t)((branch_items).len)) >= 1)) {
                                __auto_type _mv_542 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void match_transpile_option_match(context_TranspileContext* ctx, slop_string scrutinee_c, types_SExpr* scrutinee_expr, slop_list_types_SExpr_ptr patterns, slop_list_types_SExpr_ptr items, uint8_t is_return) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        __auto_type first = 1;
        while ((i < len)) {
            __auto_type _mv_543 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_543.has_value) {
                __auto_type branch = _mv_543.value;
                __auto_type _mv_544 = (*branch);
                switch (_mv_544.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type branch_lst = _mv_544.data.lst;
                        {
                            __auto_type branch_items = branch_lst.items;
                            if ((((int64_t)((branch_items).len)) >= 2)) {
                                __auto_type _mv_545 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_545.has_value) {
                                    __auto_type pattern = _mv_545.value;
                                    {
...
void match_emit_option_some_branch(context_TranspileContext* ctx, slop_string scrutinee_c, types_SExpr* scrutinee_expr, types_SExpr* pattern, slop_list_types_SExpr_ptr branch_items, uint8_t is_return, uint8_t first) {
    ...
    SLOP_PRE(((pattern != NULL)), "(!= pattern nil)");
    {
        ...
        __auto_type _mv_546 = match_extract_binding_name(pattern);
        if (_mv_546.has_value) {
            __auto_type binding_name = _mv_546.value;
            {
...
void match_transpile_result_match(context_TranspileContext* ctx, slop_string scrutinee_c, types_SExpr* scrutinee_expr, slop_list_types_SExpr_ptr patterns, slop_list_types_SExpr_ptr items, uint8_t is_return) {
    ...
    SLOP_PRE(((scrutinee_expr != NULL)), "(!= scrutinee-expr nil)");
    {
        ...
        __auto_type first = 1;
        while ((i < len)) {
            __auto_type _mv_547 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_547.has_value) {
                __auto_type branch = _mv_547.value;
                __auto_type _mv_548 = (*branch);
                switch (_mv_548.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type branch_lst = _mv_548.data.lst;
                        {
                            __auto_type branch_items = branch_lst.items;
                            if ((((int64_t)((branch_items).len)) >= 2)) {
                                __auto_type _mv_549 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_549.has_value) {
                                    __auto_type pattern = _mv_549.value;
                                    {
                                        __auto_type tag = match_get_pattern_tag(pattern);
                                        if (string_eq(tag, SLOP_STR("ok"))) {
...
void match_emit_result_ok_branch(context_TranspileContext* ctx, slop_string scrutinee_c, types_SExpr* scrutinee_expr, types_SExpr* pattern, slop_list_types_SExpr_ptr branch_items, uint8_t is_return, uint8_t first) {
    ...
    SLOP_PRE(((pattern != NULL)), "(!= pattern nil)");
    {
        ...
        context_ctx_indent(ctx);
        context_ctx_push_scope(ctx);
        __auto_type _mv_550 = match_extract_binding_name(pattern);
        if (_mv_550.has_value) {
            __auto_type binding_name = _mv_550.value;
            {
                __auto_type c_name = ctype_to_c_name(arena, binding_name);
...
void match_emit_result_error_branch(context_TranspileContext* ctx, slop_string scrutinee_c, types_SExpr* scrutinee_expr, types_SExpr* pattern, slop_list_types_SExpr_ptr branch_items, uint8_t is_return, uint8_t first) {
    ...
    SLOP_PRE(((pattern != NULL)), "(!= pattern nil)");
    {
        ...
        context_ctx_indent(ctx);
        context_ctx_push_scope(ctx);
        __auto_type _mv_551 = match_extract_binding_name(pattern);
        if (_mv_551.has_value) {
            __auto_type binding_name = _mv_551.value;
            {
                __auto_type c_name = ctype_to_c_name(arena, binding_name);
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while ((i < len)) {
            ...
            if (_mv_552.has_value) {
                __auto_type branch = _mv_552.value;
                __auto_type _mv_553 = (*branch);
                switch (_mv_553.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type branch_lst = _mv_553.data.lst;
                        {
                            __auto_type branch_items = branch_lst.items;
                            if ((((int64_t)((branch_items).len)) >= 2)) {
                                __auto_type _mv_554 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_554.has_value) {
                                    __auto_type pattern = _mv_554.value;
...
void match_emit_enum_case(context_TranspileContext* ctx, types_SExpr* pattern, slop_list_types_SExpr_ptr branch_items, uint8_t is_return) {
    ...
    SLOP_PRE(((pattern != NULL)), "(!= pattern nil)");
    {
        ...
        if (string_eq(tag, SLOP_STR("else"))) {
            ...
            __auto_type _mv_555 = context_ctx_lookup_enum_variant(ctx, tag);
            if (_mv_555.has_value) {
                __auto_type type_name = _mv_555.value;
                {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while ((i < len)) {
            ...
            if (_mv_556.has_value) {
                __auto_type branch = _mv_556.value;
                __auto_type _mv_557 = (*branch);
                switch (_mv_557.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type branch_lst = _mv_557.data.lst;
                        {
                            __auto_type branch_items = branch_lst.items;
                            if ((((int64_t)((branch_items).len)) >= 2)) {
                                __auto_type _mv_558 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_558.has_value) {
                                    __auto_type pattern = _mv_558.value;
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while ((i < len)) {
            ...
            if (_mv_559.has_value) {
                __auto_type branch = _mv_559.value;
                __auto_type _mv_560 = (*branch);
                switch (_mv_560.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type branch_lst = _mv_560.data.lst;
                        {
                            __auto_type branch_items = branch_lst.items;
                            if ((((int64_t)((branch_items).len)) >= 2)) {
                                __auto_type _mv_561 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_561.has_value) {
                                    __auto_type pattern = _mv_561.value;
                                    {
                                        __auto_type tag = match_get_pattern_tag(pattern);
                                        if ((string_eq(tag, SLOP_STR("else")) || string_eq(tag, SLOP_STR("_")))) {
                                            ...
                                            __auto_type _mv_562 = context_ctx_lookup_enum_variant(ctx, tag);
                                            if (_mv_562.has_value) {
                                                __auto_type union_type_name = _mv_562.value;
...
void match_emit_union_case(context_TranspileContext* ctx, slop_string scrutinee_c, types_SExpr* pattern, slop_string tag, slop_string union_type_name, slop_list_types_SExpr_ptr branch_items, uint8_t is_return) {
    ...
    SLOP_PRE(((pattern != NULL)), "(!= pattern nil)");
    {
        ...
        context_ctx_indent(ctx);
        context_ctx_push_scope(ctx);
        __auto_type _mv_563 = match_extract_binding_name(pattern);
        if (_mv_563.has_value) {
            __auto_type binding_name = _mv_563.value;
            {
...
void match_emit_branch_body(context_TranspileContext* ctx, slop_list_types_SExpr_ptr branch_items, uint8_t is_return) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        __auto_type i = 1;
        while ((i < len)) {
            __auto_type _mv_564 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_565.data.lst;
                {
                    ...
                    if ((((int64_t)((items).len)) < 1)) {
                        ...
                        __auto_type _mv_566 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_566.has_value) {
                            __auto_type head_expr = _mv_566.value;
                            __auto_type _mv_567 = (*head_expr);
                            switch (_mv_567.tag) {
                                case types_SExpr_sym:
                                {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len < 2)) {
            ...
            }
            {
                __auto_type i = 2;
                while ((i < len)) {
                    __auto_type _mv_569 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_569.has_value) {
                        __auto_type body_item = _mv_569.value;
                        {
...
void match_emit_inline_bindings(context_TranspileContext* ctx, types_SExpr* bindings_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_570 = (*bindings_expr);
        switch (_mv_570.tag) {
            case types_SExpr_lst:
            {
                __auto_type bindings_lst = _mv_570.data.lst;
                {
                    __auto_type bindings = bindings_lst.items;
                    __auto_type len = ((int64_t)((bindings).len));
                    __auto_type i = 0;
                    while ((i < len)) {
                        __auto_type _mv_571 = ({ __auto_type _lst = bindings; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_571.has_value) {
                            __auto_type binding = _mv_571.value;
...
void match_emit_single_inline_binding(context_TranspileContext* ctx, types_SExpr* binding) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_572 = (*binding);
        switch (_mv_572.tag) {
            case types_SExpr_lst:
            {
                __auto_type binding_lst = _mv_572.data.lst;
                {
                    ...
                    __auto_type len = ((int64_t)((items).len));
                    {
                        ...
                        if (((len - start_idx) < 2)) {
                            ...
                            __auto_type _mv_573 = ({ __auto_type _lst = items; size_t _idx = (size_t)start_idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            ...
                                            if (((len - start_idx) >= 3)) {
                                                {
                                                    ...
                                                    __auto_type _mv_575 = ({ __auto_type _lst = items; size_t _idx = (size_t)type_idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_575.has_value) {
                                                        __auto_type type_expr = _mv_575.value;
                                                        if (match_is_type_expr(type_expr)) {
                                                            __auto_type _mv_576 = ({ __auto_type _lst = items; size_t _idx = (size_t)val_idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                            ...
                                                            __auto_type _mv_577 = ({ __auto_type _lst = items; size_t _idx = (size_t)type_idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                            if (_mv_577.has_value) {
                                                                __auto_type val_expr = _mv_577.value;
                                                                {
                                                                    ...
                                                                    __auto_type _mv_578 = ptr_type_opt;
                                                                    if (_mv_578.has_value) {
                                                                        __auto_type ptr_type = _mv_578.value;
                                            ...
                                            } else {
                                                {
                                                    ...
                                                    __auto_type _mv_579 = ({ __auto_type _lst = items; size_t _idx = (size_t)val_idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_579.has_value) {
                                                        __auto_type val_expr = _mv_579.value;
                                                        {
                                                            ...
                                                            __auto_type inferred_slop_type = expr_infer_expr_slop_type(ctx, val_expr);
                                                            __auto_type ptr_type_opt = match_get_arena_alloc_ptr_type_inline(ctx, val_expr);
                                                            __auto_type _mv_580 = ptr_type_opt;
                                                            if (_mv_580.has_value) {
                                                                __auto_type ptr_type = _mv_580.value;
                                                                context_ctx_emit(ctx, context_ctx_str4(ctx, SLOP_STR("__auto_type "), c_name, SLOP_STR(" = "), context_ctx_str(ctx, val_c, SLOP_STR(";"))));
                                                                context_ctx_bind_var(ctx, (context_VarEntry){raw_name, c_name, ptr_type, inferred_slop_type, 1, has_mut, 0, SLOP_STR(""), SLOP_STR("")});
...
uint8_t match_binding_starts_with_mut(slop_list_types_SExpr_ptr items) {
    if ((((int64_t)((items).len)) < 1)) {
        ...
        __auto_type _mv_581 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    ...
    switch (_mv_584.tag) {
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_584.data.lst;
            {
                __auto_type items = lst.items;
                if ((((int64_t)((items).len)) == 1)) {
                    __auto_type _mv_585 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_587.data.lst;
                {
                    ...
                    if ((((int64_t)((items).len)) >= 3)) {
                        __auto_type _mv_588 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_588.has_value) {
                            __auto_type head_ptr = _mv_588.value;
                            __auto_type _mv_589 = (*head_ptr);
                            switch (_mv_589.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type head_sym = _mv_589.data.sym;
                                    if (string_eq(head_sym.name, SLOP_STR("arena-alloc"))) {
                                        __auto_type _mv_590 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        switch (_mv_591.tag) {
            case types_SExpr_sym:
            {
                __auto_type sym = _mv_591.data.sym;
                {
                    ...
                    __auto_type _mv_592 = context_ctx_lookup_type(ctx, type_name);
                    if (_mv_592.has_value) {
                        __auto_type entry = _mv_592.value;
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_591.data.lst;
                {
                    __auto_type items = lst.items;
                    if ((((int64_t)((items).len)) >= 2)) {
                        __auto_type _mv_593 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_593.has_value) {
                            __auto_type head_ptr = _mv_593.value;
                            __auto_type _mv_594 = (*head_ptr);
                            switch (_mv_594.tag) {
                                case types_SExpr_sym:
                                {
...
void match_emit_inline_do(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items, uint8_t is_return, uint8_t is_last) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        __auto_type i = 1;
        while ((i < len)) {
            __auto_type _mv_596 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_596.has_value) {
                __auto_type item = _mv_596.value;
                {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len < 3)) {
            ...
            if (_mv_597.has_value) {
                __auto_type cond_expr = _mv_597.value;
                {
            ...
            context_ctx_indent(ctx);
            __auto_type _mv_598 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_598.has_value) {
                __auto_type then_expr = _mv_598.value;
            ...
            if ((len >= 4)) {
                context_ctx_emit(ctx, SLOP_STR("} else {"));
                context_ctx_indent(ctx);
                __auto_type _mv_599 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_599.has_value) {
                    __auto_type else_expr = _mv_599.value;
...
void match_emit_inline_while(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len < 3)) {
            ...
            __auto_type _mv_600 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_600.has_value) {
                __auto_type cond_expr = _mv_600.value;
                {
                    __auto_type cond_c = expr_transpile_expr(ctx, cond_expr);
            ...
            context_ctx_indent(ctx);
            {
                ...
                while ((i < len)) {
                    ...
                    if (_mv_601.has_value) {
                        __auto_type body_expr = _mv_601.value;
...
slop_option_string match_get_var_c_type_inline(context_TranspileContext* ctx, types_SExpr* expr) {
    ...
    switch (_mv_602.tag) {
        case types_SExpr_sym:
        {
            ...
            {
                __auto_type name = sym.name;
                __auto_type _mv_603 = context_ctx_lookup_var(ctx, name);
                if (_mv_603.has_value) {
                    __auto_type var_entry = _mv_603.value;
        ...
        switch (_mv_604.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_604.data.lst;
                {
                    __auto_type items = lst.items;
                    if ((((int64_t)((items).len)) >= 2)) {
                        __auto_type _mv_605 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            ...
                            switch (_mv_606.tag) {
                                case types_SExpr_sym:
                                {
                                    ...
                                    if (string_eq(sym.name, SLOP_STR("some"))) {
                                        __auto_type _mv_607 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_607.has_value) {
                                            __auto_type val = _mv_607.value;
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len == 5)) {
            ...
            if (_mv_608.has_value) {
                __auto_type target_expr = _mv_608.value;
                __auto_type _mv_609 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_609.has_value) {
                    __auto_type field_expr = _mv_609.value;
                    __auto_type _mv_610 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_610.has_value) {
                        __auto_type type_expr = _mv_610.value;
                        __auto_type _mv_611 = ({ __auto_type _lst = items; size_t _idx = (size_t)4; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_611.has_value) {
                            __auto_type value_expr = _mv_611.value;
                            {
                                ...
                                __auto_type c_type = ctype_to_c_type(arena, type_expr);
                                {
                                    ...
                                    if (strlib_starts_with(c_type, SLOP_STR("slop_option_"))) {
                                        if (match_is_none_form_inline(value_expr)) {
                                            ...
                                            __auto_type _mv_612 = match_get_some_value_inline(value_expr);
                                            if (_mv_612.has_value) {
                                                __auto_type inner_val = _mv_612.value;
                                                {
            ...
            __auto_type _mv_613 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_613.has_value) {
                __auto_type target_expr = _mv_613.value;
                __auto_type _mv_614 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_614.has_value) {
                    __auto_type field_expr = _mv_614.value;
                    __auto_type _mv_615 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_615.has_value) {
                        __auto_type value_expr = _mv_615.value;
                        {
                            __auto_type field_name = match_get_field_name_inline(ctx, field_expr);
            ...
            __auto_type _mv_616 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_616.has_value) {
                __auto_type target_expr = _mv_616.value;
                __auto_type _mv_617 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_617.has_value) {
                    __auto_type val_expr = _mv_617.value;
                    {
                        ...
                        if (_mv_618.has_value) {
                            ...
                            {
                                __auto_type some_val_opt = match_get_some_value_inline(val_expr);
                                __auto_type _mv_620 = some_val_opt;
                                if (_mv_620.has_value) {
                                    __auto_type inner_expr = _mv_620.value;
                                    {
                                        __auto_type inner_c = expr_transpile_expr(ctx, inner_expr);
                                    ...
                                    if (match_is_none_form_inline(val_expr)) {
                                        __auto_type _mv_621 = context_ctx_get_current_return_type(ctx);
                                        if (_mv_621.has_value) {
                                            __auto_type ret_type = _mv_621.value;
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_622.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 2)) {
                    ...
                    __auto_type _mv_623 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_623.has_value) {
                        __auto_type head = _mv_623.value;
                        __auto_type _mv_624 = (*head);
                        switch (_mv_624.tag) {
                            case types_SExpr_sym:
                            {
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_625.data.lst;
            {
                ...
                if (_mv_626.has_value) {
                    __auto_type inner = _mv_626.value;
...
void match_emit_inline_when(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len < 2)) {
            ...
            __auto_type _mv_628 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_628.has_value) {
                __auto_type cond_expr = _mv_628.value;
                {
                    __auto_type cond_c = expr_transpile_expr(ctx, cond_expr);
                    context_ctx_emit(ctx, context_ctx_str3(ctx, SLOP_STR("if ("), cond_c, SLOP_STR(") {")));
                }
            ...
            context_ctx_indent(ctx);
            {
                ...
                while ((i < len)) {
                    ...
                    if (_mv_629.has_value) {
                        __auto_type body_expr = _mv_629.value;
                        match_emit_branch_body_item(ctx, body_expr, 0, 0);
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while ((i < len)) {
            ...
            if (_mv_630.has_value) {
                __auto_type clause_expr = _mv_630.value;
                __auto_type _mv_631 = (*clause_expr);
                switch (_mv_631.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type clause_lst = _mv_631.data.lst;
                        {
                            ...
                            if ((clause_len < 1)) {
                                ...
                                __auto_type _mv_632 = ({ __auto_type _lst = clause_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_632.has_value) {
                                    __auto_type test_expr = _mv_632.value;
                                    __auto_type _mv_633 = (*test_expr);
                                    switch (_mv_633.tag) {
                                        case types_SExpr_sym:
                                        {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while ((i < len)) {
            ...
            if (_mv_634.has_value) {
                __auto_type body_expr = _mv_634.value;
                {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len < 2)) {
            ...
            if (_mv_635.has_value) {
                __auto_type size_expr = _mv_635.value;
                {
            ...
            context_ctx_bind_var(ctx, (context_VarEntry){SLOP_STR("arena"), SLOP_STR("arena"), SLOP_STR("slop_arena*"), SLOP_STR(""), 1, 0, 0, SLOP_STR(""), SLOP_STR("")});
            {
                __auto_type i = 2;
                while ((i < len)) {
                    __auto_type _mv_636 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_636.has_value) {
                        __auto_type body_expr = _mv_636.value;
                        {
                            __auto_type is_last = (i == (len - 1));
            ...
            __auto_type lst = _mv_638.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    if (_mv_639.has_value) {
                        __auto_type head = _mv_639.value;
                        __auto_type _mv_640 = (*head);
                        switch (_mv_640.tag) {
                            case types_SExpr_sym:
                            {
                                __auto_type sym = _mv_640.data.sym;
                                {
                                    ...
                                    if (string_eq(op, SLOP_STR("some"))) {
                                        __auto_type _mv_641 = context_ctx_get_current_return_type(ctx);
                                        if (_mv_641.has_value) {
                                            __auto_type ret_type = _mv_641.value;
                                            if (strlib_starts_with(ret_type, SLOP_STR("slop_option_"))) {
                                                if ((((int64_t)((items).len)) < 2)) {
                                                    match_emit_return_typed(ctx, expr_transpile_expr(ctx, expr));
                                                } else {
                                                    __auto_type _mv_642 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_642.has_value) {
                                                        __auto_type inner_expr = _mv_642.value;
                                                        {
                                                            __auto_type inner_c = expr_transpile_expr(ctx, inner_expr);
                                        ...
                                        __auto_type _mv_643 = context_ctx_get_current_return_type(ctx);
                                        if (_mv_643.has_value) {
                                            __auto_type ret_type = _mv_643.value;
                                            if (strlib_starts_with(ret_type, SLOP_STR("slop_option_"))) {
