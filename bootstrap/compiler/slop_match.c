        ...
        while ((i < len) && all_symbols) {
            ...
            if (_mv_651.has_value) {
                ...
                switch (_mv_652.tag) {
                    ...
                    {
                        __auto_type _ = _mv_652.data.sym;
                        break;
                    }
                    default: {
                        all_symbols = 0;
        ...
        while ((i < len) && !(has_literal)) {
            ...
            if (_mv_653.has_value) {
                ...
                switch (_mv_654.tag) {
                    ...
                    {
                        __auto_type _ = _mv_654.data.num;
                        has_literal = 1;
                        break;
                    }
                    case types_SExpr_str:
                    {
                        __auto_type _ = _mv_654.data.str;
                        has_literal = 1;
                        break;
                    }
                    default: {
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_657.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 1) {
                    ...
                    __auto_type _mv_658 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_658.has_value) {
                        __auto_type head = _mv_658.value;
                        __auto_type _mv_659 = (*head);
                        switch (_mv_659.tag) {
                            case types_SExpr_sym:
                            {
            ...
            __auto_type lst = _mv_660.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 2) {
                    ...
                    if (_mv_661.has_value) {
                        __auto_type binding = _mv_661.value;
                        __auto_type _mv_662 = (*binding);
                        switch (_mv_662.tag) {
                            case types_SExpr_sym:
                            {
                ...
                __auto_type lst = _mv_664.data.lst;
                {
                    ...
                    if (len < 3) {
                        ...
                        if (_mv_665.has_value) {
                            __auto_type scrutinee = _mv_665.value;
                            {
...
void match_transpile_option_match(context_TranspileContext* ctx, slop_string scrutinee_c, types_SExpr* scrutinee_expr, slop_list_types_SExpr_ptr patterns, slop_list_types_SExpr_ptr items, uint8_t is_return) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        uint8_t has_else = 0;
        while (i < len) {
            __auto_type _mv_669 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_669.has_value) {
                __auto_type branch = _mv_669.value;
                __auto_type _mv_670 = (*branch);
                switch (_mv_670.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type branch_lst = _mv_670.data.lst;
                        {
                            __auto_type branch_items = branch_lst.items;
                            if (((int64_t)((branch_items).len)) >= 2) {
                                __auto_type _mv_671 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_671.has_value) {
                                    __auto_type pattern = _mv_671.value;
                                    {
...
void match_emit_option_some_branch(context_TranspileContext* ctx, slop_string scrutinee_c, types_SExpr* scrutinee_expr, types_SExpr* pattern, slop_list_types_SExpr_ptr branch_items, uint8_t is_return, uint8_t first) {
    ...
    SLOP_PRE(((pattern != NULL)), "(!= pattern nil)");
    {
        ...
        __auto_type _mv_672 = match_extract_binding_name(pattern);
        if (_mv_672.has_value) {
            __auto_type binding_name = _mv_672.value;
            {
...
void match_transpile_result_match(context_TranspileContext* ctx, slop_string scrutinee_c, types_SExpr* scrutinee_expr, slop_list_types_SExpr_ptr patterns, slop_list_types_SExpr_ptr items, uint8_t is_return) {
    ...
    SLOP_PRE(((scrutinee_expr != NULL)), "(!= scrutinee-expr nil)");
    {
        ...
        uint8_t has_else = 0;
        while (i < len) {
            __auto_type _mv_673 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_673.has_value) {
                __auto_type branch = _mv_673.value;
                __auto_type _mv_674 = (*branch);
                switch (_mv_674.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type branch_lst = _mv_674.data.lst;
                        {
                            __auto_type branch_items = branch_lst.items;
                            if (((int64_t)((branch_items).len)) >= 2) {
                                __auto_type _mv_675 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_675.has_value) {
                                    __auto_type pattern = _mv_675.value;
                                    {
                                        __auto_type tag = match_get_pattern_tag(pattern);
                                        if (string_eq(tag, SLOP_STR("ok"))) {
...
void match_emit_result_ok_branch(context_TranspileContext* ctx, slop_string scrutinee_c, types_SExpr* scrutinee_expr, types_SExpr* pattern, slop_list_types_SExpr_ptr branch_items, uint8_t is_return, uint8_t first) {
    ...
    SLOP_PRE(((pattern != NULL)), "(!= pattern nil)");
    {
        ...
        context_ctx_indent(ctx);
        context_ctx_push_scope(ctx);
        __auto_type _mv_676 = match_extract_binding_name(pattern);
        if (_mv_676.has_value) {
            __auto_type binding_name = _mv_676.value;
            {
                __auto_type c_name = ctype_to_c_name(arena, binding_name);
...
void match_emit_enum_case(context_TranspileContext* ctx, types_SExpr* pattern, slop_list_types_SExpr_ptr branch_items, uint8_t is_return) {
    ...
    SLOP_PRE(((pattern != NULL)), "(!= pattern nil)");
    {
        ...
        if (string_eq(tag, SLOP_STR("else")) || string_eq(tag, SLOP_STR("_"))) {
            ...
            __auto_type _mv_681 = context_ctx_lookup_enum_variant(ctx, tag);
            if (_mv_681.has_value) {
                __auto_type type_name = _mv_681.value;
                {
...
void match_transpile_union_match(context_TranspileContext* ctx, slop_string scrutinee_c, slop_list_types_SExpr_ptr patterns, slop_list_types_SExpr_ptr items, uint8_t is_return) {
    ...
    if (match_has_literal_in_patterns(patterns)) {
    ...
    } else {
        {
            ...
            context_ctx_indent(ctx);
            while (i < len) {
                __auto_type _mv_685 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_685.has_value) {
                    __auto_type branch = _mv_685.value;
                    __auto_type _mv_686 = (*branch);
                    switch (_mv_686.tag) {
                        case types_SExpr_lst:
                        {
                            __auto_type branch_lst = _mv_686.data.lst;
                            {
                                __auto_type branch_items = branch_lst.items;
                                if (((int64_t)((branch_items).len)) >= 2) {
                                    __auto_type _mv_687 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    if (_mv_687.has_value) {
                                        __auto_type pattern = _mv_687.value;
                                        {
                                            __auto_type tag = match_get_pattern_tag(pattern);
                                            if (string_eq(tag, SLOP_STR("else")) || string_eq(tag, SLOP_STR("_"))) {
                                                has_else = 1;
                                                ...
                                                __auto_type _mv_688 = context_ctx_lookup_enum_variant(ctx, tag);
                                                if (_mv_688.has_value) {
                                                    __auto_type union_type_name = _mv_688.value;
    ...
    SLOP_PRE(((pattern != NULL)), "(!= pattern nil)");
    {
        ...
        context_ctx_push_scope(ctx);
        {
            ...
            if (!(string_eq(multi_field_count, SLOP_STR("")))) {
                __auto_type _mv_689 = (*pattern);
                switch (_mv_689.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type pat_lst = _mv_689.data.lst;
                        {
                            __auto_type pat_items = pat_lst.items;
                            __auto_type pat_len = ((int64_t)((pat_items).len));
                            for (int64_t bi = 1; bi < pat_len; bi++) {
                                __auto_type _mv_690 = ({ __auto_type _lst = pat_items; size_t _idx = (size_t)bi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_690.has_value) {
                                    __auto_type binding_expr = _mv_690.value;
                                    {
                ...
                __auto_type _mv_691 = match_extract_binding_name(pattern);
                if (_mv_691.has_value) {
                    __auto_type binding_name = _mv_691.value;
                    {
                        __auto_type c_binding = ctype_to_c_name(arena, binding_name);
...
void match_emit_branch_body(context_TranspileContext* ctx, slop_list_types_SExpr_ptr branch_items, uint8_t is_return) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 1;
        while (i < len) {
            __auto_type _mv_692 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_693.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) < 1) {
                        ...
                        __auto_type _mv_694 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_694.has_value) {
                            __auto_type head_expr = _mv_694.value;
                            __auto_type _mv_695 = (*head_expr);
                            switch (_mv_695.tag) {
                                case types_SExpr_sym:
                                {
...
void match_emit_inline_let(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items, uint8_t is_return, uint8_t is_last) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 2) {
            ...
            context_ctx_indent(ctx);
            context_ctx_push_scope(ctx);
            __auto_type _mv_696 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_696.has_value) {
                __auto_type bindings_expr = _mv_696.value;
            ...
            }
            {
                ...
                while (i < len) {
                    ...
                    if (_mv_697.has_value) {
                        __auto_type body_item = _mv_697.value;
                        {
...
void match_emit_inline_bindings(context_TranspileContext* ctx, types_SExpr* bindings_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_698 = (*bindings_expr);
        switch (_mv_698.tag) {
            case types_SExpr_lst:
            {
                __auto_type bindings_lst = _mv_698.data.lst;
                {
                    __auto_type bindings = bindings_lst.items;
                    __auto_type len = ((int64_t)((bindings).len));
                    __auto_type i = 0;
                    while (i < len) {
                        __auto_type _mv_699 = ({ __auto_type _lst = bindings; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_699.has_value) {
                            __auto_type binding = _mv_699.value;
...
void match_emit_single_inline_binding(context_TranspileContext* ctx, types_SExpr* binding) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_700 = (*binding);
        switch (_mv_700.tag) {
            case types_SExpr_lst:
            {
                __auto_type binding_lst = _mv_700.data.lst;
                {
                    ...
                    __auto_type len = ((int64_t)((items).len));
                    {
                        ...
                        if ((len - start_idx) < 2) {
                            ...
                            __auto_type _mv_701 = ({ __auto_type _lst = items; size_t _idx = (size_t)start_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_701.has_value) {
                                __auto_type name_expr = _mv_701.value;
                                __auto_type _mv_702 = (*name_expr);
                                switch (_mv_702.tag) {
                                    case types_SExpr_sym:
                                    {
                                        __auto_type name_sym = _mv_702.data.sym;
                                        {
                                            ...
                                            if ((len - start_idx) >= 3) {
                                                {
                                                    ...
                                                    if (_mv_703.has_value) {
                                                        ...
                                                        if (match_is_type_expr(type_expr)) {
                                                            ...
                                                            __auto_type _mv_705 = ({ __auto_type _lst = items; size_t _idx = (size_t)type_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            ...
                                            } else {
                                                {
                                                    ...
                                                    __auto_type _mv_707 = ({ __auto_type _lst = items; size_t _idx = (size_t)val_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_707.has_value) {
                                                        __auto_type val_expr = _mv_707.value;
                                                        {
                                                            __auto_type val_c = expr_transpile_expr(ctx, val_expr);
                                                            __auto_type inferred_slop_type = expr_infer_expr_slop_type(ctx, val_expr);
                                                            __auto_type ptr_type_opt = match_get_arena_alloc_ptr_type_inline(ctx, val_expr);
                                                            __auto_type _mv_708 = ptr_type_opt;
                                                            if (_mv_708.has_value) {
                                                                __auto_type ptr_type = _mv_708.value;
                                                                context_ctx_emit(ctx, context_ctx_str4(ctx, SLOP_STR("__auto_type "), c_name, SLOP_STR(" = "), context_ctx_str(ctx, val_c, SLOP_STR(";"))));
                                                                context_ctx_bind_var(ctx, (context_VarEntry){raw_name, c_name, ptr_type, inferred_slop_type, 1, has_mut, 0, SLOP_STR(""), SLOP_STR("")});
...
uint8_t match_is_type_expr(types_SExpr* expr) {
    ...
    switch (_mv_711.tag) {
        ...
        case types_SExpr_lst:
        {
            __auto_type _ = _mv_711.data.lst;
            return 1;
        }
        default: {
            return 0;
                ...
                __auto_type lst = _mv_715.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) >= 3) {
                        ...
                        if (_mv_716.has_value) {
                            __auto_type head_ptr = _mv_716.value;
                            __auto_type _mv_717 = (*head_ptr);
                            switch (_mv_717.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type head_sym = _mv_717.data.sym;
        ...
        switch (_mv_719.tag) {
            case types_SExpr_sym:
            {
                __auto_type sym = _mv_719.data.sym;
                {
                    ...
                    __auto_type _mv_720 = context_ctx_lookup_type(ctx, type_name);
                    if (_mv_720.has_value) {
                        __auto_type entry = _mv_720.value;
                                ...
                                case types_SExpr_sym:
                                {
                                    ...
                                    if (string_eq(head_sym.name, SLOP_STR("sizeof"))) {
                                        ...
                                        if (_mv_723.has_value) {
                                            __auto_type type_expr = _mv_723.value;
                                            {
                                                __auto_type c_type = context_to_c_type_prefixed(ctx, type_expr);
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_724.has_value) {
                __auto_type item = _mv_724.value;
                {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 3) {
            ...
            if (_mv_726.has_value) {
                __auto_type then_expr = _mv_726.value;
            ...
            if (len >= 4) {
                context_ctx_emit(ctx, SLOP_STR("} else {"));
                context_ctx_indent(ctx);
                __auto_type _mv_727 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_727.has_value) {
                    __auto_type else_expr = _mv_727.value;
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (expr_set_is_self_assign(items)) {
            ...
            if (_mv_735.has_value) {
                __auto_type target_expr = _mv_735.value;
                ...
                if (_mv_736.has_value) {
                    __auto_type field_expr = _mv_736.value;
                    __auto_type _mv_737 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_737.has_value) {
                        __auto_type type_expr = _mv_737.value;
                        __auto_type _mv_738 = ({ __auto_type _lst = items; size_t _idx = (size_t)4; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_738.has_value) {
                            __auto_type value_expr = _mv_738.value;
                            {
                                ...
                                __auto_type c_type = ctype_to_c_type(arena, type_expr);
                                {
                                    ...
                                    if (strlib_starts_with(c_type, SLOP_STR("slop_option_"))) {
                                        if (match_is_none_form_inline(value_expr)) {
                                            ...
                                            __auto_type _mv_739 = match_get_some_value_inline(value_expr);
                                            if (_mv_739.has_value) {
                                                __auto_type inner_val = _mv_739.value;
                                                {
            ...
            if (_mv_740.has_value) {
                ...
                if (_mv_741.has_value) {
                    ...
                    if (_mv_742.has_value) {
                        __auto_type value_expr = _mv_742.value;
                        {
                            __auto_type field_name = match_get_field_name_inline(ctx, field_expr);
            ...
            if (_mv_743.has_value) {
                __auto_type target_expr = _mv_743.value;
                ...
                if (_mv_744.has_value) {
                    __auto_type val_expr = _mv_744.value;
                    {
                        ...
                        if (_mv_745.has_value) {
                            ...
                            {
                                __auto_type some_val_opt = match_get_some_value_inline(val_expr);
                                __auto_type _mv_747 = some_val_opt;
                                if (_mv_747.has_value) {
                                    __auto_type inner_expr = _mv_747.value;
                                    {
                                        __auto_type inner_c = expr_transpile_expr(ctx, inner_expr);
                                    ...
                                    if (match_is_none_form_inline(val_expr)) {
                                        __auto_type _mv_748 = context_ctx_get_current_return_type(ctx);
                                        if (_mv_748.has_value) {
                                            __auto_type ret_type = _mv_748.value;
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_752.data.lst;
            {
                ...
                if (_mv_753.has_value) {
                    __auto_type inner = _mv_753.value;
...
void match_emit_inline_cond(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items, uint8_t is_return, uint8_t is_last) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        uint8_t has_else = 0;
        while (i < len) {
            __auto_type _mv_756 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_756.has_value) {
                __auto_type clause_expr = _mv_756.value;
                __auto_type _mv_757 = (*clause_expr);
                switch (_mv_757.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type clause_lst = _mv_757.data.lst;
                        {
                            ...
                            if (clause_len < 1) {
                                ...
                                __auto_type _mv_758 = ({ __auto_type _lst = clause_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_758.has_value) {
                                    __auto_type test_expr = _mv_758.value;
                                    __auto_type _mv_759 = (*test_expr);
                                    switch (_mv_759.tag) {
                                        case types_SExpr_sym:
                                        {
        ...
        if (len < 2) {
        ...
        } else {
            {
                ...
                if (is_named && (len < 4)) {
                    ...
                    context_ctx_indent(ctx);
                    context_ctx_push_scope(ctx);
                    __auto_type _mv_761 = ({ __auto_type _lst = items; size_t _idx = (size_t)size_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_761.has_value) {
                        __auto_type size_expr = _mv_761.value;
                        {
                    ...
                    context_ctx_bind_var(ctx, (context_VarEntry){arena_name, c_arena_name, SLOP_STR("slop_arena*"), SLOP_STR(""), 1, 0, 0, SLOP_STR(""), SLOP_STR("")});
                    {
                        ...
                        while (i < len) {
                            ...
                            if (_mv_762.has_value) {
                                __auto_type body_expr = _mv_762.value;
                                {
                                    __auto_type is_last = (i == (len - 1));
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 2) {
            ...
            if (_mv_764.has_value) {
                ...
                __auto_type _mv_765 = (*binding_expr);
                switch (_mv_765.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type binding_lst = _mv_765.data.lst;
                        {
                            ...
                            if (binding_len < 3) {
                                ...
                                __auto_type _mv_766 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_766.has_value) {
                                    __auto_type var_expr = _mv_766.value;
                                    __auto_type _mv_767 = (*var_expr);
                                    switch (_mv_767.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type var_sym = _mv_767.data.sym;
                                            {
                                                __auto_type var_name = ctype_to_c_name(arena, var_sym.name);
                                                __auto_type _mv_768 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_768.has_value) {
                                                    __auto_type start_expr = _mv_768.value;
                                                    __auto_type _mv_769 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_769.has_value) {
                                                        __auto_type end_expr = _mv_769.value;
                                                        {
...
void match_emit_inline_for_each_map_kv(context_TranspileContext* ctx, slop_list_types_SExpr_ptr binding_items, slop_list_types_SExpr_ptr items, int64_t len) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_770 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        if (_mv_770.has_value) {
            __auto_type kv_list_expr = _mv_770.value;
            __auto_type _mv_771 = (*kv_list_expr);
            switch (_mv_771.tag) {
                case types_SExpr_lst:
                {
                    __auto_type kv_lst = _mv_771.data.lst;
                    {
                        __auto_type kv_items = kv_lst.items;
                        if (((int64_t)((kv_items).len)) < 2) {
                            context_ctx_add_error(ctx, SLOP_STR("Map for-each needs ((k v) map)"));
                        } else {
                            __auto_type _mv_772 = ({ __auto_type _lst = kv_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_772.has_value) {
                                __auto_type k_expr = _mv_772.value;
                                __auto_type _mv_773 = ({ __auto_type _lst = kv_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_773.has_value) {
                                    __auto_type v_expr = _mv_773.value;
                                    ...
                                    if (_mv_774.has_value) {
                                        __auto_type map_expr = _mv_774.value;
                                        __auto_type _mv_775 = (*k_expr);
                                        switch (_mv_775.tag) {
                                            case types_SExpr_sym:
                                            {
                                                __auto_type k_sym = _mv_775.data.sym;
                                                __auto_type _mv_776 = (*v_expr);
                                                switch (_mv_776.tag) {
                                                    case types_SExpr_sym:
                                                    {
                                                        __auto_type v_sym = _mv_776.data.sym;
                                                        {
                        ...
                        __auto_type binding_lst = _mv_778.data.lst;
                        {
                            ...
                            if (binding_len < 2) {
                                ...
                                if (_mv_779.has_value) {
                                    __auto_type first_elem = _mv_779.value;
                                    __auto_type _mv_780 = (*first_elem);
                                    switch (_mv_780.tag) {
                                        case types_SExpr_lst:
                                        {
                                            __auto_type _ = _mv_780.data.lst;
                                        ...
                                        case types_SExpr_sym:
                                        {
                                            __auto_type var_sym = _mv_780.data.sym;
                                            {
                                                ...
                                                if (_mv_781.has_value) {
                                                    __auto_type coll_expr = _mv_781.value;
                                                    {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 2) {
            ...
            if (_mv_782.has_value) {
                __auto_type val_expr = _mv_782.value;
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_783.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 1) {
                    ...
                    __auto_type _mv_784 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_784.has_value) {
                        __auto_type head = _mv_784.value;
                        __auto_type _mv_785 = (*head);
                        switch (_mv_785.tag) {
                            case types_SExpr_sym:
                            {
                                __auto_type sym = _mv_785.data.sym;
                                {
                                    ...
                                    if (string_eq(op, SLOP_STR("some"))) {
                                            ...
                                            if (strlib_starts_with(ret_type, SLOP_STR("slop_option_"))) {
                                                if (((int64_t)((items).len)) < 2) {
                                                    ...
                                                    if (_mv_787.has_value) {
                                                        __auto_type inner_expr = _mv_787.value;
                                                        {
                                                            __auto_type inner_c = expr_transpile_expr(ctx, inner_expr);
                                        ...
                                        __auto_type _mv_788 = context_ctx_get_current_return_type(ctx);
                                        if (_mv_788.has_value) {
                                            __auto_type ret_type = _mv_788.value;
                                            if (strlib_starts_with(ret_type, SLOP_STR("slop_option_"))) {
...
uint8_t match_is_pattern_literal(types_SExpr* expr) {
    ...
    switch (_mv_789.tag) {
        case types_SExpr_sym:
        {
            __auto_type sym = _mv_789.data.sym;
            {
                __auto_type name = sym.name;
        ...
        case types_SExpr_num:
        {
            __auto_type _ = _mv_789.data.num;
            return 1;
        }
        default: {
            return 0;
...
slop_string match_pattern_literal_to_c(types_SExpr* expr) {
    ...
    switch (_mv_790.tag) {
        ...
        case types_SExpr_num:
        {
            __auto_type n = _mv_790.data.num;
            return n.raw;
        }
        default: {
            return SLOP_STR("");
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_791.data.lst;
            {
                ...
                for (int64_t i = 1; i < len; i++) {
                    if (!(found)) {
                        __auto_type _mv_792 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
uint8_t match_has_literal_in_patterns(slop_list_types_SExpr_ptr patterns) {
    {
        ...
        int64_t i = 0;
        while ((i < len) && !(found)) {
            __auto_type _mv_793 = ({ __auto_type _lst = patterns; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_793.has_value) {
                __auto_type pat_expr = _mv_793.value;
...
void match_emit_union_literal_bindings(context_TranspileContext* ctx, slop_string scrutinee_c, types_SExpr* pattern, slop_string tag, slop_string union_type_name, slop_string c_tag, uint8_t is_multi) {
    ...
    SLOP_PRE(((pattern != NULL)), "(!= pattern nil)");
    {
        __auto_type arena = (*ctx).arena;
        if (is_multi) {
            __auto_type _mv_796 = (*pattern);
            switch (_mv_796.tag) {
                case types_SExpr_lst:
                {
                    __auto_type pat_lst = _mv_796.data.lst;
                    {
                        __auto_type pat_items = pat_lst.items;
                        __auto_type pat_len = ((int64_t)((pat_items).len));
                        for (int64_t bi = 1; bi < pat_len; bi++) {
                            __auto_type _mv_797 = ({ __auto_type _lst = pat_items; size_t _idx = (size_t)bi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            ...
            __auto_type _mv_798 = match_extract_binding_name(pattern);
            if (_mv_798.has_value) {
                __auto_type binding_name = _mv_798.value;
...
void match_transpile_union_match_with_literals(context_TranspileContext* ctx, slop_string scrutinee_c, slop_list_types_SExpr_ptr patterns, slop_list_types_SExpr_ptr items, uint8_t is_return) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        uint8_t has_else = 0;
        while (i < len) {
            __auto_type _mv_799 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_799.has_value) {
                __auto_type branch = _mv_799.value;
                __auto_type _mv_800 = (*branch);
                switch (_mv_800.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type branch_lst = _mv_800.data.lst;
                        {
                            __auto_type branch_items = branch_lst.items;
                            if (((int64_t)((branch_items).len)) >= 2) {
                                __auto_type _mv_801 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_801.has_value) {
                                    __auto_type pattern = _mv_801.value;
                                    {
                                        __auto_type tag = match_get_pattern_tag(pattern);
                                        if (string_eq(tag, SLOP_STR("else")) || string_eq(tag, SLOP_STR("_"))) {
                                            has_else = 1;
                                            ...
                                            __auto_type _mv_802 = context_ctx_lookup_enum_variant(ctx, tag);
                                            if (_mv_802.has_value) {
                                                __auto_type union_type_name = _mv_802.value;
                                                {
                                                    __auto_type c_tag = ctype_to_c_name(arena, tag);
