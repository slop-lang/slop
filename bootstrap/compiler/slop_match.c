...
uint8_t match_is_option_match(slop_list_types_SExpr_ptr patterns) {
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_654 = ({ __auto_type _lst = patterns; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_654.has_value) {
                __auto_type pat_expr = _mv_654.value;
                {
        ...
        while ((i < len) && all_symbols) {
            ...
            if (_mv_656.has_value) {
                ...
                switch (_mv_657.tag) {
                    ...
                    {
                        __auto_type _ = _mv_657.data.sym;
                        break;
                    }
                    default: {
                        all_symbols = 0;
...
uint8_t match_is_literal_match(slop_list_types_SExpr_ptr patterns) {
    {
        ...
        while ((i < len) && !(has_literal)) {
            __auto_type _mv_658 = ({ __auto_type _lst = patterns; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_658.has_value) {
                __auto_type pat_expr = _mv_658.value;
                __auto_type _mv_659 = (*pat_expr);
                switch (_mv_659.tag) {
                    case types_SExpr_num:
                    {
                        __auto_type _ = _mv_659.data.num;
                        has_literal = 1;
                        break;
                    }
                    case types_SExpr_str:
                    {
                        __auto_type _ = _mv_659.data.str;
                        has_literal = 1;
                        break;
                    }
                    default: {
...
uint8_t match_is_union_match(context_TranspileContext* ctx, slop_list_types_SExpr_ptr patterns) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while ((i < len) && !(has_union_variant)) {
            __auto_type _mv_660 = ({ __auto_type _lst = patterns; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_660.has_value) {
                __auto_type pat_expr = _mv_660.value;
                {
                    __auto_type tag = match_get_pattern_tag(pat_expr);
                    if ((!(string_eq(tag, SLOP_STR("")))) && (!(string_eq(tag, SLOP_STR("some")))) && (!(string_eq(tag, SLOP_STR("none")))) && (!(string_eq(tag, SLOP_STR("ok")))) && (!(string_eq(tag, SLOP_STR("error")))) && (!(string_eq(tag, SLOP_STR("else")))) && (!(string_eq(tag, SLOP_STR("_"))))) {
                        __auto_type _mv_661 = context_ctx_lookup_enum_variant(ctx, tag);
                        if (_mv_661.has_value) {
                            __auto_type _ = _mv_661.value;
                            has_union_variant = 1;
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_662.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 1) {
                    ...
                    __auto_type _mv_663 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
int64_t match_count_pattern_bindings(types_SExpr* pat_expr) {
    SLOP_PRE(((pat_expr != NULL)), "(!= pat-expr nil)");
    __auto_type _mv_668 = (*pat_expr);
    switch (_mv_668.tag) {
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_668.data.lst;
            {
                ...
                __auto_type lst = _mv_669.data.lst;
                {
                    ...
                    if (len < 3) {
                        ...
                        if (_mv_670.has_value) {
                            __auto_type scrutinee = _mv_670.value;
                            {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_674.has_value) {
                __auto_type branch = _mv_674.value;
                __auto_type _mv_675 = (*branch);
                switch (_mv_675.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type branch_lst = _mv_675.data.lst;
                        {
                            __auto_type branch_items = branch_lst.items;
                            if (((int64_t)((branch_items).len)) >= 2) {
                                __auto_type _mv_676 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_676.has_value) {
                                    __auto_type pattern = _mv_676.value;
                                    {
...
void match_emit_option_some_branch(context_TranspileContext* ctx, slop_string scrutinee_c, types_SExpr* scrutinee_expr, types_SExpr* pattern, slop_list_types_SExpr_ptr branch_items, uint8_t is_return, uint8_t first) {
    ...
    SLOP_PRE(((pattern != NULL)), "(!= pattern nil)");
    {
        ...
        __auto_type _mv_677 = match_extract_binding_name(pattern);
        if (_mv_677.has_value) {
            __auto_type binding_name = _mv_677.value;
            {
...
void match_transpile_result_match(context_TranspileContext* ctx, slop_string scrutinee_c, types_SExpr* scrutinee_expr, slop_list_types_SExpr_ptr patterns, slop_list_types_SExpr_ptr items, uint8_t is_return) {
    ...
    SLOP_PRE(((scrutinee_expr != NULL)), "(!= scrutinee-expr nil)");
    {
        ...
        uint8_t has_else = 0;
        while (i < len) {
            __auto_type _mv_678 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_678.has_value) {
                __auto_type branch = _mv_678.value;
                __auto_type _mv_679 = (*branch);
                switch (_mv_679.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type branch_lst = _mv_679.data.lst;
                        {
                            __auto_type branch_items = branch_lst.items;
                            if (((int64_t)((branch_items).len)) >= 2) {
                                __auto_type _mv_680 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_680.has_value) {
                                    __auto_type pattern = _mv_680.value;
                                    {
                                        __auto_type tag = match_get_pattern_tag(pattern);
                                        if (string_eq(tag, SLOP_STR("ok"))) {
...
void match_emit_result_ok_branch(context_TranspileContext* ctx, slop_string scrutinee_c, types_SExpr* scrutinee_expr, types_SExpr* pattern, slop_list_types_SExpr_ptr branch_items, uint8_t is_return, uint8_t first) {
    ...
    SLOP_PRE(((pattern != NULL)), "(!= pattern nil)");
    {
        ...
        context_ctx_indent(ctx);
        context_ctx_push_scope(ctx);
        __auto_type _mv_681 = match_extract_binding_name(pattern);
        if (_mv_681.has_value) {
            __auto_type binding_name = _mv_681.value;
            {
                __auto_type c_name = ctype_to_c_name(arena, binding_name);
    ...
    SLOP_PRE(((pattern != NULL)), "(!= pattern nil)");
    {
        ...
        if (string_eq(tag, SLOP_STR("else")) || string_eq(tag, SLOP_STR("_"))) {
            ...
            if (_mv_686.has_value) {
                __auto_type type_name = _mv_686.value;
                {
...
void match_transpile_union_match(context_TranspileContext* ctx, slop_string scrutinee_c, slop_list_types_SExpr_ptr patterns, slop_list_types_SExpr_ptr items, uint8_t is_return) {
    ...
    if (match_has_literal_in_patterns(patterns)) {
    ...
    } else {
        {
            ...
            context_ctx_indent(ctx);
            while (i < len) {
                __auto_type _mv_690 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_690.has_value) {
                    __auto_type branch = _mv_690.value;
                    __auto_type _mv_691 = (*branch);
                    switch (_mv_691.tag) {
                        case types_SExpr_lst:
                        {
                            __auto_type branch_lst = _mv_691.data.lst;
                            {
                                __auto_type branch_items = branch_lst.items;
                                if (((int64_t)((branch_items).len)) >= 2) {
                                    __auto_type _mv_692 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    if (_mv_692.has_value) {
                                        __auto_type pattern = _mv_692.value;
                                        {
                                            __auto_type tag = match_get_pattern_tag(pattern);
                                            if (string_eq(tag, SLOP_STR("else")) || string_eq(tag, SLOP_STR("_"))) {
                                                has_else = 1;
                                                ...
                                                __auto_type _mv_693 = context_ctx_lookup_enum_variant(ctx, tag);
                                                if (_mv_693.has_value) {
                                                    __auto_type union_type_name = _mv_693.value;
    ...
    SLOP_PRE(((pattern != NULL)), "(!= pattern nil)");
    {
        ...
        context_ctx_push_scope(ctx);
        {
            ...
            if (!(string_eq(multi_field_count, SLOP_STR("")))) {
                __auto_type _mv_694 = (*pattern);
                switch (_mv_694.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type pat_lst = _mv_694.data.lst;
                        {
                            __auto_type pat_items = pat_lst.items;
                            __auto_type pat_len = ((int64_t)((pat_items).len));
                            for (int64_t bi = 1; bi < pat_len; bi++) {
                                __auto_type _mv_695 = ({ __auto_type _lst = pat_items; size_t _idx = (size_t)bi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                ...
                __auto_type _mv_696 = match_extract_binding_name(pattern);
                if (_mv_696.has_value) {
                    __auto_type binding_name = _mv_696.value;
                    {
                        __auto_type c_binding = ctype_to_c_name(arena, binding_name);
...
void match_emit_branch_body(context_TranspileContext* ctx, slop_list_types_SExpr_ptr branch_items, uint8_t is_return) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 1;
        while (i < len) {
            __auto_type _mv_697 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_697.has_value) {
                __auto_type body_expr = _mv_697.value;
                {
                ...
                __auto_type lst = _mv_698.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) < 1) {
                        ...
                        if (_mv_699.has_value) {
                            __auto_type head_expr = _mv_699.value;
                            __auto_type _mv_700 = (*head_expr);
                            switch (_mv_700.tag) {
                                case types_SExpr_sym:
                                {
            ...
            }
            {
                ...
                while (i < len) {
                    ...
                    if (_mv_702.has_value) {
                        __auto_type body_item = _mv_702.value;
                        {
...
void match_emit_inline_bindings(context_TranspileContext* ctx, types_SExpr* bindings_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_703 = (*bindings_expr);
        switch (_mv_703.tag) {
            case types_SExpr_lst:
            {
                __auto_type bindings_lst = _mv_703.data.lst;
                {
                    __auto_type bindings = bindings_lst.items;
                    __auto_type len = ((int64_t)((bindings).len));
                    __auto_type i = 0;
                    while (i < len) {
                        __auto_type _mv_704 = ({ __auto_type _lst = bindings; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_704.has_value) {
                            __auto_type binding = _mv_704.value;
...
void match_emit_single_inline_binding(context_TranspileContext* ctx, types_SExpr* binding) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_705 = (*binding);
        switch (_mv_705.tag) {
            case types_SExpr_lst:
            {
                __auto_type binding_lst = _mv_705.data.lst;
                {
                    ...
                    __auto_type len = ((int64_t)((items).len));
                    {
                        ...
                        if ((len - start_idx) < 2) {
                            ...
                            __auto_type _mv_706 = ({ __auto_type _lst = items; size_t _idx = (size_t)start_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_706.has_value) {
                                __auto_type name_expr = _mv_706.value;
                                __auto_type _mv_707 = (*name_expr);
                                switch (_mv_707.tag) {
                                    case types_SExpr_sym:
                                    {
                                        __auto_type name_sym = _mv_707.data.sym;
                                        {
                                            ...
                                            if ((len - start_idx) >= 3) {
                                                {
                                                    ...
                                                    __auto_type _mv_708 = ({ __auto_type _lst = items; size_t _idx = (size_t)type_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_708.has_value) {
                                                        __auto_type type_expr = _mv_708.value;
                                                        if (match_is_type_expr(type_expr)) {
                                                            __auto_type _mv_709 = ({ __auto_type _lst = items; size_t _idx = (size_t)val_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                            if (_mv_709.has_value) {
                                                                __auto_type val_expr = _mv_709.value;
                                                                {
                                                            ...
                                                            __auto_type _mv_710 = ({ __auto_type _lst = items; size_t _idx = (size_t)type_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                            if (_mv_710.has_value) {
                                                                __auto_type val_expr = _mv_710.value;
                                                                {
                                                                    ...
                                                                    __auto_type _mv_711 = ptr_type_opt;
                                                                    if (_mv_711.has_value) {
                                                                        __auto_type ptr_type = _mv_711.value;
                                            ...
                                            } else {
                                                {
                                                    ...
                                                    __auto_type _mv_712 = ({ __auto_type _lst = items; size_t _idx = (size_t)val_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_712.has_value) {
                                                        __auto_type val_expr = _mv_712.value;
                                                        {
                                                            __auto_type val_c = expr_transpile_expr(ctx, val_expr);
                                                            __auto_type inferred_slop_type = expr_infer_expr_slop_type(ctx, val_expr);
                                                            __auto_type ptr_type_opt = match_get_arena_alloc_ptr_type_inline(ctx, val_expr);
                                                            __auto_type _mv_713 = ptr_type_opt;
                                                            if (_mv_713.has_value) {
                                                                __auto_type ptr_type = _mv_713.value;
                                                                context_ctx_emit(ctx, context_ctx_str4(ctx, SLOP_STR("__auto_type "), c_name, SLOP_STR(" = "), context_ctx_str(ctx, val_c, SLOP_STR(";"))));
                                                                context_ctx_bind_var(ctx, (context_VarEntry){raw_name, c_name, ptr_type, inferred_slop_type, 1, has_mut, 0, SLOP_STR(""), SLOP_STR("")});
...
uint8_t match_binding_starts_with_mut(slop_list_types_SExpr_ptr items) {
    if (((int64_t)((items).len)) < 1) {
        ...
        if (_mv_714.has_value) {
            __auto_type first = _mv_714.value;
            __auto_type _mv_715 = (*first);
            switch (_mv_715.tag) {
                case types_SExpr_sym:
                {
...
uint8_t match_is_type_expr(types_SExpr* expr) {
    ...
    switch (_mv_716.tag) {
        ...
        case types_SExpr_lst:
        {
            __auto_type _ = _mv_716.data.lst;
            return 1;
        }
        default: {
            return 0;
            ...
            __auto_type lst = _mv_717.data.lst;
            {
                ...
                if (((int64_t)((items).len)) == 1) {
                    ...
                    if (_mv_718.has_value) {
                        __auto_type head = _mv_718.value;
                        __auto_type _mv_719 = (*head);
                        switch (_mv_719.tag) {
                            case types_SExpr_sym:
                            {
                ...
                __auto_type lst = _mv_720.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) >= 3) {
                        ...
                        if (_mv_721.has_value) {
                            __auto_type head_ptr = _mv_721.value;
                            __auto_type _mv_722 = (*head_ptr);
                            switch (_mv_722.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type head_sym = _mv_722.data.sym;
                                    if (string_eq(head_sym.name, SLOP_STR("arena-alloc"))) {
                                        ...
                                        if (_mv_723.has_value) {
                                            __auto_type size_expr = _mv_723.value;
        ...
        switch (_mv_724.tag) {
            case types_SExpr_sym:
            {
                __auto_type sym = _mv_724.data.sym;
                {
                    ...
                    __auto_type _mv_725 = context_ctx_lookup_type(ctx, type_name);
                    if (_mv_725.has_value) {
                        __auto_type entry = _mv_725.value;
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_724.data.lst;
                {
                    __auto_type items = lst.items;
                    if (((int64_t)((items).len)) >= 2) {
                        __auto_type _mv_726 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_726.has_value) {
                            __auto_type head_ptr = _mv_726.value;
                            __auto_type _mv_727 = (*head_ptr);
                            switch (_mv_727.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type head_sym = _mv_727.data.sym;
                                    if (string_eq(head_sym.name, SLOP_STR("sizeof"))) {
                                        ...
                                        if (_mv_728.has_value) {
                                            __auto_type type_expr = _mv_728.value;
                                            {
                                                __auto_type c_type = context_to_c_type_prefixed(ctx, type_expr);
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_729.has_value) {
                __auto_type item = _mv_729.value;
                {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 3) {
            ...
            if (_mv_730.has_value) {
                __auto_type cond_expr = _mv_730.value;
                {
            ...
            context_ctx_indent(ctx);
            __auto_type _mv_731 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_731.has_value) {
                __auto_type then_expr = _mv_731.value;
            ...
            if (len >= 4) {
                context_ctx_emit(ctx, SLOP_STR("} else {"));
                context_ctx_indent(ctx);
                __auto_type _mv_732 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_732.has_value) {
                    __auto_type else_expr = _mv_732.value;
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 3) {
            ...
            if (_mv_733.has_value) {
                __auto_type cond_expr = _mv_733.value;
                {
                    __auto_type cond_c = context_ctx_strip_cond_parens(ctx, expr_transpile_expr(ctx, cond_expr));
...
slop_option_string match_get_var_c_type_inline(context_TranspileContext* ctx, types_SExpr* expr) {
    ...
    switch (_mv_734.tag) {
        case types_SExpr_sym:
        {
            ...
            {
                __auto_type name = sym.name;
                __auto_type _mv_735 = context_ctx_lookup_var(ctx, name);
                if (_mv_735.has_value) {
                    __auto_type var_entry = _mv_735.value;
...
slop_option_types_SExpr_ptr match_get_some_value_inline(types_SExpr* expr) {
    SLOP_PRE(((expr != NULL)), "(!= expr nil)");
    {
        ...
        switch (_mv_736.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_736.data.lst;
                {
                    __auto_type items = lst.items;
                    if (((int64_t)((items).len)) >= 2) {
                        __auto_type _mv_737 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_737.has_value) {
                            __auto_type head = _mv_737.value;
                            __auto_type _mv_738 = (*head);
                            switch (_mv_738.tag) {
                                case types_SExpr_sym:
                                {
        ...
        if (expr_set_is_self_assign(items)) {
            ...
            if (_mv_740.has_value) {
                ...
                if (_mv_741.has_value) {
                    __auto_type field_expr = _mv_741.value;
                    __auto_type _mv_742 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_742.has_value) {
                        __auto_type type_expr = _mv_742.value;
                        __auto_type _mv_743 = ({ __auto_type _lst = items; size_t _idx = (size_t)4; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_743.has_value) {
                            __auto_type value_expr = _mv_743.value;
                            {
                                ...
                                __auto_type c_type = ctype_to_c_type(arena, type_expr);
                                {
                                    ...
                                    if (context_ctx_is_option_c_type(ctx, c_type)) {
                                        if (match_is_none_form_inline(value_expr)) {
                                            ...
                                            __auto_type _mv_744 = match_get_some_value_inline(value_expr);
                                            if (_mv_744.has_value) {
                                                __auto_type inner_val = _mv_744.value;
                                                {
            ...
            if (_mv_745.has_value) {
                __auto_type target_expr = _mv_745.value;
                __auto_type _mv_746 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_746.has_value) {
                    __auto_type field_expr = _mv_746.value;
                    __auto_type _mv_747 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_747.has_value) {
                        __auto_type value_expr = _mv_747.value;
                        {
                            __auto_type field_name = match_get_field_name_inline(ctx, field_expr);
            ...
            __auto_type _mv_748 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_748.has_value) {
                __auto_type target_expr = _mv_748.value;
                __auto_type _mv_749 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_749.has_value) {
                    __auto_type val_expr = _mv_749.value;
                    {
                        __auto_type target_c = expr_transpile_expr(ctx, target_expr);
                        __auto_type target_type_opt = match_get_var_c_type_inline(ctx, target_expr);
                        __auto_type _mv_750 = target_type_opt;
                        if (_mv_750.has_value) {
                            __auto_type target_type = _mv_750.value;
                            if (context_ctx_is_option_c_type(ctx, target_type)) {
                                {
                                    __auto_type some_val_opt = match_get_some_value_inline(val_expr);
                                    __auto_type _mv_751 = some_val_opt;
                                    if (_mv_751.has_value) {
                                        __auto_type inner_expr = _mv_751.value;
                                        {
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_754.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 2) {
                    ...
                    __auto_type _mv_755 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_757.data.lst;
            {
                ...
                if (_mv_758.has_value) {
                    __auto_type inner = _mv_758.value;
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 2) {
            ...
            if (_mv_760.has_value) {
                __auto_type cond_expr = _mv_760.value;
                {
                    __auto_type cond_c = context_ctx_strip_cond_parens(ctx, expr_transpile_expr(ctx, cond_expr));
                    context_ctx_emit(ctx, context_ctx_str3(ctx, SLOP_STR("if ("), cond_c, SLOP_STR(") {")));
                }
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_761.has_value) {
                __auto_type clause_expr = _mv_761.value;
                __auto_type _mv_762 = (*clause_expr);
                switch (_mv_762.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type clause_lst = _mv_762.data.lst;
                        {
                            ...
                            if (clause_len < 1) {
                                ...
                                __auto_type _mv_763 = ({ __auto_type _lst = clause_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_763.has_value) {
                                    __auto_type test_expr = _mv_763.value;
                                    __auto_type _mv_764 = (*test_expr);
                                    switch (_mv_764.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type sym = _mv_764.data.sym;
...
void match_emit_inline_cond_body(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items, int64_t start, uint8_t is_return, uint8_t is_last) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = start;
        while (i < len) {
            __auto_type _mv_765 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        if (len < 2) {
        ...
        } else {
            {
                ...
                if (is_named && (len < 4)) {
                    ...
                    context_ctx_indent(ctx);
                    context_ctx_push_scope(ctx);
                    __auto_type _mv_766 = ({ __auto_type _lst = items; size_t _idx = (size_t)size_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_766.has_value) {
                        __auto_type size_expr = _mv_766.value;
                        {
                    ...
                    context_ctx_bind_var(ctx, (context_VarEntry){arena_name, c_arena_name, SLOP_STR("slop_arena*"), SLOP_STR(""), 1, 0, 0, SLOP_STR(""), SLOP_STR("")});
                    {
                        ...
                        while (i < len) {
                            ...
                            if (_mv_767.has_value) {
                                __auto_type body_expr = _mv_767.value;
                                {
                                    __auto_type is_last = (i == (len - 1));
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 2) {
            ...
            if (_mv_769.has_value) {
                __auto_type binding_expr = _mv_769.value;
                __auto_type _mv_770 = (*binding_expr);
                switch (_mv_770.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type binding_lst = _mv_770.data.lst;
                        {
                            ...
                            if (binding_len < 3) {
                                ...
                                __auto_type _mv_771 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_771.has_value) {
                                    __auto_type var_expr = _mv_771.value;
                                    __auto_type _mv_772 = (*var_expr);
                                    switch (_mv_772.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type var_sym = _mv_772.data.sym;
                                            {
                                                __auto_type var_name = ctype_to_c_name(arena, var_sym.name);
                                                __auto_type _mv_773 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_773.has_value) {
                                                    __auto_type start_expr = _mv_773.value;
                                                    __auto_type _mv_774 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_774.has_value) {
                                                        __auto_type end_expr = _mv_774.value;
                                                        {
...
void match_emit_inline_for_each_map_kv(context_TranspileContext* ctx, slop_list_types_SExpr_ptr binding_items, slop_list_types_SExpr_ptr items, int64_t len) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_775 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        if (_mv_775.has_value) {
            __auto_type kv_list_expr = _mv_775.value;
            __auto_type _mv_776 = (*kv_list_expr);
            switch (_mv_776.tag) {
                case types_SExpr_lst:
                {
                    __auto_type kv_lst = _mv_776.data.lst;
                    {
                        __auto_type kv_items = kv_lst.items;
                        if (((int64_t)((kv_items).len)) < 2) {
                            context_ctx_add_error(ctx, SLOP_STR("Map for-each needs ((k v) map)"));
                        } else {
                            __auto_type _mv_777 = ({ __auto_type _lst = kv_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_777.has_value) {
                                __auto_type k_expr = _mv_777.value;
                                __auto_type _mv_778 = ({ __auto_type _lst = kv_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_778.has_value) {
                                    __auto_type v_expr = _mv_778.value;
                                    ...
                                    if (_mv_779.has_value) {
                                        __auto_type map_expr = _mv_779.value;
                                        __auto_type _mv_780 = (*k_expr);
                                        switch (_mv_780.tag) {
                                            case types_SExpr_sym:
                                            {
                                                __auto_type k_sym = _mv_780.data.sym;
                                                __auto_type _mv_781 = (*v_expr);
                                                switch (_mv_781.tag) {
                                                    case types_SExpr_sym:
                                                    {
                                                        __auto_type v_sym = _mv_781.data.sym;
                                                        {
                        ...
                        __auto_type binding_lst = _mv_783.data.lst;
                        {
                            ...
                            if (binding_len < 2) {
                                ...
                                if (_mv_784.has_value) {
                                    __auto_type first_elem = _mv_784.value;
                                    __auto_type _mv_785 = (*first_elem);
                                    switch (_mv_785.tag) {
                                        case types_SExpr_lst:
                                        {
                                            __auto_type _ = _mv_785.data.lst;
                                        ...
                                        case types_SExpr_sym:
                                        {
                                            __auto_type var_sym = _mv_785.data.sym;
                                            {
                                                ...
                                                if (_mv_786.has_value) {
                                                    __auto_type coll_expr = _mv_786.value;
                                                    {
...
void match_emit_inline_return(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 2) {
            ...
            __auto_type _mv_787 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_787.has_value) {
                __auto_type val_expr = _mv_787.value;
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_788.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 1) {
                    ...
                    __auto_type _mv_789 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_789.has_value) {
                        __auto_type head = _mv_789.value;
                        __auto_type _mv_790 = (*head);
                        switch (_mv_790.tag) {
                            case types_SExpr_sym:
                            {
                                __auto_type sym = _mv_790.data.sym;
                                {
                                    ...
                                    if (string_eq(op, SLOP_STR("some"))) {
                                        __auto_type _mv_791 = context_ctx_get_current_return_type(ctx);
                                        if (_mv_791.has_value) {
                                            ...
                                            if (context_ctx_is_option_c_type(ctx, ret_type)) {
                                                if (((int64_t)((items).len)) < 2) {
                                                    ...
                                                    __auto_type _mv_792 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_792.has_value) {
                                                        __auto_type inner_expr = _mv_792.value;
                                                        {
                                                            __auto_type inner_c = expr_transpile_expr(ctx, inner_expr);
                                        ...
                                        __auto_type _mv_793 = context_ctx_get_current_return_type(ctx);
                                        if (_mv_793.has_value) {
                                            __auto_type ret_type = _mv_793.value;
                                            if (context_ctx_is_option_c_type(ctx, ret_type)) {
...
uint8_t match_is_pattern_literal(types_SExpr* expr) {
    ...
    switch (_mv_794.tag) {
        ...
        case types_SExpr_num:
        {
            __auto_type _ = _mv_794.data.num;
            return 1;
        }
        default: {
            return 0;
...
slop_string match_pattern_literal_to_c(types_SExpr* expr) {
    ...
    switch (_mv_795.tag) {
        ...
        case types_SExpr_num:
        {
            __auto_type n = _mv_795.data.num;
            return n.raw;
        }
        default: {
            return SLOP_STR("");
                ...
                for (int64_t i = 1; i < len; i++) {
                    if (!(found)) {
                        ...
                        if (_mv_797.has_value) {
                            __auto_type item = _mv_797.value;
...
uint8_t match_has_literal_in_patterns(slop_list_types_SExpr_ptr patterns) {
    {
        ...
        int64_t i = 0;
        while ((i < len) && !(found)) {
            __auto_type _mv_798 = ({ __auto_type _lst = patterns; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_798.has_value) {
                __auto_type pat_expr = _mv_798.value;
...
slop_string match_build_literal_guard_cond(context_TranspileContext* ctx, slop_string scrutinee_c, slop_string c_tag, slop_string tag_cond, types_SExpr* pattern, uint8_t is_multi) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_799 = (*pattern);
        switch (_mv_799.tag) {
            case types_SExpr_lst:
            {
                __auto_type pat_lst = _mv_799.data.lst;
                {
                    __auto_type pat_items = pat_lst.items;
                    __auto_type pat_len = ((int64_t)((pat_items).len));
                    __auto_type cond = tag_cond;
                    for (int64_t bi = 1; bi < pat_len; bi++) {
                        __auto_type _mv_800 = ({ __auto_type _lst = pat_items; size_t _idx = (size_t)bi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_800.has_value) {
                            __auto_type item = _mv_800.value;
                            if (match_is_pattern_literal(item)) {
                                {
...
void match_emit_union_literal_bindings(context_TranspileContext* ctx, slop_string scrutinee_c, types_SExpr* pattern, slop_string tag, slop_string union_type_name, slop_string c_tag, uint8_t is_multi) {
    ...
    SLOP_PRE(((pattern != NULL)), "(!= pattern nil)");
    {
        __auto_type arena = (*ctx).arena;
        if (is_multi) {
            __auto_type _mv_801 = (*pattern);
            switch (_mv_801.tag) {
                case types_SExpr_lst:
                {
                    __auto_type pat_lst = _mv_801.data.lst;
                    {
                        __auto_type pat_items = pat_lst.items;
                        __auto_type pat_len = ((int64_t)((pat_items).len));
                        for (int64_t bi = 1; bi < pat_len; bi++) {
                            __auto_type _mv_802 = ({ __auto_type _lst = pat_items; size_t _idx = (size_t)bi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_802.has_value) {
                                __auto_type binding_expr = _mv_802.value;
            ...
            __auto_type _mv_803 = match_extract_binding_name(pattern);
            if (_mv_803.has_value) {
                __auto_type binding_name = _mv_803.value;
...
void match_transpile_union_match_with_literals(context_TranspileContext* ctx, slop_string scrutinee_c, slop_list_types_SExpr_ptr patterns, slop_list_types_SExpr_ptr items, uint8_t is_return) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        uint8_t has_else = 0;
        while (i < len) {
            __auto_type _mv_804 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_804.has_value) {
                __auto_type branch = _mv_804.value;
                __auto_type _mv_805 = (*branch);
                switch (_mv_805.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type branch_lst = _mv_805.data.lst;
                        {
                            __auto_type branch_items = branch_lst.items;
                            if (((int64_t)((branch_items).len)) >= 2) {
                                __auto_type _mv_806 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_806.has_value) {
                                    __auto_type pattern = _mv_806.value;
                                    {
                                        __auto_type tag = match_get_pattern_tag(pattern);
                                        if (string_eq(tag, SLOP_STR("else")) || string_eq(tag, SLOP_STR("_"))) {
                                            has_else = 1;
                                            ...
                                            __auto_type _mv_807 = context_ctx_lookup_enum_variant(ctx, tag);
                                            if (_mv_807.has_value) {
                                                __auto_type union_type_name = _mv_807.value;
                                                {
                                                    __auto_type c_tag = ctype_to_c_name(arena, tag);
