...
uint8_t match_is_option_match(slop_list_types_SExpr_ptr patterns) {
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_587 = ({ __auto_type _lst = patterns; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_587.has_value) {
                __auto_type pat_expr = _mv_587.value;
                {
...
uint8_t match_is_enum_match(slop_list_types_SExpr_ptr patterns) {
    {
        ...
        while (((i < len) && all_symbols)) {
            __auto_type _mv_589 = ({ __auto_type _lst = patterns; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_589.has_value) {
                __auto_type pat_expr = _mv_589.value;
                __auto_type _mv_590 = (*pat_expr);
                switch (_mv_590.tag) {
                    case types_SExpr_sym:
                    {
                        __auto_type _ = _mv_590.data.sym;
                        break;
                    }
                    default: {
                        all_symbols = 0;
...
uint8_t match_is_literal_match(slop_list_types_SExpr_ptr patterns) {
    {
        ...
        while (((i < len) && !(has_literal))) {
            __auto_type _mv_591 = ({ __auto_type _lst = patterns; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_591.has_value) {
                __auto_type pat_expr = _mv_591.value;
                __auto_type _mv_592 = (*pat_expr);
                switch (_mv_592.tag) {
                    case types_SExpr_num:
                    {
                        __auto_type _ = _mv_592.data.num;
                        has_literal = 1;
                        break;
                    }
                    case types_SExpr_str:
                    {
                        __auto_type _ = _mv_592.data.str;
                        has_literal = 1;
                        break;
                    }
                    default: {
...
uint8_t match_is_union_match(context_TranspileContext* ctx, slop_list_types_SExpr_ptr patterns) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (((i < len) && !(has_union_variant))) {
            __auto_type _mv_593 = ({ __auto_type _lst = patterns; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_593.has_value) {
                __auto_type pat_expr = _mv_593.value;
                {
                    __auto_type tag = match_get_pattern_tag(pat_expr);
                    if (((!(string_eq(tag, SLOP_STR("")))) && (!(string_eq(tag, SLOP_STR("some")))) && (!(string_eq(tag, SLOP_STR("none")))) && (!(string_eq(tag, SLOP_STR("ok")))) && (!(string_eq(tag, SLOP_STR("error")))) && (!(string_eq(tag, SLOP_STR("else")))) && (!(string_eq(tag, SLOP_STR("_")))))) {
                        __auto_type _mv_594 = context_ctx_lookup_enum_variant(ctx, tag);
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_595.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    __auto_type _mv_596 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_598.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 2)) {
                    ...
                    __auto_type _mv_599 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_601.data.lst;
                {
                    ...
                    if ((len < 3)) {
                        ...
                        __auto_type _mv_602 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_602.has_value) {
                            __auto_type scrutinee = _mv_602.value;
                            {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while ((i < len)) {
            ...
            if (_mv_603.has_value) {
                __auto_type branch = _mv_603.value;
                __auto_type _mv_604 = (*branch);
                switch (_mv_604.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type branch_lst = _mv_604.data.lst;
                        {
                            __auto_type branch_items = branch_lst.items;
                            if ((((int64_t)((branch_items).len)) >= 1)) {
                                __auto_type _mv_605 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_605.has_value) {
                                    __auto_type pattern = _mv_605.value;
...
void match_transpile_option_match(context_TranspileContext* ctx, slop_string scrutinee_c, types_SExpr* scrutinee_expr, slop_list_types_SExpr_ptr patterns, slop_list_types_SExpr_ptr items, uint8_t is_return) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        uint8_t first = 1;
        while ((i < len)) {
            __auto_type _mv_606 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_606.has_value) {
                __auto_type branch = _mv_606.value;
                __auto_type _mv_607 = (*branch);
                switch (_mv_607.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type branch_lst = _mv_607.data.lst;
                        {
                            __auto_type branch_items = branch_lst.items;
                            if ((((int64_t)((branch_items).len)) >= 2)) {
                                __auto_type _mv_608 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_608.has_value) {
                                    __auto_type pattern = _mv_608.value;
                                    {
...
void match_emit_result_ok_branch(context_TranspileContext* ctx, slop_string scrutinee_c, types_SExpr* scrutinee_expr, types_SExpr* pattern, slop_list_types_SExpr_ptr branch_items, uint8_t is_return, uint8_t first) {
    ...
    SLOP_PRE(((pattern != NULL)), "(!= pattern nil)");
    {
        ...
        context_ctx_indent(ctx);
        context_ctx_push_scope(ctx);
        __auto_type _mv_613 = match_extract_binding_name(pattern);
        if (_mv_613.has_value) {
            __auto_type binding_name = _mv_613.value;
            {
                __auto_type c_name = ctype_to_c_name(arena, binding_name);
...
void match_emit_result_error_branch(context_TranspileContext* ctx, slop_string scrutinee_c, types_SExpr* scrutinee_expr, types_SExpr* pattern, slop_list_types_SExpr_ptr branch_items, uint8_t is_return, uint8_t first) {
    ...
    SLOP_PRE(((pattern != NULL)), "(!= pattern nil)");
    {
        ...
        context_ctx_indent(ctx);
        context_ctx_push_scope(ctx);
        __auto_type _mv_614 = match_extract_binding_name(pattern);
        if (_mv_614.has_value) {
            __auto_type binding_name = _mv_614.value;
            {
                __auto_type c_name = ctype_to_c_name(arena, binding_name);
...
void match_transpile_enum_match(context_TranspileContext* ctx, slop_string scrutinee_c, slop_list_types_SExpr_ptr items, uint8_t is_return) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        context_ctx_indent(ctx);
        while ((i < len)) {
            __auto_type _mv_615 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_615.has_value) {
                __auto_type branch = _mv_615.value;
                __auto_type _mv_616 = (*branch);
                switch (_mv_616.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type branch_lst = _mv_616.data.lst;
                        {
                            __auto_type branch_items = branch_lst.items;
                            if ((((int64_t)((branch_items).len)) >= 2)) {
                                __auto_type _mv_617 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_617.has_value) {
                                    __auto_type pattern = _mv_617.value;
    ...
    SLOP_PRE(((pattern != NULL)), "(!= pattern nil)");
    {
        ...
        if (string_eq(tag, SLOP_STR("else"))) {
            ...
            if (_mv_618.has_value) {
                __auto_type type_name = _mv_618.value;
                {
...
void match_transpile_literal_match(context_TranspileContext* ctx, slop_string scrutinee_c, slop_list_types_SExpr_ptr items, uint8_t is_return) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        uint8_t first = 1;
        while ((i < len)) {
            __auto_type _mv_619 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_619.has_value) {
                __auto_type branch = _mv_619.value;
                __auto_type _mv_620 = (*branch);
                switch (_mv_620.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type branch_lst = _mv_620.data.lst;
                        {
                            __auto_type branch_items = branch_lst.items;
                            if ((((int64_t)((branch_items).len)) >= 2)) {
                                __auto_type _mv_621 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_621.has_value) {
                                    __auto_type pattern = _mv_621.value;
...
void match_transpile_union_match(context_TranspileContext* ctx, slop_string scrutinee_c, slop_list_types_SExpr_ptr patterns, slop_list_types_SExpr_ptr items, uint8_t is_return) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        context_ctx_indent(ctx);
        while ((i < len)) {
            __auto_type _mv_622 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_622.has_value) {
                __auto_type branch = _mv_622.value;
                __auto_type _mv_623 = (*branch);
                switch (_mv_623.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type branch_lst = _mv_623.data.lst;
                        {
                            __auto_type branch_items = branch_lst.items;
                            if ((((int64_t)((branch_items).len)) >= 2)) {
                                __auto_type _mv_624 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_624.has_value) {
                                    __auto_type pattern = _mv_624.value;
                                    {
                                        __auto_type tag = match_get_pattern_tag(pattern);
                                        if ((string_eq(tag, SLOP_STR("else")) || string_eq(tag, SLOP_STR("_")))) {
                                            ...
                                            if (_mv_625.has_value) {
                                                __auto_type union_type_name = _mv_625.value;
...
void match_emit_union_case(context_TranspileContext* ctx, slop_string scrutinee_c, types_SExpr* pattern, slop_string tag, slop_string union_type_name, slop_list_types_SExpr_ptr branch_items, uint8_t is_return) {
    ...
    SLOP_PRE(((pattern != NULL)), "(!= pattern nil)");
    {
        ...
        context_ctx_indent(ctx);
        context_ctx_push_scope(ctx);
        __auto_type _mv_626 = match_extract_binding_name(pattern);
        if (_mv_626.has_value) {
            __auto_type binding_name = _mv_626.value;
            {
...
void match_emit_branch_body(context_TranspileContext* ctx, slop_list_types_SExpr_ptr branch_items, uint8_t is_return) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 1;
        while ((i < len)) {
            __auto_type _mv_627 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_627.has_value) {
                __auto_type body_expr = _mv_627.value;
                {
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_628.data.lst;
                {
                    ...
                    if ((((int64_t)((items).len)) < 1)) {
                        ...
                        __auto_type _mv_629 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_629.has_value) {
                            __auto_type head_expr = _mv_629.value;
                            __auto_type _mv_630 = (*head_expr);
                            switch (_mv_630.tag) {
                                case types_SExpr_sym:
                                {
...
void match_emit_inline_let(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items, uint8_t is_return, uint8_t is_last) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len < 2)) {
            ...
            context_ctx_indent(ctx);
            context_ctx_push_scope(ctx);
            __auto_type _mv_631 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_631.has_value) {
                __auto_type bindings_expr = _mv_631.value;
            ...
            }
            {
                ...
                while ((i < len)) {
                    ...
                    if (_mv_632.has_value) {
                        __auto_type body_item = _mv_632.value;
                        {
...
void match_emit_inline_bindings(context_TranspileContext* ctx, types_SExpr* bindings_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_633 = (*bindings_expr);
        switch (_mv_633.tag) {
            case types_SExpr_lst:
            {
                __auto_type bindings_lst = _mv_633.data.lst;
                {
                    __auto_type bindings = bindings_lst.items;
                    __auto_type len = ((int64_t)((bindings).len));
                    __auto_type i = 0;
                    while ((i < len)) {
                        __auto_type _mv_634 = ({ __auto_type _lst = bindings; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_634.has_value) {
                            __auto_type binding = _mv_634.value;
                ...
                __auto_type binding_lst = _mv_635.data.lst;
                {
                    ...
                    __auto_type len = ((int64_t)((items).len));
                    {
                        ...
                        if (((len - start_idx) < 2)) {
                            ...
                            __auto_type _mv_636 = ({ __auto_type _lst = items; size_t _idx = (size_t)start_idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_636.has_value) {
                                __auto_type name_expr = _mv_636.value;
                                __auto_type _mv_637 = (*name_expr);
                                switch (_mv_637.tag) {
                                    case types_SExpr_sym:
                                    {
                                        __auto_type name_sym = _mv_637.data.sym;
                                        {
                                            ...
                                            if (((len - start_idx) >= 3)) {
                                                {
                                                    ...
                                                    __auto_type _mv_638 = ({ __auto_type _lst = items; size_t _idx = (size_t)type_idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_638.has_value) {
                                                        __auto_type type_expr = _mv_638.value;
                                                        if (match_is_type_expr(type_expr)) {
                                                            __auto_type _mv_639 = ({ __auto_type _lst = items; size_t _idx = (size_t)val_idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                            if (_mv_639.has_value) {
                                                                __auto_type val_expr = _mv_639.value;
                                                                {
                                                            ...
                                                            __auto_type _mv_640 = ({ __auto_type _lst = items; size_t _idx = (size_t)type_idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                            if (_mv_640.has_value) {
                                                                __auto_type val_expr = _mv_640.value;
                                                                {
                                                                    ...
                                                                    __auto_type _mv_641 = ptr_type_opt;
                                                                    if (_mv_641.has_value) {
                                                                        __auto_type ptr_type = _mv_641.value;
                                            ...
                                            } else {
                                                {
                                                    ...
                                                    __auto_type _mv_642 = ({ __auto_type _lst = items; size_t _idx = (size_t)val_idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_642.has_value) {
                                                        __auto_type val_expr = _mv_642.value;
                                                        {
                                                            __auto_type val_c = expr_transpile_expr(ctx, val_expr);
                                                            __auto_type inferred_slop_type = expr_infer_expr_slop_type(ctx, val_expr);
                                                            __auto_type ptr_type_opt = match_get_arena_alloc_ptr_type_inline(ctx, val_expr);
                                                            __auto_type _mv_643 = ptr_type_opt;
                                                            if (_mv_643.has_value) {
                                                                __auto_type ptr_type = _mv_643.value;
                                                                context_ctx_emit(ctx, context_ctx_str4(ctx, SLOP_STR("__auto_type "), c_name, SLOP_STR(" = "), context_ctx_str(ctx, val_c, SLOP_STR(";"))));
                                                                context_ctx_bind_var(ctx, (context_VarEntry){raw_name, c_name, ptr_type, inferred_slop_type, 1, has_mut, 0, SLOP_STR(""), SLOP_STR("")});
...
uint8_t match_binding_starts_with_mut(slop_list_types_SExpr_ptr items) {
    if ((((int64_t)((items).len)) < 1)) {
        ...
        __auto_type _mv_644 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        if (_mv_644.has_value) {
            __auto_type first = _mv_644.value;
            __auto_type _mv_645 = (*first);
            switch (_mv_645.tag) {
                case types_SExpr_sym:
                {
...
uint8_t match_is_type_expr(types_SExpr* expr) {
    ...
    switch (_mv_646.tag) {
        ...
        case types_SExpr_lst:
        {
            __auto_type _ = _mv_646.data.lst;
            return 1;
        }
        default: {
            return 0;
    ...
    switch (_mv_647.tag) {
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_647.data.lst;
            {
                __auto_type items = lst.items;
                if ((((int64_t)((items).len)) == 1)) {
                    __auto_type _mv_648 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            ...
                            switch (_mv_652.tag) {
                                case types_SExpr_sym:
                                {
                                    ...
                                    if (string_eq(head_sym.name, SLOP_STR("arena-alloc"))) {
                                        __auto_type _mv_653 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_653.has_value) {
                                            __auto_type size_expr = _mv_653.value;
        ...
        switch (_mv_654.tag) {
            case types_SExpr_sym:
            {
                __auto_type sym = _mv_654.data.sym;
                {
                    ...
                    __auto_type _mv_655 = context_ctx_lookup_type(ctx, type_name);
                    if (_mv_655.has_value) {
                        __auto_type entry = _mv_655.value;
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_654.data.lst;
                {
                    __auto_type items = lst.items;
                    if ((((int64_t)((items).len)) >= 2)) {
                        __auto_type _mv_656 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_656.has_value) {
                            __auto_type head_ptr = _mv_656.value;
                            __auto_type _mv_657 = (*head_ptr);
                            switch (_mv_657.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type head_sym = _mv_657.data.sym;
                                    if (string_eq(head_sym.name, SLOP_STR("sizeof"))) {
                                        ...
                                        if (_mv_658.has_value) {
                                            __auto_type type_expr = _mv_658.value;
                                            {
                                                __auto_type c_type = context_to_c_type_prefixed(ctx, type_expr);
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while ((i < len)) {
            ...
            if (_mv_659.has_value) {
                __auto_type item = _mv_659.value;
                {
...
void match_emit_inline_if(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items, uint8_t is_return) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len < 3)) {
            ...
            __auto_type _mv_660 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_660.has_value) {
                __auto_type cond_expr = _mv_660.value;
                {
            ...
            context_ctx_indent(ctx);
            __auto_type _mv_661 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_661.has_value) {
                __auto_type then_expr = _mv_661.value;
            ...
            if ((len >= 4)) {
                context_ctx_emit(ctx, SLOP_STR("} else {"));
                context_ctx_indent(ctx);
                __auto_type _mv_662 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_662.has_value) {
                    __auto_type else_expr = _mv_662.value;
...
void match_emit_inline_while(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len < 3)) {
            ...
            __auto_type _mv_663 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_663.has_value) {
                __auto_type cond_expr = _mv_663.value;
                {
                    __auto_type cond_c = expr_transpile_expr(ctx, cond_expr);
...
slop_option_string match_get_var_c_type_inline(context_TranspileContext* ctx, types_SExpr* expr) {
    ...
    switch (_mv_665.tag) {
        case types_SExpr_sym:
        {
            ...
            {
                __auto_type name = sym.name;
                __auto_type _mv_666 = context_ctx_lookup_var(ctx, name);
                if (_mv_666.has_value) {
                    __auto_type var_entry = _mv_666.value;
                            ...
                            switch (_mv_669.tag) {
                                case types_SExpr_sym:
                                {
                                    ...
                                    if (string_eq(sym.name, SLOP_STR("some"))) {
                                        __auto_type _mv_670 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_670.has_value) {
                                            __auto_type val = _mv_670.value;
...
void match_emit_inline_set(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len == 5)) {
            ...
            if (_mv_671.has_value) {
                ...
                if (_mv_672.has_value) {
                    ...
                    if (_mv_673.has_value) {
                        __auto_type type_expr = _mv_673.value;
                        __auto_type _mv_674 = ({ __auto_type _lst = items; size_t _idx = (size_t)4; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_674.has_value) {
                            __auto_type value_expr = _mv_674.value;
                            {
                                ...
                                __auto_type c_type = ctype_to_c_type(arena, type_expr);
                                {
                                    ...
                                    if (strlib_starts_with(c_type, SLOP_STR("slop_option_"))) {
                                        if (match_is_none_form_inline(value_expr)) {
                                            ...
                                            __auto_type _mv_675 = match_get_some_value_inline(value_expr);
                                            if (_mv_675.has_value) {
                                                __auto_type inner_val = _mv_675.value;
                                                {
            ...
            __auto_type _mv_676 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_676.has_value) {
                __auto_type target_expr = _mv_676.value;
                ...
                if (_mv_677.has_value) {
                    __auto_type field_expr = _mv_677.value;
                    __auto_type _mv_678 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_678.has_value) {
                        __auto_type value_expr = _mv_678.value;
                        {
                            __auto_type field_name = match_get_field_name_inline(ctx, field_expr);
            ...
            __auto_type _mv_679 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_679.has_value) {
                __auto_type target_expr = _mv_679.value;
                __auto_type _mv_680 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_680.has_value) {
                    __auto_type val_expr = _mv_680.value;
                    {
                        ...
                        if (_mv_681.has_value) {
                            ...
                            {
                                __auto_type some_val_opt = match_get_some_value_inline(val_expr);
                                __auto_type _mv_683 = some_val_opt;
                                if (_mv_683.has_value) {
                                    __auto_type inner_expr = _mv_683.value;
                                    {
                                        __auto_type inner_c = expr_transpile_expr(ctx, inner_expr);
                                    ...
                                    if (match_is_none_form_inline(val_expr)) {
                                        __auto_type _mv_684 = context_ctx_get_current_return_type(ctx);
                                        if (_mv_684.has_value) {
                                            __auto_type ret_type = _mv_684.value;
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_688.data.lst;
            {
                ...
                if (_mv_689.has_value) {
                    __auto_type inner = _mv_689.value;
...
void match_emit_inline_cond(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items, uint8_t is_return, uint8_t is_last) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        uint8_t first = 1;
        while ((i < len)) {
            __auto_type _mv_693 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_693.has_value) {
                __auto_type clause_expr = _mv_693.value;
                __auto_type _mv_694 = (*clause_expr);
                switch (_mv_694.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type clause_lst = _mv_694.data.lst;
                        {
                            ...
                            if ((clause_len < 1)) {
                                ...
                                __auto_type _mv_695 = ({ __auto_type _lst = clause_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_695.has_value) {
                                    __auto_type test_expr = _mv_695.value;
                                    __auto_type _mv_696 = (*test_expr);
                                    switch (_mv_696.tag) {
                                        case types_SExpr_sym:
                                        {
        ...
        if ((len < 2)) {
        ...
        } else {
            {
                ...
                if ((is_named && (len < 4))) {
                    ...
                    context_ctx_indent(ctx);
                    context_ctx_push_scope(ctx);
                    __auto_type _mv_698 = ({ __auto_type _lst = items; size_t _idx = (size_t)size_idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_698.has_value) {
                        __auto_type size_expr = _mv_698.value;
                        {
                    ...
                    context_ctx_bind_var(ctx, (context_VarEntry){arena_name, arena_name, SLOP_STR("slop_arena*"), SLOP_STR(""), 1, 0, 0, SLOP_STR(""), SLOP_STR("")});
                    {
                        ...
                        while ((i < len)) {
                            __auto_type _mv_699 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_699.has_value) {
                                __auto_type body_expr = _mv_699.value;
                                {
                                    __auto_type is_last = (i == (len - 1));
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_701.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    __auto_type _mv_702 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_702.has_value) {
                        __auto_type head = _mv_702.value;
                        __auto_type _mv_703 = (*head);
                        switch (_mv_703.tag) {
                            case types_SExpr_sym:
                            {
                                __auto_type sym = _mv_703.data.sym;
                                {
                                    ...
                                    if (string_eq(op, SLOP_STR("some"))) {
                                        __auto_type _mv_704 = context_ctx_get_current_return_type(ctx);
                                        if (_mv_704.has_value) {
                                            __auto_type ret_type = _mv_704.value;
                                            if (strlib_starts_with(ret_type, SLOP_STR("slop_option_"))) {
                                                if ((((int64_t)((items).len)) < 2)) {
                                                    match_emit_return_typed(ctx, expr_transpile_expr(ctx, expr));
                                                } else {
                                        ...
                                        __auto_type _mv_706 = context_ctx_get_current_return_type(ctx);
                                        if (_mv_706.has_value) {
                                            __auto_type ret_type = _mv_706.value;
                                            if (strlib_starts_with(ret_type, SLOP_STR("slop_option_"))) {
