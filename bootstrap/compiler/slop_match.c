...
uint8_t match_is_enum_match(slop_list_types_SExpr_ptr patterns) {
    {
        ...
        while ((i < len) && all_symbols) {
            ...
            if (_mv_647.has_value) {
                ...
                __auto_type _mv_648 = (*pat_expr);
                switch (_mv_648.tag) {
                    case types_SExpr_sym:
                    {
                        __auto_type _ = _mv_648.data.sym;
                        break;
                    }
                    default: {
                        all_symbols = 0;
        ...
        while ((i < len) && !(has_literal)) {
            ...
            if (_mv_649.has_value) {
                ...
                switch (_mv_650.tag) {
                    ...
                    {
                        __auto_type _ = _mv_650.data.num;
                        has_literal = 1;
                        break;
                    }
                    case types_SExpr_str:
                    {
                        __auto_type _ = _mv_650.data.str;
                        has_literal = 1;
                        break;
                    }
                    default: {
            ...
            if (_mv_651.has_value) {
                __auto_type pat_expr = _mv_651.value;
                {
                    ...
                    if ((!(string_eq(tag, SLOP_STR("")))) && (!(string_eq(tag, SLOP_STR("some")))) && (!(string_eq(tag, SLOP_STR("none")))) && (!(string_eq(tag, SLOP_STR("ok")))) && (!(string_eq(tag, SLOP_STR("error")))) && (!(string_eq(tag, SLOP_STR("else")))) && (!(string_eq(tag, SLOP_STR("_"))))) {
                        __auto_type _mv_652 = context_ctx_lookup_enum_variant(ctx, tag);
                        if (_mv_652.has_value) {
                            __auto_type _ = _mv_652.value;
                            has_union_variant = 1;
...
slop_string match_get_pattern_tag(types_SExpr* pat_expr) {
    ...
    __auto_type _mv_653 = (*pat_expr);
    switch (_mv_653.tag) {
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_653.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 1) {
                    ...
                    if (_mv_654.has_value) {
                        __auto_type head = _mv_654.value;
                        __auto_type _mv_655 = (*head);
                        switch (_mv_655.tag) {
                            case types_SExpr_sym:
                            {
        ...
        case types_SExpr_sym:
        {
            __auto_type sym = _mv_653.data.sym;
            return sym.name;
        }
        default: {
            return SLOP_STR("");
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_662.has_value) {
                __auto_type branch = _mv_662.value;
                __auto_type _mv_663 = (*branch);
                switch (_mv_663.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type branch_lst = _mv_663.data.lst;
                        {
                            __auto_type branch_items = branch_lst.items;
                            if (((int64_t)((branch_items).len)) >= 1) {
                                __auto_type _mv_664 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_664.has_value) {
                                    __auto_type pattern = _mv_664.value;
...
void match_emit_enum_case(context_TranspileContext* ctx, types_SExpr* pattern, slop_list_types_SExpr_ptr branch_items, uint8_t is_return) {
    ...
    SLOP_PRE(((pattern != NULL)), "(!= pattern nil)");
    {
        ...
        if (string_eq(tag, SLOP_STR("else")) || string_eq(tag, SLOP_STR("_"))) {
            ...
            __auto_type _mv_677 = context_ctx_lookup_enum_variant(ctx, tag);
            if (_mv_677.has_value) {
                __auto_type type_name = _mv_677.value;
                {
...
void match_transpile_union_match(context_TranspileContext* ctx, slop_string scrutinee_c, slop_list_types_SExpr_ptr patterns, slop_list_types_SExpr_ptr items, uint8_t is_return) {
    ...
    if (match_has_literal_in_patterns(patterns)) {
    ...
    } else {
        {
            ...
            context_ctx_indent(ctx);
            while (i < len) {
                __auto_type _mv_681 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_681.has_value) {
                    __auto_type branch = _mv_681.value;
                    __auto_type _mv_682 = (*branch);
                    switch (_mv_682.tag) {
                        case types_SExpr_lst:
                        {
                            __auto_type branch_lst = _mv_682.data.lst;
                            {
                                __auto_type branch_items = branch_lst.items;
                                if (((int64_t)((branch_items).len)) >= 2) {
                                    __auto_type _mv_683 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    if (_mv_683.has_value) {
                                        __auto_type pattern = _mv_683.value;
                                        {
                                            __auto_type tag = match_get_pattern_tag(pattern);
                                            if (string_eq(tag, SLOP_STR("else")) || string_eq(tag, SLOP_STR("_"))) {
                                                context_ctx_emit(ctx, SLOP_STR("default: {"));
                                                ...
                                                __auto_type _mv_684 = context_ctx_lookup_enum_variant(ctx, tag);
                                                if (_mv_684.has_value) {
                                                    __auto_type union_type_name = _mv_684.value;
    ...
    SLOP_PRE(((pattern != NULL)), "(!= pattern nil)");
    {
        ...
        context_ctx_push_scope(ctx);
        {
            ...
            if (!(string_eq(multi_field_count, SLOP_STR("")))) {
                __auto_type _mv_685 = (*pattern);
                switch (_mv_685.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type pat_lst = _mv_685.data.lst;
                        {
                            __auto_type pat_items = pat_lst.items;
                            __auto_type pat_len = ((int64_t)((pat_items).len));
                            for (int64_t bi = 1; bi < pat_len; bi++) {
                                __auto_type _mv_686 = ({ __auto_type _lst = pat_items; size_t _idx = (size_t)bi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_686.has_value) {
                                    __auto_type binding_expr = _mv_686.value;
                                    {
...
void match_emit_branch_body(context_TranspileContext* ctx, slop_list_types_SExpr_ptr branch_items, uint8_t is_return) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 1;
        while (i < len) {
            __auto_type _mv_688 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_688.has_value) {
                __auto_type body_expr = _mv_688.value;
                {
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_689.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) < 1) {
                        ...
                        __auto_type _mv_690 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_690.has_value) {
                            __auto_type head_expr = _mv_690.value;
                            __auto_type _mv_691 = (*head_expr);
                            switch (_mv_691.tag) {
                                case types_SExpr_sym:
                                {
            ...
            }
            {
                ...
                while (i < len) {
                    ...
                    if (_mv_693.has_value) {
                        __auto_type body_item = _mv_693.value;
                        {
...
void match_emit_inline_bindings(context_TranspileContext* ctx, types_SExpr* bindings_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_694 = (*bindings_expr);
        switch (_mv_694.tag) {
            case types_SExpr_lst:
            {
                __auto_type bindings_lst = _mv_694.data.lst;
                {
                    __auto_type bindings = bindings_lst.items;
                    __auto_type len = ((int64_t)((bindings).len));
                    __auto_type i = 0;
                    while (i < len) {
                        __auto_type _mv_695 = ({ __auto_type _lst = bindings; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_695.has_value) {
                            __auto_type binding = _mv_695.value;
                ...
                __auto_type binding_lst = _mv_696.data.lst;
                {
                    ...
                    __auto_type len = ((int64_t)((items).len));
                    {
                        ...
                        if ((len - start_idx) < 2) {
                            ...
                            __auto_type _mv_697 = ({ __auto_type _lst = items; size_t _idx = (size_t)start_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            ...
                                            if ((len - start_idx) >= 3) {
                                                {
                                                    ...
                                                    __auto_type _mv_699 = ({ __auto_type _lst = items; size_t _idx = (size_t)type_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_699.has_value) {
                                                        __auto_type type_expr = _mv_699.value;
                                                        if (match_is_type_expr(type_expr)) {
                                                            __auto_type _mv_700 = ({ __auto_type _lst = items; size_t _idx = (size_t)val_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                            if (_mv_700.has_value) {
                                                                __auto_type val_expr = _mv_700.value;
                                                                {
                                            ...
                                            } else {
                                                {
                                                    ...
                                                    __auto_type _mv_703 = ({ __auto_type _lst = items; size_t _idx = (size_t)val_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
uint8_t match_binding_starts_with_mut(slop_list_types_SExpr_ptr items) {
    if (((int64_t)((items).len)) < 1) {
        ...
        if (_mv_705.has_value) {
            __auto_type first = _mv_705.value;
            __auto_type _mv_706 = (*first);
            switch (_mv_706.tag) {
                case types_SExpr_sym:
                {
                ...
                __auto_type lst = _mv_711.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) >= 3) {
                        ...
                        if (_mv_712.has_value) {
                            __auto_type head_ptr = _mv_712.value;
                            __auto_type _mv_713 = (*head_ptr);
                            switch (_mv_713.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type head_sym = _mv_713.data.sym;
                                    if (string_eq(head_sym.name, SLOP_STR("arena-alloc"))) {
                                        __auto_type _mv_714 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_714.has_value) {
                                            __auto_type size_expr = _mv_714.value;
        ...
        switch (_mv_715.tag) {
            case types_SExpr_sym:
            {
                __auto_type sym = _mv_715.data.sym;
                {
                    ...
                    __auto_type _mv_716 = context_ctx_lookup_type(ctx, type_name);
                    if (_mv_716.has_value) {
                        __auto_type entry = _mv_716.value;
                ...
                __auto_type lst = _mv_715.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) >= 2) {
                        ...
                        if (_mv_717.has_value) {
                            __auto_type head_ptr = _mv_717.value;
                            __auto_type _mv_718 = (*head_ptr);
                            switch (_mv_718.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type head_sym = _mv_718.data.sym;
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_720.has_value) {
                __auto_type item = _mv_720.value;
                {
...
void match_emit_inline_if(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items, uint8_t is_return) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 3) {
            ...
            context_ctx_indent(ctx);
            __auto_type _mv_722 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_722.has_value) {
                __auto_type then_expr = _mv_722.value;
            ...
            if (len >= 4) {
                context_ctx_emit(ctx, SLOP_STR("} else {"));
                context_ctx_indent(ctx);
                __auto_type _mv_723 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_723.has_value) {
                    __auto_type else_expr = _mv_723.value;
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 3) {
            ...
            if (_mv_724.has_value) {
                __auto_type cond_expr = _mv_724.value;
                {
                    __auto_type cond_c = context_ctx_strip_cond_parens(ctx, expr_transpile_expr(ctx, cond_expr));
...
slop_option_string match_get_var_c_type_inline(context_TranspileContext* ctx, types_SExpr* expr) {
    ...
    switch (_mv_725.tag) {
        case types_SExpr_sym:
        {
            ...
            {
                __auto_type name = sym.name;
                __auto_type _mv_726 = context_ctx_lookup_var(ctx, name);
                if (_mv_726.has_value) {
                    __auto_type var_entry = _mv_726.value;
...
slop_option_types_SExpr_ptr match_get_some_value_inline(types_SExpr* expr) {
    SLOP_PRE(((expr != NULL)), "(!= expr nil)");
    {
        ...
        switch (_mv_727.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_727.data.lst;
                {
                    __auto_type items = lst.items;
                    if (((int64_t)((items).len)) >= 2) {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (expr_set_is_self_assign(items)) {
            ...
            if (_mv_731.has_value) {
                __auto_type target_expr = _mv_731.value;
                ...
                if (_mv_732.has_value) {
                    __auto_type field_expr = _mv_732.value;
                    ...
                    if (_mv_733.has_value) {
                        ...
                        __auto_type _mv_734 = ({ __auto_type _lst = items; size_t _idx = (size_t)4; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                ...
                                __auto_type c_type = ctype_to_c_type(arena, type_expr);
                                {
                                    ...
                                    if (strlib_starts_with(c_type, SLOP_STR("slop_option_"))) {
                                        if (match_is_none_form_inline(value_expr)) {
                                            ...
                                            __auto_type _mv_735 = match_get_some_value_inline(value_expr);
                                            if (_mv_735.has_value) {
                                                __auto_type inner_val = _mv_735.value;
                                                {
            ...
            if (_mv_736.has_value) {
                ...
                __auto_type _mv_737 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_737.has_value) {
                    __auto_type field_expr = _mv_737.value;
                    __auto_type _mv_738 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            ...
            if (_mv_739.has_value) {
                __auto_type target_expr = _mv_739.value;
                        ...
                        } else if (!_mv_741.has_value) {
                            {
                                ...
                                if (_mv_743.has_value) {
                                    ...
                                    if (match_is_none_form_inline(val_expr)) {
                                        __auto_type _mv_744 = context_ctx_get_current_return_type(ctx);
                                        if (_mv_744.has_value) {
                                            __auto_type ret_type = _mv_744.value;
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_748.data.lst;
            {
                ...
                if (_mv_749.has_value) {
                    __auto_type inner = _mv_749.value;
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_752.has_value) {
                __auto_type clause_expr = _mv_752.value;
                __auto_type _mv_753 = (*clause_expr);
                switch (_mv_753.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type clause_lst = _mv_753.data.lst;
                        {
                            ...
                            if (clause_len < 1) {
                                ...
                                __auto_type _mv_754 = ({ __auto_type _lst = clause_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_754.has_value) {
                                    __auto_type test_expr = _mv_754.value;
                                    __auto_type _mv_755 = (*test_expr);
                                    switch (_mv_755.tag) {
                                        case types_SExpr_sym:
                                        {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_756.has_value) {
                __auto_type body_expr = _mv_756.value;
                {
        ...
        if (len < 2) {
        ...
        } else {
            {
                ...
                if (is_named && (len < 4)) {
                    ...
                    context_ctx_indent(ctx);
                    context_ctx_push_scope(ctx);
                    __auto_type _mv_757 = ({ __auto_type _lst = items; size_t _idx = (size_t)size_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_757.has_value) {
                        __auto_type size_expr = _mv_757.value;
                        {
                        ...
                        __auto_type binding_lst = _mv_761.data.lst;
                        {
                            ...
                            if (binding_len < 3) {
                                ...
                                if (_mv_762.has_value) {
                                    __auto_type var_expr = _mv_762.value;
                                    __auto_type _mv_763 = (*var_expr);
                                    switch (_mv_763.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type var_sym = _mv_763.data.sym;
                                            {
                                                ...
                                                if (_mv_764.has_value) {
                                                    __auto_type start_expr = _mv_764.value;
                                                    __auto_type _mv_765 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_765.has_value) {
                                                        __auto_type end_expr = _mv_765.value;
                                                        {
...
void match_emit_inline_for_each_map_kv(context_TranspileContext* ctx, slop_list_types_SExpr_ptr binding_items, slop_list_types_SExpr_ptr items, int64_t len) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (_mv_766.has_value) {
            __auto_type kv_list_expr = _mv_766.value;
            __auto_type _mv_767 = (*kv_list_expr);
            switch (_mv_767.tag) {
                case types_SExpr_lst:
                {
                    __auto_type kv_lst = _mv_767.data.lst;
                    {
                        __auto_type kv_items = kv_lst.items;
                        if (((int64_t)((kv_items).len)) < 2) {
                            context_ctx_add_error(ctx, SLOP_STR("Map for-each needs ((k v) map)"));
                        } else {
                            __auto_type _mv_768 = ({ __auto_type _lst = kv_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_768.has_value) {
                                __auto_type k_expr = _mv_768.value;
                                __auto_type _mv_769 = ({ __auto_type _lst = kv_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_769.has_value) {
                                    __auto_type v_expr = _mv_769.value;
                                    __auto_type _mv_770 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    if (_mv_770.has_value) {
                                        __auto_type map_expr = _mv_770.value;
                                        __auto_type _mv_771 = (*k_expr);
                                        switch (_mv_771.tag) {
                                            case types_SExpr_sym:
                                            {
                                                __auto_type k_sym = _mv_771.data.sym;
                                                __auto_type _mv_772 = (*v_expr);
                                                switch (_mv_772.tag) {
                                                    case types_SExpr_sym:
                                                    {
                                                        __auto_type v_sym = _mv_772.data.sym;
                                                        {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 2) {
            ...
            if (_mv_773.has_value) {
                __auto_type binding_expr = _mv_773.value;
                __auto_type _mv_774 = (*binding_expr);
                switch (_mv_774.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type binding_lst = _mv_774.data.lst;
                        {
                            __auto_type binding_items = binding_lst.items;
                            __auto_type binding_len = ((int64_t)((binding_items).len));
                            if (binding_len < 2) {
                                ...
                                if (_mv_775.has_value) {
                                    __auto_type first_elem = _mv_775.value;
                                    __auto_type _mv_776 = (*first_elem);
                                    switch (_mv_776.tag) {
                                        case types_SExpr_lst:
                                        {
                                            __auto_type _ = _mv_776.data.lst;
                                            match_emit_inline_for_each_map_kv(ctx, binding_items, items, len);
                                            break;
                                        }
                                        case types_SExpr_sym:
                                        {
                                            __auto_type var_sym = _mv_776.data.sym;
                                            {
                                                __auto_type var_name = ctype_to_c_name(arena, var_sym.name);
                                                __auto_type _mv_777 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_777.has_value) {
                                                    __auto_type coll_expr = _mv_777.value;
                                                    {
...
void match_emit_inline_return(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 2) {
            ...
            __auto_type _mv_778 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_779.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 1) {
                    ...
                    __auto_type _mv_780 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_780.has_value) {
                        __auto_type head = _mv_780.value;
                        __auto_type _mv_781 = (*head);
                        switch (_mv_781.tag) {
                            case types_SExpr_sym:
                            {
                                            ...
                                            if (strlib_starts_with(ret_type, SLOP_STR("slop_option_"))) {
                                                if (((int64_t)((items).len)) < 2) {
                                                    ...
                                                    if (_mv_783.has_value) {
                                                        __auto_type inner_expr = _mv_783.value;
                                                        {
                                                            __auto_type inner_c = expr_transpile_expr(ctx, inner_expr);
...
uint8_t match_is_pattern_literal(types_SExpr* expr) {
    ...
    switch (_mv_785.tag) {
        ...
        case types_SExpr_num:
        {
            __auto_type _ = _mv_785.data.num;
            return 1;
        }
        default: {
            return 0;
...
slop_string match_pattern_literal_to_c(types_SExpr* expr) {
    ...
    switch (_mv_786.tag) {
        ...
        case types_SExpr_num:
        {
            __auto_type n = _mv_786.data.num;
            return n.raw;
        }
        default: {
            return SLOP_STR("");
...
uint8_t match_has_literal_in_union_arm(types_SExpr* pat_expr) {
    SLOP_PRE(((pat_expr != NULL)), "(!= pat-expr nil)");
    __auto_type _mv_787 = (*pat_expr);
    switch (_mv_787.tag) {
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_787.data.lst;
            {
                __auto_type items = lst.items;
                __auto_type len = ((int64_t)((items).len));
                __auto_type found = 0;
                for (int64_t i = 1; i < len; i++) {
                    if (!(found)) {
                        ...
                        if (_mv_788.has_value) {
                            __auto_type item = _mv_788.value;
...
uint8_t match_has_literal_in_patterns(slop_list_types_SExpr_ptr patterns) {
    {
        ...
        int64_t i = 0;
        while ((i < len) && !(found)) {
            __auto_type _mv_789 = ({ __auto_type _lst = patterns; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_789.has_value) {
                __auto_type pat_expr = _mv_789.value;
...
slop_string match_build_literal_guard_cond(context_TranspileContext* ctx, slop_string scrutinee_c, slop_string c_tag, slop_string tag_cond, types_SExpr* pattern, uint8_t is_multi) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_790 = (*pattern);
        switch (_mv_790.tag) {
            case types_SExpr_lst:
            {
                __auto_type pat_lst = _mv_790.data.lst;
                {
                    __auto_type pat_items = pat_lst.items;
                    __auto_type pat_len = ((int64_t)((pat_items).len));
                    __auto_type cond = tag_cond;
                    for (int64_t bi = 1; bi < pat_len; bi++) {
                        __auto_type _mv_791 = ({ __auto_type _lst = pat_items; size_t _idx = (size_t)bi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_791.has_value) {
                            __auto_type item = _mv_791.value;
                            if (match_is_pattern_literal(item)) {
                                {
...
void match_emit_union_literal_bindings(context_TranspileContext* ctx, slop_string scrutinee_c, types_SExpr* pattern, slop_string tag, slop_string union_type_name, slop_string c_tag, uint8_t is_multi) {
    ...
    SLOP_PRE(((pattern != NULL)), "(!= pattern nil)");
    {
        ...
        if (is_multi) {
                    ...
                    __auto_type pat_lst = _mv_792.data.lst;
                    {
                        ...
                        for (int64_t bi = 1; bi < pat_len; bi++) {
                            ...
                            if (_mv_793.has_value) {
                                __auto_type binding_expr = _mv_793.value;
            ...
            __auto_type _mv_794 = match_extract_binding_name(pattern);
            if (_mv_794.has_value) {
                __auto_type binding_name = _mv_794.value;
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_795.has_value) {
                __auto_type branch = _mv_795.value;
                __auto_type _mv_796 = (*branch);
                switch (_mv_796.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type branch_lst = _mv_796.data.lst;
                        {
                            __auto_type branch_items = branch_lst.items;
                            if (((int64_t)((branch_items).len)) >= 2) {
                                __auto_type _mv_797 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_797.has_value) {
                                    __auto_type pattern = _mv_797.value;
                                    {
                                        __auto_type tag = match_get_pattern_tag(pattern);
                                        if (string_eq(tag, SLOP_STR("else")) || string_eq(tag, SLOP_STR("_"))) {
                                            if (first) {
                                            ...
                                            __auto_type _mv_798 = context_ctx_lookup_enum_variant(ctx, tag);
                                            if (_mv_798.has_value) {
                                                __auto_type union_type_name = _mv_798.value;
                                                {
                                                    __auto_type c_tag = ctype_to_c_name(arena, tag);
