...
slop_string context_strip_module_prefix(slop_arena* arena, slop_string type_name) {
    __auto_type _mv_62 = strlib_index_of(type_name, SLOP_STR("_"));
    if (_mv_62.has_value) {
        __auto_type pos = _mv_62.value;
        {
...
slop_list_context_FieldEntry context_ctx_get_fields_for_type(context_TranspileContext* ctx, slop_string type_name) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        __auto_type i = 0;
        while ((i < len)) {
            __auto_type _mv_66 = ({ __auto_type _lst = all_fields; size_t _idx = (size_t)i; slop_option_context_FieldEntry _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_66.has_value) {
...
uint8_t context_ctx_is_pointer_var(context_TranspileContext* ctx, slop_string name) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        __auto_type found = 0;
        while (((i < len) && !(found))) {
            __auto_type _mv_67 = ({ __auto_type _lst = vars; size_t _idx = (size_t)i; slop_option_string _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_67.has_value) {
                __auto_type v = _mv_67.value;
                if (string_eq(v, name)) {
                    found = 1;
                }
...
slop_string context_ctx_prefix_type(context_TranspileContext* ctx, slop_string type_name) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (context_ctx_prefixing_enabled(ctx)) {
            __auto_type _mv_68 = context_ctx_get_module(ctx);
            if (_mv_68.has_value) {
                __auto_type mod_name = _mv_68.value;
                {
...
void context_ctx_add_include(context_TranspileContext* ctx, slop_string header) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        __auto_type found = 0;
        while (((i < len) && !(found))) {
            __auto_type _mv_69 = ({ __auto_type _lst = (*ctx).includes; size_t _idx = (size_t)i; slop_option_string _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_69.has_value) {
                __auto_type h = _mv_69.value;
...
uint8_t context_ctx_is_type_emitted(context_TranspileContext* ctx, slop_string type_name) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        __auto_type found = 0;
        while (((i < len) && !(found))) {
            __auto_type _mv_70 = ({ __auto_type _lst = types; size_t _idx = (size_t)i; slop_option_string _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_70.has_value) {
                __auto_type t = _mv_70.value;
...
slop_option_string context_ctx_lookup_enum_variant(context_TranspileContext* ctx, slop_string variant_name) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        slop_option_string result = (slop_option_string){.has_value = false};
        while (((i < len) && ({ __auto_type _mv = result; _mv.has_value ? ({ __auto_type _ = _mv.value; 0; }) : (1); }))) {
            __auto_type _mv_71 = ({ __auto_type _lst = variants; size_t _idx = (size_t)i; slop_option_context_EnumVariant _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_71.has_value) {
...
slop_list_context_UnionVariantEntry context_ctx_get_union_variants(context_TranspileContext* ctx, slop_string union_name) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        __auto_type i = 0;
        while ((i < len)) {
            __auto_type _mv_72 = ({ __auto_type _lst = all_variants; size_t _idx = (size_t)i; slop_option_context_UnionVariantEntry _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_72.has_value) {
...
uint8_t context_ctx_has_result_type(context_TranspileContext* ctx, slop_string c_name) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        __auto_type found = 0;
        while (((i < len) && !(found))) {
            __auto_type _mv_73 = ({ __auto_type _lst = types; size_t _idx = (size_t)i; slop_option_context_ResultType _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_73.has_value) {
...
uint8_t context_ctx_has_option_type(context_TranspileContext* ctx, slop_string c_name) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        __auto_type found = 0;
        while (((i < len) && !(found))) {
            __auto_type _mv_74 = ({ __auto_type _lst = types; size_t _idx = (size_t)i; slop_option_context_OptionType _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_74.has_value) {
...
uint8_t context_ctx_has_list_type(context_TranspileContext* ctx, slop_string c_name) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        __auto_type found = 0;
        while (((i < len) && !(found))) {
            __auto_type _mv_75 = ({ __auto_type _lst = types; size_t _idx = (size_t)i; slop_option_context_ListType _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_75.has_value) {
...
uint8_t context_ctx_has_chan_type(context_TranspileContext* ctx, slop_string c_name) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        __auto_type found = 0;
        while (((i < len) && !(found))) {
            __auto_type _mv_76 = ({ __auto_type _lst = types; size_t _idx = (size_t)i; slop_option_context_ChanType _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_76.has_value) {
...
uint8_t context_ctx_has_thread_type(context_TranspileContext* ctx, slop_string c_name) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        __auto_type found = 0;
        while (((i < len) && !(found))) {
            __auto_type _mv_77 = ({ __auto_type _lst = types; size_t _idx = (size_t)i; slop_option_context_ThreadType _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_77.has_value) {
...
slop_option_string context_ctx_lookup_result_type_alias(context_TranspileContext* ctx, slop_string alias_name) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        slop_option_string result = (slop_option_string){.has_value = false};
        while (((i < len) && ({ __auto_type _mv = result; _mv.has_value ? ({ __auto_type _ = _mv.value; 0; }) : (1); }))) {
            __auto_type _mv_78 = ({ __auto_type _lst = aliases; size_t _idx = (size_t)i; slop_option_context_ResultTypeAlias _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_78.has_value) {
...
slop_string context_extract_fn_c_name(slop_arena* arena, slop_list_types_SExpr_ptr items, slop_string default_name) {
    {
        ...
        while ((i < len)) {
            __auto_type _mv_79 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_79.has_value) {
                __auto_type item_expr = _mv_79.value;
                __auto_type _mv_80 = (*item_expr);
                switch (_mv_80.tag) {
                    case types_SExpr_sym:
                    {
                        __auto_type sym = _mv_80.data.sym;
                        if (string_eq(sym.name, SLOP_STR(":c-name"))) {
                            __auto_type _mv_81 = ({ __auto_type _lst = items; size_t _idx = (size_t)(i + 1); slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_81.has_value) {
                                __auto_type c_name_expr = _mv_81.value;
                                __auto_type _mv_82 = (*c_name_expr);
                                switch (_mv_82.tag) {
                                    case types_SExpr_str:
                                    {
                                        __auto_type str = _mv_82.data.str;
                                        c_name = str.value;
                                        found_c_name = 1;
                                        break;
                                    }
...
void context_ctx_add_import(context_TranspileContext* ctx, slop_string mod_name) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        __auto_type found = 0;
        while (((i < len) && !(found))) {
            __auto_type _mv_83 = ({ __auto_type _lst = imports; size_t _idx = (size_t)i; slop_option_string _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_83.has_value) {
                __auto_type m = _mv_83.value;
...
void context_ctx_register_inline_record(context_TranspileContext* ctx, slop_string type_name, slop_string field_body) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        __auto_type found = 0;
        while (((i < len) && !(found))) {
            __auto_type _mv_84 = ({ __auto_type _lst = records; size_t _idx = (size_t)i; slop_option_context_InlineRecord _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_84.has_value) {
                __auto_type r = _mv_84.value;
...
slop_string context_to_c_type_prefixed(context_TranspileContext* ctx, types_SExpr* type_expr) {
    ...
    SLOP_PRE(((type_expr != NULL)), "(!= type-expr nil)");
    {
        ...
        switch (_mv_85.tag) {
            case types_SExpr_sym:
            {
                __auto_type sym = _mv_85.data.sym;
                {
                    ...
                    if (ctype_is_builtin_c_type(base_c_type)) {
                        ...
                        __auto_type _mv_86 = context_ctx_lookup_type(ctx, name);
                        if (_mv_86.has_value) {
            ...
            case types_SExpr_str:
            {
                __auto_type _ = _mv_85.data.str;
                return SLOP_STR("void*");
            }
            case types_SExpr_num:
            {
                __auto_type _ = _mv_85.data.num;
                return SLOP_STR("void*");
            }
        }
    }
...
slop_option_string context_get_array_pointer_type(context_TranspileContext* ctx, types_SExpr* expr) {
    ...
    __auto_type _mv_87 = (*expr);
    switch (_mv_87.tag) {
        case types_SExpr_sym:
        {
            __auto_type sym = _mv_87.data.sym;
            {
                __auto_type type_name = sym.name;
                __auto_type _mv_88 = context_ctx_lookup_type(ctx, type_name);
                if (_mv_88.has_value) {
                    __auto_type entry = _mv_88.value;
                    {
...
slop_string context_to_c_type_prefixed_compound(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len >= 1)) {
            __auto_type _mv_89 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_89.has_value) {
                __auto_type first_expr = _mv_89.value;
                __auto_type _mv_90 = (*first_expr);
                switch (_mv_90.tag) {
                    case types_SExpr_sym:
                    {
                        __auto_type head_sym = _mv_90.data.sym;
                        {
                            ...
                            if (string_eq(head, SLOP_STR("Ptr"))) {
                                if ((len >= 2)) {
                                    ...
                                    if (_mv_91.has_value) {
                                        __auto_type inner = _mv_91.value;
                                        __auto_type _mv_92 = context_get_array_pointer_type(ctx, inner);
                                        if (_mv_92.has_value) {
                                            __auto_type ptr_type = _mv_92.value;
                                            result = ptr_type;
                            ...
                            } else if (string_eq(head, SLOP_STR("Result"))) {
                                {
                                    ...
                                    if ((len >= 2)) {
                                        ...
                                        if (_mv_95.has_value) {
                                            __auto_type ok_expr = _mv_95.value;
                                    ...
                                    if ((len >= 3)) {
                                        ...
                                        if (_mv_96.has_value) {
                                            __auto_type err_expr = _mv_96.value;
                            ...
                            } else if (string_eq(head, SLOP_STR("record"))) {
                                {
                                    ...
                                    __auto_type i = 1;
                                    while ((i < len)) {
                                        __auto_type _mv_101 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_101.has_value) {
                                            __auto_type field_expr = _mv_101.value;
                                            __auto_type _mv_102 = (*field_expr);
                                            switch (_mv_102.tag) {
                                                case types_SExpr_lst:
                                                {
                                                    __auto_type field_lst = _mv_102.data.lst;
                                                    {
                                                        __auto_type field_items = field_lst.items;
                                                        if ((((int64_t)((field_items).len)) >= 2)) {
                                                            __auto_type _mv_103 = ({ __auto_type _lst = field_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                            if (_mv_103.has_value) {
                                                                __auto_type name_expr = _mv_103.value;
                                                                __auto_type _mv_104 = (*name_expr);
                                                                switch (_mv_104.tag) {
                                                                    case types_SExpr_sym:
                                                                    {
                                                                        __auto_type name_sym = _mv_104.data.sym;
                                                                        __auto_type _mv_105 = ({ __auto_type _lst = field_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                                        if (_mv_105.has_value) {
                                                                            __auto_type type_expr = _mv_105.value;
                                                                            {
                                ...
                                if ((len < 2)) {
                                ...
                                } else {
                                    {
                                        ...
                                        if ((len == 2)) {
                                            ...
                                            __auto_type _mv_106 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_106.has_value) {
                                                __auto_type args_expr = _mv_106.value;
                                                {
...
void context_ctx_flush_function_buffer(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        __auto_type i = 0;
        while ((i < count)) {
            __auto_type _mv_113 = ({ __auto_type _lst = fn_output; size_t _idx = (size_t)i; slop_option_string _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_113.has_value) {
                __auto_type line = _mv_113.value;
