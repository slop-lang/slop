...
void env_env_bind_var(env_TypeEnv* env, slop_string name, types_ResolvedType* var_type) {
    ...
    SLOP_PRE(((((int64_t)(((*env).scopes).len)) > 0)), "(> (list-len (. (deref env) scopes)) 0)");
    {
        ...
        __auto_type _mv_933 = ({ __auto_type _lst = scopes; size_t _idx = (size_t)top_idx; slop_option_env_CheckerScope_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        if (_mv_933.has_value) {
            __auto_type scope_ptr = _mv_933.value;
...
slop_option_types_ResolvedType_ptr env_scope_lookup_var(env_CheckerScope* scope_ptr, slop_string name) {
    SLOP_PRE(((scope_ptr != NULL)), "(!= scope-ptr nil)");
    {
        ...
        for (int64_t j = 0; j < num_bindings; j++) {
            __auto_type _mv_934 = ({ __auto_type _lst = bindings; size_t _idx = (size_t)j; slop_option_env_VarBinding _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            ...
            if (!(found)) {
                {
                    ...
                    __auto_type _mv_935 = ({ __auto_type _lst = scopes; size_t _idx = (size_t)scope_idx; slop_option_env_CheckerScope_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_935.has_value) {
                        __auto_type scope_ptr = _mv_935.value;
                        __auto_type _mv_936 = env_scope_lookup_var(scope_ptr, name);
                        if (_mv_936.has_value) {
                            __auto_type var_type = _mv_936.value;
                            found = 1;
...
uint8_t env_env_constant_matches_module(env_ConstBinding binding, slop_string mod_name) {
    __auto_type _mv_937 = binding.module_name;
    if (_mv_937.has_value) {
        __auto_type bmod = _mv_937.value;
...
uint8_t env_env_constant_is_builtin(env_ConstBinding binding) {
    __auto_type _mv_938 = binding.module_name;
    if (!_mv_938.has_value) {
        return 1;
    } else if (_mv_938.has_value) {
        __auto_type _ = _mv_938.value;
        return 0;
    }
    SLOP_UNREACHABLE();
}
...
slop_option_types_ResolvedType_ptr env_env_lookup_constant(env_TypeEnv* env, slop_string name) {
    SLOP_PRE(((env != NULL)), "(!= env nil)");
    {
        ...
        __auto_type _mv_940 = current_mod;
        if (_mv_940.has_value) {
            __auto_type mod = _mv_940.value;
            for (int64_t i = 0; i < len; i++) {
                if (!(found)) {
                    __auto_type _mv_941 = ({ __auto_type _lst = constants; size_t _idx = (size_t)i; slop_option_env_ConstBinding _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_941.has_value) {
                        __auto_type binding = _mv_941.value;
                    ...
                    if (colon_pos != -1) {
                        {
                            ...
                            for (int64_t i = 0; i < len; i++) {
                                if (!(found)) {
                                    __auto_type _mv_943 = ({ __auto_type _lst = constants; size_t _idx = (size_t)i; slop_option_env_ConstBinding _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    if (_mv_943.has_value) {
                                        __auto_type binding = _mv_943.value;
...
slop_option_types_ResolvedType_ptr env_env_lookup_type(env_TypeEnv* env, slop_string name) {
    SLOP_PRE(((env != NULL)), "(!= env nil)");
    __auto_type _mv_946 = env_env_lookup_type_direct(env, name);
    if (_mv_946.has_value) {
        __auto_type t = _mv_946.value;
        if (env_env_is_type_visible(env, t)) {
            ...
            if (_mv_947.has_value) {
                __auto_type qualified_name = _mv_947.value;
        ...
        __auto_type _mv_948 = env_env_resolve_import(env, name);
        if (_mv_948.has_value) {
            __auto_type qualified_name = _mv_948.value;
            return env_lookup_type_by_qualified_name(env, qualified_name);
...
slop_option_types_ResolvedType_ptr env_env_lookup_type_qualified(env_TypeEnv* env, slop_string module_name, slop_string type_name) {
    SLOP_PRE(((env != NULL)), "(!= env nil)");
    {
        ...
        slop_option_types_ResolvedType_ptr result = (slop_option_types_ResolvedType_ptr){.has_value = false};
        for (int64_t i = 0; i < len; i++) {
            __auto_type _mv_949 = ({ __auto_type _lst = types; size_t _idx = (size_t)i; slop_option_types_ResolvedType_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_949.has_value) {
                __auto_type t = _mv_949.value;
                if (!(found)) {
                    __auto_type _mv_950 = (*t).module_name;
                    if (_mv_950.has_value) {
                        __auto_type mod = _mv_950.value;
...
uint8_t env_env_is_type_visible(env_TypeEnv* env, types_ResolvedType* t) {
    SLOP_PRE(((env != NULL)), "(!= env nil)");
    SLOP_PRE(((t != NULL)), "(!= t nil)");
    __auto_type _mv_951 = (*t).module_name;
    if (!_mv_951.has_value) {
        return 1;
    } else if (_mv_951.has_value) {
        __auto_type mod = _mv_951.value;
        __auto_type _mv_952 = env_env_get_module(env);
        if (_mv_952.has_value) {
            __auto_type current = _mv_952.value;
...
uint8_t env_env_is_function_visible(env_TypeEnv* env, types_FnSignature* sig) {
    ...
    __auto_type _mv_953 = (*sig).module_name;
    if (!_mv_953.has_value) {
        ...
        if (_mv_954.has_value) {
            __auto_type current = _mv_954.value;
            return string_eq(mod, current);
...
slop_option_types_FnSignature_ptr env_env_lookup_function_direct(env_TypeEnv* env, slop_string name) {
    SLOP_PRE(((env != NULL)), "(!= env nil)");
    {
        ...
        for (int64_t i = 0; i < len; i++) {
            __auto_type _mv_955 = ({ __auto_type _lst = functions; size_t _idx = (size_t)i; slop_option_types_FnSignature_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_955.has_value) {
                __auto_type sig = _mv_955.value;
...
slop_option_types_FnSignature_ptr env_env_lookup_function(env_TypeEnv* env, slop_string name) {
    SLOP_PRE(((env != NULL)), "(!= env nil)");
    __auto_type _mv_956 = env_env_lookup_function_direct(env, name);
    if (_mv_956.has_value) {
        __auto_type sig = _mv_956.value;
        if (env_env_is_function_visible(env, sig)) {
            return (slop_option_types_FnSignature_ptr){.has_value = 1, .value = sig};
        } else {
            __auto_type _mv_957 = env_env_resolve_import(env, name);
            if (_mv_957.has_value) {
                __auto_type import_qualified = _mv_957.value;
                return env_env_lookup_function_direct(env, import_qualified);
            } else if (!_mv_957.has_value) {
                __auto_type _mv_958 = env_env_get_module(env);
        ...
        if (_mv_959.has_value) {
            __auto_type import_qualified = _mv_959.value;
            return env_env_lookup_function_direct(env, import_qualified);
...
slop_option_string env_env_resolve_import(env_TypeEnv* env, slop_string local_name) {
    SLOP_PRE(((env != NULL)), "(!= env nil)");
    {
        ...
        for (int64_t i = 0; i < len; i++) {
            __auto_type _mv_961 = ({ __auto_type _lst = imports; size_t _idx = (size_t)i; slop_option_env_ImportEntry _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_961.has_value) {
                __auto_type entry = _mv_961.value;
...
uint8_t env_env_variant_matches_module(env_VariantMapping v, slop_string mod_name) {
    __auto_type _mv_962 = v.module_name;
    if (_mv_962.has_value) {
        __auto_type vmod = _mv_962.value;
...
slop_option_string env_env_lookup_variant(env_TypeEnv* env, slop_string variant_name) {
    SLOP_PRE(((env != NULL)), "(!= env nil)");
    {
        ...
        __auto_type _mv_964 = current_mod;
        if (_mv_964.has_value) {
            __auto_type mod = _mv_964.value;
            for (int64_t i = 0; i < len; i++) {
                if (!(found)) {
        ...
        if (!(found)) {
            for (int64_t i = 0; i < len; i++) {
                if (!(found)) {
                    __auto_type _mv_967 = ({ __auto_type _lst = variants; size_t _idx = (size_t)i; slop_option_env_VariantMapping _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_967.has_value) {
                        __auto_type v = _mv_967.value;
                        if (string_eq(v.variant_name, variant_name)) {
                            __auto_type _mv_968 = v.module_name;
                            if (_mv_968.has_value) {
                                __auto_type vmod = _mv_968.value;
                                __auto_type _mv_969 = env_env_resolve_import(env, v.enum_name);
            ...
            if (_mv_970.has_value) {
                __auto_type v1 = _mv_970.value;
                {
                    ...
                    for (int64_t j = (i + 1); j < len; j++) {
                        __auto_type _mv_971 = ({ __auto_type _lst = variants; size_t _idx = (size_t)j; slop_option_env_VariantMapping _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_971.has_value) {
                            __auto_type v2 = _mv_971.value;
...
uint8_t env_env_is_module_loaded(env_TypeEnv* env, slop_string module_path) {
    SLOP_PRE(((env != NULL)), "(!= env nil)");
    {
        ...
        uint8_t found = 0;
        for (int64_t i = 0; i < len; i++) {
            __auto_type _mv_975 = ({ __auto_type _lst = modules; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_975.has_value) {
                __auto_type path = _mv_975.value;
...
uint8_t env_env_is_type_param(env_TypeEnv* env, slop_string name) {
    SLOP_PRE(((env != NULL)), "(!= env nil)");
    {
        ...
        for (int64_t i = 0; i < len; i++) {
            if (!(found)) {
                __auto_type _mv_976 = ({ __auto_type _lst = params; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_976.has_value) {
                    __auto_type p = _mv_976.value;
                    if (string_eq(p, name)) {
                        found = 1;
                    }
