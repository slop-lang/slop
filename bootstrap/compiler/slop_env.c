...
void env_env_bind_var(env_TypeEnv* env, slop_string name, types_ResolvedType* var_type) {
    ...
    SLOP_PRE(((((int64_t)(((*env).scopes).len)) > 0)), "(> (list-len (. (deref env) scopes)) 0)");
    {
        ...
        __auto_type _mv_941 = ({ __auto_type _lst = scopes; size_t _idx = (size_t)top_idx; slop_option_env_CheckerScope_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        if (_mv_941.has_value) {
            __auto_type scope_ptr = _mv_941.value;
...
slop_option_types_ResolvedType_ptr env_scope_lookup_var(env_CheckerScope* scope_ptr, slop_string name) {
    SLOP_PRE(((scope_ptr != NULL)), "(!= scope-ptr nil)");
    {
        ...
        for (int64_t j = 0; j < num_bindings; j++) {
            __auto_type _mv_942 = ({ __auto_type _lst = bindings; size_t _idx = (size_t)j; slop_option_env_VarBinding _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            ...
            if (!(found)) {
                {
                    ...
                    __auto_type _mv_943 = ({ __auto_type _lst = scopes; size_t _idx = (size_t)scope_idx; slop_option_env_CheckerScope_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_943.has_value) {
                        __auto_type scope_ptr = _mv_943.value;
                        __auto_type _mv_944 = env_scope_lookup_var(scope_ptr, name);
                        if (_mv_944.has_value) {
                            __auto_type var_type = _mv_944.value;
                            found = 1;
...
uint8_t env_env_constant_matches_module(env_ConstBinding binding, slop_string mod_name) {
    __auto_type _mv_945 = binding.module_name;
...
uint8_t env_env_constant_is_builtin(env_ConstBinding binding) {
    __auto_type _mv_946 = binding.module_name;
    if (!_mv_946.has_value) {
        return 1;
    } else if (_mv_946.has_value) {
        __auto_type _ = _mv_946.value;
        return 0;
    }
    SLOP_UNREACHABLE();
}
...
slop_option_types_ResolvedType_ptr env_env_lookup_constant(env_TypeEnv* env, slop_string name) {
    SLOP_PRE(((env != NULL)), "(!= env nil)");
    {
        ...
        __auto_type _mv_948 = current_mod;
        if (_mv_948.has_value) {
            __auto_type mod = _mv_948.value;
            for (int64_t i = 0; i < len; i++) {
                if (!(found)) {
                    __auto_type _mv_949 = ({ __auto_type _lst = constants; size_t _idx = (size_t)i; slop_option_env_ConstBinding _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_949.has_value) {
                        __auto_type binding = _mv_949.value;
                    ...
                    if (colon_pos != -1) {
                        {
                            ...
                            for (int64_t i = 0; i < len; i++) {
                                if (!(found)) {
                                    __auto_type _mv_951 = ({ __auto_type _lst = constants; size_t _idx = (size_t)i; slop_option_env_ConstBinding _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        if (!(found)) {
            for (int64_t i = 0; i < len; i++) {
                if (!(found)) {
                    __auto_type _mv_952 = ({ __auto_type _lst = constants; size_t _idx = (size_t)i; slop_option_env_ConstBinding _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_952.has_value) {
                        __auto_type binding = _mv_952.value;
...
slop_option_types_ResolvedType_ptr env_env_lookup_type_direct(env_TypeEnv* env, slop_string name) {
    SLOP_PRE(((env != NULL)), "(!= env nil)");
    {
        ...
        slop_option_types_ResolvedType_ptr result = (slop_option_types_ResolvedType_ptr){.has_value = false};
        for (int64_t i = 0; i < len; i++) {
            __auto_type _mv_953 = ({ __auto_type _lst = types; size_t _idx = (size_t)i; slop_option_types_ResolvedType_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_953.has_value) {
                __auto_type t = _mv_953.value;
...
slop_option_types_ResolvedType_ptr env_env_lookup_type(env_TypeEnv* env, slop_string name) {
    SLOP_PRE(((env != NULL)), "(!= env nil)");
    __auto_type _mv_954 = env_env_lookup_type_direct(env, name);
    if (_mv_954.has_value) {
        __auto_type t = _mv_954.value;
        if (env_env_is_type_visible(env, t)) {
            return (slop_option_types_ResolvedType_ptr){.has_value = 1, .value = t};
        } else {
            __auto_type _mv_955 = env_env_resolve_import(env, name);
            if (_mv_955.has_value) {
                __auto_type qualified_name = _mv_955.value;
        ...
        __auto_type _mv_956 = env_env_resolve_import(env, name);
        if (_mv_956.has_value) {
            __auto_type qualified_name = _mv_956.value;
            return env_lookup_type_by_qualified_name(env, qualified_name);
...
slop_option_types_ResolvedType_ptr env_env_lookup_type_qualified(env_TypeEnv* env, slop_string module_name, slop_string type_name) {
    SLOP_PRE(((env != NULL)), "(!= env nil)");
    {
        ...
        slop_option_types_ResolvedType_ptr result = (slop_option_types_ResolvedType_ptr){.has_value = false};
        for (int64_t i = 0; i < len; i++) {
            __auto_type _mv_957 = ({ __auto_type _lst = types; size_t _idx = (size_t)i; slop_option_types_ResolvedType_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_957.has_value) {
                __auto_type t = _mv_957.value;
                if (!(found)) {
                    __auto_type _mv_958 = (*t).module_name;
                    if (_mv_958.has_value) {
                        __auto_type mod = _mv_958.value;
...
uint8_t env_env_is_type_visible(env_TypeEnv* env, types_ResolvedType* t) {
    SLOP_PRE(((env != NULL)), "(!= env nil)");
    SLOP_PRE(((t != NULL)), "(!= t nil)");
    __auto_type _mv_959 = (*t).module_name;
    if (!_mv_959.has_value) {
        return 1;
    } else if (_mv_959.has_value) {
        __auto_type mod = _mv_959.value;
        __auto_type _mv_960 = env_env_get_module(env);
        if (_mv_960.has_value) {
            __auto_type current = _mv_960.value;
...
uint8_t env_env_is_function_visible(env_TypeEnv* env, types_FnSignature* sig) {
    ...
    __auto_type _mv_961 = (*sig).module_name;
    if (!_mv_961.has_value) {
        return 1;
    } else if (_mv_961.has_value) {
        __auto_type mod = _mv_961.value;
        __auto_type _mv_962 = env_env_get_module(env);
        if (_mv_962.has_value) {
            __auto_type current = _mv_962.value;
            return string_eq(mod, current);
...
slop_option_types_FnSignature_ptr env_env_lookup_function_direct(env_TypeEnv* env, slop_string name) {
    SLOP_PRE(((env != NULL)), "(!= env nil)");
    {
        ...
        for (int64_t i = 0; i < len; i++) {
            __auto_type _mv_963 = ({ __auto_type _lst = functions; size_t _idx = (size_t)i; slop_option_types_FnSignature_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_963.has_value) {
                __auto_type sig = _mv_963.value;
...
slop_option_types_FnSignature_ptr env_env_lookup_function(env_TypeEnv* env, slop_string name) {
    SLOP_PRE(((env != NULL)), "(!= env nil)");
    __auto_type _mv_964 = env_env_lookup_function_direct(env, name);
    if (_mv_964.has_value) {
        __auto_type sig = _mv_964.value;
        if (env_env_is_function_visible(env, sig)) {
            ...
            if (_mv_965.has_value) {
                __auto_type import_qualified = _mv_965.value;
                return env_env_lookup_function_direct(env, import_qualified);
            } else if (!_mv_965.has_value) {
                __auto_type _mv_966 = env_env_get_module(env);
                if (_mv_966.has_value) {
                    __auto_type mod = _mv_966.value;
                    {
        ...
        __auto_type _mv_967 = env_env_resolve_import(env, name);
        if (_mv_967.has_value) {
            __auto_type import_qualified = _mv_967.value;
            return env_env_lookup_function_direct(env, import_qualified);
        } else if (!_mv_967.has_value) {
            __auto_type _mv_968 = env_env_get_module(env);
...
slop_option_string env_env_resolve_import(env_TypeEnv* env, slop_string local_name) {
    SLOP_PRE(((env != NULL)), "(!= env nil)");
    {
        ...
        for (int64_t i = 0; i < len; i++) {
            __auto_type _mv_969 = ({ __auto_type _lst = imports; size_t _idx = (size_t)i; slop_option_env_ImportEntry _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_969.has_value) {
                __auto_type entry = _mv_969.value;
...
uint8_t env_env_variant_matches_module(env_VariantMapping v, slop_string mod_name) {
    __auto_type _mv_970 = v.module_name;
    if (_mv_970.has_value) {
        __auto_type vmod = _mv_970.value;
...
slop_option_string env_env_lookup_variant(env_TypeEnv* env, slop_string variant_name) {
    SLOP_PRE(((env != NULL)), "(!= env nil)");
    {
        ...
        __auto_type _mv_972 = current_mod;
        if (_mv_972.has_value) {
            __auto_type mod = _mv_972.value;
            for (int64_t i = 0; i < len; i++) {
                if (!(found)) {
        ...
        if (!(found)) {
            for (int64_t i = 0; i < len; i++) {
                if (!(found)) {
                    __auto_type _mv_974 = ({ __auto_type _lst = variants; size_t _idx = (size_t)i; slop_option_env_VariantMapping _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_974.has_value) {
                        __auto_type v = _mv_974.value;
        ...
        if (!(found)) {
            for (int64_t i = 0; i < len; i++) {
                if (!(found)) {
                    __auto_type _mv_975 = ({ __auto_type _lst = variants; size_t _idx = (size_t)i; slop_option_env_VariantMapping _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_975.has_value) {
                        __auto_type v = _mv_975.value;
                        if (string_eq(v.variant_name, variant_name)) {
                            __auto_type _mv_976 = v.module_name;
                            if (_mv_976.has_value) {
                                __auto_type vmod = _mv_976.value;
                                __auto_type _mv_977 = env_env_resolve_import(env, v.enum_name);
                                if (_mv_977.has_value) {
                                    __auto_type _ = _mv_977.value;
                                    found = 1;
                                    found_name = v.enum_name;
...
void env_env_check_variant_collisions(env_TypeEnv* env) {
    SLOP_PRE(((env != NULL)), "(!= env nil)");
    {
        ...
        __auto_type arena = (*env).arena;
        for (int64_t i = 0; i < len; i++) {
            __auto_type _mv_978 = ({ __auto_type _lst = variants; size_t _idx = (size_t)i; slop_option_env_VariantMapping _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_978.has_value) {
                __auto_type v1 = _mv_978.value;
                {
                    ...
                    for (int64_t j = (i + 1); j < len; j++) {
                        __auto_type _mv_979 = ({ __auto_type _lst = variants; size_t _idx = (size_t)j; slop_option_env_VariantMapping _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_979.has_value) {
                            __auto_type v2 = _mv_979.value;
...
uint8_t env_env_same_module_opt(slop_option_string a, slop_option_string b) {
    ...
    if (!_mv_980.has_value) {
        __auto_type _mv_981 = b;
        if (!_mv_981.has_value) {
            return 1;
        } else if (_mv_981.has_value) {
            __auto_type _ = _mv_981.value;
            return 0;
        }
        SLOP_UNREACHABLE();
    } else if (_mv_980.has_value) {
        __auto_type amod = _mv_980.value;
        __auto_type _mv_982 = b;
        if (!_mv_982.has_value) {
            return 0;
        } else if (_mv_982.has_value) {
            __auto_type bmod = _mv_982.value;
...
uint8_t env_env_is_module_loaded(env_TypeEnv* env, slop_string module_path) {
    SLOP_PRE(((env != NULL)), "(!= env nil)");
    {
        ...
        uint8_t found = 0;
        for (int64_t i = 0; i < len; i++) {
            __auto_type _mv_983 = ({ __auto_type _lst = modules; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_983.has_value) {
                __auto_type path = _mv_983.value;
...
uint8_t env_env_is_type_param(env_TypeEnv* env, slop_string name) {
    SLOP_PRE(((env != NULL)), "(!= env nil)");
    {
        ...
        for (int64_t i = 0; i < len; i++) {
            if (!(found)) {
                __auto_type _mv_984 = ({ __auto_type _lst = params; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_984.has_value) {
                    __auto_type p = _mv_984.value;
                    if (string_eq(p, name)) {
                        found = 1;
                    }
