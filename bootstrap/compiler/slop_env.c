...
void env_env_bind_var(env_TypeEnv* env, slop_string name, types_ResolvedType* var_type) {
    ...
    SLOP_PRE(((((int64_t)(((*env).scopes).len)) > 0)), "(> (list-len (. (deref env) scopes)) 0)");
    {
        ...
        __auto_type _mv_923 = ({ __auto_type _lst = scopes; size_t _idx = (size_t)top_idx; slop_option_env_CheckerScope_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_option_types_ResolvedType_ptr env_scope_lookup_var(env_CheckerScope* scope_ptr, slop_string name) {
    SLOP_PRE(((scope_ptr != NULL)), "(!= scope-ptr nil)");
    {
        ...
        for (int64_t j = 0; j < num_bindings; j++) {
            __auto_type _mv_924 = ({ __auto_type _lst = bindings; size_t _idx = (size_t)j; slop_option_env_VarBinding _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            ...
            if (!(found)) {
                {
                    ...
                    __auto_type _mv_925 = ({ __auto_type _lst = scopes; size_t _idx = (size_t)scope_idx; slop_option_env_CheckerScope_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_925.has_value) {
                        __auto_type scope_ptr = _mv_925.value;
                        __auto_type _mv_926 = env_scope_lookup_var(scope_ptr, name);
                        if (_mv_926.has_value) {
                            __auto_type var_type = _mv_926.value;
                            found = 1;
...
uint8_t env_env_constant_matches_module(env_ConstBinding binding, slop_string mod_name) {
    __auto_type _mv_927 = binding.module_name;
    if (_mv_927.has_value) {
        __auto_type bmod = _mv_927.value;
...
uint8_t env_env_constant_is_builtin(env_ConstBinding binding) {
    __auto_type _mv_928 = binding.module_name;
    if (!_mv_928.has_value) {
        return 1;
    } else if (_mv_928.has_value) {
        __auto_type _ = _mv_928.value;
        return 0;
    }
    SLOP_UNREACHABLE();
}
...
slop_option_types_ResolvedType_ptr env_env_lookup_constant(env_TypeEnv* env, slop_string name) {
    SLOP_PRE(((env != NULL)), "(!= env nil)");
    {
        ...
        __auto_type _mv_930 = current_mod;
...
slop_option_types_ResolvedType_ptr env_env_lookup_type_direct(env_TypeEnv* env, slop_string name) {
    SLOP_PRE(((env != NULL)), "(!= env nil)");
    {
        ...
        slop_option_types_ResolvedType_ptr result = (slop_option_types_ResolvedType_ptr){.has_value = false};
        for (int64_t i = 0; i < len; i++) {
            __auto_type _mv_935 = ({ __auto_type _lst = types; size_t _idx = (size_t)i; slop_option_types_ResolvedType_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_935.has_value) {
                __auto_type t = _mv_935.value;
...
slop_option_types_ResolvedType_ptr env_env_lookup_type(env_TypeEnv* env, slop_string name) {
    SLOP_PRE(((env != NULL)), "(!= env nil)");
    __auto_type _mv_936 = env_env_lookup_type_direct(env, name);
...
slop_option_types_ResolvedType_ptr env_env_lookup_type_qualified(env_TypeEnv* env, slop_string module_name, slop_string type_name) {
    SLOP_PRE(((env != NULL)), "(!= env nil)");
    {
        ...
        slop_option_types_ResolvedType_ptr result = (slop_option_types_ResolvedType_ptr){.has_value = false};
        for (int64_t i = 0; i < len; i++) {
            __auto_type _mv_939 = ({ __auto_type _lst = types; size_t _idx = (size_t)i; slop_option_types_ResolvedType_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_939.has_value) {
                __auto_type t = _mv_939.value;
                if (!(found)) {
                    __auto_type _mv_940 = (*t).module_name;
...
uint8_t env_env_is_type_visible(env_TypeEnv* env, types_ResolvedType* t) {
    SLOP_PRE(((env != NULL)), "(!= env nil)");
    SLOP_PRE(((t != NULL)), "(!= t nil)");
    __auto_type _mv_941 = (*t).module_name;
...
uint8_t env_env_is_function_visible(env_TypeEnv* env, types_FnSignature* sig) {
    ...
    __auto_type _mv_943 = (*sig).module_name;
...
slop_option_types_FnSignature_ptr env_env_lookup_function_direct(env_TypeEnv* env, slop_string name) {
    SLOP_PRE(((env != NULL)), "(!= env nil)");
    {
        ...
        for (int64_t i = 0; i < len; i++) {
            __auto_type _mv_945 = ({ __auto_type _lst = functions; size_t _idx = (size_t)i; slop_option_types_FnSignature_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_945.has_value) {
                __auto_type sig = _mv_945.value;
...
slop_option_types_FnSignature_ptr env_env_lookup_function(env_TypeEnv* env, slop_string name) {
    SLOP_PRE(((env != NULL)), "(!= env nil)");
    __auto_type _mv_946 = env_env_lookup_function_direct(env, name);
    if (_mv_946.has_value) {
        __auto_type sig = _mv_946.value;
...
slop_option_string env_env_resolve_import(env_TypeEnv* env, slop_string local_name) {
    SLOP_PRE(((env != NULL)), "(!= env nil)");
    {
        ...
        for (int64_t i = 0; i < len; i++) {
            __auto_type _mv_951 = ({ __auto_type _lst = imports; size_t _idx = (size_t)i; slop_option_env_ImportEntry _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_951.has_value) {
                __auto_type entry = _mv_951.value;
...
uint8_t env_env_variant_is_builtin(env_VariantMapping v) {
    __auto_type _mv_953 = v.module_name;
...
slop_option_string env_env_lookup_variant(env_TypeEnv* env, slop_string variant_name) {
    SLOP_PRE(((env != NULL)), "(!= env nil)");
    {
        ...
        if (!(found)) {
            for (int64_t i = 0; i < len; i++) {
                if (!(found)) {
                    __auto_type _mv_956 = ({ __auto_type _lst = variants; size_t _idx = (size_t)i; slop_option_env_VariantMapping _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_956.has_value) {
                        __auto_type v = _mv_956.value;
                    ...
                    if (_mv_957.has_value) {
                        ...
                        if (string_eq(v.variant_name, variant_name)) {
                            ...
                            if (_mv_958.has_value) {
                                ...
                                __auto_type _mv_959 = env_env_resolve_import(env, v.enum_name);
            ...
            if (_mv_960.has_value) {
                __auto_type v1 = _mv_960.value;
                {
                    ...
                    for (int64_t j = (i + 1); j < len; j++) {
                        __auto_type _mv_961 = ({ __auto_type _lst = variants; size_t _idx = (size_t)j; slop_option_env_VariantMapping _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_961.has_value) {
                            __auto_type v2 = _mv_961.value;
...
uint8_t env_env_is_module_loaded(env_TypeEnv* env, slop_string module_path) {
    SLOP_PRE(((env != NULL)), "(!= env nil)");
    {
        ...
        uint8_t found = 0;
        for (int64_t i = 0; i < len; i++) {
            __auto_type _mv_965 = ({ __auto_type _lst = modules; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_965.has_value) {
                __auto_type path = _mv_965.value;
...
uint8_t env_env_is_type_param(env_TypeEnv* env, slop_string name) {
    SLOP_PRE(((env != NULL)), "(!= env nil)");
    {
        ...
        for (int64_t i = 0; i < len; i++) {
            if (!(found)) {
                __auto_type _mv_966 = ({ __auto_type _lst = params; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_966.has_value) {
                    __auto_type p = _mv_966.value;
                    if (string_eq(p, name)) {
                        found = 1;
                    }
