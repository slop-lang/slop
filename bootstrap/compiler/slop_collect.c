...
void collect_collect_types(env_TypeEnv* env, slop_list_types_SExpr_ptr ast) {
    SLOP_PRE(((env != NULL)), "(!= env nil)");
    {
        ...
        for (int64_t i = 0; i < len; i++) {
            __auto_type _mv_1093 = ({ __auto_type _lst = ast; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1093.has_value) {
                __auto_type expr = _mv_1093.value;
...
void collect_resolve_type_body(env_TypeEnv* env, slop_arena* arena, types_SExpr* expr) {
    ...
    switch (_mv_1099.tag) {
        case types_SExpr_lst:
        {
            ...
            {
                __auto_type items = lst.items;
                __auto_type _mv_1100 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_1100.has_value) {
                    ...
                    switch (_mv_1101.tag) {
                        case types_SExpr_sym:
                        {
                            ...
                            {
                                __auto_type type_name = sym.name;
                                __auto_type _mv_1102 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1102.has_value) {
                                    __auto_type type_expr = _mv_1102.value;
                                    if (parser_is_form(type_expr, SLOP_STR("enum"))) {
                                        collect_collect_enum_variants(env, type_name, type_expr);
                                    } else if (parser_is_form(type_expr, SLOP_STR("record"))) {
                                        __auto_type _mv_1103 = env_env_lookup_type_direct(env, type_name);
                                        if (_mv_1103.has_value) {
                                            __auto_type resolved = _mv_1103.value;
                                            collect_collect_record_fields(env, arena, resolved, type_expr);
                                        } else if (!_mv_1103.has_value) {
                                        }
                                    } else if (parser_is_form(type_expr, SLOP_STR("union"))) {
                                        __auto_type _mv_1104 = env_env_lookup_type_direct(env, type_name);
                                        if (_mv_1104.has_value) {
                                            __auto_type resolved = _mv_1104.value;
...
void collect_collect_record_fields(env_TypeEnv* env, slop_arena* arena, types_ResolvedType* resolved, types_SExpr* record_expr) {
    ...
    __auto_type _mv_1110 = (*record_expr);
    switch (_mv_1110.tag) {
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1110.data.lst;
            {
                ...
                for (int64_t i = 1; i < len; i++) {
                    ...
                    if (_mv_1111.has_value) {
                        __auto_type field_form = _mv_1111.value;
                        __auto_type _mv_1112 = (*field_form);
                        switch (_mv_1112.tag) {
                            case types_SExpr_lst:
                            {
                                __auto_type field_lst = _mv_1112.data.lst;
                                {
                                    __auto_type field_items = field_lst.items;
                                    __auto_type _mv_1113 = ({ __auto_type _lst = field_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    if (_mv_1113.has_value) {
                                        ...
                                        switch (_mv_1114.tag) {
                                            case types_SExpr_sym:
                                            {
                                                ...
                                                __auto_type _mv_1115 = ({ __auto_type _lst = field_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
types_SExpr* collect_get_type_arg(types_SExpr* type_expr, int64_t idx) {
    ...
    switch (_mv_1116.tag) {
        case types_SExpr_lst:
        {
            ...
            __auto_type _mv_1117 = ({ __auto_type _lst = lst.items; size_t _idx = (size_t)idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1117.has_value) {
                __auto_type arg = _mv_1117.value;
                return arg;
...
types_ResolvedType* collect_get_field_type(env_TypeEnv* env, slop_arena* arena, types_SExpr* type_expr) {
    ...
    switch (_mv_1118.tag) {
        ...
        case types_SExpr_lst:
        {
            ...
            {
                __auto_type items = lst.items;
                __auto_type _mv_1120 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_1120.has_value) {
                    __auto_type head_expr = _mv_1120.value;
                    {
...
uint8_t collect_is_type_param(slop_string name, slop_list_string type_params) {
    {
        ...
        uint8_t found = 0;
        for (int64_t i = 0; i < len; i++) {
            __auto_type _mv_1121 = ({ __auto_type _lst = type_params; size_t _idx = (size_t)i; slop_option_string _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1121.has_value) {
                __auto_type tp = _mv_1121.value;
...
types_ResolvedType* collect_get_field_type_generic(env_TypeEnv* env, slop_arena* arena, types_SExpr* type_expr, slop_list_string type_params) {
    SLOP_PRE(((env != NULL)), "(!= env nil)");
    __auto_type _mv_1122 = (*type_expr);
    switch (_mv_1122.tag) {
        case types_SExpr_sym:
        {
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1122.data.lst;
            {
                ...
                if (_mv_1124.has_value) {
                    __auto_type head_expr = _mv_1124.value;
                    {
                        __auto_type head_name = parser_sexpr_get_symbol_name(head_expr);
                        if (string_eq(head_name, SLOP_STR("Option"))) {
                            {
...
slop_list_string collect_find_fn_type_params(slop_arena* arena, types_SExpr* fn_form) {
    SLOP_PRE(((fn_form != NULL)), "(!= fn-form nil)");
    {
        ...
        for (int64_t i = 3; i < len; i++) {
            __auto_type _mv_1125 = parser_sexpr_list_get(fn_form, i);
            if (_mv_1125.has_value) {
                __auto_type item = _mv_1125.value;
                if (parser_is_form(item, SLOP_STR("@generic"))) {
                    __auto_type _mv_1126 = parser_sexpr_list_get(item, 1);
                    if (_mv_1126.has_value) {
                        __auto_type params_expr = _mv_1126.value;
                        if (parser_sexpr_is_list(params_expr)) {
                            {
                                ...
                                for (int64_t j = 0; j < num_params; j++) {
                                    __auto_type _mv_1127 = parser_sexpr_list_get(params_expr, j);
                                    if (_mv_1127.has_value) {
                                        __auto_type param_expr = _mv_1127.value;
                                        {
...
types_ResolvedType* collect_find_fn_return_type_generic(env_TypeEnv* env, types_SExpr* fn_form, slop_list_string type_params) {
    ...
    SLOP_PRE(((fn_form != NULL)), "(!= fn-form nil)");
    {
        ...
        for (int64_t i = 3; i < len; i++) {
            __auto_type _mv_1128 = parser_sexpr_list_get(fn_form, i);
...
types_ResolvedType* collect_extract_spec_return_type_generic(env_TypeEnv* env, types_SExpr* spec_form, slop_list_string type_params) {
    ...
    {
        __auto_type arena = env_env_arena(env);
        __auto_type _mv_1129 = parser_sexpr_list_get(spec_form, 1);
        if (_mv_1129.has_value) {
            __auto_type spec_body = _mv_1129.value;
            if (parser_sexpr_is_list(spec_body)) {
                {
                    __auto_type len = parser_sexpr_list_len(spec_body);
                    __auto_type _mv_1130 = parser_sexpr_list_get(spec_body, (len - 1));
                    if (_mv_1130.has_value) {
                        __auto_type ret_expr = _mv_1130.value;
...
slop_list_types_ResolvedType_ptr collect_collect_fn_spec_params(env_TypeEnv* env, slop_arena* arena, types_SExpr* fn_form, slop_list_string type_params) {
    ...
    SLOP_PRE(((fn_form != NULL)), "(!= fn-form nil)");
    {
        ...
        __auto_type len = parser_sexpr_list_len(fn_form);
        for (int64_t i = 3; i < len; i++) {
            __auto_type _mv_1131 = parser_sexpr_list_get(fn_form, i);
            if (_mv_1131.has_value) {
                __auto_type item = _mv_1131.value;
                if (parser_is_form(item, SLOP_STR("@spec"))) {
                    __auto_type _mv_1132 = parser_sexpr_list_get(item, 1);
                    if (_mv_1132.has_value) {
                        __auto_type spec_body = _mv_1132.value;
                        if (parser_sexpr_is_list(spec_body)) {
                            __auto_type _mv_1133 = parser_sexpr_list_get(spec_body, 0);
                            if (_mv_1133.has_value) {
                                __auto_type param_types_expr = _mv_1133.value;
                                if (parser_sexpr_is_list(param_types_expr)) {
                                    {
                                        ...
                                        for (int64_t j = 0; j < num_ptypes; j++) {
                                            __auto_type _mv_1134 = parser_sexpr_list_get(param_types_expr, j);
                                            if (_mv_1134.has_value) {
                                                __auto_type ptype_expr = _mv_1134.value;
                                                {
...
void collect_set_module_name_from_form(env_TypeEnv* env, types_SExpr* module_form) {
    SLOP_PRE(((env != NULL)), "(!= env nil)");
    __auto_type _mv_1135 = parser_sexpr_list_get(module_form, 1);
        ...
        if (parser_sexpr_is_list(module_form)) {
            collect_set_module_name_from_form(env, module_form);
            {
                ...
                for (int64_t i = 2; i < len; i++) {
                    __auto_type _mv_1136 = parser_sexpr_list_get(module_form, i);
    ...
    SLOP_PRE(((module_form != NULL)), "(!= module-form nil)");
    {
        ...
        if (parser_sexpr_is_list(module_form)) {
            collect_set_module_name_from_form(env, module_form);
            {
                __auto_type len = parser_sexpr_list_len(module_form);
                for (int64_t i = 2; i < len; i++) {
                    __auto_type _mv_1137 = parser_sexpr_list_get(module_form, i);
...
slop_option_types_ResolvedType_ptr collect_lookup_payload_type(env_TypeEnv* env, slop_string type_name) {
    if (string_eq(type_name, SLOP_STR(""))) {
        ...
        __auto_type _mv_1138 = env_env_lookup_type_direct(env, type_name);
        if (_mv_1138.has_value) {
            __auto_type t = _mv_1138.value;
...
uint8_t collect_is_range_type_expr(types_SExpr* type_expr) {
    if (!(parser_sexpr_is_list(type_expr))) {
        ...
        if ((parser_sexpr_list_len(type_expr) < 2)) {
            ...
            __auto_type _mv_1139 = parser_sexpr_list_get(type_expr, 0);
            if (_mv_1139.has_value) {
                __auto_type first_elem = _mv_1139.value;
                {
...
types_ResolvedType* collect_get_range_base_type(env_TypeEnv* env, slop_arena* arena, types_SExpr* type_expr) {
    SLOP_PRE(((env != NULL)), "(!= env nil)");
    __auto_type _mv_1140 = parser_sexpr_list_get(type_expr, 0);
    if (_mv_1140.has_value) {
        __auto_type first_elem = _mv_1140.value;
        {
            __auto_type base_name = parser_sexpr_get_symbol_name(first_elem);
            if (string_eq(base_name, SLOP_STR("Int"))) {
                return env_env_get_int_type(env);
            } else if (string_eq(base_name, SLOP_STR("Float"))) {
                __auto_type _mv_1141 = env_env_lookup_type_direct(env, SLOP_STR("Float"));
                if (_mv_1141.has_value) {
                    __auto_type t = _mv_1141.value;
                    return t;
    ...
    if (parser_sexpr_is_list(union_expr)) {
        {
            ...
            for (int64_t i = 1; i < len; i++) {
                __auto_type _mv_1143 = parser_sexpr_list_get(union_expr, i);
                if (_mv_1143.has_value) {
                    __auto_type variant_form = _mv_1143.value;
...
slop_option_types_ResolvedType_ptr collect_get_variant_payload_type(env_TypeEnv* env, types_SExpr* variant_form) {
    if ((parser_sexpr_list_len(variant_form) <= 1)) {
        ...
        __auto_type _mv_1144 = parser_sexpr_list_get(variant_form, 1);
...
slop_string collect_checker_get_variant_name(types_SExpr* variant_form) {
    if (parser_sexpr_is_list(variant_form)) {
        if ((parser_sexpr_list_len(variant_form) == 0)) {
            ...
            __auto_type _mv_1145 = parser_sexpr_list_get(variant_form, 0);
        ...
        __auto_type _mv_1146 = (*variant_form);
        switch (_mv_1146.tag) {
            case types_SExpr_sym:
            {
...
void collect_collect_enum_variants(env_TypeEnv* env, slop_string enum_name, types_SExpr* enum_expr) {
    ...
    __auto_type _mv_1147 = (*enum_expr);
    switch (_mv_1147.tag) {
        case types_SExpr_lst:
        {
...
void collect_collect_constants(env_TypeEnv* env, slop_list_types_SExpr_ptr ast) {
    SLOP_PRE(((env != NULL)), "(!= env nil)");
    {
        ...
        __auto_type len = ((int64_t)((ast).len));
        for (int64_t i = 0; i < len; i++) {
            __auto_type _mv_1150 = ({ __auto_type _lst = ast; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1150.has_value) {
                __auto_type expr = _mv_1150.value;
        ...
        if (parser_sexpr_is_list(module_form)) {
            {
                __auto_type len = parser_sexpr_list_len(module_form);
                for (int64_t i = 2; i < len; i++) {
                    __auto_type _mv_1151 = parser_sexpr_list_get(module_form, i);
...
void collect_collect_single_constant(env_TypeEnv* env, slop_arena* arena, types_SExpr* const_form) {
    ...
    if (parser_sexpr_is_list(const_form)) {
        if ((parser_sexpr_list_len(const_form) >= 3)) {
            __auto_type _mv_1152 = parser_sexpr_list_get(const_form, 1);
            if (_mv_1152.has_value) {
                __auto_type name_expr = _mv_1152.value;
                {
                    ...
                    if (!(string_eq(const_name, SLOP_STR("")))) {
                        __auto_type _mv_1153 = parser_sexpr_list_get(const_form, 2);
...
types_ResolvedType* collect_get_const_type(env_TypeEnv* env, slop_arena* arena, types_SExpr* type_expr) {
    SLOP_PRE(((env != NULL)), "(!= env nil)");
    __auto_type _mv_1154 = (*type_expr);
    switch (_mv_1154.tag) {
        case types_SExpr_sym:
        {
...
void collect_collect_functions(env_TypeEnv* env, slop_list_types_SExpr_ptr ast) {
    SLOP_PRE(((env != NULL)), "(!= env nil)");
    {
        ...
        __auto_type len = ((int64_t)((ast).len));
        for (int64_t i = 0; i < len; i++) {
            __auto_type _mv_1156 = ({ __auto_type _lst = ast; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1156.has_value) {
                __auto_type expr = _mv_1156.value;
...
void collect_collect_module_functions(env_TypeEnv* env, types_SExpr* module_form) {
    ...
    SLOP_PRE(((module_form != NULL)), "(!= module-form nil)");
    {
        __auto_type arena = env_env_arena(env);
        if (parser_sexpr_is_list(module_form)) {
            __auto_type _mv_1157 = parser_sexpr_list_get(module_form, 1);
            ...
            }
            {
                __auto_type len = parser_sexpr_list_len(module_form);
                for (int64_t i = 2; i < len; i++) {
                    __auto_type _mv_1158 = parser_sexpr_list_get(module_form, i);
    ...
    if (parser_sexpr_is_list(ffi_form)) {
        {
            ...
            for (int64_t i = 2; i < len; i++) {
                __auto_type _mv_1159 = parser_sexpr_list_get(ffi_form, i);
                if (_mv_1159.has_value) {
                    __auto_type func_decl = _mv_1159.value;
    ...
    if (parser_sexpr_is_list(func_decl)) {
        {
            ...
            if ((decl_len >= 3)) {
                __auto_type _mv_1160 = parser_sexpr_list_get(func_decl, 0);
                ...
                __auto_type _mv_1161 = parser_sexpr_list_get(func_decl, 0);
                if (_mv_1161.has_value) {
                    __auto_type name_expr = _mv_1161.value;
                    {
                        __auto_type const_name = parser_sexpr_get_symbol_name(name_expr);
                        if (!(string_eq(const_name, SLOP_STR("")))) {
                            __auto_type _mv_1162 = parser_sexpr_list_get(func_decl, 1);
...
slop_list_types_ParamInfo collect_collect_ffi_params(env_TypeEnv* env, slop_arena* arena, types_SExpr* func_decl) {
    SLOP_PRE(((env != NULL)), "(!= env nil)");
    {
        ...
        __auto_type _mv_1163 = parser_sexpr_list_get(func_decl, 1);
            ...
            if (parser_sexpr_is_list(params_expr)) {
                {
                    __auto_type num_params = parser_sexpr_list_len(params_expr);
                    for (int64_t j = 0; j < num_params; j++) {
                        __auto_type _mv_1164 = parser_sexpr_list_get(params_expr, j);
                        if (_mv_1164.has_value) {
                            __auto_type param_form = _mv_1164.value;
                            if (parser_sexpr_is_list(param_form)) {
                                if ((parser_sexpr_list_len(param_form) >= 2)) {
                                    __auto_type _mv_1165 = parser_sexpr_list_get(param_form, 0);
                                    if (_mv_1165.has_value) {
                                        __auto_type pname_expr = _mv_1165.value;
                                        {
                                            __auto_type param_name = parser_sexpr_get_symbol_name(pname_expr);
                                            if (!(string_eq(param_name, SLOP_STR("")))) {
                                                __auto_type _mv_1166 = parser_sexpr_list_get(param_form, 1);
                                                if (_mv_1166.has_value) {
                                                    __auto_type ptype_expr = _mv_1166.value;
                                                    {
...
types_ResolvedType* collect_get_ffi_return_type(env_TypeEnv* env, slop_arena* arena, types_SExpr* func_decl) {
    SLOP_PRE(((env != NULL)), "(!= env nil)");
    __auto_type _mv_1167 = parser_sexpr_list_get(func_decl, 2);
    if (_mv_1167.has_value) {
        __auto_type ret_expr = _mv_1167.value;
...
void collect_collect_single_function(env_TypeEnv* env, slop_arena* arena, types_SExpr* fn_form) {
    ...
    if (parser_sexpr_is_list(fn_form)) {
        if ((parser_sexpr_list_len(fn_form) >= 3)) {
            __auto_type _mv_1168 = parser_sexpr_list_get(fn_form, 1);
            if (_mv_1168.has_value) {
                __auto_type name_expr = _mv_1168.value;
                {
                    __auto_type fn_name = parser_sexpr_get_symbol_name(name_expr);
                    if (!(string_eq(fn_name, SLOP_STR("")))) {
                        {
...
void collect_validate_main_params(env_TypeEnv* env, types_SExpr* fn_form, slop_list_types_ParamInfo params) {
    ...
    SLOP_PRE(((fn_form != NULL)), "(!= fn-form nil)");
    {
        ...
        if ((num_params == 0)) {
            ...
            __auto_type _mv_1169 = ({ __auto_type _lst = params; size_t _idx = (size_t)0; slop_option_types_ParamInfo _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1169.has_value) {
                __auto_type p0 = _mv_1169.value;
                {
            ...
            __auto_type _mv_1170 = ({ __auto_type _lst = params; size_t _idx = (size_t)1; slop_option_types_ParamInfo _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1170.has_value) {
                __auto_type p1 = _mv_1170.value;
                {
...
slop_list_types_ParamInfo collect_collect_fn_params(env_TypeEnv* env, slop_arena* arena, types_SExpr* fn_form) {
    ...
    {
        __auto_type params = ((slop_list_types_ParamInfo){ .data = (types_ParamInfo*)slop_arena_alloc(arena, 16 * sizeof(types_ParamInfo)), .len = 0, .cap = 16 });
        __auto_type _mv_1171 = parser_sexpr_list_get(fn_form, 2);
            ...
            if (parser_sexpr_is_list(params_expr)) {
                {
                    ...
                    for (int64_t i = 0; i < num_params; i++) {
                        __auto_type _mv_1172 = parser_sexpr_list_get(params_expr, i);
                        if (_mv_1172.has_value) {
                            __auto_type param_form = _mv_1172.value;
                            if ((parser_sexpr_is_list(param_form) && (parser_sexpr_list_len(param_form) >= 2))) {
                                __auto_type _mv_1173 = parser_sexpr_list_get(param_form, 0);
                                if (_mv_1173.has_value) {
                                    __auto_type first_expr = _mv_1173.value;
                                    {
                                        ...
                                        if (((string_eq(first_name, SLOP_STR("in"))) || (string_eq(first_name, SLOP_STR("out"))) || (string_eq(first_name, SLOP_STR("mut"))))) {
                                            if ((parser_sexpr_list_len(param_form) >= 3)) {
                                                __auto_type _mv_1174 = parser_sexpr_list_get(param_form, 1);
                                                if (_mv_1174.has_value) {
                                                    __auto_type name_expr = _mv_1174.value;
                                                    {
                                                        __auto_type param_name = parser_sexpr_get_symbol_name(name_expr);
                                                        if (!(string_eq(param_name, SLOP_STR("")))) {
                                                            __auto_type _mv_1175 = parser_sexpr_list_get(param_form, 2);
                                            ...
                                            if (!(string_eq(first_name, SLOP_STR("")))) {
                                                ...
                                                if (_mv_1176.has_value) {
                                                    __auto_type type_expr = _mv_1176.value;
                                                    {
                                                        __auto_type param_type = collect_get_field_type(env, arena, type_expr);
...
slop_list_types_ParamInfo collect_collect_fn_params_generic(env_TypeEnv* env, slop_arena* arena, types_SExpr* fn_form, slop_list_string type_params) {
    ...
    {
        __auto_type params = ((slop_list_types_ParamInfo){ .data = (types_ParamInfo*)slop_arena_alloc(arena, 16 * sizeof(types_ParamInfo)), .len = 0, .cap = 16 });
        __auto_type _mv_1177 = parser_sexpr_list_get(fn_form, 2);
            ...
            if (parser_sexpr_is_list(params_expr)) {
                {
                    __auto_type num_params = parser_sexpr_list_len(params_expr);
                    for (int64_t i = 0; i < num_params; i++) {
                        __auto_type _mv_1178 = parser_sexpr_list_get(params_expr, i);
                        if (_mv_1178.has_value) {
                            __auto_type param_form = _mv_1178.value;
                            if ((parser_sexpr_is_list(param_form) && (parser_sexpr_list_len(param_form) >= 2))) {
                                __auto_type _mv_1179 = parser_sexpr_list_get(param_form, 0);
                                if (_mv_1179.has_value) {
                                    __auto_type first_expr = _mv_1179.value;
                                    {
                                        __auto_type first_name = parser_sexpr_get_symbol_name(first_expr);
                                        if (((string_eq(first_name, SLOP_STR("in"))) || (string_eq(first_name, SLOP_STR("out"))) || (string_eq(first_name, SLOP_STR("mut"))))) {
                                            if ((parser_sexpr_list_len(param_form) >= 3)) {
                                                __auto_type _mv_1180 = parser_sexpr_list_get(param_form, 1);
                                                if (_mv_1180.has_value) {
                                                    __auto_type name_expr = _mv_1180.value;
                                                    {
                                                        __auto_type param_name = parser_sexpr_get_symbol_name(name_expr);
                                                        if (!(string_eq(param_name, SLOP_STR("")))) {
                                                            __auto_type _mv_1181 = parser_sexpr_list_get(param_form, 2);
                                            ...
                                            if (!(string_eq(first_name, SLOP_STR("")))) {
                                                __auto_type _mv_1182 = parser_sexpr_list_get(param_form, 1);
...
types_ResolvedType* collect_checker_extract_spec_return_type(env_TypeEnv* env, types_SExpr* spec_form) {
    ...
    {
        __auto_type arena = env_env_arena(env);
        __auto_type _mv_1184 = parser_sexpr_list_get(spec_form, 1);
        if (_mv_1184.has_value) {
            __auto_type spec_body = _mv_1184.value;
            if (parser_sexpr_is_list(spec_body)) {
                {
                    __auto_type len = parser_sexpr_list_len(spec_body);
                    __auto_type _mv_1185 = parser_sexpr_list_get(spec_body, (len - 1));
                    if (_mv_1185.has_value) {
                        __auto_type ret_expr = _mv_1185.value;
                        return collect_get_field_type(env, arena, ret_expr);
