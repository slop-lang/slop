...
void collect_collect_types(env_TypeEnv* env, slop_list_types_SExpr_ptr ast) {
    SLOP_PRE(((env != NULL)), "(!= env nil)");
    {
        ...
        for (int64_t i = 0; i < len; i++) {
            __auto_type _mv_1137 = ({ __auto_type _lst = ast; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1137.has_value) {
                __auto_type expr = _mv_1137.value;
        ...
        for (int64_t i = 0; i < len; i++) {
            __auto_type _mv_1138 = ({ __auto_type _lst = ast; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1138.has_value) {
                __auto_type expr = _mv_1138.value;
                if (parser_is_form(expr, SLOP_STR("type"))) {
                            ...
                            __auto_type sym = _mv_1145.data.sym;
                            {
                                ...
                                if (_mv_1146.has_value) {
                                    ...
                                    if (parser_is_form(type_expr, SLOP_STR("enum"))) {
                                        ...
                                        __auto_type _mv_1152 = env_env_lookup_type_direct(env, type_name);
                                        if (_mv_1152.has_value) {
                                            __auto_type resolved = _mv_1152.value;
                                            {
                                                __auto_type elem_type = collect_get_field_type(env, arena, collect_get_type_arg(type_expr, 1));
                                                types_resolved_type_set_inner(resolved, elem_type);
                                            }
                                    ...
                                    } else {
                                        {
                                            ...
                                            if (!(string_eq(alias_name, SLOP_STR("")))) {
                                                __auto_type _mv_1153 = env_env_lookup_type_direct(env, type_name);
                                                if (_mv_1153.has_value) {
                                                    __auto_type resolved = _mv_1153.value;
                                                    {
...
void collect_collect_record_fields(env_TypeEnv* env, slop_arena* arena, types_ResolvedType* resolved, types_SExpr* record_expr) {
    ...
    __auto_type _mv_1154 = (*record_expr);
    switch (_mv_1154.tag) {
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1154.data.lst;
            {
                ...
                for (int64_t i = 1; i < len; i++) {
                    ...
                    if (_mv_1155.has_value) {
                        __auto_type field_form = _mv_1155.value;
                        __auto_type _mv_1156 = (*field_form);
                        switch (_mv_1156.tag) {
                            case types_SExpr_lst:
                            {
                                __auto_type field_lst = _mv_1156.data.lst;
                                {
                                    __auto_type field_items = field_lst.items;
                                    __auto_type _mv_1157 = ({ __auto_type _lst = field_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    if (_mv_1157.has_value) {
                                        ...
                                        switch (_mv_1158.tag) {
                                            case types_SExpr_sym:
                                            {
                                                ...
                                                __auto_type _mv_1159 = ({ __auto_type _lst = field_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
types_SExpr* collect_get_type_arg(types_SExpr* type_expr, int64_t idx) {
    ...
    switch (_mv_1160.tag) {
        case types_SExpr_lst:
        {
            ...
            __auto_type _mv_1161 = ({ __auto_type _lst = lst.items; size_t _idx = (size_t)idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1161.has_value) {
                __auto_type arg = _mv_1161.value;
                return arg;
...
types_ResolvedType* collect_get_field_type(env_TypeEnv* env, slop_arena* arena, types_SExpr* type_expr) {
    SLOP_PRE(((env != NULL)), "(!= env nil)");
    __auto_type _mv_1162 = (*type_expr);
    switch (_mv_1162.tag) {
        case types_SExpr_sym:
        {
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1162.data.lst;
            {
                ...
                if (_mv_1164.has_value) {
                    __auto_type head_expr = _mv_1164.value;
                    {
...
uint8_t collect_is_type_param(slop_string name, slop_list_string type_params) {
    {
        ...
        uint8_t found = 0;
        for (int64_t i = 0; i < len; i++) {
            __auto_type _mv_1165 = ({ __auto_type _lst = type_params; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1165.has_value) {
                __auto_type tp = _mv_1165.value;
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1166.data.lst;
            {
                ...
                if (_mv_1168.has_value) {
                    __auto_type head_expr = _mv_1168.value;
                    {
                        __auto_type head_name = parser_sexpr_get_symbol_name(head_expr);
                        if (string_eq(head_name, SLOP_STR("Option"))) {
                            {
...
slop_list_string collect_find_fn_type_params(slop_arena* arena, types_SExpr* fn_form) {
    SLOP_PRE(((fn_form != NULL)), "(!= fn-form nil)");
    {
        ...
        for (int64_t i = 3; i < len; i++) {
            __auto_type _mv_1169 = parser_sexpr_list_get(fn_form, i);
            if (_mv_1169.has_value) {
                __auto_type item = _mv_1169.value;
                if (parser_is_form(item, SLOP_STR("@generic"))) {
                    __auto_type _mv_1170 = parser_sexpr_list_get(item, 1);
                        ...
                        if (parser_sexpr_is_list(params_expr)) {
                            {
                                ...
                                for (int64_t j = 0; j < num_params; j++) {
                                    __auto_type _mv_1171 = parser_sexpr_list_get(params_expr, j);
                                    if (_mv_1171.has_value) {
                                        __auto_type param_expr = _mv_1171.value;
                                        {
...
types_ResolvedType* collect_find_fn_return_type_generic(env_TypeEnv* env, types_SExpr* fn_form, slop_list_string type_params) {
    ...
    SLOP_PRE(((fn_form != NULL)), "(!= fn-form nil)");
    {
        ...
        for (int64_t i = 3; i < len; i++) {
            __auto_type _mv_1172 = parser_sexpr_list_get(fn_form, i);
...
types_ResolvedType* collect_extract_spec_return_type_generic(env_TypeEnv* env, types_SExpr* spec_form, slop_list_string type_params) {
    ...
    {
        __auto_type arena = env_env_arena(env);
        __auto_type _mv_1173 = parser_sexpr_list_get(spec_form, 1);
            ...
            if (parser_sexpr_is_list(spec_body)) {
                {
                    ...
                    __auto_type _mv_1174 = parser_sexpr_list_get(spec_body, (len - 1));
                    if (_mv_1174.has_value) {
                        __auto_type ret_expr = _mv_1174.value;
...
slop_list_types_ResolvedType_ptr collect_collect_fn_spec_params(env_TypeEnv* env, slop_arena* arena, types_SExpr* fn_form, slop_list_string type_params) {
    ...
    SLOP_PRE(((fn_form != NULL)), "(!= fn-form nil)");
    {
        ...
        __auto_type len = parser_sexpr_list_len(fn_form);
        for (int64_t i = 3; i < len; i++) {
            __auto_type _mv_1175 = parser_sexpr_list_get(fn_form, i);
            if (_mv_1175.has_value) {
                __auto_type item = _mv_1175.value;
                if (parser_is_form(item, SLOP_STR("@spec"))) {
                    __auto_type _mv_1176 = parser_sexpr_list_get(item, 1);
                    if (_mv_1176.has_value) {
                        __auto_type spec_body = _mv_1176.value;
                        if (parser_sexpr_is_list(spec_body)) {
                            __auto_type _mv_1177 = parser_sexpr_list_get(spec_body, 0);
                            if (_mv_1177.has_value) {
                                __auto_type param_types_expr = _mv_1177.value;
                                if (parser_sexpr_is_list(param_types_expr)) {
                                    {
                                        ...
                                        for (int64_t j = 0; j < num_ptypes; j++) {
                                            __auto_type _mv_1178 = parser_sexpr_list_get(param_types_expr, j);
                                            if (_mv_1178.has_value) {
                                                __auto_type ptype_expr = _mv_1178.value;
                                                {
...
void collect_set_module_name_from_form(env_TypeEnv* env, types_SExpr* module_form) {
    SLOP_PRE(((env != NULL)), "(!= env nil)");
    __auto_type _mv_1179 = parser_sexpr_list_get(module_form, 1);
        ...
        if (parser_sexpr_is_list(module_form)) {
            collect_set_module_name_from_form(env, module_form);
            {
                ...
                for (int64_t i = 2; i < len; i++) {
                    __auto_type _mv_1180 = parser_sexpr_list_get(module_form, i);
    ...
    SLOP_PRE(((module_form != NULL)), "(!= module-form nil)");
    {
        ...
        if (parser_sexpr_is_list(module_form)) {
            collect_set_module_name_from_form(env, module_form);
            {
                __auto_type len = parser_sexpr_list_len(module_form);
                for (int64_t i = 2; i < len; i++) {
                    __auto_type _mv_1181 = parser_sexpr_list_get(module_form, i);
...
uint8_t collect_is_range_type_expr(types_SExpr* type_expr) {
    if (!(parser_sexpr_is_list(type_expr))) {
        ...
        if ((parser_sexpr_list_len(type_expr) < 2)) {
            ...
            __auto_type _mv_1183 = parser_sexpr_list_get(type_expr, 0);
            if (_mv_1183.has_value) {
                __auto_type first_elem = _mv_1183.value;
                {
...
types_ResolvedType* collect_get_range_base_type(env_TypeEnv* env, slop_arena* arena, types_SExpr* type_expr) {
    SLOP_PRE(((env != NULL)), "(!= env nil)");
    __auto_type _mv_1184 = parser_sexpr_list_get(type_expr, 0);
    if (_mv_1184.has_value) {
        __auto_type first_elem = _mv_1184.value;
        {
            __auto_type base_name = parser_sexpr_get_symbol_name(first_elem);
            if (string_eq(base_name, SLOP_STR("Int"))) {
                return env_env_get_int_type(env);
            } else if (string_eq(base_name, SLOP_STR("Float"))) {
                __auto_type _mv_1185 = env_env_lookup_type_direct(env, SLOP_STR("Float"));
                if (_mv_1185.has_value) {
                    __auto_type t = _mv_1185.value;
                    return t;
    ...
    if (parser_sexpr_is_list(union_expr)) {
        {
            ...
            for (int64_t i = 1; i < len; i++) {
                __auto_type _mv_1187 = parser_sexpr_list_get(union_expr, i);
                if (_mv_1187.has_value) {
                    __auto_type variant_form = _mv_1187.value;
...
slop_list_types_ResolvedType_ptr collect_get_variant_payload_types(env_TypeEnv* env, types_SExpr* variant_form) {
    ...
    SLOP_PRE(((variant_form != NULL)), "(!= variant-form nil)");
    {
        ...
        for (int64_t idx = 1; idx < vlen; idx++) {
            __auto_type _mv_1188 = parser_sexpr_list_get(variant_form, idx);
...
slop_option_types_ResolvedType_ptr collect_get_variant_payload_type(env_TypeEnv* env, types_SExpr* variant_form) {
    if ((parser_sexpr_list_len(variant_form) <= 1)) {
        ...
        __auto_type _mv_1189 = parser_sexpr_list_get(variant_form, 1);
...
slop_string collect_checker_get_variant_name(types_SExpr* variant_form) {
    if (parser_sexpr_is_list(variant_form)) {
        if ((parser_sexpr_list_len(variant_form) == 0)) {
            ...
            __auto_type _mv_1190 = parser_sexpr_list_get(variant_form, 0);
        ...
        __auto_type _mv_1191 = (*variant_form);
        switch (_mv_1191.tag) {
            case types_SExpr_sym:
            {
                            ...
                            case types_SExpr_sym:
                            {
                                ...
                                if (string_eq(sym.name, SLOP_STR("Option"))) {
                                    ...
                                    if (_mv_1195.has_value) {
                                        __auto_type inner = _mv_1195.value;
...
uint8_t collect_has_recursive_value_payload(types_SExpr* variant_form, slop_string union_name) {
    SLOP_PRE(((variant_form != NULL)), "(!= variant-form nil)");
    {
        ...
        for (int64_t idx = 1; idx < vlen; idx++) {
            if (!(found)) {
                __auto_type _mv_1196 = parser_sexpr_list_get(variant_form, idx);
...
void collect_collect_enum_variants(env_TypeEnv* env, slop_string enum_name, types_SExpr* enum_expr) {
    ...
    __auto_type _mv_1197 = (*enum_expr);
    switch (_mv_1197.tag) {
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1197.data.lst;
            {
                ...
                for (int64_t i = 1; i < len; i++) {
                    ...
                    if (_mv_1198.has_value) {
                        __auto_type variant_expr = _mv_1198.value;
                        __auto_type _mv_1199 = (*variant_expr);
                        switch (_mv_1199.tag) {
                            case types_SExpr_sym:
                            {
...
void collect_collect_constants(env_TypeEnv* env, slop_list_types_SExpr_ptr ast) {
    SLOP_PRE(((env != NULL)), "(!= env nil)");
    {
        ...
        __auto_type len = ((int64_t)((ast).len));
        for (int64_t i = 0; i < len; i++) {
            __auto_type _mv_1200 = ({ __auto_type _lst = ast; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1200.has_value) {
                __auto_type expr = _mv_1200.value;
        ...
        if (parser_sexpr_is_list(module_form)) {
            {
                __auto_type len = parser_sexpr_list_len(module_form);
                for (int64_t i = 2; i < len; i++) {
                    __auto_type _mv_1201 = parser_sexpr_list_get(module_form, i);
...
void collect_collect_single_constant(env_TypeEnv* env, slop_arena* arena, types_SExpr* const_form) {
    ...
    if (parser_sexpr_is_list(const_form)) {
        if ((parser_sexpr_list_len(const_form) >= 3)) {
            __auto_type _mv_1202 = parser_sexpr_list_get(const_form, 1);
            if (_mv_1202.has_value) {
                __auto_type name_expr = _mv_1202.value;
                {
                    ...
                    if (!(string_eq(const_name, SLOP_STR("")))) {
                        __auto_type _mv_1203 = parser_sexpr_list_get(const_form, 2);
...
void collect_collect_functions(env_TypeEnv* env, slop_list_types_SExpr_ptr ast) {
    SLOP_PRE(((env != NULL)), "(!= env nil)");
    {
        ...
        __auto_type len = ((int64_t)((ast).len));
        for (int64_t i = 0; i < len; i++) {
            __auto_type _mv_1206 = ({ __auto_type _lst = ast; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1206.has_value) {
                __auto_type expr = _mv_1206.value;
...
void collect_collect_module_functions(env_TypeEnv* env, types_SExpr* module_form) {
    ...
    SLOP_PRE(((module_form != NULL)), "(!= module-form nil)");
    {
        __auto_type arena = env_env_arena(env);
        if (parser_sexpr_is_list(module_form)) {
            __auto_type _mv_1207 = parser_sexpr_list_get(module_form, 1);
            ...
            }
            {
                __auto_type len = parser_sexpr_list_len(module_form);
                for (int64_t i = 2; i < len; i++) {
                    __auto_type _mv_1208 = parser_sexpr_list_get(module_form, i);
    ...
    if (parser_sexpr_is_list(ffi_form)) {
        {
            ...
            for (int64_t i = 2; i < len; i++) {
                __auto_type _mv_1209 = parser_sexpr_list_get(ffi_form, i);
                if (_mv_1209.has_value) {
                    __auto_type func_decl = _mv_1209.value;
    ...
    if (parser_sexpr_is_list(func_decl)) {
        {
            ...
            if ((decl_len >= 3)) {
                __auto_type _mv_1210 = parser_sexpr_list_get(func_decl, 0);
                ...
                __auto_type _mv_1211 = parser_sexpr_list_get(func_decl, 0);
...
uint8_t collect_ffi_has_variadic(types_SExpr* func_decl) {
    SLOP_PRE(((func_decl != NULL)), "(!= func-decl nil)");
    {
        ...
        if ((len >= 4)) {
            __auto_type _mv_1213 = parser_sexpr_list_get(func_decl, (len - 1));
            if (_mv_1213.has_value) {
                __auto_type last_expr = _mv_1213.value;
...
slop_list_types_ParamInfo collect_collect_ffi_params(env_TypeEnv* env, slop_arena* arena, types_SExpr* func_decl) {
    SLOP_PRE(((env != NULL)), "(!= env nil)");
    {
        ...
        __auto_type _mv_1214 = parser_sexpr_list_get(func_decl, 1);
            ...
            if (parser_sexpr_is_list(params_expr)) {
                {
                    __auto_type num_params = parser_sexpr_list_len(params_expr);
                    for (int64_t j = 0; j < num_params; j++) {
                        __auto_type _mv_1215 = parser_sexpr_list_get(params_expr, j);
                        if (_mv_1215.has_value) {
                            __auto_type param_form = _mv_1215.value;
                            if (parser_sexpr_is_list(param_form)) {
                                if ((parser_sexpr_list_len(param_form) >= 2)) {
                                    __auto_type _mv_1216 = parser_sexpr_list_get(param_form, 0);
                                    if (_mv_1216.has_value) {
                                        __auto_type pname_expr = _mv_1216.value;
                                        {
                                            __auto_type param_name = parser_sexpr_get_symbol_name(pname_expr);
                                            if (!(string_eq(param_name, SLOP_STR("")))) {
                                                __auto_type _mv_1217 = parser_sexpr_list_get(param_form, 1);
                                                if (_mv_1217.has_value) {
                                                    __auto_type ptype_expr = _mv_1217.value;
                                                    {
...
types_ResolvedType* collect_get_ffi_return_type(env_TypeEnv* env, slop_arena* arena, types_SExpr* func_decl) {
    SLOP_PRE(((env != NULL)), "(!= env nil)");
    __auto_type _mv_1218 = parser_sexpr_list_get(func_decl, 2);
    if (_mv_1218.has_value) {
        __auto_type ret_expr = _mv_1218.value;
...
void collect_collect_single_function(env_TypeEnv* env, slop_arena* arena, types_SExpr* fn_form) {
    ...
    if (parser_sexpr_is_list(fn_form)) {
        if ((parser_sexpr_list_len(fn_form) >= 3)) {
            __auto_type _mv_1219 = parser_sexpr_list_get(fn_form, 1);
...
void collect_validate_main_params(env_TypeEnv* env, types_SExpr* fn_form, slop_list_types_ParamInfo params) {
    ...
    SLOP_PRE(((fn_form != NULL)), "(!= fn-form nil)");
    {
        ...
        if ((num_params == 0)) {
            ...
            __auto_type _mv_1220 = ({ __auto_type _lst = params; size_t _idx = (size_t)0; slop_option_types_ParamInfo _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1220.has_value) {
                __auto_type p0 = _mv_1220.value;
                {
            ...
            __auto_type _mv_1221 = ({ __auto_type _lst = params; size_t _idx = (size_t)1; slop_option_types_ParamInfo _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1221.has_value) {
                __auto_type p1 = _mv_1221.value;
                {
...
slop_list_types_ParamInfo collect_collect_fn_params(env_TypeEnv* env, slop_arena* arena, types_SExpr* fn_form) {
    ...
    {
        __auto_type params = ((slop_list_types_ParamInfo){ .data = (types_ParamInfo*)slop_arena_alloc(arena, 16 * sizeof(types_ParamInfo)), .len = 0, .cap = 16 });
        __auto_type _mv_1222 = parser_sexpr_list_get(fn_form, 2);
        if (_mv_1222.has_value) {
            __auto_type params_expr = _mv_1222.value;
            if (parser_sexpr_is_list(params_expr)) {
                {
                    __auto_type num_params = parser_sexpr_list_len(params_expr);
                    for (int64_t i = 0; i < num_params; i++) {
                        __auto_type _mv_1223 = parser_sexpr_list_get(params_expr, i);
                        if (_mv_1223.has_value) {
                            __auto_type param_form = _mv_1223.value;
                            if ((parser_sexpr_is_list(param_form) && (parser_sexpr_list_len(param_form) >= 2))) {
                                __auto_type _mv_1224 = parser_sexpr_list_get(param_form, 0);
                                if (_mv_1224.has_value) {
                                    __auto_type first_expr = _mv_1224.value;
                                    {
                                        ...
                                        if (((string_eq(first_name, SLOP_STR("in"))) || (string_eq(first_name, SLOP_STR("out"))) || (string_eq(first_name, SLOP_STR("mut"))))) {
                                            if ((parser_sexpr_list_len(param_form) >= 3)) {
                                                ...
                                                if (_mv_1225.has_value) {
                                                    __auto_type name_expr = _mv_1225.value;
                                                    {
                                                        ...
                                                        if (!(string_eq(param_name, SLOP_STR("")))) {
                                                            __auto_type _mv_1226 = parser_sexpr_list_get(param_form, 2);
                                            ...
                                            if (!(string_eq(first_name, SLOP_STR("")))) {
                                                __auto_type _mv_1227 = parser_sexpr_list_get(param_form, 1);
...
slop_list_types_ParamInfo collect_collect_fn_params_generic(env_TypeEnv* env, slop_arena* arena, types_SExpr* fn_form, slop_list_string type_params) {
    ...
    {
        __auto_type params = ((slop_list_types_ParamInfo){ .data = (types_ParamInfo*)slop_arena_alloc(arena, 16 * sizeof(types_ParamInfo)), .len = 0, .cap = 16 });
        __auto_type _mv_1228 = parser_sexpr_list_get(fn_form, 2);
            ...
            if (parser_sexpr_is_list(params_expr)) {
                {
                    __auto_type num_params = parser_sexpr_list_len(params_expr);
                    for (int64_t i = 0; i < num_params; i++) {
                        __auto_type _mv_1229 = parser_sexpr_list_get(params_expr, i);
                        if (_mv_1229.has_value) {
                            ...
                            if ((parser_sexpr_is_list(param_form) && (parser_sexpr_list_len(param_form) >= 2))) {
                                ...
                                if (_mv_1230.has_value) {
                                    __auto_type first_expr = _mv_1230.value;
                                    {
                                        __auto_type first_name = parser_sexpr_get_symbol_name(first_expr);
                                        if (((string_eq(first_name, SLOP_STR("in"))) || (string_eq(first_name, SLOP_STR("out"))) || (string_eq(first_name, SLOP_STR("mut"))))) {
                                            if ((parser_sexpr_list_len(param_form) >= 3)) {
                                                ...
                                                if (_mv_1231.has_value) {
                                                    __auto_type name_expr = _mv_1231.value;
                                                    {
                                                        __auto_type param_name = parser_sexpr_get_symbol_name(name_expr);
                                                        if (!(string_eq(param_name, SLOP_STR("")))) {
                                                            __auto_type _mv_1232 = parser_sexpr_list_get(param_form, 2);
                                            ...
                                            if (!(string_eq(first_name, SLOP_STR("")))) {
                                                __auto_type _mv_1233 = parser_sexpr_list_get(param_form, 1);
                                                if (_mv_1233.has_value) {
                                                    __auto_type type_expr = _mv_1233.value;
                                                    {
                                                        __auto_type param_type = collect_get_field_type_generic(env, arena, type_expr, type_params);
                                                        __auto_type info = types_param_info_new(arena, first_name, param_type);
                                                        ({ __auto_type _lst_p = &(params); __auto_type _item = ((*info)); if (_lst_p->len >= _lst_p->cap) { size_t _new_cap = _lst_p->cap == 0 ? 16 : _lst_p->cap * 2; __typeof__(_lst_p->data) _new_data = (__typeof__(_lst_p->data))slop_arena_alloc(arena, _new_cap * sizeof(*_lst_p->data)); if (_lst_p->len > 0) memcpy(_new_data, _lst_p->data, _lst_p->len * sizeof(*_lst_p->data)); _lst_p->data = _new_data; _lst_p->cap = _new_cap; } _lst_p->data[_lst_p->len++] = _item; (void)0; });
...
types_ResolvedType* collect_find_fn_return_type(env_TypeEnv* env, types_SExpr* fn_form) {
    ...
    SLOP_PRE(((fn_form != NULL)), "(!= fn-form nil)");
    {
        ...
        types_ResolvedType* found_type = env_env_get_unit_type(env);
        for (int64_t i = 3; i < len; i++) {
            __auto_type _mv_1234 = parser_sexpr_list_get(fn_form, i);
...
types_ResolvedType* collect_checker_extract_spec_return_type(env_TypeEnv* env, types_SExpr* spec_form) {
    ...
    {
        __auto_type arena = env_env_arena(env);
        __auto_type _mv_1235 = parser_sexpr_list_get(spec_form, 1);
        if (_mv_1235.has_value) {
            __auto_type spec_body = _mv_1235.value;
            if (parser_sexpr_is_list(spec_body)) {
                {
                    __auto_type len = parser_sexpr_list_len(spec_body);
                    __auto_type _mv_1236 = parser_sexpr_list_get(spec_body, (len - 1));
                    if (_mv_1236.has_value) {
                        __auto_type ret_expr = _mv_1236.value;
                        return collect_get_field_type(env, arena, ret_expr);
