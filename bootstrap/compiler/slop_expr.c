        ...
        __auto_type arena = (*ctx).arena;
        {
            ...
            if ((string_len(runtime_name) > 0)) {
            ...
            } else {
                {
                    ...
                    __auto_type _mv_133 = context_ctx_lookup_var(ctx, fn_name);
                    if (_mv_133.has_value) {
                        __auto_type var_entry = _mv_133.value;
...
slop_string expr_transpile_enum_variant(context_TranspileContext* ctx, slop_string variant_name) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_134 = context_ctx_lookup_enum_variant(ctx, variant_name);
        if (_mv_134.has_value) {
            __auto_type enum_name = _mv_134.value;
            {
...
slop_string expr_transpile_ok(context_TranspileContext* ctx, slop_string value_c) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    __auto_type _mv_135 = context_ctx_get_current_result_type(ctx);
    if (_mv_135.has_value) {
        __auto_type result_type = _mv_135.value;
...
slop_string expr_transpile_error(context_TranspileContext* ctx, slop_string value_c) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    __auto_type _mv_136 = context_ctx_get_current_result_type(ctx);
    if (_mv_136.has_value) {
        __auto_type result_type = _mv_136.value;
...
slop_string expr_infer_option_type(context_TranspileContext* ctx, types_SExpr* val_expr) {
    ...
    __auto_type _mv_137 = (*val_expr);
    switch (_mv_137.tag) {
        case types_SExpr_num:
        {
            __auto_type num = _mv_137.data.num;
            if (num.is_float) {
        ...
        case types_SExpr_sym:
        {
            __auto_type sym = _mv_137.data.sym;
            {
                ...
                if (_mv_138.has_value) {
                    __auto_type var_entry = _mv_138.value;
                    {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len < 3)) {
            ...
            if (_mv_139.has_value) {
                __auto_type obj_expr = _mv_139.value;
                __auto_type _mv_140 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_140.has_value) {
                    __auto_type field_expr = _mv_140.value;
                    __auto_type _mv_141 = (*field_expr);
                    switch (_mv_141.tag) {
                        case types_SExpr_sym:
                        {
                            __auto_type field_sym = _mv_141.data.sym;
                            {
                                __auto_type field_name = field_sym.name;
                                __auto_type obj_c_type = expr_infer_expr_c_type(ctx, obj_expr);
                                __auto_type _mv_142 = context_ctx_lookup_field_type(ctx, obj_c_type, field_name);
                                if (_mv_142.has_value) {
                                    __auto_type c_type = _mv_142.value;
                                    return c_type;
                                } else if (!_mv_142.has_value) {
                                    __auto_type _mv_143 = context_ctx_lookup_var(ctx, expr_get_var_name_from_expr(obj_expr));
                                    if (_mv_143.has_value) {
                                        __auto_type var_entry = _mv_143.value;
                                        {
                                            __auto_type obj_slop_type = var_entry.slop_type;
                                            __auto_type _mv_144 = context_ctx_lookup_field_type(ctx, obj_slop_type, field_name);
                                            if (_mv_144.has_value) {
                                                __auto_type c_type2 = _mv_144.value;
                                                return c_type2;
...
slop_string expr_infer_list_expr_option_type(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len < 1)) {
            ...
            __auto_type _mv_145 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_145.has_value) {
                __auto_type head_expr = _mv_145.value;
                __auto_type _mv_146 = (*head_expr);
                switch (_mv_146.tag) {
                    case types_SExpr_sym:
                    {
                        __auto_type sym = _mv_146.data.sym;
                        {
                            ...
                            if (string_eq(op, SLOP_STR("."))) {
                                if ((len < 3)) {
                                ...
                                } else {
                                    {
                                        ...
                                        if (!(string_eq(field_c_type, SLOP_STR("__auto_type")))) {
                                            ...
                                            __auto_type _mv_147 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_147.has_value) {
                                                __auto_type field_expr = _mv_147.value;
                                                __auto_type _mv_148 = (*field_expr);
                                                switch (_mv_148.tag) {
                                                    case types_SExpr_sym:
                                                    {
                                                        __auto_type field_sym = _mv_148.data.sym;
                                                        {
                                                            __auto_type field_name = field_sym.name;
                                ...
                                __auto_type _mv_149 = context_ctx_lookup_func(ctx, op);
                                if (_mv_149.has_value) {
                                    __auto_type func_entry = _mv_149.value;
                                    {
...
slop_string expr_infer_list_element_option_type(context_TranspileContext* ctx, types_SExpr* list_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_150 = ctype_get_node_resolved_type(list_expr);
        if (_mv_150.has_value) {
            __auto_type rt = _mv_150.value;
            __auto_type _mv_151 = (*rt).inner_type;
            if (_mv_151.has_value) {
                __auto_type elem_type = _mv_151.value;
                {
                ...
                case types_SExpr_lst:
                {
                    __auto_type lst = _mv_152.data.lst;
                    {
                        ...
                        if ((((int64_t)((items).len)) < 3)) {
                            ...
                            __auto_type _mv_154 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_154.has_value) {
                                __auto_type head = _mv_154.value;
                                __auto_type _mv_155 = (*head);
                                switch (_mv_155.tag) {
                                    case types_SExpr_sym:
                                    {
                                        __auto_type head_sym = _mv_155.data.sym;
        ...
        if (strlib_ends_with(elem_type, SLOP_STR("_ptr"))) {
            {
                ...
                __auto_type _mv_158 = context_ctx_lookup_type(ctx, base);
            ...
            __auto_type _mv_159 = context_ctx_lookup_type(ctx, elem_type);
            if (_mv_159.has_value) {
                __auto_type entry = _mv_159.value;
                return entry.c_name;
...
slop_string expr_slop_value_type_to_c_type(context_TranspileContext* ctx, slop_string slop_type) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_160 = context_ctx_lookup_type(ctx, slop_type);
        if (_mv_160.has_value) {
            __auto_type entry = _mv_160.value;
            return entry.c_name;
...
slop_string expr_resolve_type_alias_for_map(context_TranspileContext* ctx, slop_string slop_type) {
    ...
    if (strlib_starts_with(slop_type, SLOP_STR("(Map "))) {
        ...
        __auto_type _mv_162 = context_ctx_lookup_type_alias(ctx, slop_type);
        if (_mv_162.has_value) {
            __auto_type alias_def = _mv_162.value;
            return alias_def;
            ...
            case types_SExpr_sym:
            {
                __auto_type sym = _mv_163.data.sym;
                {
                    ...
                    if (_mv_164.has_value) {
                        __auto_type entry = _mv_164.value;
                                ...
                                case types_SExpr_sym:
                                {
                                    __auto_type head_sym = _mv_166.data.sym;
                                    {
                                        ...
                                        if ((string_eq(op, SLOP_STR(".")) && (len >= 3))) {
                                            __auto_type _mv_167 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    ...
                                                    switch (_mv_169.tag) {
                                                        case types_SExpr_sym:
                                                        {
                                                            __auto_type field_sym = _mv_169.data.sym;
                                                            {
                                                                ...
                                                                {
                                                                    __auto_type obj_c_type = expr_infer_expr_c_type(ctx, obj_expr);
                                                                    __auto_type _mv_170 = context_ctx_lookup_field_slop_type(ctx, obj_c_type, field_name);
                                                                    if (_mv_170.has_value) {
                                                                        __auto_type slop_type = _mv_170.value;
                                                                        return slop_type;
                                                                    } else if (!_mv_170.has_value) {
                                                                        {
                                                                            __auto_type obj_slop_type = expr_infer_expr_slop_type(ctx, obj_expr);
                                                                            __auto_type _mv_171 = context_ctx_lookup_field_slop_type(ctx, obj_slop_type, field_name);
                                                                            if (_mv_171.has_value) {
                                                                                __auto_type slop_type2 = _mv_171.value;
                                                                                return slop_type2;
                                            ...
                                            if ((len >= 2)) {
                                                __auto_type _mv_172 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_172.has_value) {
                                                    __auto_type type_expr = _mv_172.value;
                                                    __auto_type _mv_173 = (*type_expr);
                                                    switch (_mv_173.tag) {
                                                        case types_SExpr_sym:
                                                        {
                                                            __auto_type type_sym = _mv_173.data.sym;
                                            ...
                                            if ((len >= 4)) {
                                                __auto_type _mv_174 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_174.has_value) {
                                                    __auto_type key_expr = _mv_174.value;
                                                    __auto_type _mv_175 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_175.has_value) {
                                                        __auto_type val_expr = _mv_175.value;
                                                        {
                                            ...
                                            if ((len >= 3)) {
                                                __auto_type _mv_176 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_176.has_value) {
                                                    __auto_type elem_expr = _mv_176.value;
                                                    {
                                            ...
                                            if ((len >= 3)) {
                                                __auto_type _mv_177 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_177.has_value) {
                                                    __auto_type elem_expr = _mv_177.value;
                                                    {
                                                        __auto_type elem_str = ctype_sexpr_to_type_string(arena, elem_expr);
                                            ...
                                            __auto_type _mv_178 = context_ctx_lookup_func(ctx, op);
                                            if (_mv_178.has_value) {
                                                __auto_type func_entry = _mv_178.value;
            ...
            case types_SExpr_sym:
            {
                __auto_type sym = _mv_179.data.sym;
                {
                    ...
                    if (_mv_180.has_value) {
                        __auto_type var_entry = _mv_180.value;
                        {
                            __auto_type slop_type = var_entry.slop_type;
                            if ((string_len(slop_type) > 0)) {
                                {
            ...
            case types_SExpr_sym:
            {
                __auto_type sym = _mv_181.data.sym;
                {
                    ...
                    if (_mv_182.has_value) {
                        __auto_type var_entry = _mv_182.value;
                        {
                            __auto_type slop_type = var_entry.slop_type;
                            if ((string_len(slop_type) > 0)) {
                                {
    ...
    SLOP_PRE(((map_expr != NULL)), "(!= map-expr nil)");
    {
        ...
        switch (_mv_183.tag) {
            case types_SExpr_sym:
            {
                ...
                {
                    __auto_type name = sym.name;
                    __auto_type _mv_184 = context_ctx_lookup_var(ctx, name);
                    if (_mv_184.has_value) {
                        __auto_type var_entry = _mv_184.value;
                        {
                            __auto_type slop_type = var_entry.slop_type;
                            if ((string_len(slop_type) > 0)) {
                                {
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_185.data.lst;
                {
                    ...
                    if ((len < 2)) {
                        ...
                        __auto_type _mv_187 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_187.has_value) {
                            __auto_type head_expr = _mv_187.value;
                            __auto_type _mv_188 = (*head_expr);
                            switch (_mv_188.tag) {
                                case types_SExpr_sym:
                                {
                                        ...
                                        if (string_eq(op, SLOP_STR("map-get"))) {
                                            if ((len < 2)) {
                                                ...
                                                if (_mv_189.has_value) {
                                                    __auto_type map_expr = _mv_189.value;
                                                    __auto_type _mv_190 = (*map_expr);
                                                    switch (_mv_190.tag) {
                                                        case types_SExpr_sym:
                                                        {
                                                            __auto_type map_sym = _mv_190.data.sym;
                                                            {
                                                                __auto_type map_name = map_sym.name;
                                                                __auto_type _mv_191 = context_ctx_lookup_var(ctx, map_name);
                                            ...
                                            if ((len < 2)) {
                                                ...
                                                if (_mv_192.has_value) {
                                                    __auto_type list_expr = _mv_192.value;
                                                    __auto_type _mv_193 = (*list_expr);
                                                    switch (_mv_193.tag) {
                                                        case types_SExpr_sym:
                                                        {
                                                            __auto_type list_sym = _mv_193.data.sym;
                                                            {
                                                                __auto_type list_name = list_sym.name;
                                                                __auto_type _mv_194 = context_ctx_lookup_var(ctx, list_name);
...
slop_string expr_fix_ternary_none(context_TranspileContext* ctx, slop_string other_branch, slop_string this_branch) {
    ...
    if ((string_eq(this_branch, SLOP_STR("none")) && strlib_starts_with(other_branch, SLOP_STR("(slop_option_")))) {
        {
            __auto_type arena = (*ctx).arena;
            __auto_type _mv_195 = expr_extract_option_type(arena, other_branch);
            if (_mv_195.has_value) {
                __auto_type opt_type = _mv_195.value;
            ...
            __auto_type lst = _mv_198.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) >= 1)) {
                    ...
                    if (_mv_200.has_value) {
                        __auto_type head_ptr = _mv_200.value;
                        __auto_type _mv_201 = (*head_ptr);
                        switch (_mv_201.tag) {
                            case types_SExpr_sym:
                            {
                                __auto_type head_sym = _mv_201.data.sym;
                                {
                                    __auto_type op = head_sym.name;
                                    if (string_eq(op, SLOP_STR("deref"))) {
                                        ...
                                        if (_mv_202.has_value) {
                                            __auto_type type_expr = _mv_202.value;
                ...
                __auto_type lst = _mv_203.data.lst;
                {
                    ...
                    if ((len >= 2)) {
                        ...
                        if (_mv_204.has_value) {
                            __auto_type head_ptr = _mv_204.value;
                            __auto_type _mv_205 = (*head_ptr);
                            switch (_mv_205.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type head_sym = _mv_205.data.sym;
                                    {
                                        ...
                                        if (string_eq(op, SLOP_STR("sizeof"))) {
                                            ...
                                            if (_mv_206.has_value) {
                                                __auto_type type_expr = _mv_206.value;
                                        ...
                                        } else if ((string_eq(op, SLOP_STR("*")) || (string_eq(op, SLOP_STR("+")) || (string_eq(op, SLOP_STR("-")) || string_eq(op, SLOP_STR("/")))))) {
                                            {
                                                ...
                                                while ((i < len)) {
                                                    __auto_type _mv_207 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_string expr_transpile_expr(context_TranspileContext* ctx, types_SExpr* expr) {
    ...
    switch (_mv_208.tag) {
        case types_SExpr_num:
        {
            __auto_type _ = _mv_208.data.num;
            return expr_transpile_literal(ctx, expr);
        }
        case types_SExpr_str:
        {
            __auto_type _ = _mv_208.data.str;
            return expr_transpile_literal(ctx, expr);
        }
        case types_SExpr_sym:
        {
            __auto_type _ = _mv_208.data.sym;
            return expr_transpile_literal(ctx, expr);
        }
        case types_SExpr_lst:
        {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len < 1)) {
            ...
            if (_mv_209.has_value) {
                __auto_type head_expr = _mv_209.value;
                __auto_type _mv_210 = (*head_expr);
                switch (_mv_210.tag) {
                    case types_SExpr_sym:
                    {
                            ...
                            if ((expr_is_binop(op) && (len < 3))) {
                                ...
                                if ((len > 3)) {
                                    ...
                                    if (_mv_211.has_value) {
                                        __auto_type left = _mv_211.value;
                                        __auto_type _mv_212 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_212.has_value) {
                                            __auto_type right = _mv_212.value;
                                            {
                                ...
                                if (_mv_213.has_value) {
                                    __auto_type left = _mv_213.value;
                                    __auto_type _mv_214 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    if (_mv_214.has_value) {
                                        __auto_type right = _mv_214.value;
                                        {
                                            __auto_type left_c = expr_transpile_expr(ctx, left);
                                            __auto_type right_c = expr_transpile_expr(ctx, right);
                                            return expr_transpile_binop(ctx, op, left_c, right_c);
                                ...
                                if (_mv_216.has_value) {
                                    __auto_type cond_expr = _mv_216.value;
                                    __auto_type _mv_217 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    if (_mv_217.has_value) {
                                        __auto_type then_expr = _mv_217.value;
                                        ...
                                        if (_mv_218.has_value) {
                                            __auto_type else_expr = _mv_218.value;
                                            {
                                ...
                                if (_mv_220.has_value) {
                                    ...
                                    if (_mv_221.has_value) {
                                        __auto_type field_expr = _mv_221.value;
                                        __auto_type _mv_222 = (*field_expr);
                                        switch (_mv_222.tag) {
                                            case types_SExpr_sym:
                                            {
                                                __auto_type field_sym = _mv_222.data.sym;
                                                {
                                ...
                                if (_mv_223.has_value) {
                                    ...
                                    if (_mv_224.has_value) {
                                        __auto_type val_expr = _mv_224.value;
                                        {
                                ...
                                if (_mv_225.has_value) {
                                    __auto_type str_expr = _mv_225.value;
                                    __auto_type _mv_226 = (*str_expr);
                                    switch (_mv_226.tag) {
                                        case types_SExpr_str:
                                        {
                                            __auto_type str = _mv_226.data.str;
                                            return str.value;
                                        }
                                        default: {
                                ...
                                if (_mv_227.has_value) {
                                    __auto_type val_expr = _mv_227.value;
                                    {
                                        __auto_type val_c = expr_transpile_expr(ctx, val_expr);
                                ...
                                if (_mv_230.has_value) {
                                    __auto_type arr_expr = _mv_230.value;
                                    ...
                                    if (_mv_231.has_value) {
                                        __auto_type idx_expr = _mv_231.value;
                                        {
                                ...
                                if (_mv_232.has_value) {
                                    __auto_type arena_expr = _mv_232.value;
                                    ...
                                    if (_mv_233.has_value) {
                                        __auto_type size_expr = _mv_233.value;
                                        {
                                            __auto_type arena_c = expr_transpile_expr(ctx, arena_expr);
                                            __auto_type _mv_234 = (*size_expr);
                                            switch (_mv_234.tag) {
                                                case types_SExpr_sym:
                                                {
                                                    __auto_type sym = _mv_234.data.sym;
                                                    {
                                                        ...
                                                        __auto_type _mv_235 = context_ctx_lookup_type(ctx, type_name);
                                                        if (_mv_235.has_value) {
                                                            __auto_type entry = _mv_235.value;
                                                            {
                                ...
                                if (_mv_236.has_value) {
                                    __auto_type variant_expr = _mv_236.value;
                                    __auto_type _mv_237 = (*variant_expr);
                                    switch (_mv_237.tag) {
                                        case types_SExpr_sym:
                                        {
                                ...
                                if (_mv_238.has_value) {
                                    ...
                                    if (_mv_239.has_value) {
                                        __auto_type tag_expr = _mv_239.value;
                                        __auto_type _mv_240 = (*type_expr);
                                        switch (_mv_240.tag) {
                                            case types_SExpr_sym:
                                            {
                                                __auto_type type_sym = _mv_240.data.sym;
                                                __auto_type _mv_241 = expr_extract_symbol_name(tag_expr);
                                                if (_mv_241.has_value) {
                                                    __auto_type tag_str = _mv_241.value;
                                                    {
                                                        ...
                                                        if ((len >= 4)) {
                                                            __auto_type _mv_242 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                ...
                                if (_mv_245.has_value) {
                                    __auto_type result_expr = _mv_245.value;
                                    {
                                        __auto_type result_c = expr_transpile_expr(ctx, result_expr);
                                        __auto_type _mv_246 = context_ctx_get_current_result_type(ctx);
                                        if (_mv_246.has_value) {
                                            __auto_type enclosing_type = _mv_246.value;
                                ...
                                if (_mv_247.has_value) {
                                    __auto_type list_expr = _mv_247.value;
                                    {
                                ...
                                if (_mv_248.has_value) {
                                    __auto_type list_expr = _mv_248.value;
                                ...
                                if (_mv_250.has_value) {
                                    __auto_type list_expr = _mv_250.value;
                                    {
                                        __auto_type list_c = expr_transpile_expr(ctx, list_expr);
                                        __auto_type option_type = expr_infer_list_element_option_type(ctx, list_expr);
                                        if ((string_len(option_type) > 0)) {
                                ...
                                if (_mv_251.has_value) {
                                    ...
                                    __auto_type _mv_252 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                ...
                                if (_mv_253.has_value) {
                                    __auto_type list_expr = _mv_253.value;
                                    ...
                                    if (_mv_254.has_value) {
                                        __auto_type item_expr = _mv_254.value;
                                        {
                                            __auto_type list_c = expr_transpile_expr(ctx, list_expr);
                                ...
                                __auto_type _mv_255 = context_ctx_get_current_return_type(ctx);
                                if (_mv_255.has_value) {
                                    __auto_type ret_type = _mv_255.value;
                    ...
                    default: {
                        {
                            ...
                            __auto_type i = 1;
                            while ((i < len)) {
                                __auto_type _mv_256 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_256.has_value) {
                                    __auto_type arg = _mv_256.value;
                                    {
        ...
        if (string_eq(fn_name, SLOP_STR("println"))) {
            ...
            if ((len < 3)) {
                ...
                if (_mv_259.has_value) {
                    __auto_type a_expr = _mv_259.value;
                    __auto_type _mv_260 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_260.has_value) {
                        __auto_type b_expr = _mv_260.value;
                        {
            ...
            if ((len < 3)) {
                ...
                if (_mv_261.has_value) {
                    __auto_type a_expr = _mv_261.value;
                    ...
                    if (_mv_262.has_value) {
                        __auto_type b_expr = _mv_262.value;
                        {
                            __auto_type a_c = expr_transpile_expr(ctx, a_expr);
                            __auto_type b_c = expr_transpile_expr(ctx, b_expr);
                            __auto_type s1 = string_concat(arena, SLOP_STR("(("), a_c);
            ...
            if ((len < 3)) {
                ...
                if (_mv_263.has_value) {
                    __auto_type fn_expr = _mv_263.value;
            ...
            if ((len < 3)) {
                ...
                if (_mv_264.has_value) {
                    __auto_type chan_expr = _mv_264.value;
                    ...
                    if (_mv_265.has_value) {
                        __auto_type value_expr = _mv_265.value;
                        {
            ...
            if ((len < 2)) {
                ...
                if (_mv_266.has_value) {
                    __auto_type chan_expr = _mv_266.value;
                    {
                        __auto_type chan_c = expr_transpile_expr(ctx, chan_expr);
                        __auto_type chan_c_type = expr_infer_expr_c_type(ctx, chan_expr);
                        {
        ...
        } else {
            {
                ...
                if ((string_len(builtin_c_name) > 0)) {
                    ...
                    __auto_type _mv_267 = context_ctx_lookup_type(ctx, fn_name);
                    if (_mv_267.has_value) {
                        __auto_type type_entry = _mv_267.value;
                        ...
                        __auto_type _mv_269 = context_ctx_lookup_enum_variant(ctx, fn_name);
                        if (_mv_269.has_value) {
                            __auto_type type_name = _mv_269.value;
                            {
                                ...
                                if ((len >= 2)) {
                                    ...
                                    if (_mv_270.has_value) {
                                        __auto_type value_expr = _mv_270.value;
                                        {
                                            __auto_type value_c = expr_transpile_expr(ctx, value_expr);
                        ...
                        } else if (!_mv_269.has_value) {
                            {
                                ...
                                if (!_mv_271.has_value) {
                                    ...
                                    __auto_type func_entry = _mv_271.value;
                                    while ((i < len)) {
...
slop_string expr_transpile_print(context_TranspileContext* ctx, types_SExpr* arg, uint8_t newline) {
    ...
    SLOP_PRE(((arg != NULL)), "(!= arg nil)");
    {
        ...
        __auto_type _mv_274 = (*arg);
        switch (_mv_274.tag) {
            case types_SExpr_str:
            {
                __auto_type s = _mv_274.data.str;
                return context_ctx_str5(ctx, SLOP_STR("printf(\"%s"), nl, SLOP_STR("\", \""), s.value, SLOP_STR("\")"));
            }
            case types_SExpr_num:
            {
                __auto_type n = _mv_274.data.num;
            ...
            default: {
                {
                    __auto_type arg_c = expr_transpile_expr(ctx, arg);
                    __auto_type _mv_275 = expr_get_expr_type_hint(ctx, arg);
                    if (_mv_275.has_value) {
                        __auto_type type_hint = _mv_275.value;
...
slop_string expr_transpile_printf_call(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        __auto_type i = 1;
        while ((i < len)) {
            __auto_type _mv_276 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_option_string expr_get_expr_type_hint(context_TranspileContext* ctx, types_SExpr* expr) {
    __auto_type _mv_278 = (*expr);
    switch (_mv_278.tag) {
        case types_SExpr_sym:
        {
            __auto_type sym = _mv_278.data.sym;
            __auto_type _mv_279 = context_ctx_lookup_var(ctx, sym.name);
            if (_mv_279.has_value) {
                __auto_type entry = _mv_279.value;
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_278.data.lst;
            {
                __auto_type items = lst.items;
                if ((((int64_t)((items).len)) >= 1)) {
                    __auto_type _mv_280 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_280.has_value) {
                        __auto_type head = _mv_280.value;
                        __auto_type _mv_281 = (*head);
                        switch (_mv_281.tag) {
                            case types_SExpr_sym:
                            {
                                __auto_type head_sym = _mv_281.data.sym;
                                {
                                    __auto_type op = head_sym.name;
                                    if ((string_eq(op, SLOP_STR(".")) && (((int64_t)((items).len)) >= 3))) {
                                        ...
                                        if (_mv_282.has_value) {
                                            __auto_type field_expr = _mv_282.value;
                                            __auto_type _mv_283 = (*field_expr);
                                            switch (_mv_283.tag) {
                                                case types_SExpr_sym:
                                                {
                                                    __auto_type field_sym = _mv_283.data.sym;
                                                    {
                                                        __auto_type field_name = field_sym.name;
                                        ...
                                        if (string_eq(op, SLOP_STR("pretty-print"))) {
                                            ...
                                            __auto_type _mv_284 = context_ctx_lookup_func(ctx, op);
                                            if (_mv_284.has_value) {
                                                __auto_type func_entry = _mv_284.value;
                                                if (func_entry.returns_string) {
                                                    return (slop_option_string){.has_value = 1, .value = SLOP_STR("slop_string")};
                                                } else {
                                                    return (slop_option_string){.has_value = false};
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len < 2)) {
            ...
            if (_mv_285.has_value) {
                __auto_type tag_expr = _mv_285.value;
                __auto_type _mv_286 = (*tag_expr);
                switch (_mv_286.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type tag_list = _mv_286.data.lst;
                        {
                            __auto_type tag_items = tag_list.items;
                            if ((((int64_t)((tag_items).len)) < 1)) {
                                return context_ctx_str3(ctx, SLOP_STR("(("), c_type_name, SLOP_STR("){})"));
                            } else {
                                __auto_type _mv_287 = ({ __auto_type _lst = tag_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_287.has_value) {
                                    __auto_type tag_name_expr = _mv_287.value;
                                    __auto_type _mv_288 = (*tag_name_expr);
                                    switch (_mv_288.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type tag_sym = _mv_288.data.sym;
                                            {
                                                ...
                                                if ((((int64_t)((tag_items).len)) >= 2)) {
                                                    __auto_type _mv_289 = ({ __auto_type _lst = tag_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_string expr_transpile_cond_expr(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        __auto_type i = 1;
        while ((i < len)) {
            __auto_type _mv_290 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_290.has_value) {
                __auto_type clause_expr = _mv_290.value;
                __auto_type _mv_291 = (*clause_expr);
                switch (_mv_291.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type clause_lst = _mv_291.data.lst;
                        {
                            __auto_type clause_items = clause_lst.items;
                            __auto_type clause_len = ((int64_t)((clause_items).len));
                            if ((clause_len >= 2)) {
                                __auto_type _mv_292 = ({ __auto_type _lst = clause_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_292.has_value) {
                                    __auto_type test_expr = _mv_292.value;
                                    __auto_type _mv_293 = (*test_expr);
                                    switch (_mv_293.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type sym = _mv_293.data.sym;
                                            if (string_eq(sym.name, SLOP_STR("else"))) {
                                                __auto_type _mv_294 = ({ __auto_type _lst = clause_items; size_t _idx = (size_t)(clause_len - 1); slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_294.has_value) {
                                                    __auto_type body_expr = _mv_294.value;
                                                    {
                                            ...
                                            } else {
                                                {
                                                    ...
                                                    __auto_type _mv_295 = ({ __auto_type _lst = clause_items; size_t _idx = (size_t)(clause_len - 1); slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_295.has_value) {
                                                        __auto_type body_expr = _mv_295.value;
                                                        {
                                        ...
                                        default: {
                                            {
                                                __auto_type test_c = expr_transpile_expr(ctx, test_expr);
                                                __auto_type _mv_296 = ({ __auto_type _lst = clause_items; size_t _idx = (size_t)(clause_len - 1); slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len < 3)) {
            ...
            if (_mv_297.has_value) {
                __auto_type scrutinee = _mv_297.value;
                {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while ((i < len)) {
            ...
            if (_mv_298.has_value) {
                __auto_type branch = _mv_298.value;
                __auto_type _mv_299 = (*branch);
                switch (_mv_299.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type branch_lst = _mv_299.data.lst;
                        {
                            __auto_type branch_items = branch_lst.items;
                            if ((((int64_t)((branch_items).len)) >= 1)) {
                                __auto_type _mv_300 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_300.has_value) {
                                    __auto_type pattern = _mv_300.value;
...
slop_string expr_get_expr_pattern_tag(types_SExpr* pat_expr) {
    ...
    __auto_type _mv_301 = (*pat_expr);
    switch (_mv_301.tag) {
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_301.data.lst;
            {
                __auto_type items = lst.items;
                if ((((int64_t)((items).len)) < 1)) {
                    return SLOP_STR("");
                } else {
                    __auto_type _mv_302 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_302.has_value) {
                        ...
                        switch (_mv_303.tag) {
                            case types_SExpr_sym:
                            {
                                __auto_type sym = _mv_303.data.sym;
                                return sym.name;
                            }
                            default: {
                                return SLOP_STR("");
...
uint8_t expr_is_option_patterns(slop_list_types_SExpr_ptr patterns) {
    {
        ...
        __auto_type i = 0;
        while (((i < len) && !(found))) {
            __auto_type _mv_304 = ({ __auto_type _lst = patterns; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_304.has_value) {
                __auto_type pat = _mv_304.value;
                {
...
uint8_t expr_is_result_patterns(slop_list_types_SExpr_ptr patterns) {
    {
        ...
        __auto_type i = 0;
        while (((i < len) && !(found))) {
            __auto_type _mv_305 = ({ __auto_type _lst = patterns; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_305.has_value) {
                __auto_type pat = _mv_305.value;
                {
                    __auto_type tag = expr_get_expr_pattern_tag(pat);
...
uint8_t expr_is_union_expr_patterns(context_TranspileContext* ctx, slop_list_types_SExpr_ptr patterns) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (((i < len) && !(has_union_variant))) {
            __auto_type _mv_306 = ({ __auto_type _lst = patterns; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_306.has_value) {
                __auto_type pat_expr = _mv_306.value;
                {
...
slop_option_string expr_get_expr_binding_name(types_SExpr* pat_expr) {
    SLOP_PRE(((pat_expr != NULL)), "(!= pat-expr nil)");
    __auto_type _mv_308 = (*pat_expr);
    switch (_mv_308.tag) {
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_308.data.lst;
            {
                __auto_type items = lst.items;
                if ((((int64_t)((items).len)) < 2)) {
                    return (slop_option_string){.has_value = false};
                    ...
                    if (_mv_309.has_value) {
                        __auto_type binding = _mv_309.value;
                        __auto_type _mv_310 = (*binding);
                        switch (_mv_310.tag) {
                            case types_SExpr_sym:
                            {
...
slop_string expr_get_match_branch_body(context_TranspileContext* ctx, slop_list_types_SExpr_ptr branch_items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len < 2)) {
            ...
            __auto_type _mv_311 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)(len - 1); slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_311.has_value) {
                __auto_type body_expr = _mv_311.value;
...
slop_string expr_build_option_match_expr(context_TranspileContext* ctx, types_SExpr* scrutinee, slop_string scrutinee_c, slop_list_types_SExpr_ptr items) {
    ...
    SLOP_PRE(((scrutinee != NULL)), "(!= scrutinee nil)");
    {
        ...
        __auto_type i = 2;
        while ((i < len)) {
            __auto_type _mv_312 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_312.has_value) {
                __auto_type branch = _mv_312.value;
                __auto_type _mv_313 = (*branch);
                switch (_mv_313.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type branch_lst = _mv_313.data.lst;
                        {
                            __auto_type branch_items = branch_lst.items;
                            if ((((int64_t)((branch_items).len)) >= 2)) {
                                __auto_type _mv_314 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_314.has_value) {
                                    __auto_type pattern = _mv_314.value;
                                    {
                                        __auto_type tag = expr_get_expr_pattern_tag(pattern);
                                        if (string_eq(tag, SLOP_STR("some"))) {
                                            __auto_type _mv_315 = expr_get_expr_binding_name(pattern);
                                            if (_mv_315.has_value) {
                                                __auto_type name = _mv_315.value;
                                                some_binding = name;
...
slop_string expr_infer_cond_result_c_type(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len < 2)) {
            ...
            __auto_type _mv_316 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_316.has_value) {
                __auto_type first_clause = _mv_316.value;
                __auto_type _mv_317 = (*first_clause);
                switch (_mv_317.tag) {
                    case types_SExpr_lst:
                    {
...
slop_string expr_infer_match_branch_body_type(context_TranspileContext* ctx, types_SExpr* branch) {
    ...
    __auto_type _mv_319 = (*branch);
    switch (_mv_319.tag) {
        case types_SExpr_lst:
        {
            __auto_type branch_lst = _mv_319.data.lst;
            {
                __auto_type branch_items = branch_lst.items;
                ...
                if ((branch_len < 2)) {
                    ...
                    __auto_type _mv_320 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)(branch_len - 1); slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_string expr_slop_type_to_c_type(context_TranspileContext* ctx, slop_string slop_type) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_322 = context_ctx_lookup_type(ctx, slop_type);
        if (_mv_322.has_value) {
            __auto_type entry = _mv_322.value;
            return entry.c_name;
...
slop_string expr_infer_expr_c_type(context_TranspileContext* ctx, types_SExpr* expr) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    SLOP_PRE(((expr != NULL)), "(!= expr nil)");
    __auto_type _mv_323 = ctype_get_node_resolved_type(expr);
    if (_mv_323.has_value) {
        __auto_type rt = _mv_323.value;
        ...
        __auto_type _mv_324 = (*expr);
        switch (_mv_324.tag) {
            case types_SExpr_str:
            {
                __auto_type _ = _mv_324.data.str;
                return SLOP_STR("slop_string");
            }
            case types_SExpr_num:
            {
                __auto_type num = _mv_324.data.num;
                if (num.is_float) {
                    return SLOP_STR("double");
                } else {
                    return SLOP_STR("int64_t");
            ...
            case types_SExpr_sym:
            {
                __auto_type sym = _mv_324.data.sym;
                {
                    ...
                    if (_mv_325.has_value) {
                        __auto_type entry = _mv_325.value;
                        {
                                    ...
                                    __auto_type sym = _mv_327.data.sym;
                                    {
                                        ...
                                        if (({ __auto_type _mv = context_ctx_lookup_func(ctx, op); _mv.has_value ? ({ __auto_type func_entry = _mv.value; func_entry.returns_string; }) : (0); })) {
                                            ...
                                            if ((((int64_t)((items).len)) < 3)) {
                                                ...
                                                __auto_type _mv_328 = ({ __auto_type _lst = items; size_t _idx = (size_t)(((int64_t)((items).len)) - 1); slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_328.has_value) {
                                                    __auto_type body = _mv_328.value;
                                            ...
                                            if ((((int64_t)((items).len)) < 2)) {
                                                ...
                                                __auto_type _mv_329 = ({ __auto_type _lst = items; size_t _idx = (size_t)(((int64_t)((items).len)) - 1); slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_329.has_value) {
                                                    __auto_type last_expr = _mv_329.value;
                                            ...
                                            if ((((int64_t)((items).len)) < 3)) {
                                                ...
                                                __auto_type _mv_330 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_330.has_value) {
                                                    __auto_type then_expr = _mv_330.value;
                                            ...
                                            if ((((int64_t)((items).len)) < 2)) {
                                                ...
                                                __auto_type _mv_331 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            ...
                                            __auto_type _mv_332 = context_ctx_get_current_return_type(ctx);
                                            if (_mv_332.has_value) {
                                                __auto_type ret_type = _mv_332.value;
                                                if (strlib_starts_with(ret_type, SLOP_STR("slop_option_"))) {
                                                    return ret_type;
                                                } else {
                                                    return SLOP_STR("slop_option_int");
                                            ...
                                            if ((((int64_t)((items).len)) < 2)) {
                                                ...
                                                if (_mv_333.has_value) {
                                                    __auto_type type_expr = _mv_333.value;
                                                    return context_to_c_type_prefixed(ctx, type_expr);
                                            ...
                                            if ((((int64_t)((items).len)) < 2)) {
                                                ...
                                                __auto_type _mv_334 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_334.has_value) {
                                                    __auto_type inner = _mv_334.value;
                                                    {
                                            ...
                                            if ((((int64_t)((items).len)) < 2)) {
                                                ...
                                                __auto_type _mv_336 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_336.has_value) {
                                                    __auto_type chan_arg = _mv_336.value;
                                                    {
                                            ...
                                            if ((((int64_t)((items).len)) < 3)) {
                                                ...
                                                __auto_type _mv_337 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            ...
                                            __auto_type _mv_339 = context_ctx_lookup_type(ctx, op);
                                            if (_mv_339.has_value) {
                                                __auto_type type_entry = _mv_339.value;
                                                return type_entry.c_name;
                                            } else if (!_mv_339.has_value) {
                                                __auto_type _mv_340 = context_ctx_lookup_func(ctx, op);
                                                if (_mv_340.has_value) {
                                                    __auto_type func_entry = _mv_340.value;
                                                    {
                                                        __auto_type ret_type = func_entry.return_type;
                                                        if (func_entry.returns_string) {
                                                            return SLOP_STR("slop_string");
                                ...
                                if (_mv_343.has_value) {
                                    __auto_type pattern = _mv_343.value;
                                    {
                                        ...
                                        if (string_eq(tag, SLOP_STR("ok"))) {
                                            ...
                                            __auto_type _mv_345 = expr_get_expr_binding_name(pattern);
                                            if (_mv_345.has_value) {
                                                __auto_type name = _mv_345.value;
                                                err_binding = name;
...
slop_string expr_build_union_match_expr(context_TranspileContext* ctx, types_SExpr* scrutinee, slop_string scrutinee_c, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        __auto_type i = 2;
        while ((i < len)) {
            __auto_type _mv_346 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_346.has_value) {
                __auto_type branch = _mv_346.value;
                __auto_type _mv_347 = (*branch);
                switch (_mv_347.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type branch_lst = _mv_347.data.lst;
                        {
                            __auto_type branch_items = branch_lst.items;
                            if ((((int64_t)((branch_items).len)) >= 2)) {
                                __auto_type _mv_348 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_348.has_value) {
                                    __auto_type pattern = _mv_348.value;
...
slop_string expr_build_union_case_expr(context_TranspileContext* ctx, slop_arena* arena, slop_string cases, types_SExpr* scrutinee, types_SExpr* pattern, slop_list_types_SExpr_ptr branch_items, slop_string result_type) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((string_eq(tag, SLOP_STR("else")) || string_eq(tag, SLOP_STR("_")))) {
            ...
            __auto_type _mv_349 = context_ctx_lookup_enum_variant(ctx, tag);
            if (_mv_349.has_value) {
                __auto_type type_name = _mv_349.value;
                {
                    ...
                    __auto_type _mv_350 = binding_opt;
                    if (_mv_350.has_value) {
                        __auto_type binding_name = _mv_350.value;
                        {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while ((i >= 2)) {
            ...
            if (_mv_351.has_value) {
                __auto_type branch = _mv_351.value;
                ...
                switch (_mv_352.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type branch_lst = _mv_352.data.lst;
                        {
                            __auto_type branch_items = branch_lst.items;
                            if ((((int64_t)((branch_items).len)) >= 2)) {
                                __auto_type _mv_353 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_353.has_value) {
                                    __auto_type pattern = _mv_353.value;
                                    {
                                        __auto_type tag = expr_get_expr_pattern_tag(pattern);
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len < 3)) {
            ...
            if (_mv_354.has_value) {
                __auto_type bindings_expr = _mv_354.value;
                __auto_type _mv_355 = (*bindings_expr);
                switch (_mv_355.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type bindings_lst = _mv_355.data.lst;
                        {
                            __auto_type result = SLOP_STR("({ ");
                            ...
                            while ((bi < bindings_len)) {
                                __auto_type _mv_356 = ({ __auto_type _lst = bindings_items; size_t _idx = (size_t)bi; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            ...
                            }
                            {
                                ...
                                while ((i < (len - 1))) {
                                    ...
                                    if (_mv_357.has_value) {
                                        __auto_type body_expr = _mv_357.value;
                                        {
                                            __auto_type body_c = expr_transpile_expr(ctx, body_expr);
                                ...
                                __auto_type _mv_358 = ({ __auto_type _lst = items; size_t _idx = (size_t)(len - 1); slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_358.has_value) {
                                    __auto_type last_expr = _mv_358.value;
                                    {
                ...
                __auto_type lst = _mv_359.data.lst;
                {
                    ...
                    if ((len < 2)) {
                    ...
                    } else {
                        {
                            ...
                            __auto_type _mv_360 = ({ __auto_type _lst = items; size_t _idx = (size_t)name_idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_360.has_value) {
                                __auto_type name_expr = _mv_360.value;
                                __auto_type _mv_361 = (*name_expr);
                                switch (_mv_361.tag) {
                                    case types_SExpr_sym:
                                    {
                                        __auto_type name_sym = _mv_361.data.sym;
                                        {
                                            ...
                                            if (has_type) {
                                                __auto_type _mv_362 = ({ __auto_type _lst = items; size_t _idx = (size_t)type_idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_362.has_value) {
                                                    __auto_type type_expr = _mv_362.value;
                                                    {
                                                        __auto_type c_type = context_to_c_type_prefixed(ctx, type_expr);
                                                        __auto_type _mv_363 = ({ __auto_type _lst = items; size_t _idx = (size_t)init_idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                        if (_mv_363.has_value) {
                                                            __auto_type init_expr = _mv_363.value;
                                                            {
                                                    ...
                                                    __auto_type _mv_364 = ({ __auto_type _lst = items; size_t _idx = (size_t)init_idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_364.has_value) {
                                                        __auto_type init_expr = _mv_364.value;
                                                        {
                                                ...
                                                __auto_type _mv_365 = ({ __auto_type _lst = items; size_t _idx = (size_t)init_idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_365.has_value) {
                                                    __auto_type init_expr = _mv_365.value;
                                                    {
                                                        __auto_type init_c = expr_transpile_expr(ctx, init_expr);
                                                        return context_ctx_str5(ctx, SLOP_STR("__auto_type "), var_name, SLOP_STR(" = "), init_c, SLOP_STR(";"));
                                                    }
...
uint8_t expr_binding_has_mut(slop_list_types_SExpr_ptr items) {
    if ((((int64_t)((items).len)) < 1)) {
        ...
        __auto_type _mv_366 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        if (_mv_366.has_value) {
            __auto_type first = _mv_366.value;
            __auto_type _mv_367 = (*first);
            switch (_mv_367.tag) {
                case types_SExpr_sym:
                {
                    __auto_type sym = _mv_367.data.sym;
...
slop_string expr_transpile_typed_init(context_TranspileContext* ctx, types_SExpr* init_expr, slop_string target_type) {
    ...
    __auto_type _mv_368 = (*init_expr);
    switch (_mv_368.tag) {
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_368.data.lst;
            {
                __auto_type items = lst.items;
                if ((((int64_t)((items).len)) < 1)) {
                    return expr_transpile_expr(ctx, init_expr);
                } else {
                    __auto_type _mv_369 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                ...
                                __auto_type sym = _mv_370.data.sym;
                                {
                                    ...
                                    if (string_eq(op, SLOP_STR("some"))) {
                                        if ((((int64_t)((items).len)) < 2)) {
                                            ...
                                            __auto_type _mv_371 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len < 3)) {
            ...
            if (_mv_372.has_value) {
                __auto_type cond_expr = _mv_372.value;
                {
                    __auto_type cond_c = expr_transpile_expr(ctx, cond_expr);
...
slop_string expr_transpile_when_expr(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len < 2)) {
            ...
            __auto_type _mv_375 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_375.has_value) {
                __auto_type cond_expr = _mv_375.value;
                {
                    __auto_type cond_c = expr_transpile_expr(ctx, cond_expr);
...
slop_string expr_transpile_set_expr(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len < 3)) {
            ...
            __auto_type _mv_377 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_377.has_value) {
                __auto_type target_expr = _mv_377.value;
                __auto_type _mv_378 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_378.has_value) {
                    __auto_type val_expr = _mv_378.value;
                    {
                        __auto_type val_c = expr_transpile_expr(ctx, val_expr);
                        __auto_type _mv_379 = (*target_expr);
                        switch (_mv_379.tag) {
                            case types_SExpr_lst:
                            {
                                __auto_type target_lst = _mv_379.data.lst;
                                {
                                    ...
                                    if ((((int64_t)((target_items).len)) < 1)) {
                                        ...
                                        __auto_type _mv_380 = ({ __auto_type _lst = target_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_380.has_value) {
                                            __auto_type head = _mv_380.value;
                                            __auto_type _mv_381 = (*head);
                                            switch (_mv_381.tag) {
                                                case types_SExpr_sym:
                                                {
                                                    __auto_type sym = _mv_381.data.sym;
                                                    {
                                                        ...
                                                        if (string_eq(op, SLOP_STR("@"))) {
                                                            if ((((int64_t)((target_items).len)) < 3)) {
                                                                ...
                                                                __auto_type _mv_382 = ({ __auto_type _lst = target_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                                if (_mv_382.has_value) {
                                                                    __auto_type arr_expr = _mv_382.value;
                                                                    __auto_type _mv_383 = ({ __auto_type _lst = target_items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                                    if (_mv_383.has_value) {
                                                                        __auto_type idx_expr = _mv_383.value;
                                                                        {
                                                                            __auto_type arr_c = expr_transpile_expr(ctx, arr_expr);
                                                                            __auto_type idx_c = expr_transpile_expr(ctx, idx_expr);
                            ...
                            case types_SExpr_sym:
                            {
                                __auto_type sym = _mv_379.data.sym;
                                {
...
slop_string expr_get_arena_for_list_push_expr(context_TranspileContext* ctx, types_SExpr* list_expr, slop_string list_c) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    SLOP_PRE(((list_expr != NULL)), "(!= list-expr nil)");
    __auto_type _mv_384 = context_ctx_lookup_var(ctx, SLOP_STR("arena"));
    if (_mv_384.has_value) {
        __auto_type arena_var = _mv_384.value;
        return arena_var.c_name;
    } else if (!_mv_384.has_value) {
        __auto_type _mv_385 = context_ctx_lookup_var(ctx, SLOP_STR("ctx"));
        if (_mv_385.has_value) {
            __auto_type ctx_var = _mv_385.value;
            ...
            __auto_type lst = _mv_386.data.lst;
            {
                ...
                if ((len < 3)) {
                    ...
                    if (_mv_387.has_value) {
                        __auto_type head_expr = _mv_387.value;
                        __auto_type _mv_388 = (*head_expr);
                        switch (_mv_388.tag) {
                            case types_SExpr_sym:
                            {
                                ...
                                if (string_eq(sym.name, SLOP_STR("."))) {
                                    ...
                                    if (_mv_389.has_value) {
                                        __auto_type base_expr = _mv_389.value;
    ...
    switch (_mv_390.tag) {
        case types_SExpr_sym:
        {
            __auto_type sym = _mv_390.data.sym;
            {
                ...
                __auto_type _mv_391 = context_ctx_lookup_var(ctx, var_name);
                if (_mv_391.has_value) {
                    __auto_type entry = _mv_391.value;
                    if (entry.is_pointer) {
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_390.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 2)) {
                    ...
                    __auto_type _mv_392 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_392.has_value) {
                        __auto_type head_expr = _mv_392.value;
                        __auto_type _mv_393 = (*head_expr);
                        switch (_mv_393.tag) {
                            case types_SExpr_sym:
                            {
                                ...
                                if (string_eq(sym.name, SLOP_STR("deref"))) {
                                    ...
                                    if (_mv_394.has_value) {
                                        __auto_type ptr_expr = _mv_394.value;
                                        {
...
uint8_t expr_is_ptr_to_ptr_map(context_TranspileContext* ctx, types_SExpr* expr) {
    ...
    switch (_mv_395.tag) {
        case types_SExpr_sym:
        {
            ...
            {
                __auto_type name = sym.name;
                __auto_type _mv_396 = context_ctx_lookup_var(ctx, name);
        ...
        if ((len < 2)) {
            ...
            if (_mv_397.has_value) {
                ...
                switch (_mv_398.tag) {
                    case types_SExpr_sym:
                    {
                        __auto_type type_sym = _mv_398.data.sym;
                        {
                            __auto_type raw_type_name = type_sym.name;
                    ...
                    case types_SExpr_lst:
                    {
                        __auto_type type_lst = _mv_398.data.lst;
                        {
                            ...
                            if ((((int64_t)((type_items).len)) < 1)) {
                                ...
                                __auto_type _mv_399 = ({ __auto_type _lst = type_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_399.has_value) {
                                    ...
                                    switch (_mv_400.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type head_sym = _mv_400.data.sym;
...
slop_string expr_transpile_record_fields(context_TranspileContext* ctx, slop_string type_name, slop_list_types_SExpr_ptr items, int64_t start_idx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        __auto_type first = 1;
        while ((i < len)) {
            __auto_type _mv_401 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_401.has_value) {
                __auto_type field_expr = _mv_401.value;
                __auto_type _mv_402 = (*field_expr);
                switch (_mv_402.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type field_lst = _mv_402.data.lst;
                        {
                            __auto_type field_items = field_lst.items;
                            if ((((int64_t)((field_items).len)) >= 2)) {
                                __auto_type _mv_403 = ({ __auto_type _lst = field_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_403.has_value) {
                                    __auto_type name_expr = _mv_403.value;
                                    __auto_type _mv_404 = (*name_expr);
                                    switch (_mv_404.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type name_sym = _mv_404.data.sym;
                                            __auto_type _mv_405 = ({ __auto_type _lst = field_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_string expr_build_inline_struct_type(context_TranspileContext* ctx, slop_list_types_SExpr_ptr type_items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        __auto_type i = 1;
        while ((i < len)) {
            __auto_type _mv_406 = ({ __auto_type _lst = type_items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_406.has_value) {
                __auto_type field_expr = _mv_406.value;
                __auto_type _mv_407 = (*field_expr);
                switch (_mv_407.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type field_lst = _mv_407.data.lst;
                        {
                            __auto_type field_items = field_lst.items;
                            if ((((int64_t)((field_items).len)) >= 2)) {
                                __auto_type _mv_408 = ({ __auto_type _lst = field_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_408.has_value) {
                                    ...
                                    switch (_mv_409.tag) {
                                        case types_SExpr_sym:
                                        {
                                            ...
                                            __auto_type _mv_410 = ({ __auto_type _lst = field_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_string expr_transpile_inline_record_fields(context_TranspileContext* ctx, slop_string struct_def, slop_list_types_SExpr_ptr items, int64_t start_idx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        __auto_type first = 1;
        while ((i < len)) {
            __auto_type _mv_411 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_411.has_value) {
                __auto_type field_expr = _mv_411.value;
                __auto_type _mv_412 = (*field_expr);
                switch (_mv_412.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type field_lst = _mv_412.data.lst;
                        {
                            __auto_type field_items = field_lst.items;
                            if ((((int64_t)((field_items).len)) >= 2)) {
                                __auto_type _mv_413 = ({ __auto_type _lst = field_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_413.has_value) {
                                    __auto_type name_expr = _mv_413.value;
                                    __auto_type _mv_414 = (*name_expr);
                                    switch (_mv_414.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type name_sym = _mv_414.data.sym;
                                            __auto_type _mv_415 = ({ __auto_type _lst = field_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_string expr_get_map_key_c_info(context_TranspileContext* ctx, types_SExpr* key_type_expr) {
    ...
    __auto_type _mv_418 = (*key_type_expr);
    switch (_mv_418.tag) {
        case types_SExpr_sym:
        {
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_418.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    __auto_type _mv_419 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_string expr_get_struct_key_info_by_name(context_TranspileContext* ctx, slop_string name) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    __auto_type _mv_421 = context_ctx_lookup_type(ctx, name);
    if (_mv_421.has_value) {
        __auto_type type_entry = _mv_421.value;
        {
            __auto_type c_name = type_entry.c_name;
            context_ctx_register_struct_key_type(ctx, c_name);
            return expr_build_struct_key_info(ctx, c_name);
        ...
        __auto_type _mv_422 = context_ctx_get_module(ctx);
        if (_mv_422.has_value) {
            __auto_type mod = _mv_422.value;
            {
                __auto_type prefixed = context_ctx_str3(ctx, mod, SLOP_STR("_"), name);
                __auto_type _mv_423 = context_ctx_lookup_type(ctx, prefixed);
                if (_mv_423.has_value) {
                    __auto_type type_entry = _mv_423.value;
                    {
                        __auto_type c_name = type_entry.c_name;
                        context_ctx_register_struct_key_type(ctx, c_name);
                        return expr_build_struct_key_info(ctx, c_name);
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len < 3)) {
            ...
            if (_mv_425.has_value) {
                ...
                __auto_type _mv_426 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_426.has_value) {
                    __auto_type key_type_expr = _mv_426.value;
                    {
                        __auto_type arena_c = expr_transpile_expr(ctx, arena_expr);
...
slop_string expr_transpile_map_put(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len < 4)) {
            ...
            __auto_type _mv_427 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_427.has_value) {
                __auto_type map_expr = _mv_427.value;
                __auto_type _mv_428 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_428.has_value) {
                    __auto_type key_expr = _mv_428.value;
                    __auto_type _mv_429 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_string expr_transpile_map_get(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len < 3)) {
            ...
            __auto_type _mv_430 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_430.has_value) {
                __auto_type map_expr = _mv_430.value;
                __auto_type _mv_431 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_431.has_value) {
                    __auto_type key_expr = _mv_431.value;
                    {
                        __auto_type map_c = expr_transpile_expr(ctx, map_expr);
                        __auto_type key_c = expr_transpile_expr(ctx, key_expr);
                        __auto_type key_ptr = expr_wrap_map_key_as_ptr(ctx, key_c, key_expr, map_expr);
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len < 3)) {
            ...
            if (_mv_432.has_value) {
                __auto_type map_expr = _mv_432.value;
                __auto_type _mv_433 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_433.has_value) {
                    __auto_type key_expr = _mv_433.value;
                    {
                        __auto_type map_c = expr_transpile_expr(ctx, map_expr);
                        __auto_type key_c = expr_transpile_expr(ctx, key_expr);
                        __auto_type key_ptr = expr_wrap_map_key_as_ptr(ctx, key_c, key_expr, map_expr);
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len < 2)) {
            ...
            if (_mv_434.has_value) {
                __auto_type map_expr = _mv_434.value;
                {
                    __auto_type map_c = expr_transpile_expr(ctx, map_expr);
...
slop_string expr_transpile_set_new(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len < 3)) {
            ...
            __auto_type _mv_435 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_435.has_value) {
                __auto_type arena_expr = _mv_435.value;
                __auto_type _mv_436 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_436.has_value) {
                    __auto_type elem_type_expr = _mv_436.value;
                    {
                        __auto_type arena_c = expr_transpile_expr(ctx, arena_expr);
...
slop_string expr_transpile_set_put(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len < 3)) {
            ...
            __auto_type _mv_437 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_437.has_value) {
                __auto_type set_expr = _mv_437.value;
                __auto_type _mv_438 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_438.has_value) {
                    __auto_type elem_expr = _mv_438.value;
                    {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len < 3)) {
            ...
            if (_mv_439.has_value) {
                __auto_type set_expr = _mv_439.value;
                __auto_type _mv_440 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_440.has_value) {
                    __auto_type elem_expr = _mv_440.value;
                    {
                        __auto_type set_c = expr_transpile_expr(ctx, set_expr);
                        __auto_type elem_c = expr_transpile_expr(ctx, elem_expr);
                        __auto_type elem_ptr = expr_wrap_map_key_as_ptr(ctx, elem_c, elem_expr, set_expr);
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len < 3)) {
            ...
            if (_mv_441.has_value) {
                __auto_type set_expr = _mv_441.value;
                ...
                if (_mv_442.has_value) {
                    __auto_type elem_expr = _mv_442.value;
                    {
                        __auto_type set_c = expr_transpile_expr(ctx, set_expr);
                        __auto_type elem_c = expr_transpile_expr(ctx, elem_expr);
                        __auto_type elem_ptr = expr_wrap_map_key_as_ptr(ctx, elem_c, elem_expr, set_expr);
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len < 2)) {
            ...
            if (_mv_443.has_value) {
                __auto_type set_expr = _mv_443.value;
                {
                    __auto_type set_c = expr_transpile_expr(ctx, set_expr);
...
slop_string expr_transpile_set_literal(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len < 2)) {
            ...
            __auto_type _mv_444 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_444.has_value) {
                __auto_type type_expr = _mv_444.value;
                {
                    ...
                    __auto_type result = context_ctx_str(ctx, SLOP_STR("({ slop_map* _s = slop_map_new_ptr(arena, "), context_ctx_str(ctx, int_to_string(arena, init_cap), context_ctx_str(ctx, SLOP_STR(", "), context_ctx_str(ctx, elem_info, SLOP_STR("); ")))));
                    {
                        __auto_type i = 2;
                        while ((i < len)) {
                            __auto_type _mv_445 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_445.has_value) {
                                __auto_type elem_expr = _mv_445.value;
                                {
                                    __auto_type elem_c = expr_transpile_expr(ctx, elem_expr);
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len < 2)) {
            ...
            if (_mv_446.has_value) {
                __auto_type binding_expr = _mv_446.value;
                __auto_type _mv_447 = (*binding_expr);
                switch (_mv_447.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type binding_lst = _mv_447.data.lst;
                        {
                            ...
                            if ((binding_len < 3)) {
                                ...
                                __auto_type _mv_448 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_448.has_value) {
                                    __auto_type var_expr = _mv_448.value;
                                    __auto_type _mv_449 = (*var_expr);
                                    switch (_mv_449.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type var_sym = _mv_449.data.sym;
                                            {
                                                __auto_type var_name = ctype_to_c_name(arena, var_sym.name);
                                                __auto_type _mv_450 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_450.has_value) {
                                                    __auto_type start_expr = _mv_450.value;
                                                    __auto_type _mv_451 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_451.has_value) {
                                                        __auto_type end_expr = _mv_451.value;
                                                        {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len < 2)) {
            ...
            if (_mv_453.has_value) {
                __auto_type binding_expr = _mv_453.value;
                __auto_type _mv_454 = (*binding_expr);
                switch (_mv_454.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type binding_lst = _mv_454.data.lst;
                        {
                            __auto_type binding_items = binding_lst.items;
                            __auto_type binding_len = ((int64_t)((binding_items).len));
                            if ((binding_len < 2)) {
                                ...
                                __auto_type _mv_455 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_455.has_value) {
                                    __auto_type var_expr = _mv_455.value;
                                    __auto_type _mv_456 = (*var_expr);
                                    switch (_mv_456.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type var_sym = _mv_456.data.sym;
                                            {
                                                __auto_type var_name = ctype_to_c_name(arena, var_sym.name);
                                                __auto_type _mv_457 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_457.has_value) {
                                                    __auto_type coll_expr = _mv_457.value;
                                                    {
                                                        ...
                                                        context_ctx_bind_var(ctx, (context_VarEntry){var_sym.name, var_name, SLOP_STR("auto"), elem_slop_type, 0, 0, 0, SLOP_STR(""), SLOP_STR("")});
                                                        {
                                                            __auto_type i = 2;
                                                            while ((i < len)) {
                                                                __auto_type _mv_458 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len < 2)) {
            ...
            if (_mv_459.has_value) {
                __auto_type second = _mv_459.value;
                __auto_type _mv_460 = (*second);
                switch (_mv_460.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type params_lst = _mv_460.data.lst;
                        return expr_transpile_lambda_with_params(ctx, items, params_lst.items);
                    }
                    case types_SExpr_sym:
                    {
                        __auto_type _ = _mv_460.data.sym;
...
slop_list_string expr_extract_param_names(slop_arena* arena, slop_list_types_SExpr_ptr params) {
    {
        ...
        __auto_type i = 0;
        while ((i < count)) {
            __auto_type _mv_461 = ({ __auto_type _lst = params; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_461.has_value) {
                __auto_type param_expr = _mv_461.value;
                __auto_type _mv_462 = (*param_expr);
                switch (_mv_462.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type param_lst = _mv_462.data.lst;
                        {
                            __auto_type param_items = param_lst.items;
                            if ((((int64_t)((param_items).len)) >= 1)) {
                                __auto_type _mv_463 = ({ __auto_type _lst = param_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_string expr_build_closure_struct(context_TranspileContext* ctx, slop_string env_type, slop_list_string free_vars) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        __auto_type i = 0;
        while ((i < count)) {
            __auto_type _mv_465 = ({ __auto_type _lst = free_vars; size_t _idx = (size_t)i; slop_option_string _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_465.has_value) {
                __auto_type var_name = _mv_465.value;
                {
...
void expr_bind_closure_captures(context_TranspileContext* ctx, slop_list_string free_vars) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        __auto_type i = 0;
        while ((i < count)) {
            __auto_type _mv_466 = ({ __auto_type _lst = free_vars; size_t _idx = (size_t)i; slop_option_string _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_466.has_value) {
                __auto_type var_name = _mv_466.value;
                {
                    __auto_type c_name = ctype_to_c_name(arena, var_name);
...
slop_string expr_build_env_initializer(context_TranspileContext* ctx, slop_list_string free_vars) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        __auto_type i = 0;
        while ((i < count)) {
            __auto_type _mv_467 = ({ __auto_type _lst = free_vars; size_t _idx = (size_t)i; slop_option_string _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_467.has_value) {
                __auto_type var_name = _mv_467.value;
                {
                    __auto_type c_name = ctype_to_c_name(arena, var_name);
                    if ((i > 0)) {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((param_count == 0)) {
        ...
        } else {
            {
                ...
                __auto_type i = 0;
                while ((i < param_count)) {
                    __auto_type _mv_468 = ({ __auto_type _lst = params; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_468.has_value) {
                        __auto_type param_expr = _mv_468.value;
                        __auto_type _mv_469 = (*param_expr);
                        switch (_mv_469.tag) {
                            case types_SExpr_lst:
                            {
                                __auto_type param_lst = _mv_469.data.lst;
                                {
                                    __auto_type param_items = param_lst.items;
                                    if ((((int64_t)((param_items).len)) >= 2)) {
                                        __auto_type _mv_470 = ({ __auto_type _lst = param_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_470.has_value) {
                                            ...
                                            switch (_mv_471.tag) {
                                                case types_SExpr_sym:
                                                {
                                                    ...
                                                    __auto_type _mv_472 = ({ __auto_type _lst = param_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void expr_bind_lambda_params(context_TranspileContext* ctx, slop_list_types_SExpr_ptr params) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        __auto_type i = 0;
        while ((i < param_count)) {
            __auto_type _mv_473 = ({ __auto_type _lst = params; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_473.has_value) {
                __auto_type param_expr = _mv_473.value;
                __auto_type _mv_474 = (*param_expr);
                switch (_mv_474.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type param_lst = _mv_474.data.lst;
                        {
                            __auto_type param_items = param_lst.items;
                            if ((((int64_t)((param_items).len)) >= 2)) {
                                __auto_type _mv_475 = ({ __auto_type _lst = param_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_475.has_value) {
                                    __auto_type name_expr = _mv_475.value;
                                    __auto_type _mv_476 = (*name_expr);
                                    switch (_mv_476.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type name_sym = _mv_476.data.sym;
                                            __auto_type _mv_477 = ({ __auto_type _lst = param_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_477.has_value) {
                                                __auto_type type_expr = _mv_477.value;
                                                {
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_478.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    __auto_type _mv_479 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_482.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 2)) {
                    ...
                    __auto_type _mv_483 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            ...
                            case types_SExpr_sym:
                            {
                                ...
                                if (!(string_eq(sym.name, SLOP_STR("fn")))) {
                                    ...
                                    if (_mv_485.has_value) {
                                        __auto_type second = _mv_485.value;
                                        __auto_type _mv_486 = (*second);
                                        switch (_mv_486.tag) {
                                            case types_SExpr_lst:
                                            {
...
slop_string expr_transpile_spawn_closure(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items, types_SExpr* fn_expr) {
    ...
    SLOP_PRE(((fn_expr != NULL)), "(!= fn-expr nil)");
    {
        ...
        if (_mv_487.has_value) {
            __auto_type arena_expr = _mv_487.value;
            {
                __auto_type arena_c = expr_transpile_expr(ctx, arena_expr);
...
uint8_t expr_lambda_has_captures(context_TranspileContext* ctx, types_SExpr* fn_expr) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    SLOP_PRE(((fn_expr != NULL)), "(!= fn-expr nil)");
    __auto_type _mv_488 = (*fn_expr);
    switch (_mv_488.tag) {
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_488.data.lst;
            {
                __auto_type items = lst.items;
                __auto_type arena = (*ctx).arena;
                if ((((int64_t)((items).len)) < 2)) {
                    ...
                    if (_mv_489.has_value) {
                        __auto_type params_expr = _mv_489.value;
                        __auto_type _mv_490 = (*params_expr);
                        switch (_mv_490.tag) {
                            case types_SExpr_lst:
                            {
                                __auto_type params_lst = _mv_490.data.lst;
                                {
...
slop_list_string expr_find_free_vars(context_TranspileContext* ctx, slop_list_string param_names, slop_list_types_SExpr_ptr body_items, int64_t start) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        __auto_type i = start;
        while ((i < len)) {
            __auto_type _mv_492 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_492.has_value) {
                __auto_type expr = _mv_492.value;
        ...
        }
        {
            ...
            __auto_type j = 0;
            while ((j < sym_count)) {
                __auto_type _mv_493 = ({ __auto_type _lst = all_symbols; size_t _idx = (size_t)j; slop_option_string _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_493.has_value) {
                    __auto_type sym_name = _mv_493.value;
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len >= 2)) {
            ...
            if (_mv_498.has_value) {
                ...
                __auto_type _mv_499 = (*bindings_expr);
                switch (_mv_499.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type bindings_lst = _mv_499.data.lst;
                        {
                            __auto_type bindings = bindings_lst.items;
                            __auto_type binding_count = ((int64_t)((bindings).len));
                            __auto_type i = 0;
                            while ((i < binding_count)) {
                                __auto_type _mv_500 = ({ __auto_type _lst = bindings; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_500.has_value) {
                                    __auto_type binding = _mv_500.value;
                                    __auto_type _mv_501 = (*binding);
                                    switch (_mv_501.tag) {
                                        case types_SExpr_lst:
                                        {
                                            __auto_type bind_lst = _mv_501.data.lst;
                                            {
                                                __auto_type bind_items = bind_lst.items;
                                                if ((((int64_t)((bind_items).len)) >= 2)) {
                                                    {
                                                        __auto_type val_idx = ((expr_is_mut_binding(bind_items)) ? 2 : 1);
                                                        __auto_type _mv_502 = ({ __auto_type _lst = bind_items; size_t _idx = (size_t)val_idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                        if (_mv_502.has_value) {
                                                            __auto_type val_expr = _mv_502.value;
...
uint8_t expr_is_mut_binding(slop_list_types_SExpr_ptr items) {
    if ((((int64_t)((items).len)) < 1)) {
        ...
        __auto_type _mv_503 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        if (_mv_503.has_value) {
            __auto_type first = _mv_503.value;
            __auto_type _mv_504 = (*first);
            switch (_mv_504.tag) {
                case types_SExpr_sym:
                {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len >= 2)) {
            ...
            if (_mv_505.has_value) {
                __auto_type scrutinee = _mv_505.value;
            ...
            }
            {
                ...
                while ((i < len)) {
                    ...
                    if (_mv_506.has_value) {
                        __auto_type clause = _mv_506.value;
                        __auto_type _mv_507 = (*clause);
                        switch (_mv_507.tag) {
                            case types_SExpr_lst:
                            {
                                __auto_type clause_lst = _mv_507.data.lst;
                                {
                                    __auto_type clause_items = clause_lst.items;
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len >= 2)) {
            ...
            if (_mv_508.has_value) {
                __auto_type binding = _mv_508.value;
                __auto_type _mv_509 = (*binding);
                switch (_mv_509.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type bind_lst = _mv_509.data.lst;
                        {
                            __auto_type bind_items = bind_lst.items;
...
uint8_t expr_is_free_var(context_TranspileContext* ctx, slop_list_string param_names, slop_string sym_name) {
    ...
    if (expr_list_contains_string(param_names, sym_name)) {
        ...
        if (expr_is_builtin_op(sym_name)) {
            ...
            __auto_type _mv_510 = context_ctx_lookup_func(ctx, sym_name);
            if (_mv_510.has_value) {
                __auto_type _ = _mv_510.value;
                return 0;
            } else if (!_mv_510.has_value) {
                __auto_type _mv_511 = context_ctx_lookup_type(ctx, sym_name);
                if (_mv_511.has_value) {
                    __auto_type _ = _mv_511.value;
                    return 0;
                } else if (!_mv_511.has_value) {
                    __auto_type _mv_512 = context_ctx_lookup_var(ctx, sym_name);
                    if (_mv_512.has_value) {
                        __auto_type _ = _mv_512.value;
                        return 1;
...
uint8_t expr_list_contains_string(slop_list_string lst, slop_string needle) {
    {
        ...
        __auto_type found = 0;
        while (((i < len) && !(found))) {
            __auto_type _mv_513 = ({ __auto_type _lst = lst; size_t _idx = (size_t)i; slop_option_string _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_513.has_value) {
                __auto_type s = _mv_513.value;
...
slop_string expr_infer_result_ok_slop_type(context_TranspileContext* ctx, types_SExpr* scrutinee) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_514 = (*scrutinee);
        switch (_mv_514.tag) {
            case types_SExpr_sym:
            {
                __auto_type sym = _mv_514.data.sym;
                __auto_type _mv_515 = context_ctx_lookup_var(ctx, sym.name);
                if (_mv_515.has_value) {
                    __auto_type var_entry = _mv_515.value;
                    {
                        __auto_type slop_type = var_entry.slop_type;
...
slop_string expr_infer_result_err_slop_type(context_TranspileContext* ctx, types_SExpr* scrutinee) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_516 = (*scrutinee);
        switch (_mv_516.tag) {
            case types_SExpr_sym:
            {
                __auto_type sym = _mv_516.data.sym;
                __auto_type _mv_517 = context_ctx_lookup_var(ctx, sym.name);
                if (_mv_517.has_value) {
                    __auto_type var_entry = _mv_517.value;
                    {
                        __auto_type slop_type = var_entry.slop_type;
                        if (strlib_starts_with(slop_type, SLOP_STR("(Result "))) {
...
slop_string expr_infer_collection_element_slop_type(context_TranspileContext* ctx, types_SExpr* coll_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_518 = (*coll_expr);
        switch (_mv_518.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_518.data.lst;
                {
                    __auto_type items = lst.items;
                    if ((((int64_t)((items).len)) < 1)) {
                        return SLOP_STR("");
                    } else {
                        __auto_type _mv_519 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_519.has_value) {
                            __auto_type head = _mv_519.value;
                            __auto_type _mv_520 = (*head);
                            switch (_mv_520.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type sym = _mv_520.data.sym;
                                    {
                                        __auto_type op = sym.name;
                                        if (string_eq(op, SLOP_STR("map-keys"))) {
                                            if ((((int64_t)((items).len)) < 2)) {
                                                ...
                                                __auto_type _mv_521 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            ...
                                            if ((((int64_t)((items).len)) < 2)) {
                                                ...
                                                __auto_type _mv_522 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_522.has_value) {
                                                    __auto_type set_expr = _mv_522.value;
                                                    {
                                            ...
                                            if ((((int64_t)((items).len)) < 2)) {
                                                ...
                                                __auto_type _mv_523 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
