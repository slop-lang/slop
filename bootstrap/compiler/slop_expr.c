        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_120.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 2)) {
                    ...
                    __auto_type _mv_121 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        ...
                        switch (_mv_122.tag) {
                            case types_SExpr_sym:
                            {
                                ...
                                if (string_eq(head_sym.name, SLOP_STR("quote"))) {
                                    __auto_type _mv_123 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len <= (start_idx + 1))) {
        ...
        } else {
            {
                ...
                __auto_type _mv_133 = ({ __auto_type _lst = items; size_t _idx = (size_t)start_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                ...
                }
                {
                    ...
                    while ((i < len)) {
                        __auto_type _mv_134 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_135.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    __auto_type _mv_136 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
uint8_t expr_is_fn_type_expr(types_SExpr* type_expr) {
    ...
    switch (_mv_139.tag) {
        case types_SExpr_lst:
        {
            ...
            __auto_type _mv_140 = ({ __auto_type _lst = lst.items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_string expr_infer_field_c_type_from_items(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len < 3)) {
            ...
            __auto_type _mv_156 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_156.has_value) {
                __auto_type obj_expr = _mv_156.value;
                __auto_type _mv_157 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_string expr_infer_list_expr_option_type(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len < 1)) {
            ...
            __auto_type _mv_162 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                ...
                case types_SExpr_lst:
                {
                    __auto_type lst = _mv_169.data.lst;
                    {
                        ...
                        if ((((int64_t)((items).len)) < 3)) {
                            ...
                            __auto_type _mv_171 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                ...
                                switch (_mv_172.tag) {
                                    case types_SExpr_sym:
                                    {
                                        ...
                                        if (string_eq(head_sym.name, SLOP_STR("."))) {
                                            __auto_type _mv_173 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_180.data.lst;
                {
                    ...
                    if ((len < 1)) {
                        ...
                        __auto_type _mv_182 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                ...
                                case types_SExpr_sym:
                                {
                                    __auto_type head_sym = _mv_183.data.sym;
                                    {
                                        ...
                                        if ((string_eq(op, SLOP_STR(".")) && (len >= 3))) {
                                            __auto_type _mv_184 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            ...
                                            if ((len >= 4)) {
                                                __auto_type _mv_191 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_191.has_value) {
                                                    __auto_type key_expr = _mv_191.value;
                                                    __auto_type _mv_192 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            ...
                                            if ((len >= 3)) {
                                                __auto_type _mv_193 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            ...
                                            if ((len >= 3)) {
                                                __auto_type _mv_194 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            ...
                                            if (_mv_197.has_value) {
                                                __auto_type inner_expr = _mv_197.value;
                                                return expr_infer_result_ok_slop_type(ctx, inner_expr);
                                            } else if (!_mv_197.has_value) {
                                                return SLOP_STR("");
                                            }
                                        } else {
                                            __auto_type _mv_198 = context_ctx_lookup_func(ctx, op);
                                            if (_mv_198.has_value) {
                                                __auto_type func_entry = _mv_198.value;
    ...
    SLOP_PRE(((map_expr != NULL)), "(!= map-expr nil)");
    {
        ...
        switch (_mv_203.tag) {
            case types_SExpr_sym:
            {
                ...
                {
                    __auto_type name = sym.name;
                    __auto_type _mv_204 = context_ctx_lookup_var(ctx, name);
        ...
        __auto_type arena = (*ctx).arena;
        {
            __auto_type expr_type = expr_infer_expr_slop_type(ctx, scrutinee);
            {
                ...
                if (strlib_starts_with(resolved, SLOP_STR("(Option "))) {
                    ...
                    __auto_type _mv_205 = (*scrutinee);
                    switch (_mv_205.tag) {
                        case types_SExpr_lst:
                        {
                            __auto_type lst = _mv_205.data.lst;
                            {
                                __auto_type items = lst.items;
                                __auto_type len = ((int64_t)((items).len));
                                if ((len < 2)) {
                                    ...
                                    __auto_type _mv_206 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    if (_mv_206.has_value) {
                                        __auto_type head_expr = _mv_206.value;
                                        __auto_type _mv_207 = (*head_expr);
                                        switch (_mv_207.tag) {
                                            case types_SExpr_sym:
                                            {
                                                    ...
                                                    if (string_eq(op, SLOP_STR("map-get"))) {
                                                        if ((len < 2)) {
                                                            ...
                                                            if (_mv_208.has_value) {
                                                                __auto_type map_expr = _mv_208.value;
                                                                __auto_type _mv_209 = (*map_expr);
                                                                switch (_mv_209.tag) {
                                                                    case types_SExpr_sym:
                                                                    {
                                                                        __auto_type map_sym = _mv_209.data.sym;
                                                                        {
                                                                            __auto_type map_name = map_sym.name;
                                                                            __auto_type _mv_210 = context_ctx_lookup_var(ctx, map_name);
                                                                            if (_mv_210.has_value) {
                                                                                __auto_type var_entry = _mv_210.value;
                                                                                {
                                                                                    __auto_type slop_type = var_entry.slop_type;
                                                                                    if ((string_len(slop_type) > 0)) {
                                                                                        {
                                                        ...
                                                        if ((len < 2)) {
                                                            ...
                                                            if (_mv_211.has_value) {
                                                                __auto_type list_expr = _mv_211.value;
                                                                __auto_type _mv_212 = (*list_expr);
                                                                switch (_mv_212.tag) {
                                                                    case types_SExpr_sym:
                                                                    {
                                                                        __auto_type list_sym = _mv_212.data.sym;
                                                                        {
                                                                            __auto_type list_name = list_sym.name;
                                                                            __auto_type _mv_213 = context_ctx_lookup_var(ctx, list_name);
...
slop_string expr_fix_ternary_none(context_TranspileContext* ctx, types_SExpr* other_expr, slop_string other_branch, slop_string this_branch) {
    ...
    if ((string_eq(this_branch, SLOP_STR("none")) && strlib_starts_with(other_branch, SLOP_STR("(slop_option_")))) {
        {
            __auto_type arena = (*ctx).arena;
            __auto_type _mv_214 = expr_extract_option_type(arena, other_branch);
            if (_mv_214.has_value) {
                __auto_type opt_type = _mv_214.value;
...
uint8_t expr_is_pointer_expr(context_TranspileContext* ctx, types_SExpr* expr) {
    ...
    switch (_mv_217.tag) {
        case types_SExpr_sym:
        {
            __auto_type sym = _mv_217.data.sym;
            {
                __auto_type name = sym.name;
                __auto_type _mv_218 = context_ctx_lookup_var(ctx, name);
                if (_mv_218.has_value) {
                    __auto_type var_entry = _mv_218.value;
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_217.data.lst;
            {
                __auto_type items = lst.items;
                if ((((int64_t)((items).len)) >= 1)) {
                    __auto_type _mv_219 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_219.has_value) {
                        __auto_type head_ptr = _mv_219.value;
                        __auto_type _mv_220 = (*head_ptr);
                        switch (_mv_220.tag) {
                            case types_SExpr_sym:
                            {
                                __auto_type head_sym = _mv_220.data.sym;
                                {
                                    ...
                                    if (string_eq(op, SLOP_STR("deref"))) {
                                        ...
                                        if (_mv_221.has_value) {
                                            __auto_type type_expr = _mv_221.value;
        ...
        switch (_mv_222.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_222.data.lst;
                {
                    ...
                    __auto_type len = ((int64_t)((items).len));
                    if ((len >= 2)) {
                        __auto_type _mv_223 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_223.has_value) {
                            __auto_type head_ptr = _mv_223.value;
                            __auto_type _mv_224 = (*head_ptr);
                            switch (_mv_224.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type head_sym = _mv_224.data.sym;
                                    {
                                        ...
                                        if (string_eq(op, SLOP_STR("sizeof"))) {
                                            ...
                                            if (_mv_225.has_value) {
                                                __auto_type type_expr = _mv_225.value;
                                        ...
                                        } else if ((string_eq(op, SLOP_STR("*")) || (string_eq(op, SLOP_STR("+")) || (string_eq(op, SLOP_STR("-")) || string_eq(op, SLOP_STR("/")))))) {
                                            {
                                                ...
                                                while ((i < len)) {
                                                    ...
                                                    if (_mv_226.has_value) {
                                                        __auto_type arg_expr = _mv_226.value;
                                                        {
...
slop_string expr_transpile_expr(context_TranspileContext* ctx, types_SExpr* expr) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    SLOP_PRE(((expr != NULL)), "(!= expr nil)");
    __auto_type _mv_227 = (*expr);
    switch (_mv_227.tag) {
        case types_SExpr_num:
        {
            __auto_type _ = _mv_227.data.num;
            return expr_transpile_literal(ctx, expr);
        }
        case types_SExpr_str:
        {
            __auto_type _ = _mv_227.data.str;
            return expr_transpile_literal(ctx, expr);
        }
        case types_SExpr_sym:
        {
            __auto_type _ = _mv_227.data.sym;
            return expr_transpile_literal(ctx, expr);
        }
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_227.data.lst;
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len < 1)) {
            ...
            if (_mv_228.has_value) {
                __auto_type head_expr = _mv_228.value;
                __auto_type _mv_229 = (*head_expr);
                switch (_mv_229.tag) {
                    case types_SExpr_sym:
                    {
                            ...
                            if ((expr_is_binop(op) && (len < 3))) {
                                ...
                                if ((len > 3)) {
                                    ...
                                    if (_mv_230.has_value) {
                                        ...
                                        __auto_type _mv_231 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                ...
                                if (_mv_232.has_value) {
                                    __auto_type left = _mv_232.value;
                                    __auto_type _mv_233 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    if (_mv_233.has_value) {
                                        __auto_type right = _mv_233.value;
                                        {
                                            __auto_type left_c = expr_transpile_expr(ctx, left);
                                            __auto_type right_c = expr_transpile_expr(ctx, right);
                                ...
                                if (_mv_235.has_value) {
                                    __auto_type cond_expr = _mv_235.value;
                                    __auto_type _mv_236 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    if (_mv_236.has_value) {
                                        __auto_type then_expr = _mv_236.value;
                                        __auto_type _mv_237 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_237.has_value) {
                                            __auto_type else_expr = _mv_237.value;
                                            {
                                ...
                                __auto_type _mv_238 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                ...
                                if (_mv_239.has_value) {
                                    ...
                                    if (_mv_240.has_value) {
                                        __auto_type field_expr = _mv_240.value;
                                        __auto_type _mv_241 = (*field_expr);
                                        switch (_mv_241.tag) {
                                            case types_SExpr_sym:
                                            {
                                                __auto_type field_sym = _mv_241.data.sym;
                                                {
                                ...
                                if (_mv_242.has_value) {
                                    ...
                                    __auto_type _mv_243 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    if (_mv_243.has_value) {
                                        __auto_type val_expr = _mv_243.value;
                                        {
                                ...
                                if (_mv_244.has_value) {
                                    __auto_type str_expr = _mv_244.value;
                                    __auto_type _mv_245 = (*str_expr);
                                    switch (_mv_245.tag) {
                                        case types_SExpr_str:
                                        {
                                            __auto_type str = _mv_245.data.str;
                                            return str.value;
                                        }
                                        default: {
                                ...
                                if (_mv_246.has_value) {
                                    __auto_type val_expr = _mv_246.value;
                                    {
                                        __auto_type val_c = expr_transpile_expr(ctx, val_expr);
                                ...
                                if (_mv_249.has_value) {
                                    __auto_type arr_expr = _mv_249.value;
                                    __auto_type _mv_250 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    if (_mv_250.has_value) {
                                        __auto_type idx_expr = _mv_250.value;
                                        {
                                ...
                                if (_mv_251.has_value) {
                                    ...
                                    if (_mv_252.has_value) {
                                        __auto_type size_expr = _mv_252.value;
                                        {
                                            __auto_type arena_c = expr_transpile_expr(ctx, arena_expr);
                                            __auto_type _mv_253 = (*size_expr);
                                            switch (_mv_253.tag) {
                                                case types_SExpr_sym:
                                                {
                                                    __auto_type sym = _mv_253.data.sym;
                                                    {
                                                        ...
                                                        __auto_type _mv_254 = context_ctx_lookup_type(ctx, type_name);
                                ...
                                if (_mv_255.has_value) {
                                    __auto_type size_expr = _mv_255.value;
                                    {
                                        __auto_type size_c = expr_transpile_expr(ctx, size_expr);
                                ...
                                if (_mv_256.has_value) {
                                    __auto_type arena_expr = _mv_256.value;
                                    {
                                        __auto_type arena_c = expr_transpile_expr(ctx, arena_expr);
                                ...
                                if (_mv_257.has_value) {
                                    __auto_type variant_expr = _mv_257.value;
                                    __auto_type _mv_258 = (*variant_expr);
                                    switch (_mv_258.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type sym = _mv_258.data.sym;
                                            {
                                ...
                                if (_mv_259.has_value) {
                                    ...
                                    __auto_type _mv_260 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    if (_mv_260.has_value) {
                                        __auto_type tag_expr = _mv_260.value;
                                        __auto_type _mv_261 = (*type_expr);
                                        switch (_mv_261.tag) {
                                            case types_SExpr_sym:
                                            {
                                                __auto_type type_sym = _mv_261.data.sym;
                                                __auto_type _mv_262 = expr_extract_symbol_name(tag_expr);
                                                if (_mv_262.has_value) {
                                                    __auto_type tag_str = _mv_262.value;
                                                    {
                                                        ...
                                                        if ((len >= 5)) {
                                                            {
                                                                ...
                                                                for (int64_t vi = 3; vi < len; vi++) {
                                                                    __auto_type _mv_263 = ({ __auto_type _lst = items; size_t _idx = (size_t)vi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                            ...
                                                            __auto_type _mv_264 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                ...
                                if (_mv_267.has_value) {
                                    __auto_type result_expr = _mv_267.value;
                                    {
                                        __auto_type result_c = expr_transpile_expr(ctx, result_expr);
                                        __auto_type _mv_268 = context_ctx_get_current_result_type(ctx);
                                        if (_mv_268.has_value) {
                                            __auto_type enclosing_type = _mv_268.value;
                                ...
                                if (_mv_270.has_value) {
                                    __auto_type list_expr = _mv_270.value;
                                    __auto_type _mv_271 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    if (_mv_271.has_value) {
                                        __auto_type idx_expr = _mv_271.value;
                                        {
                                            __auto_type list_c = expr_transpile_expr(ctx, list_expr);
                                            __auto_type idx_c = expr_transpile_expr(ctx, idx_expr);
                                ...
                                if (_mv_273.has_value) {
                                    __auto_type arena_expr = _mv_273.value;
                                    __auto_type _mv_274 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                ...
                                if (_mv_275.has_value) {
                                    __auto_type list_expr = _mv_275.value;
                                    ...
                                    if (_mv_276.has_value) {
                                        __auto_type item_expr = _mv_276.value;
                                        {
                                            __auto_type list_c = expr_transpile_expr(ctx, list_expr);
                                ...
                                __auto_type _mv_277 = context_ctx_get_current_return_type(ctx);
                                if (_mv_277.has_value) {
                                    __auto_type ret_type = _mv_277.value;
                    ...
                    default: {
                        {
                            ...
                            __auto_type i = 1;
                            while ((i < len)) {
                                __auto_type _mv_278 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        if (string_eq(fn_name, SLOP_STR("println"))) {
            ...
            if ((len < 3)) {
                ...
                if (_mv_281.has_value) {
                    __auto_type a_expr = _mv_281.value;
                    __auto_type _mv_282 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_282.has_value) {
                        __auto_type b_expr = _mv_282.value;
                        {
            ...
            if ((len < 3)) {
                ...
                if (_mv_283.has_value) {
                    __auto_type a_expr = _mv_283.value;
                    ...
                    if (_mv_284.has_value) {
                        __auto_type b_expr = _mv_284.value;
                        {
                            __auto_type a_c = expr_transpile_expr(ctx, a_expr);
                            __auto_type b_c = expr_transpile_expr(ctx, b_expr);
                            __auto_type s1 = string_concat(arena, SLOP_STR("(("), a_c);
            ...
            if ((len < 3)) {
                ...
                if (_mv_285.has_value) {
                    __auto_type fn_expr = _mv_285.value;
            ...
            if ((len < 4)) {
                ...
                if (_mv_286.has_value) {
                    ...
                    __auto_type _mv_287 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_287.has_value) {
                        __auto_type arena_expr = _mv_287.value;
                        __auto_type _mv_288 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_288.has_value) {
                            __auto_type cap_expr = _mv_288.value;
                            {
            ...
            if ((len < 3)) {
                ...
                if (_mv_289.has_value) {
                    ...
                    if (_mv_290.has_value) {
                        __auto_type arena_expr = _mv_290.value;
                        {
                            __auto_type elem_c = context_to_c_type_prefixed(ctx, type_expr);
                            __auto_type elem_id = ctype_type_to_identifier(arena, elem_c);
                            __auto_type chan_type = context_ctx_str(ctx, SLOP_STR("slop_chan_"), elem_id);
            ...
            if ((len < 3)) {
                ...
                if (_mv_291.has_value) {
                    __auto_type chan_expr = _mv_291.value;
                    __auto_type _mv_292 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_292.has_value) {
                        __auto_type value_expr = _mv_292.value;
                        {
            ...
            if ((len < 2)) {
                ...
                if (_mv_293.has_value) {
                    __auto_type chan_expr = _mv_293.value;
                    {
                        __auto_type chan_c = expr_transpile_expr(ctx, chan_expr);
                        __auto_type chan_c_type = expr_infer_expr_c_type(ctx, chan_expr);
                        {
        ...
        } else {
            {
                ...
                if ((string_len(builtin_c_name) > 0)) {
                    ...
                    __auto_type _mv_294 = context_ctx_lookup_type(ctx, fn_name);
                    if (_mv_294.has_value) {
                        __auto_type type_entry = _mv_294.value;
                        if (type_entry.is_union) {
                        ...
                        } else {
                            {
                                ...
                                while ((i < len)) {
                                    __auto_type _mv_295 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        ...
                        __auto_type _mv_296 = context_ctx_lookup_enum_variant(ctx, fn_name);
                        if (_mv_296.has_value) {
                            __auto_type type_name = _mv_296.value;
                            {
                                ...
                                if ((len >= 2)) {
                                    ...
                                    if (_mv_297.has_value) {
                                        __auto_type value_expr = _mv_297.value;
                                        {
                                            __auto_type value_c = expr_transpile_expr(ctx, value_expr);
                                ...
                                if (!_mv_298.has_value) {
                                    {
                                        ...
                                        if (((string_len(runtime_name) == 0) && ({ __auto_type _mv = var_opt; _mv.has_value ? ({ __auto_type _ = _mv.value; 0; }) : (1); }))) {
                                            ...
                                            while ((i < len)) {
                                                __auto_type _mv_299 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    ...
                                    while ((i < len)) {
                                        __auto_type _mv_300 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    ...
    SLOP_PRE(((arg != NULL)), "(!= arg nil)");
    {
        ...
        switch (_mv_301.tag) {
            ...
            default: {
                {
                    __auto_type arg_c = expr_transpile_expr(ctx, arg);
                    __auto_type _mv_302 = expr_get_expr_type_hint(ctx, arg);
                    if (_mv_302.has_value) {
                        __auto_type type_hint = _mv_302.value;
...
slop_string expr_transpile_printf_call(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 1;
        while ((i < len)) {
            __auto_type _mv_303 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_string expr_transpile_raw_string_fn_call(context_TranspileContext* ctx, slop_string fn_name, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 1;
        while ((i < len)) {
            __auto_type _mv_304 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_304.has_value) {
                __auto_type arg = _mv_304.value;
                {
                    __auto_type arg_c = ({ __auto_type _mv = (*arg); slop_string _mr = {0}; switch (_mv.tag) { case types_SExpr_str: { __auto_type s = _mv.data.str; _mr = context_ctx_str3(ctx, SLOP_STR("\""), expr_escape_c_string(ctx, s.value), SLOP_STR("\"")); break; } default: { _mr = expr_transpile_expr(ctx, arg); break; }  } _mr; });
                    if (string_eq(args, SLOP_STR(""))) {
                        args = arg_c;
...
slop_option_string expr_get_expr_type_hint(context_TranspileContext* ctx, types_SExpr* expr) {
    ...
    SLOP_PRE(((expr != NULL)), "(!= expr nil)");
    {
        ...
        if (string_eq(slop_type, SLOP_STR("String"))) {
            ...
            __auto_type _mv_305 = (*expr);
            switch (_mv_305.tag) {
                case types_SExpr_sym:
                {
                    __auto_type sym = _mv_305.data.sym;
                    __auto_type _mv_306 = context_ctx_lookup_var(ctx, sym.name);
                    if (_mv_306.has_value) {
                        __auto_type entry = _mv_306.value;
                        {
                ...
                case types_SExpr_lst:
                {
                    __auto_type lst = _mv_305.data.lst;
                    {
                        __auto_type items = lst.items;
                        if ((((int64_t)((items).len)) >= 1)) {
                            __auto_type _mv_307 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_307.has_value) {
                                __auto_type head = _mv_307.value;
                                __auto_type _mv_308 = (*head);
                                switch (_mv_308.tag) {
                                    case types_SExpr_sym:
                                    {
                                        __auto_type head_sym = _mv_308.data.sym;
                                        {
                                            __auto_type op = head_sym.name;
                                            if ((string_eq(op, SLOP_STR(".")) && (((int64_t)((items).len)) >= 3))) {
                                                {
                                                    ...
                                                    if (string_eq(c_type, SLOP_STR("slop_string"))) {
                                                        ...
                                                        if (_mv_309.has_value) {
                                                            __auto_type obj_expr = _mv_309.value;
                                                            __auto_type _mv_310 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                            if (_mv_310.has_value) {
                                                                __auto_type field_expr = _mv_310.value;
                                                                __auto_type _mv_311 = (*field_expr);
                                                                switch (_mv_311.tag) {
                                                                    case types_SExpr_sym:
                                                                    {
                                                                        __auto_type field_sym = _mv_311.data.sym;
                                                                        {
                                                                            __auto_type field_name = field_sym.name;
                                                                            __auto_type obj_slop_type = expr_infer_expr_slop_type(ctx, obj_expr);
                                                                            if ((string_len(obj_slop_type) > 0)) {
                                                                                __auto_type _mv_312 = context_ctx_lookup_field_slop_type(ctx, obj_slop_type, field_name);
                                                                                if (_mv_312.has_value) {
                                                                                    __auto_type fst = _mv_312.value;
                                                ...
                                                __auto_type _mv_313 = context_ctx_lookup_func(ctx, op);
                                                if (_mv_313.has_value) {
                                                    __auto_type func_entry = _mv_313.value;
                                                    if (func_entry.returns_string) {
                                                        return (slop_option_string){.has_value = 1, .value = SLOP_STR("slop_string")};
                                                    } else {
                                                        return (slop_option_string){.has_value = false};
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len < 2)) {
            ...
            if (_mv_314.has_value) {
                __auto_type tag_expr = _mv_314.value;
                __auto_type _mv_315 = (*tag_expr);
                switch (_mv_315.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type tag_list = _mv_315.data.lst;
                        {
                            __auto_type tag_items = tag_list.items;
                            if ((((int64_t)((tag_items).len)) < 1)) {
                                return context_ctx_str3(ctx, SLOP_STR("(("), c_type_name, SLOP_STR("){})"));
                            } else {
                                __auto_type _mv_316 = ({ __auto_type _lst = tag_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_316.has_value) {
                                    __auto_type tag_name_expr = _mv_316.value;
                                    __auto_type _mv_317 = (*tag_name_expr);
                                    switch (_mv_317.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type tag_sym = _mv_317.data.sym;
                                            {
                                                ...
                                                if ((num_tag_items >= 3)) {
                                                    {
                                                        ...
                                                        for (int64_t fi = 1; fi < num_tag_items; fi++) {
                                                            __auto_type _mv_318 = ({ __auto_type _lst = tag_items; size_t _idx = (size_t)fi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    ...
                                                    __auto_type _mv_319 = ({ __auto_type _lst = tag_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_string expr_transpile_cond_expr(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 1;
        while ((i < len)) {
            __auto_type _mv_320 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_320.has_value) {
                __auto_type clause_expr = _mv_320.value;
                __auto_type _mv_321 = (*clause_expr);
                switch (_mv_321.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type clause_lst = _mv_321.data.lst;
                        {
                            __auto_type clause_items = clause_lst.items;
                            __auto_type clause_len = ((int64_t)((clause_items).len));
                            if ((clause_len >= 2)) {
                                __auto_type _mv_322 = ({ __auto_type _lst = clause_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_322.has_value) {
                                    __auto_type test_expr = _mv_322.value;
                                    __auto_type _mv_323 = (*test_expr);
                                    switch (_mv_323.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type sym = _mv_323.data.sym;
                                            if (string_eq(sym.name, SLOP_STR("else"))) {
                                                __auto_type _mv_324 = ({ __auto_type _lst = clause_items; size_t _idx = (size_t)(clause_len - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            ...
                                            } else {
                                                {
                                                    ...
                                                    __auto_type _mv_325 = ({ __auto_type _lst = clause_items; size_t _idx = (size_t)(clause_len - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        ...
                                        default: {
                                            {
                                                __auto_type test_c = expr_transpile_expr(ctx, test_expr);
                                                __auto_type _mv_326 = ({ __auto_type _lst = clause_items; size_t _idx = (size_t)(clause_len - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_326.has_value) {
                                                    __auto_type body_expr = _mv_326.value;
                                                    {
                                                        __auto_type body_c = expr_typed_none(ctx, result_type, expr_transpile_expr(ctx, body_expr));
                                                        result = context_ctx_str(ctx, result, context_ctx_str(ctx, SLOP_STR("("), context_ctx_str(ctx, test_c, context_ctx_str(ctx, SLOP_STR(" ? "), context_ctx_str(ctx, body_c, SLOP_STR(" : "))))));
                                                    }
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len < 3)) {
            ...
            if (_mv_327.has_value) {
                __auto_type scrutinee = _mv_327.value;
                {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while ((i < len)) {
            ...
            if (_mv_328.has_value) {
                __auto_type branch = _mv_328.value;
                __auto_type _mv_329 = (*branch);
                switch (_mv_329.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type branch_lst = _mv_329.data.lst;
                        {
                            __auto_type branch_items = branch_lst.items;
                            if ((((int64_t)((branch_items).len)) >= 1)) {
                                __auto_type _mv_330 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_330.has_value) {
                                    __auto_type pattern = _mv_330.value;
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_331.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    __auto_type _mv_332 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_332.has_value) {
                        __auto_type head = _mv_332.value;
                        __auto_type _mv_333 = (*head);
                        switch (_mv_333.tag) {
                            case types_SExpr_sym:
                            {
...
uint8_t expr_is_option_patterns(slop_list_types_SExpr_ptr patterns) {
    {
        ...
        int64_t i = 0;
        while (((i < len) && !(found))) {
            __auto_type _mv_334 = ({ __auto_type _lst = patterns; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
uint8_t expr_is_result_patterns(slop_list_types_SExpr_ptr patterns) {
    {
        ...
        int64_t i = 0;
        while (((i < len) && !(found))) {
            __auto_type _mv_335 = ({ __auto_type _lst = patterns; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_335.has_value) {
                __auto_type pat = _mv_335.value;
                {
                    __auto_type tag = expr_get_expr_pattern_tag(pat);
...
uint8_t expr_is_enum_expr_patterns(context_TranspileContext* ctx, slop_list_types_SExpr_ptr patterns) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (((i < len) && all_symbols)) {
            __auto_type _mv_336 = ({ __auto_type _lst = patterns; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_336.has_value) {
                __auto_type pat_expr = _mv_336.value;
                __auto_type _mv_337 = (*pat_expr);
                switch (_mv_337.tag) {
                    case types_SExpr_sym:
                    {
                        __auto_type s = _mv_337.data.sym;
                        {
                            __auto_type name = s.name;
                            if ((!(string_eq(name, SLOP_STR("else"))) && !(string_eq(name, SLOP_STR("_"))))) {
                                __auto_type _mv_338 = context_ctx_lookup_enum_variant(ctx, name);
...
uint8_t expr_is_union_expr_patterns(context_TranspileContext* ctx, slop_list_types_SExpr_ptr patterns) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (((i < len) && !(has_union_variant))) {
            __auto_type _mv_339 = ({ __auto_type _lst = patterns; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_339.has_value) {
                __auto_type pat_expr = _mv_339.value;
                {
                    ...
                    if (((!(string_eq(tag, SLOP_STR("")))) && (!(string_eq(tag, SLOP_STR("some")))) && (!(string_eq(tag, SLOP_STR("none")))) && (!(string_eq(tag, SLOP_STR("ok")))) && (!(string_eq(tag, SLOP_STR("error")))) && (!(string_eq(tag, SLOP_STR("else")))) && (!(string_eq(tag, SLOP_STR("_")))))) {
                        __auto_type _mv_340 = context_ctx_lookup_enum_variant(ctx, tag);
...
slop_option_string expr_get_expr_binding_name(types_SExpr* pat_expr) {
    SLOP_PRE(((pat_expr != NULL)), "(!= pat-expr nil)");
    __auto_type _mv_341 = (*pat_expr);
    switch (_mv_341.tag) {
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_341.data.lst;
            {
                __auto_type items = lst.items;
                if ((((int64_t)((items).len)) < 2)) {
                    return (slop_option_string){.has_value = false};
                    ...
                    if (_mv_342.has_value) {
                        __auto_type binding = _mv_342.value;
                        __auto_type _mv_343 = (*binding);
                        switch (_mv_343.tag) {
                            case types_SExpr_sym:
                            {
...
slop_string expr_get_match_branch_body(context_TranspileContext* ctx, slop_list_types_SExpr_ptr branch_items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len < 2)) {
            ...
            __auto_type _mv_344 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)(len - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    ...
    SLOP_PRE(((scrutinee != NULL)), "(!= scrutinee nil)");
    {
        ...
        while ((i < len)) {
            ...
            if (_mv_345.has_value) {
                __auto_type branch = _mv_345.value;
                __auto_type _mv_346 = (*branch);
                switch (_mv_346.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type branch_lst = _mv_346.data.lst;
                        {
                            __auto_type branch_items = branch_lst.items;
                            if ((((int64_t)((branch_items).len)) >= 2)) {
                                __auto_type _mv_347 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_347.has_value) {
                                    __auto_type pattern = _mv_347.value;
                                    {
                                        __auto_type tag = expr_get_expr_pattern_tag(pattern);
                                        if (string_eq(tag, SLOP_STR("some"))) {
                                            __auto_type _mv_348 = expr_get_expr_binding_name(pattern);
                                            if (_mv_348.has_value) {
                                                __auto_type name = _mv_348.value;
                                                some_binding = name;
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len < 2)) {
            ...
            if (_mv_349.has_value) {
                __auto_type first_clause = _mv_349.value;
                __auto_type _mv_350 = (*first_clause);
                switch (_mv_350.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type clause_lst = _mv_350.data.lst;
                        {
                            __auto_type clause_items = clause_lst.items;
                            __auto_type clause_len = ((int64_t)((clause_items).len));
                            if ((clause_len < 2)) {
                                ...
                                __auto_type _mv_351 = ({ __auto_type _lst = clause_items; size_t _idx = (size_t)(clause_len - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_string expr_infer_match_branch_body_type(context_TranspileContext* ctx, types_SExpr* branch) {
    ...
    __auto_type _mv_352 = (*branch);
    switch (_mv_352.tag) {
        case types_SExpr_lst:
        {
            __auto_type branch_lst = _mv_352.data.lst;
            {
                __auto_type branch_items = branch_lst.items;
                ...
                if ((branch_len < 2)) {
                    ...
                    __auto_type _mv_353 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)(branch_len - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len < 3)) {
            ...
            while (((i < len) && string_eq(result, SLOP_STR("__type_error__")))) {
                __auto_type _mv_354 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_354.has_value) {
                    __auto_type branch = _mv_354.value;
...
slop_string expr_slop_type_to_c_type(context_TranspileContext* ctx, slop_string slop_type) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_355 = context_ctx_lookup_type(ctx, slop_type);
    ...
    SLOP_PRE(((expr != NULL)), "(!= expr nil)");
    {
        ...
        if ((string_len(checker_type) > 0)) {
            ...
            switch (_mv_356.tag) {
                case types_SExpr_str:
                {
                    __auto_type _ = _mv_356.data.str;
                    return SLOP_STR("slop_string");
                }
                case types_SExpr_num:
                {
                    __auto_type num = _mv_356.data.num;
                    if (num.is_float) {
                        return SLOP_STR("double");
                    } else {
                        return SLOP_STR("int64_t");
                ...
                case types_SExpr_sym:
                {
                    ...
                    {
                        __auto_type name = sym.name;
                        __auto_type _mv_357 = context_ctx_lookup_var(ctx, name);
                        if (_mv_357.has_value) {
                            __auto_type entry = _mv_357.value;
                            {
                    ...
                    __auto_type lst = _mv_356.data.lst;
                    {
                        ...
                        if ((((int64_t)((items).len)) < 1)) {
                            ...
                            if (_mv_358.has_value) {
                                __auto_type head = _mv_358.value;
                                __auto_type _mv_359 = (*head);
                                switch (_mv_359.tag) {
                                    case types_SExpr_sym:
                                    {
                                        __auto_type sym = _mv_359.data.sym;
                                        {
                                            ...
                                            if (({ __auto_type _mv = context_ctx_lookup_func(ctx, op); _mv.has_value ? ({ __auto_type func_entry = _mv.value; func_entry.returns_string; }) : (0); })) {
                                                ...
                                                if ((((int64_t)((items).len)) < 3)) {
                                                    ...
                                                    __auto_type _mv_360 = ({ __auto_type _lst = items; size_t _idx = (size_t)(((int64_t)((items).len)) - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_360.has_value) {
                                                        __auto_type body = _mv_360.value;
                                                ...
                                                if ((((int64_t)((items).len)) < 2)) {
                                                    ...
                                                    __auto_type _mv_361 = ({ __auto_type _lst = items; size_t _idx = (size_t)(((int64_t)((items).len)) - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_361.has_value) {
                                                        __auto_type last_expr = _mv_361.value;
                                                ...
                                                if ((((int64_t)((items).len)) < 3)) {
                                                    ...
                                                    __auto_type _mv_362 = ({ __auto_type _lst = items; size_t _idx = (size_t)(((int64_t)((items).len)) - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_362.has_value) {
                                                        __auto_type body = _mv_362.value;
                                                        return expr_infer_expr_c_type(ctx, body);
                                                ...
                                                if ((((int64_t)((items).len)) < 3)) {
                                                    ...
                                                    if (_mv_363.has_value) {
                                                        __auto_type then_expr = _mv_363.value;
                                                ...
                                                if ((((int64_t)((items).len)) < 2)) {
                                                    ...
                                                    if (_mv_364.has_value) {
                                                        __auto_type val_expr = _mv_364.value;
                                                        {
                                                            __auto_type val_type = expr_infer_expr_c_type(ctx, val_expr);
                                                ...
                                                __auto_type _mv_365 = context_ctx_get_current_return_type(ctx);
                                                if (_mv_365.has_value) {
                                                    __auto_type ret_type = _mv_365.value;
                                                    if (strlib_starts_with(ret_type, SLOP_STR("slop_option_"))) {
                                                        return ret_type;
                                                    } else {
                                                        return SLOP_STR("slop_option_int");
                                                ...
                                                if ((((int64_t)((items).len)) < 2)) {
                                                    ...
                                                    if (_mv_369.has_value) {
                                                        __auto_type chan_arg = _mv_369.value;
                                                        {
                                                ...
                                                __auto_type _mv_374 = context_ctx_lookup_type(ctx, op);
                                                if (_mv_374.has_value) {
                                                    __auto_type type_entry = _mv_374.value;
                                                    return type_entry.c_name;
                                                } else if (!_mv_374.has_value) {
                                                    __auto_type _mv_375 = context_ctx_lookup_func(ctx, op);
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while ((i < len)) {
            ...
            if (_mv_376.has_value) {
                __auto_type branch = _mv_376.value;
                __auto_type _mv_377 = (*branch);
                switch (_mv_377.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type branch_lst = _mv_377.data.lst;
                        {
                            __auto_type branch_items = branch_lst.items;
                            if ((((int64_t)((branch_items).len)) >= 2)) {
                                __auto_type _mv_378 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_378.has_value) {
                                    __auto_type pattern = _mv_378.value;
                                    {
                                        __auto_type tag = expr_get_expr_pattern_tag(pattern);
                                        if (string_eq(tag, SLOP_STR("ok"))) {
                                            ...
                                            __auto_type _mv_380 = expr_get_expr_binding_name(pattern);
                                            if (_mv_380.has_value) {
                                                __auto_type name = _mv_380.value;
                                                err_binding = name;
                ...
                switch (_mv_382.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type branch_lst = _mv_382.data.lst;
                        {
                            __auto_type branch_items = branch_lst.items;
                            if ((((int64_t)((branch_items).len)) >= 2)) {
                                __auto_type _mv_383 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_string expr_build_enum_case_expr(context_TranspileContext* ctx, slop_arena* arena, slop_string cases, types_SExpr* pattern, slop_list_types_SExpr_ptr branch_items, slop_string result_type) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((string_eq(tag, SLOP_STR("else")) || string_eq(tag, SLOP_STR("_")))) {
            ...
            __auto_type _mv_384 = context_ctx_lookup_enum_variant(ctx, tag);
            if (_mv_384.has_value) {
                __auto_type type_name = _mv_384.value;
                {
...
slop_string expr_build_union_match_expr(context_TranspileContext* ctx, types_SExpr* scrutinee, slop_string scrutinee_c, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 2;
        while ((i < len)) {
            __auto_type _mv_385 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_385.has_value) {
                __auto_type branch = _mv_385.value;
                __auto_type _mv_386 = (*branch);
                switch (_mv_386.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type branch_lst = _mv_386.data.lst;
                        {
                            __auto_type branch_items = branch_lst.items;
                            if ((((int64_t)((branch_items).len)) >= 2)) {
                                __auto_type _mv_387 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_387.has_value) {
                                    __auto_type pattern = _mv_387.value;
        ...
        switch (_mv_388.tag) {
            case types_SExpr_sym:
            {
                __auto_type sym = _mv_388.data.sym;
                {
                    ...
                    __auto_type _mv_389 = context_ctx_lookup_func(ctx, slop_name);
        ...
        if (context_ctx_skip_trampoline_generation(ctx)) {
            ...
            if (context_ctx_has_trampoline(ctx, fn_c_name)) {
            ...
            } else {
                {
                    ...
                    int64_t i = 0;
                    while ((i < count)) {
                        __auto_type _mv_390 = ({ __auto_type _lst = param_types; size_t _idx = (size_t)i; slop_option_context_FuncParamType_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_390.has_value) {
                            __auto_type param_type_ptr = _mv_390.value;
                            {
...
slop_string expr_build_union_case_expr(context_TranspileContext* ctx, slop_arena* arena, slop_string cases, types_SExpr* scrutinee, types_SExpr* pattern, slop_list_types_SExpr_ptr branch_items, slop_string result_type) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((string_eq(tag, SLOP_STR("else")) || string_eq(tag, SLOP_STR("_")))) {
            ...
            __auto_type _mv_391 = context_ctx_lookup_enum_variant(ctx, tag);
            if (_mv_391.has_value) {
                __auto_type type_name = _mv_391.value;
                {
                    __auto_type c_tag = ctype_to_c_name(arena, tag);
                    __auto_type case_label = context_ctx_str4(ctx, type_name, SLOP_STR("_"), c_tag, SLOP_STR(""));
                    __auto_type binding_opt = expr_get_expr_binding_name(pattern);
                    __auto_type _mv_392 = binding_opt;
                    if (_mv_392.has_value) {
                        __auto_type binding_name = _mv_392.value;
                        {
...
slop_string expr_build_ternary_match_expr(context_TranspileContext* ctx, slop_string scrutinee_c, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = (len - 1);
        while ((i >= 2)) {
            __auto_type _mv_393 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_393.has_value) {
                __auto_type branch = _mv_393.value;
                __auto_type _mv_394 = (*branch);
                switch (_mv_394.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type branch_lst = _mv_394.data.lst;
                        {
                            __auto_type branch_items = branch_lst.items;
                            if ((((int64_t)((branch_items).len)) >= 2)) {
                                __auto_type _mv_395 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_395.has_value) {
                                    __auto_type pattern = _mv_395.value;
                                    {
                                        __auto_type tag = expr_get_expr_pattern_tag(pattern);
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len < 3)) {
            ...
            if (_mv_396.has_value) {
                __auto_type bindings_expr = _mv_396.value;
                __auto_type _mv_397 = (*bindings_expr);
                switch (_mv_397.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type bindings_lst = _mv_397.data.lst;
                        context_ctx_push_scope(ctx);
                        {
                            __auto_type result = SLOP_STR("({ ");
                            ...
                            while ((bi < bindings_len)) {
                                __auto_type _mv_398 = ({ __auto_type _lst = bindings_items; size_t _idx = (size_t)bi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            ...
                            bi = 0;
                            while ((bi < bindings_len)) {
                                __auto_type _mv_399 = ({ __auto_type _lst = bindings_items; size_t _idx = (size_t)bi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_399.has_value) {
                                    __auto_type binding = _mv_399.value;
                                    {
                            ...
                            }
                            {
                                ...
                                while ((i < (len - 1))) {
                                    ...
                                    if (_mv_400.has_value) {
                                        __auto_type body_expr = _mv_400.value;
                                        {
                                            __auto_type body_c = expr_transpile_expr(ctx, body_expr);
                    ...
                    if ((len >= 2)) {
                        {
                            ...
                            __auto_type _mv_402 = ({ __auto_type _lst = items; size_t _idx = (size_t)name_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_402.has_value) {
                                __auto_type name_expr = _mv_402.value;
                                __auto_type _mv_403 = (*name_expr);
                                switch (_mv_403.tag) {
                                    case types_SExpr_sym:
                                    {
                                        __auto_type name_sym = _mv_403.data.sym;
                                        {
                ...
                __auto_type lst = _mv_404.data.lst;
                {
                    ...
                    if ((len < 2)) {
                    ...
                    } else {
                        {
                            __auto_type has_mut = expr_binding_has_mut(items);
                            __auto_type name_idx = ((has_mut) ? 1 : 0);
                            __auto_type _mv_405 = ({ __auto_type _lst = items; size_t _idx = (size_t)name_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_405.has_value) {
                                __auto_type name_expr = _mv_405.value;
                                __auto_type _mv_406 = (*name_expr);
                                switch (_mv_406.tag) {
                                    case types_SExpr_sym:
                                    {
                                        __auto_type name_sym = _mv_406.data.sym;
                                        {
                                            ...
                                            __auto_type init_idx = ((has_mut) ? ((has_type) ? 3 : 2) : ((has_type) ? 2 : 1));
                                            if (has_type) {
                                                __auto_type _mv_407 = ({ __auto_type _lst = items; size_t _idx = (size_t)type_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_407.has_value) {
                                                    __auto_type type_expr = _mv_407.value;
                                                    {
                                                        __auto_type c_type = context_to_c_type_prefixed(ctx, type_expr);
                                                        __auto_type _mv_408 = ({ __auto_type _lst = items; size_t _idx = (size_t)init_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    ...
                                                    __auto_type _mv_409 = ({ __auto_type _lst = items; size_t _idx = (size_t)init_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                ...
                                                __auto_type _mv_410 = ({ __auto_type _lst = items; size_t _idx = (size_t)init_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_410.has_value) {
                                                    __auto_type init_expr = _mv_410.value;
                                                    {
                                                        __auto_type init_c = expr_transpile_expr(ctx, init_expr);
                                                        return context_ctx_str5(ctx, SLOP_STR("__auto_type "), var_name, SLOP_STR(" = "), init_c, SLOP_STR(";"));
                                                    }
...
uint8_t expr_binding_has_mut(slop_list_types_SExpr_ptr items) {
    if ((((int64_t)((items).len)) < 1)) {
        ...
        __auto_type _mv_411 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        if (_mv_411.has_value) {
            __auto_type first = _mv_411.value;
            __auto_type _mv_412 = (*first);
            switch (_mv_412.tag) {
                case types_SExpr_sym:
                {
...
slop_string expr_transpile_typed_init(context_TranspileContext* ctx, types_SExpr* init_expr, slop_string target_type) {
    ...
    __auto_type _mv_413 = (*init_expr);
    switch (_mv_413.tag) {
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_413.data.lst;
            {
                __auto_type items = lst.items;
                if ((((int64_t)((items).len)) < 1)) {
                    return expr_transpile_expr(ctx, init_expr);
                } else {
                    __auto_type _mv_414 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    ...
                                    if (string_eq(op, SLOP_STR("some"))) {
                                        if ((((int64_t)((items).len)) < 2)) {
                                            ...
                                            if (_mv_416.has_value) {
                                                __auto_type val_expr = _mv_416.value;
                                                {
                                                    __auto_type val_c = expr_transpile_expr(ctx, val_expr);
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len < 3)) {
            ...
            if (_mv_417.has_value) {
                __auto_type cond_expr = _mv_417.value;
                {
                    __auto_type cond_c = expr_transpile_expr(ctx, cond_expr);
        ...
        } else {
            {
                ...
                while ((i < len)) {
                    ...
                    if (_mv_419.has_value) {
                        __auto_type expr = _mv_419.value;
                        {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len < 2)) {
            ...
            if (_mv_420.has_value) {
                __auto_type cond_expr = _mv_420.value;
                {
                    __auto_type cond_c = expr_transpile_expr(ctx, cond_expr);
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len < 3)) {
            ...
            if (_mv_422.has_value) {
                __auto_type target_expr = _mv_422.value;
                ...
                if (_mv_423.has_value) {
                    ...
                    {
                        __auto_type val_c = expr_transpile_expr(ctx, val_expr);
                        __auto_type _mv_424 = (*target_expr);
                        switch (_mv_424.tag) {
                            case types_SExpr_lst:
                            {
                                __auto_type target_lst = _mv_424.data.lst;
                                {
                                    ...
                                    if ((((int64_t)((target_items).len)) < 1)) {
                                        ...
                                        __auto_type _mv_425 = ({ __auto_type _lst = target_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    ...
                                                    __auto_type sym = _mv_426.data.sym;
                                                    {
                                                        ...
                                                        if (string_eq(op, SLOP_STR("@"))) {
                                                            if ((((int64_t)((target_items).len)) < 3)) {
                                                                ...
                                                                __auto_type _mv_427 = ({ __auto_type _lst = target_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                                if (_mv_427.has_value) {
                                                                    __auto_type arr_expr = _mv_427.value;
                                                                    __auto_type _mv_428 = ({ __auto_type _lst = target_items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                                    if (_mv_428.has_value) {
                                                                        __auto_type idx_expr = _mv_428.value;
                                                                        {
                                                                            __auto_type arr_c = expr_transpile_expr(ctx, arr_expr);
                                                                            __auto_type idx_c = expr_transpile_expr(ctx, idx_expr);
...
slop_string expr_get_arena_for_list_push_expr(context_TranspileContext* ctx, types_SExpr* list_expr, slop_string list_c) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    SLOP_PRE(((list_expr != NULL)), "(!= list-expr nil)");
    __auto_type _mv_429 = context_ctx_lookup_var(ctx, SLOP_STR("arena"));
    if (_mv_429.has_value) {
        __auto_type arena_var = _mv_429.value;
        return arena_var.c_name;
    } else if (!_mv_429.has_value) {
        __auto_type _mv_430 = context_ctx_lookup_var(ctx, SLOP_STR("ctx"));
        if (_mv_430.has_value) {
            __auto_type ctx_var = _mv_430.value;
        ...
        } else if (!_mv_430.has_value) {
            {
                ...
                if ((string_len(arena_from_field) > 0)) {
                    ...
                    __auto_type _mv_431 = context_ctx_find_arena_var(ctx);
                    if (_mv_431.has_value) {
                        __auto_type arena_entry = _mv_431.value;
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_432.data.lst;
            {
                ...
                if ((len < 3)) {
                    ...
                    __auto_type _mv_433 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_433.has_value) {
                        __auto_type head_expr = _mv_433.value;
                        __auto_type _mv_434 = (*head_expr);
                        switch (_mv_434.tag) {
                            case types_SExpr_sym:
                            {
                                ...
                                if (string_eq(sym.name, SLOP_STR("."))) {
                                    ...
                                    if (_mv_435.has_value) {
                                        __auto_type base_expr = _mv_435.value;
...
slop_string expr_get_arena_from_base(context_TranspileContext* ctx, types_SExpr* base_expr) {
    ...
    switch (_mv_436.tag) {
        case types_SExpr_sym:
        {
            ...
            {
                __auto_type var_name = sym.name;
                __auto_type _mv_437 = context_ctx_lookup_var(ctx, var_name);
                if (_mv_437.has_value) {
                    __auto_type entry = _mv_437.value;
                    if (entry.is_pointer) {
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_436.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 2)) {
                    ...
                    __auto_type _mv_438 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_438.has_value) {
                        __auto_type head_expr = _mv_438.value;
                        __auto_type _mv_439 = (*head_expr);
                        switch (_mv_439.tag) {
                            case types_SExpr_sym:
                            {
                                ...
                                if (string_eq(sym.name, SLOP_STR("deref"))) {
                                    ...
                                    if (_mv_440.has_value) {
                                        __auto_type ptr_expr = _mv_440.value;
                                        {
...
uint8_t expr_is_ptr_to_ptr_map(context_TranspileContext* ctx, types_SExpr* expr) {
    ...
    switch (_mv_441.tag) {
        case types_SExpr_sym:
        {
            __auto_type sym = _mv_441.data.sym;
            {
                __auto_type name = sym.name;
                __auto_type _mv_442 = context_ctx_lookup_var(ctx, name);
                if (_mv_442.has_value) {
                    __auto_type entry = _mv_442.value;
                    {
                        __auto_type c_type = entry.c_type;
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len < 2)) {
            ...
            if (_mv_443.has_value) {
                __auto_type type_expr = _mv_443.value;
                __auto_type _mv_444 = (*type_expr);
                switch (_mv_444.tag) {
                    case types_SExpr_sym:
                    {
                        __auto_type type_sym = _mv_444.data.sym;
                        {
                            __auto_type raw_type_name = type_sym.name;
                    ...
                    case types_SExpr_lst:
                    {
                        __auto_type type_lst = _mv_444.data.lst;
                        {
                            ...
                            if ((((int64_t)((type_items).len)) < 1)) {
                                ...
                                __auto_type _mv_445 = ({ __auto_type _lst = type_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_445.has_value) {
                                    ...
                                    switch (_mv_446.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type head_sym = _mv_446.data.sym;
...
slop_string expr_transpile_record_fields(context_TranspileContext* ctx, slop_string type_name, slop_list_types_SExpr_ptr items, int64_t start_idx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        uint8_t first = 1;
        while ((i < len)) {
            __auto_type _mv_447 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_447.has_value) {
                __auto_type field_expr = _mv_447.value;
                __auto_type _mv_448 = (*field_expr);
                switch (_mv_448.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type field_lst = _mv_448.data.lst;
                        {
                            __auto_type field_items = field_lst.items;
                            if ((((int64_t)((field_items).len)) >= 2)) {
                                __auto_type _mv_449 = ({ __auto_type _lst = field_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_449.has_value) {
                                    ...
                                    switch (_mv_450.tag) {
                                        case types_SExpr_sym:
                                        {
                                            ...
                                            __auto_type _mv_451 = ({ __auto_type _lst = field_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_451.has_value) {
                                                __auto_type val_expr = _mv_451.value;
                                                {
...
slop_string expr_build_inline_struct_type(context_TranspileContext* ctx, slop_list_types_SExpr_ptr type_items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 1;
        while ((i < len)) {
            __auto_type _mv_452 = ({ __auto_type _lst = type_items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_452.has_value) {
                __auto_type field_expr = _mv_452.value;
                __auto_type _mv_453 = (*field_expr);
                switch (_mv_453.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type field_lst = _mv_453.data.lst;
                        {
                            __auto_type field_items = field_lst.items;
                            if ((((int64_t)((field_items).len)) >= 2)) {
                                __auto_type _mv_454 = ({ __auto_type _lst = field_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_454.has_value) {
                                    __auto_type name_expr = _mv_454.value;
                                    __auto_type _mv_455 = (*name_expr);
                                    switch (_mv_455.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type name_sym = _mv_455.data.sym;
                                            __auto_type _mv_456 = ({ __auto_type _lst = field_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_string expr_transpile_inline_record_fields(context_TranspileContext* ctx, slop_string struct_def, slop_list_types_SExpr_ptr items, int64_t start_idx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        uint8_t first = 1;
        while ((i < len)) {
            __auto_type _mv_457 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_457.has_value) {
                __auto_type field_expr = _mv_457.value;
                __auto_type _mv_458 = (*field_expr);
                switch (_mv_458.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type field_lst = _mv_458.data.lst;
                        {
                            __auto_type field_items = field_lst.items;
                            if ((((int64_t)((field_items).len)) >= 2)) {
                                __auto_type _mv_459 = ({ __auto_type _lst = field_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_459.has_value) {
                                    __auto_type name_expr = _mv_459.value;
                                    __auto_type _mv_460 = (*name_expr);
                                    switch (_mv_460.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type name_sym = _mv_460.data.sym;
                                            __auto_type _mv_461 = ({ __auto_type _lst = field_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_461.has_value) {
                                                __auto_type val_expr = _mv_461.value;
                                                {
                                                    __auto_type field_name = ctype_to_c_name(arena, name_sym.name);
...
slop_string expr_transpile_list_literal(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len < 2)) {
            ...
            __auto_type _mv_462 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                ...
                __auto_type type_expr = _mv_462.value;
                {
                    ...
                    __auto_type elem_count = (len - 2);
                    {
                        ...
                        }
                        {
                            ...
                            __auto_type _mv_464 = arena_var;
                            if (_mv_464.has_value) {
                                __auto_type arena_var = _mv_464.value;
                                {
                                    ...
                                    while ((i < ((int64_t)((elem_codes).len)))) {
                                        __auto_type _mv_465 = ({ __auto_type _lst = elem_codes; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                ...
                                context_ctx_add_warning(ctx, SLOP_STR("list literal uses stack-allocated compound literal (no arena in scope)"));
                                {
                                    ...
                                    i = 0;
                                    while ((i < ((int64_t)((elem_codes).len)))) {
                                        __auto_type _mv_466 = ({ __auto_type _lst = elem_codes; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_466.has_value) {
                                            __auto_type ec = _mv_466.value;
                                            if (first) {
...
slop_string expr_get_map_key_c_info(context_TranspileContext* ctx, types_SExpr* key_type_expr) {
    ...
    __auto_type _mv_467 = (*key_type_expr);
    switch (_mv_467.tag) {
        case types_SExpr_sym:
        {
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_467.data.lst;
            {
                __auto_type items = lst.items;
                if ((((int64_t)((items).len)) < 1)) {
                    return SLOP_STR("sizeof(void*), slop_hash_ptr, slop_eq_ptr");
                } else {
                    __auto_type _mv_468 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_468.has_value) {
                        __auto_type head = _mv_468.value;
                        __auto_type _mv_469 = (*head);
                        switch (_mv_469.tag) {
                            case types_SExpr_sym:
                            {
...
slop_string expr_get_struct_key_info_by_name(context_TranspileContext* ctx, slop_string name) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    __auto_type _mv_470 = context_ctx_lookup_type(ctx, name);
    if (_mv_470.has_value) {
        __auto_type type_entry = _mv_470.value;
        {
            __auto_type c_name = type_entry.c_name;
            context_ctx_register_struct_key_type(ctx, c_name);
            return expr_build_struct_key_info(ctx, c_name);
        ...
        __auto_type _mv_471 = context_ctx_get_module(ctx);
        if (_mv_471.has_value) {
            __auto_type mod = _mv_471.value;
            {
                __auto_type prefixed = context_ctx_str3(ctx, mod, SLOP_STR("_"), name);
                __auto_type _mv_472 = context_ctx_lookup_type(ctx, prefixed);
                if (_mv_472.has_value) {
                    __auto_type type_entry = _mv_472.value;
                    {
                        __auto_type c_name = type_entry.c_name;
                        context_ctx_register_struct_key_type(ctx, c_name);
                        return expr_build_struct_key_info(ctx, c_name);
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len < 3)) {
            ...
            if (_mv_474.has_value) {
                __auto_type arena_expr = _mv_474.value;
                __auto_type _mv_475 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_475.has_value) {
                    __auto_type key_type_expr = _mv_475.value;
                    {
                        __auto_type arena_c = expr_transpile_expr(ctx, arena_expr);
...
slop_string expr_transpile_map_put(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len < 4)) {
            ...
            __auto_type _mv_476 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_476.has_value) {
                __auto_type map_expr = _mv_476.value;
                __auto_type _mv_477 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_477.has_value) {
                    __auto_type key_expr = _mv_477.value;
                    __auto_type _mv_478 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_478.has_value) {
                        __auto_type val_expr = _mv_478.value;
                        {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len < 3)) {
            ...
            if (_mv_479.has_value) {
                ...
                __auto_type _mv_480 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_480.has_value) {
                    __auto_type key_expr = _mv_480.value;
                    {
                        __auto_type map_c = expr_transpile_expr(ctx, map_expr);
                        __auto_type key_c = expr_transpile_expr(ctx, key_expr);
                        __auto_type key_ptr = expr_wrap_map_key_as_ptr(ctx, key_c, key_expr, map_expr);
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len < 3)) {
            ...
            if (_mv_481.has_value) {
                ...
                __auto_type _mv_482 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_482.has_value) {
                    __auto_type key_expr = _mv_482.value;
                    {
                        __auto_type map_c = expr_transpile_expr(ctx, map_expr);
                        __auto_type key_c = expr_transpile_expr(ctx, key_expr);
                        __auto_type key_ptr = expr_wrap_map_key_as_ptr(ctx, key_c, key_expr, map_expr);
...
slop_string expr_transpile_map_keys(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len < 2)) {
            ...
            __auto_type _mv_483 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_string expr_transpile_set_new(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len < 3)) {
            ...
            __auto_type _mv_484 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_484.has_value) {
                __auto_type arena_expr = _mv_484.value;
                __auto_type _mv_485 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_485.has_value) {
                    __auto_type elem_type_expr = _mv_485.value;
                    {
                        __auto_type arena_c = expr_transpile_expr(ctx, arena_expr);
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len < 3)) {
            ...
            if (_mv_486.has_value) {
                ...
                __auto_type _mv_487 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_string expr_transpile_set_has(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len < 3)) {
            ...
            __auto_type _mv_488 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_488.has_value) {
                __auto_type set_expr = _mv_488.value;
                __auto_type _mv_489 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_489.has_value) {
                    __auto_type elem_expr = _mv_489.value;
                    {
                        __auto_type set_c = expr_transpile_expr(ctx, set_expr);
                        __auto_type elem_c = expr_transpile_expr(ctx, elem_expr);
                        __auto_type elem_ptr = expr_wrap_map_key_as_ptr(ctx, elem_c, elem_expr, set_expr);
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len < 3)) {
            ...
            if (_mv_490.has_value) {
                __auto_type set_expr = _mv_490.value;
                __auto_type _mv_491 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_491.has_value) {
                    __auto_type elem_expr = _mv_491.value;
                    {
                        __auto_type set_c = expr_transpile_expr(ctx, set_expr);
                        __auto_type elem_c = expr_transpile_expr(ctx, elem_expr);
                        __auto_type elem_ptr = expr_wrap_map_key_as_ptr(ctx, elem_c, elem_expr, set_expr);
...
slop_string expr_transpile_set_elements(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len < 2)) {
            ...
            __auto_type _mv_492 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_492.has_value) {
                __auto_type set_expr = _mv_492.value;
                {
                    __auto_type set_c = expr_transpile_expr(ctx, set_expr);
                    ...
                    __auto_type result = context_ctx_str(ctx, SLOP_STR("({ slop_map* _s = slop_map_new_ptr(arena, "), context_ctx_str(ctx, int_to_string(arena, init_cap), context_ctx_str(ctx, SLOP_STR(", "), context_ctx_str(ctx, elem_info, SLOP_STR("); ")))));
                    {
                        ...
                        while ((i < len)) {
                            ...
                            if (_mv_494.has_value) {
                                __auto_type elem_expr = _mv_494.value;
                                {
                                    __auto_type elem_c = expr_transpile_expr(ctx, elem_expr);
...
slop_string expr_transpile_for_as_expr(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len < 2)) {
            ...
            __auto_type _mv_495 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_495.has_value) {
                __auto_type binding_expr = _mv_495.value;
                __auto_type _mv_496 = (*binding_expr);
                switch (_mv_496.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type binding_lst = _mv_496.data.lst;
                        {
                            ...
                            if ((binding_len < 3)) {
                                ...
                                __auto_type _mv_497 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_497.has_value) {
                                    __auto_type var_expr = _mv_497.value;
                                    __auto_type _mv_498 = (*var_expr);
                                    switch (_mv_498.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type var_sym = _mv_498.data.sym;
                                            {
                                                __auto_type var_name = ctype_to_c_name(arena, var_sym.name);
                                                __auto_type _mv_499 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_499.has_value) {
                                                    __auto_type start_expr = _mv_499.value;
                                                    __auto_type _mv_500 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_500.has_value) {
                                                        __auto_type end_expr = _mv_500.value;
                                                        {
...
slop_string expr_transpile_for_each_as_expr(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len < 2)) {
            ...
            __auto_type _mv_502 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_502.has_value) {
                __auto_type binding_expr = _mv_502.value;
                __auto_type _mv_503 = (*binding_expr);
                switch (_mv_503.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type binding_lst = _mv_503.data.lst;
                        {
                            __auto_type binding_items = binding_lst.items;
                            __auto_type binding_len = ((int64_t)((binding_items).len));
                            if ((binding_len < 2)) {
                                ...
                                __auto_type _mv_504 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_504.has_value) {
                                    __auto_type first_elem = _mv_504.value;
                                    __auto_type _mv_505 = (*first_elem);
                                    switch (_mv_505.tag) {
                                        case types_SExpr_lst:
                                        {
                                            __auto_type _ = _mv_505.data.lst;
                                            return expr_transpile_for_each_map_kv_as_expr(ctx, binding_items, items, len);
                                        }
                                        case types_SExpr_sym:
                                        {
                                            __auto_type var_sym = _mv_505.data.sym;
                                            {
                                                __auto_type var_name = ctype_to_c_name(arena, var_sym.name);
                                                __auto_type _mv_506 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_506.has_value) {
                                                    __auto_type coll_expr = _mv_506.value;
                                                    {
    ...
    SLOP_PRE(((coll_expr != NULL)), "(!= coll-expr nil)");
    {
        ...
        __auto_type elem_c_type = expr_slop_value_type_to_c_type(ctx, elem_slop_type);
        {
            ...
            context_ctx_bind_var(ctx, (context_VarEntry){var_sym.name, var_name, elem_c_type, elem_slop_type, 0, 0, 0, SLOP_STR(""), SLOP_STR("")});
            {
                int64_t i = 2;
                while ((i < len)) {
                    __auto_type _mv_508 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    ...
    SLOP_PRE(((coll_expr != NULL)), "(!= coll-expr nil)");
    {
        ...
        __auto_type key_c_type = expr_slop_value_type_to_c_type(ctx, key_slop_type);
        {
            ...
            context_ctx_bind_var(ctx, (context_VarEntry){var_sym.name, var_name, key_c_type, key_slop_type, 0, 0, 0, SLOP_STR(""), SLOP_STR("")});
            {
                int64_t i = 2;
                while ((i < len)) {
                    __auto_type _mv_509 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_509.has_value) {
                        __auto_type body_expr = _mv_509.value;
                        {
                            __auto_type body_c = expr_transpile_expr(ctx, body_expr);
                            result = context_ctx_str3(ctx, result, body_c, SLOP_STR("; "));
                        }
...
slop_string expr_transpile_for_each_map_kv_as_expr(context_TranspileContext* ctx, slop_list_types_SExpr_ptr binding_items, slop_list_types_SExpr_ptr items, int64_t len) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_510 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        if (_mv_510.has_value) {
            __auto_type kv_list_expr = _mv_510.value;
            __auto_type _mv_511 = (*kv_list_expr);
            switch (_mv_511.tag) {
                case types_SExpr_lst:
                {
                    __auto_type kv_lst = _mv_511.data.lst;
                    {
                        __auto_type kv_items = kv_lst.items;
                        if ((((int64_t)((kv_items).len)) < 2)) {
                            return SLOP_STR("({ /* for-each: map binding needs ((k v) map) */ 0; })");
                        } else {
                            __auto_type _mv_512 = ({ __auto_type _lst = kv_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_512.has_value) {
                                __auto_type k_expr = _mv_512.value;
                                __auto_type _mv_513 = ({ __auto_type _lst = kv_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_513.has_value) {
                                    __auto_type v_expr = _mv_513.value;
                                    __auto_type _mv_514 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    if (_mv_514.has_value) {
                                        __auto_type map_expr = _mv_514.value;
                                        __auto_type _mv_515 = (*k_expr);
                                        switch (_mv_515.tag) {
                                            case types_SExpr_sym:
                                            {
                                                __auto_type k_sym = _mv_515.data.sym;
                                                __auto_type _mv_516 = (*v_expr);
                                                switch (_mv_516.tag) {
                                                    case types_SExpr_sym:
                                                    {
                                                        __auto_type v_sym = _mv_516.data.sym;
                                                        {
                                                            ...
                                                            __auto_type val_c_type = expr_slop_value_type_to_c_type(ctx, val_slop_type);
                                                            {
                                                                ...
                                                                context_ctx_bind_var(ctx, (context_VarEntry){v_sym.name, v_name, val_c_type, val_slop_type, 0, 0, 0, SLOP_STR(""), SLOP_STR("")});
                                                                {
                                                                    __auto_type i = 2;
                                                                    while ((i < len)) {
                                                                        __auto_type _mv_517 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                                        if (_mv_517.has_value) {
                                                                            __auto_type body_expr = _mv_517.value;
                                                                            {
                                                                                __auto_type body_c = expr_transpile_expr(ctx, body_expr);
                                                                                result = context_ctx_str3(ctx, result, body_c, SLOP_STR("; "));
                                                                            }
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len < 2)) {
            ...
            if (_mv_518.has_value) {
                __auto_type second = _mv_518.value;
                __auto_type _mv_519 = (*second);
                switch (_mv_519.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type params_lst = _mv_519.data.lst;
                        return expr_transpile_lambda_with_params(ctx, items, params_lst.items);
                    }
                    case types_SExpr_sym:
                    {
                        __auto_type _ = _mv_519.data.sym;
...
slop_list_string expr_extract_param_names(slop_arena* arena, slop_list_types_SExpr_ptr params) {
    {
        ...
        int64_t i = 0;
        while ((i < count)) {
            __auto_type _mv_520 = ({ __auto_type _lst = params; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_520.has_value) {
                __auto_type param_expr = _mv_520.value;
                __auto_type _mv_521 = (*param_expr);
                switch (_mv_521.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type param_lst = _mv_521.data.lst;
                        {
                            __auto_type param_items = param_lst.items;
                            if ((((int64_t)((param_items).len)) >= 1)) {
                                __auto_type _mv_522 = ({ __auto_type _lst = param_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_522.has_value) {
                                    __auto_type name_expr = _mv_522.value;
                                    __auto_type _mv_523 = (*name_expr);
                                    switch (_mv_523.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type name_sym = _mv_523.data.sym;
...
slop_string expr_build_closure_struct(context_TranspileContext* ctx, slop_string env_type, slop_list_string free_vars) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < count)) {
            __auto_type _mv_524 = ({ __auto_type _lst = free_vars; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void expr_bind_closure_captures(context_TranspileContext* ctx, slop_list_string free_vars) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < count)) {
            __auto_type _mv_525 = ({ __auto_type _lst = free_vars; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_list_string expr_capture_free_var_accesses(context_TranspileContext* ctx, slop_list_string free_vars) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < count)) {
            __auto_type _mv_526 = ({ __auto_type _lst = free_vars; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_526.has_value) {
                __auto_type var_name = _mv_526.value;
                {
                    __auto_type c_name = ctype_to_c_name(arena, var_name);
                    __auto_type var_info = context_ctx_lookup_var(ctx, var_name);
...
slop_string expr_find_arena_ptr_expr(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    __auto_type _mv_527 = context_ctx_lookup_var(ctx, SLOP_STR("_arena"));
    if (_mv_527.has_value) {
        __auto_type entry = _mv_527.value;
        return SLOP_STR("&_arena");
    } else if (!_mv_527.has_value) {
        __auto_type _mv_528 = context_ctx_lookup_var(ctx, SLOP_STR("arena"));
        if (_mv_528.has_value) {
            __auto_type entry = _mv_528.value;
            return entry.c_name;
...
slop_string expr_build_env_initializer(context_TranspileContext* ctx, slop_list_string free_vars, slop_list_string captured_accesses) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < count)) {
            __auto_type _mv_529 = ({ __auto_type _lst = free_vars; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_529.has_value) {
                __auto_type var_name = _mv_529.value;
                {
                    __auto_type c_name = ctype_to_c_name(arena, var_name);
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((param_count == 0)) {
        ...
        } else {
            {
                ...
                int64_t i = 0;
                while ((i < param_count)) {
                    __auto_type _mv_530 = ({ __auto_type _lst = params; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_530.has_value) {
                        __auto_type param_expr = _mv_530.value;
                        __auto_type _mv_531 = (*param_expr);
                        switch (_mv_531.tag) {
                            case types_SExpr_lst:
                            {
                                __auto_type param_lst = _mv_531.data.lst;
                                {
                                    __auto_type param_items = param_lst.items;
                                    if ((((int64_t)((param_items).len)) >= 2)) {
                                        __auto_type _mv_532 = ({ __auto_type _lst = param_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_532.has_value) {
                                            __auto_type name_expr = _mv_532.value;
                                            __auto_type _mv_533 = (*name_expr);
                                            switch (_mv_533.tag) {
                                                case types_SExpr_sym:
                                                {
                                                    __auto_type name_sym = _mv_533.data.sym;
                                                    __auto_type _mv_534 = ({ __auto_type _lst = param_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_534.has_value) {
                                                        __auto_type type_expr = _mv_534.value;
                                                        {
...
void expr_bind_lambda_params(context_TranspileContext* ctx, slop_list_types_SExpr_ptr params) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < param_count)) {
            __auto_type _mv_535 = ({ __auto_type _lst = params; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_535.has_value) {
                __auto_type param_expr = _mv_535.value;
                __auto_type _mv_536 = (*param_expr);
                switch (_mv_536.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type param_lst = _mv_536.data.lst;
                        {
                            __auto_type param_items = param_lst.items;
                            if ((((int64_t)((param_items).len)) >= 2)) {
                                __auto_type _mv_537 = ({ __auto_type _lst = param_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_537.has_value) {
                                    __auto_type name_expr = _mv_537.value;
                                    __auto_type _mv_538 = (*name_expr);
                                    switch (_mv_538.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type name_sym = _mv_538.data.sym;
                                            __auto_type _mv_539 = ({ __auto_type _lst = param_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_539.has_value) {
                                                __auto_type type_expr = _mv_539.value;
                                                {
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_540.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    __auto_type _mv_541 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        if ((len <= start)) {
            ...
            while ((i < len)) {
                ...
                if (_mv_543.has_value) {
                    __auto_type expr = _mv_543.value;
                    {
                        __auto_type expr_c = expr_transpile_expr(ctx, expr);
                        __auto_type is_last = (i == (len - 1));
                        if (is_last) {
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_544.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 2)) {
                    ...
                    __auto_type _mv_545 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_string expr_transpile_spawn_closure(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items, types_SExpr* fn_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_549 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        if (_mv_549.has_value) {
            __auto_type arena_expr = _mv_549.value;
            {
                __auto_type arena_c = expr_transpile_expr(ctx, arena_expr);
...
uint8_t expr_lambda_has_captures(context_TranspileContext* ctx, types_SExpr* fn_expr) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    SLOP_PRE(((fn_expr != NULL)), "(!= fn-expr nil)");
    __auto_type _mv_550 = (*fn_expr);
    switch (_mv_550.tag) {
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_550.data.lst;
            {
                __auto_type items = lst.items;
                __auto_type arena = (*ctx).arena;
                if ((((int64_t)((items).len)) < 2)) {
                    ...
                    __auto_type _mv_551 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_551.has_value) {
                        __auto_type params_expr = _mv_551.value;
                        __auto_type _mv_552 = (*params_expr);
                        switch (_mv_552.tag) {
                            case types_SExpr_lst:
                            {
                                __auto_type params_lst = _mv_552.data.lst;
                                {
...
slop_string expr_transpile_regular_fn_call(context_TranspileContext* ctx, slop_string fn_name, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t param_idx = 0;
        while ((i < len)) {
            __auto_type _mv_553 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_553.has_value) {
                __auto_type arg = _mv_553.value;
                {
                    __auto_type arg_c = expr_transpile_expr(ctx, arg);
...
slop_string expr_infer_generic_type_binding(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((((int64_t)((items).len)) < 2)) {
            ...
            __auto_type _mv_554 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_554.has_value) {
                __auto_type first_arg = _mv_554.value;
                {
...
slop_list_string expr_find_free_vars(context_TranspileContext* ctx, slop_list_string param_names, slop_list_types_SExpr_ptr body_items, int64_t start, slop_list_string pending) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = start;
        while ((i < len)) {
            __auto_type _mv_555 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_555.has_value) {
                __auto_type expr = _mv_555.value;
        ...
        }
        {
            ...
            int64_t j = 0;
            while ((j < sym_count)) {
                __auto_type _mv_556 = ({ __auto_type _lst = all_symbols; size_t _idx = (size_t)j; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_556.has_value) {
                    __auto_type sym_name = _mv_556.value;
                ...
                if ((len > 0)) {
                    ...
                    if (_mv_558.has_value) {
                        ...
                        switch (_mv_559.tag) {
                            case types_SExpr_sym:
                            {
                                __auto_type head_sym = _mv_559.data.sym;
                                {
                                    __auto_type op = head_sym.name;
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while ((i < len)) {
            ...
            if (_mv_560.has_value) {
                __auto_type item = _mv_560.value;
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len >= 2)) {
            ...
            if (_mv_561.has_value) {
                __auto_type bindings_expr = _mv_561.value;
                {
                    ...
                    __auto_type _mv_562 = (*bindings_expr);
                    switch (_mv_562.tag) {
                        case types_SExpr_lst:
                        {
                            __auto_type bindings_lst = _mv_562.data.lst;
                            {
                                __auto_type bindings = bindings_lst.items;
                                __auto_type binding_count = ((int64_t)((bindings).len));
                                __auto_type i = 0;
                                while ((i < binding_count)) {
                                    __auto_type _mv_563 = ({ __auto_type _lst = bindings; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    if (_mv_563.has_value) {
                                        __auto_type binding = _mv_563.value;
                                        __auto_type _mv_564 = (*binding);
                                        switch (_mv_564.tag) {
                                            case types_SExpr_lst:
                                            {
                                                __auto_type bind_lst = _mv_564.data.lst;
                                                {
                                                    __auto_type bind_items = bind_lst.items;
                                                    if ((((int64_t)((bind_items).len)) >= 2)) {
                                                        {
                                                            __auto_type val_idx = ((expr_is_mut_binding(bind_items)) ? 2 : 1);
                                                            __auto_type _mv_565 = ({ __auto_type _lst = bind_items; size_t _idx = (size_t)val_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                            if (_mv_565.has_value) {
                                                                __auto_type val_expr = _mv_565.value;
...
uint8_t expr_is_mut_binding(slop_list_types_SExpr_ptr items) {
    if ((((int64_t)((items).len)) < 1)) {
        ...
        __auto_type _mv_566 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        if (_mv_566.has_value) {
            __auto_type first = _mv_566.value;
            __auto_type _mv_567 = (*first);
            switch (_mv_567.tag) {
                case types_SExpr_sym:
                {
                    __auto_type sym = _mv_567.data.sym;
                    return string_eq(sym.name, SLOP_STR("mut"));
                }
                default: {
                    return 0;
...
slop_list_string expr_extract_let_binding_names(slop_arena* arena, types_SExpr* bindings_expr) {
    ...
    {
        __auto_type names = ((slop_list_string){ .data = (slop_string*)slop_arena_alloc(arena, 16 * sizeof(slop_string)), .len = 0, .cap = 16 });
        __auto_type _mv_568 = (*bindings_expr);
        switch (_mv_568.tag) {
            case types_SExpr_lst:
            {
                __auto_type bindings_lst = _mv_568.data.lst;
                {
                    __auto_type bindings = bindings_lst.items;
                    __auto_type binding_count = ((int64_t)((bindings).len));
                    __auto_type i = 0;
                    while ((i < binding_count)) {
                        __auto_type _mv_569 = ({ __auto_type _lst = bindings; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_569.has_value) {
                            __auto_type binding = _mv_569.value;
                            __auto_type _mv_570 = (*binding);
                            switch (_mv_570.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type bind_lst = _mv_570.data.lst;
                                    {
                                        __auto_type bind_items = bind_lst.items;
                                        if ((((int64_t)((bind_items).len)) >= 1)) {
                                            {
                                                __auto_type name_idx = ((expr_is_mut_binding(bind_items)) ? 1 : 0);
                                                __auto_type _mv_571 = ({ __auto_type _lst = bind_items; size_t _idx = (size_t)name_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_571.has_value) {
                                                    __auto_type name_expr = _mv_571.value;
                                                    __auto_type _mv_572 = (*name_expr);
                                                    switch (_mv_572.tag) {
                                                        case types_SExpr_sym:
                                                        {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len >= 2)) {
            ...
            if (_mv_573.has_value) {
                __auto_type scrutinee = _mv_573.value;
            ...
            }
            {
                ...
                while ((i < len)) {
                    ...
                    if (_mv_574.has_value) {
                        __auto_type clause = _mv_574.value;
                        __auto_type _mv_575 = (*clause);
                        switch (_mv_575.tag) {
                            case types_SExpr_lst:
                            {
                                __auto_type clause_lst = _mv_575.data.lst;
                                {
                                    __auto_type clause_items = clause_lst.items;
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len >= 2)) {
            ...
            if (_mv_576.has_value) {
                __auto_type binding = _mv_576.value;
                __auto_type _mv_577 = (*binding);
                switch (_mv_577.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type bind_lst = _mv_577.data.lst;
                        {
                            __auto_type bind_items = bind_lst.items;
...
slop_list_string expr_extract_for_loop_var_pending(slop_arena* arena, slop_list_string pending, slop_list_types_SExpr_ptr bind_items) {
    if ((((int64_t)((bind_items).len)) < 1)) {
        ...
        __auto_type _mv_578 = ({ __auto_type _lst = bind_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        if (_mv_578.has_value) {
            __auto_type var_expr = _mv_578.value;
            __auto_type _mv_579 = (*var_expr);
            switch (_mv_579.tag) {
                case types_SExpr_sym:
                {
                    __auto_type var_sym = _mv_579.data.sym;
                    {
                        __auto_type result = ((slop_list_string){ .data = (slop_string*)slop_arena_alloc(arena, 16 * sizeof(slop_string)), .len = 0, .cap = 16 });
                        ...
                        __auto_type i = 0;
                        while ((i < plen)) {
                            __auto_type _mv_580 = ({ __auto_type _lst = pending; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_580.has_value) {
                                __auto_type s = _mv_580.value;
        ...
        if ((len >= 3)) {
            {
                ...
                __auto_type size_idx = ((is_named) ? 3 : 1);
                __auto_type body_start = ((is_named) ? 4 : 2);
                __auto_type _mv_581 = ({ __auto_type _lst = items; size_t _idx = (size_t)size_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_581.has_value) {
                    __auto_type size_expr = _mv_581.value;
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len >= 2)) {
            ...
            if (_mv_582.has_value) {
                __auto_type params_expr = _mv_582.value;
                __auto_type _mv_583 = (*params_expr);
                switch (_mv_583.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type params_lst = _mv_583.data.lst;
                        {
                            __auto_type params = params_lst.items;
                            __auto_type param_names = expr_extract_param_names(arena, params);
    ...
    if (expr_list_contains_string(param_names, sym_name)) {
        ...
        if (expr_list_contains_string(pending, sym_name)) {
            ...
            if (expr_is_builtin_op(sym_name)) {
                ...
                __auto_type _mv_584 = context_ctx_lookup_func(ctx, sym_name);
                if (_mv_584.has_value) {
                    __auto_type _ = _mv_584.value;
                    return 0;
                } else if (!_mv_584.has_value) {
                    __auto_type _mv_585 = context_ctx_lookup_type(ctx, sym_name);
                    if (_mv_585.has_value) {
                        __auto_type _ = _mv_585.value;
                        return 0;
                    } else if (!_mv_585.has_value) {
                        __auto_type _mv_586 = context_ctx_lookup_var(ctx, sym_name);
                        if (_mv_586.has_value) {
                            __auto_type _ = _mv_586.value;
                            return 1;
...
uint8_t expr_list_contains_string(slop_list_string lst, slop_string needle) {
    {
        ...
        uint8_t found = 0;
        while (((i < len) && !(found))) {
            __auto_type _mv_587 = ({ __auto_type _lst = lst; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_list_string expr_list_concat(slop_arena* arena, slop_list_string a, slop_list_string b) {
    {
        ...
        int64_t i = 0;
        while ((i < len_a)) {
            __auto_type _mv_588 = ({ __auto_type _lst = a; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        i = 0;
        while ((i < len_b)) {
            __auto_type _mv_589 = ({ __auto_type _lst = b; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_589.has_value) {
                __auto_type s = _mv_589.value;
                ({ __auto_type _lst_p = &(result); __auto_type _item = (s); if (_lst_p->len >= _lst_p->cap) { size_t _new_cap = _lst_p->cap == 0 ? 16 : _lst_p->cap * 2; __typeof__(_lst_p->data) _new_data = (__typeof__(_lst_p->data))slop_arena_alloc(arena, _new_cap * sizeof(*_lst_p->data)); if (_lst_p->len > 0) memcpy(_new_data, _lst_p->data, _lst_p->len * sizeof(*_lst_p->data)); _lst_p->data = _new_data; _lst_p->cap = _new_cap; } _lst_p->data[_lst_p->len++] = _item; (void)0; });
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_590.data.lst;
                {
                    ...
                    if ((((int64_t)((items).len)) < 1)) {
                        ...
                        __auto_type _mv_591 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        ...
                                        if (string_eq(op, SLOP_STR("map-keys"))) {
                                            if ((((int64_t)((items).len)) < 2)) {
                                                ...
                                                if (_mv_593.has_value) {
                                                    __auto_type map_expr = _mv_593.value;
                                                    {
                                                        __auto_type map_slop_type = expr_infer_expr_slop_type(ctx, map_expr);
                                            ...
                                            if ((((int64_t)((items).len)) < 2)) {
                                                ...
                                                if (_mv_594.has_value) {
                                                    __auto_type set_expr = _mv_594.value;
                                                    {
                                            ...
                                            if ((((int64_t)((items).len)) < 2)) {
                                                ...
                                                if (_mv_595.has_value) {
                                                    __auto_type map_expr = _mv_595.value;
                                                    {
                                                        __auto_type map_slop_type = expr_infer_expr_slop_type(ctx, map_expr);
                                                        if ((string_len(map_slop_type) > 0)) {
                                                            {
