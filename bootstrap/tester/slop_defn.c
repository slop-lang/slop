        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_867.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    __auto_type _mv_868 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_873.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    __auto_type _mv_874 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_876.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    __auto_type _mv_877 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
uint8_t defn_has_generic_annotation(slop_list_types_SExpr_ptr items) {
    {
        ...
        __auto_type found = 0;
        while (((i < len) && !(found))) {
            __auto_type _mv_882 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_882.has_value) {
                __auto_type item = _mv_882.value;
                __auto_type _mv_883 = (*item);
                switch (_mv_883.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type lst = _mv_883.data.lst;
                        {
                            ...
                            if ((((int64_t)((sub_items).len)) > 0)) {
                                __auto_type _mv_884 = ({ __auto_type _lst = sub_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_889.data.lst;
                {
                    ...
                    if ((len < 4)) {
                        ...
                        __auto_type _mv_890 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_890.has_value) {
                            __auto_type name_expr = _mv_890.value;
                            __auto_type _mv_891 = (*name_expr);
                            switch (_mv_891.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_891.data.sym;
                                    {
                                        ...
                                        __auto_type _mv_892 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_892.has_value) {
                                            __auto_type type_expr = _mv_892.value;
                                            {
                                                ...
                                                __auto_type _mv_893 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_893.has_value) {
                                                    __auto_type value_expr = _mv_893.value;
        ...
        if (ctype_is_int_type(type_name)) {
        ...
        } else {
            {
                ...
                if (string_eq(type_name, SLOP_STR("String"))) {
                    __auto_type _mv_894 = (*value_expr);
                    switch (_mv_894.tag) {
                        case types_SExpr_str:
                        {
                            __auto_type str = _mv_894.data.str;
...
slop_string defn_eval_const_value(context_TranspileContext* ctx, types_SExpr* expr) {
    ...
    SLOP_PRE(((expr != NULL)), "(!= expr nil)");
    {
        ...
        switch (_mv_896.tag) {
            ...
            case types_SExpr_str:
            {
                __auto_type str = _mv_896.data.str;
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_897.data.lst;
                {
                    ...
                    __auto_type len = ((int64_t)((items).len));
                    {
                        ...
                        if ((len >= (name_idx + 1))) {
                            __auto_type _mv_898 = ({ __auto_type _lst = items; size_t _idx = (size_t)name_idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
uint8_t defn_is_string_expr(slop_list_types_SExpr_ptr items, int64_t idx) {
    __auto_type _mv_900 = ({ __auto_type _lst = items; size_t _idx = (size_t)idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    if (_mv_900.has_value) {
        ...
        switch (_mv_901.tag) {
            case types_SExpr_str:
            {
                __auto_type _ = _mv_901.data.str;
                return 1;
            }
            default: {
                return 0;
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_902.data.lst;
                {
                    ...
                    if ((len < 3)) {
                        ...
                        __auto_type _mv_903 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            ...
                            switch (_mv_904.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_904.data.sym;
                                    {
                                        ...
                                        __auto_type _mv_905 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_905.has_value) {
                                            __auto_type type_def = _mv_905.value;
...
void defn_dispatch_type_def(context_TranspileContext* ctx, slop_string raw_name, slop_string qualified_name, types_SExpr* type_def) {
    ...
    __auto_type _mv_906 = (*type_def);
    switch (_mv_906.tag) {
        case types_SExpr_lst:
        {
            __auto_type def_lst = _mv_906.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    __auto_type _mv_907 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
uint8_t defn_has_payload_variants(slop_list_types_SExpr_ptr items) {
    {
        ...
        uint8_t found = 0;
        while (((i < len) && !(found))) {
            __auto_type _mv_909 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_909.has_value) {
                __auto_type item = _mv_909.value;
                __auto_type _mv_910 = (*item);
                switch (_mv_910.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type _ = _mv_910.data.lst;
                        found = 1;
                        break;
                    }
                    default: {
...
void defn_emit_record_fields(context_TranspileContext* ctx, slop_string raw_type_name, slop_string qualified_type_name, slop_list_types_SExpr_ptr items, int64_t start_idx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = start_idx;
        while ((i < len)) {
            __auto_type _mv_912 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_912.has_value) {
                __auto_type field_expr = _mv_912.value;
...
void defn_emit_record_field(context_TranspileContext* ctx, slop_string raw_type_name, slop_string qualified_type_name, types_SExpr* field) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_913 = (*field);
        switch (_mv_913.tag) {
            case types_SExpr_lst:
            {
                __auto_type field_lst = _mv_913.data.lst;
                {
                    ...
                    if ((len < 2)) {
                        ...
                        if (_mv_914.has_value) {
                            __auto_type name_expr = _mv_914.value;
                            __auto_type _mv_915 = (*name_expr);
                            switch (_mv_915.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_915.data.sym;
                                    __auto_type _mv_916 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    if (_mv_916.has_value) {
                                        __auto_type type_expr = _mv_916.value;
                                        {
...
void defn_emit_union_variants(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items, int64_t start_idx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = start_idx;
        while ((i < len)) {
            __auto_type _mv_921 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_921.has_value) {
                __auto_type variant_expr = _mv_921.value;
                __auto_type _mv_922 = (*variant_expr);
                switch (_mv_922.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type var_lst = _mv_922.data.lst;
                        {
                            __auto_type var_items = var_lst.items;
                            __auto_type var_len = ((int64_t)((var_items).len));
                            if ((var_len >= 1)) {
                                __auto_type _mv_923 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_923.has_value) {
                                    __auto_type tag_expr = _mv_923.value;
                                    __auto_type _mv_924 = (*tag_expr);
                                    switch (_mv_924.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type tag_sym = _mv_924.data.sym;
                                            {
                                                __auto_type tag_name = tag_sym.name;
                                                if ((var_len >= 2)) {
                                                    __auto_type _mv_925 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while ((i < len)) {
            ...
            if (_mv_926.has_value) {
                __auto_type variant_expr = _mv_926.value;
                __auto_type _mv_927 = (*variant_expr);
                switch (_mv_927.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type var_lst = _mv_927.data.lst;
                        {
                            __auto_type var_items = var_lst.items;
                            if ((((int64_t)((var_items).len)) >= 1)) {
                                __auto_type _mv_928 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_928.has_value) {
                                    __auto_type tag_expr = _mv_928.value;
                                    __auto_type _mv_929 = (*tag_expr);
                                    switch (_mv_929.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type tag_sym = _mv_929.data.sym;
                                            {
                                                __auto_type tag_name = tag_sym.name;
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while ((i < len)) {
            ...
            if (_mv_930.has_value) {
                __auto_type variant_expr = _mv_930.value;
                __auto_type _mv_931 = (*variant_expr);
                switch (_mv_931.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type var_lst = _mv_931.data.lst;
                        {
                            __auto_type var_items = var_lst.items;
                            __auto_type var_len = ((int64_t)((var_items).len));
                            if ((var_len >= 2)) {
                                __auto_type _mv_932 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_932.has_value) {
                                    __auto_type tag_expr = _mv_932.value;
                                    __auto_type _mv_933 = (*tag_expr);
                                    switch (_mv_933.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type tag_sym = _mv_933.data.sym;
                                            {
                                                __auto_type tag_name = tag_sym.name;
                                                __auto_type _mv_934 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_938.data.lst;
                {
                    ...
                    if ((len < 3)) {
                        ...
                        __auto_type _mv_939 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_939.has_value) {
                            __auto_type elem_type_expr = _mv_939.value;
                            ...
                            if (_mv_940.has_value) {
                                __auto_type size_expr = _mv_940.value;
                                {
...
slop_string defn_get_number_as_string(types_SExpr* expr) {
    ...
    switch (_mv_941.tag) {
        case types_SExpr_num:
        {
            __auto_type num = _mv_941.data.num;
            return num.raw;
        }
        default: {
            return SLOP_STR("0");
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_942.data.lst;
            {
                ...
                while (((i < len) && !(found_dots))) {
                    __auto_type _mv_943 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_943.has_value) {
                        __auto_type item = _mv_943.value;
                        __auto_type _mv_944 = (*item);
                        switch (_mv_944.tag) {
                            case types_SExpr_sym:
                            {
                    ...
                    while ((i < len)) {
                        ...
                        if (_mv_946.has_value) {
                            ...
                            switch (_mv_947.tag) {
                                case types_SExpr_num:
                                {
                                    __auto_type num = _mv_947.data.num;
                                    if (!(found_dots)) {
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_948.data.lst;
                {
                    ...
                    if ((len < 3)) {
                        ...
                        __auto_type _mv_949 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_949.has_value) {
                            __auto_type name_expr = _mv_949.value;
                            __auto_type _mv_950 = (*name_expr);
                            switch (_mv_950.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_950.data.sym;
                                    {
                                        __auto_type raw_name = name_sym.name;
                                        __auto_type base_name = ctype_to_c_name(arena, raw_name);
                                        ...
                                        __auto_type _mv_951 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_951.has_value) {
                                            __auto_type params_expr = _mv_951.value;
...
void defn_bind_params_to_scope(context_TranspileContext* ctx, types_SExpr* params_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_954 = (*params_expr);
        switch (_mv_954.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_954.data.lst;
                {
                    ...
                    while ((i < len)) {
                        ...
                        if (_mv_955.has_value) {
                            __auto_type param = _mv_955.value;
                    ...
                    if ((len >= 2)) {
                        {
                            ...
                            __auto_type _mv_957 = ({ __auto_type _lst = items; size_t _idx = (size_t)name_idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_957.has_value) {
                                ...
                                switch (_mv_958.tag) {
                                    case types_SExpr_sym:
                                    {
                                        ...
                                        __auto_type _mv_959 = ({ __auto_type _lst = items; size_t _idx = (size_t)type_idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_959.has_value) {
                                            __auto_type type_expr = _mv_959.value;
                                            {
...
slop_list_context_FuncParamType_ptr defn_collect_param_types(context_TranspileContext* ctx, types_SExpr* params_expr) {
    ...
    SLOP_PRE(((params_expr != NULL)), "(!= params-expr nil)");
    {
        ...
        __auto_type _mv_963 = (*params_expr);
        switch (_mv_963.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_963.data.lst;
                {
                    ...
                    while ((i < len)) {
                        ...
                        if (_mv_964.has_value) {
                            __auto_type param = _mv_964.value;
                            {
        ...
        switch (_mv_967.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_967.data.lst;
                {
                    ...
                    __auto_type len = ((int64_t)((items).len));
                    if ((len >= 3)) {
                        __auto_type _mv_968 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                ...
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_969.data.sym;
                                    {
                                        ...
                                        if (_mv_970.has_value) {
                                            __auto_type params_expr = _mv_970.value;
                                            {
                                                __auto_type result_type_opt = defn_get_result_type_name(ctx, items);
                                                __auto_type raw_return = defn_get_return_type(ctx, items);
                                                {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while ((i < len)) {
            ...
            if (_mv_971.has_value) {
                __auto_type item = _mv_971.value;
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_975.data.lst;
                {
                    ...
                    if ((((int64_t)((items).len)) < 2)) {
                        ...
                        __auto_type _mv_976 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_976.has_value) {
                            __auto_type spec_body = _mv_976.value;
                            __auto_type _mv_977 = (*spec_body);
                            switch (_mv_977.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type body_lst = _mv_977.data.lst;
                                    {
                                        ...
                                        if ((body_len < 1)) {
                                            ...
                                            __auto_type _mv_978 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)(body_len - 1); slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_978.has_value) {
                                                __auto_type ret_type = _mv_978.value;
                ...
                __auto_type lst = _mv_979.data.lst;
                {
                    ...
                    if ((((int64_t)((items).len)) < 2)) {
                        ...
                        if (_mv_980.has_value) {
                            __auto_type spec_body = _mv_980.value;
                            __auto_type _mv_981 = (*spec_body);
                            switch (_mv_981.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type body_lst = _mv_981.data.lst;
                                    {
                                        __auto_type body_items = body_lst.items;
                                        __auto_type body_len = ((int64_t)((body_items).len));
                                        if ((body_len < 1)) {
                                            ...
                                            __auto_type _mv_982 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)(body_len - 1); slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_982.has_value) {
                                                __auto_type ret_type = _mv_982.value;
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (((i < len) && ({ __auto_type _mv = result; _mv.has_value ? ({ __auto_type _ = _mv.value; 0; }) : (1); }))) {
            ...
            if (_mv_984.has_value) {
                __auto_type item = _mv_984.value;
                if (defn_is_spec_form(item)) {
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_985.data.lst;
                {
                    ...
                    if ((((int64_t)((items).len)) < 2)) {
                        ...
                        __auto_type _mv_986 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_986.has_value) {
                            __auto_type spec_body = _mv_986.value;
                            __auto_type _mv_987 = (*spec_body);
                            switch (_mv_987.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type body_lst = _mv_987.data.lst;
                                    {
                                        __auto_type body_items = body_lst.items;
                                        __auto_type body_len = ((int64_t)((body_items).len));
                                        if ((body_len < 1)) {
                                            ...
                                            __auto_type _mv_988 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)(body_len - 1); slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_988.has_value) {
                                                __auto_type ret_type = _mv_988.value;
    ...
    SLOP_PRE(((type_expr != NULL)), "(!= type-expr nil)");
    {
        ...
        switch (_mv_989.tag) {
            case types_SExpr_sym:
            {
                ...
                {
                    __auto_type type_name = sym.name;
                    __auto_type _mv_990 = context_ctx_lookup_result_type_alias(ctx, type_name);
                    if (_mv_990.has_value) {
                        __auto_type alias_result = _mv_990.value;
                        return (slop_option_string){.has_value = 1, .value = alias_result};
                    } else if (!_mv_990.has_value) {
                        __auto_type _mv_991 = context_ctx_lookup_type(ctx, type_name);
                        if (_mv_991.has_value) {
                            __auto_type entry = _mv_991.value;
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_989.data.lst;
                {
                    ...
                    if ((((int64_t)((items).len)) < 3)) {
                        ...
                        __auto_type _mv_992 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            ...
                            switch (_mv_993.tag) {
                                case types_SExpr_sym:
                                {
                                    ...
                                    if (string_eq(sym.name, SLOP_STR("Result"))) {
                                        __auto_type _mv_994 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_994.has_value) {
                                            __auto_type ok_type_expr = _mv_994.value;
                                            ...
                                            if (_mv_995.has_value) {
                                                __auto_type err_type_expr = _mv_995.value;
                                                {
...
uint8_t defn_is_param_mode(slop_list_types_SExpr_ptr items) {
    if ((((int64_t)((items).len)) < 1)) {
        ...
        __auto_type _mv_1002 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        if (_mv_1002.has_value) {
            __auto_type first = _mv_1002.value;
            __auto_type _mv_1003 = (*first);
            switch (_mv_1003.tag) {
                case types_SExpr_sym:
                {
            ...
            __auto_type lst = _mv_1004.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    if (_mv_1005.has_value) {
                        __auto_type first = _mv_1005.value;
                        __auto_type _mv_1006 = (*first);
                        switch (_mv_1006.tag) {
                            case types_SExpr_sym:
                            {
...
slop_string defn_emit_fn_param_type(context_TranspileContext* ctx, types_SExpr* type_expr, slop_string param_name) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1007 = (*type_expr);
        switch (_mv_1007.tag) {
            case types_SExpr_lst:
            {
                    ...
                    } else {
                        {
                            ...
                            if ((len == 2)) {
                                ...
                                if (_mv_1008.has_value) {
                                    __auto_type args_expr = _mv_1008.value;
                                    {
...
slop_string defn_build_fn_args_str_for_param(context_TranspileContext* ctx, types_SExpr* args_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1009 = (*args_expr);
        switch (_mv_1009.tag) {
            case types_SExpr_lst:
            {
                __auto_type args_list = _mv_1009.data.lst;
                {
                    ...
                    if ((arg_count == 0)) {
                    ...
                    } else {
                        {
                            ...
                            __auto_type i = 0;
                            while ((i < arg_count)) {
                                __auto_type _mv_1010 = ({ __auto_type _lst = arg_items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1010.has_value) {
                                    __auto_type arg_expr = _mv_1010.value;
                                    {
...
uint8_t defn_is_c_name_attr_at(slop_list_types_SExpr_ptr items, int64_t idx) {
    __auto_type _mv_1014 = ({ __auto_type _lst = items; size_t _idx = (size_t)idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    if (_mv_1014.has_value) {
        __auto_type item = _mv_1014.value;
            ...
            __auto_type lst = _mv_1028.data.lst;
            {
                ...
                if ((len < 1)) {
                ...
                } else {
                    {
                        __auto_type found = 0;
                        __auto_type i = 0;
                        __auto_type _mv_1029 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                ...
                __auto_type lst = _mv_1035.data.lst;
                {
                    ...
                    if ((((int64_t)((items).len)) >= 2)) {
                        ...
                        if (_mv_1036.has_value) {
                            __auto_type val = _mv_1036.value;
                            __auto_type _mv_1037 = (*val);
                            switch (_mv_1037.tag) {
                                case types_SExpr_str:
                                {
                                    __auto_type str = _mv_1037.data.str;
                ...
                __auto_type lst = _mv_1039.data.lst;
                {
                    ...
                    if ((((int64_t)((items).len)) >= 2)) {
                        ...
                        if (_mv_1040.has_value) {
                            __auto_type val = _mv_1040.value;
        ...
        while ((i < len)) {
            ...
            if (_mv_1041.has_value) {
                ...
                if (defn_is_pre_form(item)) {
                    __auto_type _mv_1042 = defn_get_annotation_condition(item);
                    if (_mv_1042.has_value) {
                        __auto_type cond = _mv_1042.value;
...
slop_list_types_SExpr_ptr defn_collect_postconditions(slop_arena* arena, slop_list_types_SExpr_ptr items) {
    {
        ...
        int64_t i = 3;
        while ((i < len)) {
            __auto_type _mv_1043 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1043.has_value) {
                __auto_type item = _mv_1043.value;
                if (defn_is_post_form(item)) {
                    __auto_type _mv_1044 = defn_get_annotation_condition(item);
                    if (_mv_1044.has_value) {
                        __auto_type cond = _mv_1044.value;
                        ({ __auto_type _lst_p = &(result); __auto_type _item = (cond); if (_lst_p->len >= _lst_p->cap) { size_t _new_cap = _lst_p->cap == 0 ? 16 : _lst_p->cap * 2; __typeof__(_lst_p->data) _new_data = (__typeof__(_lst_p->data))slop_arena_alloc(arena, _new_cap * sizeof(*_lst_p->data)); if (_lst_p->len > 0) memcpy(_new_data, _lst_p->data, _lst_p->len * sizeof(*_lst_p->data)); _lst_p->data = _new_data; _lst_p->cap = _new_cap; } _lst_p->data[_lst_p->len++] = _item; (void)0; });
        ...
        while ((i < len)) {
            ...
            if (_mv_1045.has_value) {
                ...
                if (defn_is_assume_form(item)) {
                    __auto_type _mv_1046 = defn_get_annotation_condition(item);
                    if (_mv_1046.has_value) {
                        __auto_type cond = _mv_1046.value;
                        ({ __auto_type _lst_p = &(result); __auto_type _item = (cond); if (_lst_p->len >= _lst_p->cap) { size_t _new_cap = _lst_p->cap == 0 ? 16 : _lst_p->cap * 2; __typeof__(_lst_p->data) _new_data = (__typeof__(_lst_p->data))slop_arena_alloc(arena, _new_cap * sizeof(*_lst_p->data)); if (_lst_p->len > 0) memcpy(_new_data, _lst_p->data, _lst_p->len * sizeof(*_lst_p->data)); _lst_p->data = _new_data; _lst_p->cap = _new_cap; } _lst_p->data[_lst_p->len++] = _item; (void)0; });
...
void defn_emit_preconditions(context_TranspileContext* ctx, slop_list_types_SExpr_ptr preconditions) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1048 = ({ __auto_type _lst = preconditions; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void defn_emit_postconditions(context_TranspileContext* ctx, slop_list_types_SExpr_ptr postconditions) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1049 = ({ __auto_type _lst = postconditions; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1049.has_value) {
                __auto_type cond_expr = _mv_1049.value;
...
void defn_emit_assumptions(context_TranspileContext* ctx, slop_list_types_SExpr_ptr assumptions) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1050 = ({ __auto_type _lst = assumptions; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1050.has_value) {
                __auto_type cond_expr = _mv_1050.value;
                if (!(defn_is_verification_only_expr(cond_expr))) {
                    {
                        __auto_type cond_c = expr_transpile_expr(ctx, cond_expr);
                        __auto_type expr_str = parser_pretty_print(arena, cond_expr);
