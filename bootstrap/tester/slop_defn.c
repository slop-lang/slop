        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_871.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    __auto_type _mv_872 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
uint8_t defn_has_generic_annotation(slop_list_types_SExpr_ptr items) {
    {
        ...
        __auto_type found = 0;
        while (((i < len) && !(found))) {
            __auto_type _mv_880 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_880.has_value) {
                __auto_type item = _mv_880.value;
                __auto_type _mv_881 = (*item);
                switch (_mv_881.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type lst = _mv_881.data.lst;
                        {
                            ...
                            if ((((int64_t)((sub_items).len)) > 0)) {
                                __auto_type _mv_882 = ({ __auto_type _lst = sub_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                ...
                __auto_type lst = _mv_887.data.lst;
                {
                    ...
                    if ((len < 4)) {
                        ...
                        if (_mv_888.has_value) {
                            __auto_type name_expr = _mv_888.value;
                            __auto_type _mv_889 = (*name_expr);
                            switch (_mv_889.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_889.data.sym;
                                    {
                                        ...
                                        __auto_type _mv_890 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_890.has_value) {
                                            __auto_type type_expr = _mv_890.value;
                                            {
                                                ...
                                                __auto_type _mv_891 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_891.has_value) {
                                                    __auto_type value_expr = _mv_891.value;
        ...
        if (ctype_is_int_type(type_name)) {
        ...
        } else {
            {
                ...
                if (string_eq(type_name, SLOP_STR("String"))) {
                    __auto_type _mv_892 = (*value_expr);
                    switch (_mv_892.tag) {
                        case types_SExpr_str:
                        {
                            __auto_type str = _mv_892.data.str;
...
slop_string defn_eval_const_value(context_TranspileContext* ctx, types_SExpr* expr) {
    ...
    SLOP_PRE(((expr != NULL)), "(!= expr nil)");
    {
        ...
        switch (_mv_894.tag) {
            ...
            {
                __auto_type num = _mv_894.data.num;
                return num.raw;
            }
            case types_SExpr_str:
            {
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_895.data.lst;
                {
                    ...
                    __auto_type len = ((int64_t)((items).len));
                    {
                        ...
                        if ((len >= (name_idx + 1))) {
                            __auto_type _mv_896 = ({ __auto_type _lst = items; size_t _idx = (size_t)name_idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
uint8_t defn_is_string_expr(slop_list_types_SExpr_ptr items, int64_t idx) {
    __auto_type _mv_898 = ({ __auto_type _lst = items; size_t _idx = (size_t)idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    if (_mv_898.has_value) {
        ...
        switch (_mv_899.tag) {
            case types_SExpr_str:
            {
                __auto_type _ = _mv_899.data.str;
                return 1;
            }
            default: {
                return 0;
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_900.data.lst;
                {
                    ...
                    if ((len < 3)) {
                        ...
                        __auto_type _mv_901 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            ...
                            switch (_mv_902.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_902.data.sym;
                                    {
                                        ...
                                        __auto_type _mv_903 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_903.has_value) {
                                            __auto_type type_def = _mv_903.value;
...
void defn_dispatch_type_def(context_TranspileContext* ctx, slop_string raw_name, slop_string qualified_name, types_SExpr* type_def) {
    ...
    __auto_type _mv_904 = (*type_def);
    switch (_mv_904.tag) {
        case types_SExpr_lst:
        {
            __auto_type def_lst = _mv_904.data.lst;
            {
        ...
        case types_SExpr_sym:
        {
            __auto_type sym = _mv_904.data.sym;
            defn_transpile_type_alias(ctx, raw_name, qualified_name, type_def);
            break;
        }
        default: {
        ...
        while (((i < len) && !(found))) {
            ...
            if (_mv_907.has_value) {
                ...
                switch (_mv_908.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type _ = _mv_908.data.lst;
                        found = 1;
                        break;
                    }
                    default: {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while ((i < len)) {
            ...
            if (_mv_910.has_value) {
                __auto_type field_expr = _mv_910.value;
...
void defn_emit_record_field(context_TranspileContext* ctx, slop_string raw_type_name, slop_string qualified_type_name, types_SExpr* field) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_911 = (*field);
        switch (_mv_911.tag) {
            case types_SExpr_lst:
            {
                __auto_type field_lst = _mv_911.data.lst;
                {
                        ...
                        if (_mv_912.has_value) {
                            ...
                            switch (_mv_913.tag) {
                                case types_SExpr_sym:
                                {
                                    ...
                                    __auto_type _mv_914 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while ((i < len)) {
            ...
            if (_mv_916.has_value) {
                __auto_type val_expr = _mv_916.value;
                __auto_type _mv_917 = (*val_expr);
                switch (_mv_917.tag) {
                    case types_SExpr_sym:
                    {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while ((i < len)) {
            ...
            if (_mv_924.has_value) {
                __auto_type variant_expr = _mv_924.value;
                __auto_type _mv_925 = (*variant_expr);
                switch (_mv_925.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type var_lst = _mv_925.data.lst;
                        {
                            __auto_type var_items = var_lst.items;
                            if ((((int64_t)((var_items).len)) >= 1)) {
                                __auto_type _mv_926 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_926.has_value) {
                                    __auto_type tag_expr = _mv_926.value;
                                    __auto_type _mv_927 = (*tag_expr);
                                    switch (_mv_927.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type tag_sym = _mv_927.data.sym;
                                            {
                                                __auto_type tag_name = tag_sym.name;
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_933.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    __auto_type _mv_934 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                ...
                __auto_type lst = _mv_936.data.lst;
                {
                    ...
                    if ((len < 3)) {
                        ...
                        if (_mv_937.has_value) {
                            __auto_type elem_type_expr = _mv_937.value;
                            ...
                            if (_mv_938.has_value) {
                                __auto_type size_expr = _mv_938.value;
                                {
...
slop_string defn_get_number_as_string(types_SExpr* expr) {
    ...
    switch (_mv_939.tag) {
        case types_SExpr_num:
        {
            __auto_type num = _mv_939.data.num;
            return num.raw;
        }
        default: {
            return SLOP_STR("0");
                    ...
                    while ((i < len)) {
                        ...
                        if (_mv_944.has_value) {
                            ...
                            switch (_mv_945.tag) {
                                case types_SExpr_num:
                                {
                                    __auto_type num = _mv_945.data.num;
                                    if (!(found_dots)) {
                                ...
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_948.data.sym;
                                    {
                                        ...
                                        if (_mv_949.has_value) {
                                            __auto_type params_expr = _mv_949.value;
                    ...
                    if ((len >= 2)) {
                        {
                            ...
                            __auto_type _mv_955 = ({ __auto_type _lst = items; size_t _idx = (size_t)name_idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_955.has_value) {
                                __auto_type name_expr = _mv_955.value;
                                __auto_type _mv_956 = (*name_expr);
                                switch (_mv_956.tag) {
                                    case types_SExpr_sym:
                                    {
                                        __auto_type name_sym = _mv_956.data.sym;
                                        __auto_type _mv_957 = ({ __auto_type _lst = items; size_t _idx = (size_t)type_idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_957.has_value) {
                                            __auto_type type_expr = _mv_957.value;
                                            {
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_958.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    __auto_type _mv_959 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                ...
                __auto_type lst = _mv_963.data.lst;
                {
                    ...
                    if ((len < 2)) {
                    ...
                    } else {
                        {
                            __auto_type has_mode = ((len >= 3) && defn_is_param_mode(items));
                            __auto_type type_idx = ((has_mode) ? 2 : 1);
                            __auto_type _mv_964 = ({ __auto_type _lst = items; size_t _idx = (size_t)type_idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_964.has_value) {
                                __auto_type type_expr = _mv_964.value;
        ...
        switch (_mv_965.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_965.data.lst;
                {
                    ...
                    __auto_type len = ((int64_t)((items).len));
                    if ((len >= 3)) {
                        __auto_type _mv_966 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_966.has_value) {
                            __auto_type name_expr = _mv_966.value;
                            __auto_type _mv_967 = (*name_expr);
                            switch (_mv_967.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_967.data.sym;
                                    {
                                        __auto_type raw_name = name_sym.name;
                                        __auto_type base_name = ctype_to_c_name(arena, raw_name);
                                        ...
                                        __auto_type _mv_968 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_968.has_value) {
                                            __auto_type params_expr = _mv_968.value;
                                            {
                                                __auto_type result_type_opt = defn_get_result_type_name(ctx, items);
                                                __auto_type raw_return = defn_get_return_type(ctx, items);
                                                {
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_970.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    __auto_type _mv_971 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                ...
                __auto_type lst = _mv_973.data.lst;
                {
                    ...
                    if ((((int64_t)((items).len)) < 2)) {
                        ...
                        if (_mv_974.has_value) {
                            __auto_type spec_body = _mv_974.value;
                            __auto_type _mv_975 = (*spec_body);
                            switch (_mv_975.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type body_lst = _mv_975.data.lst;
                                    {
                                        ...
                                        if ((body_len < 1)) {
                                            ...
                                            __auto_type _mv_976 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)(body_len - 1); slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_976.has_value) {
                                                __auto_type ret_type = _mv_976.value;
                ...
                __auto_type lst = _mv_977.data.lst;
                {
                    ...
                    if ((((int64_t)((items).len)) < 2)) {
                        ...
                        if (_mv_978.has_value) {
                            __auto_type spec_body = _mv_978.value;
                            __auto_type _mv_979 = (*spec_body);
                            switch (_mv_979.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type body_lst = _mv_979.data.lst;
                                    {
                                        __auto_type body_items = body_lst.items;
                                        __auto_type body_len = ((int64_t)((body_items).len));
                                        if ((body_len < 1)) {
                                            ...
                                            __auto_type _mv_980 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)(body_len - 1); slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_980.has_value) {
                                                __auto_type ret_type = _mv_980.value;
                                ...
                                case types_SExpr_lst:
                                {
                                    __auto_type body_lst = _mv_985.data.lst;
                                    {
                                        ...
                                        if ((body_len < 1)) {
                                            ...
                                            __auto_type _mv_986 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)(body_len - 1); slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    ...
    SLOP_PRE(((type_expr != NULL)), "(!= type-expr nil)");
    {
        ...
        switch (_mv_987.tag) {
            case types_SExpr_sym:
            {
                ...
                {
                    __auto_type type_name = sym.name;
                    __auto_type _mv_988 = context_ctx_lookup_result_type_alias(ctx, type_name);
                    if (_mv_988.has_value) {
                        __auto_type alias_result = _mv_988.value;
                        return (slop_option_string){.has_value = 1, .value = alias_result};
                    } else if (!_mv_988.has_value) {
                        __auto_type _mv_989 = context_ctx_lookup_type(ctx, type_name);
                        if (_mv_989.has_value) {
                            __auto_type entry = _mv_989.value;
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_987.data.lst;
                {
                    ...
                    if ((((int64_t)((items).len)) < 3)) {
                        ...
                        __auto_type _mv_990 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_990.has_value) {
                            __auto_type head = _mv_990.value;
                            __auto_type _mv_991 = (*head);
                            switch (_mv_991.tag) {
                                case types_SExpr_sym:
                                {
                                    ...
                                    if (string_eq(sym.name, SLOP_STR("Result"))) {
                                        ...
                                        if (_mv_992.has_value) {
                                            __auto_type ok_type_expr = _mv_992.value;
                                            ...
                                            if (_mv_993.has_value) {
                                                __auto_type err_type_expr = _mv_993.value;
                                                {
...
uint8_t defn_is_param_mode(slop_list_types_SExpr_ptr items) {
    if ((((int64_t)((items).len)) < 1)) {
        ...
        __auto_type _mv_1000 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        if (_mv_1000.has_value) {
            __auto_type first = _mv_1000.value;
            __auto_type _mv_1001 = (*first);
            switch (_mv_1001.tag) {
                case types_SExpr_sym:
                {
            ...
            __auto_type lst = _mv_1002.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    if (_mv_1003.has_value) {
                        __auto_type first = _mv_1003.value;
                        __auto_type _mv_1004 = (*first);
                        switch (_mv_1004.tag) {
                            case types_SExpr_sym:
                            {
...
slop_string defn_emit_fn_param_type(context_TranspileContext* ctx, types_SExpr* type_expr, slop_string param_name) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1005 = (*type_expr);
        switch (_mv_1005.tag) {
            case types_SExpr_lst:
            {
                    ...
                    if ((len < 2)) {
                    ...
                    } else {
                        {
                            ...
                            if ((len == 2)) {
                                ...
                                __auto_type _mv_1006 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1006.has_value) {
                                    __auto_type args_expr = _mv_1006.value;
                                    {
...
slop_string defn_build_fn_args_str_for_param(context_TranspileContext* ctx, types_SExpr* args_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1007 = (*args_expr);
        switch (_mv_1007.tag) {
            case types_SExpr_lst:
            {
                __auto_type args_list = _mv_1007.data.lst;
                {
                    ...
                    if ((arg_count == 0)) {
                    ...
                    } else {
                        {
                            ...
                            __auto_type i = 0;
                            while ((i < arg_count)) {
                                __auto_type _mv_1008 = ({ __auto_type _lst = arg_items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1008.has_value) {
                                    __auto_type arg_expr = _mv_1008.value;
                                    {
...
void defn_emit_function_body(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        i = body_start;
        while ((i < len)) {
            __auto_type _mv_1009 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1009.has_value) {
                __auto_type item = _mv_1009.value;
...
uint8_t defn_is_c_name_attr_at(slop_list_types_SExpr_ptr items, int64_t idx) {
    __auto_type _mv_1012 = ({ __auto_type _lst = items; size_t _idx = (size_t)idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                ...
                __auto_type lst = _mv_1033.data.lst;
                {
                    ...
                    if ((((int64_t)((items).len)) >= 2)) {
                        ...
                        if (_mv_1034.has_value) {
                            __auto_type val = _mv_1034.value;
                            __auto_type _mv_1035 = (*val);
                            switch (_mv_1035.tag) {
                                case types_SExpr_str:
                                {
                ...
                __auto_type lst = _mv_1037.data.lst;
                {
                    ...
                    if ((((int64_t)((items).len)) >= 2)) {
                        ...
                        if (_mv_1038.has_value) {
                            __auto_type val = _mv_1038.value;
        ...
        while ((i < len)) {
            ...
            if (_mv_1039.has_value) {
                ...
                if (defn_is_pre_form(item)) {
                    __auto_type _mv_1040 = defn_get_annotation_condition(item);
                    if (_mv_1040.has_value) {
                        __auto_type cond = _mv_1040.value;
...
void defn_emit_preconditions(context_TranspileContext* ctx, slop_list_types_SExpr_ptr preconditions) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1046 = ({ __auto_type _lst = preconditions; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1046.has_value) {
                __auto_type cond_expr = _mv_1046.value;
                {
...
void defn_emit_postconditions(context_TranspileContext* ctx, slop_list_types_SExpr_ptr postconditions) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1047 = ({ __auto_type _lst = postconditions; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void defn_emit_assumptions(context_TranspileContext* ctx, slop_list_types_SExpr_ptr assumptions) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1048 = ({ __auto_type _lst = assumptions; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
