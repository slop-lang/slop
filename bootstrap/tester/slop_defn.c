        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_881.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    __auto_type _mv_882 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_887.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    __auto_type _mv_888 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_888.has_value) {
                        __auto_type head = _mv_888.value;
                        __auto_type _mv_889 = (*head);
                        switch (_mv_889.tag) {
                            case types_SExpr_sym:
                            {
                    ...
                    case types_SExpr_lst:
                    {
                        __auto_type lst = _mv_897.data.lst;
                        {
                            ...
                            if ((((int64_t)((sub_items).len)) > 0)) {
                                __auto_type _mv_898 = ({ __auto_type _lst = sub_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    ...
                    if ((len < 4)) {
                        ...
                        if (_mv_904.has_value) {
                            ...
                            switch (_mv_905.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_905.data.sym;
                                    {
                                        ...
                                        if (_mv_906.has_value) {
                                            __auto_type type_expr = _mv_906.value;
                                            {
                                                ...
                                                __auto_type _mv_907 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_907.has_value) {
                                                    __auto_type value_expr = _mv_907.value;
        ...
        if (ctype_is_int_type(type_name)) {
        ...
        } else {
            {
                ...
                if (string_eq(type_name, SLOP_STR("String"))) {
                    __auto_type _mv_908 = (*value_expr);
                    switch (_mv_908.tag) {
                        case types_SExpr_str:
                        {
                            __auto_type str = _mv_908.data.str;
...
slop_string defn_eval_const_value(context_TranspileContext* ctx, types_SExpr* expr) {
    ...
    SLOP_PRE(((expr != NULL)), "(!= expr nil)");
    {
        ...
        switch (_mv_910.tag) {
            ...
            {
                __auto_type num = _mv_910.data.num;
                return num.raw;
            }
            case types_SExpr_str:
            {
                __auto_type str = _mv_910.data.str;
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_911.data.lst;
                {
                    ...
                    __auto_type len = ((int64_t)((items).len));
                    {
                        ...
                        if ((len >= (name_idx + 1))) {
                            __auto_type _mv_912 = ({ __auto_type _lst = items; size_t _idx = (size_t)name_idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
uint8_t defn_is_string_expr(slop_list_types_SExpr_ptr items, int64_t idx) {
    __auto_type _mv_914 = ({ __auto_type _lst = items; size_t _idx = (size_t)idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    if (_mv_914.has_value) {
        __auto_type item = _mv_914.value;
        __auto_type _mv_915 = (*item);
        switch (_mv_915.tag) {
            case types_SExpr_str:
            {
                __auto_type _ = _mv_915.data.str;
                return 1;
            }
            default: {
                return 0;
                                ...
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_918.data.sym;
                                    {
                                        ...
                                        if (_mv_919.has_value) {
                                            __auto_type type_def = _mv_919.value;
...
void defn_dispatch_type_def(context_TranspileContext* ctx, slop_string raw_name, slop_string qualified_name, types_SExpr* type_def) {
    ...
    __auto_type _mv_920 = (*type_def);
    switch (_mv_920.tag) {
        case types_SExpr_lst:
        {
            __auto_type def_lst = _mv_920.data.lst;
            {
        ...
        while (((i < len) && !(found))) {
            ...
            if (_mv_923.has_value) {
                ...
                switch (_mv_924.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type _ = _mv_924.data.lst;
                        found = 1;
                        break;
                    }
                    default: {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while ((i < len)) {
            ...
            if (_mv_926.has_value) {
                __auto_type field_expr = _mv_926.value;
...
void defn_emit_record_field(context_TranspileContext* ctx, slop_string raw_type_name, slop_string qualified_type_name, types_SExpr* field) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_927 = (*field);
        switch (_mv_927.tag) {
            case types_SExpr_lst:
            {
                __auto_type field_lst = _mv_927.data.lst;
                {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while ((i < len)) {
            ...
            if (_mv_932.has_value) {
                __auto_type val_expr = _mv_932.value;
                __auto_type _mv_933 = (*val_expr);
                switch (_mv_933.tag) {
                    case types_SExpr_sym:
                    {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while ((i < len)) {
            ...
            if (_mv_935.has_value) {
                __auto_type variant_expr = _mv_935.value;
                __auto_type _mv_936 = (*variant_expr);
                switch (_mv_936.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type var_lst = _mv_936.data.lst;
                        {
                            __auto_type var_items = var_lst.items;
                            __auto_type var_len = ((int64_t)((var_items).len));
                            if ((var_len >= 1)) {
                                __auto_type _mv_937 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_937.has_value) {
                                    __auto_type tag_expr = _mv_937.value;
                                    __auto_type _mv_938 = (*tag_expr);
                                    switch (_mv_938.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type tag_sym = _mv_938.data.sym;
                                            {
                                                __auto_type tag_name = tag_sym.name;
                                                if ((var_len >= 2)) {
                                                    __auto_type _mv_939 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_939.has_value) {
                                                        __auto_type type_expr = _mv_939.value;
                                                        {
                                                            __auto_type c_type = context_to_c_type_prefixed(ctx, type_expr);
                                                            {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while ((i < len)) {
            ...
            if (_mv_940.has_value) {
                __auto_type variant_expr = _mv_940.value;
                __auto_type _mv_941 = (*variant_expr);
                switch (_mv_941.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type var_lst = _mv_941.data.lst;
                        {
                            __auto_type var_items = var_lst.items;
                            if ((((int64_t)((var_items).len)) >= 1)) {
                                __auto_type _mv_942 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_942.has_value) {
                                    __auto_type tag_expr = _mv_942.value;
                                    __auto_type _mv_943 = (*tag_expr);
                                    switch (_mv_943.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type tag_sym = _mv_943.data.sym;
                                            {
                                                __auto_type tag_name = tag_sym.name;
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while ((i < len)) {
            ...
            if (_mv_944.has_value) {
                __auto_type variant_expr = _mv_944.value;
                __auto_type _mv_945 = (*variant_expr);
                switch (_mv_945.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type var_lst = _mv_945.data.lst;
                        {
                            __auto_type var_items = var_lst.items;
                            __auto_type var_len = ((int64_t)((var_items).len));
                            if ((var_len >= 2)) {
                                __auto_type _mv_946 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_946.has_value) {
                                    __auto_type tag_expr = _mv_946.value;
                                    __auto_type _mv_947 = (*tag_expr);
                                    switch (_mv_947.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type tag_sym = _mv_947.data.sym;
                                            {
                                                __auto_type tag_name = tag_sym.name;
                                                __auto_type _mv_948 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                ...
                __auto_type lst = _mv_952.data.lst;
                {
                    ...
                    if ((len < 3)) {
                        ...
                        if (_mv_953.has_value) {
                            __auto_type elem_type_expr = _mv_953.value;
                            ...
                            if (_mv_954.has_value) {
                                __auto_type size_expr = _mv_954.value;
                                {
...
slop_string defn_get_number_as_string(types_SExpr* expr) {
    ...
    switch (_mv_955.tag) {
        case types_SExpr_num:
        {
            __auto_type num = _mv_955.data.num;
            return num.raw;
        }
        default: {
            return SLOP_STR("0");
                    ...
                    while ((i < len)) {
                        ...
                        if (_mv_960.has_value) {
                            ...
                            switch (_mv_961.tag) {
                                case types_SExpr_num:
                                {
                                    __auto_type num = _mv_961.data.num;
                                    if (!(found_dots)) {
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_962.data.lst;
                {
                    ...
                    if ((len < 3)) {
                        ...
                        __auto_type _mv_963 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_963.has_value) {
                            __auto_type name_expr = _mv_963.value;
                            __auto_type _mv_964 = (*name_expr);
                            switch (_mv_964.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_964.data.sym;
                                    {
                                        __auto_type raw_name = name_sym.name;
                                        __auto_type base_name = ctype_to_c_name(arena, raw_name);
                                        ...
                                        __auto_type _mv_965 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_965.has_value) {
                                            __auto_type params_expr = _mv_965.value;
                ...
                __auto_type lst = _mv_968.data.lst;
                {
                    ...
                    while ((i < len)) {
                        ...
                        if (_mv_969.has_value) {
                            __auto_type param = _mv_969.value;
                    ...
                    if ((len >= 2)) {
                        {
                            ...
                            __auto_type _mv_971 = ({ __auto_type _lst = items; size_t _idx = (size_t)name_idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_list_context_FuncParamType_ptr defn_collect_param_types(context_TranspileContext* ctx, types_SExpr* params_expr) {
    ...
    SLOP_PRE(((params_expr != NULL)), "(!= params-expr nil)");
    {
        ...
        __auto_type _mv_977 = (*params_expr);
        switch (_mv_977.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_977.data.lst;
                {
                    ...
                    while ((i < len)) {
                        ...
                        if (_mv_978.has_value) {
                            __auto_type param = _mv_978.value;
                            {
        ...
        switch (_mv_981.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_981.data.lst;
                {
                    ...
                    __auto_type len = ((int64_t)((items).len));
                    if ((len >= 3)) {
                        __auto_type _mv_982 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_982.has_value) {
                            __auto_type name_expr = _mv_982.value;
                            __auto_type _mv_983 = (*name_expr);
                            switch (_mv_983.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_983.data.sym;
                                    {
                                        __auto_type raw_name = name_sym.name;
                                        __auto_type base_name = ctype_to_c_name(arena, raw_name);
                                        ...
                                        if (_mv_984.has_value) {
                                            __auto_type params_expr = _mv_984.value;
                                            {
                                                __auto_type result_type_opt = defn_get_result_type_name(ctx, items);
                                                __auto_type raw_return = defn_get_return_type(ctx, items);
                                                {
                ...
                __auto_type lst = _mv_989.data.lst;
                {
                    ...
                    if ((((int64_t)((items).len)) < 2)) {
                        ...
                        if (_mv_990.has_value) {
                            __auto_type spec_body = _mv_990.value;
                            __auto_type _mv_991 = (*spec_body);
                            switch (_mv_991.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type body_lst = _mv_991.data.lst;
                                    {
                                        ...
                                        if ((body_len < 1)) {
                                            ...
                                            __auto_type _mv_992 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)(body_len - 1); slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                ...
                __auto_type lst = _mv_993.data.lst;
                {
                    ...
                    if ((((int64_t)((items).len)) < 2)) {
                        ...
                        if (_mv_994.has_value) {
                            __auto_type spec_body = _mv_994.value;
                            __auto_type _mv_995 = (*spec_body);
                            switch (_mv_995.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type body_lst = _mv_995.data.lst;
                                    {
                                        __auto_type body_items = body_lst.items;
                                        __auto_type body_len = ((int64_t)((body_items).len));
                                        if ((body_len < 1)) {
                                            ...
                                            __auto_type _mv_996 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)(body_len - 1); slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_996.has_value) {
                                                __auto_type ret_type = _mv_996.value;
...
slop_option_string defn_get_result_type_name(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (((i < len) && ({ __auto_type _mv = result; _mv.has_value ? ({ __auto_type _ = _mv.value; 0; }) : (1); }))) {
            __auto_type _mv_998 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                ...
                __auto_type lst = _mv_999.data.lst;
                {
                    ...
                    if ((((int64_t)((items).len)) < 2)) {
                        ...
                        if (_mv_1000.has_value) {
                            __auto_type spec_body = _mv_1000.value;
                            __auto_type _mv_1001 = (*spec_body);
                            switch (_mv_1001.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type body_lst = _mv_1001.data.lst;
                                    {
                                        __auto_type body_items = body_lst.items;
                                        __auto_type body_len = ((int64_t)((body_items).len));
                                        if ((body_len < 1)) {
                                            ...
                                            __auto_type _mv_1002 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)(body_len - 1); slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_1002.has_value) {
                                                __auto_type ret_type = _mv_1002.value;
    ...
    SLOP_PRE(((type_expr != NULL)), "(!= type-expr nil)");
    {
        ...
        switch (_mv_1003.tag) {
            case types_SExpr_sym:
            {
                ...
                {
                    __auto_type type_name = sym.name;
                    __auto_type _mv_1004 = context_ctx_lookup_result_type_alias(ctx, type_name);
                    if (_mv_1004.has_value) {
                        __auto_type alias_result = _mv_1004.value;
                        return (slop_option_string){.has_value = 1, .value = alias_result};
                    } else if (!_mv_1004.has_value) {
                        __auto_type _mv_1005 = context_ctx_lookup_type(ctx, type_name);
                        if (_mv_1005.has_value) {
                            __auto_type entry = _mv_1005.value;
                                ...
                                case types_SExpr_sym:
                                {
                                    ...
                                    if (string_eq(sym.name, SLOP_STR("Result"))) {
                                        ...
                                        if (_mv_1008.has_value) {
                                            __auto_type ok_type_expr = _mv_1008.value;
                                            ...
                                            if (_mv_1009.has_value) {
                                                __auto_type err_type_expr = _mv_1009.value;
                                                {
                ...
                __auto_type lst = _mv_1012.data.lst;
                {
                    ...
                    if ((len < 2)) {
                    ...
                    } else {
                        {
                            ...
                            __auto_type _mv_1013 = ({ __auto_type _lst = items; size_t _idx = (size_t)name_idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_1013.has_value) {
                                ...
                                switch (_mv_1014.tag) {
                                    case types_SExpr_sym:
                                    {
                                        ...
                                        __auto_type _mv_1015 = ({ __auto_type _lst = items; size_t _idx = (size_t)type_idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
uint8_t defn_is_param_mode(slop_list_types_SExpr_ptr items) {
    if ((((int64_t)((items).len)) < 1)) {
        ...
        __auto_type _mv_1016 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        if (_mv_1016.has_value) {
            __auto_type first = _mv_1016.value;
            __auto_type _mv_1017 = (*first);
            switch (_mv_1017.tag) {
                case types_SExpr_sym:
                {
            ...
            __auto_type lst = _mv_1018.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    if (_mv_1019.has_value) {
                        __auto_type first = _mv_1019.value;
                        __auto_type _mv_1020 = (*first);
                        switch (_mv_1020.tag) {
                            case types_SExpr_sym:
                            {
...
slop_string defn_emit_fn_param_type(context_TranspileContext* ctx, types_SExpr* type_expr, slop_string param_name) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1021 = (*type_expr);
        switch (_mv_1021.tag) {
            case types_SExpr_lst:
            {
                    ...
                    } else {
                        {
                            ...
                            if ((len == 2)) {
                                ...
                                if (_mv_1022.has_value) {
                                    __auto_type args_expr = _mv_1022.value;
                                    {
...
slop_string defn_build_fn_args_str_for_param(context_TranspileContext* ctx, types_SExpr* args_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1023 = (*args_expr);
        switch (_mv_1023.tag) {
            case types_SExpr_lst:
            {
                __auto_type args_list = _mv_1023.data.lst;
                {
                    ...
                    if ((arg_count == 0)) {
                    ...
                    } else {
                        {
                            ...
                            __auto_type i = 0;
                            while ((i < arg_count)) {
                                __auto_type _mv_1024 = ({ __auto_type _lst = arg_items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1024.has_value) {
                                    __auto_type arg_expr = _mv_1024.value;
                                    {
...
uint8_t defn_is_c_name_attr_at(slop_list_types_SExpr_ptr items, int64_t idx) {
    __auto_type _mv_1028 = ({ __auto_type _lst = items; size_t _idx = (size_t)idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1036.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    __auto_type _mv_1037 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                ...
                __auto_type lst = _mv_1049.data.lst;
                {
                    ...
                    if ((((int64_t)((items).len)) >= 2)) {
                        ...
                        if (_mv_1050.has_value) {
                            __auto_type val = _mv_1050.value;
                            __auto_type _mv_1051 = (*val);
                            switch (_mv_1051.tag) {
                                case types_SExpr_str:
                                {
                                    __auto_type str = _mv_1051.data.str;
                ...
                __auto_type lst = _mv_1053.data.lst;
                {
                    ...
                    if ((((int64_t)((items).len)) >= 2)) {
                        ...
                        if (_mv_1054.has_value) {
                            __auto_type val = _mv_1054.value;
        ...
        while ((i < len)) {
            ...
            if (_mv_1055.has_value) {
                ...
                if (defn_is_pre_form(item)) {
                    __auto_type _mv_1056 = defn_get_annotation_condition(item);
                    if (_mv_1056.has_value) {
                        __auto_type cond = _mv_1056.value;
        ...
        while ((i < len)) {
            ...
            if (_mv_1057.has_value) {
                ...
                if (defn_is_post_form(item)) {
                    __auto_type _mv_1058 = defn_get_annotation_condition(item);
                    if (_mv_1058.has_value) {
                        __auto_type cond = _mv_1058.value;
                        ({ __auto_type _lst_p = &(result); __auto_type _item = (cond); if (_lst_p->len >= _lst_p->cap) { size_t _new_cap = _lst_p->cap == 0 ? 16 : _lst_p->cap * 2; __typeof__(_lst_p->data) _new_data = (__typeof__(_lst_p->data))slop_arena_alloc(arena, _new_cap * sizeof(*_lst_p->data)); if (_lst_p->len > 0) memcpy(_new_data, _lst_p->data, _lst_p->len * sizeof(*_lst_p->data)); _lst_p->data = _new_data; _lst_p->cap = _new_cap; } _lst_p->data[_lst_p->len++] = _item; (void)0; });
        ...
        while ((i < len)) {
            ...
            if (_mv_1059.has_value) {
                ...
                if (defn_is_assume_form(item)) {
                    __auto_type _mv_1060 = defn_get_annotation_condition(item);
                    if (_mv_1060.has_value) {
                        __auto_type cond = _mv_1060.value;
                        ({ __auto_type _lst_p = &(result); __auto_type _item = (cond); if (_lst_p->len >= _lst_p->cap) { size_t _new_cap = _lst_p->cap == 0 ? 16 : _lst_p->cap * 2; __typeof__(_lst_p->data) _new_data = (__typeof__(_lst_p->data))slop_arena_alloc(arena, _new_cap * sizeof(*_lst_p->data)); if (_lst_p->len > 0) memcpy(_new_data, _lst_p->data, _lst_p->len * sizeof(*_lst_p->data)); _lst_p->data = _new_data; _lst_p->cap = _new_cap; } _lst_p->data[_lst_p->len++] = _item; (void)0; });
...
uint8_t defn_has_postconditions(slop_list_types_SExpr_ptr items) {
    {
        ...
        uint8_t found = 0;
        while (((i < len) && !(found))) {
            __auto_type _mv_1061 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void defn_emit_preconditions(context_TranspileContext* ctx, slop_list_types_SExpr_ptr preconditions) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1062 = ({ __auto_type _lst = preconditions; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1062.has_value) {
                __auto_type cond_expr = _mv_1062.value;
                {
...
void defn_emit_postconditions(context_TranspileContext* ctx, slop_list_types_SExpr_ptr postconditions) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1063 = ({ __auto_type _lst = postconditions; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1063.has_value) {
                __auto_type cond_expr = _mv_1063.value;
...
void defn_emit_assumptions(context_TranspileContext* ctx, slop_list_types_SExpr_ptr assumptions) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1064 = ({ __auto_type _lst = assumptions; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1064.has_value) {
                __auto_type cond_expr = _mv_1064.value;
                if (!(defn_is_verification_only_expr(cond_expr))) {
                    {
                        __auto_type cond_c = expr_transpile_expr(ctx, cond_expr);
                        __auto_type expr_str = parser_pretty_print(arena, cond_expr);
