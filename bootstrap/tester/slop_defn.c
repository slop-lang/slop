                    ...
                    case types_SExpr_lst:
                    {
                        __auto_type lst = _mv_940.data.lst;
                        {
                            ...
                            if (((int64_t)((sub_items).len)) > 0) {
                                __auto_type _mv_941 = ({ __auto_type _lst = sub_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_946.data.lst;
                {
                    ...
                    if (len < 4) {
                        ...
                        __auto_type _mv_947 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            ...
                            switch (_mv_948.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_948.data.sym;
                                    {
                                        ...
                                        __auto_type _mv_949 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_949.has_value) {
                                            __auto_type type_expr = _mv_949.value;
                                            {
                                                ...
                                                __auto_type _mv_950 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_950.has_value) {
                                                    __auto_type value_expr = _mv_950.value;
        ...
        if (ctype_is_int_type(type_name)) {
        ...
        } else {
            {
                ...
                if (string_eq(type_name, SLOP_STR("String"))) {
                    __auto_type _mv_951 = (*value_expr);
                    switch (_mv_951.tag) {
                        case types_SExpr_str:
                        {
                            __auto_type str = _mv_951.data.str;
...
slop_string defn_eval_const_value(context_TranspileContext* ctx, types_SExpr* expr) {
    ...
    SLOP_PRE(((expr != NULL)), "(!= expr nil)");
    {
        ...
        switch (_mv_953.tag) {
            ...
            {
                __auto_type num = _mv_953.data.num;
                return num.raw;
            }
            case types_SExpr_str:
            {
                __auto_type str = _mv_953.data.str;
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_954.data.lst;
                {
                    ...
                    __auto_type len = ((int64_t)((items).len));
                    {
                        ...
                        if (len >= (name_idx + 1)) {
                            __auto_type _mv_955 = ({ __auto_type _lst = items; size_t _idx = (size_t)name_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
uint8_t defn_is_string_expr(slop_list_types_SExpr_ptr items, int64_t idx) {
    __auto_type _mv_957 = ({ __auto_type _lst = items; size_t _idx = (size_t)idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    if (_mv_957.has_value) {
        ...
        switch (_mv_958.tag) {
            case types_SExpr_str:
            {
                __auto_type _ = _mv_958.data.str;
                return 1;
            }
            default: {
                return 0;
                            ...
                            switch (_mv_961.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_961.data.sym;
                                    {
                                        ...
                                        __auto_type _mv_962 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_962.has_value) {
                                            __auto_type type_def = _mv_962.value;
...
void defn_dispatch_type_def(context_TranspileContext* ctx, slop_string raw_name, slop_string qualified_name, types_SExpr* type_def) {
    ...
    __auto_type _mv_963 = (*type_def);
    switch (_mv_963.tag) {
        case types_SExpr_lst:
        {
            __auto_type def_lst = _mv_963.data.lst;
            {
...
uint8_t defn_has_payload_variants(slop_list_types_SExpr_ptr items) {
    {
        ...
        while ((i < len) && !(found)) {
            ...
            if (_mv_966.has_value) {
                __auto_type item = _mv_966.value;
                __auto_type _mv_967 = (*item);
                switch (_mv_967.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type _ = _mv_967.data.lst;
                        found = 1;
                        break;
                    }
                    default: {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_969.has_value) {
                __auto_type field_expr = _mv_969.value;
...
void defn_emit_record_field(context_TranspileContext* ctx, slop_string raw_type_name, slop_string qualified_type_name, types_SExpr* field) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_970 = (*field);
        switch (_mv_970.tag) {
            case types_SExpr_lst:
            {
                __auto_type field_lst = _mv_970.data.lst;
                {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_975.has_value) {
                __auto_type val_expr = _mv_975.value;
                __auto_type _mv_976 = (*val_expr);
                switch (_mv_976.tag) {
                    case types_SExpr_sym:
                    {
        ...
        while (i < len) {
            ...
            if (_mv_978.has_value) {
                ...
                switch (_mv_979.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type var_lst = _mv_979.data.lst;
                        {
                            __auto_type var_items = var_lst.items;
                            __auto_type var_len = ((int64_t)((var_items).len));
                            if (var_len >= 1) {
                                __auto_type _mv_980 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_980.has_value) {
                                    __auto_type tag_expr = _mv_980.value;
                                    __auto_type _mv_981 = (*tag_expr);
                                    switch (_mv_981.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type tag_sym = _mv_981.data.sym;
                                            {
                                                __auto_type tag_name = tag_sym.name;
                                                __auto_type c_tag = ctype_to_c_name(arena, tag_name);
                                                if (var_len == 2) {
                                                    __auto_type _mv_982 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    ...
                                                    for (int64_t fi = 1; fi < var_len; fi++) {
                                                        __auto_type _mv_983 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)fi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    ...
                                    switch (_mv_991.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type tag_sym = _mv_991.data.sym;
                                            {
                                                __auto_type tag_name = tag_sym.name;
                                                if (var_len == 2) {
                                                    __auto_type _mv_992 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    ...
                                                    for (int64_t fi = 1; fi < var_len; fi++) {
                                                        __auto_type _mv_993 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)fi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                ...
                __auto_type lst = _mv_998.data.lst;
                {
                    ...
                    if (len < 3) {
                        ...
                        if (_mv_999.has_value) {
                            __auto_type elem_type_expr = _mv_999.value;
                            ...
                            if (_mv_1000.has_value) {
                                __auto_type size_expr = _mv_1000.value;
                                {
                    ...
                    while (i < len) {
                        ...
                        if (_mv_1006.has_value) {
                            ...
                            switch (_mv_1007.tag) {
                                case types_SExpr_num:
                                {
                                    __auto_type num = _mv_1007.data.num;
                                    if (!(found_dots)) {
                                ...
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_1010.data.sym;
                                    {
                                        ...
                                        if (_mv_1011.has_value) {
                                            __auto_type params_expr = _mv_1011.value;
                    ...
                    if (len >= 2) {
                        {
                            ...
                            __auto_type _mv_1017 = ({ __auto_type _lst = items; size_t _idx = (size_t)name_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_list_context_FuncParamType_ptr defn_collect_param_types(context_TranspileContext* ctx, types_SExpr* params_expr) {
    ...
    SLOP_PRE(((params_expr != NULL)), "(!= params-expr nil)");
    {
        ...
        __auto_type _mv_1023 = (*params_expr);
        switch (_mv_1023.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1023.data.lst;
                {
                    ...
                    while (i < len) {
                        ...
                        if (_mv_1024.has_value) {
                            __auto_type param = _mv_1024.value;
                            {
                ...
                __auto_type lst = _mv_1025.data.lst;
                {
                    ...
                    if (len < 2) {
                    ...
                    } else {
                        {
                            __auto_type has_mode = ((len >= 3) && defn_is_param_mode(items));
                            __auto_type type_idx = ((has_mode) ? 2 : 1);
                            __auto_type _mv_1026 = ({ __auto_type _lst = items; size_t _idx = (size_t)type_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                ...
                __auto_type lst = _mv_1027.data.lst;
                {
                    ...
                    if (len >= 3) {
                        ...
                        if (_mv_1028.has_value) {
                            __auto_type name_expr = _mv_1028.value;
                            __auto_type _mv_1029 = (*name_expr);
                            switch (_mv_1029.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_1029.data.sym;
                                    {
                                        __auto_type raw_name = name_sym.name;
                                        __auto_type base_name = ctype_to_c_name(arena, raw_name);
                                        ...
                                        __auto_type _mv_1030 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_1030.has_value) {
                                            __auto_type params_expr = _mv_1030.value;
                                            {
                                                __auto_type result_type_opt = defn_get_result_type_name(ctx, items);
                                                __auto_type raw_return = defn_get_return_type(ctx, items);
                                                {
...
slop_option_string defn_extract_result_type_name(context_TranspileContext* ctx, types_SExpr* spec_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1045 = (*spec_expr);
        switch (_mv_1045.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1045.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) < 2) {
                        ...
                        __auto_type _mv_1046 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_1046.has_value) {
                            __auto_type spec_body = _mv_1046.value;
                            __auto_type _mv_1047 = (*spec_body);
                            switch (_mv_1047.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type body_lst = _mv_1047.data.lst;
                                    {
                                        __auto_type body_items = body_lst.items;
                                        __auto_type body_len = ((int64_t)((body_items).len));
                                        if (body_len < 1) {
                                            ...
                                            __auto_type _mv_1048 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)(body_len - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_1048.has_value) {
                                                __auto_type ret_type = _mv_1048.value;
    ...
    SLOP_PRE(((type_expr != NULL)), "(!= type-expr nil)");
    {
        ...
        switch (_mv_1049.tag) {
            case types_SExpr_sym:
            {
                ...
                {
                    __auto_type type_name = sym.name;
                    __auto_type _mv_1050 = context_ctx_lookup_result_type_alias(ctx, type_name);
                    if (_mv_1050.has_value) {
                        __auto_type alias_result = _mv_1050.value;
                        return (slop_option_string){.has_value = 1, .value = alias_result};
                    } else if (!_mv_1050.has_value) {
                        __auto_type _mv_1051 = context_ctx_lookup_type(ctx, type_name);
                        if (_mv_1051.has_value) {
                            __auto_type entry = _mv_1051.value;
                                ...
                                case types_SExpr_sym:
                                {
                                    ...
                                    if (string_eq(sym.name, SLOP_STR("Result"))) {
                                        ...
                                        if (_mv_1054.has_value) {
                                            __auto_type ok_type_expr = _mv_1054.value;
                                            ...
                                            if (_mv_1055.has_value) {
                                                __auto_type err_type_expr = _mv_1055.value;
                                                {
                ...
                __auto_type lst = _mv_1058.data.lst;
                {
                    ...
                    if (len < 2) {
                    ...
                    } else {
                        {
                            ...
                            __auto_type _mv_1059 = ({ __auto_type _lst = items; size_t _idx = (size_t)name_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            ...
            __auto_type lst = _mv_1064.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 1) {
                    ...
                    if (_mv_1065.has_value) {
                        __auto_type first = _mv_1065.value;
                        __auto_type _mv_1066 = (*first);
                        switch (_mv_1066.tag) {
                            case types_SExpr_sym:
                            {
                    ...
                    } else {
                        {
                            ...
                            if (len == 2) {
                                ...
                                if (_mv_1068.has_value) {
                                    __auto_type args_expr = _mv_1068.value;
                                    {
...
slop_string defn_build_fn_args_str_for_param(context_TranspileContext* ctx, types_SExpr* args_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1069 = (*args_expr);
        switch (_mv_1069.tag) {
            case types_SExpr_lst:
            {
                __auto_type args_list = _mv_1069.data.lst;
                {
                    ...
                    if (arg_count == 0) {
                    ...
                    } else {
                        {
                            ...
                            __auto_type i = 0;
                            while (i < arg_count) {
                                __auto_type _mv_1070 = ({ __auto_type _lst = arg_items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1070.has_value) {
                                    __auto_type arg_expr = _mv_1070.value;
                                    {
...
uint8_t defn_is_c_name_attr_at(slop_list_types_SExpr_ptr items, int64_t idx) {
    __auto_type _mv_1074 = ({ __auto_type _lst = items; size_t _idx = (size_t)idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                ...
                __auto_type lst = _mv_1095.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) >= 2) {
                        ...
                        if (_mv_1096.has_value) {
                            ...
                            __auto_type _mv_1097 = (*val);
                            switch (_mv_1097.tag) {
                                case types_SExpr_str:
                                {
                                    __auto_type str = _mv_1097.data.str;
...
void defn_emit_preconditions(context_TranspileContext* ctx, slop_list_types_SExpr_ptr preconditions) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1108 = ({ __auto_type _lst = preconditions; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void defn_emit_postconditions(context_TranspileContext* ctx, slop_list_types_SExpr_ptr postconditions) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1109 = ({ __auto_type _lst = postconditions; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void defn_emit_assumptions(context_TranspileContext* ctx, slop_list_types_SExpr_ptr assumptions) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1110 = ({ __auto_type _lst = assumptions; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
