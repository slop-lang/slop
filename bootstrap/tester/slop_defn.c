...
uint8_t defn_has_generic_annotation(slop_list_types_SExpr_ptr items) {
    {
        ...
        __auto_type found = 0;
        while ((i < len) && !(found)) {
            __auto_type _mv_944 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    ...
                    case types_SExpr_lst:
                    {
                        __auto_type lst = _mv_945.data.lst;
                        {
                            ...
                            if (((int64_t)((sub_items).len)) > 0) {
                                __auto_type _mv_946 = ({ __auto_type _lst = sub_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                ...
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_953.data.sym;
                                    {
                                        ...
                                        if (_mv_954.has_value) {
                                            __auto_type type_expr = _mv_954.value;
                                            {
        ...
        if (ctype_is_int_type(type_name)) {
        ...
        } else {
            {
                ...
                if (string_eq(type_name, SLOP_STR("String"))) {
                    __auto_type _mv_956 = (*value_expr);
                    switch (_mv_956.tag) {
                        case types_SExpr_str:
                        {
                            __auto_type str = _mv_956.data.str;
...
slop_string defn_eval_const_value(context_TranspileContext* ctx, types_SExpr* expr) {
    ...
    SLOP_PRE(((expr != NULL)), "(!= expr nil)");
    {
        ...
        switch (_mv_958.tag) {
            ...
            {
                __auto_type num = _mv_958.data.num;
                return num.raw;
            }
            case types_SExpr_str:
            {
                __auto_type str = _mv_958.data.str;
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_959.data.lst;
                {
                    ...
                    __auto_type len = ((int64_t)((items).len));
                    {
                        ...
                        if (len >= (name_idx + 1)) {
                            __auto_type _mv_960 = ({ __auto_type _lst = items; size_t _idx = (size_t)name_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
uint8_t defn_is_string_expr(slop_list_types_SExpr_ptr items, int64_t idx) {
    __auto_type _mv_962 = ({ __auto_type _lst = items; size_t _idx = (size_t)idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    if (_mv_962.has_value) {
        ...
        switch (_mv_963.tag) {
            case types_SExpr_str:
            {
                __auto_type _ = _mv_963.data.str;
                return 1;
            }
            default: {
                return 0;
                                ...
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_966.data.sym;
                                    {
                                        ...
                                        if (_mv_967.has_value) {
                                            __auto_type type_def = _mv_967.value;
...
uint8_t defn_has_payload_variants(slop_list_types_SExpr_ptr items) {
    {
        ...
        while ((i < len) && !(found)) {
            ...
            if (_mv_971.has_value) {
                ...
                __auto_type _mv_972 = (*item);
                switch (_mv_972.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type _ = _mv_972.data.lst;
                        found = 1;
                        break;
                    }
                    default: {
...
void defn_emit_record_field(context_TranspileContext* ctx, slop_string raw_type_name, slop_string qualified_type_name, types_SExpr* field) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_975 = (*field);
        switch (_mv_975.tag) {
            case types_SExpr_lst:
            {
                __auto_type field_lst = _mv_975.data.lst;
                {
                    ...
                    if (len < 2) {
                        ...
                        if (_mv_976.has_value) {
                            ...
                            switch (_mv_977.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_977.data.sym;
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_980.has_value) {
                __auto_type val_expr = _mv_980.value;
                __auto_type _mv_981 = (*val_expr);
                switch (_mv_981.tag) {
                    case types_SExpr_sym:
                    {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_993.has_value) {
                __auto_type variant_expr = _mv_993.value;
                __auto_type _mv_994 = (*variant_expr);
                switch (_mv_994.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type var_lst = _mv_994.data.lst;
                        {
                            __auto_type var_items = var_lst.items;
                            __auto_type var_len = ((int64_t)((var_items).len));
                            if (var_len >= 2) {
                                __auto_type _mv_995 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_995.has_value) {
                                    __auto_type tag_expr = _mv_995.value;
                                    __auto_type _mv_996 = (*tag_expr);
                                    switch (_mv_996.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type tag_sym = _mv_996.data.sym;
                                            {
                                                __auto_type tag_name = tag_sym.name;
                                                if (var_len == 2) {
                                                    __auto_type _mv_997 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    ...
                                                    for (int64_t fi = 1; fi < var_len; fi++) {
                                                        __auto_type _mv_998 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)fi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                ...
                __auto_type lst = _mv_1003.data.lst;
                {
                    ...
                    if (len < 3) {
                        ...
                        if (_mv_1004.has_value) {
                            __auto_type elem_type_expr = _mv_1004.value;
                            ...
                            if (_mv_1005.has_value) {
                                __auto_type size_expr = _mv_1005.value;
                                {
                    ...
                    while (i < len) {
                        ...
                        if (_mv_1011.has_value) {
                            ...
                            switch (_mv_1012.tag) {
                                case types_SExpr_num:
                                {
                                    __auto_type num = _mv_1012.data.num;
                                    if (!(found_dots)) {
                                ...
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_1015.data.sym;
                                    {
                                        ...
                                        if (_mv_1016.has_value) {
                                            __auto_type params_expr = _mv_1016.value;
                            ...
                            if (_mv_1022.has_value) {
                                ...
                                switch (_mv_1023.tag) {
                                    case types_SExpr_sym:
                                    {
                                        ...
                                        __auto_type _mv_1024 = ({ __auto_type _lst = items; size_t _idx = (size_t)type_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_list_context_FuncParamType_ptr defn_collect_param_types(context_TranspileContext* ctx, types_SExpr* params_expr) {
    ...
    SLOP_PRE(((params_expr != NULL)), "(!= params-expr nil)");
    {
        ...
        __auto_type _mv_1028 = (*params_expr);
        switch (_mv_1028.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1028.data.lst;
                {
                    ...
                    while (i < len) {
                        ...
                        if (_mv_1029.has_value) {
                            __auto_type param = _mv_1029.value;
                            {
...
slop_option_string defn_extract_result_type_name(context_TranspileContext* ctx, types_SExpr* spec_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1050 = (*spec_expr);
        switch (_mv_1050.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1050.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) < 2) {
                        ...
                        if (_mv_1051.has_value) {
                            __auto_type spec_body = _mv_1051.value;
                            __auto_type _mv_1052 = (*spec_body);
                            switch (_mv_1052.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type body_lst = _mv_1052.data.lst;
                                    {
                                        __auto_type body_items = body_lst.items;
                                        __auto_type body_len = ((int64_t)((body_items).len));
                                        if (body_len < 1) {
                                            ...
                                            __auto_type _mv_1053 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)(body_len - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_1053.has_value) {
                                                __auto_type ret_type = _mv_1053.value;
    ...
    SLOP_PRE(((type_expr != NULL)), "(!= type-expr nil)");
    {
        ...
        switch (_mv_1054.tag) {
            case types_SExpr_sym:
            {
                ...
                {
                    __auto_type type_name = sym.name;
                    __auto_type _mv_1055 = context_ctx_lookup_result_type_alias(ctx, type_name);
                    if (_mv_1055.has_value) {
                        __auto_type alias_result = _mv_1055.value;
                        return (slop_option_string){.has_value = 1, .value = alias_result};
                    } else if (!_mv_1055.has_value) {
                        __auto_type _mv_1056 = context_ctx_lookup_type(ctx, type_name);
                        if (_mv_1056.has_value) {
                            __auto_type entry = _mv_1056.value;
                                ...
                                case types_SExpr_sym:
                                {
                                    ...
                                    if (string_eq(sym.name, SLOP_STR("Result"))) {
                                        ...
                                        if (_mv_1059.has_value) {
                                            __auto_type ok_type_expr = _mv_1059.value;
                                            ...
                                            if (_mv_1060.has_value) {
                                                __auto_type err_type_expr = _mv_1060.value;
                                                {
...
slop_string defn_build_param_str(context_TranspileContext* ctx, types_SExpr* params_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1061 = (*params_expr);
        switch (_mv_1061.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1061.data.lst;
                {
                    ...
                    while (i < len) {
                        ...
                        if (_mv_1062.has_value) {
                            __auto_type param = _mv_1062.value;
                            {
                ...
                __auto_type lst = _mv_1063.data.lst;
                {
                    ...
                    if (len < 2) {
                    ...
                    } else {
                        {
                            ...
                            __auto_type _mv_1064 = ({ __auto_type _lst = items; size_t _idx = (size_t)name_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_1064.has_value) {
                                ...
                                switch (_mv_1065.tag) {
                                    case types_SExpr_sym:
                                    {
                                        __auto_type name_sym = _mv_1065.data.sym;
...
uint8_t defn_is_param_mode(slop_list_types_SExpr_ptr items) {
    if (((int64_t)((items).len)) < 1) {
        ...
        if (_mv_1067.has_value) {
            __auto_type first = _mv_1067.value;
            __auto_type _mv_1068 = (*first);
            switch (_mv_1068.tag) {
                case types_SExpr_sym:
                {
            ...
            __auto_type lst = _mv_1069.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 1) {
                    ...
                    if (_mv_1070.has_value) {
                        __auto_type first = _mv_1070.value;
                        __auto_type _mv_1071 = (*first);
                        switch (_mv_1071.tag) {
                            case types_SExpr_sym:
                            {
                    ...
                    } else {
                        {
                            ...
                            if (len == 2) {
                                ...
                                if (_mv_1073.has_value) {
                                    __auto_type args_expr = _mv_1073.value;
                                    {
...
slop_string defn_build_fn_args_str_for_param(context_TranspileContext* ctx, types_SExpr* args_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1074 = (*args_expr);
        switch (_mv_1074.tag) {
            case types_SExpr_lst:
            {
                __auto_type args_list = _mv_1074.data.lst;
                {
                    ...
                    if (arg_count == 0) {
                    ...
                    } else {
                        {
                            ...
                            __auto_type i = 0;
                            while (i < arg_count) {
                                __auto_type _mv_1075 = ({ __auto_type _lst = arg_items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1075.has_value) {
                                    __auto_type arg_expr = _mv_1075.value;
                                    {
...
uint8_t defn_is_c_name_attr_at(slop_list_types_SExpr_ptr items, int64_t idx) {
    __auto_type _mv_1079 = ({ __auto_type _lst = items; size_t _idx = (size_t)idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                ...
                __auto_type lst = _mv_1100.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) >= 2) {
                        ...
                        if (_mv_1101.has_value) {
                            ...
                            __auto_type _mv_1102 = (*val);
                            switch (_mv_1102.tag) {
                                case types_SExpr_str:
                                {
                                    __auto_type str = _mv_1102.data.str;
                ...
                __auto_type lst = _mv_1104.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) >= 2) {
                        ...
                        if (_mv_1105.has_value) {
                            __auto_type val = _mv_1105.value;
        ...
        while (i < len) {
            ...
            if (_mv_1108.has_value) {
                ...
                if (defn_is_post_form(item)) {
                    __auto_type _mv_1109 = defn_get_annotation_condition(item);
                    if (_mv_1109.has_value) {
                        __auto_type cond = _mv_1109.value;
                        ({ __auto_type _lst_p = &(result); __auto_type _item = (cond); if (_lst_p->len >= _lst_p->cap) { size_t _new_cap = _lst_p->cap == 0 ? 16 : _lst_p->cap * 2; __typeof__(_lst_p->data) _new_data = (__typeof__(_lst_p->data))slop_arena_alloc(arena, _new_cap * sizeof(*_lst_p->data)); if (_lst_p->len > 0) memcpy(_new_data, _lst_p->data, _lst_p->len * sizeof(*_lst_p->data)); _lst_p->data = _new_data; _lst_p->cap = _new_cap; } _lst_p->data[_lst_p->len++] = _item; (void)0; });
        ...
        while (i < len) {
            ...
            if (_mv_1110.has_value) {
                ...
                if (defn_is_assume_form(item)) {
                    __auto_type _mv_1111 = defn_get_annotation_condition(item);
                    if (_mv_1111.has_value) {
                        __auto_type cond = _mv_1111.value;
                        ({ __auto_type _lst_p = &(result); __auto_type _item = (cond); if (_lst_p->len >= _lst_p->cap) { size_t _new_cap = _lst_p->cap == 0 ? 16 : _lst_p->cap * 2; __typeof__(_lst_p->data) _new_data = (__typeof__(_lst_p->data))slop_arena_alloc(arena, _new_cap * sizeof(*_lst_p->data)); if (_lst_p->len > 0) memcpy(_new_data, _lst_p->data, _lst_p->len * sizeof(*_lst_p->data)); _lst_p->data = _new_data; _lst_p->cap = _new_cap; } _lst_p->data[_lst_p->len++] = _item; (void)0; });
...
void defn_emit_preconditions(context_TranspileContext* ctx, slop_list_types_SExpr_ptr preconditions) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1113 = ({ __auto_type _lst = preconditions; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void defn_emit_postconditions(context_TranspileContext* ctx, slop_list_types_SExpr_ptr postconditions) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1114 = ({ __auto_type _lst = postconditions; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void defn_emit_assumptions(context_TranspileContext* ctx, slop_list_types_SExpr_ptr assumptions) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1115 = ({ __auto_type _lst = assumptions; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1115.has_value) {
                __auto_type cond_expr = _mv_1115.value;
                if (!(defn_is_verification_only_expr(cond_expr))) {
                    {
                        __auto_type cond_c = expr_transpile_expr(ctx, cond_expr);
                        __auto_type expr_str = parser_pretty_print(arena, cond_expr);
