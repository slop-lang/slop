                    ...
                    case types_SExpr_lst:
                    {
                        __auto_type lst = _mv_963.data.lst;
                        {
                            ...
                            if (((int64_t)((sub_items).len)) > 0) {
                                __auto_type _mv_964 = ({ __auto_type _lst = sub_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            ...
                            switch (_mv_971.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_971.data.sym;
                                    {
                                        ...
                                        __auto_type _mv_972 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_972.has_value) {
                                            __auto_type type_expr = _mv_972.value;
                                            {
                                                ...
                                                __auto_type _mv_973 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_973.has_value) {
                                                    __auto_type value_expr = _mv_973.value;
        ...
        if (ctype_is_int_type(type_name)) {
        ...
        } else {
            {
                ...
                if (string_eq(type_name, SLOP_STR("String"))) {
                    __auto_type _mv_974 = (*value_expr);
                    switch (_mv_974.tag) {
...
slop_string defn_eval_const_value(context_TranspileContext* ctx, types_SExpr* expr) {
    ...
    SLOP_PRE(((expr != NULL)), "(!= expr nil)");
    {
        ...
        switch (_mv_976.tag) {
            ...
            {
                __auto_type num = _mv_976.data.num;
                return num.raw;
            }
            case types_SExpr_str:
            {
                __auto_type str = _mv_976.data.str;
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_977.data.lst;
                {
                    ...
                    __auto_type len = ((int64_t)((items).len));
                    {
                        ...
                        if (len >= (name_idx + 1)) {
                            __auto_type _mv_978 = ({ __auto_type _lst = items; size_t _idx = (size_t)name_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
uint8_t defn_is_string_expr(slop_list_types_SExpr_ptr items, int64_t idx) {
    __auto_type _mv_980 = ({ __auto_type _lst = items; size_t _idx = (size_t)idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    if (_mv_980.has_value) {
        ...
        switch (_mv_981.tag) {
            case types_SExpr_str:
            {
                __auto_type _ = _mv_981.data.str;
                return 1;
            }
            default: {
                return 0;
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_982.data.lst;
                {
                    ...
                    if (len < 3) {
                        ...
                        __auto_type _mv_983 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            ...
                            switch (_mv_984.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_984.data.sym;
                                    {
                                        ...
                                        __auto_type _mv_985 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_985.has_value) {
                                            __auto_type type_def = _mv_985.value;
...
void defn_dispatch_type_def(context_TranspileContext* ctx, slop_string raw_name, slop_string qualified_name, types_SExpr* type_def) {
    ...
    __auto_type _mv_986 = (*type_def);
    switch (_mv_986.tag) {
        case types_SExpr_lst:
        {
            __auto_type def_lst = _mv_986.data.lst;
            {
...
uint8_t defn_has_payload_variants(slop_list_types_SExpr_ptr items) {
    {
        ...
        uint8_t found = 0;
        while ((i < len) && !(found)) {
            __auto_type _mv_989 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_989.has_value) {
                __auto_type item = _mv_989.value;
                __auto_type _mv_990 = (*item);
                switch (_mv_990.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type _ = _mv_990.data.lst;
                        found = 1;
                        break;
                    }
                    default: {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_992.has_value) {
                __auto_type field_expr = _mv_992.value;
...
void defn_emit_record_field(context_TranspileContext* ctx, slop_string raw_type_name, slop_string qualified_type_name, types_SExpr* field) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_993 = (*field);
        switch (_mv_993.tag) {
            case types_SExpr_lst:
            {
                __auto_type field_lst = _mv_993.data.lst;
                {
                    ...
                    if (len < 2) {
                        ...
                        __auto_type _mv_994 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_998.has_value) {
                __auto_type val_expr = _mv_998.value;
                __auto_type _mv_999 = (*val_expr);
                switch (_mv_999.tag) {
                    case types_SExpr_sym:
                    {
                                    ...
                                    switch (_mv_1004.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type tag_sym = _mv_1004.data.sym;
                                            {
                                                ...
                                                if (var_len == 2) {
                                                    __auto_type _mv_1005 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    ...
                                                    for (int64_t fi = 1; fi < var_len; fi++) {
                                                        __auto_type _mv_1006 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)fi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_1007.has_value) {
                __auto_type variant_expr = _mv_1007.value;
                __auto_type _mv_1008 = (*variant_expr);
                switch (_mv_1008.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type var_lst = _mv_1008.data.lst;
                        {
                            __auto_type var_items = var_lst.items;
                            if (((int64_t)((var_items).len)) >= 1) {
                                __auto_type _mv_1009 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1009.has_value) {
                                    __auto_type tag_expr = _mv_1009.value;
                                    __auto_type _mv_1010 = (*tag_expr);
                                    switch (_mv_1010.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type tag_sym = _mv_1010.data.sym;
                                            {
                                                __auto_type tag_name = tag_sym.name;
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_1011.has_value) {
                __auto_type variant_expr = _mv_1011.value;
                __auto_type _mv_1012 = (*variant_expr);
                switch (_mv_1012.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type var_lst = _mv_1012.data.lst;
                        {
                            __auto_type var_items = var_lst.items;
                            __auto_type var_len = ((int64_t)((var_items).len));
                            if (var_len >= 2) {
                                __auto_type _mv_1013 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1013.has_value) {
                                    __auto_type tag_expr = _mv_1013.value;
                                    __auto_type _mv_1014 = (*tag_expr);
                                    switch (_mv_1014.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type tag_sym = _mv_1014.data.sym;
                                            {
                                                __auto_type tag_name = tag_sym.name;
                                                if (var_len == 2) {
                                                    ...
                                                    for (int64_t fi = 1; fi < var_len; fi++) {
                                                        __auto_type _mv_1016 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)fi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    ...
                                                    __auto_type _mv_1017 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                ...
                __auto_type lst = _mv_1021.data.lst;
                {
                    ...
                    if (len < 3) {
                        ...
                        if (_mv_1022.has_value) {
                            __auto_type elem_type_expr = _mv_1022.value;
                            __auto_type _mv_1023 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_1023.has_value) {
                                __auto_type size_expr = _mv_1023.value;
                                {
                    ...
                    while (i < len) {
                        ...
                        if (_mv_1029.has_value) {
                            ...
                            switch (_mv_1030.tag) {
                                case types_SExpr_num:
                                {
                                    __auto_type num = _mv_1030.data.num;
                                    if (!(found_dots)) {
    ...
    SLOP_PRE(((params_expr != NULL)), "(!= params-expr nil)");
    {
        ...
        __auto_type doc_string = defn_collect_doc_string(arena, items);
        {
            ...
            context_ctx_emit(ctx, SLOP_STR(""));
            {
                ...
                context_ctx_register_func(ctx, (context_FuncEntry){raw_name, fn_name, actual_return, slop_ret_type, strlib_ends_with(actual_return, SLOP_STR("*")), string_eq(actual_return, SLOP_STR("slop_string")), param_types, 0, empty_type_params, no_source});
            }
            context_ctx_clear_current_result_type(ctx);
                    ...
                    if (len >= 2) {
                        {
                            ...
                            __auto_type _mv_1040 = ({ __auto_type _lst = items; size_t _idx = (size_t)name_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_1040.has_value) {
                                __auto_type name_expr = _mv_1040.value;
                                __auto_type _mv_1041 = (*name_expr);
                                switch (_mv_1041.tag) {
                                    case types_SExpr_sym:
                                    {
                                        __auto_type name_sym = _mv_1041.data.sym;
                                        __auto_type _mv_1042 = ({ __auto_type _lst = items; size_t _idx = (size_t)type_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_list_context_FuncParamType_ptr defn_collect_param_types(context_TranspileContext* ctx, types_SExpr* params_expr) {
    ...
    SLOP_PRE(((params_expr != NULL)), "(!= params-expr nil)");
    {
        ...
        __auto_type _mv_1046 = (*params_expr);
        switch (_mv_1046.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1046.data.lst;
                {
                    ...
                    while (i < len) {
                        ...
                        if (_mv_1047.has_value) {
                            __auto_type param = _mv_1047.value;
                            {
                ...
                __auto_type lst = _mv_1048.data.lst;
                {
                    ...
                    if (len < 2) {
                    ...
                    } else {
                        {
                            __auto_type has_mode = ((len >= 3) && defn_is_param_mode(items));
                            __auto_type type_idx = ((has_mode) ? 2 : 1);
                            __auto_type _mv_1049 = ({ __auto_type _lst = items; size_t _idx = (size_t)type_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            ...
                            switch (_mv_1052.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_1052.data.sym;
                                    {
                                        ...
                                        __auto_type _mv_1053 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1058.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) < 2) {
                        ...
                        __auto_type _mv_1059 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                ...
                                case types_SExpr_lst:
                                {
                                    __auto_type body_lst = _mv_1060.data.lst;
                                    {
                                        ...
                                        if (body_len < 1) {
                                            ...
                                            __auto_type _mv_1061 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)(body_len - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_option_string defn_extract_result_type_name(context_TranspileContext* ctx, types_SExpr* spec_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1068 = (*spec_expr);
        switch (_mv_1068.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1068.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) < 2) {
                        ...
                        if (_mv_1069.has_value) {
                            __auto_type spec_body = _mv_1069.value;
                            __auto_type _mv_1070 = (*spec_body);
                            switch (_mv_1070.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type body_lst = _mv_1070.data.lst;
                                    {
                                        __auto_type body_items = body_lst.items;
                                        __auto_type body_len = ((int64_t)((body_items).len));
                                        if (body_len < 1) {
                                            ...
                                            __auto_type _mv_1071 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)(body_len - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_1071.has_value) {
                                                __auto_type ret_type = _mv_1071.value;
    ...
    SLOP_PRE(((type_expr != NULL)), "(!= type-expr nil)");
    {
        ...
        switch (_mv_1072.tag) {
            case types_SExpr_sym:
            {
                ...
                {
                    __auto_type type_name = sym.name;
                    __auto_type _mv_1073 = context_ctx_lookup_result_type_alias(ctx, type_name);
                    if (_mv_1073.has_value) {
                        __auto_type alias_result = _mv_1073.value;
                        return (slop_option_string){.has_value = 1, .value = alias_result};
                    } else if (!_mv_1073.has_value) {
                        __auto_type _mv_1074 = context_ctx_lookup_type(ctx, type_name);
                        if (_mv_1074.has_value) {
                            __auto_type entry = _mv_1074.value;
                                ...
                                case types_SExpr_sym:
                                {
                                    ...
                                    if (string_eq(sym.name, SLOP_STR("Result"))) {
                                        ...
                                        if (_mv_1077.has_value) {
                                            __auto_type ok_type_expr = _mv_1077.value;
                                            ...
                                            if (_mv_1078.has_value) {
                                                __auto_type err_type_expr = _mv_1078.value;
                                                {
...
uint8_t defn_is_param_mode(slop_list_types_SExpr_ptr items) {
    if (((int64_t)((items).len)) < 1) {
        ...
        if (_mv_1085.has_value) {
            __auto_type first = _mv_1085.value;
            __auto_type _mv_1086 = (*first);
            switch (_mv_1086.tag) {
                case types_SExpr_sym:
                {
                    ...
                    } else {
                        {
                            ...
                            if (len == 2) {
                                ...
                                if (_mv_1091.has_value) {
                                    __auto_type args_expr = _mv_1091.value;
                                    {
...
slop_string defn_build_fn_args_str_for_param(context_TranspileContext* ctx, types_SExpr* args_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1092 = (*args_expr);
        switch (_mv_1092.tag) {
            case types_SExpr_lst:
            {
                __auto_type args_list = _mv_1092.data.lst;
                {
                    ...
                    if (arg_count == 0) {
                    ...
                    } else {
                        {
                            ...
                            __auto_type i = 0;
                            while (i < arg_count) {
                                __auto_type _mv_1093 = ({ __auto_type _lst = arg_items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1093.has_value) {
                                    __auto_type arg_expr = _mv_1093.value;
                                    {
...
uint8_t defn_is_c_name_attr_at(slop_list_types_SExpr_ptr items, int64_t idx) {
    __auto_type _mv_1097 = ({ __auto_type _lst = items; size_t _idx = (size_t)idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                ...
                __auto_type lst = _mv_1118.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) >= 2) {
                        ...
                        if (_mv_1119.has_value) {
                            __auto_type val = _mv_1119.value;
                            __auto_type _mv_1120 = (*val);
                            switch (_mv_1120.tag) {
                                case types_SExpr_str:
                                {
                                    __auto_type str = _mv_1120.data.str;
                ...
                __auto_type lst = _mv_1122.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) >= 2) {
                        ...
                        if (_mv_1123.has_value) {
                            __auto_type val = _mv_1123.value;
        ...
        while (i < len) {
            ...
            if (_mv_1128.has_value) {
                ...
                if (defn_is_assume_form(item)) {
                    __auto_type _mv_1129 = defn_get_annotation_condition(item);
                    if (_mv_1129.has_value) {
                        __auto_type cond = _mv_1129.value;
                        ({ __auto_type _lst_p = &(result); __auto_type _item = (cond); if (_lst_p->len >= _lst_p->cap) { size_t _new_cap = _lst_p->cap == 0 ? 16 : _lst_p->cap * 2; __typeof__(_lst_p->data) _new_data = (__typeof__(_lst_p->data))slop_arena_alloc(arena, _new_cap * sizeof(*_lst_p->data)); if (_lst_p->len > 0) memcpy(_new_data, _lst_p->data, _lst_p->len * sizeof(*_lst_p->data)); _lst_p->data = _new_data; _lst_p->cap = _new_cap; } _lst_p->data[_lst_p->len++] = _item; (void)0; });
...
void defn_emit_preconditions(context_TranspileContext* ctx, slop_list_types_SExpr_ptr preconditions) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1131 = ({ __auto_type _lst = preconditions; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void defn_emit_postconditions(context_TranspileContext* ctx, slop_list_types_SExpr_ptr postconditions) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1132 = ({ __auto_type _lst = postconditions; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void defn_emit_assumptions(context_TranspileContext* ctx, slop_list_types_SExpr_ptr assumptions) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1133 = ({ __auto_type _lst = assumptions; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
