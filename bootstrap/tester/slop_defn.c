                    ...
                    case types_SExpr_lst:
                    {
                        __auto_type lst = _mv_952.data.lst;
                        {
                            ...
                            if (((int64_t)((sub_items).len)) > 0) {
                                __auto_type _mv_953 = ({ __auto_type _lst = sub_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_955.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 1) {
                    ...
                    __auto_type _mv_956 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_956.has_value) {
                        __auto_type head = _mv_956.value;
                        __auto_type _mv_957 = (*head);
                        switch (_mv_957.tag) {
                            case types_SExpr_sym:
                            {
                                ...
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_960.data.sym;
                                    {
                                        ...
                                        if (_mv_961.has_value) {
                                            __auto_type type_expr = _mv_961.value;
                                            {
                                                ...
                                                __auto_type _mv_962 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_962.has_value) {
                                                    __auto_type value_expr = _mv_962.value;
        ...
        if (ctype_is_int_type(type_name)) {
        ...
        } else {
            {
                ...
                if (string_eq(type_name, SLOP_STR("String"))) {
                    __auto_type _mv_963 = (*value_expr);
                    switch (_mv_963.tag) {
                        case types_SExpr_str:
                        {
                            __auto_type str = _mv_963.data.str;
...
slop_string defn_eval_const_value(context_TranspileContext* ctx, types_SExpr* expr) {
    ...
    SLOP_PRE(((expr != NULL)), "(!= expr nil)");
    {
        ...
        switch (_mv_965.tag) {
            ...
            {
                __auto_type num = _mv_965.data.num;
                return num.raw;
            }
            case types_SExpr_str:
            {
                __auto_type str = _mv_965.data.str;
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_966.data.lst;
                {
                    ...
                    __auto_type len = ((int64_t)((items).len));
                    {
                        ...
                        if (len >= (name_idx + 1)) {
                            __auto_type _mv_967 = ({ __auto_type _lst = items; size_t _idx = (size_t)name_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
uint8_t defn_is_string_expr(slop_list_types_SExpr_ptr items, int64_t idx) {
    __auto_type _mv_969 = ({ __auto_type _lst = items; size_t _idx = (size_t)idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    if (_mv_969.has_value) {
        __auto_type item = _mv_969.value;
        __auto_type _mv_970 = (*item);
        switch (_mv_970.tag) {
            case types_SExpr_str:
            {
                __auto_type _ = _mv_970.data.str;
                return 1;
            }
            default: {
                return 0;
                                ...
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_973.data.sym;
                                    {
                                        ...
                                        if (_mv_974.has_value) {
                                            __auto_type type_def = _mv_974.value;
...
void defn_dispatch_type_def(context_TranspileContext* ctx, slop_string raw_name, slop_string qualified_name, types_SExpr* type_def) {
    ...
    __auto_type _mv_975 = (*type_def);
    switch (_mv_975.tag) {
        case types_SExpr_lst:
        {
            __auto_type def_lst = _mv_975.data.lst;
            {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_981.has_value) {
                __auto_type field_expr = _mv_981.value;
...
void defn_emit_record_field(context_TranspileContext* ctx, slop_string raw_type_name, slop_string qualified_type_name, types_SExpr* field) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_982 = (*field);
        switch (_mv_982.tag) {
            case types_SExpr_lst:
            {
                __auto_type field_lst = _mv_982.data.lst;
                {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_987.has_value) {
                __auto_type val_expr = _mv_987.value;
                __auto_type _mv_988 = (*val_expr);
                switch (_mv_988.tag) {
                    case types_SExpr_sym:
                    {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_990.has_value) {
                __auto_type variant_expr = _mv_990.value;
                __auto_type _mv_991 = (*variant_expr);
                switch (_mv_991.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type var_lst = _mv_991.data.lst;
                        {
                            __auto_type var_items = var_lst.items;
                            __auto_type var_len = ((int64_t)((var_items).len));
                            if (var_len >= 1) {
                                __auto_type _mv_992 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_992.has_value) {
                                    __auto_type tag_expr = _mv_992.value;
                                    __auto_type _mv_993 = (*tag_expr);
                                    switch (_mv_993.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type tag_sym = _mv_993.data.sym;
                                            {
                                                __auto_type tag_name = tag_sym.name;
                                                __auto_type c_tag = ctype_to_c_name(arena, tag_name);
                                                if (var_len == 2) {
                                                    __auto_type _mv_994 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    ...
                                                    for (int64_t fi = 1; fi < var_len; fi++) {
                                                        __auto_type _mv_995 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)fi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_996.has_value) {
                __auto_type variant_expr = _mv_996.value;
                __auto_type _mv_997 = (*variant_expr);
                switch (_mv_997.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type var_lst = _mv_997.data.lst;
                        {
                            __auto_type var_items = var_lst.items;
                            if (((int64_t)((var_items).len)) >= 1) {
                                __auto_type _mv_998 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_998.has_value) {
                                    __auto_type tag_expr = _mv_998.value;
                                    __auto_type _mv_999 = (*tag_expr);
                                    switch (_mv_999.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type tag_sym = _mv_999.data.sym;
                                            {
                                                __auto_type tag_name = tag_sym.name;
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_1000.has_value) {
                __auto_type variant_expr = _mv_1000.value;
                __auto_type _mv_1001 = (*variant_expr);
                switch (_mv_1001.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type var_lst = _mv_1001.data.lst;
                        {
                            __auto_type var_items = var_lst.items;
                            __auto_type var_len = ((int64_t)((var_items).len));
                            if (var_len >= 2) {
                                __auto_type _mv_1002 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1002.has_value) {
                                    __auto_type tag_expr = _mv_1002.value;
                                    __auto_type _mv_1003 = (*tag_expr);
                                    switch (_mv_1003.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type tag_sym = _mv_1003.data.sym;
                                            {
                                                __auto_type tag_name = tag_sym.name;
                                                if (var_len == 2) {
                                                    __auto_type _mv_1004 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    ...
                                                    for (int64_t fi = 1; fi < var_len; fi++) {
                                                        __auto_type _mv_1005 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)fi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                ...
                __auto_type lst = _mv_1010.data.lst;
                {
                    ...
                    if (len < 3) {
                        ...
                        if (_mv_1011.has_value) {
                            __auto_type elem_type_expr = _mv_1011.value;
                            ...
                            if (_mv_1012.has_value) {
                                __auto_type size_expr = _mv_1012.value;
                                {
...
slop_string defn_get_number_as_string(types_SExpr* expr) {
    ...
    switch (_mv_1013.tag) {
        case types_SExpr_num:
        {
            __auto_type num = _mv_1013.data.num;
            return num.raw;
        }
        default: {
            return SLOP_STR("0");
                ...
                __auto_type lst = _mv_1017.data.lst;
                {
                    ...
                    while (i < len) {
                        ...
                        if (_mv_1018.has_value) {
                            ...
                            __auto_type _mv_1019 = (*item);
                            switch (_mv_1019.tag) {
                                case types_SExpr_num:
                                {
                                    __auto_type num = _mv_1019.data.num;
                                    if (!(found_dots)) {
                                ...
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_1022.data.sym;
                                    {
                                        ...
                                        if (_mv_1023.has_value) {
                                            __auto_type params_expr = _mv_1023.value;
...
void defn_bind_params_to_scope(context_TranspileContext* ctx, types_SExpr* params_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1026 = (*params_expr);
        switch (_mv_1026.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1026.data.lst;
                {
                    ...
                    while (i < len) {
                        ...
                        if (_mv_1027.has_value) {
                            __auto_type param = _mv_1027.value;
                    ...
                    if (len >= 2) {
                        {
                            ...
                            __auto_type _mv_1029 = ({ __auto_type _lst = items; size_t _idx = (size_t)name_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_1029.has_value) {
                                ...
                                switch (_mv_1030.tag) {
                                    case types_SExpr_sym:
                                    {
                                        ...
                                        __auto_type _mv_1031 = ({ __auto_type _lst = items; size_t _idx = (size_t)type_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
uint8_t defn_is_pointer_type(types_SExpr* type_expr) {
    SLOP_PRE(((type_expr != NULL)), "(!= type-expr nil)");
    __auto_type _mv_1032 = (*type_expr);
    switch (_mv_1032.tag) {
        case types_SExpr_lst:
        {
                ...
                __auto_type lst = _mv_1037.data.lst;
                {
                    ...
                    if (len < 2) {
                    ...
                    } else {
                        {
                            __auto_type has_mode = ((len >= 3) && defn_is_param_mode(items));
                            __auto_type type_idx = ((has_mode) ? 2 : 1);
                            __auto_type _mv_1038 = ({ __auto_type _lst = items; size_t _idx = (size_t)type_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            ...
                            switch (_mv_1041.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_1041.data.sym;
                                    {
                                        ...
                                        __auto_type _mv_1042 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_string defn_extract_spec_return_type(context_TranspileContext* ctx, types_SExpr* spec_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1047 = (*spec_expr);
        switch (_mv_1047.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1047.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) < 2) {
                        ...
                        if (_mv_1048.has_value) {
                            __auto_type spec_body = _mv_1048.value;
                            __auto_type _mv_1049 = (*spec_body);
                            switch (_mv_1049.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type body_lst = _mv_1049.data.lst;
                                    {
                                        ...
                                        if (body_len < 1) {
                                            ...
                                            __auto_type _mv_1050 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)(body_len - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_1050.has_value) {
                                                __auto_type ret_type = _mv_1050.value;
...
slop_string defn_extract_spec_slop_return_type(context_TranspileContext* ctx, types_SExpr* spec_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1051 = (*spec_expr);
        switch (_mv_1051.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1051.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) < 2) {
                        ...
                        if (_mv_1052.has_value) {
                            __auto_type spec_body = _mv_1052.value;
                            __auto_type _mv_1053 = (*spec_body);
                            switch (_mv_1053.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type body_lst = _mv_1053.data.lst;
                                    {
                                        __auto_type body_items = body_lst.items;
                                        __auto_type body_len = ((int64_t)((body_items).len));
                                        if (body_len < 1) {
                                            ...
                                            __auto_type _mv_1054 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)(body_len - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_1054.has_value) {
                                                __auto_type ret_type = _mv_1054.value;
...
slop_option_string defn_extract_result_type_name(context_TranspileContext* ctx, types_SExpr* spec_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1057 = (*spec_expr);
        switch (_mv_1057.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1057.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) < 2) {
                        ...
                        if (_mv_1058.has_value) {
                            __auto_type spec_body = _mv_1058.value;
                            __auto_type _mv_1059 = (*spec_body);
                            switch (_mv_1059.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type body_lst = _mv_1059.data.lst;
                                    {
                                        __auto_type body_items = body_lst.items;
                                        __auto_type body_len = ((int64_t)((body_items).len));
                                        if (body_len < 1) {
                                            ...
                                            __auto_type _mv_1060 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)(body_len - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_1060.has_value) {
                                                __auto_type ret_type = _mv_1060.value;
    ...
    SLOP_PRE(((type_expr != NULL)), "(!= type-expr nil)");
    {
        ...
        switch (_mv_1061.tag) {
            case types_SExpr_sym:
            {
                ...
                {
                    __auto_type type_name = sym.name;
                    __auto_type _mv_1062 = context_ctx_lookup_result_type_alias(ctx, type_name);
                    if (_mv_1062.has_value) {
                        __auto_type alias_result = _mv_1062.value;
                        return (slop_option_string){.has_value = 1, .value = alias_result};
                    } else if (!_mv_1062.has_value) {
                        __auto_type _mv_1063 = context_ctx_lookup_type(ctx, type_name);
                        if (_mv_1063.has_value) {
                            __auto_type entry = _mv_1063.value;
                                ...
                                case types_SExpr_sym:
                                {
                                    ...
                                    if (string_eq(sym.name, SLOP_STR("Result"))) {
                                        ...
                                        if (_mv_1066.has_value) {
                                            __auto_type ok_type_expr = _mv_1066.value;
                                            ...
                                            if (_mv_1067.has_value) {
                                                __auto_type err_type_expr = _mv_1067.value;
                                                {
                ...
                __auto_type lst = _mv_1070.data.lst;
                {
                    ...
                    if (len < 2) {
                    ...
                    } else {
                        {
                            ...
                            __auto_type _mv_1071 = ({ __auto_type _lst = items; size_t _idx = (size_t)name_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_1071.has_value) {
                                __auto_type name_expr = _mv_1071.value;
                                __auto_type _mv_1072 = (*name_expr);
                                switch (_mv_1072.tag) {
                                    case types_SExpr_sym:
                                    {
                                        __auto_type name_sym = _mv_1072.data.sym;
                                        __auto_type _mv_1073 = ({ __auto_type _lst = items; size_t _idx = (size_t)type_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_1073.has_value) {
                                            __auto_type type_expr = _mv_1073.value;
                                            {
...
uint8_t defn_is_param_mode(slop_list_types_SExpr_ptr items) {
    if (((int64_t)((items).len)) < 1) {
        ...
        if (_mv_1074.has_value) {
            __auto_type first = _mv_1074.value;
            __auto_type _mv_1075 = (*first);
            switch (_mv_1075.tag) {
                case types_SExpr_sym:
                {
            ...
            __auto_type lst = _mv_1076.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 1) {
                    ...
                    if (_mv_1077.has_value) {
                        __auto_type first = _mv_1077.value;
                        __auto_type _mv_1078 = (*first);
                        switch (_mv_1078.tag) {
                            case types_SExpr_sym:
                            {
...
slop_string defn_emit_fn_param_type(context_TranspileContext* ctx, types_SExpr* type_expr, slop_string param_name) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1079 = (*type_expr);
        switch (_mv_1079.tag) {
            case types_SExpr_lst:
            {
                    ...
                    } else {
                        {
                            ...
                            if (len == 2) {
                                ...
                                if (_mv_1080.has_value) {
                                    __auto_type args_expr = _mv_1080.value;
                                    {
...
slop_string defn_build_fn_args_str_for_param(context_TranspileContext* ctx, types_SExpr* args_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1081 = (*args_expr);
        switch (_mv_1081.tag) {
            case types_SExpr_lst:
            {
                __auto_type args_list = _mv_1081.data.lst;
                {
                    ...
                    if (arg_count == 0) {
                    ...
                    } else {
                        {
                            ...
                            __auto_type i = 0;
                            while (i < arg_count) {
                                __auto_type _mv_1082 = ({ __auto_type _lst = arg_items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1082.has_value) {
                                    __auto_type arg_expr = _mv_1082.value;
                                    {
...
uint8_t defn_is_c_name_attr_at(slop_list_types_SExpr_ptr items, int64_t idx) {
    __auto_type _mv_1086 = ({ __auto_type _lst = items; size_t _idx = (size_t)idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                ...
                __auto_type lst = _mv_1107.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) >= 2) {
                        ...
                        if (_mv_1108.has_value) {
                            __auto_type val = _mv_1108.value;
                            __auto_type _mv_1109 = (*val);
                            switch (_mv_1109.tag) {
                                case types_SExpr_str:
                                {
                ...
                __auto_type lst = _mv_1111.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) >= 2) {
                        ...
                        if (_mv_1112.has_value) {
                            __auto_type val = _mv_1112.value;
        ...
        while (i < len) {
            ...
            if (_mv_1113.has_value) {
                ...
                if (defn_is_pre_form(item)) {
                    __auto_type _mv_1114 = defn_get_annotation_condition(item);
                    if (_mv_1114.has_value) {
                        __auto_type cond = _mv_1114.value;
        ...
        while (i < len) {
            ...
            if (_mv_1115.has_value) {
                ...
                if (defn_is_post_form(item)) {
                    __auto_type _mv_1116 = defn_get_annotation_condition(item);
                    if (_mv_1116.has_value) {
                        __auto_type cond = _mv_1116.value;
                        ({ __auto_type _lst_p = &(result); __auto_type _item = (cond); if (_lst_p->len >= _lst_p->cap) { size_t _new_cap = _lst_p->cap == 0 ? 16 : _lst_p->cap * 2; __typeof__(_lst_p->data) _new_data = (__typeof__(_lst_p->data))slop_arena_alloc(arena, _new_cap * sizeof(*_lst_p->data)); if (_lst_p->len > 0) memcpy(_new_data, _lst_p->data, _lst_p->len * sizeof(*_lst_p->data)); _lst_p->data = _new_data; _lst_p->cap = _new_cap; } _lst_p->data[_lst_p->len++] = _item; (void)0; });
        ...
        while (i < len) {
            ...
            if (_mv_1117.has_value) {
                ...
                if (defn_is_assume_form(item)) {
                    __auto_type _mv_1118 = defn_get_annotation_condition(item);
                    if (_mv_1118.has_value) {
                        __auto_type cond = _mv_1118.value;
                        ({ __auto_type _lst_p = &(result); __auto_type _item = (cond); if (_lst_p->len >= _lst_p->cap) { size_t _new_cap = _lst_p->cap == 0 ? 16 : _lst_p->cap * 2; __typeof__(_lst_p->data) _new_data = (__typeof__(_lst_p->data))slop_arena_alloc(arena, _new_cap * sizeof(*_lst_p->data)); if (_lst_p->len > 0) memcpy(_new_data, _lst_p->data, _lst_p->len * sizeof(*_lst_p->data)); _lst_p->data = _new_data; _lst_p->cap = _new_cap; } _lst_p->data[_lst_p->len++] = _item; (void)0; });
...
void defn_emit_preconditions(context_TranspileContext* ctx, slop_list_types_SExpr_ptr preconditions) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1120 = ({ __auto_type _lst = preconditions; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1120.has_value) {
                __auto_type cond_expr = _mv_1120.value;
                {
...
void defn_emit_postconditions(context_TranspileContext* ctx, slop_list_types_SExpr_ptr postconditions) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1121 = ({ __auto_type _lst = postconditions; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1121.has_value) {
                __auto_type cond_expr = _mv_1121.value;
...
void defn_emit_assumptions(context_TranspileContext* ctx, slop_list_types_SExpr_ptr assumptions) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1122 = ({ __auto_type _lst = assumptions; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1122.has_value) {
                __auto_type cond_expr = _mv_1122.value;
                if (!(defn_is_verification_only_expr(cond_expr))) {
                    {
                        __auto_type cond_c = expr_transpile_expr(ctx, cond_expr);
                        __auto_type expr_str = parser_pretty_print(arena, cond_expr);
