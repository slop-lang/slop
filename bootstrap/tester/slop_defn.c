        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_928.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 1) {
                    ...
                    __auto_type _mv_929 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_934.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 1) {
                    ...
                    __auto_type _mv_935 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_937.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 1) {
                    ...
                    __auto_type _mv_938 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
uint8_t defn_has_generic_annotation(slop_list_types_SExpr_ptr items) {
    {
        ...
        __auto_type found = 0;
        while ((i < len) && !(found)) {
            __auto_type _mv_943 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    ...
                    case types_SExpr_lst:
                    {
                        __auto_type lst = _mv_944.data.lst;
                        {
                            ...
                            if (((int64_t)((sub_items).len)) > 0) {
                                __auto_type _mv_945 = ({ __auto_type _lst = sub_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            ...
                            switch (_mv_952.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_952.data.sym;
                                    {
                                        ...
                                        __auto_type _mv_953 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_953.has_value) {
                                            __auto_type type_expr = _mv_953.value;
                                            {
                                                ...
                                                __auto_type _mv_954 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_954.has_value) {
                                                    __auto_type value_expr = _mv_954.value;
        ...
        if (ctype_is_int_type(type_name)) {
        ...
        } else {
            {
                ...
                if (string_eq(type_name, SLOP_STR("String"))) {
                    __auto_type _mv_955 = (*value_expr);
                    switch (_mv_955.tag) {
                        case types_SExpr_str:
                        {
                            __auto_type str = _mv_955.data.str;
...
slop_string defn_eval_const_value(context_TranspileContext* ctx, types_SExpr* expr) {
    ...
    SLOP_PRE(((expr != NULL)), "(!= expr nil)");
    {
        ...
        switch (_mv_957.tag) {
            ...
            {
                __auto_type num = _mv_957.data.num;
                return num.raw;
            }
            case types_SExpr_str:
            {
                __auto_type str = _mv_957.data.str;
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_958.data.lst;
                {
                    ...
                    __auto_type len = ((int64_t)((items).len));
                    {
                        ...
                        if (len >= (name_idx + 1)) {
                            __auto_type _mv_959 = ({ __auto_type _lst = items; size_t _idx = (size_t)name_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_959.has_value) {
                                __auto_type name_expr = _mv_959.value;
                                __auto_type _mv_960 = (*name_expr);
                                switch (_mv_960.tag) {
                                    case types_SExpr_sym:
                                    {
...
uint8_t defn_is_string_expr(slop_list_types_SExpr_ptr items, int64_t idx) {
    __auto_type _mv_961 = ({ __auto_type _lst = items; size_t _idx = (size_t)idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    if (_mv_961.has_value) {
        ...
        switch (_mv_962.tag) {
            case types_SExpr_str:
            {
                __auto_type _ = _mv_962.data.str;
                return 1;
            }
            default: {
                return 0;
                                ...
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_965.data.sym;
                                    {
                                        ...
                                        if (_mv_966.has_value) {
                                            __auto_type type_def = _mv_966.value;
...
void defn_dispatch_type_def(context_TranspileContext* ctx, slop_string raw_name, slop_string qualified_name, types_SExpr* type_def) {
    ...
    __auto_type _mv_967 = (*type_def);
    switch (_mv_967.tag) {
        case types_SExpr_lst:
        {
            __auto_type def_lst = _mv_967.data.lst;
            {
        ...
        while ((i < len) && !(found)) {
            ...
            if (_mv_970.has_value) {
                ...
                switch (_mv_971.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type _ = _mv_971.data.lst;
                        found = 1;
                        break;
                    }
                    default: {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_973.has_value) {
                __auto_type field_expr = _mv_973.value;
...
void defn_emit_record_field(context_TranspileContext* ctx, slop_string raw_type_name, slop_string qualified_type_name, types_SExpr* field) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_974 = (*field);
        switch (_mv_974.tag) {
            case types_SExpr_lst:
            {
                __auto_type field_lst = _mv_974.data.lst;
                {
                            ...
                            switch (_mv_976.tag) {
                                case types_SExpr_sym:
                                {
                                    ...
                                    if (_mv_977.has_value) {
                                        __auto_type type_expr = _mv_977.value;
                                        {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_979.has_value) {
                __auto_type val_expr = _mv_979.value;
                __auto_type _mv_980 = (*val_expr);
                switch (_mv_980.tag) {
                    case types_SExpr_sym:
                    {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_982.has_value) {
                __auto_type variant_expr = _mv_982.value;
                __auto_type _mv_983 = (*variant_expr);
                switch (_mv_983.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type var_lst = _mv_983.data.lst;
                        {
                            __auto_type var_items = var_lst.items;
                            __auto_type var_len = ((int64_t)((var_items).len));
                            if (var_len >= 1) {
                                __auto_type _mv_984 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_984.has_value) {
                                    __auto_type tag_expr = _mv_984.value;
                                    __auto_type _mv_985 = (*tag_expr);
                                    switch (_mv_985.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type tag_sym = _mv_985.data.sym;
                                            {
                                                __auto_type tag_name = tag_sym.name;
                                                __auto_type c_tag = ctype_to_c_name(arena, tag_name);
                                                if (var_len == 2) {
                                                    __auto_type _mv_986 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_986.has_value) {
                                                        __auto_type type_expr = _mv_986.value;
                                                        {
                                                            __auto_type c_type = context_to_c_type_prefixed(ctx, type_expr);
                                                            {
                                                    ...
                                                    for (int64_t fi = 1; fi < var_len; fi++) {
                                                        __auto_type _mv_987 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)fi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    ...
                    case types_SExpr_lst:
                    {
                        __auto_type var_lst = _mv_989.data.lst;
                        {
                            ...
                            if (((int64_t)((var_items).len)) >= 1) {
                                __auto_type _mv_990 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_992.has_value) {
                __auto_type variant_expr = _mv_992.value;
                __auto_type _mv_993 = (*variant_expr);
                switch (_mv_993.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type var_lst = _mv_993.data.lst;
                        {
                            __auto_type var_items = var_lst.items;
                            __auto_type var_len = ((int64_t)((var_items).len));
                            if (var_len >= 2) {
                                __auto_type _mv_994 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_994.has_value) {
                                    __auto_type tag_expr = _mv_994.value;
                                    __auto_type _mv_995 = (*tag_expr);
                                    switch (_mv_995.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type tag_sym = _mv_995.data.sym;
                                            {
                                                __auto_type tag_name = tag_sym.name;
                                                if (var_len == 2) {
                                                    __auto_type _mv_996 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_996.has_value) {
                                                        __auto_type type_expr = _mv_996.value;
                                                        {
                                                            __auto_type c_type = context_to_c_type_prefixed(ctx, type_expr);
                                                            __auto_type slop_type_str = parser_pretty_print(arena, type_expr);
                                                            __auto_type is_ptr = defn_is_pointer_type_expr(type_expr);
                                                    ...
                                                    for (int64_t fi = 1; fi < var_len; fi++) {
                                                        __auto_type _mv_997 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)fi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    ...
                                                    __auto_type _mv_998 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_998.has_value) {
                                                        __auto_type type_expr = _mv_998.value;
                                                        {
                                                            __auto_type c_type = context_to_c_type_prefixed(ctx, type_expr);
                                                            __auto_type slop_type_str = parser_pretty_print(arena, type_expr);
                                                            __auto_type is_ptr = defn_is_pointer_type_expr(type_expr);
                ...
                __auto_type lst = _mv_1002.data.lst;
                {
                    ...
                    if (len < 3) {
                        ...
                        if (_mv_1003.has_value) {
                            __auto_type elem_type_expr = _mv_1003.value;
                            __auto_type _mv_1004 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_1004.has_value) {
                                __auto_type size_expr = _mv_1004.value;
                                {
...
uint8_t defn_is_range_type(types_SExpr* type_expr) {
    SLOP_PRE(((type_expr != NULL)), "(!= type-expr nil)");
    __auto_type _mv_1006 = (*type_expr);
    switch (_mv_1006.tag) {
        case types_SExpr_lst:
        {
...
types_RangeBounds defn_parse_range_bounds(types_SExpr* type_expr) {
    SLOP_PRE(((type_expr != NULL)), "(!= type-expr nil)");
    {
        ...
        __auto_type _mv_1009 = (*type_expr);
        switch (_mv_1009.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1009.data.lst;
                {
                    ...
                    while (i < len) {
                        ...
                        if (_mv_1010.has_value) {
                            __auto_type item = _mv_1010.value;
                            __auto_type _mv_1011 = (*item);
                            switch (_mv_1011.tag) {
                                case types_SExpr_num:
                                {
                                    __auto_type num = _mv_1011.data.num;
                                    if (!(found_dots)) {
                            ...
                            switch (_mv_1014.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_1014.data.sym;
                                    {
                                        ...
                                        __auto_type _mv_1015 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_1015.has_value) {
                                            __auto_type params_expr = _mv_1015.value;
...
void defn_bind_params_to_scope(context_TranspileContext* ctx, types_SExpr* params_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1018 = (*params_expr);
        switch (_mv_1018.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1018.data.lst;
                {
                    ...
                    while (i < len) {
                        ...
                        if (_mv_1019.has_value) {
                            __auto_type param = _mv_1019.value;
                    ...
                    if (len >= 2) {
                        {
                            ...
                            __auto_type _mv_1021 = ({ __auto_type _lst = items; size_t _idx = (size_t)name_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
uint8_t defn_is_pointer_type(types_SExpr* type_expr) {
    SLOP_PRE(((type_expr != NULL)), "(!= type-expr nil)");
    __auto_type _mv_1024 = (*type_expr);
    switch (_mv_1024.tag) {
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1024.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 1) {
                    ...
                    __auto_type _mv_1025 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_1025.has_value) {
                        __auto_type head = _mv_1025.value;
                        __auto_type _mv_1026 = (*head);
                        switch (_mv_1026.tag) {
                            case types_SExpr_sym:
                            {
...
slop_list_context_FuncParamType_ptr defn_collect_param_types(context_TranspileContext* ctx, types_SExpr* params_expr) {
    ...
    SLOP_PRE(((params_expr != NULL)), "(!= params-expr nil)");
    {
        ...
        __auto_type _mv_1027 = (*params_expr);
        switch (_mv_1027.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1027.data.lst;
                {
                    ...
                    while (i < len) {
                        ...
                        if (_mv_1028.has_value) {
                            __auto_type param = _mv_1028.value;
                            {
                ...
                __auto_type lst = _mv_1029.data.lst;
                {
                    ...
                    if (len < 2) {
                    ...
                    } else {
                        {
                            __auto_type has_mode = ((len >= 3) && defn_is_param_mode(items));
                            __auto_type type_idx = ((has_mode) ? 2 : 1);
                            __auto_type _mv_1030 = ({ __auto_type _lst = items; size_t _idx = (size_t)type_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                ...
                __auto_type lst = _mv_1031.data.lst;
                {
                    ...
                    if (len >= 3) {
                        ...
                        if (_mv_1032.has_value) {
                            __auto_type name_expr = _mv_1032.value;
                            __auto_type _mv_1033 = (*name_expr);
                            switch (_mv_1033.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_1033.data.sym;
                                    {
                                        __auto_type raw_name = name_sym.name;
                                        __auto_type base_name = ctype_to_c_name(arena, raw_name);
                                        ...
                                        __auto_type _mv_1034 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_1034.has_value) {
                                            __auto_type params_expr = _mv_1034.value;
                                            {
                                                __auto_type result_type_opt = defn_get_result_type_name(ctx, items);
                                                __auto_type raw_return = defn_get_return_type(ctx, items);
                                                {
...
slop_string defn_get_return_type(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            __auto_type _mv_1035 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_string defn_extract_spec_return_type(context_TranspileContext* ctx, types_SExpr* spec_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1039 = (*spec_expr);
        switch (_mv_1039.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1039.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) < 2) {
                        ...
                        if (_mv_1040.has_value) {
                            __auto_type spec_body = _mv_1040.value;
                            __auto_type _mv_1041 = (*spec_body);
                            switch (_mv_1041.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type body_lst = _mv_1041.data.lst;
                                    {
                                        ...
                                        if (body_len < 1) {
                                            ...
                                            __auto_type _mv_1042 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)(body_len - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_1042.has_value) {
                                                __auto_type ret_type = _mv_1042.value;
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1043.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) < 2) {
                        ...
                        __auto_type _mv_1044 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                ...
                                case types_SExpr_lst:
                                {
                                    __auto_type body_lst = _mv_1045.data.lst;
                                    {
                                        ...
                                        if (body_len < 1) {
                                            ...
                                            __auto_type _mv_1046 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)(body_len - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_option_string defn_extract_result_type_name(context_TranspileContext* ctx, types_SExpr* spec_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1049 = (*spec_expr);
        switch (_mv_1049.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1049.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) < 2) {
                        ...
                        if (_mv_1050.has_value) {
                            __auto_type spec_body = _mv_1050.value;
                            __auto_type _mv_1051 = (*spec_body);
                            switch (_mv_1051.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type body_lst = _mv_1051.data.lst;
                                    {
                                        ...
                                        if (body_len < 1) {
                                            ...
                                            __auto_type _mv_1052 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)(body_len - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_1052.has_value) {
                                                __auto_type ret_type = _mv_1052.value;
    ...
    SLOP_PRE(((type_expr != NULL)), "(!= type-expr nil)");
    {
        ...
        switch (_mv_1053.tag) {
            case types_SExpr_sym:
            {
                ...
                {
                    __auto_type type_name = sym.name;
                    __auto_type _mv_1054 = context_ctx_lookup_result_type_alias(ctx, type_name);
                    if (_mv_1054.has_value) {
                        __auto_type alias_result = _mv_1054.value;
                        return (slop_option_string){.has_value = 1, .value = alias_result};
                    } else if (!_mv_1054.has_value) {
                        __auto_type _mv_1055 = context_ctx_lookup_type(ctx, type_name);
                        if (_mv_1055.has_value) {
                            __auto_type entry = _mv_1055.value;
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1053.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) < 3) {
                        ...
                        __auto_type _mv_1056 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            ...
                            switch (_mv_1057.tag) {
                                case types_SExpr_sym:
                                {
                                    ...
                                    if (string_eq(sym.name, SLOP_STR("Result"))) {
                                        __auto_type _mv_1058 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_1058.has_value) {
                                            __auto_type ok_type_expr = _mv_1058.value;
                                            ...
                                            if (_mv_1059.has_value) {
                                                __auto_type err_type_expr = _mv_1059.value;
                                                {
...
slop_string defn_build_param_str(context_TranspileContext* ctx, types_SExpr* params_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1060 = (*params_expr);
        switch (_mv_1060.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1060.data.lst;
                {
                    ...
                    while (i < len) {
                        ...
                        if (_mv_1061.has_value) {
                            __auto_type param = _mv_1061.value;
                            {
                ...
                __auto_type lst = _mv_1062.data.lst;
                {
                    ...
                    if (len < 2) {
                    ...
                    } else {
                        {
                            ...
                            __auto_type _mv_1063 = ({ __auto_type _lst = items; size_t _idx = (size_t)name_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_1063.has_value) {
                                ...
                                switch (_mv_1064.tag) {
                                    case types_SExpr_sym:
                                    {
                                        __auto_type name_sym = _mv_1064.data.sym;
                                        __auto_type _mv_1065 = ({ __auto_type _lst = items; size_t _idx = (size_t)type_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
uint8_t defn_is_param_mode(slop_list_types_SExpr_ptr items) {
    if (((int64_t)((items).len)) < 1) {
        ...
        if (_mv_1066.has_value) {
            __auto_type first = _mv_1066.value;
            __auto_type _mv_1067 = (*first);
            switch (_mv_1067.tag) {
                case types_SExpr_sym:
                {
            ...
            __auto_type lst = _mv_1068.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 1) {
                    ...
                    if (_mv_1069.has_value) {
                        __auto_type first = _mv_1069.value;
                        __auto_type _mv_1070 = (*first);
                        switch (_mv_1070.tag) {
                            case types_SExpr_sym:
                            {
...
slop_string defn_emit_fn_param_type(context_TranspileContext* ctx, types_SExpr* type_expr, slop_string param_name) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1071 = (*type_expr);
        switch (_mv_1071.tag) {
            case types_SExpr_lst:
            {
                    ...
                    if (len < 2) {
                    ...
                    } else {
                        {
                            ...
                            if (len == 2) {
                                ...
                                __auto_type _mv_1072 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1072.has_value) {
                                    __auto_type args_expr = _mv_1072.value;
                                    {
...
slop_string defn_build_fn_args_str_for_param(context_TranspileContext* ctx, types_SExpr* args_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1073 = (*args_expr);
        switch (_mv_1073.tag) {
            case types_SExpr_lst:
            {
                __auto_type args_list = _mv_1073.data.lst;
                {
                    ...
                    if (arg_count == 0) {
                    ...
                    } else {
                        {
                            ...
                            __auto_type i = 0;
                            while (i < arg_count) {
                                __auto_type _mv_1074 = ({ __auto_type _lst = arg_items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1074.has_value) {
                                    __auto_type arg_expr = _mv_1074.value;
                                    {
...
void defn_emit_function_body(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        i = body_start;
        while (i < len) {
            __auto_type _mv_1075 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
uint8_t defn_is_last_body_item(slop_list_types_SExpr_ptr items, int64_t current_i) {
    {
        ...
        while ((i < len) && !(found_body)) {
            __auto_type _mv_1077 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
uint8_t defn_is_c_name_attr_at(slop_list_types_SExpr_ptr items, int64_t idx) {
    __auto_type _mv_1078 = ({ __auto_type _lst = items; size_t _idx = (size_t)idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1083.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 1) {
                    ...
                    __auto_type _mv_1084 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1086.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 1) {
                    ...
                    __auto_type _mv_1087 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        switch (_mv_1099.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1099.data.lst;
                {
                    __auto_type items = lst.items;
                    if (((int64_t)((items).len)) >= 2) {
                        __auto_type _mv_1100 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_1100.has_value) {
                            __auto_type val = _mv_1100.value;
                            __auto_type _mv_1101 = (*val);
                            switch (_mv_1101.tag) {
                                case types_SExpr_str:
                                {
                                    __auto_type str = _mv_1101.data.str;
        ...
        switch (_mv_1103.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1103.data.lst;
                {
                    __auto_type items = lst.items;
                    if (((int64_t)((items).len)) >= 2) {
                        __auto_type _mv_1104 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_1104.has_value) {
                            __auto_type val = _mv_1104.value;
        ...
        while (i < len) {
            ...
            if (_mv_1105.has_value) {
                ...
                if (defn_is_pre_form(item)) {
                    __auto_type _mv_1106 = defn_get_annotation_condition(item);
                    if (_mv_1106.has_value) {
                        __auto_type cond = _mv_1106.value;
        ...
        while (i < len) {
            ...
            if (_mv_1107.has_value) {
                ...
                if (defn_is_post_form(item)) {
                    __auto_type _mv_1108 = defn_get_annotation_condition(item);
                    if (_mv_1108.has_value) {
                        __auto_type cond = _mv_1108.value;
                        ({ __auto_type _lst_p = &(result); __auto_type _item = (cond); if (_lst_p->len >= _lst_p->cap) { size_t _new_cap = _lst_p->cap == 0 ? 16 : _lst_p->cap * 2; __typeof__(_lst_p->data) _new_data = (__typeof__(_lst_p->data))slop_arena_alloc(arena, _new_cap * sizeof(*_lst_p->data)); if (_lst_p->len > 0) memcpy(_new_data, _lst_p->data, _lst_p->len * sizeof(*_lst_p->data)); _lst_p->data = _new_data; _lst_p->cap = _new_cap; } _lst_p->data[_lst_p->len++] = _item; (void)0; });
        ...
        while (i < len) {
            ...
            if (_mv_1109.has_value) {
                ...
                if (defn_is_assume_form(item)) {
                    __auto_type _mv_1110 = defn_get_annotation_condition(item);
                    if (_mv_1110.has_value) {
                        __auto_type cond = _mv_1110.value;
                        ({ __auto_type _lst_p = &(result); __auto_type _item = (cond); if (_lst_p->len >= _lst_p->cap) { size_t _new_cap = _lst_p->cap == 0 ? 16 : _lst_p->cap * 2; __typeof__(_lst_p->data) _new_data = (__typeof__(_lst_p->data))slop_arena_alloc(arena, _new_cap * sizeof(*_lst_p->data)); if (_lst_p->len > 0) memcpy(_new_data, _lst_p->data, _lst_p->len * sizeof(*_lst_p->data)); _lst_p->data = _new_data; _lst_p->cap = _new_cap; } _lst_p->data[_lst_p->len++] = _item; (void)0; });
...
void defn_emit_preconditions(context_TranspileContext* ctx, slop_list_types_SExpr_ptr preconditions) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1112 = ({ __auto_type _lst = preconditions; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1112.has_value) {
                __auto_type cond_expr = _mv_1112.value;
                {
...
void defn_emit_postconditions(context_TranspileContext* ctx, slop_list_types_SExpr_ptr postconditions) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1113 = ({ __auto_type _lst = postconditions; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1113.has_value) {
                __auto_type cond_expr = _mv_1113.value;
...
void defn_emit_assumptions(context_TranspileContext* ctx, slop_list_types_SExpr_ptr assumptions) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1114 = ({ __auto_type _lst = assumptions; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1114.has_value) {
                __auto_type cond_expr = _mv_1114.value;
                if (!(defn_is_verification_only_expr(cond_expr))) {
                    {
                        __auto_type cond_c = expr_transpile_expr(ctx, cond_expr);
                        __auto_type expr_str = parser_pretty_print(arena, cond_expr);
