...
uint8_t defn_has_generic_annotation(slop_list_types_SExpr_ptr items) {
    {
        ...
        while ((i < len) && !(found)) {
            ...
            if (_mv_934.has_value) {
                __auto_type item = _mv_934.value;
                __auto_type _mv_935 = (*item);
                switch (_mv_935.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type lst = _mv_935.data.lst;
                        {
                            ...
                            if (((int64_t)((sub_items).len)) > 0) {
                                __auto_type _mv_936 = ({ __auto_type _lst = sub_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_938.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 1) {
                    ...
                    __auto_type _mv_939 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    ...
                                    __auto_type name_sym = _mv_943.data.sym;
                                    {
                                        ...
                                        if (_mv_944.has_value) {
                                            __auto_type type_expr = _mv_944.value;
                                            {
                                                ...
                                                __auto_type _mv_945 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_945.has_value) {
                                                    __auto_type value_expr = _mv_945.value;
        ...
        if (ctype_is_int_type(type_name)) {
        ...
        } else {
            {
                ...
                if (string_eq(type_name, SLOP_STR("String"))) {
                    __auto_type _mv_946 = (*value_expr);
                    switch (_mv_946.tag) {
                        case types_SExpr_str:
                        {
                            __auto_type str = _mv_946.data.str;
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_949.data.lst;
                {
                    ...
                    __auto_type len = ((int64_t)((items).len));
                    {
                        ...
                        if (len >= (name_idx + 1)) {
                            __auto_type _mv_950 = ({ __auto_type _lst = items; size_t _idx = (size_t)name_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
uint8_t defn_is_string_expr(slop_list_types_SExpr_ptr items, int64_t idx) {
    __auto_type _mv_952 = ({ __auto_type _lst = items; size_t _idx = (size_t)idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    if (_mv_952.has_value) {
        ...
        switch (_mv_953.tag) {
            case types_SExpr_str:
            {
                __auto_type _ = _mv_953.data.str;
                return 1;
            }
            default: {
                return 0;
                                ...
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_956.data.sym;
                                    {
                                        ...
                                        if (_mv_957.has_value) {
                                            __auto_type type_def = _mv_957.value;
...
void defn_dispatch_type_def(context_TranspileContext* ctx, slop_string raw_name, slop_string qualified_name, types_SExpr* type_def) {
    ...
    __auto_type _mv_958 = (*type_def);
    switch (_mv_958.tag) {
        case types_SExpr_lst:
        {
            __auto_type def_lst = _mv_958.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 1) {
                    ...
                    __auto_type _mv_959 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        while ((i < len) && !(found)) {
            ...
            if (_mv_961.has_value) {
                ...
                switch (_mv_962.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type _ = _mv_962.data.lst;
                        found = 1;
                        break;
                    }
                    default: {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_964.has_value) {
                __auto_type field_expr = _mv_964.value;
...
void defn_emit_record_field(context_TranspileContext* ctx, slop_string raw_type_name, slop_string qualified_type_name, types_SExpr* field) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_965 = (*field);
        switch (_mv_965.tag) {
            case types_SExpr_lst:
            {
                __auto_type field_lst = _mv_965.data.lst;
                {
                            ...
                            switch (_mv_967.tag) {
                                case types_SExpr_sym:
                                {
                                    ...
                                    if (_mv_968.has_value) {
                                        __auto_type type_expr = _mv_968.value;
                                        {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_970.has_value) {
                __auto_type val_expr = _mv_970.value;
                __auto_type _mv_971 = (*val_expr);
                switch (_mv_971.tag) {
                    case types_SExpr_sym:
                    {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_973.has_value) {
                __auto_type variant_expr = _mv_973.value;
                __auto_type _mv_974 = (*variant_expr);
                switch (_mv_974.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type var_lst = _mv_974.data.lst;
                        {
                            __auto_type var_items = var_lst.items;
                            __auto_type var_len = ((int64_t)((var_items).len));
                            if (var_len >= 1) {
                                __auto_type _mv_975 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_975.has_value) {
                                    __auto_type tag_expr = _mv_975.value;
                                    __auto_type _mv_976 = (*tag_expr);
                                    switch (_mv_976.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type tag_sym = _mv_976.data.sym;
                                            {
                                                __auto_type tag_name = tag_sym.name;
                                                __auto_type c_tag = ctype_to_c_name(arena, tag_name);
                                                if (var_len == 2) {
                                                    __auto_type _mv_977 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    ...
                                                    for (int64_t fi = 1; fi < var_len; fi++) {
                                                        __auto_type _mv_978 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)fi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    ...
                    case types_SExpr_lst:
                    {
                        __auto_type var_lst = _mv_980.data.lst;
                        {
                            ...
                            if (((int64_t)((var_items).len)) >= 1) {
                                __auto_type _mv_981 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_983.has_value) {
                __auto_type variant_expr = _mv_983.value;
                __auto_type _mv_984 = (*variant_expr);
                switch (_mv_984.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type var_lst = _mv_984.data.lst;
                        {
                            __auto_type var_items = var_lst.items;
                            __auto_type var_len = ((int64_t)((var_items).len));
                            if (var_len >= 2) {
                                __auto_type _mv_985 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_985.has_value) {
                                    __auto_type tag_expr = _mv_985.value;
                                    __auto_type _mv_986 = (*tag_expr);
                                    switch (_mv_986.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type tag_sym = _mv_986.data.sym;
                                            {
                                                __auto_type tag_name = tag_sym.name;
                                                if (var_len == 2) {
                                                    __auto_type _mv_987 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    ...
                                                    for (int64_t fi = 1; fi < var_len; fi++) {
                                                        __auto_type _mv_988 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)fi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_990.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 1) {
                    ...
                    __auto_type _mv_991 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_991.has_value) {
                        __auto_type head = _mv_991.value;
                        __auto_type _mv_992 = (*head);
                        switch (_mv_992.tag) {
                            case types_SExpr_sym:
                            {
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_993.data.lst;
                {
                    ...
                    if (len < 3) {
                        ...
                        __auto_type _mv_994 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_994.has_value) {
                            __auto_type elem_type_expr = _mv_994.value;
                            __auto_type _mv_995 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_string defn_get_number_as_string(types_SExpr* expr) {
    ...
    switch (_mv_996.tag) {
        case types_SExpr_num:
        {
            __auto_type num = _mv_996.data.num;
            return num.raw;
        }
        default: {
            return SLOP_STR("0");
                    ...
                    while (i < len) {
                        ...
                        if (_mv_1001.has_value) {
                            ...
                            switch (_mv_1002.tag) {
                                case types_SExpr_num:
                                {
                                    __auto_type num = _mv_1002.data.num;
                                    if (!(found_dots)) {
                ...
                __auto_type lst = _mv_1003.data.lst;
                {
                    ...
                    if (len < 3) {
                        ...
                        if (_mv_1004.has_value) {
                            __auto_type name_expr = _mv_1004.value;
                            __auto_type _mv_1005 = (*name_expr);
                            switch (_mv_1005.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_1005.data.sym;
                                    {
                                        __auto_type raw_name = name_sym.name;
                                        __auto_type base_name = ctype_to_c_name(arena, raw_name);
                                        ...
                                        __auto_type _mv_1006 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_1006.has_value) {
                                            __auto_type params_expr = _mv_1006.value;
...
void defn_bind_params_to_scope(context_TranspileContext* ctx, types_SExpr* params_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1009 = (*params_expr);
        switch (_mv_1009.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1009.data.lst;
                {
                    ...
                    while (i < len) {
                        ...
                        if (_mv_1010.has_value) {
                            __auto_type param = _mv_1010.value;
                    ...
                    if (len >= 2) {
                        {
                            ...
                            __auto_type _mv_1012 = ({ __auto_type _lst = items; size_t _idx = (size_t)name_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_1012.has_value) {
                                ...
                                switch (_mv_1013.tag) {
                                    case types_SExpr_sym:
                                    {
                                        ...
                                        __auto_type _mv_1014 = ({ __auto_type _lst = items; size_t _idx = (size_t)type_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                ...
                __auto_type lst = _mv_1020.data.lst;
                {
                    ...
                    if (len < 2) {
                    ...
                    } else {
                        {
                            __auto_type has_mode = ((len >= 3) && defn_is_param_mode(items));
                            __auto_type type_idx = ((has_mode) ? 2 : 1);
                            __auto_type _mv_1021 = ({ __auto_type _lst = items; size_t _idx = (size_t)type_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        switch (_mv_1022.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1022.data.lst;
                {
                    ...
                    __auto_type len = ((int64_t)((items).len));
                    if (len >= 3) {
                        __auto_type _mv_1023 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_1023.has_value) {
                            __auto_type name_expr = _mv_1023.value;
                            __auto_type _mv_1024 = (*name_expr);
                            switch (_mv_1024.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_1024.data.sym;
                                    {
                                        __auto_type raw_name = name_sym.name;
                                        __auto_type base_name = ctype_to_c_name(arena, raw_name);
                                        ...
                                        __auto_type _mv_1025 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_1025.has_value) {
                                            __auto_type params_expr = _mv_1025.value;
                                            {
                                                __auto_type result_type_opt = defn_get_result_type_name(ctx, items);
                                                __auto_type raw_return = defn_get_return_type(ctx, items);
                                                {
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1027.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 1) {
                    ...
                    __auto_type _mv_1028 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_1028.has_value) {
                        __auto_type head = _mv_1028.value;
                        __auto_type _mv_1029 = (*head);
                        switch (_mv_1029.tag) {
                            case types_SExpr_sym:
                            {
                                ...
                                case types_SExpr_lst:
                                {
                                    __auto_type body_lst = _mv_1032.data.lst;
                                    {
                                        ...
                                        if (body_len < 1) {
                                            ...
                                            __auto_type _mv_1033 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)(body_len - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_string defn_extract_spec_slop_return_type(context_TranspileContext* ctx, types_SExpr* spec_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1034 = (*spec_expr);
        switch (_mv_1034.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1034.data.lst;
                {
                    __auto_type items = lst.items;
                    if (((int64_t)((items).len)) < 2) {
                        return SLOP_STR("");
                    } else {
                        __auto_type _mv_1035 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_1035.has_value) {
                            __auto_type spec_body = _mv_1035.value;
                            __auto_type _mv_1036 = (*spec_body);
                            switch (_mv_1036.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type body_lst = _mv_1036.data.lst;
                                    {
                                        __auto_type body_items = body_lst.items;
                                        __auto_type body_len = ((int64_t)((body_items).len));
                                        if (body_len < 1) {
                                            ...
                                            __auto_type _mv_1037 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)(body_len - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_string defn_get_slop_return_type(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            __auto_type _mv_1038 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_option_string defn_extract_result_type_name(context_TranspileContext* ctx, types_SExpr* spec_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1040 = (*spec_expr);
        switch (_mv_1040.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1040.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) < 2) {
                        ...
                        __auto_type _mv_1041 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_1041.has_value) {
                            __auto_type spec_body = _mv_1041.value;
                            __auto_type _mv_1042 = (*spec_body);
                            switch (_mv_1042.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type body_lst = _mv_1042.data.lst;
                                    {
                                        __auto_type body_items = body_lst.items;
                                        __auto_type body_len = ((int64_t)((body_items).len));
                                        if (body_len < 1) {
                                            ...
                                            __auto_type _mv_1043 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)(body_len - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_1043.has_value) {
                                                __auto_type ret_type = _mv_1043.value;
    ...
    SLOP_PRE(((type_expr != NULL)), "(!= type-expr nil)");
    {
        ...
        switch (_mv_1044.tag) {
            case types_SExpr_sym:
            {
                ...
                {
                    __auto_type type_name = sym.name;
                    __auto_type _mv_1045 = context_ctx_lookup_result_type_alias(ctx, type_name);
                    if (_mv_1045.has_value) {
                        __auto_type alias_result = _mv_1045.value;
                        return (slop_option_string){.has_value = 1, .value = alias_result};
                    } else if (!_mv_1045.has_value) {
                        __auto_type _mv_1046 = context_ctx_lookup_type(ctx, type_name);
                        if (_mv_1046.has_value) {
                            __auto_type entry = _mv_1046.value;
                                ...
                                case types_SExpr_sym:
                                {
                                    ...
                                    if (string_eq(sym.name, SLOP_STR("Result"))) {
                                        ...
                                        if (_mv_1049.has_value) {
                                            __auto_type ok_type_expr = _mv_1049.value;
                                            __auto_type _mv_1050 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_1050.has_value) {
                                                __auto_type err_type_expr = _mv_1050.value;
                                                {
...
slop_string defn_build_param_str(context_TranspileContext* ctx, types_SExpr* params_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1051 = (*params_expr);
        switch (_mv_1051.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1051.data.lst;
                {
                    ...
                    __auto_type i = 0;
                    while (i < len) {
                        __auto_type _mv_1052 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_1052.has_value) {
                            __auto_type param = _mv_1052.value;
                            {
                ...
                __auto_type lst = _mv_1053.data.lst;
                {
                    ...
                    if (len < 2) {
                    ...
                    } else {
                        {
                            ...
                            __auto_type _mv_1054 = ({ __auto_type _lst = items; size_t _idx = (size_t)name_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_1054.has_value) {
                                __auto_type name_expr = _mv_1054.value;
                                __auto_type _mv_1055 = (*name_expr);
                                switch (_mv_1055.tag) {
                                    case types_SExpr_sym:
                                    {
                                        __auto_type name_sym = _mv_1055.data.sym;
                                        __auto_type _mv_1056 = ({ __auto_type _lst = items; size_t _idx = (size_t)type_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
uint8_t defn_is_fn_type(types_SExpr* type_expr) {
    __auto_type _mv_1059 = (*type_expr);
    switch (_mv_1059.tag) {
        case types_SExpr_lst:
        {
                    ...
                    } else {
                        {
                            ...
                            if (len == 2) {
                                ...
                                if (_mv_1063.has_value) {
                                    __auto_type args_expr = _mv_1063.value;
                                    {
...
slop_string defn_build_fn_args_str_for_param(context_TranspileContext* ctx, types_SExpr* args_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1064 = (*args_expr);
        switch (_mv_1064.tag) {
            case types_SExpr_lst:
            {
                __auto_type args_list = _mv_1064.data.lst;
                {
                    ...
                    if (arg_count == 0) {
                    ...
                    } else {
                        {
                            ...
                            __auto_type i = 0;
                            while (i < arg_count) {
                                __auto_type _mv_1065 = ({ __auto_type _lst = arg_items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1065.has_value) {
                                    __auto_type arg_expr = _mv_1065.value;
                                    {
...
uint8_t defn_is_c_name_attr_at(slop_list_types_SExpr_ptr items, int64_t idx) {
    __auto_type _mv_1069 = ({ __auto_type _lst = items; size_t _idx = (size_t)idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1071.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 1) {
                    ...
                    __auto_type _mv_1072 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_1072.has_value) {
                        __auto_type head = _mv_1072.value;
                        __auto_type _mv_1073 = (*head);
                        switch (_mv_1073.tag) {
                            case types_SExpr_sym:
                            {
            ...
            __auto_type lst = _mv_1083.data.lst;
            {
                ...
                if (len < 1) {
                ...
                } else {
                    {
                        ...
                        while ((i < len) && !(found)) {
                            __auto_type _mv_1086 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_1086.has_value) {
                                __auto_type item = _mv_1086.value;
                ...
                __auto_type lst = _mv_1090.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) >= 2) {
                        ...
                        if (_mv_1091.has_value) {
                            ...
                            __auto_type _mv_1092 = (*val);
                            switch (_mv_1092.tag) {
                                case types_SExpr_str:
                                {
                                    __auto_type str = _mv_1092.data.str;
                ...
                __auto_type lst = _mv_1094.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) >= 2) {
                        ...
                        if (_mv_1095.has_value) {
                            __auto_type val = _mv_1095.value;
...
void defn_emit_preconditions(context_TranspileContext* ctx, slop_list_types_SExpr_ptr preconditions) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1103 = ({ __auto_type _lst = preconditions; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1103.has_value) {
                __auto_type cond_expr = _mv_1103.value;
                {
...
void defn_emit_postconditions(context_TranspileContext* ctx, slop_list_types_SExpr_ptr postconditions) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1104 = ({ __auto_type _lst = postconditions; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void defn_emit_assumptions(context_TranspileContext* ctx, slop_list_types_SExpr_ptr assumptions) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1105 = ({ __auto_type _lst = assumptions; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
