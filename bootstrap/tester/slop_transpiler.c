...
transpiler_GenericInfo transpiler_extract_generic_info(slop_arena* arena, slop_list_types_SExpr_ptr items) {
    {
        ...
        while ((i < len)) {
            __auto_type _mv_1058 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1058.has_value) {
                __auto_type item = _mv_1058.value;
                __auto_type _mv_1059 = (*item);
                switch (_mv_1059.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type lst = _mv_1059.data.lst;
                        {
                            ...
                            if ((((int64_t)((sub_items).len)) >= 1)) {
                                __auto_type _mv_1060 = ({ __auto_type _lst = sub_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        ...
                                        case types_SExpr_sym:
                                        {
                                            ...
                                            if (string_eq(sym.name, SLOP_STR("@generic"))) {
                                                if ((((int64_t)((sub_items).len)) >= 2)) {
                                                    __auto_type _mv_1062 = ({ __auto_type _lst = sub_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_1062.has_value) {
                                                        ...
                                                        switch (_mv_1063.tag) {
                                                            case types_SExpr_lst:
                                                            {
                                                                __auto_type params_lst = _mv_1063.data.lst;
                                                                {
                                                                    __auto_type param_items = params_lst.items;
                                                                    __auto_type param_len = ((int64_t)((param_items).len));
                                                                    __auto_type j = 0;
                                                                    while ((j < param_len)) {
                                                                        __auto_type _mv_1064 = ({ __auto_type _lst = param_items; size_t _idx = (size_t)j; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                                        if (_mv_1064.has_value) {
                                                                            ...
                                                                            switch (_mv_1065.tag) {
                                                                                case types_SExpr_sym:
                                                                                {
                                                                                    __auto_type param_sym = _mv_1065.data.sym;
                                                            ...
                                                            case types_SExpr_sym:
                                                            {
                                                                __auto_type single_sym = _mv_1063.data.sym;
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1067.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) >= 1)) {
                    __auto_type _mv_1068 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_1068.has_value) {
                        __auto_type head = _mv_1068.value;
                        __auto_type _mv_1069 = (*head);
                        switch (_mv_1069.tag) {
                            case types_SExpr_sym:
                            {
...
void transpiler_prescan_type(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((((int64_t)((items).len)) >= 2)) {
            __auto_type _mv_1070 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            ...
                            __auto_type c_name = ((context_ctx_prefixing_enabled(ctx)) ? ({ __auto_type _mv = context_ctx_get_module(ctx); _mv.has_value ? ({ __auto_type mod_name = _mv.value; context_ctx_str(ctx, ctype_to_c_name(arena, mod_name), context_ctx_str(ctx, SLOP_STR("_"), base_c_name)); }) : (base_c_name); }) : base_c_name);
                            {
                                ...
                                if ((is_record || is_union)) {
                                    if ((((int64_t)((items).len)) >= 3)) {
                                        ...
                                        if (_mv_1072.has_value) {
                                            __auto_type def_expr = _mv_1072.value;
                                            __auto_type _mv_1073 = (*def_expr);
                                            switch (_mv_1073.tag) {
                                                case types_SExpr_lst:
                                                {
                                                    __auto_type def_lst = _mv_1073.data.lst;
                                ...
                                if ((((int64_t)((items).len)) >= 3)) {
                                    ...
                                    if (_mv_1074.has_value) {
                                        __auto_type body_expr = _mv_1074.value;
...
void transpiler_register_enum_variants(context_TranspileContext* ctx, slop_string enum_name, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    if ((((int64_t)((items).len)) >= 3)) {
        __auto_type _mv_1075 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        if (_mv_1075.has_value) {
            __auto_type def_expr = _mv_1075.value;
            __auto_type _mv_1076 = (*def_expr);
            switch (_mv_1076.tag) {
                case types_SExpr_lst:
                {
                    __auto_type def_lst = _mv_1076.data.lst;
                    {
                        __auto_type def_items = def_lst.items;
                        __auto_type len = ((int64_t)((def_items).len));
                        __auto_type i = 1;
                        while ((i < len)) {
                            __auto_type _mv_1077 = ({ __auto_type _lst = def_items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_1077.has_value) {
                                __auto_type variant_expr = _mv_1077.value;
                                __auto_type _mv_1078 = (*variant_expr);
                                switch (_mv_1078.tag) {
                                    case types_SExpr_sym:
                                    {
                                    ...
                                    case types_SExpr_lst:
                                    {
                                        __auto_type variant_lst = _mv_1078.data.lst;
                                        if ((((int64_t)((variant_lst.items).len)) > 0)) {
                                            __auto_type _mv_1079 = ({ __auto_type _lst = variant_lst.items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((((int64_t)((items).len)) >= 3)) {
            ...
            if (_mv_1081.has_value) {
                __auto_type def_expr = _mv_1081.value;
                __auto_type _mv_1082 = (*def_expr);
                switch (_mv_1082.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type def_lst = _mv_1082.data.lst;
                        {
                            __auto_type def_items = def_lst.items;
                            __auto_type len = ((int64_t)((def_items).len));
                            __auto_type i = 1;
                            while ((i < len)) {
                                __auto_type _mv_1083 = ({ __auto_type _lst = def_items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1083.has_value) {
                                    __auto_type variant_expr = _mv_1083.value;
                                    __auto_type _mv_1084 = (*variant_expr);
                                    switch (_mv_1084.tag) {
                                        case types_SExpr_sym:
                                        {
                                        ...
                                        case types_SExpr_lst:
                                        {
                                            __auto_type variant_lst = _mv_1084.data.lst;
                                            {
                                                __auto_type vl_items = variant_lst.items;
                                                if ((((int64_t)((vl_items).len)) >= 2)) {
                                                    __auto_type _mv_1085 = ({ __auto_type _lst = vl_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_1085.has_value) {
                                                        ...
                                                        switch (_mv_1086.tag) {
                                                            case types_SExpr_sym:
                                                            {
                                                                __auto_type name_sym = _mv_1086.data.sym;
                                                                {
                                                                    __auto_type variant_name = name_sym.name;
                                                                    __auto_type c_variant_name = ctype_to_c_name(arena, variant_name);
                                                                    context_ctx_register_enum_variant(ctx, variant_name, union_name);
                                                                    __auto_type _mv_1087 = ({ __auto_type _lst = vl_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                                    if (_mv_1087.has_value) {
                                                                        __auto_type type_expr = _mv_1087.value;
                                                                        {
...
void transpiler_prescan_fn(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        __auto_type arena = (*ctx).arena;
        if ((((int64_t)((items).len)) >= 2)) {
            __auto_type _mv_1088 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1088.has_value) {
                __auto_type name_expr = _mv_1088.value;
                __auto_type _mv_1089 = (*name_expr);
                switch (_mv_1089.tag) {
                    case types_SExpr_sym:
                    {
...
uint8_t transpiler_fn_returns_string(slop_list_types_SExpr_ptr items) {
    {
        ...
        uint8_t result = 0;
        while (((i < len) && !(result))) {
            __auto_type _mv_1090 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1090.has_value) {
                __auto_type item = _mv_1090.value;
                __auto_type _mv_1091 = (*item);
                switch (_mv_1091.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type lst = _mv_1091.data.lst;
                        {
                            __auto_type sub_items = lst.items;
                            if ((((int64_t)((sub_items).len)) >= 2)) {
                                __auto_type _mv_1092 = ({ __auto_type _lst = sub_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    ...
                                    switch (_mv_1093.tag) {
                                        case types_SExpr_sym:
                                        {
                                            ...
                                            if (string_eq(sym.name, SLOP_STR("@spec"))) {
                                                __auto_type _mv_1094 = ({ __auto_type _lst = sub_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_1094.has_value) {
                                                    __auto_type spec_body = _mv_1094.value;
                                                    __auto_type _mv_1095 = (*spec_body);
                                                    switch (_mv_1095.tag) {
                                                        case types_SExpr_lst:
                                                        {
                                                            __auto_type body_lst = _mv_1095.data.lst;
                                                            {
                                                                __auto_type body_items = body_lst.items;
                                                                __auto_type body_len = ((int64_t)((body_items).len));
                                                                if ((body_len >= 1)) {
                                                                    __auto_type _mv_1096 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)(body_len - 1); slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                                    if (_mv_1096.has_value) {
                                                                        __auto_type ret_type = _mv_1096.value;
                                                                        __auto_type _mv_1097 = (*ret_type);
                                                                        switch (_mv_1097.tag) {
                                                                            case types_SExpr_sym:
                                                                            {
                                                                                __auto_type ret_sym = _mv_1097.data.sym;
                ...
                switch (_mv_1099.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type lst = _mv_1099.data.lst;
                        {
                            __auto_type sub_items = lst.items;
                            if ((((int64_t)((sub_items).len)) >= 2)) {
                                __auto_type _mv_1100 = ({ __auto_type _lst = sub_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1100.has_value) {
                                    ...
                                    switch (_mv_1101.tag) {
                                        case types_SExpr_sym:
                                        {
                                            ...
                                            if (string_eq(sym.name, SLOP_STR("@spec"))) {
                                                __auto_type _mv_1102 = ({ __auto_type _lst = sub_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    ...
                                                    switch (_mv_1103.tag) {
                                                        case types_SExpr_lst:
                                                        {
                                                            __auto_type body_lst = _mv_1103.data.lst;
                                                            {
                                                                ...
                                                                __auto_type body_len = ((int64_t)((body_items).len));
                                                                if ((body_len >= 1)) {
                                                                    __auto_type _mv_1104 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)(body_len - 1); slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void transpiler_prescan_fn_params(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    ...
    if ((((int64_t)((items).len)) >= 3)) {
        ...
        if (_mv_1105.has_value) {
            __auto_type params_expr = _mv_1105.value;
            __auto_type _mv_1106 = (*params_expr);
            switch (_mv_1106.tag) {
                case types_SExpr_lst:
                {
                    __auto_type params_lst = _mv_1106.data.lst;
                    {
                        __auto_type params = params_lst.items;
                        __auto_type param_count = ((int64_t)((params).len));
                        __auto_type i = 0;
                        while ((i < param_count)) {
                            __auto_type _mv_1107 = ({ __auto_type _lst = params; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_1107.has_value) {
                                __auto_type param_expr = _mv_1107.value;
                                __auto_type _mv_1108 = (*param_expr);
                                switch (_mv_1108.tag) {
                                    case types_SExpr_lst:
                                    {
                                        __auto_type param_lst = _mv_1108.data.lst;
                                        {
                                            __auto_type param_items = param_lst.items;
                                            if ((((int64_t)((param_items).len)) >= 2)) {
                                                __auto_type _mv_1109 = ({ __auto_type _lst = param_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_1109.has_value) {
                                                    __auto_type type_expr = _mv_1109.value;
...
slop_list_context_FuncParamType_ptr transpiler_prescan_collect_param_types(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((((int64_t)((items).len)) >= 3)) {
            __auto_type _mv_1110 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1110.has_value) {
                __auto_type params_expr = _mv_1110.value;
                __auto_type _mv_1111 = (*params_expr);
                switch (_mv_1111.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type params_lst = _mv_1111.data.lst;
                        {
                            __auto_type params = params_lst.items;
                            __auto_type param_count = ((int64_t)((params).len));
                            __auto_type i = 0;
                            while ((i < param_count)) {
                                __auto_type _mv_1112 = ({ __auto_type _lst = params; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1112.has_value) {
                                    __auto_type param_expr = _mv_1112.value;
                                    {
                ...
                __auto_type lst = _mv_1113.data.lst;
                {
                    ...
                    if ((len < 2)) {
                    ...
                    } else {
                        {
                            ...
                            __auto_type _mv_1114 = ({ __auto_type _lst = items; size_t _idx = (size_t)type_idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
uint8_t transpiler_prescan_is_param_mode(slop_list_types_SExpr_ptr items) {
    if ((((int64_t)((items).len)) < 1)) {
        ...
        __auto_type _mv_1115 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        if (_mv_1115.has_value) {
            __auto_type first = _mv_1115.value;
            __auto_type _mv_1116 = (*first);
            switch (_mv_1116.tag) {
                case types_SExpr_sym:
                {
        ...
        switch (_mv_1121.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1121.data.lst;
                {
                    __auto_type items = lst.items;
                    if ((((int64_t)((items).len)) >= 2)) {
                        __auto_type _mv_1122 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            ...
                            switch (_mv_1123.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type body_lst = _mv_1123.data.lst;
                                    {
                                        ...
                                        __auto_type body_len = ((int64_t)((body_items).len));
                                        if ((body_len >= 1)) {
                                            __auto_type _mv_1124 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)(body_len - 1); slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        switch (_mv_1125.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1125.data.lst;
                {
                    __auto_type items = lst.items;
                    if ((((int64_t)((items).len)) >= 3)) {
                        __auto_type _mv_1126 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            ...
                            switch (_mv_1127.tag) {
                                case types_SExpr_sym:
                                {
                                    ...
                                    if (string_eq(sym.name, SLOP_STR("Result"))) {
                                        __auto_type _mv_1128 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_1128.has_value) {
                                            __auto_type ok_type_expr = _mv_1128.value;
                                            __auto_type _mv_1129 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_1129.has_value) {
                                                __auto_type err_type_expr = _mv_1129.value;
                                                {
    ...
    switch (_mv_1131.tag) {
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1131.data.lst;
            {
                ...
                __auto_type len = ((int64_t)((items).len));
                if ((len >= 1)) {
                    __auto_type _mv_1132 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_1132.has_value) {
                        __auto_type head = _mv_1132.value;
                        __auto_type _mv_1133 = (*head);
                        switch (_mv_1133.tag) {
                            case types_SExpr_sym:
                            {
                                __auto_type sym = _mv_1133.data.sym;
                                {
                                    ...
                                    if (string_eq(name, SLOP_STR("map-new"))) {
                                        if ((len >= 3)) {
                                            __auto_type _mv_1134 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_1134.has_value) {
                                                __auto_type key_type_expr = _mv_1134.value;
                                        ...
                                        if ((len >= 3)) {
                                            __auto_type _mv_1135 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_1135.has_value) {
                                                __auto_type elem_type_expr = _mv_1135.value;
                                        ...
                                        if ((len >= 4)) {
                                            __auto_type _mv_1136 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    ...
                                    } else {
                                        {
                                            ...
                                            while ((i < len)) {
                                                ...
                                                if (_mv_1138.has_value) {
                                                    __auto_type child = _mv_1138.value;
                            ...
                            default: {
                                {
                                    ...
                                    while ((i < len)) {
                                        ...
                                        if (_mv_1139.has_value) {
                                            __auto_type child = _mv_1139.value;
                                            transpiler_prescan_expr_for_struct_keys(ctx, child);
...
void transpiler_prescan_register_struct_key_type(context_TranspileContext* ctx, types_SExpr* type_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1140 = (*type_expr);
        switch (_mv_1140.tag) {
            case types_SExpr_sym:
            {
                __auto_type sym = _mv_1140.data.sym;
                {
                    ...
                    if (!(transpiler_is_builtin_map_key_type(name))) {
                        __auto_type _mv_1141 = context_ctx_lookup_type(ctx, name);
                        if (_mv_1141.has_value) {
                            __auto_type type_entry = _mv_1141.value;
                            context_ctx_register_struct_key_type(ctx, type_entry.c_name);
                        } else if (!_mv_1141.has_value) {
                            __auto_type _mv_1142 = context_ctx_get_module(ctx);
                            if (_mv_1142.has_value) {
                                __auto_type mod = _mv_1142.value;
                                {
                                    __auto_type prefixed = context_ctx_str3(ctx, mod, SLOP_STR("_"), name);
                                    __auto_type _mv_1143 = context_ctx_lookup_type(ctx, prefixed);
                                    if (_mv_1143.has_value) {
                                        __auto_type type_entry = _mv_1143.value;
                                        context_ctx_register_struct_key_type(ctx, type_entry.c_name);
...
void transpiler_check_and_register_result_alias(context_TranspileContext* ctx, slop_string alias_name, types_SExpr* body_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1144 = (*body_expr);
        switch (_mv_1144.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1144.data.lst;
                {
                    __auto_type items = lst.items;
                    if ((((int64_t)((items).len)) >= 3)) {
                        __auto_type _mv_1145 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_1145.has_value) {
                            ...
                            switch (_mv_1146.tag) {
                                case types_SExpr_sym:
                                {
                                    ...
                                    if (string_eq(sym.name, SLOP_STR("Result"))) {
                                        __auto_type _mv_1147 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_1147.has_value) {
                                            __auto_type ok_type_expr = _mv_1147.value;
                                            __auto_type _mv_1148 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_1148.has_value) {
                                                __auto_type err_type_expr = _mv_1148.value;
                                                {
                                                    __auto_type ok_c_type = context_to_c_type_prefixed(ctx, ok_type_expr);
                                                    __auto_type err_c_type = context_to_c_type_prefixed(ctx, err_type_expr);
                                                    __auto_type result_name = transpiler_build_result_type_name(ctx, ok_c_type, err_c_type);
...
void transpiler_prescan_ffi(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        __auto_type len = ((int64_t)((items).len));
        if ((len >= 2)) {
            __auto_type _mv_1149 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1149.has_value) {
                __auto_type header_expr = _mv_1149.value;
                __auto_type _mv_1150 = (*header_expr);
                switch (_mv_1150.tag) {
                    case types_SExpr_str:
                    {
                        __auto_type str = _mv_1150.data.str;
            ...
            }
            {
                ...
                while ((i < len)) {
                    ...
                    if (_mv_1151.has_value) {
                        __auto_type func_decl = _mv_1151.value;
...
void transpiler_prescan_import(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    if ((((int64_t)((items).len)) >= 3)) {
        __auto_type _mv_1152 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        if (_mv_1152.has_value) {
            __auto_type mod_expr = _mv_1152.value;
            __auto_type _mv_1153 = (*mod_expr);
            switch (_mv_1153.tag) {
                case types_SExpr_sym:
                {
                    __auto_type mod_sym = _mv_1153.data.sym;
                    {
                        ...
                        __auto_type _mv_1154 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_1154.has_value) {
                            __auto_type symbols_expr = _mv_1154.value;
                            __auto_type _mv_1155 = (*symbols_expr);
                            switch (_mv_1155.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type symbols_lst = _mv_1155.data.lst;
                                    {
                                        __auto_type syms = symbols_lst.items;
                                        __auto_type sym_len = ((int64_t)((syms).len));
                                        __auto_type j = 0;
                                        while ((j < sym_len)) {
                                            __auto_type _mv_1156 = ({ __auto_type _lst = syms; size_t _idx = (size_t)j; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_1156.has_value) {
                                                __auto_type sym_item = _mv_1156.value;
                                                __auto_type _mv_1157 = (*sym_item);
                                                switch (_mv_1157.tag) {
                                                    case types_SExpr_sym:
                                                    {
                                                        __auto_type s = _mv_1157.data.sym;
                                                        {
...
void transpiler_register_ffi_function(context_TranspileContext* ctx, types_SExpr* func_decl) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1158 = (*func_decl);
        switch (_mv_1158.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1158.data.lst;
                {
                    ...
                    __auto_type len = ((int64_t)((items).len));
                    if ((len >= 1)) {
                        __auto_type _mv_1159 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_string transpiler_extract_ffi_c_name(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items, slop_string fn_name) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while ((i < len)) {
            __auto_type _mv_1164 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1164.has_value) {
                __auto_type item_expr = _mv_1164.value;
                __auto_type _mv_1165 = (*item_expr);
                switch (_mv_1165.tag) {
                    case types_SExpr_sym:
                    {
                        __auto_type sym = _mv_1165.data.sym;
                        if (string_eq(sym.name, SLOP_STR(":c-name"))) {
                            __auto_type _mv_1166 = ({ __auto_type _lst = items; size_t _idx = (size_t)(i + 1); slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_1166.has_value) {
                                __auto_type c_name_expr = _mv_1166.value;
                                __auto_type _mv_1167 = (*c_name_expr);
                                switch (_mv_1167.tag) {
                                    case types_SExpr_sym:
                                    {
                                        __auto_type c_sym = _mv_1167.data.sym;
                                        c_name = c_sym.name;
                                        found_c_name = 1;
                                        break;
                                    }
        ...
        if ((len >= 2)) {
            {
                ...
                if (has_header) {
                    ...
                    if (_mv_1168.has_value) {
                        __auto_type header_expr = _mv_1168.value;
                        __auto_type _mv_1169 = (*header_expr);
                        switch (_mv_1169.tag) {
                            case types_SExpr_str:
                            {
                                __auto_type str = _mv_1169.data.str;
                                context_ctx_add_include(ctx, str.value);
                                break;
                            }
                            default: {
                ...
                if ((len >= (name_idx + 1))) {
                    __auto_type _mv_1170 = ({ __auto_type _lst = items; size_t _idx = (size_t)name_idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_string transpiler_get_ffi_struct_c_name(slop_arena* arena, slop_list_types_SExpr_ptr items, int64_t name_idx, slop_string default_name) {
    {
        ...
        if ((len >= (modifier_idx + 2))) {
            __auto_type _mv_1172 = ({ __auto_type _lst = items; size_t _idx = (size_t)modifier_idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1172.has_value) {
                __auto_type mod_expr = _mv_1172.value;
                __auto_type _mv_1173 = (*mod_expr);
                switch (_mv_1173.tag) {
                    case types_SExpr_sym:
                    {
                        __auto_type sym = _mv_1173.data.sym;
                        if (string_eq(sym.name, SLOP_STR(":c-name"))) {
                            __auto_type _mv_1174 = ({ __auto_type _lst = items; size_t _idx = (size_t)(modifier_idx + 1); slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_1174.has_value) {
                                __auto_type cname_expr = _mv_1174.value;
                                __auto_type _mv_1175 = (*cname_expr);
                                switch (_mv_1175.tag) {
                                    case types_SExpr_str:
                                    {
                                        __auto_type str = _mv_1175.data.str;
...
uint8_t transpiler_is_ffi_string_item(slop_list_types_SExpr_ptr items, int64_t idx) {
    __auto_type _mv_1176 = ({ __auto_type _lst = items; size_t _idx = (size_t)idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    if (_mv_1176.has_value) {
        __auto_type item = _mv_1176.value;
        __auto_type _mv_1177 = (*item);
        switch (_mv_1177.tag) {
            case types_SExpr_str:
            {
                __auto_type _ = _mv_1177.data.str;
                return 1;
            }
            default: {
                return 0;
...
uint8_t transpiler_is_enum_def(slop_list_types_SExpr_ptr items) {
    if ((((int64_t)((items).len)) < 3)) {
        ...
        __auto_type _mv_1178 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        if (_mv_1178.has_value) {
            __auto_type def_expr = _mv_1178.value;
            __auto_type _mv_1179 = (*def_expr);
            switch (_mv_1179.tag) {
                case types_SExpr_lst:
                {
                    __auto_type def_lst = _mv_1179.data.lst;
                    {
                        __auto_type def_items = def_lst.items;
                        if ((((int64_t)((def_items).len)) < 1)) {
                            return 0;
                        } else {
                            __auto_type _mv_1180 = ({ __auto_type _lst = def_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
uint8_t transpiler_is_union_def(slop_list_types_SExpr_ptr items) {
    if ((((int64_t)((items).len)) < 3)) {
        ...
        if (_mv_1186.has_value) {
            __auto_type def_expr = _mv_1186.value;
            __auto_type _mv_1187 = (*def_expr);
            switch (_mv_1187.tag) {
                case types_SExpr_lst:
                {
                    __auto_type def_lst = _mv_1187.data.lst;
                    {
                        __auto_type def_items = def_lst.items;
                        if ((((int64_t)((def_items).len)) < 1)) {
                            return 0;
                        } else {
                            __auto_type _mv_1188 = ({ __auto_type _lst = def_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_string transpiler_get_array_c_type(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items, slop_string default_c_type) {
    ...
    if ((((int64_t)((items).len)) < 3)) {
        ...
        if (_mv_1190.has_value) {
            __auto_type body_expr = _mv_1190.value;
            __auto_type _mv_1191 = (*body_expr);
            switch (_mv_1191.tag) {
                case types_SExpr_lst:
                {
                    __auto_type body_lst = _mv_1191.data.lst;
                    {
                        ...
                        if ((((int64_t)((body_items).len)) < 2)) {
                            ...
                            __auto_type _mv_1192 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                ...
                                switch (_mv_1193.tag) {
                                    case types_SExpr_sym:
                                    {
                                        ...
                                        if (string_eq(sym.name, SLOP_STR("Array"))) {
                                            __auto_type _mv_1194 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_1194.has_value) {
                                                __auto_type elem_expr = _mv_1194.value;
                                                {
...
void transpiler_emit_all_types(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1195 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    ...
    }
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1196 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            ...
            __auto_type lst = _mv_1197.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 3)) {
                    ...
                    if (_mv_1198.has_value) {
                        __auto_type def_expr = _mv_1198.value;
                        __auto_type _mv_1199 = (*def_expr);
                        switch (_mv_1199.tag) {
                            case types_SExpr_lst:
                            {
                                __auto_type def_lst = _mv_1199.data.lst;
                                {
                                    __auto_type def_items = def_lst.items;
                                    if ((((int64_t)((def_items).len)) < 1)) {
                                        return 0;
                                    } else {
                                        __auto_type _mv_1200 = ({ __auto_type _lst = def_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void transpiler_transpile_module(context_TranspileContext* ctx, types_SExpr* module_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1209 = (*module_expr);
        switch (_mv_1209.tag) {
            case types_SExpr_lst:
            {
...
int64_t transpiler_get_body_start(slop_list_types_SExpr_ptr items) {
    if ((((int64_t)((items).len)) < 3)) {
        ...
        if (_mv_1212.has_value) {
            __auto_type third = _mv_1212.value;
            __auto_type _mv_1213 = (*third);
            switch (_mv_1213.tag) {
                case types_SExpr_lst:
                {
                    __auto_type lst = _mv_1213.data.lst;
                    {
                        ...
                        if ((((int64_t)((sub_items).len)) < 1)) {
                            ...
                            __auto_type _mv_1214 = ({ __auto_type _lst = sub_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                ...
                switch (_mv_1217.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type lst = _mv_1217.data.lst;
                        {
                            __auto_type sub_items = lst.items;
                            if ((((int64_t)((sub_items).len)) >= 1)) {
                                __auto_type _mv_1218 = ({ __auto_type _lst = sub_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            ...
                                            if (string_eq(sym.name, SLOP_STR("export"))) {
                                                {
                                                    ...
                                                    __auto_type j = 1;
                                                    while ((j < export_len)) {
                                                        __auto_type _mv_1220 = ({ __auto_type _lst = sub_items; size_t _idx = (size_t)j; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
uint8_t transpiler_list_contains_str(slop_list_string lst, slop_string needle) {
    {
        ...
        uint8_t found = 0;
        while (((i < len) && !(found))) {
            __auto_type _mv_1222 = ({ __auto_type _lst = lst; size_t _idx = (size_t)i; slop_option_string _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1222.has_value) {
                __auto_type s = _mv_1222.value;
...
void transpiler_prescan_module_body(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items, int64_t start) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = start;
        while ((i < len)) {
            __auto_type _mv_1223 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void transpiler_scan_type_for_generics(context_TranspileContext* ctx, types_SExpr* type_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1224 = (*type_expr);
        switch (_mv_1224.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1224.data.lst;
                {
                    ...
                    __auto_type len = ((int64_t)((items).len));
                    if ((len >= 1)) {
                        __auto_type _mv_1225 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        ...
                                        if (string_eq(op, SLOP_STR("Option"))) {
                                            if ((len >= 2)) {
                                                ...
                                                if (_mv_1227.has_value) {
                                                    __auto_type inner = _mv_1227.value;
                                                    {
                                            ...
                                            if ((len >= 2)) {
                                                __auto_type _mv_1228 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_1228.has_value) {
                                                    __auto_type elem = _mv_1228.value;
                                                    {
                                            ...
                                            if ((len >= 2)) {
                                                ...
                                                if (_mv_1229.has_value) {
                                                    __auto_type inner = _mv_1229.value;
                                                    transpiler_scan_type_for_generics(ctx, inner);
                                            ...
                                            if ((len >= 3)) {
                                                __auto_type _mv_1230 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_1230.has_value) {
                                                    __auto_type ok_type = _mv_1230.value;
                                                    ...
                                                    if (_mv_1231.has_value) {
                                                        __auto_type err_type = _mv_1231.value;
                                                        {
                                            ...
                                            if ((len >= 2)) {
                                                __auto_type _mv_1232 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_1232.has_value) {
                                                    __auto_type elem = _mv_1232.value;
                                                    {
                                                        __auto_type elem_c = context_to_c_type_prefixed(ctx, elem);
                                                        __auto_type elem_id = ctype_type_to_identifier(arena, elem_c);
                                                        __auto_type c_name = context_ctx_str(ctx, SLOP_STR("slop_chan_"), elem_id);
                                            ...
                                            if ((len >= 2)) {
                                                __auto_type _mv_1233 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_1233.has_value) {
                                                    __auto_type result = _mv_1233.value;
                                                    {
                                            ...
                                            if ((len >= 3)) {
                                                __auto_type _mv_1234 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_1234.has_value) {
                                                    __auto_type key_type = _mv_1234.value;
                                                    {
                                                        ...
                                                        if (_mv_1235.has_value) {
                                                            __auto_type val_type = _mv_1235.value;
                                            ...
                                            if ((len >= 2)) {
                                                __auto_type _mv_1236 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_1236.has_value) {
                                                    __auto_type elem_type = _mv_1236.value;
                                                    {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while ((i < len)) {
            ...
            if (_mv_1237.has_value) {
                __auto_type field_expr = _mv_1237.value;
                __auto_type _mv_1238 = (*field_expr);
                switch (_mv_1238.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type field_lst = _mv_1238.data.lst;
                        {
                            __auto_type field_items = field_lst.items;
                            if ((((int64_t)((field_items).len)) >= 2)) {
                                __auto_type _mv_1239 = ({ __auto_type _lst = field_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1239.has_value) {
                                    __auto_type type_expr = _mv_1239.value;
                                    transpiler_scan_type_for_generics(ctx, type_expr);
...
void transpiler_emit_ffi_includes(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1240 = ({ __auto_type _lst = includes; size_t _idx = (size_t)i; slop_option_string _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1240.has_value) {
                __auto_type header = _mv_1240.value;
...
void transpiler_emit_ffi_includes_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1241 = ({ __auto_type _lst = includes; size_t _idx = (size_t)i; slop_option_string _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1241.has_value) {
                __auto_type header = _mv_1241.value;
...
void transpiler_emit_header_guard_open(context_TranspileContext* ctx) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1242 = context_ctx_get_module(ctx);
        if (_mv_1242.has_value) {
            __auto_type mod_name = _mv_1242.value;
            {
...
void transpiler_emit_header_dependency_includes(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1243 = ({ __auto_type _lst = imports; size_t _idx = (size_t)i; slop_option_string _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1243.has_value) {
                __auto_type mod_name = _mv_1243.value;
                {
                    __auto_type c_name = ctype_to_c_name(arena, mod_name);
        ...
        while ((i < len)) {
            ...
            if (_mv_1244.has_value) {
                ...
                if ((transpiler_is_type_def(item) && transpiler_is_struct_type_def(item))) {
                    __auto_type _mv_1245 = transpiler_get_type_name(item);
                    if (_mv_1245.has_value) {
                        __auto_type type_name = _mv_1245.value;
                        {
        ...
        while (((i < len) && !(found))) {
            ...
            if (_mv_1251.has_value) {
                ...
                switch (_mv_1252.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type _ = _mv_1252.data.lst;
                        found = 1;
                        break;
                    }
                    default: {
            ...
            __auto_type lst = _mv_1253.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 3)) {
                    ...
                    if (_mv_1254.has_value) {
                        __auto_type def_expr = _mv_1254.value;
                        __auto_type _mv_1255 = (*def_expr);
                        switch (_mv_1255.tag) {
                            case types_SExpr_sym:
                            {
                                __auto_type _ = _mv_1255.data.sym;
                                return 1;
                            }
                            case types_SExpr_lst:
                            {
                                __auto_type def_lst = _mv_1255.data.lst;
                                {
                                    __auto_type def_items = def_lst.items;
                                    if ((((int64_t)((def_items).len)) < 1)) {
                                        return 0;
                                    } else {
                                        __auto_type _mv_1256 = ({ __auto_type _lst = def_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            ...
            __auto_type lst = _mv_1258.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 3)) {
                    ...
                    if (_mv_1259.has_value) {
                        __auto_type def_expr = _mv_1259.value;
                        __auto_type _mv_1260 = (*def_expr);
                        switch (_mv_1260.tag) {
                            case types_SExpr_lst:
                            {
                                __auto_type def_lst = _mv_1260.data.lst;
                                {
                                    __auto_type def_items = def_lst.items;
                                    if ((((int64_t)((def_items).len)) < 1)) {
                                        return 0;
                                    } else {
                                        __auto_type _mv_1261 = ({ __auto_type _lst = def_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                ...
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_1265.data.sym;
                                    {
                                        ...
                                        if (_mv_1266.has_value) {
                                            __auto_type body_expr = _mv_1266.value;
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1267.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    __auto_type _mv_1268 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                ...
                __auto_type lst = _mv_1270.data.lst;
                {
                    ...
                    if ((len < 3)) {
                        ...
                        if (_mv_1271.has_value) {
                            __auto_type elem_type_expr = _mv_1271.value;
                            __auto_type _mv_1272 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_1272.has_value) {
                                __auto_type size_expr = _mv_1272.value;
                                {
...
slop_string transpiler_get_array_size_string(types_SExpr* expr) {
    ...
    switch (_mv_1273.tag) {
        ...
        {
            __auto_type num = _mv_1273.data.num;
            return num.raw;
        }
        default: {
            return SLOP_STR("0");
...
uint8_t transpiler_is_range_type_body(types_SExpr* body_expr) {
    SLOP_PRE(((body_expr != NULL)), "(!= body-expr nil)");
    __auto_type _mv_1274 = (*body_expr);
    switch (_mv_1274.tag) {
        case types_SExpr_lst:
        {
...
transpiler_RangeBoundsHeader transpiler_parse_range_bounds_header(types_SExpr* body_expr) {
    SLOP_PRE(((body_expr != NULL)), "(!= body-expr nil)");
    {
        ...
        __auto_type _mv_1277 = (*body_expr);
        switch (_mv_1277.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1277.data.lst;
                {
                    ...
                    __auto_type i = 1;
                    while ((i < len)) {
                        __auto_type _mv_1278 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_1278.has_value) {
                            __auto_type item = _mv_1278.value;
                            __auto_type _mv_1279 = (*item);
                            switch (_mv_1279.tag) {
                                case types_SExpr_num:
                                {
                                    __auto_type num = _mv_1279.data.num;
                                    if (!(found_dots)) {
                                ...
                                case types_SExpr_sym:
                                {
                                    __auto_type sym = _mv_1279.data.sym;
                                    if (string_eq(sym.name, SLOP_STR(".."))) {
                                        found_dots = 1;
                                    }
                                    break;
...
void transpiler_emit_forward_decls_header(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items, int64_t start) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        uint8_t emitted_any = 0;
        while ((i < len)) {
            __auto_type _mv_1280 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1280.has_value) {
                __auto_type item = _mv_1280.value;
                if ((transpiler_is_type_def(item) && transpiler_is_struct_type_def(item))) {
                    __auto_type _mv_1281 = transpiler_get_type_name(item);
                    if (_mv_1281.has_value) {
                        __auto_type type_name = _mv_1281.value;
                        {
...
void transpiler_emit_c_name_aliases(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len > 0)) {
            ...
            while ((i < len)) {
                __auto_type _mv_1284 = ({ __auto_type _lst = aliases; size_t _idx = (size_t)i; slop_option_context_FuncCNameAlias _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_1284.has_value) {
                    __auto_type alias = _mv_1284.value;
...
void transpiler_emit_module_types(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items, int64_t start) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = start;
        while ((i < len)) {
            __auto_type _mv_1292 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while ((i < len)) {
            ...
            if (_mv_1295.has_value) {
                __auto_type item = _mv_1295.value;
                if ((transpiler_is_type_def(item) && transpiler_is_struct_type_def(item))) {
                    defn_transpile_type(ctx, item);
                    context_ctx_emit(ctx, SLOP_STR(""));
                }
...
void transpiler_emit_result_types(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1296 = ({ __auto_type _lst = result_types; size_t _idx = (size_t)i; slop_option_context_ResultType _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1296.has_value) {
                __auto_type rt = _mv_1296.value;
...
void transpiler_emit_result_types_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1297 = ({ __auto_type _lst = result_types; size_t _idx = (size_t)i; slop_option_context_ResultType _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1297.has_value) {
                __auto_type rt = _mv_1297.value;
...
void transpiler_emit_inline_records_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1298 = ({ __auto_type _lst = inline_records; size_t _idx = (size_t)i; slop_option_context_InlineRecord _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1298.has_value) {
                __auto_type ir = _mv_1298.value;
                {
...
void transpiler_emit_complex_value_option_types_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1301 = ({ __auto_type _lst = option_types; size_t _idx = (size_t)i; slop_option_context_OptionType _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1301.has_value) {
                __auto_type ot = _mv_1301.value;
                if (!(transpiler_is_pointer_elem_type(ot.inner_type))) {
                    transpiler_emit_single_option_type_header(ctx, ot);
                }
...
void transpiler_emit_primitive_option_types_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1304 = ({ __auto_type _lst = option_types; size_t _idx = (size_t)i; slop_option_context_OptionType _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1304.has_value) {
                __auto_type ot = _mv_1304.value;
...
void transpiler_emit_imported_list_types_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1305 = ({ __auto_type _lst = list_types; size_t _idx = (size_t)i; slop_option_context_ListType _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1305.has_value) {
                __auto_type lt = _mv_1305.value;
...
void transpiler_emit_imported_option_types_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1306 = ({ __auto_type _lst = option_types; size_t _idx = (size_t)i; slop_option_context_OptionType _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1306.has_value) {
                __auto_type ot = _mv_1306.value;
...
void transpiler_emit_complex_value_list_types_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1309 = ({ __auto_type _lst = list_types; size_t _idx = (size_t)i; slop_option_context_ListType _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1309.has_value) {
                __auto_type lt = _mv_1309.value;
...
void transpiler_emit_union_payload_hash_eq(context_TranspileContext* ctx, slop_list_context_UnionVariantEntry variants) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1310 = ({ __auto_type _lst = variants; size_t _idx = (size_t)i; slop_option_context_UnionVariantEntry _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1310.has_value) {
                __auto_type variant = _mv_1310.value;
                {
...
void transpiler_emit_record_field_dependencies(context_TranspileContext* ctx, slop_list_context_FieldEntry fields) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1311 = ({ __auto_type _lst = fields; size_t _idx = (size_t)i; slop_option_context_FieldEntry _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1311.has_value) {
                __auto_type field = _mv_1311.value;
                {
...
uint8_t transpiler_is_range_type_alias(context_TranspileContext* ctx, slop_string slop_type) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    __auto_type _mv_1312 = context_ctx_lookup_type_alias(ctx, slop_type);
    if (_mv_1312.has_value) {
        __auto_type underlying = _mv_1312.value;
...
void transpiler_emit_union_hash_fn(context_TranspileContext* ctx, slop_string c_type, slop_list_context_UnionVariantEntry variants) {
    ...
    context_ctx_emit_header(ctx, SLOP_STR("    switch (_k->tag) {"));
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1313 = ({ __auto_type _lst = variants; size_t _idx = (size_t)i; slop_option_context_UnionVariantEntry _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1313.has_value) {
                __auto_type variant = _mv_1313.value;
...
void transpiler_emit_union_eq_fn(context_TranspileContext* ctx, slop_string c_type, slop_list_context_UnionVariantEntry variants) {
    ...
    context_ctx_emit_header(ctx, SLOP_STR("    switch (_a->tag) {"));
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1314 = ({ __auto_type _lst = variants; size_t _idx = (size_t)i; slop_option_context_UnionVariantEntry _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1314.has_value) {
                __auto_type variant = _mv_1314.value;
...
void transpiler_emit_struct_hash_fn(context_TranspileContext* ctx, slop_string c_type, slop_list_context_FieldEntry fields) {
    ...
    context_ctx_emit_header(ctx, SLOP_STR("    uint64_t hash = 14695981039346656037ULL;"));
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1315 = ({ __auto_type _lst = fields; size_t _idx = (size_t)i; slop_option_context_FieldEntry _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1315.has_value) {
                __auto_type field = _mv_1315.value;
    ...
    context_ctx_emit_header(ctx, context_ctx_str(ctx, context_ctx_str4(ctx, SLOP_STR("    const "), c_type, SLOP_STR("* _b = (const "), c_type), SLOP_STR("*)b;")));
    {
        ...
        if ((len == 0)) {
            ...
            context_ctx_emit_header(ctx, SLOP_STR("    return true"));
            {
                int64_t i = 0;
                while ((i < len)) {
                    __auto_type _mv_1316 = ({ __auto_type _lst = fields; size_t _idx = (size_t)i; slop_option_context_FieldEntry _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_1316.has_value) {
                        __auto_type field = _mv_1316.value;
...
void transpiler_emit_struct_key_types_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while ((i < ((int64_t)((struct_key_types).len)))) {
            __auto_type _mv_1317 = ({ __auto_type _lst = struct_key_types; size_t _idx = (size_t)i; slop_option_string _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1317.has_value) {
                __auto_type c_type = _mv_1317.value;
                {
                    __auto_type guard_name = context_ctx_str3(ctx, transpiler_uppercase_name(ctx, c_type), SLOP_STR("_HASH_EQ_DEFINED"), SLOP_STR(""));
...
void transpiler_emit_chan_types_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1318 = ({ __auto_type _lst = chan_types; size_t _idx = (size_t)i; slop_option_context_ChanType _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1318.has_value) {
                __auto_type ct = _mv_1318.value;
                {
...
void transpiler_emit_chan_funcs_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1319 = ({ __auto_type _lst = chan_types; size_t _idx = (size_t)i; slop_option_context_ChanType _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1319.has_value) {
                __auto_type ct = _mv_1319.value;
                {
                    __auto_type elem_type = ct.elem_type;
                    __auto_type c_name = ct.c_name;
...
void transpiler_emit_thread_types_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1320 = ({ __auto_type _lst = thread_types; size_t _idx = (size_t)i; slop_option_context_ThreadType _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1320.has_value) {
                __auto_type tt = _mv_1320.value;
                {
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1321.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 3)) {
                    ...
                    __auto_type _mv_1322 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_1322.has_value) {
                        __auto_type def_expr = _mv_1322.value;
                        __auto_type _mv_1323 = (*def_expr);
                        switch (_mv_1323.tag) {
                            case types_SExpr_lst:
                            {
                                __auto_type def_lst = _mv_1323.data.lst;
                                {
                                    __auto_type def_items = def_lst.items;
                                    if ((((int64_t)((def_items).len)) < 1)) {
                                        return 0;
                                    } else {
                                        __auto_type _mv_1324 = ({ __auto_type _lst = def_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_1324.has_value) {
                                            __auto_type head = _mv_1324.value;
                                            __auto_type _mv_1325 = (*head);
                                            switch (_mv_1325.tag) {
                                                case types_SExpr_sym:
                                                {
...
void transpiler_emit_pending_container_deps(context_TranspileContext* ctx, types_SExpr* type_def) {
    ...
    SLOP_PRE(((type_def != NULL)), "(!= type-def nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1332 = ({ __auto_type _lst = field_types; size_t _idx = (size_t)i; slop_option_string _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1332.has_value) {
                __auto_type field_type = _mv_1332.value;
            ...
            prev_count = current_count;
            {
                ...
                while ((i < len)) {
                    if (!(transpiler_index_in_list(emitted, i))) {
                        __auto_type _mv_1335 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
uint8_t transpiler_index_in_list(slop_list_int lst, int64_t idx) {
    {
        ...
        uint8_t found = 0;
        while (((i < len) && !(found))) {
            __auto_type _mv_1336 = ({ __auto_type _lst = lst; size_t _idx = (size_t)i; slop_option_int _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1336.has_value) {
                __auto_type v = _mv_1336.value;
                if ((v == idx)) {
                    found = 1;
                }
...
uint8_t transpiler_type_deps_satisfied(context_TranspileContext* ctx, types_SExpr* type_def) {
    ...
    SLOP_PRE(((type_def != NULL)), "(!= type-def nil)");
    {
        ...
        while (((i < len) && all_satisfied)) {
            __auto_type _mv_1337 = ({ __auto_type _lst = field_types; size_t _idx = (size_t)i; slop_option_string _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1337.has_value) {
                __auto_type field_type = _mv_1337.value;
...
slop_list_string transpiler_extract_record_field_types(context_TranspileContext* ctx, slop_list_types_SExpr_ptr def_items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 1;
        while ((i < len)) {
            __auto_type _mv_1343 = ({ __auto_type _lst = def_items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1343.has_value) {
                __auto_type field_expr = _mv_1343.value;
                __auto_type _mv_1344 = (*field_expr);
                switch (_mv_1344.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type field_lst = _mv_1344.data.lst;
                        if ((((int64_t)((field_lst.items).len)) >= 2)) {
                            __auto_type _mv_1345 = ({ __auto_type _lst = field_lst.items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_list_string transpiler_extract_union_variant_types(context_TranspileContext* ctx, slop_list_types_SExpr_ptr def_items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 1;
        while ((i < len)) {
            __auto_type _mv_1346 = ({ __auto_type _lst = def_items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1346.has_value) {
                __auto_type variant_expr = _mv_1346.value;
                __auto_type _mv_1347 = (*variant_expr);
                switch (_mv_1347.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type variant_lst = _mv_1347.data.lst;
                        if ((((int64_t)((variant_lst.items).len)) >= 2)) {
                            __auto_type _mv_1348 = ({ __auto_type _lst = variant_lst.items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_1348.has_value) {
                                __auto_type type_expr = _mv_1348.value;
                                {
                                    __auto_type type_str = transpiler_get_field_type_string(ctx, type_expr);
                                    if (!(string_eq(type_str, SLOP_STR("")))) {
                                        ({ __auto_type _lst_p = &(result); __auto_type _item = (type_str); if (_lst_p->len >= _lst_p->cap) { size_t _new_cap = _lst_p->cap == 0 ? 16 : _lst_p->cap * 2; __typeof__(_lst_p->data) _new_data = (__typeof__(_lst_p->data))slop_arena_alloc(arena, _new_cap * sizeof(*_lst_p->data)); if (_lst_p->len > 0) memcpy(_new_data, _lst_p->data, _lst_p->len * sizeof(*_lst_p->data)); _lst_p->data = _new_data; _lst_p->cap = _new_cap; } _lst_p->data[_lst_p->len++] = _item; (void)0; });
...
slop_string transpiler_get_field_type_string(context_TranspileContext* ctx, types_SExpr* type_expr) {
    ...
    SLOP_PRE(((type_expr != NULL)), "(!= type-expr nil)");
    {
        ...
        switch (_mv_1349.tag) {
            case types_SExpr_sym:
            {
                __auto_type sym = _mv_1349.data.sym;
                {
                    ...
                    if (_mv_1350.has_value) {
                        __auto_type entry = _mv_1350.value;
                        return entry.c_name;
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1349.data.lst;
                {
                    __auto_type items = lst.items;
                    if ((((int64_t)((items).len)) < 1)) {
                        return SLOP_STR("");
                                        ...
                                        if (string_eq(kind, SLOP_STR("Ptr"))) {
                                            ...
                                            if ((((int64_t)((items).len)) >= 2)) {
                                                ...
                                                if (_mv_1353.has_value) {
                                                    __auto_type inner = _mv_1353.value;
                                                    {
                                            ...
                                            if ((((int64_t)((items).len)) >= 2)) {
                                                __auto_type _mv_1354 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_1354.has_value) {
                                                    __auto_type inner = _mv_1354.value;
                                                    {
                                                        __auto_type inner_str = transpiler_get_field_type_string(ctx, inner);
                                                        if (string_eq(inner_str, SLOP_STR(""))) {
                                                            return SLOP_STR("");
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1355.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 2)) {
                    ...
                    __auto_type _mv_1356 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_1356.has_value) {
                        ...
                        switch (_mv_1357.tag) {
                            case types_SExpr_sym:
                            {
                                ...
                                {
                                    __auto_type name = sym.name;
                                    __auto_type _mv_1358 = context_ctx_lookup_type(ctx, name);
                                    if (_mv_1358.has_value) {
                                        __auto_type entry = _mv_1358.value;
                                        return entry.c_name;
...
void transpiler_emit_list_for_elem_type(context_TranspileContext* ctx, slop_string elem_c_name) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1360 = ({ __auto_type _lst = list_types; size_t _idx = (size_t)i; slop_option_context_ListType _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        if (!(found)) {
            {
                ...
                int64_t j = 0;
                while (((j < len2) && !(found))) {
                    __auto_type _mv_1362 = ({ __auto_type _lst = option_types; size_t _idx = (size_t)j; slop_option_context_OptionType _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void transpiler_emit_struct_dependent_list_types(context_TranspileContext* ctx, types_SExpr* type_def) {
    ...
    SLOP_PRE(((type_def != NULL)), "(!= type-def nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1363 = ({ __auto_type _lst = list_types; size_t _idx = (size_t)i; slop_option_context_ListType _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void transpiler_emit_struct_dependent_option_types(context_TranspileContext* ctx, types_SExpr* type_def) {
    ...
    SLOP_PRE(((type_def != NULL)), "(!= type-def nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1364 = ({ __auto_type _lst = option_types; size_t _idx = (size_t)i; slop_option_context_OptionType _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1364.has_value) {
                __auto_type ot = _mv_1364.value;
                if ((!(transpiler_is_pointer_elem_type(ot.inner_type)) && transpiler_struct_uses_option_type(ctx, type_def, ot.c_name))) {
...
void transpiler_emit_struct_dependent_list_types_safe(context_TranspileContext* ctx, types_SExpr* type_def) {
    ...
    SLOP_PRE(((type_def != NULL)), "(!= type-def nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1365 = ({ __auto_type _lst = list_types; size_t _idx = (size_t)i; slop_option_context_ListType _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void transpiler_emit_struct_dependent_option_types_safe(context_TranspileContext* ctx, types_SExpr* type_def) {
    ...
    SLOP_PRE(((type_def != NULL)), "(!= type-def nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1366 = ({ __auto_type _lst = option_types; size_t _idx = (size_t)i; slop_option_context_OptionType _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1366.has_value) {
                __auto_type ot = _mv_1366.value;
                if ((!(transpiler_is_pointer_elem_type(ot.inner_type)) && transpiler_struct_uses_option_type(ctx, type_def, ot.c_name))) {
...
uint8_t transpiler_is_imported_type(context_TranspileContext* ctx, slop_string type_name) {
    ...
    if ((strlib_starts_with(type_name, SLOP_STR("slop_list_")) || strlib_starts_with(type_name, SLOP_STR("slop_option_")))) {
        ...
        if (_mv_1367.has_value) {
            __auto_type current_mod = _mv_1367.value;
            {
                __auto_type arena = (*ctx).arena;
    ...
    if (strlib_starts_with(inner_type, SLOP_STR("slop_list_"))) {
        {
            ...
            int64_t i = 0;
            while ((i < len)) {
                __auto_type _mv_1368 = ({ __auto_type _lst = list_types; size_t _idx = (size_t)i; slop_option_context_ListType _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_1368.has_value) {
                    __auto_type lt = _mv_1368.value;
    ...
    if (strlib_starts_with(inner_type, SLOP_STR("slop_list_"))) {
        {
            ...
            int64_t i = 0;
            while ((i < len)) {
                __auto_type _mv_1369 = ({ __auto_type _lst = list_types; size_t _idx = (size_t)i; slop_option_context_ListType _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_1369.has_value) {
                    __auto_type lt = _mv_1369.value;
                ...
                __auto_type lst = _mv_1370.data.lst;
                {
                    ...
                    if ((((int64_t)((items).len)) < 3)) {
                        ...
                        if (_mv_1371.has_value) {
                            __auto_type body_expr = _mv_1371.value;
...
uint8_t transpiler_type_body_uses_typename(context_TranspileContext* ctx, types_SExpr* body_expr, slop_string typename) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1372 = (*body_expr);
        switch (_mv_1372.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1372.data.lst;
                {
                    ...
                    while (((i < len) && !(found))) {
                        ...
                        if (_mv_1373.has_value) {
                            __auto_type field_expr = _mv_1373.value;
...
uint8_t transpiler_field_uses_typename(context_TranspileContext* ctx, types_SExpr* field_expr, slop_string typename) {
    ...
    __auto_type _mv_1374 = (*field_expr);
    switch (_mv_1374.tag) {
        case types_SExpr_lst:
        {
...
void transpiler_emit_type_to_header(context_TranspileContext* ctx, types_SExpr* type_def) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1376 = (*type_def);
        switch (_mv_1376.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1376.data.lst;
                {
                    __auto_type items = lst.items;
                    __auto_type len = ((int64_t)((items).len));
                    if ((len >= 3)) {
                        __auto_type _mv_1377 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            ...
                            switch (_mv_1378.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_1378.data.sym;
                                    {
                                        ...
                                        __auto_type base_name = ctype_to_c_name(arena, type_name);
                                        __auto_type c_name = ((context_ctx_prefixing_enabled(ctx)) ? ({ __auto_type _mv = context_ctx_get_module(ctx); _mv.has_value ? ({ __auto_type mod_name = _mv.value; context_ctx_str(ctx, ctype_to_c_name(arena, mod_name), context_ctx_str(ctx, SLOP_STR("_"), base_name)); }) : (base_name); }) : base_name);
                                        __auto_type _mv_1379 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_1379.has_value) {
                                            __auto_type body_expr = _mv_1379.value;
...
void transpiler_emit_type_body_to_header(context_TranspileContext* ctx, slop_string raw_type_name, slop_string c_name, types_SExpr* body_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1380 = (*body_expr);
        switch (_mv_1380.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1380.data.lst;
                {
                    ...
                    if ((((int64_t)((items).len)) < 1)) {
                        ...
                        __auto_type _mv_1381 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_1381.has_value) {
                            __auto_type kind_expr = _mv_1381.value;
                            __auto_type _mv_1382 = (*kind_expr);
                            switch (_mv_1382.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type kind_sym = _mv_1382.data.sym;
                                    {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while ((i < len)) {
            ...
            if (_mv_1383.has_value) {
                __auto_type variant_expr = _mv_1383.value;
                __auto_type _mv_1384 = (*variant_expr);
                switch (_mv_1384.tag) {
                    case types_SExpr_sym:
                    {
                        __auto_type variant_sym = _mv_1384.data.sym;
                        {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while ((i < len)) {
            ...
            if (_mv_1385.has_value) {
                __auto_type field_expr = _mv_1385.value;
...
void transpiler_emit_field_to_header(context_TranspileContext* ctx, slop_string raw_type_name, slop_string c_type_name, types_SExpr* field_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1386 = (*field_expr);
        switch (_mv_1386.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1386.data.lst;
                {
                    __auto_type items = lst.items;
                    if ((((int64_t)((items).len)) >= 2)) {
                        __auto_type _mv_1387 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_1387.has_value) {
                            __auto_type name_expr = _mv_1387.value;
                            __auto_type _mv_1388 = (*name_expr);
                            switch (_mv_1388.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_1388.data.sym;
                                    {
...
uint8_t transpiler_is_pointer_type_expr_header(types_SExpr* type_expr) {
    SLOP_PRE(((type_expr != NULL)), "(!= type-expr nil)");
    __auto_type _mv_1390 = (*type_expr);
    switch (_mv_1390.tag) {
        case types_SExpr_lst:
        {
...
void transpiler_emit_union_to_header(context_TranspileContext* ctx, slop_string c_name, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        context_ctx_emit_header(ctx, SLOP_STR("typedef enum {"));
        {
            int64_t i = 1;
            while ((i < len)) {
                __auto_type _mv_1393 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_1393.has_value) {
                    __auto_type variant_expr = _mv_1393.value;
                    {
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1395.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    __auto_type _mv_1396 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_1396.has_value) {
                        __auto_type name_expr = _mv_1396.value;
                        __auto_type _mv_1397 = (*name_expr);
                        switch (_mv_1397.tag) {
                            case types_SExpr_sym:
                            {
                                __auto_type name_sym = _mv_1397.data.sym;
...
void transpiler_emit_union_variant_to_header(context_TranspileContext* ctx, types_SExpr* variant_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1398 = (*variant_expr);
        switch (_mv_1398.tag) {
            case types_SExpr_sym:
            {
                ...
                __auto_type lst = _mv_1398.data.lst;
                {
                    ...
                    if ((((int64_t)((items).len)) >= 2)) {
                        ...
                        if (_mv_1399.has_value) {
                            __auto_type name_expr = _mv_1399.value;
                            __auto_type _mv_1400 = (*name_expr);
                            switch (_mv_1400.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_1400.data.sym;
                                    {
                                        __auto_type variant_name = name_sym.name;
                                        ...
                                        if (_mv_1401.has_value) {
                                            __auto_type type_expr = _mv_1401.value;
                                            {
                                                __auto_type c_type = context_to_c_type_prefixed(ctx, type_expr);
                                                {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while ((i < len)) {
            ...
            if (_mv_1402.has_value) {
                __auto_type item = _mv_1402.value;
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1407.data.lst;
            {
                ...
                if ((((int64_t)((const_items).len)) < 4)) {
                    ...
                    __auto_type _mv_1408 = ({ __auto_type _lst = const_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_1408.has_value) {
                        __auto_type name_expr = _mv_1408.value;
                        __auto_type _mv_1409 = (*name_expr);
                        switch (_mv_1409.tag) {
                            case types_SExpr_sym:
                            {
                                __auto_type name_sym = _mv_1409.data.sym;
                                {
                                    __auto_type raw_name = name_sym.name;
                                    if (!(transpiler_list_contains_str(exports, raw_name))) {
                                        return 0;
                                    } else {
                                        __auto_type _mv_1410 = ({ __auto_type _lst = const_items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_1410.has_value) {
                                            __auto_type type_expr = _mv_1410.value;
...
void transpiler_emit_all_lambdas(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((count > 0)) {
            while ((i < count)) {
                __auto_type _mv_1412 = ({ __auto_type _lst = lambdas; size_t _idx = (size_t)i; slop_option_string _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_1412.has_value) {
                    __auto_type lambda_code = _mv_1412.value;
...
slop_string transpiler_generate_c_output(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1413 = ({ __auto_type _lst = output_lines; size_t _idx = (size_t)i; slop_option_string _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1413.has_value) {
                __auto_type line = _mv_1413.value;
...
void transpiler_transpile_file(context_TranspileContext* ctx, slop_list_types_SExpr_ptr exprs) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (((len > 0) && transpiler_is_module_expr(exprs))) {
            __auto_type _mv_1414 = ({ __auto_type _lst = exprs; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1414.has_value) {
                __auto_type module_expr = _mv_1414.value;
...
uint8_t transpiler_is_module_expr(slop_list_types_SExpr_ptr exprs) {
    if ((((int64_t)((exprs).len)) < 1)) {
        ...
        __auto_type _mv_1415 = ({ __auto_type _lst = exprs; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        if (_mv_1415.has_value) {
            __auto_type first = _mv_1415.value;
            __auto_type _mv_1416 = (*first);
            switch (_mv_1416.tag) {
                case types_SExpr_lst:
                {
                    __auto_type lst = _mv_1416.data.lst;
                    {
                        ...
                        if ((((int64_t)((items).len)) < 1)) {
                            ...
                            __auto_type _mv_1417 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
