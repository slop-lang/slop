                    ...
                    case types_SExpr_lst:
                    {
                        __auto_type lst = _mv_1117.data.lst;
                        {
                            ...
                            if (((int64_t)((sub_items).len)) >= 1) {
                                __auto_type _mv_1118 = ({ __auto_type _lst = sub_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        ...
                                        case types_SExpr_sym:
                                        {
                                            ...
                                            if (string_eq(sym.name, SLOP_STR("@generic"))) {
                                                if (((int64_t)((sub_items).len)) >= 2) {
                                                    __auto_type _mv_1120 = ({ __auto_type _lst = sub_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_1120.has_value) {
                                                        __auto_type params_expr = _mv_1120.value;
                                                        __auto_type _mv_1121 = (*params_expr);
                                                        switch (_mv_1121.tag) {
                                                            case types_SExpr_lst:
                                                            {
                                                                __auto_type params_lst = _mv_1121.data.lst;
                                                                {
                                                                    __auto_type param_items = params_lst.items;
                                                                    __auto_type param_len = ((int64_t)((param_items).len));
                                                                    __auto_type j = 0;
                                                                    while (j < param_len) {
                                                                        __auto_type _mv_1122 = ({ __auto_type _lst = param_items; size_t _idx = (size_t)j; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                                        if (_mv_1122.has_value) {
                                                                            ...
                                                                            switch (_mv_1123.tag) {
                                                                                case types_SExpr_sym:
                                                                                {
                                                                                    __auto_type param_sym = _mv_1123.data.sym;
                                                            ...
                                                            case types_SExpr_sym:
                                                            {
                                                                __auto_type single_sym = _mv_1121.data.sym;
                            ...
                            __auto_type c_name = ((context_ctx_prefixing_enabled(ctx)) ? ({ __auto_type _mv = context_ctx_get_module(ctx); _mv.has_value ? ({ __auto_type mod_name = _mv.value; context_ctx_str(ctx, ctype_to_c_name(arena, mod_name), context_ctx_str(ctx, SLOP_STR("_"), base_c_name)); }) : (base_c_name); }) : base_c_name);
                            {
                                ...
                                if (((int64_t)((items).len)) >= 3) {
                                    ...
                                    if (_mv_1132.has_value) {
                                        __auto_type body_expr = _mv_1132.value;
            ...
            switch (_mv_1134.tag) {
                case types_SExpr_lst:
                {
                    __auto_type def_lst = _mv_1134.data.lst;
                    {
                        ...
                        __auto_type i = 1;
                        while (i < len) {
                            __auto_type _mv_1135 = ({ __auto_type _lst = def_items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_1135.has_value) {
                                __auto_type variant_expr = _mv_1135.value;
                                __auto_type _mv_1136 = (*variant_expr);
                                switch (_mv_1136.tag) {
                                    case types_SExpr_sym:
                                    {
                                    ...
                                    case types_SExpr_lst:
                                    {
                                        __auto_type variant_lst = _mv_1136.data.lst;
                                        if (((int64_t)((variant_lst.items).len)) > 0) {
                                            __auto_type _mv_1137 = ({ __auto_type _lst = variant_lst.items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_1137.has_value) {
                                                __auto_type name_expr = _mv_1137.value;
                                                __auto_type _mv_1138 = (*name_expr);
                                                switch (_mv_1138.tag) {
                                                    case types_SExpr_sym:
                                                    {
                                                        __auto_type name_sym = _mv_1138.data.sym;
...
void transpiler_register_union_variants(context_TranspileContext* ctx, slop_string union_name, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        __auto_type arena = (*ctx).arena;
        if (((int64_t)((items).len)) >= 3) {
            __auto_type _mv_1139 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1139.has_value) {
                __auto_type def_expr = _mv_1139.value;
                __auto_type _mv_1140 = (*def_expr);
                switch (_mv_1140.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type def_lst = _mv_1140.data.lst;
                        {
                            __auto_type def_items = def_lst.items;
                            __auto_type len = ((int64_t)((def_items).len));
                            __auto_type i = 1;
                            while (i < len) {
                                __auto_type _mv_1141 = ({ __auto_type _lst = def_items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1141.has_value) {
                                    __auto_type variant_expr = _mv_1141.value;
                                    __auto_type _mv_1142 = (*variant_expr);
                                    switch (_mv_1142.tag) {
                                        case types_SExpr_sym:
                                        {
                                        ...
                                        case types_SExpr_lst:
                                        {
                                            __auto_type variant_lst = _mv_1142.data.lst;
                                            {
                                                __auto_type vl_items = variant_lst.items;
                                                __auto_type vl_len = ((int64_t)((vl_items).len));
                                                if (vl_len >= 2) {
                                                    __auto_type _mv_1143 = ({ __auto_type _lst = vl_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_1143.has_value) {
                                                        __auto_type name_expr = _mv_1143.value;
                                                        __auto_type _mv_1144 = (*name_expr);
                                                        switch (_mv_1144.tag) {
                                                            case types_SExpr_sym:
                                                            {
                                                                __auto_type name_sym = _mv_1144.data.sym;
                                                                {
                                                                    __auto_type variant_name = name_sym.name;
                                                                    __auto_type c_variant_name = ctype_to_c_name(arena, variant_name);
                                                                    context_ctx_register_enum_variant(ctx, variant_name, union_name);
                                                                    __auto_type _mv_1145 = ({ __auto_type _lst = vl_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                                    ...
                                                                    if (vl_len >= 3) {
                                                                        ...
                                                                        for (int64_t fi = 1; fi < vl_len; fi++) {
                                                                            __auto_type _mv_1146 = ({ __auto_type _lst = vl_items; size_t _idx = (size_t)fi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    ...
                                                    if (((int64_t)((vl_items).len)) == 1) {
                                                        __auto_type _mv_1147 = ({ __auto_type _lst = vl_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void transpiler_prescan_fn(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        __auto_type arena = (*ctx).arena;
        if (((int64_t)((items).len)) >= 2) {
            __auto_type _mv_1149 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                            ...
                                                            __auto_type body_lst = _mv_1156.data.lst;
                                                            {
                                                                ...
                                                                if (body_len >= 1) {
                                                                    ...
                                                                    if (_mv_1157.has_value) {
                                                                        ...
                                                                        __auto_type _mv_1158 = (*ret_type);
                                                                        switch (_mv_1158.tag) {
                                                                            case types_SExpr_sym:
                                                                            {
                                                                                __auto_type ret_sym = _mv_1158.data.sym;
                ...
                switch (_mv_1160.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type lst = _mv_1160.data.lst;
                        {
                            __auto_type sub_items = lst.items;
                            if (((int64_t)((sub_items).len)) >= 2) {
                                __auto_type _mv_1161 = ({ __auto_type _lst = sub_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1161.has_value) {
                                    ...
                                    switch (_mv_1162.tag) {
                                        case types_SExpr_sym:
                                        {
                                            ...
                                            if (string_eq(sym.name, SLOP_STR("@spec"))) {
                                                __auto_type _mv_1163 = ({ __auto_type _lst = sub_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_1163.has_value) {
                                                    __auto_type spec_body = _mv_1163.value;
                                                    __auto_type _mv_1164 = (*spec_body);
                                                    switch (_mv_1164.tag) {
                                                        case types_SExpr_lst:
                                                        {
                                                            __auto_type body_lst = _mv_1164.data.lst;
                                                            {
                                                                __auto_type body_items = body_lst.items;
                                                                __auto_type body_len = ((int64_t)((body_items).len));
                                                                if (body_len >= 1) {
                                                                    __auto_type _mv_1165 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)(body_len - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                                    if (_mv_1165.has_value) {
                                                                        __auto_type ret_type = _mv_1165.value;
...
void transpiler_prescan_fn_params(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    if (((int64_t)((items).len)) >= 3) {
        __auto_type _mv_1166 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            ...
            switch (_mv_1167.tag) {
                case types_SExpr_lst:
                {
                    __auto_type params_lst = _mv_1167.data.lst;
                    {
                        ...
                        __auto_type i = 0;
                        while (i < param_count) {
                            __auto_type _mv_1168 = ({ __auto_type _lst = params; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_1168.has_value) {
                                __auto_type param_expr = _mv_1168.value;
                                __auto_type _mv_1169 = (*param_expr);
                                switch (_mv_1169.tag) {
                                    case types_SExpr_lst:
                                    {
                                        __auto_type param_lst = _mv_1169.data.lst;
                                        {
                                            __auto_type param_items = param_lst.items;
                                            if (((int64_t)((param_items).len)) >= 2) {
                                                __auto_type _mv_1170 = ({ __auto_type _lst = param_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (((int64_t)((items).len)) >= 3) {
            ...
            if (_mv_1171.has_value) {
                __auto_type params_expr = _mv_1171.value;
                __auto_type _mv_1172 = (*params_expr);
                switch (_mv_1172.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type params_lst = _mv_1172.data.lst;
                        {
                            __auto_type params = params_lst.items;
                            __auto_type param_count = ((int64_t)((params).len));
                            __auto_type i = 0;
                            while (i < param_count) {
                                __auto_type _mv_1173 = ({ __auto_type _lst = params; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1173.has_value) {
                                    __auto_type param_expr = _mv_1173.value;
                                    {
                ...
                __auto_type lst = _mv_1174.data.lst;
                {
                    ...
                    if (len < 2) {
                    ...
                    } else {
                        {
                            ...
                            __auto_type _mv_1175 = ({ __auto_type _lst = items; size_t _idx = (size_t)type_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
uint8_t transpiler_prescan_is_param_mode(slop_list_types_SExpr_ptr items) {
    if (((int64_t)((items).len)) < 1) {
        ...
        __auto_type _mv_1176 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        if (_mv_1176.has_value) {
            __auto_type first = _mv_1176.value;
            __auto_type _mv_1177 = (*first);
            switch (_mv_1177.tag) {
                case types_SExpr_sym:
                {
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1179.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 1) {
                    ...
                    __auto_type _mv_1180 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void transpiler_extract_result_type(context_TranspileContext* ctx, types_SExpr* spec_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1182 = (*spec_expr);
        switch (_mv_1182.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1182.data.lst;
                {
                    __auto_type items = lst.items;
                    if (((int64_t)((items).len)) >= 2) {
                        __auto_type _mv_1183 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_1183.has_value) {
                            __auto_type spec_body = _mv_1183.value;
                            __auto_type _mv_1184 = (*spec_body);
                            switch (_mv_1184.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type body_lst = _mv_1184.data.lst;
                                    {
                                        ...
                                        __auto_type body_len = ((int64_t)((body_items).len));
                                        if (body_len >= 1) {
                                            __auto_type _mv_1185 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)(body_len - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_1185.has_value) {
                                                __auto_type ret_type = _mv_1185.value;
...
void transpiler_check_and_register_result_type(context_TranspileContext* ctx, types_SExpr* type_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1186 = (*type_expr);
        switch (_mv_1186.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1186.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) >= 3) {
                        ...
                        if (_mv_1187.has_value) {
                            __auto_type head = _mv_1187.value;
                            __auto_type _mv_1188 = (*head);
                            switch (_mv_1188.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type sym = _mv_1188.data.sym;
                                    if (string_eq(sym.name, SLOP_STR("Result"))) {
                                        ...
                                        if (_mv_1189.has_value) {
                                            __auto_type ok_type_expr = _mv_1189.value;
                                            __auto_type _mv_1190 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_1190.has_value) {
                                                __auto_type err_type_expr = _mv_1190.value;
                                                {
    ...
    switch (_mv_1192.tag) {
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1192.data.lst;
            {
                ...
                __auto_type len = ((int64_t)((items).len));
                if (len >= 1) {
                    __auto_type _mv_1193 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            ...
                            case types_SExpr_sym:
                            {
                                __auto_type sym = _mv_1194.data.sym;
                                {
                                    ...
                                    if (string_eq(name, SLOP_STR("map-new"))) {
                                        if (len >= 3) {
                                            __auto_type _mv_1195 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_1195.has_value) {
                                                __auto_type key_type_expr = _mv_1195.value;
                                        ...
                                        if (len >= 3) {
                                            __auto_type _mv_1196 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_1196.has_value) {
                                                __auto_type elem_type_expr = _mv_1196.value;
                                        ...
                                        if (len >= 4) {
                                            __auto_type _mv_1197 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        ...
                                        if (len >= 3) {
                                            ...
                                            if (_mv_1198.has_value) {
                                                __auto_type type_expr = _mv_1198.value;
                                                {
                                                    __auto_type elem_c = context_to_c_type_prefixed(ctx, type_expr);
                                                    __auto_type elem_id = ctype_type_to_identifier((*ctx).arena, elem_c);
                                                    __auto_type c_name = context_ctx_str(ctx, SLOP_STR("slop_chan_"), elem_id);
                                    ...
                                    } else {
                                        {
                                            ...
                                            while (i < len) {
                                                ...
                                                if (_mv_1199.has_value) {
                                                    __auto_type child = _mv_1199.value;
                            ...
                            default: {
                                {
                                    __auto_type i = 0;
                                    while (i < len) {
                                        __auto_type _mv_1200 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_1200.has_value) {
                                            __auto_type child = _mv_1200.value;
                                            transpiler_prescan_expr_for_struct_keys(ctx, child);
...
void transpiler_prescan_register_struct_key_type(context_TranspileContext* ctx, types_SExpr* type_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1201 = (*type_expr);
        switch (_mv_1201.tag) {
            case types_SExpr_sym:
            {
                __auto_type sym = _mv_1201.data.sym;
                {
                    ...
                    if (!(transpiler_is_builtin_map_key_type(name))) {
                        __auto_type _mv_1202 = context_ctx_lookup_type(ctx, name);
                        if (_mv_1202.has_value) {
                            __auto_type type_entry = _mv_1202.value;
                            context_ctx_register_struct_key_type(ctx, type_entry.c_name);
                        } else if (!_mv_1202.has_value) {
                            __auto_type _mv_1203 = context_ctx_get_module(ctx);
                            if (_mv_1203.has_value) {
                                __auto_type mod = _mv_1203.value;
                                {
                                    __auto_type prefixed = context_ctx_str3(ctx, mod, SLOP_STR("_"), name);
                                    __auto_type _mv_1204 = context_ctx_lookup_type(ctx, prefixed);
                                    if (_mv_1204.has_value) {
                                        __auto_type type_entry = _mv_1204.value;
                                        context_ctx_register_struct_key_type(ctx, type_entry.c_name);
        ...
        switch (_mv_1205.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1205.data.lst;
                {
                    __auto_type items = lst.items;
                    if (((int64_t)((items).len)) >= 3) {
                        __auto_type _mv_1206 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_1206.has_value) {
                            __auto_type head = _mv_1206.value;
                            __auto_type _mv_1207 = (*head);
                            switch (_mv_1207.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type sym = _mv_1207.data.sym;
                                    if (string_eq(sym.name, SLOP_STR("Result"))) {
                                        __auto_type _mv_1208 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_1208.has_value) {
                                            __auto_type ok_type_expr = _mv_1208.value;
                                            __auto_type _mv_1209 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_1209.has_value) {
                                                __auto_type err_type_expr = _mv_1209.value;
                                                {
                                                    __auto_type ok_c_type = context_to_c_type_prefixed(ctx, ok_type_expr);
                                                    __auto_type err_c_type = context_to_c_type_prefixed(ctx, err_type_expr);
                                                    __auto_type result_name = transpiler_build_result_type_name(ctx, ok_c_type, err_c_type);
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len >= 2) {
            ...
            if (_mv_1210.has_value) {
                __auto_type header_expr = _mv_1210.value;
                __auto_type _mv_1211 = (*header_expr);
                switch (_mv_1211.tag) {
                    case types_SExpr_str:
                    {
                        __auto_type str = _mv_1211.data.str;
            ...
            }
            {
                ...
                while (i < len) {
                    ...
                    if (_mv_1212.has_value) {
                        __auto_type func_decl = _mv_1212.value;
...
void transpiler_prescan_import(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    if (((int64_t)((items).len)) >= 3) {
        __auto_type _mv_1213 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        if (_mv_1213.has_value) {
            __auto_type mod_expr = _mv_1213.value;
            __auto_type _mv_1214 = (*mod_expr);
            switch (_mv_1214.tag) {
                case types_SExpr_sym:
                {
                    __auto_type mod_sym = _mv_1214.data.sym;
                    {
                        ...
                        if (_mv_1215.has_value) {
                            __auto_type symbols_expr = _mv_1215.value;
                            __auto_type _mv_1216 = (*symbols_expr);
                            switch (_mv_1216.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type symbols_lst = _mv_1216.data.lst;
                                    {
                                        __auto_type syms = symbols_lst.items;
                                        __auto_type sym_len = ((int64_t)((syms).len));
                                        __auto_type j = 0;
                                        while (j < sym_len) {
                                            __auto_type _mv_1217 = ({ __auto_type _lst = syms; size_t _idx = (size_t)j; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_1217.has_value) {
                                                __auto_type sym_item = _mv_1217.value;
                                                __auto_type _mv_1218 = (*sym_item);
                                                switch (_mv_1218.tag) {
                                                    case types_SExpr_sym:
                                                    {
                                                        __auto_type s = _mv_1218.data.sym;
                                                        {
...
void transpiler_prescan_const(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        __auto_type arena = (*ctx).arena;
        if (((int64_t)((items).len)) >= 3) {
            __auto_type _mv_1219 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void transpiler_register_ffi_function(context_TranspileContext* ctx, types_SExpr* func_decl) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1221 = (*func_decl);
        switch (_mv_1221.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1221.data.lst;
                {
                    __auto_type items = lst.items;
                    __auto_type len = ((int64_t)((items).len));
                    if (len >= 1) {
                        __auto_type _mv_1222 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_list_context_FuncParamType_ptr transpiler_extract_ffi_param_types(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        __auto_type result = ((slop_list_context_FuncParamType_ptr){ .data = (context_FuncParamType**)slop_arena_alloc(arena, 16 * sizeof(context_FuncParamType*)), .len = 0, .cap = 16 });
        if (((int64_t)((items).len)) >= 2) {
            __auto_type _mv_1224 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1224.has_value) {
                __auto_type params_expr = _mv_1224.value;
                __auto_type _mv_1225 = (*params_expr);
                switch (_mv_1225.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type params_lst = _mv_1225.data.lst;
                        {
                            __auto_type params = params_lst.items;
                            __auto_type param_count = ((int64_t)((params).len));
                            __auto_type i = 0;
                            while (i < param_count) {
                                __auto_type _mv_1226 = ({ __auto_type _lst = params; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1226.has_value) {
                                    __auto_type param_expr = _mv_1226.value;
                                    {
                                        __auto_type c_type = transpiler_prescan_get_param_c_type(ctx, param_expr);
                                        __auto_type param_info = ((context_FuncParamType*)(({ __auto_type _alloc = (context_FuncParamType*)slop_arena_alloc(arena, sizeof(context_FuncParamType)); if (_alloc == NULL) { fprintf(stderr, "SLOP: arena alloc failed at %s:%d\n", __FILE__, __LINE__); abort(); } _alloc; })));
                                        (*param_info).c_type = c_type;
...
slop_string transpiler_extract_ffi_c_name(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items, slop_string fn_name) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            __auto_type _mv_1227 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1227.has_value) {
                __auto_type item_expr = _mv_1227.value;
                __auto_type _mv_1228 = (*item_expr);
                switch (_mv_1228.tag) {
                    case types_SExpr_sym:
                    {
                        __auto_type sym = _mv_1228.data.sym;
                        if (string_eq(sym.name, SLOP_STR(":c-name"))) {
                            __auto_type _mv_1229 = ({ __auto_type _lst = items; size_t _idx = (size_t)(i + 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_1229.has_value) {
                                __auto_type c_name_expr = _mv_1229.value;
                                __auto_type _mv_1230 = (*c_name_expr);
                                switch (_mv_1230.tag) {
                                    case types_SExpr_sym:
                                    {
                                        __auto_type c_sym = _mv_1230.data.sym;
                                        c_name = c_sym.name;
                                        found_c_name = 1;
                                        break;
                                    }
        ...
        if (len >= 2) {
            {
                ...
                if (has_header) {
                    __auto_type _mv_1231 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_1231.has_value) {
                        __auto_type header_expr = _mv_1231.value;
                        __auto_type _mv_1232 = (*header_expr);
                        switch (_mv_1232.tag) {
                            case types_SExpr_str:
                            {
                                __auto_type str = _mv_1232.data.str;
                                context_ctx_add_include(ctx, str.value);
                                break;
                            }
                            default: {
                ...
                if (len >= (name_idx + 1)) {
                    __auto_type _mv_1233 = ({ __auto_type _lst = items; size_t _idx = (size_t)name_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_string transpiler_get_ffi_struct_c_name(slop_arena* arena, slop_list_types_SExpr_ptr items, int64_t name_idx, slop_string default_name) {
    {
        ...
        if (len >= (modifier_idx + 2)) {
            __auto_type _mv_1235 = ({ __auto_type _lst = items; size_t _idx = (size_t)modifier_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1235.has_value) {
                __auto_type mod_expr = _mv_1235.value;
                __auto_type _mv_1236 = (*mod_expr);
                switch (_mv_1236.tag) {
                    case types_SExpr_sym:
                    {
                        __auto_type sym = _mv_1236.data.sym;
                        if (string_eq(sym.name, SLOP_STR(":c-name"))) {
                            __auto_type _mv_1237 = ({ __auto_type _lst = items; size_t _idx = (size_t)(modifier_idx + 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_1237.has_value) {
                                __auto_type cname_expr = _mv_1237.value;
                                __auto_type _mv_1238 = (*cname_expr);
                                switch (_mv_1238.tag) {
                                    case types_SExpr_str:
                                    {
...
uint8_t transpiler_is_ffi_string_item(slop_list_types_SExpr_ptr items, int64_t idx) {
    __auto_type _mv_1239 = ({ __auto_type _lst = items; size_t _idx = (size_t)idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    if (_mv_1239.has_value) {
        ...
        switch (_mv_1240.tag) {
            case types_SExpr_str:
            {
                __auto_type _ = _mv_1240.data.str;
                return 1;
            }
            default: {
                return 0;
                ...
                case types_SExpr_lst:
                {
                    __auto_type def_lst = _mv_1246.data.lst;
                    {
                        ...
                        if (((int64_t)((def_items).len)) < 1) {
                            ...
                            __auto_type _mv_1247 = ({ __auto_type _lst = def_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
uint8_t transpiler_is_union_def(slop_list_types_SExpr_ptr items) {
    if (((int64_t)((items).len)) < 3) {
        ...
        if (_mv_1249.has_value) {
            __auto_type def_expr = _mv_1249.value;
            __auto_type _mv_1250 = (*def_expr);
            switch (_mv_1250.tag) {
                case types_SExpr_lst:
                {
                    __auto_type def_lst = _mv_1250.data.lst;
                    {
                        __auto_type def_items = def_lst.items;
                        if (((int64_t)((def_items).len)) < 1) {
                            return 0;
                        } else {
                            __auto_type _mv_1251 = ({ __auto_type _lst = def_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_string transpiler_get_array_c_type(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items, slop_string default_c_type) {
    ...
    if (((int64_t)((items).len)) < 3) {
        ...
        if (_mv_1253.has_value) {
            __auto_type body_expr = _mv_1253.value;
            __auto_type _mv_1254 = (*body_expr);
            switch (_mv_1254.tag) {
                case types_SExpr_lst:
                {
                    __auto_type body_lst = _mv_1254.data.lst;
                    {
                        ...
                        if (((int64_t)((body_items).len)) < 2) {
                            ...
                            __auto_type _mv_1255 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                ...
                                switch (_mv_1256.tag) {
                                    case types_SExpr_sym:
                                    {
                                        ...
                                        if (string_eq(sym.name, SLOP_STR("Array"))) {
                                            __auto_type _mv_1257 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_1257.has_value) {
                                                __auto_type elem_expr = _mv_1257.value;
                                                {
...
void transpiler_emit_all_types(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1258 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1260.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 3) {
                    ...
                    __auto_type _mv_1261 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            ...
                            case types_SExpr_lst:
                            {
                                __auto_type def_lst = _mv_1262.data.lst;
                                {
                                    ...
                                    if (((int64_t)((def_items).len)) < 1) {
                                        ...
                                        __auto_type _mv_1263 = ({ __auto_type _lst = def_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1265.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 1) {
                    ...
                    __auto_type _mv_1266 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void transpiler_emit_all_functions(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1268 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1269.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 1) {
                    ...
                    __auto_type _mv_1270 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_1270.has_value) {
                        __auto_type head = _mv_1270.value;
                        __auto_type _mv_1271 = (*head);
                        switch (_mv_1271.tag) {
                            case types_SExpr_sym:
                            {
...
void transpiler_transpile_module(context_TranspileContext* ctx, types_SExpr* module_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1272 = (*module_expr);
        switch (_mv_1272.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1272.data.lst;
                {
                    ...
                    __auto_type len = ((int64_t)((items).len));
                    if (len >= 2) {
                        __auto_type _mv_1273 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_1273.has_value) {
                            __auto_type name_expr = _mv_1273.value;
                            __auto_type _mv_1274 = (*name_expr);
                            switch (_mv_1274.tag) {
                                case types_SExpr_sym:
                                {
...
int64_t transpiler_get_body_start(slop_list_types_SExpr_ptr items) {
    if (((int64_t)((items).len)) < 3) {
        ...
        __auto_type _mv_1275 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        if (_mv_1275.has_value) {
            __auto_type third = _mv_1275.value;
            __auto_type _mv_1276 = (*third);
            switch (_mv_1276.tag) {
                case types_SExpr_lst:
                {
                    __auto_type lst = _mv_1276.data.lst;
                    {
                        ...
                        if (((int64_t)((sub_items).len)) < 1) {
                            ...
                            __auto_type _mv_1277 = ({ __auto_type _lst = sub_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_1277.has_value) {
                                __auto_type head = _mv_1277.value;
                                __auto_type _mv_1278 = (*head);
                                switch (_mv_1278.tag) {
                                    case types_SExpr_sym:
                                    {
...
slop_list_string transpiler_get_export_names(slop_arena* arena, slop_list_types_SExpr_ptr items) {
    {
        ...
        int64_t i = 2;
        while (i < len) {
            __auto_type _mv_1279 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                ...
                switch (_mv_1280.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type lst = _mv_1280.data.lst;
                        {
                            __auto_type sub_items = lst.items;
                            if (((int64_t)((sub_items).len)) >= 1) {
                                __auto_type _mv_1281 = ({ __auto_type _lst = sub_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            ...
                                            if (string_eq(sym.name, SLOP_STR("export"))) {
                                                {
                                                    ...
                                                    __auto_type j = 1;
                                                    while (j < export_len) {
                                                        __auto_type _mv_1283 = ({ __auto_type _lst = sub_items; size_t _idx = (size_t)j; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                        if (_mv_1283.has_value) {
                                                            ...
                                                            switch (_mv_1284.tag) {
                                                                case types_SExpr_sym:
                                                                {
                                                                    __auto_type name_sym = _mv_1284.data.sym;
...
uint8_t transpiler_list_contains_str(slop_list_string lst, slop_string needle) {
    {
        ...
        uint8_t found = 0;
        while ((i < len) && !(found)) {
            __auto_type _mv_1285 = ({ __auto_type _lst = lst; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1285.has_value) {
                __auto_type s = _mv_1285.value;
...
void transpiler_prescan_module_body(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items, int64_t start) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = start;
        while (i < len) {
            __auto_type _mv_1286 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void transpiler_scan_type_for_generics(context_TranspileContext* ctx, types_SExpr* type_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1287 = (*type_expr);
        switch (_mv_1287.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1287.data.lst;
                {
                    ...
                    __auto_type len = ((int64_t)((items).len));
                    if (len >= 1) {
                        __auto_type _mv_1288 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        ...
                                        if (string_eq(op, SLOP_STR("Option"))) {
                                            if (len >= 2) {
                                                ...
                                                if (_mv_1290.has_value) {
                                                    __auto_type inner = _mv_1290.value;
                                                    {
                                            ...
                                            if (len >= 2) {
                                                ...
                                                if (_mv_1291.has_value) {
                                                    __auto_type elem = _mv_1291.value;
                                                    {
                                            ...
                                            if (len >= 2) {
                                                __auto_type _mv_1292 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_1292.has_value) {
                                                    __auto_type inner = _mv_1292.value;
                                                    transpiler_scan_type_for_generics(ctx, inner);
                                            ...
                                            if (len >= 3) {
                                                __auto_type _mv_1293 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_1293.has_value) {
                                                    __auto_type ok_type = _mv_1293.value;
                                                    __auto_type _mv_1294 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_1294.has_value) {
                                                        __auto_type err_type = _mv_1294.value;
                                                        {
                                            ...
                                            if (len >= 2) {
                                                __auto_type _mv_1295 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_1295.has_value) {
                                                    __auto_type elem = _mv_1295.value;
                                                    {
                                                        __auto_type elem_c = context_to_c_type_prefixed(ctx, elem);
                                                        __auto_type elem_id = ctype_type_to_identifier(arena, elem_c);
                                                        __auto_type c_name = context_ctx_str(ctx, SLOP_STR("slop_chan_"), elem_id);
                                            ...
                                            if (len >= 2) {
                                                ...
                                                if (_mv_1296.has_value) {
                                                    __auto_type result = _mv_1296.value;
                                                    {
                                            ...
                                            if (len >= 3) {
                                                ...
                                                if (_mv_1297.has_value) {
                                                    __auto_type key_type = _mv_1297.value;
                                                    {
                                                        ...
                                                        if (_mv_1298.has_value) {
                                                            __auto_type val_type = _mv_1298.value;
                                                            {
                                            ...
                                            if (len >= 2) {
                                                __auto_type _mv_1299 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_1299.has_value) {
                                                    __auto_type elem_type = _mv_1299.value;
                                                    {
...
void transpiler_scan_record_fields_for_generics(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 1;
        while (i < len) {
            __auto_type _mv_1300 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1300.has_value) {
                __auto_type field_expr = _mv_1300.value;
                __auto_type _mv_1301 = (*field_expr);
                switch (_mv_1301.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type field_lst = _mv_1301.data.lst;
                        {
                            __auto_type field_items = field_lst.items;
                            if (((int64_t)((field_items).len)) >= 2) {
                                __auto_type _mv_1302 = ({ __auto_type _lst = field_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void transpiler_emit_ffi_includes(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1303 = ({ __auto_type _lst = includes; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1303.has_value) {
                __auto_type header = _mv_1303.value;
...
void transpiler_emit_ffi_includes_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1304 = ({ __auto_type _lst = includes; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1304.has_value) {
                __auto_type header = _mv_1304.value;
...
void transpiler_emit_header_guard_open(context_TranspileContext* ctx) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1305 = context_ctx_get_module(ctx);
        if (_mv_1305.has_value) {
            __auto_type mod_name = _mv_1305.value;
            {
...
void transpiler_emit_header_dependency_includes(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1306 = ({ __auto_type _lst = imports; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1306.has_value) {
                __auto_type mod_name = _mv_1306.value;
                {
                    __auto_type c_name = ctype_to_c_name(arena, mod_name);
        ...
        while (i < len) {
            ...
            if (_mv_1307.has_value) {
                ...
                if (transpiler_is_type_def(item) && transpiler_is_struct_type_def(item)) {
                    __auto_type _mv_1308 = transpiler_get_type_name(item);
                    if (_mv_1308.has_value) {
                        __auto_type type_name = _mv_1308.value;
                        {
...
uint8_t transpiler_is_struct_type_def(types_SExpr* item) {
    SLOP_PRE(((item != NULL)), "(!= item nil)");
    __auto_type _mv_1309 = (*item);
    switch (_mv_1309.tag) {
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1309.data.lst;
            {
                __auto_type items = lst.items;
                if (((int64_t)((items).len)) < 3) {
                    return 0;
                    ...
                    if (_mv_1310.has_value) {
                        __auto_type def_expr = _mv_1310.value;
                        __auto_type _mv_1311 = (*def_expr);
                        switch (_mv_1311.tag) {
                            case types_SExpr_lst:
                            {
                                __auto_type def_lst = _mv_1311.data.lst;
                                {
                                    __auto_type def_items = def_lst.items;
                                    if (((int64_t)((def_items).len)) < 1) {
                                        return 0;
                                    } else {
                                        __auto_type _mv_1312 = ({ __auto_type _lst = def_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_1312.has_value) {
                                            __auto_type head = _mv_1312.value;
                                            __auto_type _mv_1313 = (*head);
                                            switch (_mv_1313.tag) {
                                                case types_SExpr_sym:
                                                {
...
uint8_t transpiler_has_enum_payload_variants(slop_list_types_SExpr_ptr items) {
    {
        ...
        uint8_t found = 0;
        while ((i < len) && !(found)) {
            __auto_type _mv_1314 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1314.has_value) {
                __auto_type item = _mv_1314.value;
                __auto_type _mv_1315 = (*item);
                switch (_mv_1315.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type _ = _mv_1315.data.lst;
                        found = 1;
                        break;
                    }
                    default: {
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1316.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 3) {
                    ...
                    __auto_type _mv_1317 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_1317.has_value) {
                        ...
                        switch (_mv_1318.tag) {
                            case types_SExpr_sym:
                            {
                                __auto_type _ = _mv_1318.data.sym;
                                return 1;
                            }
                            case types_SExpr_lst:
                            {
                                __auto_type def_lst = _mv_1318.data.lst;
                                {
                                    ...
                                    if (((int64_t)((def_items).len)) < 1) {
                                        ...
                                        __auto_type _mv_1319 = ({ __auto_type _lst = def_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1321.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 3) {
                    ...
                    __auto_type _mv_1322 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            ...
                            case types_SExpr_lst:
                            {
                                __auto_type def_lst = _mv_1323.data.lst;
                                {
                                    ...
                                    if (((int64_t)((def_items).len)) < 1) {
                                        ...
                                        __auto_type _mv_1324 = ({ __auto_type _lst = def_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            ...
            __auto_type lst = _mv_1326.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 3) {
                    ...
                    if (_mv_1327.has_value) {
                        __auto_type body_expr = _mv_1327.value;
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1328.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) < 2) {
                        ...
                        __auto_type _mv_1329 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_1329.has_value) {
                            __auto_type name_expr = _mv_1329.value;
                            __auto_type _mv_1330 = (*name_expr);
                            switch (_mv_1330.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_1330.data.sym;
        ...
        switch (_mv_1331.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1331.data.lst;
                {
                    __auto_type items = lst.items;
                    if (((int64_t)((items).len)) >= 3) {
                        __auto_type _mv_1332 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_1332.has_value) {
                            __auto_type name_expr = _mv_1332.value;
                            __auto_type _mv_1333 = (*name_expr);
                            switch (_mv_1333.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_1333.data.sym;
                                    {
                                        ...
                                        if (_mv_1334.has_value) {
                                            __auto_type body_expr = _mv_1334.value;
...
uint8_t transpiler_is_array_type_body(types_SExpr* body_expr) {
    SLOP_PRE(((body_expr != NULL)), "(!= body-expr nil)");
    __auto_type _mv_1335 = (*body_expr);
    switch (_mv_1335.tag) {
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1335.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 1) {
                    ...
                    __auto_type _mv_1336 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_1336.has_value) {
                        __auto_type head = _mv_1336.value;
                        __auto_type _mv_1337 = (*head);
                        switch (_mv_1337.tag) {
                            case types_SExpr_sym:
                            {
                                __auto_type sym = _mv_1337.data.sym;
...
void transpiler_emit_array_typedef_to_header(context_TranspileContext* ctx, slop_string c_name, types_SExpr* body_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1338 = (*body_expr);
        switch (_mv_1338.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1338.data.lst;
                {
                    ...
                    if (len < 3) {
                        ...
                        __auto_type _mv_1339 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_1339.has_value) {
                            __auto_type elem_type_expr = _mv_1339.value;
                            ...
                            if (_mv_1340.has_value) {
                                __auto_type size_expr = _mv_1340.value;
                                {
...
slop_string transpiler_get_array_size_string(types_SExpr* expr) {
    SLOP_PRE(((expr != NULL)), "(!= expr nil)");
    __auto_type _mv_1341 = (*expr);
    switch (_mv_1341.tag) {
        case types_SExpr_num:
        {
            __auto_type num = _mv_1341.data.num;
            return num.raw;
        }
        default: {
            return SLOP_STR("0");
...
uint8_t transpiler_is_range_type_body(types_SExpr* body_expr) {
    SLOP_PRE(((body_expr != NULL)), "(!= body-expr nil)");
    __auto_type _mv_1342 = (*body_expr);
    switch (_mv_1342.tag) {
        case types_SExpr_lst:
        {
                ...
                while ((i < len) && !(found_dots)) {
                    ...
                    if (_mv_1343.has_value) {
                        ...
                        switch (_mv_1344.tag) {
                            case types_SExpr_sym:
                            {
                                __auto_type sym = _mv_1344.data.sym;
...
transpiler_RangeBoundsHeader transpiler_parse_range_bounds_header(types_SExpr* body_expr) {
    SLOP_PRE(((body_expr != NULL)), "(!= body-expr nil)");
    {
        ...
        __auto_type _mv_1345 = (*body_expr);
        switch (_mv_1345.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1345.data.lst;
                {
                    __auto_type items = lst.items;
                    __auto_type len = ((int64_t)((items).len));
                    __auto_type i = 1;
                    while (i < len) {
                        ...
                        if (_mv_1346.has_value) {
                            ...
                            switch (_mv_1347.tag) {
                                case types_SExpr_num:
                                {
                                    __auto_type num = _mv_1347.data.num;
                                    if (!(found_dots)) {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_1348.has_value) {
                ...
                if (transpiler_is_type_def(item) && transpiler_is_struct_type_def(item)) {
                    __auto_type _mv_1349 = transpiler_get_type_name(item);
                    if (_mv_1349.has_value) {
                        __auto_type type_name = _mv_1349.value;
                        {
...
void transpiler_emit_c_name_aliases(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len > 0) {
            ...
            while (i < len) {
                __auto_type _mv_1352 = ({ __auto_type _lst = aliases; size_t _idx = (size_t)i; slop_option_context_FuncCNameAlias _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_1352.has_value) {
                    __auto_type alias = _mv_1352.value;
        ...
        switch (_mv_1353.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1353.data.lst;
                {
                    ...
                    __auto_type len = ((int64_t)((items).len));
                    if (len >= 3) {
                        __auto_type _mv_1354 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            ...
                            switch (_mv_1355.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_1355.data.sym;
                                    {
                                        ...
                                        __auto_type _mv_1356 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_1356.has_value) {
                                            __auto_type params_expr = _mv_1356.value;
                                            {
...
slop_option_string transpiler_get_type_name(types_SExpr* item) {
    SLOP_PRE(((item != NULL)), "(!= item nil)");
    __auto_type _mv_1357 = (*item);
    switch (_mv_1357.tag) {
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1357.data.lst;
            {
                __auto_type items = lst.items;
                if (((int64_t)((items).len)) < 2) {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_1360.has_value) {
                __auto_type item = _mv_1360.value;
...
void transpiler_emit_type_aliases(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items, int64_t start) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        uint8_t emitted_any = 0;
        while (i < len) {
            __auto_type _mv_1361 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void transpiler_emit_struct_types(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items, int64_t start) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = start;
        while (i < len) {
            __auto_type _mv_1363 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void transpiler_emit_result_types(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1364 = ({ __auto_type _lst = result_types; size_t _idx = (size_t)i; slop_option_context_ResultType _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1364.has_value) {
                __auto_type rt = _mv_1364.value;
...
void transpiler_emit_result_types_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1365 = ({ __auto_type _lst = result_types; size_t _idx = (size_t)i; slop_option_context_ResultType _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1365.has_value) {
                __auto_type rt = _mv_1365.value;
...
void transpiler_emit_inline_records_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1366 = ({ __auto_type _lst = inline_records; size_t _idx = (size_t)i; slop_option_context_InlineRecord _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1366.has_value) {
                __auto_type ir = _mv_1366.value;
                {
...
void transpiler_emit_option_types_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1367 = ({ __auto_type _lst = option_types; size_t _idx = (size_t)i; slop_option_context_OptionType _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1367.has_value) {
                __auto_type ot = _mv_1367.value;
...
void transpiler_emit_value_option_types_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1368 = ({ __auto_type _lst = option_types; size_t _idx = (size_t)i; slop_option_context_OptionType _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1368.has_value) {
                __auto_type ot = _mv_1368.value;
...
void transpiler_emit_complex_value_option_types_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1369 = ({ __auto_type _lst = option_types; size_t _idx = (size_t)i; slop_option_context_OptionType _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1369.has_value) {
                __auto_type ot = _mv_1369.value;
                if (!(transpiler_is_pointer_elem_type(ot.inner_type))) {
                    transpiler_emit_single_option_type_header(ctx, ot);
                }
...
void transpiler_emit_list_types_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1370 = ({ __auto_type _lst = list_types; size_t _idx = (size_t)i; slop_option_context_ListType _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1370.has_value) {
                __auto_type lt = _mv_1370.value;
...
void transpiler_emit_primitive_list_types_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1371 = ({ __auto_type _lst = list_types; size_t _idx = (size_t)i; slop_option_context_ListType _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1371.has_value) {
                __auto_type lt = _mv_1371.value;
...
void transpiler_emit_primitive_option_types_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1372 = ({ __auto_type _lst = option_types; size_t _idx = (size_t)i; slop_option_context_OptionType _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1372.has_value) {
                __auto_type ot = _mv_1372.value;
...
void transpiler_emit_imported_list_types_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1373 = ({ __auto_type _lst = list_types; size_t _idx = (size_t)i; slop_option_context_ListType _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1373.has_value) {
                __auto_type lt = _mv_1373.value;
...
void transpiler_emit_imported_option_types_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1374 = ({ __auto_type _lst = option_types; size_t _idx = (size_t)i; slop_option_context_OptionType _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1374.has_value) {
                __auto_type ot = _mv_1374.value;
...
void transpiler_emit_late_registered_list_types_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1375 = ({ __auto_type _lst = list_types; size_t _idx = (size_t)i; slop_option_context_ListType _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1375.has_value) {
                __auto_type lt = _mv_1375.value;
                transpiler_emit_single_list_type_header(ctx, lt);
...
void transpiler_emit_late_registered_option_types_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1376 = ({ __auto_type _lst = option_types; size_t _idx = (size_t)i; slop_option_context_OptionType _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void transpiler_emit_value_list_types_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1377 = ({ __auto_type _lst = list_types; size_t _idx = (size_t)i; slop_option_context_ListType _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void transpiler_emit_complex_value_list_types_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1378 = ({ __auto_type _lst = list_types; size_t _idx = (size_t)i; slop_option_context_ListType _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void transpiler_emit_union_payload_hash_eq(context_TranspileContext* ctx, slop_list_context_UnionVariantEntry variants) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1379 = ({ __auto_type _lst = variants; size_t _idx = (size_t)i; slop_option_context_UnionVariantEntry _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1379.has_value) {
                __auto_type variant = _mv_1379.value;
                {
...
void transpiler_emit_record_field_dependencies(context_TranspileContext* ctx, slop_list_context_FieldEntry fields) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1380 = ({ __auto_type _lst = fields; size_t _idx = (size_t)i; slop_option_context_FieldEntry _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1380.has_value) {
                __auto_type field = _mv_1380.value;
                {
...
uint8_t transpiler_is_range_type_alias(context_TranspileContext* ctx, slop_string slop_type) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    __auto_type _mv_1381 = context_ctx_lookup_type_alias(ctx, slop_type);
    if (_mv_1381.has_value) {
        __auto_type underlying = _mv_1381.value;
...
slop_string transpiler_resolve_payload_slop_type(context_TranspileContext* ctx, slop_string slop_type) {
    ...
    if (transpiler_is_range_type_alias(ctx, slop_type)) {
        __auto_type _mv_1382 = context_ctx_lookup_type_alias(ctx, slop_type);
        if (_mv_1382.has_value) {
            __auto_type underlying = _mv_1382.value;
            return underlying;
...
slop_list_transpiler_PayloadSlot transpiler_union_variant_payloads(context_TranspileContext* ctx, slop_string union_name, slop_string variant_name) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        __auto_type _mv_1383 = context_ctx_lookup_field_type(ctx, union_name, count_key);
        if (_mv_1383.has_value) {
            __auto_type _ = _mv_1383.value;
            {
                __auto_type i = 0;
                __auto_type more = 1;
                while (more) {
                    {
                        ...
                        __auto_type _mv_1384 = context_ctx_lookup_field_type(ctx, union_name, key);
                        if (_mv_1384.has_value) {
                            __auto_type slot_c_type = _mv_1384.value;
                            {
...
void transpiler_emit_union_hash_fn(context_TranspileContext* ctx, slop_string c_type, slop_list_context_UnionVariantEntry variants) {
    ...
    context_ctx_emit_header(ctx, SLOP_STR("    switch (_k->tag) {"));
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1385 = ({ __auto_type _lst = variants; size_t _idx = (size_t)i; slop_option_context_UnionVariantEntry _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1385.has_value) {
                __auto_type variant = _mv_1385.value;
...
void transpiler_emit_multi_payload_hash(context_TranspileContext* ctx, slop_string c_variant_name, slop_list_transpiler_PayloadSlot payloads) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            __auto_type _mv_1386 = ({ __auto_type _lst = payloads; size_t _idx = (size_t)i; slop_option_transpiler_PayloadSlot _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1386.has_value) {
                __auto_type slot = _mv_1386.value;
                {
...
void transpiler_emit_union_eq_fn(context_TranspileContext* ctx, slop_string c_type, slop_list_context_UnionVariantEntry variants) {
    ...
    context_ctx_emit_header(ctx, SLOP_STR("    switch (_a->tag) {"));
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1387 = ({ __auto_type _lst = variants; size_t _idx = (size_t)i; slop_option_context_UnionVariantEntry _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1387.has_value) {
                __auto_type variant = _mv_1387.value;
...
void transpiler_emit_multi_payload_eq(context_TranspileContext* ctx, slop_string c_variant_name, slop_list_transpiler_PayloadSlot payloads) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        context_ctx_emit_header(ctx, SLOP_STR("            return true"));
        while (i < len) {
            __auto_type _mv_1388 = ({ __auto_type _lst = payloads; size_t _idx = (size_t)i; slop_option_transpiler_PayloadSlot _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1388.has_value) {
                __auto_type slot = _mv_1388.value;
                {
...
void transpiler_emit_struct_hash_fn(context_TranspileContext* ctx, slop_string c_type, slop_list_context_FieldEntry fields) {
    ...
    context_ctx_emit_header(ctx, SLOP_STR("    uint64_t hash = 14695981039346656037ULL;"));
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1389 = ({ __auto_type _lst = fields; size_t _idx = (size_t)i; slop_option_context_FieldEntry _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1389.has_value) {
                __auto_type field = _mv_1389.value;
    ...
    context_ctx_emit_header(ctx, context_ctx_str(ctx, context_ctx_str4(ctx, SLOP_STR("    const "), c_type, SLOP_STR("* _b = (const "), c_type), SLOP_STR("*)b;")));
    {
        ...
        if (len == 0) {
            ...
            context_ctx_emit_header(ctx, SLOP_STR("    return true"));
            {
                int64_t i = 0;
                while (i < len) {
                    __auto_type _mv_1390 = ({ __auto_type _lst = fields; size_t _idx = (size_t)i; slop_option_context_FieldEntry _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_1390.has_value) {
                        __auto_type field = _mv_1390.value;
...
void transpiler_emit_struct_key_types_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < ((int64_t)((struct_key_types).len))) {
            __auto_type _mv_1391 = ({ __auto_type _lst = struct_key_types; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1391.has_value) {
                __auto_type c_type = _mv_1391.value;
                {
...
void transpiler_emit_chan_types_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1392 = ({ __auto_type _lst = chan_types; size_t _idx = (size_t)i; slop_option_context_ChanType _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1392.has_value) {
                __auto_type ct = _mv_1392.value;
                {
...
void transpiler_emit_chan_funcs_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1393 = ({ __auto_type _lst = chan_types; size_t _idx = (size_t)i; slop_option_context_ChanType _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1393.has_value) {
                __auto_type ct = _mv_1393.value;
                {
                    __auto_type elem_type = ct.elem_type;
                    __auto_type c_name = ct.c_name;
...
void transpiler_emit_thread_types_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1394 = ({ __auto_type _lst = thread_types; size_t _idx = (size_t)i; slop_option_context_ThreadType _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1394.has_value) {
                __auto_type tt = _mv_1394.value;
                {
...
void transpiler_emit_module_types_header(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items, int64_t start) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        i = start;
        while (i < len) {
            __auto_type _mv_1401 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        i = start;
        while (i < len) {
            __auto_type _mv_1402 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void transpiler_emit_pending_container_deps(context_TranspileContext* ctx, types_SExpr* type_def) {
    ...
    SLOP_PRE(((type_def != NULL)), "(!= type-def nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1406 = ({ __auto_type _lst = field_types; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1406.has_value) {
                __auto_type field_type = _mv_1406.value;
...
void transpiler_emit_option_by_c_name(context_TranspileContext* ctx, slop_string c_name) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1407 = ({ __auto_type _lst = option_types; size_t _idx = (size_t)i; slop_option_context_OptionType _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void transpiler_emit_list_by_c_name(context_TranspileContext* ctx, slop_string c_name) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1408 = ({ __auto_type _lst = list_types; size_t _idx = (size_t)i; slop_option_context_ListType _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            ...
            prev_count = current_count;
            {
                ...
                while (i < len) {
                    if (!(transpiler_index_in_list(emitted, i))) {
                        __auto_type _mv_1409 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    ...
                    while (i < len) {
                        if (!(transpiler_index_in_list(emitted, i))) {
                            ...
                            if (_mv_1410.has_value) {
                                __auto_type item = _mv_1410.value;
                                if (transpiler_is_type_def(item) && transpiler_is_struct_type_def(item)) {
                                    if (transpiler_type_deps_satisfied(ctx, item)) {
                                        transpiler_emit_pending_container_deps(ctx, item);
                                        transpiler_emit_type_to_header(ctx, item);
...
uint8_t transpiler_has_unemitted_struct_types(slop_list_types_SExpr_ptr items, int64_t start, int64_t len, slop_list_int emitted) {
    {
        ...
        while ((i < len) && !(found)) {
            if (!(transpiler_index_in_list(emitted, i))) {
                __auto_type _mv_1411 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void transpiler_break_list_cycles(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items, int64_t start, int64_t len, slop_list_int emitted) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            if (!(transpiler_index_in_list(emitted, i))) {
                __auto_type _mv_1412 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    ...
                    if (transpiler_is_type_def(item) && transpiler_is_struct_type_def(item)) {
                        {
                            ...
                            __auto_type j = 0;
                            while (j < dep_len) {
                                __auto_type _mv_1413 = ({ __auto_type _lst = blocking_deps; size_t _idx = (size_t)j; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1413.has_value) {
                                    __auto_type dep_name = _mv_1413.value;
...
slop_list_string transpiler_find_blocking_list_deps(context_TranspileContext* ctx, types_SExpr* type_def) {
    ...
    SLOP_PRE(((type_def != NULL)), "(!= type-def nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1414 = ({ __auto_type _lst = field_types; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1414.has_value) {
                __auto_type field_type = _mv_1414.value;
...
void transpiler_emit_list_declare_by_c_name(context_TranspileContext* ctx, slop_string c_name) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1415 = ({ __auto_type _lst = list_types; size_t _idx = (size_t)i; slop_option_context_ListType _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
uint8_t transpiler_index_in_list(slop_list_int lst, int64_t idx) {
    {
        ...
        uint8_t found = 0;
        while ((i < len) && !(found)) {
            __auto_type _mv_1416 = ({ __auto_type _lst = lst; size_t _idx = (size_t)i; slop_option_int _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1416.has_value) {
                __auto_type v = _mv_1416.value;
                if (v == idx) {
                    found = 1;
                }
...
uint8_t transpiler_type_deps_satisfied(context_TranspileContext* ctx, types_SExpr* type_def) {
    ...
    SLOP_PRE(((type_def != NULL)), "(!= type-def nil)");
    {
        ...
        while ((i < len) && all_satisfied) {
            __auto_type _mv_1417 = ({ __auto_type _lst = field_types; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1417.has_value) {
                __auto_type field_type = _mv_1417.value;
        ...
        switch (_mv_1418.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1418.data.lst;
                {
                    __auto_type items = lst.items;
                    if (((int64_t)((items).len)) >= 3) {
                        __auto_type _mv_1419 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_1419.has_value) {
                            __auto_type def_expr = _mv_1419.value;
                            __auto_type _mv_1420 = (*def_expr);
                            switch (_mv_1420.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type def_lst = _mv_1420.data.lst;
                                    {
                                        __auto_type def_items = def_lst.items;
                                        __auto_type def_len = ((int64_t)((def_items).len));
                                        if (def_len > 0) {
                                            __auto_type _mv_1421 = ({ __auto_type _lst = def_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_1421.has_value) {
                                                __auto_type head = _mv_1421.value;
                                                __auto_type _mv_1422 = (*head);
                                                switch (_mv_1422.tag) {
                                                    case types_SExpr_sym:
                                                    {
...
slop_list_string transpiler_extract_record_field_types(context_TranspileContext* ctx, slop_list_types_SExpr_ptr def_items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 1;
        while (i < len) {
            __auto_type _mv_1423 = ({ __auto_type _lst = def_items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1423.has_value) {
                __auto_type field_expr = _mv_1423.value;
                __auto_type _mv_1424 = (*field_expr);
                switch (_mv_1424.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type field_lst = _mv_1424.data.lst;
                        if (((int64_t)((field_lst.items).len)) >= 2) {
                            __auto_type _mv_1425 = ({ __auto_type _lst = field_lst.items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_list_string transpiler_extract_union_variant_types(context_TranspileContext* ctx, slop_list_types_SExpr_ptr def_items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 1;
        while (i < len) {
            __auto_type _mv_1426 = ({ __auto_type _lst = def_items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1426.has_value) {
                __auto_type variant_expr = _mv_1426.value;
                __auto_type _mv_1427 = (*variant_expr);
                switch (_mv_1427.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type variant_lst = _mv_1427.data.lst;
                        if (((int64_t)((variant_lst.items).len)) >= 2) {
                            __auto_type _mv_1428 = ({ __auto_type _lst = variant_lst.items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_1428.has_value) {
                                __auto_type type_expr = _mv_1428.value;
                                {
                                    __auto_type type_str = transpiler_get_field_type_string(ctx, type_expr);
                                    if (!(string_eq(type_str, SLOP_STR("")))) {
                                        ({ __auto_type _lst_p = &(result); __auto_type _item = (type_str); if (_lst_p->len >= _lst_p->cap) { size_t _new_cap = _lst_p->cap == 0 ? 16 : _lst_p->cap * 2; __typeof__(_lst_p->data) _new_data = (__typeof__(_lst_p->data))slop_arena_alloc(arena, _new_cap * sizeof(*_lst_p->data)); if (_lst_p->len > 0) memcpy(_new_data, _lst_p->data, _lst_p->len * sizeof(*_lst_p->data)); _lst_p->data = _new_data; _lst_p->cap = _new_cap; } _lst_p->data[_lst_p->len++] = _item; (void)0; });
...
slop_string transpiler_get_field_type_string(context_TranspileContext* ctx, types_SExpr* type_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1429 = (*type_expr);
        switch (_mv_1429.tag) {
            case types_SExpr_sym:
            {
                ...
                {
                    __auto_type name = sym.name;
                    __auto_type _mv_1430 = context_ctx_lookup_type(ctx, name);
                                        ...
                                        if (string_eq(kind, SLOP_STR("Ptr"))) {
                                            ...
                                            if (((int64_t)((items).len)) >= 2) {
                                                ...
                                                if (_mv_1433.has_value) {
                                                    __auto_type inner = _mv_1433.value;
                                                    {
                                            ...
                                            if (((int64_t)((items).len)) >= 2) {
                                                ...
                                                if (_mv_1434.has_value) {
                                                    __auto_type inner = _mv_1434.value;
                                                    {
                                                        __auto_type inner_str = transpiler_get_field_type_string(ctx, inner);
                                                        if (string_eq(inner_str, SLOP_STR(""))) {
                                                            return SLOP_STR("");
...
void transpiler_emit_option_for_inner_type(context_TranspileContext* ctx, slop_string inner_c_name) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1439 = ({ __auto_type _lst = option_types; size_t _idx = (size_t)i; slop_option_context_OptionType _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1439.has_value) {
                __auto_type ot = _mv_1439.value;
...
void transpiler_emit_list_for_elem_type(context_TranspileContext* ctx, slop_string elem_c_name) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1440 = ({ __auto_type _lst = list_types; size_t _idx = (size_t)i; slop_option_context_ListType _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
uint8_t transpiler_struct_uses_value_list_or_option(context_TranspileContext* ctx, types_SExpr* type_def) {
    ...
    SLOP_PRE(((type_def != NULL)), "(!= type-def nil)");
    {
        ...
        uint8_t found = 0;
        {
            ...
            int64_t i = 0;
            while ((i < len) && !(found)) {
                __auto_type _mv_1441 = ({ __auto_type _lst = list_types; size_t _idx = (size_t)i; slop_option_context_ListType _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_1441.has_value) {
                    __auto_type lt = _mv_1441.value;
        ...
        if (!(found)) {
            {
                ...
                int64_t j = 0;
                while ((j < len2) && !(found)) {
                    __auto_type _mv_1442 = ({ __auto_type _lst = option_types; size_t _idx = (size_t)j; slop_option_context_OptionType _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void transpiler_emit_struct_dependent_list_types(context_TranspileContext* ctx, types_SExpr* type_def) {
    ...
    SLOP_PRE(((type_def != NULL)), "(!= type-def nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1443 = ({ __auto_type _lst = list_types; size_t _idx = (size_t)i; slop_option_context_ListType _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void transpiler_emit_struct_dependent_option_types(context_TranspileContext* ctx, types_SExpr* type_def) {
    ...
    SLOP_PRE(((type_def != NULL)), "(!= type-def nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1444 = ({ __auto_type _lst = option_types; size_t _idx = (size_t)i; slop_option_context_OptionType _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1444.has_value) {
                __auto_type ot = _mv_1444.value;
                if (!(transpiler_is_pointer_elem_type(ot.inner_type)) && transpiler_struct_uses_option_type(ctx, type_def, ot.c_name)) {
...
void transpiler_emit_struct_dependent_list_types_safe(context_TranspileContext* ctx, types_SExpr* type_def) {
    ...
    SLOP_PRE(((type_def != NULL)), "(!= type-def nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1445 = ({ __auto_type _lst = list_types; size_t _idx = (size_t)i; slop_option_context_ListType _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1445.has_value) {
                __auto_type lt = _mv_1445.value;
                if (!(transpiler_is_pointer_elem_type(lt.elem_type)) && transpiler_struct_uses_list_type(ctx, type_def, lt.c_name)) {
...
void transpiler_emit_struct_dependent_option_types_safe(context_TranspileContext* ctx, types_SExpr* type_def) {
    ...
    SLOP_PRE(((type_def != NULL)), "(!= type-def nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1446 = ({ __auto_type _lst = option_types; size_t _idx = (size_t)i; slop_option_context_OptionType _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1446.has_value) {
                __auto_type ot = _mv_1446.value;
                if (!(transpiler_is_pointer_elem_type(ot.inner_type)) && transpiler_struct_uses_option_type(ctx, type_def, ot.c_name)) {
...
uint8_t transpiler_is_imported_type(context_TranspileContext* ctx, slop_string type_name) {
    ...
    if (strlib_starts_with(type_name, SLOP_STR("slop_list_")) || strlib_starts_with(type_name, SLOP_STR("slop_option_"))) {
        ...
        __auto_type _mv_1447 = context_ctx_get_module(ctx);
        if (_mv_1447.has_value) {
            __auto_type current_mod = _mv_1447.value;
            {
                __auto_type arena = (*ctx).arena;
    ...
    if (strlib_starts_with(inner_type, SLOP_STR("slop_list_"))) {
        {
            ...
            int64_t i = 0;
            while (i < len) {
                __auto_type _mv_1448 = ({ __auto_type _lst = list_types; size_t _idx = (size_t)i; slop_option_context_ListType _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    ...
    if (strlib_starts_with(inner_type, SLOP_STR("slop_list_"))) {
        {
            ...
            int64_t i = 0;
            while (i < len) {
                __auto_type _mv_1449 = ({ __auto_type _lst = list_types; size_t _idx = (size_t)i; slop_option_context_ListType _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                ...
                __auto_type lst = _mv_1452.data.lst;
                {
                    ...
                    while ((i < len) && !(found)) {
                        ...
                        if (_mv_1453.has_value) {
                            __auto_type field_expr = _mv_1453.value;
...
uint8_t transpiler_field_uses_typename(context_TranspileContext* ctx, types_SExpr* field_expr, slop_string typename) {
    ...
    __auto_type _mv_1454 = (*field_expr);
    switch (_mv_1454.tag) {
        case types_SExpr_lst:
        {
                ...
                __auto_type lst = _mv_1456.data.lst;
                {
                    ...
                    if (len >= 3) {
                        ...
                        if (_mv_1457.has_value) {
                            __auto_type name_expr = _mv_1457.value;
                            __auto_type _mv_1458 = (*name_expr);
                            switch (_mv_1458.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_1458.data.sym;
                                    {
                                        __auto_type type_name = name_sym.name;
                                        __auto_type base_name = ctype_to_c_name(arena, type_name);
                                        __auto_type c_name = ((context_ctx_prefixing_enabled(ctx)) ? ({ __auto_type _mv = context_ctx_get_module(ctx); _mv.has_value ? ({ __auto_type mod_name = _mv.value; context_ctx_str(ctx, ctype_to_c_name(arena, mod_name), context_ctx_str(ctx, SLOP_STR("_"), base_name)); }) : (base_name); }) : base_name);
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1460.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) < 1) {
                        ...
                        __auto_type _mv_1461 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_1461.has_value) {
                            __auto_type kind_expr = _mv_1461.value;
                            __auto_type _mv_1462 = (*kind_expr);
                            switch (_mv_1462.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type kind_sym = _mv_1462.data.sym;
                                    {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_1463.has_value) {
                __auto_type variant_expr = _mv_1463.value;
                __auto_type _mv_1464 = (*variant_expr);
                switch (_mv_1464.tag) {
                    case types_SExpr_sym:
                    {
                        __auto_type variant_sym = _mv_1464.data.sym;
                        {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_1465.has_value) {
                __auto_type field_expr = _mv_1465.value;
...
void transpiler_emit_field_to_header(context_TranspileContext* ctx, slop_string raw_type_name, slop_string c_type_name, types_SExpr* field_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1466 = (*field_expr);
        switch (_mv_1466.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1466.data.lst;
                {
                    __auto_type items = lst.items;
                    if (((int64_t)((items).len)) >= 2) {
                        __auto_type _mv_1467 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_1467.has_value) {
                            __auto_type name_expr = _mv_1467.value;
                            __auto_type _mv_1468 = (*name_expr);
                            switch (_mv_1468.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_1468.data.sym;
                                    {
                                        __auto_type field_name = name_sym.name;
                                        __auto_type c_field_name = ctype_to_c_name(arena, field_name);
                                        __auto_type _mv_1469 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
uint8_t transpiler_is_pointer_type_expr_header(types_SExpr* type_expr) {
    SLOP_PRE(((type_expr != NULL)), "(!= type-expr nil)");
    __auto_type _mv_1470 = (*type_expr);
    switch (_mv_1470.tag) {
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1470.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 1) {
                    ...
                    __auto_type _mv_1471 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        context_ctx_emit_header(ctx, SLOP_STR("typedef enum {"));
        {
            ...
            while (i < len) {
                ...
                if (_mv_1473.has_value) {
                    __auto_type variant_expr = _mv_1473.value;
                    {
        ...
        context_ctx_emit_header(ctx, SLOP_STR("    union {"));
        {
            ...
            while (i < len) {
                ...
                if (_mv_1474.has_value) {
                    __auto_type variant_expr = _mv_1474.value;
...
slop_string transpiler_get_variant_name(types_SExpr* variant_expr) {
    ...
    __auto_type _mv_1475 = (*variant_expr);
    switch (_mv_1475.tag) {
        case types_SExpr_sym:
        {
            __auto_type sym = _mv_1475.data.sym;
            return sym.name;
        }
        case types_SExpr_lst:
        {
        ...
        switch (_mv_1478.tag) {
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1478.data.lst;
                {
                    ...
                    if (num_items >= 2) {
                        __auto_type _mv_1479 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_1479.has_value) {
                            ...
                            switch (_mv_1480.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_1480.data.sym;
                                    {
                                        __auto_type variant_name = name_sym.name;
                                        __auto_type c_field = ctype_to_c_name(arena, variant_name);
                                        if (num_items == 2) {
                                            __auto_type _mv_1481 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_1481.has_value) {
                                                __auto_type type_expr = _mv_1481.value;
                                                {
                                                    __auto_type c_type = context_to_c_type_prefixed(ctx, type_expr);
                                                    {
                                            ...
                                            for (int64_t fi = 1; fi < num_items; fi++) {
                                                __auto_type _mv_1482 = ({ __auto_type _lst = items; size_t _idx = (size_t)fi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1488.data.lst;
            {
                ...
                if (((int64_t)((const_items).len)) < 4) {
                    ...
                    __auto_type _mv_1489 = ({ __auto_type _lst = const_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            ...
                            case types_SExpr_sym:
                            {
                                __auto_type name_sym = _mv_1490.data.sym;
                                {
                                    ...
                                    if (!(transpiler_list_contains_str(exports, raw_name))) {
                                        ...
                                        __auto_type _mv_1491 = ({ __auto_type _lst = const_items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_1491.has_value) {
                                            __auto_type type_expr = _mv_1491.value;
...
void transpiler_emit_all_lambdas(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (count > 0) {
            while (i < count) {
                __auto_type _mv_1493 = ({ __auto_type _lst = lambdas; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_1493.has_value) {
                    __auto_type lambda_code = _mv_1493.value;
...
slop_string transpiler_generate_c_output(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1494 = ({ __auto_type _lst = output_lines; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void transpiler_transpile_file(context_TranspileContext* ctx, slop_list_types_SExpr_ptr exprs) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len > 0) && transpiler_is_module_expr(exprs)) {
            __auto_type _mv_1495 = ({ __auto_type _lst = exprs; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1495.has_value) {
                __auto_type module_expr = _mv_1495.value;
...
uint8_t transpiler_is_module_expr(slop_list_types_SExpr_ptr exprs) {
    if (((int64_t)((exprs).len)) < 1) {
        ...
        __auto_type _mv_1496 = ({ __auto_type _lst = exprs; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        if (_mv_1496.has_value) {
            __auto_type first = _mv_1496.value;
            __auto_type _mv_1497 = (*first);
            switch (_mv_1497.tag) {
                case types_SExpr_lst:
                {
