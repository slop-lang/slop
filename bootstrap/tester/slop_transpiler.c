...
transpiler_GenericInfo transpiler_extract_generic_info(slop_arena* arena, slop_list_types_SExpr_ptr items) {
    {
        ...
        while (i < len) {
            ...
            if (_mv_1120.has_value) {
                __auto_type item = _mv_1120.value;
                __auto_type _mv_1121 = (*item);
                switch (_mv_1121.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type lst = _mv_1121.data.lst;
                        {
                            ...
                            if (((int64_t)((sub_items).len)) >= 1) {
                                __auto_type _mv_1122 = ({ __auto_type _lst = sub_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        ...
                                        case types_SExpr_sym:
                                        {
                                            ...
                                            if (string_eq(sym.name, SLOP_STR("@generic"))) {
                                                if (((int64_t)((sub_items).len)) >= 2) {
                                                    __auto_type _mv_1124 = ({ __auto_type _lst = sub_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_1124.has_value) {
                                                        __auto_type params_expr = _mv_1124.value;
                                                        __auto_type _mv_1125 = (*params_expr);
                                                        switch (_mv_1125.tag) {
                                                            case types_SExpr_lst:
                                                            {
                                                                __auto_type params_lst = _mv_1125.data.lst;
                                                                {
                                                                    __auto_type param_items = params_lst.items;
                                                                    __auto_type param_len = ((int64_t)((param_items).len));
                                                                    __auto_type j = 0;
                                                                    while (j < param_len) {
                                                                        __auto_type _mv_1126 = ({ __auto_type _lst = param_items; size_t _idx = (size_t)j; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                                        if (_mv_1126.has_value) {
                                                                            __auto_type param = _mv_1126.value;
                                                                            __auto_type _mv_1127 = (*param);
                                                                            switch (_mv_1127.tag) {
                                                                                case types_SExpr_sym:
                                                                                {
                                                                                    __auto_type param_sym = _mv_1127.data.sym;
                                                            ...
                                                            case types_SExpr_sym:
                                                            {
                                                                __auto_type single_sym = _mv_1125.data.sym;
...
void transpiler_prescan_type(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (((int64_t)((items).len)) >= 2) {
            __auto_type _mv_1132 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1132.has_value) {
                __auto_type name_expr = _mv_1132.value;
                __auto_type _mv_1133 = (*name_expr);
                switch (_mv_1133.tag) {
                    case types_SExpr_sym:
                    {
                            ...
                            __auto_type c_name = ((context_ctx_prefixing_enabled(ctx)) ? ({ __auto_type _mv = context_ctx_get_module(ctx); _mv.has_value ? ({ __auto_type mod_name = _mv.value; context_ctx_str(ctx, ctype_to_c_name(arena, mod_name), context_ctx_str(ctx, SLOP_STR("_"), base_c_name)); }) : (base_c_name); }) : base_c_name);
                            {
                                ...
                                if (is_record || is_union) {
                                    if (((int64_t)((items).len)) >= 3) {
                                        __auto_type _mv_1134 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_1134.has_value) {
                                            __auto_type def_expr = _mv_1134.value;
                                            __auto_type _mv_1135 = (*def_expr);
                                            switch (_mv_1135.tag) {
                                                case types_SExpr_lst:
                                                {
                                                    __auto_type def_lst = _mv_1135.data.lst;
                                ...
                                if (((int64_t)((items).len)) >= 3) {
                                    __auto_type _mv_1136 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    if (_mv_1136.has_value) {
                                        __auto_type body_expr = _mv_1136.value;
            ...
            switch (_mv_1138.tag) {
                case types_SExpr_lst:
                {
                    __auto_type def_lst = _mv_1138.data.lst;
                    {
                        ...
                        __auto_type i = 1;
                        while (i < len) {
                            __auto_type _mv_1139 = ({ __auto_type _lst = def_items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                ...
                                switch (_mv_1140.tag) {
                                    ...
                                    case types_SExpr_lst:
                                    {
                                        ...
                                        if (((int64_t)((variant_lst.items).len)) > 0) {
                                            __auto_type _mv_1141 = ({ __auto_type _lst = variant_lst.items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (((int64_t)((items).len)) >= 3) {
            ...
            if (_mv_1143.has_value) {
                __auto_type def_expr = _mv_1143.value;
                __auto_type _mv_1144 = (*def_expr);
                switch (_mv_1144.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type def_lst = _mv_1144.data.lst;
                        {
                            __auto_type def_items = def_lst.items;
                            __auto_type len = ((int64_t)((def_items).len));
                            __auto_type i = 1;
                            while (i < len) {
                                __auto_type _mv_1145 = ({ __auto_type _lst = def_items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1145.has_value) {
                                    __auto_type variant_expr = _mv_1145.value;
                                    __auto_type _mv_1146 = (*variant_expr);
                                    switch (_mv_1146.tag) {
                                        case types_SExpr_sym:
                                        {
                                        ...
                                        case types_SExpr_lst:
                                        {
                                            __auto_type variant_lst = _mv_1146.data.lst;
                                            {
                                                ...
                                                if (vl_len >= 2) {
                                                        ...
                                                        switch (_mv_1148.tag) {
                                                            case types_SExpr_sym:
                                                            {
                                                                __auto_type name_sym = _mv_1148.data.sym;
                                                                {
                                                                    ...
                                                                    context_ctx_register_enum_variant(ctx, variant_name, union_name);
                                                                    __auto_type _mv_1149 = ({ __auto_type _lst = vl_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                                    ...
                                                                    if (vl_len >= 3) {
                                                                        ...
                                                                        for (int64_t fi = 1; fi < vl_len; fi++) {
                                                                            __auto_type _mv_1150 = ({ __auto_type _lst = vl_items; size_t _idx = (size_t)fi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    ...
                                                    if (((int64_t)((vl_items).len)) == 1) {
                                                        __auto_type _mv_1151 = ({ __auto_type _lst = vl_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                        if (_mv_1151.has_value) {
                                                            __auto_type name_expr = _mv_1151.value;
                                                            __auto_type _mv_1152 = (*name_expr);
                                                            switch (_mv_1152.tag) {
                                                                case types_SExpr_sym:
                                                                {
                                                                    __auto_type name_sym = _mv_1152.data.sym;
                                                                    {
                                                                        __auto_type variant_name = name_sym.name;
                                                                        context_ctx_register_enum_variant(ctx, variant_name, union_name);
                                                                        context_ctx_register_union_variant(ctx, variant_name, union_name, ctype_to_c_name(arena, variant_name), SLOP_STR(""), SLOP_STR(""));
...
void transpiler_prescan_fn(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        __auto_type arena = (*ctx).arena;
        if (((int64_t)((items).len)) >= 2) {
            __auto_type _mv_1153 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1153.has_value) {
                __auto_type name_expr = _mv_1153.value;
                __auto_type _mv_1154 = (*name_expr);
                switch (_mv_1154.tag) {
                    case types_SExpr_sym:
                    {
                ...
                switch (_mv_1156.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type lst = _mv_1156.data.lst;
                        {
                            __auto_type sub_items = lst.items;
                            if (((int64_t)((sub_items).len)) >= 2) {
                                __auto_type _mv_1157 = ({ __auto_type _lst = sub_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    ...
                                    switch (_mv_1158.tag) {
                                        case types_SExpr_sym:
                                        {
                                            ...
                                            if (string_eq(sym.name, SLOP_STR("@spec"))) {
                                                __auto_type _mv_1159 = ({ __auto_type _lst = sub_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_1159.has_value) {
                                                    __auto_type spec_body = _mv_1159.value;
                                                    __auto_type _mv_1160 = (*spec_body);
                                                    switch (_mv_1160.tag) {
                                                        case types_SExpr_lst:
                                                        {
                                                            __auto_type body_lst = _mv_1160.data.lst;
                                                            {
                                                                __auto_type body_items = body_lst.items;
                                                                __auto_type body_len = ((int64_t)((body_items).len));
                                                                if (body_len >= 1) {
                                                                    __auto_type _mv_1161 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)(body_len - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                                    if (_mv_1161.has_value) {
                                                                        __auto_type ret_type = _mv_1161.value;
                                                                        __auto_type _mv_1162 = (*ret_type);
                                                                        switch (_mv_1162.tag) {
                                                                            case types_SExpr_sym:
                                                                            {
                                                                                __auto_type ret_sym = _mv_1162.data.sym;
                ...
                switch (_mv_1164.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type lst = _mv_1164.data.lst;
                        {
                            __auto_type sub_items = lst.items;
                            if (((int64_t)((sub_items).len)) >= 2) {
                                __auto_type _mv_1165 = ({ __auto_type _lst = sub_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1165.has_value) {
                                    ...
                                    switch (_mv_1166.tag) {
                                        case types_SExpr_sym:
                                        {
                                            ...
                                            if (string_eq(sym.name, SLOP_STR("@spec"))) {
                                                __auto_type _mv_1167 = ({ __auto_type _lst = sub_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_1167.has_value) {
                                                    __auto_type spec_body = _mv_1167.value;
                                                    __auto_type _mv_1168 = (*spec_body);
                                                    switch (_mv_1168.tag) {
                                                        case types_SExpr_lst:
                                                        {
                                                            __auto_type body_lst = _mv_1168.data.lst;
                                                            {
                                                                __auto_type body_items = body_lst.items;
                                                                __auto_type body_len = ((int64_t)((body_items).len));
                                                                if (body_len >= 1) {
                                                                    __auto_type _mv_1169 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)(body_len - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                                    if (_mv_1169.has_value) {
                                                                        __auto_type ret_type = _mv_1169.value;
...
void transpiler_prescan_fn_params(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    if (((int64_t)((items).len)) >= 3) {
        __auto_type _mv_1170 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        if (_mv_1170.has_value) {
            __auto_type params_expr = _mv_1170.value;
            __auto_type _mv_1171 = (*params_expr);
            switch (_mv_1171.tag) {
                case types_SExpr_lst:
                {
                    __auto_type params_lst = _mv_1171.data.lst;
                    {
                        __auto_type params = params_lst.items;
                        __auto_type param_count = ((int64_t)((params).len));
                        __auto_type i = 0;
                        while (i < param_count) {
                            __auto_type _mv_1172 = ({ __auto_type _lst = params; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_1172.has_value) {
                                __auto_type param_expr = _mv_1172.value;
                                __auto_type _mv_1173 = (*param_expr);
                                switch (_mv_1173.tag) {
                                    case types_SExpr_lst:
                                    {
                                        __auto_type param_lst = _mv_1173.data.lst;
                                        {
                                            __auto_type param_items = param_lst.items;
                                            if (((int64_t)((param_items).len)) >= 2) {
                                                __auto_type _mv_1174 = ({ __auto_type _lst = param_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_list_context_FuncParamType_ptr transpiler_prescan_collect_param_types(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (((int64_t)((items).len)) >= 3) {
            __auto_type _mv_1175 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1175.has_value) {
                __auto_type params_expr = _mv_1175.value;
                __auto_type _mv_1176 = (*params_expr);
                switch (_mv_1176.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type params_lst = _mv_1176.data.lst;
                        {
                            __auto_type params = params_lst.items;
                            __auto_type param_count = ((int64_t)((params).len));
                            __auto_type i = 0;
                            while (i < param_count) {
                                __auto_type _mv_1177 = ({ __auto_type _lst = params; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1177.has_value) {
                                    __auto_type param_expr = _mv_1177.value;
                                    {
                ...
                __auto_type lst = _mv_1178.data.lst;
                {
                    ...
                    if (len < 2) {
                    ...
                    } else {
                        {
                            ...
                            __auto_type _mv_1179 = ({ __auto_type _lst = items; size_t _idx = (size_t)type_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
uint8_t transpiler_prescan_is_param_mode(slop_list_types_SExpr_ptr items) {
    if (((int64_t)((items).len)) < 1) {
        ...
        if (_mv_1180.has_value) {
            __auto_type first = _mv_1180.value;
            __auto_type _mv_1181 = (*first);
            switch (_mv_1181.tag) {
                case types_SExpr_sym:
                {
...
void transpiler_extract_result_type(context_TranspileContext* ctx, types_SExpr* spec_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1186 = (*spec_expr);
        switch (_mv_1186.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1186.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) >= 2) {
                        ...
                        if (_mv_1187.has_value) {
                            ...
                            __auto_type _mv_1188 = (*spec_body);
                            switch (_mv_1188.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type body_lst = _mv_1188.data.lst;
                                    {
                                        __auto_type body_items = body_lst.items;
                                        __auto_type body_len = ((int64_t)((body_items).len));
                                        if (body_len >= 1) {
                                            __auto_type _mv_1189 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)(body_len - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_1189.has_value) {
                                                __auto_type ret_type = _mv_1189.value;
...
void transpiler_check_and_register_result_type(context_TranspileContext* ctx, types_SExpr* type_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1190 = (*type_expr);
        switch (_mv_1190.tag) {
            case types_SExpr_lst:
            {
                            ...
                            switch (_mv_1192.tag) {
                                case types_SExpr_sym:
                                {
                                    ...
                                    if (string_eq(sym.name, SLOP_STR("Result"))) {
                                        __auto_type _mv_1193 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_1193.has_value) {
                                            __auto_type ok_type_expr = _mv_1193.value;
                                            __auto_type _mv_1194 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_1194.has_value) {
                                                __auto_type err_type_expr = _mv_1194.value;
                                                {
                            ...
                            case types_SExpr_sym:
                            {
                                __auto_type sym = _mv_1198.data.sym;
                                {
                                    ...
                                    if (string_eq(name, SLOP_STR("map-new"))) {
                                        if (len >= 3) {
                                            __auto_type _mv_1199 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_1199.has_value) {
                                                __auto_type key_type_expr = _mv_1199.value;
                                        ...
                                        if (len >= 3) {
                                            ...
                                            if (_mv_1200.has_value) {
                                                __auto_type elem_type_expr = _mv_1200.value;
                                    ...
                                    } else {
                                        {
                                            ...
                                            while (i < len) {
                                                ...
                                                if (_mv_1203.has_value) {
                                                    __auto_type child = _mv_1203.value;
                            ...
                            default: {
                                {
                                    ...
                                    while (i < len) {
                                        ...
                                        if (_mv_1204.has_value) {
                                            __auto_type child = _mv_1204.value;
                                            transpiler_prescan_expr_for_struct_keys(ctx, child);
                ...
                __auto_type sym = _mv_1205.data.sym;
                {
                    ...
                    if (!(transpiler_is_builtin_map_key_type(name))) {
                        ...
                        if (_mv_1206.has_value) {
                            __auto_type type_entry = _mv_1206.value;
                            context_ctx_register_struct_key_type(ctx, type_entry.c_name);
                        } else if (!_mv_1206.has_value) {
                            __auto_type _mv_1207 = context_ctx_get_module(ctx);
                            if (_mv_1207.has_value) {
                                __auto_type mod = _mv_1207.value;
                                {
                                    __auto_type prefixed = context_ctx_str3(ctx, mod, SLOP_STR("_"), name);
                                    __auto_type _mv_1208 = context_ctx_lookup_type(ctx, prefixed);
                                    if (_mv_1208.has_value) {
                                        __auto_type type_entry = _mv_1208.value;
                                        context_ctx_register_struct_key_type(ctx, type_entry.c_name);
...
void transpiler_prescan_ffi(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        __auto_type len = ((int64_t)((items).len));
        if (len >= 2) {
            __auto_type _mv_1214 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1214.has_value) {
                __auto_type header_expr = _mv_1214.value;
                __auto_type _mv_1215 = (*header_expr);
                switch (_mv_1215.tag) {
            ...
            }
            {
                int64_t i = 2;
                while (i < len) {
                    __auto_type _mv_1216 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_1216.has_value) {
                        __auto_type func_decl = _mv_1216.value;
...
void transpiler_prescan_import(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    ...
    if (((int64_t)((items).len)) >= 3) {
        ...
        if (_mv_1217.has_value) {
            __auto_type mod_expr = _mv_1217.value;
            __auto_type _mv_1218 = (*mod_expr);
            switch (_mv_1218.tag) {
                case types_SExpr_sym:
                {
                    __auto_type mod_sym = _mv_1218.data.sym;
                    {
                        ...
                        __auto_type _mv_1219 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_1219.has_value) {
                            __auto_type symbols_expr = _mv_1219.value;
                            __auto_type _mv_1220 = (*symbols_expr);
                            switch (_mv_1220.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type symbols_lst = _mv_1220.data.lst;
                                    {
                                        __auto_type syms = symbols_lst.items;
                                        __auto_type sym_len = ((int64_t)((syms).len));
                                        __auto_type j = 0;
                                        while (j < sym_len) {
                                            __auto_type _mv_1221 = ({ __auto_type _lst = syms; size_t _idx = (size_t)j; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_1221.has_value) {
                                                __auto_type sym_item = _mv_1221.value;
                                                __auto_type _mv_1222 = (*sym_item);
                                                switch (_mv_1222.tag) {
                                                    case types_SExpr_sym:
                                                    {
                                                        __auto_type s = _mv_1222.data.sym;
                                                        {
...
void transpiler_register_ffi_function(context_TranspileContext* ctx, types_SExpr* func_decl) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1225 = (*func_decl);
        switch (_mv_1225.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1225.data.lst;
                {
                    ...
                    __auto_type len = ((int64_t)((items).len));
                    if (len >= 1) {
                        __auto_type _mv_1226 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (((int64_t)((items).len)) >= 2) {
            ...
            if (_mv_1228.has_value) {
                ...
                __auto_type _mv_1229 = (*params_expr);
                switch (_mv_1229.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type params_lst = _mv_1229.data.lst;
                        {
                            __auto_type params = params_lst.items;
                            __auto_type param_count = ((int64_t)((params).len));
                            __auto_type i = 0;
                            while (i < param_count) {
                                __auto_type _mv_1230 = ({ __auto_type _lst = params; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1230.has_value) {
                                    __auto_type param_expr = _mv_1230.value;
                                    {
                                        __auto_type c_type = transpiler_prescan_get_param_c_type(ctx, param_expr);
                                        __auto_type param_info = ((context_FuncParamType*)(({ __auto_type _alloc = (context_FuncParamType*)slop_arena_alloc(arena, sizeof(context_FuncParamType)); if (_alloc == NULL) { fprintf(stderr, "SLOP: arena alloc failed at %s:%d\n", __FILE__, __LINE__); abort(); } _alloc; })));
                                        (*param_info).c_type = c_type;
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_1231.has_value) {
                __auto_type item_expr = _mv_1231.value;
                __auto_type _mv_1232 = (*item_expr);
                switch (_mv_1232.tag) {
                    case types_SExpr_sym:
                    {
                        __auto_type sym = _mv_1232.data.sym;
                        if (string_eq(sym.name, SLOP_STR(":c-name"))) {
                            __auto_type _mv_1233 = ({ __auto_type _lst = items; size_t _idx = (size_t)(i + 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_1233.has_value) {
                                __auto_type c_name_expr = _mv_1233.value;
                                __auto_type _mv_1234 = (*c_name_expr);
                                switch (_mv_1234.tag) {
                                    case types_SExpr_sym:
                                    {
                                        __auto_type c_sym = _mv_1234.data.sym;
                                        c_name = c_sym.name;
                                        found_c_name = 1;
                                        break;
                                    }
        ...
        if (len >= 2) {
            {
                ...
                if (has_header) {
                    __auto_type _mv_1235 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_1235.has_value) {
                        __auto_type header_expr = _mv_1235.value;
                        __auto_type _mv_1236 = (*header_expr);
                        switch (_mv_1236.tag) {
                            case types_SExpr_str:
                            {
                                __auto_type str = _mv_1236.data.str;
                                context_ctx_add_include(ctx, str.value);
                                break;
                            }
                            default: {
                ...
                if (len >= (name_idx + 1)) {
                    __auto_type _mv_1237 = ({ __auto_type _lst = items; size_t _idx = (size_t)name_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_1237.has_value) {
                        __auto_type name_expr = _mv_1237.value;
                        __auto_type _mv_1238 = (*name_expr);
                        switch (_mv_1238.tag) {
                            case types_SExpr_sym:
                            {
...
slop_string transpiler_get_ffi_struct_c_name(slop_arena* arena, slop_list_types_SExpr_ptr items, int64_t name_idx, slop_string default_name) {
    {
        ...
        if (len >= (modifier_idx + 2)) {
            __auto_type _mv_1239 = ({ __auto_type _lst = items; size_t _idx = (size_t)modifier_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1239.has_value) {
                __auto_type mod_expr = _mv_1239.value;
                __auto_type _mv_1240 = (*mod_expr);
                switch (_mv_1240.tag) {
                    case types_SExpr_sym:
                    {
                        __auto_type sym = _mv_1240.data.sym;
                        if (string_eq(sym.name, SLOP_STR(":c-name"))) {
                            __auto_type _mv_1241 = ({ __auto_type _lst = items; size_t _idx = (size_t)(modifier_idx + 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_1241.has_value) {
                                __auto_type cname_expr = _mv_1241.value;
                                __auto_type _mv_1242 = (*cname_expr);
                                switch (_mv_1242.tag) {
                                    case types_SExpr_str:
                                    {
                                        __auto_type str = _mv_1242.data.str;
...
uint8_t transpiler_is_ffi_string_item(slop_list_types_SExpr_ptr items, int64_t idx) {
    __auto_type _mv_1243 = ({ __auto_type _lst = items; size_t _idx = (size_t)idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    if (_mv_1243.has_value) {
        ...
        switch (_mv_1244.tag) {
            case types_SExpr_str:
            {
                __auto_type _ = _mv_1244.data.str;
                return 1;
            }
            default: {
                return 0;
...
slop_string transpiler_get_array_c_type(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items, slop_string default_c_type) {
    ...
    if (((int64_t)((items).len)) < 3) {
        ...
        __auto_type _mv_1257 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                ...
                case types_SExpr_lst:
                {
                    __auto_type body_lst = _mv_1258.data.lst;
                    {
                        ...
                        if (((int64_t)((body_items).len)) < 2) {
                            ...
                            __auto_type _mv_1259 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                ...
                                switch (_mv_1260.tag) {
                                    case types_SExpr_sym:
                                    {
                                        ...
                                        if (string_eq(sym.name, SLOP_STR("Array"))) {
                                            __auto_type _mv_1261 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_1261.has_value) {
                                                __auto_type elem_expr = _mv_1261.value;
                                                {
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1264.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 3) {
                    ...
                    __auto_type _mv_1265 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            ...
                            case types_SExpr_lst:
                            {
                                __auto_type def_lst = _mv_1266.data.lst;
                                {
                                    ...
                                    if (((int64_t)((def_items).len)) < 1) {
                                        ...
                                        __auto_type _mv_1267 = ({ __auto_type _lst = def_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void transpiler_transpile_module(context_TranspileContext* ctx, types_SExpr* module_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1276 = (*module_expr);
        switch (_mv_1276.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1276.data.lst;
                {
                    ...
                    __auto_type len = ((int64_t)((items).len));
                    if (len >= 2) {
                        __auto_type _mv_1277 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
int64_t transpiler_get_body_start(slop_list_types_SExpr_ptr items) {
    if (((int64_t)((items).len)) < 3) {
        ...
        __auto_type _mv_1279 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        if (_mv_1279.has_value) {
            __auto_type third = _mv_1279.value;
            __auto_type _mv_1280 = (*third);
            switch (_mv_1280.tag) {
                case types_SExpr_lst:
                {
...
slop_list_string transpiler_get_export_names(slop_arena* arena, slop_list_types_SExpr_ptr items) {
    {
        ...
        int64_t i = 2;
        while (i < len) {
            __auto_type _mv_1283 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                ...
                switch (_mv_1284.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type lst = _mv_1284.data.lst;
                        {
                            __auto_type sub_items = lst.items;
                            if (((int64_t)((sub_items).len)) >= 1) {
                                __auto_type _mv_1285 = ({ __auto_type _lst = sub_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            ...
                                            if (string_eq(sym.name, SLOP_STR("export"))) {
                                                {
                                                    ...
                                                    __auto_type j = 1;
                                                    while (j < export_len) {
                                                        __auto_type _mv_1287 = ({ __auto_type _lst = sub_items; size_t _idx = (size_t)j; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                        if (_mv_1287.has_value) {
                                                            ...
                                                            switch (_mv_1288.tag) {
                                                                case types_SExpr_sym:
                                                                {
                                                                    __auto_type name_sym = _mv_1288.data.sym;
...
uint8_t transpiler_list_contains_str(slop_list_string lst, slop_string needle) {
    {
        ...
        uint8_t found = 0;
        while ((i < len) && !(found)) {
            __auto_type _mv_1289 = ({ __auto_type _lst = lst; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1289.has_value) {
                __auto_type s = _mv_1289.value;
...
void transpiler_scan_type_for_generics(context_TranspileContext* ctx, types_SExpr* type_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1291 = (*type_expr);
        switch (_mv_1291.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1291.data.lst;
                {
                    ...
                    __auto_type len = ((int64_t)((items).len));
                    if (len >= 1) {
                        __auto_type _mv_1292 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                ...
                                case types_SExpr_sym:
                                {
                                    __auto_type sym = _mv_1293.data.sym;
                                    {
                                        ...
                                        if (string_eq(op, SLOP_STR("Option"))) {
                                            if (len >= 2) {
                                                __auto_type _mv_1294 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            ...
                                            if (len >= 2) {
                                                ...
                                                if (_mv_1296.has_value) {
                                                    __auto_type inner = _mv_1296.value;
                                                    transpiler_scan_type_for_generics(ctx, inner);
                                            ...
                                            if (len >= 3) {
                                                ...
                                                if (_mv_1297.has_value) {
                                                    __auto_type ok_type = _mv_1297.value;
                                                    ...
                                                    if (_mv_1298.has_value) {
                                                        __auto_type err_type = _mv_1298.value;
                                                        {
                                            ...
                                            if (len >= 2) {
                                                ...
                                                if (_mv_1299.has_value) {
                                                    __auto_type elem = _mv_1299.value;
                                                    {
                                                        __auto_type elem_c = context_to_c_type_prefixed(ctx, elem);
                                                        __auto_type elem_id = ctype_type_to_identifier(arena, elem_c);
                                                        __auto_type c_name = context_ctx_str(ctx, SLOP_STR("slop_chan_"), elem_id);
                                            ...
                                            if (len >= 2) {
                                                ...
                                                if (_mv_1300.has_value) {
                                                    __auto_type result = _mv_1300.value;
                                                    {
                                            ...
                                            if (len >= 3) {
                                                __auto_type _mv_1301 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_1301.has_value) {
                                                    __auto_type key_type = _mv_1301.value;
                                                    {
                                                        ...
                                                        if (_mv_1302.has_value) {
                                                            __auto_type val_type = _mv_1302.value;
                                                            {
                                            ...
                                            if (len >= 2) {
                                                ...
                                                if (_mv_1303.has_value) {
                                                    __auto_type elem_type = _mv_1303.value;
                                                    {
...
void transpiler_scan_record_fields_for_generics(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 1;
        while (i < len) {
            __auto_type _mv_1304 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1304.has_value) {
                __auto_type field_expr = _mv_1304.value;
                __auto_type _mv_1305 = (*field_expr);
                switch (_mv_1305.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type field_lst = _mv_1305.data.lst;
                        {
                            __auto_type field_items = field_lst.items;
                            if (((int64_t)((field_items).len)) >= 2) {
                                __auto_type _mv_1306 = ({ __auto_type _lst = field_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void transpiler_emit_ffi_includes(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1307 = ({ __auto_type _lst = includes; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1307.has_value) {
                __auto_type header = _mv_1307.value;
...
void transpiler_emit_ffi_includes_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1308 = ({ __auto_type _lst = includes; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1308.has_value) {
                __auto_type header = _mv_1308.value;
...
void transpiler_emit_header_guard_open(context_TranspileContext* ctx) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1309 = context_ctx_get_module(ctx);
        if (_mv_1309.has_value) {
            __auto_type mod_name = _mv_1309.value;
            {
...
void transpiler_emit_header_dependency_includes(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1310 = ({ __auto_type _lst = imports; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1310.has_value) {
                __auto_type mod_name = _mv_1310.value;
                {
                    __auto_type c_name = ctype_to_c_name(arena, mod_name);
...
void transpiler_emit_forward_decls(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items, int64_t start) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            __auto_type _mv_1311 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1311.has_value) {
                __auto_type item = _mv_1311.value;
                if (transpiler_is_type_def(item) && transpiler_is_struct_type_def(item)) {
                    __auto_type _mv_1312 = transpiler_get_type_name(item);
                    if (_mv_1312.has_value) {
                        __auto_type type_name = _mv_1312.value;
                        {
        ...
        while ((i < len) && !(found)) {
            ...
            if (_mv_1318.has_value) {
                ...
                switch (_mv_1319.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type _ = _mv_1319.data.lst;
                        found = 1;
                        break;
                    }
                    default: {
            ...
            __auto_type lst = _mv_1320.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 3) {
                    ...
                    if (_mv_1321.has_value) {
                        __auto_type def_expr = _mv_1321.value;
                        __auto_type _mv_1322 = (*def_expr);
                        switch (_mv_1322.tag) {
                            case types_SExpr_sym:
                            {
                                __auto_type _ = _mv_1322.data.sym;
                                return 1;
                            }
                            case types_SExpr_lst:
                            {
                                __auto_type def_lst = _mv_1322.data.lst;
                                {
                                    __auto_type def_items = def_lst.items;
                                    if (((int64_t)((def_items).len)) < 1) {
                                        return 0;
                                    } else {
                                        __auto_type _mv_1323 = ({ __auto_type _lst = def_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            ...
            __auto_type lst = _mv_1325.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 3) {
                    ...
                    if (_mv_1326.has_value) {
                        __auto_type def_expr = _mv_1326.value;
                        __auto_type _mv_1327 = (*def_expr);
                        switch (_mv_1327.tag) {
                            case types_SExpr_lst:
                            {
                                __auto_type def_lst = _mv_1327.data.lst;
                                {
                                    __auto_type def_items = def_lst.items;
                                    if (((int64_t)((def_items).len)) < 1) {
                                        return 0;
                                    } else {
                                        __auto_type _mv_1328 = ({ __auto_type _lst = def_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1332.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) < 2) {
                        ...
                        __auto_type _mv_1333 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                ...
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_1337.data.sym;
                                    {
                                        ...
                                        if (_mv_1338.has_value) {
                                            __auto_type body_expr = _mv_1338.value;
...
uint8_t transpiler_is_array_type_body(types_SExpr* body_expr) {
    SLOP_PRE(((body_expr != NULL)), "(!= body-expr nil)");
    __auto_type _mv_1339 = (*body_expr);
    switch (_mv_1339.tag) {
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1339.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 1) {
                    ...
                    __auto_type _mv_1340 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_1340.has_value) {
                        __auto_type head = _mv_1340.value;
                        __auto_type _mv_1341 = (*head);
                        switch (_mv_1341.tag) {
                            case types_SExpr_sym:
                            {
                                __auto_type sym = _mv_1341.data.sym;
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1342.data.lst;
                {
                    ...
                    if (len < 3) {
                        ...
                        __auto_type _mv_1343 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_1343.has_value) {
                            __auto_type elem_type_expr = _mv_1343.value;
                            ...
                            if (_mv_1344.has_value) {
                                __auto_type size_expr = _mv_1344.value;
                                {
...
slop_string transpiler_get_array_size_string(types_SExpr* expr) {
    SLOP_PRE(((expr != NULL)), "(!= expr nil)");
    __auto_type _mv_1345 = (*expr);
    switch (_mv_1345.tag) {
        case types_SExpr_num:
        {
            __auto_type num = _mv_1345.data.num;
            return num.raw;
        }
        default: {
            return SLOP_STR("0");
                    ...
                    while (i < len) {
                        ...
                        if (_mv_1350.has_value) {
                            ...
                            switch (_mv_1351.tag) {
                                case types_SExpr_num:
                                {
                                    __auto_type num = _mv_1351.data.num;
                                    if (!(found_dots)) {
...
void transpiler_emit_forward_decls_header(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items, int64_t start) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        uint8_t emitted_any = 0;
        while (i < len) {
            __auto_type _mv_1352 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1352.has_value) {
                __auto_type item = _mv_1352.value;
                if (transpiler_is_type_def(item) && transpiler_is_struct_type_def(item)) {
                    __auto_type _mv_1353 = transpiler_get_type_name(item);
                    if (_mv_1353.has_value) {
                        __auto_type type_name = _mv_1353.value;
                        {
...
void transpiler_emit_fn_forward_decls(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items, int64_t start) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        uint8_t emitted_any = 0;
        while (i < len) {
            __auto_type _mv_1354 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void transpiler_emit_c_name_aliases(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len > 0) {
            ...
            while (i < len) {
                __auto_type _mv_1356 = ({ __auto_type _lst = aliases; size_t _idx = (size_t)i; slop_option_context_FuncCNameAlias _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_1356.has_value) {
                    __auto_type alias = _mv_1356.value;
                    ...
                    if (len >= 3) {
                        ...
                        if (_mv_1358.has_value) {
                            ...
                            switch (_mv_1359.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_1359.data.sym;
                                    {
                                        ...
                                        if (_mv_1360.has_value) {
                                            __auto_type params_expr = _mv_1360.value;
                                            {
            ...
            __auto_type lst = _mv_1361.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 2) {
                    ...
                    if (_mv_1362.has_value) {
                        __auto_type name_expr = _mv_1362.value;
                        __auto_type _mv_1363 = (*name_expr);
                        switch (_mv_1363.tag) {
                            case types_SExpr_sym:
                            {
...
void transpiler_emit_result_types(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1368 = ({ __auto_type _lst = result_types; size_t _idx = (size_t)i; slop_option_context_ResultType _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1368.has_value) {
                __auto_type rt = _mv_1368.value;
...
void transpiler_emit_result_types_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1369 = ({ __auto_type _lst = result_types; size_t _idx = (size_t)i; slop_option_context_ResultType _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1369.has_value) {
                __auto_type rt = _mv_1369.value;
...
void transpiler_emit_inline_records_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1370 = ({ __auto_type _lst = inline_records; size_t _idx = (size_t)i; slop_option_context_InlineRecord _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1370.has_value) {
                __auto_type ir = _mv_1370.value;
                {
...
void transpiler_emit_option_types_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1371 = ({ __auto_type _lst = option_types; size_t _idx = (size_t)i; slop_option_context_OptionType _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void transpiler_emit_imported_option_types_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1378 = ({ __auto_type _lst = option_types; size_t _idx = (size_t)i; slop_option_context_OptionType _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1378.has_value) {
                __auto_type ot = _mv_1378.value;
...
void transpiler_emit_late_registered_list_types_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1379 = ({ __auto_type _lst = list_types; size_t _idx = (size_t)i; slop_option_context_ListType _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void transpiler_emit_late_registered_option_types_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1380 = ({ __auto_type _lst = option_types; size_t _idx = (size_t)i; slop_option_context_OptionType _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1380.has_value) {
                __auto_type ot = _mv_1380.value;
                transpiler_emit_single_option_type_header(ctx, ot);
...
void transpiler_emit_union_payload_hash_eq(context_TranspileContext* ctx, slop_list_context_UnionVariantEntry variants) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1383 = ({ __auto_type _lst = variants; size_t _idx = (size_t)i; slop_option_context_UnionVariantEntry _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1383.has_value) {
                __auto_type variant = _mv_1383.value;
                {
...
void transpiler_emit_record_field_dependencies(context_TranspileContext* ctx, slop_list_context_FieldEntry fields) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1384 = ({ __auto_type _lst = fields; size_t _idx = (size_t)i; slop_option_context_FieldEntry _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1384.has_value) {
                __auto_type field = _mv_1384.value;
                {
...
uint8_t transpiler_is_range_type_alias(context_TranspileContext* ctx, slop_string slop_type) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    __auto_type _mv_1385 = context_ctx_lookup_type_alias(ctx, slop_type);
    if (_mv_1385.has_value) {
        __auto_type underlying = _mv_1385.value;
...
slop_string transpiler_resolve_payload_slop_type(context_TranspileContext* ctx, slop_string slop_type) {
    ...
    if (transpiler_is_range_type_alias(ctx, slop_type)) {
        __auto_type _mv_1386 = context_ctx_lookup_type_alias(ctx, slop_type);
        if (_mv_1386.has_value) {
            __auto_type underlying = _mv_1386.value;
            return underlying;
...
slop_list_transpiler_PayloadSlot transpiler_union_variant_payloads(context_TranspileContext* ctx, slop_string union_name, slop_string variant_name) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        __auto_type _mv_1387 = context_ctx_lookup_field_type(ctx, union_name, count_key);
        if (_mv_1387.has_value) {
            __auto_type _ = _mv_1387.value;
            {
                __auto_type i = 0;
                __auto_type more = 1;
                while (more) {
                    {
                        ...
                        __auto_type _mv_1388 = context_ctx_lookup_field_type(ctx, union_name, key);
                        if (_mv_1388.has_value) {
                            __auto_type slot_c_type = _mv_1388.value;
                            {
...
void transpiler_emit_union_hash_fn(context_TranspileContext* ctx, slop_string c_type, slop_list_context_UnionVariantEntry variants) {
    ...
    context_ctx_emit_header(ctx, SLOP_STR("    switch (_k->tag) {"));
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1389 = ({ __auto_type _lst = variants; size_t _idx = (size_t)i; slop_option_context_UnionVariantEntry _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1389.has_value) {
                __auto_type variant = _mv_1389.value;
...
void transpiler_emit_multi_payload_hash(context_TranspileContext* ctx, slop_string c_variant_name, slop_list_transpiler_PayloadSlot payloads) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            __auto_type _mv_1390 = ({ __auto_type _lst = payloads; size_t _idx = (size_t)i; slop_option_transpiler_PayloadSlot _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1390.has_value) {
                __auto_type slot = _mv_1390.value;
                {
...
void transpiler_emit_union_eq_fn(context_TranspileContext* ctx, slop_string c_type, slop_list_context_UnionVariantEntry variants) {
    ...
    context_ctx_emit_header(ctx, SLOP_STR("    switch (_a->tag) {"));
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1391 = ({ __auto_type _lst = variants; size_t _idx = (size_t)i; slop_option_context_UnionVariantEntry _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1391.has_value) {
                __auto_type variant = _mv_1391.value;
...
void transpiler_emit_multi_payload_eq(context_TranspileContext* ctx, slop_string c_variant_name, slop_list_transpiler_PayloadSlot payloads) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        context_ctx_emit_header(ctx, SLOP_STR("            return true"));
        while (i < len) {
            __auto_type _mv_1392 = ({ __auto_type _lst = payloads; size_t _idx = (size_t)i; slop_option_transpiler_PayloadSlot _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1392.has_value) {
                __auto_type slot = _mv_1392.value;
                {
...
void transpiler_emit_struct_hash_fn(context_TranspileContext* ctx, slop_string c_type, slop_list_context_FieldEntry fields) {
    ...
    context_ctx_emit_header(ctx, SLOP_STR("    uint64_t hash = 14695981039346656037ULL;"));
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1393 = ({ __auto_type _lst = fields; size_t _idx = (size_t)i; slop_option_context_FieldEntry _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1393.has_value) {
                __auto_type field = _mv_1393.value;
    ...
    context_ctx_emit_header(ctx, context_ctx_str(ctx, context_ctx_str4(ctx, SLOP_STR("    const "), c_type, SLOP_STR("* _b = (const "), c_type), SLOP_STR("*)b;")));
    {
        ...
        if (len == 0) {
            ...
            context_ctx_emit_header(ctx, SLOP_STR("    return true"));
            {
                int64_t i = 0;
                while (i < len) {
                    __auto_type _mv_1394 = ({ __auto_type _lst = fields; size_t _idx = (size_t)i; slop_option_context_FieldEntry _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_1394.has_value) {
                        __auto_type field = _mv_1394.value;
...
void transpiler_emit_struct_key_types_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < ((int64_t)((struct_key_types).len))) {
            __auto_type _mv_1395 = ({ __auto_type _lst = struct_key_types; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1395.has_value) {
                __auto_type c_type = _mv_1395.value;
                {
...
void transpiler_emit_chan_types_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1396 = ({ __auto_type _lst = chan_types; size_t _idx = (size_t)i; slop_option_context_ChanType _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1396.has_value) {
                __auto_type ct = _mv_1396.value;
                {
...
void transpiler_emit_chan_funcs_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1397 = ({ __auto_type _lst = chan_types; size_t _idx = (size_t)i; slop_option_context_ChanType _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1397.has_value) {
                __auto_type ct = _mv_1397.value;
                {
                    __auto_type elem_type = ct.elem_type;
                    __auto_type c_name = ct.c_name;
...
void transpiler_emit_thread_types_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1398 = ({ __auto_type _lst = thread_types; size_t _idx = (size_t)i; slop_option_context_ThreadType _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1398.has_value) {
                __auto_type tt = _mv_1398.value;
                {
...
void transpiler_emit_pending_container_deps(context_TranspileContext* ctx, types_SExpr* type_def) {
    ...
    SLOP_PRE(((type_def != NULL)), "(!= type-def nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1410 = ({ __auto_type _lst = field_types; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1410.has_value) {
                __auto_type field_type = _mv_1410.value;
...
void transpiler_emit_option_by_c_name(context_TranspileContext* ctx, slop_string c_name) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1411 = ({ __auto_type _lst = option_types; size_t _idx = (size_t)i; slop_option_context_OptionType _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1411.has_value) {
                __auto_type ot = _mv_1411.value;
...
void transpiler_emit_list_by_c_name(context_TranspileContext* ctx, slop_string c_name) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1412 = ({ __auto_type _lst = list_types; size_t _idx = (size_t)i; slop_option_context_ListType _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            ...
            prev_count = current_count;
            {
                ...
                while (i < len) {
                    if (!(transpiler_index_in_list(emitted, i))) {
                        __auto_type _mv_1413 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        if (transpiler_has_unemitted_struct_types(items, start, len, emitted)) {
            ...
            while (prev_count != current_count) {
                prev_count = current_count;
                {
                    ...
                    while (i < len) {
                        if (!(transpiler_index_in_list(emitted, i))) {
                            __auto_type _mv_1414 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    ...
                    if (transpiler_is_type_def(item) && transpiler_is_struct_type_def(item)) {
                        {
                            ...
                            __auto_type j = 0;
                            while (j < dep_len) {
                                __auto_type _mv_1417 = ({ __auto_type _lst = blocking_deps; size_t _idx = (size_t)j; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1417.has_value) {
                                    __auto_type dep_name = _mv_1417.value;
...
slop_list_string transpiler_find_blocking_list_deps(context_TranspileContext* ctx, types_SExpr* type_def) {
    ...
    SLOP_PRE(((type_def != NULL)), "(!= type-def nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1418 = ({ __auto_type _lst = field_types; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1418.has_value) {
                __auto_type field_type = _mv_1418.value;
...
uint8_t transpiler_index_in_list(slop_list_int lst, int64_t idx) {
    {
        ...
        uint8_t found = 0;
        while ((i < len) && !(found)) {
            __auto_type _mv_1420 = ({ __auto_type _lst = lst; size_t _idx = (size_t)i; slop_option_int _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                ...
                __auto_type lst = _mv_1422.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) >= 3) {
                        ...
                        if (_mv_1423.has_value) {
                            __auto_type def_expr = _mv_1423.value;
                            __auto_type _mv_1424 = (*def_expr);
                            switch (_mv_1424.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type def_lst = _mv_1424.data.lst;
                                    {
                                        __auto_type def_items = def_lst.items;
                                        __auto_type def_len = ((int64_t)((def_items).len));
                                        if (def_len > 0) {
                                            __auto_type _mv_1425 = ({ __auto_type _lst = def_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_list_string transpiler_extract_record_field_types(context_TranspileContext* ctx, slop_list_types_SExpr_ptr def_items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 1;
        while (i < len) {
            __auto_type _mv_1427 = ({ __auto_type _lst = def_items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1427.has_value) {
                ...
                switch (_mv_1428.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type field_lst = _mv_1428.data.lst;
                        if (((int64_t)((field_lst.items).len)) >= 2) {
                            __auto_type _mv_1429 = ({ __auto_type _lst = field_lst.items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_1430.has_value) {
                __auto_type variant_expr = _mv_1430.value;
                __auto_type _mv_1431 = (*variant_expr);
                switch (_mv_1431.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type variant_lst = _mv_1431.data.lst;
                        if (((int64_t)((variant_lst.items).len)) >= 2) {
                            __auto_type _mv_1432 = ({ __auto_type _lst = variant_lst.items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_string transpiler_get_field_type_string(context_TranspileContext* ctx, types_SExpr* type_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1433 = (*type_expr);
        switch (_mv_1433.tag) {
            case types_SExpr_sym:
            {
                ...
                {
                    __auto_type name = sym.name;
                    __auto_type _mv_1434 = context_ctx_lookup_type(ctx, name);
                    if (_mv_1434.has_value) {
                        __auto_type entry = _mv_1434.value;
                        return entry.c_name;
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1433.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) < 1) {
                        ...
                        __auto_type _mv_1435 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    ...
                    if (_mv_1440.has_value) {
                        ...
                        switch (_mv_1441.tag) {
                            case types_SExpr_sym:
                            {
                                ...
                                {
                                    __auto_type name = sym.name;
                                    __auto_type _mv_1442 = context_ctx_lookup_type(ctx, name);
                                    if (_mv_1442.has_value) {
                                        __auto_type entry = _mv_1442.value;
                                        return entry.c_name;
...
void transpiler_emit_option_for_inner_type(context_TranspileContext* ctx, slop_string inner_c_name) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1443 = ({ __auto_type _lst = option_types; size_t _idx = (size_t)i; slop_option_context_OptionType _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1443.has_value) {
                __auto_type ot = _mv_1443.value;
...
void transpiler_emit_list_for_elem_type(context_TranspileContext* ctx, slop_string elem_c_name) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1444 = ({ __auto_type _lst = list_types; size_t _idx = (size_t)i; slop_option_context_ListType _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        if (!(found)) {
            {
                ...
                int64_t j = 0;
                while ((j < len2) && !(found)) {
                    __auto_type _mv_1446 = ({ __auto_type _lst = option_types; size_t _idx = (size_t)j; slop_option_context_OptionType _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void transpiler_emit_struct_dependent_option_types(context_TranspileContext* ctx, types_SExpr* type_def) {
    ...
    SLOP_PRE(((type_def != NULL)), "(!= type-def nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1448 = ({ __auto_type _lst = option_types; size_t _idx = (size_t)i; slop_option_context_OptionType _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void transpiler_emit_struct_dependent_option_types_safe(context_TranspileContext* ctx, types_SExpr* type_def) {
    ...
    SLOP_PRE(((type_def != NULL)), "(!= type-def nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1450 = ({ __auto_type _lst = option_types; size_t _idx = (size_t)i; slop_option_context_OptionType _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
uint8_t transpiler_is_imported_type(context_TranspileContext* ctx, slop_string type_name) {
    ...
    if (strlib_starts_with(type_name, SLOP_STR("slop_list_")) || strlib_starts_with(type_name, SLOP_STR("slop_option_"))) {
        ...
        __auto_type _mv_1451 = context_ctx_get_module(ctx);
        if (_mv_1451.has_value) {
            __auto_type current_mod = _mv_1451.value;
            {
                __auto_type arena = (*ctx).arena;
    ...
    if (strlib_starts_with(inner_type, SLOP_STR("slop_list_"))) {
        {
            ...
            int64_t i = 0;
            while (i < len) {
                __auto_type _mv_1453 = ({ __auto_type _lst = list_types; size_t _idx = (size_t)i; slop_option_context_ListType _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                ...
                __auto_type lst = _mv_1454.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) < 3) {
                        ...
                        if (_mv_1455.has_value) {
                            __auto_type body_expr = _mv_1455.value;
...
uint8_t transpiler_type_body_uses_typename(context_TranspileContext* ctx, types_SExpr* body_expr, slop_string typename) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1456 = (*body_expr);
        switch (_mv_1456.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1456.data.lst;
                {
                    ...
                    __auto_type i = 1;
                    while ((i < len) && !(found)) {
                        __auto_type _mv_1457 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_1457.has_value) {
                            __auto_type field_expr = _mv_1457.value;
...
uint8_t transpiler_field_uses_typename(context_TranspileContext* ctx, types_SExpr* field_expr, slop_string typename) {
    ...
    __auto_type _mv_1458 = (*field_expr);
    switch (_mv_1458.tag) {
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1458.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 2) {
                    ...
                    if (_mv_1459.has_value) {
                        __auto_type type_expr = _mv_1459.value;
                        {
                            __auto_type c_type = context_to_c_type_prefixed(ctx, type_expr);
                    ...
                    if (len >= 3) {
                        ...
                        if (_mv_1461.has_value) {
                            ...
                            switch (_mv_1462.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_1462.data.sym;
                                    {
                                        __auto_type type_name = name_sym.name;
                                        __auto_type base_name = ctype_to_c_name(arena, type_name);
                                        __auto_type c_name = ((context_ctx_prefixing_enabled(ctx)) ? ({ __auto_type _mv = context_ctx_get_module(ctx); _mv.has_value ? ({ __auto_type mod_name = _mv.value; context_ctx_str(ctx, ctype_to_c_name(arena, mod_name), context_ctx_str(ctx, SLOP_STR("_"), base_name)); }) : (base_name); }) : base_name);
                                        __auto_type _mv_1463 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_1463.has_value) {
                                            __auto_type body_expr = _mv_1463.value;
...
void transpiler_emit_type_body_to_header(context_TranspileContext* ctx, slop_string raw_type_name, slop_string c_name, types_SExpr* body_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1464 = (*body_expr);
        switch (_mv_1464.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1464.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) < 1) {
                        ...
                        if (_mv_1465.has_value) {
                            __auto_type kind_expr = _mv_1465.value;
                            __auto_type _mv_1466 = (*kind_expr);
                            switch (_mv_1466.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type kind_sym = _mv_1466.data.sym;
                                    {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_1467.has_value) {
                __auto_type variant_expr = _mv_1467.value;
                __auto_type _mv_1468 = (*variant_expr);
                switch (_mv_1468.tag) {
                    case types_SExpr_sym:
                    {
                        __auto_type variant_sym = _mv_1468.data.sym;
                        {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_1469.has_value) {
                __auto_type field_expr = _mv_1469.value;
...
void transpiler_emit_field_to_header(context_TranspileContext* ctx, slop_string raw_type_name, slop_string c_type_name, types_SExpr* field_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1470 = (*field_expr);
        switch (_mv_1470.tag) {
            case types_SExpr_lst:
            {
                                ...
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_1472.data.sym;
                                    {
                                        ...
                                        if (_mv_1473.has_value) {
                                            __auto_type type_expr = _mv_1473.value;
                                            {
                                                __auto_type c_type = context_to_c_type_prefixed(ctx, type_expr);
                                                __auto_type slop_type_str = parser_pretty_print(arena, type_expr);
                                                __auto_type is_ptr = transpiler_is_pointer_type_expr_header(type_expr);
...
uint8_t transpiler_is_pointer_type_expr_header(types_SExpr* type_expr) {
    SLOP_PRE(((type_expr != NULL)), "(!= type-expr nil)");
    __auto_type _mv_1474 = (*type_expr);
    switch (_mv_1474.tag) {
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1474.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 1) {
                    ...
                    __auto_type _mv_1475 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        context_ctx_emit_header(ctx, SLOP_STR("    union {"));
        {
            ...
            while (i < len) {
                ...
                if (_mv_1478.has_value) {
                    __auto_type variant_expr = _mv_1478.value;
...
slop_string transpiler_get_variant_name(types_SExpr* variant_expr) {
    ...
    __auto_type _mv_1479 = (*variant_expr);
    switch (_mv_1479.tag) {
        case types_SExpr_sym:
        {
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1479.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 1) {
                    ...
                    __auto_type _mv_1480 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    ...
                                    __auto_type name_sym = _mv_1484.data.sym;
                                    {
                                        ...
                                        if (num_items == 2) {
                                            ...
                                            if (_mv_1485.has_value) {
                                                __auto_type type_expr = _mv_1485.value;
                                                {
                                                    __auto_type c_type = context_to_c_type_prefixed(ctx, type_expr);
                                                    {
                                            ...
                                            for (int64_t fi = 1; fi < num_items; fi++) {
                                                __auto_type _mv_1486 = ({ __auto_type _lst = items; size_t _idx = (size_t)fi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1488.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 2) {
                    ...
                    __auto_type _mv_1489 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
uint8_t transpiler_emit_const_header_if_exported(context_TranspileContext* ctx, types_SExpr* item, slop_list_string exports) {
    ...
    switch (_mv_1492.tag) {
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1492.data.lst;
            {
                __auto_type const_items = lst.items;
                if (((int64_t)((const_items).len)) < 4) {
                    return 0;
                } else {
                    __auto_type _mv_1493 = ({ __auto_type _lst = const_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            ...
                            case types_SExpr_sym:
                            {
                                __auto_type name_sym = _mv_1494.data.sym;
                                {
                                    ...
                                    if (!(transpiler_list_contains_str(exports, raw_name))) {
                                        ...
                                        __auto_type _mv_1495 = ({ __auto_type _lst = const_items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_1495.has_value) {
                                            __auto_type type_expr = _mv_1495.value;
...
void transpiler_emit_all_lambdas(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (count > 0) {
            while (i < count) {
                __auto_type _mv_1497 = ({ __auto_type _lst = lambdas; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_1497.has_value) {
                    __auto_type lambda_code = _mv_1497.value;
...
slop_string transpiler_generate_c_output(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1498 = ({ __auto_type _lst = output_lines; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1498.has_value) {
                __auto_type line = _mv_1498.value;
...
void transpiler_transpile_file(context_TranspileContext* ctx, slop_list_types_SExpr_ptr exprs) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len > 0) && transpiler_is_module_expr(exprs)) {
            __auto_type _mv_1499 = ({ __auto_type _lst = exprs; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1499.has_value) {
                __auto_type module_expr = _mv_1499.value;
...
uint8_t transpiler_is_module_expr(slop_list_types_SExpr_ptr exprs) {
    if (((int64_t)((exprs).len)) < 1) {
        ...
        __auto_type _mv_1500 = ({ __auto_type _lst = exprs; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        if (_mv_1500.has_value) {
            __auto_type first = _mv_1500.value;
            __auto_type _mv_1501 = (*first);
            switch (_mv_1501.tag) {
                case types_SExpr_lst:
                {
