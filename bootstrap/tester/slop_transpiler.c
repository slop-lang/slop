                    ...
                    case types_SExpr_lst:
                    {
                        __auto_type lst = _mv_1101.data.lst;
                        {
                            ...
                            if (((int64_t)((sub_items).len)) >= 1) {
                                __auto_type _mv_1102 = ({ __auto_type _lst = sub_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        ...
                                        case types_SExpr_sym:
                                        {
                                            ...
                                            if (string_eq(sym.name, SLOP_STR("@generic"))) {
                                                if (((int64_t)((sub_items).len)) >= 2) {
                                                    __auto_type _mv_1104 = ({ __auto_type _lst = sub_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_1104.has_value) {
                                                        __auto_type params_expr = _mv_1104.value;
                                                        __auto_type _mv_1105 = (*params_expr);
                                                        switch (_mv_1105.tag) {
                                                            case types_SExpr_lst:
                                                            {
                                                                __auto_type params_lst = _mv_1105.data.lst;
                                                                {
                                                                    __auto_type param_items = params_lst.items;
                                                                    __auto_type param_len = ((int64_t)((param_items).len));
                                                                    __auto_type j = 0;
                                                                    while (j < param_len) {
                                                                        __auto_type _mv_1106 = ({ __auto_type _lst = param_items; size_t _idx = (size_t)j; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                                        if (_mv_1106.has_value) {
                                                                            ...
                                                                            switch (_mv_1107.tag) {
                                                                                case types_SExpr_sym:
                                                                                {
                                                                                    __auto_type param_sym = _mv_1107.data.sym;
                                                            ...
                                                            case types_SExpr_sym:
                                                            {
                                                                __auto_type single_sym = _mv_1105.data.sym;
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1109.data.lst;
            {
                ...
                if (((int64_t)((items).len)) >= 1) {
                    __auto_type _mv_1110 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void transpiler_prescan_type(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (((int64_t)((items).len)) >= 2) {
            __auto_type _mv_1112 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            ...
                            __auto_type c_name = ((context_ctx_prefixing_enabled(ctx)) ? ({ __auto_type _mv = context_ctx_get_module(ctx); _mv.has_value ? ({ __auto_type mod_name = _mv.value; context_ctx_str(ctx, ctype_to_c_name(arena, mod_name), context_ctx_str(ctx, SLOP_STR("_"), base_c_name)); }) : (base_c_name); }) : base_c_name);
                            {
                                ...
                                if (is_record || is_union) {
                                    if (((int64_t)((items).len)) >= 3) {
                                        __auto_type _mv_1114 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                ...
                                if (((int64_t)((items).len)) >= 3) {
                                    ...
                                    if (_mv_1116.has_value) {
                                        __auto_type body_expr = _mv_1116.value;
...
void transpiler_register_enum_variants(context_TranspileContext* ctx, slop_string enum_name, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    if (((int64_t)((items).len)) >= 3) {
        __auto_type _mv_1117 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            ...
            switch (_mv_1118.tag) {
                case types_SExpr_lst:
                {
                    __auto_type def_lst = _mv_1118.data.lst;
                    {
                        ...
                        __auto_type i = 1;
                        while (i < len) {
                            __auto_type _mv_1119 = ({ __auto_type _lst = def_items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_1119.has_value) {
                                __auto_type variant_expr = _mv_1119.value;
                                __auto_type _mv_1120 = (*variant_expr);
                                switch (_mv_1120.tag) {
                                    case types_SExpr_sym:
                                    {
                                    ...
                                    case types_SExpr_lst:
                                    {
                                        __auto_type variant_lst = _mv_1120.data.lst;
                                        if (((int64_t)((variant_lst.items).len)) > 0) {
                                            __auto_type _mv_1121 = ({ __auto_type _lst = variant_lst.items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_1121.has_value) {
                                                ...
                                                switch (_mv_1122.tag) {
                                                    case types_SExpr_sym:
                                                    {
                                                        __auto_type name_sym = _mv_1122.data.sym;
                ...
                switch (_mv_1124.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type def_lst = _mv_1124.data.lst;
                        {
                            ...
                            __auto_type i = 1;
                            while (i < len) {
                                __auto_type _mv_1125 = ({ __auto_type _lst = def_items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1125.has_value) {
                                    __auto_type variant_expr = _mv_1125.value;
                                    __auto_type _mv_1126 = (*variant_expr);
                                    switch (_mv_1126.tag) {
                                        case types_SExpr_sym:
                                        {
                                        ...
                                        case types_SExpr_lst:
                                        {
                                            __auto_type variant_lst = _mv_1126.data.lst;
                                            {
                                                __auto_type vl_items = variant_lst.items;
                                                __auto_type vl_len = ((int64_t)((vl_items).len));
                                                if (vl_len >= 2) {
                                                    __auto_type _mv_1127 = ({ __auto_type _lst = vl_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_1127.has_value) {
                                                        ...
                                                        switch (_mv_1128.tag) {
                                                            case types_SExpr_sym:
                                                            {
                                                                __auto_type name_sym = _mv_1128.data.sym;
                                                                {
                                                                    __auto_type variant_name = name_sym.name;
                                                                    __auto_type c_variant_name = ctype_to_c_name(arena, variant_name);
                                                                    context_ctx_register_enum_variant(ctx, variant_name, union_name);
                                                                    __auto_type _mv_1129 = ({ __auto_type _lst = vl_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                                    ...
                                                                    if (vl_len >= 3) {
                                                                        ...
                                                                        for (int64_t fi = 1; fi < vl_len; fi++) {
                                                                            __auto_type _mv_1130 = ({ __auto_type _lst = vl_items; size_t _idx = (size_t)fi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    ...
                                                    if (((int64_t)((vl_items).len)) == 1) {
                                                        __auto_type _mv_1131 = ({ __auto_type _lst = vl_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                ...
                switch (_mv_1136.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type lst = _mv_1136.data.lst;
                        {
                            __auto_type sub_items = lst.items;
                            if (((int64_t)((sub_items).len)) >= 2) {
                                __auto_type _mv_1137 = ({ __auto_type _lst = sub_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1137.has_value) {
                                    __auto_type head = _mv_1137.value;
                                    __auto_type _mv_1138 = (*head);
                                    switch (_mv_1138.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type sym = _mv_1138.data.sym;
                                            if (string_eq(sym.name, SLOP_STR("@spec"))) {
                                                __auto_type _mv_1139 = ({ __auto_type _lst = sub_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_1139.has_value) {
                                                    __auto_type spec_body = _mv_1139.value;
                                                    __auto_type _mv_1140 = (*spec_body);
                                                    switch (_mv_1140.tag) {
                                                        case types_SExpr_lst:
                                                        {
                                                            __auto_type body_lst = _mv_1140.data.lst;
                                                            {
                                                                __auto_type body_items = body_lst.items;
                                                                __auto_type body_len = ((int64_t)((body_items).len));
                                                                if (body_len >= 1) {
                                                                    __auto_type _mv_1141 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)(body_len - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                                    if (_mv_1141.has_value) {
                                                                        __auto_type ret_type = _mv_1141.value;
                                                                        __auto_type _mv_1142 = (*ret_type);
                                                                        switch (_mv_1142.tag) {
                                                                            case types_SExpr_sym:
                                                                            {
                                                                                __auto_type ret_sym = _mv_1142.data.sym;
            ...
            switch (_mv_1151.tag) {
                case types_SExpr_lst:
                {
                    __auto_type params_lst = _mv_1151.data.lst;
                    {
                        ...
                        __auto_type i = 0;
                        while (i < param_count) {
                            __auto_type _mv_1152 = ({ __auto_type _lst = params; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_1152.has_value) {
                                __auto_type param_expr = _mv_1152.value;
                                __auto_type _mv_1153 = (*param_expr);
                                switch (_mv_1153.tag) {
                                    case types_SExpr_lst:
                                    {
                                        __auto_type param_lst = _mv_1153.data.lst;
                                        {
                                            __auto_type param_items = param_lst.items;
                                            if (((int64_t)((param_items).len)) >= 2) {
                                                __auto_type _mv_1154 = ({ __auto_type _lst = param_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (((int64_t)((items).len)) >= 3) {
            ...
            if (_mv_1155.has_value) {
                __auto_type params_expr = _mv_1155.value;
                __auto_type _mv_1156 = (*params_expr);
                switch (_mv_1156.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type params_lst = _mv_1156.data.lst;
                        {
                            __auto_type params = params_lst.items;
                            __auto_type param_count = ((int64_t)((params).len));
                            __auto_type i = 0;
                            while (i < param_count) {
                                __auto_type _mv_1157 = ({ __auto_type _lst = params; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                ...
                __auto_type lst = _mv_1158.data.lst;
                {
                    ...
                    if (len < 2) {
                    ...
                    } else {
                        {
                            ...
                            __auto_type _mv_1159 = ({ __auto_type _lst = items; size_t _idx = (size_t)type_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_1159.has_value) {
                                __auto_type type_expr = _mv_1159.value;
...
uint8_t transpiler_prescan_is_param_mode(slop_list_types_SExpr_ptr items) {
    if (((int64_t)((items).len)) < 1) {
        ...
        if (_mv_1160.has_value) {
            __auto_type first = _mv_1160.value;
            __auto_type _mv_1161 = (*first);
            switch (_mv_1161.tag) {
                case types_SExpr_sym:
                {
...
void transpiler_prescan_fn_result_type(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 3;
        while (i < len) {
            __auto_type _mv_1162 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1162.has_value) {
                __auto_type item = _mv_1162.value;
...
void transpiler_extract_result_type(context_TranspileContext* ctx, types_SExpr* spec_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1166 = (*spec_expr);
        switch (_mv_1166.tag) {
            case types_SExpr_lst:
            {
...
void transpiler_check_and_register_result_type(context_TranspileContext* ctx, types_SExpr* type_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1170 = (*type_expr);
        switch (_mv_1170.tag) {
            case types_SExpr_lst:
            {
                            ...
                            switch (_mv_1172.tag) {
                                case types_SExpr_sym:
                                {
                                    ...
                                    if (string_eq(sym.name, SLOP_STR("Result"))) {
                                        __auto_type _mv_1173 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_1173.has_value) {
                                            __auto_type ok_type_expr = _mv_1173.value;
                                            __auto_type _mv_1174 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_1174.has_value) {
                                                __auto_type err_type_expr = _mv_1174.value;
                                                {
    ...
    switch (_mv_1176.tag) {
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1176.data.lst;
            {
                ...
                __auto_type len = ((int64_t)((items).len));
                if (len >= 1) {
                    __auto_type _mv_1177 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            ...
                            case types_SExpr_sym:
                            {
                                __auto_type sym = _mv_1178.data.sym;
                                {
                                    ...
                                    if (string_eq(name, SLOP_STR("map-new"))) {
                                        if (len >= 3) {
                                            __auto_type _mv_1179 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_1179.has_value) {
                                                __auto_type key_type_expr = _mv_1179.value;
                                        ...
                                        if (len >= 3) {
                                            __auto_type _mv_1180 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_1180.has_value) {
                                                __auto_type elem_type_expr = _mv_1180.value;
                                        ...
                                        if (len >= 4) {
                                            ...
                                            if (_mv_1181.has_value) {
                                                __auto_type type_expr = _mv_1181.value;
                                                {
                                    ...
                                    } else {
                                        {
                                            ...
                                            while (i < len) {
                                                ...
                                                if (_mv_1183.has_value) {
                                                    __auto_type child = _mv_1183.value;
                            ...
                            default: {
                                {
                                    __auto_type i = 0;
                                    while (i < len) {
                                        __auto_type _mv_1184 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_1184.has_value) {
                                            __auto_type child = _mv_1184.value;
                                            transpiler_prescan_expr_for_struct_keys(ctx, child);
            ...
            case types_SExpr_sym:
            {
                __auto_type sym = _mv_1185.data.sym;
                {
                    ...
                    if (!(transpiler_is_builtin_map_key_type(name))) {
                        __auto_type _mv_1186 = context_ctx_lookup_type(ctx, name);
                        if (_mv_1186.has_value) {
                            __auto_type type_entry = _mv_1186.value;
                            ...
                            if (_mv_1187.has_value) {
                                __auto_type mod = _mv_1187.value;
                                {
                                    __auto_type prefixed = context_ctx_str3(ctx, mod, SLOP_STR("_"), name);
                                    __auto_type _mv_1188 = context_ctx_lookup_type(ctx, prefixed);
                                    if (_mv_1188.has_value) {
                                        __auto_type type_entry = _mv_1188.value;
                                        context_ctx_register_struct_key_type(ctx, type_entry.c_name);
...
void transpiler_check_and_register_result_alias(context_TranspileContext* ctx, slop_string alias_name, types_SExpr* body_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1189 = (*body_expr);
        switch (_mv_1189.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1189.data.lst;
                {
                    __auto_type items = lst.items;
                    if (((int64_t)((items).len)) >= 3) {
                        __auto_type _mv_1190 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_1190.has_value) {
                            __auto_type head = _mv_1190.value;
                            __auto_type _mv_1191 = (*head);
                            switch (_mv_1191.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type sym = _mv_1191.data.sym;
                                    if (string_eq(sym.name, SLOP_STR("Result"))) {
                                        __auto_type _mv_1192 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_1192.has_value) {
                                            __auto_type ok_type_expr = _mv_1192.value;
                                            __auto_type _mv_1193 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_1193.has_value) {
                                                __auto_type err_type_expr = _mv_1193.value;
                                                {
                                                    __auto_type ok_c_type = context_to_c_type_prefixed(ctx, ok_type_expr);
                                                    __auto_type err_c_type = context_to_c_type_prefixed(ctx, err_type_expr);
                                                    __auto_type result_name = transpiler_build_result_type_name(ctx, ok_c_type, err_c_type);
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len >= 2) {
            ...
            if (_mv_1194.has_value) {
                __auto_type header_expr = _mv_1194.value;
                __auto_type _mv_1195 = (*header_expr);
                switch (_mv_1195.tag) {
                    case types_SExpr_str:
                    {
                        __auto_type str = _mv_1195.data.str;
            ...
            }
            {
                ...
                while (i < len) {
                    ...
                    if (_mv_1196.has_value) {
                        __auto_type func_decl = _mv_1196.value;
...
void transpiler_prescan_import(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    ...
    if (((int64_t)((items).len)) >= 3) {
        ...
        if (_mv_1197.has_value) {
            __auto_type mod_expr = _mv_1197.value;
            __auto_type _mv_1198 = (*mod_expr);
            switch (_mv_1198.tag) {
                case types_SExpr_sym:
                {
                    __auto_type mod_sym = _mv_1198.data.sym;
                    {
                        ...
                        if (_mv_1199.has_value) {
                            __auto_type symbols_expr = _mv_1199.value;
                            __auto_type _mv_1200 = (*symbols_expr);
                            switch (_mv_1200.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type symbols_lst = _mv_1200.data.lst;
                                    {
                                        __auto_type syms = symbols_lst.items;
                                        __auto_type sym_len = ((int64_t)((syms).len));
                                        __auto_type j = 0;
                                        while (j < sym_len) {
                                            __auto_type _mv_1201 = ({ __auto_type _lst = syms; size_t _idx = (size_t)j; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_1201.has_value) {
                                                __auto_type sym_item = _mv_1201.value;
                                                __auto_type _mv_1202 = (*sym_item);
                                                switch (_mv_1202.tag) {
                                                    case types_SExpr_sym:
                                                    {
                                                        __auto_type s = _mv_1202.data.sym;
                                                        {
...
void transpiler_prescan_const(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        __auto_type arena = (*ctx).arena;
        if (((int64_t)((items).len)) >= 3) {
            __auto_type _mv_1203 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void transpiler_register_ffi_function(context_TranspileContext* ctx, types_SExpr* func_decl) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1205 = (*func_decl);
        switch (_mv_1205.tag) {
            case types_SExpr_lst:
            {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (((int64_t)((items).len)) >= 2) {
            ...
            if (_mv_1208.has_value) {
                __auto_type params_expr = _mv_1208.value;
                __auto_type _mv_1209 = (*params_expr);
                switch (_mv_1209.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type params_lst = _mv_1209.data.lst;
                        {
                            __auto_type params = params_lst.items;
                            __auto_type param_count = ((int64_t)((params).len));
                            __auto_type i = 0;
                            while (i < param_count) {
                                __auto_type _mv_1210 = ({ __auto_type _lst = params; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_1211.has_value) {
                __auto_type item_expr = _mv_1211.value;
                __auto_type _mv_1212 = (*item_expr);
                switch (_mv_1212.tag) {
                    case types_SExpr_sym:
                    {
                        __auto_type sym = _mv_1212.data.sym;
                        if (string_eq(sym.name, SLOP_STR(":c-name"))) {
                            __auto_type _mv_1213 = ({ __auto_type _lst = items; size_t _idx = (size_t)(i + 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_1213.has_value) {
                                __auto_type c_name_expr = _mv_1213.value;
                                __auto_type _mv_1214 = (*c_name_expr);
                                switch (_mv_1214.tag) {
                                    case types_SExpr_sym:
                                    {
                                        __auto_type c_sym = _mv_1214.data.sym;
                                        c_name = c_sym.name;
                                        found_c_name = 1;
                                        break;
                                    }
        ...
        if (len >= 2) {
            {
                ...
                if (has_header) {
                    ...
                    if (_mv_1215.has_value) {
                        __auto_type header_expr = _mv_1215.value;
                        __auto_type _mv_1216 = (*header_expr);
                        switch (_mv_1216.tag) {
                            case types_SExpr_str:
                            {
                                __auto_type str = _mv_1216.data.str;
                                context_ctx_add_include(ctx, str.value);
                                break;
                            }
                            default: {
...
slop_string transpiler_get_ffi_struct_c_name(slop_arena* arena, slop_list_types_SExpr_ptr items, int64_t name_idx, slop_string default_name) {
    {
        ...
        if (len >= (modifier_idx + 2)) {
            __auto_type _mv_1219 = ({ __auto_type _lst = items; size_t _idx = (size_t)modifier_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1219.has_value) {
                __auto_type mod_expr = _mv_1219.value;
                __auto_type _mv_1220 = (*mod_expr);
                switch (_mv_1220.tag) {
                    case types_SExpr_sym:
                    {
                        __auto_type sym = _mv_1220.data.sym;
                        if (string_eq(sym.name, SLOP_STR(":c-name"))) {
                            __auto_type _mv_1221 = ({ __auto_type _lst = items; size_t _idx = (size_t)(modifier_idx + 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_1221.has_value) {
                                __auto_type cname_expr = _mv_1221.value;
                                __auto_type _mv_1222 = (*cname_expr);
                                switch (_mv_1222.tag) {
                                    case types_SExpr_str:
                                    {
                                        __auto_type str = _mv_1222.data.str;
...
uint8_t transpiler_is_ffi_string_item(slop_list_types_SExpr_ptr items, int64_t idx) {
    __auto_type _mv_1223 = ({ __auto_type _lst = items; size_t _idx = (size_t)idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    if (_mv_1223.has_value) {
        ...
        switch (_mv_1224.tag) {
            case types_SExpr_str:
            {
                __auto_type _ = _mv_1224.data.str;
                return 1;
            }
            default: {
                return 0;
                ...
                case types_SExpr_lst:
                {
                    __auto_type def_lst = _mv_1226.data.lst;
                    {
                        ...
                        if (((int64_t)((def_items).len)) < 1) {
                            ...
                            __auto_type _mv_1227 = ({ __auto_type _lst = def_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_1227.has_value) {
                                __auto_type head = _mv_1227.value;
                                __auto_type _mv_1228 = (*head);
                                switch (_mv_1228.tag) {
                                    case types_SExpr_sym:
                                    {
...
uint8_t transpiler_is_record_def(slop_list_types_SExpr_ptr items) {
    if (((int64_t)((items).len)) < 3) {
        ...
        __auto_type _mv_1229 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        if (_mv_1229.has_value) {
            __auto_type def_expr = _mv_1229.value;
            __auto_type _mv_1230 = (*def_expr);
            switch (_mv_1230.tag) {
                case types_SExpr_lst:
                {
                    __auto_type def_lst = _mv_1230.data.lst;
                    {
                        __auto_type def_items = def_lst.items;
                        if (((int64_t)((def_items).len)) < 1) {
                            return 0;
                        } else {
                            __auto_type _mv_1231 = ({ __auto_type _lst = def_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_string transpiler_get_array_c_type(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items, slop_string default_c_type) {
    ...
    if (((int64_t)((items).len)) < 3) {
        ...
        if (_mv_1237.has_value) {
            __auto_type body_expr = _mv_1237.value;
            __auto_type _mv_1238 = (*body_expr);
            switch (_mv_1238.tag) {
                case types_SExpr_lst:
                {
                    __auto_type body_lst = _mv_1238.data.lst;
                    {
                        __auto_type body_items = body_lst.items;
                        if (((int64_t)((body_items).len)) < 2) {
                            return default_c_type;
                        } else {
                            __auto_type _mv_1239 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                ...
                                switch (_mv_1240.tag) {
                                    case types_SExpr_sym:
                                    {
                                        ...
                                        if (string_eq(sym.name, SLOP_STR("Array"))) {
                                            __auto_type _mv_1241 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_1241.has_value) {
                                                __auto_type elem_expr = _mv_1241.value;
                                                {
...
void transpiler_emit_all_functions(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1252 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void transpiler_transpile_module(context_TranspileContext* ctx, types_SExpr* module_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1256 = (*module_expr);
        switch (_mv_1256.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1256.data.lst;
                {
                    ...
                    __auto_type len = ((int64_t)((items).len));
                    if (len >= 2) {
                        __auto_type _mv_1257 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
int64_t transpiler_get_body_start(slop_list_types_SExpr_ptr items) {
    if (((int64_t)((items).len)) < 3) {
        ...
        if (_mv_1259.has_value) {
            __auto_type third = _mv_1259.value;
            __auto_type _mv_1260 = (*third);
            switch (_mv_1260.tag) {
                case types_SExpr_lst:
                {
                    __auto_type lst = _mv_1260.data.lst;
                    {
                        ...
                        if (((int64_t)((sub_items).len)) < 1) {
                            ...
                            __auto_type _mv_1261 = ({ __auto_type _lst = sub_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                ...
                switch (_mv_1264.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type lst = _mv_1264.data.lst;
                        {
                            __auto_type sub_items = lst.items;
                            if (((int64_t)((sub_items).len)) >= 1) {
                                __auto_type _mv_1265 = ({ __auto_type _lst = sub_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            ...
                                            if (string_eq(sym.name, SLOP_STR("export"))) {
                                                {
                                                    ...
                                                    __auto_type j = 1;
                                                    while (j < export_len) {
                                                        __auto_type _mv_1267 = ({ __auto_type _lst = sub_items; size_t _idx = (size_t)j; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
uint8_t transpiler_list_contains_str(slop_list_string lst, slop_string needle) {
    {
        ...
        uint8_t found = 0;
        while ((i < len) && !(found)) {
            __auto_type _mv_1269 = ({ __auto_type _lst = lst; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1269.has_value) {
                __auto_type s = _mv_1269.value;
        ...
        switch (_mv_1271.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1271.data.lst;
                {
                    ...
                    __auto_type len = ((int64_t)((items).len));
                    if (len >= 1) {
                        __auto_type _mv_1272 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        ...
                                        if (string_eq(op, SLOP_STR("Option"))) {
                                            if (len >= 2) {
                                                ...
                                                if (_mv_1274.has_value) {
                                                    __auto_type inner = _mv_1274.value;
                                                    {
                                            ...
                                            if (len >= 2) {
                                                ...
                                                if (_mv_1275.has_value) {
                                                    __auto_type elem = _mv_1275.value;
                                                    {
                                            ...
                                            if (len >= 3) {
                                                ...
                                                if (_mv_1277.has_value) {
                                                    __auto_type ok_type = _mv_1277.value;
                                                    ...
                                                    if (_mv_1278.has_value) {
                                                        __auto_type err_type = _mv_1278.value;
                                                        {
                                            ...
                                            if (len >= 2) {
                                                ...
                                                if (_mv_1279.has_value) {
                                                    __auto_type elem = _mv_1279.value;
                                                    {
                                                        __auto_type elem_c = context_to_c_type_prefixed(ctx, elem);
                                                        __auto_type elem_id = ctype_type_to_identifier(arena, elem_c);
                                                        __auto_type c_name = context_ctx_str(ctx, SLOP_STR("slop_chan_"), elem_id);
                                            ...
                                            if (len >= 2) {
                                                ...
                                                if (_mv_1280.has_value) {
                                                    __auto_type result = _mv_1280.value;
                                                    {
                                            ...
                                            if (len >= 3) {
                                                ...
                                                if (_mv_1281.has_value) {
                                                    __auto_type key_type = _mv_1281.value;
                                                    {
                                                        ...
                                                        if (_mv_1282.has_value) {
                                                            __auto_type val_type = _mv_1282.value;
                                                            {
                                            ...
                                            if (len >= 2) {
                                                ...
                                                if (_mv_1283.has_value) {
                                                    __auto_type elem_type = _mv_1283.value;
                                                    {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_1284.has_value) {
                __auto_type field_expr = _mv_1284.value;
                __auto_type _mv_1285 = (*field_expr);
                switch (_mv_1285.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type field_lst = _mv_1285.data.lst;
                        {
                            __auto_type field_items = field_lst.items;
                            if (((int64_t)((field_items).len)) >= 2) {
                                __auto_type _mv_1286 = ({ __auto_type _lst = field_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1286.has_value) {
                                    __auto_type type_expr = _mv_1286.value;
                                    transpiler_scan_type_for_generics(ctx, type_expr);
...
void transpiler_emit_ffi_includes(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1287 = ({ __auto_type _lst = includes; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1287.has_value) {
                __auto_type header = _mv_1287.value;
...
void transpiler_emit_ffi_includes_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1288 = ({ __auto_type _lst = includes; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1288.has_value) {
                __auto_type header = _mv_1288.value;
...
void transpiler_emit_header_guard_open(context_TranspileContext* ctx) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1289 = context_ctx_get_module(ctx);
        if (_mv_1289.has_value) {
            __auto_type mod_name = _mv_1289.value;
            {
...
void transpiler_emit_header_dependency_includes(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1290 = ({ __auto_type _lst = imports; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1290.has_value) {
                __auto_type mod_name = _mv_1290.value;
                {
                    __auto_type c_name = ctype_to_c_name(arena, mod_name);
        ...
        while ((i < len) && !(found)) {
            ...
            if (_mv_1298.has_value) {
                ...
                switch (_mv_1299.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type _ = _mv_1299.data.lst;
                        found = 1;
                        break;
                    }
                    default: {
                ...
                if (((int64_t)((items).len)) < 3) {
                    ...
                    if (_mv_1301.has_value) {
                        ...
                        switch (_mv_1302.tag) {
                            case types_SExpr_sym:
                            {
                                __auto_type _ = _mv_1302.data.sym;
                                return 1;
                            }
                            case types_SExpr_lst:
                            {
                            ...
                            case types_SExpr_lst:
                            {
                                __auto_type def_lst = _mv_1307.data.lst;
                                {
                                    ...
                                    if (((int64_t)((def_items).len)) < 1) {
                                        ...
                                        __auto_type _mv_1308 = ({ __auto_type _lst = def_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    ...
                    if (len < 3) {
                        ...
                        if (_mv_1318.has_value) {
                            ...
                            if (_mv_1319.has_value) {
                                __auto_type size_expr = _mv_1319.value;
                                {
...
slop_string transpiler_get_array_size_string(types_SExpr* expr) {
    SLOP_PRE(((expr != NULL)), "(!= expr nil)");
    __auto_type _mv_1320 = (*expr);
    switch (_mv_1320.tag) {
        case types_SExpr_num:
        {
            __auto_type num = _mv_1320.data.num;
            return num.raw;
        }
        default: {
            return SLOP_STR("0");
                ...
                __auto_type lst = _mv_1324.data.lst;
                {
                    ...
                    while (i < len) {
                        ...
                        if (_mv_1325.has_value) {
                            ...
                            __auto_type _mv_1326 = (*item);
                            switch (_mv_1326.tag) {
                                case types_SExpr_num:
                                {
                                    __auto_type num = _mv_1326.data.num;
                                    if (!(found_dots)) {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_1327.has_value) {
                ...
                if (transpiler_is_type_def(item) && transpiler_is_struct_type_def(item)) {
                    __auto_type _mv_1328 = transpiler_get_type_name(item);
                    if (_mv_1328.has_value) {
                        __auto_type type_name = _mv_1328.value;
                        {
...
void transpiler_emit_c_name_aliases(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len > 0) {
            ...
            while (i < len) {
                __auto_type _mv_1331 = ({ __auto_type _lst = aliases; size_t _idx = (size_t)i; slop_option_context_FuncCNameAlias _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_1331.has_value) {
                    __auto_type alias = _mv_1331.value;
                                ...
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_1334.data.sym;
                                    {
                                        ...
                                        if (_mv_1335.has_value) {
                                            __auto_type params_expr = _mv_1335.value;
                                            {
...
void transpiler_emit_result_types(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1343 = ({ __auto_type _lst = result_types; size_t _idx = (size_t)i; slop_option_context_ResultType _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1343.has_value) {
                __auto_type rt = _mv_1343.value;
...
void transpiler_emit_result_types_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1344 = ({ __auto_type _lst = result_types; size_t _idx = (size_t)i; slop_option_context_ResultType _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1344.has_value) {
                __auto_type rt = _mv_1344.value;
...
void transpiler_emit_inline_records_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1345 = ({ __auto_type _lst = inline_records; size_t _idx = (size_t)i; slop_option_context_InlineRecord _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1345.has_value) {
                __auto_type ir = _mv_1345.value;
                {
...
void transpiler_emit_complex_value_option_types_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1348 = ({ __auto_type _lst = option_types; size_t _idx = (size_t)i; slop_option_context_OptionType _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void transpiler_emit_primitive_list_types_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1350 = ({ __auto_type _lst = list_types; size_t _idx = (size_t)i; slop_option_context_ListType _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1350.has_value) {
                __auto_type lt = _mv_1350.value;
...
void transpiler_emit_primitive_option_types_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1351 = ({ __auto_type _lst = option_types; size_t _idx = (size_t)i; slop_option_context_OptionType _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1351.has_value) {
                __auto_type ot = _mv_1351.value;
...
void transpiler_emit_imported_list_types_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1352 = ({ __auto_type _lst = list_types; size_t _idx = (size_t)i; slop_option_context_ListType _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void transpiler_emit_value_list_types_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1355 = ({ __auto_type _lst = list_types; size_t _idx = (size_t)i; slop_option_context_ListType _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1355.has_value) {
                __auto_type lt = _mv_1355.value;
...
void transpiler_emit_union_payload_hash_eq(context_TranspileContext* ctx, slop_list_context_UnionVariantEntry variants) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1357 = ({ __auto_type _lst = variants; size_t _idx = (size_t)i; slop_option_context_UnionVariantEntry _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1357.has_value) {
                __auto_type variant = _mv_1357.value;
                {
...
void transpiler_emit_record_field_dependencies(context_TranspileContext* ctx, slop_list_context_FieldEntry fields) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1358 = ({ __auto_type _lst = fields; size_t _idx = (size_t)i; slop_option_context_FieldEntry _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1358.has_value) {
                __auto_type field = _mv_1358.value;
                {
...
uint8_t transpiler_is_range_type_alias(context_TranspileContext* ctx, slop_string slop_type) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    __auto_type _mv_1359 = context_ctx_lookup_type_alias(ctx, slop_type);
    if (_mv_1359.has_value) {
        __auto_type underlying = _mv_1359.value;
...
void transpiler_emit_union_hash_fn(context_TranspileContext* ctx, slop_string c_type, slop_list_context_UnionVariantEntry variants) {
    ...
    context_ctx_emit_header(ctx, SLOP_STR("    switch (_k->tag) {"));
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1360 = ({ __auto_type _lst = variants; size_t _idx = (size_t)i; slop_option_context_UnionVariantEntry _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1360.has_value) {
                __auto_type variant = _mv_1360.value;
...
void transpiler_emit_union_eq_fn(context_TranspileContext* ctx, slop_string c_type, slop_list_context_UnionVariantEntry variants) {
    ...
    context_ctx_emit_header(ctx, SLOP_STR("    switch (_a->tag) {"));
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1361 = ({ __auto_type _lst = variants; size_t _idx = (size_t)i; slop_option_context_UnionVariantEntry _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void transpiler_emit_struct_hash_fn(context_TranspileContext* ctx, slop_string c_type, slop_list_context_FieldEntry fields) {
    ...
    context_ctx_emit_header(ctx, SLOP_STR("    uint64_t hash = 14695981039346656037ULL;"));
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1362 = ({ __auto_type _lst = fields; size_t _idx = (size_t)i; slop_option_context_FieldEntry _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1362.has_value) {
                __auto_type field = _mv_1362.value;
    ...
    context_ctx_emit_header(ctx, context_ctx_str(ctx, context_ctx_str4(ctx, SLOP_STR("    const "), c_type, SLOP_STR("* _b = (const "), c_type), SLOP_STR("*)b;")));
    {
        ...
        if (len == 0) {
            ...
            context_ctx_emit_header(ctx, SLOP_STR("    return true"));
            {
                int64_t i = 0;
                while (i < len) {
                    __auto_type _mv_1363 = ({ __auto_type _lst = fields; size_t _idx = (size_t)i; slop_option_context_FieldEntry _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void transpiler_emit_struct_key_types_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < ((int64_t)((struct_key_types).len))) {
            __auto_type _mv_1364 = ({ __auto_type _lst = struct_key_types; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1364.has_value) {
                __auto_type c_type = _mv_1364.value;
                {
                    __auto_type guard_name = context_ctx_str3(ctx, transpiler_uppercase_name(ctx, c_type), SLOP_STR("_HASH_EQ_DEFINED"), SLOP_STR(""));
...
void transpiler_emit_chan_types_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1365 = ({ __auto_type _lst = chan_types; size_t _idx = (size_t)i; slop_option_context_ChanType _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1365.has_value) {
                __auto_type ct = _mv_1365.value;
                {
...
void transpiler_emit_chan_funcs_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1366 = ({ __auto_type _lst = chan_types; size_t _idx = (size_t)i; slop_option_context_ChanType _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void transpiler_emit_thread_types_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1367 = ({ __auto_type _lst = thread_types; size_t _idx = (size_t)i; slop_option_context_ThreadType _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1367.has_value) {
                __auto_type tt = _mv_1367.value;
                {
...
uint8_t transpiler_is_simple_enum_def(types_SExpr* item) {
    SLOP_PRE(((item != NULL)), "(!= item nil)");
    __auto_type _mv_1368 = (*item);
    switch (_mv_1368.tag) {
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1368.data.lst;
            {
                __auto_type items = lst.items;
                if (((int64_t)((items).len)) < 3) {
                    return 0;
...
void transpiler_emit_pending_container_deps(context_TranspileContext* ctx, types_SExpr* type_def) {
    ...
    SLOP_PRE(((type_def != NULL)), "(!= type-def nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1379 = ({ __auto_type _lst = field_types; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1379.has_value) {
                __auto_type field_type = _mv_1379.value;
                    ...
                    if (transpiler_is_type_def(item) && transpiler_is_struct_type_def(item)) {
                        {
                            ...
                            __auto_type j = 0;
                            while (j < dep_len) {
                                __auto_type _mv_1386 = ({ __auto_type _lst = blocking_deps; size_t _idx = (size_t)j; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1386.has_value) {
                                    __auto_type dep_name = _mv_1386.value;
...
slop_list_string transpiler_find_blocking_list_deps(context_TranspileContext* ctx, types_SExpr* type_def) {
    ...
    SLOP_PRE(((type_def != NULL)), "(!= type-def nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1387 = ({ __auto_type _lst = field_types; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1387.has_value) {
                __auto_type field_type = _mv_1387.value;
...
uint8_t transpiler_index_in_list(slop_list_int lst, int64_t idx) {
    {
        ...
        uint8_t found = 0;
        while ((i < len) && !(found)) {
            __auto_type _mv_1389 = ({ __auto_type _lst = lst; size_t _idx = (size_t)i; slop_option_int _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1389.has_value) {
                __auto_type v = _mv_1389.value;
                if (v == idx) {
                    found = 1;
                }
...
uint8_t transpiler_type_deps_satisfied(context_TranspileContext* ctx, types_SExpr* type_def) {
    ...
    SLOP_PRE(((type_def != NULL)), "(!= type-def nil)");
    {
        ...
        while ((i < len) && all_satisfied) {
            __auto_type _mv_1390 = ({ __auto_type _lst = field_types; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1390.has_value) {
                __auto_type field_type = _mv_1390.value;
                ...
                __auto_type lst = _mv_1391.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) >= 3) {
                        ...
                        if (_mv_1392.has_value) {
                            __auto_type def_expr = _mv_1392.value;
                            __auto_type _mv_1393 = (*def_expr);
                            switch (_mv_1393.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type def_lst = _mv_1393.data.lst;
                                    {
                                        __auto_type def_items = def_lst.items;
                                        __auto_type def_len = ((int64_t)((def_items).len));
                                        if (def_len > 0) {
                                            __auto_type _mv_1394 = ({ __auto_type _lst = def_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_list_string transpiler_extract_record_field_types(context_TranspileContext* ctx, slop_list_types_SExpr_ptr def_items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 1;
        while (i < len) {
            __auto_type _mv_1396 = ({ __auto_type _lst = def_items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1396.has_value) {
                __auto_type field_expr = _mv_1396.value;
                __auto_type _mv_1397 = (*field_expr);
                switch (_mv_1397.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type field_lst = _mv_1397.data.lst;
                        if (((int64_t)((field_lst.items).len)) >= 2) {
                            __auto_type _mv_1398 = ({ __auto_type _lst = field_lst.items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_1398.has_value) {
                                __auto_type type_expr = _mv_1398.value;
                                {
...
slop_list_string transpiler_extract_union_variant_types(context_TranspileContext* ctx, slop_list_types_SExpr_ptr def_items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 1;
        while (i < len) {
            __auto_type _mv_1399 = ({ __auto_type _lst = def_items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1399.has_value) {
                __auto_type variant_expr = _mv_1399.value;
                __auto_type _mv_1400 = (*variant_expr);
                switch (_mv_1400.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type variant_lst = _mv_1400.data.lst;
                        if (((int64_t)((variant_lst.items).len)) >= 2) {
                            __auto_type _mv_1401 = ({ __auto_type _lst = variant_lst.items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_string transpiler_get_field_type_string(context_TranspileContext* ctx, types_SExpr* type_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1402 = (*type_expr);
        switch (_mv_1402.tag) {
            case types_SExpr_sym:
            {
                ...
                {
                    __auto_type name = sym.name;
                    __auto_type _mv_1403 = context_ctx_lookup_type(ctx, name);
                    if (_mv_1403.has_value) {
                        __auto_type entry = _mv_1403.value;
                        return entry.c_name;
                                        ...
                                        if (string_eq(kind, SLOP_STR("Ptr"))) {
                                            ...
                                            if (((int64_t)((items).len)) >= 2) {
                                                ...
                                                if (_mv_1406.has_value) {
                                                    __auto_type inner = _mv_1406.value;
                                                    {
                                            ...
                                            if (((int64_t)((items).len)) >= 2) {
                                                __auto_type _mv_1407 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1408.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 2) {
                    ...
                    __auto_type _mv_1409 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_1409.has_value) {
                        __auto_type name_expr = _mv_1409.value;
                        __auto_type _mv_1410 = (*name_expr);
                        switch (_mv_1410.tag) {
                            case types_SExpr_sym:
                            {
                                ...
                                {
                                    __auto_type name = sym.name;
                                    __auto_type _mv_1411 = context_ctx_lookup_type(ctx, name);
...
void transpiler_emit_list_for_elem_type(context_TranspileContext* ctx, slop_string elem_c_name) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1413 = ({ __auto_type _lst = list_types; size_t _idx = (size_t)i; slop_option_context_ListType _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        if (!(found)) {
            {
                ...
                int64_t j = 0;
                while ((j < len2) && !(found)) {
                    __auto_type _mv_1415 = ({ __auto_type _lst = option_types; size_t _idx = (size_t)j; slop_option_context_OptionType _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_1415.has_value) {
                        __auto_type ot = _mv_1415.value;
...
void transpiler_emit_struct_dependent_list_types(context_TranspileContext* ctx, types_SExpr* type_def) {
    ...
    SLOP_PRE(((type_def != NULL)), "(!= type-def nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1416 = ({ __auto_type _lst = list_types; size_t _idx = (size_t)i; slop_option_context_ListType _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void transpiler_emit_struct_dependent_option_types(context_TranspileContext* ctx, types_SExpr* type_def) {
    ...
    SLOP_PRE(((type_def != NULL)), "(!= type-def nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1417 = ({ __auto_type _lst = option_types; size_t _idx = (size_t)i; slop_option_context_OptionType _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1417.has_value) {
                __auto_type ot = _mv_1417.value;
                if (!(transpiler_is_pointer_elem_type(ot.inner_type)) && transpiler_struct_uses_option_type(ctx, type_def, ot.c_name)) {
...
void transpiler_emit_struct_dependent_list_types_safe(context_TranspileContext* ctx, types_SExpr* type_def) {
    ...
    SLOP_PRE(((type_def != NULL)), "(!= type-def nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1418 = ({ __auto_type _lst = list_types; size_t _idx = (size_t)i; slop_option_context_ListType _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1418.has_value) {
                __auto_type lt = _mv_1418.value;
                if (!(transpiler_is_pointer_elem_type(lt.elem_type)) && transpiler_struct_uses_list_type(ctx, type_def, lt.c_name)) {
...
uint8_t transpiler_is_imported_type(context_TranspileContext* ctx, slop_string type_name) {
    ...
    if (strlib_starts_with(type_name, SLOP_STR("slop_list_")) || strlib_starts_with(type_name, SLOP_STR("slop_option_"))) {
        ...
        __auto_type _mv_1420 = context_ctx_get_module(ctx);
        if (_mv_1420.has_value) {
            __auto_type current_mod = _mv_1420.value;
            {
                __auto_type arena = (*ctx).arena;
                ...
                __auto_type lst = _mv_1423.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) < 3) {
                        ...
                        if (_mv_1424.has_value) {
                            __auto_type body_expr = _mv_1424.value;
...
uint8_t transpiler_type_body_uses_typename(context_TranspileContext* ctx, types_SExpr* body_expr, slop_string typename) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1425 = (*body_expr);
        switch (_mv_1425.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1425.data.lst;
                {
                    ...
                    while ((i < len) && !(found)) {
                        ...
                        if (_mv_1426.has_value) {
                            __auto_type field_expr = _mv_1426.value;
...
uint8_t transpiler_field_uses_typename(context_TranspileContext* ctx, types_SExpr* field_expr, slop_string typename) {
    ...
    __auto_type _mv_1427 = (*field_expr);
    switch (_mv_1427.tag) {
        case types_SExpr_lst:
        {
                ...
                __auto_type lst = _mv_1429.data.lst;
                {
                    ...
                    if (len >= 3) {
                        ...
                        if (_mv_1430.has_value) {
                            __auto_type name_expr = _mv_1430.value;
                            __auto_type _mv_1431 = (*name_expr);
                            switch (_mv_1431.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_1431.data.sym;
                                    {
                                        __auto_type type_name = name_sym.name;
                                        __auto_type base_name = ctype_to_c_name(arena, type_name);
                                        __auto_type c_name = ((context_ctx_prefixing_enabled(ctx)) ? ({ __auto_type _mv = context_ctx_get_module(ctx); _mv.has_value ? ({ __auto_type mod_name = _mv.value; context_ctx_str(ctx, ctype_to_c_name(arena, mod_name), context_ctx_str(ctx, SLOP_STR("_"), base_name)); }) : (base_name); }) : base_name);
                                        ...
                                        if (_mv_1432.has_value) {
                                            __auto_type body_expr = _mv_1432.value;
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1433.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) < 1) {
                        ...
                        __auto_type _mv_1434 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_1434.has_value) {
                            __auto_type kind_expr = _mv_1434.value;
                            __auto_type _mv_1435 = (*kind_expr);
                            switch (_mv_1435.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type kind_sym = _mv_1435.data.sym;
                                    {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_1436.has_value) {
                __auto_type variant_expr = _mv_1436.value;
                __auto_type _mv_1437 = (*variant_expr);
                switch (_mv_1437.tag) {
                    case types_SExpr_sym:
                    {
                        __auto_type variant_sym = _mv_1437.data.sym;
                        {
...
uint8_t transpiler_is_pointer_type_expr_header(types_SExpr* type_expr) {
    SLOP_PRE(((type_expr != NULL)), "(!= type-expr nil)");
    __auto_type _mv_1443 = (*type_expr);
    switch (_mv_1443.tag) {
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1443.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 1) {
                    ...
                    __auto_type _mv_1444 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        context_ctx_emit_header(ctx, SLOP_STR("typedef enum {"));
        {
            ...
            while (i < len) {
                ...
                if (_mv_1446.has_value) {
                    __auto_type variant_expr = _mv_1446.value;
                    {
...
slop_string transpiler_get_variant_name(types_SExpr* variant_expr) {
    ...
    __auto_type _mv_1448 = (*variant_expr);
    switch (_mv_1448.tag) {
        case types_SExpr_sym:
        {
        ...
        switch (_mv_1451.tag) {
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1451.data.lst;
                {
                    ...
                    if (num_items >= 2) {
                        __auto_type _mv_1452 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_1452.has_value) {
                            ...
                            switch (_mv_1453.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_1453.data.sym;
                                    {
                                        __auto_type variant_name = name_sym.name;
                                        ...
                                        if (num_items == 2) {
                                            ...
                                            for (int64_t fi = 1; fi < num_items; fi++) {
                                                __auto_type _mv_1455 = ({ __auto_type _lst = items; size_t _idx = (size_t)fi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1461.data.lst;
            {
                ...
                if (((int64_t)((const_items).len)) < 4) {
                    ...
                    __auto_type _mv_1462 = ({ __auto_type _lst = const_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            ...
                            case types_SExpr_sym:
                            {
                                __auto_type name_sym = _mv_1463.data.sym;
                                {
                                    ...
                                    if (!(transpiler_list_contains_str(exports, raw_name))) {
                                        ...
                                        __auto_type _mv_1464 = ({ __auto_type _lst = const_items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void transpiler_emit_all_lambdas(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (count > 0) {
            while (i < count) {
                __auto_type _mv_1466 = ({ __auto_type _lst = lambdas; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_string transpiler_generate_c_output(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1467 = ({ __auto_type _lst = output_lines; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void transpiler_transpile_file(context_TranspileContext* ctx, slop_list_types_SExpr_ptr exprs) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len > 0) && transpiler_is_module_expr(exprs)) {
            __auto_type _mv_1468 = ({ __auto_type _lst = exprs; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
uint8_t transpiler_is_module_expr(slop_list_types_SExpr_ptr exprs) {
    if (((int64_t)((exprs).len)) < 1) {
        ...
        __auto_type _mv_1469 = ({ __auto_type _lst = exprs; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
