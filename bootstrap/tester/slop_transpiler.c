                    ...
                    case types_SExpr_lst:
                    {
                        __auto_type lst = _mv_1001.data.lst;
                        {
                            ...
                            if ((((int64_t)((sub_items).len)) >= 1)) {
                                __auto_type _mv_1002 = ({ __auto_type _lst = sub_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        ...
                                        case types_SExpr_sym:
                                        {
                                            ...
                                            if (string_eq(sym.name, SLOP_STR("@generic"))) {
                                                if ((((int64_t)((sub_items).len)) >= 2)) {
                                                    __auto_type _mv_1004 = ({ __auto_type _lst = sub_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_1004.has_value) {
                                                        __auto_type params_expr = _mv_1004.value;
                                                        __auto_type _mv_1005 = (*params_expr);
                                                        switch (_mv_1005.tag) {
                                                            case types_SExpr_lst:
                                                            {
                                                                __auto_type params_lst = _mv_1005.data.lst;
                                                                {
                                                                    __auto_type param_items = params_lst.items;
                                                                    __auto_type param_len = ((int64_t)((param_items).len));
                                                                    __auto_type j = 0;
                                                                    while ((j < param_len)) {
                                                                        __auto_type _mv_1006 = ({ __auto_type _lst = param_items; size_t _idx = (size_t)j; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                                        if (_mv_1006.has_value) {
                                                                            __auto_type param = _mv_1006.value;
                                                                            __auto_type _mv_1007 = (*param);
                                                                            switch (_mv_1007.tag) {
                                                                                case types_SExpr_sym:
                                                                                {
                                                                                    __auto_type param_sym = _mv_1007.data.sym;
                                                            ...
                                                            case types_SExpr_sym:
                                                            {
                                                                __auto_type single_sym = _mv_1005.data.sym;
...
void transpiler_prescan_module(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1008 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1008.has_value) {
                __auto_type item = _mv_1008.value;
                    ...
                    case types_SExpr_sym:
                    {
                        __auto_type sym = _mv_1013.data.sym;
                        {
                            ...
                            __auto_type c_name = ((context_ctx_prefixing_enabled(ctx)) ? ({ __auto_type _mv = context_ctx_get_module(ctx); _mv.has_value ? ({ __auto_type mod_name = _mv.value; context_ctx_str(ctx, ctype_to_c_name(arena, mod_name), context_ctx_str(ctx, SLOP_STR("_"), base_c_name)); }) : (base_c_name); }) : base_c_name);
                            {
                                ...
                                if ((is_record || is_union)) {
                                    if ((((int64_t)((items).len)) >= 3)) {
                                        ...
                                        if (_mv_1014.has_value) {
                                            __auto_type def_expr = _mv_1014.value;
                                            __auto_type _mv_1015 = (*def_expr);
                                            switch (_mv_1015.tag) {
                                                case types_SExpr_lst:
                                                {
                                                    __auto_type def_lst = _mv_1015.data.lst;
                                ...
                                if ((((int64_t)((items).len)) >= 3)) {
                                    __auto_type _mv_1016 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    if (_mv_1016.has_value) {
                                        __auto_type body_expr = _mv_1016.value;
            ...
            switch (_mv_1018.tag) {
                case types_SExpr_lst:
                {
                    __auto_type def_lst = _mv_1018.data.lst;
                    {
                        ...
                        __auto_type i = 1;
                        while ((i < len)) {
                            __auto_type _mv_1019 = ({ __auto_type _lst = def_items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_1019.has_value) {
                                ...
                                switch (_mv_1020.tag) {
                                    ...
                                    case types_SExpr_lst:
                                    {
                                        __auto_type variant_lst = _mv_1020.data.lst;
                                        if ((((int64_t)((variant_lst.items).len)) > 0)) {
                                            __auto_type _mv_1021 = ({ __auto_type _lst = variant_lst.items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_1021.has_value) {
                                                __auto_type name_expr = _mv_1021.value;
                                                __auto_type _mv_1022 = (*name_expr);
                                                switch (_mv_1022.tag) {
                                                    case types_SExpr_sym:
                                                    {
                                                        __auto_type name_sym = _mv_1022.data.sym;
...
void transpiler_register_union_variants(context_TranspileContext* ctx, slop_string union_name, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        __auto_type arena = (*ctx).arena;
        if ((((int64_t)((items).len)) >= 3)) {
            __auto_type _mv_1023 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1023.has_value) {
                __auto_type def_expr = _mv_1023.value;
                __auto_type _mv_1024 = (*def_expr);
                switch (_mv_1024.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type def_lst = _mv_1024.data.lst;
                        {
                            __auto_type def_items = def_lst.items;
                            __auto_type len = ((int64_t)((def_items).len));
                            __auto_type i = 1;
                            while ((i < len)) {
                                __auto_type _mv_1025 = ({ __auto_type _lst = def_items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1025.has_value) {
                                    ...
                                    switch (_mv_1026.tag) {
                                        ...
                                        case types_SExpr_lst:
                                        {
                                            __auto_type variant_lst = _mv_1026.data.lst;
                                            {
                                                __auto_type vl_items = variant_lst.items;
                                                if ((((int64_t)((vl_items).len)) >= 2)) {
                                                    __auto_type _mv_1027 = ({ __auto_type _lst = vl_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                        ...
                                                        switch (_mv_1028.tag) {
                                                            case types_SExpr_sym:
                                                            {
                                                                __auto_type name_sym = _mv_1028.data.sym;
                                                                {
                                                                    ...
                                                                    context_ctx_register_enum_variant(ctx, variant_name, union_name);
                                                                    __auto_type _mv_1029 = ({ __auto_type _lst = vl_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void transpiler_prescan_fn(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        __auto_type arena = (*ctx).arena;
        if ((((int64_t)((items).len)) >= 2)) {
            __auto_type _mv_1030 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    ...
                                                    switch (_mv_1037.tag) {
                                                        case types_SExpr_lst:
                                                        {
                                                            __auto_type body_lst = _mv_1037.data.lst;
                                                            {
                                                                ...
                                                                if ((body_len >= 1)) {
                                                                    __auto_type _mv_1038 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)(body_len - 1); slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                                    if (_mv_1038.has_value) {
                                                                        __auto_type ret_type = _mv_1038.value;
                                                                        __auto_type _mv_1039 = (*ret_type);
                                                                        switch (_mv_1039.tag) {
                                                                            case types_SExpr_sym:
                                                                            {
                                                                                __auto_type ret_sym = _mv_1039.data.sym;
                ...
                switch (_mv_1041.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type lst = _mv_1041.data.lst;
                        {
                            __auto_type sub_items = lst.items;
                            if ((((int64_t)((sub_items).len)) >= 2)) {
                                __auto_type _mv_1042 = ({ __auto_type _lst = sub_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1042.has_value) {
                                    ...
                                    switch (_mv_1043.tag) {
                                        case types_SExpr_sym:
                                        {
                                            ...
                                            if (string_eq(sym.name, SLOP_STR("@spec"))) {
                                                __auto_type _mv_1044 = ({ __auto_type _lst = sub_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_1044.has_value) {
                                                    __auto_type spec_body = _mv_1044.value;
                                                    __auto_type _mv_1045 = (*spec_body);
                                                    switch (_mv_1045.tag) {
                                                        case types_SExpr_lst:
                                                        {
                                                            __auto_type body_lst = _mv_1045.data.lst;
                                                            {
                                                                __auto_type body_items = body_lst.items;
                                                                __auto_type body_len = ((int64_t)((body_items).len));
                                                                if ((body_len >= 1)) {
                                                                    __auto_type _mv_1046 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)(body_len - 1); slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                                    if (_mv_1046.has_value) {
                                                                        __auto_type ret_type = _mv_1046.value;
                    ...
                    __auto_type params_lst = _mv_1048.data.lst;
                    {
                        ...
                        while ((i < param_count)) {
                            ...
                            if (_mv_1049.has_value) {
                                ...
                                __auto_type _mv_1050 = (*param_expr);
                                switch (_mv_1050.tag) {
                                    case types_SExpr_lst:
                                    {
                                        __auto_type param_lst = _mv_1050.data.lst;
                                        {
                                            __auto_type param_items = param_lst.items;
                                            if ((((int64_t)((param_items).len)) >= 2)) {
                                                __auto_type _mv_1051 = ({ __auto_type _lst = param_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_list_context_FuncParamType_ptr transpiler_prescan_collect_param_types(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((((int64_t)((items).len)) >= 3)) {
            __auto_type _mv_1052 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1052.has_value) {
                ...
                switch (_mv_1053.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type params_lst = _mv_1053.data.lst;
                        {
                            __auto_type params = params_lst.items;
                            __auto_type param_count = ((int64_t)((params).len));
                            __auto_type i = 0;
                            while ((i < param_count)) {
                                __auto_type _mv_1054 = ({ __auto_type _lst = params; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1054.has_value) {
                                    __auto_type param_expr = _mv_1054.value;
                                    {
                ...
                __auto_type lst = _mv_1055.data.lst;
                {
                    ...
                    if ((len < 2)) {
                    ...
                    } else {
                        {
                            ...
                            __auto_type _mv_1056 = ({ __auto_type _lst = items; size_t _idx = (size_t)type_idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_1056.has_value) {
                                __auto_type type_expr = _mv_1056.value;
...
uint8_t transpiler_prescan_is_param_mode(slop_list_types_SExpr_ptr items) {
    if ((((int64_t)((items).len)) < 1)) {
        ...
        __auto_type _mv_1057 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        if (_mv_1057.has_value) {
            __auto_type first = _mv_1057.value;
            __auto_type _mv_1058 = (*first);
            switch (_mv_1058.tag) {
                case types_SExpr_sym:
                {
...
void transpiler_extract_result_type(context_TranspileContext* ctx, types_SExpr* spec_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1063 = (*spec_expr);
        switch (_mv_1063.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1063.data.lst;
                {
                    __auto_type items = lst.items;
                    if ((((int64_t)((items).len)) >= 2)) {
                        __auto_type _mv_1064 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_1064.has_value) {
                            __auto_type spec_body = _mv_1064.value;
                            __auto_type _mv_1065 = (*spec_body);
                            switch (_mv_1065.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type body_lst = _mv_1065.data.lst;
                                    {
                                        __auto_type body_items = body_lst.items;
                                        __auto_type body_len = ((int64_t)((body_items).len));
                                        if ((body_len >= 1)) {
                                            __auto_type _mv_1066 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)(body_len - 1); slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_1066.has_value) {
                                                __auto_type ret_type = _mv_1066.value;
                                ...
                                case types_SExpr_sym:
                                {
                                    ...
                                    if (string_eq(sym.name, SLOP_STR("Result"))) {
                                        ...
                                        if (_mv_1070.has_value) {
                                            __auto_type ok_type_expr = _mv_1070.value;
                                            ...
                                            if (_mv_1071.has_value) {
                                                __auto_type err_type_expr = _mv_1071.value;
                                                {
    ...
    switch (_mv_1073.tag) {
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1073.data.lst;
            {
                ...
                __auto_type len = ((int64_t)((items).len));
                if ((len >= 1)) {
                    __auto_type _mv_1074 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            ...
                            case types_SExpr_sym:
                            {
                                __auto_type sym = _mv_1075.data.sym;
                                {
                                    ...
                                    if (string_eq(name, SLOP_STR("map-new"))) {
                                        if ((len >= 3)) {
                                            __auto_type _mv_1076 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_1076.has_value) {
                                                __auto_type key_type_expr = _mv_1076.value;
                                        ...
                                        if ((len >= 3)) {
                                            __auto_type _mv_1077 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_1077.has_value) {
                                                __auto_type elem_type_expr = _mv_1077.value;
                                    ...
                                    } else {
                                        {
                                            __auto_type i = 0;
                                            while ((i < len)) {
                                                __auto_type _mv_1078 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_1078.has_value) {
                                                    __auto_type child = _mv_1078.value;
                            ...
                            default: {
                                {
                                    __auto_type i = 0;
                                    while ((i < len)) {
                                        __auto_type _mv_1079 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_1079.has_value) {
                                            __auto_type child = _mv_1079.value;
                                            transpiler_prescan_expr_for_struct_keys(ctx, child);
            ...
            case types_SExpr_sym:
            {
                __auto_type sym = _mv_1080.data.sym;
                {
                    ...
                    if (!(transpiler_is_builtin_map_key_type(name))) {
                        __auto_type _mv_1081 = context_ctx_lookup_type(ctx, name);
                        if (_mv_1081.has_value) {
                            __auto_type type_entry = _mv_1081.value;
                            context_ctx_register_struct_key_type(ctx, type_entry.c_name);
                        } else if (!_mv_1081.has_value) {
                            __auto_type _mv_1082 = context_ctx_get_module(ctx);
                            if (_mv_1082.has_value) {
                                __auto_type mod = _mv_1082.value;
                                {
                                    __auto_type prefixed = context_ctx_str3(ctx, mod, SLOP_STR("_"), name);
                                    __auto_type _mv_1083 = context_ctx_lookup_type(ctx, prefixed);
                                    if (_mv_1083.has_value) {
                                        __auto_type type_entry = _mv_1083.value;
                                        context_ctx_register_struct_key_type(ctx, type_entry.c_name);
        ...
        switch (_mv_1084.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1084.data.lst;
                {
                    __auto_type items = lst.items;
                    if ((((int64_t)((items).len)) >= 3)) {
                        __auto_type _mv_1085 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                ...
                                case types_SExpr_sym:
                                {
                                    ...
                                    if (string_eq(sym.name, SLOP_STR("Result"))) {
                                        ...
                                        if (_mv_1087.has_value) {
                                            __auto_type ok_type_expr = _mv_1087.value;
                                            ...
                                            if (_mv_1088.has_value) {
                                                __auto_type err_type_expr = _mv_1088.value;
                                                {
                                                    __auto_type ok_c_type = context_to_c_type_prefixed(ctx, ok_type_expr);
                                                    __auto_type err_c_type = context_to_c_type_prefixed(ctx, err_type_expr);
                                                    __auto_type result_name = transpiler_build_result_type_name(ctx, ok_c_type, err_c_type);
...
void transpiler_prescan_ffi(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        __auto_type len = ((int64_t)((items).len));
        if ((len >= 2)) {
            __auto_type _mv_1089 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1089.has_value) {
                __auto_type header_expr = _mv_1089.value;
                __auto_type _mv_1090 = (*header_expr);
                switch (_mv_1090.tag) {
                    case types_SExpr_str:
                    {
                        __auto_type str = _mv_1090.data.str;
            ...
            }
            {
                ...
                while ((i < len)) {
                    ...
                    if (_mv_1091.has_value) {
                        __auto_type func_decl = _mv_1091.value;
...
void transpiler_prescan_import(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    if ((((int64_t)((items).len)) >= 3)) {
        __auto_type _mv_1092 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        if (_mv_1092.has_value) {
            __auto_type mod_expr = _mv_1092.value;
            __auto_type _mv_1093 = (*mod_expr);
            switch (_mv_1093.tag) {
                case types_SExpr_sym:
                {
                    __auto_type mod_sym = _mv_1093.data.sym;
                    {
                        ...
                        __auto_type _mv_1094 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_1094.has_value) {
                            __auto_type symbols_expr = _mv_1094.value;
                            __auto_type _mv_1095 = (*symbols_expr);
                            switch (_mv_1095.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type symbols_lst = _mv_1095.data.lst;
                                    {
                                        __auto_type syms = symbols_lst.items;
                                        __auto_type sym_len = ((int64_t)((syms).len));
                                        __auto_type j = 0;
                                        while ((j < sym_len)) {
                                            __auto_type _mv_1096 = ({ __auto_type _lst = syms; size_t _idx = (size_t)j; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_1096.has_value) {
                                                __auto_type sym_item = _mv_1096.value;
                                                __auto_type _mv_1097 = (*sym_item);
                                                switch (_mv_1097.tag) {
                                                    case types_SExpr_sym:
                                                    {
                                                        __auto_type s = _mv_1097.data.sym;
                                                        {
...
void transpiler_register_ffi_function(context_TranspileContext* ctx, types_SExpr* func_decl) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1098 = (*func_decl);
        switch (_mv_1098.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1098.data.lst;
                {
                    ...
                    __auto_type len = ((int64_t)((items).len));
                    if ((len >= 1)) {
                        __auto_type _mv_1099 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_list_context_FuncParamType_ptr transpiler_extract_ffi_param_types(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        __auto_type result = ((slop_list_context_FuncParamType_ptr){ .data = (context_FuncParamType**)slop_arena_alloc(arena, 16 * sizeof(context_FuncParamType*)), .len = 0, .cap = 16 });
        if ((((int64_t)((items).len)) >= 2)) {
            __auto_type _mv_1101 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while ((i < len)) {
            ...
            if (_mv_1104.has_value) {
                __auto_type item_expr = _mv_1104.value;
                __auto_type _mv_1105 = (*item_expr);
                switch (_mv_1105.tag) {
                    case types_SExpr_sym:
                    {
                        __auto_type sym = _mv_1105.data.sym;
                        if (string_eq(sym.name, SLOP_STR(":c-name"))) {
                            __auto_type _mv_1106 = ({ __auto_type _lst = items; size_t _idx = (size_t)(i + 1); slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_1106.has_value) {
                                __auto_type c_name_expr = _mv_1106.value;
                                __auto_type _mv_1107 = (*c_name_expr);
                                switch (_mv_1107.tag) {
                                    case types_SExpr_sym:
                                    {
                                        __auto_type c_sym = _mv_1107.data.sym;
                                        c_name = c_sym.name;
                                        found_c_name = 1;
                                        break;
                                    }
        ...
        if ((len >= 2)) {
            {
                ...
                if (has_header) {
                    __auto_type _mv_1108 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_1108.has_value) {
                        __auto_type header_expr = _mv_1108.value;
                        __auto_type _mv_1109 = (*header_expr);
                        switch (_mv_1109.tag) {
                            case types_SExpr_str:
                            {
                ...
                if ((len >= (name_idx + 1))) {
                    __auto_type _mv_1110 = ({ __auto_type _lst = items; size_t _idx = (size_t)name_idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_string transpiler_get_ffi_struct_c_name(slop_arena* arena, slop_list_types_SExpr_ptr items, int64_t name_idx, slop_string default_name) {
    {
        ...
        if ((len >= (modifier_idx + 2))) {
            __auto_type _mv_1112 = ({ __auto_type _lst = items; size_t _idx = (size_t)modifier_idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1112.has_value) {
                __auto_type mod_expr = _mv_1112.value;
                __auto_type _mv_1113 = (*mod_expr);
                switch (_mv_1113.tag) {
                    case types_SExpr_sym:
                    {
                        __auto_type sym = _mv_1113.data.sym;
                        if (string_eq(sym.name, SLOP_STR(":c-name"))) {
                            __auto_type _mv_1114 = ({ __auto_type _lst = items; size_t _idx = (size_t)(modifier_idx + 1); slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_1114.has_value) {
                                __auto_type cname_expr = _mv_1114.value;
                                __auto_type _mv_1115 = (*cname_expr);
                                switch (_mv_1115.tag) {
                                    case types_SExpr_str:
                                    {
                                        __auto_type str = _mv_1115.data.str;
...
uint8_t transpiler_is_ffi_string_item(slop_list_types_SExpr_ptr items, int64_t idx) {
    __auto_type _mv_1116 = ({ __auto_type _lst = items; size_t _idx = (size_t)idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    if (_mv_1116.has_value) {
        ...
        switch (_mv_1117.tag) {
            case types_SExpr_str:
            {
                __auto_type _ = _mv_1117.data.str;
                return 1;
            }
            default: {
                return 0;
...
uint8_t transpiler_is_enum_def(slop_list_types_SExpr_ptr items) {
    if ((((int64_t)((items).len)) < 3)) {
        ...
        __auto_type _mv_1118 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        if (_mv_1118.has_value) {
            __auto_type def_expr = _mv_1118.value;
            __auto_type _mv_1119 = (*def_expr);
            switch (_mv_1119.tag) {
                case types_SExpr_lst:
                {
                    __auto_type def_lst = _mv_1119.data.lst;
                    {
                        __auto_type def_items = def_lst.items;
                        if ((((int64_t)((def_items).len)) < 1)) {
                            return 0;
                        } else {
                            __auto_type _mv_1120 = ({ __auto_type _lst = def_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                ...
                case types_SExpr_lst:
                {
                    __auto_type def_lst = _mv_1123.data.lst;
                    {
                        ...
                        if ((((int64_t)((def_items).len)) < 1)) {
                            ...
                            __auto_type _mv_1124 = ({ __auto_type _lst = def_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                ...
                case types_SExpr_lst:
                {
                    __auto_type def_lst = _mv_1127.data.lst;
                    {
                        ...
                        if ((((int64_t)((def_items).len)) < 1)) {
                            ...
                            __auto_type _mv_1128 = ({ __auto_type _lst = def_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_string transpiler_get_array_c_type(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items, slop_string default_c_type) {
    ...
    if ((((int64_t)((items).len)) < 3)) {
        ...
        __auto_type _mv_1130 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        if (_mv_1130.has_value) {
            __auto_type body_expr = _mv_1130.value;
            __auto_type _mv_1131 = (*body_expr);
            switch (_mv_1131.tag) {
                case types_SExpr_lst:
                {
                    __auto_type body_lst = _mv_1131.data.lst;
                    {
                        ...
                        if ((((int64_t)((body_items).len)) < 2)) {
                            ...
                            __auto_type _mv_1132 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                ...
                                switch (_mv_1133.tag) {
                                    case types_SExpr_sym:
                                    {
                                        ...
                                        if (string_eq(sym.name, SLOP_STR("Array"))) {
                                            __auto_type _mv_1134 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_1134.has_value) {
                                                __auto_type elem_expr = _mv_1134.value;
                                                {
...
void transpiler_emit_all_types(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1135 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    ...
    }
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1136 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            ...
            __auto_type lst = _mv_1137.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 3)) {
                    ...
                    if (_mv_1138.has_value) {
                        __auto_type def_expr = _mv_1138.value;
                        __auto_type _mv_1139 = (*def_expr);
                        switch (_mv_1139.tag) {
                            case types_SExpr_lst:
                            {
                                __auto_type def_lst = _mv_1139.data.lst;
                                {
                                    __auto_type def_items = def_lst.items;
                                    if ((((int64_t)((def_items).len)) < 1)) {
                                        return 0;
                                    } else {
                                        __auto_type _mv_1140 = ({ __auto_type _lst = def_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_1140.has_value) {
                                            __auto_type head = _mv_1140.value;
                                            __auto_type _mv_1141 = (*head);
                                            switch (_mv_1141.tag) {
                                                case types_SExpr_sym:
                                                {
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1142.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    __auto_type _mv_1143 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void transpiler_emit_all_functions(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1145 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1146.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    __auto_type _mv_1147 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void transpiler_transpile_module(context_TranspileContext* ctx, types_SExpr* module_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1149 = (*module_expr);
        switch (_mv_1149.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1149.data.lst;
                {
                    ...
                    __auto_type len = ((int64_t)((items).len));
                    if ((len >= 2)) {
                        __auto_type _mv_1150 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
int64_t transpiler_get_body_start(slop_list_types_SExpr_ptr items) {
    if ((((int64_t)((items).len)) < 3)) {
        ...
        if (_mv_1152.has_value) {
            __auto_type third = _mv_1152.value;
            __auto_type _mv_1153 = (*third);
            switch (_mv_1153.tag) {
                case types_SExpr_lst:
                {
                    __auto_type lst = _mv_1153.data.lst;
                    {
                        ...
                        if ((((int64_t)((sub_items).len)) < 1)) {
                            ...
                            __auto_type _mv_1154 = ({ __auto_type _lst = sub_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                ...
                switch (_mv_1157.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type lst = _mv_1157.data.lst;
                        {
                            __auto_type sub_items = lst.items;
                            if ((((int64_t)((sub_items).len)) >= 1)) {
                                __auto_type _mv_1158 = ({ __auto_type _lst = sub_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            ...
                                            if (string_eq(sym.name, SLOP_STR("export"))) {
                                                {
                                                    ...
                                                    __auto_type j = 1;
                                                    while ((j < export_len)) {
                                                        __auto_type _mv_1160 = ({ __auto_type _lst = sub_items; size_t _idx = (size_t)j; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
uint8_t transpiler_list_contains_str(slop_list_string lst, slop_string needle) {
    {
        ...
        uint8_t found = 0;
        while (((i < len) && !(found))) {
            __auto_type _mv_1162 = ({ __auto_type _lst = lst; size_t _idx = (size_t)i; slop_option_string _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1162.has_value) {
                __auto_type s = _mv_1162.value;
...
void transpiler_prescan_module_body(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items, int64_t start) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = start;
        while ((i < len)) {
            __auto_type _mv_1163 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void transpiler_scan_type_for_generics(context_TranspileContext* ctx, types_SExpr* type_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1164 = (*type_expr);
        switch (_mv_1164.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1164.data.lst;
                {
                    ...
                    __auto_type len = ((int64_t)((items).len));
                    if ((len >= 1)) {
                        __auto_type _mv_1165 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        ...
                                        if (string_eq(op, SLOP_STR("Option"))) {
                                            if ((len >= 2)) {
                                                ...
                                                if (_mv_1167.has_value) {
                                                    __auto_type inner = _mv_1167.value;
                                                    {
                                            ...
                                            if ((len >= 2)) {
                                                ...
                                                if (_mv_1168.has_value) {
                                                    __auto_type elem = _mv_1168.value;
                                                    {
                                            ...
                                            if ((len >= 2)) {
                                                ...
                                                if (_mv_1169.has_value) {
                                                    __auto_type inner = _mv_1169.value;
                                                    transpiler_scan_type_for_generics(ctx, inner);
                                            ...
                                            if ((len >= 3)) {
                                                __auto_type _mv_1170 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_1170.has_value) {
                                                    __auto_type ok_type = _mv_1170.value;
                                                    ...
                                                    if (_mv_1171.has_value) {
                                                        __auto_type err_type = _mv_1171.value;
                                                        {
                                            ...
                                            if ((len >= 2)) {
                                                ...
                                                if (_mv_1172.has_value) {
                                                    __auto_type elem = _mv_1172.value;
                                                    {
                                                        __auto_type elem_c = context_to_c_type_prefixed(ctx, elem);
                                                        __auto_type elem_id = ctype_type_to_identifier(arena, elem_c);
                                            ...
                                            if ((len >= 2)) {
                                                ...
                                                if (_mv_1173.has_value) {
                                                    __auto_type result = _mv_1173.value;
                                                    {
                                            ...
                                            if ((len >= 3)) {
                                                __auto_type _mv_1174 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_1174.has_value) {
                                                    __auto_type key_type = _mv_1174.value;
                                                    {
                                                        ...
                                                        if (_mv_1175.has_value) {
                                                            __auto_type val_type = _mv_1175.value;
                                            ...
                                            if ((len >= 2)) {
                                                ...
                                                if (_mv_1176.has_value) {
                                                    __auto_type elem_type = _mv_1176.value;
                                                    {
...
void transpiler_scan_record_fields_for_generics(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 1;
        while ((i < len)) {
            __auto_type _mv_1177 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1177.has_value) {
                __auto_type field_expr = _mv_1177.value;
                __auto_type _mv_1178 = (*field_expr);
                switch (_mv_1178.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type field_lst = _mv_1178.data.lst;
                        {
                            __auto_type field_items = field_lst.items;
                            if ((((int64_t)((field_items).len)) >= 2)) {
                                __auto_type _mv_1179 = ({ __auto_type _lst = field_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1179.has_value) {
                                    __auto_type type_expr = _mv_1179.value;
                                    transpiler_scan_type_for_generics(ctx, type_expr);
...
void transpiler_emit_ffi_includes(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1180 = ({ __auto_type _lst = includes; size_t _idx = (size_t)i; slop_option_string _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1180.has_value) {
                __auto_type header = _mv_1180.value;
...
void transpiler_emit_ffi_includes_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1181 = ({ __auto_type _lst = includes; size_t _idx = (size_t)i; slop_option_string _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1181.has_value) {
                __auto_type header = _mv_1181.value;
...
void transpiler_emit_header_guard_open(context_TranspileContext* ctx) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1182 = context_ctx_get_module(ctx);
        if (_mv_1182.has_value) {
            __auto_type mod_name = _mv_1182.value;
            {
...
void transpiler_emit_header_dependency_includes(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1183 = ({ __auto_type _lst = imports; size_t _idx = (size_t)i; slop_option_string _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1183.has_value) {
                __auto_type mod_name = _mv_1183.value;
                {
                    __auto_type c_name = ctype_to_c_name(arena, mod_name);
...
void transpiler_emit_forward_decls(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items, int64_t start) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while ((i < len)) {
            __auto_type _mv_1184 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1184.has_value) {
                __auto_type item = _mv_1184.value;
                if ((transpiler_is_type_def(item) && transpiler_is_struct_type_def(item))) {
                    __auto_type _mv_1185 = transpiler_get_type_name(item);
                    if (_mv_1185.has_value) {
                        __auto_type type_name = _mv_1185.value;
                        {
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1186.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 3)) {
                    ...
                    __auto_type _mv_1187 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_1187.has_value) {
                        __auto_type def_expr = _mv_1187.value;
                        __auto_type _mv_1188 = (*def_expr);
                        switch (_mv_1188.tag) {
                            case types_SExpr_lst:
                            {
                                __auto_type def_lst = _mv_1188.data.lst;
                                {
                                    __auto_type def_items = def_lst.items;
                                    if ((((int64_t)((def_items).len)) < 1)) {
                                        return 0;
                                    } else {
                                        __auto_type _mv_1189 = ({ __auto_type _lst = def_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_1189.has_value) {
                                            __auto_type head = _mv_1189.value;
                                            __auto_type _mv_1190 = (*head);
                                            switch (_mv_1190.tag) {
                                                case types_SExpr_sym:
                                                {
                                                    __auto_type sym = _mv_1190.data.sym;
                                                    {
...
uint8_t transpiler_has_enum_payload_variants(slop_list_types_SExpr_ptr items) {
    {
        ...
        while (((i < len) && !(found))) {
            ...
            if (_mv_1191.has_value) {
                ...
                __auto_type _mv_1192 = (*item);
                switch (_mv_1192.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type _ = _mv_1192.data.lst;
                        found = 1;
                        break;
                    }
                    default: {
                ...
                if ((((int64_t)((items).len)) < 3)) {
                    ...
                    if (_mv_1194.has_value) {
                        ...
                        switch (_mv_1195.tag) {
                            case types_SExpr_sym:
                            {
                                __auto_type _ = _mv_1195.data.sym;
                                return 1;
                            }
                            case types_SExpr_lst:
                            {
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1198.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 3)) {
                    ...
                    __auto_type _mv_1199 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_1199.has_value) {
                        __auto_type def_expr = _mv_1199.value;
                        __auto_type _mv_1200 = (*def_expr);
                        switch (_mv_1200.tag) {
                            case types_SExpr_lst:
                            {
                                __auto_type def_lst = _mv_1200.data.lst;
                                {
                                    __auto_type def_items = def_lst.items;
                                    if ((((int64_t)((def_items).len)) < 1)) {
                                        return 0;
                                    } else {
                                        __auto_type _mv_1201 = ({ __auto_type _lst = def_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    ...
                    if ((((int64_t)((items).len)) >= 3)) {
                        ...
                        if (_mv_1204.has_value) {
                            ...
                            switch (_mv_1205.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_1205.data.sym;
                                    {
                                        ...
                                        if (_mv_1206.has_value) {
                                            __auto_type body_expr = _mv_1206.value;
...
uint8_t transpiler_is_array_type_body(types_SExpr* body_expr) {
    SLOP_PRE(((body_expr != NULL)), "(!= body-expr nil)");
    __auto_type _mv_1207 = (*body_expr);
    switch (_mv_1207.tag) {
        case types_SExpr_lst:
        {
...
void transpiler_emit_array_typedef_to_header(context_TranspileContext* ctx, slop_string c_name, types_SExpr* body_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1210 = (*body_expr);
        switch (_mv_1210.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1210.data.lst;
                {
                    ...
                    if ((len < 3)) {
                        ...
                        if (_mv_1211.has_value) {
                            __auto_type elem_type_expr = _mv_1211.value;
                            ...
                            if (_mv_1212.has_value) {
                                __auto_type size_expr = _mv_1212.value;
                                {
...
slop_string transpiler_get_array_size_string(types_SExpr* expr) {
    SLOP_PRE(((expr != NULL)), "(!= expr nil)");
    __auto_type _mv_1213 = (*expr);
    switch (_mv_1213.tag) {
        case types_SExpr_num:
        {
            __auto_type num = _mv_1213.data.num;
            return num.raw;
        }
        default: {
            return SLOP_STR("0");
...
uint8_t transpiler_is_range_type_body(types_SExpr* body_expr) {
    SLOP_PRE(((body_expr != NULL)), "(!= body-expr nil)");
    __auto_type _mv_1214 = (*body_expr);
    switch (_mv_1214.tag) {
        case types_SExpr_lst:
        {
...
transpiler_RangeBoundsHeader transpiler_parse_range_bounds_header(types_SExpr* body_expr) {
    SLOP_PRE(((body_expr != NULL)), "(!= body-expr nil)");
    {
        ...
        __auto_type _mv_1217 = (*body_expr);
        switch (_mv_1217.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1217.data.lst;
                {
                    ...
                    while ((i < len)) {
                        ...
                        if (_mv_1218.has_value) {
                            ...
                            __auto_type _mv_1219 = (*item);
                            switch (_mv_1219.tag) {
                                case types_SExpr_num:
                                {
                                    __auto_type num = _mv_1219.data.num;
                                    if (!(found_dots)) {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while ((i < len)) {
            ...
            if (_mv_1220.has_value) {
                ...
                if ((transpiler_is_type_def(item) && transpiler_is_struct_type_def(item))) {
                    __auto_type _mv_1221 = transpiler_get_type_name(item);
                    if (_mv_1221.has_value) {
                        __auto_type type_name = _mv_1221.value;
                        {
...
void transpiler_emit_c_name_aliases(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len > 0)) {
            ...
            while ((i < len)) {
                __auto_type _mv_1224 = ({ __auto_type _lst = aliases; size_t _idx = (size_t)i; slop_option_context_FuncCNameAlias _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_1224.has_value) {
                    __auto_type alias = _mv_1224.value;
...
void transpiler_emit_result_types(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1236 = ({ __auto_type _lst = result_types; size_t _idx = (size_t)i; slop_option_context_ResultType _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1236.has_value) {
                __auto_type rt = _mv_1236.value;
...
void transpiler_emit_result_types_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1237 = ({ __auto_type _lst = result_types; size_t _idx = (size_t)i; slop_option_context_ResultType _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1237.has_value) {
                __auto_type rt = _mv_1237.value;
...
void transpiler_emit_inline_records_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1238 = ({ __auto_type _lst = inline_records; size_t _idx = (size_t)i; slop_option_context_InlineRecord _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1238.has_value) {
                __auto_type ir = _mv_1238.value;
                {
...
void transpiler_emit_value_option_types_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1240 = ({ __auto_type _lst = option_types; size_t _idx = (size_t)i; slop_option_context_OptionType _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1240.has_value) {
                __auto_type ot = _mv_1240.value;
...
void transpiler_emit_list_types_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1242 = ({ __auto_type _lst = list_types; size_t _idx = (size_t)i; slop_option_context_ListType _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1242.has_value) {
                __auto_type lt = _mv_1242.value;
...
void transpiler_emit_primitive_option_types_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1244 = ({ __auto_type _lst = option_types; size_t _idx = (size_t)i; slop_option_context_OptionType _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1244.has_value) {
                __auto_type ot = _mv_1244.value;
...
void transpiler_emit_imported_list_types_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1245 = ({ __auto_type _lst = list_types; size_t _idx = (size_t)i; slop_option_context_ListType _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1245.has_value) {
                __auto_type lt = _mv_1245.value;
...
void transpiler_emit_imported_option_types_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1246 = ({ __auto_type _lst = option_types; size_t _idx = (size_t)i; slop_option_context_OptionType _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1246.has_value) {
                __auto_type ot = _mv_1246.value;
...
void transpiler_emit_late_registered_option_types_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1247 = ({ __auto_type _lst = option_types; size_t _idx = (size_t)i; slop_option_context_OptionType _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1247.has_value) {
                __auto_type ot = _mv_1247.value;
                transpiler_emit_single_option_type_header(ctx, ot);
...
void transpiler_emit_value_list_types_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1248 = ({ __auto_type _lst = list_types; size_t _idx = (size_t)i; slop_option_context_ListType _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1248.has_value) {
                __auto_type lt = _mv_1248.value;
...
void transpiler_emit_complex_value_list_types_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1249 = ({ __auto_type _lst = list_types; size_t _idx = (size_t)i; slop_option_context_ListType _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1249.has_value) {
                __auto_type lt = _mv_1249.value;
...
void transpiler_emit_union_payload_hash_eq(context_TranspileContext* ctx, slop_list_context_UnionVariantEntry variants) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1250 = ({ __auto_type _lst = variants; size_t _idx = (size_t)i; slop_option_context_UnionVariantEntry _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1250.has_value) {
                __auto_type variant = _mv_1250.value;
                {
...
void transpiler_emit_record_field_dependencies(context_TranspileContext* ctx, slop_list_context_FieldEntry fields) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1251 = ({ __auto_type _lst = fields; size_t _idx = (size_t)i; slop_option_context_FieldEntry _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1251.has_value) {
                __auto_type field = _mv_1251.value;
                {
...
uint8_t transpiler_is_range_type_alias(context_TranspileContext* ctx, slop_string slop_type) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    __auto_type _mv_1252 = context_ctx_lookup_type_alias(ctx, slop_type);
    if (_mv_1252.has_value) {
        __auto_type underlying = _mv_1252.value;
...
void transpiler_emit_union_hash_fn(context_TranspileContext* ctx, slop_string c_type, slop_list_context_UnionVariantEntry variants) {
    ...
    context_ctx_emit_header(ctx, SLOP_STR("    switch (_k->tag) {"));
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1253 = ({ __auto_type _lst = variants; size_t _idx = (size_t)i; slop_option_context_UnionVariantEntry _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1253.has_value) {
                __auto_type variant = _mv_1253.value;
...
void transpiler_emit_union_eq_fn(context_TranspileContext* ctx, slop_string c_type, slop_list_context_UnionVariantEntry variants) {
    ...
    context_ctx_emit_header(ctx, SLOP_STR("    switch (_a->tag) {"));
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1254 = ({ __auto_type _lst = variants; size_t _idx = (size_t)i; slop_option_context_UnionVariantEntry _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1254.has_value) {
                __auto_type variant = _mv_1254.value;
...
void transpiler_emit_struct_hash_fn(context_TranspileContext* ctx, slop_string c_type, slop_list_context_FieldEntry fields) {
    ...
    context_ctx_emit_header(ctx, SLOP_STR("    uint64_t hash = 14695981039346656037ULL;"));
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1255 = ({ __auto_type _lst = fields; size_t _idx = (size_t)i; slop_option_context_FieldEntry _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1255.has_value) {
                __auto_type field = _mv_1255.value;
    ...
    context_ctx_emit_header(ctx, context_ctx_str(ctx, context_ctx_str4(ctx, SLOP_STR("    const "), c_type, SLOP_STR("* _b = (const "), c_type), SLOP_STR("*)b;")));
    {
        ...
        if ((len == 0)) {
            ...
            context_ctx_emit_header(ctx, SLOP_STR("    return true"));
            {
                int64_t i = 0;
                while ((i < len)) {
                    __auto_type _mv_1256 = ({ __auto_type _lst = fields; size_t _idx = (size_t)i; slop_option_context_FieldEntry _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_1256.has_value) {
                        __auto_type field = _mv_1256.value;
...
void transpiler_emit_struct_key_types_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while ((i < ((int64_t)((struct_key_types).len)))) {
            __auto_type _mv_1257 = ({ __auto_type _lst = struct_key_types; size_t _idx = (size_t)i; slop_option_string _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1257.has_value) {
                __auto_type c_type = _mv_1257.value;
                {
                    __auto_type guard_name = context_ctx_str3(ctx, transpiler_uppercase_name(ctx, c_type), SLOP_STR("_HASH_EQ_DEFINED"), SLOP_STR(""));
...
void transpiler_emit_chan_types_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1258 = ({ __auto_type _lst = chan_types; size_t _idx = (size_t)i; slop_option_context_ChanType _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1258.has_value) {
                __auto_type ct = _mv_1258.value;
                {
...
void transpiler_emit_chan_funcs_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1259 = ({ __auto_type _lst = chan_types; size_t _idx = (size_t)i; slop_option_context_ChanType _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1259.has_value) {
                __auto_type ct = _mv_1259.value;
                {
                    __auto_type elem_type = ct.elem_type;
                    __auto_type c_name = ct.c_name;
...
void transpiler_emit_thread_types_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1260 = ({ __auto_type _lst = thread_types; size_t _idx = (size_t)i; slop_option_context_ThreadType _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1260.has_value) {
                __auto_type tt = _mv_1260.value;
                {
            ...
            __auto_type lst = _mv_1261.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 3)) {
                    ...
                    if (_mv_1262.has_value) {
                        __auto_type def_expr = _mv_1262.value;
                        __auto_type _mv_1263 = (*def_expr);
                        switch (_mv_1263.tag) {
                            case types_SExpr_lst:
                            {
                                __auto_type def_lst = _mv_1263.data.lst;
                                {
                                    __auto_type def_items = def_lst.items;
                                    if ((((int64_t)((def_items).len)) < 1)) {
                                        return 0;
                                    } else {
                                        __auto_type _mv_1264 = ({ __auto_type _lst = def_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void transpiler_emit_pending_container_deps(context_TranspileContext* ctx, types_SExpr* type_def) {
    ...
    SLOP_PRE(((type_def != NULL)), "(!= type-def nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1272 = ({ __auto_type _lst = field_types; size_t _idx = (size_t)i; slop_option_string _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1272.has_value) {
                __auto_type field_type = _mv_1272.value;
...
void transpiler_emit_list_by_c_name(context_TranspileContext* ctx, slop_string c_name) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1274 = ({ __auto_type _lst = list_types; size_t _idx = (size_t)i; slop_option_context_ListType _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1274.has_value) {
                __auto_type lt = _mv_1274.value;
...
uint8_t transpiler_index_in_list(slop_list_int lst, int64_t idx) {
    {
        ...
        uint8_t found = 0;
        while (((i < len) && !(found))) {
            __auto_type _mv_1276 = ({ __auto_type _lst = lst; size_t _idx = (size_t)i; slop_option_int _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1276.has_value) {
                __auto_type v = _mv_1276.value;
                if ((v == idx)) {
                    found = 1;
                }
...
uint8_t transpiler_type_deps_satisfied(context_TranspileContext* ctx, types_SExpr* type_def) {
    ...
    SLOP_PRE(((type_def != NULL)), "(!= type-def nil)");
    {
        ...
        while (((i < len) && all_satisfied)) {
            __auto_type _mv_1277 = ({ __auto_type _lst = field_types; size_t _idx = (size_t)i; slop_option_string _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1277.has_value) {
                __auto_type field_type = _mv_1277.value;
                ...
                __auto_type lst = _mv_1278.data.lst;
                {
                    ...
                    if ((((int64_t)((items).len)) >= 3)) {
                        ...
                        if (_mv_1279.has_value) {
                            __auto_type def_expr = _mv_1279.value;
                            __auto_type _mv_1280 = (*def_expr);
                            switch (_mv_1280.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type def_lst = _mv_1280.data.lst;
                                    {
                                        __auto_type def_items = def_lst.items;
                                        __auto_type def_len = ((int64_t)((def_items).len));
                                        if ((def_len > 0)) {
                                            __auto_type _mv_1281 = ({ __auto_type _lst = def_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_list_string transpiler_extract_record_field_types(context_TranspileContext* ctx, slop_list_types_SExpr_ptr def_items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 1;
        while ((i < len)) {
            __auto_type _mv_1283 = ({ __auto_type _lst = def_items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1283.has_value) {
                __auto_type field_expr = _mv_1283.value;
                __auto_type _mv_1284 = (*field_expr);
                switch (_mv_1284.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type field_lst = _mv_1284.data.lst;
                        if ((((int64_t)((field_lst.items).len)) >= 2)) {
                            __auto_type _mv_1285 = ({ __auto_type _lst = field_lst.items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_list_string transpiler_extract_union_variant_types(context_TranspileContext* ctx, slop_list_types_SExpr_ptr def_items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 1;
        while ((i < len)) {
            __auto_type _mv_1286 = ({ __auto_type _lst = def_items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1286.has_value) {
                ...
                switch (_mv_1287.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type variant_lst = _mv_1287.data.lst;
                        if ((((int64_t)((variant_lst.items).len)) >= 2)) {
                            __auto_type _mv_1288 = ({ __auto_type _lst = variant_lst.items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_string transpiler_get_field_type_string(context_TranspileContext* ctx, types_SExpr* type_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1289 = (*type_expr);
        switch (_mv_1289.tag) {
            case types_SExpr_sym:
            {
                ...
                {
                    __auto_type name = sym.name;
                    __auto_type _mv_1290 = context_ctx_lookup_type(ctx, name);
                                        ...
                                        if (string_eq(kind, SLOP_STR("Ptr"))) {
                                            ...
                                            if ((((int64_t)((items).len)) >= 2)) {
                                                ...
                                                if (_mv_1293.has_value) {
                                                    __auto_type inner = _mv_1293.value;
                                                    {
                                            ...
                                            if ((((int64_t)((items).len)) >= 2)) {
                                                __auto_type _mv_1294 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_1294.has_value) {
                                                    __auto_type inner = _mv_1294.value;
                                                    {
                                                        __auto_type inner_str = transpiler_get_field_type_string(ctx, inner);
                                                        if (string_eq(inner_str, SLOP_STR(""))) {
                                                            return SLOP_STR("");
                    ...
                    if (_mv_1296.has_value) {
                        ...
                        switch (_mv_1297.tag) {
                            case types_SExpr_sym:
                            {
                                ...
                                {
                                    __auto_type name = sym.name;
                                    __auto_type _mv_1298 = context_ctx_lookup_type(ctx, name);
                                    if (_mv_1298.has_value) {
                                        __auto_type entry = _mv_1298.value;
                                        return entry.c_name;
        ...
        if (!(found)) {
            {
                ...
                int64_t j = 0;
                while (((j < len2) && !(found))) {
                    __auto_type _mv_1302 = ({ __auto_type _lst = option_types; size_t _idx = (size_t)j; slop_option_context_OptionType _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_1302.has_value) {
                        __auto_type ot = _mv_1302.value;
...
uint8_t transpiler_is_imported_type(context_TranspileContext* ctx, slop_string type_name) {
    ...
    if ((strlib_starts_with(type_name, SLOP_STR("slop_list_")) || strlib_starts_with(type_name, SLOP_STR("slop_option_")))) {
        ...
        __auto_type _mv_1307 = context_ctx_get_module(ctx);
        if (_mv_1307.has_value) {
            __auto_type current_mod = _mv_1307.value;
            {
                __auto_type arena = (*ctx).arena;
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1310.data.lst;
                {
                    ...
                    if ((((int64_t)((items).len)) < 3)) {
                        ...
                        __auto_type _mv_1311 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_1311.has_value) {
                            __auto_type body_expr = _mv_1311.value;
                ...
                __auto_type lst = _mv_1312.data.lst;
                {
                    ...
                    while (((i < len) && !(found))) {
                        ...
                        if (_mv_1313.has_value) {
                            __auto_type field_expr = _mv_1313.value;
...
uint8_t transpiler_field_uses_typename(context_TranspileContext* ctx, types_SExpr* field_expr, slop_string typename) {
    ...
    __auto_type _mv_1314 = (*field_expr);
    switch (_mv_1314.tag) {
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1314.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 2)) {
                    ...
                    if (_mv_1315.has_value) {
                        __auto_type type_expr = _mv_1315.value;
                        {
                            __auto_type c_type = context_to_c_type_prefixed(ctx, type_expr);
                                ...
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_1318.data.sym;
                                    {
                                        ...
                                        if (_mv_1319.has_value) {
                                            __auto_type body_expr = _mv_1319.value;
...
void transpiler_emit_type_body_to_header(context_TranspileContext* ctx, slop_string raw_type_name, slop_string c_name, types_SExpr* body_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1320 = (*body_expr);
        switch (_mv_1320.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1320.data.lst;
                {
                    ...
                    if ((((int64_t)((items).len)) < 1)) {
                        ...
                        if (_mv_1321.has_value) {
                            __auto_type kind_expr = _mv_1321.value;
                            __auto_type _mv_1322 = (*kind_expr);
                            switch (_mv_1322.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type kind_sym = _mv_1322.data.sym;
                                    {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while ((i < len)) {
            ...
            if (_mv_1323.has_value) {
                __auto_type variant_expr = _mv_1323.value;
                __auto_type _mv_1324 = (*variant_expr);
                switch (_mv_1324.tag) {
                    case types_SExpr_sym:
                    {
                        __auto_type variant_sym = _mv_1324.data.sym;
                        {
        ...
        switch (_mv_1326.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1326.data.lst;
                {
                    __auto_type items = lst.items;
                    if ((((int64_t)((items).len)) >= 2)) {
                        __auto_type _mv_1327 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_1327.has_value) {
                            ...
                            switch (_mv_1328.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_1328.data.sym;
                                    {
                                        __auto_type field_name = name_sym.name;
                                        __auto_type c_field_name = ctype_to_c_name(arena, field_name);
                                        __auto_type _mv_1329 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_1329.has_value) {
                                            __auto_type type_expr = _mv_1329.value;
                                            {
                                                __auto_type c_type = context_to_c_type_prefixed(ctx, type_expr);
...
uint8_t transpiler_is_pointer_type_expr_header(types_SExpr* type_expr) {
    SLOP_PRE(((type_expr != NULL)), "(!= type-expr nil)");
    __auto_type _mv_1330 = (*type_expr);
    switch (_mv_1330.tag) {
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1330.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    __auto_type _mv_1331 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        context_ctx_emit_header(ctx, SLOP_STR("typedef enum {"));
        {
            ...
            while ((i < len)) {
                ...
                if (_mv_1333.has_value) {
                    __auto_type variant_expr = _mv_1333.value;
                    {
        ...
        context_ctx_emit_header(ctx, SLOP_STR("    union {"));
        {
            ...
            while ((i < len)) {
                ...
                if (_mv_1334.has_value) {
                    __auto_type variant_expr = _mv_1334.value;
...
slop_string transpiler_get_variant_name(types_SExpr* variant_expr) {
    ...
    __auto_type _mv_1335 = (*variant_expr);
    switch (_mv_1335.tag) {
        case types_SExpr_sym:
        {
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1335.data.lst;
            {
                __auto_type items = lst.items;
                if ((((int64_t)((items).len)) < 1)) {
                    return SLOP_STR("unknown");
                } else {
                    __auto_type _mv_1336 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_1336.has_value) {
                        __auto_type name_expr = _mv_1336.value;
                        __auto_type _mv_1337 = (*name_expr);
                        switch (_mv_1337.tag) {
                            case types_SExpr_sym:
                            {
                                __auto_type name_sym = _mv_1337.data.sym;
        ...
        switch (_mv_1338.tag) {
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1338.data.lst;
                {
                    __auto_type items = lst.items;
                    if ((((int64_t)((items).len)) >= 2)) {
                        __auto_type _mv_1339 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_1339.has_value) {
                            ...
                            switch (_mv_1340.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_1340.data.sym;
                                    {
                                        __auto_type variant_name = name_sym.name;
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1347.data.lst;
            {
                ...
                if ((((int64_t)((const_items).len)) < 4)) {
                    ...
                    __auto_type _mv_1348 = ({ __auto_type _lst = const_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_1348.has_value) {
                        __auto_type name_expr = _mv_1348.value;
                        __auto_type _mv_1349 = (*name_expr);
                        switch (_mv_1349.tag) {
                            case types_SExpr_sym:
                            {
                                __auto_type name_sym = _mv_1349.data.sym;
                                {
                                    __auto_type raw_name = name_sym.name;
                                    if (!(transpiler_list_contains_str(exports, raw_name))) {
                                        return 0;
                                    } else {
                                        __auto_type _mv_1350 = ({ __auto_type _lst = const_items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_1350.has_value) {
                                            __auto_type type_expr = _mv_1350.value;
...
void transpiler_emit_module_functions(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items, int64_t start) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while ((i < len)) {
            __auto_type _mv_1351 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void transpiler_emit_all_lambdas(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((count > 0)) {
            while ((i < count)) {
                __auto_type _mv_1352 = ({ __auto_type _lst = lambdas; size_t _idx = (size_t)i; slop_option_string _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_1352.has_value) {
                    __auto_type lambda_code = _mv_1352.value;
...
slop_string transpiler_generate_c_output(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1353 = ({ __auto_type _lst = output_lines; size_t _idx = (size_t)i; slop_option_string _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1353.has_value) {
                __auto_type line = _mv_1353.value;
...
void transpiler_transpile_file(context_TranspileContext* ctx, slop_list_types_SExpr_ptr exprs) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (((len > 0) && transpiler_is_module_expr(exprs))) {
            __auto_type _mv_1354 = ({ __auto_type _lst = exprs; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1354.has_value) {
                __auto_type module_expr = _mv_1354.value;
...
uint8_t transpiler_is_module_expr(slop_list_types_SExpr_ptr exprs) {
    if ((((int64_t)((exprs).len)) < 1)) {
        ...
        __auto_type _mv_1355 = ({ __auto_type _lst = exprs; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        if (_mv_1355.has_value) {
            __auto_type first = _mv_1355.value;
            __auto_type _mv_1356 = (*first);
            switch (_mv_1356.tag) {
                case types_SExpr_lst:
                {
                    __auto_type lst = _mv_1356.data.lst;
                    {
                        __auto_type items = lst.items;
                        if ((((int64_t)((items).len)) < 1)) {
                            return 0;
                        } else {
                            __auto_type _mv_1357 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
