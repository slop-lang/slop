            ...
            __auto_type lst = _mv_797.data.lst;
            {
                ...
                while (i < len) {
                    ...
                    if (_mv_798.has_value) {
                        __auto_type item_expr = _mv_798.value;
                        {
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_799.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) >= 3) {
                        __auto_type _mv_800 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_800.has_value) {
                            __auto_type head_ptr = _mv_800.value;
                            __auto_type _mv_801 = (*head_ptr);
                            switch (_mv_801.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type head_sym = _mv_801.data.sym;
                                    {
                                        __auto_type op = head_sym.name;
                                        if (string_eq(op, SLOP_STR("arena-alloc"))) {
                                            __auto_type _mv_802 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            ...
                                            if (_mv_803.has_value) {
                                                __auto_type inner_expr = _mv_803.value;
            ...
            __auto_type lst = _mv_809.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 1) {
                    ...
                    if (_mv_810.has_value) {
                        __auto_type head_expr = _mv_810.value;
                        __auto_type _mv_811 = (*head_expr);
                        switch (_mv_811.tag) {
                            case types_SExpr_sym:
                            {
                ...
                __auto_type lst = _mv_812.data.lst;
                {
                    ...
                    if (len < 2) {
                        ...
                        if (_mv_813.has_value) {
                            __auto_type bindings_expr = _mv_813.value;
                            __auto_type _mv_814 = (*bindings_expr);
                            switch (_mv_814.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type bindings_lst = _mv_814.data.lst;
                        ...
                        }
                        {
                            __auto_type i = 2;
                            while (i < len) {
                                __auto_type _mv_815 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_815.has_value) {
                                    __auto_type body_expr = _mv_815.value;
                                    {
...
void stmt_transpile_bindings(context_TranspileContext* ctx, slop_list_types_SExpr_ptr bindings) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_816 = ({ __auto_type _lst = bindings; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_816.has_value) {
                __auto_type binding_expr = _mv_816.value;
...
void stmt_transpile_single_binding(context_TranspileContext* ctx, types_SExpr* binding) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_817 = (*binding);
        switch (_mv_817.tag) {
            case types_SExpr_lst:
            {
                __auto_type binding_lst = _mv_817.data.lst;
                {
                    ...
                    __auto_type len = ((int64_t)((items).len));
                    {
                        ...
                        if ((len - start_idx) < 2) {
                            ...
                            __auto_type _mv_818 = ({ __auto_type _lst = items; size_t _idx = (size_t)start_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        ...
                                        __auto_type name_sym = _mv_819.data.sym;
                                        {
                                            ...
                                            if ((len - start_idx) >= 3) {
                                                ...
                                                if (_mv_820.has_value) {
                                                    ...
                                                    __auto_type _mv_821 = ({ __auto_type _lst = items; size_t _idx = (size_t)(start_idx + 2); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_821.has_value) {
                                                        __auto_type init_expr = _mv_821.value;
                                                        {
                                                            __auto_type c_type = context_to_c_type_prefixed(ctx, type_expr);
                                                            {
                                                ...
                                                if (_mv_822.has_value) {
                                                    __auto_type init_expr = _mv_822.value;
                                                    {
                                                        ...
                                                        __auto_type _mv_823 = ptr_type_opt;
                                                        if (_mv_823.has_value) {
                                                            __auto_type ptr_type = _mv_823.value;
...
uint8_t stmt_binding_has_mut(slop_list_types_SExpr_ptr items) {
    if (((int64_t)((items).len)) < 1) {
        ...
        if (_mv_824.has_value) {
            __auto_type first = _mv_824.value;
            __auto_type _mv_825 = (*first);
            switch (_mv_825.tag) {
                case types_SExpr_sym:
                {
                ...
                __auto_type lst = _mv_826.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) >= 2) {
                        ...
                        if (_mv_827.has_value) {
                            __auto_type head_expr = _mv_827.value;
                            __auto_type _mv_828 = (*head_expr);
                            switch (_mv_828.tag) {
                                case types_SExpr_sym:
                                {
                            ...
                            if (_mv_845.has_value) {
                                __auto_type value_expr = _mv_845.value;
                                {
                                    ...
                                    if (_mv_846.has_value) {
                                        ...
                                        {
                                            __auto_type some_val_opt = stmt_get_some_value(value_expr);
                                            __auto_type _mv_848 = some_val_opt;
                                            if (_mv_848.has_value) {
                                                ...
                                                if (stmt_is_none_form(value_expr)) {
                                                    __auto_type _mv_849 = context_ctx_get_current_return_type(ctx);
                                                    if (_mv_849.has_value) {
                                                        __auto_type ret_type = _mv_849.value;
...
void stmt_transpile_field_set(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (_mv_854.has_value) {
            __auto_type target_expr = _mv_854.value;
            __auto_type _mv_855 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_855.has_value) {
                __auto_type field_expr = _mv_855.value;
                __auto_type _mv_856 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        if (_mv_857.has_value) {
            ...
            if (_mv_858.has_value) {
                ...
                if (_mv_859.has_value) {
                    __auto_type type_expr = _mv_859.value;
                    __auto_type _mv_860 = ({ __auto_type _lst = items; size_t _idx = (size_t)4; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            ...
                            __auto_type c_type = ctype_to_c_type(arena, type_expr);
                            {
                                ...
                                if (strlib_starts_with(c_type, SLOP_STR("slop_option_"))) {
                                    if (stmt_is_none_form(value_expr)) {
                                        ...
                                        __auto_type _mv_861 = stmt_get_some_value(value_expr);
                                        if (_mv_861.has_value) {
                                            __auto_type inner_val = _mv_861.value;
                                            {
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_865.data.lst;
            {
                ...
                if (_mv_866.has_value) {
                    __auto_type inner = _mv_866.value;
                    return inner;
                ...
                if (len < 2) {
                ...
                } else {
                    {
                        ...
                        if (is_named && (len < 4)) {
                            ...
                            context_ctx_indent(ctx);
                            context_ctx_push_scope(ctx);
                            __auto_type _mv_871 = ({ __auto_type _lst = items; size_t _idx = (size_t)size_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_871.has_value) {
                                __auto_type size_expr = _mv_871.value;
                                {
            ...
            __auto_type lst = _mv_873.data.lst;
            {
                ...
                while (i < len) {
                    ...
                    if (_mv_874.has_value) {
                        __auto_type clause_expr = _mv_874.value;
                        __auto_type _mv_875 = (*clause_expr);
                        switch (_mv_875.tag) {
                            case types_SExpr_lst:
                            {
                                __auto_type clause_lst = _mv_875.data.lst;
                                {
                                    ...
                                    if (clause_len < 1) {
                                        ...
                                        __auto_type _mv_876 = ({ __auto_type _lst = clause_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_876.has_value) {
                                            __auto_type test_expr = _mv_876.value;
                                            __auto_type _mv_877 = (*test_expr);
                                            switch (_mv_877.tag) {
                                                case types_SExpr_sym:
                                                {
                ...
                __auto_type lst = _mv_879.data.lst;
                {
                    ...
                    if (len < 2) {
                        ...
                        if (_mv_880.has_value) {
                            __auto_type binding_expr = _mv_880.value;
                            __auto_type _mv_881 = (*binding_expr);
                            switch (_mv_881.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type binding_lst = _mv_881.data.lst;
                                    {
                                        ...
                                        if (binding_len < 3) {
                                            ...
                                            __auto_type _mv_882 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_882.has_value) {
                                                __auto_type var_expr = _mv_882.value;
                                                __auto_type _mv_883 = (*var_expr);
                                                switch (_mv_883.tag) {
                                                    case types_SExpr_sym:
                                                    {
                                                        __auto_type var_sym = _mv_883.data.sym;
                                                        {
                                                            __auto_type var_name = ctype_to_c_name(arena, var_sym.name);
                                                            __auto_type _mv_884 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                            if (_mv_884.has_value) {
                                                                __auto_type start_expr = _mv_884.value;
                                                                __auto_type _mv_885 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                                if (_mv_885.has_value) {
                                                                    __auto_type end_expr = _mv_885.value;
                                                                    {
...
void stmt_transpile_for_each_map_kv(context_TranspileContext* ctx, slop_list_types_SExpr_ptr binding_items, slop_list_types_SExpr_ptr items, int64_t len) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (_mv_889.has_value) {
            __auto_type kv_list_expr = _mv_889.value;
            __auto_type _mv_890 = (*kv_list_expr);
            switch (_mv_890.tag) {
                case types_SExpr_lst:
                {
                    __auto_type kv_lst = _mv_890.data.lst;
                    {
                        __auto_type kv_items = kv_lst.items;
                        if (((int64_t)((kv_items).len)) < 2) {
                            context_ctx_add_error(ctx, SLOP_STR("Map for-each needs ((k v) map)"));
                        } else {
                            __auto_type _mv_891 = ({ __auto_type _lst = kv_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_891.has_value) {
                                __auto_type k_expr = _mv_891.value;
                                __auto_type _mv_892 = ({ __auto_type _lst = kv_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_892.has_value) {
                                    __auto_type v_expr = _mv_892.value;
                                    __auto_type _mv_893 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    if (_mv_893.has_value) {
                                        __auto_type map_expr = _mv_893.value;
                                        __auto_type _mv_894 = (*k_expr);
                                        switch (_mv_894.tag) {
                                            case types_SExpr_sym:
                                            {
                                                __auto_type k_sym = _mv_894.data.sym;
                                                __auto_type _mv_895 = (*v_expr);
                                                switch (_mv_895.tag) {
                                                    case types_SExpr_sym:
                                                    {
                                                        __auto_type v_sym = _mv_895.data.sym;
                                                        {
                ...
                __auto_type lst = _mv_897.data.lst;
                {
                    ...
                    if (len < 2) {
                        ...
                        if (_mv_898.has_value) {
                            __auto_type binding_expr = _mv_898.value;
                            __auto_type _mv_899 = (*binding_expr);
                            switch (_mv_899.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type binding_lst = _mv_899.data.lst;
                                    {
                                        __auto_type binding_items = binding_lst.items;
                                        __auto_type binding_len = ((int64_t)((binding_items).len));
                                        if (binding_len < 2) {
                                            ...
                                            if (_mv_900.has_value) {
                                                __auto_type first_elem = _mv_900.value;
                                                __auto_type _mv_901 = (*first_elem);
                                                switch (_mv_901.tag) {
                                                    case types_SExpr_lst:
                                                    {
                                                        __auto_type _ = _mv_901.data.lst;
                                                        stmt_transpile_for_each_map_kv(ctx, binding_items, items, len);
                                                        break;
                                                    }
                                                    case types_SExpr_sym:
                                                    {
                                                        __auto_type var_sym = _mv_901.data.sym;
                                                        {
                                                            __auto_type var_name = ctype_to_c_name(arena, var_sym.name);
                                                            __auto_type _mv_902 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                            if (_mv_902.has_value) {
                                                                __auto_type coll_expr = _mv_902.value;
                                                                {
                                            ...
                                            if (strlib_starts_with(ret_type, SLOP_STR("slop_option_"))) {
                                                if (((int64_t)((items).len)) < 2) {
                                                    ...
                                                    if (_mv_912.has_value) {
                                                        __auto_type inner_expr = _mv_912.value;
                                                        {
                                                            __auto_type inner_c = expr_transpile_expr(ctx, inner_expr);
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (string_eq(code, SLOP_STR("none"))) {
            ...
            if (_mv_915.has_value) {
                ...
                if (strlib_starts_with(ret_type, SLOP_STR("slop_option_"))) {
                    __auto_type _mv_916 = context_ctx_lookup_var(ctx, code);
                    if (_mv_916.has_value) {
                        __auto_type var_entry = _mv_916.value;
                        {
