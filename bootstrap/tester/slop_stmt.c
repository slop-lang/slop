            ...
            __auto_type lst = _mv_816.data.lst;
            {
                ...
                while (i < len) {
                    ...
                    if (_mv_817.has_value) {
                        __auto_type item_expr = _mv_817.value;
                        {
                                ...
                                case types_SExpr_sym:
                                {
                                    __auto_type head_sym = _mv_820.data.sym;
                                    {
                                        ...
                                        if (string_eq(op, SLOP_STR("arena-alloc"))) {
                                            ...
                                            __auto_type _mv_822 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_822.has_value) {
                                                __auto_type inner_expr = _mv_822.value;
        ...
        switch (_mv_823.tag) {
            case types_SExpr_sym:
            {
                __auto_type sym = _mv_823.data.sym;
                {
                    ...
                    __auto_type _mv_824 = context_ctx_lookup_type(ctx, type_name);
                    if (_mv_824.has_value) {
                        __auto_type entry = _mv_824.value;
                ...
                __auto_type lst = _mv_831.data.lst;
                {
                    ...
                    if (len < 2) {
                        ...
                        if (_mv_832.has_value) {
                            __auto_type bindings_expr = _mv_832.value;
                            __auto_type _mv_833 = (*bindings_expr);
                            switch (_mv_833.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type bindings_lst = _mv_833.data.lst;
                        ...
                        }
                        {
                            __auto_type i = 2;
                            while (i < len) {
                                __auto_type _mv_834 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void stmt_transpile_bindings(context_TranspileContext* ctx, slop_list_types_SExpr_ptr bindings) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_835 = ({ __auto_type _lst = bindings; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_835.has_value) {
                __auto_type binding_expr = _mv_835.value;
...
void stmt_transpile_single_binding(context_TranspileContext* ctx, types_SExpr* binding) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_836 = (*binding);
        switch (_mv_836.tag) {
            case types_SExpr_lst:
            {
                __auto_type binding_lst = _mv_836.data.lst;
                {
                    ...
                    __auto_type len = ((int64_t)((items).len));
                    {
                        ...
                        if ((len - start_idx) < 2) {
                            ...
                            __auto_type _mv_837 = ({ __auto_type _lst = items; size_t _idx = (size_t)start_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_837.has_value) {
                                __auto_type name_expr = _mv_837.value;
                                __auto_type _mv_838 = (*name_expr);
                                switch (_mv_838.tag) {
                                    case types_SExpr_sym:
                                    {
                                        __auto_type name_sym = _mv_838.data.sym;
                                        {
                                            __auto_type raw_name = name_sym.name;
                                            __auto_type var_name = ctype_to_c_name(arena, raw_name);
                                            if ((len - start_idx) >= 3) {
                                                __auto_type _mv_839 = ({ __auto_type _lst = items; size_t _idx = (size_t)(start_idx + 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_839.has_value) {
                                                    __auto_type type_expr = _mv_839.value;
                                                    __auto_type _mv_840 = ({ __auto_type _lst = items; size_t _idx = (size_t)(start_idx + 2); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_840.has_value) {
                                                        __auto_type init_expr = _mv_840.value;
                                                        {
                                                            __auto_type c_type = context_to_c_type_prefixed(ctx, type_expr);
                                                            {
                                                ...
                                                __auto_type _mv_841 = ({ __auto_type _lst = items; size_t _idx = (size_t)(start_idx + 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_841.has_value) {
                                                    __auto_type init_expr = _mv_841.value;
                                                    {
                                                        ...
                                                        __auto_type _mv_842 = ptr_type_opt;
                                                        if (_mv_842.has_value) {
                                                            __auto_type ptr_type = _mv_842.value;
...
uint8_t stmt_binding_has_mut(slop_list_types_SExpr_ptr items) {
    if (((int64_t)((items).len)) < 1) {
        ...
        if (_mv_843.has_value) {
            __auto_type first = _mv_843.value;
            __auto_type _mv_844 = (*first);
            switch (_mv_844.tag) {
                case types_SExpr_sym:
                {
        ...
        switch (_mv_845.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_845.data.lst;
                {
                    __auto_type items = lst.items;
                    if (((int64_t)((items).len)) >= 2) {
                        __auto_type _mv_846 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_846.has_value) {
                            __auto_type head_expr = _mv_846.value;
                            __auto_type _mv_847 = (*head_expr);
                            switch (_mv_847.tag) {
                                case types_SExpr_sym:
                                {
    ...
    switch (_mv_849.tag) {
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_849.data.lst;
            {
                __auto_type items = lst.items;
                if (((int64_t)((items).len)) == 1) {
                    __auto_type _mv_850 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    ...
                    if (_mv_853.has_value) {
                        __auto_type cond_expr = _mv_853.value;
                        {
                            ...
                            if (_mv_854.has_value) {
                                __auto_type then_expr = _mv_854.value;
                            ...
                            if (len >= 4) {
                                ...
                                if (_mv_855.has_value) {
                                    __auto_type else_expr = _mv_855.value;
            ...
            __auto_type lst = _mv_859.data.lst;
            {
                ...
                if (len < 3) {
                    ...
                    if (_mv_860.has_value) {
                        __auto_type cond_expr = _mv_860.value;
                        {
                            __auto_type cond_c = context_ctx_strip_cond_parens(ctx, expr_transpile_expr(ctx, cond_expr));
                            ...
                            if (_mv_864.has_value) {
                                __auto_type value_expr = _mv_864.value;
                                {
                                    ...
                                    if (_mv_865.has_value) {
                                        ...
                                        {
                                            __auto_type some_val_opt = stmt_get_some_value(value_expr);
                                            __auto_type _mv_867 = some_val_opt;
                                            if (_mv_867.has_value) {
                                                __auto_type inner_expr = _mv_867.value;
                                                {
...
slop_option_string stmt_get_var_c_type(context_TranspileContext* ctx, types_SExpr* expr) {
    ...
    switch (_mv_869.tag) {
        case types_SExpr_sym:
        {
            ...
            {
                __auto_type name = sym.name;
                __auto_type _mv_870 = context_ctx_lookup_var(ctx, name);
                if (_mv_870.has_value) {
                    __auto_type var_entry = _mv_870.value;
...
uint8_t stmt_is_pointer_target(context_TranspileContext* ctx, types_SExpr* expr) {
    ...
    switch (_mv_871.tag) {
        case types_SExpr_sym:
        {
            ...
            {
                __auto_type name = sym.name;
                __auto_type _mv_872 = context_ctx_lookup_var(ctx, name);
                if (_mv_872.has_value) {
                    __auto_type var_entry = _mv_872.value;
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (_mv_876.has_value) {
            ...
            if (_mv_877.has_value) {
                __auto_type field_expr = _mv_877.value;
                __auto_type _mv_878 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_878.has_value) {
                    __auto_type type_expr = _mv_878.value;
                    __auto_type _mv_879 = ({ __auto_type _lst = items; size_t _idx = (size_t)4; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_879.has_value) {
                        __auto_type value_expr = _mv_879.value;
                        {
                            __auto_type field_name = stmt_get_symbol_name(arena, field_expr);
                            __auto_type c_type = ctype_to_c_type(arena, type_expr);
                            {
                                ...
                                if (context_ctx_is_option_c_type(ctx, c_type)) {
                                    if (stmt_is_none_form(value_expr)) {
                                        ...
                                        __auto_type _mv_880 = stmt_get_some_value(value_expr);
                                        if (_mv_880.has_value) {
                                            __auto_type inner_val = _mv_880.value;
                                            {
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_884.data.lst;
            {
                ...
                if (_mv_885.has_value) {
                    __auto_type inner = _mv_885.value;
                    return inner;
                ...
                if (len < 2) {
                ...
                } else {
                    {
                        ...
                        if (is_named && (len < 4)) {
                            ...
                            context_ctx_indent(ctx);
                            context_ctx_push_scope(ctx);
                            __auto_type _mv_890 = ({ __auto_type _lst = items; size_t _idx = (size_t)size_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_890.has_value) {
                                __auto_type size_expr = _mv_890.value;
                                {
            ...
            __auto_type lst = _mv_892.data.lst;
            {
                ...
                while (i < len) {
                    ...
                    if (_mv_893.has_value) {
                        __auto_type clause_expr = _mv_893.value;
                        __auto_type _mv_894 = (*clause_expr);
                        switch (_mv_894.tag) {
                            case types_SExpr_lst:
                            {
                                __auto_type clause_lst = _mv_894.data.lst;
                                {
                                    ...
                                    if (clause_len < 1) {
                                        ...
                                        __auto_type _mv_895 = ({ __auto_type _lst = clause_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_895.has_value) {
                                            __auto_type test_expr = _mv_895.value;
                                            __auto_type _mv_896 = (*test_expr);
                                            switch (_mv_896.tag) {
                                                case types_SExpr_sym:
                                                {
                ...
                __auto_type lst = _mv_898.data.lst;
                {
                    ...
                    if (len < 2) {
                        ...
                        if (_mv_899.has_value) {
                            __auto_type binding_expr = _mv_899.value;
                            __auto_type _mv_900 = (*binding_expr);
                            switch (_mv_900.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type binding_lst = _mv_900.data.lst;
                                    {
                                        ...
                                        if (binding_len < 3) {
                                            ...
                                            if (_mv_901.has_value) {
                                                __auto_type var_expr = _mv_901.value;
                                                __auto_type _mv_902 = (*var_expr);
                                                switch (_mv_902.tag) {
                                                    case types_SExpr_sym:
                                                    {
                                                        __auto_type var_sym = _mv_902.data.sym;
                                                        {
                                                            __auto_type var_name = ctype_to_c_name(arena, var_sym.name);
                                                            __auto_type _mv_903 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                            if (_mv_903.has_value) {
                                                                __auto_type start_expr = _mv_903.value;
                                                                __auto_type _mv_904 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                                if (_mv_904.has_value) {
                                                                    __auto_type end_expr = _mv_904.value;
                                                                    {
...
void stmt_transpile_for_each_map_kv(context_TranspileContext* ctx, slop_list_types_SExpr_ptr binding_items, slop_list_types_SExpr_ptr items, int64_t len) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_908 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        if (_mv_908.has_value) {
            __auto_type kv_list_expr = _mv_908.value;
            __auto_type _mv_909 = (*kv_list_expr);
            switch (_mv_909.tag) {
                case types_SExpr_lst:
                {
                    __auto_type kv_lst = _mv_909.data.lst;
                    {
                        __auto_type kv_items = kv_lst.items;
                        if (((int64_t)((kv_items).len)) < 2) {
                            context_ctx_add_error(ctx, SLOP_STR("Map for-each needs ((k v) map)"));
                        } else {
                            __auto_type _mv_910 = ({ __auto_type _lst = kv_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_910.has_value) {
                                __auto_type k_expr = _mv_910.value;
                                __auto_type _mv_911 = ({ __auto_type _lst = kv_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_911.has_value) {
                                    __auto_type v_expr = _mv_911.value;
                                    ...
                                    if (_mv_912.has_value) {
                                        __auto_type map_expr = _mv_912.value;
                                        __auto_type _mv_913 = (*k_expr);
                                        switch (_mv_913.tag) {
                                            case types_SExpr_sym:
                                            {
                                                __auto_type k_sym = _mv_913.data.sym;
                                                __auto_type _mv_914 = (*v_expr);
                                                switch (_mv_914.tag) {
                                                    case types_SExpr_sym:
                                                    {
                                                        __auto_type v_sym = _mv_914.data.sym;
                                                        {
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_916.data.lst;
                {
                    ...
                    if (len < 2) {
                        ...
                        __auto_type _mv_917 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_917.has_value) {
                            __auto_type binding_expr = _mv_917.value;
                            __auto_type _mv_918 = (*binding_expr);
                            switch (_mv_918.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type binding_lst = _mv_918.data.lst;
                                    {
                                        __auto_type binding_items = binding_lst.items;
                                        __auto_type binding_len = ((int64_t)((binding_items).len));
                                        if (binding_len < 2) {
                                            ...
                                            if (_mv_919.has_value) {
                                                __auto_type first_elem = _mv_919.value;
                                                __auto_type _mv_920 = (*first_elem);
                                                switch (_mv_920.tag) {
                                                    case types_SExpr_lst:
                                                    {
                                                        __auto_type _ = _mv_920.data.lst;
                                                        stmt_transpile_for_each_map_kv(ctx, binding_items, items, len);
                                                        break;
                                                    }
                                                    case types_SExpr_sym:
                                                    {
                                                        __auto_type var_sym = _mv_920.data.sym;
                                                        {
                                                            __auto_type var_name = ctype_to_c_name(arena, var_sym.name);
                                                            ...
                                                            if (_mv_921.has_value) {
                                                                __auto_type coll_expr = _mv_921.value;
                                                                {
                                                                            ...
                                                                            }
                                                                            {
                                                                                ...
                                                                                while (i < len) {
                                                                                    ...
                                                                                    if (_mv_922.has_value) {
                                                                                        __auto_type body_expr = _mv_922.value;
                                                                                        stmt_transpile_stmt(ctx, body_expr, 0);
            ...
            __auto_type lst = _mv_923.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 1) {
                    ...
                    if (_mv_924.has_value) {
                        __auto_type head_expr = _mv_924.value;
                        __auto_type _mv_925 = (*head_expr);
                        switch (_mv_925.tag) {
                            case types_SExpr_sym:
                            {
                                    ...
                                    if (string_eq(op, SLOP_STR("let")) || string_eq(op, SLOP_STR("let*"))) {
                                        ...
                                        if (((int64_t)((items).len)) < 2) {
                                            ...
                                            if (_mv_926.has_value) {
                                                __auto_type val_expr = _mv_926.value;
                            ...
                            case types_SExpr_sym:
                            {
                                __auto_type sym = _mv_929.data.sym;
                                {
                                    ...
                                    if (string_eq(op, SLOP_STR("some"))) {
                                            ...
                                            if (context_ctx_is_option_c_type(ctx, ret_type)) {
                                                if (((int64_t)((items).len)) < 2) {
                                                    ...
                                                    if (_mv_931.has_value) {
                                                        __auto_type inner_expr = _mv_931.value;
                                                        {
                                                            __auto_type inner_c = expr_transpile_expr(ctx, inner_expr);
                                        ...
                                        __auto_type _mv_932 = context_ctx_get_current_return_type(ctx);
...
void stmt_emit_return_with_typed_none(context_TranspileContext* ctx, slop_string code) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (string_eq(code, SLOP_STR("none"))) {
            __auto_type _mv_933 = context_ctx_get_current_return_type(ctx);
            if (_mv_933.has_value) {
                __auto_type ret_type = _mv_933.value;
                if (context_ctx_is_option_c_type(ctx, ret_type)) {
            ...
            __auto_type _mv_934 = context_ctx_get_current_return_type(ctx);
            if (_mv_934.has_value) {
                __auto_type ret_type = _mv_934.value;
                if (context_ctx_is_option_c_type(ctx, ret_type)) {
                    __auto_type _mv_935 = context_ctx_lookup_var(ctx, code);
                    if (_mv_935.has_value) {
                        __auto_type var_entry = _mv_935.value;
                        {
