            ...
            __auto_type lst = _mv_813.data.lst;
            {
                ...
                while (i < len) {
                    ...
                    if (_mv_814.has_value) {
                        __auto_type item_expr = _mv_814.value;
                        {
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_815.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) >= 3) {
                        __auto_type _mv_816 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_816.has_value) {
                            __auto_type head_ptr = _mv_816.value;
                            __auto_type _mv_817 = (*head_ptr);
                            switch (_mv_817.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type head_sym = _mv_817.data.sym;
                                    {
                                        __auto_type op = head_sym.name;
                                        if (string_eq(op, SLOP_STR("arena-alloc"))) {
                                            __auto_type _mv_818 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_818.has_value) {
                                                __auto_type size_expr = _mv_818.value;
                                            ...
                                            if (_mv_819.has_value) {
                                                __auto_type inner_expr = _mv_819.value;
        ...
        switch (_mv_820.tag) {
            case types_SExpr_sym:
            {
                __auto_type sym = _mv_820.data.sym;
                {
                    ...
                    __auto_type _mv_821 = context_ctx_lookup_type(ctx, type_name);
                    if (_mv_821.has_value) {
                        __auto_type entry = _mv_821.value;
                ...
                __auto_type lst = _mv_820.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) >= 2) {
                        ...
                        if (_mv_822.has_value) {
                            __auto_type head_ptr = _mv_822.value;
                            __auto_type _mv_823 = (*head_ptr);
                            switch (_mv_823.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type head_sym = _mv_823.data.sym;
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_825.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 1) {
                    ...
                    __auto_type _mv_826 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_826.has_value) {
                        __auto_type head_expr = _mv_826.value;
                        __auto_type _mv_827 = (*head_expr);
                        switch (_mv_827.tag) {
                            case types_SExpr_sym:
                            {
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_828.data.lst;
                {
                    ...
                    if (len < 2) {
                        ...
                        __auto_type _mv_829 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_829.has_value) {
                            __auto_type bindings_expr = _mv_829.value;
                            __auto_type _mv_830 = (*bindings_expr);
                            switch (_mv_830.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type bindings_lst = _mv_830.data.lst;
                        ...
                        }
                        {
                            __auto_type i = 2;
                            while (i < len) {
                                __auto_type _mv_831 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_831.has_value) {
                                    __auto_type body_expr = _mv_831.value;
                                    {
...
void stmt_transpile_bindings(context_TranspileContext* ctx, slop_list_types_SExpr_ptr bindings) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_832 = ({ __auto_type _lst = bindings; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_832.has_value) {
                __auto_type binding_expr = _mv_832.value;
...
void stmt_transpile_single_binding(context_TranspileContext* ctx, types_SExpr* binding) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_833 = (*binding);
        switch (_mv_833.tag) {
            case types_SExpr_lst:
            {
                __auto_type binding_lst = _mv_833.data.lst;
                {
                    ...
                    __auto_type len = ((int64_t)((items).len));
                    {
                        ...
                        if ((len - start_idx) < 2) {
                            ...
                            __auto_type _mv_834 = ({ __auto_type _lst = items; size_t _idx = (size_t)start_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                ...
                                switch (_mv_835.tag) {
                                    case types_SExpr_sym:
                                    {
                                        __auto_type name_sym = _mv_835.data.sym;
                                        {
                                            ...
                                            if ((len - start_idx) >= 3) {
                                                __auto_type _mv_836 = ({ __auto_type _lst = items; size_t _idx = (size_t)(start_idx + 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_836.has_value) {
                                                    __auto_type type_expr = _mv_836.value;
                                                    __auto_type _mv_837 = ({ __auto_type _lst = items; size_t _idx = (size_t)(start_idx + 2); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_837.has_value) {
                                                        __auto_type init_expr = _mv_837.value;
                                                        {
                                                            __auto_type c_type = context_to_c_type_prefixed(ctx, type_expr);
                                                            {
                                                ...
                                                __auto_type _mv_838 = ({ __auto_type _lst = items; size_t _idx = (size_t)(start_idx + 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_838.has_value) {
                                                    __auto_type init_expr = _mv_838.value;
                                                    {
                                                        ...
                                                        __auto_type _mv_839 = ptr_type_opt;
                                                        if (_mv_839.has_value) {
                                                            __auto_type ptr_type = _mv_839.value;
...
uint8_t stmt_binding_has_mut(slop_list_types_SExpr_ptr items) {
    if (((int64_t)((items).len)) < 1) {
        ...
        __auto_type _mv_840 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        if (_mv_840.has_value) {
            __auto_type first = _mv_840.value;
            __auto_type _mv_841 = (*first);
            switch (_mv_841.tag) {
                case types_SExpr_sym:
                {
                ...
                __auto_type lst = _mv_842.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) >= 2) {
                        ...
                        if (_mv_843.has_value) {
                            __auto_type head_expr = _mv_843.value;
                            __auto_type _mv_844 = (*head_expr);
                            switch (_mv_844.tag) {
                                case types_SExpr_sym:
                                {
    ...
    switch (_mv_846.tag) {
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_846.data.lst;
            {
                __auto_type items = lst.items;
                if (((int64_t)((items).len)) == 1) {
                    __auto_type _mv_847 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_847.has_value) {
                        __auto_type head = _mv_847.value;
                        __auto_type _mv_848 = (*head);
                        switch (_mv_848.tag) {
                            case types_SExpr_sym:
                            {
                ...
                if (len < 3) {
                    ...
                    if (_mv_850.has_value) {
                        __auto_type cond_expr = _mv_850.value;
                        {
                            ...
                            context_ctx_indent(ctx);
                            __auto_type _mv_851 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_851.has_value) {
                                __auto_type then_expr = _mv_851.value;
                            ...
                            if (len >= 4) {
                                ...
                                context_ctx_indent(ctx);
                                __auto_type _mv_852 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_852.has_value) {
                                    __auto_type else_expr = _mv_852.value;
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_853.data.lst;
            {
                ...
                if (len < 3) {
                    ...
                    __auto_type _mv_854 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_854.has_value) {
                        __auto_type cond_expr = _mv_854.value;
                        {
                            __auto_type cond_c = context_ctx_strip_cond_parens(ctx, expr_transpile_expr(ctx, cond_expr));
                            context_ctx_emit(ctx, context_ctx_str3(ctx, SLOP_STR("if ("), cond_c, SLOP_STR(") {")));
                            context_ctx_indent(ctx);
            ...
            __auto_type lst = _mv_856.data.lst;
            {
                ...
                if (len < 3) {
                    ...
                    if (_mv_857.has_value) {
                        __auto_type cond_expr = _mv_857.value;
                        {
                            __auto_type cond_c = context_ctx_strip_cond_parens(ctx, expr_transpile_expr(ctx, cond_expr));
                            ...
                            if (_mv_861.has_value) {
                                __auto_type value_expr = _mv_861.value;
                                {
                                    ...
                                    if (_mv_862.has_value) {
                                        ...
                                        {
                                            __auto_type some_val_opt = stmt_get_some_value(value_expr);
                                            __auto_type _mv_864 = some_val_opt;
                                            if (_mv_864.has_value) {
                                                __auto_type inner_expr = _mv_864.value;
                                                {
...
slop_option_string stmt_get_var_c_type(context_TranspileContext* ctx, types_SExpr* expr) {
    ...
    switch (_mv_866.tag) {
        case types_SExpr_sym:
        {
            ...
            {
                __auto_type name = sym.name;
                __auto_type _mv_867 = context_ctx_lookup_var(ctx, name);
                if (_mv_867.has_value) {
                    __auto_type var_entry = _mv_867.value;
...
uint8_t stmt_is_pointer_target(context_TranspileContext* ctx, types_SExpr* expr) {
    ...
    switch (_mv_868.tag) {
        case types_SExpr_sym:
        {
            ...
            {
                __auto_type name = sym.name;
                __auto_type _mv_869 = context_ctx_lookup_var(ctx, name);
                if (_mv_869.has_value) {
                    __auto_type var_entry = _mv_869.value;
...
void stmt_transpile_field_set(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (_mv_870.has_value) {
            __auto_type target_expr = _mv_870.value;
            __auto_type _mv_871 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_871.has_value) {
                __auto_type field_expr = _mv_871.value;
                __auto_type _mv_872 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void stmt_transpile_typed_field_set(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (_mv_873.has_value) {
            __auto_type target_expr = _mv_873.value;
            __auto_type _mv_874 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_874.has_value) {
                __auto_type field_expr = _mv_874.value;
                __auto_type _mv_875 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_875.has_value) {
                    __auto_type type_expr = _mv_875.value;
                    __auto_type _mv_876 = ({ __auto_type _lst = items; size_t _idx = (size_t)4; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_876.has_value) {
                        __auto_type value_expr = _mv_876.value;
                        {
                            __auto_type field_name = stmt_get_symbol_name(arena, field_expr);
                            __auto_type c_type = ctype_to_c_type(arena, type_expr);
                            {
                                ...
                                if (context_ctx_is_option_c_type(ctx, c_type)) {
                                    if (stmt_is_none_form(value_expr)) {
                                        ...
                                        __auto_type _mv_877 = stmt_get_some_value(value_expr);
                                        if (_mv_877.has_value) {
                                            __auto_type inner_val = _mv_877.value;
                                            {
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_878.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 1) {
                    ...
                    __auto_type _mv_879 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_879.has_value) {
                        __auto_type head = _mv_879.value;
                        __auto_type _mv_880 = (*head);
                        switch (_mv_880.tag) {
                            case types_SExpr_sym:
                            {
...
types_SExpr* stmt_get_deref_inner(types_SExpr* expr) {
    ...
    switch (_mv_881.tag) {
        case types_SExpr_lst:
        {
            ...
            {
                __auto_type items = lst.items;
                __auto_type _mv_882 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_882.has_value) {
                    __auto_type inner = _mv_882.value;
                    return inner;
            ...
            __auto_type lst = _mv_884.data.lst;
            {
                ...
                while (i < len) {
                    ...
                    if (_mv_885.has_value) {
                        __auto_type body_expr = _mv_885.value;
                        {
                            __auto_type is_last = (i == (len - 1));
                            stmt_transpile_stmt(ctx, body_expr, (is_return && is_last));
                        }
                ...
                if (len < 2) {
                ...
                } else {
                    {
                        ...
                        if (is_named && (len < 4)) {
                            ...
                            context_ctx_indent(ctx);
                            context_ctx_push_scope(ctx);
                            __auto_type _mv_887 = ({ __auto_type _lst = items; size_t _idx = (size_t)size_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_887.has_value) {
                                __auto_type size_expr = _mv_887.value;
                                {
                            ...
                            context_ctx_bind_var(ctx, (context_VarEntry){arena_name, c_arena_name, SLOP_STR("slop_arena*"), SLOP_STR(""), 1, 0, 0, SLOP_STR(""), SLOP_STR("")});
                            {
                                ...
                                while (i < len) {
                                    __auto_type _mv_888 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    if (_mv_888.has_value) {
                                        __auto_type body_expr = _mv_888.value;
                                        {
                                            __auto_type is_last = (i == (len - 1));
                                            stmt_transpile_stmt(ctx, body_expr, (is_return && is_last));
                                        }
            ...
            __auto_type lst = _mv_889.data.lst;
            {
                ...
                while (i < len) {
                    ...
                    if (_mv_890.has_value) {
                        __auto_type clause_expr = _mv_890.value;
                        __auto_type _mv_891 = (*clause_expr);
                        switch (_mv_891.tag) {
                            case types_SExpr_lst:
                            {
                                __auto_type clause_lst = _mv_891.data.lst;
                                {
                                    ...
                                    if (clause_len < 1) {
                                        ...
                                        __auto_type _mv_892 = ({ __auto_type _lst = clause_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_892.has_value) {
                                            __auto_type test_expr = _mv_892.value;
                                            __auto_type _mv_893 = (*test_expr);
                                            switch (_mv_893.tag) {
                                                case types_SExpr_sym:
                                                {
...
void stmt_transpile_cond_body(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items, int64_t start, uint8_t is_return) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = start;
        while (i < len) {
            __auto_type _mv_894 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_894.has_value) {
                __auto_type body_expr = _mv_894.value;
                {
                    __auto_type is_last = (i == (len - 1));
                    stmt_transpile_stmt(ctx, body_expr, (is_return && is_last));
                }
                ...
                __auto_type lst = _mv_895.data.lst;
                {
                    ...
                    if (len < 2) {
                        ...
                        if (_mv_896.has_value) {
                            __auto_type binding_expr = _mv_896.value;
                            __auto_type _mv_897 = (*binding_expr);
                            switch (_mv_897.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type binding_lst = _mv_897.data.lst;
                                    {
                                        ...
                                        if (binding_len < 3) {
                                            ...
                                            __auto_type _mv_898 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_898.has_value) {
                                                __auto_type var_expr = _mv_898.value;
                                                __auto_type _mv_899 = (*var_expr);
                                                switch (_mv_899.tag) {
                                                    case types_SExpr_sym:
                                                    {
                                                        __auto_type var_sym = _mv_899.data.sym;
                                                        {
                                                            __auto_type var_name = ctype_to_c_name(arena, var_sym.name);
                                                            __auto_type _mv_900 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                            if (_mv_900.has_value) {
                                                                __auto_type start_expr = _mv_900.value;
                                                                __auto_type _mv_901 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                                if (_mv_901.has_value) {
                                                                    __auto_type end_expr = _mv_901.value;
                                                                    {
                                                                        ...
                                                                        context_ctx_bind_var(ctx, (context_VarEntry){var_sym.name, var_name, SLOP_STR("int64_t"), SLOP_STR(""), 0, 0, 0, SLOP_STR(""), SLOP_STR("")});
                                                                        {
                                                                            __auto_type i = 2;
                                                                            while (i < len) {
                                                                                __auto_type _mv_902 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                                                if (_mv_902.has_value) {
                                                                                    __auto_type body_expr = _mv_902.value;
                                                                                    stmt_transpile_stmt(ctx, body_expr, 0);
...
void stmt_transpile_for_each_set(context_TranspileContext* ctx, slop_string var_name, types_SExprSymbol var_sym, slop_string coll_c, slop_string resolved_type, slop_list_types_SExpr_ptr items, int64_t len) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        context_ctx_bind_var(ctx, (context_VarEntry){var_sym.name, var_name, elem_c_type, elem_slop_type, 0, 0, 0, SLOP_STR(""), SLOP_STR("")});
        {
            int64_t i = 2;
            while (i < len) {
                __auto_type _mv_903 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_903.has_value) {
                    __auto_type body_expr = _mv_903.value;
                    stmt_transpile_stmt(ctx, body_expr, 0);
...
void stmt_transpile_for_each_map_kv(context_TranspileContext* ctx, slop_list_types_SExpr_ptr binding_items, slop_list_types_SExpr_ptr items, int64_t len) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_905 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        if (_mv_905.has_value) {
            __auto_type kv_list_expr = _mv_905.value;
            __auto_type _mv_906 = (*kv_list_expr);
            switch (_mv_906.tag) {
                case types_SExpr_lst:
                {
                    __auto_type kv_lst = _mv_906.data.lst;
                    {
                        __auto_type kv_items = kv_lst.items;
                        if (((int64_t)((kv_items).len)) < 2) {
                            context_ctx_add_error(ctx, SLOP_STR("Map for-each needs ((k v) map)"));
                        } else {
                            __auto_type _mv_907 = ({ __auto_type _lst = kv_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_907.has_value) {
                                __auto_type k_expr = _mv_907.value;
                                __auto_type _mv_908 = ({ __auto_type _lst = kv_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_908.has_value) {
                                    __auto_type v_expr = _mv_908.value;
                                    __auto_type _mv_909 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    if (_mv_909.has_value) {
                                        __auto_type map_expr = _mv_909.value;
                                        __auto_type _mv_910 = (*k_expr);
                                        switch (_mv_910.tag) {
                                            case types_SExpr_sym:
                                            {
                                                __auto_type k_sym = _mv_910.data.sym;
                                                __auto_type _mv_911 = (*v_expr);
                                                switch (_mv_911.tag) {
                                                    case types_SExpr_sym:
                                                    {
                                                        __auto_type v_sym = _mv_911.data.sym;
                                                        {
                                                            ...
                                                            context_ctx_bind_var(ctx, (context_VarEntry){v_sym.name, v_name, val_c_type, val_slop_type, 0, 0, 0, SLOP_STR(""), SLOP_STR("")});
                                                            {
                                                                __auto_type i = 2;
                                                                while (i < len) {
                                                                    __auto_type _mv_912 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                                    if (_mv_912.has_value) {
                                                                        __auto_type body_expr = _mv_912.value;
                                                                        stmt_transpile_stmt(ctx, body_expr, 0);
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_913.data.lst;
                {
                    ...
                    if (len < 2) {
                        ...
                        __auto_type _mv_914 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_914.has_value) {
                            __auto_type binding_expr = _mv_914.value;
                            __auto_type _mv_915 = (*binding_expr);
                            switch (_mv_915.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type binding_lst = _mv_915.data.lst;
                                    {
                                        __auto_type binding_items = binding_lst.items;
                                        __auto_type binding_len = ((int64_t)((binding_items).len));
                                        if (binding_len < 2) {
                                            ...
                                            __auto_type _mv_916 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_916.has_value) {
                                                __auto_type first_elem = _mv_916.value;
                                                __auto_type _mv_917 = (*first_elem);
                                                switch (_mv_917.tag) {
                                                    case types_SExpr_lst:
                                                    {
                                                    ...
                                                    case types_SExpr_sym:
                                                    {
                                                        __auto_type var_sym = _mv_917.data.sym;
                                                        {
                                                            __auto_type var_name = ctype_to_c_name(arena, var_sym.name);
                                                            __auto_type _mv_918 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                            if (_mv_918.has_value) {
                                                                __auto_type coll_expr = _mv_918.value;
                                                                {
            ...
            __auto_type lst = _mv_920.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 1) {
                    ...
                    if (_mv_921.has_value) {
                        __auto_type head_expr = _mv_921.value;
                        __auto_type _mv_922 = (*head_expr);
                        switch (_mv_922.tag) {
                            case types_SExpr_sym:
                            {
                                    ...
                                    if (string_eq(op, SLOP_STR("let")) || string_eq(op, SLOP_STR("let*"))) {
                                        ...
                                        if (((int64_t)((items).len)) < 2) {
                                            ...
                                            if (_mv_923.has_value) {
                                                __auto_type val_expr = _mv_923.value;
                            ...
                            case types_SExpr_sym:
                            {
                                __auto_type sym = _mv_926.data.sym;
                                {
                                    ...
                                    if (string_eq(op, SLOP_STR("some"))) {
                                            ...
                                            if (context_ctx_is_option_c_type(ctx, ret_type)) {
                                                if (((int64_t)((items).len)) < 2) {
                                                    ...
                                                    if (_mv_928.has_value) {
                                                        __auto_type inner_expr = _mv_928.value;
                                                        {
                                                            __auto_type inner_c = expr_transpile_expr(ctx, inner_expr);
                                        ...
                                        __auto_type _mv_929 = context_ctx_get_current_return_type(ctx);
...
void stmt_emit_return_with_typed_none(context_TranspileContext* ctx, slop_string code) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (string_eq(code, SLOP_STR("none"))) {
            __auto_type _mv_930 = context_ctx_get_current_return_type(ctx);
            if (_mv_930.has_value) {
                __auto_type ret_type = _mv_930.value;
                if (context_ctx_is_option_c_type(ctx, ret_type)) {
            ...
            __auto_type _mv_931 = context_ctx_get_current_return_type(ctx);
            if (_mv_931.has_value) {
                __auto_type ret_type = _mv_931.value;
                if (context_ctx_is_option_c_type(ctx, ret_type)) {
                    __auto_type _mv_932 = context_ctx_lookup_var(ctx, code);
                    if (_mv_932.has_value) {
                        __auto_type var_entry = _mv_932.value;
                        {
