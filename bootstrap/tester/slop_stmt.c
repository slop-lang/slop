            ...
            __auto_type lst = _mv_827.data.lst;
            {
                ...
                while (i < len) {
                    ...
                    if (_mv_828.has_value) {
                        __auto_type item_expr = _mv_828.value;
                        {
                                    ...
                                    __auto_type head_sym = _mv_831.data.sym;
                                    {
                                        ...
                                        if (string_eq(op, SLOP_STR("arena-alloc"))) {
                                            ...
                                            if (_mv_832.has_value) {
                                                __auto_type size_expr = _mv_832.value;
                                            ...
                                            if (_mv_833.has_value) {
                                                __auto_type inner_expr = _mv_833.value;
        ...
        switch (_mv_834.tag) {
            case types_SExpr_sym:
            {
                __auto_type sym = _mv_834.data.sym;
                {
                    ...
                    __auto_type _mv_835 = context_ctx_lookup_type(ctx, type_name);
                    if (_mv_835.has_value) {
                        __auto_type entry = _mv_835.value;
                ...
                __auto_type lst = _mv_834.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) >= 2) {
                        ...
                        if (_mv_836.has_value) {
                            __auto_type head_ptr = _mv_836.value;
                            __auto_type _mv_837 = (*head_ptr);
                            switch (_mv_837.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type head_sym = _mv_837.data.sym;
                                    if (string_eq(head_sym.name, SLOP_STR("sizeof"))) {
                                        ...
                                        if (_mv_838.has_value) {
                                            __auto_type type_expr = _mv_838.value;
                                            {
            ...
            __auto_type lst = _mv_839.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 1) {
                    ...
                    if (_mv_840.has_value) {
                        __auto_type head_expr = _mv_840.value;
                        __auto_type _mv_841 = (*head_expr);
                        switch (_mv_841.tag) {
                            case types_SExpr_sym:
                            {
                ...
                __auto_type lst = _mv_842.data.lst;
                {
                    ...
                    if (len < 2) {
                        ...
                        if (_mv_843.has_value) {
                            __auto_type bindings_expr = _mv_843.value;
                            __auto_type _mv_844 = (*bindings_expr);
                            switch (_mv_844.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type bindings_lst = _mv_844.data.lst;
...
void stmt_transpile_bindings(context_TranspileContext* ctx, slop_list_types_SExpr_ptr bindings) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_846 = ({ __auto_type _lst = bindings; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                ...
                __auto_type binding_lst = _mv_847.data.lst;
                {
                    ...
                    __auto_type len = ((int64_t)((items).len));
                    {
                        ...
                        if ((len - start_idx) < 2) {
                            ...
                            __auto_type _mv_848 = ({ __auto_type _lst = items; size_t _idx = (size_t)start_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_848.has_value) {
                                __auto_type name_expr = _mv_848.value;
                                __auto_type _mv_849 = (*name_expr);
                                switch (_mv_849.tag) {
                                    case types_SExpr_sym:
                                    {
                                        __auto_type name_sym = _mv_849.data.sym;
                                        {
                                            ...
                                            if ((len - start_idx) >= 3) {
                                                ...
                                                if (_mv_850.has_value) {
                                                    __auto_type type_expr = _mv_850.value;
                                                    __auto_type _mv_851 = ({ __auto_type _lst = items; size_t _idx = (size_t)(start_idx + 2); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_851.has_value) {
                                                        __auto_type init_expr = _mv_851.value;
                                                        {
                                                            __auto_type c_type = context_to_c_type_prefixed(ctx, type_expr);
                                                            {
                                                ...
                                                if (_mv_852.has_value) {
                                                    __auto_type init_expr = _mv_852.value;
                                                    {
                                                        ...
                                                        __auto_type _mv_853 = ptr_type_opt;
                                                        if (_mv_853.has_value) {
                                                            __auto_type ptr_type = _mv_853.value;
...
uint8_t stmt_binding_has_mut(slop_list_types_SExpr_ptr items) {
    if (((int64_t)((items).len)) < 1) {
        ...
        __auto_type _mv_854 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        if (_mv_854.has_value) {
            __auto_type first = _mv_854.value;
            __auto_type _mv_855 = (*first);
            switch (_mv_855.tag) {
                case types_SExpr_sym:
                {
        ...
        switch (_mv_856.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_856.data.lst;
                {
                    __auto_type items = lst.items;
                    if (((int64_t)((items).len)) >= 2) {
                        __auto_type _mv_857 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_857.has_value) {
                            __auto_type head_expr = _mv_857.value;
                            __auto_type _mv_858 = (*head_expr);
                            switch (_mv_858.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type sym = _mv_858.data.sym;
                                    if (string_eq(sym.name, SLOP_STR("some"))) {
                                        __auto_type _mv_859 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_859.has_value) {
                                            __auto_type val = _mv_859.value;
                ...
                if (len < 3) {
                    ...
                    if (_mv_864.has_value) {
                        __auto_type cond_expr = _mv_864.value;
                        {
                            ...
                            context_ctx_indent(ctx);
                            __auto_type _mv_865 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_865.has_value) {
                                __auto_type then_expr = _mv_865.value;
                            ...
                            if (len >= 4) {
                                ...
                                context_ctx_indent(ctx);
                                __auto_type _mv_866 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_866.has_value) {
                                    __auto_type else_expr = _mv_866.value;
            ...
            __auto_type lst = _mv_867.data.lst;
            {
                ...
                if (len < 3) {
                    ...
                    if (_mv_868.has_value) {
                        __auto_type cond_expr = _mv_868.value;
                        {
                            __auto_type cond_c = context_ctx_strip_cond_parens(ctx, expr_transpile_expr(ctx, cond_expr));
                            context_ctx_emit(ctx, context_ctx_str3(ctx, SLOP_STR("if ("), cond_c, SLOP_STR(") {")));
                            context_ctx_indent(ctx);
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_870.data.lst;
            {
                ...
                if (len < 3) {
                    ...
                    __auto_type _mv_871 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_871.has_value) {
                        __auto_type cond_expr = _mv_871.value;
                        {
                            __auto_type cond_c = context_ctx_strip_cond_parens(ctx, expr_transpile_expr(ctx, cond_expr));
                ...
                __auto_type lst = _mv_873.data.lst;
                {
                    ...
                    if (expr_set_is_self_assign(items)) {
                        ...
                        if (_mv_874.has_value) {
                            __auto_type target_expr = _mv_874.value;
                            __auto_type _mv_875 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_875.has_value) {
                                __auto_type value_expr = _mv_875.value;
                                {
                                    __auto_type target_c = expr_transpile_expr(ctx, target_expr);
                                    __auto_type target_type_opt = stmt_get_var_c_type(ctx, target_expr);
                                    __auto_type _mv_876 = target_type_opt;
                                    if (_mv_876.has_value) {
                                        __auto_type target_type = _mv_876.value;
                                        if (context_ctx_is_option_c_type(ctx, target_type)) {
                                            {
                                                __auto_type some_val_opt = stmt_get_some_value(value_expr);
                                                __auto_type _mv_877 = some_val_opt;
                                                if (_mv_877.has_value) {
                                                    __auto_type val_expr = _mv_877.value;
                                                    {
                                        ...
                                        {
                                            __auto_type some_val_opt = stmt_get_some_value(value_expr);
                                            __auto_type _mv_878 = some_val_opt;
                                            if (_mv_878.has_value) {
                                                __auto_type inner_expr = _mv_878.value;
                                                {
...
void stmt_transpile_field_set(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (_mv_884.has_value) {
            __auto_type target_expr = _mv_884.value;
            __auto_type _mv_885 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_885.has_value) {
                __auto_type field_expr = _mv_885.value;
                __auto_type _mv_886 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_886.has_value) {
                    __auto_type value_expr = _mv_886.value;
                    {
...
void stmt_transpile_typed_field_set(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (_mv_887.has_value) {
            __auto_type target_expr = _mv_887.value;
            __auto_type _mv_888 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_888.has_value) {
                __auto_type field_expr = _mv_888.value;
                __auto_type _mv_889 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_889.has_value) {
                    __auto_type type_expr = _mv_889.value;
                    __auto_type _mv_890 = ({ __auto_type _lst = items; size_t _idx = (size_t)4; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            ...
                            __auto_type c_type = ctype_to_c_type(arena, type_expr);
                            {
                                ...
                                if (context_ctx_is_option_c_type(ctx, c_type)) {
                                    if (stmt_is_none_form(value_expr)) {
                                        ...
                                        __auto_type _mv_891 = stmt_get_some_value(value_expr);
                                        if (_mv_891.has_value) {
                                            __auto_type inner_val = _mv_891.value;
                                            {
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_895.data.lst;
            {
                ...
                if (_mv_896.has_value) {
                    __auto_type inner = _mv_896.value;
                    return inner;
                ...
                if (len < 2) {
                ...
                } else {
                    {
                        ...
                        if (is_named && (len < 4)) {
                            ...
                            context_ctx_indent(ctx);
                            context_ctx_push_scope(ctx);
                            __auto_type _mv_901 = ({ __auto_type _lst = items; size_t _idx = (size_t)size_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            ...
            __auto_type lst = _mv_903.data.lst;
            {
                ...
                while (i < len) {
                    ...
                    if (_mv_904.has_value) {
                        __auto_type clause_expr = _mv_904.value;
                        __auto_type _mv_905 = (*clause_expr);
                        switch (_mv_905.tag) {
                            case types_SExpr_lst:
                            {
                                __auto_type clause_lst = _mv_905.data.lst;
                                {
                                    ...
                                    if (clause_len < 1) {
                                        ...
                                        __auto_type _mv_906 = ({ __auto_type _lst = clause_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_906.has_value) {
                                            __auto_type test_expr = _mv_906.value;
                                            __auto_type _mv_907 = (*test_expr);
                                            switch (_mv_907.tag) {
                                                case types_SExpr_sym:
                                                {
                                    ...
                                    __auto_type binding_lst = _mv_911.data.lst;
                                    {
                                        ...
                                        if (binding_len < 3) {
                                            ...
                                            if (_mv_912.has_value) {
                                                __auto_type var_expr = _mv_912.value;
                                                __auto_type _mv_913 = (*var_expr);
                                                switch (_mv_913.tag) {
                                                    case types_SExpr_sym:
                                                    {
                                                        __auto_type var_sym = _mv_913.data.sym;
                                                        {
                                                            ...
                                                            if (_mv_914.has_value) {
                                                                __auto_type start_expr = _mv_914.value;
                                                                __auto_type _mv_915 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                                if (_mv_915.has_value) {
                                                                    __auto_type end_expr = _mv_915.value;
                                                                    {
...
void stmt_transpile_for_each_map_kv(context_TranspileContext* ctx, slop_list_types_SExpr_ptr binding_items, slop_list_types_SExpr_ptr items, int64_t len) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_919 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        if (_mv_919.has_value) {
            __auto_type kv_list_expr = _mv_919.value;
            __auto_type _mv_920 = (*kv_list_expr);
            switch (_mv_920.tag) {
                case types_SExpr_lst:
                {
                    __auto_type kv_lst = _mv_920.data.lst;
                    {
                        __auto_type kv_items = kv_lst.items;
                        if (((int64_t)((kv_items).len)) < 2) {
                            context_ctx_add_error(ctx, SLOP_STR("Map for-each needs ((k v) map)"));
                        } else {
                            __auto_type _mv_921 = ({ __auto_type _lst = kv_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_921.has_value) {
                                __auto_type k_expr = _mv_921.value;
                                __auto_type _mv_922 = ({ __auto_type _lst = kv_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_922.has_value) {
                                    __auto_type v_expr = _mv_922.value;
                                    __auto_type _mv_923 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    if (_mv_923.has_value) {
                                        __auto_type map_expr = _mv_923.value;
                                        __auto_type _mv_924 = (*k_expr);
                                        switch (_mv_924.tag) {
                                            case types_SExpr_sym:
                                            {
                                                __auto_type k_sym = _mv_924.data.sym;
                                                __auto_type _mv_925 = (*v_expr);
                                                switch (_mv_925.tag) {
                                                    case types_SExpr_sym:
                                                    {
                                                        __auto_type v_sym = _mv_925.data.sym;
                                                        {
                                                            ...
                                                            context_ctx_bind_var(ctx, (context_VarEntry){v_sym.name, v_name, val_c_type, val_slop_type, 0, 0, 0, SLOP_STR(""), SLOP_STR("")});
                                                            {
                                                                __auto_type i = 2;
                                                                while (i < len) {
                                                                    __auto_type _mv_926 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                                    if (_mv_926.has_value) {
                                                                        __auto_type body_expr = _mv_926.value;
                                                                        stmt_transpile_stmt(ctx, body_expr, 0);
                ...
                __auto_type lst = _mv_927.data.lst;
                {
                    ...
                    if (len < 2) {
                        ...
                        if (_mv_928.has_value) {
                            __auto_type binding_expr = _mv_928.value;
                            __auto_type _mv_929 = (*binding_expr);
                            switch (_mv_929.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type binding_lst = _mv_929.data.lst;
                                    {
                                        __auto_type binding_items = binding_lst.items;
                                        __auto_type binding_len = ((int64_t)((binding_items).len));
                                        if (binding_len < 2) {
                                            ...
                                            __auto_type _mv_930 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_930.has_value) {
                                                __auto_type first_elem = _mv_930.value;
                                                __auto_type _mv_931 = (*first_elem);
                                                switch (_mv_931.tag) {
                                                    case types_SExpr_lst:
                                                    {
                                                    ...
                                                    case types_SExpr_sym:
                                                    {
                                                        __auto_type var_sym = _mv_931.data.sym;
                                                        {
                                                            __auto_type var_name = ctype_to_c_name(arena, var_sym.name);
                                                            __auto_type _mv_932 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                            if (_mv_932.has_value) {
                                                                __auto_type coll_expr = _mv_932.value;
                                                                {
            ...
            __auto_type lst = _mv_934.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 1) {
                    ...
                    if (_mv_935.has_value) {
                        __auto_type head_expr = _mv_935.value;
                        __auto_type _mv_936 = (*head_expr);
                        switch (_mv_936.tag) {
                            case types_SExpr_sym:
                            {
                                    ...
                                    if (string_eq(op, SLOP_STR("let")) || string_eq(op, SLOP_STR("let*"))) {
                                        ...
                                        if (((int64_t)((items).len)) < 2) {
                                            ...
                                            if (_mv_937.has_value) {
                                                __auto_type val_expr = _mv_937.value;
                                            ...
                                            if (context_ctx_is_option_c_type(ctx, ret_type)) {
                                                if (((int64_t)((items).len)) < 2) {
                                                    ...
                                                    if (_mv_942.has_value) {
                                                        __auto_type inner_expr = _mv_942.value;
                                                        {
                                                            __auto_type inner_c = expr_transpile_expr(ctx, inner_expr);
...
void stmt_emit_return_with_typed_none(context_TranspileContext* ctx, slop_string code) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (string_eq(code, SLOP_STR("none"))) {
            __auto_type _mv_944 = context_ctx_get_current_return_type(ctx);
            if (_mv_944.has_value) {
                __auto_type ret_type = _mv_944.value;
                if (context_ctx_is_option_c_type(ctx, ret_type)) {
            ...
            if (_mv_945.has_value) {
                ...
                if (context_ctx_is_option_c_type(ctx, ret_type)) {
                    __auto_type _mv_946 = context_ctx_lookup_var(ctx, code);
                    if (_mv_946.has_value) {
                        __auto_type var_entry = _mv_946.value;
                        {
