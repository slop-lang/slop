            ...
            __auto_type lst = _mv_803.data.lst;
            {
                ...
                while (i < len) {
                    ...
                    if (_mv_804.has_value) {
                        __auto_type item_expr = _mv_804.value;
                        {
                                ...
                                case types_SExpr_sym:
                                {
                                    __auto_type head_sym = _mv_807.data.sym;
                                    {
                                        ...
                                        if (string_eq(op, SLOP_STR("arena-alloc"))) {
                                            __auto_type _mv_808 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_808.has_value) {
                                                __auto_type size_expr = _mv_808.value;
                                            ...
                                            __auto_type _mv_809 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        switch (_mv_810.tag) {
            case types_SExpr_sym:
            {
                __auto_type sym = _mv_810.data.sym;
                {
                    ...
                    __auto_type _mv_811 = context_ctx_lookup_type(ctx, type_name);
                    if (_mv_811.has_value) {
                        __auto_type entry = _mv_811.value;
                                ...
                                case types_SExpr_sym:
                                {
                                    ...
                                    if (string_eq(head_sym.name, SLOP_STR("sizeof"))) {
                                        ...
                                        if (_mv_814.has_value) {
                                            __auto_type type_expr = _mv_814.value;
                                            {
                ...
                __auto_type lst = _mv_818.data.lst;
                {
                    ...
                    if (len < 2) {
                        ...
                        if (_mv_819.has_value) {
                            __auto_type bindings_expr = _mv_819.value;
                            __auto_type _mv_820 = (*bindings_expr);
                            switch (_mv_820.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type bindings_lst = _mv_820.data.lst;
                        ...
                        }
                        {
                            ...
                            while (i < len) {
                                ...
                                if (_mv_821.has_value) {
                                    __auto_type body_expr = _mv_821.value;
                                    {
...
void stmt_transpile_bindings(context_TranspileContext* ctx, slop_list_types_SExpr_ptr bindings) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_822 = ({ __auto_type _lst = bindings; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_822.has_value) {
                __auto_type binding_expr = _mv_822.value;
...
void stmt_transpile_single_binding(context_TranspileContext* ctx, types_SExpr* binding) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_823 = (*binding);
        switch (_mv_823.tag) {
            case types_SExpr_lst:
            {
                __auto_type binding_lst = _mv_823.data.lst;
                {
                    ...
                    __auto_type len = ((int64_t)((items).len));
                    {
                        ...
                        if ((len - start_idx) < 2) {
                            ...
                            __auto_type _mv_824 = ({ __auto_type _lst = items; size_t _idx = (size_t)start_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_824.has_value) {
                                __auto_type name_expr = _mv_824.value;
                                __auto_type _mv_825 = (*name_expr);
                                switch (_mv_825.tag) {
                                    case types_SExpr_sym:
                                    {
                                        __auto_type name_sym = _mv_825.data.sym;
                                        {
                                            ...
                                            if ((len - start_idx) >= 3) {
                                                ...
                                                if (_mv_826.has_value) {
                                                    __auto_type type_expr = _mv_826.value;
                                                    __auto_type _mv_827 = ({ __auto_type _lst = items; size_t _idx = (size_t)(start_idx + 2); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_827.has_value) {
                                                        __auto_type init_expr = _mv_827.value;
                                                        {
                                                            __auto_type c_type = context_to_c_type_prefixed(ctx, type_expr);
                                                            {
                                                ...
                                                __auto_type _mv_828 = ({ __auto_type _lst = items; size_t _idx = (size_t)(start_idx + 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_828.has_value) {
                                                    __auto_type init_expr = _mv_828.value;
                                                    {
                                                        ...
                                                        __auto_type _mv_829 = ptr_type_opt;
                                                        if (_mv_829.has_value) {
                                                            __auto_type ptr_type = _mv_829.value;
...
uint8_t stmt_binding_has_mut(slop_list_types_SExpr_ptr items) {
    if (((int64_t)((items).len)) < 1) {
        ...
        if (_mv_830.has_value) {
            __auto_type first = _mv_830.value;
            __auto_type _mv_831 = (*first);
            switch (_mv_831.tag) {
                case types_SExpr_sym:
                {
        ...
        switch (_mv_832.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_832.data.lst;
                {
                    __auto_type items = lst.items;
                    if (((int64_t)((items).len)) >= 2) {
                        __auto_type _mv_833 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_833.has_value) {
                            __auto_type head_expr = _mv_833.value;
                            __auto_type _mv_834 = (*head_expr);
                            switch (_mv_834.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type sym = _mv_834.data.sym;
                                    if (string_eq(sym.name, SLOP_STR("some"))) {
                                        __auto_type _mv_835 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_835.has_value) {
                                            __auto_type val = _mv_835.value;
    ...
    switch (_mv_836.tag) {
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_836.data.lst;
            {
                __auto_type items = lst.items;
                if (((int64_t)((items).len)) == 1) {
                    __auto_type _mv_837 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_837.has_value) {
                        __auto_type head = _mv_837.value;
                        __auto_type _mv_838 = (*head);
                        switch (_mv_838.tag) {
                            case types_SExpr_sym:
                            {
                    ...
                    if (_mv_840.has_value) {
                        __auto_type cond_expr = _mv_840.value;
                        {
                            ...
                            if (_mv_841.has_value) {
                                __auto_type then_expr = _mv_841.value;
                            ...
                            if (len >= 4) {
                                ...
                                context_ctx_indent(ctx);
                                __auto_type _mv_842 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_842.has_value) {
                                    __auto_type else_expr = _mv_842.value;
            ...
            __auto_type lst = _mv_846.data.lst;
            {
                ...
                if (len < 3) {
                    ...
                    if (_mv_847.has_value) {
                        __auto_type cond_expr = _mv_847.value;
                        {
                            __auto_type cond_c = context_ctx_strip_cond_parens(ctx, expr_transpile_expr(ctx, cond_expr));
                            ...
                            if (_mv_851.has_value) {
                                __auto_type value_expr = _mv_851.value;
                                {
                                    ...
                                    if (_mv_852.has_value) {
                                        ...
                                        {
                                            __auto_type some_val_opt = stmt_get_some_value(value_expr);
                                            __auto_type _mv_854 = some_val_opt;
                                            if (_mv_854.has_value) {
                                                __auto_type inner_expr = _mv_854.value;
                                                {
                                                ...
                                                if (stmt_is_none_form(value_expr)) {
                                                    __auto_type _mv_855 = context_ctx_get_current_return_type(ctx);
                                                    if (_mv_855.has_value) {
                                                        __auto_type ret_type = _mv_855.value;
...
uint8_t stmt_is_pointer_target(context_TranspileContext* ctx, types_SExpr* expr) {
    ...
    switch (_mv_858.tag) {
        case types_SExpr_sym:
        {
            ...
            {
                __auto_type name = sym.name;
                __auto_type _mv_859 = context_ctx_lookup_var(ctx, name);
                if (_mv_859.has_value) {
                    __auto_type var_entry = _mv_859.value;
        ...
        if (_mv_860.has_value) {
            ...
            if (_mv_861.has_value) {
                ...
                if (_mv_862.has_value) {
                    __auto_type value_expr = _mv_862.value;
                    {
...
void stmt_transpile_typed_field_set(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_863 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        if (_mv_863.has_value) {
            __auto_type target_expr = _mv_863.value;
            __auto_type _mv_864 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_864.has_value) {
                __auto_type field_expr = _mv_864.value;
                __auto_type _mv_865 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_865.has_value) {
                    __auto_type type_expr = _mv_865.value;
                    __auto_type _mv_866 = ({ __auto_type _lst = items; size_t _idx = (size_t)4; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_866.has_value) {
                        __auto_type value_expr = _mv_866.value;
                        {
                            __auto_type field_name = stmt_get_symbol_name(arena, field_expr);
                            __auto_type c_type = ctype_to_c_type(arena, type_expr);
                            {
                                ...
                                if (strlib_starts_with(c_type, SLOP_STR("slop_option_"))) {
                                    if (stmt_is_none_form(value_expr)) {
                                        ...
                                        __auto_type _mv_867 = stmt_get_some_value(value_expr);
                                        if (_mv_867.has_value) {
                                            __auto_type inner_val = _mv_867.value;
                                            {
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_871.data.lst;
            {
                ...
                if (_mv_872.has_value) {
                    __auto_type inner = _mv_872.value;
                    return inner;
                ...
                if (len < 2) {
                ...
                } else {
                    {
                        ...
                        if (is_named && (len < 4)) {
                            ...
                            context_ctx_indent(ctx);
                            context_ctx_push_scope(ctx);
                            __auto_type _mv_877 = ({ __auto_type _lst = items; size_t _idx = (size_t)size_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_877.has_value) {
                                __auto_type size_expr = _mv_877.value;
                                {
                            ...
                            context_ctx_bind_var(ctx, (context_VarEntry){arena_name, c_arena_name, SLOP_STR("slop_arena*"), SLOP_STR(""), 1, 0, 0, SLOP_STR(""), SLOP_STR("")});
                            {
                                ...
                                while (i < len) {
                                    ...
                                    if (_mv_878.has_value) {
                                        __auto_type body_expr = _mv_878.value;
                                        {
                                            __auto_type is_last = (i == (len - 1));
                                            stmt_transpile_stmt(ctx, body_expr, (is_return && is_last));
                                        }
            ...
            __auto_type lst = _mv_879.data.lst;
            {
                ...
                while (i < len) {
                    ...
                    if (_mv_880.has_value) {
                        __auto_type clause_expr = _mv_880.value;
                        __auto_type _mv_881 = (*clause_expr);
                        switch (_mv_881.tag) {
                            case types_SExpr_lst:
                            {
                                __auto_type clause_lst = _mv_881.data.lst;
                                {
                                    ...
                                    if (clause_len < 1) {
                                        ...
                                        __auto_type _mv_882 = ({ __auto_type _lst = clause_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_882.has_value) {
                                            __auto_type test_expr = _mv_882.value;
                                            __auto_type _mv_883 = (*test_expr);
                                            switch (_mv_883.tag) {
                                                case types_SExpr_sym:
                                                {
                                    ...
                                    __auto_type binding_lst = _mv_887.data.lst;
                                    {
                                        ...
                                        if (binding_len < 3) {
                                            ...
                                            if (_mv_888.has_value) {
                                                __auto_type var_expr = _mv_888.value;
                                                __auto_type _mv_889 = (*var_expr);
                                                switch (_mv_889.tag) {
                                                    case types_SExpr_sym:
                                                    {
                                                        __auto_type var_sym = _mv_889.data.sym;
                                                        {
                                                            ...
                                                            if (_mv_890.has_value) {
                                                                __auto_type start_expr = _mv_890.value;
                                                                __auto_type _mv_891 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                                if (_mv_891.has_value) {
                                                                    __auto_type end_expr = _mv_891.value;
                                                                    {
...
void stmt_transpile_for_each_map_kv(context_TranspileContext* ctx, slop_list_types_SExpr_ptr binding_items, slop_list_types_SExpr_ptr items, int64_t len) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_895 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        if (_mv_895.has_value) {
            __auto_type kv_list_expr = _mv_895.value;
            __auto_type _mv_896 = (*kv_list_expr);
            switch (_mv_896.tag) {
                case types_SExpr_lst:
                {
                    __auto_type kv_lst = _mv_896.data.lst;
                    {
                        __auto_type kv_items = kv_lst.items;
                        if (((int64_t)((kv_items).len)) < 2) {
                            context_ctx_add_error(ctx, SLOP_STR("Map for-each needs ((k v) map)"));
                        } else {
                            __auto_type _mv_897 = ({ __auto_type _lst = kv_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_897.has_value) {
                                __auto_type k_expr = _mv_897.value;
                                __auto_type _mv_898 = ({ __auto_type _lst = kv_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_898.has_value) {
                                    __auto_type v_expr = _mv_898.value;
                                    __auto_type _mv_899 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    if (_mv_899.has_value) {
                                        __auto_type map_expr = _mv_899.value;
                                        __auto_type _mv_900 = (*k_expr);
                                        switch (_mv_900.tag) {
                                            case types_SExpr_sym:
                                            {
                                                __auto_type k_sym = _mv_900.data.sym;
                                                __auto_type _mv_901 = (*v_expr);
                                                switch (_mv_901.tag) {
                                                    case types_SExpr_sym:
                                                    {
                                                        __auto_type v_sym = _mv_901.data.sym;
                                                        {
                                    ...
                                    __auto_type binding_lst = _mv_905.data.lst;
                                    {
                                        ...
                                        if (binding_len < 2) {
                                            ...
                                            if (_mv_906.has_value) {
                                                __auto_type first_elem = _mv_906.value;
                                                __auto_type _mv_907 = (*first_elem);
                                                switch (_mv_907.tag) {
                                                    case types_SExpr_lst:
                                                    {
                                                        __auto_type _ = _mv_907.data.lst;
                                                    ...
                                                    case types_SExpr_sym:
                                                    {
                                                        __auto_type var_sym = _mv_907.data.sym;
                                                        {
                                                            ...
                                                            if (_mv_908.has_value) {
                                                                __auto_type coll_expr = _mv_908.value;
                                                                {
                                                                    ...
                                                                    if (expr_is_set_type(resolved_type)) {
                                                                    ...
                                                                    } else {
                                                                        {
                                                                            ...
                                                                            }
                                                                            {
                                                                                __auto_type i = 2;
                                                                                while (i < len) {
                                                                                    __auto_type _mv_909 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                                                    if (_mv_909.has_value) {
                                                                                        __auto_type body_expr = _mv_909.value;
                                                                                        stmt_transpile_stmt(ctx, body_expr, 0);
            ...
            __auto_type lst = _mv_910.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 1) {
                    ...
                    if (_mv_911.has_value) {
                        __auto_type head_expr = _mv_911.value;
                        __auto_type _mv_912 = (*head_expr);
                        switch (_mv_912.tag) {
                            case types_SExpr_sym:
                            {
                                __auto_type sym = _mv_912.data.sym;
                                {
                                    ...
                                    if (string_eq(op, SLOP_STR("let")) || string_eq(op, SLOP_STR("let*"))) {
                                        ...
                                        if (((int64_t)((items).len)) < 2) {
                                            ...
                                            __auto_type _mv_913 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_913.has_value) {
                                                __auto_type val_expr = _mv_913.value;
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_914.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 1) {
                    ...
                    __auto_type _mv_915 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            ...
                                            if (strlib_starts_with(ret_type, SLOP_STR("slop_option_"))) {
                                                if (((int64_t)((items).len)) < 2) {
                                                    ...
                                                    if (_mv_918.has_value) {
                                                        __auto_type inner_expr = _mv_918.value;
                                                        {
                                                            __auto_type inner_c = expr_transpile_expr(ctx, inner_expr);
...
void stmt_emit_return_with_typed_none(context_TranspileContext* ctx, slop_string code) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (string_eq(code, SLOP_STR("none"))) {
            __auto_type _mv_920 = context_ctx_get_current_return_type(ctx);
            if (_mv_920.has_value) {
                __auto_type ret_type = _mv_920.value;
                if (strlib_starts_with(ret_type, SLOP_STR("slop_option_"))) {
            ...
            __auto_type _mv_921 = context_ctx_get_current_return_type(ctx);
            if (_mv_921.has_value) {
                __auto_type ret_type = _mv_921.value;
                if (strlib_starts_with(ret_type, SLOP_STR("slop_option_"))) {
                    __auto_type _mv_922 = context_ctx_lookup_var(ctx, code);
                    if (_mv_922.has_value) {
                        __auto_type var_entry = _mv_922.value;
                        {
