                            ...
                            if (expr_is_binop(op) && (len < 3)) {
                                ...
                                if (_mv_283.has_value) {
                                    ...
                                    if (_mv_284.has_value) {
                                        __auto_type idx_expr = _mv_284.value;
                                        __auto_type _mv_285 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                ...
                                __auto_type _mv_286 = context_ctx_get_current_return_type(ctx);
                                if (_mv_286.has_value) {
                                    __auto_type ret_type = _mv_286.value;
                    ...
                    default: {
                        {
                            ...
                            __auto_type i = 1;
                            while (i < len) {
                                __auto_type _mv_287 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        if (string_eq(fn_name, SLOP_STR("println"))) {
            ...
            if (len < 3) {
                ...
                if (_mv_290.has_value) {
                    __auto_type a_expr = _mv_290.value;
                    ...
                    if (_mv_291.has_value) {
                        __auto_type b_expr = _mv_291.value;
                        {
            ...
            if (len < 3) {
                ...
                if (_mv_292.has_value) {
                    __auto_type a_expr = _mv_292.value;
                    ...
                    if (_mv_293.has_value) {
                        __auto_type b_expr = _mv_293.value;
                        {
                            __auto_type a_c = expr_transpile_expr(ctx, a_expr);
                            __auto_type b_c = expr_transpile_expr(ctx, b_expr);
                            __auto_type s1 = string_concat(arena, SLOP_STR("(("), a_c);
            ...
            if (len < 3) {
                ...
                if (_mv_294.has_value) {
                    __auto_type fn_expr = _mv_294.value;
            ...
            if (len < 4) {
                ...
                if (_mv_295.has_value) {
                    ...
                    if (_mv_296.has_value) {
                        ...
                        __auto_type _mv_297 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_297.has_value) {
                            __auto_type cap_expr = _mv_297.value;
                            {
            ...
            if (len < 3) {
                ...
                if (_mv_298.has_value) {
                    ...
                    if (_mv_299.has_value) {
                        __auto_type arena_expr = _mv_299.value;
                        {
                            __auto_type elem_c = context_to_c_type_prefixed(ctx, type_expr);
                            __auto_type elem_id = ctype_type_to_identifier(arena, elem_c);
                            __auto_type chan_type = context_ctx_str(ctx, SLOP_STR("slop_chan_"), elem_id);
            ...
            if (len < 3) {
                ...
                if (_mv_300.has_value) {
                    __auto_type chan_expr = _mv_300.value;
            ...
            if (len < 2) {
                ...
                if (_mv_302.has_value) {
                    __auto_type chan_expr = _mv_302.value;
                    {
                        __auto_type chan_c = expr_transpile_expr(ctx, chan_expr);
                        __auto_type chan_c_type = expr_infer_expr_c_type(ctx, chan_expr);
                        {
        ...
        } else {
            {
                ...
                if (string_len(builtin_c_name) > 0) {
                    ...
                    __auto_type _mv_303 = context_ctx_lookup_type(ctx, fn_name);
                    if (_mv_303.has_value) {
                        __auto_type type_entry = _mv_303.value;
                        ...
                        __auto_type _mv_305 = context_ctx_lookup_enum_variant(ctx, fn_name);
                        if (_mv_305.has_value) {
                            __auto_type type_name = _mv_305.value;
                            {
                                ...
                                if (len > 2) {
                                    {
                                        ...
                                        __auto_type vi = 1;
                                        while (vi < len) {
                                            __auto_type _mv_306 = ({ __auto_type _lst = items; size_t _idx = (size_t)vi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_306.has_value) {
                                                __auto_type v = _mv_306.value;
                                                {
                                    ...
                                    if (_mv_307.has_value) {
                                        __auto_type value_expr = _mv_307.value;
                                        {
                                            __auto_type value_c = expr_transpile_expr(ctx, value_expr);
                        ...
                        } else if (!_mv_305.has_value) {
                            {
                                ...
                                if (!_mv_308.has_value) {
                                    ...
                                    __auto_type func_entry = _mv_308.value;
                                    while (i < len) {
    ...
    SLOP_PRE(((arg != NULL)), "(!= arg nil)");
    {
        ...
        switch (_mv_311.tag) {
            ...
            default: {
                {
                    __auto_type arg_c = expr_transpile_expr(ctx, arg);
                    __auto_type _mv_312 = expr_get_expr_type_hint(ctx, arg);
                    if (_mv_312.has_value) {
                        __auto_type type_hint = _mv_312.value;
...
slop_option_string expr_get_expr_type_hint(context_TranspileContext* ctx, types_SExpr* expr) {
    ...
    SLOP_PRE(((expr != NULL)), "(!= expr nil)");
    {
        ...
        if (string_eq(slop_type, SLOP_STR("String"))) {
            ...
            __auto_type _mv_315 = (*expr);
            switch (_mv_315.tag) {
                case types_SExpr_sym:
                {
                    __auto_type sym = _mv_315.data.sym;
                    __auto_type _mv_316 = context_ctx_lookup_var(ctx, sym.name);
                    if (_mv_316.has_value) {
                        __auto_type entry = _mv_316.value;
                        {
                ...
                case types_SExpr_lst:
                {
                    __auto_type lst = _mv_315.data.lst;
                    {
                        __auto_type items = lst.items;
                        if (((int64_t)((items).len)) >= 1) {
                            __auto_type _mv_317 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_317.has_value) {
                                ...
                                switch (_mv_318.tag) {
                                    case types_SExpr_sym:
                                    {
                                        __auto_type head_sym = _mv_318.data.sym;
                                        {
                                            __auto_type op = head_sym.name;
                                            if (string_eq(op, SLOP_STR(".")) && (((int64_t)((items).len)) >= 3)) {
                                                {
                                                    ...
                                                    if (string_eq(c_type, SLOP_STR("slop_string"))) {
                                                        ...
                                                        if (_mv_319.has_value) {
                                                            __auto_type obj_expr = _mv_319.value;
                                                            __auto_type _mv_320 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                            if (_mv_320.has_value) {
                                                                __auto_type field_expr = _mv_320.value;
                                                                __auto_type _mv_321 = (*field_expr);
                                                                switch (_mv_321.tag) {
                                                                    case types_SExpr_sym:
                                                                    {
                                                                        __auto_type field_sym = _mv_321.data.sym;
                                                                        {
                                                                            __auto_type field_name = field_sym.name;
                                                                            __auto_type obj_slop_type = expr_infer_expr_slop_type(ctx, obj_expr);
                                                                            if (string_len(obj_slop_type) > 0) {
                                                                                __auto_type _mv_322 = context_ctx_lookup_field_slop_type(ctx, obj_slop_type, field_name);
                                                                                if (_mv_322.has_value) {
                                                                                    __auto_type fst = _mv_322.value;
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 2) {
            ...
            if (_mv_324.has_value) {
                __auto_type tag_expr = _mv_324.value;
                __auto_type _mv_325 = (*tag_expr);
                switch (_mv_325.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type tag_list = _mv_325.data.lst;
                        {
                            __auto_type tag_items = tag_list.items;
                            if (((int64_t)((tag_items).len)) < 1) {
                                return context_ctx_str3(ctx, SLOP_STR("(("), c_type_name, SLOP_STR("){})"));
                            } else {
                                __auto_type _mv_326 = ({ __auto_type _lst = tag_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_326.has_value) {
                                    __auto_type tag_name_expr = _mv_326.value;
                                    __auto_type _mv_327 = (*tag_name_expr);
                                    switch (_mv_327.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type tag_sym = _mv_327.data.sym;
                                            {
                                                ...
                                                if (num_tag_items >= 3) {
                                                    {
                                                        ...
                                                        for (int64_t fi = 1; fi < num_tag_items; fi++) {
                                                            __auto_type _mv_328 = ({ __auto_type _lst = tag_items; size_t _idx = (size_t)fi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                            if (_mv_328.has_value) {
                                                                __auto_type value_expr = _mv_328.value;
                                                                {
                                                                    __auto_type value_c = expr_transpile_expr(ctx, value_expr);
                                                    ...
                                                    __auto_type _mv_329 = ({ __auto_type _lst = tag_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_329.has_value) {
                                                        __auto_type value_expr = _mv_329.value;
                                                        {
                                                            __auto_type value_c = expr_transpile_expr(ctx, value_expr);
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_330.has_value) {
                __auto_type clause_expr = _mv_330.value;
                __auto_type _mv_331 = (*clause_expr);
                switch (_mv_331.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type clause_lst = _mv_331.data.lst;
                        {
                            __auto_type clause_items = clause_lst.items;
                            __auto_type clause_len = ((int64_t)((clause_items).len));
                            if (clause_len >= 2) {
                                __auto_type _mv_332 = ({ __auto_type _lst = clause_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_332.has_value) {
                                    __auto_type test_expr = _mv_332.value;
                                    __auto_type _mv_333 = (*test_expr);
                                    switch (_mv_333.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type sym = _mv_333.data.sym;
                                            if (string_eq(sym.name, SLOP_STR("else"))) {
                                                __auto_type _mv_334 = ({ __auto_type _lst = clause_items; size_t _idx = (size_t)(clause_len - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            ...
                                            } else {
                                                {
                                                    ...
                                                    __auto_type _mv_335 = ({ __auto_type _lst = clause_items; size_t _idx = (size_t)(clause_len - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 3) {
            ...
            if (_mv_337.has_value) {
                __auto_type scrutinee = _mv_337.value;
                {
                    ...
                    case types_SExpr_lst:
                    {
                        __auto_type branch_lst = _mv_339.data.lst;
                        {
                            ...
                            if (((int64_t)((branch_items).len)) >= 1) {
                                __auto_type _mv_340 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_341.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 1) {
                    ...
                    __auto_type _mv_342 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_342.has_value) {
                        __auto_type head = _mv_342.value;
                        __auto_type _mv_343 = (*head);
                        switch (_mv_343.tag) {
                            case types_SExpr_sym:
                            {
        ...
        while ((i < len) && all_symbols) {
            ...
            if (_mv_346.has_value) {
                ...
                switch (_mv_347.tag) {
                    case types_SExpr_sym:
                    {
                        __auto_type s = _mv_347.data.sym;
                        {
                            __auto_type name = s.name;
                            if (!(string_eq(name, SLOP_STR("else"))) && !(string_eq(name, SLOP_STR("_")))) {
                                __auto_type _mv_348 = context_ctx_lookup_enum_variant(ctx, name);
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while ((i < len) && !(has_union_variant)) {
            ...
            if (_mv_349.has_value) {
                __auto_type pat_expr = _mv_349.value;
                {
                    ...
                    if ((!(string_eq(tag, SLOP_STR("")))) && (!(string_eq(tag, SLOP_STR("some")))) && (!(string_eq(tag, SLOP_STR("none")))) && (!(string_eq(tag, SLOP_STR("ok")))) && (!(string_eq(tag, SLOP_STR("error")))) && (!(string_eq(tag, SLOP_STR("else")))) && (!(string_eq(tag, SLOP_STR("_"))))) {
                        __auto_type _mv_350 = context_ctx_lookup_enum_variant(ctx, tag);
                        if (_mv_350.has_value) {
                            __auto_type _ = _mv_350.value;
                            has_union_variant = 1;
...
slop_option_string expr_get_expr_binding_name(types_SExpr* pat_expr) {
    ...
    switch (_mv_351.tag) {
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_351.data.lst;
            {
                __auto_type items = lst.items;
                if (((int64_t)((items).len)) < 2) {
                    return (slop_option_string){.has_value = false};
                    ...
                    if (_mv_352.has_value) {
                        __auto_type binding = _mv_352.value;
                        __auto_type _mv_353 = (*binding);
                        switch (_mv_353.tag) {
                            case types_SExpr_sym:
                            {
...
slop_string expr_get_match_branch_body(context_TranspileContext* ctx, slop_list_types_SExpr_ptr branch_items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 2) {
            ...
            __auto_type _mv_354 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)(len - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_string expr_build_option_match_expr(context_TranspileContext* ctx, types_SExpr* scrutinee, slop_string scrutinee_c, slop_list_types_SExpr_ptr items) {
    ...
    SLOP_PRE(((scrutinee != NULL)), "(!= scrutinee nil)");
    {
        ...
        int64_t i = 2;
        while (i < len) {
            __auto_type _mv_355 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_355.has_value) {
                __auto_type branch = _mv_355.value;
                __auto_type _mv_356 = (*branch);
                switch (_mv_356.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type branch_lst = _mv_356.data.lst;
                        {
                            __auto_type branch_items = branch_lst.items;
                            if (((int64_t)((branch_items).len)) >= 2) {
                                __auto_type _mv_357 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_357.has_value) {
                                    __auto_type pattern = _mv_357.value;
                                    {
                                        __auto_type tag = expr_get_expr_pattern_tag(pattern);
                                        if (string_eq(tag, SLOP_STR("some"))) {
                                            __auto_type _mv_358 = expr_get_expr_binding_name(pattern);
                                            if (_mv_358.has_value) {
                                                __auto_type name = _mv_358.value;
                                                some_binding = name;
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 2) {
            ...
            if (_mv_359.has_value) {
                __auto_type first_clause = _mv_359.value;
                __auto_type _mv_360 = (*first_clause);
                switch (_mv_360.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type clause_lst = _mv_360.data.lst;
                        {
                            __auto_type clause_items = clause_lst.items;
                            __auto_type clause_len = ((int64_t)((clause_items).len));
                            if (clause_len < 2) {
                                ...
                                if (_mv_361.has_value) {
                                    __auto_type body_expr = _mv_361.value;
...
slop_string expr_infer_match_branch_body_type(context_TranspileContext* ctx, types_SExpr* branch) {
    ...
    __auto_type _mv_362 = (*branch);
    switch (_mv_362.tag) {
        case types_SExpr_lst:
        {
            __auto_type branch_lst = _mv_362.data.lst;
            {
                __auto_type branch_items = branch_lst.items;
                ...
                if (branch_len < 2) {
                    ...
                    __auto_type _mv_363 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)(branch_len - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_363.has_value) {
                        __auto_type body_expr = _mv_363.value;
                        return expr_infer_expr_c_type(ctx, body_expr);
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 3) {
            ...
            while ((i < len) && string_eq(result, SLOP_STR("__type_error__"))) {
                __auto_type _mv_364 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_string expr_slop_type_to_c_type(context_TranspileContext* ctx, slop_string slop_type) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_365 = context_ctx_lookup_type(ctx, slop_type);
        if (_mv_365.has_value) {
            __auto_type entry = _mv_365.value;
            return entry.c_name;
    ...
    SLOP_PRE(((expr != NULL)), "(!= expr nil)");
    {
        ...
        if (string_len(checker_type) > 0) {
            ...
            switch (_mv_366.tag) {
                ...
                case types_SExpr_num:
                {
                    __auto_type num = _mv_366.data.num;
                    if (num.is_float) {
                        return SLOP_STR("double");
                    } else {
                        return SLOP_STR("int64_t");
                ...
                case types_SExpr_sym:
                {
                    ...
                    {
                        __auto_type name = sym.name;
                        __auto_type _mv_367 = context_ctx_lookup_var(ctx, name);
                        if (_mv_367.has_value) {
                            __auto_type entry = _mv_367.value;
                            {
                ...
                case types_SExpr_lst:
                {
                    __auto_type lst = _mv_366.data.lst;
                    {
                        ...
                        if (((int64_t)((items).len)) < 1) {
                            ...
                            __auto_type _mv_368 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_368.has_value) {
                                __auto_type head = _mv_368.value;
                                __auto_type _mv_369 = (*head);
                                switch (_mv_369.tag) {
                                    case types_SExpr_sym:
                                    {
                                        __auto_type sym = _mv_369.data.sym;
                                        {
                                            __auto_type op = sym.name;
                                            if (({ __auto_type _mv = context_ctx_lookup_func(ctx, op); _mv.has_value ? ({ __auto_type func_entry = _mv.value; func_entry.returns_string; }) : (0); })) {
                                                ...
                                                if (((int64_t)((items).len)) < 3) {
                                                    ...
                                                    __auto_type _mv_370 = ({ __auto_type _lst = items; size_t _idx = (size_t)(((int64_t)((items).len)) - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_370.has_value) {
                                                        __auto_type body = _mv_370.value;
                                                ...
                                                if (((int64_t)((items).len)) < 2) {
                                                    ...
                                                    __auto_type _mv_371 = ({ __auto_type _lst = items; size_t _idx = (size_t)(((int64_t)((items).len)) - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_371.has_value) {
                                                        __auto_type last_expr = _mv_371.value;
                                                ...
                                                if (((int64_t)((items).len)) < 3) {
                                                    ...
                                                    __auto_type _mv_372 = ({ __auto_type _lst = items; size_t _idx = (size_t)(((int64_t)((items).len)) - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_372.has_value) {
                                                        __auto_type body = _mv_372.value;
                                                        return expr_infer_expr_c_type(ctx, body);
                                                ...
                                                if (((int64_t)((items).len)) < 3) {
                                                    ...
                                                    __auto_type _mv_373 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_373.has_value) {
                                                        __auto_type then_expr = _mv_373.value;
                                                ...
                                                if (((int64_t)((items).len)) < 2) {
                                                    ...
                                                    if (_mv_374.has_value) {
                                                        __auto_type val_expr = _mv_374.value;
                                                        {
                                                            __auto_type val_type = expr_infer_expr_c_type(ctx, val_expr);
                                                ...
                                                __auto_type _mv_375 = context_ctx_get_current_return_type(ctx);
                                                if (_mv_375.has_value) {
                                                    __auto_type ret_type = _mv_375.value;
                                                    if (strlib_starts_with(ret_type, SLOP_STR("slop_option_"))) {
                                                        return ret_type;
                                                    } else {
                                                        return SLOP_STR("slop_option_int");
                                                ...
                                                if (((int64_t)((items).len)) < 2) {
                                                    ...
                                                    if (_mv_378.has_value) {
                                                        __auto_type inner = _mv_378.value;
                                                ...
                                                if (((int64_t)((items).len)) < 2) {
                                                    ...
                                                    if (_mv_379.has_value) {
                                                        __auto_type chan_arg = _mv_379.value;
                                                        {
                                                ...
                                                if (((int64_t)((items).len)) < 3) {
                                                    ...
                                                    __auto_type _mv_382 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                ...
                                                if (((int64_t)((items).len)) < 2) {
                                                    ...
                                                    if (_mv_383.has_value) {
                                                        __auto_type list_arg = _mv_383.value;
                                                        {
                                                ...
                                                __auto_type _mv_384 = context_ctx_lookup_type(ctx, op);
                                                if (_mv_384.has_value) {
                                                    __auto_type type_entry = _mv_384.value;
                                                    return type_entry.c_name;
                                                } else if (!_mv_384.has_value) {
                                                    __auto_type _mv_385 = context_ctx_lookup_func(ctx, op);
                                ...
                                if (_mv_388.has_value) {
                                    __auto_type pattern = _mv_388.value;
                                    {
                                        ...
                                        if (string_eq(tag, SLOP_STR("ok"))) {
                                            ...
                                            __auto_type _mv_390 = expr_get_expr_binding_name(pattern);
                                            if (_mv_390.has_value) {
                                                __auto_type name = _mv_390.value;
                                                err_binding = name;
...
slop_string expr_build_enum_case_expr(context_TranspileContext* ctx, slop_arena* arena, slop_string cases, types_SExpr* pattern, slop_list_types_SExpr_ptr branch_items, slop_string result_type) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (string_eq(tag, SLOP_STR("else")) || string_eq(tag, SLOP_STR("_"))) {
            ...
            __auto_type _mv_394 = context_ctx_lookup_enum_variant(ctx, tag);
            if (_mv_394.has_value) {
                __auto_type type_name = _mv_394.value;
                {
        ...
        switch (_mv_398.tag) {
            case types_SExpr_sym:
            {
                __auto_type sym = _mv_398.data.sym;
                {
                    ...
                    __auto_type _mv_399 = context_ctx_lookup_func(ctx, slop_name);
                    if (_mv_399.has_value) {
                        __auto_type func_entry = _mv_399.value;
                        {
        ...
        if (context_ctx_skip_trampoline_generation(ctx)) {
            ...
            if (context_ctx_has_trampoline(ctx, fn_c_name)) {
            ...
            } else {
                {
                    ...
                    int64_t i = 0;
                    while (i < count) {
                        __auto_type _mv_400 = ({ __auto_type _lst = param_types; size_t _idx = (size_t)i; slop_option_context_FuncParamType_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_400.has_value) {
                            __auto_type param_type_ptr = _mv_400.value;
                            {
...
slop_string expr_build_union_case_expr(context_TranspileContext* ctx, slop_arena* arena, slop_string cases, types_SExpr* scrutinee, types_SExpr* pattern, slop_list_types_SExpr_ptr branch_items, slop_string result_type) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (string_eq(tag, SLOP_STR("else")) || string_eq(tag, SLOP_STR("_"))) {
            ...
            __auto_type _mv_401 = context_ctx_lookup_enum_variant(ctx, tag);
            if (_mv_401.has_value) {
                __auto_type type_name = _mv_401.value;
                {
                    __auto_type c_tag = ctype_to_c_name(arena, tag);
                    __auto_type case_label = context_ctx_str4(ctx, type_name, SLOP_STR("_"), c_tag, SLOP_STR(""));
                    __auto_type binding_opt = expr_get_expr_binding_name(pattern);
                    __auto_type _mv_402 = binding_opt;
                    if (_mv_402.has_value) {
                        __auto_type binding_name = _mv_402.value;
                        {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i >= 2) {
            ...
            if (_mv_403.has_value) {
                __auto_type branch = _mv_403.value;
                __auto_type _mv_404 = (*branch);
                switch (_mv_404.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type branch_lst = _mv_404.data.lst;
                        {
                            __auto_type branch_items = branch_lst.items;
                            if (((int64_t)((branch_items).len)) >= 2) {
                                __auto_type _mv_405 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_405.has_value) {
                                    __auto_type pattern = _mv_405.value;
                                    {
                                        __auto_type tag = expr_get_expr_pattern_tag(pattern);
...
uint8_t expr_discard_needs_void(types_SExpr* e) {
    __auto_type _mv_406 = (*e);
    switch (_mv_406.tag) {
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_406.data.lst;
            __auto_type _mv_407 = ({ __auto_type _lst = lst.items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_407.has_value) {
                __auto_type head = _mv_407.value;
                __auto_type _mv_408 = (*head);
                switch (_mv_408.tag) {
                    case types_SExpr_sym:
                    {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 3) {
            ...
            if (_mv_409.has_value) {
                __auto_type bindings_expr = _mv_409.value;
                __auto_type _mv_410 = (*bindings_expr);
                switch (_mv_410.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type bindings_lst = _mv_410.data.lst;
                        context_ctx_push_scope(ctx);
                        {
                            __auto_type result = SLOP_STR("({ ");
                            ...
                            while (bi < bindings_len) {
                                __auto_type _mv_411 = ({ __auto_type _lst = bindings_items; size_t _idx = (size_t)bi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_411.has_value) {
                                    __auto_type binding = _mv_411.value;
                            ...
                            bi = 0;
                            while (bi < bindings_len) {
                                __auto_type _mv_412 = ({ __auto_type _lst = bindings_items; size_t _idx = (size_t)bi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_412.has_value) {
                                    __auto_type binding = _mv_412.value;
                                    {
                            ...
                            }
                            {
                                ...
                                while (i < (len - 1)) {
                                    ...
                                    if (_mv_413.has_value) {
                                        __auto_type body_expr = _mv_413.value;
                                        {
                ...
                __auto_type lst = _mv_417.data.lst;
                {
                    ...
                    if (len < 2) {
                    ...
                    } else {
                        {
                            __auto_type has_mut = expr_binding_has_mut(items);
                            __auto_type name_idx = ((has_mut) ? 1 : 0);
                            __auto_type _mv_418 = ({ __auto_type _lst = items; size_t _idx = (size_t)name_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                ...
                                switch (_mv_419.tag) {
                                    case types_SExpr_sym:
                                    {
                                        __auto_type name_sym = _mv_419.data.sym;
                                        {
                                            ...
                                            __auto_type init_idx = ((has_mut) ? ((has_type) ? 3 : 2) : ((has_type) ? 2 : 1));
                                            if (has_type) {
                                                __auto_type _mv_420 = ({ __auto_type _lst = items; size_t _idx = (size_t)type_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_420.has_value) {
                                                    __auto_type type_expr = _mv_420.value;
                                                    {
                                                        __auto_type c_type = context_to_c_type_prefixed(ctx, type_expr);
                                                        __auto_type _mv_421 = ({ __auto_type _lst = items; size_t _idx = (size_t)init_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                        if (_mv_421.has_value) {
                                                            __auto_type init_expr = _mv_421.value;
                                                            {
                                                    ...
                                                    __auto_type _mv_422 = ({ __auto_type _lst = items; size_t _idx = (size_t)init_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_422.has_value) {
                                                        __auto_type init_expr = _mv_422.value;
                                                        {
                                                ...
                                                __auto_type _mv_423 = ({ __auto_type _lst = items; size_t _idx = (size_t)init_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_423.has_value) {
                                                    __auto_type init_expr = _mv_423.value;
                                                    {
                                                        __auto_type init_c = expr_transpile_expr(ctx, init_expr);
                                                        return context_ctx_str5(ctx, SLOP_STR("__auto_type "), var_name, SLOP_STR(" = "), init_c, SLOP_STR(";"));
                                                    }
...
uint8_t expr_binding_has_mut(slop_list_types_SExpr_ptr items) {
    if (((int64_t)((items).len)) < 1) {
        ...
        if (_mv_424.has_value) {
            __auto_type first = _mv_424.value;
            __auto_type _mv_425 = (*first);
            switch (_mv_425.tag) {
                case types_SExpr_sym:
                {
...
slop_string expr_transpile_typed_init(context_TranspileContext* ctx, types_SExpr* init_expr, slop_string target_type) {
    ...
    __auto_type _mv_426 = (*init_expr);
    switch (_mv_426.tag) {
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_426.data.lst;
            {
                __auto_type items = lst.items;
                if (((int64_t)((items).len)) < 1) {
                    return expr_transpile_expr(ctx, init_expr);
                } else {
                    __auto_type _mv_427 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_427.has_value) {
                        __auto_type head = _mv_427.value;
                        __auto_type _mv_428 = (*head);
                        switch (_mv_428.tag) {
                            case types_SExpr_sym:
                            {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len <= 1) {
        ...
        } else {
            {
                ...
                int64_t i = 1;
                while (i < len) {
                    __auto_type _mv_432 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_432.has_value) {
                        __auto_type expr = _mv_432.value;
                        {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 2) {
            ...
            if (_mv_433.has_value) {
                __auto_type cond_expr = _mv_433.value;
                {
                    __auto_type cond_c = expr_transpile_expr(ctx, cond_expr);
                    __auto_type body_c = SLOP_STR("({ ");
                    {
                        ...
                        while (i < len) {
                            ...
                            if (_mv_434.has_value) {
                                __auto_type body_expr = _mv_434.value;
    ...
    if (((int64_t)((items).len)) == 3) {
        ...
        if (_mv_435.has_value) {
            ...
            switch (_mv_436.tag) {
                case types_SExpr_sym:
                {
                    __auto_type tsym = _mv_436.data.sym;
                    ...
                    if (_mv_437.has_value) {
                        ...
                        __auto_type _mv_438 = (*value_expr);
                        switch (_mv_438.tag) {
                            case types_SExpr_sym:
                            {
                                __auto_type vsym = _mv_438.data.sym;
            ...
            if (len < 3) {
                ...
                if (_mv_439.has_value) {
                    ...
                    if (_mv_440.has_value) {
                        ...
                        {
                            __auto_type val_c = expr_transpile_expr(ctx, val_expr);
                            __auto_type _mv_441 = (*target_expr);
                            switch (_mv_441.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type target_lst = _mv_441.data.lst;
                                    {
                                        ...
                                        if (((int64_t)((target_items).len)) < 1) {
                                            ...
                                            __auto_type _mv_442 = ({ __auto_type _lst = target_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                        ...
                                                        __auto_type sym = _mv_443.data.sym;
                                                        {
                                                            ...
                                                            if (string_eq(op, SLOP_STR("@"))) {
                                                                if (((int64_t)((target_items).len)) < 3) {
                                                                    ...
                                                                    __auto_type _mv_444 = ({ __auto_type _lst = target_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                                    if (_mv_444.has_value) {
                                                                        __auto_type arr_expr = _mv_444.value;
                                                                        __auto_type _mv_445 = ({ __auto_type _lst = target_items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                                        if (_mv_445.has_value) {
                                                                            __auto_type idx_expr = _mv_445.value;
                                                                            {
                                                                                __auto_type arr_c = expr_transpile_expr(ctx, arr_expr);
                                                                                __auto_type idx_c = expr_transpile_expr(ctx, idx_expr);
...
slop_string expr_resolve_arena_c_name(context_TranspileContext* ctx, slop_string op, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    __auto_type _mv_446 = context_ctx_lookup_var(ctx, SLOP_STR("arena"));
...
slop_string expr_get_arena_for_list_push_expr(context_TranspileContext* ctx, types_SExpr* list_expr, slop_string list_c) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    SLOP_PRE(((list_expr != NULL)), "(!= list-expr nil)");
    __auto_type _mv_448 = context_ctx_lookup_var(ctx, SLOP_STR("arena"));
    if (_mv_448.has_value) {
        __auto_type arena_var = _mv_448.value;
        return arena_var.c_name;
    } else if (!_mv_448.has_value) {
        __auto_type _mv_449 = context_ctx_lookup_var(ctx, SLOP_STR("ctx"));
        if (_mv_449.has_value) {
            __auto_type ctx_var = _mv_449.value;
        ...
        } else if (!_mv_449.has_value) {
            {
                ...
                if (string_len(arena_from_field) > 0) {
                    ...
                    __auto_type _mv_450 = context_ctx_find_arena_var(ctx);
                    if (_mv_450.has_value) {
                        __auto_type arena_entry = _mv_450.value;
                            ...
                            case types_SExpr_sym:
                            {
                                ...
                                if (string_eq(sym.name, SLOP_STR("."))) {
                                    ...
                                    if (_mv_454.has_value) {
                                        __auto_type base_expr = _mv_454.value;
...
slop_string expr_get_arena_from_base(context_TranspileContext* ctx, types_SExpr* base_expr) {
    ...
    switch (_mv_455.tag) {
        case types_SExpr_sym:
        {
            ...
            {
                __auto_type var_name = sym.name;
                __auto_type _mv_456 = context_ctx_lookup_var(ctx, var_name);
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_455.data.lst;
            {
                __auto_type items = lst.items;
                if (((int64_t)((items).len)) < 2) {
                    return SLOP_STR("arena");
                            ...
                            case types_SExpr_sym:
                            {
                                ...
                                if (string_eq(sym.name, SLOP_STR("deref"))) {
                                    ...
                                    if (_mv_459.has_value) {
                                        __auto_type ptr_expr = _mv_459.value;
                                        {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 2) {
            ...
            if (_mv_462.has_value) {
                ...
                __auto_type _mv_463 = (*type_expr);
                switch (_mv_463.tag) {
                    case types_SExpr_sym:
                    {
                        __auto_type type_sym = _mv_463.data.sym;
                        {
                            __auto_type raw_type_name = type_sym.name;
                    ...
                    case types_SExpr_lst:
                    {
                        __auto_type type_lst = _mv_463.data.lst;
                        {
                            ...
                            if (((int64_t)((type_items).len)) < 1) {
                                ...
                                __auto_type _mv_464 = ({ __auto_type _lst = type_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_464.has_value) {
                                    ...
                                    switch (_mv_465.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type head_sym = _mv_465.data.sym;
...
slop_string expr_build_inline_struct_type(context_TranspileContext* ctx, slop_list_types_SExpr_ptr type_items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 1;
        while (i < len) {
            __auto_type _mv_471 = ({ __auto_type _lst = type_items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_string expr_transpile_inline_record_fields(context_TranspileContext* ctx, slop_string struct_def, slop_list_types_SExpr_ptr items, int64_t start_idx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        uint8_t first = 1;
        while (i < len) {
            __auto_type _mv_476 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    ...
                    __auto_type elem_count = (len - 2);
                    {
                        ...
                        while (i < len) {
                            ...
                            if (_mv_482.has_value) {
                                __auto_type elem_expr = _mv_482.value;
                        ...
                        }
                        {
                            ...
                            __auto_type _mv_483 = arena_var;
                            if (_mv_483.has_value) {
                                __auto_type arena_var = _mv_483.value;
                                {
                                    ...
                                    while (i < ((int64_t)((elem_codes).len))) {
                                        __auto_type _mv_484 = ({ __auto_type _lst = elem_codes; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_484.has_value) {
                                            __auto_type ec = _mv_484.value;
                                            {
                                ...
                                context_ctx_add_warning(ctx, SLOP_STR("list literal uses stack-allocated compound literal (no arena in scope)"));
                                {
                                    ...
                                    i = 0;
                                    while (i < ((int64_t)((elem_codes).len))) {
                                        __auto_type _mv_485 = ({ __auto_type _lst = elem_codes; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_485.has_value) {
                                            __auto_type ec = _mv_485.value;
                                            if (first) {
...
slop_string expr_get_map_key_c_info(context_TranspileContext* ctx, types_SExpr* key_type_expr) {
    ...
    __auto_type _mv_486 = (*key_type_expr);
    switch (_mv_486.tag) {
        case types_SExpr_sym:
        {
...
slop_string expr_get_struct_key_info_by_name(context_TranspileContext* ctx, slop_string name) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    __auto_type _mv_489 = context_ctx_lookup_type(ctx, name);
    if (_mv_489.has_value) {
        __auto_type type_entry = _mv_489.value;
        {
            __auto_type c_name = type_entry.c_name;
            context_ctx_register_struct_key_type(ctx, c_name);
            return expr_build_struct_key_info(ctx, c_name);
        ...
        __auto_type _mv_490 = context_ctx_get_module(ctx);
        if (_mv_490.has_value) {
            __auto_type mod = _mv_490.value;
            {
                __auto_type prefixed = context_ctx_str3(ctx, mod, SLOP_STR("_"), name);
                __auto_type _mv_491 = context_ctx_lookup_type(ctx, prefixed);
                if (_mv_491.has_value) {
                    __auto_type type_entry = _mv_491.value;
                    {
                        __auto_type c_name = type_entry.c_name;
                        context_ctx_register_struct_key_type(ctx, c_name);
                        return expr_build_struct_key_info(ctx, c_name);
        ...
        if (len < 3) {
            if (len < 2) {
                ...
                if (_mv_492.has_value) {
                    __auto_type arena_expr = _mv_492.value;
                    {
                        __auto_type arena_c = expr_transpile_expr(ctx, arena_expr);
            ...
            if (_mv_493.has_value) {
                ...
                if (_mv_494.has_value) {
                    __auto_type key_type_expr = _mv_494.value;
                    {
                        __auto_type arena_c = expr_transpile_expr(ctx, arena_expr);
        ...
        if (len < 4) {
            ...
            if (_mv_495.has_value) {
                ...
                if (_mv_496.has_value) {
                    ...
                    __auto_type _mv_497 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        if (len < 3) {
            ...
            if (_mv_500.has_value) {
                ...
                if (_mv_501.has_value) {
                    __auto_type key_expr = _mv_501.value;
                    {
                        __auto_type map_c = expr_resolve_container_c(ctx, map_expr);
                        __auto_type key_c = expr_transpile_expr(ctx, key_expr);
                        __auto_type key_ptr = expr_wrap_map_key_as_ptr(ctx, key_c, key_expr, map_expr);
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 3) {
            ...
            if (_mv_502.has_value) {
                __auto_type map_expr = _mv_502.value;
                ...
                if (_mv_503.has_value) {
                    __auto_type key_expr = _mv_503.value;
                    {
                        __auto_type map_c = expr_resolve_container_c(ctx, map_expr);
                        __auto_type key_c = expr_transpile_expr(ctx, key_expr);
                        __auto_type key_ptr = expr_wrap_map_key_as_ptr(ctx, key_c, key_expr, map_expr);
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 2) {
            ...
            if (_mv_504.has_value) {
                __auto_type map_expr = _mv_504.value;
                {
                    __auto_type map_c = expr_resolve_container_c(ctx, map_expr);
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 3) {
            ...
            if (_mv_505.has_value) {
                __auto_type arena_expr = _mv_505.value;
                ...
                if (_mv_506.has_value) {
                    __auto_type elem_type_expr = _mv_506.value;
                    {
                        __auto_type arena_c = expr_transpile_expr(ctx, arena_expr);
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 3) {
            ...
            if (_mv_511.has_value) {
                __auto_type set_expr = _mv_511.value;
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 2) {
            ...
            if (_mv_513.has_value) {
                __auto_type set_expr = _mv_513.value;
                {
                    __auto_type set_c = expr_resolve_container_c(ctx, set_expr);
                    ...
                    __auto_type result = context_ctx_str(ctx, context_ctx_str3(ctx, SLOP_STR("({ slop_map* _s = slop_map_new_ptr("), arena_c, SLOP_STR(", ")), context_ctx_str(ctx, int_to_string(arena, init_cap), context_ctx_str(ctx, SLOP_STR(", "), context_ctx_str(ctx, elem_info, SLOP_STR("); ")))));
                    {
                        ...
                        while (i < len) {
                            ...
                            if (_mv_515.has_value) {
                                __auto_type elem_expr = _mv_515.value;
                                {
                                    __auto_type elem_c = expr_transpile_expr(ctx, elem_expr);
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 2) {
            ...
            if (_mv_516.has_value) {
                __auto_type binding_expr = _mv_516.value;
                __auto_type _mv_517 = (*binding_expr);
                switch (_mv_517.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type binding_lst = _mv_517.data.lst;
                        {
                            ...
                            if (binding_len < 3) {
                                ...
                                __auto_type _mv_518 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_518.has_value) {
                                    __auto_type var_expr = _mv_518.value;
                                    __auto_type _mv_519 = (*var_expr);
                                    switch (_mv_519.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type var_sym = _mv_519.data.sym;
                                            {
                                                __auto_type var_name = ctype_to_c_name(arena, var_sym.name);
                                                __auto_type _mv_520 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_520.has_value) {
                                                    __auto_type start_expr = _mv_520.value;
                                                    __auto_type _mv_521 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_521.has_value) {
                                                        __auto_type end_expr = _mv_521.value;
                                                        {
        ...
        if (len < 2) {
            ...
            if (_mv_523.has_value) {
                ...
                switch (_mv_524.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type binding_lst = _mv_524.data.lst;
                        {
                            __auto_type binding_items = binding_lst.items;
                            __auto_type binding_len = ((int64_t)((binding_items).len));
                            if (binding_len < 2) {
                                ...
                                __auto_type _mv_525 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_525.has_value) {
                                    __auto_type first_elem = _mv_525.value;
                                    __auto_type _mv_526 = (*first_elem);
                                    switch (_mv_526.tag) {
                                        case types_SExpr_lst:
                                        {
                                            __auto_type _ = _mv_526.data.lst;
                                            return expr_transpile_for_each_map_kv_as_expr(ctx, binding_items, items, len);
                                        }
                                        case types_SExpr_sym:
                                        {
                                            __auto_type var_sym = _mv_526.data.sym;
                                            {
                                                __auto_type var_name = ctype_to_c_name(arena, var_sym.name);
                                                ...
                                                if (_mv_527.has_value) {
                                                    __auto_type coll_expr = _mv_527.value;
                                                    {
            ...
            context_ctx_bind_var(ctx, (context_VarEntry){var_sym.name, var_name, elem_c_type, elem_slop_type, 0, 0, 0, SLOP_STR(""), SLOP_STR("")});
            {
                ...
                while (i < len) {
                    ...
                    if (_mv_529.has_value) {
                        __auto_type body_expr = _mv_529.value;
                        {
                            __auto_type body_c = expr_transpile_expr(ctx, body_expr);
                            result = context_ctx_str3(ctx, result, body_c, SLOP_STR("; "));
                        }
...
slop_string expr_transpile_for_each_map_kv_as_expr(context_TranspileContext* ctx, slop_list_types_SExpr_ptr binding_items, slop_list_types_SExpr_ptr items, int64_t len) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_531 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        if (_mv_531.has_value) {
            __auto_type kv_list_expr = _mv_531.value;
            __auto_type _mv_532 = (*kv_list_expr);
            switch (_mv_532.tag) {
                case types_SExpr_lst:
                {
                    __auto_type kv_lst = _mv_532.data.lst;
                    {
                        __auto_type kv_items = kv_lst.items;
                        if (((int64_t)((kv_items).len)) < 2) {
                            return SLOP_STR("({ /* for-each: map binding needs ((k v) map) */ 0; })");
                        } else {
                            __auto_type _mv_533 = ({ __auto_type _lst = kv_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_533.has_value) {
                                __auto_type k_expr = _mv_533.value;
                                __auto_type _mv_534 = ({ __auto_type _lst = kv_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_534.has_value) {
                                    __auto_type v_expr = _mv_534.value;
                                    ...
                                    if (_mv_535.has_value) {
                                        __auto_type map_expr = _mv_535.value;
                                        __auto_type _mv_536 = (*k_expr);
                                        switch (_mv_536.tag) {
                                            case types_SExpr_sym:
                                            {
                                                __auto_type k_sym = _mv_536.data.sym;
                                                __auto_type _mv_537 = (*v_expr);
                                                switch (_mv_537.tag) {
                                                    case types_SExpr_sym:
                                                    {
                                                        __auto_type v_sym = _mv_537.data.sym;
                                                        {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 2) {
            ...
            if (_mv_539.has_value) {
                __auto_type second = _mv_539.value;
                __auto_type _mv_540 = (*second);
                switch (_mv_540.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type params_lst = _mv_540.data.lst;
                        return expr_transpile_lambda_with_params(ctx, items, params_lst.items);
                    }
                    case types_SExpr_sym:
                    {
                        __auto_type _ = _mv_540.data.sym;
...
slop_string expr_build_closure_struct(context_TranspileContext* ctx, slop_string env_type, slop_list_string free_vars) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < count) {
            __auto_type _mv_545 = ({ __auto_type _lst = free_vars; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_545.has_value) {
                __auto_type var_name = _mv_545.value;
                {
...
slop_string expr_find_arena_ptr_expr(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    __auto_type _mv_548 = context_ctx_lookup_var(ctx, SLOP_STR("_arena"));
    if (_mv_548.has_value) {
        __auto_type entry = _mv_548.value;
        return SLOP_STR("&_arena");
    } else if (!_mv_548.has_value) {
        __auto_type _mv_549 = context_ctx_lookup_var(ctx, SLOP_STR("arena"));
        if (_mv_549.has_value) {
            __auto_type entry = _mv_549.value;
            return entry.c_name;
        } else if (!_mv_549.has_value) {
            __auto_type _mv_550 = context_ctx_find_arena_var(ctx);
            if (_mv_550.has_value) {
                __auto_type entry = _mv_550.value;
                return entry.c_name;
...
slop_string expr_build_env_initializer(context_TranspileContext* ctx, slop_list_string free_vars, slop_list_string captured_accesses) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < count) {
            __auto_type _mv_551 = ({ __auto_type _lst = free_vars; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_551.has_value) {
                __auto_type var_name = _mv_551.value;
                {
                    __auto_type c_name = ctype_to_c_name(arena, var_name);
...
void expr_bind_lambda_params(context_TranspileContext* ctx, slop_list_types_SExpr_ptr params) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < param_count) {
            __auto_type _mv_557 = ({ __auto_type _lst = params; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_557.has_value) {
                __auto_type param_expr = _mv_557.value;
                __auto_type _mv_558 = (*param_expr);
                switch (_mv_558.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type param_lst = _mv_558.data.lst;
                        {
                            __auto_type param_items = param_lst.items;
                            if (((int64_t)((param_items).len)) >= 2) {
                                __auto_type _mv_559 = ({ __auto_type _lst = param_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_559.has_value) {
                                    __auto_type name_expr = _mv_559.value;
                                    __auto_type _mv_560 = (*name_expr);
                                    switch (_mv_560.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type name_sym = _mv_560.data.sym;
                                            __auto_type _mv_561 = ({ __auto_type _lst = param_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_561.has_value) {
                                                __auto_type type_expr = _mv_561.value;
                                                {
        ...
        if (len <= start) {
            ...
            while (i < len) {
                ...
                if (_mv_565.has_value) {
                    __auto_type expr = _mv_565.value;
                    {
                            ...
                            case types_SExpr_sym:
                            {
                                ...
                                if (!(string_eq(sym.name, SLOP_STR("fn")))) {
                                    ...
                                    if (_mv_569.has_value) {
                                        __auto_type second = _mv_569.value;
                                        __auto_type _mv_570 = (*second);
                                        switch (_mv_570.tag) {
                                            case types_SExpr_lst:
                                            {
                                                __auto_type _ = _mv_570.data.lst;
                                                return 1;
                                            }
                                            default: {
                                                return 0;
            ...
            __auto_type lst = _mv_572.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 2) {
                    ...
                    if (_mv_573.has_value) {
                        __auto_type params_expr = _mv_573.value;
                        __auto_type _mv_574 = (*params_expr);
                        switch (_mv_574.tag) {
                            case types_SExpr_lst:
                            {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (((int64_t)((items).len)) < 2) {
            ...
            if (_mv_576.has_value) {
                __auto_type first_arg = _mv_576.value;
                {
...
slop_list_string expr_find_free_vars(context_TranspileContext* ctx, slop_list_string param_names, slop_list_types_SExpr_ptr body_items, int64_t start, slop_list_string pending) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = start;
        while (i < len) {
            __auto_type _mv_577 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_577.has_value) {
                __auto_type expr = _mv_577.value;
        ...
        }
        {
            ...
            int64_t j = 0;
            while (j < sym_count) {
                __auto_type _mv_578 = ({ __auto_type _lst = all_symbols; size_t _idx = (size_t)j; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_578.has_value) {
                    __auto_type sym_name = _mv_578.value;
                ...
                if (len > 0) {
                    ...
                    if (_mv_580.has_value) {
                        ...
                        switch (_mv_581.tag) {
                            case types_SExpr_sym:
                            {
                                __auto_type head_sym = _mv_581.data.sym;
                                {
                                    __auto_type op = head_sym.name;
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_582.has_value) {
                __auto_type item = _mv_582.value;
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len >= 2) {
            ...
            if (_mv_583.has_value) {
                __auto_type bindings_expr = _mv_583.value;
                {
                    ...
                    __auto_type _mv_584 = (*bindings_expr);
                    switch (_mv_584.tag) {
                        case types_SExpr_lst:
                        {
                            __auto_type bindings_lst = _mv_584.data.lst;
                            {
                                __auto_type bindings = bindings_lst.items;
                                __auto_type binding_count = ((int64_t)((bindings).len));
                                __auto_type i = 0;
                                while (i < binding_count) {
                                    __auto_type _mv_585 = ({ __auto_type _lst = bindings; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    ...
                                                    if (((int64_t)((bind_items).len)) >= 2) {
                                                        {
                                                            ...
                                                            __auto_type _mv_587 = ({ __auto_type _lst = bind_items; size_t _idx = (size_t)val_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
uint8_t expr_is_mut_binding(slop_list_types_SExpr_ptr items) {
    if (((int64_t)((items).len)) < 1) {
        ...
        if (_mv_588.has_value) {
            __auto_type first = _mv_588.value;
            __auto_type _mv_589 = (*first);
            switch (_mv_589.tag) {
                case types_SExpr_sym:
                {
...
slop_list_string expr_extract_let_binding_names(slop_arena* arena, types_SExpr* bindings_expr) {
    ...
    {
        __auto_type names = ((slop_list_string){ .data = (slop_string*)slop_arena_alloc(arena, 16 * sizeof(slop_string)), .len = 0, .cap = 16 });
        __auto_type _mv_590 = (*bindings_expr);
        switch (_mv_590.tag) {
            case types_SExpr_lst:
            {
                __auto_type bindings_lst = _mv_590.data.lst;
                {
                    __auto_type bindings = bindings_lst.items;
                    __auto_type binding_count = ((int64_t)((bindings).len));
                    __auto_type i = 0;
                    while (i < binding_count) {
                        __auto_type _mv_591 = ({ __auto_type _lst = bindings; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        ...
                                        if (((int64_t)((bind_items).len)) >= 1) {
                                            {
                                                ...
                                                __auto_type _mv_593 = ({ __auto_type _lst = bind_items; size_t _idx = (size_t)name_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_593.has_value) {
                                                    ...
                                                    switch (_mv_594.tag) {
                                                        case types_SExpr_sym:
                                                        {
                                                            __auto_type sym = _mv_594.data.sym;
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len >= 2) {
            ...
            if (_mv_595.has_value) {
                __auto_type scrutinee = _mv_595.value;
            ...
            }
            {
                ...
                while (i < len) {
                    ...
                    if (_mv_596.has_value) {
                        __auto_type clause = _mv_596.value;
                        __auto_type _mv_597 = (*clause);
                        switch (_mv_597.tag) {
                            case types_SExpr_lst:
                            {
                                __auto_type clause_lst = _mv_597.data.lst;
                                {
                                    __auto_type clause_items = clause_lst.items;
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len >= 2) {
            ...
            if (_mv_598.has_value) {
                __auto_type binding = _mv_598.value;
                __auto_type _mv_599 = (*binding);
                switch (_mv_599.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type bind_lst = _mv_599.data.lst;
                        {
                            __auto_type bind_items = bind_lst.items;
...
slop_list_string expr_extract_for_loop_var_pending(slop_arena* arena, slop_list_string pending, slop_list_types_SExpr_ptr bind_items) {
    if (((int64_t)((bind_items).len)) < 1) {
        ...
        __auto_type _mv_600 = ({ __auto_type _lst = bind_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        if (_mv_600.has_value) {
            __auto_type var_expr = _mv_600.value;
            __auto_type _mv_601 = (*var_expr);
            switch (_mv_601.tag) {
                case types_SExpr_sym:
                {
                    __auto_type var_sym = _mv_601.data.sym;
                    {
                        __auto_type result = ((slop_list_string){ .data = (slop_string*)slop_arena_alloc(arena, 16 * sizeof(slop_string)), .len = 0, .cap = 16 });
                        ...
                        __auto_type i = 0;
                        while (i < plen) {
                            __auto_type _mv_602 = ({ __auto_type _lst = pending; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        if (len >= 3) {
            {
                ...
                __auto_type size_idx = ((is_named) ? 3 : 1);
                __auto_type body_start = ((is_named) ? 4 : 2);
                __auto_type _mv_603 = ({ __auto_type _lst = items; size_t _idx = (size_t)size_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_603.has_value) {
                    __auto_type size_expr = _mv_603.value;
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len >= 2) {
            ...
            if (_mv_604.has_value) {
                __auto_type params_expr = _mv_604.value;
                __auto_type _mv_605 = (*params_expr);
                switch (_mv_605.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type params_lst = _mv_605.data.lst;
                        {
                            __auto_type params = params_lst.items;
                            __auto_type param_names = expr_extract_param_names(arena, params);
    ...
    if (expr_list_contains_string(param_names, sym_name)) {
        ...
        if (expr_list_contains_string(pending, sym_name)) {
            ...
            if (expr_is_builtin_op(sym_name)) {
                ...
                __auto_type _mv_606 = context_ctx_lookup_func(ctx, sym_name);
                if (_mv_606.has_value) {
                    __auto_type _ = _mv_606.value;
                    return 0;
                } else if (!_mv_606.has_value) {
                    __auto_type _mv_607 = context_ctx_lookup_type(ctx, sym_name);
                    if (_mv_607.has_value) {
                        __auto_type _ = _mv_607.value;
                        return 0;
                    } else if (!_mv_607.has_value) {
                        __auto_type _mv_608 = context_ctx_lookup_var(ctx, sym_name);
                        if (_mv_608.has_value) {
                            __auto_type _ = _mv_608.value;
                            return 1;
...
uint8_t expr_list_contains_string(slop_list_string lst, slop_string needle) {
    {
        ...
        uint8_t found = 0;
        while ((i < len) && !(found)) {
            __auto_type _mv_609 = ({ __auto_type _lst = lst; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_609.has_value) {
                __auto_type s = _mv_609.value;
...
slop_list_string expr_list_concat(slop_arena* arena, slop_list_string a, slop_list_string b) {
    {
        ...
        int64_t i = 0;
        while (i < len_a) {
            __auto_type _mv_610 = ({ __auto_type _lst = a; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        i = 0;
        while (i < len_b) {
            __auto_type _mv_611 = ({ __auto_type _lst = b; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_611.has_value) {
                __auto_type s = _mv_611.value;
                ({ __auto_type _lst_p = &(result); __auto_type _item = (s); if (_lst_p->len >= _lst_p->cap) { size_t _new_cap = _lst_p->cap == 0 ? 16 : _lst_p->cap * 2; __typeof__(_lst_p->data) _new_data = (__typeof__(_lst_p->data))slop_arena_alloc(arena, _new_cap * sizeof(*_lst_p->data)); if (_lst_p->len > 0) memcpy(_new_data, _lst_p->data, _lst_p->len * sizeof(*_lst_p->data)); _lst_p->data = _new_data; _lst_p->cap = _new_cap; } _lst_p->data[_lst_p->len++] = _item; (void)0; });
...
slop_string expr_infer_collection_element_slop_type(context_TranspileContext* ctx, types_SExpr* coll_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_612 = (*coll_expr);
        switch (_mv_612.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_612.data.lst;
                {
                    __auto_type items = lst.items;
                    if (((int64_t)((items).len)) < 1) {
                        return SLOP_STR("");
                    } else {
                        __auto_type _mv_613 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_613.has_value) {
                            __auto_type head = _mv_613.value;
                            __auto_type _mv_614 = (*head);
                            switch (_mv_614.tag) {
                                case types_SExpr_sym:
                                {
                                        ...
                                        if (string_eq(op, SLOP_STR("map-keys"))) {
                                            ...
                                            if (((int64_t)((items).len)) < 2) {
                                                ...
                                                if (_mv_616.has_value) {
                                                    __auto_type set_expr = _mv_616.value;
                                                    {
                                            ...
                                            if (((int64_t)((items).len)) < 2) {
                                                ...
                                                if (_mv_617.has_value) {
                                                    __auto_type map_expr = _mv_617.value;
                                                    {
                                                        __auto_type map_slop_type = expr_infer_expr_slop_type(ctx, map_expr);
                                                        if (string_len(map_slop_type) > 0) {
                                                            {
