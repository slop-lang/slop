        ...
        if (len < 4) {
            ...
            if (_mv_500.has_value) {
                ...
                if (_mv_501.has_value) {
                    ...
                    __auto_type _mv_502 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        if (len < 3) {
            ...
            if (_mv_505.has_value) {
                ...
                if (_mv_506.has_value) {
                    __auto_type key_expr = _mv_506.value;
                    {
                        __auto_type map_c = expr_resolve_container_c(ctx, map_expr);
                        __auto_type key_c = expr_transpile_expr(ctx, key_expr);
                        __auto_type key_ptr = expr_wrap_map_key_as_ptr(ctx, key_c, key_expr, map_expr);
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 3) {
            ...
            if (_mv_507.has_value) {
                __auto_type map_expr = _mv_507.value;
                ...
                if (_mv_508.has_value) {
                    __auto_type key_expr = _mv_508.value;
                    {
                        __auto_type map_c = expr_resolve_container_c(ctx, map_expr);
                        __auto_type key_c = expr_transpile_expr(ctx, key_expr);
                        __auto_type key_ptr = expr_wrap_map_key_as_ptr(ctx, key_c, key_expr, map_expr);
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 2) {
            ...
            if (_mv_509.has_value) {
                __auto_type map_expr = _mv_509.value;
                {
                    __auto_type map_c = expr_resolve_container_c(ctx, map_expr);
        ...
        if (len < 3) {
            ...
            if (_mv_510.has_value) {
                ...
                if (_mv_511.has_value) {
                    __auto_type elem_type_expr = _mv_511.value;
                    {
                        __auto_type arena_c = expr_transpile_expr(ctx, arena_expr);
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 3) {
            ...
            if (_mv_516.has_value) {
                __auto_type set_expr = _mv_516.value;
                ...
                if (_mv_517.has_value) {
                    __auto_type elem_expr = _mv_517.value;
                    {
                        __auto_type set_c = expr_resolve_container_c(ctx, set_expr);
                        __auto_type elem_c = expr_transpile_expr(ctx, elem_expr);
                        __auto_type elem_ptr = expr_wrap_map_key_as_ptr(ctx, elem_c, elem_expr, set_expr);
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 2) {
            ...
            if (_mv_518.has_value) {
                __auto_type set_expr = _mv_518.value;
                {
                    __auto_type set_c = expr_resolve_container_c(ctx, set_expr);
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 2) {
            ...
            if (_mv_521.has_value) {
                __auto_type binding_expr = _mv_521.value;
                __auto_type _mv_522 = (*binding_expr);
                switch (_mv_522.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type binding_lst = _mv_522.data.lst;
                        {
                            ...
                            if (binding_len < 3) {
                                ...
                                if (_mv_523.has_value) {
                                    __auto_type var_expr = _mv_523.value;
                                    __auto_type _mv_524 = (*var_expr);
                                    switch (_mv_524.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type var_sym = _mv_524.data.sym;
                                            {
                                                ...
                                                if (_mv_525.has_value) {
                                                    __auto_type start_expr = _mv_525.value;
                                                    __auto_type _mv_526 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_526.has_value) {
                                                        __auto_type end_expr = _mv_526.value;
                                                        {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 2) {
            ...
            if (_mv_528.has_value) {
                __auto_type binding_expr = _mv_528.value;
                __auto_type _mv_529 = (*binding_expr);
                switch (_mv_529.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type binding_lst = _mv_529.data.lst;
                        {
                            __auto_type binding_items = binding_lst.items;
                            __auto_type binding_len = ((int64_t)((binding_items).len));
                            if (binding_len < 2) {
                                ...
                                __auto_type _mv_530 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_530.has_value) {
                                    __auto_type first_elem = _mv_530.value;
                                    __auto_type _mv_531 = (*first_elem);
                                    switch (_mv_531.tag) {
                                        case types_SExpr_lst:
                                        {
                                            __auto_type _ = _mv_531.data.lst;
                                            return expr_transpile_for_each_map_kv_as_expr(ctx, binding_items, items, len);
                                        }
                                        case types_SExpr_sym:
                                        {
                                            __auto_type var_sym = _mv_531.data.sym;
                                            {
                                                __auto_type var_name = ctype_to_c_name(arena, var_sym.name);
                                                ...
                                                if (_mv_532.has_value) {
                                                    __auto_type coll_expr = _mv_532.value;
                                                    {
...
slop_string expr_transpile_for_each_map_kv_as_expr(context_TranspileContext* ctx, slop_list_types_SExpr_ptr binding_items, slop_list_types_SExpr_ptr items, int64_t len) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_536 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        if (_mv_536.has_value) {
            __auto_type kv_list_expr = _mv_536.value;
            __auto_type _mv_537 = (*kv_list_expr);
            switch (_mv_537.tag) {
                case types_SExpr_lst:
                {
                    __auto_type kv_lst = _mv_537.data.lst;
                    {
                        __auto_type kv_items = kv_lst.items;
                        if (((int64_t)((kv_items).len)) < 2) {
                            return SLOP_STR("({ /* for-each: map binding needs ((k v) map) */ 0; })");
                        } else {
                            __auto_type _mv_538 = ({ __auto_type _lst = kv_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_538.has_value) {
                                __auto_type k_expr = _mv_538.value;
                                __auto_type _mv_539 = ({ __auto_type _lst = kv_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_539.has_value) {
                                    __auto_type v_expr = _mv_539.value;
                                    ...
                                    if (_mv_540.has_value) {
                                        __auto_type map_expr = _mv_540.value;
                                        __auto_type _mv_541 = (*k_expr);
                                        switch (_mv_541.tag) {
                                            case types_SExpr_sym:
                                            {
                                                __auto_type k_sym = _mv_541.data.sym;
                                                __auto_type _mv_542 = (*v_expr);
                                                switch (_mv_542.tag) {
                                                    case types_SExpr_sym:
                                                    {
                                                        __auto_type v_sym = _mv_542.data.sym;
                                                        {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 2) {
            ...
            if (_mv_544.has_value) {
                __auto_type second = _mv_544.value;
                __auto_type _mv_545 = (*second);
                switch (_mv_545.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type params_lst = _mv_545.data.lst;
                        return expr_transpile_lambda_with_params(ctx, items, params_lst.items);
                    }
                    case types_SExpr_sym:
                    {
                        __auto_type _ = _mv_545.data.sym;
...
slop_string expr_build_closure_struct(context_TranspileContext* ctx, slop_string env_type, slop_list_string free_vars) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < count) {
            __auto_type _mv_550 = ({ __auto_type _lst = free_vars; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_550.has_value) {
                __auto_type var_name = _mv_550.value;
                {
...
slop_string expr_find_arena_ptr_expr(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    __auto_type _mv_553 = context_ctx_lookup_var(ctx, SLOP_STR("_arena"));
    if (_mv_553.has_value) {
        __auto_type entry = _mv_553.value;
        return SLOP_STR("&_arena");
    } else if (!_mv_553.has_value) {
        __auto_type _mv_554 = context_ctx_lookup_var(ctx, SLOP_STR("arena"));
        if (_mv_554.has_value) {
            __auto_type entry = _mv_554.value;
            return entry.c_name;
        } else if (!_mv_554.has_value) {
            __auto_type _mv_555 = context_ctx_find_arena_var(ctx);
            if (_mv_555.has_value) {
                __auto_type entry = _mv_555.value;
                return entry.c_name;
...
slop_string expr_build_env_initializer(context_TranspileContext* ctx, slop_list_string free_vars, slop_list_string captured_accesses) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < count) {
            __auto_type _mv_556 = ({ __auto_type _lst = free_vars; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_556.has_value) {
                __auto_type var_name = _mv_556.value;
                {
                    __auto_type c_name = ctype_to_c_name(arena, var_name);
                                ...
                                if (_mv_564.has_value) {
                                    ...
                                    switch (_mv_565.tag) {
                                        case types_SExpr_sym:
                                        {
                                            ...
                                            __auto_type _mv_566 = ({ __auto_type _lst = param_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_566.has_value) {
                                                __auto_type type_expr = _mv_566.value;
                                                {
                ...
                if (((int64_t)((items).len)) < 2) {
                    ...
                    if (_mv_572.has_value) {
                        ...
                        switch (_mv_573.tag) {
                            case types_SExpr_sym:
                            {
                                __auto_type sym = _mv_573.data.sym;
                                if (!(string_eq(sym.name, SLOP_STR("fn")))) {
                                    ...
                                    if (_mv_574.has_value) {
                                        __auto_type second = _mv_574.value;
                                        __auto_type _mv_575 = (*second);
                                        switch (_mv_575.tag) {
                                            case types_SExpr_lst:
                                            {
                                                __auto_type _ = _mv_575.data.lst;
                                                return 1;
                                            }
                                            default: {
                                                return 0;
...
uint8_t expr_lambda_has_captures(context_TranspileContext* ctx, types_SExpr* fn_expr) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    SLOP_PRE(((fn_expr != NULL)), "(!= fn-expr nil)");
    __auto_type _mv_577 = (*fn_expr);
    switch (_mv_577.tag) {
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_577.data.lst;
            {
                __auto_type items = lst.items;
                __auto_type arena = (*ctx).arena;
                if (((int64_t)((items).len)) < 2) {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (((int64_t)((items).len)) < 2) {
            ...
            if (_mv_581.has_value) {
                __auto_type first_arg = _mv_581.value;
                {
...
slop_list_string expr_find_free_vars(context_TranspileContext* ctx, slop_list_string param_names, slop_list_types_SExpr_ptr body_items, int64_t start, slop_list_string pending) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = start;
        while (i < len) {
            __auto_type _mv_582 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        }
        {
            ...
            int64_t j = 0;
            while (j < sym_count) {
                __auto_type _mv_583 = ({ __auto_type _lst = all_symbols; size_t _idx = (size_t)j; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_583.has_value) {
                    __auto_type sym_name = _mv_583.value;
                ...
                if (len > 0) {
                    ...
                    if (_mv_585.has_value) {
                        ...
                        switch (_mv_586.tag) {
                            case types_SExpr_sym:
                            {
                                __auto_type head_sym = _mv_586.data.sym;
                                {
                                    __auto_type op = head_sym.name;
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_587.has_value) {
                __auto_type item = _mv_587.value;
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len >= 2) {
            ...
            if (_mv_588.has_value) {
                __auto_type bindings_expr = _mv_588.value;
                {
                    ...
                    __auto_type _mv_589 = (*bindings_expr);
                    switch (_mv_589.tag) {
                        case types_SExpr_lst:
                        {
                            __auto_type bindings_lst = _mv_589.data.lst;
                            {
                                __auto_type bindings = bindings_lst.items;
                                __auto_type binding_count = ((int64_t)((bindings).len));
                                __auto_type i = 0;
                                while (i < binding_count) {
                                    __auto_type _mv_590 = ({ __auto_type _lst = bindings; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    ...
                                                    if (((int64_t)((bind_items).len)) >= 2) {
                                                        {
                                                            ...
                                                            __auto_type _mv_592 = ({ __auto_type _lst = bind_items; size_t _idx = (size_t)val_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
uint8_t expr_is_mut_binding(slop_list_types_SExpr_ptr items) {
    if (((int64_t)((items).len)) < 1) {
        ...
        if (_mv_593.has_value) {
            __auto_type first = _mv_593.value;
            __auto_type _mv_594 = (*first);
            switch (_mv_594.tag) {
                case types_SExpr_sym:
                {
...
slop_list_string expr_extract_let_binding_names(slop_arena* arena, types_SExpr* bindings_expr) {
    ...
    {
        __auto_type names = ((slop_list_string){ .data = (slop_string*)slop_arena_alloc(arena, 16 * sizeof(slop_string)), .len = 0, .cap = 16 });
        __auto_type _mv_595 = (*bindings_expr);
        switch (_mv_595.tag) {
            case types_SExpr_lst:
            {
                __auto_type bindings_lst = _mv_595.data.lst;
                {
                    __auto_type bindings = bindings_lst.items;
                    __auto_type binding_count = ((int64_t)((bindings).len));
                    __auto_type i = 0;
                    while (i < binding_count) {
                        __auto_type _mv_596 = ({ __auto_type _lst = bindings; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_596.has_value) {
                            __auto_type binding = _mv_596.value;
                            __auto_type _mv_597 = (*binding);
                            switch (_mv_597.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type bind_lst = _mv_597.data.lst;
                                    {
                                        __auto_type bind_items = bind_lst.items;
                                        if (((int64_t)((bind_items).len)) >= 1) {
                                            {
                                                __auto_type name_idx = ((expr_is_mut_binding(bind_items)) ? 1 : 0);
                                                __auto_type _mv_598 = ({ __auto_type _lst = bind_items; size_t _idx = (size_t)name_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len >= 2) {
            ...
            if (_mv_600.has_value) {
                __auto_type scrutinee = _mv_600.value;
            ...
            }
            {
                ...
                while (i < len) {
                    ...
                    if (_mv_601.has_value) {
                        __auto_type clause = _mv_601.value;
                        __auto_type _mv_602 = (*clause);
                        switch (_mv_602.tag) {
                            case types_SExpr_lst:
                            {
                                __auto_type clause_lst = _mv_602.data.lst;
                                {
                                    __auto_type clause_items = clause_lst.items;
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len >= 2) {
            ...
            if (_mv_603.has_value) {
                __auto_type binding = _mv_603.value;
                __auto_type _mv_604 = (*binding);
                switch (_mv_604.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type bind_lst = _mv_604.data.lst;
                        {
                            __auto_type bind_items = bind_lst.items;
...
slop_list_string expr_extract_for_loop_var_pending(slop_arena* arena, slop_list_string pending, slop_list_types_SExpr_ptr bind_items) {
    if (((int64_t)((bind_items).len)) < 1) {
        ...
        __auto_type _mv_605 = ({ __auto_type _lst = bind_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        if (_mv_605.has_value) {
            __auto_type var_expr = _mv_605.value;
            __auto_type _mv_606 = (*var_expr);
            switch (_mv_606.tag) {
                case types_SExpr_sym:
                {
                    __auto_type var_sym = _mv_606.data.sym;
                    {
                        __auto_type result = ((slop_list_string){ .data = (slop_string*)slop_arena_alloc(arena, 16 * sizeof(slop_string)), .len = 0, .cap = 16 });
                        ...
                        __auto_type i = 0;
                        while (i < plen) {
                            __auto_type _mv_607 = ({ __auto_type _lst = pending; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        if (len >= 3) {
            {
                ...
                __auto_type size_idx = ((is_named) ? 3 : 1);
                __auto_type body_start = ((is_named) ? 4 : 2);
                __auto_type _mv_608 = ({ __auto_type _lst = items; size_t _idx = (size_t)size_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len >= 2) {
            ...
            if (_mv_609.has_value) {
                __auto_type params_expr = _mv_609.value;
                __auto_type _mv_610 = (*params_expr);
                switch (_mv_610.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type params_lst = _mv_610.data.lst;
                        {
                            __auto_type params = params_lst.items;
                            __auto_type param_names = expr_extract_param_names(arena, params);
    ...
    if (expr_list_contains_string(param_names, sym_name)) {
        ...
        if (expr_list_contains_string(pending, sym_name)) {
            ...
            if (expr_is_builtin_op(sym_name)) {
                ...
                __auto_type _mv_611 = context_ctx_lookup_func(ctx, sym_name);
                if (_mv_611.has_value) {
                    __auto_type _ = _mv_611.value;
                    return 0;
                } else if (!_mv_611.has_value) {
                    __auto_type _mv_612 = context_ctx_lookup_type(ctx, sym_name);
                    if (_mv_612.has_value) {
                        __auto_type _ = _mv_612.value;
                        return 0;
                    } else if (!_mv_612.has_value) {
                        __auto_type _mv_613 = context_ctx_lookup_var(ctx, sym_name);
                        if (_mv_613.has_value) {
                            __auto_type _ = _mv_613.value;
                            return 1;
...
uint8_t expr_list_contains_string(slop_list_string lst, slop_string needle) {
    {
        ...
        uint8_t found = 0;
        while ((i < len) && !(found)) {
            __auto_type _mv_614 = ({ __auto_type _lst = lst; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_614.has_value) {
                __auto_type s = _mv_614.value;
...
slop_list_string expr_list_concat(slop_arena* arena, slop_list_string a, slop_list_string b) {
    {
        ...
        int64_t i = 0;
        while (i < len_a) {
            __auto_type _mv_615 = ({ __auto_type _lst = a; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        i = 0;
        while (i < len_b) {
            __auto_type _mv_616 = ({ __auto_type _lst = b; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_616.has_value) {
                __auto_type s = _mv_616.value;
                ({ __auto_type _lst_p = &(result); __auto_type _item = (s); if (_lst_p->len >= _lst_p->cap) { size_t _new_cap = _lst_p->cap == 0 ? 16 : _lst_p->cap * 2; __typeof__(_lst_p->data) _new_data = (__typeof__(_lst_p->data))slop_arena_alloc(arena, _new_cap * sizeof(*_lst_p->data)); if (_lst_p->len > 0) memcpy(_new_data, _lst_p->data, _lst_p->len * sizeof(*_lst_p->data)); _lst_p->data = _new_data; _lst_p->cap = _new_cap; } _lst_p->data[_lst_p->len++] = _item; (void)0; });
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_617.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) < 1) {
                        ...
                        __auto_type _mv_618 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        ...
                                        if (string_eq(op, SLOP_STR("map-keys"))) {
                                            ...
                                            if (((int64_t)((items).len)) < 2) {
                                                ...
                                                if (_mv_621.has_value) {
                                                    __auto_type set_expr = _mv_621.value;
                                                    {
