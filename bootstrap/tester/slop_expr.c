...
slop_string expr_closure_type_to_c(context_TranspileContext* ctx, slop_string slop_type) {
    ...
    if (string_eq(slop_type, SLOP_STR("Int"))) {
        ...
        __auto_type _mv_152 = context_ctx_lookup_type(ctx, slop_type);
        if (_mv_152.has_value) {
            __auto_type type_entry = _mv_152.value;
...
slop_string expr_transpile_enum_variant(context_TranspileContext* ctx, slop_string variant_name) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_153 = context_ctx_lookup_enum_variant(ctx, variant_name);
        if (_mv_153.has_value) {
            __auto_type enum_name = _mv_153.value;
            {
...
slop_string expr_transpile_error(context_TranspileContext* ctx, slop_string value_c) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    __auto_type _mv_155 = context_ctx_get_current_result_type(ctx);
    if (_mv_155.has_value) {
        __auto_type result_type = _mv_155.value;
...
slop_string expr_infer_option_type(context_TranspileContext* ctx, types_SExpr* val_expr) {
    ...
    __auto_type _mv_156 = (*val_expr);
    switch (_mv_156.tag) {
        case types_SExpr_num:
        {
            __auto_type num = _mv_156.data.num;
            if (num.is_float) {
        ...
        case types_SExpr_str:
        {
            __auto_type _ = _mv_156.data.str;
            return SLOP_STR("slop_option_string");
        }
        case types_SExpr_sym:
        {
            __auto_type sym = _mv_156.data.sym;
            __auto_type _mv_157 = ctype_get_node_resolved_type(val_expr);
            if (_mv_157.has_value) {
                __auto_type rt = _mv_157.value;
                {
...
slop_string expr_infer_field_c_type_from_items(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 3) {
            ...
            __auto_type _mv_159 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_159.has_value) {
                __auto_type obj_expr = _mv_159.value;
                __auto_type _mv_160 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    ...
                    switch (_mv_161.tag) {
                        case types_SExpr_sym:
                        {
                            __auto_type field_sym = _mv_161.data.sym;
                            {
                                ...
                                __auto_type _mv_162 = context_ctx_lookup_field_type(ctx, obj_c_type, field_name);
                                if (_mv_162.has_value) {
                                    __auto_type c_type = _mv_162.value;
                                    return c_type;
                                } else if (!_mv_162.has_value) {
                                    __auto_type _mv_163 = context_ctx_lookup_var(ctx, expr_get_var_name_from_expr(obj_expr));
                                    if (_mv_163.has_value) {
                                        __auto_type var_entry = _mv_163.value;
                                        {
                                            __auto_type obj_slop_type = var_entry.slop_type;
                                            __auto_type _mv_164 = context_ctx_lookup_field_type(ctx, obj_slop_type, field_name);
                                            if (_mv_164.has_value) {
                                                __auto_type c_type2 = _mv_164.value;
                                                return c_type2;
...
slop_string expr_infer_list_expr_option_type(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 1) {
            ...
            __auto_type _mv_165 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_165.has_value) {
                __auto_type head_expr = _mv_165.value;
                __auto_type _mv_166 = (*head_expr);
                switch (_mv_166.tag) {
                    case types_SExpr_sym:
                    {
                        __auto_type sym = _mv_166.data.sym;
                        {
                            ...
                            if (string_eq(op, SLOP_STR("."))) {
                                if (len < 3) {
                                ...
                                } else {
                                    {
                                        ...
                                        if (!(string_eq(field_c_type, SLOP_STR("__auto_type")))) {
                                            ...
                                            __auto_type _mv_167 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                ...
                                __auto_type _mv_169 = context_ctx_lookup_func(ctx, op);
                                if (_mv_169.has_value) {
                                    __auto_type func_entry = _mv_169.value;
                                    {
...
slop_string expr_infer_list_element_option_type(context_TranspileContext* ctx, types_SExpr* list_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_170 = ctype_get_node_resolved_type(list_expr);
        if (_mv_170.has_value) {
            __auto_type rt = _mv_170.value;
            __auto_type _mv_171 = (*rt).inner_type;
            if (_mv_171.has_value) {
                __auto_type elem_type = _mv_171.value;
                {
                ...
                case types_SExpr_lst:
                {
                    __auto_type lst = _mv_172.data.lst;
                    {
                        ...
                        if (((int64_t)((items).len)) < 3) {
                            ...
                            __auto_type _mv_174 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_174.has_value) {
                                __auto_type head = _mv_174.value;
                                __auto_type _mv_175 = (*head);
                                switch (_mv_175.tag) {
                                    case types_SExpr_sym:
                                    {
                                        __auto_type head_sym = _mv_175.data.sym;
                                        if (string_eq(head_sym.name, SLOP_STR("."))) {
                                            __auto_type _mv_176 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_176.has_value) {
                                                __auto_type field_expr = _mv_176.value;
...
slop_string expr_infer_field_access_list_type(context_TranspileContext* ctx, types_SExpr* field_expr) {
    ...
    __auto_type _mv_177 = (*field_expr);
    switch (_mv_177.tag) {
        case types_SExpr_sym:
        {
            __auto_type field_sym = _mv_177.data.sym;
            {
                __auto_type field_name = field_sym.name;
        ...
        if (strlib_ends_with(elem_type, SLOP_STR("_ptr"))) {
            {
                ...
                __auto_type _mv_178 = context_ctx_lookup_type(ctx, base);
            ...
            __auto_type _mv_179 = context_ctx_lookup_type(ctx, elem_type);
...
slop_string expr_slop_value_type_to_c_type(context_TranspileContext* ctx, slop_string slop_type) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (strlib_starts_with(slop_type, SLOP_STR("(Map "))) {
            ...
            __auto_type _mv_180 = context_ctx_lookup_type(ctx, slop_type);
...
slop_string expr_resolve_type_alias(context_TranspileContext* ctx, slop_string slop_type) {
    ...
    if (strlib_starts_with(slop_type, SLOP_STR("(Map "))) {
        ...
        __auto_type _mv_182 = context_ctx_lookup_type_alias(ctx, slop_type);
        if (_mv_182.has_value) {
            __auto_type alias_def = _mv_182.value;
            return alias_def;
                ...
                __auto_type lst = _mv_183.data.lst;
                {
                    ...
                    if (len < 1) {
                        ...
                        if (_mv_185.has_value) {
                            __auto_type head = _mv_185.value;
                            __auto_type _mv_186 = (*head);
                            switch (_mv_186.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type head_sym = _mv_186.data.sym;
                                    {
                                        ...
                                        if (string_eq(op, SLOP_STR(".")) && (len >= 3)) {
                                            ...
                                            if (_mv_187.has_value) {
                                                __auto_type obj_expr = _mv_187.value;
                                                __auto_type _mv_188 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                        ...
                                                        case types_SExpr_sym:
                                                        {
                                                            __auto_type field_sym = _mv_189.data.sym;
                                                            {
                                                                __auto_type field_name = field_sym.name;
                                                                {
                                                                    ...
                                                                    __auto_type _mv_190 = context_ctx_lookup_field_slop_type(ctx, obj_c_type, field_name);
                                                                    if (_mv_190.has_value) {
                                                                        __auto_type slop_type = _mv_190.value;
                                                                        return slop_type;
                                                                    } else if (!_mv_190.has_value) {
                                                                        {
                                                                            ...
                                                                            __auto_type _mv_191 = context_ctx_lookup_field_slop_type(ctx, obj_slop_type, field_name);
                                                                            if (_mv_191.has_value) {
                                                                                __auto_type slop_type2 = _mv_191.value;
                                                                                return slop_type2;
                                            ...
                                            if (len >= 2) {
                                                ...
                                                if (_mv_192.has_value) {
                                                    ...
                                                    __auto_type _mv_193 = (*type_expr);
                                                    switch (_mv_193.tag) {
                                                        case types_SExpr_sym:
                                                        {
                                                            __auto_type type_sym = _mv_193.data.sym;
                                            ...
                                            if (len >= 4) {
                                                ...
                                                if (_mv_194.has_value) {
                                                    __auto_type key_expr = _mv_194.value;
                                                    __auto_type _mv_195 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_195.has_value) {
                                                        __auto_type val_expr = _mv_195.value;
                                                        {
                                            ...
                                            if (len >= 3) {
                                                __auto_type _mv_196 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            ...
                                            if (len >= 3) {
                                                __auto_type _mv_199 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_199.has_value) {
                                                    __auto_type elem_expr = _mv_199.value;
                                                    {
                                                        __auto_type elem_str = ctype_sexpr_to_type_string(arena, elem_expr);
                                                        return context_ctx_str3(ctx, SLOP_STR("(List "), elem_str, SLOP_STR(")"));
                                                    }
                                            ...
                                            if (_mv_202.has_value) {
                                                __auto_type inner_expr = _mv_202.value;
                                            ...
                                            __auto_type _mv_203 = context_ctx_lookup_func(ctx, op);
                                            if (_mv_203.has_value) {
                                                __auto_type func_entry = _mv_203.value;
                        ...
                        case types_SExpr_lst:
                        {
                            __auto_type lst = _mv_210.data.lst;
                            {
                                ...
                                if (len < 2) {
                                    ...
                                    __auto_type _mv_211 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    if (_mv_211.has_value) {
                                        __auto_type head_expr = _mv_211.value;
                                        __auto_type _mv_212 = (*head_expr);
                                        switch (_mv_212.tag) {
                                            case types_SExpr_sym:
                                            {
                                                    ...
                                                    if (string_eq(op, SLOP_STR("map-get"))) {
                                                        if (len < 2) {
                                                            ...
                                                            if (_mv_213.has_value) {
                                                                __auto_type map_expr = _mv_213.value;
                                                                __auto_type _mv_214 = (*map_expr);
                                                                switch (_mv_214.tag) {
                                                                    case types_SExpr_sym:
                                                                    {
                                                                        __auto_type map_sym = _mv_214.data.sym;
                                                                        {
                                                                            __auto_type map_name = map_sym.name;
                                                                            __auto_type _mv_215 = context_ctx_lookup_var(ctx, map_name);
                                                        ...
                                                        if (len < 2) {
                                                            ...
                                                            if (_mv_216.has_value) {
                                                                ...
                                                                __auto_type _mv_217 = (*list_expr);
                                                                switch (_mv_217.tag) {
                                                                    case types_SExpr_sym:
                                                                    {
                                                                        __auto_type list_sym = _mv_217.data.sym;
                                                                        {
                                                                            __auto_type list_name = list_sym.name;
                                                                            __auto_type _mv_218 = context_ctx_lookup_var(ctx, list_name);
...
slop_string expr_fix_ternary_none(context_TranspileContext* ctx, types_SExpr* other_expr, slop_string other_branch, slop_string this_branch) {
    ...
    if (string_eq(this_branch, SLOP_STR("none")) && strlib_starts_with(other_branch, SLOP_STR("(slop_option_"))) {
        {
            __auto_type arena = (*ctx).arena;
            __auto_type _mv_219 = expr_extract_option_type(arena, other_branch);
            if (_mv_219.has_value) {
                __auto_type opt_type = _mv_219.value;
                                    ...
                                    __auto_type head_sym = _mv_229.data.sym;
                                    {
                                        ...
                                        if (string_eq(op, SLOP_STR("sizeof"))) {
                                        ...
                                        } else if (string_eq(op, SLOP_STR("*")) || (string_eq(op, SLOP_STR("+")) || (string_eq(op, SLOP_STR("-")) || string_eq(op, SLOP_STR("/"))))) {
                                            {
                                                ...
                                                while (i < len) {
                                                    __auto_type _mv_231 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_231.has_value) {
                                                        __auto_type arg_expr = _mv_231.value;
                                                        {
...
slop_string expr_transpile_expr(context_TranspileContext* ctx, types_SExpr* expr) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    SLOP_PRE(((expr != NULL)), "(!= expr nil)");
    __auto_type _mv_232 = (*expr);
    switch (_mv_232.tag) {
        case types_SExpr_num:
        {
            __auto_type _ = _mv_232.data.num;
            return expr_transpile_literal(ctx, expr);
        }
        case types_SExpr_str:
        {
            __auto_type _ = _mv_232.data.str;
            return expr_transpile_literal(ctx, expr);
        }
        case types_SExpr_sym:
        {
            __auto_type _ = _mv_232.data.sym;
            return expr_transpile_literal(ctx, expr);
        }
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_232.data.lst;
...
slop_string expr_transpile_list_expr(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 1) {
            ...
            __auto_type _mv_233 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_233.has_value) {
                __auto_type head_expr = _mv_233.value;
                __auto_type _mv_234 = (*head_expr);
                switch (_mv_234.tag) {
                    case types_SExpr_sym:
                    {
                        __auto_type head_sym = _mv_234.data.sym;
                        {
                            __auto_type op = head_sym.name;
                            if (expr_is_binop(op) && (len < 3)) {
                                ...
                                if (len > 3) {
                                    ...
                                    if (_mv_235.has_value) {
                                        __auto_type left = _mv_235.value;
                                        ...
                                        if (_mv_236.has_value) {
                                            __auto_type right = _mv_236.value;
                                            {
                                ...
                                if (_mv_237.has_value) {
                                    __auto_type left = _mv_237.value;
                                    __auto_type _mv_238 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    if (_mv_238.has_value) {
                                        __auto_type right = _mv_238.value;
                                        {
                                            __auto_type left_c = expr_transpile_expr(ctx, left);
                                            __auto_type right_c = expr_transpile_expr(ctx, right);
                                ...
                                if (_mv_240.has_value) {
                                    __auto_type cond_expr = _mv_240.value;
                                    ...
                                    if (_mv_241.has_value) {
                                        __auto_type then_expr = _mv_241.value;
                                        ...
                                        if (_mv_242.has_value) {
                                            __auto_type else_expr = _mv_242.value;
                                            {
                                ...
                                if (_mv_244.has_value) {
                                    ...
                                    if (_mv_245.has_value) {
                                        __auto_type field_expr = _mv_245.value;
                                        __auto_type _mv_246 = (*field_expr);
                                        switch (_mv_246.tag) {
                                            case types_SExpr_sym:
                                            {
                                                __auto_type field_sym = _mv_246.data.sym;
                                                {
                                ...
                                if (_mv_247.has_value) {
                                    ...
                                    __auto_type _mv_248 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    if (_mv_248.has_value) {
                                        __auto_type val_expr = _mv_248.value;
                                        {
                                ...
                                if (_mv_249.has_value) {
                                    __auto_type str_expr = _mv_249.value;
                                    __auto_type _mv_250 = (*str_expr);
                                    switch (_mv_250.tag) {
                                        case types_SExpr_str:
                                        {
                                            __auto_type str = _mv_250.data.str;
                                            return str.value;
                                        }
                                        default: {
                                ...
                                if (_mv_254.has_value) {
                                    __auto_type arr_expr = _mv_254.value;
                                    __auto_type _mv_255 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    if (_mv_255.has_value) {
                                        __auto_type idx_expr = _mv_255.value;
                                        {
                                ...
                                if (_mv_256.has_value) {
                                    ...
                                    if (_mv_257.has_value) {
                                        __auto_type size_expr = _mv_257.value;
                                        {
                                            __auto_type arena_c = expr_transpile_expr(ctx, arena_expr);
                                            __auto_type _mv_258 = (*size_expr);
                                            switch (_mv_258.tag) {
                                                case types_SExpr_sym:
                                                {
                                                    __auto_type sym = _mv_258.data.sym;
                                                    {
                                                        ...
                                                        __auto_type _mv_259 = context_ctx_lookup_type(ctx, type_name);
                                                        if (_mv_259.has_value) {
                                                            __auto_type entry = _mv_259.value;
                                                            {
                                ...
                                if (_mv_260.has_value) {
                                    __auto_type size_expr = _mv_260.value;
                                    {
                                        __auto_type size_c = expr_transpile_expr(ctx, size_expr);
                                ...
                                if (_mv_262.has_value) {
                                    __auto_type variant_expr = _mv_262.value;
                                    __auto_type _mv_263 = (*variant_expr);
                                    switch (_mv_263.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type sym = _mv_263.data.sym;
                                            {
                                ...
                                if (_mv_264.has_value) {
                                    __auto_type type_expr = _mv_264.value;
                                    __auto_type _mv_265 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    if (_mv_265.has_value) {
                                        __auto_type tag_expr = _mv_265.value;
                                        __auto_type _mv_266 = (*type_expr);
                                        switch (_mv_266.tag) {
                                            case types_SExpr_sym:
                                            {
                                                __auto_type type_sym = _mv_266.data.sym;
                                                __auto_type _mv_267 = expr_extract_symbol_name(tag_expr);
                                                if (_mv_267.has_value) {
                                                    __auto_type tag_str = _mv_267.value;
                                                    {
                                                        ...
                                                        if (len >= 5) {
                                                            {
                                                                ...
                                                                for (int64_t vi = 3; vi < len; vi++) {
                                                                    __auto_type _mv_268 = ({ __auto_type _lst = items; size_t _idx = (size_t)vi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                            ...
                                                            __auto_type _mv_269 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                ...
                                if (_mv_271.has_value) {
                                    __auto_type val_expr = _mv_271.value;
                                    {
                                        __auto_type val_c = expr_transpile_expr(ctx, val_expr);
                                ...
                                if (_mv_272.has_value) {
                                    __auto_type result_expr = _mv_272.value;
                                    {
                                        __auto_type result_c = expr_transpile_expr(ctx, result_expr);
                                        __auto_type _mv_273 = context_ctx_get_current_result_type(ctx);
                                        if (_mv_273.has_value) {
                                            __auto_type enclosing_type = _mv_273.value;
                                ...
                                if (_mv_274.has_value) {
                                    __auto_type opt_expr = _mv_274.value;
                                    {
                                ...
                                if (_mv_276.has_value) {
                                    ...
                                    if (_mv_277.has_value) {
                                        __auto_type idx_expr = _mv_277.value;
                                        {
                                            __auto_type list_c = expr_transpile_expr(ctx, list_expr);
                                            __auto_type idx_c = expr_transpile_expr(ctx, idx_expr);
                                ...
                                if (_mv_278.has_value) {
                                    __auto_type list_expr = _mv_278.value;
                                    {
                                        __auto_type list_c = expr_transpile_expr(ctx, list_expr);
                                        __auto_type option_type = expr_infer_list_element_option_type(ctx, list_expr);
                                        if (string_len(option_type) > 0) {
                                ...
                                if (_mv_281.has_value) {
                                    __auto_type list_expr = _mv_281.value;
                                    ...
                                    if (_mv_282.has_value) {
                                        __auto_type item_expr = _mv_282.value;
                                        {
                                            __auto_type list_c = expr_transpile_expr(ctx, list_expr);
                                ...
                                __auto_type _mv_283 = context_ctx_get_current_return_type(ctx);
                                if (_mv_283.has_value) {
                                    __auto_type ret_type = _mv_283.value;
                    ...
                    default: {
                        {
                            ...
                            __auto_type i = 1;
                            while (i < len) {
                                __auto_type _mv_284 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        if (string_eq(fn_name, SLOP_STR("println"))) {
            ...
            if (len < 3) {
                ...
                if (_mv_289.has_value) {
                    __auto_type a_expr = _mv_289.value;
                    ...
                    if (_mv_290.has_value) {
                        __auto_type b_expr = _mv_290.value;
                        {
                            __auto_type a_c = expr_transpile_expr(ctx, a_expr);
                            __auto_type b_c = expr_transpile_expr(ctx, b_expr);
                            __auto_type s1 = string_concat(arena, SLOP_STR("(("), a_c);
            ...
            if (len < 3) {
                ...
                if (_mv_291.has_value) {
                    __auto_type fn_expr = _mv_291.value;
            ...
            if (len < 4) {
                ...
                if (_mv_292.has_value) {
                    ...
                    if (_mv_293.has_value) {
                        __auto_type arena_expr = _mv_293.value;
                        __auto_type _mv_294 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_294.has_value) {
                            __auto_type cap_expr = _mv_294.value;
                            {
            ...
            if (len < 3) {
                ...
                if (_mv_295.has_value) {
                    ...
                    if (_mv_296.has_value) {
                        __auto_type arena_expr = _mv_296.value;
                        {
                            __auto_type elem_c = context_to_c_type_prefixed(ctx, type_expr);
                            __auto_type elem_id = ctype_type_to_identifier(arena, elem_c);
                            __auto_type chan_type = context_ctx_str(ctx, SLOP_STR("slop_chan_"), elem_id);
            ...
            if (len < 3) {
                ...
                if (_mv_297.has_value) {
                    ...
                    if (_mv_298.has_value) {
                        __auto_type value_expr = _mv_298.value;
                        {
            ...
            if (len < 2) {
                ...
                if (_mv_299.has_value) {
                    __auto_type chan_expr = _mv_299.value;
                    {
                        __auto_type chan_c = expr_transpile_expr(ctx, chan_expr);
                        __auto_type chan_c_type = expr_infer_expr_c_type(ctx, chan_expr);
                        {
        ...
        } else {
            {
                ...
                if (string_len(builtin_c_name) > 0) {
                    ...
                    __auto_type _mv_300 = context_ctx_lookup_type(ctx, fn_name);
                    if (_mv_300.has_value) {
                        __auto_type type_entry = _mv_300.value;
                        ...
                        __auto_type _mv_302 = context_ctx_lookup_enum_variant(ctx, fn_name);
                        if (_mv_302.has_value) {
                            __auto_type type_name = _mv_302.value;
                            {
                                ...
                                if (len > 2) {
                                    {
                                        ...
                                        __auto_type vi = 1;
                                        while (vi < len) {
                                            __auto_type _mv_303 = ({ __auto_type _lst = items; size_t _idx = (size_t)vi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_303.has_value) {
                                                __auto_type v = _mv_303.value;
                                                {
                                    ...
                                    if (_mv_304.has_value) {
                                        __auto_type value_expr = _mv_304.value;
                                        {
                                            __auto_type value_c = expr_transpile_expr(ctx, value_expr);
                        ...
                        } else if (!_mv_302.has_value) {
                            {
                                ...
                                if (!_mv_305.has_value) {
                                    ...
                                    while (i < len) {
                                        __auto_type _mv_307 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    ...
    SLOP_PRE(((arg != NULL)), "(!= arg nil)");
    {
        ...
        switch (_mv_308.tag) {
            ...
            default: {
                {
                    __auto_type arg_c = expr_transpile_expr(ctx, arg);
                    __auto_type _mv_309 = expr_get_expr_type_hint(ctx, arg);
                    if (_mv_309.has_value) {
                        __auto_type type_hint = _mv_309.value;
...
slop_string expr_transpile_raw_string_fn_call(context_TranspileContext* ctx, slop_string fn_name, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 1;
        while (i < len) {
            __auto_type _mv_311 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_311.has_value) {
                __auto_type arg = _mv_311.value;
                {
                    __auto_type arg_c = ({ __auto_type _mv = (*arg); slop_string _mr = {0}; switch (_mv.tag) { case types_SExpr_str: { __auto_type s = _mv.data.str; _mr = context_ctx_str3(ctx, SLOP_STR("\""), expr_escape_c_string(ctx, s.value), SLOP_STR("\"")); break; } default: { _mr = expr_transpile_expr(ctx, arg); break; }  } _mr; });
                    if (string_eq(args, SLOP_STR(""))) {
                        args = arg_c;
        ...
        if (string_eq(slop_type, SLOP_STR("String"))) {
            ...
            switch (_mv_312.tag) {
                case types_SExpr_sym:
                {
                    ...
                    __auto_type _mv_313 = context_ctx_lookup_var(ctx, sym.name);
                    if (_mv_313.has_value) {
                        __auto_type entry = _mv_313.value;
                        {
                ...
                case types_SExpr_lst:
                {
                    __auto_type lst = _mv_312.data.lst;
                    {
                        __auto_type items = lst.items;
                        if (((int64_t)((items).len)) >= 1) {
                            __auto_type _mv_314 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_314.has_value) {
                                ...
                                switch (_mv_315.tag) {
                                    case types_SExpr_sym:
                                    {
                                        __auto_type head_sym = _mv_315.data.sym;
                                        {
                                            __auto_type op = head_sym.name;
                                            if (string_eq(op, SLOP_STR(".")) && (((int64_t)((items).len)) >= 3)) {
                                                {
                                                    ...
                                                    if (string_eq(c_type, SLOP_STR("slop_string"))) {
                                                        ...
                                                        if (_mv_316.has_value) {
                                                            __auto_type obj_expr = _mv_316.value;
                                                            ...
                                                            if (_mv_317.has_value) {
                                                                __auto_type field_expr = _mv_317.value;
                                                                __auto_type _mv_318 = (*field_expr);
                                                                switch (_mv_318.tag) {
                                                                    case types_SExpr_sym:
                                                                    {
                                                                        __auto_type field_sym = _mv_318.data.sym;
                                                                        {
                                                                            __auto_type field_name = field_sym.name;
                                                                            __auto_type obj_slop_type = expr_infer_expr_slop_type(ctx, obj_expr);
                                                                            if (string_len(obj_slop_type) > 0) {
                                                                                __auto_type _mv_319 = context_ctx_lookup_field_slop_type(ctx, obj_slop_type, field_name);
                                                                                if (_mv_319.has_value) {
                                                                                    __auto_type fst = _mv_319.value;
                                                ...
                                                __auto_type _mv_320 = context_ctx_lookup_func(ctx, op);
                                                if (_mv_320.has_value) {
                                                    __auto_type func_entry = _mv_320.value;
                                                    if (func_entry.returns_string) {
                                                        return (slop_option_string){.has_value = 1, .value = SLOP_STR("slop_string")};
                                                    } else {
                                                        return (slop_option_string){.has_value = false};
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 2) {
            ...
            if (_mv_321.has_value) {
                __auto_type tag_expr = _mv_321.value;
                __auto_type _mv_322 = (*tag_expr);
                switch (_mv_322.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type tag_list = _mv_322.data.lst;
                        {
                            __auto_type tag_items = tag_list.items;
                            if (((int64_t)((tag_items).len)) < 1) {
                                return context_ctx_str3(ctx, SLOP_STR("(("), c_type_name, SLOP_STR("){})"));
                            } else {
                                __auto_type _mv_323 = ({ __auto_type _lst = tag_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_323.has_value) {
                                    __auto_type tag_name_expr = _mv_323.value;
                                    __auto_type _mv_324 = (*tag_name_expr);
                                    switch (_mv_324.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type tag_sym = _mv_324.data.sym;
                                            {
                                                ...
                                                if (num_tag_items >= 3) {
                                                    {
                                                        ...
                                                        for (int64_t fi = 1; fi < num_tag_items; fi++) {
                                                            __auto_type _mv_325 = ({ __auto_type _lst = tag_items; size_t _idx = (size_t)fi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    ...
                                                    __auto_type _mv_326 = ({ __auto_type _lst = tag_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_326.has_value) {
                                                        __auto_type value_expr = _mv_326.value;
                                                        {
                                                            __auto_type value_c = expr_transpile_expr(ctx, value_expr);
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_327.has_value) {
                __auto_type clause_expr = _mv_327.value;
                __auto_type _mv_328 = (*clause_expr);
                switch (_mv_328.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type clause_lst = _mv_328.data.lst;
                        {
                            ...
                            if (clause_len >= 2) {
                                __auto_type _mv_329 = ({ __auto_type _lst = clause_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_329.has_value) {
                                    __auto_type test_expr = _mv_329.value;
                                    __auto_type _mv_330 = (*test_expr);
                                    switch (_mv_330.tag) {
                                        case types_SExpr_sym:
                                        {
                                        ...
                                        default: {
                                            {
                                                __auto_type test_c = expr_transpile_expr(ctx, test_expr);
                                                __auto_type _mv_333 = ({ __auto_type _lst = clause_items; size_t _idx = (size_t)(clause_len - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 3) {
            ...
            if (_mv_334.has_value) {
                __auto_type scrutinee = _mv_334.value;
                {
                    ...
                    case types_SExpr_lst:
                    {
                        __auto_type branch_lst = _mv_336.data.lst;
                        {
                            ...
                            if (((int64_t)((branch_items).len)) >= 1) {
                                __auto_type _mv_337 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_string expr_get_expr_pattern_tag(types_SExpr* pat_expr) {
    ...
    __auto_type _mv_338 = (*pat_expr);
    switch (_mv_338.tag) {
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_338.data.lst;
            {
                __auto_type items = lst.items;
                if (((int64_t)((items).len)) < 1) {
                    return SLOP_STR("");
                } else {
                    __auto_type _mv_339 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_339.has_value) {
                        __auto_type head = _mv_339.value;
                        __auto_type _mv_340 = (*head);
                        switch (_mv_340.tag) {
                            case types_SExpr_sym:
                            {
...
uint8_t expr_is_enum_expr_patterns(context_TranspileContext* ctx, slop_list_types_SExpr_ptr patterns) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while ((i < len) && all_symbols) {
            __auto_type _mv_343 = ({ __auto_type _lst = patterns; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_343.has_value) {
                __auto_type pat_expr = _mv_343.value;
                __auto_type _mv_344 = (*pat_expr);
                switch (_mv_344.tag) {
                    case types_SExpr_sym:
                    {
                        __auto_type s = _mv_344.data.sym;
                        {
                            __auto_type name = s.name;
                            if (!(string_eq(name, SLOP_STR("else"))) && !(string_eq(name, SLOP_STR("_")))) {
                                __auto_type _mv_345 = context_ctx_lookup_enum_variant(ctx, name);
...
uint8_t expr_is_union_expr_patterns(context_TranspileContext* ctx, slop_list_types_SExpr_ptr patterns) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while ((i < len) && !(has_union_variant)) {
            __auto_type _mv_346 = ({ __auto_type _lst = patterns; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_346.has_value) {
                __auto_type pat_expr = _mv_346.value;
                {
                    ...
                    if ((!(string_eq(tag, SLOP_STR("")))) && (!(string_eq(tag, SLOP_STR("some")))) && (!(string_eq(tag, SLOP_STR("none")))) && (!(string_eq(tag, SLOP_STR("ok")))) && (!(string_eq(tag, SLOP_STR("error")))) && (!(string_eq(tag, SLOP_STR("else")))) && (!(string_eq(tag, SLOP_STR("_"))))) {
                        __auto_type _mv_347 = context_ctx_lookup_enum_variant(ctx, tag);
                        if (_mv_347.has_value) {
                            __auto_type _ = _mv_347.value;
                            has_union_variant = 1;
            ...
            __auto_type lst = _mv_348.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 2) {
                    ...
                    if (_mv_349.has_value) {
                        __auto_type binding = _mv_349.value;
                        __auto_type _mv_350 = (*binding);
                        switch (_mv_350.tag) {
                            case types_SExpr_sym:
                            {
...
slop_string expr_get_match_branch_body(context_TranspileContext* ctx, slop_list_types_SExpr_ptr branch_items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 2) {
            ...
            __auto_type _mv_351 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)(len - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_string expr_build_option_match_expr(context_TranspileContext* ctx, types_SExpr* scrutinee, slop_string scrutinee_c, slop_list_types_SExpr_ptr items) {
    ...
    SLOP_PRE(((scrutinee != NULL)), "(!= scrutinee nil)");
    {
        ...
        int64_t i = 2;
        while (i < len) {
            __auto_type _mv_352 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    ...
                    case types_SExpr_lst:
                    {
                        __auto_type branch_lst = _mv_353.data.lst;
                        {
                            ...
                            if (((int64_t)((branch_items).len)) >= 2) {
                                __auto_type _mv_354 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 2) {
            ...
            if (_mv_356.has_value) {
                __auto_type first_clause = _mv_356.value;
                __auto_type _mv_357 = (*first_clause);
                switch (_mv_357.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type clause_lst = _mv_357.data.lst;
                        {
                            __auto_type clause_items = clause_lst.items;
                            __auto_type clause_len = ((int64_t)((clause_items).len));
                            if (clause_len < 2) {
                                ...
                                __auto_type _mv_358 = ({ __auto_type _lst = clause_items; size_t _idx = (size_t)(clause_len - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        case types_SExpr_lst:
        {
            __auto_type branch_lst = _mv_359.data.lst;
            {
                ...
                if (branch_len < 2) {
                    ...
                    __auto_type _mv_360 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)(branch_len - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_360.has_value) {
                        __auto_type body_expr = _mv_360.value;
                        return expr_infer_expr_c_type(ctx, body_expr);
        ...
        if (len < 3) {
            ...
            while ((i < len) && string_eq(result, SLOP_STR("__type_error__"))) {
                ...
                if (_mv_361.has_value) {
                    __auto_type branch = _mv_361.value;
...
slop_string expr_slop_type_to_c_type(context_TranspileContext* ctx, slop_string slop_type) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_362 = context_ctx_lookup_type(ctx, slop_type);
...
slop_string expr_infer_expr_c_type(context_TranspileContext* ctx, types_SExpr* expr) {
    ...
    SLOP_PRE(((expr != NULL)), "(!= expr nil)");
    {
        ...
        if (string_len(checker_type) > 0) {
            ...
            __auto_type _mv_363 = (*expr);
            switch (_mv_363.tag) {
                case types_SExpr_str:
                {
                    __auto_type _ = _mv_363.data.str;
                    return SLOP_STR("slop_string");
                }
                case types_SExpr_num:
                {
                    __auto_type num = _mv_363.data.num;
                    if (num.is_float) {
                        return SLOP_STR("double");
                    } else {
                        return SLOP_STR("int64_t");
                ...
                case types_SExpr_sym:
                {
                    ...
                    {
                        __auto_type name = sym.name;
                        __auto_type _mv_364 = context_ctx_lookup_var(ctx, name);
                        if (_mv_364.has_value) {
                            __auto_type entry = _mv_364.value;
                            {
                ...
                case types_SExpr_lst:
                {
                    __auto_type lst = _mv_363.data.lst;
                    {
                        __auto_type items = lst.items;
                        if (((int64_t)((items).len)) < 1) {
                            return SLOP_STR("int64_t");
                        } else {
                            __auto_type _mv_365 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_365.has_value) {
                                __auto_type head = _mv_365.value;
                                __auto_type _mv_366 = (*head);
                                switch (_mv_366.tag) {
                                    case types_SExpr_sym:
                                    {
                                            ...
                                            if (({ __auto_type _mv = context_ctx_lookup_func(ctx, op); _mv.has_value ? ({ __auto_type func_entry = _mv.value; func_entry.returns_string; }) : (0); })) {
                                                ...
                                                if (((int64_t)((items).len)) < 2) {
                                                    ...
                                                    if (_mv_368.has_value) {
                                                        __auto_type last_expr = _mv_368.value;
                                                ...
                                                if (((int64_t)((items).len)) < 3) {
                                                    ...
                                                    __auto_type _mv_369 = ({ __auto_type _lst = items; size_t _idx = (size_t)(((int64_t)((items).len)) - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_369.has_value) {
                                                        __auto_type body = _mv_369.value;
                                                        return expr_infer_expr_c_type(ctx, body);
                                                ...
                                                __auto_type _mv_372 = context_ctx_get_current_return_type(ctx);
                                                if (_mv_372.has_value) {
                                                    __auto_type ret_type = _mv_372.value;
                                                    if (strlib_starts_with(ret_type, SLOP_STR("slop_option_"))) {
                                                        return ret_type;
                                                    } else {
                                                        return SLOP_STR("slop_option_int");
                                                ...
                                                if (((int64_t)((items).len)) < 2) {
                                                    ...
                                                    if (_mv_376.has_value) {
                                                        __auto_type chan_arg = _mv_376.value;
                                                        {
                                                ...
                                                if (((int64_t)((items).len)) < 3) {
                                                    ...
                                                    if (_mv_379.has_value) {
                                                        __auto_type type_expr = _mv_379.value;
                                                        {
                                                ...
                                                if (((int64_t)((items).len)) < 2) {
                                                    ...
                                                    if (_mv_380.has_value) {
                                                        __auto_type list_arg = _mv_380.value;
                                                        {
                                                ...
                                                __auto_type _mv_381 = context_ctx_lookup_type(ctx, op);
                                                if (_mv_381.has_value) {
                                                    __auto_type type_entry = _mv_381.value;
                                                    return type_entry.c_name;
                                                } else if (!_mv_381.has_value) {
                                                    __auto_type _mv_382 = context_ctx_lookup_func(ctx, op);
                                                    if (_mv_382.has_value) {
                                                        __auto_type func_entry = _mv_382.value;
                                                        {
                                                            __auto_type ret_type = func_entry.return_type;
                                                            if (func_entry.returns_string) {
                                                                return SLOP_STR("slop_string");
                                ...
                                if (_mv_385.has_value) {
                                    __auto_type pattern = _mv_385.value;
                                    {
                                        ...
                                        if (string_eq(tag, SLOP_STR("ok"))) {
                                            ...
                                            __auto_type _mv_387 = expr_get_expr_binding_name(pattern);
                                            if (_mv_387.has_value) {
                                                __auto_type name = _mv_387.value;
                                                err_binding = name;
...
slop_string expr_build_enum_match_expr(context_TranspileContext* ctx, slop_string scrutinee_c, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 2;
        while (i < len) {
            __auto_type _mv_388 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_388.has_value) {
                __auto_type branch = _mv_388.value;
                __auto_type _mv_389 = (*branch);
                switch (_mv_389.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type branch_lst = _mv_389.data.lst;
                        {
                            __auto_type branch_items = branch_lst.items;
                            if (((int64_t)((branch_items).len)) >= 2) {
                                __auto_type _mv_390 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_390.has_value) {
                                    __auto_type pattern = _mv_390.value;
        ...
        switch (_mv_395.tag) {
            case types_SExpr_sym:
            {
                __auto_type sym = _mv_395.data.sym;
                {
                    ...
                    __auto_type _mv_396 = context_ctx_lookup_func(ctx, slop_name);
                    if (_mv_396.has_value) {
                        __auto_type func_entry = _mv_396.value;
                        {
        ...
        if (context_ctx_skip_trampoline_generation(ctx)) {
            ...
            if (context_ctx_has_trampoline(ctx, fn_c_name)) {
            ...
            } else {
                {
                    ...
                    int64_t i = 0;
                    while (i < count) {
                        __auto_type _mv_397 = ({ __auto_type _lst = param_types; size_t _idx = (size_t)i; slop_option_context_FuncParamType_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_397.has_value) {
                            __auto_type param_type_ptr = _mv_397.value;
                            {
        ...
        if (string_eq(tag, SLOP_STR("else")) || string_eq(tag, SLOP_STR("_"))) {
            ...
            if (_mv_398.has_value) {
                __auto_type type_name = _mv_398.value;
                {
                    ...
                    __auto_type _mv_399 = binding_opt;
                    if (_mv_399.has_value) {
                        __auto_type binding_name = _mv_399.value;
                        {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i >= 2) {
            ...
            if (_mv_400.has_value) {
                __auto_type branch = _mv_400.value;
                __auto_type _mv_401 = (*branch);
                switch (_mv_401.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type branch_lst = _mv_401.data.lst;
                        {
                            __auto_type branch_items = branch_lst.items;
                            if (((int64_t)((branch_items).len)) >= 2) {
                                __auto_type _mv_402 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
uint8_t expr_discard_needs_void(types_SExpr* e) {
    __auto_type _mv_403 = (*e);
    switch (_mv_403.tag) {
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_403.data.lst;
            __auto_type _mv_404 = ({ __auto_type _lst = lst.items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_404.has_value) {
                __auto_type head = _mv_404.value;
                __auto_type _mv_405 = (*head);
                switch (_mv_405.tag) {
                    case types_SExpr_sym:
                    {
                        __auto_type sym = _mv_405.data.sym;
                        {
                            __auto_type name = sym.name;
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 3) {
            ...
            if (_mv_406.has_value) {
                __auto_type bindings_expr = _mv_406.value;
                __auto_type _mv_407 = (*bindings_expr);
                switch (_mv_407.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type bindings_lst = _mv_407.data.lst;
                        context_ctx_push_scope(ctx);
                        {
                            __auto_type result = SLOP_STR("({ ");
                            ...
                            bi = 0;
                            while (bi < bindings_len) {
                                __auto_type _mv_409 = ({ __auto_type _lst = bindings_items; size_t _idx = (size_t)bi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_409.has_value) {
                                    __auto_type binding = _mv_409.value;
                                    {
...
void expr_register_let_binding_in_context(context_TranspileContext* ctx, types_SExpr* binding) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_411 = (*binding);
        switch (_mv_411.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_411.data.lst;
                {
                    __auto_type items = lst.items;
                    __auto_type len = ((int64_t)((items).len));
                    if (len >= 2) {
                        {
                            ...
                            __auto_type _mv_412 = ({ __auto_type _lst = items; size_t _idx = (size_t)name_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_412.has_value) {
                                __auto_type name_expr = _mv_412.value;
                                __auto_type _mv_413 = (*name_expr);
                                switch (_mv_413.tag) {
                                    case types_SExpr_sym:
                                    {
                                        __auto_type name_sym = _mv_413.data.sym;
                                        {
...
slop_string expr_transpile_binding_expr(context_TranspileContext* ctx, types_SExpr* binding) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_414 = (*binding);
        switch (_mv_414.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_414.data.lst;
                {
                    __auto_type items = lst.items;
                    __auto_type len = ((int64_t)((items).len));
                    if (len < 2) {
                    ...
                    } else {
                        {
                            __auto_type has_mut = expr_binding_has_mut(items);
                            __auto_type name_idx = ((has_mut) ? 1 : 0);
                            __auto_type _mv_415 = ({ __auto_type _lst = items; size_t _idx = (size_t)name_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_415.has_value) {
                                __auto_type name_expr = _mv_415.value;
                                __auto_type _mv_416 = (*name_expr);
                                switch (_mv_416.tag) {
                                    case types_SExpr_sym:
                                    {
                                        __auto_type name_sym = _mv_416.data.sym;
                                        {
                                            ...
                                            __auto_type init_idx = ((has_mut) ? ((has_type) ? 3 : 2) : ((has_type) ? 2 : 1));
                                            if (has_type) {
                                                __auto_type _mv_417 = ({ __auto_type _lst = items; size_t _idx = (size_t)type_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_417.has_value) {
                                                    __auto_type type_expr = _mv_417.value;
                                                    {
                                                        __auto_type c_type = context_to_c_type_prefixed(ctx, type_expr);
                                                ...
                                                __auto_type _mv_420 = ({ __auto_type _lst = items; size_t _idx = (size_t)init_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_420.has_value) {
                                                    __auto_type init_expr = _mv_420.value;
                                                    {
                                                        __auto_type init_c = expr_transpile_expr(ctx, init_expr);
                                                        return context_ctx_str5(ctx, SLOP_STR("__auto_type "), var_name, SLOP_STR(" = "), init_c, SLOP_STR(";"));
                                                    }
...
uint8_t expr_binding_has_mut(slop_list_types_SExpr_ptr items) {
    if (((int64_t)((items).len)) < 1) {
        ...
        __auto_type _mv_421 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        if (_mv_421.has_value) {
            __auto_type first = _mv_421.value;
            __auto_type _mv_422 = (*first);
            switch (_mv_422.tag) {
                case types_SExpr_sym:
                {
...
slop_string expr_transpile_typed_init(context_TranspileContext* ctx, types_SExpr* init_expr, slop_string target_type) {
    ...
    __auto_type _mv_423 = (*init_expr);
    switch (_mv_423.tag) {
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_423.data.lst;
            {
                __auto_type items = lst.items;
                if (((int64_t)((items).len)) < 1) {
                    return expr_transpile_expr(ctx, init_expr);
                } else {
                    __auto_type _mv_424 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    ...
                                    if (string_eq(op, SLOP_STR("some"))) {
                                        if (((int64_t)((items).len)) < 2) {
                                            ...
                                            if (_mv_426.has_value) {
                                                __auto_type val_expr = _mv_426.value;
                                                {
                                                    __auto_type val_c = expr_transpile_expr(ctx, val_expr);
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 3) {
            ...
            if (_mv_427.has_value) {
                __auto_type cond_expr = _mv_427.value;
                {
                    __auto_type cond_c = expr_transpile_expr(ctx, cond_expr);
        ...
        } else {
            {
                ...
                while (i < len) {
                    ...
                    if (_mv_429.has_value) {
                        __auto_type expr = _mv_429.value;
                        {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 2) {
            ...
            if (_mv_430.has_value) {
                __auto_type cond_expr = _mv_430.value;
                {
                    __auto_type cond_c = expr_transpile_expr(ctx, cond_expr);
...
uint8_t expr_set_is_self_assign(slop_list_types_SExpr_ptr items) {
    if (((int64_t)((items).len)) == 3) {
        ...
        if (_mv_432.has_value) {
            __auto_type target_expr = _mv_432.value;
            __auto_type _mv_433 = (*target_expr);
            switch (_mv_433.tag) {
                case types_SExpr_sym:
                {
                    __auto_type tsym = _mv_433.data.sym;
                    ...
                    if (_mv_434.has_value) {
                        __auto_type value_expr = _mv_434.value;
                        __auto_type _mv_435 = (*value_expr);
                        switch (_mv_435.tag) {
                            case types_SExpr_sym:
                            {
                                __auto_type vsym = _mv_435.data.sym;
        ...
        if (expr_set_is_self_assign(items)) {
            ...
            if (len < 3) {
                ...
                if (_mv_436.has_value) {
                    __auto_type target_expr = _mv_436.value;
                    __auto_type _mv_437 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_437.has_value) {
                        __auto_type val_expr = _mv_437.value;
                        {
                            __auto_type val_c = expr_transpile_expr(ctx, val_expr);
                            __auto_type _mv_438 = (*target_expr);
                            switch (_mv_438.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type target_lst = _mv_438.data.lst;
                                    {
                                        ...
                                        if (((int64_t)((target_items).len)) < 1) {
                                            ...
                                            __auto_type _mv_439 = ({ __auto_type _lst = target_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                        ...
                                                        __auto_type sym = _mv_440.data.sym;
                                                        {
                                                            ...
                                                            if (string_eq(op, SLOP_STR("@"))) {
                                                                if (((int64_t)((target_items).len)) < 3) {
                                                                    ...
                                                                    __auto_type _mv_441 = ({ __auto_type _lst = target_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                                    if (_mv_441.has_value) {
                                                                        __auto_type arr_expr = _mv_441.value;
                                                                        __auto_type _mv_442 = ({ __auto_type _lst = target_items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                                        if (_mv_442.has_value) {
                                                                            __auto_type idx_expr = _mv_442.value;
                                                                            {
                                                                                __auto_type arr_c = expr_transpile_expr(ctx, arr_expr);
                                                                                __auto_type idx_c = expr_transpile_expr(ctx, idx_expr);
...
slop_string expr_resolve_arena_c_name(context_TranspileContext* ctx, slop_string op, slop_list_types_SExpr_ptr items) {
    ...
    if (_mv_443.has_value) {
        ...
        __auto_type _mv_444 = context_ctx_find_arena_var(ctx);
...
slop_string expr_get_arena_for_list_push_expr(context_TranspileContext* ctx, types_SExpr* list_expr, slop_string list_c) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    SLOP_PRE(((list_expr != NULL)), "(!= list-expr nil)");
    __auto_type _mv_445 = context_ctx_lookup_var(ctx, SLOP_STR("arena"));
    if (_mv_445.has_value) {
        __auto_type arena_var = _mv_445.value;
        return arena_var.c_name;
    } else if (!_mv_445.has_value) {
        __auto_type _mv_446 = context_ctx_lookup_var(ctx, SLOP_STR("ctx"));
        if (_mv_446.has_value) {
            __auto_type ctx_var = _mv_446.value;
        ...
        } else if (!_mv_446.has_value) {
            {
                ...
                if (string_len(arena_from_field) > 0) {
                    ...
                    __auto_type _mv_447 = context_ctx_find_arena_var(ctx);
                    if (_mv_447.has_value) {
                        __auto_type arena_entry = _mv_447.value;
                            ...
                            case types_SExpr_sym:
                            {
                                ...
                                if (string_eq(sym.name, SLOP_STR("."))) {
                                    ...
                                    if (_mv_451.has_value) {
                                        __auto_type base_expr = _mv_451.value;
...
slop_string expr_get_arena_from_base(context_TranspileContext* ctx, types_SExpr* base_expr) {
    ...
    switch (_mv_452.tag) {
        case types_SExpr_sym:
        {
            ...
            {
                __auto_type var_name = sym.name;
                __auto_type _mv_453 = context_ctx_lookup_var(ctx, var_name);
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_452.data.lst;
            {
                __auto_type items = lst.items;
                if (((int64_t)((items).len)) < 2) {
                    return SLOP_STR("arena");
                } else {
                    __auto_type _mv_454 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_454.has_value) {
                        __auto_type head_expr = _mv_454.value;
                        __auto_type _mv_455 = (*head_expr);
                        switch (_mv_455.tag) {
                            case types_SExpr_sym:
                            {
                                ...
                                if (string_eq(sym.name, SLOP_STR("deref"))) {
                                    ...
                                    if (_mv_456.has_value) {
                                        __auto_type ptr_expr = _mv_456.value;
                                        {
...
uint8_t expr_is_ptr_to_ptr_map(context_TranspileContext* ctx, types_SExpr* expr) {
    ...
    switch (_mv_457.tag) {
        case types_SExpr_sym:
        {
            ...
            {
                __auto_type name = sym.name;
                __auto_type _mv_458 = context_ctx_lookup_var(ctx, name);
                if (_mv_458.has_value) {
                    __auto_type entry = _mv_458.value;
                    {
                        __auto_type c_type = entry.c_type;
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 2) {
            ...
            if (_mv_459.has_value) {
                __auto_type type_expr = _mv_459.value;
                __auto_type _mv_460 = (*type_expr);
                switch (_mv_460.tag) {
                    case types_SExpr_sym:
                    {
                        __auto_type type_sym = _mv_460.data.sym;
                        {
                            __auto_type raw_type_name = type_sym.name;
                    ...
                    case types_SExpr_lst:
                    {
                        __auto_type type_lst = _mv_460.data.lst;
                        {
                            ...
                            if (((int64_t)((type_items).len)) < 1) {
                                ...
                                __auto_type _mv_461 = ({ __auto_type _lst = type_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_461.has_value) {
                                    ...
                                    switch (_mv_462.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type head_sym = _mv_462.data.sym;
...
slop_string expr_build_inline_struct_type(context_TranspileContext* ctx, slop_list_types_SExpr_ptr type_items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 1;
        while (i < len) {
            __auto_type _mv_468 = ({ __auto_type _lst = type_items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_473.has_value) {
                __auto_type field_expr = _mv_473.value;
                __auto_type _mv_474 = (*field_expr);
                switch (_mv_474.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type field_lst = _mv_474.data.lst;
                        {
                            __auto_type field_items = field_lst.items;
                            if (((int64_t)((field_items).len)) >= 2) {
                                __auto_type _mv_475 = ({ __auto_type _lst = field_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_475.has_value) {
                                    ...
                                    switch (_mv_476.tag) {
                                        case types_SExpr_sym:
                                        {
                                            ...
                                            __auto_type _mv_477 = ({ __auto_type _lst = field_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            ...
            if (_mv_478.has_value) {
                __auto_type type_expr = _mv_478.value;
                {
                    ...
                    __auto_type elem_count = (len - 2);
                    {
                        ...
                        while (i < len) {
                            __auto_type _mv_479 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_479.has_value) {
                                __auto_type elem_expr = _mv_479.value;
                        ...
                        }
                        {
                            ...
                            if (_mv_480.has_value) {
                                ...
                                context_ctx_add_warning(ctx, SLOP_STR("list literal uses stack-allocated compound literal (no arena in scope)"));
                                {
                                    ...
                                    i = 0;
                                    while (i < ((int64_t)((elem_codes).len))) {
                                        __auto_type _mv_482 = ({ __auto_type _lst = elem_codes; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_482.has_value) {
                                            __auto_type ec = _mv_482.value;
                                            if (first) {
...
slop_string expr_get_map_key_c_info(context_TranspileContext* ctx, types_SExpr* key_type_expr) {
    ...
    __auto_type _mv_483 = (*key_type_expr);
    switch (_mv_483.tag) {
        case types_SExpr_sym:
        {
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_483.data.lst;
            {
                __auto_type items = lst.items;
                if (((int64_t)((items).len)) < 1) {
                    return SLOP_STR("sizeof(void*), slop_hash_ptr, slop_eq_ptr");
                } else {
                    __auto_type _mv_484 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_484.has_value) {
                        __auto_type head = _mv_484.value;
                        __auto_type _mv_485 = (*head);
                        switch (_mv_485.tag) {
                            case types_SExpr_sym:
                            {
...
slop_string expr_get_struct_key_info_by_name(context_TranspileContext* ctx, slop_string name) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    __auto_type _mv_486 = context_ctx_lookup_type(ctx, name);
    if (_mv_486.has_value) {
        ...
        __auto_type _mv_487 = context_ctx_get_module(ctx);
        if (_mv_487.has_value) {
            __auto_type mod = _mv_487.value;
            {
                __auto_type prefixed = context_ctx_str3(ctx, mod, SLOP_STR("_"), name);
                __auto_type _mv_488 = context_ctx_lookup_type(ctx, prefixed);
                if (_mv_488.has_value) {
                    __auto_type type_entry = _mv_488.value;
                    {
                        __auto_type c_name = type_entry.c_name;
                        context_ctx_register_struct_key_type(ctx, c_name);
                        return expr_build_struct_key_info(ctx, c_name);
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 3) {
            ...
            if (_mv_490.has_value) {
                __auto_type arena_expr = _mv_490.value;
                ...
                if (_mv_491.has_value) {
                    __auto_type key_type_expr = _mv_491.value;
                    {
                        __auto_type arena_c = expr_transpile_expr(ctx, arena_expr);
        ...
        if (len < 4) {
            ...
            if (_mv_492.has_value) {
                ...
                if (_mv_493.has_value) {
                    ...
                    __auto_type _mv_494 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        if (len < 3) {
            ...
            if (_mv_499.has_value) {
                ...
                if (_mv_500.has_value) {
                    __auto_type key_expr = _mv_500.value;
                    {
                        __auto_type map_c = expr_resolve_container_c(ctx, map_expr);
                        __auto_type key_c = expr_transpile_expr(ctx, key_expr);
                        __auto_type key_ptr = expr_wrap_map_key_as_ptr(ctx, key_c, key_expr, map_expr);
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 2) {
            ...
            if (_mv_501.has_value) {
                __auto_type map_expr = _mv_501.value;
                {
                    __auto_type map_c = expr_resolve_container_c(ctx, map_expr);
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 3) {
            ...
            if (_mv_502.has_value) {
                __auto_type arena_expr = _mv_502.value;
                ...
                if (_mv_503.has_value) {
                    __auto_type elem_type_expr = _mv_503.value;
                    {
                        __auto_type arena_c = expr_transpile_expr(ctx, arena_expr);
        ...
        if (len < 3) {
            ...
            if (_mv_508.has_value) {
                ...
                if (_mv_509.has_value) {
                    __auto_type elem_expr = _mv_509.value;
                    {
                        __auto_type set_c = expr_resolve_container_c(ctx, set_expr);
                        __auto_type elem_c = expr_transpile_expr(ctx, elem_expr);
                        __auto_type elem_ptr = expr_wrap_map_key_as_ptr(ctx, elem_c, elem_expr, set_expr);
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 2) {
            ...
            if (_mv_510.has_value) {
                __auto_type set_expr = _mv_510.value;
                {
                    __auto_type set_c = expr_resolve_container_c(ctx, set_expr);
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 2) {
            ...
            if (_mv_511.has_value) {
                __auto_type type_expr = _mv_511.value;
                {
                    ...
                    __auto_type result = context_ctx_str(ctx, context_ctx_str3(ctx, SLOP_STR("({ slop_map* _s = slop_map_new_ptr("), arena_c, SLOP_STR(", ")), context_ctx_str(ctx, int_to_string(arena, init_cap), context_ctx_str(ctx, SLOP_STR(", "), context_ctx_str(ctx, elem_info, SLOP_STR("); ")))));
                    {
                        ...
                        while (i < len) {
                            ...
                            if (_mv_512.has_value) {
                                __auto_type elem_expr = _mv_512.value;
                                {
                                    __auto_type elem_c = expr_transpile_expr(ctx, elem_expr);
                        ...
                        __auto_type binding_lst = _mv_514.data.lst;
                        {
                            ...
                            if (binding_len < 3) {
                                ...
                                if (_mv_515.has_value) {
                                    __auto_type var_expr = _mv_515.value;
                                    __auto_type _mv_516 = (*var_expr);
                                    switch (_mv_516.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type var_sym = _mv_516.data.sym;
                                            {
                                                ...
                                                if (_mv_517.has_value) {
                                                    __auto_type start_expr = _mv_517.value;
                                                    __auto_type _mv_518 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_518.has_value) {
                                                        __auto_type end_expr = _mv_518.value;
                                                        {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 2) {
            ...
            if (_mv_520.has_value) {
                __auto_type binding_expr = _mv_520.value;
                __auto_type _mv_521 = (*binding_expr);
                switch (_mv_521.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type binding_lst = _mv_521.data.lst;
                        {
                            __auto_type binding_items = binding_lst.items;
                            __auto_type binding_len = ((int64_t)((binding_items).len));
                            if (binding_len < 2) {
                                ...
                                __auto_type _mv_522 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_522.has_value) {
                                    __auto_type first_elem = _mv_522.value;
                                    __auto_type _mv_523 = (*first_elem);
                                    switch (_mv_523.tag) {
                                        case types_SExpr_lst:
                                        {
                                            __auto_type _ = _mv_523.data.lst;
                                            return expr_transpile_for_each_map_kv_as_expr(ctx, binding_items, items, len);
                                        }
                                        case types_SExpr_sym:
                                        {
                                            __auto_type var_sym = _mv_523.data.sym;
                                            {
                                                __auto_type var_name = ctype_to_c_name(arena, var_sym.name);
                                                __auto_type _mv_524 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_524.has_value) {
                                                    __auto_type coll_expr = _mv_524.value;
                                                    {
            ...
            context_ctx_bind_var(ctx, (context_VarEntry){var_sym.name, var_name, key_c_type, key_slop_type, 0, 0, 0, SLOP_STR(""), SLOP_STR("")});
            {
                ...
                while (i < len) {
                    ...
                    if (_mv_527.has_value) {
                        __auto_type body_expr = _mv_527.value;
                        {
                            __auto_type body_c = expr_transpile_expr(ctx, body_expr);
                            result = context_ctx_str3(ctx, result, body_c, SLOP_STR("; "));
                        }
...
slop_string expr_transpile_for_each_map_kv_as_expr(context_TranspileContext* ctx, slop_list_types_SExpr_ptr binding_items, slop_list_types_SExpr_ptr items, int64_t len) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_528 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        if (_mv_528.has_value) {
            __auto_type kv_list_expr = _mv_528.value;
            __auto_type _mv_529 = (*kv_list_expr);
            switch (_mv_529.tag) {
                case types_SExpr_lst:
                {
                    __auto_type kv_lst = _mv_529.data.lst;
                    {
                        __auto_type kv_items = kv_lst.items;
                        if (((int64_t)((kv_items).len)) < 2) {
                            return SLOP_STR("({ /* for-each: map binding needs ((k v) map) */ 0; })");
                        } else {
                            __auto_type _mv_530 = ({ __auto_type _lst = kv_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_530.has_value) {
                                __auto_type k_expr = _mv_530.value;
                                __auto_type _mv_531 = ({ __auto_type _lst = kv_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_531.has_value) {
                                    __auto_type v_expr = _mv_531.value;
                                    __auto_type _mv_532 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    if (_mv_532.has_value) {
                                        __auto_type map_expr = _mv_532.value;
                                        __auto_type _mv_533 = (*k_expr);
                                        switch (_mv_533.tag) {
                                            case types_SExpr_sym:
                                            {
                                                __auto_type k_sym = _mv_533.data.sym;
                                                __auto_type _mv_534 = (*v_expr);
                                                switch (_mv_534.tag) {
                                                    case types_SExpr_sym:
                                                    {
                                                        __auto_type v_sym = _mv_534.data.sym;
                                                        {
                                                            ...
                                                            __auto_type val_c_type = expr_slop_value_type_to_c_type(ctx, val_slop_type);
                                                            {
                                                                ...
                                                                context_ctx_bind_var(ctx, (context_VarEntry){v_sym.name, v_name, val_c_type, val_slop_type, 0, 0, 0, SLOP_STR(""), SLOP_STR("")});
                                                                {
                                                                    __auto_type i = 2;
                                                                    while (i < len) {
                                                                        __auto_type _mv_535 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        if (len < 2) {
            ...
            if (_mv_536.has_value) {
                ...
                switch (_mv_537.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type params_lst = _mv_537.data.lst;
                        return expr_transpile_lambda_with_params(ctx, items, params_lst.items);
                    }
                    case types_SExpr_sym:
                    {
                        __auto_type _ = _mv_537.data.sym;
...
slop_list_string expr_extract_param_names(slop_arena* arena, slop_list_types_SExpr_ptr params) {
    {
        ...
        int64_t i = 0;
        while (i < count) {
            __auto_type _mv_538 = ({ __auto_type _lst = params; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_538.has_value) {
                __auto_type param_expr = _mv_538.value;
                __auto_type _mv_539 = (*param_expr);
                switch (_mv_539.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type param_lst = _mv_539.data.lst;
                        {
                            __auto_type param_items = param_lst.items;
                            if (((int64_t)((param_items).len)) >= 1) {
                                __auto_type _mv_540 = ({ __auto_type _lst = param_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_540.has_value) {
                                    __auto_type name_expr = _mv_540.value;
                                    __auto_type _mv_541 = (*name_expr);
                                    switch (_mv_541.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type name_sym = _mv_541.data.sym;
...
slop_string expr_find_arena_ptr_expr(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    __auto_type _mv_545 = context_ctx_lookup_var(ctx, SLOP_STR("_arena"));
    if (_mv_545.has_value) {
        __auto_type entry = _mv_545.value;
        return SLOP_STR("&_arena");
    } else if (!_mv_545.has_value) {
        __auto_type _mv_546 = context_ctx_lookup_var(ctx, SLOP_STR("arena"));
        if (_mv_546.has_value) {
            __auto_type entry = _mv_546.value;
            return entry.c_name;
        } else if (!_mv_546.has_value) {
            __auto_type _mv_547 = context_ctx_find_arena_var(ctx);
            if (_mv_547.has_value) {
                __auto_type entry = _mv_547.value;
                return entry.c_name;
...
slop_string expr_build_env_initializer(context_TranspileContext* ctx, slop_list_string free_vars, slop_list_string captured_accesses) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < count) {
            __auto_type _mv_548 = ({ __auto_type _lst = free_vars; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_548.has_value) {
                __auto_type var_name = _mv_548.value;
                {
                    __auto_type c_name = ctype_to_c_name(arena, var_name);
...
void expr_bind_lambda_params(context_TranspileContext* ctx, slop_list_types_SExpr_ptr params) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < param_count) {
            __auto_type _mv_554 = ({ __auto_type _lst = params; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_554.has_value) {
                __auto_type param_expr = _mv_554.value;
                __auto_type _mv_555 = (*param_expr);
                switch (_mv_555.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type param_lst = _mv_555.data.lst;
                        {
                            __auto_type param_items = param_lst.items;
                            if (((int64_t)((param_items).len)) >= 2) {
                                __auto_type _mv_556 = ({ __auto_type _lst = param_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_556.has_value) {
                                    ...
                                    switch (_mv_557.tag) {
                                        case types_SExpr_sym:
                                        {
                                            ...
                                            __auto_type _mv_558 = ({ __auto_type _lst = param_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            ...
                            case types_SExpr_sym:
                            {
                                ...
                                if (!(string_eq(sym.name, SLOP_STR("fn")))) {
                                    ...
                                    if (_mv_566.has_value) {
                                        __auto_type second = _mv_566.value;
                                        __auto_type _mv_567 = (*second);
                                        switch (_mv_567.tag) {
                                            case types_SExpr_lst:
                                            {
                                                __auto_type _ = _mv_567.data.lst;
                                                return 1;
                                            }
                                            default: {
                                                return 0;
...
slop_string expr_transpile_spawn_closure(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items, types_SExpr* fn_expr) {
    ...
    SLOP_PRE(((fn_expr != NULL)), "(!= fn-expr nil)");
    {
        ...
        if (_mv_568.has_value) {
            __auto_type arena_expr = _mv_568.value;
            {
                __auto_type arena_c = expr_transpile_expr(ctx, arena_expr);
...
uint8_t expr_lambda_has_captures(context_TranspileContext* ctx, types_SExpr* fn_expr) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    SLOP_PRE(((fn_expr != NULL)), "(!= fn-expr nil)");
    __auto_type _mv_569 = (*fn_expr);
    switch (_mv_569.tag) {
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_569.data.lst;
            {
                __auto_type items = lst.items;
                __auto_type arena = (*ctx).arena;
                if (((int64_t)((items).len)) < 2) {
                    ...
                    if (_mv_570.has_value) {
                        __auto_type params_expr = _mv_570.value;
                        __auto_type _mv_571 = (*params_expr);
                        switch (_mv_571.tag) {
                            case types_SExpr_lst:
                            {
                                __auto_type params_lst = _mv_571.data.lst;
                                {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (((int64_t)((items).len)) < 2) {
            ...
            if (_mv_573.has_value) {
                __auto_type first_arg = _mv_573.value;
                {
...
slop_list_string expr_find_free_vars(context_TranspileContext* ctx, slop_list_string param_names, slop_list_types_SExpr_ptr body_items, int64_t start, slop_list_string pending) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = start;
        while (i < len) {
            __auto_type _mv_574 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_574.has_value) {
                __auto_type expr = _mv_574.value;
        ...
        }
        {
            ...
            int64_t j = 0;
            while (j < sym_count) {
                __auto_type _mv_575 = ({ __auto_type _lst = all_symbols; size_t _idx = (size_t)j; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_575.has_value) {
                    __auto_type sym_name = _mv_575.value;
...
void expr_collect_symbols_in_expr(context_TranspileContext* ctx, slop_list_string* symbols, slop_list_string pending, types_SExpr* expr) {
    ...
    switch (_mv_576.tag) {
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_576.data.lst;
            {
                __auto_type items = lst.items;
                __auto_type len = ((int64_t)((items).len));
                if (len > 0) {
                    ...
                    if (_mv_577.has_value) {
                        __auto_type head = _mv_577.value;
                        __auto_type _mv_578 = (*head);
                        switch (_mv_578.tag) {
                            case types_SExpr_sym:
                            {
                                __auto_type head_sym = _mv_578.data.sym;
                                {
                                    __auto_type op = head_sym.name;
...
void expr_collect_symbols_in_list(context_TranspileContext* ctx, slop_list_string* symbols, slop_list_string pending, slop_list_types_SExpr_ptr items, int64_t start) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = start;
        while (i < len) {
            __auto_type _mv_579 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_579.has_value) {
                __auto_type item = _mv_579.value;
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len >= 2) {
            ...
            if (_mv_580.has_value) {
                __auto_type bindings_expr = _mv_580.value;
                {
                                                    ...
                                                    if (((int64_t)((bind_items).len)) >= 2) {
                                                        {
                                                            ...
                                                            __auto_type _mv_584 = ({ __auto_type _lst = bind_items; size_t _idx = (size_t)val_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
uint8_t expr_is_mut_binding(slop_list_types_SExpr_ptr items) {
    if (((int64_t)((items).len)) < 1) {
        ...
        if (_mv_585.has_value) {
            __auto_type first = _mv_585.value;
            __auto_type _mv_586 = (*first);
            switch (_mv_586.tag) {
                case types_SExpr_sym:
                {
...
slop_list_string expr_extract_let_binding_names(slop_arena* arena, types_SExpr* bindings_expr) {
    ...
    {
        __auto_type names = ((slop_list_string){ .data = (slop_string*)slop_arena_alloc(arena, 16 * sizeof(slop_string)), .len = 0, .cap = 16 });
        __auto_type _mv_587 = (*bindings_expr);
        switch (_mv_587.tag) {
            case types_SExpr_lst:
            {
                __auto_type bindings_lst = _mv_587.data.lst;
                {
                    __auto_type bindings = bindings_lst.items;
                    __auto_type binding_count = ((int64_t)((bindings).len));
                    __auto_type i = 0;
                    while (i < binding_count) {
                        __auto_type _mv_588 = ({ __auto_type _lst = bindings; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_588.has_value) {
                            __auto_type binding = _mv_588.value;
                            __auto_type _mv_589 = (*binding);
                            switch (_mv_589.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type bind_lst = _mv_589.data.lst;
                                    {
                                        __auto_type bind_items = bind_lst.items;
                                        if (((int64_t)((bind_items).len)) >= 1) {
                                            {
                                                __auto_type name_idx = ((expr_is_mut_binding(bind_items)) ? 1 : 0);
                                                __auto_type _mv_590 = ({ __auto_type _lst = bind_items; size_t _idx = (size_t)name_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len >= 2) {
            ...
            if (_mv_592.has_value) {
                __auto_type scrutinee = _mv_592.value;
            ...
            }
            {
                ...
                while (i < len) {
                    ...
                    if (_mv_593.has_value) {
                        __auto_type clause = _mv_593.value;
                        __auto_type _mv_594 = (*clause);
                        switch (_mv_594.tag) {
                            case types_SExpr_lst:
                            {
                                __auto_type clause_lst = _mv_594.data.lst;
                                {
                                    __auto_type clause_items = clause_lst.items;
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len >= 2) {
            ...
            if (_mv_595.has_value) {
                __auto_type binding = _mv_595.value;
                __auto_type _mv_596 = (*binding);
                switch (_mv_596.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type bind_lst = _mv_596.data.lst;
                        {
                            __auto_type bind_items = bind_lst.items;
...
slop_list_string expr_extract_for_loop_var_pending(slop_arena* arena, slop_list_string pending, slop_list_types_SExpr_ptr bind_items) {
    if (((int64_t)((bind_items).len)) < 1) {
        ...
        __auto_type _mv_597 = ({ __auto_type _lst = bind_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        if (_mv_597.has_value) {
            __auto_type var_expr = _mv_597.value;
            __auto_type _mv_598 = (*var_expr);
            switch (_mv_598.tag) {
                case types_SExpr_sym:
                {
                    __auto_type var_sym = _mv_598.data.sym;
                    {
                        __auto_type result = ((slop_list_string){ .data = (slop_string*)slop_arena_alloc(arena, 16 * sizeof(slop_string)), .len = 0, .cap = 16 });
                        ...
                        __auto_type i = 0;
                        while (i < plen) {
                            __auto_type _mv_599 = ({ __auto_type _lst = pending; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        if (len >= 3) {
            {
                ...
                __auto_type size_idx = ((is_named) ? 3 : 1);
                __auto_type body_start = ((is_named) ? 4 : 2);
                __auto_type _mv_600 = ({ __auto_type _lst = items; size_t _idx = (size_t)size_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_600.has_value) {
                    __auto_type size_expr = _mv_600.value;
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len >= 2) {
            ...
            if (_mv_601.has_value) {
                __auto_type params_expr = _mv_601.value;
                __auto_type _mv_602 = (*params_expr);
                switch (_mv_602.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type params_lst = _mv_602.data.lst;
                        {
                            __auto_type params = params_lst.items;
                            __auto_type param_names = expr_extract_param_names(arena, params);
    ...
    if (expr_list_contains_string(param_names, sym_name)) {
        ...
        if (expr_list_contains_string(pending, sym_name)) {
            ...
            if (expr_is_builtin_op(sym_name)) {
                ...
                __auto_type _mv_603 = context_ctx_lookup_func(ctx, sym_name);
                if (_mv_603.has_value) {
                    __auto_type _ = _mv_603.value;
                    return 0;
                } else if (!_mv_603.has_value) {
                    __auto_type _mv_604 = context_ctx_lookup_type(ctx, sym_name);
                    if (_mv_604.has_value) {
                        __auto_type _ = _mv_604.value;
                        return 0;
                    } else if (!_mv_604.has_value) {
                        __auto_type _mv_605 = context_ctx_lookup_var(ctx, sym_name);
                        if (_mv_605.has_value) {
                            __auto_type _ = _mv_605.value;
                            return 1;
...
uint8_t expr_list_contains_string(slop_list_string lst, slop_string needle) {
    {
        ...
        uint8_t found = 0;
        while ((i < len) && !(found)) {
            __auto_type _mv_606 = ({ __auto_type _lst = lst; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_list_string expr_list_concat(slop_arena* arena, slop_list_string a, slop_list_string b) {
    {
        ...
        int64_t i = 0;
        while (i < len_a) {
            __auto_type _mv_607 = ({ __auto_type _lst = a; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        i = 0;
        while (i < len_b) {
            __auto_type _mv_608 = ({ __auto_type _lst = b; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_string expr_infer_collection_element_slop_type(context_TranspileContext* ctx, types_SExpr* coll_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_609 = (*coll_expr);
        switch (_mv_609.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_609.data.lst;
                {
                    __auto_type items = lst.items;
                    if (((int64_t)((items).len)) < 1) {
                        return SLOP_STR("");
                        ...
                        if (_mv_610.has_value) {
                            __auto_type head = _mv_610.value;
                            __auto_type _mv_611 = (*head);
                            switch (_mv_611.tag) {
                                case types_SExpr_sym:
                                {
                                        ...
                                        if (string_eq(op, SLOP_STR("map-keys"))) {
                                            ...
                                            if (((int64_t)((items).len)) < 2) {
                                                ...
                                                if (_mv_613.has_value) {
                                                    __auto_type set_expr = _mv_613.value;
                                                    {
                                            ...
                                            if (((int64_t)((items).len)) < 2) {
                                                ...
                                                if (_mv_614.has_value) {
                                                    __auto_type map_expr = _mv_614.value;
                                                    {
                                                        __auto_type map_slop_type = expr_infer_expr_slop_type(ctx, map_expr);
                                                        if (string_len(map_slop_type) > 0) {
                                                            {
