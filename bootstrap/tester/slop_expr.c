        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_121.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 2) {
                    ...
                    __auto_type _mv_122 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_122.has_value) {
                        __auto_type head = _mv_122.value;
                        __auto_type _mv_123 = (*head);
                        switch (_mv_123.tag) {
                            case types_SExpr_sym:
                            {
                                __auto_type head_sym = _mv_123.data.sym;
                                if (string_eq(head_sym.name, SLOP_STR("quote"))) {
                                    __auto_type _mv_124 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    if (_mv_124.has_value) {
                                        __auto_type inner = _mv_124.value;
                                        __auto_type _mv_125 = (*inner);
                                        switch (_mv_125.tag) {
                                            case types_SExpr_sym:
                                            {
                                                __auto_type inner_sym = _mv_125.data.sym;
...
slop_string expr_transpile_literal(context_TranspileContext* ctx, types_SExpr* expr) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    SLOP_PRE(((expr != NULL)), "(!= expr nil)");
    __auto_type _mv_126 = (*expr);
    switch (_mv_126.tag) {
        case types_SExpr_num:
        {
            __auto_type num = _mv_126.data.num;
            if (num.is_float) {
                return num.raw;
            } else {
                return num.raw;
        ...
        {
            __auto_type str = _mv_126.data.str;
        ...
        case types_SExpr_lst:
        {
            __auto_type _ = _mv_126.data.lst;
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (string_eq(name, SLOP_STR("true"))) {
        ...
        } else if (strlib_starts_with(name, SLOP_STR("'"))) {
            {
                ...
                __auto_type _mv_127 = context_ctx_lookup_enum_variant(ctx, variant_name);
            ...
            if (_mv_128.has_value) {
                __auto_type dot_pos = _mv_128.value;
                {
                    ...
                    __auto_type _mv_129 = context_ctx_lookup_var(ctx, base_name);
                    if (_mv_129.has_value) {
                        ...
                        __auto_type _mv_130 = context_ctx_lookup_type(ctx, base_name);
                        if (_mv_130.has_value) {
                            __auto_type type_info = _mv_130.value;
            ...
            if (_mv_131.has_value) {
                __auto_type entry = _mv_131.value;
                return entry.c_name;
            } else if (!_mv_131.has_value) {
                __auto_type _mv_132 = context_ctx_lookup_enum_variant(ctx, name);
                if (_mv_132.has_value) {
                ...
                } else if (!_mv_132.has_value) {
                    {
                        ...
                        __auto_type _mv_133 = context_ctx_lookup_func(ctx, name);
                        if (_mv_133.has_value) {
                            __auto_type func_entry = _mv_133.value;
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len <= (start_idx + 1)) {
        ...
        } else {
            {
                ...
                __auto_type _mv_134 = ({ __auto_type _lst = items; size_t _idx = (size_t)start_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_134.has_value) {
                    __auto_type first_arg = _mv_134.value;
                ...
                }
                {
                    ...
                    while (i < len) {
                        __auto_type _mv_135 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_135.has_value) {
                            __auto_type arg = _mv_135.value;
                            {
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_136.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 1) {
                    ...
                    __auto_type _mv_137 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_137.has_value) {
                        __auto_type head = _mv_137.value;
                        __auto_type _mv_138 = (*head);
                        switch (_mv_138.tag) {
                            case types_SExpr_sym:
                            {
...
uint8_t expr_is_string_literal(types_SExpr* expr) {
    ...
    switch (_mv_139.tag) {
        case types_SExpr_str:
        {
            __auto_type _ = _mv_139.data.str;
            return 1;
        }
        default: {
            return 0;
...
uint8_t expr_is_fn_type_expr(types_SExpr* type_expr) {
    SLOP_PRE(((type_expr != NULL)), "(!= type-expr nil)");
    __auto_type _mv_140 = (*type_expr);
    switch (_mv_140.tag) {
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_140.data.lst;
            __auto_type _mv_141 = ({ __auto_type _lst = lst.items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
uint8_t expr_is_ptr_void_type(types_SExpr* type_expr) {
    ...
    switch (_mv_143.tag) {
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_143.data.lst;
            {
                __auto_type items = lst.items;
...
uint8_t expr_is_closure_typed_expr(context_TranspileContext* ctx, types_SExpr* expr) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    SLOP_PRE(((expr != NULL)), "(!= expr nil)");
    __auto_type _mv_144 = (*expr);
    switch (_mv_144.tag) {
        case types_SExpr_sym:
        {
            __auto_type sym = _mv_144.data.sym;
            __auto_type _mv_145 = context_ctx_lookup_var(ctx, sym.name);
            if (_mv_145.has_value) {
                __auto_type entry = _mv_145.value;
...
slop_string expr_fn_type_to_c_fn_ptr(context_TranspileContext* ctx, types_SExpr* fn_expr) {
    ...
    __auto_type _mv_146 = (*fn_expr);
    switch (_mv_146.tag) {
        case types_SExpr_lst:
        {
            __auto_type l = _mv_146.data.lst;
            {
    ...
    switch (_mv_147.tag) {
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_147.data.lst;
            {
                ...
                __auto_type i = 0;
                while (i < count) {
                    __auto_type _mv_148 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_148.has_value) {
                        __auto_type arg_type = _mv_148.value;
                        {
        ...
        __auto_type arena = (*ctx).arena;
        {
            ...
            if (string_len(runtime_name) > 0) {
            ...
            } else {
                {
                    ...
                    __auto_type _mv_149 = context_ctx_lookup_var(ctx, fn_name);
...
slop_string expr_closure_type_to_c(context_TranspileContext* ctx, slop_string slop_type) {
    ...
    if (string_eq(slop_type, SLOP_STR("Int"))) {
        ...
        __auto_type _mv_150 = context_ctx_lookup_type(ctx, slop_type);
        if (_mv_150.has_value) {
            __auto_type type_entry = _mv_150.value;
...
slop_string expr_transpile_enum_variant(context_TranspileContext* ctx, slop_string variant_name) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_151 = context_ctx_lookup_enum_variant(ctx, variant_name);
        if (_mv_151.has_value) {
            __auto_type enum_name = _mv_151.value;
            {
...
slop_string expr_transpile_error(context_TranspileContext* ctx, slop_string value_c) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    __auto_type _mv_153 = context_ctx_get_current_result_type(ctx);
    if (_mv_153.has_value) {
        __auto_type result_type = _mv_153.value;
...
slop_string expr_infer_option_type(context_TranspileContext* ctx, types_SExpr* val_expr) {
    ...
    __auto_type _mv_154 = (*val_expr);
    switch (_mv_154.tag) {
        case types_SExpr_num:
        {
            __auto_type num = _mv_154.data.num;
            if (num.is_float) {
        ...
        case types_SExpr_str:
        {
            __auto_type _ = _mv_154.data.str;
            return SLOP_STR("slop_option_string");
        }
        case types_SExpr_sym:
        {
            __auto_type sym = _mv_154.data.sym;
            __auto_type _mv_155 = ctype_get_node_resolved_type(val_expr);
            if (_mv_155.has_value) {
                __auto_type rt = _mv_155.value;
                {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 3) {
            ...
            if (_mv_157.has_value) {
                __auto_type obj_expr = _mv_157.value;
                __auto_type _mv_158 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    ...
                    switch (_mv_159.tag) {
                        case types_SExpr_sym:
                        {
                            __auto_type field_sym = _mv_159.data.sym;
                            {
                                ...
                                __auto_type _mv_160 = context_ctx_lookup_field_type(ctx, obj_c_type, field_name);
                                if (_mv_160.has_value) {
                                    __auto_type c_type = _mv_160.value;
                                    return c_type;
                                } else if (!_mv_160.has_value) {
                                    __auto_type _mv_161 = context_ctx_lookup_var(ctx, expr_get_var_name_from_expr(obj_expr));
                                    if (_mv_161.has_value) {
                                        __auto_type var_entry = _mv_161.value;
                                        {
                                            __auto_type obj_slop_type = var_entry.slop_type;
                                            __auto_type _mv_162 = context_ctx_lookup_field_type(ctx, obj_slop_type, field_name);
                                            if (_mv_162.has_value) {
                                                __auto_type c_type2 = _mv_162.value;
                                                return c_type2;
...
slop_string expr_infer_list_expr_option_type(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 1) {
            ...
            __auto_type _mv_163 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    ...
                    case types_SExpr_sym:
                    {
                        __auto_type sym = _mv_164.data.sym;
                        {
                            ...
                            if (string_eq(op, SLOP_STR("."))) {
                                if (len < 3) {
                                ...
                                } else {
                                    {
                                        ...
                                        if (!(string_eq(field_c_type, SLOP_STR("__auto_type")))) {
                                            ...
                                            __auto_type _mv_165 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_165.has_value) {
                                                __auto_type field_expr = _mv_165.value;
                                                __auto_type _mv_166 = (*field_expr);
                                                switch (_mv_166.tag) {
                                                    case types_SExpr_sym:
                                                    {
                                                        __auto_type field_sym = _mv_166.data.sym;
                                                        {
                                                            __auto_type field_name = field_sym.name;
                                ...
                                __auto_type _mv_167 = context_ctx_lookup_func(ctx, op);
                                if (_mv_167.has_value) {
                                    __auto_type func_entry = _mv_167.value;
                                    {
...
slop_string expr_infer_list_element_option_type(context_TranspileContext* ctx, types_SExpr* list_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_168 = ctype_get_node_resolved_type(list_expr);
        if (_mv_168.has_value) {
            __auto_type rt = _mv_168.value;
            __auto_type _mv_169 = (*rt).inner_type;
            if (_mv_169.has_value) {
                __auto_type elem_type = _mv_169.value;
                {
        ...
        if (strlib_starts_with(list_c_type, SLOP_STR("slop_list_"))) {
            ...
            switch (_mv_170.tag) {
                case types_SExpr_sym:
                {
                    ...
                    {
                        __auto_type name = sym.name;
                        __auto_type _mv_171 = context_ctx_lookup_var(ctx, name);
                ...
                case types_SExpr_lst:
                {
                    __auto_type lst = _mv_170.data.lst;
                    {
                        ...
                        if (((int64_t)((items).len)) < 3) {
                            ...
                            __auto_type _mv_172 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_172.has_value) {
                                __auto_type head = _mv_172.value;
                                __auto_type _mv_173 = (*head);
                                switch (_mv_173.tag) {
                                    case types_SExpr_sym:
                                    {
                                        __auto_type head_sym = _mv_173.data.sym;
        ...
        if (strlib_ends_with(elem_type, SLOP_STR("_ptr"))) {
            {
                ...
                __auto_type _mv_176 = context_ctx_lookup_type(ctx, base);
            ...
            __auto_type _mv_177 = context_ctx_lookup_type(ctx, elem_type);
...
slop_string expr_slop_value_type_to_c_type(context_TranspileContext* ctx, slop_string slop_type) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (strlib_starts_with(slop_type, SLOP_STR("(Map "))) {
            ...
            __auto_type _mv_178 = context_ctx_lookup_type(ctx, slop_type);
            if (_mv_178.has_value) {
                __auto_type entry = _mv_178.value;
                return entry.c_name;
...
slop_string expr_resolve_type_alias(context_TranspileContext* ctx, slop_string slop_type) {
    ...
    if (strlib_starts_with(slop_type, SLOP_STR("(Map "))) {
        ...
        __auto_type _mv_180 = context_ctx_lookup_type_alias(ctx, slop_type);
        if (_mv_180.has_value) {
            __auto_type alias_def = _mv_180.value;
            return alias_def;
    ...
    SLOP_PRE(((expr != NULL)), "(!= expr nil)");
    {
        ...
        switch (_mv_181.tag) {
            case types_SExpr_sym:
            {
                ...
                {
                    __auto_type name = sym.name;
                    __auto_type _mv_182 = context_ctx_lookup_var(ctx, name);
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_181.data.lst;
                {
                    __auto_type items = lst.items;
                    __auto_type len = ((int64_t)((items).len));
                    if (len < 1) {
                        ...
                        if (_mv_183.has_value) {
                            __auto_type head = _mv_183.value;
                            __auto_type _mv_184 = (*head);
                            switch (_mv_184.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type head_sym = _mv_184.data.sym;
                                    {
                                        __auto_type op = head_sym.name;
                                        if (string_eq(op, SLOP_STR(".")) && (len >= 3)) {
                                            __auto_type _mv_185 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_185.has_value) {
                                                __auto_type obj_expr = _mv_185.value;
                                                __auto_type _mv_186 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_186.has_value) {
                                                    __auto_type field_expr = _mv_186.value;
                                                    __auto_type _mv_187 = (*field_expr);
                                                    switch (_mv_187.tag) {
                                                        case types_SExpr_sym:
                                                        {
                                                            __auto_type field_sym = _mv_187.data.sym;
                                                            {
                                                                __auto_type field_name = field_sym.name;
                                                                {
                                                                    ...
                                                                    __auto_type _mv_188 = context_ctx_lookup_field_slop_type(ctx, obj_c_type, field_name);
                                                                    if (_mv_188.has_value) {
                                                                        __auto_type slop_type = _mv_188.value;
                                                                        return slop_type;
                                                                    } else if (!_mv_188.has_value) {
                                                                        {
                                                                            ...
                                                                            __auto_type _mv_189 = context_ctx_lookup_field_slop_type(ctx, obj_slop_type, field_name);
                                                                            if (_mv_189.has_value) {
                                                                                __auto_type slop_type2 = _mv_189.value;
                                                                                return slop_type2;
                                            ...
                                            if (len >= 2) {
                                                ...
                                                if (_mv_190.has_value) {
                                                    ...
                                                    __auto_type _mv_191 = (*type_expr);
                                                    switch (_mv_191.tag) {
                                                        case types_SExpr_sym:
                                                        {
                                                            __auto_type type_sym = _mv_191.data.sym;
                                            ...
                                            if (len >= 4) {
                                                ...
                                                if (_mv_192.has_value) {
                                                    __auto_type key_expr = _mv_192.value;
                                                    __auto_type _mv_193 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            ...
                                            if (len >= 3) {
                                                ...
                                                if (_mv_195.has_value) {
                                                    __auto_type elem_expr = _mv_195.value;
                                                    {
                                                        __auto_type elem_str = ctype_sexpr_to_type_string(arena, elem_expr);
                                            ...
                                            if (_mv_198.has_value) {
                                                __auto_type inner_expr = _mv_198.value;
                                                return expr_infer_result_ok_slop_type(ctx, inner_expr);
                                            } else if (!_mv_198.has_value) {
                                                return SLOP_STR("");
                                            }
                                        } else {
                                            __auto_type _mv_199 = context_ctx_lookup_func(ctx, op);
                                            if (_mv_199.has_value) {
                                                __auto_type func_entry = _mv_199.value;
    ...
    SLOP_PRE(((map_expr != NULL)), "(!= map-expr nil)");
    {
        ...
        switch (_mv_204.tag) {
            case types_SExpr_sym:
            {
                ...
                {
                    __auto_type name = sym.name;
                    __auto_type _mv_205 = context_ctx_lookup_var(ctx, name);
        ...
        __auto_type arena = (*ctx).arena;
        {
            __auto_type expr_type = expr_infer_expr_slop_type(ctx, scrutinee);
            {
                ...
                if (strlib_starts_with(resolved, SLOP_STR("(Option "))) {
                    ...
                    __auto_type _mv_206 = (*scrutinee);
                    switch (_mv_206.tag) {
                        case types_SExpr_lst:
                        {
                            __auto_type lst = _mv_206.data.lst;
                            {
                                __auto_type items = lst.items;
                                __auto_type len = ((int64_t)((items).len));
                                if (len < 2) {
                                    ...
                                    __auto_type _mv_207 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    if (_mv_207.has_value) {
                                        __auto_type head_expr = _mv_207.value;
                                        __auto_type _mv_208 = (*head_expr);
                                        switch (_mv_208.tag) {
                                            case types_SExpr_sym:
                                            {
                                                __auto_type sym = _mv_208.data.sym;
                                                {
                                                    ...
                                                    if (string_eq(op, SLOP_STR("map-get"))) {
                                                        if (len < 2) {
                                                            ...
                                                            __auto_type _mv_209 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                            if (_mv_209.has_value) {
                                                                __auto_type map_expr = _mv_209.value;
                                                                __auto_type _mv_210 = (*map_expr);
                                                                switch (_mv_210.tag) {
                                                                    case types_SExpr_sym:
                                                                    {
                                                                        __auto_type map_sym = _mv_210.data.sym;
                                                                        {
                                                                            __auto_type map_name = map_sym.name;
                                                                            __auto_type _mv_211 = context_ctx_lookup_var(ctx, map_name);
                                                        ...
                                                        if (len < 2) {
                                                            ...
                                                            __auto_type _mv_212 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                            if (_mv_212.has_value) {
                                                                __auto_type list_expr = _mv_212.value;
                                                                __auto_type _mv_213 = (*list_expr);
                                                                switch (_mv_213.tag) {
                                                                    case types_SExpr_sym:
                                                                    {
                                                                        __auto_type list_sym = _mv_213.data.sym;
                                                                        {
                                                                            __auto_type list_name = list_sym.name;
                                                                            __auto_type _mv_214 = context_ctx_lookup_var(ctx, list_name);
...
slop_string expr_fix_ternary_none(context_TranspileContext* ctx, types_SExpr* other_expr, slop_string other_branch, slop_string this_branch) {
    ...
    if (string_eq(this_branch, SLOP_STR("none")) && strlib_starts_with(other_branch, SLOP_STR("(slop_option_"))) {
        {
            __auto_type arena = (*ctx).arena;
            __auto_type _mv_215 = expr_extract_option_type(arena, other_branch);
            if (_mv_215.has_value) {
                __auto_type opt_type = _mv_215.value;
...
uint8_t expr_is_pointer_expr(context_TranspileContext* ctx, types_SExpr* expr) {
    ...
    switch (_mv_218.tag) {
        case types_SExpr_sym:
        {
            __auto_type sym = _mv_218.data.sym;
            {
                __auto_type name = sym.name;
                __auto_type _mv_219 = context_ctx_lookup_var(ctx, name);
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_218.data.lst;
            {
                __auto_type items = lst.items;
                if (((int64_t)((items).len)) >= 1) {
                    __auto_type _mv_220 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_220.has_value) {
                        __auto_type head_ptr = _mv_220.value;
                        __auto_type _mv_221 = (*head_ptr);
                        switch (_mv_221.tag) {
                            case types_SExpr_sym:
                            {
                                __auto_type head_sym = _mv_221.data.sym;
                                {
                                    __auto_type op = head_sym.name;
                                    if (string_eq(op, SLOP_STR("deref"))) {
                                        ...
                                        __auto_type _mv_222 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_222.has_value) {
                                            __auto_type type_expr = _mv_222.value;
                ...
                __auto_type lst = _mv_223.data.lst;
                {
                    ...
                    if (len >= 2) {
                        ...
                        if (_mv_224.has_value) {
                            __auto_type head_ptr = _mv_224.value;
                            __auto_type _mv_225 = (*head_ptr);
                            switch (_mv_225.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type head_sym = _mv_225.data.sym;
                                    {
                                        __auto_type op = head_sym.name;
                                        if (string_eq(op, SLOP_STR("sizeof"))) {
                                            ...
                                            if (_mv_226.has_value) {
                                                __auto_type type_expr = _mv_226.value;
                                        ...
                                        } else if (string_eq(op, SLOP_STR("*")) || (string_eq(op, SLOP_STR("+")) || (string_eq(op, SLOP_STR("-")) || string_eq(op, SLOP_STR("/"))))) {
                                            {
                                                ...
                                                while (i < len) {
                                                    __auto_type _mv_227 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_227.has_value) {
                                                        __auto_type arg_expr = _mv_227.value;
                                                        {
...
slop_string expr_transpile_expr(context_TranspileContext* ctx, types_SExpr* expr) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    SLOP_PRE(((expr != NULL)), "(!= expr nil)");
    __auto_type _mv_228 = (*expr);
    switch (_mv_228.tag) {
        case types_SExpr_num:
        {
            __auto_type _ = _mv_228.data.num;
            return expr_transpile_literal(ctx, expr);
        }
        case types_SExpr_str:
        {
            __auto_type _ = _mv_228.data.str;
            return expr_transpile_literal(ctx, expr);
        }
        case types_SExpr_sym:
        {
            __auto_type _ = _mv_228.data.sym;
            return expr_transpile_literal(ctx, expr);
        }
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_228.data.lst;
...
slop_string expr_transpile_list_expr(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 1) {
            ...
            __auto_type _mv_229 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_229.has_value) {
                __auto_type head_expr = _mv_229.value;
                __auto_type _mv_230 = (*head_expr);
                switch (_mv_230.tag) {
                    case types_SExpr_sym:
                    {
                        __auto_type head_sym = _mv_230.data.sym;
                        {
                            __auto_type op = head_sym.name;
                            if (expr_is_binop(op) && (len < 3)) {
                                ...
                                if (len > 3) {
                                    ...
                                    if (_mv_231.has_value) {
                                        ...
                                        __auto_type _mv_232 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                ...
                                if (_mv_233.has_value) {
                                    __auto_type left = _mv_233.value;
                                    __auto_type _mv_234 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    if (_mv_234.has_value) {
                                        __auto_type right = _mv_234.value;
                                        {
                                            __auto_type left_c = expr_transpile_expr(ctx, left);
                                            __auto_type right_c = expr_transpile_expr(ctx, right);
                                ...
                                if (_mv_236.has_value) {
                                    __auto_type cond_expr = _mv_236.value;
                                    __auto_type _mv_237 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    if (_mv_237.has_value) {
                                        __auto_type then_expr = _mv_237.value;
                                        ...
                                        if (_mv_238.has_value) {
                                            __auto_type else_expr = _mv_238.value;
                                            {
                                ...
                                if (_mv_240.has_value) {
                                    __auto_type obj = _mv_240.value;
                                    __auto_type _mv_241 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                ...
                                if (_mv_243.has_value) {
                                    __auto_type type_expr = _mv_243.value;
                                    __auto_type _mv_244 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                ...
                                if (_mv_245.has_value) {
                                    __auto_type str_expr = _mv_245.value;
                                    __auto_type _mv_246 = (*str_expr);
                                    switch (_mv_246.tag) {
                                        case types_SExpr_str:
                                        {
                                            __auto_type str = _mv_246.data.str;
                                            return str.value;
                                        }
                                        default: {
                                ...
                                if (_mv_247.has_value) {
                                    __auto_type val_expr = _mv_247.value;
                                    {
                                        __auto_type val_c = expr_transpile_expr(ctx, val_expr);
                                ...
                                if (_mv_250.has_value) {
                                    __auto_type arr_expr = _mv_250.value;
                                    ...
                                    if (_mv_251.has_value) {
                                        __auto_type idx_expr = _mv_251.value;
                                        {
                                ...
                                if (_mv_252.has_value) {
                                    __auto_type arena_expr = _mv_252.value;
                                            ...
                                            switch (_mv_254.tag) {
                                                case types_SExpr_sym:
                                                {
                                                    __auto_type sym = _mv_254.data.sym;
                                                    {
                                                        ...
                                                        __auto_type _mv_255 = context_ctx_lookup_type(ctx, type_name);
                                                        if (_mv_255.has_value) {
                                                            __auto_type entry = _mv_255.value;
                                                            {
                                ...
                                if (_mv_256.has_value) {
                                    __auto_type size_expr = _mv_256.value;
                                    {
                                        __auto_type size_c = expr_transpile_expr(ctx, size_expr);
                                ...
                                if (_mv_257.has_value) {
                                    __auto_type arena_expr = _mv_257.value;
                                    {
                                        __auto_type arena_c = expr_transpile_expr(ctx, arena_expr);
                                ...
                                if (_mv_258.has_value) {
                                    __auto_type variant_expr = _mv_258.value;
                                    __auto_type _mv_259 = (*variant_expr);
                                    switch (_mv_259.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type sym = _mv_259.data.sym;
                                            {
                                ...
                                if (_mv_260.has_value) {
                                    __auto_type type_expr = _mv_260.value;
                                    ...
                                    if (_mv_261.has_value) {
                                        __auto_type tag_expr = _mv_261.value;
                                        __auto_type _mv_262 = (*type_expr);
                                        switch (_mv_262.tag) {
                                            case types_SExpr_sym:
                                            {
                                                __auto_type type_sym = _mv_262.data.sym;
                                                __auto_type _mv_263 = expr_extract_symbol_name(tag_expr);
                                                if (_mv_263.has_value) {
                                                    __auto_type tag_str = _mv_263.value;
                                                    {
                                                        ...
                                                        if (len >= 5) {
                                                            {
                                                                ...
                                                                for (int64_t vi = 3; vi < len; vi++) {
                                                                    __auto_type _mv_264 = ({ __auto_type _lst = items; size_t _idx = (size_t)vi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                            ...
                                                            __auto_type _mv_265 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                ...
                                if (_mv_267.has_value) {
                                    __auto_type val_expr = _mv_267.value;
                                    {
                                        __auto_type val_c = expr_transpile_expr(ctx, val_expr);
                                ...
                                if (_mv_268.has_value) {
                                    __auto_type result_expr = _mv_268.value;
                                    {
                                        __auto_type result_c = expr_transpile_expr(ctx, result_expr);
                                        __auto_type _mv_269 = context_ctx_get_current_result_type(ctx);
                                        if (_mv_269.has_value) {
                                            __auto_type enclosing_type = _mv_269.value;
                                ...
                                if (_mv_271.has_value) {
                                    ...
                                    if (_mv_272.has_value) {
                                        __auto_type idx_expr = _mv_272.value;
                                        {
                                            __auto_type list_c = expr_transpile_expr(ctx, list_expr);
                                            __auto_type idx_c = expr_transpile_expr(ctx, idx_expr);
                                ...
                                if (_mv_273.has_value) {
                                    __auto_type list_expr = _mv_273.value;
                                    {
                                        __auto_type list_c = expr_transpile_expr(ctx, list_expr);
                                        __auto_type option_type = expr_infer_list_element_option_type(ctx, list_expr);
                                        if (string_len(option_type) > 0) {
                                ...
                                if (_mv_274.has_value) {
                                    ...
                                    if (_mv_275.has_value) {
                                        __auto_type type_expr = _mv_275.value;
                                        {
                                            __auto_type arena_c = expr_transpile_expr(ctx, arena_expr);
                                ...
                                if (_mv_276.has_value) {
                                    __auto_type list_expr = _mv_276.value;
                                    __auto_type _mv_277 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    if (_mv_277.has_value) {
                                        __auto_type item_expr = _mv_277.value;
                                        {
                                            __auto_type list_c = expr_transpile_expr(ctx, list_expr);
                                ...
                                __auto_type _mv_278 = context_ctx_get_current_return_type(ctx);
                                if (_mv_278.has_value) {
                                    __auto_type ret_type = _mv_278.value;
                    ...
                    default: {
                        {
                            ...
                            __auto_type i = 1;
                            while (i < len) {
                                __auto_type _mv_279 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        if (string_eq(fn_name, SLOP_STR("println"))) {
            ...
            if (len < 3) {
                ...
                if (_mv_284.has_value) {
                    __auto_type a_expr = _mv_284.value;
                    ...
                    if (_mv_285.has_value) {
                        __auto_type b_expr = _mv_285.value;
                        {
                            __auto_type a_c = expr_transpile_expr(ctx, a_expr);
                            __auto_type b_c = expr_transpile_expr(ctx, b_expr);
                            __auto_type s1 = string_concat(arena, SLOP_STR("(("), a_c);
            ...
            if (len < 3) {
                ...
                if (_mv_286.has_value) {
                    __auto_type fn_expr = _mv_286.value;
            ...
            if (len < 4) {
                ...
                if (_mv_287.has_value) {
                    __auto_type type_expr = _mv_287.value;
                    ...
                    if (_mv_288.has_value) {
                        __auto_type arena_expr = _mv_288.value;
                        ...
                        if (_mv_289.has_value) {
                            __auto_type cap_expr = _mv_289.value;
                            {
            ...
            if (len < 3) {
                ...
                if (_mv_290.has_value) {
                    ...
                    __auto_type _mv_291 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_291.has_value) {
                        __auto_type arena_expr = _mv_291.value;
                        {
                            __auto_type elem_c = context_to_c_type_prefixed(ctx, type_expr);
                            __auto_type elem_id = ctype_type_to_identifier(arena, elem_c);
                            __auto_type chan_type = context_ctx_str(ctx, SLOP_STR("slop_chan_"), elem_id);
            ...
            if (len < 3) {
                ...
                if (_mv_292.has_value) {
                    ...
                    __auto_type _mv_293 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_293.has_value) {
                        __auto_type value_expr = _mv_293.value;
                        {
            ...
            if (len < 2) {
                ...
                if (_mv_294.has_value) {
                    __auto_type chan_expr = _mv_294.value;
                    {
                        __auto_type chan_c = expr_transpile_expr(ctx, chan_expr);
                        __auto_type chan_c_type = expr_infer_expr_c_type(ctx, chan_expr);
                        {
        ...
        } else {
            {
                ...
                if (string_len(builtin_c_name) > 0) {
                    ...
                    __auto_type _mv_295 = context_ctx_lookup_type(ctx, fn_name);
                    if (_mv_295.has_value) {
                        __auto_type type_entry = _mv_295.value;
                        if (type_entry.is_union) {
                        ...
                        } else {
                            {
                                ...
                                while (i < len) {
                                    __auto_type _mv_296 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        ...
                        __auto_type _mv_297 = context_ctx_lookup_enum_variant(ctx, fn_name);
                        if (_mv_297.has_value) {
                            __auto_type type_name = _mv_297.value;
                            {
                                ...
                                if (len > 2) {
                                    {
                                        ...
                                        __auto_type vi = 1;
                                        while (vi < len) {
                                            __auto_type _mv_298 = ({ __auto_type _lst = items; size_t _idx = (size_t)vi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    ...
                                    if (_mv_299.has_value) {
                                        __auto_type value_expr = _mv_299.value;
                                        {
                                            __auto_type value_c = expr_transpile_expr(ctx, value_expr);
                                ...
                                if (!_mv_300.has_value) {
                                    {
                                        ...
                                        if ((string_len(runtime_name) == 0) && ({ __auto_type _mv = var_opt; _mv.has_value ? ({ __auto_type _ = _mv.value; 0; }) : (1); })) {
                                            ...
                                            while (i < len) {
                                                __auto_type _mv_301 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    ...
    SLOP_PRE(((arg != NULL)), "(!= arg nil)");
    {
        ...
        switch (_mv_303.tag) {
            ...
            default: {
                {
                    __auto_type arg_c = expr_transpile_expr(ctx, arg);
                    __auto_type _mv_304 = expr_get_expr_type_hint(ctx, arg);
                    if (_mv_304.has_value) {
                        __auto_type type_hint = _mv_304.value;
...
slop_string expr_transpile_raw_string_fn_call(context_TranspileContext* ctx, slop_string fn_name, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 1;
        while (i < len) {
            __auto_type _mv_306 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_option_string expr_get_expr_type_hint(context_TranspileContext* ctx, types_SExpr* expr) {
    ...
    SLOP_PRE(((expr != NULL)), "(!= expr nil)");
    {
        ...
        if (string_eq(slop_type, SLOP_STR("String"))) {
            ...
            __auto_type _mv_307 = (*expr);
            switch (_mv_307.tag) {
                case types_SExpr_sym:
                {
                    __auto_type sym = _mv_307.data.sym;
                    __auto_type _mv_308 = context_ctx_lookup_var(ctx, sym.name);
                    if (_mv_308.has_value) {
                        __auto_type entry = _mv_308.value;
                        {
                ...
                case types_SExpr_lst:
                {
                    __auto_type lst = _mv_307.data.lst;
                    {
                        __auto_type items = lst.items;
                        if (((int64_t)((items).len)) >= 1) {
                            __auto_type _mv_309 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_309.has_value) {
                                __auto_type head = _mv_309.value;
                                __auto_type _mv_310 = (*head);
                                switch (_mv_310.tag) {
                                    case types_SExpr_sym:
                                    {
                                        __auto_type head_sym = _mv_310.data.sym;
                                        {
                                            __auto_type op = head_sym.name;
                                            if (string_eq(op, SLOP_STR(".")) && (((int64_t)((items).len)) >= 3)) {
                                                {
                                                    ...
                                                    if (string_eq(c_type, SLOP_STR("slop_string"))) {
                                                        ...
                                                        if (_mv_311.has_value) {
                                                            __auto_type obj_expr = _mv_311.value;
                                                            ...
                                                            if (_mv_312.has_value) {
                                                                __auto_type field_expr = _mv_312.value;
                                                                __auto_type _mv_313 = (*field_expr);
                                                                switch (_mv_313.tag) {
                                                                    case types_SExpr_sym:
                                                                    {
                                                                        __auto_type field_sym = _mv_313.data.sym;
                                                                        {
                                                                            __auto_type field_name = field_sym.name;
                                                                            __auto_type obj_slop_type = expr_infer_expr_slop_type(ctx, obj_expr);
                                                                            if (string_len(obj_slop_type) > 0) {
                                                                                __auto_type _mv_314 = context_ctx_lookup_field_slop_type(ctx, obj_slop_type, field_name);
                                                                                if (_mv_314.has_value) {
                                                                                    __auto_type fst = _mv_314.value;
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 2) {
            ...
            if (_mv_316.has_value) {
                __auto_type tag_expr = _mv_316.value;
                __auto_type _mv_317 = (*tag_expr);
                switch (_mv_317.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type tag_list = _mv_317.data.lst;
                        {
                            __auto_type tag_items = tag_list.items;
                            if (((int64_t)((tag_items).len)) < 1) {
                                return context_ctx_str3(ctx, SLOP_STR("(("), c_type_name, SLOP_STR("){})"));
                            } else {
                                __auto_type _mv_318 = ({ __auto_type _lst = tag_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_318.has_value) {
                                    __auto_type tag_name_expr = _mv_318.value;
                                    __auto_type _mv_319 = (*tag_name_expr);
                                    switch (_mv_319.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type tag_sym = _mv_319.data.sym;
                                            {
                                                ...
                                                if (num_tag_items >= 3) {
                                                    {
                                                        ...
                                                        for (int64_t fi = 1; fi < num_tag_items; fi++) {
                                                            __auto_type _mv_320 = ({ __auto_type _lst = tag_items; size_t _idx = (size_t)fi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                            if (_mv_320.has_value) {
                                                                __auto_type value_expr = _mv_320.value;
                                                                {
                                                                    __auto_type value_c = expr_transpile_expr(ctx, value_expr);
                                                    ...
                                                    __auto_type _mv_321 = ({ __auto_type _lst = tag_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_321.has_value) {
                                                        __auto_type value_expr = _mv_321.value;
                                                        {
                                                            __auto_type value_c = expr_transpile_expr(ctx, value_expr);
                    ...
                    case types_SExpr_sym:
                    {
                        __auto_type sym = _mv_317.data.sym;
                        {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_322.has_value) {
                __auto_type clause_expr = _mv_322.value;
                __auto_type _mv_323 = (*clause_expr);
                switch (_mv_323.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type clause_lst = _mv_323.data.lst;
                        {
                            __auto_type clause_items = clause_lst.items;
                            __auto_type clause_len = ((int64_t)((clause_items).len));
                            if (clause_len >= 2) {
                                __auto_type _mv_324 = ({ __auto_type _lst = clause_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_324.has_value) {
                                    __auto_type test_expr = _mv_324.value;
                                    __auto_type _mv_325 = (*test_expr);
                                    switch (_mv_325.tag) {
                                        case types_SExpr_sym:
                                        {
                                            ...
                                            if (string_eq(sym.name, SLOP_STR("else"))) {
                                            ...
                                            } else {
                                                {
                                                    ...
                                                    __auto_type _mv_327 = ({ __auto_type _lst = clause_items; size_t _idx = (size_t)(clause_len - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_327.has_value) {
                                                        __auto_type body_expr = _mv_327.value;
                                                        {
                                        ...
                                        default: {
                                            {
                                                __auto_type test_c = expr_transpile_expr(ctx, test_expr);
                                                __auto_type _mv_328 = ({ __auto_type _lst = clause_items; size_t _idx = (size_t)(clause_len - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 3) {
            ...
            if (_mv_329.has_value) {
                __auto_type scrutinee = _mv_329.value;
                {
...
slop_list_types_SExpr_ptr expr_collect_match_patterns(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 2;
        while (i < len) {
            __auto_type _mv_330 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_330.has_value) {
                __auto_type branch = _mv_330.value;
                    ...
                    case types_SExpr_lst:
                    {
                        __auto_type branch_lst = _mv_331.data.lst;
                        {
                            ...
                            if (((int64_t)((branch_items).len)) >= 1) {
                                __auto_type _mv_332 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_332.has_value) {
                                    __auto_type pattern = _mv_332.value;
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_333.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 1) {
                    ...
                    __auto_type _mv_334 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_334.has_value) {
                        __auto_type head = _mv_334.value;
                        __auto_type _mv_335 = (*head);
                        switch (_mv_335.tag) {
                            case types_SExpr_sym:
                            {
...
uint8_t expr_is_result_patterns(slop_list_types_SExpr_ptr patterns) {
    {
        ...
        int64_t i = 0;
        while ((i < len) && !(found)) {
            __auto_type _mv_337 = ({ __auto_type _lst = patterns; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_337.has_value) {
                __auto_type pat = _mv_337.value;
                {
                    __auto_type tag = expr_get_expr_pattern_tag(pat);
...
uint8_t expr_is_enum_expr_patterns(context_TranspileContext* ctx, slop_list_types_SExpr_ptr patterns) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while ((i < len) && all_symbols) {
            __auto_type _mv_338 = ({ __auto_type _lst = patterns; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_338.has_value) {
                __auto_type pat_expr = _mv_338.value;
                __auto_type _mv_339 = (*pat_expr);
                switch (_mv_339.tag) {
                    case types_SExpr_sym:
                    {
                        __auto_type s = _mv_339.data.sym;
                        {
                            ...
                            if (!(string_eq(name, SLOP_STR("else"))) && !(string_eq(name, SLOP_STR("_")))) {
                                __auto_type _mv_340 = context_ctx_lookup_enum_variant(ctx, name);
...
uint8_t expr_is_union_expr_patterns(context_TranspileContext* ctx, slop_list_types_SExpr_ptr patterns) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while ((i < len) && !(has_union_variant)) {
            __auto_type _mv_341 = ({ __auto_type _lst = patterns; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_341.has_value) {
                __auto_type pat_expr = _mv_341.value;
                {
                    ...
                    if ((!(string_eq(tag, SLOP_STR("")))) && (!(string_eq(tag, SLOP_STR("some")))) && (!(string_eq(tag, SLOP_STR("none")))) && (!(string_eq(tag, SLOP_STR("ok")))) && (!(string_eq(tag, SLOP_STR("error")))) && (!(string_eq(tag, SLOP_STR("else")))) && (!(string_eq(tag, SLOP_STR("_"))))) {
                        __auto_type _mv_342 = context_ctx_lookup_enum_variant(ctx, tag);
            ...
            __auto_type lst = _mv_343.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 2) {
                    ...
                    if (_mv_344.has_value) {
                        __auto_type binding = _mv_344.value;
                        __auto_type _mv_345 = (*binding);
                        switch (_mv_345.tag) {
                            case types_SExpr_sym:
                            {
...
slop_string expr_get_match_branch_body(context_TranspileContext* ctx, slop_list_types_SExpr_ptr branch_items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 2) {
            ...
            __auto_type _mv_346 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)(len - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_string expr_build_option_match_expr(context_TranspileContext* ctx, types_SExpr* scrutinee, slop_string scrutinee_c, slop_list_types_SExpr_ptr items) {
    ...
    SLOP_PRE(((scrutinee != NULL)), "(!= scrutinee nil)");
    {
        ...
        int64_t i = 2;
        while (i < len) {
            __auto_type _mv_347 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    ...
                    case types_SExpr_lst:
                    {
                        __auto_type branch_lst = _mv_348.data.lst;
                        {
                            ...
                            if (((int64_t)((branch_items).len)) >= 2) {
                                __auto_type _mv_349 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_349.has_value) {
                                    __auto_type pattern = _mv_349.value;
                                    {
                                        __auto_type tag = expr_get_expr_pattern_tag(pattern);
                                        if (string_eq(tag, SLOP_STR("some"))) {
                                            __auto_type _mv_350 = expr_get_expr_binding_name(pattern);
                                            if (_mv_350.has_value) {
                                                __auto_type name = _mv_350.value;
                                                some_binding = name;
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 2) {
            ...
            if (_mv_351.has_value) {
                __auto_type first_clause = _mv_351.value;
                __auto_type _mv_352 = (*first_clause);
                switch (_mv_352.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type clause_lst = _mv_352.data.lst;
                        {
                            __auto_type clause_items = clause_lst.items;
                            __auto_type clause_len = ((int64_t)((clause_items).len));
                            if (clause_len < 2) {
        ...
        case types_SExpr_lst:
        {
            __auto_type branch_lst = _mv_354.data.lst;
            {
                ...
                if (branch_len < 2) {
                    ...
                    __auto_type _mv_355 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)(branch_len - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_355.has_value) {
                        __auto_type body_expr = _mv_355.value;
                        return expr_infer_expr_c_type(ctx, body_expr);
...
slop_string expr_slop_type_to_c_type(context_TranspileContext* ctx, slop_string slop_type) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_357 = context_ctx_lookup_type(ctx, slop_type);
...
slop_string expr_infer_expr_c_type(context_TranspileContext* ctx, types_SExpr* expr) {
    ...
    SLOP_PRE(((expr != NULL)), "(!= expr nil)");
    {
        ...
        if (string_len(checker_type) > 0) {
            ...
            __auto_type _mv_358 = (*expr);
            switch (_mv_358.tag) {
                case types_SExpr_str:
                {
                    __auto_type _ = _mv_358.data.str;
                    return SLOP_STR("slop_string");
                }
                case types_SExpr_num:
                {
                ...
                case types_SExpr_sym:
                {
                    ...
                    {
                        __auto_type name = sym.name;
                        __auto_type _mv_359 = context_ctx_lookup_var(ctx, name);
                        if (_mv_359.has_value) {
                            __auto_type entry = _mv_359.value;
                            {
                ...
                case types_SExpr_lst:
                {
                    __auto_type lst = _mv_358.data.lst;
                    {
                        __auto_type items = lst.items;
                        if (((int64_t)((items).len)) < 1) {
                            return SLOP_STR("int64_t");
                                        ...
                                        __auto_type sym = _mv_361.data.sym;
                                        {
                                            ...
                                            if (({ __auto_type _mv = context_ctx_lookup_func(ctx, op); _mv.has_value ? ({ __auto_type func_entry = _mv.value; func_entry.returns_string; }) : (0); })) {
                                                ...
                                                if (((int64_t)((items).len)) < 2) {
                                                    ...
                                                    __auto_type _mv_363 = ({ __auto_type _lst = items; size_t _idx = (size_t)(((int64_t)((items).len)) - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_363.has_value) {
                                                        __auto_type last_expr = _mv_363.value;
                                                ...
                                                if (((int64_t)((items).len)) < 3) {
                                                    ...
                                                    __auto_type _mv_364 = ({ __auto_type _lst = items; size_t _idx = (size_t)(((int64_t)((items).len)) - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_364.has_value) {
                                                        __auto_type body = _mv_364.value;
                                                        return expr_infer_expr_c_type(ctx, body);
                                                ...
                                                if (((int64_t)((items).len)) < 3) {
                                                    ...
                                                    if (_mv_365.has_value) {
                                                        __auto_type then_expr = _mv_365.value;
                                                ...
                                                __auto_type _mv_367 = context_ctx_get_current_return_type(ctx);
                                                if (_mv_367.has_value) {
                                                    __auto_type ret_type = _mv_367.value;
                                                    if (strlib_starts_with(ret_type, SLOP_STR("slop_option_"))) {
                                                        return ret_type;
                                                    } else {
                                                        return SLOP_STR("slop_option_int");
                                                ...
                                                if (((int64_t)((items).len)) < 2) {
                                                    ...
                                                    if (_mv_369.has_value) {
                                                        __auto_type inner = _mv_369.value;
                                                        {
                                                ...
                                                if (((int64_t)((items).len)) < 2) {
                                                    ...
                                                    if (_mv_371.has_value) {
                                                        __auto_type chan_arg = _mv_371.value;
                                                        {
                                                ...
                                                if (((int64_t)((items).len)) < 2) {
                                                    ...
                                                    if (_mv_375.has_value) {
                                                        __auto_type list_arg = _mv_375.value;
                                                        {
                                                ...
                                                __auto_type _mv_376 = context_ctx_lookup_type(ctx, op);
                                                if (_mv_376.has_value) {
                                                    __auto_type type_entry = _mv_376.value;
                                                    return type_entry.c_name;
                                                } else if (!_mv_376.has_value) {
                                                    __auto_type _mv_377 = context_ctx_lookup_func(ctx, op);
                                                    if (_mv_377.has_value) {
                                                        __auto_type func_entry = _mv_377.value;
                                                        {
                                                            __auto_type ret_type = func_entry.return_type;
                                                            if (func_entry.returns_string) {
                                                                return SLOP_STR("slop_string");
...
slop_string expr_build_result_match_expr(context_TranspileContext* ctx, types_SExpr* scrutinee, slop_string scrutinee_c, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 2;
        while (i < len) {
            __auto_type _mv_378 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_378.has_value) {
                __auto_type branch = _mv_378.value;
                __auto_type _mv_379 = (*branch);
                switch (_mv_379.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type branch_lst = _mv_379.data.lst;
                        {
                            __auto_type branch_items = branch_lst.items;
                            if (((int64_t)((branch_items).len)) >= 2) {
                                __auto_type _mv_380 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_380.has_value) {
                                    __auto_type pattern = _mv_380.value;
                                    {
                                        __auto_type tag = expr_get_expr_pattern_tag(pattern);
                                        if (string_eq(tag, SLOP_STR("ok"))) {
                                            __auto_type _mv_381 = expr_get_expr_binding_name(pattern);
                                            if (_mv_381.has_value) {
                                                __auto_type name = _mv_381.value;
                                                ok_binding = name;
                                            ...
                                            __auto_type _mv_382 = expr_get_expr_binding_name(pattern);
                                            if (_mv_382.has_value) {
                                                __auto_type name = _mv_382.value;
                                                err_binding = name;
...
slop_string expr_build_enum_match_expr(context_TranspileContext* ctx, slop_string scrutinee_c, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 2;
        while (i < len) {
            __auto_type _mv_383 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_383.has_value) {
                __auto_type branch = _mv_383.value;
                __auto_type _mv_384 = (*branch);
                switch (_mv_384.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type branch_lst = _mv_384.data.lst;
                        {
                            __auto_type branch_items = branch_lst.items;
                            if (((int64_t)((branch_items).len)) >= 2) {
                                __auto_type _mv_385 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_385.has_value) {
                                    __auto_type pattern = _mv_385.value;
...
slop_string expr_build_enum_case_expr(context_TranspileContext* ctx, slop_arena* arena, slop_string cases, types_SExpr* pattern, slop_list_types_SExpr_ptr branch_items, slop_string result_type) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (string_eq(tag, SLOP_STR("else")) || string_eq(tag, SLOP_STR("_"))) {
            ...
            __auto_type _mv_386 = context_ctx_lookup_enum_variant(ctx, tag);
            if (_mv_386.has_value) {
                __auto_type type_name = _mv_386.value;
                {
...
slop_string expr_build_union_match_expr(context_TranspileContext* ctx, types_SExpr* scrutinee, slop_string scrutinee_c, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 2;
        while (i < len) {
            __auto_type _mv_387 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_387.has_value) {
                __auto_type branch = _mv_387.value;
                __auto_type _mv_388 = (*branch);
                switch (_mv_388.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type branch_lst = _mv_388.data.lst;
                        {
                            __auto_type branch_items = branch_lst.items;
                            if (((int64_t)((branch_items).len)) >= 2) {
                                __auto_type _mv_389 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_389.has_value) {
                                    __auto_type pattern = _mv_389.value;
...
slop_string expr_wrap_fn_ref_as_closure(context_TranspileContext* ctx, slop_string expected_type, slop_string arg_c, types_SExpr* arg_expr) {
    ...
    if (string_eq(expected_type, SLOP_STR("slop_closure_t"))) {
        __auto_type _mv_390 = (*arg_expr);
        switch (_mv_390.tag) {
            case types_SExpr_sym:
            {
                __auto_type sym = _mv_390.data.sym;
                {
                    __auto_type slop_name = sym.name;
                    __auto_type _mv_391 = context_ctx_lookup_func(ctx, slop_name);
                    if (_mv_391.has_value) {
                        __auto_type func_entry = _mv_391.value;
                        {
        ...
        if (context_ctx_skip_trampoline_generation(ctx)) {
            ...
            if (context_ctx_has_trampoline(ctx, fn_c_name)) {
            ...
            } else {
                {
                    ...
                    int64_t i = 0;
                    while (i < count) {
                        __auto_type _mv_392 = ({ __auto_type _lst = param_types; size_t _idx = (size_t)i; slop_option_context_FuncParamType_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_392.has_value) {
                            __auto_type param_type_ptr = _mv_392.value;
                            {
...
slop_string expr_build_union_case_expr(context_TranspileContext* ctx, slop_arena* arena, slop_string cases, types_SExpr* scrutinee, types_SExpr* pattern, slop_list_types_SExpr_ptr branch_items, slop_string result_type) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (string_eq(tag, SLOP_STR("else")) || string_eq(tag, SLOP_STR("_"))) {
            ...
            __auto_type _mv_393 = context_ctx_lookup_enum_variant(ctx, tag);
            if (_mv_393.has_value) {
                __auto_type type_name = _mv_393.value;
                {
                    __auto_type c_tag = ctype_to_c_name(arena, tag);
                    __auto_type case_label = context_ctx_str4(ctx, type_name, SLOP_STR("_"), c_tag, SLOP_STR(""));
                    __auto_type binding_opt = expr_get_expr_binding_name(pattern);
                    __auto_type _mv_394 = binding_opt;
                    if (_mv_394.has_value) {
                        __auto_type binding_name = _mv_394.value;
                        {
...
uint8_t expr_discard_needs_void(types_SExpr* e) {
    __auto_type _mv_398 = (*e);
    switch (_mv_398.tag) {
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_398.data.lst;
            __auto_type _mv_399 = ({ __auto_type _lst = lst.items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 3) {
            ...
            if (_mv_401.has_value) {
                __auto_type bindings_expr = _mv_401.value;
                __auto_type _mv_402 = (*bindings_expr);
                switch (_mv_402.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type bindings_lst = _mv_402.data.lst;
                        context_ctx_push_scope(ctx);
                        {
                            __auto_type result = SLOP_STR("({ ");
                            ...
                            while (bi < bindings_len) {
                                __auto_type _mv_403 = ({ __auto_type _lst = bindings_items; size_t _idx = (size_t)bi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_403.has_value) {
                                    __auto_type binding = _mv_403.value;
                            ...
                            bi = 0;
                            while (bi < bindings_len) {
                                __auto_type _mv_404 = ({ __auto_type _lst = bindings_items; size_t _idx = (size_t)bi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_404.has_value) {
                                    __auto_type binding = _mv_404.value;
                                    {
                            ...
                            }
                            {
                                __auto_type i = 2;
                                while (i < (len - 1)) {
                                    __auto_type _mv_405 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    ...
                    if (len >= 2) {
                        {
                            ...
                            __auto_type _mv_407 = ({ __auto_type _lst = items; size_t _idx = (size_t)name_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_407.has_value) {
                                __auto_type name_expr = _mv_407.value;
                                __auto_type _mv_408 = (*name_expr);
                                switch (_mv_408.tag) {
                                    case types_SExpr_sym:
                                    {
                                        __auto_type name_sym = _mv_408.data.sym;
                                        {
                ...
                __auto_type lst = _mv_409.data.lst;
                {
                    ...
                    if (len < 2) {
                    ...
                    } else {
                        {
                            __auto_type has_mut = expr_binding_has_mut(items);
                            __auto_type name_idx = ((has_mut) ? 1 : 0);
                            __auto_type _mv_410 = ({ __auto_type _lst = items; size_t _idx = (size_t)name_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                ...
                                switch (_mv_411.tag) {
                                    case types_SExpr_sym:
                                    {
                                        __auto_type name_sym = _mv_411.data.sym;
                                        {
                                            ...
                                            __auto_type init_idx = ((has_mut) ? ((has_type) ? 3 : 2) : ((has_type) ? 2 : 1));
                                            if (has_type) {
                                                __auto_type _mv_412 = ({ __auto_type _lst = items; size_t _idx = (size_t)type_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_412.has_value) {
                                                    ...
                                                    __auto_type _mv_414 = ({ __auto_type _lst = items; size_t _idx = (size_t)init_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_414.has_value) {
                                                        __auto_type init_expr = _mv_414.value;
                                                        {
                                                ...
                                                if (_mv_415.has_value) {
                                                    __auto_type init_expr = _mv_415.value;
                                                    {
                                                        __auto_type init_c = expr_transpile_expr(ctx, init_expr);
                                                        return context_ctx_str5(ctx, SLOP_STR("__auto_type "), var_name, SLOP_STR(" = "), init_c, SLOP_STR(";"));
                                                    }
...
uint8_t expr_binding_has_mut(slop_list_types_SExpr_ptr items) {
    if (((int64_t)((items).len)) < 1) {
        ...
        __auto_type _mv_416 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        if (_mv_416.has_value) {
            __auto_type first = _mv_416.value;
            __auto_type _mv_417 = (*first);
            switch (_mv_417.tag) {
                case types_SExpr_sym:
                {
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_418.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 1) {
                    ...
                    __auto_type _mv_419 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_419.has_value) {
                        __auto_type head = _mv_419.value;
                        __auto_type _mv_420 = (*head);
                        switch (_mv_420.tag) {
                            case types_SExpr_sym:
                            {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 3) {
            ...
            if (_mv_422.has_value) {
                __auto_type cond_expr = _mv_422.value;
                {
                    __auto_type cond_c = expr_transpile_expr(ctx, cond_expr);
        ...
        } else {
            {
                ...
                while (i < len) {
                    ...
                    if (_mv_424.has_value) {
                        __auto_type expr = _mv_424.value;
                        {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 2) {
            ...
            if (_mv_425.has_value) {
                __auto_type cond_expr = _mv_425.value;
                {
                    __auto_type cond_c = expr_transpile_expr(ctx, cond_expr);
                    __auto_type body_c = SLOP_STR("({ ");
                    {
                        ...
                        while (i < len) {
                            ...
                            if (_mv_426.has_value) {
                                __auto_type body_expr = _mv_426.value;
...
uint8_t expr_set_is_self_assign(slop_list_types_SExpr_ptr items) {
    if (((int64_t)((items).len)) == 3) {
        ...
        if (_mv_427.has_value) {
            __auto_type target_expr = _mv_427.value;
            __auto_type _mv_428 = (*target_expr);
            switch (_mv_428.tag) {
                case types_SExpr_sym:
                {
                    __auto_type tsym = _mv_428.data.sym;
                    ...
                    if (_mv_429.has_value) {
                        ...
                        __auto_type _mv_430 = (*value_expr);
                        switch (_mv_430.tag) {
                            case types_SExpr_sym:
                            {
                                __auto_type vsym = _mv_430.data.sym;
        ...
        if (expr_set_is_self_assign(items)) {
            ...
            if (len < 3) {
                ...
                if (_mv_431.has_value) {
                    __auto_type target_expr = _mv_431.value;
                    ...
                    if (_mv_432.has_value) {
                        ...
                        {
                            __auto_type val_c = expr_transpile_expr(ctx, val_expr);
                            __auto_type _mv_433 = (*target_expr);
                            switch (_mv_433.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type target_lst = _mv_433.data.lst;
                                    {
                                        ...
                                        if (((int64_t)((target_items).len)) < 1) {
                                            ...
                                            __auto_type _mv_434 = ({ __auto_type _lst = target_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                        ...
                                                        __auto_type sym = _mv_435.data.sym;
                                                        {
                                                            ...
                                                            if (string_eq(op, SLOP_STR("@"))) {
                                                                if (((int64_t)((target_items).len)) < 3) {
                                                                    ...
                                                                    __auto_type _mv_436 = ({ __auto_type _lst = target_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                                    if (_mv_436.has_value) {
                                                                        __auto_type arr_expr = _mv_436.value;
                                                                        __auto_type _mv_437 = ({ __auto_type _lst = target_items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                                        if (_mv_437.has_value) {
                                                                            __auto_type idx_expr = _mv_437.value;
                                                                            {
                                                                                __auto_type arr_c = expr_transpile_expr(ctx, arr_expr);
                                                                                __auto_type idx_c = expr_transpile_expr(ctx, idx_expr);
...
slop_string expr_resolve_arena_c_name(context_TranspileContext* ctx, slop_string op, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    __auto_type _mv_438 = context_ctx_lookup_var(ctx, SLOP_STR("arena"));
    if (_mv_438.has_value) {
        __auto_type entry = _mv_438.value;
        return entry.c_name;
    } else if (!_mv_438.has_value) {
        __auto_type _mv_439 = context_ctx_find_arena_var(ctx);
        if (_mv_439.has_value) {
            __auto_type entry = _mv_439.value;
            return entry.c_name;
...
slop_string expr_get_arena_for_list_push_expr(context_TranspileContext* ctx, types_SExpr* list_expr, slop_string list_c) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    SLOP_PRE(((list_expr != NULL)), "(!= list-expr nil)");
    __auto_type _mv_440 = context_ctx_lookup_var(ctx, SLOP_STR("arena"));
    if (_mv_440.has_value) {
        __auto_type arena_var = _mv_440.value;
        return arena_var.c_name;
    } else if (!_mv_440.has_value) {
        __auto_type _mv_441 = context_ctx_lookup_var(ctx, SLOP_STR("ctx"));
        if (_mv_441.has_value) {
            __auto_type ctx_var = _mv_441.value;
        ...
        } else if (!_mv_441.has_value) {
            {
                ...
                if (string_len(arena_from_field) > 0) {
                    ...
                    __auto_type _mv_442 = context_ctx_find_arena_var(ctx);
                    if (_mv_442.has_value) {
                        __auto_type arena_entry = _mv_442.value;
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_443.data.lst;
            {
                ...
                if (len < 3) {
                    ...
                    __auto_type _mv_444 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_444.has_value) {
                        __auto_type head_expr = _mv_444.value;
                        __auto_type _mv_445 = (*head_expr);
                        switch (_mv_445.tag) {
                            case types_SExpr_sym:
                            {
                                __auto_type sym = _mv_445.data.sym;
                                if (string_eq(sym.name, SLOP_STR("."))) {
                                    __auto_type _mv_446 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    if (_mv_446.has_value) {
                                        __auto_type base_expr = _mv_446.value;
...
slop_string expr_get_arena_from_base(context_TranspileContext* ctx, types_SExpr* base_expr) {
    ...
    switch (_mv_447.tag) {
        case types_SExpr_sym:
        {
            ...
            {
                __auto_type var_name = sym.name;
                __auto_type _mv_448 = context_ctx_lookup_var(ctx, var_name);
                if (_mv_448.has_value) {
                    __auto_type entry = _mv_448.value;
                    if (entry.is_pointer) {
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_447.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 2) {
                    ...
                    __auto_type _mv_449 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_449.has_value) {
                        __auto_type head_expr = _mv_449.value;
                        __auto_type _mv_450 = (*head_expr);
                        switch (_mv_450.tag) {
                            case types_SExpr_sym:
                            {
                                __auto_type sym = _mv_450.data.sym;
                                if (string_eq(sym.name, SLOP_STR("deref"))) {
                                    ...
                                    if (_mv_451.has_value) {
                                        __auto_type ptr_expr = _mv_451.value;
                                        {
...
uint8_t expr_is_ptr_to_ptr_map(context_TranspileContext* ctx, types_SExpr* expr) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    SLOP_PRE(((expr != NULL)), "(!= expr nil)");
    __auto_type _mv_452 = (*expr);
    switch (_mv_452.tag) {
        case types_SExpr_sym:
        {
            __auto_type sym = _mv_452.data.sym;
            {
                __auto_type name = sym.name;
                __auto_type _mv_453 = context_ctx_lookup_var(ctx, name);
                if (_mv_453.has_value) {
                    __auto_type entry = _mv_453.value;
                    {
                        __auto_type c_type = entry.c_type;
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 2) {
            ...
            if (_mv_454.has_value) {
                __auto_type type_expr = _mv_454.value;
                __auto_type _mv_455 = (*type_expr);
                switch (_mv_455.tag) {
                    case types_SExpr_sym:
                    {
                        __auto_type type_sym = _mv_455.data.sym;
                        {
                            __auto_type raw_type_name = type_sym.name;
                    ...
                    case types_SExpr_lst:
                    {
                        __auto_type type_lst = _mv_455.data.lst;
                        {
                            ...
                            if (((int64_t)((type_items).len)) < 1) {
                                ...
                                __auto_type _mv_456 = ({ __auto_type _lst = type_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_456.has_value) {
                                    __auto_type head = _mv_456.value;
                                    __auto_type _mv_457 = (*head);
                                    switch (_mv_457.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type head_sym = _mv_457.data.sym;
...
slop_string expr_transpile_record_fields(context_TranspileContext* ctx, slop_string type_name, slop_list_types_SExpr_ptr items, int64_t start_idx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        uint8_t first = 1;
        while (i < len) {
            __auto_type _mv_458 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_458.has_value) {
                __auto_type field_expr = _mv_458.value;
                __auto_type _mv_459 = (*field_expr);
                switch (_mv_459.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type field_lst = _mv_459.data.lst;
                        {
                            __auto_type field_items = field_lst.items;
                            if (((int64_t)((field_items).len)) >= 2) {
                                __auto_type _mv_460 = ({ __auto_type _lst = field_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_460.has_value) {
                                    ...
                                    switch (_mv_461.tag) {
                                        case types_SExpr_sym:
                                        {
                                            ...
                                            __auto_type _mv_462 = ({ __auto_type _lst = field_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_string expr_build_inline_struct_type(context_TranspileContext* ctx, slop_list_types_SExpr_ptr type_items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 1;
        while (i < len) {
            __auto_type _mv_463 = ({ __auto_type _lst = type_items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_463.has_value) {
                __auto_type field_expr = _mv_463.value;
                __auto_type _mv_464 = (*field_expr);
                switch (_mv_464.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type field_lst = _mv_464.data.lst;
                        {
                            __auto_type field_items = field_lst.items;
                            if (((int64_t)((field_items).len)) >= 2) {
                                __auto_type _mv_465 = ({ __auto_type _lst = field_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_465.has_value) {
                                    __auto_type name_expr = _mv_465.value;
                                    __auto_type _mv_466 = (*name_expr);
                                    switch (_mv_466.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type name_sym = _mv_466.data.sym;
                                            __auto_type _mv_467 = ({ __auto_type _lst = field_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_string expr_transpile_inline_record_fields(context_TranspileContext* ctx, slop_string struct_def, slop_list_types_SExpr_ptr items, int64_t start_idx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        uint8_t first = 1;
        while (i < len) {
            __auto_type _mv_468 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_468.has_value) {
                __auto_type field_expr = _mv_468.value;
                __auto_type _mv_469 = (*field_expr);
                switch (_mv_469.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type field_lst = _mv_469.data.lst;
                        {
                            __auto_type field_items = field_lst.items;
                            if (((int64_t)((field_items).len)) >= 2) {
                                __auto_type _mv_470 = ({ __auto_type _lst = field_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_470.has_value) {
                                    __auto_type name_expr = _mv_470.value;
                                    __auto_type _mv_471 = (*name_expr);
                                    switch (_mv_471.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type name_sym = _mv_471.data.sym;
                                            __auto_type _mv_472 = ({ __auto_type _lst = field_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_472.has_value) {
                                                __auto_type val_expr = _mv_472.value;
                                                {
                                                    __auto_type field_name = ctype_to_c_name(arena, name_sym.name);
                ...
                __auto_type type_expr = _mv_473.value;
                {
                    ...
                    __auto_type elem_count = (len - 2);
                    {
                        ...
                        }
                        {
                            ...
                            __auto_type _mv_475 = arena_var;
                            if (_mv_475.has_value) {
                                __auto_type arena_var = _mv_475.value;
                                {
                                    ...
                                    while (i < ((int64_t)((elem_codes).len))) {
                                        __auto_type _mv_476 = ({ __auto_type _lst = elem_codes; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_476.has_value) {
                                            __auto_type ec = _mv_476.value;
                                            {
                                ...
                                context_ctx_add_warning(ctx, SLOP_STR("list literal uses stack-allocated compound literal (no arena in scope)"));
                                {
                                    ...
                                    i = 0;
                                    while (i < ((int64_t)((elem_codes).len))) {
                                        __auto_type _mv_477 = ({ __auto_type _lst = elem_codes; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_477.has_value) {
                                            __auto_type ec = _mv_477.value;
                                            if (first) {
...
slop_string expr_get_map_key_c_info(context_TranspileContext* ctx, types_SExpr* key_type_expr) {
    ...
    __auto_type _mv_478 = (*key_type_expr);
    switch (_mv_478.tag) {
        case types_SExpr_sym:
        {
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_478.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 1) {
                    ...
                    __auto_type _mv_479 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_string expr_get_struct_key_info_by_name(context_TranspileContext* ctx, slop_string name) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    __auto_type _mv_481 = context_ctx_lookup_type(ctx, name);
    if (_mv_481.has_value) {
        __auto_type type_entry = _mv_481.value;
        {
            __auto_type c_name = type_entry.c_name;
            context_ctx_register_struct_key_type(ctx, c_name);
            return expr_build_struct_key_info(ctx, c_name);
        ...
        __auto_type _mv_482 = context_ctx_get_module(ctx);
        if (_mv_482.has_value) {
            __auto_type mod = _mv_482.value;
            {
                __auto_type prefixed = context_ctx_str3(ctx, mod, SLOP_STR("_"), name);
                __auto_type _mv_483 = context_ctx_lookup_type(ctx, prefixed);
                if (_mv_483.has_value) {
                    __auto_type type_entry = _mv_483.value;
                    {
                        __auto_type c_name = type_entry.c_name;
                        context_ctx_register_struct_key_type(ctx, c_name);
                        return expr_build_struct_key_info(ctx, c_name);
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 3) {
            ...
            if (_mv_485.has_value) {
                __auto_type arena_expr = _mv_485.value;
                __auto_type _mv_486 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_486.has_value) {
                    __auto_type key_type_expr = _mv_486.value;
                    {
                        __auto_type arena_c = expr_transpile_expr(ctx, arena_expr);
...
slop_string expr_transpile_map_put(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 4) {
            ...
            __auto_type _mv_487 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_487.has_value) {
                __auto_type map_expr = _mv_487.value;
                __auto_type _mv_488 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_488.has_value) {
                    __auto_type key_expr = _mv_488.value;
                    __auto_type _mv_489 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 3) {
            ...
            if (_mv_492.has_value) {
                __auto_type map_expr = _mv_492.value;
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 3) {
            ...
            if (_mv_495.has_value) {
                __auto_type arena_expr = _mv_495.value;
                ...
                if (_mv_496.has_value) {
                    __auto_type elem_type_expr = _mv_496.value;
                    {
                        __auto_type arena_c = expr_transpile_expr(ctx, arena_expr);
            ...
            if (_mv_497.has_value) {
                ...
                if (_mv_498.has_value) {
                    __auto_type elem_expr = _mv_498.value;
                    {
                        ...
                        return context_ctx_str(ctx, context_ctx_str3(ctx, SLOP_STR("({ uint8_t _dummy = 1; slop_map_put("), arena_c, SLOP_STR(", ")), context_ctx_str(ctx, set_c, context_ctx_str(ctx, SLOP_STR(", "), context_ctx_str(ctx, elem_ptr, SLOP_STR(", &_dummy); })")))));
                    }
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 3) {
            ...
            if (_mv_501.has_value) {
                __auto_type set_expr = _mv_501.value;
                __auto_type _mv_502 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 2) {
            ...
            if (_mv_503.has_value) {
                __auto_type set_expr = _mv_503.value;
                {
                    __auto_type set_c = expr_transpile_expr(ctx, set_expr);
            ...
            if (_mv_504.has_value) {
                __auto_type type_expr = _mv_504.value;
                {
                    ...
                    __auto_type result = context_ctx_str(ctx, context_ctx_str3(ctx, SLOP_STR("({ slop_map* _s = slop_map_new_ptr("), arena_c, SLOP_STR(", ")), context_ctx_str(ctx, int_to_string(arena, init_cap), context_ctx_str(ctx, SLOP_STR(", "), context_ctx_str(ctx, elem_info, SLOP_STR("); ")))));
                    {
                        __auto_type i = 2;
                        while (i < len) {
                            __auto_type _mv_505 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_505.has_value) {
                                __auto_type elem_expr = _mv_505.value;
                                {
                                    __auto_type elem_c = expr_transpile_expr(ctx, elem_expr);
                                    __auto_type elem_ptr = expr_wrap_map_key_as_ptr(ctx, elem_c, elem_expr, NULL);
                                    result = context_ctx_str(ctx, result, context_ctx_str(ctx, context_ctx_str3(ctx, SLOP_STR("slop_map_put("), arena_c, SLOP_STR(", _s, ")), context_ctx_str(ctx, elem_ptr, SLOP_STR(", &(uint8_t){1}); "))));
                                }
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 2) {
            ...
            if (_mv_506.has_value) {
                __auto_type binding_expr = _mv_506.value;
                __auto_type _mv_507 = (*binding_expr);
                switch (_mv_507.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type binding_lst = _mv_507.data.lst;
                        {
                            ...
                            if (binding_len < 3) {
                                ...
                                __auto_type _mv_508 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_508.has_value) {
                                    __auto_type var_expr = _mv_508.value;
                                    __auto_type _mv_509 = (*var_expr);
                                    switch (_mv_509.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type var_sym = _mv_509.data.sym;
                                            {
                                                __auto_type var_name = ctype_to_c_name(arena, var_sym.name);
                                                __auto_type _mv_510 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_510.has_value) {
                                                    __auto_type start_expr = _mv_510.value;
                                                    __auto_type _mv_511 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_511.has_value) {
                                                        __auto_type end_expr = _mv_511.value;
                                                        {
                                                            ...
                                                            context_ctx_bind_var(ctx, (context_VarEntry){var_sym.name, var_name, SLOP_STR("int64_t"), SLOP_STR(""), 0, 0, 0, SLOP_STR(""), SLOP_STR("")});
                                                            {
                                                                __auto_type i = 2;
                                                                while (i < len) {
                                                                    __auto_type _mv_512 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                                    if (_mv_512.has_value) {
                                                                        __auto_type body_expr = _mv_512.value;
                                                                        {
                                                                            __auto_type body_c = expr_transpile_expr(ctx, body_expr);
                                                                            result = context_ctx_str3(ctx, result, body_c, SLOP_STR("; "));
                                                                        }
        ...
        if (len < 2) {
            ...
            if (_mv_513.has_value) {
                ...
                switch (_mv_514.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type binding_lst = _mv_514.data.lst;
                        {
                            __auto_type binding_items = binding_lst.items;
                            __auto_type binding_len = ((int64_t)((binding_items).len));
                            if (binding_len < 2) {
                                ...
                                __auto_type _mv_515 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_515.has_value) {
                                    __auto_type first_elem = _mv_515.value;
                                    __auto_type _mv_516 = (*first_elem);
                                    switch (_mv_516.tag) {
                                        case types_SExpr_lst:
                                        {
                                            __auto_type _ = _mv_516.data.lst;
                                            return expr_transpile_for_each_map_kv_as_expr(ctx, binding_items, items, len);
                                        }
                                        case types_SExpr_sym:
                                        {
                                            __auto_type var_sym = _mv_516.data.sym;
                                            {
                                                __auto_type var_name = ctype_to_c_name(arena, var_sym.name);
                                                __auto_type _mv_517 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_517.has_value) {
                                                    __auto_type coll_expr = _mv_517.value;
                                                    {
        ...
        }
        {
            ...
            while (i < len) {
                ...
                if (_mv_518.has_value) {
                    __auto_type body_expr = _mv_518.value;
                    {
                        __auto_type body_c = expr_transpile_expr(ctx, body_expr);
                        result = context_ctx_str3(ctx, result, body_c, SLOP_STR("; "));
                    }
    ...
    SLOP_PRE(((coll_expr != NULL)), "(!= coll-expr nil)");
    {
        ...
        __auto_type elem_c_type = expr_slop_value_type_to_c_type(ctx, elem_slop_type);
        {
            ...
            context_ctx_bind_var(ctx, (context_VarEntry){var_sym.name, var_name, elem_c_type, elem_slop_type, 0, 0, 0, SLOP_STR(""), SLOP_STR("")});
            {
                int64_t i = 2;
                while (i < len) {
                    __auto_type _mv_519 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_519.has_value) {
                        __auto_type body_expr = _mv_519.value;
                        {
                            __auto_type body_c = expr_transpile_expr(ctx, body_expr);
                            result = context_ctx_str3(ctx, result, body_c, SLOP_STR("; "));
                        }
    ...
    SLOP_PRE(((coll_expr != NULL)), "(!= coll-expr nil)");
    {
        ...
        __auto_type key_c_type = expr_slop_value_type_to_c_type(ctx, key_slop_type);
        {
            ...
            context_ctx_bind_var(ctx, (context_VarEntry){var_sym.name, var_name, key_c_type, key_slop_type, 0, 0, 0, SLOP_STR(""), SLOP_STR("")});
            {
                int64_t i = 2;
                while (i < len) {
                    __auto_type _mv_520 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_520.has_value) {
                        __auto_type body_expr = _mv_520.value;
                        {
                            __auto_type body_c = expr_transpile_expr(ctx, body_expr);
                            result = context_ctx_str3(ctx, result, body_c, SLOP_STR("; "));
                        }
...
slop_string expr_transpile_for_each_map_kv_as_expr(context_TranspileContext* ctx, slop_list_types_SExpr_ptr binding_items, slop_list_types_SExpr_ptr items, int64_t len) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_521 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        if (_mv_521.has_value) {
            __auto_type kv_list_expr = _mv_521.value;
            __auto_type _mv_522 = (*kv_list_expr);
            switch (_mv_522.tag) {
                case types_SExpr_lst:
                {
                    __auto_type kv_lst = _mv_522.data.lst;
                    {
                        __auto_type kv_items = kv_lst.items;
                        if (((int64_t)((kv_items).len)) < 2) {
                            return SLOP_STR("({ /* for-each: map binding needs ((k v) map) */ 0; })");
                        } else {
                            __auto_type _mv_523 = ({ __auto_type _lst = kv_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_523.has_value) {
                                __auto_type k_expr = _mv_523.value;
                                __auto_type _mv_524 = ({ __auto_type _lst = kv_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_524.has_value) {
                                    __auto_type v_expr = _mv_524.value;
                                    __auto_type _mv_525 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    if (_mv_525.has_value) {
                                        __auto_type map_expr = _mv_525.value;
                                        __auto_type _mv_526 = (*k_expr);
                                        switch (_mv_526.tag) {
                                            case types_SExpr_sym:
                                            {
                                                __auto_type k_sym = _mv_526.data.sym;
                                                __auto_type _mv_527 = (*v_expr);
                                                switch (_mv_527.tag) {
                                                    case types_SExpr_sym:
                                                    {
                                                        __auto_type v_sym = _mv_527.data.sym;
                                                        {
                                                            ...
                                                            __auto_type val_c_type = expr_slop_value_type_to_c_type(ctx, val_slop_type);
                                                            {
                                                                ...
                                                                context_ctx_bind_var(ctx, (context_VarEntry){v_sym.name, v_name, val_c_type, val_slop_type, 0, 0, 0, SLOP_STR(""), SLOP_STR("")});
                                                                {
                                                                    __auto_type i = 2;
                                                                    while (i < len) {
                                                                        __auto_type _mv_528 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                                        if (_mv_528.has_value) {
                                                                            __auto_type body_expr = _mv_528.value;
                                                                            {
                                                                                __auto_type body_c = expr_transpile_expr(ctx, body_expr);
                                                                                result = context_ctx_str3(ctx, result, body_c, SLOP_STR("; "));
                                                                            }
        ...
        if (len < 2) {
            ...
            if (_mv_529.has_value) {
                ...
                switch (_mv_530.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type params_lst = _mv_530.data.lst;
                        return expr_transpile_lambda_with_params(ctx, items, params_lst.items);
                    }
                    case types_SExpr_sym:
                    {
                        __auto_type _ = _mv_530.data.sym;
...
slop_list_string expr_extract_param_names(slop_arena* arena, slop_list_types_SExpr_ptr params) {
    {
        ...
        int64_t i = 0;
        while (i < count) {
            __auto_type _mv_531 = ({ __auto_type _lst = params; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    ...
                    case types_SExpr_lst:
                    {
                        __auto_type param_lst = _mv_532.data.lst;
                        {
                            ...
                            if (((int64_t)((param_items).len)) >= 1) {
                                __auto_type _mv_533 = ({ __auto_type _lst = param_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_string expr_build_closure_struct(context_TranspileContext* ctx, slop_string env_type, slop_list_string free_vars) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < count) {
            __auto_type _mv_535 = ({ __auto_type _lst = free_vars; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_535.has_value) {
                __auto_type var_name = _mv_535.value;
                {
...
slop_list_string expr_capture_free_var_accesses(context_TranspileContext* ctx, slop_list_string free_vars) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < count) {
            __auto_type _mv_537 = ({ __auto_type _lst = free_vars; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_537.has_value) {
                __auto_type var_name = _mv_537.value;
                {
                    __auto_type c_name = ctype_to_c_name(arena, var_name);
                    __auto_type var_info = context_ctx_lookup_var(ctx, var_name);
...
slop_string expr_find_arena_ptr_expr(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    __auto_type _mv_538 = context_ctx_lookup_var(ctx, SLOP_STR("_arena"));
    if (_mv_538.has_value) {
        __auto_type entry = _mv_538.value;
        return SLOP_STR("&_arena");
    } else if (!_mv_538.has_value) {
        __auto_type _mv_539 = context_ctx_lookup_var(ctx, SLOP_STR("arena"));
        if (_mv_539.has_value) {
            __auto_type entry = _mv_539.value;
            return entry.c_name;
...
slop_string expr_build_env_initializer(context_TranspileContext* ctx, slop_list_string free_vars, slop_list_string captured_accesses) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < count) {
            __auto_type _mv_540 = ({ __auto_type _lst = free_vars; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_540.has_value) {
                __auto_type var_name = _mv_540.value;
                {
                    __auto_type c_name = ctype_to_c_name(arena, var_name);
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (param_count == 0) {
        ...
        } else {
            {
                ...
                int64_t i = 0;
                while (i < param_count) {
                    __auto_type _mv_541 = ({ __auto_type _lst = params; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_541.has_value) {
                        __auto_type param_expr = _mv_541.value;
                        __auto_type _mv_542 = (*param_expr);
                        switch (_mv_542.tag) {
                            case types_SExpr_lst:
                            {
                                __auto_type param_lst = _mv_542.data.lst;
                                {
                                    __auto_type param_items = param_lst.items;
                                    if (((int64_t)((param_items).len)) >= 2) {
                                        __auto_type _mv_543 = ({ __auto_type _lst = param_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_543.has_value) {
                                            __auto_type name_expr = _mv_543.value;
                                            __auto_type _mv_544 = (*name_expr);
                                            switch (_mv_544.tag) {
                                                case types_SExpr_sym:
                                                {
                                                    __auto_type name_sym = _mv_544.data.sym;
                                                    __auto_type _mv_545 = ({ __auto_type _lst = param_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void expr_bind_lambda_params(context_TranspileContext* ctx, slop_list_types_SExpr_ptr params) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < param_count) {
            __auto_type _mv_546 = ({ __auto_type _lst = params; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_546.has_value) {
                __auto_type param_expr = _mv_546.value;
                __auto_type _mv_547 = (*param_expr);
                switch (_mv_547.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type param_lst = _mv_547.data.lst;
                        {
                            __auto_type param_items = param_lst.items;
                            if (((int64_t)((param_items).len)) >= 2) {
                                __auto_type _mv_548 = ({ __auto_type _lst = param_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_548.has_value) {
                                    ...
                                    switch (_mv_549.tag) {
                                        case types_SExpr_sym:
                                        {
                                            ...
                                            __auto_type _mv_550 = ({ __auto_type _lst = param_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_string expr_transpile_lambda_body(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items, int64_t start, slop_string return_type) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len <= start) {
            ...
            while (i < len) {
                __auto_type _mv_554 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_string expr_transpile_spawn_closure(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items, types_SExpr* fn_expr) {
    ...
    SLOP_PRE(((fn_expr != NULL)), "(!= fn-expr nil)");
    {
        ...
        if (_mv_560.has_value) {
            __auto_type arena_expr = _mv_560.value;
            {
                __auto_type arena_c = expr_transpile_expr(ctx, arena_expr);
...
uint8_t expr_lambda_has_captures(context_TranspileContext* ctx, types_SExpr* fn_expr) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    SLOP_PRE(((fn_expr != NULL)), "(!= fn-expr nil)");
    __auto_type _mv_561 = (*fn_expr);
    switch (_mv_561.tag) {
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_561.data.lst;
            {
                __auto_type items = lst.items;
                __auto_type arena = (*ctx).arena;
                if (((int64_t)((items).len)) < 2) {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (((int64_t)((items).len)) < 2) {
            ...
            if (_mv_565.has_value) {
                __auto_type first_arg = _mv_565.value;
                {
...
slop_list_string expr_find_free_vars(context_TranspileContext* ctx, slop_list_string param_names, slop_list_types_SExpr_ptr body_items, int64_t start, slop_list_string pending) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = start;
        while (i < len) {
            __auto_type _mv_566 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_566.has_value) {
                __auto_type expr = _mv_566.value;
        ...
        }
        {
            ...
            int64_t j = 0;
            while (j < sym_count) {
                __auto_type _mv_567 = ({ __auto_type _lst = all_symbols; size_t _idx = (size_t)j; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_567.has_value) {
                    __auto_type sym_name = _mv_567.value;
...
void expr_collect_symbols_in_expr(context_TranspileContext* ctx, slop_list_string* symbols, slop_list_string pending, types_SExpr* expr) {
    ...
    switch (_mv_568.tag) {
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_568.data.lst;
            {
                __auto_type items = lst.items;
                __auto_type len = ((int64_t)((items).len));
                if (len > 0) {
                    __auto_type _mv_569 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_569.has_value) {
                        ...
                        switch (_mv_570.tag) {
                            case types_SExpr_sym:
                            {
                                __auto_type head_sym = _mv_570.data.sym;
                                {
                                    __auto_type op = head_sym.name;
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len >= 2) {
            ...
            if (_mv_572.has_value) {
                __auto_type bindings_expr = _mv_572.value;
                {
                    ...
                    __auto_type _mv_573 = (*bindings_expr);
                    switch (_mv_573.tag) {
                        case types_SExpr_lst:
                        {
                            __auto_type bindings_lst = _mv_573.data.lst;
                            {
                                __auto_type bindings = bindings_lst.items;
                                __auto_type binding_count = ((int64_t)((bindings).len));
                                __auto_type i = 0;
                                while (i < binding_count) {
                                    __auto_type _mv_574 = ({ __auto_type _lst = bindings; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    if (_mv_574.has_value) {
                                        __auto_type binding = _mv_574.value;
                                        __auto_type _mv_575 = (*binding);
                                        switch (_mv_575.tag) {
                                            case types_SExpr_lst:
                                            {
                                                __auto_type bind_lst = _mv_575.data.lst;
                                                {
                                                    __auto_type bind_items = bind_lst.items;
                                                    if (((int64_t)((bind_items).len)) >= 2) {
                                                        {
                                                            __auto_type val_idx = ((expr_is_mut_binding(bind_items)) ? 2 : 1);
                                                            __auto_type _mv_576 = ({ __auto_type _lst = bind_items; size_t _idx = (size_t)val_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                            if (_mv_576.has_value) {
                                                                __auto_type val_expr = _mv_576.value;
...
uint8_t expr_is_mut_binding(slop_list_types_SExpr_ptr items) {
    if (((int64_t)((items).len)) < 1) {
        ...
        __auto_type _mv_577 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        if (_mv_577.has_value) {
            __auto_type first = _mv_577.value;
            __auto_type _mv_578 = (*first);
            switch (_mv_578.tag) {
                case types_SExpr_sym:
                {
...
slop_list_string expr_extract_let_binding_names(slop_arena* arena, types_SExpr* bindings_expr) {
    ...
    {
        __auto_type names = ((slop_list_string){ .data = (slop_string*)slop_arena_alloc(arena, 16 * sizeof(slop_string)), .len = 0, .cap = 16 });
        __auto_type _mv_579 = (*bindings_expr);
        switch (_mv_579.tag) {
            case types_SExpr_lst:
            {
                __auto_type bindings_lst = _mv_579.data.lst;
                {
                    __auto_type bindings = bindings_lst.items;
                    __auto_type binding_count = ((int64_t)((bindings).len));
                    __auto_type i = 0;
                    while (i < binding_count) {
                        __auto_type _mv_580 = ({ __auto_type _lst = bindings; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_580.has_value) {
                            __auto_type binding = _mv_580.value;
                            __auto_type _mv_581 = (*binding);
                            switch (_mv_581.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type bind_lst = _mv_581.data.lst;
                                    {
                                        __auto_type bind_items = bind_lst.items;
                                        if (((int64_t)((bind_items).len)) >= 1) {
                                            {
                                                __auto_type name_idx = ((expr_is_mut_binding(bind_items)) ? 1 : 0);
                                                __auto_type _mv_582 = ({ __auto_type _lst = bind_items; size_t _idx = (size_t)name_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len >= 2) {
            ...
            if (_mv_584.has_value) {
                __auto_type scrutinee = _mv_584.value;
            ...
            }
            {
                int64_t i = 2;
                while (i < len) {
                    __auto_type _mv_585 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_585.has_value) {
                        __auto_type clause = _mv_585.value;
                        __auto_type _mv_586 = (*clause);
                        switch (_mv_586.tag) {
                            case types_SExpr_lst:
                            {
                                __auto_type clause_lst = _mv_586.data.lst;
                                {
                                    __auto_type clause_items = clause_lst.items;
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len >= 2) {
            ...
            if (_mv_587.has_value) {
                __auto_type binding = _mv_587.value;
                __auto_type _mv_588 = (*binding);
                switch (_mv_588.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type bind_lst = _mv_588.data.lst;
                        {
                            __auto_type bind_items = bind_lst.items;
...
slop_list_string expr_extract_for_loop_var_pending(slop_arena* arena, slop_list_string pending, slop_list_types_SExpr_ptr bind_items) {
    if (((int64_t)((bind_items).len)) < 1) {
        ...
        __auto_type _mv_589 = ({ __auto_type _lst = bind_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        if (_mv_589.has_value) {
            __auto_type var_expr = _mv_589.value;
            __auto_type _mv_590 = (*var_expr);
            switch (_mv_590.tag) {
                case types_SExpr_sym:
                {
                    __auto_type var_sym = _mv_590.data.sym;
                    {
                        __auto_type result = ((slop_list_string){ .data = (slop_string*)slop_arena_alloc(arena, 16 * sizeof(slop_string)), .len = 0, .cap = 16 });
                        ...
                        __auto_type i = 0;
                        while (i < plen) {
                            __auto_type _mv_591 = ({ __auto_type _lst = pending; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_591.has_value) {
                                __auto_type s = _mv_591.value;
        ...
        if (len >= 3) {
            {
                ...
                __auto_type size_idx = ((is_named) ? 3 : 1);
                __auto_type body_start = ((is_named) ? 4 : 2);
                __auto_type _mv_592 = ({ __auto_type _lst = items; size_t _idx = (size_t)size_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_592.has_value) {
                    __auto_type size_expr = _mv_592.value;
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len >= 2) {
            ...
            if (_mv_593.has_value) {
                __auto_type params_expr = _mv_593.value;
                __auto_type _mv_594 = (*params_expr);
                switch (_mv_594.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type params_lst = _mv_594.data.lst;
                        {
                            __auto_type params = params_lst.items;
                            __auto_type param_names = expr_extract_param_names(arena, params);
    ...
    if (expr_list_contains_string(param_names, sym_name)) {
        ...
        if (expr_list_contains_string(pending, sym_name)) {
            ...
            if (expr_is_builtin_op(sym_name)) {
                ...
                __auto_type _mv_595 = context_ctx_lookup_func(ctx, sym_name);
                if (_mv_595.has_value) {
                    __auto_type _ = _mv_595.value;
                    return 0;
                } else if (!_mv_595.has_value) {
                    __auto_type _mv_596 = context_ctx_lookup_type(ctx, sym_name);
                    if (_mv_596.has_value) {
                        __auto_type _ = _mv_596.value;
                        return 0;
                    } else if (!_mv_596.has_value) {
                        __auto_type _mv_597 = context_ctx_lookup_var(ctx, sym_name);
                        if (_mv_597.has_value) {
                            __auto_type _ = _mv_597.value;
                            return 1;
...
uint8_t expr_list_contains_string(slop_list_string lst, slop_string needle) {
    {
        ...
        uint8_t found = 0;
        while ((i < len) && !(found)) {
            __auto_type _mv_598 = ({ __auto_type _lst = lst; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_598.has_value) {
                __auto_type s = _mv_598.value;
                    ...
                    if (((int64_t)((items).len)) < 1) {
                        ...
                        if (_mv_602.has_value) {
                            ...
                            switch (_mv_603.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type sym = _mv_603.data.sym;
                                    {
                                        __auto_type op = sym.name;
                                        if (string_eq(op, SLOP_STR("map-keys"))) {
                                            if (((int64_t)((items).len)) < 2) {
                                                ...
                                                if (_mv_604.has_value) {
                                                    __auto_type map_expr = _mv_604.value;
                                                    {
                                                        __auto_type map_slop_type = expr_infer_expr_slop_type(ctx, map_expr);
                                            ...
                                            if (((int64_t)((items).len)) < 2) {
                                                ...
                                                if (_mv_605.has_value) {
                                                    __auto_type set_expr = _mv_605.value;
                                                    {
                                            ...
                                            if (((int64_t)((items).len)) < 2) {
                                                ...
                                                if (_mv_606.has_value) {
                                                    __auto_type map_expr = _mv_606.value;
                                                    {
                                                        __auto_type map_slop_type = expr_infer_expr_slop_type(ctx, map_expr);
                                                        if (string_len(map_slop_type) > 0) {
                                                            {
