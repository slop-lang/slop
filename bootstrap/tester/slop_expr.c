                            ...
                            if (expr_is_binop(op) && (len < 3)) {
                                ...
                                if (_mv_274.has_value) {
                                    ...
                                    if (_mv_275.has_value) {
                                        __auto_type idx_expr = _mv_275.value;
                                        {
                                            __auto_type list_c = expr_transpile_expr(ctx, list_expr);
                                            __auto_type idx_c = expr_transpile_expr(ctx, idx_expr);
                                ...
                                if (_mv_277.has_value) {
                                    __auto_type arena_expr = _mv_277.value;
                                    __auto_type _mv_278 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                ...
                                if (_mv_279.has_value) {
                                    ...
                                    if (_mv_280.has_value) {
                                        __auto_type item_expr = _mv_280.value;
                                        {
                                            __auto_type list_c = expr_transpile_expr(ctx, list_expr);
                                ...
                                __auto_type _mv_281 = context_ctx_get_current_return_type(ctx);
                                if (_mv_281.has_value) {
                                    __auto_type ret_type = _mv_281.value;
                    ...
                    default: {
                        {
                            ...
                            __auto_type i = 1;
                            while (i < len) {
                                __auto_type _mv_282 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        if (string_eq(fn_name, SLOP_STR("println"))) {
            ...
            if (len < 3) {
                ...
                if (_mv_285.has_value) {
                    __auto_type a_expr = _mv_285.value;
                    ...
                    if (_mv_286.has_value) {
                        __auto_type b_expr = _mv_286.value;
                        {
            ...
            if (len < 3) {
                ...
                if (_mv_287.has_value) {
                    __auto_type a_expr = _mv_287.value;
                    ...
                    if (_mv_288.has_value) {
                        __auto_type b_expr = _mv_288.value;
                        {
                            __auto_type a_c = expr_transpile_expr(ctx, a_expr);
                            __auto_type b_c = expr_transpile_expr(ctx, b_expr);
                            __auto_type s1 = string_concat(arena, SLOP_STR("(("), a_c);
            ...
            if (len < 3) {
                ...
                if (_mv_289.has_value) {
                    __auto_type fn_expr = _mv_289.value;
                ...
                if (_mv_290.has_value) {
                    ...
                    if (_mv_291.has_value) {
                        ...
                        if (_mv_292.has_value) {
                            __auto_type cap_expr = _mv_292.value;
                            {
            ...
            if (len < 3) {
                ...
                if (_mv_293.has_value) {
                    ...
                    __auto_type _mv_294 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            ...
            if (len < 3) {
                ...
                if (_mv_295.has_value) {
                    __auto_type chan_expr = _mv_295.value;
            ...
            if (len < 2) {
                ...
                if (_mv_297.has_value) {
                    __auto_type chan_expr = _mv_297.value;
                    {
                        __auto_type chan_c = expr_transpile_expr(ctx, chan_expr);
                        __auto_type chan_c_type = expr_infer_expr_c_type(ctx, chan_expr);
                        {
        ...
        } else {
            {
                ...
                if (string_len(builtin_c_name) > 0) {
                    ...
                    __auto_type _mv_298 = context_ctx_lookup_type(ctx, fn_name);
                    if (_mv_298.has_value) {
                        __auto_type type_entry = _mv_298.value;
                        ...
                        __auto_type _mv_300 = context_ctx_lookup_enum_variant(ctx, fn_name);
                        if (_mv_300.has_value) {
                            __auto_type type_name = _mv_300.value;
                            {
                                ...
                                if (len > 2) {
                                    {
                                        ...
                                        __auto_type vi = 1;
                                        while (vi < len) {
                                            __auto_type _mv_301 = ({ __auto_type _lst = items; size_t _idx = (size_t)vi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_301.has_value) {
                                                __auto_type v = _mv_301.value;
                                                {
                                    ...
                                    if (_mv_302.has_value) {
                                        __auto_type value_expr = _mv_302.value;
                                        {
                                            __auto_type value_c = expr_transpile_expr(ctx, value_expr);
                        ...
                        } else if (!_mv_300.has_value) {
                            {
                                ...
                                if (!_mv_303.has_value) {
                                    ...
                                    __auto_type func_entry = _mv_303.value;
                                    while (i < len) {
    ...
    SLOP_PRE(((arg != NULL)), "(!= arg nil)");
    {
        ...
        switch (_mv_306.tag) {
            ...
            default: {
                {
                    __auto_type arg_c = expr_transpile_expr(ctx, arg);
                    __auto_type _mv_307 = expr_get_expr_type_hint(ctx, arg);
                    if (_mv_307.has_value) {
                        __auto_type type_hint = _mv_307.value;
        ...
        if (string_eq(slop_type, SLOP_STR("String"))) {
            ...
            switch (_mv_310.tag) {
                case types_SExpr_sym:
                {
                    ...
                    __auto_type _mv_311 = context_ctx_lookup_var(ctx, sym.name);
                    if (_mv_311.has_value) {
                        __auto_type entry = _mv_311.value;
                        {
                ...
                case types_SExpr_lst:
                {
                    __auto_type lst = _mv_310.data.lst;
                    {
                        __auto_type items = lst.items;
                        if (((int64_t)((items).len)) >= 1) {
                            __auto_type _mv_312 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_312.has_value) {
                                __auto_type head = _mv_312.value;
                                __auto_type _mv_313 = (*head);
                                switch (_mv_313.tag) {
                                    case types_SExpr_sym:
                                    {
                                        __auto_type head_sym = _mv_313.data.sym;
                                        {
                                            __auto_type op = head_sym.name;
                                            if (string_eq(op, SLOP_STR(".")) && (((int64_t)((items).len)) >= 3)) {
                                                {
                                                    ...
                                                    if (string_eq(c_type, SLOP_STR("slop_string"))) {
                                                        ...
                                                        if (_mv_314.has_value) {
                                                            __auto_type obj_expr = _mv_314.value;
                                                            ...
                                                            if (_mv_315.has_value) {
                                                                __auto_type field_expr = _mv_315.value;
                                                                __auto_type _mv_316 = (*field_expr);
                                                                switch (_mv_316.tag) {
                                                                    case types_SExpr_sym:
                                                                    {
                                                                        __auto_type field_sym = _mv_316.data.sym;
                                                                        {
                                                                            __auto_type field_name = field_sym.name;
                                                                            __auto_type obj_slop_type = expr_infer_expr_slop_type(ctx, obj_expr);
                                                                            if (string_len(obj_slop_type) > 0) {
                                                                                __auto_type _mv_317 = context_ctx_lookup_field_slop_type(ctx, obj_slop_type, field_name);
                                                                                if (_mv_317.has_value) {
                                                                                    __auto_type fst = _mv_317.value;
                                                ...
                                                __auto_type _mv_318 = context_ctx_lookup_func(ctx, op);
                                                if (_mv_318.has_value) {
                                                    __auto_type func_entry = _mv_318.value;
                                                    if (func_entry.returns_string) {
                                                        return (slop_option_string){.has_value = 1, .value = SLOP_STR("slop_string")};
                                                    } else {
                                                        return (slop_option_string){.has_value = false};
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 2) {
            ...
            if (_mv_319.has_value) {
                __auto_type tag_expr = _mv_319.value;
                __auto_type _mv_320 = (*tag_expr);
                switch (_mv_320.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type tag_list = _mv_320.data.lst;
                        {
                            __auto_type tag_items = tag_list.items;
                            if (((int64_t)((tag_items).len)) < 1) {
                                return context_ctx_str3(ctx, SLOP_STR("(("), c_type_name, SLOP_STR("){})"));
                            } else {
                                __auto_type _mv_321 = ({ __auto_type _lst = tag_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_321.has_value) {
                                    __auto_type tag_name_expr = _mv_321.value;
                                    __auto_type _mv_322 = (*tag_name_expr);
                                    switch (_mv_322.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type tag_sym = _mv_322.data.sym;
                                            {
                                                ...
                                                if (num_tag_items >= 3) {
                                                    {
                                                        ...
                                                        for (int64_t fi = 1; fi < num_tag_items; fi++) {
                                                            __auto_type _mv_323 = ({ __auto_type _lst = tag_items; size_t _idx = (size_t)fi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                            if (_mv_323.has_value) {
                                                                __auto_type value_expr = _mv_323.value;
                                                                {
                                                                    __auto_type value_c = expr_transpile_expr(ctx, value_expr);
                                                    ...
                                                    __auto_type _mv_324 = ({ __auto_type _lst = tag_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    ...
                    case types_SExpr_sym:
                    {
                        __auto_type sym = _mv_320.data.sym;
                        {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_325.has_value) {
                __auto_type clause_expr = _mv_325.value;
                __auto_type _mv_326 = (*clause_expr);
                switch (_mv_326.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type clause_lst = _mv_326.data.lst;
                        {
                            __auto_type clause_items = clause_lst.items;
                            __auto_type clause_len = ((int64_t)((clause_items).len));
                            if (clause_len >= 2) {
                                __auto_type _mv_327 = ({ __auto_type _lst = clause_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_327.has_value) {
                                    __auto_type test_expr = _mv_327.value;
                                    __auto_type _mv_328 = (*test_expr);
                                    switch (_mv_328.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type sym = _mv_328.data.sym;
                                            if (string_eq(sym.name, SLOP_STR("else"))) {
                                                __auto_type _mv_329 = ({ __auto_type _lst = clause_items; size_t _idx = (size_t)(clause_len - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 3) {
            ...
            if (_mv_332.has_value) {
                __auto_type scrutinee = _mv_332.value;
                {
...
slop_list_types_SExpr_ptr expr_collect_match_patterns(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 2;
        while (i < len) {
            __auto_type _mv_333 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    ...
                    case types_SExpr_lst:
                    {
                        __auto_type branch_lst = _mv_334.data.lst;
                        {
                            ...
                            if (((int64_t)((branch_items).len)) >= 1) {
                                __auto_type _mv_335 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_336.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 1) {
                    ...
                    __auto_type _mv_337 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while ((i < len) && all_symbols) {
            ...
            if (_mv_341.has_value) {
                ...
                __auto_type _mv_342 = (*pat_expr);
                switch (_mv_342.tag) {
                    case types_SExpr_sym:
                    {
                        __auto_type s = _mv_342.data.sym;
                        {
                            __auto_type name = s.name;
                            if (!(string_eq(name, SLOP_STR("else"))) && !(string_eq(name, SLOP_STR("_")))) {
                                __auto_type _mv_343 = context_ctx_lookup_enum_variant(ctx, name);
...
uint8_t expr_is_union_expr_patterns(context_TranspileContext* ctx, slop_list_types_SExpr_ptr patterns) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while ((i < len) && !(has_union_variant)) {
            __auto_type _mv_344 = ({ __auto_type _lst = patterns; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_344.has_value) {
                __auto_type pat_expr = _mv_344.value;
                {
                    ...
                    if ((!(string_eq(tag, SLOP_STR("")))) && (!(string_eq(tag, SLOP_STR("some")))) && (!(string_eq(tag, SLOP_STR("none")))) && (!(string_eq(tag, SLOP_STR("ok")))) && (!(string_eq(tag, SLOP_STR("error")))) && (!(string_eq(tag, SLOP_STR("else")))) && (!(string_eq(tag, SLOP_STR("_"))))) {
                        __auto_type _mv_345 = context_ctx_lookup_enum_variant(ctx, tag);
            ...
            __auto_type lst = _mv_346.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 2) {
                    ...
                    if (_mv_347.has_value) {
                        __auto_type binding = _mv_347.value;
                        __auto_type _mv_348 = (*binding);
                        switch (_mv_348.tag) {
                            case types_SExpr_sym:
                            {
...
slop_string expr_get_match_branch_body(context_TranspileContext* ctx, slop_list_types_SExpr_ptr branch_items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 2) {
            ...
            __auto_type _mv_349 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)(len - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_string expr_build_option_match_expr(context_TranspileContext* ctx, types_SExpr* scrutinee, slop_string scrutinee_c, slop_list_types_SExpr_ptr items) {
    ...
    SLOP_PRE(((scrutinee != NULL)), "(!= scrutinee nil)");
    {
        ...
        int64_t i = 2;
        while (i < len) {
            __auto_type _mv_350 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    ...
                    case types_SExpr_lst:
                    {
                        __auto_type branch_lst = _mv_351.data.lst;
                        {
                            ...
                            if (((int64_t)((branch_items).len)) >= 2) {
                                __auto_type _mv_352 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_352.has_value) {
                                    __auto_type pattern = _mv_352.value;
                                    {
                                        __auto_type tag = expr_get_expr_pattern_tag(pattern);
                                        if (string_eq(tag, SLOP_STR("some"))) {
                                            __auto_type _mv_353 = expr_get_expr_binding_name(pattern);
                                            if (_mv_353.has_value) {
                                                __auto_type name = _mv_353.value;
                                                some_binding = name;
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 2) {
            ...
            if (_mv_354.has_value) {
                __auto_type first_clause = _mv_354.value;
                __auto_type _mv_355 = (*first_clause);
                switch (_mv_355.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type clause_lst = _mv_355.data.lst;
                        {
                            __auto_type clause_items = clause_lst.items;
                            __auto_type clause_len = ((int64_t)((clause_items).len));
                            if (clause_len < 2) {
                                ...
                                __auto_type _mv_356 = ({ __auto_type _lst = clause_items; size_t _idx = (size_t)(clause_len - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_356.has_value) {
                                    __auto_type body_expr = _mv_356.value;
        ...
        case types_SExpr_lst:
        {
            __auto_type branch_lst = _mv_357.data.lst;
            {
                ...
                if (branch_len < 2) {
                    ...
                    __auto_type _mv_358 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)(branch_len - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_string expr_slop_type_to_c_type(context_TranspileContext* ctx, slop_string slop_type) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_360 = context_ctx_lookup_type(ctx, slop_type);
        if (_mv_360.has_value) {
            __auto_type entry = _mv_360.value;
            return entry.c_name;
    ...
    SLOP_PRE(((expr != NULL)), "(!= expr nil)");
    {
        ...
        if (string_len(checker_type) > 0) {
            ...
            switch (_mv_361.tag) {
                ...
                case types_SExpr_num:
                {
                    __auto_type num = _mv_361.data.num;
                    if (num.is_float) {
                        return SLOP_STR("double");
                    } else {
                        return SLOP_STR("int64_t");
                ...
                case types_SExpr_sym:
                {
                    ...
                    {
                        __auto_type name = sym.name;
                        __auto_type _mv_362 = context_ctx_lookup_var(ctx, name);
                        if (_mv_362.has_value) {
                            __auto_type entry = _mv_362.value;
                            {
                                        ...
                                        __auto_type sym = _mv_364.data.sym;
                                        {
                                            ...
                                            if (({ __auto_type _mv = context_ctx_lookup_func(ctx, op); _mv.has_value ? ({ __auto_type func_entry = _mv.value; func_entry.returns_string; }) : (0); })) {
                                                ...
                                                if (((int64_t)((items).len)) < 3) {
                                                    ...
                                                    __auto_type _mv_365 = ({ __auto_type _lst = items; size_t _idx = (size_t)(((int64_t)((items).len)) - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_365.has_value) {
                                                        __auto_type body = _mv_365.value;
                                                ...
                                                if (((int64_t)((items).len)) < 2) {
                                                    ...
                                                    if (_mv_366.has_value) {
                                                        __auto_type last_expr = _mv_366.value;
                                                ...
                                                if (((int64_t)((items).len)) < 3) {
                                                    ...
                                                    if (_mv_367.has_value) {
                                                        __auto_type body = _mv_367.value;
                                                        return expr_infer_expr_c_type(ctx, body);
                                                ...
                                                if (((int64_t)((items).len)) < 3) {
                                                    ...
                                                    if (_mv_368.has_value) {
                                                        __auto_type then_expr = _mv_368.value;
                                                ...
                                                if (((int64_t)((items).len)) < 2) {
                                                    ...
                                                    if (_mv_369.has_value) {
                                                        __auto_type val_expr = _mv_369.value;
                                                        {
                                                            __auto_type val_type = expr_infer_expr_c_type(ctx, val_expr);
                                                ...
                                                __auto_type _mv_370 = context_ctx_get_current_return_type(ctx);
                                                if (_mv_370.has_value) {
                                                    __auto_type ret_type = _mv_370.value;
                                                    if (strlib_starts_with(ret_type, SLOP_STR("slop_option_"))) {
                                                        return ret_type;
                                                    } else {
                                                        return SLOP_STR("slop_option_int");
                                                ...
                                                if (((int64_t)((items).len)) < 2) {
                                                    ...
                                                    if (_mv_372.has_value) {
                                                        __auto_type inner = _mv_372.value;
                                                        {
                                                ...
                                                if (((int64_t)((items).len)) < 2) {
                                                    ...
                                                    if (_mv_374.has_value) {
                                                        __auto_type chan_arg = _mv_374.value;
                                                        {
                                                ...
                                                if (((int64_t)((items).len)) < 2) {
                                                    ...
                                                    if (_mv_378.has_value) {
                                                        __auto_type list_arg = _mv_378.value;
                                                        {
                                                ...
                                                __auto_type _mv_379 = context_ctx_lookup_type(ctx, op);
                                                if (_mv_379.has_value) {
                                                    __auto_type type_entry = _mv_379.value;
                                                    return type_entry.c_name;
                                                } else if (!_mv_379.has_value) {
                                                    __auto_type _mv_380 = context_ctx_lookup_func(ctx, op);
                                                    if (_mv_380.has_value) {
                                                        __auto_type func_entry = _mv_380.value;
                                                        {
                                                            __auto_type ret_type = func_entry.return_type;
                                                            if (func_entry.returns_string) {
                                                                return SLOP_STR("slop_string");
                                ...
                                if (_mv_383.has_value) {
                                    __auto_type pattern = _mv_383.value;
                                    {
                                        ...
                                        if (string_eq(tag, SLOP_STR("ok"))) {
                                            __auto_type _mv_384 = expr_get_expr_binding_name(pattern);
                                            if (_mv_384.has_value) {
                                                __auto_type name = _mv_384.value;
                                                ok_binding = name;
...
slop_string expr_build_enum_case_expr(context_TranspileContext* ctx, slop_arena* arena, slop_string cases, types_SExpr* pattern, slop_list_types_SExpr_ptr branch_items, slop_string result_type) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (string_eq(tag, SLOP_STR("else")) || string_eq(tag, SLOP_STR("_"))) {
            ...
            __auto_type _mv_389 = context_ctx_lookup_enum_variant(ctx, tag);
            if (_mv_389.has_value) {
                __auto_type type_name = _mv_389.value;
                {
        ...
        switch (_mv_393.tag) {
            case types_SExpr_sym:
            {
                __auto_type sym = _mv_393.data.sym;
                {
                    ...
                    __auto_type _mv_394 = context_ctx_lookup_func(ctx, slop_name);
                    if (_mv_394.has_value) {
                        __auto_type func_entry = _mv_394.value;
                        {
        ...
        if (context_ctx_skip_trampoline_generation(ctx)) {
            ...
            if (context_ctx_has_trampoline(ctx, fn_c_name)) {
            ...
            } else {
                {
                    ...
                    int64_t i = 0;
                    while (i < count) {
                        __auto_type _mv_395 = ({ __auto_type _lst = param_types; size_t _idx = (size_t)i; slop_option_context_FuncParamType_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_395.has_value) {
                            __auto_type param_type_ptr = _mv_395.value;
                            {
...
slop_string expr_build_union_case_expr(context_TranspileContext* ctx, slop_arena* arena, slop_string cases, types_SExpr* scrutinee, types_SExpr* pattern, slop_list_types_SExpr_ptr branch_items, slop_string result_type) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (string_eq(tag, SLOP_STR("else")) || string_eq(tag, SLOP_STR("_"))) {
            ...
            __auto_type _mv_396 = context_ctx_lookup_enum_variant(ctx, tag);
            if (_mv_396.has_value) {
                __auto_type type_name = _mv_396.value;
                {
                    __auto_type c_tag = ctype_to_c_name(arena, tag);
                    __auto_type case_label = context_ctx_str4(ctx, type_name, SLOP_STR("_"), c_tag, SLOP_STR(""));
                    __auto_type binding_opt = expr_get_expr_binding_name(pattern);
                    __auto_type _mv_397 = binding_opt;
                    if (_mv_397.has_value) {
                        __auto_type binding_name = _mv_397.value;
                        {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i >= 2) {
            ...
            if (_mv_398.has_value) {
                __auto_type branch = _mv_398.value;
                __auto_type _mv_399 = (*branch);
                switch (_mv_399.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type branch_lst = _mv_399.data.lst;
                        {
                            __auto_type branch_items = branch_lst.items;
                            if (((int64_t)((branch_items).len)) >= 2) {
                                __auto_type _mv_400 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_400.has_value) {
                                    __auto_type pattern = _mv_400.value;
                                    {
                                        __auto_type tag = expr_get_expr_pattern_tag(pattern);
...
uint8_t expr_discard_needs_void(types_SExpr* e) {
    __auto_type _mv_401 = (*e);
    switch (_mv_401.tag) {
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_401.data.lst;
            __auto_type _mv_402 = ({ __auto_type _lst = lst.items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 3) {
            ...
            if (_mv_404.has_value) {
                __auto_type bindings_expr = _mv_404.value;
                __auto_type _mv_405 = (*bindings_expr);
                switch (_mv_405.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type bindings_lst = _mv_405.data.lst;
                        context_ctx_push_scope(ctx);
                        {
                            __auto_type result = SLOP_STR("({ ");
                            ...
                            while (bi < bindings_len) {
                                __auto_type _mv_406 = ({ __auto_type _lst = bindings_items; size_t _idx = (size_t)bi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_406.has_value) {
                                    __auto_type binding = _mv_406.value;
                            ...
                            }
                            {
                                __auto_type i = 2;
                                while (i < (len - 1)) {
                                    __auto_type _mv_408 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    if (_mv_408.has_value) {
                                        __auto_type body_expr = _mv_408.value;
                                        {
                ...
                __auto_type lst = _mv_412.data.lst;
                {
                    ...
                    if (len < 2) {
                    ...
                    } else {
                        {
                            __auto_type has_mut = expr_binding_has_mut(items);
                            __auto_type name_idx = ((has_mut) ? 1 : 0);
                            __auto_type _mv_413 = ({ __auto_type _lst = items; size_t _idx = (size_t)name_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                ...
                                switch (_mv_414.tag) {
                                    case types_SExpr_sym:
                                    {
                                        __auto_type name_sym = _mv_414.data.sym;
                                        {
                                            ...
                                            __auto_type init_idx = ((has_mut) ? ((has_type) ? 3 : 2) : ((has_type) ? 2 : 1));
                                            if (has_type) {
                                                __auto_type _mv_415 = ({ __auto_type _lst = items; size_t _idx = (size_t)type_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_415.has_value) {
                                                    __auto_type type_expr = _mv_415.value;
                                                    {
                                                        ...
                                                        if (_mv_416.has_value) {
                                                            __auto_type init_expr = _mv_416.value;
                                                            {
...
uint8_t expr_binding_has_mut(slop_list_types_SExpr_ptr items) {
    if (((int64_t)((items).len)) < 1) {
        ...
        if (_mv_419.has_value) {
            __auto_type first = _mv_419.value;
            __auto_type _mv_420 = (*first);
            switch (_mv_420.tag) {
                case types_SExpr_sym:
                {
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_421.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 1) {
                    ...
                    __auto_type _mv_422 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    ...
                                    if (string_eq(op, SLOP_STR("some"))) {
                                        if (((int64_t)((items).len)) < 2) {
                                            ...
                                            if (_mv_424.has_value) {
                                                __auto_type val_expr = _mv_424.value;
                                                {
                                                    __auto_type val_c = expr_transpile_expr(ctx, val_expr);
        ...
        } else {
            {
                ...
                while (i < len) {
                    ...
                    if (_mv_427.has_value) {
                        __auto_type expr = _mv_427.value;
                        {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 2) {
            ...
            if (_mv_428.has_value) {
                __auto_type cond_expr = _mv_428.value;
                {
                    __auto_type cond_c = expr_transpile_expr(ctx, cond_expr);
                    __auto_type body_c = SLOP_STR("({ ");
                    {
                        __auto_type i = 2;
                        while (i < len) {
                            __auto_type _mv_429 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
uint8_t expr_set_is_self_assign(slop_list_types_SExpr_ptr items) {
    if (((int64_t)((items).len)) == 3) {
        ...
        if (_mv_430.has_value) {
            __auto_type target_expr = _mv_430.value;
            __auto_type _mv_431 = (*target_expr);
            switch (_mv_431.tag) {
                case types_SExpr_sym:
                {
                    __auto_type tsym = _mv_431.data.sym;
                    ...
                    if (_mv_432.has_value) {
                        __auto_type value_expr = _mv_432.value;
                        __auto_type _mv_433 = (*value_expr);
                        switch (_mv_433.tag) {
                            case types_SExpr_sym:
                            {
                                __auto_type vsym = _mv_433.data.sym;
        ...
        if (expr_set_is_self_assign(items)) {
            ...
            if (len < 3) {
                ...
                if (_mv_434.has_value) {
                    __auto_type target_expr = _mv_434.value;
                    __auto_type _mv_435 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_435.has_value) {
                        __auto_type val_expr = _mv_435.value;
                        {
                            __auto_type val_c = expr_transpile_expr(ctx, val_expr);
                            __auto_type _mv_436 = (*target_expr);
                            switch (_mv_436.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type target_lst = _mv_436.data.lst;
                                    {
                                        ...
                                        if (((int64_t)((target_items).len)) < 1) {
                                            ...
                                            __auto_type _mv_437 = ({ __auto_type _lst = target_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                        ...
                                                        __auto_type sym = _mv_438.data.sym;
                                                        {
                                                            ...
                                                            if (string_eq(op, SLOP_STR("@"))) {
                                                                if (((int64_t)((target_items).len)) < 3) {
                                                                    ...
                                                                    __auto_type _mv_439 = ({ __auto_type _lst = target_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                                    if (_mv_439.has_value) {
                                                                        __auto_type arr_expr = _mv_439.value;
                                                                        __auto_type _mv_440 = ({ __auto_type _lst = target_items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                                        if (_mv_440.has_value) {
                                                                            __auto_type idx_expr = _mv_440.value;
                                                                            {
                                                                                __auto_type arr_c = expr_transpile_expr(ctx, arr_expr);
                                                                                __auto_type idx_c = expr_transpile_expr(ctx, idx_expr);
...
slop_string expr_resolve_arena_c_name(context_TranspileContext* ctx, slop_string op, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    __auto_type _mv_441 = context_ctx_lookup_var(ctx, SLOP_STR("arena"));
...
slop_string expr_get_arena_for_list_push_expr(context_TranspileContext* ctx, types_SExpr* list_expr, slop_string list_c) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    SLOP_PRE(((list_expr != NULL)), "(!= list-expr nil)");
    __auto_type _mv_443 = context_ctx_lookup_var(ctx, SLOP_STR("arena"));
    if (_mv_443.has_value) {
        __auto_type arena_var = _mv_443.value;
        return arena_var.c_name;
    } else if (!_mv_443.has_value) {
        __auto_type _mv_444 = context_ctx_lookup_var(ctx, SLOP_STR("ctx"));
        if (_mv_444.has_value) {
            __auto_type ctx_var = _mv_444.value;
        ...
        } else if (!_mv_444.has_value) {
            {
                ...
                if (string_len(arena_from_field) > 0) {
                    ...
                    __auto_type _mv_445 = context_ctx_find_arena_var(ctx);
                    if (_mv_445.has_value) {
                        __auto_type arena_entry = _mv_445.value;
                            ...
                            case types_SExpr_sym:
                            {
                                ...
                                if (string_eq(sym.name, SLOP_STR("."))) {
                                    ...
                                    if (_mv_449.has_value) {
                                        __auto_type base_expr = _mv_449.value;
...
slop_string expr_get_arena_from_base(context_TranspileContext* ctx, types_SExpr* base_expr) {
    ...
    switch (_mv_450.tag) {
        case types_SExpr_sym:
        {
            ...
            {
                __auto_type var_name = sym.name;
                __auto_type _mv_451 = context_ctx_lookup_var(ctx, var_name);
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_450.data.lst;
            {
                __auto_type items = lst.items;
                if (((int64_t)((items).len)) < 2) {
                    return SLOP_STR("arena");
                } else {
                    __auto_type _mv_452 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_452.has_value) {
                        __auto_type head_expr = _mv_452.value;
                        __auto_type _mv_453 = (*head_expr);
                        switch (_mv_453.tag) {
                            case types_SExpr_sym:
                            {
                                __auto_type sym = _mv_453.data.sym;
                                if (string_eq(sym.name, SLOP_STR("deref"))) {
                                    ...
                                    if (_mv_454.has_value) {
                                        __auto_type ptr_expr = _mv_454.value;
                                        {
...
uint8_t expr_is_ptr_to_ptr_map(context_TranspileContext* ctx, types_SExpr* expr) {
    ...
    switch (_mv_455.tag) {
        case types_SExpr_sym:
        {
            ...
            {
                __auto_type name = sym.name;
                __auto_type _mv_456 = context_ctx_lookup_var(ctx, name);
                if (_mv_456.has_value) {
                    __auto_type entry = _mv_456.value;
                    {
                        __auto_type c_type = entry.c_type;
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 2) {
            ...
            if (_mv_457.has_value) {
                ...
                __auto_type _mv_458 = (*type_expr);
                switch (_mv_458.tag) {
                    case types_SExpr_sym:
                    {
                        __auto_type type_sym = _mv_458.data.sym;
                        {
                            __auto_type raw_type_name = type_sym.name;
                    ...
                    case types_SExpr_lst:
                    {
                        __auto_type type_lst = _mv_458.data.lst;
                        {
                            ...
                            if (((int64_t)((type_items).len)) < 1) {
                                ...
                                __auto_type _mv_459 = ({ __auto_type _lst = type_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    ...
                                    switch (_mv_464.tag) {
                                        case types_SExpr_sym:
                                        {
                                            ...
                                            if (_mv_465.has_value) {
                                                __auto_type val_expr = _mv_465.value;
                                                {
...
slop_string expr_build_inline_struct_type(context_TranspileContext* ctx, slop_list_types_SExpr_ptr type_items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 1;
        while (i < len) {
            __auto_type _mv_466 = ({ __auto_type _lst = type_items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    ...
                                    switch (_mv_469.tag) {
                                        case types_SExpr_sym:
                                        {
                                            ...
                                            if (_mv_470.has_value) {
                                                __auto_type type_expr = _mv_470.value;
                                                {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 2) {
            ...
            if (_mv_476.has_value) {
                __auto_type type_expr = _mv_476.value;
                {
                    ...
                    __auto_type elem_count = (len - 2);
                    {
                        ...
                        while (i < len) {
                            __auto_type _mv_477 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_477.has_value) {
                                __auto_type elem_expr = _mv_477.value;
                        ...
                        }
                        {
                            ...
                            __auto_type _mv_478 = arena_var;
                            if (_mv_478.has_value) {
                                __auto_type arena_var = _mv_478.value;
                                {
                                    ...
                                    while (i < ((int64_t)((elem_codes).len))) {
                                        __auto_type _mv_479 = ({ __auto_type _lst = elem_codes; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_479.has_value) {
                                            __auto_type ec = _mv_479.value;
                                            {
...
slop_string expr_get_map_key_c_info(context_TranspileContext* ctx, types_SExpr* key_type_expr) {
    ...
    __auto_type _mv_481 = (*key_type_expr);
    switch (_mv_481.tag) {
        case types_SExpr_sym:
        {
            __auto_type sym = _mv_481.data.sym;
            {
                __auto_type name = sym.name;
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_481.data.lst;
            {
                __auto_type items = lst.items;
                if (((int64_t)((items).len)) < 1) {
                    return SLOP_STR("sizeof(void*), slop_hash_ptr, slop_eq_ptr");
                } else {
                    __auto_type _mv_482 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_482.has_value) {
                        ...
                        switch (_mv_483.tag) {
                            case types_SExpr_sym:
                            {
                                __auto_type sym = _mv_483.data.sym;
                                {
...
slop_string expr_get_struct_key_info_by_name(context_TranspileContext* ctx, slop_string name) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    __auto_type _mv_484 = context_ctx_lookup_type(ctx, name);
    if (_mv_484.has_value) {
        __auto_type type_entry = _mv_484.value;
        {
            __auto_type c_name = type_entry.c_name;
            context_ctx_register_struct_key_type(ctx, c_name);
            return expr_build_struct_key_info(ctx, c_name);
        ...
        __auto_type _mv_485 = context_ctx_get_module(ctx);
        if (_mv_485.has_value) {
            __auto_type mod = _mv_485.value;
            {
                __auto_type prefixed = context_ctx_str3(ctx, mod, SLOP_STR("_"), name);
                __auto_type _mv_486 = context_ctx_lookup_type(ctx, prefixed);
                if (_mv_486.has_value) {
                    __auto_type type_entry = _mv_486.value;
                    {
                        __auto_type c_name = type_entry.c_name;
                        context_ctx_register_struct_key_type(ctx, c_name);
                        return expr_build_struct_key_info(ctx, c_name);
        ...
        if (len < 3) {
            ...
            if (_mv_488.has_value) {
                ...
                if (_mv_489.has_value) {
                    __auto_type key_type_expr = _mv_489.value;
                    {
                        __auto_type arena_c = expr_transpile_expr(ctx, arena_expr);
        ...
        if (len < 4) {
            ...
            if (_mv_490.has_value) {
                ...
                if (_mv_491.has_value) {
                    ...
                    __auto_type _mv_492 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_492.has_value) {
                        __auto_type val_expr = _mv_492.value;
                        {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 3) {
            ...
            if (_mv_493.has_value) {
                __auto_type map_expr = _mv_493.value;
                ...
                if (_mv_494.has_value) {
                    __auto_type key_expr = _mv_494.value;
                    {
                        __auto_type map_c = expr_resolve_container_c(ctx, map_expr);
                        __auto_type key_c = expr_transpile_expr(ctx, key_expr);
                        __auto_type key_ptr = expr_wrap_map_key_as_ptr(ctx, key_c, key_expr, map_expr);
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 3) {
            ...
            if (_mv_495.has_value) {
                __auto_type map_expr = _mv_495.value;
                ...
                if (_mv_496.has_value) {
                    __auto_type key_expr = _mv_496.value;
                    {
                        __auto_type map_c = expr_resolve_container_c(ctx, map_expr);
                        __auto_type key_c = expr_transpile_expr(ctx, key_expr);
                        __auto_type key_ptr = expr_wrap_map_key_as_ptr(ctx, key_c, key_expr, map_expr);
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 3) {
            ...
            if (_mv_497.has_value) {
                __auto_type map_expr = _mv_497.value;
                ...
                if (_mv_498.has_value) {
                    __auto_type key_expr = _mv_498.value;
                    {
                        __auto_type map_c = expr_resolve_container_c(ctx, map_expr);
                        __auto_type key_c = expr_transpile_expr(ctx, key_expr);
                        __auto_type key_ptr = expr_wrap_map_key_as_ptr(ctx, key_c, key_expr, map_expr);
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 2) {
            ...
            if (_mv_499.has_value) {
                __auto_type map_expr = _mv_499.value;
                {
                    __auto_type map_c = expr_resolve_container_c(ctx, map_expr);
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 3) {
            ...
            if (_mv_500.has_value) {
                __auto_type arena_expr = _mv_500.value;
                __auto_type _mv_501 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_501.has_value) {
                    __auto_type elem_type_expr = _mv_501.value;
                    {
                        __auto_type arena_c = expr_transpile_expr(ctx, arena_expr);
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 3) {
            ...
            if (_mv_502.has_value) {
                __auto_type set_expr = _mv_502.value;
                __auto_type _mv_503 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 3) {
            ...
            if (_mv_504.has_value) {
                __auto_type set_expr = _mv_504.value;
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 3) {
            ...
            if (_mv_506.has_value) {
                __auto_type set_expr = _mv_506.value;
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 2) {
            ...
            if (_mv_508.has_value) {
                __auto_type set_expr = _mv_508.value;
                {
                    __auto_type set_c = expr_resolve_container_c(ctx, set_expr);
                    ...
                    __auto_type result = context_ctx_str(ctx, context_ctx_str3(ctx, SLOP_STR("({ slop_map* _s = slop_map_new_ptr("), arena_c, SLOP_STR(", ")), context_ctx_str(ctx, int_to_string(arena, init_cap), context_ctx_str(ctx, SLOP_STR(", "), context_ctx_str(ctx, elem_info, SLOP_STR("); ")))));
                    {
                        ...
                        while (i < len) {
                            ...
                            if (_mv_510.has_value) {
                                __auto_type elem_expr = _mv_510.value;
                                {
                                    __auto_type elem_c = expr_transpile_expr(ctx, elem_expr);
                        ...
                        __auto_type binding_lst = _mv_512.data.lst;
                        {
                            ...
                            if (binding_len < 3) {
                                ...
                                if (_mv_513.has_value) {
                                    __auto_type var_expr = _mv_513.value;
                                    __auto_type _mv_514 = (*var_expr);
                                    switch (_mv_514.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type var_sym = _mv_514.data.sym;
                                            {
                                                ...
                                                if (_mv_515.has_value) {
                                                    __auto_type start_expr = _mv_515.value;
                                                    __auto_type _mv_516 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_516.has_value) {
                                                        __auto_type end_expr = _mv_516.value;
                                                        {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 2) {
            ...
            if (_mv_518.has_value) {
                __auto_type binding_expr = _mv_518.value;
                __auto_type _mv_519 = (*binding_expr);
                switch (_mv_519.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type binding_lst = _mv_519.data.lst;
                        {
                            __auto_type binding_items = binding_lst.items;
                            __auto_type binding_len = ((int64_t)((binding_items).len));
                            if (binding_len < 2) {
                                ...
                                __auto_type _mv_520 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_520.has_value) {
                                    __auto_type first_elem = _mv_520.value;
                                    __auto_type _mv_521 = (*first_elem);
                                    switch (_mv_521.tag) {
                                        case types_SExpr_lst:
                                        {
                                            __auto_type _ = _mv_521.data.lst;
                                            return expr_transpile_for_each_map_kv_as_expr(ctx, binding_items, items, len);
                                        }
                                        case types_SExpr_sym:
                                        {
                                            __auto_type var_sym = _mv_521.data.sym;
                                            {
                                                __auto_type var_name = ctype_to_c_name(arena, var_sym.name);
                                                __auto_type _mv_522 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_522.has_value) {
                                                    __auto_type coll_expr = _mv_522.value;
                                                    {
        ...
        }
        {
            ...
            while (i < len) {
                ...
                if (_mv_523.has_value) {
                    __auto_type body_expr = _mv_523.value;
                    {
                        __auto_type body_c = expr_transpile_expr(ctx, body_expr);
                        result = context_ctx_str3(ctx, result, body_c, SLOP_STR("; "));
                    }
...
slop_string expr_transpile_for_each_map_kv_as_expr(context_TranspileContext* ctx, slop_list_types_SExpr_ptr binding_items, slop_list_types_SExpr_ptr items, int64_t len) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (_mv_526.has_value) {
            __auto_type kv_list_expr = _mv_526.value;
            __auto_type _mv_527 = (*kv_list_expr);
            switch (_mv_527.tag) {
                case types_SExpr_lst:
                {
                    __auto_type kv_lst = _mv_527.data.lst;
                    {
                        __auto_type kv_items = kv_lst.items;
                        if (((int64_t)((kv_items).len)) < 2) {
                            return SLOP_STR("({ /* for-each: map binding needs ((k v) map) */ 0; })");
                        } else {
                            __auto_type _mv_528 = ({ __auto_type _lst = kv_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_528.has_value) {
                                __auto_type k_expr = _mv_528.value;
                                __auto_type _mv_529 = ({ __auto_type _lst = kv_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_529.has_value) {
                                    __auto_type v_expr = _mv_529.value;
                                    __auto_type _mv_530 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    if (_mv_530.has_value) {
                                        __auto_type map_expr = _mv_530.value;
                                        __auto_type _mv_531 = (*k_expr);
                                        switch (_mv_531.tag) {
                                            case types_SExpr_sym:
                                            {
                                                __auto_type k_sym = _mv_531.data.sym;
                                                __auto_type _mv_532 = (*v_expr);
                                                switch (_mv_532.tag) {
                                                    case types_SExpr_sym:
                                                    {
                                                        __auto_type v_sym = _mv_532.data.sym;
                                                        {
                                                                ...
                                                                context_ctx_bind_var(ctx, (context_VarEntry){v_sym.name, v_name, val_c_type, val_slop_type, 0, 0, 0, SLOP_STR(""), SLOP_STR("")});
                                                                {
                                                                    ...
                                                                    while (i < len) {
                                                                        ...
                                                                        if (_mv_533.has_value) {
                                                                            __auto_type body_expr = _mv_533.value;
                                                                            {
                                                                                __auto_type body_c = expr_transpile_expr(ctx, body_expr);
                                                                                result = context_ctx_str3(ctx, result, body_c, SLOP_STR("; "));
                                                                            }
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 2) {
            ...
            if (_mv_534.has_value) {
                __auto_type second = _mv_534.value;
                __auto_type _mv_535 = (*second);
                switch (_mv_535.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type params_lst = _mv_535.data.lst;
                        return expr_transpile_lambda_with_params(ctx, items, params_lst.items);
                    }
                    case types_SExpr_sym:
                    {
                        __auto_type _ = _mv_535.data.sym;
...
slop_list_string expr_extract_param_names(slop_arena* arena, slop_list_types_SExpr_ptr params) {
    {
        ...
        int64_t i = 0;
        while (i < count) {
            __auto_type _mv_536 = ({ __auto_type _lst = params; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_536.has_value) {
                __auto_type param_expr = _mv_536.value;
                __auto_type _mv_537 = (*param_expr);
                switch (_mv_537.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type param_lst = _mv_537.data.lst;
                        {
                            __auto_type param_items = param_lst.items;
                            if (((int64_t)((param_items).len)) >= 1) {
                                __auto_type _mv_538 = ({ __auto_type _lst = param_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_538.has_value) {
                                    __auto_type name_expr = _mv_538.value;
                                    __auto_type _mv_539 = (*name_expr);
                                    switch (_mv_539.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type name_sym = _mv_539.data.sym;
...
slop_string expr_build_env_initializer(context_TranspileContext* ctx, slop_list_string free_vars, slop_list_string captured_accesses) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < count) {
            __auto_type _mv_546 = ({ __auto_type _lst = free_vars; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_546.has_value) {
                __auto_type var_name = _mv_546.value;
                {
                    __auto_type c_name = ctype_to_c_name(arena, var_name);
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (param_count == 0) {
        ...
        } else {
            {
                ...
                int64_t i = 0;
                while (i < param_count) {
                    __auto_type _mv_547 = ({ __auto_type _lst = params; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_547.has_value) {
                        __auto_type param_expr = _mv_547.value;
                        __auto_type _mv_548 = (*param_expr);
                        switch (_mv_548.tag) {
                            case types_SExpr_lst:
                            {
                                __auto_type param_lst = _mv_548.data.lst;
                                {
                                    __auto_type param_items = param_lst.items;
                                    if (((int64_t)((param_items).len)) >= 2) {
                                        __auto_type _mv_549 = ({ __auto_type _lst = param_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_549.has_value) {
                                            ...
                                            switch (_mv_550.tag) {
                                                case types_SExpr_sym:
                                                {
                                                    ...
                                                    __auto_type _mv_551 = ({ __auto_type _lst = param_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void expr_bind_lambda_params(context_TranspileContext* ctx, slop_list_types_SExpr_ptr params) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < param_count) {
            __auto_type _mv_552 = ({ __auto_type _lst = params; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_552.has_value) {
                __auto_type param_expr = _mv_552.value;
                __auto_type _mv_553 = (*param_expr);
                switch (_mv_553.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type param_lst = _mv_553.data.lst;
                        {
                            __auto_type param_items = param_lst.items;
                            if (((int64_t)((param_items).len)) >= 2) {
                                __auto_type _mv_554 = ({ __auto_type _lst = param_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_554.has_value) {
                                    __auto_type name_expr = _mv_554.value;
                                    __auto_type _mv_555 = (*name_expr);
                                    switch (_mv_555.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type name_sym = _mv_555.data.sym;
                                            __auto_type _mv_556 = ({ __auto_type _lst = param_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_556.has_value) {
                                                __auto_type type_expr = _mv_556.value;
                                                {
        ...
        if (len <= start) {
            ...
            while (i < len) {
                ...
                if (_mv_560.has_value) {
                    __auto_type expr = _mv_560.value;
                    {
            ...
            __auto_type lst = _mv_561.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 2) {
                    ...
                    if (_mv_562.has_value) {
                        __auto_type head = _mv_562.value;
                        __auto_type _mv_563 = (*head);
                        switch (_mv_563.tag) {
                            case types_SExpr_sym:
                            {
                                ...
                                if (!(string_eq(sym.name, SLOP_STR("fn")))) {
                                    ...
                                    if (_mv_564.has_value) {
                                        __auto_type second = _mv_564.value;
                                        __auto_type _mv_565 = (*second);
                                        switch (_mv_565.tag) {
                                            case types_SExpr_lst:
                                            {
                                                __auto_type _ = _mv_565.data.lst;
                                                return 1;
                                            }
                                            default: {
                                                return 0;
...
slop_string expr_transpile_spawn_closure(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items, types_SExpr* fn_expr) {
    ...
    SLOP_PRE(((fn_expr != NULL)), "(!= fn-expr nil)");
    {
        ...
        if (_mv_566.has_value) {
            __auto_type arena_expr = _mv_566.value;
            {
                __auto_type arena_c = expr_transpile_expr(ctx, arena_expr);
...
uint8_t expr_lambda_has_captures(context_TranspileContext* ctx, types_SExpr* fn_expr) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    SLOP_PRE(((fn_expr != NULL)), "(!= fn-expr nil)");
    __auto_type _mv_567 = (*fn_expr);
    switch (_mv_567.tag) {
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_567.data.lst;
            {
                __auto_type items = lst.items;
                __auto_type arena = (*ctx).arena;
                if (((int64_t)((items).len)) < 2) {
                    ...
                    if (_mv_568.has_value) {
                        __auto_type params_expr = _mv_568.value;
                        __auto_type _mv_569 = (*params_expr);
                        switch (_mv_569.tag) {
                            case types_SExpr_lst:
                            {
                                __auto_type params_lst = _mv_569.data.lst;
                                {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (((int64_t)((items).len)) < 2) {
            ...
            if (_mv_571.has_value) {
                __auto_type first_arg = _mv_571.value;
                {
...
slop_list_string expr_find_free_vars(context_TranspileContext* ctx, slop_list_string param_names, slop_list_types_SExpr_ptr body_items, int64_t start, slop_list_string pending) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = start;
        while (i < len) {
            __auto_type _mv_572 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_572.has_value) {
                __auto_type expr = _mv_572.value;
        ...
        }
        {
            ...
            int64_t j = 0;
            while (j < sym_count) {
                __auto_type _mv_573 = ({ __auto_type _lst = all_symbols; size_t _idx = (size_t)j; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_573.has_value) {
                    __auto_type sym_name = _mv_573.value;
                ...
                if (len > 0) {
                    ...
                    if (_mv_575.has_value) {
                        ...
                        switch (_mv_576.tag) {
                            case types_SExpr_sym:
                            {
                                __auto_type head_sym = _mv_576.data.sym;
                                {
                                    __auto_type op = head_sym.name;
...
void expr_collect_symbols_in_list(context_TranspileContext* ctx, slop_list_string* symbols, slop_list_string pending, slop_list_types_SExpr_ptr items, int64_t start) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = start;
        while (i < len) {
            __auto_type _mv_577 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_577.has_value) {
                __auto_type item = _mv_577.value;
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len >= 2) {
            ...
            if (_mv_578.has_value) {
                __auto_type bindings_expr = _mv_578.value;
                {
                                                    ...
                                                    if (((int64_t)((bind_items).len)) >= 2) {
                                                        {
                                                            ...
                                                            __auto_type _mv_582 = ({ __auto_type _lst = bind_items; size_t _idx = (size_t)val_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                            if (_mv_582.has_value) {
                                                                __auto_type val_expr = _mv_582.value;
...
uint8_t expr_is_mut_binding(slop_list_types_SExpr_ptr items) {
    if (((int64_t)((items).len)) < 1) {
        ...
        __auto_type _mv_583 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        if (_mv_583.has_value) {
            __auto_type first = _mv_583.value;
            __auto_type _mv_584 = (*first);
            switch (_mv_584.tag) {
                case types_SExpr_sym:
                {
...
slop_list_string expr_extract_let_binding_names(slop_arena* arena, types_SExpr* bindings_expr) {
    ...
    {
        __auto_type names = ((slop_list_string){ .data = (slop_string*)slop_arena_alloc(arena, 16 * sizeof(slop_string)), .len = 0, .cap = 16 });
        __auto_type _mv_585 = (*bindings_expr);
        switch (_mv_585.tag) {
            case types_SExpr_lst:
            {
                __auto_type bindings_lst = _mv_585.data.lst;
                {
                    __auto_type bindings = bindings_lst.items;
                    __auto_type binding_count = ((int64_t)((bindings).len));
                    __auto_type i = 0;
                    while (i < binding_count) {
                        __auto_type _mv_586 = ({ __auto_type _lst = bindings; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_586.has_value) {
                            __auto_type binding = _mv_586.value;
                            __auto_type _mv_587 = (*binding);
                            switch (_mv_587.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type bind_lst = _mv_587.data.lst;
                                    {
                                        __auto_type bind_items = bind_lst.items;
                                        if (((int64_t)((bind_items).len)) >= 1) {
                                            {
                                                __auto_type name_idx = ((expr_is_mut_binding(bind_items)) ? 1 : 0);
                                                __auto_type _mv_588 = ({ __auto_type _lst = bind_items; size_t _idx = (size_t)name_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len >= 2) {
            ...
            if (_mv_590.has_value) {
                __auto_type scrutinee = _mv_590.value;
            ...
            }
            {
                int64_t i = 2;
                while (i < len) {
                    __auto_type _mv_591 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_591.has_value) {
                        __auto_type clause = _mv_591.value;
                        __auto_type _mv_592 = (*clause);
                        switch (_mv_592.tag) {
                            case types_SExpr_lst:
                            {
                                __auto_type clause_lst = _mv_592.data.lst;
                                {
                                    __auto_type clause_items = clause_lst.items;
...
slop_list_string expr_extract_for_loop_var_pending(slop_arena* arena, slop_list_string pending, slop_list_types_SExpr_ptr bind_items) {
    if (((int64_t)((bind_items).len)) < 1) {
        ...
        __auto_type _mv_595 = ({ __auto_type _lst = bind_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        if (_mv_595.has_value) {
            __auto_type var_expr = _mv_595.value;
            __auto_type _mv_596 = (*var_expr);
            switch (_mv_596.tag) {
                case types_SExpr_sym:
                {
                    __auto_type var_sym = _mv_596.data.sym;
                    {
                        __auto_type result = ((slop_list_string){ .data = (slop_string*)slop_arena_alloc(arena, 16 * sizeof(slop_string)), .len = 0, .cap = 16 });
                        ...
                        __auto_type i = 0;
                        while (i < plen) {
                            __auto_type _mv_597 = ({ __auto_type _lst = pending; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        if (len >= 3) {
            {
                ...
                __auto_type size_idx = ((is_named) ? 3 : 1);
                __auto_type body_start = ((is_named) ? 4 : 2);
                __auto_type _mv_598 = ({ __auto_type _lst = items; size_t _idx = (size_t)size_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_598.has_value) {
                    __auto_type size_expr = _mv_598.value;
...
void expr_collect_nested_lambda_free_vars(context_TranspileContext* ctx, slop_list_string* symbols, slop_list_string pending, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        __auto_type len = ((int64_t)((items).len));
        if (len >= 2) {
            __auto_type _mv_599 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_599.has_value) {
                __auto_type params_expr = _mv_599.value;
                __auto_type _mv_600 = (*params_expr);
                switch (_mv_600.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type params_lst = _mv_600.data.lst;
                        {
                            __auto_type params = params_lst.items;
                            __auto_type param_names = expr_extract_param_names(arena, params);
    ...
    if (expr_list_contains_string(param_names, sym_name)) {
        ...
        if (expr_list_contains_string(pending, sym_name)) {
            ...
            if (expr_is_builtin_op(sym_name)) {
                ...
                __auto_type _mv_601 = context_ctx_lookup_func(ctx, sym_name);
                if (_mv_601.has_value) {
                    __auto_type _ = _mv_601.value;
                    return 0;
                } else if (!_mv_601.has_value) {
                    __auto_type _mv_602 = context_ctx_lookup_type(ctx, sym_name);
                    if (_mv_602.has_value) {
                        __auto_type _ = _mv_602.value;
                        return 0;
                    } else if (!_mv_602.has_value) {
                        __auto_type _mv_603 = context_ctx_lookup_var(ctx, sym_name);
...
uint8_t expr_list_contains_string(slop_list_string lst, slop_string needle) {
    {
        ...
        uint8_t found = 0;
        while ((i < len) && !(found)) {
            __auto_type _mv_604 = ({ __auto_type _lst = lst; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_list_string expr_list_concat(slop_arena* arena, slop_list_string a, slop_list_string b) {
    {
        ...
        int64_t i = 0;
        while (i < len_a) {
            __auto_type _mv_605 = ({ __auto_type _lst = a; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        i = 0;
        while (i < len_b) {
            __auto_type _mv_606 = ({ __auto_type _lst = b; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_string expr_infer_collection_element_slop_type(context_TranspileContext* ctx, types_SExpr* coll_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_607 = (*coll_expr);
        switch (_mv_607.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_607.data.lst;
                {
                    __auto_type items = lst.items;
                    if (((int64_t)((items).len)) < 1) {
                        return SLOP_STR("");
                    } else {
                        __auto_type _mv_608 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_608.has_value) {
                            __auto_type head = _mv_608.value;
                            __auto_type _mv_609 = (*head);
                            switch (_mv_609.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type sym = _mv_609.data.sym;
                                    {
                                        __auto_type op = sym.name;
                                        if (string_eq(op, SLOP_STR("map-keys"))) {
                                            ...
                                            if (((int64_t)((items).len)) < 2) {
                                                ...
                                                if (_mv_611.has_value) {
                                                    __auto_type set_expr = _mv_611.value;
                                                    {
