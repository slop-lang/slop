        ...
        while ((i < argc)) {
            {
                ...
                __auto_type _mv_1607 = tester_main_read_file(arena, path_ptr);
                if (_mv_1607.has_value) {
                    __auto_type source = _mv_1607.value;
...
int main(int argc, char** _c_argv) {
    ...
    if ((argc < 2)) {
    ...
    } else {
        {
            ...
            __auto_type _mv_1608 = tester_main_read_file(arena, ((char*)(argv[1])));
            if (_mv_1608.has_value) {
                __auto_type source = _mv_1608.value;
                {
