...
slop_string tester_main_lines_to_string(slop_arena* arena, slop_list_string lines) {
    {
        ...
        if ((len == 0)) {
        ...
        } else {
            {
                ...
                int64_t i = 0;
                while ((i < len)) {
                    __auto_type _mv_1577 = ({ __auto_type _lst = lines; size_t _idx = (size_t)i; slop_option_string _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_1577.has_value) {
                        __auto_type line = _mv_1577.value;
                ...
                }
                {
                    ...
                    int64_t j = 0;
                    while ((j < len)) {
                        __auto_type _mv_1578 = ({ __auto_type _lst = lines; size_t _idx = (size_t)j; slop_option_string _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_1578.has_value) {
                            __auto_type line = _mv_1578.value;
                            {
        ...
        while ((i < argc)) {
            {
                ...
                __auto_type _mv_1579 = tester_main_read_file(arena, path_ptr);
                if (_mv_1579.has_value) {
                    __auto_type source = _mv_1579.value;
...
int main(int64_t argc, uint8_t** argv) {
    if ((argc < 2)) {
    ...
    } else {
        {
            ...
            __auto_type _mv_1580 = tester_main_read_file(arena, ((char*)(argv[1])));
            if (_mv_1580.has_value) {
                __auto_type source = _mv_1580.value;
                {
