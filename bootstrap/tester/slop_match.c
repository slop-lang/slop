...
uint8_t match_is_result_match(slop_list_types_SExpr_ptr patterns) {
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_672 = ({ __auto_type _lst = patterns; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_672.has_value) {
                __auto_type pat_expr = _mv_672.value;
                {
                    __auto_type tag = match_get_pattern_tag(pat_expr);
...
uint8_t match_is_enum_match(slop_list_types_SExpr_ptr patterns) {
    {
        ...
        while ((i < len) && all_symbols) {
            ...
            if (_mv_673.has_value) {
                ...
                __auto_type _mv_674 = (*pat_expr);
                switch (_mv_674.tag) {
                    case types_SExpr_sym:
                    {
                        __auto_type _ = _mv_674.data.sym;
                        break;
                    }
                    default: {
                        all_symbols = 0;
        ...
        while ((i < len) && !(has_literal)) {
            ...
            if (_mv_675.has_value) {
                ...
                switch (_mv_676.tag) {
                    ...
                    {
                        __auto_type _ = _mv_676.data.num;
                        has_literal = 1;
                        break;
                    }
                    case types_SExpr_str:
                    {
                        __auto_type _ = _mv_676.data.str;
                        has_literal = 1;
                        break;
                    }
                    default: {
            ...
            __auto_type lst = _mv_682.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 2) {
                    ...
                    if (_mv_683.has_value) {
                        __auto_type binding = _mv_683.value;
                        __auto_type _mv_684 = (*binding);
                        switch (_mv_684.tag) {
                            case types_SExpr_sym:
                            {
                ...
                __auto_type lst = _mv_686.data.lst;
                {
                    ...
                    if (len < 3) {
                        ...
                        if (_mv_687.has_value) {
                            __auto_type scrutinee = _mv_687.value;
                            {
...
void match_emit_enum_case(context_TranspileContext* ctx, types_SExpr* pattern, slop_list_types_SExpr_ptr branch_items, uint8_t is_return) {
    ...
    SLOP_PRE(((pattern != NULL)), "(!= pattern nil)");
    {
        ...
        if (string_eq(tag, SLOP_STR("else")) || string_eq(tag, SLOP_STR("_"))) {
            ...
            __auto_type _mv_703 = context_ctx_lookup_enum_variant(ctx, tag);
            if (_mv_703.has_value) {
                __auto_type type_name = _mv_703.value;
                {
    ...
    } else {
        {
            ...
            while (i < len) {
                ...
                if (_mv_707.has_value) {
                    __auto_type branch = _mv_707.value;
                    __auto_type _mv_708 = (*branch);
                    switch (_mv_708.tag) {
                        case types_SExpr_lst:
                        {
                            __auto_type branch_lst = _mv_708.data.lst;
                            {
                                __auto_type branch_items = branch_lst.items;
                                if (((int64_t)((branch_items).len)) >= 2) {
                                    __auto_type _mv_709 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    if (_mv_709.has_value) {
                                        __auto_type pattern = _mv_709.value;
                                        {
                                            __auto_type tag = match_get_pattern_tag(pattern);
                                            if (string_eq(tag, SLOP_STR("else")) || string_eq(tag, SLOP_STR("_"))) {
                                                has_else = 1;
                                                ...
                                                __auto_type _mv_710 = context_ctx_lookup_enum_variant(ctx, tag);
                                                if (_mv_710.has_value) {
                                                    __auto_type union_type_name = _mv_710.value;
    ...
    SLOP_PRE(((pattern != NULL)), "(!= pattern nil)");
    {
        ...
        context_ctx_push_scope(ctx);
        {
            ...
            if (!(string_eq(multi_field_count, SLOP_STR("")))) {
                __auto_type _mv_711 = (*pattern);
                switch (_mv_711.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type pat_lst = _mv_711.data.lst;
                        {
                            __auto_type pat_items = pat_lst.items;
                            __auto_type pat_len = ((int64_t)((pat_items).len));
                            for (int64_t bi = 1; bi < pat_len; bi++) {
                                __auto_type _mv_712 = ({ __auto_type _lst = pat_items; size_t _idx = (size_t)bi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_712.has_value) {
                                    __auto_type binding_expr = _mv_712.value;
                                    {
                ...
                __auto_type _mv_713 = match_extract_binding_name(pattern);
                if (_mv_713.has_value) {
                    __auto_type binding_name = _mv_713.value;
                    {
                        __auto_type c_binding = ctype_to_c_name(arena, binding_name);
...
void match_emit_branch_body(context_TranspileContext* ctx, slop_list_types_SExpr_ptr branch_items, uint8_t is_return) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 1;
        while (i < len) {
            __auto_type _mv_714 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_714.has_value) {
                __auto_type body_expr = _mv_714.value;
                {
                ...
                __auto_type lst = _mv_715.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) < 1) {
                        ...
                        if (_mv_716.has_value) {
                            __auto_type head_expr = _mv_716.value;
                            __auto_type _mv_717 = (*head_expr);
                            switch (_mv_717.tag) {
                                case types_SExpr_sym:
                                {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 2) {
            ...
            if (_mv_718.has_value) {
                __auto_type bindings_expr = _mv_718.value;
            ...
            }
            {
                int64_t i = 2;
                while (i < len) {
                    __auto_type _mv_719 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_719.has_value) {
                        __auto_type body_item = _mv_719.value;
                        {
...
void match_emit_inline_bindings(context_TranspileContext* ctx, types_SExpr* bindings_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_720 = (*bindings_expr);
        switch (_mv_720.tag) {
            case types_SExpr_lst:
            {
                __auto_type bindings_lst = _mv_720.data.lst;
                {
                    __auto_type bindings = bindings_lst.items;
                    __auto_type len = ((int64_t)((bindings).len));
                    __auto_type i = 0;
                    while (i < len) {
                        __auto_type _mv_721 = ({ __auto_type _lst = bindings; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_721.has_value) {
                            __auto_type binding = _mv_721.value;
                ...
                __auto_type binding_lst = _mv_722.data.lst;
                {
                    ...
                    __auto_type len = ((int64_t)((items).len));
                    {
                        ...
                        if ((len - start_idx) < 2) {
                            ...
                            __auto_type _mv_723 = ({ __auto_type _lst = items; size_t _idx = (size_t)start_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_723.has_value) {
                                __auto_type name_expr = _mv_723.value;
                                __auto_type _mv_724 = (*name_expr);
                                switch (_mv_724.tag) {
                                    case types_SExpr_sym:
                                    {
                                        __auto_type name_sym = _mv_724.data.sym;
                                        {
                                            ...
                                            if ((len - start_idx) >= 3) {
                                                {
                                                    ...
                                                    __auto_type _mv_725 = ({ __auto_type _lst = items; size_t _idx = (size_t)type_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_725.has_value) {
                                                        __auto_type type_expr = _mv_725.value;
                                                        if (match_is_type_expr(type_expr)) {
                                                            __auto_type _mv_726 = ({ __auto_type _lst = items; size_t _idx = (size_t)val_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                            ...
                                                            if (_mv_727.has_value) {
                                                                __auto_type val_expr = _mv_727.value;
                                                                {
                                                                    ...
                                                                    __auto_type _mv_728 = ptr_type_opt;
                                                                    if (_mv_728.has_value) {
                                                                        __auto_type ptr_type = _mv_728.value;
                                            ...
                                            } else {
                                                {
                                                    ...
                                                    __auto_type _mv_729 = ({ __auto_type _lst = items; size_t _idx = (size_t)val_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
uint8_t match_binding_starts_with_mut(slop_list_types_SExpr_ptr items) {
    if (((int64_t)((items).len)) < 1) {
        ...
        if (_mv_731.has_value) {
            __auto_type first = _mv_731.value;
            __auto_type _mv_732 = (*first);
            switch (_mv_732.tag) {
                case types_SExpr_sym:
                {
...
uint8_t match_is_type_expr(types_SExpr* expr) {
    ...
    switch (_mv_733.tag) {
        ...
        case types_SExpr_lst:
        {
            __auto_type _ = _mv_733.data.lst;
            return 1;
        }
        default: {
            return 0;
            ...
            __auto_type lst = _mv_734.data.lst;
            {
                ...
                if (((int64_t)((items).len)) == 1) {
                    ...
                    if (_mv_735.has_value) {
                        __auto_type head = _mv_735.value;
                        __auto_type _mv_736 = (*head);
                        switch (_mv_736.tag) {
                            case types_SExpr_sym:
                            {
                ...
                __auto_type lst = _mv_737.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) >= 3) {
                        ...
                        if (_mv_738.has_value) {
                            __auto_type head_ptr = _mv_738.value;
                            __auto_type _mv_739 = (*head_ptr);
                            switch (_mv_739.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type head_sym = _mv_739.data.sym;
                                    if (string_eq(head_sym.name, SLOP_STR("arena-alloc"))) {
                                        __auto_type _mv_740 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_740.has_value) {
                                            __auto_type size_expr = _mv_740.value;
        ...
        switch (_mv_741.tag) {
            case types_SExpr_sym:
            {
                __auto_type sym = _mv_741.data.sym;
                {
                    ...
                    __auto_type _mv_742 = context_ctx_lookup_type(ctx, type_name);
                    if (_mv_742.has_value) {
                        __auto_type entry = _mv_742.value;
                                ...
                                case types_SExpr_sym:
                                {
                                    ...
                                    if (string_eq(head_sym.name, SLOP_STR("sizeof"))) {
                                        ...
                                        if (_mv_745.has_value) {
                                            __auto_type type_expr = _mv_745.value;
                                            {
                                                __auto_type c_type = context_to_c_type_prefixed(ctx, type_expr);
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_746.has_value) {
                __auto_type item = _mv_746.value;
                {
...
void match_emit_inline_if(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items, uint8_t is_return) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 3) {
            ...
            context_ctx_indent(ctx);
            __auto_type _mv_748 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_748.has_value) {
                __auto_type then_expr = _mv_748.value;
            ...
            if (len >= 4) {
                context_ctx_emit(ctx, SLOP_STR("} else {"));
                context_ctx_indent(ctx);
                __auto_type _mv_749 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_749.has_value) {
                    __auto_type else_expr = _mv_749.value;
...
slop_option_string match_get_var_c_type_inline(context_TranspileContext* ctx, types_SExpr* expr) {
    ...
    switch (_mv_751.tag) {
        case types_SExpr_sym:
        {
            ...
            {
                __auto_type name = sym.name;
                __auto_type _mv_752 = context_ctx_lookup_var(ctx, name);
                if (_mv_752.has_value) {
                    __auto_type var_entry = _mv_752.value;
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (expr_set_is_self_assign(items)) {
            ...
            if (_mv_757.has_value) {
                __auto_type target_expr = _mv_757.value;
                __auto_type _mv_758 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_758.has_value) {
                    __auto_type field_expr = _mv_758.value;
                    __auto_type _mv_759 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_759.has_value) {
                        __auto_type type_expr = _mv_759.value;
                        __auto_type _mv_760 = ({ __auto_type _lst = items; size_t _idx = (size_t)4; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                ...
                                __auto_type c_type = ctype_to_c_type(arena, type_expr);
                                {
                                    ...
                                    if (context_ctx_is_option_c_type(ctx, c_type)) {
                                        if (match_is_none_form_inline(value_expr)) {
                                            ...
                                            __auto_type _mv_761 = match_get_some_value_inline(value_expr);
                                            if (_mv_761.has_value) {
                                                __auto_type inner_val = _mv_761.value;
                                                {
            ...
            if (_mv_765.has_value) {
                __auto_type target_expr = _mv_765.value;
                __auto_type _mv_766 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_766.has_value) {
                    __auto_type val_expr = _mv_766.value;
                    {
                        __auto_type target_c = expr_transpile_expr(ctx, target_expr);
                        __auto_type target_type_opt = match_get_var_c_type_inline(ctx, target_expr);
                        __auto_type _mv_767 = target_type_opt;
                        if (_mv_767.has_value) {
                            __auto_type target_type = _mv_767.value;
                            if (context_ctx_is_option_c_type(ctx, target_type)) {
                                {
                                    __auto_type some_val_opt = match_get_some_value_inline(val_expr);
                                    __auto_type _mv_768 = some_val_opt;
                                    if (_mv_768.has_value) {
                                        __auto_type inner_expr = _mv_768.value;
                                        {
                            ...
                            {
                                __auto_type some_val_opt = match_get_some_value_inline(val_expr);
                                __auto_type _mv_769 = some_val_opt;
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_771.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 2) {
                    ...
                    __auto_type _mv_772 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 2) {
            ...
            if (_mv_777.has_value) {
                __auto_type cond_expr = _mv_777.value;
                {
                    __auto_type cond_c = context_ctx_strip_cond_parens(ctx, expr_transpile_expr(ctx, cond_expr));
                    context_ctx_emit(ctx, context_ctx_str3(ctx, SLOP_STR("if ("), cond_c, SLOP_STR(") {")));
                }
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_778.has_value) {
                __auto_type clause_expr = _mv_778.value;
                __auto_type _mv_779 = (*clause_expr);
                switch (_mv_779.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type clause_lst = _mv_779.data.lst;
                        {
                            ...
                            if (clause_len < 1) {
                                ...
                                __auto_type _mv_780 = ({ __auto_type _lst = clause_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_780.has_value) {
                                    __auto_type test_expr = _mv_780.value;
                                    __auto_type _mv_781 = (*test_expr);
                                    switch (_mv_781.tag) {
                                        case types_SExpr_sym:
                                        {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_782.has_value) {
                __auto_type body_expr = _mv_782.value;
                {
        ...
        if (len < 2) {
        ...
        } else {
            {
                ...
                if (is_named && (len < 4)) {
                    ...
                    context_ctx_indent(ctx);
                    context_ctx_push_scope(ctx);
                    __auto_type _mv_783 = ({ __auto_type _lst = items; size_t _idx = (size_t)size_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_783.has_value) {
                        __auto_type size_expr = _mv_783.value;
                        {
...
void match_emit_inline_for(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 2) {
            ...
            __auto_type _mv_786 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_786.has_value) {
                __auto_type binding_expr = _mv_786.value;
                __auto_type _mv_787 = (*binding_expr);
                switch (_mv_787.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type binding_lst = _mv_787.data.lst;
                        {
                            ...
                            if (binding_len < 3) {
                                ...
                                if (_mv_788.has_value) {
                                    __auto_type var_expr = _mv_788.value;
                                    __auto_type _mv_789 = (*var_expr);
                                    switch (_mv_789.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type var_sym = _mv_789.data.sym;
                                            {
                                                __auto_type var_name = ctype_to_c_name(arena, var_sym.name);
                                                __auto_type _mv_790 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_790.has_value) {
                                                    __auto_type start_expr = _mv_790.value;
                                                    __auto_type _mv_791 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_791.has_value) {
                                                        __auto_type end_expr = _mv_791.value;
                                                        {
...
void match_emit_inline_for_each_map_kv(context_TranspileContext* ctx, slop_list_types_SExpr_ptr binding_items, slop_list_types_SExpr_ptr items, int64_t len) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (_mv_792.has_value) {
            __auto_type kv_list_expr = _mv_792.value;
            __auto_type _mv_793 = (*kv_list_expr);
            switch (_mv_793.tag) {
                case types_SExpr_lst:
                {
                    __auto_type kv_lst = _mv_793.data.lst;
                    {
                        __auto_type kv_items = kv_lst.items;
                        if (((int64_t)((kv_items).len)) < 2) {
                            context_ctx_add_error(ctx, SLOP_STR("Map for-each needs ((k v) map)"));
                        } else {
                            __auto_type _mv_794 = ({ __auto_type _lst = kv_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_794.has_value) {
                                __auto_type k_expr = _mv_794.value;
                                __auto_type _mv_795 = ({ __auto_type _lst = kv_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_795.has_value) {
                                    __auto_type v_expr = _mv_795.value;
                                    __auto_type _mv_796 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    if (_mv_796.has_value) {
                                        __auto_type map_expr = _mv_796.value;
                                        __auto_type _mv_797 = (*k_expr);
                                        switch (_mv_797.tag) {
                                            case types_SExpr_sym:
                                            {
                                                __auto_type k_sym = _mv_797.data.sym;
                                                __auto_type _mv_798 = (*v_expr);
                                                switch (_mv_798.tag) {
                                                    case types_SExpr_sym:
                                                    {
                                                        __auto_type v_sym = _mv_798.data.sym;
                                                        {
...
void match_emit_inline_for_each(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 2) {
            ...
            __auto_type _mv_799 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_799.has_value) {
                __auto_type binding_expr = _mv_799.value;
                __auto_type _mv_800 = (*binding_expr);
                switch (_mv_800.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type binding_lst = _mv_800.data.lst;
                        {
                            __auto_type binding_items = binding_lst.items;
                            __auto_type binding_len = ((int64_t)((binding_items).len));
                            if (binding_len < 2) {
                                ...
                                __auto_type _mv_801 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_801.has_value) {
                                    __auto_type first_elem = _mv_801.value;
                                    __auto_type _mv_802 = (*first_elem);
                                    switch (_mv_802.tag) {
                                        case types_SExpr_lst:
                                        {
                                            __auto_type _ = _mv_802.data.lst;
                                            match_emit_inline_for_each_map_kv(ctx, binding_items, items, len);
                                            break;
                                        }
                                        case types_SExpr_sym:
                                        {
                                            __auto_type var_sym = _mv_802.data.sym;
                                            {
                                                __auto_type var_name = ctype_to_c_name(arena, var_sym.name);
                                                __auto_type _mv_803 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_803.has_value) {
                                                    __auto_type coll_expr = _mv_803.value;
                                                    {
                            ...
                            case types_SExpr_sym:
                            {
                                __auto_type sym = _mv_807.data.sym;
                                {
                                    ...
                                    if (string_eq(op, SLOP_STR("some"))) {
                                        __auto_type _mv_808 = context_ctx_get_current_return_type(ctx);
                                        if (_mv_808.has_value) {
                                            __auto_type ret_type = _mv_808.value;
                                            if (context_ctx_is_option_c_type(ctx, ret_type)) {
                                                if (((int64_t)((items).len)) < 2) {
                                                    match_emit_return_typed(ctx, expr_transpile_expr(ctx, expr));
                                                } else {
                                                    ...
                                                    if (_mv_809.has_value) {
                                                        __auto_type inner_expr = _mv_809.value;
                                                        {
                                                            __auto_type inner_c = expr_transpile_expr(ctx, inner_expr);
...
uint8_t match_is_pattern_literal(types_SExpr* expr) {
    ...
    switch (_mv_811.tag) {
        ...
        case types_SExpr_num:
        {
            __auto_type _ = _mv_811.data.num;
            return 1;
        }
        case types_SExpr_str:
        {
            __auto_type _ = _mv_811.data.str;
            return 1;
        }
        default: {
            return 0;
...
slop_string match_pattern_literal_to_c(types_SExpr* expr) {
    ...
    switch (_mv_812.tag) {
        ...
        case types_SExpr_num:
        {
            __auto_type n = _mv_812.data.num;
            return n.raw;
        }
        default: {
            return SLOP_STR("");
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_813.data.lst;
            {
                ...
                for (int64_t i = 1; i < len; i++) {
                    if (!(found)) {
                        __auto_type _mv_814 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
uint8_t match_has_literal_in_patterns(slop_list_types_SExpr_ptr patterns) {
    {
        ...
        int64_t i = 0;
        while ((i < len) && !(found)) {
            __auto_type _mv_815 = ({ __auto_type _lst = patterns; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_815.has_value) {
                __auto_type pat_expr = _mv_815.value;
...
slop_string match_build_literal_guard_cond(context_TranspileContext* ctx, slop_string scrutinee_c, slop_string c_tag, slop_string tag_cond, types_SExpr* pattern, uint8_t is_multi) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_816 = (*pattern);
        switch (_mv_816.tag) {
            case types_SExpr_lst:
            {
                __auto_type pat_lst = _mv_816.data.lst;
                {
                    __auto_type pat_items = pat_lst.items;
                    __auto_type pat_len = ((int64_t)((pat_items).len));
                    __auto_type cond = tag_cond;
                    for (int64_t bi = 1; bi < pat_len; bi++) {
                        __auto_type _mv_817 = ({ __auto_type _lst = pat_items; size_t _idx = (size_t)bi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void match_emit_union_literal_bindings(context_TranspileContext* ctx, slop_string scrutinee_c, types_SExpr* pattern, slop_string tag, slop_string union_type_name, slop_string c_tag, uint8_t is_multi) {
    ...
    SLOP_PRE(((pattern != NULL)), "(!= pattern nil)");
    {
        ...
        if (is_multi) {
            ...
            __auto_type _mv_820 = match_extract_binding_name(pattern);
            if (_mv_820.has_value) {
                __auto_type binding_name = _mv_820.value;
...
void match_transpile_union_match_with_literals(context_TranspileContext* ctx, slop_string scrutinee_c, slop_list_types_SExpr_ptr patterns, slop_list_types_SExpr_ptr items, uint8_t is_return) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        uint8_t has_else = 0;
        while (i < len) {
            __auto_type _mv_821 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_821.has_value) {
                __auto_type branch = _mv_821.value;
                __auto_type _mv_822 = (*branch);
                switch (_mv_822.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type branch_lst = _mv_822.data.lst;
                        {
                            __auto_type branch_items = branch_lst.items;
                            if (((int64_t)((branch_items).len)) >= 2) {
                                __auto_type _mv_823 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_823.has_value) {
                                    __auto_type pattern = _mv_823.value;
                                    {
                                        __auto_type tag = match_get_pattern_tag(pattern);
                                        if (string_eq(tag, SLOP_STR("else")) || string_eq(tag, SLOP_STR("_"))) {
                                            has_else = 1;
                                            ...
                                            __auto_type _mv_824 = context_ctx_lookup_enum_variant(ctx, tag);
                                            if (_mv_824.has_value) {
                                                __auto_type union_type_name = _mv_824.value;
                                                {
                                                    __auto_type c_tag = ctype_to_c_name(arena, tag);
