        ...
        while ((i < len) && all_symbols) {
            ...
            if (_mv_653.has_value) {
                ...
                switch (_mv_654.tag) {
                    ...
                    {
                        __auto_type _ = _mv_654.data.sym;
                        break;
                    }
                    default: {
                        all_symbols = 0;
        ...
        while ((i < len) && !(has_literal)) {
            ...
            if (_mv_655.has_value) {
                ...
                switch (_mv_656.tag) {
                    ...
                    {
                        __auto_type _ = _mv_656.data.num;
                        has_literal = 1;
                        break;
                    }
                    case types_SExpr_str:
                    {
                        __auto_type _ = _mv_656.data.str;
                        has_literal = 1;
                        break;
                    }
                    default: {
            ...
            if (_mv_657.has_value) {
                __auto_type pat_expr = _mv_657.value;
                {
                    ...
                    if ((!(string_eq(tag, SLOP_STR("")))) && (!(string_eq(tag, SLOP_STR("some")))) && (!(string_eq(tag, SLOP_STR("none")))) && (!(string_eq(tag, SLOP_STR("ok")))) && (!(string_eq(tag, SLOP_STR("error")))) && (!(string_eq(tag, SLOP_STR("else")))) && (!(string_eq(tag, SLOP_STR("_"))))) {
                        __auto_type _mv_658 = context_ctx_lookup_enum_variant(ctx, tag);
                        if (_mv_658.has_value) {
                            __auto_type _ = _mv_658.value;
                            has_union_variant = 1;
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_659.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 1) {
                    ...
                    __auto_type _mv_660 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_660.has_value) {
                        __auto_type head = _mv_660.value;
                        __auto_type _mv_661 = (*head);
                        switch (_mv_661.tag) {
                            case types_SExpr_sym:
                            {
            ...
            __auto_type lst = _mv_662.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 2) {
                    ...
                    if (_mv_663.has_value) {
                        __auto_type binding = _mv_663.value;
                        __auto_type _mv_664 = (*binding);
                        switch (_mv_664.tag) {
                            case types_SExpr_sym:
                            {
                ...
                __auto_type lst = _mv_666.data.lst;
                {
                    ...
                    if (len < 3) {
                        ...
                        if (_mv_667.has_value) {
                            __auto_type scrutinee = _mv_667.value;
                            {
...
void match_emit_result_error_branch(context_TranspileContext* ctx, slop_string scrutinee_c, types_SExpr* scrutinee_expr, types_SExpr* pattern, slop_list_types_SExpr_ptr branch_items, uint8_t is_return, uint8_t first) {
    ...
    SLOP_PRE(((pattern != NULL)), "(!= pattern nil)");
    {
        ...
        context_ctx_indent(ctx);
        context_ctx_push_scope(ctx);
        __auto_type _mv_679 = match_extract_binding_name(pattern);
        if (_mv_679.has_value) {
            __auto_type binding_name = _mv_679.value;
            {
                __auto_type c_name = ctype_to_c_name(arena, binding_name);
    ...
    SLOP_PRE(((pattern != NULL)), "(!= pattern nil)");
    {
        ...
        if (string_eq(tag, SLOP_STR("else")) || string_eq(tag, SLOP_STR("_"))) {
            ...
            if (_mv_683.has_value) {
                __auto_type type_name = _mv_683.value;
                {
                                    ...
                                    if (_mv_689.has_value) {
                                        __auto_type pattern = _mv_689.value;
                                        {
                                            ...
                                            if (string_eq(tag, SLOP_STR("else")) || string_eq(tag, SLOP_STR("_"))) {
                                                ...
                                                __auto_type _mv_690 = context_ctx_lookup_enum_variant(ctx, tag);
                                                if (_mv_690.has_value) {
                                                    __auto_type union_type_name = _mv_690.value;
    ...
    SLOP_PRE(((pattern != NULL)), "(!= pattern nil)");
    {
        ...
        context_ctx_push_scope(ctx);
        {
            ...
            if (!(string_eq(multi_field_count, SLOP_STR("")))) {
                __auto_type _mv_691 = (*pattern);
                switch (_mv_691.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type pat_lst = _mv_691.data.lst;
                        {
                            __auto_type pat_items = pat_lst.items;
                            __auto_type pat_len = ((int64_t)((pat_items).len));
                            for (int64_t bi = 1; bi < pat_len; bi++) {
                                __auto_type _mv_692 = ({ __auto_type _lst = pat_items; size_t _idx = (size_t)bi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_692.has_value) {
                                    __auto_type binding_expr = _mv_692.value;
                                    {
                ...
                __auto_type _mv_693 = match_extract_binding_name(pattern);
                if (_mv_693.has_value) {
                    __auto_type binding_name = _mv_693.value;
                    {
                        __auto_type c_binding = ctype_to_c_name(arena, binding_name);
...
void match_emit_branch_body(context_TranspileContext* ctx, slop_list_types_SExpr_ptr branch_items, uint8_t is_return) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 1;
        while (i < len) {
            __auto_type _mv_694 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                ...
                __auto_type lst = _mv_695.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) < 1) {
                        ...
                        if (_mv_696.has_value) {
                            __auto_type head_expr = _mv_696.value;
                            __auto_type _mv_697 = (*head_expr);
                            switch (_mv_697.tag) {
                                case types_SExpr_sym:
                                {
...
void match_emit_inline_let(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items, uint8_t is_return, uint8_t is_last) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 2) {
            ...
            context_ctx_indent(ctx);
            context_ctx_push_scope(ctx);
            __auto_type _mv_698 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_698.has_value) {
                __auto_type bindings_expr = _mv_698.value;
            ...
            }
            {
                ...
                while (i < len) {
                    ...
                    if (_mv_699.has_value) {
                        __auto_type body_item = _mv_699.value;
                        {
...
void match_emit_inline_bindings(context_TranspileContext* ctx, types_SExpr* bindings_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_700 = (*bindings_expr);
        switch (_mv_700.tag) {
            case types_SExpr_lst:
            {
                __auto_type bindings_lst = _mv_700.data.lst;
                {
                    __auto_type bindings = bindings_lst.items;
                    __auto_type len = ((int64_t)((bindings).len));
                    __auto_type i = 0;
                    while (i < len) {
                        __auto_type _mv_701 = ({ __auto_type _lst = bindings; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_701.has_value) {
                            __auto_type binding = _mv_701.value;
...
void match_emit_single_inline_binding(context_TranspileContext* ctx, types_SExpr* binding) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_702 = (*binding);
        switch (_mv_702.tag) {
            case types_SExpr_lst:
            {
                __auto_type binding_lst = _mv_702.data.lst;
                {
                    ...
                    __auto_type len = ((int64_t)((items).len));
                    {
                        ...
                        if ((len - start_idx) < 2) {
                            ...
                            __auto_type _mv_703 = ({ __auto_type _lst = items; size_t _idx = (size_t)start_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_703.has_value) {
                                __auto_type name_expr = _mv_703.value;
                                __auto_type _mv_704 = (*name_expr);
                                switch (_mv_704.tag) {
                                    case types_SExpr_sym:
                                    {
                                        __auto_type name_sym = _mv_704.data.sym;
                                        {
                                            ...
                                            if ((len - start_idx) >= 3) {
                                                {
                                                    ...
                                                    if (_mv_705.has_value) {
                                                        ...
                                                        if (match_is_type_expr(type_expr)) {
                                                            __auto_type _mv_706 = ({ __auto_type _lst = items; size_t _idx = (size_t)val_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                            if (_mv_706.has_value) {
                                                                __auto_type val_expr = _mv_706.value;
                                                                {
                                                            ...
                                                            __auto_type _mv_707 = ({ __auto_type _lst = items; size_t _idx = (size_t)type_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            ...
                                            } else {
                                                {
                                                    ...
                                                    if (_mv_709.has_value) {
                                                        __auto_type val_expr = _mv_709.value;
                                                        {
                                                            ...
                                                            __auto_type inferred_slop_type = expr_infer_expr_slop_type(ctx, val_expr);
                                                            __auto_type ptr_type_opt = match_get_arena_alloc_ptr_type_inline(ctx, val_expr);
                                                            __auto_type _mv_710 = ptr_type_opt;
                                                            if (_mv_710.has_value) {
                                                                __auto_type ptr_type = _mv_710.value;
                                                                context_ctx_emit(ctx, context_ctx_str4(ctx, SLOP_STR("__auto_type "), c_name, SLOP_STR(" = "), context_ctx_str(ctx, val_c, SLOP_STR(";"))));
                                                                context_ctx_bind_var(ctx, (context_VarEntry){raw_name, c_name, ptr_type, inferred_slop_type, 1, has_mut, 0, SLOP_STR(""), SLOP_STR("")});
...
uint8_t match_binding_starts_with_mut(slop_list_types_SExpr_ptr items) {
    if (((int64_t)((items).len)) < 1) {
        ...
        if (_mv_711.has_value) {
            __auto_type first = _mv_711.value;
            __auto_type _mv_712 = (*first);
            switch (_mv_712.tag) {
                case types_SExpr_sym:
                {
...
uint8_t match_is_type_expr(types_SExpr* expr) {
    ...
    switch (_mv_713.tag) {
        ...
        case types_SExpr_lst:
        {
            __auto_type _ = _mv_713.data.lst;
            return 1;
        }
        default: {
            return 0;
                            ...
                            switch (_mv_719.tag) {
                                case types_SExpr_sym:
                                {
                                    ...
                                    if (string_eq(head_sym.name, SLOP_STR("arena-alloc"))) {
                                        __auto_type _mv_720 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        switch (_mv_721.tag) {
            case types_SExpr_sym:
            {
                __auto_type sym = _mv_721.data.sym;
                {
                    ...
                    __auto_type _mv_722 = context_ctx_lookup_type(ctx, type_name);
                    if (_mv_722.has_value) {
                        __auto_type entry = _mv_722.value;
                ...
                __auto_type lst = _mv_721.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) >= 2) {
                        ...
                        if (_mv_723.has_value) {
                            __auto_type head_ptr = _mv_723.value;
                            __auto_type _mv_724 = (*head_ptr);
                            switch (_mv_724.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type head_sym = _mv_724.data.sym;
...
void match_emit_inline_do(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items, uint8_t is_return, uint8_t is_last) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 1;
        while (i < len) {
            __auto_type _mv_726 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_726.has_value) {
                __auto_type item = _mv_726.value;
                {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 3) {
            ...
            if (_mv_727.has_value) {
                __auto_type cond_expr = _mv_727.value;
                {
            ...
            if (_mv_728.has_value) {
                __auto_type then_expr = _mv_728.value;
            ...
            if (len >= 4) {
                ...
                if (_mv_729.has_value) {
                    __auto_type else_expr = _mv_729.value;
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (expr_set_is_self_assign(items)) {
            ...
            if (_mv_737.has_value) {
                ...
                if (_mv_738.has_value) {
                    ...
                    if (_mv_739.has_value) {
                        ...
                        __auto_type _mv_740 = ({ __auto_type _lst = items; size_t _idx = (size_t)4; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                ...
                                __auto_type c_type = ctype_to_c_type(arena, type_expr);
                                {
                                    ...
                                    if (context_ctx_is_option_c_type(ctx, c_type)) {
                                        if (match_is_none_form_inline(value_expr)) {
                                            ...
                                            __auto_type _mv_741 = match_get_some_value_inline(value_expr);
                                            if (_mv_741.has_value) {
                                                __auto_type inner_val = _mv_741.value;
                                                {
            ...
            if (_mv_742.has_value) {
                __auto_type target_expr = _mv_742.value;
                __auto_type _mv_743 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_743.has_value) {
                    __auto_type field_expr = _mv_743.value;
                    __auto_type _mv_744 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                ...
                if (_mv_746.has_value) {
                    __auto_type val_expr = _mv_746.value;
                    {
                        ...
                        if (_mv_747.has_value) {
                            ...
                            {
                                __auto_type some_val_opt = match_get_some_value_inline(val_expr);
                                __auto_type _mv_749 = some_val_opt;
                                if (_mv_749.has_value) {
                                    __auto_type inner_expr = _mv_749.value;
                                    {
                                        __auto_type inner_c = expr_transpile_expr(ctx, inner_expr);
                                    ...
                                    if (match_is_none_form_inline(val_expr)) {
                                        __auto_type _mv_750 = context_ctx_get_current_return_type(ctx);
                                        if (_mv_750.has_value) {
                                            __auto_type ret_type = _mv_750.value;
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_751.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 2) {
                    ...
                    __auto_type _mv_752 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_754.data.lst;
            {
                ...
                if (_mv_755.has_value) {
                    __auto_type inner = _mv_755.value;
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 2) {
            ...
            if (_mv_757.has_value) {
                __auto_type cond_expr = _mv_757.value;
                {
                    __auto_type cond_c = context_ctx_strip_cond_parens(ctx, expr_transpile_expr(ctx, cond_expr));
                    context_ctx_emit(ctx, context_ctx_str3(ctx, SLOP_STR("if ("), cond_c, SLOP_STR(") {")));
                }
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_758.has_value) {
                __auto_type clause_expr = _mv_758.value;
                __auto_type _mv_759 = (*clause_expr);
                switch (_mv_759.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type clause_lst = _mv_759.data.lst;
                        {
                            ...
                            if (clause_len < 1) {
                                ...
                                __auto_type _mv_760 = ({ __auto_type _lst = clause_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_760.has_value) {
                                    __auto_type test_expr = _mv_760.value;
                                    __auto_type _mv_761 = (*test_expr);
                                    switch (_mv_761.tag) {
                                        case types_SExpr_sym:
                                        {
        ...
        if (len < 2) {
        ...
        } else {
            {
                ...
                if (is_named && (len < 4)) {
                    ...
                    context_ctx_indent(ctx);
                    context_ctx_push_scope(ctx);
                    __auto_type _mv_763 = ({ __auto_type _lst = items; size_t _idx = (size_t)size_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_763.has_value) {
                        __auto_type size_expr = _mv_763.value;
                        {
                    ...
                    context_ctx_bind_var(ctx, (context_VarEntry){arena_name, c_arena_name, SLOP_STR("slop_arena*"), SLOP_STR(""), 1, 0, 0, SLOP_STR(""), SLOP_STR("")});
                    {
                        ...
                        while (i < len) {
                            ...
                            if (_mv_764.has_value) {
                                __auto_type body_expr = _mv_764.value;
                                {
                                    __auto_type is_last = (i == (len - 1));
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 2) {
            ...
            if (_mv_766.has_value) {
                __auto_type binding_expr = _mv_766.value;
                __auto_type _mv_767 = (*binding_expr);
                switch (_mv_767.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type binding_lst = _mv_767.data.lst;
                        {
                            ...
                            if (binding_len < 3) {
                                ...
                                if (_mv_768.has_value) {
                                    __auto_type var_expr = _mv_768.value;
                                    __auto_type _mv_769 = (*var_expr);
                                    switch (_mv_769.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type var_sym = _mv_769.data.sym;
                                            {
                                                ...
                                                if (_mv_770.has_value) {
                                                    __auto_type start_expr = _mv_770.value;
                                                    __auto_type _mv_771 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_771.has_value) {
                                                        __auto_type end_expr = _mv_771.value;
                                                        {
...
void match_emit_inline_for_each_map_kv(context_TranspileContext* ctx, slop_list_types_SExpr_ptr binding_items, slop_list_types_SExpr_ptr items, int64_t len) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (_mv_772.has_value) {
            __auto_type kv_list_expr = _mv_772.value;
            __auto_type _mv_773 = (*kv_list_expr);
            switch (_mv_773.tag) {
                case types_SExpr_lst:
                {
                    __auto_type kv_lst = _mv_773.data.lst;
                    {
                        __auto_type kv_items = kv_lst.items;
                        if (((int64_t)((kv_items).len)) < 2) {
                            context_ctx_add_error(ctx, SLOP_STR("Map for-each needs ((k v) map)"));
                        } else {
                            __auto_type _mv_774 = ({ __auto_type _lst = kv_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_774.has_value) {
                                __auto_type k_expr = _mv_774.value;
                                __auto_type _mv_775 = ({ __auto_type _lst = kv_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_775.has_value) {
                                    __auto_type v_expr = _mv_775.value;
                                    __auto_type _mv_776 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    if (_mv_776.has_value) {
                                        __auto_type map_expr = _mv_776.value;
                                        __auto_type _mv_777 = (*k_expr);
                                        switch (_mv_777.tag) {
                                            case types_SExpr_sym:
                                            {
                                                __auto_type k_sym = _mv_777.data.sym;
                                                __auto_type _mv_778 = (*v_expr);
                                                switch (_mv_778.tag) {
                                                    case types_SExpr_sym:
                                                    {
                                                        __auto_type v_sym = _mv_778.data.sym;
                                                        {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 2) {
            ...
            if (_mv_779.has_value) {
                ...
                __auto_type _mv_780 = (*binding_expr);
                switch (_mv_780.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type binding_lst = _mv_780.data.lst;
                        {
                            __auto_type binding_items = binding_lst.items;
                            __auto_type binding_len = ((int64_t)((binding_items).len));
                            if (binding_len < 2) {
                                ...
                                __auto_type _mv_781 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_781.has_value) {
                                    __auto_type first_elem = _mv_781.value;
                                    __auto_type _mv_782 = (*first_elem);
                                    switch (_mv_782.tag) {
                                        case types_SExpr_lst:
                                        {
                                            __auto_type _ = _mv_782.data.lst;
                                            match_emit_inline_for_each_map_kv(ctx, binding_items, items, len);
                                            break;
                                        }
                                        case types_SExpr_sym:
                                        {
                                            __auto_type var_sym = _mv_782.data.sym;
                                            {
                                                __auto_type var_name = ctype_to_c_name(arena, var_sym.name);
                                                __auto_type _mv_783 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_783.has_value) {
                                                    __auto_type coll_expr = _mv_783.value;
                                                    {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 2) {
            ...
            if (_mv_784.has_value) {
                __auto_type val_expr = _mv_784.value;
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_785.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 1) {
                    ...
                    __auto_type _mv_786 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_786.has_value) {
                        __auto_type head = _mv_786.value;
                        __auto_type _mv_787 = (*head);
                        switch (_mv_787.tag) {
                            case types_SExpr_sym:
                            {
                                __auto_type sym = _mv_787.data.sym;
                                {
                                    ...
                                    if (string_eq(op, SLOP_STR("some"))) {
                                            ...
                                            if (context_ctx_is_option_c_type(ctx, ret_type)) {
                                                if (((int64_t)((items).len)) < 2) {
                                                    ...
                                                    if (_mv_789.has_value) {
                                                        __auto_type inner_expr = _mv_789.value;
                                                        {
                                                            __auto_type inner_c = expr_transpile_expr(ctx, inner_expr);
                                        ...
                                        __auto_type _mv_790 = context_ctx_get_current_return_type(ctx);
                                        if (_mv_790.has_value) {
                                            __auto_type ret_type = _mv_790.value;
                                            if (context_ctx_is_option_c_type(ctx, ret_type)) {
...
uint8_t match_is_pattern_literal(types_SExpr* expr) {
    ...
    switch (_mv_791.tag) {
        ...
        case types_SExpr_num:
        {
            __auto_type _ = _mv_791.data.num;
            return 1;
        }
        default: {
            return 0;
...
slop_string match_pattern_literal_to_c(types_SExpr* expr) {
    ...
    switch (_mv_792.tag) {
        ...
        case types_SExpr_num:
        {
            __auto_type n = _mv_792.data.num;
            return n.raw;
        }
        default: {
            return SLOP_STR("");
                ...
                for (int64_t i = 1; i < len; i++) {
                    if (!(found)) {
                        ...
                        if (_mv_794.has_value) {
                            __auto_type item = _mv_794.value;
...
uint8_t match_has_literal_in_patterns(slop_list_types_SExpr_ptr patterns) {
    {
        ...
        int64_t i = 0;
        while ((i < len) && !(found)) {
            __auto_type _mv_795 = ({ __auto_type _lst = patterns; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_795.has_value) {
                __auto_type pat_expr = _mv_795.value;
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_801.has_value) {
                __auto_type branch = _mv_801.value;
                __auto_type _mv_802 = (*branch);
                switch (_mv_802.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type branch_lst = _mv_802.data.lst;
                        {
                            __auto_type branch_items = branch_lst.items;
                            if (((int64_t)((branch_items).len)) >= 2) {
                                __auto_type _mv_803 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_803.has_value) {
                                    __auto_type pattern = _mv_803.value;
                                    {
                                        __auto_type tag = match_get_pattern_tag(pattern);
                                        if (string_eq(tag, SLOP_STR("else")) || string_eq(tag, SLOP_STR("_"))) {
                                            has_else = 1;
                                            ...
                                            __auto_type _mv_804 = context_ctx_lookup_enum_variant(ctx, tag);
                                            if (_mv_804.has_value) {
                                                __auto_type union_type_name = _mv_804.value;
                                                {
                                                    __auto_type c_tag = ctype_to_c_name(arena, tag);
