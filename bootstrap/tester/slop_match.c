...
uint8_t match_is_option_match(slop_list_types_SExpr_ptr patterns) {
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_639 = ({ __auto_type _lst = patterns; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_639.has_value) {
                __auto_type pat_expr = _mv_639.value;
                {
...
uint8_t match_is_result_match(slop_list_types_SExpr_ptr patterns) {
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_640 = ({ __auto_type _lst = patterns; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_640.has_value) {
                __auto_type pat_expr = _mv_640.value;
                {
                    __auto_type tag = match_get_pattern_tag(pat_expr);
        ...
        while ((i < len) && all_symbols) {
            ...
            if (_mv_641.has_value) {
                ...
                switch (_mv_642.tag) {
                    ...
                    {
                        __auto_type _ = _mv_642.data.sym;
                        break;
                    }
                    default: {
                        all_symbols = 0;
        ...
        while ((i < len) && !(has_literal)) {
            ...
            if (_mv_643.has_value) {
                ...
                switch (_mv_644.tag) {
                    ...
                    {
                        __auto_type _ = _mv_644.data.num;
                        has_literal = 1;
                        break;
                    }
                    case types_SExpr_str:
                    {
                        __auto_type _ = _mv_644.data.str;
                        has_literal = 1;
                        break;
                    }
                    default: {
            ...
            if (_mv_645.has_value) {
                __auto_type pat_expr = _mv_645.value;
                {
                    ...
                    if ((!(string_eq(tag, SLOP_STR("")))) && (!(string_eq(tag, SLOP_STR("some")))) && (!(string_eq(tag, SLOP_STR("none")))) && (!(string_eq(tag, SLOP_STR("ok")))) && (!(string_eq(tag, SLOP_STR("error")))) && (!(string_eq(tag, SLOP_STR("else")))) && (!(string_eq(tag, SLOP_STR("_"))))) {
                        __auto_type _mv_646 = context_ctx_lookup_enum_variant(ctx, tag);
                        if (_mv_646.has_value) {
                            __auto_type _ = _mv_646.value;
                            has_union_variant = 1;
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_654.data.lst;
                {
                    ...
                    if (len < 3) {
                        ...
                        __auto_type _mv_655 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_655.has_value) {
                            __auto_type scrutinee = _mv_655.value;
                            {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_659.has_value) {
                __auto_type branch = _mv_659.value;
                __auto_type _mv_660 = (*branch);
                switch (_mv_660.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type branch_lst = _mv_660.data.lst;
                        {
                            __auto_type branch_items = branch_lst.items;
                            if (((int64_t)((branch_items).len)) >= 2) {
                                __auto_type _mv_661 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_661.has_value) {
                                    __auto_type pattern = _mv_661.value;
                                    {
...
void match_emit_option_some_branch(context_TranspileContext* ctx, slop_string scrutinee_c, types_SExpr* scrutinee_expr, types_SExpr* pattern, slop_list_types_SExpr_ptr branch_items, uint8_t is_return, uint8_t first) {
    ...
    SLOP_PRE(((pattern != NULL)), "(!= pattern nil)");
    {
        ...
        __auto_type _mv_662 = match_extract_binding_name(pattern);
        if (_mv_662.has_value) {
            __auto_type binding_name = _mv_662.value;
            {
...
void match_emit_result_ok_branch(context_TranspileContext* ctx, slop_string scrutinee_c, types_SExpr* scrutinee_expr, types_SExpr* pattern, slop_list_types_SExpr_ptr branch_items, uint8_t is_return, uint8_t first) {
    ...
    SLOP_PRE(((pattern != NULL)), "(!= pattern nil)");
    {
        ...
        context_ctx_indent(ctx);
        context_ctx_push_scope(ctx);
        __auto_type _mv_666 = match_extract_binding_name(pattern);
        if (_mv_666.has_value) {
            __auto_type binding_name = _mv_666.value;
            {
                __auto_type c_name = ctype_to_c_name(arena, binding_name);
...
void match_emit_result_error_branch(context_TranspileContext* ctx, slop_string scrutinee_c, types_SExpr* scrutinee_expr, types_SExpr* pattern, slop_list_types_SExpr_ptr branch_items, uint8_t is_return, uint8_t first) {
    ...
    SLOP_PRE(((pattern != NULL)), "(!= pattern nil)");
    {
        ...
        context_ctx_indent(ctx);
        context_ctx_push_scope(ctx);
        __auto_type _mv_667 = match_extract_binding_name(pattern);
        if (_mv_667.has_value) {
            __auto_type binding_name = _mv_667.value;
            {
                __auto_type c_name = ctype_to_c_name(arena, binding_name);
    ...
    SLOP_PRE(((pattern != NULL)), "(!= pattern nil)");
    {
        ...
        if (string_eq(tag, SLOP_STR("else")) || string_eq(tag, SLOP_STR("_"))) {
            ...
            if (_mv_671.has_value) {
                __auto_type type_name = _mv_671.value;
                {
                                        ...
                                        __auto_type pattern = _mv_677.value;
                                        {
                                            ...
                                            if (string_eq(tag, SLOP_STR("else")) || string_eq(tag, SLOP_STR("_"))) {
                                                ...
                                                if (_mv_678.has_value) {
                                                    __auto_type union_type_name = _mv_678.value;
    ...
    SLOP_PRE(((pattern != NULL)), "(!= pattern nil)");
    {
        ...
        context_ctx_push_scope(ctx);
        {
            ...
            if (!(string_eq(multi_field_count, SLOP_STR("")))) {
                __auto_type _mv_679 = (*pattern);
                switch (_mv_679.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type pat_lst = _mv_679.data.lst;
                        {
                            __auto_type pat_items = pat_lst.items;
                            __auto_type pat_len = ((int64_t)((pat_items).len));
                            for (int64_t bi = 1; bi < pat_len; bi++) {
                                __auto_type _mv_680 = ({ __auto_type _lst = pat_items; size_t _idx = (size_t)bi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_680.has_value) {
                                    __auto_type binding_expr = _mv_680.value;
                                    {
...
void match_emit_branch_body(context_TranspileContext* ctx, slop_list_types_SExpr_ptr branch_items, uint8_t is_return) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 1;
        while (i < len) {
            __auto_type _mv_682 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_682.has_value) {
                __auto_type body_expr = _mv_682.value;
                {
                ...
                __auto_type lst = _mv_683.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) < 1) {
                        ...
                        if (_mv_684.has_value) {
                            __auto_type head_expr = _mv_684.value;
                            __auto_type _mv_685 = (*head_expr);
                            switch (_mv_685.tag) {
                                case types_SExpr_sym:
                                {
...
void match_emit_inline_let(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items, uint8_t is_return, uint8_t is_last) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 2) {
            ...
            context_ctx_indent(ctx);
            context_ctx_push_scope(ctx);
            __auto_type _mv_686 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_686.has_value) {
                __auto_type bindings_expr = _mv_686.value;
            ...
            }
            {
                ...
                while (i < len) {
                    ...
                    if (_mv_687.has_value) {
                        __auto_type body_item = _mv_687.value;
                        {
...
void match_emit_inline_bindings(context_TranspileContext* ctx, types_SExpr* bindings_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_688 = (*bindings_expr);
        switch (_mv_688.tag) {
            case types_SExpr_lst:
            {
                __auto_type bindings_lst = _mv_688.data.lst;
                {
                    __auto_type bindings = bindings_lst.items;
                    __auto_type len = ((int64_t)((bindings).len));
                    __auto_type i = 0;
                    while (i < len) {
                        __auto_type _mv_689 = ({ __auto_type _lst = bindings; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_689.has_value) {
                            __auto_type binding = _mv_689.value;
...
void match_emit_single_inline_binding(context_TranspileContext* ctx, types_SExpr* binding) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_690 = (*binding);
        switch (_mv_690.tag) {
            case types_SExpr_lst:
            {
                __auto_type binding_lst = _mv_690.data.lst;
                {
                    ...
                    __auto_type len = ((int64_t)((items).len));
                    {
                        ...
                        if ((len - start_idx) < 2) {
                            ...
                            __auto_type _mv_691 = ({ __auto_type _lst = items; size_t _idx = (size_t)start_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            ...
                                            if ((len - start_idx) >= 3) {
                                                {
                                                    ...
                                                    __auto_type _mv_693 = ({ __auto_type _lst = items; size_t _idx = (size_t)type_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_693.has_value) {
                                                        __auto_type type_expr = _mv_693.value;
                                                        if (match_is_type_expr(type_expr)) {
                                                            __auto_type _mv_694 = ({ __auto_type _lst = items; size_t _idx = (size_t)val_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                            if (_mv_694.has_value) {
                                                                __auto_type val_expr = _mv_694.value;
                                                                {
                                                            ...
                                                            if (_mv_695.has_value) {
                                                                __auto_type val_expr = _mv_695.value;
                                                                {
                                                                    ...
                                                                    __auto_type _mv_696 = ptr_type_opt;
                                                                    if (_mv_696.has_value) {
                                                                        __auto_type ptr_type = _mv_696.value;
                                            ...
                                            } else {
                                                {
                                                    ...
                                                    __auto_type _mv_697 = ({ __auto_type _lst = items; size_t _idx = (size_t)val_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
uint8_t match_binding_starts_with_mut(slop_list_types_SExpr_ptr items) {
    if (((int64_t)((items).len)) < 1) {
        ...
        if (_mv_699.has_value) {
            __auto_type first = _mv_699.value;
            __auto_type _mv_700 = (*first);
            switch (_mv_700.tag) {
                case types_SExpr_sym:
                {
...
uint8_t match_is_type_expr(types_SExpr* expr) {
    ...
    switch (_mv_701.tag) {
        ...
        case types_SExpr_lst:
        {
            __auto_type _ = _mv_701.data.lst;
            return 1;
        }
        default: {
            return 0;
                ...
                __auto_type lst = _mv_705.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) >= 3) {
                        ...
                        if (_mv_706.has_value) {
                            __auto_type head_ptr = _mv_706.value;
                            __auto_type _mv_707 = (*head_ptr);
                            switch (_mv_707.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type head_sym = _mv_707.data.sym;
                                    if (string_eq(head_sym.name, SLOP_STR("arena-alloc"))) {
                                        ...
                                        if (_mv_708.has_value) {
                                            __auto_type size_expr = _mv_708.value;
        ...
        switch (_mv_709.tag) {
            case types_SExpr_sym:
            {
                __auto_type sym = _mv_709.data.sym;
                {
                    ...
                    __auto_type _mv_710 = context_ctx_lookup_type(ctx, type_name);
                    if (_mv_710.has_value) {
                        __auto_type entry = _mv_710.value;
                ...
                __auto_type lst = _mv_709.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) >= 2) {
                        ...
                        if (_mv_711.has_value) {
                            __auto_type head_ptr = _mv_711.value;
                            __auto_type _mv_712 = (*head_ptr);
                            switch (_mv_712.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type head_sym = _mv_712.data.sym;
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 3) {
            ...
            if (_mv_715.has_value) {
                __auto_type cond_expr = _mv_715.value;
                {
            ...
            if (_mv_716.has_value) {
                __auto_type then_expr = _mv_716.value;
            ...
            if (len >= 4) {
                context_ctx_emit(ctx, SLOP_STR("} else {"));
                context_ctx_indent(ctx);
                __auto_type _mv_717 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_717.has_value) {
                    __auto_type else_expr = _mv_717.value;
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 3) {
            ...
            if (_mv_718.has_value) {
                __auto_type cond_expr = _mv_718.value;
                {
                    __auto_type cond_c = context_ctx_strip_cond_parens(ctx, expr_transpile_expr(ctx, cond_expr));
...
slop_option_string match_get_var_c_type_inline(context_TranspileContext* ctx, types_SExpr* expr) {
    ...
    switch (_mv_719.tag) {
        case types_SExpr_sym:
        {
            ...
            {
                __auto_type name = sym.name;
                __auto_type _mv_720 = context_ctx_lookup_var(ctx, name);
                if (_mv_720.has_value) {
                    __auto_type var_entry = _mv_720.value;
                ...
                __auto_type lst = _mv_721.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) >= 2) {
                        ...
                        if (_mv_722.has_value) {
                            __auto_type head = _mv_722.value;
                            __auto_type _mv_723 = (*head);
                            switch (_mv_723.tag) {
                                case types_SExpr_sym:
                                {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (expr_set_is_self_assign(items)) {
            ...
            if (_mv_725.has_value) {
                ...
                if (_mv_726.has_value) {
                    ...
                    if (_mv_727.has_value) {
                        ...
                        __auto_type _mv_728 = ({ __auto_type _lst = items; size_t _idx = (size_t)4; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_728.has_value) {
                            __auto_type value_expr = _mv_728.value;
                            {
                                ...
                                __auto_type c_type = ctype_to_c_type(arena, type_expr);
                                {
                                    ...
                                    if (strlib_starts_with(c_type, SLOP_STR("slop_option_"))) {
                                        if (match_is_none_form_inline(value_expr)) {
                                            ...
                                            __auto_type _mv_729 = match_get_some_value_inline(value_expr);
                                            if (_mv_729.has_value) {
                                                __auto_type inner_val = _mv_729.value;
                                                {
            ...
            if (_mv_730.has_value) {
                __auto_type target_expr = _mv_730.value;
                ...
                if (_mv_731.has_value) {
                    __auto_type field_expr = _mv_731.value;
                    ...
                    if (_mv_732.has_value) {
                        __auto_type value_expr = _mv_732.value;
                        {
                            __auto_type field_name = match_get_field_name_inline(ctx, field_expr);
                ...
                if (_mv_734.has_value) {
                    __auto_type val_expr = _mv_734.value;
                    {
                        ...
                        if (_mv_735.has_value) {
                            ...
                            {
                                __auto_type some_val_opt = match_get_some_value_inline(val_expr);
                                __auto_type _mv_737 = some_val_opt;
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_742.data.lst;
            {
                ...
                if (_mv_743.has_value) {
                    __auto_type inner = _mv_743.value;
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 2) {
            ...
            if (_mv_745.has_value) {
                __auto_type cond_expr = _mv_745.value;
                {
                    __auto_type cond_c = context_ctx_strip_cond_parens(ctx, expr_transpile_expr(ctx, cond_expr));
                    context_ctx_emit(ctx, context_ctx_str3(ctx, SLOP_STR("if ("), cond_c, SLOP_STR(") {")));
                }
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_746.has_value) {
                __auto_type clause_expr = _mv_746.value;
                __auto_type _mv_747 = (*clause_expr);
                switch (_mv_747.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type clause_lst = _mv_747.data.lst;
                        {
                            ...
                            if (clause_len < 1) {
                                ...
                                __auto_type _mv_748 = ({ __auto_type _lst = clause_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_748.has_value) {
                                    __auto_type test_expr = _mv_748.value;
                                    __auto_type _mv_749 = (*test_expr);
                                    switch (_mv_749.tag) {
                                        case types_SExpr_sym:
                                        {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_750.has_value) {
                __auto_type body_expr = _mv_750.value;
                {
        ...
        if (len < 2) {
        ...
        } else {
            {
                ...
                if (is_named && (len < 4)) {
                    ...
                    context_ctx_indent(ctx);
                    context_ctx_push_scope(ctx);
                    __auto_type _mv_751 = ({ __auto_type _lst = items; size_t _idx = (size_t)size_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_753.has_value) {
                __auto_type body_expr = _mv_753.value;
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 2) {
            ...
            if (_mv_754.has_value) {
                __auto_type binding_expr = _mv_754.value;
                __auto_type _mv_755 = (*binding_expr);
                switch (_mv_755.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type binding_lst = _mv_755.data.lst;
                        {
                            ...
                            if (binding_len < 3) {
                                ...
                                __auto_type _mv_756 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_756.has_value) {
                                    __auto_type var_expr = _mv_756.value;
                                    __auto_type _mv_757 = (*var_expr);
                                    switch (_mv_757.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type var_sym = _mv_757.data.sym;
                                            {
                                                __auto_type var_name = ctype_to_c_name(arena, var_sym.name);
                                                __auto_type _mv_758 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_758.has_value) {
                                                    __auto_type start_expr = _mv_758.value;
                                                    __auto_type _mv_759 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_759.has_value) {
                                                        __auto_type end_expr = _mv_759.value;
                                                        {
...
void match_emit_inline_for_each_map_kv(context_TranspileContext* ctx, slop_list_types_SExpr_ptr binding_items, slop_list_types_SExpr_ptr items, int64_t len) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_760 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        if (_mv_760.has_value) {
            __auto_type kv_list_expr = _mv_760.value;
            __auto_type _mv_761 = (*kv_list_expr);
            switch (_mv_761.tag) {
                case types_SExpr_lst:
                {
                    __auto_type kv_lst = _mv_761.data.lst;
                    {
                        __auto_type kv_items = kv_lst.items;
                        if (((int64_t)((kv_items).len)) < 2) {
                            context_ctx_add_error(ctx, SLOP_STR("Map for-each needs ((k v) map)"));
                        } else {
                            __auto_type _mv_762 = ({ __auto_type _lst = kv_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_762.has_value) {
                                __auto_type k_expr = _mv_762.value;
                                __auto_type _mv_763 = ({ __auto_type _lst = kv_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_763.has_value) {
                                    __auto_type v_expr = _mv_763.value;
                                    ...
                                    if (_mv_764.has_value) {
                                        __auto_type map_expr = _mv_764.value;
                                        __auto_type _mv_765 = (*k_expr);
                                        switch (_mv_765.tag) {
                                            case types_SExpr_sym:
                                            {
                                                __auto_type k_sym = _mv_765.data.sym;
                                                __auto_type _mv_766 = (*v_expr);
                                                switch (_mv_766.tag) {
                                                    case types_SExpr_sym:
                                                    {
                                                        __auto_type v_sym = _mv_766.data.sym;
                                                        {
                    ...
                    case types_SExpr_lst:
                    {
                        __auto_type binding_lst = _mv_768.data.lst;
                        {
                            ...
                            if (binding_len < 2) {
                                ...
                                __auto_type _mv_769 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_769.has_value) {
                                    __auto_type first_elem = _mv_769.value;
                                    __auto_type _mv_770 = (*first_elem);
                                    switch (_mv_770.tag) {
                                        case types_SExpr_lst:
                                        {
                                            __auto_type _ = _mv_770.data.lst;
...
void match_emit_inline_return(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 2) {
            ...
            __auto_type _mv_772 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_772.has_value) {
                __auto_type val_expr = _mv_772.value;
                            ...
                            case types_SExpr_sym:
                            {
                                __auto_type sym = _mv_775.data.sym;
                                {
                                    ...
                                    if (string_eq(op, SLOP_STR("some"))) {
                                        __auto_type _mv_776 = context_ctx_get_current_return_type(ctx);
                                        if (_mv_776.has_value) {
                                            __auto_type ret_type = _mv_776.value;
                                            if (strlib_starts_with(ret_type, SLOP_STR("slop_option_"))) {
                                                if (((int64_t)((items).len)) < 2) {
                                                    match_emit_return_typed(ctx, expr_transpile_expr(ctx, expr));
                                                } else {
                                                    ...
                                                    if (_mv_777.has_value) {
                                                        __auto_type inner_expr = _mv_777.value;
                                                        {
                                                            __auto_type inner_c = expr_transpile_expr(ctx, inner_expr);
...
uint8_t match_is_pattern_literal(types_SExpr* expr) {
    ...
    switch (_mv_779.tag) {
        ...
        case types_SExpr_num:
        {
            __auto_type _ = _mv_779.data.num;
            return 1;
        }
        default: {
            return 0;
...
slop_string match_pattern_literal_to_c(types_SExpr* expr) {
    ...
    switch (_mv_780.tag) {
        ...
        case types_SExpr_num:
        {
            __auto_type n = _mv_780.data.num;
            return n.raw;
        }
        default: {
            return SLOP_STR("");
                ...
                for (int64_t i = 1; i < len; i++) {
                    if (!(found)) {
                        ...
                        if (_mv_782.has_value) {
                            __auto_type item = _mv_782.value;
...
uint8_t match_has_literal_in_patterns(slop_list_types_SExpr_ptr patterns) {
    {
        ...
        int64_t i = 0;
        while ((i < len) && !(found)) {
            __auto_type _mv_783 = ({ __auto_type _lst = patterns; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_783.has_value) {
                __auto_type pat_expr = _mv_783.value;
...
slop_string match_build_literal_guard_cond(context_TranspileContext* ctx, slop_string scrutinee_c, slop_string c_tag, slop_string tag_cond, types_SExpr* pattern, uint8_t is_multi) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_784 = (*pattern);
        switch (_mv_784.tag) {
            case types_SExpr_lst:
            {
                __auto_type pat_lst = _mv_784.data.lst;
                {
                    __auto_type pat_items = pat_lst.items;
                    __auto_type pat_len = ((int64_t)((pat_items).len));
                    __auto_type cond = tag_cond;
                    for (int64_t bi = 1; bi < pat_len; bi++) {
                        __auto_type _mv_785 = ({ __auto_type _lst = pat_items; size_t _idx = (size_t)bi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_785.has_value) {
                            __auto_type item = _mv_785.value;
                            if (match_is_pattern_literal(item)) {
                                {
...
void match_emit_union_literal_bindings(context_TranspileContext* ctx, slop_string scrutinee_c, types_SExpr* pattern, slop_string tag, slop_string union_type_name, slop_string c_tag, uint8_t is_multi) {
    ...
    SLOP_PRE(((pattern != NULL)), "(!= pattern nil)");
    {
        ...
        if (is_multi) {
            ...
            __auto_type _mv_788 = match_extract_binding_name(pattern);
            if (_mv_788.has_value) {
                __auto_type binding_name = _mv_788.value;
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_789.has_value) {
                __auto_type branch = _mv_789.value;
                __auto_type _mv_790 = (*branch);
                switch (_mv_790.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type branch_lst = _mv_790.data.lst;
                        {
                            __auto_type branch_items = branch_lst.items;
                            if (((int64_t)((branch_items).len)) >= 2) {
                                __auto_type _mv_791 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_791.has_value) {
                                    __auto_type pattern = _mv_791.value;
                                    {
                                        __auto_type tag = match_get_pattern_tag(pattern);
                                        if (string_eq(tag, SLOP_STR("else")) || string_eq(tag, SLOP_STR("_"))) {
                                            if (first) {
                                            ...
                                            __auto_type _mv_792 = context_ctx_lookup_enum_variant(ctx, tag);
                                            if (_mv_792.has_value) {
                                                __auto_type union_type_name = _mv_792.value;
                                                {
                                                    __auto_type c_tag = ctype_to_c_name(arena, tag);
