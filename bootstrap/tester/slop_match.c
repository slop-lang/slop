        ...
        while ((i < len) && all_symbols) {
            ...
            if (_mv_652.has_value) {
                ...
                switch (_mv_653.tag) {
                    ...
                    {
                        __auto_type _ = _mv_653.data.sym;
                        break;
                    }
                    default: {
                        all_symbols = 0;
        ...
        while ((i < len) && !(has_literal)) {
            ...
            if (_mv_654.has_value) {
                ...
                switch (_mv_655.tag) {
                    ...
                    {
                        __auto_type _ = _mv_655.data.num;
                        has_literal = 1;
                        break;
                    }
                    case types_SExpr_str:
                    {
                        __auto_type _ = _mv_655.data.str;
                        has_literal = 1;
                        break;
                    }
                    default: {
            ...
            if (_mv_656.has_value) {
                __auto_type pat_expr = _mv_656.value;
                {
                    ...
                    if ((!(string_eq(tag, SLOP_STR("")))) && (!(string_eq(tag, SLOP_STR("some")))) && (!(string_eq(tag, SLOP_STR("none")))) && (!(string_eq(tag, SLOP_STR("ok")))) && (!(string_eq(tag, SLOP_STR("error")))) && (!(string_eq(tag, SLOP_STR("else")))) && (!(string_eq(tag, SLOP_STR("_"))))) {
                        __auto_type _mv_657 = context_ctx_lookup_enum_variant(ctx, tag);
                        if (_mv_657.has_value) {
                            __auto_type _ = _mv_657.value;
                            has_union_variant = 1;
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_658.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 1) {
                    ...
                    __auto_type _mv_659 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_659.has_value) {
                        __auto_type head = _mv_659.value;
                        __auto_type _mv_660 = (*head);
                        switch (_mv_660.tag) {
                            case types_SExpr_sym:
                            {
            ...
            __auto_type lst = _mv_661.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 2) {
                    ...
                    if (_mv_662.has_value) {
                        __auto_type binding = _mv_662.value;
                        __auto_type _mv_663 = (*binding);
                        switch (_mv_663.tag) {
                            case types_SExpr_sym:
                            {
                ...
                __auto_type lst = _mv_665.data.lst;
                {
                    ...
                    if (len < 3) {
                        ...
                        if (_mv_666.has_value) {
                            __auto_type scrutinee = _mv_666.value;
                            {
    ...
    SLOP_PRE(((pattern != NULL)), "(!= pattern nil)");
    {
        ...
        if (string_eq(tag, SLOP_STR("else")) || string_eq(tag, SLOP_STR("_"))) {
            ...
            if (_mv_682.has_value) {
                __auto_type type_name = _mv_682.value;
                {
                                    ...
                                    if (_mv_688.has_value) {
                                        __auto_type pattern = _mv_688.value;
                                        {
                                            ...
                                            if (string_eq(tag, SLOP_STR("else")) || string_eq(tag, SLOP_STR("_"))) {
                                                ...
                                                __auto_type _mv_689 = context_ctx_lookup_enum_variant(ctx, tag);
                                                if (_mv_689.has_value) {
                                                    __auto_type union_type_name = _mv_689.value;
    ...
    SLOP_PRE(((pattern != NULL)), "(!= pattern nil)");
    {
        ...
        context_ctx_push_scope(ctx);
        {
            ...
            if (!(string_eq(multi_field_count, SLOP_STR("")))) {
                __auto_type _mv_690 = (*pattern);
                switch (_mv_690.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type pat_lst = _mv_690.data.lst;
                        {
                            __auto_type pat_items = pat_lst.items;
                            __auto_type pat_len = ((int64_t)((pat_items).len));
                            for (int64_t bi = 1; bi < pat_len; bi++) {
                                __auto_type _mv_691 = ({ __auto_type _lst = pat_items; size_t _idx = (size_t)bi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_691.has_value) {
                                    __auto_type binding_expr = _mv_691.value;
                                    {
                ...
                __auto_type _mv_692 = match_extract_binding_name(pattern);
                if (_mv_692.has_value) {
                    __auto_type binding_name = _mv_692.value;
                    {
                        __auto_type c_binding = ctype_to_c_name(arena, binding_name);
...
void match_emit_branch_body(context_TranspileContext* ctx, slop_list_types_SExpr_ptr branch_items, uint8_t is_return) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 1;
        while (i < len) {
            __auto_type _mv_693 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_693.has_value) {
                __auto_type body_expr = _mv_693.value;
                {
                ...
                __auto_type lst = _mv_694.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) < 1) {
                        ...
                        if (_mv_695.has_value) {
                            __auto_type head_expr = _mv_695.value;
                            __auto_type _mv_696 = (*head_expr);
                            switch (_mv_696.tag) {
                                case types_SExpr_sym:
                                {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 2) {
            ...
            if (_mv_697.has_value) {
                __auto_type bindings_expr = _mv_697.value;
            ...
            }
            {
                ...
                while (i < len) {
                    ...
                    if (_mv_698.has_value) {
                        __auto_type body_item = _mv_698.value;
                        {
...
void match_emit_inline_bindings(context_TranspileContext* ctx, types_SExpr* bindings_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_699 = (*bindings_expr);
        switch (_mv_699.tag) {
            case types_SExpr_lst:
            {
                __auto_type bindings_lst = _mv_699.data.lst;
                {
                    __auto_type bindings = bindings_lst.items;
                    __auto_type len = ((int64_t)((bindings).len));
                    __auto_type i = 0;
                    while (i < len) {
                        __auto_type _mv_700 = ({ __auto_type _lst = bindings; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_700.has_value) {
                            __auto_type binding = _mv_700.value;
...
void match_emit_single_inline_binding(context_TranspileContext* ctx, types_SExpr* binding) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_701 = (*binding);
        switch (_mv_701.tag) {
            case types_SExpr_lst:
            {
                __auto_type binding_lst = _mv_701.data.lst;
                {
                    ...
                    __auto_type len = ((int64_t)((items).len));
                    {
                        ...
                        if ((len - start_idx) < 2) {
                            ...
                            __auto_type _mv_702 = ({ __auto_type _lst = items; size_t _idx = (size_t)start_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_702.has_value) {
                                __auto_type name_expr = _mv_702.value;
                                __auto_type _mv_703 = (*name_expr);
                                switch (_mv_703.tag) {
                                    case types_SExpr_sym:
                                    {
                                        __auto_type name_sym = _mv_703.data.sym;
                                        {
                                            ...
                                            if ((len - start_idx) >= 3) {
                                                {
                                                    ...
                                                    __auto_type _mv_704 = ({ __auto_type _lst = items; size_t _idx = (size_t)type_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_704.has_value) {
                                                        __auto_type type_expr = _mv_704.value;
                                                        if (match_is_type_expr(type_expr)) {
                                                            ...
                                                            __auto_type _mv_706 = ({ __auto_type _lst = items; size_t _idx = (size_t)type_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                            if (_mv_706.has_value) {
                                                                __auto_type val_expr = _mv_706.value;
                                                                {
                                                                    ...
                                                                    __auto_type _mv_707 = ptr_type_opt;
                                                                    if (_mv_707.has_value) {
                                                                        __auto_type ptr_type = _mv_707.value;
                                            ...
                                            } else {
                                                {
                                                    ...
                                                    __auto_type _mv_708 = ({ __auto_type _lst = items; size_t _idx = (size_t)val_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_708.has_value) {
                                                        __auto_type val_expr = _mv_708.value;
                                                        {
                                                            ...
                                                            __auto_type inferred_slop_type = expr_infer_expr_slop_type(ctx, val_expr);
                                                            __auto_type ptr_type_opt = match_get_arena_alloc_ptr_type_inline(ctx, val_expr);
                                                            __auto_type _mv_709 = ptr_type_opt;
                                                            if (_mv_709.has_value) {
                                                                __auto_type ptr_type = _mv_709.value;
                                                                context_ctx_emit(ctx, context_ctx_str4(ctx, SLOP_STR("__auto_type "), c_name, SLOP_STR(" = "), context_ctx_str(ctx, val_c, SLOP_STR(";"))));
                                                                context_ctx_bind_var(ctx, (context_VarEntry){raw_name, c_name, ptr_type, inferred_slop_type, 1, has_mut, 0, SLOP_STR(""), SLOP_STR("")});
...
uint8_t match_binding_starts_with_mut(slop_list_types_SExpr_ptr items) {
    if (((int64_t)((items).len)) < 1) {
        ...
        if (_mv_710.has_value) {
            __auto_type first = _mv_710.value;
            __auto_type _mv_711 = (*first);
            switch (_mv_711.tag) {
                case types_SExpr_sym:
                {
...
uint8_t match_is_type_expr(types_SExpr* expr) {
    ...
    switch (_mv_712.tag) {
        ...
        case types_SExpr_lst:
        {
            __auto_type _ = _mv_712.data.lst;
            return 1;
        }
        default: {
            return 0;
                                ...
                                case types_SExpr_sym:
                                {
                                    ...
                                    if (string_eq(head_sym.name, SLOP_STR("arena-alloc"))) {
                                        ...
                                        if (_mv_719.has_value) {
                                            __auto_type size_expr = _mv_719.value;
        ...
        switch (_mv_720.tag) {
            case types_SExpr_sym:
            {
                __auto_type sym = _mv_720.data.sym;
                {
                    ...
                    __auto_type _mv_721 = context_ctx_lookup_type(ctx, type_name);
                    if (_mv_721.has_value) {
                        __auto_type entry = _mv_721.value;
                                ...
                                case types_SExpr_sym:
                                {
                                    ...
                                    if (string_eq(head_sym.name, SLOP_STR("sizeof"))) {
                                        ...
                                        if (_mv_724.has_value) {
                                            __auto_type type_expr = _mv_724.value;
                                            {
                                                __auto_type c_type = context_to_c_type_prefixed(ctx, type_expr);
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_725.has_value) {
                __auto_type item = _mv_725.value;
                {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 3) {
            ...
            if (_mv_727.has_value) {
                __auto_type then_expr = _mv_727.value;
            ...
            if (len >= 4) {
                context_ctx_emit(ctx, SLOP_STR("} else {"));
                context_ctx_indent(ctx);
                __auto_type _mv_728 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_728.has_value) {
                    __auto_type else_expr = _mv_728.value;
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 3) {
            ...
            if (_mv_729.has_value) {
                __auto_type cond_expr = _mv_729.value;
                {
                    __auto_type cond_c = context_ctx_strip_cond_parens(ctx, expr_transpile_expr(ctx, cond_expr));
...
slop_option_string match_get_var_c_type_inline(context_TranspileContext* ctx, types_SExpr* expr) {
    ...
    switch (_mv_730.tag) {
        case types_SExpr_sym:
        {
            ...
            {
                __auto_type name = sym.name;
                __auto_type _mv_731 = context_ctx_lookup_var(ctx, name);
                if (_mv_731.has_value) {
                    __auto_type var_entry = _mv_731.value;
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (expr_set_is_self_assign(items)) {
            ...
            if (_mv_736.has_value) {
                ...
                if (_mv_737.has_value) {
                    ...
                    if (_mv_738.has_value) {
                        ...
                        __auto_type _mv_739 = ({ __auto_type _lst = items; size_t _idx = (size_t)4; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                ...
                                __auto_type c_type = ctype_to_c_type(arena, type_expr);
                                {
                                    ...
                                    if (strlib_starts_with(c_type, SLOP_STR("slop_option_"))) {
                                        if (match_is_none_form_inline(value_expr)) {
                                            ...
                                            __auto_type _mv_740 = match_get_some_value_inline(value_expr);
            ...
            if (_mv_744.has_value) {
                __auto_type target_expr = _mv_744.value;
                ...
                if (_mv_745.has_value) {
                    __auto_type val_expr = _mv_745.value;
                    {
                        __auto_type target_c = expr_transpile_expr(ctx, target_expr);
                        __auto_type target_type_opt = match_get_var_c_type_inline(ctx, target_expr);
                        __auto_type _mv_746 = target_type_opt;
                        if (_mv_746.has_value) {
                            __auto_type target_type = _mv_746.value;
                        ...
                        } else if (!_mv_746.has_value) {
                            {
                                ...
                                if (_mv_748.has_value) {
                                    ...
                                    if (match_is_none_form_inline(val_expr)) {
                                        __auto_type _mv_749 = context_ctx_get_current_return_type(ctx);
                                        if (_mv_749.has_value) {
                                            __auto_type ret_type = _mv_749.value;
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_753.data.lst;
            {
                ...
                if (_mv_754.has_value) {
                    __auto_type inner = _mv_754.value;
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 2) {
            ...
            if (_mv_756.has_value) {
                __auto_type cond_expr = _mv_756.value;
                {
                    __auto_type cond_c = context_ctx_strip_cond_parens(ctx, expr_transpile_expr(ctx, cond_expr));
                    context_ctx_emit(ctx, context_ctx_str3(ctx, SLOP_STR("if ("), cond_c, SLOP_STR(") {")));
                }
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_757.has_value) {
                __auto_type clause_expr = _mv_757.value;
                __auto_type _mv_758 = (*clause_expr);
                switch (_mv_758.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type clause_lst = _mv_758.data.lst;
                        {
                            ...
                            if (clause_len < 1) {
                                ...
                                __auto_type _mv_759 = ({ __auto_type _lst = clause_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_759.has_value) {
                                    __auto_type test_expr = _mv_759.value;
                                    __auto_type _mv_760 = (*test_expr);
                                    switch (_mv_760.tag) {
                                        case types_SExpr_sym:
                                        {
        ...
        if (len < 2) {
        ...
        } else {
            {
                ...
                if (is_named && (len < 4)) {
                    ...
                    context_ctx_indent(ctx);
                    context_ctx_push_scope(ctx);
                    __auto_type _mv_762 = ({ __auto_type _lst = items; size_t _idx = (size_t)size_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_762.has_value) {
                        __auto_type size_expr = _mv_762.value;
                        {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 2) {
            ...
            if (_mv_765.has_value) {
                __auto_type binding_expr = _mv_765.value;
                __auto_type _mv_766 = (*binding_expr);
                switch (_mv_766.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type binding_lst = _mv_766.data.lst;
                        {
                            ...
                            if (binding_len < 3) {
                                ...
                                if (_mv_767.has_value) {
                                    __auto_type var_expr = _mv_767.value;
                                    __auto_type _mv_768 = (*var_expr);
                                    switch (_mv_768.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type var_sym = _mv_768.data.sym;
                                            {
                                                __auto_type var_name = ctype_to_c_name(arena, var_sym.name);
                                                __auto_type _mv_769 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_769.has_value) {
                                                    __auto_type start_expr = _mv_769.value;
                                                    __auto_type _mv_770 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_770.has_value) {
                                                        __auto_type end_expr = _mv_770.value;
                                                        {
...
void match_emit_inline_for_each_map_kv(context_TranspileContext* ctx, slop_list_types_SExpr_ptr binding_items, slop_list_types_SExpr_ptr items, int64_t len) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (_mv_771.has_value) {
            __auto_type kv_list_expr = _mv_771.value;
            __auto_type _mv_772 = (*kv_list_expr);
            switch (_mv_772.tag) {
                case types_SExpr_lst:
                {
                    __auto_type kv_lst = _mv_772.data.lst;
                    {
                        __auto_type kv_items = kv_lst.items;
                        if (((int64_t)((kv_items).len)) < 2) {
                            context_ctx_add_error(ctx, SLOP_STR("Map for-each needs ((k v) map)"));
                        } else {
                            __auto_type _mv_773 = ({ __auto_type _lst = kv_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_773.has_value) {
                                __auto_type k_expr = _mv_773.value;
                                __auto_type _mv_774 = ({ __auto_type _lst = kv_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_774.has_value) {
                                    __auto_type v_expr = _mv_774.value;
                                    ...
                                    if (_mv_775.has_value) {
                                        __auto_type map_expr = _mv_775.value;
                                        __auto_type _mv_776 = (*k_expr);
                                        switch (_mv_776.tag) {
                                            case types_SExpr_sym:
                                            {
                                                __auto_type k_sym = _mv_776.data.sym;
                                                __auto_type _mv_777 = (*v_expr);
                                                switch (_mv_777.tag) {
                                                    case types_SExpr_sym:
                                                    {
                                                        __auto_type v_sym = _mv_777.data.sym;
                                                        {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 2) {
            ...
            if (_mv_778.has_value) {
                ...
                __auto_type _mv_779 = (*binding_expr);
                switch (_mv_779.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type binding_lst = _mv_779.data.lst;
                        {
                            __auto_type binding_items = binding_lst.items;
                            __auto_type binding_len = ((int64_t)((binding_items).len));
                            if (binding_len < 2) {
                                ...
                                if (_mv_780.has_value) {
                                    __auto_type first_elem = _mv_780.value;
                                    __auto_type _mv_781 = (*first_elem);
                                    switch (_mv_781.tag) {
                                        case types_SExpr_lst:
                                        {
                                        ...
                                        case types_SExpr_sym:
                                        {
                                            __auto_type var_sym = _mv_781.data.sym;
                                            {
                                                __auto_type var_name = ctype_to_c_name(arena, var_sym.name);
                                                __auto_type _mv_782 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_782.has_value) {
                                                    __auto_type coll_expr = _mv_782.value;
                                                    {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 2) {
            ...
            if (_mv_783.has_value) {
                __auto_type val_expr = _mv_783.value;
...
void match_emit_typed_return_expr(context_TranspileContext* ctx, types_SExpr* expr) {
    ...
    switch (_mv_784.tag) {
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_784.data.lst;
            {
                __auto_type items = lst.items;
                if (((int64_t)((items).len)) < 1) {
                    match_emit_return_typed(ctx, expr_transpile_expr(ctx, expr));
                } else {
                    __auto_type _mv_785 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_785.has_value) {
                        __auto_type head = _mv_785.value;
                        __auto_type _mv_786 = (*head);
                        switch (_mv_786.tag) {
                            case types_SExpr_sym:
                            {
                                __auto_type sym = _mv_786.data.sym;
                                {
                                    ...
                                    if (string_eq(op, SLOP_STR("some"))) {
                                        __auto_type _mv_787 = context_ctx_get_current_return_type(ctx);
                                        if (_mv_787.has_value) {
                                            __auto_type ret_type = _mv_787.value;
                                            if (strlib_starts_with(ret_type, SLOP_STR("slop_option_"))) {
                                                if (((int64_t)((items).len)) < 2) {
                                                    match_emit_return_typed(ctx, expr_transpile_expr(ctx, expr));
                                                } else {
                                                    ...
                                                    if (_mv_788.has_value) {
                                                        __auto_type inner_expr = _mv_788.value;
                                                        {
                                                            __auto_type inner_c = expr_transpile_expr(ctx, inner_expr);
                                        ...
                                        __auto_type _mv_789 = context_ctx_get_current_return_type(ctx);
                                        if (_mv_789.has_value) {
                                            __auto_type ret_type = _mv_789.value;
                                            if (strlib_starts_with(ret_type, SLOP_STR("slop_option_"))) {
...
uint8_t match_is_pattern_literal(types_SExpr* expr) {
    ...
    switch (_mv_790.tag) {
        ...
        case types_SExpr_num:
        {
            __auto_type _ = _mv_790.data.num;
            return 1;
        }
        default: {
            return 0;
...
slop_string match_pattern_literal_to_c(types_SExpr* expr) {
    ...
    switch (_mv_791.tag) {
        ...
        case types_SExpr_num:
        {
            __auto_type n = _mv_791.data.num;
            return n.raw;
        }
        default: {
            return SLOP_STR("");
...
uint8_t match_has_literal_in_patterns(slop_list_types_SExpr_ptr patterns) {
    {
        ...
        int64_t i = 0;
        while ((i < len) && !(found)) {
            __auto_type _mv_794 = ({ __auto_type _lst = patterns; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_794.has_value) {
                __auto_type pat_expr = _mv_794.value;
...
slop_string match_build_literal_guard_cond(context_TranspileContext* ctx, slop_string scrutinee_c, slop_string c_tag, slop_string tag_cond, types_SExpr* pattern, uint8_t is_multi) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_795 = (*pattern);
        switch (_mv_795.tag) {
            case types_SExpr_lst:
            {
                __auto_type pat_lst = _mv_795.data.lst;
                {
                    __auto_type pat_items = pat_lst.items;
                    __auto_type pat_len = ((int64_t)((pat_items).len));
                    __auto_type cond = tag_cond;
                    for (int64_t bi = 1; bi < pat_len; bi++) {
                        __auto_type _mv_796 = ({ __auto_type _lst = pat_items; size_t _idx = (size_t)bi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_796.has_value) {
                            __auto_type item = _mv_796.value;
                            if (match_is_pattern_literal(item)) {
                                {
...
void match_emit_union_literal_bindings(context_TranspileContext* ctx, slop_string scrutinee_c, types_SExpr* pattern, slop_string tag, slop_string union_type_name, slop_string c_tag, uint8_t is_multi) {
    ...
    SLOP_PRE(((pattern != NULL)), "(!= pattern nil)");
    {
        __auto_type arena = (*ctx).arena;
        if (is_multi) {
            __auto_type _mv_797 = (*pattern);
            switch (_mv_797.tag) {
                case types_SExpr_lst:
                {
                    __auto_type pat_lst = _mv_797.data.lst;
                    {
                        __auto_type pat_items = pat_lst.items;
                        __auto_type pat_len = ((int64_t)((pat_items).len));
                        for (int64_t bi = 1; bi < pat_len; bi++) {
                            __auto_type _mv_798 = ({ __auto_type _lst = pat_items; size_t _idx = (size_t)bi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_798.has_value) {
                                __auto_type binding_expr = _mv_798.value;
            ...
            __auto_type _mv_799 = match_extract_binding_name(pattern);
            if (_mv_799.has_value) {
                __auto_type binding_name = _mv_799.value;
...
void match_transpile_union_match_with_literals(context_TranspileContext* ctx, slop_string scrutinee_c, slop_list_types_SExpr_ptr patterns, slop_list_types_SExpr_ptr items, uint8_t is_return) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        uint8_t has_else = 0;
        while (i < len) {
            __auto_type _mv_800 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_800.has_value) {
                __auto_type branch = _mv_800.value;
                __auto_type _mv_801 = (*branch);
                switch (_mv_801.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type branch_lst = _mv_801.data.lst;
                        {
                            __auto_type branch_items = branch_lst.items;
                            if (((int64_t)((branch_items).len)) >= 2) {
                                __auto_type _mv_802 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_802.has_value) {
                                    __auto_type pattern = _mv_802.value;
                                    {
                                        __auto_type tag = match_get_pattern_tag(pattern);
                                        if (string_eq(tag, SLOP_STR("else")) || string_eq(tag, SLOP_STR("_"))) {
                                            has_else = 1;
                                            ...
                                            __auto_type _mv_803 = context_ctx_lookup_enum_variant(ctx, tag);
                                            if (_mv_803.has_value) {
                                                __auto_type union_type_name = _mv_803.value;
                                                {
                                                    __auto_type c_tag = ctype_to_c_name(arena, tag);
