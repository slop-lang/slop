...
uint8_t match_is_option_match(slop_list_types_SExpr_ptr patterns) {
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_641 = ({ __auto_type _lst = patterns; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_641.has_value) {
                __auto_type pat_expr = _mv_641.value;
                {
...
uint8_t match_is_result_match(slop_list_types_SExpr_ptr patterns) {
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_642 = ({ __auto_type _lst = patterns; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_642.has_value) {
                __auto_type pat_expr = _mv_642.value;
                {
                    __auto_type tag = match_get_pattern_tag(pat_expr);
...
uint8_t match_is_enum_match(slop_list_types_SExpr_ptr patterns) {
    {
        ...
        while ((i < len) && all_symbols) {
            __auto_type _mv_643 = ({ __auto_type _lst = patterns; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_643.has_value) {
                __auto_type pat_expr = _mv_643.value;
                __auto_type _mv_644 = (*pat_expr);
                switch (_mv_644.tag) {
                    case types_SExpr_sym:
                    {
                        __auto_type _ = _mv_644.data.sym;
                        break;
                    }
                    default: {
                        all_symbols = 0;
...
uint8_t match_is_literal_match(slop_list_types_SExpr_ptr patterns) {
    {
        ...
        while ((i < len) && !(has_literal)) {
            __auto_type _mv_645 = ({ __auto_type _lst = patterns; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_645.has_value) {
                __auto_type pat_expr = _mv_645.value;
                __auto_type _mv_646 = (*pat_expr);
                switch (_mv_646.tag) {
                    case types_SExpr_num:
                    {
                        __auto_type _ = _mv_646.data.num;
                        has_literal = 1;
                        break;
                    }
                    case types_SExpr_str:
                    {
                        __auto_type _ = _mv_646.data.str;
                        has_literal = 1;
                        break;
                    }
                    default: {
            ...
            if (_mv_647.has_value) {
                __auto_type pat_expr = _mv_647.value;
                {
                    ...
                    if ((!(string_eq(tag, SLOP_STR("")))) && (!(string_eq(tag, SLOP_STR("some")))) && (!(string_eq(tag, SLOP_STR("none")))) && (!(string_eq(tag, SLOP_STR("ok")))) && (!(string_eq(tag, SLOP_STR("error")))) && (!(string_eq(tag, SLOP_STR("else")))) && (!(string_eq(tag, SLOP_STR("_"))))) {
                        __auto_type _mv_648 = context_ctx_lookup_enum_variant(ctx, tag);
                        if (_mv_648.has_value) {
                            __auto_type _ = _mv_648.value;
                            has_union_variant = 1;
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_649.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 1) {
                    ...
                    __auto_type _mv_650 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_650.has_value) {
                        __auto_type head = _mv_650.value;
                        __auto_type _mv_651 = (*head);
                        switch (_mv_651.tag) {
                            case types_SExpr_sym:
                            {
                                __auto_type sym = _mv_651.data.sym;
                                return sym.name;
                            }
                            default: {
                                return SLOP_STR("");
                ...
                __auto_type lst = _mv_656.data.lst;
                {
                    ...
                    if (len < 3) {
                        ...
                        if (_mv_657.has_value) {
                            __auto_type scrutinee = _mv_657.value;
                            {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_658.has_value) {
                __auto_type branch = _mv_658.value;
                __auto_type _mv_659 = (*branch);
                switch (_mv_659.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type branch_lst = _mv_659.data.lst;
                        {
                            __auto_type branch_items = branch_lst.items;
                            if (((int64_t)((branch_items).len)) >= 1) {
                                __auto_type _mv_660 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_660.has_value) {
                                    __auto_type pattern = _mv_660.value;
...
void match_emit_result_ok_branch(context_TranspileContext* ctx, slop_string scrutinee_c, types_SExpr* scrutinee_expr, types_SExpr* pattern, slop_list_types_SExpr_ptr branch_items, uint8_t is_return, uint8_t first) {
    ...
    SLOP_PRE(((pattern != NULL)), "(!= pattern nil)");
    {
        ...
        context_ctx_indent(ctx);
        context_ctx_push_scope(ctx);
        __auto_type _mv_668 = match_extract_binding_name(pattern);
        if (_mv_668.has_value) {
            __auto_type binding_name = _mv_668.value;
            {
                __auto_type c_name = ctype_to_c_name(arena, binding_name);
...
void match_emit_enum_case(context_TranspileContext* ctx, types_SExpr* pattern, slop_list_types_SExpr_ptr branch_items, uint8_t is_return) {
    ...
    SLOP_PRE(((pattern != NULL)), "(!= pattern nil)");
    {
        ...
        if (string_eq(tag, SLOP_STR("else")) || string_eq(tag, SLOP_STR("_"))) {
            ...
            __auto_type _mv_673 = context_ctx_lookup_enum_variant(ctx, tag);
            if (_mv_673.has_value) {
                __auto_type type_name = _mv_673.value;
                {
...
void match_transpile_union_match(context_TranspileContext* ctx, slop_string scrutinee_c, slop_list_types_SExpr_ptr patterns, slop_list_types_SExpr_ptr items, uint8_t is_return) {
    ...
    if (match_has_literal_in_patterns(patterns)) {
    ...
    } else {
        {
            ...
            context_ctx_indent(ctx);
            while (i < len) {
                __auto_type _mv_677 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_677.has_value) {
                    __auto_type branch = _mv_677.value;
                    __auto_type _mv_678 = (*branch);
                    switch (_mv_678.tag) {
                        case types_SExpr_lst:
                        {
                            __auto_type branch_lst = _mv_678.data.lst;
                            {
                                __auto_type branch_items = branch_lst.items;
                                if (((int64_t)((branch_items).len)) >= 2) {
                                    __auto_type _mv_679 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    if (_mv_679.has_value) {
                                        __auto_type pattern = _mv_679.value;
                                        {
                                            __auto_type tag = match_get_pattern_tag(pattern);
                                            if (string_eq(tag, SLOP_STR("else")) || string_eq(tag, SLOP_STR("_"))) {
                                                context_ctx_emit(ctx, SLOP_STR("default: {"));
                                                ...
                                                if (_mv_680.has_value) {
                                                    __auto_type union_type_name = _mv_680.value;
    ...
    SLOP_PRE(((pattern != NULL)), "(!= pattern nil)");
    {
        ...
        context_ctx_push_scope(ctx);
        {
            ...
            if (!(string_eq(multi_field_count, SLOP_STR("")))) {
                __auto_type _mv_681 = (*pattern);
                switch (_mv_681.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type pat_lst = _mv_681.data.lst;
                        {
                            __auto_type pat_items = pat_lst.items;
                            __auto_type pat_len = ((int64_t)((pat_items).len));
                            for (int64_t bi = 1; bi < pat_len; bi++) {
                                __auto_type _mv_682 = ({ __auto_type _lst = pat_items; size_t _idx = (size_t)bi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_682.has_value) {
                                    __auto_type binding_expr = _mv_682.value;
                                    {
...
void match_emit_branch_body(context_TranspileContext* ctx, slop_list_types_SExpr_ptr branch_items, uint8_t is_return) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 1;
        while (i < len) {
            __auto_type _mv_684 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_684.has_value) {
                __auto_type body_expr = _mv_684.value;
                {
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_685.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) < 1) {
                        ...
                        __auto_type _mv_686 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_686.has_value) {
                            __auto_type head_expr = _mv_686.value;
                            __auto_type _mv_687 = (*head_expr);
                            switch (_mv_687.tag) {
                                case types_SExpr_sym:
                                {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 2) {
            ...
            if (_mv_688.has_value) {
                __auto_type bindings_expr = _mv_688.value;
            ...
            }
            {
                int64_t i = 2;
                while (i < len) {
                    __auto_type _mv_689 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_689.has_value) {
                        __auto_type body_item = _mv_689.value;
                        {
...
void match_emit_inline_bindings(context_TranspileContext* ctx, types_SExpr* bindings_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_690 = (*bindings_expr);
        switch (_mv_690.tag) {
            case types_SExpr_lst:
            {
                __auto_type bindings_lst = _mv_690.data.lst;
                {
                    __auto_type bindings = bindings_lst.items;
                    __auto_type len = ((int64_t)((bindings).len));
                    __auto_type i = 0;
                    while (i < len) {
                        __auto_type _mv_691 = ({ __auto_type _lst = bindings; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_691.has_value) {
                            __auto_type binding = _mv_691.value;
...
void match_emit_single_inline_binding(context_TranspileContext* ctx, types_SExpr* binding) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_692 = (*binding);
        switch (_mv_692.tag) {
            case types_SExpr_lst:
            {
                __auto_type binding_lst = _mv_692.data.lst;
                {
                    ...
                    __auto_type len = ((int64_t)((items).len));
                    {
                        ...
                        if ((len - start_idx) < 2) {
                            ...
                            __auto_type _mv_693 = ({ __auto_type _lst = items; size_t _idx = (size_t)start_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_693.has_value) {
                                __auto_type name_expr = _mv_693.value;
                                __auto_type _mv_694 = (*name_expr);
                                switch (_mv_694.tag) {
                                    case types_SExpr_sym:
                                    {
                                        __auto_type name_sym = _mv_694.data.sym;
                                        {
                                            ...
                                            if ((len - start_idx) >= 3) {
                                                {
                                                    ...
                                                    __auto_type _mv_695 = ({ __auto_type _lst = items; size_t _idx = (size_t)type_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_695.has_value) {
                                                        __auto_type type_expr = _mv_695.value;
                                                        if (match_is_type_expr(type_expr)) {
                                                            __auto_type _mv_696 = ({ __auto_type _lst = items; size_t _idx = (size_t)val_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                            if (_mv_696.has_value) {
                                                                __auto_type val_expr = _mv_696.value;
                                                                {
                                                            ...
                                                            __auto_type _mv_697 = ({ __auto_type _lst = items; size_t _idx = (size_t)type_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                            if (_mv_697.has_value) {
                                                                __auto_type val_expr = _mv_697.value;
                                                                {
                                                                    ...
                                                                    __auto_type _mv_698 = ptr_type_opt;
                                                                    if (_mv_698.has_value) {
                                                                        __auto_type ptr_type = _mv_698.value;
                                            ...
                                            } else {
                                                {
                                                    ...
                                                    __auto_type _mv_699 = ({ __auto_type _lst = items; size_t _idx = (size_t)val_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_699.has_value) {
                                                        __auto_type val_expr = _mv_699.value;
                                                        {
                                                            ...
                                                            __auto_type inferred_slop_type = expr_infer_expr_slop_type(ctx, val_expr);
                                                            __auto_type ptr_type_opt = match_get_arena_alloc_ptr_type_inline(ctx, val_expr);
                                                            __auto_type _mv_700 = ptr_type_opt;
                                                            if (_mv_700.has_value) {
                                                                __auto_type ptr_type = _mv_700.value;
                                                                context_ctx_emit(ctx, context_ctx_str4(ctx, SLOP_STR("__auto_type "), c_name, SLOP_STR(" = "), context_ctx_str(ctx, val_c, SLOP_STR(";"))));
                                                                context_ctx_bind_var(ctx, (context_VarEntry){raw_name, c_name, ptr_type, inferred_slop_type, 1, has_mut, 0, SLOP_STR(""), SLOP_STR("")});
...
uint8_t match_binding_starts_with_mut(slop_list_types_SExpr_ptr items) {
    if (((int64_t)((items).len)) < 1) {
        ...
        if (_mv_701.has_value) {
            __auto_type first = _mv_701.value;
            __auto_type _mv_702 = (*first);
            switch (_mv_702.tag) {
                case types_SExpr_sym:
                {
...
uint8_t match_is_type_expr(types_SExpr* expr) {
    ...
    switch (_mv_703.tag) {
        ...
        case types_SExpr_lst:
        {
            __auto_type _ = _mv_703.data.lst;
            return 1;
        }
        default: {
            return 0;
    ...
    switch (_mv_704.tag) {
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_704.data.lst;
            {
                __auto_type items = lst.items;
                if (((int64_t)((items).len)) == 1) {
                    __auto_type _mv_705 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                ...
                __auto_type lst = _mv_707.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) >= 3) {
                        ...
                        if (_mv_708.has_value) {
                            __auto_type head_ptr = _mv_708.value;
                            __auto_type _mv_709 = (*head_ptr);
                            switch (_mv_709.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type head_sym = _mv_709.data.sym;
                                    if (string_eq(head_sym.name, SLOP_STR("arena-alloc"))) {
                                        __auto_type _mv_710 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_710.has_value) {
                                            __auto_type size_expr = _mv_710.value;
        ...
        switch (_mv_711.tag) {
            case types_SExpr_sym:
            {
                __auto_type sym = _mv_711.data.sym;
                {
                    ...
                    __auto_type _mv_712 = context_ctx_lookup_type(ctx, type_name);
                    if (_mv_712.has_value) {
                        __auto_type entry = _mv_712.value;
                                ...
                                case types_SExpr_sym:
                                {
                                    ...
                                    if (string_eq(head_sym.name, SLOP_STR("sizeof"))) {
                                        ...
                                        if (_mv_715.has_value) {
                                            __auto_type type_expr = _mv_715.value;
                                            {
                                                __auto_type c_type = context_to_c_type_prefixed(ctx, type_expr);
...
void match_emit_inline_do(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items, uint8_t is_return, uint8_t is_last) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 1;
        while (i < len) {
            __auto_type _mv_716 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_716.has_value) {
                __auto_type item = _mv_716.value;
                {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 3) {
            ...
            if (_mv_718.has_value) {
                __auto_type then_expr = _mv_718.value;
            ...
            if (len >= 4) {
                ...
                if (_mv_719.has_value) {
                    __auto_type else_expr = _mv_719.value;
...
slop_option_string match_get_var_c_type_inline(context_TranspileContext* ctx, types_SExpr* expr) {
    ...
    switch (_mv_721.tag) {
        case types_SExpr_sym:
        {
            ...
            {
                __auto_type name = sym.name;
                __auto_type _mv_722 = context_ctx_lookup_var(ctx, name);
                if (_mv_722.has_value) {
                    __auto_type var_entry = _mv_722.value;
        ...
        switch (_mv_723.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_723.data.lst;
                {
                    __auto_type items = lst.items;
                    if (((int64_t)((items).len)) >= 2) {
                        __auto_type _mv_724 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_724.has_value) {
                            __auto_type head = _mv_724.value;
                            __auto_type _mv_725 = (*head);
                            switch (_mv_725.tag) {
                                case types_SExpr_sym:
                                {
...
void match_emit_inline_set(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (expr_set_is_self_assign(items)) {
            ...
            __auto_type _mv_727 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_727.has_value) {
                __auto_type target_expr = _mv_727.value;
                __auto_type _mv_728 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_728.has_value) {
                    __auto_type field_expr = _mv_728.value;
                    __auto_type _mv_729 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_729.has_value) {
                        __auto_type type_expr = _mv_729.value;
                        __auto_type _mv_730 = ({ __auto_type _lst = items; size_t _idx = (size_t)4; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_730.has_value) {
                            __auto_type value_expr = _mv_730.value;
                            {
                                ...
                                __auto_type c_type = ctype_to_c_type(arena, type_expr);
                                {
                                    ...
                                    if (strlib_starts_with(c_type, SLOP_STR("slop_option_"))) {
                                        if (match_is_none_form_inline(value_expr)) {
                                            ...
                                            __auto_type _mv_731 = match_get_some_value_inline(value_expr);
                                            if (_mv_731.has_value) {
                                                __auto_type inner_val = _mv_731.value;
                                                {
            ...
            if (_mv_732.has_value) {
                ...
                if (_mv_733.has_value) {
                    ...
                    if (_mv_734.has_value) {
                        __auto_type value_expr = _mv_734.value;
                        {
                            __auto_type field_name = match_get_field_name_inline(ctx, field_expr);
                ...
                if (_mv_736.has_value) {
                    __auto_type val_expr = _mv_736.value;
                    {
                        ...
                        if (_mv_737.has_value) {
                            ...
                            {
                                __auto_type some_val_opt = match_get_some_value_inline(val_expr);
                                __auto_type _mv_739 = some_val_opt;
                                if (_mv_739.has_value) {
                                    __auto_type inner_expr = _mv_739.value;
                                    {
                                        __auto_type inner_c = expr_transpile_expr(ctx, inner_expr);
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_748.has_value) {
                __auto_type clause_expr = _mv_748.value;
                __auto_type _mv_749 = (*clause_expr);
                switch (_mv_749.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type clause_lst = _mv_749.data.lst;
                        {
                            ...
                            if (clause_len < 1) {
                                ...
                                __auto_type _mv_750 = ({ __auto_type _lst = clause_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_750.has_value) {
                                    __auto_type test_expr = _mv_750.value;
                                    __auto_type _mv_751 = (*test_expr);
                                    switch (_mv_751.tag) {
                                        case types_SExpr_sym:
                                        {
...
void match_emit_inline_cond_body(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items, int64_t start, uint8_t is_return, uint8_t is_last) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = start;
        while (i < len) {
            __auto_type _mv_752 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_752.has_value) {
                __auto_type body_expr = _mv_752.value;
                {
        ...
        if (len < 2) {
        ...
        } else {
            {
                ...
                if (is_named && (len < 4)) {
                    ...
                    context_ctx_indent(ctx);
                    context_ctx_push_scope(ctx);
                    __auto_type _mv_753 = ({ __auto_type _lst = items; size_t _idx = (size_t)size_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_753.has_value) {
                        __auto_type size_expr = _mv_753.value;
                        {
                    ...
                    context_ctx_bind_var(ctx, (context_VarEntry){arena_name, arena_name, SLOP_STR("slop_arena*"), SLOP_STR(""), 1, 0, 0, SLOP_STR(""), SLOP_STR("")});
                    {
                        ...
                        while (i < len) {
                            ...
                            if (_mv_754.has_value) {
                                __auto_type body_expr = _mv_754.value;
                                {
                                    __auto_type is_last = (i == (len - 1));
...
void match_emit_inline_body_items(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items, int64_t start) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = start;
        while (i < len) {
            __auto_type _mv_755 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_755.has_value) {
                __auto_type body_expr = _mv_755.value;
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 2) {
            ...
            if (_mv_756.has_value) {
                __auto_type binding_expr = _mv_756.value;
                __auto_type _mv_757 = (*binding_expr);
                switch (_mv_757.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type binding_lst = _mv_757.data.lst;
                        {
                            ...
                            if (binding_len < 3) {
                                ...
                                __auto_type _mv_758 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_758.has_value) {
                                    __auto_type var_expr = _mv_758.value;
                                    __auto_type _mv_759 = (*var_expr);
                                    switch (_mv_759.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type var_sym = _mv_759.data.sym;
                                            {
                                                __auto_type var_name = ctype_to_c_name(arena, var_sym.name);
                                                __auto_type _mv_760 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_760.has_value) {
                                                    __auto_type start_expr = _mv_760.value;
                                                    __auto_type _mv_761 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_761.has_value) {
                                                        __auto_type end_expr = _mv_761.value;
                                                        {
...
void match_emit_inline_for_each_map_kv(context_TranspileContext* ctx, slop_list_types_SExpr_ptr binding_items, slop_list_types_SExpr_ptr items, int64_t len) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (_mv_762.has_value) {
            __auto_type kv_list_expr = _mv_762.value;
            __auto_type _mv_763 = (*kv_list_expr);
            switch (_mv_763.tag) {
                case types_SExpr_lst:
                {
                    __auto_type kv_lst = _mv_763.data.lst;
                    {
                        __auto_type kv_items = kv_lst.items;
                        if (((int64_t)((kv_items).len)) < 2) {
                            context_ctx_add_error(ctx, SLOP_STR("Map for-each needs ((k v) map)"));
                        } else {
                            __auto_type _mv_764 = ({ __auto_type _lst = kv_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_764.has_value) {
                                __auto_type k_expr = _mv_764.value;
                                __auto_type _mv_765 = ({ __auto_type _lst = kv_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_765.has_value) {
                                    __auto_type v_expr = _mv_765.value;
                                    ...
                                    if (_mv_766.has_value) {
                                        __auto_type map_expr = _mv_766.value;
                                        __auto_type _mv_767 = (*k_expr);
                                        switch (_mv_767.tag) {
                                            case types_SExpr_sym:
                                            {
                                                __auto_type k_sym = _mv_767.data.sym;
                                                __auto_type _mv_768 = (*v_expr);
                                                switch (_mv_768.tag) {
                                                    case types_SExpr_sym:
                                                    {
                                                        __auto_type v_sym = _mv_768.data.sym;
                                                        {
                        ...
                        __auto_type binding_lst = _mv_770.data.lst;
                        {
                            ...
                            if (binding_len < 2) {
                                ...
                                if (_mv_771.has_value) {
                                    __auto_type first_elem = _mv_771.value;
                                    __auto_type _mv_772 = (*first_elem);
                                    switch (_mv_772.tag) {
                                        case types_SExpr_lst:
                                        {
                                            __auto_type _ = _mv_772.data.lst;
                                        ...
                                        case types_SExpr_sym:
                                        {
                                            __auto_type var_sym = _mv_772.data.sym;
                                            {
                                                ...
                                                if (_mv_773.has_value) {
                                                    __auto_type coll_expr = _mv_773.value;
                                                    {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 2) {
            ...
            if (_mv_774.has_value) {
                __auto_type val_expr = _mv_774.value;
                            ...
                            case types_SExpr_sym:
                            {
                                __auto_type sym = _mv_777.data.sym;
                                {
                                    ...
                                    if (string_eq(op, SLOP_STR("some"))) {
                                        __auto_type _mv_778 = context_ctx_get_current_return_type(ctx);
                                        if (_mv_778.has_value) {
                                            __auto_type ret_type = _mv_778.value;
                                            if (strlib_starts_with(ret_type, SLOP_STR("slop_option_"))) {
                                                if (((int64_t)((items).len)) < 2) {
                                                    match_emit_return_typed(ctx, expr_transpile_expr(ctx, expr));
                                                } else {
...
uint8_t match_is_pattern_literal(types_SExpr* expr) {
    ...
    switch (_mv_781.tag) {
        ...
        case types_SExpr_num:
        {
            __auto_type _ = _mv_781.data.num;
            return 1;
        }
        default: {
            return 0;
...
slop_string match_pattern_literal_to_c(types_SExpr* expr) {
    ...
    switch (_mv_782.tag) {
        ...
        case types_SExpr_num:
        {
            __auto_type n = _mv_782.data.num;
            return n.raw;
        }
        default: {
            return SLOP_STR("");
                ...
                for (int64_t i = 1; i < len; i++) {
                    if (!(found)) {
                        ...
                        if (_mv_784.has_value) {
                            __auto_type item = _mv_784.value;
...
uint8_t match_has_literal_in_patterns(slop_list_types_SExpr_ptr patterns) {
    {
        ...
        int64_t i = 0;
        while ((i < len) && !(found)) {
            __auto_type _mv_785 = ({ __auto_type _lst = patterns; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_785.has_value) {
                __auto_type pat_expr = _mv_785.value;
...
slop_string match_build_literal_guard_cond(context_TranspileContext* ctx, slop_string scrutinee_c, slop_string c_tag, slop_string tag_cond, types_SExpr* pattern, uint8_t is_multi) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_786 = (*pattern);
        switch (_mv_786.tag) {
            case types_SExpr_lst:
            {
                __auto_type pat_lst = _mv_786.data.lst;
                {
                    __auto_type pat_items = pat_lst.items;
                    __auto_type pat_len = ((int64_t)((pat_items).len));
                    __auto_type cond = tag_cond;
                    for (int64_t bi = 1; bi < pat_len; bi++) {
                        __auto_type _mv_787 = ({ __auto_type _lst = pat_items; size_t _idx = (size_t)bi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void match_emit_union_literal_bindings(context_TranspileContext* ctx, slop_string scrutinee_c, types_SExpr* pattern, slop_string tag, slop_string union_type_name, slop_string c_tag, uint8_t is_multi) {
    ...
    SLOP_PRE(((pattern != NULL)), "(!= pattern nil)");
    {
        __auto_type arena = (*ctx).arena;
        if (is_multi) {
            __auto_type _mv_788 = (*pattern);
            switch (_mv_788.tag) {
                case types_SExpr_lst:
                {
                    __auto_type pat_lst = _mv_788.data.lst;
                    {
                        __auto_type pat_items = pat_lst.items;
                        __auto_type pat_len = ((int64_t)((pat_items).len));
                        for (int64_t bi = 1; bi < pat_len; bi++) {
                            __auto_type _mv_789 = ({ __auto_type _lst = pat_items; size_t _idx = (size_t)bi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            ...
            __auto_type _mv_790 = match_extract_binding_name(pattern);
            if (_mv_790.has_value) {
                __auto_type binding_name = _mv_790.value;
                                ...
                                if (_mv_793.has_value) {
                                    __auto_type pattern = _mv_793.value;
                                    {
                                        ...
                                        if (string_eq(tag, SLOP_STR("else")) || string_eq(tag, SLOP_STR("_"))) {
                                            ...
                                            __auto_type _mv_794 = context_ctx_lookup_enum_variant(ctx, tag);
                                            if (_mv_794.has_value) {
                                                __auto_type union_type_name = _mv_794.value;
                                                {
                                                    __auto_type c_tag = ctype_to_c_name(arena, tag);
