    ...
    if (!(parser_sexpr_is_symbol(params))) {
        {
            ...
            int64_t found = -1;
            while ((i < len) && (found == -1)) {
                __auto_type _mv_1537 = parser_sexpr_list_get(params, i);
                if (_mv_1537.has_value) {
                    __auto_type param = _mv_1537.value;
                    {
                        ...
                        if (plen >= 2) {
                            {
                                ...
                                __auto_type _mv_1538 = parser_sexpr_list_get(param, name_pos);
                                if (_mv_1538.has_value) {
                                    ...
                                    if (parser_sexpr_is_symbol(name_expr)) {
                                        if (string_eq(parser_sexpr_get_symbol_name(name_expr), SLOP_STR("arena"))) {
                                            __auto_type _mv_1539 = parser_sexpr_list_get(param, type_pos);
...
slop_option_string extract_extract_return_type(slop_arena* arena, types_SExpr* spec_form) {
    if (parser_sexpr_list_len(spec_form) < 2) {
        ...
        __auto_type _mv_1540 = parser_sexpr_list_get(spec_form, 1);
        if (_mv_1540.has_value) {
            __auto_type sig = _mv_1540.value;
            {
                __auto_type sig_len = parser_sexpr_list_len(sig);
                if (sig_len < 3) {
                    return (slop_option_string){.has_value = false};
                } else {
                    __auto_type _mv_1541 = parser_sexpr_list_get(sig, (sig_len - 1));
                    if (_mv_1541.has_value) {
                        __auto_type ret_type = _mv_1541.value;
...
slop_list_extract_TestCase_ptr extract_extract_fn_examples(slop_arena* arena, types_SExpr* fn_form, slop_option_string module_name) {
    {
        ...
        if (parser_sexpr_list_len(fn_form) < 3) {
        ...
        } else {
            {
                ...
                __auto_type _mv_1544 = fn_name_opt;
                if (!_mv_1544.has_value) {
                    return result;
                } else if (_mv_1544.has_value) {
                    __auto_type fn_name_expr = _mv_1544.value;
                    if (!(parser_sexpr_is_symbol(fn_name_expr))) {
                    ...
                    } else {
                        {
                            __auto_type fn_name = parser_sexpr_get_symbol_name(fn_name_expr);
                            {
                                ...
                                __auto_type _mv_1545 = params_opt;
                                if (!_mv_1545.has_value) {
                                    return result;
                                } else if (_mv_1545.has_value) {
                                    __auto_type params = _mv_1545.value;
                                    {
                                                    ...
                                                    if (parser_is_form(item, SLOP_STR("@example"))) {
                                                        {
                                                            ...
                                                            __auto_type _mv_1547 = example_tc;
...
slop_option_extract_TestCase_ptr extract_parse_example(slop_arena* arena, types_SExpr* example_form, slop_string fn_name, slop_option_string module_name, slop_option_string return_type, uint8_t needs_arena, int64_t arena_pos, types_SExpr* params, slop_list_types_SExpr_ptr preconditions) {
    {
        ...
        if (example_len < 2) {
        ...
        } else {
            {
                ...
                int64_t i = 1;
                while (i < example_len) {
                    __auto_type _mv_1548 = parser_sexpr_list_get(example_form, i);
                ...
                }
                {
                    ...
                    if (((int64_t)((items).len)) >= 2) {
                        ...
                        if (_mv_1549.has_value) {
                            __auto_type first_item = _mv_1549.value;
                            if (parser_sexpr_is_symbol(first_item)) {
                                if (string_eq(parser_sexpr_get_symbol_name(first_item), SLOP_STR(":eq"))) {
                                    ...
                                    if (_mv_1550.has_value) {
                                        __auto_type eq_name_expr = _mv_1550.value;
                        ...
                        if (arrow_idx < 0) {
                            ...
                            if (arrow_idx >= (((int64_t)((items).len)) - 1)) {
                            ...
                            } else {
                                {
                                    ...
                                    while (j < arrow_idx) {
                                        __auto_type _mv_1551 = ({ __auto_type _lst = items; size_t _idx = (size_t)j; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    ...
                                    }
                                    {
                                        ...
                                        __auto_type _mv_1552 = ({ __auto_type _lst = items; size_t _idx = (size_t)(arrow_idx + 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_1552.has_value) {
                                            __auto_type expected = _mv_1552.value;
...
slop_list_types_SExpr_ptr extract_unpack_grouped_args(slop_arena* arena, slop_list_types_SExpr_ptr args) {
    {
        ...
        if (((int64_t)((args).len)) == 1) {
            __auto_type _mv_1553 = ({ __auto_type _lst = args; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1553.has_value) {
                __auto_type first_arg = _mv_1553.value;
                if (!(parser_sexpr_is_symbol(first_arg))) {
                    {
                        ...
                        if (inner_len == 0) {
                            ...
                            __auto_type _mv_1554 = parser_sexpr_list_get(first_arg, 0);
                            if (_mv_1554.has_value) {
                                __auto_type first_inner = _mv_1554.value;
                                if (parser_sexpr_is_symbol(first_inner) && string_eq(parser_sexpr_get_symbol_name(first_inner), SLOP_STR("arena"))) {
                                    {
                                        ...
                                        __auto_type i = 1;
                                        while (i < inner_len) {
                                            __auto_type _mv_1555 = parser_sexpr_list_get(first_arg, i);
                                    ...
                                    if ((parser_sexpr_is_number(first_inner)) || (parser_sexpr_is_string(first_inner)) || (!(parser_sexpr_is_symbol(first_inner)))) {
                                        {
                                            ...
                                            __auto_type i = 0;
                                            while (i < inner_len) {
                                                __auto_type _mv_1556 = parser_sexpr_list_get(first_arg, i);
...
slop_list_extract_TestCase_ptr extract_extract_examples_from_module(slop_arena* arena, types_SExpr* module_form) {
    {
        ...
        if (parser_sexpr_list_len(module_form) < 2) {
        ...
        } else {
            {
                ...
                __auto_type _mv_1557 = mod_name_opt;
                if (!_mv_1557.has_value) {
                    return result;
                } else if (_mv_1557.has_value) {
                    __auto_type mod_name_expr = _mv_1557.value;
                    {
                        ...
                        }
                        {
                            ...
                            __auto_type i = 2;
                            while (i < form_len) {
                                __auto_type _mv_1558 = parser_sexpr_list_get(module_form, i);
                                    ...
                                    if (parser_is_form(item, SLOP_STR("fn"))) {
                                        {
                                            ...
                                            while (j < fn_tests_len) {
                                                __auto_type _mv_1559 = ({ __auto_type _lst = fn_tests; size_t _idx = (size_t)j; slop_option_extract_TestCase_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_1559.has_value) {
                                                    __auto_type tc = _mv_1559.value;
                                                    ({ __auto_type _lst_p = &(result); __auto_type _item = (tc); if (_lst_p->len >= _lst_p->cap) { size_t _new_cap = _lst_p->cap == 0 ? 16 : _lst_p->cap * 2; __typeof__(_lst_p->data) _new_data = (__typeof__(_lst_p->data))slop_arena_alloc(arena, _new_cap * sizeof(*_lst_p->data)); if (_lst_p->len > 0) memcpy(_new_data, _lst_p->data, _lst_p->len * sizeof(*_lst_p->data)); _lst_p->data = _new_data; _lst_p->cap = _new_cap; } _lst_p->data[_lst_p->len++] = _item; (void)0; });
...
slop_list_extract_TestCase_ptr extract_extract_examples_from_ast(slop_arena* arena, slop_list_types_SExpr_ptr ast) {
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1560 = ({ __auto_type _lst = ast; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1560.has_value) {
                __auto_type form = _mv_1560.value;
                if (parser_is_form(form, SLOP_STR("fn"))) {
                    {
                        ...
                        __auto_type j = 0;
                        while (j < fn_tests_len) {
                            __auto_type _mv_1561 = ({ __auto_type _lst = fn_tests; size_t _idx = (size_t)j; slop_option_extract_TestCase_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                ...
                if (parser_is_form(form, SLOP_STR("module"))) {
                    {
                        ...
                        while (k < mod_tests_len) {
                            __auto_type _mv_1562 = ({ __auto_type _lst = mod_tests; size_t _idx = (size_t)k; slop_option_extract_TestCase_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
