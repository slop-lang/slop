...
uint8_t match_is_option_match(slop_list_types_SExpr_ptr patterns) {
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_625 = ({ __auto_type _lst = patterns; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_625.has_value) {
                __auto_type pat_expr = _mv_625.value;
                {
...
uint8_t match_is_result_match(slop_list_types_SExpr_ptr patterns) {
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_626 = ({ __auto_type _lst = patterns; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_626.has_value) {
                __auto_type pat_expr = _mv_626.value;
                {
                    __auto_type tag = match_get_pattern_tag(pat_expr);
...
uint8_t match_is_enum_match(slop_list_types_SExpr_ptr patterns) {
    {
        ...
        while (((i < len) && all_symbols)) {
            __auto_type _mv_627 = ({ __auto_type _lst = patterns; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_627.has_value) {
                __auto_type pat_expr = _mv_627.value;
                __auto_type _mv_628 = (*pat_expr);
                switch (_mv_628.tag) {
                    case types_SExpr_sym:
                    {
                        __auto_type _ = _mv_628.data.sym;
                        break;
                    }
                    default: {
                        all_symbols = 0;
...
uint8_t match_is_literal_match(slop_list_types_SExpr_ptr patterns) {
    {
        ...
        while (((i < len) && !(has_literal))) {
            __auto_type _mv_629 = ({ __auto_type _lst = patterns; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_629.has_value) {
                __auto_type pat_expr = _mv_629.value;
                __auto_type _mv_630 = (*pat_expr);
                switch (_mv_630.tag) {
                    case types_SExpr_num:
                    {
                        __auto_type _ = _mv_630.data.num;
                        has_literal = 1;
                        break;
                    }
                    case types_SExpr_str:
                    {
                        __auto_type _ = _mv_630.data.str;
                        has_literal = 1;
                        break;
                    }
                    default: {
            ...
            if (_mv_631.has_value) {
                __auto_type pat_expr = _mv_631.value;
                {
                    ...
                    if (((!(string_eq(tag, SLOP_STR("")))) && (!(string_eq(tag, SLOP_STR("some")))) && (!(string_eq(tag, SLOP_STR("none")))) && (!(string_eq(tag, SLOP_STR("ok")))) && (!(string_eq(tag, SLOP_STR("error")))) && (!(string_eq(tag, SLOP_STR("else")))) && (!(string_eq(tag, SLOP_STR("_")))))) {
                        __auto_type _mv_632 = context_ctx_lookup_enum_variant(ctx, tag);
                        if (_mv_632.has_value) {
                            __auto_type _ = _mv_632.value;
                            has_union_variant = 1;
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_633.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    __auto_type _mv_634 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_option_string match_extract_binding_name(types_SExpr* pat_expr) {
    ...
    switch (_mv_636.tag) {
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_636.data.lst;
            {
                __auto_type items = lst.items;
                if ((((int64_t)((items).len)) < 2)) {
                    return (slop_option_string){.has_value = false};
                } else {
                    __auto_type _mv_637 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_637.has_value) {
                        __auto_type binding = _mv_637.value;
                        __auto_type _mv_638 = (*binding);
                        switch (_mv_638.tag) {
                            case types_SExpr_sym:
                            {
                                __auto_type sym = _mv_638.data.sym;
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_639.data.lst;
                {
                    ...
                    if ((len < 3)) {
                        ...
                        __auto_type _mv_640 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_640.has_value) {
                            __auto_type scrutinee = _mv_640.value;
                            {
...
void match_emit_option_some_branch(context_TranspileContext* ctx, slop_string scrutinee_c, types_SExpr* scrutinee_expr, types_SExpr* pattern, slop_list_types_SExpr_ptr branch_items, uint8_t is_return, uint8_t first) {
    ...
    SLOP_PRE(((pattern != NULL)), "(!= pattern nil)");
    {
        ...
        __auto_type _mv_647 = match_extract_binding_name(pattern);
        if (_mv_647.has_value) {
            __auto_type binding_name = _mv_647.value;
            {
...
void match_emit_result_ok_branch(context_TranspileContext* ctx, slop_string scrutinee_c, types_SExpr* scrutinee_expr, types_SExpr* pattern, slop_list_types_SExpr_ptr branch_items, uint8_t is_return, uint8_t first) {
    ...
    SLOP_PRE(((pattern != NULL)), "(!= pattern nil)");
    {
        ...
        context_ctx_indent(ctx);
        context_ctx_push_scope(ctx);
        __auto_type _mv_651 = match_extract_binding_name(pattern);
        if (_mv_651.has_value) {
            __auto_type binding_name = _mv_651.value;
            {
                __auto_type c_name = ctype_to_c_name(arena, binding_name);
...
void match_emit_result_error_branch(context_TranspileContext* ctx, slop_string scrutinee_c, types_SExpr* scrutinee_expr, types_SExpr* pattern, slop_list_types_SExpr_ptr branch_items, uint8_t is_return, uint8_t first) {
    ...
    SLOP_PRE(((pattern != NULL)), "(!= pattern nil)");
    {
        ...
        context_ctx_indent(ctx);
        context_ctx_push_scope(ctx);
        __auto_type _mv_652 = match_extract_binding_name(pattern);
        if (_mv_652.has_value) {
            __auto_type binding_name = _mv_652.value;
            {
                __auto_type c_name = ctype_to_c_name(arena, binding_name);
...
void match_transpile_enum_match(context_TranspileContext* ctx, slop_string scrutinee_c, slop_list_types_SExpr_ptr items, uint8_t is_return) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        context_ctx_indent(ctx);
        while ((i < len)) {
            __auto_type _mv_653 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_653.has_value) {
                __auto_type branch = _mv_653.value;
                __auto_type _mv_654 = (*branch);
                switch (_mv_654.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type branch_lst = _mv_654.data.lst;
                        {
                            __auto_type branch_items = branch_lst.items;
                            if ((((int64_t)((branch_items).len)) >= 2)) {
                                __auto_type _mv_655 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_655.has_value) {
                                    __auto_type pattern = _mv_655.value;
...
void match_emit_enum_case(context_TranspileContext* ctx, types_SExpr* pattern, slop_list_types_SExpr_ptr branch_items, uint8_t is_return) {
    ...
    SLOP_PRE(((pattern != NULL)), "(!= pattern nil)");
    {
        ...
        if ((string_eq(tag, SLOP_STR("else")) || string_eq(tag, SLOP_STR("_")))) {
            ...
            __auto_type _mv_656 = context_ctx_lookup_enum_variant(ctx, tag);
            if (_mv_656.has_value) {
                __auto_type type_name = _mv_656.value;
                {
...
void match_transpile_literal_match(context_TranspileContext* ctx, slop_string scrutinee_c, slop_list_types_SExpr_ptr items, uint8_t is_return) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        uint8_t first = 1;
        while ((i < len)) {
            __auto_type _mv_657 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_657.has_value) {
                __auto_type branch = _mv_657.value;
                __auto_type _mv_658 = (*branch);
                switch (_mv_658.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type branch_lst = _mv_658.data.lst;
                        {
                            __auto_type branch_items = branch_lst.items;
                            if ((((int64_t)((branch_items).len)) >= 2)) {
                                __auto_type _mv_659 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_659.has_value) {
                                    __auto_type pattern = _mv_659.value;
                                    ...
                                    __auto_type pattern = _mv_662.value;
                                    {
                                        ...
                                        if ((string_eq(tag, SLOP_STR("else")) || string_eq(tag, SLOP_STR("_")))) {
                                            ...
                                            if (_mv_663.has_value) {
                                                __auto_type union_type_name = _mv_663.value;
...
void match_emit_union_case(context_TranspileContext* ctx, slop_string scrutinee_c, types_SExpr* pattern, slop_string tag, slop_string union_type_name, slop_list_types_SExpr_ptr branch_items, uint8_t is_return) {
    ...
    SLOP_PRE(((pattern != NULL)), "(!= pattern nil)");
    {
        ...
        context_ctx_indent(ctx);
        context_ctx_push_scope(ctx);
        __auto_type _mv_664 = match_extract_binding_name(pattern);
        if (_mv_664.has_value) {
            __auto_type binding_name = _mv_664.value;
            {
...
void match_emit_branch_body(context_TranspileContext* ctx, slop_list_types_SExpr_ptr branch_items, uint8_t is_return) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 1;
        while ((i < len)) {
            __auto_type _mv_665 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void match_emit_branch_body_item(context_TranspileContext* ctx, types_SExpr* body_expr, uint8_t is_return, uint8_t is_last) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_666 = (*body_expr);
        switch (_mv_666.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_666.data.lst;
                {
                    __auto_type items = lst.items;
                    if ((((int64_t)((items).len)) < 1)) {
                        context_ctx_emit(ctx, SLOP_STR("/* empty list */;"));
                    } else {
                        __auto_type _mv_667 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_667.has_value) {
                            __auto_type head_expr = _mv_667.value;
                            __auto_type _mv_668 = (*head_expr);
                            switch (_mv_668.tag) {
                                case types_SExpr_sym:
                                {
...
void match_emit_inline_let(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items, uint8_t is_return, uint8_t is_last) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len < 2)) {
            ...
            context_ctx_indent(ctx);
            context_ctx_push_scope(ctx);
            __auto_type _mv_669 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_669.has_value) {
                __auto_type bindings_expr = _mv_669.value;
            ...
            }
            {
                int64_t i = 2;
                while ((i < len)) {
                    __auto_type _mv_670 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_670.has_value) {
                        __auto_type body_item = _mv_670.value;
                        {
...
void match_emit_inline_bindings(context_TranspileContext* ctx, types_SExpr* bindings_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_671 = (*bindings_expr);
        switch (_mv_671.tag) {
            case types_SExpr_lst:
            {
                __auto_type bindings_lst = _mv_671.data.lst;
                {
                    __auto_type bindings = bindings_lst.items;
                    __auto_type len = ((int64_t)((bindings).len));
                    __auto_type i = 0;
                    while ((i < len)) {
                        __auto_type _mv_672 = ({ __auto_type _lst = bindings; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_672.has_value) {
                            __auto_type binding = _mv_672.value;
...
void match_emit_single_inline_binding(context_TranspileContext* ctx, types_SExpr* binding) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_673 = (*binding);
        switch (_mv_673.tag) {
            case types_SExpr_lst:
            {
                __auto_type binding_lst = _mv_673.data.lst;
                {
                    ...
                    __auto_type len = ((int64_t)((items).len));
                    {
                        ...
                        if (((len - start_idx) < 2)) {
                            ...
                            __auto_type _mv_674 = ({ __auto_type _lst = items; size_t _idx = (size_t)start_idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_674.has_value) {
                                __auto_type name_expr = _mv_674.value;
                                __auto_type _mv_675 = (*name_expr);
                                switch (_mv_675.tag) {
                                    case types_SExpr_sym:
                                    {
                                        __auto_type name_sym = _mv_675.data.sym;
                                        {
                                            ...
                                            if (((len - start_idx) >= 3)) {
                                                {
                                                    ...
                                                    __auto_type _mv_676 = ({ __auto_type _lst = items; size_t _idx = (size_t)type_idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_676.has_value) {
                                                        __auto_type type_expr = _mv_676.value;
                                                        if (match_is_type_expr(type_expr)) {
                                                            __auto_type _mv_677 = ({ __auto_type _lst = items; size_t _idx = (size_t)val_idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                            if (_mv_677.has_value) {
                                                                __auto_type val_expr = _mv_677.value;
                                                                {
                                                            ...
                                                            __auto_type _mv_678 = ({ __auto_type _lst = items; size_t _idx = (size_t)type_idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                            if (_mv_678.has_value) {
                                                                __auto_type val_expr = _mv_678.value;
                                                                {
                                                                    ...
                                                                    __auto_type _mv_679 = ptr_type_opt;
                                                                    if (_mv_679.has_value) {
                                                                        __auto_type ptr_type = _mv_679.value;
                                            ...
                                            } else {
                                                {
                                                    ...
                                                    __auto_type _mv_680 = ({ __auto_type _lst = items; size_t _idx = (size_t)val_idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_680.has_value) {
                                                        __auto_type val_expr = _mv_680.value;
                                                        {
                                                            __auto_type val_c = expr_transpile_expr(ctx, val_expr);
                                                            __auto_type inferred_slop_type = expr_infer_expr_slop_type(ctx, val_expr);
                                                            __auto_type ptr_type_opt = match_get_arena_alloc_ptr_type_inline(ctx, val_expr);
                                                            __auto_type _mv_681 = ptr_type_opt;
                                                            if (_mv_681.has_value) {
                                                                __auto_type ptr_type = _mv_681.value;
                                                                context_ctx_emit(ctx, context_ctx_str4(ctx, SLOP_STR("__auto_type "), c_name, SLOP_STR(" = "), context_ctx_str(ctx, val_c, SLOP_STR(";"))));
                                                                context_ctx_bind_var(ctx, (context_VarEntry){raw_name, c_name, ptr_type, inferred_slop_type, 1, has_mut, 0, SLOP_STR(""), SLOP_STR("")});
...
uint8_t match_binding_starts_with_mut(slop_list_types_SExpr_ptr items) {
    if ((((int64_t)((items).len)) < 1)) {
        ...
        __auto_type _mv_682 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        if (_mv_682.has_value) {
            __auto_type first = _mv_682.value;
            __auto_type _mv_683 = (*first);
            switch (_mv_683.tag) {
                case types_SExpr_sym:
                {
...
uint8_t match_is_type_expr(types_SExpr* expr) {
    ...
    switch (_mv_684.tag) {
        ...
        case types_SExpr_lst:
        {
            __auto_type _ = _mv_684.data.lst;
            return 1;
        }
        default: {
            return 0;
    ...
    switch (_mv_685.tag) {
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_685.data.lst;
            {
                __auto_type items = lst.items;
                if ((((int64_t)((items).len)) == 1)) {
                    __auto_type _mv_686 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                ...
                __auto_type lst = _mv_688.data.lst;
                {
                    ...
                    if ((((int64_t)((items).len)) >= 3)) {
                        ...
                        if (_mv_689.has_value) {
                            __auto_type head_ptr = _mv_689.value;
                            __auto_type _mv_690 = (*head_ptr);
                            switch (_mv_690.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type head_sym = _mv_690.data.sym;
                                    if (string_eq(head_sym.name, SLOP_STR("arena-alloc"))) {
                                        __auto_type _mv_691 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_691.has_value) {
                                            __auto_type size_expr = _mv_691.value;
        ...
        switch (_mv_692.tag) {
            case types_SExpr_sym:
            {
                __auto_type sym = _mv_692.data.sym;
                {
                    ...
                    __auto_type _mv_693 = context_ctx_lookup_type(ctx, type_name);
                    if (_mv_693.has_value) {
                        __auto_type entry = _mv_693.value;
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_692.data.lst;
                {
                    __auto_type items = lst.items;
                    if ((((int64_t)((items).len)) >= 2)) {
                        __auto_type _mv_694 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_694.has_value) {
                            __auto_type head_ptr = _mv_694.value;
                            __auto_type _mv_695 = (*head_ptr);
                            switch (_mv_695.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type head_sym = _mv_695.data.sym;
                                    if (string_eq(head_sym.name, SLOP_STR("sizeof"))) {
                                        __auto_type _mv_696 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_696.has_value) {
                                            __auto_type type_expr = _mv_696.value;
                                            {
                                                __auto_type c_type = context_to_c_type_prefixed(ctx, type_expr);
...
void match_emit_inline_do(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items, uint8_t is_return, uint8_t is_last) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 1;
        while ((i < len)) {
            __auto_type _mv_697 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_697.has_value) {
                __auto_type item = _mv_697.value;
                {
...
void match_emit_inline_if(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items, uint8_t is_return) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len < 3)) {
            ...
            __auto_type _mv_698 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_698.has_value) {
                __auto_type cond_expr = _mv_698.value;
                {
            ...
            context_ctx_indent(ctx);
            __auto_type _mv_699 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_699.has_value) {
                __auto_type then_expr = _mv_699.value;
            ...
            if ((len >= 4)) {
                context_ctx_emit(ctx, SLOP_STR("} else {"));
                context_ctx_indent(ctx);
                __auto_type _mv_700 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_700.has_value) {
                    __auto_type else_expr = _mv_700.value;
...
void match_emit_inline_while(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len < 3)) {
            ...
            __auto_type _mv_701 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_701.has_value) {
                __auto_type cond_expr = _mv_701.value;
                {
                    __auto_type cond_c = expr_transpile_expr(ctx, cond_expr);
...
slop_option_types_SExpr_ptr match_get_some_value_inline(types_SExpr* expr) {
    SLOP_PRE(((expr != NULL)), "(!= expr nil)");
    {
        ...
        __auto_type _mv_704 = (*expr);
        switch (_mv_704.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_704.data.lst;
                {
                    __auto_type items = lst.items;
                    if ((((int64_t)((items).len)) >= 2)) {
                        __auto_type _mv_705 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_705.has_value) {
                            __auto_type head = _mv_705.value;
                            __auto_type _mv_706 = (*head);
                            switch (_mv_706.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type sym = _mv_706.data.sym;
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len == 5)) {
            ...
            if (_mv_708.has_value) {
                __auto_type target_expr = _mv_708.value;
                __auto_type _mv_709 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_709.has_value) {
                    __auto_type field_expr = _mv_709.value;
                    __auto_type _mv_710 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_710.has_value) {
                        __auto_type type_expr = _mv_710.value;
                        __auto_type _mv_711 = ({ __auto_type _lst = items; size_t _idx = (size_t)4; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_711.has_value) {
                            __auto_type value_expr = _mv_711.value;
                            {
                                ...
                                __auto_type c_type = ctype_to_c_type(arena, type_expr);
                                {
                                    ...
                                    if (strlib_starts_with(c_type, SLOP_STR("slop_option_"))) {
                                        if (match_is_none_form_inline(value_expr)) {
                                            ...
                                            __auto_type _mv_712 = match_get_some_value_inline(value_expr);
                                            if (_mv_712.has_value) {
                                                __auto_type inner_val = _mv_712.value;
                                                {
            ...
            if (_mv_713.has_value) {
                __auto_type target_expr = _mv_713.value;
                ...
                if (_mv_714.has_value) {
                    __auto_type field_expr = _mv_714.value;
                    ...
                    if (_mv_715.has_value) {
                        __auto_type value_expr = _mv_715.value;
                        {
                            __auto_type field_name = match_get_field_name_inline(ctx, field_expr);
            ...
            if (_mv_716.has_value) {
                __auto_type target_expr = _mv_716.value;
                __auto_type _mv_717 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_717.has_value) {
                    __auto_type val_expr = _mv_717.value;
                    {
                        __auto_type target_c = expr_transpile_expr(ctx, target_expr);
                        __auto_type target_type_opt = match_get_var_c_type_inline(ctx, target_expr);
                        __auto_type _mv_718 = target_type_opt;
                        if (_mv_718.has_value) {
                            __auto_type target_type = _mv_718.value;
                            if (strlib_starts_with(target_type, SLOP_STR("slop_option_"))) {
                                {
                                    __auto_type some_val_opt = match_get_some_value_inline(val_expr);
                                    __auto_type _mv_719 = some_val_opt;
                                    if (_mv_719.has_value) {
                                        __auto_type inner_expr = _mv_719.value;
                                        {
                            ...
                            {
                                __auto_type some_val_opt = match_get_some_value_inline(val_expr);
                                __auto_type _mv_720 = some_val_opt;
                                if (_mv_720.has_value) {
                                    __auto_type inner_expr = _mv_720.value;
                                    {
                                        __auto_type inner_c = expr_transpile_expr(ctx, inner_expr);
                                    ...
                                    if (match_is_none_form_inline(val_expr)) {
                                        __auto_type _mv_721 = context_ctx_get_current_return_type(ctx);
                                        if (_mv_721.has_value) {
                                            __auto_type ret_type = _mv_721.value;
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_722.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 2)) {
                    ...
                    __auto_type _mv_723 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_723.has_value) {
                        __auto_type head = _mv_723.value;
                        __auto_type _mv_724 = (*head);
                        switch (_mv_724.tag) {
                            case types_SExpr_sym:
                            {
                                __auto_type sym = _mv_724.data.sym;
...
slop_string match_get_deref_inner_inline(context_TranspileContext* ctx, types_SExpr* expr) {
    ...
    switch (_mv_725.tag) {
        case types_SExpr_lst:
        {
            ...
            {
                __auto_type items = lst.items;
                __auto_type _mv_726 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_726.has_value) {
                    __auto_type inner = _mv_726.value;
...
void match_emit_inline_when(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len < 2)) {
            ...
            __auto_type _mv_728 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_728.has_value) {
                __auto_type cond_expr = _mv_728.value;
                {
                    __auto_type cond_c = expr_transpile_expr(ctx, cond_expr);
                    context_ctx_emit(ctx, context_ctx_str3(ctx, SLOP_STR("if ("), cond_c, SLOP_STR(") {")));
                }
...
void match_emit_inline_cond(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items, uint8_t is_return, uint8_t is_last) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        uint8_t first = 1;
        while ((i < len)) {
            __auto_type _mv_729 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_729.has_value) {
                __auto_type clause_expr = _mv_729.value;
                __auto_type _mv_730 = (*clause_expr);
                switch (_mv_730.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type clause_lst = _mv_730.data.lst;
                        {
                            ...
                            if ((clause_len < 1)) {
                                ...
                                __auto_type _mv_731 = ({ __auto_type _lst = clause_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_731.has_value) {
                                    __auto_type test_expr = _mv_731.value;
                                    __auto_type _mv_732 = (*test_expr);
                                    switch (_mv_732.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type sym = _mv_732.data.sym;
...
void match_emit_inline_cond_body(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items, int64_t start, uint8_t is_return, uint8_t is_last) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = start;
        while ((i < len)) {
            __auto_type _mv_733 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_733.has_value) {
                __auto_type body_expr = _mv_733.value;
                {
        ...
        if ((len < 2)) {
        ...
        } else {
            {
                ...
                if ((is_named && (len < 4))) {
                    ...
                    context_ctx_indent(ctx);
                    context_ctx_push_scope(ctx);
                    __auto_type _mv_734 = ({ __auto_type _lst = items; size_t _idx = (size_t)size_idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    ...
                    context_ctx_bind_var(ctx, (context_VarEntry){arena_name, arena_name, SLOP_STR("slop_arena*"), SLOP_STR(""), 1, 0, 0, SLOP_STR(""), SLOP_STR("")});
                    {
                        ...
                        while ((i < len)) {
                            ...
                            if (_mv_735.has_value) {
                                __auto_type body_expr = _mv_735.value;
                                {
                                    __auto_type is_last = (i == (len - 1));
...
void match_emit_inline_body_items(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items, int64_t start) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = start;
        while ((i < len)) {
            __auto_type _mv_736 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len < 2)) {
            ...
            if (_mv_737.has_value) {
                __auto_type binding_expr = _mv_737.value;
                __auto_type _mv_738 = (*binding_expr);
                switch (_mv_738.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type binding_lst = _mv_738.data.lst;
                        {
                            ...
                            if ((binding_len < 3)) {
                                ...
                                __auto_type _mv_739 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_739.has_value) {
                                    __auto_type var_expr = _mv_739.value;
                                    __auto_type _mv_740 = (*var_expr);
                                    switch (_mv_740.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type var_sym = _mv_740.data.sym;
                                            {
                                                __auto_type var_name = ctype_to_c_name(arena, var_sym.name);
                                                __auto_type _mv_741 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_741.has_value) {
                                                    __auto_type start_expr = _mv_741.value;
                                                    __auto_type _mv_742 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_742.has_value) {
                                                        __auto_type end_expr = _mv_742.value;
                                                        {
...
void match_emit_inline_for_each_map_kv(context_TranspileContext* ctx, slop_list_types_SExpr_ptr binding_items, slop_list_types_SExpr_ptr items, int64_t len) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_743 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        if (_mv_743.has_value) {
            __auto_type kv_list_expr = _mv_743.value;
            __auto_type _mv_744 = (*kv_list_expr);
            switch (_mv_744.tag) {
                case types_SExpr_lst:
                {
                    __auto_type kv_lst = _mv_744.data.lst;
                    {
                        __auto_type kv_items = kv_lst.items;
                        if ((((int64_t)((kv_items).len)) < 2)) {
                            context_ctx_add_error(ctx, SLOP_STR("Map for-each needs ((k v) map)"));
                        } else {
                            __auto_type _mv_745 = ({ __auto_type _lst = kv_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_745.has_value) {
                                __auto_type k_expr = _mv_745.value;
                                __auto_type _mv_746 = ({ __auto_type _lst = kv_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_746.has_value) {
                                    __auto_type v_expr = _mv_746.value;
                                    __auto_type _mv_747 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    if (_mv_747.has_value) {
                                        __auto_type map_expr = _mv_747.value;
                                        __auto_type _mv_748 = (*k_expr);
                                        switch (_mv_748.tag) {
                                            case types_SExpr_sym:
                                            {
                                                __auto_type k_sym = _mv_748.data.sym;
                                                __auto_type _mv_749 = (*v_expr);
                                                switch (_mv_749.tag) {
                                                    case types_SExpr_sym:
                                                    {
                                                        __auto_type v_sym = _mv_749.data.sym;
                                                        {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len < 2)) {
            ...
            if (_mv_750.has_value) {
                __auto_type binding_expr = _mv_750.value;
                __auto_type _mv_751 = (*binding_expr);
                switch (_mv_751.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type binding_lst = _mv_751.data.lst;
                        {
                            __auto_type binding_items = binding_lst.items;
                            __auto_type binding_len = ((int64_t)((binding_items).len));
                            if ((binding_len < 2)) {
                                ...
                                if (_mv_752.has_value) {
                                    __auto_type first_elem = _mv_752.value;
                                    __auto_type _mv_753 = (*first_elem);
                                    switch (_mv_753.tag) {
                                        case types_SExpr_lst:
                                        {
                                            __auto_type _ = _mv_753.data.lst;
                                            match_emit_inline_for_each_map_kv(ctx, binding_items, items, len);
                                            break;
                                        }
                                        case types_SExpr_sym:
                                        {
                                            __auto_type var_sym = _mv_753.data.sym;
                                            {
                                                __auto_type var_name = ctype_to_c_name(arena, var_sym.name);
                                                __auto_type _mv_754 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_754.has_value) {
                                                    __auto_type coll_expr = _mv_754.value;
                                                    {
...
void match_emit_inline_return(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len < 2)) {
            ...
            __auto_type _mv_755 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_755.has_value) {
                __auto_type val_expr = _mv_755.value;
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_756.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    __auto_type _mv_757 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_757.has_value) {
                        __auto_type head = _mv_757.value;
                        __auto_type _mv_758 = (*head);
                        switch (_mv_758.tag) {
                            case types_SExpr_sym:
                            {
                                __auto_type sym = _mv_758.data.sym;
                                {
                                    __auto_type op = sym.name;
                                    if (string_eq(op, SLOP_STR("some"))) {
                                        __auto_type _mv_759 = context_ctx_get_current_return_type(ctx);
                                        if (_mv_759.has_value) {
                                            __auto_type ret_type = _mv_759.value;
                                            if (strlib_starts_with(ret_type, SLOP_STR("slop_option_"))) {
                                                if ((((int64_t)((items).len)) < 2)) {
                                                    match_emit_return_typed(ctx, expr_transpile_expr(ctx, expr));
                                                } else {
                                                    ...
                                                    if (_mv_760.has_value) {
                                                        __auto_type inner_expr = _mv_760.value;
                                                        {
                                                            __auto_type inner_c = expr_transpile_expr(ctx, inner_expr);
                                        ...
                                        __auto_type _mv_761 = context_ctx_get_current_return_type(ctx);
                                        if (_mv_761.has_value) {
                                            __auto_type ret_type = _mv_761.value;
                                            if (strlib_starts_with(ret_type, SLOP_STR("slop_option_"))) {
