...
uint8_t match_is_option_match(slop_list_types_SExpr_ptr patterns) {
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_667 = ({ __auto_type _lst = patterns; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_667.has_value) {
                __auto_type pat_expr = _mv_667.value;
                {
...
uint8_t match_is_result_match(slop_list_types_SExpr_ptr patterns) {
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_668 = ({ __auto_type _lst = patterns; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_668.has_value) {
                __auto_type pat_expr = _mv_668.value;
                {
                    __auto_type tag = match_get_pattern_tag(pat_expr);
...
uint8_t match_is_enum_match(slop_list_types_SExpr_ptr patterns) {
    {
        ...
        while ((i < len) && all_symbols) {
            __auto_type _mv_669 = ({ __auto_type _lst = patterns; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_669.has_value) {
                __auto_type pat_expr = _mv_669.value;
                __auto_type _mv_670 = (*pat_expr);
                switch (_mv_670.tag) {
...
uint8_t match_is_literal_match(slop_list_types_SExpr_ptr patterns) {
    {
        ...
        while ((i < len) && !(has_literal)) {
            __auto_type _mv_671 = ({ __auto_type _lst = patterns; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_671.has_value) {
                __auto_type pat_expr = _mv_671.value;
                __auto_type _mv_672 = (*pat_expr);
                switch (_mv_672.tag) {
                    case types_SExpr_num:
                    {
                        __auto_type _ = _mv_672.data.num;
                        has_literal = 1;
                        break;
                    }
                    case types_SExpr_str:
                    {
                        __auto_type _ = _mv_672.data.str;
                        has_literal = 1;
                        break;
                    }
                    default: {
...
uint8_t match_is_union_match(context_TranspileContext* ctx, slop_list_types_SExpr_ptr patterns) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while ((i < len) && !(has_union_variant)) {
            __auto_type _mv_673 = ({ __auto_type _lst = patterns; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_673.has_value) {
                __auto_type pat_expr = _mv_673.value;
                {
                    __auto_type tag = match_get_pattern_tag(pat_expr);
                    if ((!(string_eq(tag, SLOP_STR("")))) && (!(string_eq(tag, SLOP_STR("some")))) && (!(string_eq(tag, SLOP_STR("none")))) && (!(string_eq(tag, SLOP_STR("ok")))) && (!(string_eq(tag, SLOP_STR("error")))) && (!(string_eq(tag, SLOP_STR("else")))) && (!(string_eq(tag, SLOP_STR("_"))))) {
                        __auto_type _mv_674 = context_ctx_lookup_enum_variant(ctx, tag);
...
slop_string match_get_pattern_tag(types_SExpr* pat_expr) {
    ...
    switch (_mv_675.tag) {
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_675.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 1) {
                    ...
                    __auto_type _mv_676 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_676.has_value) {
                        __auto_type head = _mv_676.value;
                        __auto_type _mv_677 = (*head);
                        switch (_mv_677.tag) {
                            case types_SExpr_sym:
                            {
        ...
        case types_SExpr_sym:
        {
            __auto_type sym = _mv_675.data.sym;
            return sym.name;
        }
        default: {
            return SLOP_STR("");
            ...
            __auto_type lst = _mv_678.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 2) {
                    ...
                    if (_mv_679.has_value) {
                        __auto_type binding = _mv_679.value;
                        __auto_type _mv_680 = (*binding);
                        switch (_mv_680.tag) {
                            case types_SExpr_sym:
                            {
                ...
                __auto_type lst = _mv_682.data.lst;
                {
                    ...
                    if (len < 3) {
                        ...
                        if (_mv_683.has_value) {
                            __auto_type scrutinee = _mv_683.value;
                            {
...
void match_transpile_option_match(context_TranspileContext* ctx, slop_string scrutinee_c, types_SExpr* scrutinee_expr, slop_list_types_SExpr_ptr patterns, slop_list_types_SExpr_ptr items, uint8_t is_return) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        uint8_t has_else = 0;
        while (i < len) {
            __auto_type _mv_687 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_687.has_value) {
                __auto_type branch = _mv_687.value;
                __auto_type _mv_688 = (*branch);
                switch (_mv_688.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type branch_lst = _mv_688.data.lst;
                        {
                            __auto_type branch_items = branch_lst.items;
                            if (((int64_t)((branch_items).len)) >= 2) {
                                __auto_type _mv_689 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_689.has_value) {
                                    __auto_type pattern = _mv_689.value;
                                    {
...
void match_emit_option_some_branch(context_TranspileContext* ctx, slop_string scrutinee_c, types_SExpr* scrutinee_expr, types_SExpr* pattern, slop_list_types_SExpr_ptr branch_items, uint8_t is_return, uint8_t first) {
    ...
    SLOP_PRE(((pattern != NULL)), "(!= pattern nil)");
    {
        ...
        __auto_type _mv_690 = match_extract_binding_name(pattern);
        if (_mv_690.has_value) {
            __auto_type binding_name = _mv_690.value;
            {
...
void match_emit_result_ok_branch(context_TranspileContext* ctx, slop_string scrutinee_c, types_SExpr* scrutinee_expr, types_SExpr* pattern, slop_list_types_SExpr_ptr branch_items, uint8_t is_return, uint8_t first) {
    ...
    SLOP_PRE(((pattern != NULL)), "(!= pattern nil)");
    {
        ...
        context_ctx_indent(ctx);
        context_ctx_push_scope(ctx);
        __auto_type _mv_694 = match_extract_binding_name(pattern);
        if (_mv_694.has_value) {
            __auto_type binding_name = _mv_694.value;
            {
                __auto_type c_name = ctype_to_c_name(arena, binding_name);
...
void match_emit_result_error_branch(context_TranspileContext* ctx, slop_string scrutinee_c, types_SExpr* scrutinee_expr, types_SExpr* pattern, slop_list_types_SExpr_ptr branch_items, uint8_t is_return, uint8_t first) {
    ...
    SLOP_PRE(((pattern != NULL)), "(!= pattern nil)");
    {
        ...
        context_ctx_indent(ctx);
        context_ctx_push_scope(ctx);
        __auto_type _mv_695 = match_extract_binding_name(pattern);
        if (_mv_695.has_value) {
            __auto_type binding_name = _mv_695.value;
            {
                __auto_type c_name = ctype_to_c_name(arena, binding_name);
...
void match_emit_enum_case(context_TranspileContext* ctx, types_SExpr* pattern, slop_list_types_SExpr_ptr branch_items, uint8_t is_return) {
    ...
    SLOP_PRE(((pattern != NULL)), "(!= pattern nil)");
    {
        ...
        if (string_eq(tag, SLOP_STR("else")) || string_eq(tag, SLOP_STR("_"))) {
            ...
            __auto_type _mv_699 = context_ctx_lookup_enum_variant(ctx, tag);
            if (_mv_699.has_value) {
                __auto_type type_name = _mv_699.value;
                {
    ...
    } else {
        {
            ...
            while (i < len) {
                ...
                if (_mv_703.has_value) {
                    __auto_type branch = _mv_703.value;
                    __auto_type _mv_704 = (*branch);
                    switch (_mv_704.tag) {
                        case types_SExpr_lst:
                        {
                            __auto_type branch_lst = _mv_704.data.lst;
                            {
                                __auto_type branch_items = branch_lst.items;
                                if (((int64_t)((branch_items).len)) >= 2) {
                                    __auto_type _mv_705 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    if (_mv_705.has_value) {
                                        __auto_type pattern = _mv_705.value;
                                        {
                                            __auto_type tag = match_get_pattern_tag(pattern);
                                            if (string_eq(tag, SLOP_STR("else")) || string_eq(tag, SLOP_STR("_"))) {
                                                has_else = 1;
                                                ...
                                                __auto_type _mv_706 = context_ctx_lookup_enum_variant(ctx, tag);
                                                if (_mv_706.has_value) {
                                                    __auto_type union_type_name = _mv_706.value;
    ...
    SLOP_PRE(((pattern != NULL)), "(!= pattern nil)");
    {
        ...
        context_ctx_push_scope(ctx);
        {
            ...
            if (!(string_eq(multi_field_count, SLOP_STR("")))) {
                __auto_type _mv_707 = (*pattern);
                switch (_mv_707.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type pat_lst = _mv_707.data.lst;
                        {
                            __auto_type pat_items = pat_lst.items;
                            __auto_type pat_len = ((int64_t)((pat_items).len));
                            for (int64_t bi = 1; bi < pat_len; bi++) {
                                __auto_type _mv_708 = ({ __auto_type _lst = pat_items; size_t _idx = (size_t)bi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_708.has_value) {
                                    __auto_type binding_expr = _mv_708.value;
                                    {
                ...
                __auto_type _mv_709 = match_extract_binding_name(pattern);
                if (_mv_709.has_value) {
                    __auto_type binding_name = _mv_709.value;
                    {
                        __auto_type c_binding = ctype_to_c_name(arena, binding_name);
...
void match_emit_branch_body(context_TranspileContext* ctx, slop_list_types_SExpr_ptr branch_items, uint8_t is_return) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 1;
        while (i < len) {
            __auto_type _mv_710 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_710.has_value) {
                __auto_type body_expr = _mv_710.value;
                {
                ...
                __auto_type lst = _mv_711.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) < 1) {
                        ...
                        if (_mv_712.has_value) {
                            __auto_type head_expr = _mv_712.value;
                            __auto_type _mv_713 = (*head_expr);
                            switch (_mv_713.tag) {
                                case types_SExpr_sym:
                                {
...
void match_emit_inline_let(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items, uint8_t is_return, uint8_t is_last) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 2) {
            ...
            context_ctx_indent(ctx);
            context_ctx_push_scope(ctx);
            __auto_type _mv_714 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_714.has_value) {
                __auto_type bindings_expr = _mv_714.value;
            ...
            }
            {
                ...
                while (i < len) {
                    ...
                    if (_mv_715.has_value) {
                        __auto_type body_item = _mv_715.value;
                        {
...
void match_emit_inline_bindings(context_TranspileContext* ctx, types_SExpr* bindings_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_716 = (*bindings_expr);
        switch (_mv_716.tag) {
            case types_SExpr_lst:
            {
                __auto_type bindings_lst = _mv_716.data.lst;
                {
                    __auto_type bindings = bindings_lst.items;
                    __auto_type len = ((int64_t)((bindings).len));
                    __auto_type i = 0;
                    while (i < len) {
                        __auto_type _mv_717 = ({ __auto_type _lst = bindings; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_717.has_value) {
                            __auto_type binding = _mv_717.value;
...
void match_emit_single_inline_binding(context_TranspileContext* ctx, types_SExpr* binding) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_718 = (*binding);
        switch (_mv_718.tag) {
            case types_SExpr_lst:
            {
                __auto_type binding_lst = _mv_718.data.lst;
                {
                    ...
                    __auto_type len = ((int64_t)((items).len));
                    {
                        ...
                        if ((len - start_idx) < 2) {
                            ...
                            __auto_type _mv_719 = ({ __auto_type _lst = items; size_t _idx = (size_t)start_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_719.has_value) {
                                __auto_type name_expr = _mv_719.value;
                                __auto_type _mv_720 = (*name_expr);
                                switch (_mv_720.tag) {
                                    case types_SExpr_sym:
                                    {
                                        __auto_type name_sym = _mv_720.data.sym;
                                        {
                                            ...
                                            if ((len - start_idx) >= 3) {
                                                {
                                                    ...
                                                    __auto_type _mv_721 = ({ __auto_type _lst = items; size_t _idx = (size_t)type_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_721.has_value) {
                                                        __auto_type type_expr = _mv_721.value;
                                                        if (match_is_type_expr(type_expr)) {
                                                            __auto_type _mv_722 = ({ __auto_type _lst = items; size_t _idx = (size_t)val_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                            if (_mv_722.has_value) {
                                                                __auto_type val_expr = _mv_722.value;
                                                                {
                                                            ...
                                                            __auto_type _mv_723 = ({ __auto_type _lst = items; size_t _idx = (size_t)type_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                            if (_mv_723.has_value) {
                                                                __auto_type val_expr = _mv_723.value;
                                                                {
                                                                    ...
                                                                    __auto_type _mv_724 = ptr_type_opt;
                                                                    if (_mv_724.has_value) {
                                                                        __auto_type ptr_type = _mv_724.value;
                                            ...
                                            } else {
                                                {
                                                    ...
                                                    __auto_type _mv_725 = ({ __auto_type _lst = items; size_t _idx = (size_t)val_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_725.has_value) {
                                                        __auto_type val_expr = _mv_725.value;
                                                        {
                                                            __auto_type val_c = expr_transpile_expr(ctx, val_expr);
                                                            __auto_type inferred_slop_type = expr_infer_expr_slop_type(ctx, val_expr);
                                                            __auto_type ptr_type_opt = match_get_arena_alloc_ptr_type_inline(ctx, val_expr);
                                                            __auto_type _mv_726 = ptr_type_opt;
                                                            if (_mv_726.has_value) {
                                                                __auto_type ptr_type = _mv_726.value;
                                                                context_ctx_emit(ctx, context_ctx_str4(ctx, SLOP_STR("__auto_type "), c_name, SLOP_STR(" = "), context_ctx_str(ctx, val_c, SLOP_STR(";"))));
                                                                context_ctx_bind_var(ctx, (context_VarEntry){raw_name, c_name, ptr_type, inferred_slop_type, 1, has_mut, 0, SLOP_STR(""), SLOP_STR("")});
...
uint8_t match_is_type_expr(types_SExpr* expr) {
    ...
    switch (_mv_729.tag) {
        ...
        case types_SExpr_lst:
        {
            __auto_type _ = _mv_729.data.lst;
            return 1;
        }
        default: {
            return 0;
...
uint8_t match_is_none_form_inline(types_SExpr* expr) {
    ...
    switch (_mv_730.tag) {
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_730.data.lst;
            {
                __auto_type items = lst.items;
                if (((int64_t)((items).len)) == 1) {
                    __auto_type _mv_731 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_731.has_value) {
                        __auto_type head = _mv_731.value;
                        __auto_type _mv_732 = (*head);
                        switch (_mv_732.tag) {
                            case types_SExpr_sym:
                            {
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_733.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) >= 3) {
                        __auto_type _mv_734 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_734.has_value) {
                            __auto_type head_ptr = _mv_734.value;
                            __auto_type _mv_735 = (*head_ptr);
                            switch (_mv_735.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type head_sym = _mv_735.data.sym;
                                    if (string_eq(head_sym.name, SLOP_STR("arena-alloc"))) {
                                        __auto_type _mv_736 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_736.has_value) {
                                            __auto_type size_expr = _mv_736.value;
        ...
        switch (_mv_737.tag) {
            case types_SExpr_sym:
            {
                __auto_type sym = _mv_737.data.sym;
                {
                    ...
                    __auto_type _mv_738 = context_ctx_lookup_type(ctx, type_name);
                    if (_mv_738.has_value) {
                        __auto_type entry = _mv_738.value;
                ...
                __auto_type lst = _mv_737.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) >= 2) {
                        ...
                        if (_mv_739.has_value) {
                            __auto_type head_ptr = _mv_739.value;
                            __auto_type _mv_740 = (*head_ptr);
                            switch (_mv_740.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type head_sym = _mv_740.data.sym;
                                    if (string_eq(head_sym.name, SLOP_STR("sizeof"))) {
                                        ...
                                        if (_mv_741.has_value) {
                                            __auto_type type_expr = _mv_741.value;
                                            {
                                                __auto_type c_type = context_to_c_type_prefixed(ctx, type_expr);
...
void match_emit_inline_do(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items, uint8_t is_return, uint8_t is_last) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 1;
        while (i < len) {
            __auto_type _mv_742 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_742.has_value) {
                __auto_type item = _mv_742.value;
                {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 3) {
            ...
            if (len >= 4) {
                context_ctx_emit(ctx, SLOP_STR("} else {"));
                context_ctx_indent(ctx);
                __auto_type _mv_745 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 3) {
            ...
            if (_mv_746.has_value) {
                __auto_type cond_expr = _mv_746.value;
                {
                    __auto_type cond_c = context_ctx_strip_cond_parens(ctx, expr_transpile_expr(ctx, cond_expr));
...
slop_option_string match_get_var_c_type_inline(context_TranspileContext* ctx, types_SExpr* expr) {
    ...
    switch (_mv_747.tag) {
        case types_SExpr_sym:
        {
            ...
            {
                __auto_type name = sym.name;
                __auto_type _mv_748 = context_ctx_lookup_var(ctx, name);
                if (_mv_748.has_value) {
                    __auto_type var_entry = _mv_748.value;
        ...
        switch (_mv_749.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_749.data.lst;
                {
                    __auto_type items = lst.items;
                    if (((int64_t)((items).len)) >= 2) {
                        __auto_type _mv_750 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (expr_set_is_self_assign(items)) {
            ...
            if (_mv_753.has_value) {
                ...
                __auto_type _mv_754 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_754.has_value) {
                    __auto_type field_expr = _mv_754.value;
                    __auto_type _mv_755 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_755.has_value) {
                        __auto_type type_expr = _mv_755.value;
                        __auto_type _mv_756 = ({ __auto_type _lst = items; size_t _idx = (size_t)4; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_756.has_value) {
                            __auto_type value_expr = _mv_756.value;
                            {
                                ...
                                __auto_type c_type = ctype_to_c_type(arena, type_expr);
                                {
                                    ...
                                    if (context_ctx_is_option_c_type(ctx, c_type)) {
                                        if (match_is_none_form_inline(value_expr)) {
                                            ...
                                            __auto_type _mv_757 = match_get_some_value_inline(value_expr);
                                            if (_mv_757.has_value) {
                                                __auto_type inner_val = _mv_757.value;
                                                {
            ...
            if (_mv_758.has_value) {
                __auto_type target_expr = _mv_758.value;
                __auto_type _mv_759 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_759.has_value) {
                    __auto_type field_expr = _mv_759.value;
                    __auto_type _mv_760 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_760.has_value) {
                        __auto_type value_expr = _mv_760.value;
                        {
                            __auto_type field_name = match_get_field_name_inline(ctx, field_expr);
                ...
                if (_mv_762.has_value) {
                    __auto_type val_expr = _mv_762.value;
                    {
                        ...
                        if (_mv_763.has_value) {
                            ...
                            {
                                __auto_type some_val_opt = match_get_some_value_inline(val_expr);
                                __auto_type _mv_765 = some_val_opt;
                                if (_mv_765.has_value) {
                                    __auto_type inner_expr = _mv_765.value;
                                    {
                                        __auto_type inner_c = expr_transpile_expr(ctx, inner_expr);
                                    ...
                                    if (match_is_none_form_inline(val_expr)) {
                                        __auto_type _mv_766 = context_ctx_get_current_return_type(ctx);
                                        if (_mv_766.has_value) {
                                            __auto_type ret_type = _mv_766.value;
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_767.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 2) {
                    ...
                    __auto_type _mv_768 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_768.has_value) {
                        __auto_type head = _mv_768.value;
                        __auto_type _mv_769 = (*head);
                        switch (_mv_769.tag) {
                            case types_SExpr_sym:
                            {
                                __auto_type sym = _mv_769.data.sym;
...
slop_string match_get_deref_inner_inline(context_TranspileContext* ctx, types_SExpr* expr) {
    SLOP_PRE(((expr != NULL)), "(!= expr nil)");
    __auto_type _mv_770 = (*expr);
    switch (_mv_770.tag) {
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_770.data.lst;
            {
                __auto_type items = lst.items;
                __auto_type _mv_771 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_771.has_value) {
                    __auto_type inner = _mv_771.value;
...
void match_emit_inline_when(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 2) {
            ...
            __auto_type _mv_773 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_773.has_value) {
                __auto_type cond_expr = _mv_773.value;
                {
                    __auto_type cond_c = context_ctx_strip_cond_parens(ctx, expr_transpile_expr(ctx, cond_expr));
                    context_ctx_emit(ctx, context_ctx_str3(ctx, SLOP_STR("if ("), cond_c, SLOP_STR(") {")));
                }
...
void match_emit_inline_cond(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items, uint8_t is_return, uint8_t is_last) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        uint8_t has_else = 0;
        while (i < len) {
            __auto_type _mv_774 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_774.has_value) {
                __auto_type clause_expr = _mv_774.value;
                __auto_type _mv_775 = (*clause_expr);
                switch (_mv_775.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type clause_lst = _mv_775.data.lst;
                        {
                            ...
                            if (clause_len < 1) {
                                ...
                                __auto_type _mv_776 = ({ __auto_type _lst = clause_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_776.has_value) {
                                    __auto_type test_expr = _mv_776.value;
                                    __auto_type _mv_777 = (*test_expr);
                                    switch (_mv_777.tag) {
                                        case types_SExpr_sym:
                                        {
        ...
        if (len < 2) {
        ...
        } else {
            {
                ...
                if (is_named && (len < 4)) {
                    ...
                    context_ctx_indent(ctx);
                    context_ctx_push_scope(ctx);
                    __auto_type _mv_779 = ({ __auto_type _lst = items; size_t _idx = (size_t)size_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_779.has_value) {
                        __auto_type size_expr = _mv_779.value;
                        {
...
void match_emit_inline_body_items(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items, int64_t start) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = start;
        while (i < len) {
            __auto_type _mv_781 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 2) {
            ...
            if (_mv_782.has_value) {
                __auto_type binding_expr = _mv_782.value;
                __auto_type _mv_783 = (*binding_expr);
                switch (_mv_783.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type binding_lst = _mv_783.data.lst;
                        {
                            ...
                            if (binding_len < 3) {
                                ...
                                __auto_type _mv_784 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_784.has_value) {
                                    __auto_type var_expr = _mv_784.value;
                                    __auto_type _mv_785 = (*var_expr);
                                    switch (_mv_785.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type var_sym = _mv_785.data.sym;
                                            {
                                                __auto_type var_name = ctype_to_c_name(arena, var_sym.name);
                                                __auto_type _mv_786 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_786.has_value) {
                                                    __auto_type start_expr = _mv_786.value;
                                                    __auto_type _mv_787 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_787.has_value) {
                                                        __auto_type end_expr = _mv_787.value;
                                                        {
...
void match_emit_inline_for_each_map_kv(context_TranspileContext* ctx, slop_list_types_SExpr_ptr binding_items, slop_list_types_SExpr_ptr items, int64_t len) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_788 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        if (_mv_788.has_value) {
            __auto_type kv_list_expr = _mv_788.value;
            __auto_type _mv_789 = (*kv_list_expr);
            switch (_mv_789.tag) {
                case types_SExpr_lst:
                {
                    __auto_type kv_lst = _mv_789.data.lst;
                    {
                        __auto_type kv_items = kv_lst.items;
                        if (((int64_t)((kv_items).len)) < 2) {
                            context_ctx_add_error(ctx, SLOP_STR("Map for-each needs ((k v) map)"));
                        } else {
                            __auto_type _mv_790 = ({ __auto_type _lst = kv_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_790.has_value) {
                                __auto_type k_expr = _mv_790.value;
                                __auto_type _mv_791 = ({ __auto_type _lst = kv_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_791.has_value) {
                                    __auto_type v_expr = _mv_791.value;
                                    __auto_type _mv_792 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    if (_mv_792.has_value) {
                                        __auto_type map_expr = _mv_792.value;
                                        __auto_type _mv_793 = (*k_expr);
                                        switch (_mv_793.tag) {
                                            case types_SExpr_sym:
                                            {
                                                __auto_type k_sym = _mv_793.data.sym;
                                                __auto_type _mv_794 = (*v_expr);
                                                switch (_mv_794.tag) {
                                                    case types_SExpr_sym:
                                                    {
                                                        __auto_type v_sym = _mv_794.data.sym;
                                                        {
...
void match_emit_inline_for_each(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 2) {
            ...
            __auto_type _mv_795 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_795.has_value) {
                __auto_type binding_expr = _mv_795.value;
                __auto_type _mv_796 = (*binding_expr);
                switch (_mv_796.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type binding_lst = _mv_796.data.lst;
                        {
                            __auto_type binding_items = binding_lst.items;
                            __auto_type binding_len = ((int64_t)((binding_items).len));
                            if (binding_len < 2) {
                                ...
                                if (_mv_797.has_value) {
                                    __auto_type first_elem = _mv_797.value;
                                    __auto_type _mv_798 = (*first_elem);
                                    switch (_mv_798.tag) {
                                        case types_SExpr_lst:
                                        {
                                            __auto_type _ = _mv_798.data.lst;
                                            match_emit_inline_for_each_map_kv(ctx, binding_items, items, len);
                                            break;
                                        }
                                        case types_SExpr_sym:
                                        {
                                            __auto_type var_sym = _mv_798.data.sym;
                                            {
                                                __auto_type var_name = ctype_to_c_name(arena, var_sym.name);
                                                __auto_type _mv_799 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_799.has_value) {
                                                    __auto_type coll_expr = _mv_799.value;
                                                    {
...
void match_emit_inline_return(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 2) {
            ...
            __auto_type _mv_800 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            ...
                            case types_SExpr_sym:
                            {
                                __auto_type sym = _mv_803.data.sym;
                                {
                                    ...
                                    if (string_eq(op, SLOP_STR("some"))) {
                                        __auto_type _mv_804 = context_ctx_get_current_return_type(ctx);
                                        if (_mv_804.has_value) {
                                            __auto_type ret_type = _mv_804.value;
                                            if (context_ctx_is_option_c_type(ctx, ret_type)) {
                                                if (((int64_t)((items).len)) < 2) {
                                                    match_emit_return_typed(ctx, expr_transpile_expr(ctx, expr));
                                                } else {
                                                    ...
                                                    if (_mv_805.has_value) {
                                                        __auto_type inner_expr = _mv_805.value;
                                                        {
                                                            __auto_type inner_c = expr_transpile_expr(ctx, inner_expr);
                                        ...
                                        __auto_type _mv_806 = context_ctx_get_current_return_type(ctx);
                                        if (_mv_806.has_value) {
                                            __auto_type ret_type = _mv_806.value;
                                            if (context_ctx_is_option_c_type(ctx, ret_type)) {
...
uint8_t match_is_pattern_literal(types_SExpr* expr) {
    ...
    switch (_mv_807.tag) {
        ...
        case types_SExpr_num:
        {
            __auto_type _ = _mv_807.data.num;
            return 1;
        }
        default: {
            return 0;
...
slop_string match_pattern_literal_to_c(types_SExpr* expr) {
    ...
    switch (_mv_808.tag) {
        ...
        case types_SExpr_num:
        {
            __auto_type n = _mv_808.data.num;
            return n.raw;
        }
        default: {
            return SLOP_STR("");
                ...
                for (int64_t i = 1; i < len; i++) {
                    if (!(found)) {
                        ...
                        if (_mv_810.has_value) {
                            __auto_type item = _mv_810.value;
...
uint8_t match_has_literal_in_patterns(slop_list_types_SExpr_ptr patterns) {
    {
        ...
        int64_t i = 0;
        while ((i < len) && !(found)) {
            __auto_type _mv_811 = ({ __auto_type _lst = patterns; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_811.has_value) {
                __auto_type pat_expr = _mv_811.value;
...
slop_string match_build_literal_guard_cond(context_TranspileContext* ctx, slop_string scrutinee_c, slop_string c_tag, slop_string tag_cond, types_SExpr* pattern, uint8_t is_multi) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_812 = (*pattern);
        switch (_mv_812.tag) {
            case types_SExpr_lst:
            {
                __auto_type pat_lst = _mv_812.data.lst;
                {
                    __auto_type pat_items = pat_lst.items;
                    __auto_type pat_len = ((int64_t)((pat_items).len));
                    __auto_type cond = tag_cond;
                    for (int64_t bi = 1; bi < pat_len; bi++) {
                        __auto_type _mv_813 = ({ __auto_type _lst = pat_items; size_t _idx = (size_t)bi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_813.has_value) {
                            __auto_type item = _mv_813.value;
                            if (match_is_pattern_literal(item)) {
                                {
...
void match_emit_union_literal_bindings(context_TranspileContext* ctx, slop_string scrutinee_c, types_SExpr* pattern, slop_string tag, slop_string union_type_name, slop_string c_tag, uint8_t is_multi) {
    ...
    SLOP_PRE(((pattern != NULL)), "(!= pattern nil)");
    {
        __auto_type arena = (*ctx).arena;
        if (is_multi) {
            __auto_type _mv_814 = (*pattern);
            switch (_mv_814.tag) {
                case types_SExpr_lst:
                {
                    __auto_type pat_lst = _mv_814.data.lst;
                    {
                        __auto_type pat_items = pat_lst.items;
                        __auto_type pat_len = ((int64_t)((pat_items).len));
                        for (int64_t bi = 1; bi < pat_len; bi++) {
                            __auto_type _mv_815 = ({ __auto_type _lst = pat_items; size_t _idx = (size_t)bi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_815.has_value) {
                                __auto_type binding_expr = _mv_815.value;
            ...
            __auto_type _mv_816 = match_extract_binding_name(pattern);
            if (_mv_816.has_value) {
                __auto_type binding_name = _mv_816.value;
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_817.has_value) {
                __auto_type branch = _mv_817.value;
                __auto_type _mv_818 = (*branch);
                switch (_mv_818.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type branch_lst = _mv_818.data.lst;
                        {
                            __auto_type branch_items = branch_lst.items;
                            if (((int64_t)((branch_items).len)) >= 2) {
                                __auto_type _mv_819 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_819.has_value) {
                                    __auto_type pattern = _mv_819.value;
                                    {
                                        __auto_type tag = match_get_pattern_tag(pattern);
                                        if (string_eq(tag, SLOP_STR("else")) || string_eq(tag, SLOP_STR("_"))) {
                                            has_else = 1;
                                            ...
                                            __auto_type _mv_820 = context_ctx_lookup_enum_variant(ctx, tag);
                                            if (_mv_820.has_value) {
                                                __auto_type union_type_name = _mv_820.value;
                                                {
                                                    __auto_type c_tag = ctype_to_c_name(arena, tag);
