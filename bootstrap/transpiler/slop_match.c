...
uint8_t match_is_result_match(slop_list_types_SExpr_ptr patterns) {
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_644 = ({ __auto_type _lst = patterns; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_644.has_value) {
                __auto_type pat_expr = _mv_644.value;
                {
                    __auto_type tag = match_get_pattern_tag(pat_expr);
        ...
        while ((i < len) && all_symbols) {
            ...
            if (_mv_645.has_value) {
                ...
                switch (_mv_646.tag) {
                    ...
                    {
                        __auto_type _ = _mv_646.data.sym;
                        break;
                    }
                    default: {
                        all_symbols = 0;
        ...
        while ((i < len) && !(has_literal)) {
            ...
            if (_mv_647.has_value) {
                ...
                switch (_mv_648.tag) {
                    ...
                    {
                        __auto_type _ = _mv_648.data.num;
                        has_literal = 1;
                        break;
                    }
                    case types_SExpr_str:
                    {
                        __auto_type _ = _mv_648.data.str;
                        has_literal = 1;
                        break;
                    }
                    default: {
            ...
            if (_mv_649.has_value) {
                __auto_type pat_expr = _mv_649.value;
                {
                    ...
                    if ((!(string_eq(tag, SLOP_STR("")))) && (!(string_eq(tag, SLOP_STR("some")))) && (!(string_eq(tag, SLOP_STR("none")))) && (!(string_eq(tag, SLOP_STR("ok")))) && (!(string_eq(tag, SLOP_STR("error")))) && (!(string_eq(tag, SLOP_STR("else")))) && (!(string_eq(tag, SLOP_STR("_"))))) {
                        __auto_type _mv_650 = context_ctx_lookup_enum_variant(ctx, tag);
                        if (_mv_650.has_value) {
                            __auto_type _ = _mv_650.value;
                            has_union_variant = 1;
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_651.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 1) {
                    ...
                    __auto_type _mv_652 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_652.has_value) {
                        __auto_type head = _mv_652.value;
                        __auto_type _mv_653 = (*head);
                        switch (_mv_653.tag) {
                            case types_SExpr_sym:
                            {
            ...
            __auto_type lst = _mv_654.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 2) {
                    ...
                    if (_mv_655.has_value) {
                        __auto_type binding = _mv_655.value;
                        __auto_type _mv_656 = (*binding);
                        switch (_mv_656.tag) {
                            case types_SExpr_sym:
                            {
                ...
                __auto_type lst = _mv_658.data.lst;
                {
                    ...
                    if (len < 3) {
                        ...
                        if (_mv_659.has_value) {
                            __auto_type scrutinee = _mv_659.value;
                            {
...
void match_emit_result_error_branch(context_TranspileContext* ctx, slop_string scrutinee_c, types_SExpr* scrutinee_expr, types_SExpr* pattern, slop_list_types_SExpr_ptr branch_items, uint8_t is_return, uint8_t first) {
    ...
    SLOP_PRE(((pattern != NULL)), "(!= pattern nil)");
    {
        ...
        context_ctx_indent(ctx);
        context_ctx_push_scope(ctx);
        __auto_type _mv_671 = match_extract_binding_name(pattern);
        if (_mv_671.has_value) {
            __auto_type binding_name = _mv_671.value;
            {
                __auto_type c_name = ctype_to_c_name(arena, binding_name);
...
void match_emit_enum_case(context_TranspileContext* ctx, types_SExpr* pattern, slop_list_types_SExpr_ptr branch_items, uint8_t is_return) {
    ...
    SLOP_PRE(((pattern != NULL)), "(!= pattern nil)");
    {
        ...
        if (string_eq(tag, SLOP_STR("else")) || string_eq(tag, SLOP_STR("_"))) {
            ...
            __auto_type _mv_675 = context_ctx_lookup_enum_variant(ctx, tag);
            if (_mv_675.has_value) {
                __auto_type type_name = _mv_675.value;
                {
                                        ...
                                        __auto_type pattern = _mv_681.value;
                                        {
                                            ...
                                            if (string_eq(tag, SLOP_STR("else")) || string_eq(tag, SLOP_STR("_"))) {
                                                ...
                                                if (_mv_682.has_value) {
                                                    __auto_type union_type_name = _mv_682.value;
    ...
    SLOP_PRE(((pattern != NULL)), "(!= pattern nil)");
    {
        ...
        context_ctx_push_scope(ctx);
        {
            ...
            if (!(string_eq(multi_field_count, SLOP_STR("")))) {
                __auto_type _mv_683 = (*pattern);
                switch (_mv_683.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type pat_lst = _mv_683.data.lst;
                        {
                            __auto_type pat_items = pat_lst.items;
                            __auto_type pat_len = ((int64_t)((pat_items).len));
                            for (int64_t bi = 1; bi < pat_len; bi++) {
                                __auto_type _mv_684 = ({ __auto_type _lst = pat_items; size_t _idx = (size_t)bi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_684.has_value) {
                                    __auto_type binding_expr = _mv_684.value;
                                    {
...
void match_emit_branch_body(context_TranspileContext* ctx, slop_list_types_SExpr_ptr branch_items, uint8_t is_return) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 1;
        while (i < len) {
            __auto_type _mv_686 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_686.has_value) {
                __auto_type body_expr = _mv_686.value;
                {
                ...
                __auto_type lst = _mv_687.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) < 1) {
                        ...
                        if (_mv_688.has_value) {
                            __auto_type head_expr = _mv_688.value;
                            __auto_type _mv_689 = (*head_expr);
                            switch (_mv_689.tag) {
                                case types_SExpr_sym:
                                {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 2) {
            ...
            if (_mv_690.has_value) {
                __auto_type bindings_expr = _mv_690.value;
            ...
            }
            {
                ...
                while (i < len) {
                    ...
                    if (_mv_691.has_value) {
                        __auto_type body_item = _mv_691.value;
                        {
...
void match_emit_inline_bindings(context_TranspileContext* ctx, types_SExpr* bindings_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_692 = (*bindings_expr);
        switch (_mv_692.tag) {
            case types_SExpr_lst:
            {
                __auto_type bindings_lst = _mv_692.data.lst;
                {
                    __auto_type bindings = bindings_lst.items;
                    __auto_type len = ((int64_t)((bindings).len));
                    __auto_type i = 0;
                    while (i < len) {
                        __auto_type _mv_693 = ({ __auto_type _lst = bindings; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_693.has_value) {
                            __auto_type binding = _mv_693.value;
...
void match_emit_single_inline_binding(context_TranspileContext* ctx, types_SExpr* binding) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_694 = (*binding);
        switch (_mv_694.tag) {
            case types_SExpr_lst:
            {
                __auto_type binding_lst = _mv_694.data.lst;
                {
                    ...
                    __auto_type len = ((int64_t)((items).len));
                    {
                        ...
                        if ((len - start_idx) < 2) {
                            ...
                            __auto_type _mv_695 = ({ __auto_type _lst = items; size_t _idx = (size_t)start_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            ...
                                            if ((len - start_idx) >= 3) {
                                                {
                                                    ...
                                                    if (_mv_697.has_value) {
                                                        ...
                                                        if (match_is_type_expr(type_expr)) {
                                                            __auto_type _mv_698 = ({ __auto_type _lst = items; size_t _idx = (size_t)val_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                            if (_mv_698.has_value) {
                                                                __auto_type val_expr = _mv_698.value;
                                                                {
...
uint8_t match_is_type_expr(types_SExpr* expr) {
    ...
    switch (_mv_705.tag) {
        ...
        case types_SExpr_lst:
        {
            __auto_type _ = _mv_705.data.lst;
            return 1;
        }
        default: {
            return 0;
                            ...
                            switch (_mv_711.tag) {
                                case types_SExpr_sym:
                                {
                                    ...
                                    if (string_eq(head_sym.name, SLOP_STR("arena-alloc"))) {
                                        __auto_type _mv_712 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void match_emit_inline_do(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items, uint8_t is_return, uint8_t is_last) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 1;
        while (i < len) {
            __auto_type _mv_718 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_718.has_value) {
                __auto_type item = _mv_718.value;
                {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 3) {
            ...
            if (_mv_719.has_value) {
                __auto_type cond_expr = _mv_719.value;
                {
            ...
            if (_mv_720.has_value) {
                __auto_type then_expr = _mv_720.value;
            ...
            if (len >= 4) {
                context_ctx_emit(ctx, SLOP_STR("} else {"));
                context_ctx_indent(ctx);
                __auto_type _mv_721 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_721.has_value) {
                    __auto_type else_expr = _mv_721.value;
...
slop_option_string match_get_var_c_type_inline(context_TranspileContext* ctx, types_SExpr* expr) {
    ...
    switch (_mv_723.tag) {
        case types_SExpr_sym:
        {
            ...
            {
                __auto_type name = sym.name;
                __auto_type _mv_724 = context_ctx_lookup_var(ctx, name);
                if (_mv_724.has_value) {
                    __auto_type var_entry = _mv_724.value;
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (expr_set_is_self_assign(items)) {
            ...
            if (_mv_729.has_value) {
                __auto_type target_expr = _mv_729.value;
                __auto_type _mv_730 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_730.has_value) {
                    __auto_type field_expr = _mv_730.value;
                    __auto_type _mv_731 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_731.has_value) {
                        __auto_type type_expr = _mv_731.value;
                        __auto_type _mv_732 = ({ __auto_type _lst = items; size_t _idx = (size_t)4; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                ...
                                __auto_type c_type = ctype_to_c_type(arena, type_expr);
                                {
                                    ...
                                    if (strlib_starts_with(c_type, SLOP_STR("slop_option_"))) {
                                        if (match_is_none_form_inline(value_expr)) {
                                            ...
                                            __auto_type _mv_733 = match_get_some_value_inline(value_expr);
                                            if (_mv_733.has_value) {
                                                __auto_type inner_val = _mv_733.value;
                                                {
            ...
            if (_mv_734.has_value) {
                __auto_type target_expr = _mv_734.value;
                __auto_type _mv_735 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_735.has_value) {
                    __auto_type field_expr = _mv_735.value;
                    __auto_type _mv_736 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                ...
                if (_mv_738.has_value) {
                    __auto_type val_expr = _mv_738.value;
                    {
                        ...
                        if (_mv_739.has_value) {
                            ...
                            {
                                __auto_type some_val_opt = match_get_some_value_inline(val_expr);
                                __auto_type _mv_741 = some_val_opt;
                                if (_mv_741.has_value) {
                                    __auto_type inner_expr = _mv_741.value;
                                    {
                                        __auto_type inner_c = expr_transpile_expr(ctx, inner_expr);
                                    ...
                                    if (match_is_none_form_inline(val_expr)) {
                                        __auto_type _mv_742 = context_ctx_get_current_return_type(ctx);
                                        if (_mv_742.has_value) {
                                            __auto_type ret_type = _mv_742.value;
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_743.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 2) {
                    ...
                    __auto_type _mv_744 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_744.has_value) {
                        __auto_type head = _mv_744.value;
                        __auto_type _mv_745 = (*head);
                        switch (_mv_745.tag) {
                            case types_SExpr_sym:
                            {
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_746.data.lst;
            {
                ...
                if (_mv_747.has_value) {
                    __auto_type inner = _mv_747.value;
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_750.has_value) {
                __auto_type clause_expr = _mv_750.value;
                __auto_type _mv_751 = (*clause_expr);
                switch (_mv_751.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type clause_lst = _mv_751.data.lst;
                        {
                            ...
                            if (clause_len < 1) {
                                ...
                                __auto_type _mv_752 = ({ __auto_type _lst = clause_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_752.has_value) {
                                    __auto_type test_expr = _mv_752.value;
                                    __auto_type _mv_753 = (*test_expr);
                                    switch (_mv_753.tag) {
                                        case types_SExpr_sym:
                                        {
        ...
        if (len < 2) {
        ...
        } else {
            {
                ...
                if (is_named && (len < 4)) {
                    ...
                    context_ctx_indent(ctx);
                    context_ctx_push_scope(ctx);
                    __auto_type _mv_755 = ({ __auto_type _lst = items; size_t _idx = (size_t)size_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_755.has_value) {
                        __auto_type size_expr = _mv_755.value;
                        {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 2) {
            ...
            if (_mv_758.has_value) {
                __auto_type binding_expr = _mv_758.value;
                __auto_type _mv_759 = (*binding_expr);
                switch (_mv_759.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type binding_lst = _mv_759.data.lst;
                        {
                            ...
                            if (binding_len < 3) {
                                ...
                                if (_mv_760.has_value) {
                                    __auto_type var_expr = _mv_760.value;
                                    __auto_type _mv_761 = (*var_expr);
                                    switch (_mv_761.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type var_sym = _mv_761.data.sym;
                                            {
                                                __auto_type var_name = ctype_to_c_name(arena, var_sym.name);
                                                __auto_type _mv_762 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_762.has_value) {
                                                    __auto_type start_expr = _mv_762.value;
                                                    __auto_type _mv_763 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_763.has_value) {
                                                        __auto_type end_expr = _mv_763.value;
                                                        {
...
void match_emit_inline_for_each_map_kv(context_TranspileContext* ctx, slop_list_types_SExpr_ptr binding_items, slop_list_types_SExpr_ptr items, int64_t len) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (_mv_764.has_value) {
            __auto_type kv_list_expr = _mv_764.value;
            __auto_type _mv_765 = (*kv_list_expr);
            switch (_mv_765.tag) {
                case types_SExpr_lst:
                {
                    __auto_type kv_lst = _mv_765.data.lst;
                    {
                        __auto_type kv_items = kv_lst.items;
                        if (((int64_t)((kv_items).len)) < 2) {
                            context_ctx_add_error(ctx, SLOP_STR("Map for-each needs ((k v) map)"));
                        } else {
                            __auto_type _mv_766 = ({ __auto_type _lst = kv_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_766.has_value) {
                                __auto_type k_expr = _mv_766.value;
                                __auto_type _mv_767 = ({ __auto_type _lst = kv_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_767.has_value) {
                                    __auto_type v_expr = _mv_767.value;
                                    ...
                                    if (_mv_768.has_value) {
                                        __auto_type map_expr = _mv_768.value;
                                        __auto_type _mv_769 = (*k_expr);
                                        switch (_mv_769.tag) {
                                            case types_SExpr_sym:
                                            {
                                                __auto_type k_sym = _mv_769.data.sym;
                                                __auto_type _mv_770 = (*v_expr);
                                                switch (_mv_770.tag) {
                                                    case types_SExpr_sym:
                                                    {
                                                        __auto_type v_sym = _mv_770.data.sym;
                                                        {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 2) {
            ...
            if (_mv_771.has_value) {
                __auto_type binding_expr = _mv_771.value;
                __auto_type _mv_772 = (*binding_expr);
                switch (_mv_772.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type binding_lst = _mv_772.data.lst;
                        {
                            __auto_type binding_items = binding_lst.items;
                            __auto_type binding_len = ((int64_t)((binding_items).len));
                            if (binding_len < 2) {
                                ...
                                __auto_type _mv_773 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_773.has_value) {
                                    __auto_type first_elem = _mv_773.value;
                                    __auto_type _mv_774 = (*first_elem);
                                    switch (_mv_774.tag) {
                                        case types_SExpr_lst:
                                        {
                                            __auto_type _ = _mv_774.data.lst;
                                            match_emit_inline_for_each_map_kv(ctx, binding_items, items, len);
                                            break;
                                        }
                                        case types_SExpr_sym:
                                        {
                                            __auto_type var_sym = _mv_774.data.sym;
                                            {
                                                __auto_type var_name = ctype_to_c_name(arena, var_sym.name);
                                                __auto_type _mv_775 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_775.has_value) {
                                                    __auto_type coll_expr = _mv_775.value;
                                                    {
...
void match_emit_inline_return(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 2) {
            ...
            __auto_type _mv_776 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_777.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 1) {
                    ...
                    __auto_type _mv_778 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
uint8_t match_is_pattern_literal(types_SExpr* expr) {
    ...
    switch (_mv_783.tag) {
        ...
        case types_SExpr_num:
        {
            __auto_type _ = _mv_783.data.num;
            return 1;
        }
        default: {
            return 0;
...
slop_string match_pattern_literal_to_c(types_SExpr* expr) {
    SLOP_PRE(((expr != NULL)), "(!= expr nil)");
    __auto_type _mv_784 = (*expr);
    switch (_mv_784.tag) {
        case types_SExpr_sym:
        {
            __auto_type sym = _mv_784.data.sym;
            {
                __auto_type name = sym.name;
        ...
        case types_SExpr_num:
        {
            __auto_type n = _mv_784.data.num;
            return n.raw;
        }
        default: {
            return SLOP_STR("");
...
uint8_t match_has_literal_in_patterns(slop_list_types_SExpr_ptr patterns) {
    {
        ...
        int64_t i = 0;
        while ((i < len) && !(found)) {
            __auto_type _mv_787 = ({ __auto_type _lst = patterns; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_787.has_value) {
                __auto_type pat_expr = _mv_787.value;
...
void match_emit_union_literal_bindings(context_TranspileContext* ctx, slop_string scrutinee_c, types_SExpr* pattern, slop_string tag, slop_string union_type_name, slop_string c_tag, uint8_t is_multi) {
    ...
    SLOP_PRE(((pattern != NULL)), "(!= pattern nil)");
    {
        ...
        if (is_multi) {
            ...
            __auto_type _mv_792 = match_extract_binding_name(pattern);
            if (_mv_792.has_value) {
                __auto_type binding_name = _mv_792.value;
...
void match_transpile_union_match_with_literals(context_TranspileContext* ctx, slop_string scrutinee_c, slop_list_types_SExpr_ptr patterns, slop_list_types_SExpr_ptr items, uint8_t is_return) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        uint8_t first = 1;
        while (i < len) {
            __auto_type _mv_793 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_793.has_value) {
                __auto_type branch = _mv_793.value;
                __auto_type _mv_794 = (*branch);
                switch (_mv_794.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type branch_lst = _mv_794.data.lst;
                        {
                            __auto_type branch_items = branch_lst.items;
                            if (((int64_t)((branch_items).len)) >= 2) {
                                __auto_type _mv_795 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_795.has_value) {
                                    __auto_type pattern = _mv_795.value;
                                    {
                                        __auto_type tag = match_get_pattern_tag(pattern);
                                        if (string_eq(tag, SLOP_STR("else")) || string_eq(tag, SLOP_STR("_"))) {
                                            if (first) {
                                            ...
                                            __auto_type _mv_796 = context_ctx_lookup_enum_variant(ctx, tag);
                                            if (_mv_796.has_value) {
                                                __auto_type union_type_name = _mv_796.value;
                                                {
                                                    __auto_type c_tag = ctype_to_c_name(arena, tag);
