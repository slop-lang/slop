...
uint8_t match_is_option_match(slop_list_types_SExpr_ptr patterns) {
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_662 = ({ __auto_type _lst = patterns; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_662.has_value) {
                __auto_type pat_expr = _mv_662.value;
                {
...
uint8_t match_is_result_match(slop_list_types_SExpr_ptr patterns) {
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_663 = ({ __auto_type _lst = patterns; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_663.has_value) {
                __auto_type pat_expr = _mv_663.value;
                {
                    __auto_type tag = match_get_pattern_tag(pat_expr);
...
uint8_t match_is_enum_match(slop_list_types_SExpr_ptr patterns) {
    {
        ...
        while ((i < len) && all_symbols) {
            __auto_type _mv_664 = ({ __auto_type _lst = patterns; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_664.has_value) {
                __auto_type pat_expr = _mv_664.value;
                __auto_type _mv_665 = (*pat_expr);
                switch (_mv_665.tag) {
                    case types_SExpr_sym:
                    {
                        __auto_type _ = _mv_665.data.sym;
                        break;
                    }
                    default: {
                        all_symbols = 0;
...
uint8_t match_is_literal_match(slop_list_types_SExpr_ptr patterns) {
    {
        ...
        while ((i < len) && !(has_literal)) {
            __auto_type _mv_666 = ({ __auto_type _lst = patterns; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_666.has_value) {
                __auto_type pat_expr = _mv_666.value;
                __auto_type _mv_667 = (*pat_expr);
                switch (_mv_667.tag) {
                    case types_SExpr_num:
                    {
                        __auto_type _ = _mv_667.data.num;
                        has_literal = 1;
                        break;
                    }
                    case types_SExpr_str:
                    {
                        __auto_type _ = _mv_667.data.str;
                        has_literal = 1;
                        break;
                    }
                    default: {
            ...
            if (_mv_668.has_value) {
                __auto_type pat_expr = _mv_668.value;
                {
                    ...
                    if ((!(string_eq(tag, SLOP_STR("")))) && (!(string_eq(tag, SLOP_STR("some")))) && (!(string_eq(tag, SLOP_STR("none")))) && (!(string_eq(tag, SLOP_STR("ok")))) && (!(string_eq(tag, SLOP_STR("error")))) && (!(string_eq(tag, SLOP_STR("else")))) && (!(string_eq(tag, SLOP_STR("_"))))) {
                        __auto_type _mv_669 = context_ctx_lookup_enum_variant(ctx, tag);
                        if (_mv_669.has_value) {
                            __auto_type _ = _mv_669.value;
                            has_union_variant = 1;
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_670.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 1) {
                    ...
                    __auto_type _mv_671 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_671.has_value) {
                        __auto_type head = _mv_671.value;
                        __auto_type _mv_672 = (*head);
                        switch (_mv_672.tag) {
                            case types_SExpr_sym:
                            {
                                __auto_type sym = _mv_672.data.sym;
                                return sym.name;
                            }
                            default: {
                                return SLOP_STR("");
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_673.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 2) {
                    ...
                    __auto_type _mv_674 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_674.has_value) {
                        __auto_type binding = _mv_674.value;
                        __auto_type _mv_675 = (*binding);
                        switch (_mv_675.tag) {
                            case types_SExpr_sym:
                            {
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_677.data.lst;
                {
                    ...
                    if (len < 3) {
                        ...
                        __auto_type _mv_678 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_678.has_value) {
                            __auto_type scrutinee = _mv_678.value;
                            {
...
void match_emit_option_some_branch(context_TranspileContext* ctx, slop_string scrutinee_c, types_SExpr* scrutinee_expr, types_SExpr* pattern, slop_list_types_SExpr_ptr branch_items, uint8_t is_return, uint8_t first) {
    ...
    SLOP_PRE(((pattern != NULL)), "(!= pattern nil)");
    {
        ...
        __auto_type _mv_685 = match_extract_binding_name(pattern);
        if (_mv_685.has_value) {
            __auto_type binding_name = _mv_685.value;
            {
    ...
    SLOP_PRE(((scrutinee_expr != NULL)), "(!= scrutinee-expr nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_686.has_value) {
                __auto_type branch = _mv_686.value;
                __auto_type _mv_687 = (*branch);
                switch (_mv_687.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type branch_lst = _mv_687.data.lst;
                        {
                            __auto_type branch_items = branch_lst.items;
                            if (((int64_t)((branch_items).len)) >= 2) {
                                __auto_type _mv_688 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_688.has_value) {
                                    __auto_type pattern = _mv_688.value;
                                    {
                                        __auto_type tag = match_get_pattern_tag(pattern);
                                        if (string_eq(tag, SLOP_STR("ok"))) {
    ...
    SLOP_PRE(((pattern != NULL)), "(!= pattern nil)");
    {
        ...
        if (string_eq(tag, SLOP_STR("else")) || string_eq(tag, SLOP_STR("_"))) {
            ...
            if (_mv_694.has_value) {
                __auto_type type_name = _mv_694.value;
                {
...
void match_transpile_union_match(context_TranspileContext* ctx, slop_string scrutinee_c, slop_list_types_SExpr_ptr patterns, slop_list_types_SExpr_ptr items, uint8_t is_return) {
    ...
    if (match_has_literal_in_patterns(patterns)) {
    ...
    } else {
        {
            ...
            context_ctx_indent(ctx);
            while (i < len) {
                __auto_type _mv_698 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_698.has_value) {
                    __auto_type branch = _mv_698.value;
                    __auto_type _mv_699 = (*branch);
                    switch (_mv_699.tag) {
                        case types_SExpr_lst:
                        {
                            __auto_type branch_lst = _mv_699.data.lst;
                            {
                                __auto_type branch_items = branch_lst.items;
                                if (((int64_t)((branch_items).len)) >= 2) {
                                    __auto_type _mv_700 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    if (_mv_700.has_value) {
                                        __auto_type pattern = _mv_700.value;
                                        {
                                            __auto_type tag = match_get_pattern_tag(pattern);
                                            if (string_eq(tag, SLOP_STR("else")) || string_eq(tag, SLOP_STR("_"))) {
                                                has_else = 1;
                                                ...
                                                __auto_type _mv_701 = context_ctx_lookup_enum_variant(ctx, tag);
                                                if (_mv_701.has_value) {
                                                    __auto_type union_type_name = _mv_701.value;
    ...
    SLOP_PRE(((pattern != NULL)), "(!= pattern nil)");
    {
        ...
        context_ctx_push_scope(ctx);
        {
            ...
            if (!(string_eq(multi_field_count, SLOP_STR("")))) {
                __auto_type _mv_702 = (*pattern);
                switch (_mv_702.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type pat_lst = _mv_702.data.lst;
                        {
                            __auto_type pat_items = pat_lst.items;
                            __auto_type pat_len = ((int64_t)((pat_items).len));
                            for (int64_t bi = 1; bi < pat_len; bi++) {
                                __auto_type _mv_703 = ({ __auto_type _lst = pat_items; size_t _idx = (size_t)bi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_703.has_value) {
                                    __auto_type binding_expr = _mv_703.value;
                                    {
...
void match_emit_branch_body(context_TranspileContext* ctx, slop_list_types_SExpr_ptr branch_items, uint8_t is_return) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 1;
        while (i < len) {
            __auto_type _mv_705 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_705.has_value) {
                __auto_type body_expr = _mv_705.value;
                {
                ...
                __auto_type lst = _mv_706.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) < 1) {
                        ...
                        if (_mv_707.has_value) {
                            __auto_type head_expr = _mv_707.value;
                            __auto_type _mv_708 = (*head_expr);
                            switch (_mv_708.tag) {
                                case types_SExpr_sym:
                                {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 2) {
            ...
            if (_mv_709.has_value) {
                __auto_type bindings_expr = _mv_709.value;
            ...
            }
            {
                ...
                while (i < len) {
                    ...
                    if (_mv_710.has_value) {
                        __auto_type body_item = _mv_710.value;
                        {
...
void match_emit_single_inline_binding(context_TranspileContext* ctx, types_SExpr* binding) {
    ...
    SLOP_PRE(((binding != NULL)), "(!= binding nil)");
    {
        ...
        switch (_mv_713.tag) {
            case types_SExpr_lst:
            {
                __auto_type binding_lst = _mv_713.data.lst;
                {
                    ...
                    __auto_type len = ((int64_t)((items).len));
                    {
                        ...
                        if ((len - start_idx) < 2) {
                            ...
                            __auto_type _mv_714 = ({ __auto_type _lst = items; size_t _idx = (size_t)start_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_714.has_value) {
                                ...
                                switch (_mv_715.tag) {
                                    case types_SExpr_sym:
                                    {
                                        __auto_type name_sym = _mv_715.data.sym;
                                        {
                                            ...
                                            if ((len - start_idx) >= 3) {
                                                {
                                                    ...
                                                    __auto_type _mv_716 = ({ __auto_type _lst = items; size_t _idx = (size_t)type_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_716.has_value) {
                                                        __auto_type type_expr = _mv_716.value;
                                                        if (match_is_type_expr(type_expr)) {
                                                            __auto_type _mv_717 = ({ __auto_type _lst = items; size_t _idx = (size_t)val_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                            ...
                                                            __auto_type _mv_718 = ({ __auto_type _lst = items; size_t _idx = (size_t)type_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                            if (_mv_718.has_value) {
                                                                __auto_type val_expr = _mv_718.value;
                                                                {
                                                                    ...
                                                                    __auto_type _mv_719 = ptr_type_opt;
                                                                    if (_mv_719.has_value) {
                                                                        __auto_type ptr_type = _mv_719.value;
                                            ...
                                            } else {
                                                {
                                                    ...
                                                    __auto_type _mv_720 = ({ __auto_type _lst = items; size_t _idx = (size_t)val_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_720.has_value) {
                                                        __auto_type val_expr = _mv_720.value;
                                                        {
                                                            ...
                                                            __auto_type inferred_slop_type = expr_infer_expr_slop_type(ctx, val_expr);
                                                            __auto_type ptr_type_opt = match_get_arena_alloc_ptr_type_inline(ctx, val_expr);
                                                            __auto_type _mv_721 = ptr_type_opt;
                                                            if (_mv_721.has_value) {
                                                                __auto_type ptr_type = _mv_721.value;
                                                                context_ctx_emit(ctx, context_ctx_str4(ctx, SLOP_STR("__auto_type "), c_name, SLOP_STR(" = "), context_ctx_str(ctx, val_c, SLOP_STR(";"))));
                                                                context_ctx_bind_var(ctx, (context_VarEntry){raw_name, c_name, ptr_type, inferred_slop_type, 1, has_mut, 0, SLOP_STR(""), SLOP_STR("")});
...
uint8_t match_binding_starts_with_mut(slop_list_types_SExpr_ptr items) {
    if (((int64_t)((items).len)) < 1) {
        ...
        if (_mv_722.has_value) {
            __auto_type first = _mv_722.value;
            __auto_type _mv_723 = (*first);
            switch (_mv_723.tag) {
                case types_SExpr_sym:
                {
            ...
            __auto_type lst = _mv_725.data.lst;
            {
                ...
                if (((int64_t)((items).len)) == 1) {
                    ...
                    if (_mv_726.has_value) {
                        __auto_type head = _mv_726.value;
                        __auto_type _mv_727 = (*head);
                        switch (_mv_727.tag) {
                            case types_SExpr_sym:
                            {
                ...
                __auto_type lst = _mv_728.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) >= 3) {
                        ...
                        if (_mv_729.has_value) {
                            __auto_type head_ptr = _mv_729.value;
                            __auto_type _mv_730 = (*head_ptr);
                            switch (_mv_730.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type head_sym = _mv_730.data.sym;
        ...
        switch (_mv_732.tag) {
            case types_SExpr_sym:
            {
                __auto_type sym = _mv_732.data.sym;
                {
                    ...
                    __auto_type _mv_733 = context_ctx_lookup_type(ctx, type_name);
                    if (_mv_733.has_value) {
                        __auto_type entry = _mv_733.value;
                                ...
                                case types_SExpr_sym:
                                {
                                    ...
                                    if (string_eq(head_sym.name, SLOP_STR("sizeof"))) {
                                        ...
                                        if (_mv_736.has_value) {
                                            __auto_type type_expr = _mv_736.value;
                                            {
                                                __auto_type c_type = context_to_c_type_prefixed(ctx, type_expr);
...
void match_emit_inline_do(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items, uint8_t is_return, uint8_t is_last) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 1;
        while (i < len) {
            __auto_type _mv_737 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_737.has_value) {
                __auto_type item = _mv_737.value;
                {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 3) {
            ...
            if (_mv_739.has_value) {
                __auto_type then_expr = _mv_739.value;
            ...
            if (len >= 4) {
                ...
                if (_mv_740.has_value) {
                    __auto_type else_expr = _mv_740.value;
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 3) {
            ...
            if (_mv_741.has_value) {
                __auto_type cond_expr = _mv_741.value;
                {
                    __auto_type cond_c = context_ctx_strip_cond_parens(ctx, expr_transpile_expr(ctx, cond_expr));
...
slop_option_string match_get_var_c_type_inline(context_TranspileContext* ctx, types_SExpr* expr) {
    ...
    switch (_mv_742.tag) {
        case types_SExpr_sym:
        {
            ...
            {
                __auto_type name = sym.name;
                __auto_type _mv_743 = context_ctx_lookup_var(ctx, name);
                if (_mv_743.has_value) {
                    __auto_type var_entry = _mv_743.value;
        ...
        switch (_mv_744.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_744.data.lst;
                {
                    __auto_type items = lst.items;
                    if (((int64_t)((items).len)) >= 2) {
                        __auto_type _mv_745 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        if (expr_set_is_self_assign(items)) {
            ...
            if (_mv_748.has_value) {
                ...
                if (_mv_749.has_value) {
                    __auto_type field_expr = _mv_749.value;
                    __auto_type _mv_750 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_750.has_value) {
                        __auto_type type_expr = _mv_750.value;
                        __auto_type _mv_751 = ({ __auto_type _lst = items; size_t _idx = (size_t)4; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_751.has_value) {
                            __auto_type value_expr = _mv_751.value;
                            {
                                ...
                                __auto_type c_type = ctype_to_c_type(arena, type_expr);
                                {
                                    ...
                                    if (context_ctx_is_option_c_type(ctx, c_type)) {
                                        if (match_is_none_form_inline(value_expr)) {
                                            ...
                                            __auto_type _mv_752 = match_get_some_value_inline(value_expr);
                                            if (_mv_752.has_value) {
                                                __auto_type inner_val = _mv_752.value;
                                                {
            ...
            if (_mv_753.has_value) {
                ...
                if (_mv_754.has_value) {
                    ...
                    if (_mv_755.has_value) {
                        __auto_type value_expr = _mv_755.value;
                        {
                            __auto_type field_name = match_get_field_name_inline(ctx, field_expr);
            ...
            if (_mv_756.has_value) {
                __auto_type target_expr = _mv_756.value;
                __auto_type _mv_757 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_757.has_value) {
                    __auto_type val_expr = _mv_757.value;
                    {
                        __auto_type target_c = expr_transpile_expr(ctx, target_expr);
                        __auto_type target_type_opt = match_get_var_c_type_inline(ctx, target_expr);
                        __auto_type _mv_758 = target_type_opt;
                        if (_mv_758.has_value) {
                            __auto_type target_type = _mv_758.value;
                            if (context_ctx_is_option_c_type(ctx, target_type)) {
                                {
                                    __auto_type some_val_opt = match_get_some_value_inline(val_expr);
                                    __auto_type _mv_759 = some_val_opt;
                                    if (_mv_759.has_value) {
                                        __auto_type inner_expr = _mv_759.value;
                                        {
                            ...
                            {
                                __auto_type some_val_opt = match_get_some_value_inline(val_expr);
                                __auto_type _mv_760 = some_val_opt;
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_762.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 2) {
                    ...
                    __auto_type _mv_763 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_763.has_value) {
                        __auto_type head = _mv_763.value;
                        __auto_type _mv_764 = (*head);
                        switch (_mv_764.tag) {
                            case types_SExpr_sym:
                            {
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_765.data.lst;
            {
                ...
                if (_mv_766.has_value) {
                    __auto_type inner = _mv_766.value;
...
void match_emit_inline_when(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 2) {
            ...
            __auto_type _mv_768 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_768.has_value) {
                __auto_type cond_expr = _mv_768.value;
                {
                    __auto_type cond_c = context_ctx_strip_cond_parens(ctx, expr_transpile_expr(ctx, cond_expr));
                    context_ctx_emit(ctx, context_ctx_str3(ctx, SLOP_STR("if ("), cond_c, SLOP_STR(") {")));
                }
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_769.has_value) {
                __auto_type clause_expr = _mv_769.value;
                __auto_type _mv_770 = (*clause_expr);
                switch (_mv_770.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type clause_lst = _mv_770.data.lst;
                        {
                            ...
                            if (clause_len < 1) {
                                ...
                                __auto_type _mv_771 = ({ __auto_type _lst = clause_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_771.has_value) {
                                    __auto_type test_expr = _mv_771.value;
                                    __auto_type _mv_772 = (*test_expr);
                                    switch (_mv_772.tag) {
                                        case types_SExpr_sym:
                                        {
        ...
        if (len < 2) {
        ...
        } else {
            {
                ...
                if (is_named && (len < 4)) {
                    ...
                    context_ctx_indent(ctx);
                    context_ctx_push_scope(ctx);
                    __auto_type _mv_774 = ({ __auto_type _lst = items; size_t _idx = (size_t)size_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_774.has_value) {
                        __auto_type size_expr = _mv_774.value;
                        {
                    ...
                    context_ctx_bind_var(ctx, (context_VarEntry){arena_name, c_arena_name, SLOP_STR("slop_arena*"), SLOP_STR(""), 1, 0, 0, SLOP_STR(""), SLOP_STR("")});
                    {
                        ...
                        while (i < len) {
                            ...
                            if (_mv_775.has_value) {
                                __auto_type body_expr = _mv_775.value;
                                {
                                    __auto_type is_last = (i == (len - 1));
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_776.has_value) {
                __auto_type body_expr = _mv_776.value;
...
void match_emit_inline_for(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 2) {
            ...
            __auto_type _mv_777 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_777.has_value) {
                __auto_type binding_expr = _mv_777.value;
                __auto_type _mv_778 = (*binding_expr);
                switch (_mv_778.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type binding_lst = _mv_778.data.lst;
                        {
                            ...
                            if (binding_len < 3) {
                                ...
                                __auto_type _mv_779 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_779.has_value) {
                                    __auto_type var_expr = _mv_779.value;
                                    __auto_type _mv_780 = (*var_expr);
                                    switch (_mv_780.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type var_sym = _mv_780.data.sym;
                                            {
                                                __auto_type var_name = ctype_to_c_name(arena, var_sym.name);
                                                __auto_type _mv_781 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_781.has_value) {
                                                    __auto_type start_expr = _mv_781.value;
                                                    __auto_type _mv_782 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_782.has_value) {
                                                        __auto_type end_expr = _mv_782.value;
                                                        {
...
void match_emit_inline_for_each_map_kv(context_TranspileContext* ctx, slop_list_types_SExpr_ptr binding_items, slop_list_types_SExpr_ptr items, int64_t len) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_783 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        if (_mv_783.has_value) {
            __auto_type kv_list_expr = _mv_783.value;
            __auto_type _mv_784 = (*kv_list_expr);
            switch (_mv_784.tag) {
                case types_SExpr_lst:
                {
                    __auto_type kv_lst = _mv_784.data.lst;
                    {
                        __auto_type kv_items = kv_lst.items;
                        if (((int64_t)((kv_items).len)) < 2) {
                            context_ctx_add_error(ctx, SLOP_STR("Map for-each needs ((k v) map)"));
                        } else {
                            __auto_type _mv_785 = ({ __auto_type _lst = kv_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_785.has_value) {
                                __auto_type k_expr = _mv_785.value;
                                __auto_type _mv_786 = ({ __auto_type _lst = kv_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_786.has_value) {
                                    __auto_type v_expr = _mv_786.value;
                                    ...
                                    if (_mv_787.has_value) {
                                        __auto_type map_expr = _mv_787.value;
                                        __auto_type _mv_788 = (*k_expr);
                                        switch (_mv_788.tag) {
                                            case types_SExpr_sym:
                                            {
                                                __auto_type k_sym = _mv_788.data.sym;
                                                __auto_type _mv_789 = (*v_expr);
                                                switch (_mv_789.tag) {
                                                    case types_SExpr_sym:
                                                    {
                                                        __auto_type v_sym = _mv_789.data.sym;
                                                        {
                        ...
                        __auto_type binding_lst = _mv_791.data.lst;
                        {
                            ...
                            if (binding_len < 2) {
                                ...
                                if (_mv_792.has_value) {
                                    __auto_type first_elem = _mv_792.value;
                                    __auto_type _mv_793 = (*first_elem);
                                    switch (_mv_793.tag) {
                                        case types_SExpr_lst:
                                        {
                                            __auto_type _ = _mv_793.data.lst;
                                        ...
                                        case types_SExpr_sym:
                                        {
                                            __auto_type var_sym = _mv_793.data.sym;
                                            {
                                                ...
                                                if (_mv_794.has_value) {
                                                    __auto_type coll_expr = _mv_794.value;
                                                    {
            ...
            __auto_type lst = _mv_796.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 1) {
                    ...
                    if (_mv_797.has_value) {
                        __auto_type head = _mv_797.value;
                        __auto_type _mv_798 = (*head);
                        switch (_mv_798.tag) {
                            case types_SExpr_sym:
                            {
                                __auto_type sym = _mv_798.data.sym;
                                {
                                    ...
                                    if (string_eq(op, SLOP_STR("some"))) {
                                        __auto_type _mv_799 = context_ctx_get_current_return_type(ctx);
                                        if (_mv_799.has_value) {
                                            __auto_type ret_type = _mv_799.value;
                                            if (context_ctx_is_option_c_type(ctx, ret_type)) {
                                                if (((int64_t)((items).len)) < 2) {
                                                    match_emit_return_typed(ctx, expr_transpile_expr(ctx, expr));
                                                } else {
                                                    ...
                                                    if (_mv_800.has_value) {
                                                        __auto_type inner_expr = _mv_800.value;
                                                        {
                                                            __auto_type inner_c = expr_transpile_expr(ctx, inner_expr);
                                        ...
                                        __auto_type _mv_801 = context_ctx_get_current_return_type(ctx);
                                        if (_mv_801.has_value) {
                                            __auto_type ret_type = _mv_801.value;
                                            if (context_ctx_is_option_c_type(ctx, ret_type)) {
...
uint8_t match_is_pattern_literal(types_SExpr* expr) {
    ...
    switch (_mv_802.tag) {
        ...
        case types_SExpr_num:
        {
            __auto_type _ = _mv_802.data.num;
            return 1;
        }
        default: {
            return 0;
...
slop_string match_pattern_literal_to_c(types_SExpr* expr) {
    ...
    switch (_mv_803.tag) {
        ...
        case types_SExpr_num:
        {
            __auto_type n = _mv_803.data.num;
            return n.raw;
        }
        default: {
            return SLOP_STR("");
                ...
                for (int64_t i = 1; i < len; i++) {
                    if (!(found)) {
                        ...
                        if (_mv_805.has_value) {
                            __auto_type item = _mv_805.value;
...
uint8_t match_has_literal_in_patterns(slop_list_types_SExpr_ptr patterns) {
    {
        ...
        int64_t i = 0;
        while ((i < len) && !(found)) {
            __auto_type _mv_806 = ({ __auto_type _lst = patterns; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_806.has_value) {
                __auto_type pat_expr = _mv_806.value;
...
slop_string match_build_literal_guard_cond(context_TranspileContext* ctx, slop_string scrutinee_c, slop_string c_tag, slop_string tag_cond, types_SExpr* pattern, uint8_t is_multi) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_807 = (*pattern);
        switch (_mv_807.tag) {
            case types_SExpr_lst:
            {
                __auto_type pat_lst = _mv_807.data.lst;
                {
                    __auto_type pat_items = pat_lst.items;
                    __auto_type pat_len = ((int64_t)((pat_items).len));
                    __auto_type cond = tag_cond;
                    for (int64_t bi = 1; bi < pat_len; bi++) {
                        __auto_type _mv_808 = ({ __auto_type _lst = pat_items; size_t _idx = (size_t)bi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_808.has_value) {
                            __auto_type item = _mv_808.value;
                            if (match_is_pattern_literal(item)) {
                                {
...
void match_emit_union_literal_bindings(context_TranspileContext* ctx, slop_string scrutinee_c, types_SExpr* pattern, slop_string tag, slop_string union_type_name, slop_string c_tag, uint8_t is_multi) {
    ...
    SLOP_PRE(((pattern != NULL)), "(!= pattern nil)");
    {
        __auto_type arena = (*ctx).arena;
        if (is_multi) {
            __auto_type _mv_809 = (*pattern);
            switch (_mv_809.tag) {
                case types_SExpr_lst:
                {
                    __auto_type pat_lst = _mv_809.data.lst;
                    {
                        __auto_type pat_items = pat_lst.items;
                        __auto_type pat_len = ((int64_t)((pat_items).len));
                        for (int64_t bi = 1; bi < pat_len; bi++) {
                            __auto_type _mv_810 = ({ __auto_type _lst = pat_items; size_t _idx = (size_t)bi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_810.has_value) {
                                __auto_type binding_expr = _mv_810.value;
            ...
            __auto_type _mv_811 = match_extract_binding_name(pattern);
            if (_mv_811.has_value) {
                __auto_type binding_name = _mv_811.value;
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_812.has_value) {
                __auto_type branch = _mv_812.value;
                __auto_type _mv_813 = (*branch);
                switch (_mv_813.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type branch_lst = _mv_813.data.lst;
                        {
                            __auto_type branch_items = branch_lst.items;
                            if (((int64_t)((branch_items).len)) >= 2) {
                                __auto_type _mv_814 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_814.has_value) {
                                    __auto_type pattern = _mv_814.value;
                                    {
                                        __auto_type tag = match_get_pattern_tag(pattern);
                                        if (string_eq(tag, SLOP_STR("else")) || string_eq(tag, SLOP_STR("_"))) {
                                            has_else = 1;
                                            ...
                                            __auto_type _mv_815 = context_ctx_lookup_enum_variant(ctx, tag);
                                            if (_mv_815.has_value) {
                                                __auto_type union_type_name = _mv_815.value;
                                                {
                                                    __auto_type c_tag = ctype_to_c_name(arena, tag);
