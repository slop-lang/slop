        ...
        while ((i < len) && all_symbols) {
            ...
            if (_mv_661.has_value) {
                ...
                switch (_mv_662.tag) {
                    ...
                    {
                        __auto_type _ = _mv_662.data.sym;
                        break;
                    }
                    default: {
                        all_symbols = 0;
...
uint8_t match_is_literal_match(slop_list_types_SExpr_ptr patterns) {
    {
        ...
        while ((i < len) && !(has_literal)) {
            ...
            if (_mv_663.has_value) {
                ...
                __auto_type _mv_664 = (*pat_expr);
                switch (_mv_664.tag) {
                    case types_SExpr_num:
                    {
                        __auto_type _ = _mv_664.data.num;
                        has_literal = 1;
                        break;
                    }
                    case types_SExpr_str:
                    {
                        __auto_type _ = _mv_664.data.str;
                        has_literal = 1;
                        break;
                    }
                    default: {
...
uint8_t match_is_union_match(context_TranspileContext* ctx, slop_list_types_SExpr_ptr patterns) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while ((i < len) && !(has_union_variant)) {
            __auto_type _mv_665 = ({ __auto_type _lst = patterns; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_665.has_value) {
                __auto_type pat_expr = _mv_665.value;
                {
                    __auto_type tag = match_get_pattern_tag(pat_expr);
                    if ((!(string_eq(tag, SLOP_STR("")))) && (!(string_eq(tag, SLOP_STR("some")))) && (!(string_eq(tag, SLOP_STR("none")))) && (!(string_eq(tag, SLOP_STR("ok")))) && (!(string_eq(tag, SLOP_STR("error")))) && (!(string_eq(tag, SLOP_STR("else")))) && (!(string_eq(tag, SLOP_STR("_"))))) {
                        __auto_type _mv_666 = context_ctx_lookup_enum_variant(ctx, tag);
                        if (_mv_666.has_value) {
                            __auto_type _ = _mv_666.value;
                            has_union_variant = 1;
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_667.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 1) {
                    ...
                    __auto_type _mv_668 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            ...
            __auto_type lst = _mv_670.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 2) {
                    ...
                    if (_mv_671.has_value) {
                        __auto_type binding = _mv_671.value;
                        __auto_type _mv_672 = (*binding);
                        switch (_mv_672.tag) {
                            case types_SExpr_sym:
                            {
                ...
                __auto_type lst = _mv_674.data.lst;
                {
                    ...
                    if (len < 3) {
                        ...
                        if (_mv_675.has_value) {
                            __auto_type scrutinee = _mv_675.value;
                            {
...
void match_emit_result_ok_branch(context_TranspileContext* ctx, slop_string scrutinee_c, types_SExpr* scrutinee_expr, types_SExpr* pattern, slop_list_types_SExpr_ptr branch_items, uint8_t is_return, uint8_t first) {
    ...
    SLOP_PRE(((pattern != NULL)), "(!= pattern nil)");
    {
        ...
        context_ctx_indent(ctx);
        context_ctx_push_scope(ctx);
        __auto_type _mv_686 = match_extract_binding_name(pattern);
        if (_mv_686.has_value) {
            __auto_type binding_name = _mv_686.value;
            {
                __auto_type c_name = ctype_to_c_name(arena, binding_name);
...
void match_emit_result_error_branch(context_TranspileContext* ctx, slop_string scrutinee_c, types_SExpr* scrutinee_expr, types_SExpr* pattern, slop_list_types_SExpr_ptr branch_items, uint8_t is_return, uint8_t first) {
    ...
    SLOP_PRE(((pattern != NULL)), "(!= pattern nil)");
    {
        ...
        context_ctx_indent(ctx);
        context_ctx_push_scope(ctx);
        __auto_type _mv_687 = match_extract_binding_name(pattern);
        if (_mv_687.has_value) {
            __auto_type binding_name = _mv_687.value;
            {
                __auto_type c_name = ctype_to_c_name(arena, binding_name);
...
void match_emit_enum_case(context_TranspileContext* ctx, types_SExpr* pattern, slop_list_types_SExpr_ptr branch_items, uint8_t is_return) {
    ...
    SLOP_PRE(((pattern != NULL)), "(!= pattern nil)");
    {
        ...
        if (string_eq(tag, SLOP_STR("else")) || string_eq(tag, SLOP_STR("_"))) {
            ...
            __auto_type _mv_691 = context_ctx_lookup_enum_variant(ctx, tag);
            if (_mv_691.has_value) {
                __auto_type type_name = _mv_691.value;
                {
                                    ...
                                    if (_mv_697.has_value) {
                                        __auto_type pattern = _mv_697.value;
                                        {
                                            ...
                                            if (string_eq(tag, SLOP_STR("else")) || string_eq(tag, SLOP_STR("_"))) {
                                                ...
                                                __auto_type _mv_698 = context_ctx_lookup_enum_variant(ctx, tag);
                                                if (_mv_698.has_value) {
                                                    __auto_type union_type_name = _mv_698.value;
    ...
    SLOP_PRE(((pattern != NULL)), "(!= pattern nil)");
    {
        ...
        context_ctx_push_scope(ctx);
        {
            ...
            if (!(string_eq(multi_field_count, SLOP_STR("")))) {
                __auto_type _mv_699 = (*pattern);
                switch (_mv_699.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type pat_lst = _mv_699.data.lst;
                        {
                            __auto_type pat_items = pat_lst.items;
                            __auto_type pat_len = ((int64_t)((pat_items).len));
                            for (int64_t bi = 1; bi < pat_len; bi++) {
                                __auto_type _mv_700 = ({ __auto_type _lst = pat_items; size_t _idx = (size_t)bi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_700.has_value) {
                                    __auto_type binding_expr = _mv_700.value;
                                    {
...
void match_emit_branch_body(context_TranspileContext* ctx, slop_list_types_SExpr_ptr branch_items, uint8_t is_return) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 1;
        while (i < len) {
            __auto_type _mv_702 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_702.has_value) {
                __auto_type body_expr = _mv_702.value;
                {
                ...
                __auto_type lst = _mv_703.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) < 1) {
                        ...
                        if (_mv_704.has_value) {
                            __auto_type head_expr = _mv_704.value;
                            __auto_type _mv_705 = (*head_expr);
                            switch (_mv_705.tag) {
                                case types_SExpr_sym:
                                {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 2) {
            ...
            if (_mv_706.has_value) {
                __auto_type bindings_expr = _mv_706.value;
            ...
            }
            {
                ...
                while (i < len) {
                    ...
                    if (_mv_707.has_value) {
                        __auto_type body_item = _mv_707.value;
                        {
...
void match_emit_single_inline_binding(context_TranspileContext* ctx, types_SExpr* binding) {
    ...
    SLOP_PRE(((binding != NULL)), "(!= binding nil)");
    {
        ...
        switch (_mv_710.tag) {
            case types_SExpr_lst:
            {
                __auto_type binding_lst = _mv_710.data.lst;
                {
                    ...
                    __auto_type len = ((int64_t)((items).len));
                    {
                        ...
                        if ((len - start_idx) < 2) {
                            ...
                            __auto_type _mv_711 = ({ __auto_type _lst = items; size_t _idx = (size_t)start_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_711.has_value) {
                                ...
                                switch (_mv_712.tag) {
                                    case types_SExpr_sym:
                                    {
                                        __auto_type name_sym = _mv_712.data.sym;
                                        {
                                            ...
                                            if ((len - start_idx) >= 3) {
                                                {
                                                    ...
                                                    __auto_type _mv_713 = ({ __auto_type _lst = items; size_t _idx = (size_t)type_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_713.has_value) {
                                                        __auto_type type_expr = _mv_713.value;
                                                        if (match_is_type_expr(type_expr)) {
                                                            __auto_type _mv_714 = ({ __auto_type _lst = items; size_t _idx = (size_t)val_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                            if (_mv_714.has_value) {
                                                                __auto_type val_expr = _mv_714.value;
                                                                {
                                                            ...
                                                            __auto_type _mv_715 = ({ __auto_type _lst = items; size_t _idx = (size_t)type_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                            if (_mv_715.has_value) {
                                                                __auto_type val_expr = _mv_715.value;
                                                                {
                                                                    ...
                                                                    __auto_type _mv_716 = ptr_type_opt;
                                                                    if (_mv_716.has_value) {
                                                                        __auto_type ptr_type = _mv_716.value;
                                            ...
                                            } else {
                                                {
                                                    ...
                                                    if (_mv_717.has_value) {
                                                        __auto_type val_expr = _mv_717.value;
                                                        {
                                                            ...
                                                            __auto_type inferred_slop_type = expr_infer_expr_slop_type(ctx, val_expr);
                                                            __auto_type ptr_type_opt = match_get_arena_alloc_ptr_type_inline(ctx, val_expr);
                                                            __auto_type _mv_718 = ptr_type_opt;
                                                            if (_mv_718.has_value) {
                                                                __auto_type ptr_type = _mv_718.value;
                                                                context_ctx_emit(ctx, context_ctx_str4(ctx, SLOP_STR("__auto_type "), c_name, SLOP_STR(" = "), context_ctx_str(ctx, val_c, SLOP_STR(";"))));
                                                                context_ctx_bind_var(ctx, (context_VarEntry){raw_name, c_name, ptr_type, inferred_slop_type, 1, has_mut, 0, SLOP_STR(""), SLOP_STR("")});
...
uint8_t match_binding_starts_with_mut(slop_list_types_SExpr_ptr items) {
    if (((int64_t)((items).len)) < 1) {
        ...
        if (_mv_719.has_value) {
            __auto_type first = _mv_719.value;
            __auto_type _mv_720 = (*first);
            switch (_mv_720.tag) {
                case types_SExpr_sym:
                {
...
uint8_t match_is_type_expr(types_SExpr* expr) {
    ...
    switch (_mv_721.tag) {
        ...
        case types_SExpr_lst:
        {
            __auto_type _ = _mv_721.data.lst;
            return 1;
        }
        default: {
            return 0;
    ...
    switch (_mv_722.tag) {
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_722.data.lst;
            {
                __auto_type items = lst.items;
                if (((int64_t)((items).len)) == 1) {
                    __auto_type _mv_723 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                ...
                                case types_SExpr_sym:
                                {
                                    ...
                                    if (string_eq(head_sym.name, SLOP_STR("arena-alloc"))) {
                                        ...
                                        if (_mv_728.has_value) {
                                            __auto_type size_expr = _mv_728.value;
        ...
        switch (_mv_729.tag) {
            case types_SExpr_sym:
            {
                __auto_type sym = _mv_729.data.sym;
                {
                    ...
                    __auto_type _mv_730 = context_ctx_lookup_type(ctx, type_name);
                    if (_mv_730.has_value) {
                        __auto_type entry = _mv_730.value;
                ...
                __auto_type lst = _mv_729.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) >= 2) {
                        ...
                        if (_mv_731.has_value) {
                            __auto_type head_ptr = _mv_731.value;
                            __auto_type _mv_732 = (*head_ptr);
                            switch (_mv_732.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type head_sym = _mv_732.data.sym;
                                    if (string_eq(head_sym.name, SLOP_STR("sizeof"))) {
                                        ...
                                        if (_mv_733.has_value) {
                                            __auto_type type_expr = _mv_733.value;
                                            {
                                                __auto_type c_type = context_to_c_type_prefixed(ctx, type_expr);
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_734.has_value) {
                __auto_type item = _mv_734.value;
                {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 3) {
            ...
            if (_mv_735.has_value) {
                __auto_type cond_expr = _mv_735.value;
                {
            ...
            if (_mv_736.has_value) {
                __auto_type then_expr = _mv_736.value;
            ...
            if (len >= 4) {
                ...
                if (_mv_737.has_value) {
                    __auto_type else_expr = _mv_737.value;
...
slop_option_string match_get_var_c_type_inline(context_TranspileContext* ctx, types_SExpr* expr) {
    ...
    switch (_mv_739.tag) {
        case types_SExpr_sym:
        {
            ...
            {
                __auto_type name = sym.name;
                __auto_type _mv_740 = context_ctx_lookup_var(ctx, name);
                if (_mv_740.has_value) {
                    __auto_type var_entry = _mv_740.value;
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (expr_set_is_self_assign(items)) {
            ...
            if (_mv_745.has_value) {
                ...
                if (_mv_746.has_value) {
                    ...
                    if (_mv_747.has_value) {
                        ...
                        __auto_type _mv_748 = ({ __auto_type _lst = items; size_t _idx = (size_t)4; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                ...
                                __auto_type c_type = ctype_to_c_type(arena, type_expr);
                                {
                                    ...
                                    if (context_ctx_is_option_c_type(ctx, c_type)) {
                                        if (match_is_none_form_inline(value_expr)) {
                                            ...
                                            __auto_type _mv_749 = match_get_some_value_inline(value_expr);
                                            if (_mv_749.has_value) {
                                                __auto_type inner_val = _mv_749.value;
                                                {
            ...
            if (_mv_750.has_value) {
                __auto_type target_expr = _mv_750.value;
                __auto_type _mv_751 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_751.has_value) {
                    __auto_type field_expr = _mv_751.value;
                    __auto_type _mv_752 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_752.has_value) {
                        __auto_type value_expr = _mv_752.value;
                        {
                            __auto_type field_name = match_get_field_name_inline(ctx, field_expr);
            ...
            if (_mv_753.has_value) {
                ...
                if (_mv_754.has_value) {
                    __auto_type val_expr = _mv_754.value;
                    {
                        __auto_type target_c = expr_transpile_expr(ctx, target_expr);
                            ...
                            if (context_ctx_is_option_c_type(ctx, target_type)) {
                                {
                                    ...
                                    if (_mv_756.has_value) {
                                        __auto_type inner_expr = _mv_756.value;
                                        {
...
uint8_t match_is_deref_inline(types_SExpr* expr) {
    ...
    switch (_mv_759.tag) {
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_759.data.lst;
            {
                __auto_type items = lst.items;
                if (((int64_t)((items).len)) < 2) {
                    return 0;
                } else {
                    __auto_type _mv_760 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_760.has_value) {
                        __auto_type head = _mv_760.value;
                        __auto_type _mv_761 = (*head);
                        switch (_mv_761.tag) {
                            case types_SExpr_sym:
                            {
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_762.data.lst;
            {
                ...
                if (_mv_763.has_value) {
                    __auto_type inner = _mv_763.value;
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_766.has_value) {
                __auto_type clause_expr = _mv_766.value;
                __auto_type _mv_767 = (*clause_expr);
                switch (_mv_767.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type clause_lst = _mv_767.data.lst;
                        {
                            ...
                            if (clause_len < 1) {
                                ...
                                __auto_type _mv_768 = ({ __auto_type _lst = clause_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_768.has_value) {
                                    __auto_type test_expr = _mv_768.value;
                                    __auto_type _mv_769 = (*test_expr);
                                    switch (_mv_769.tag) {
                                        case types_SExpr_sym:
                                        {
        ...
        if (len < 2) {
        ...
        } else {
            {
                ...
                if (is_named && (len < 4)) {
                    ...
                    context_ctx_indent(ctx);
                    context_ctx_push_scope(ctx);
                    __auto_type _mv_771 = ({ __auto_type _lst = items; size_t _idx = (size_t)size_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_771.has_value) {
                        __auto_type size_expr = _mv_771.value;
                        {
                    ...
                    context_ctx_bind_var(ctx, (context_VarEntry){arena_name, c_arena_name, SLOP_STR("slop_arena*"), SLOP_STR(""), 1, 0, 0, SLOP_STR(""), SLOP_STR("")});
                    {
                        ...
                        while (i < len) {
                            __auto_type _mv_772 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        ...
                        __auto_type binding_lst = _mv_775.data.lst;
                        {
                            ...
                            if (binding_len < 3) {
                                ...
                                if (_mv_776.has_value) {
                                    __auto_type var_expr = _mv_776.value;
                                    __auto_type _mv_777 = (*var_expr);
                                    switch (_mv_777.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type var_sym = _mv_777.data.sym;
                                            {
                                                ...
                                                if (_mv_778.has_value) {
                                                    __auto_type start_expr = _mv_778.value;
                                                    __auto_type _mv_779 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_779.has_value) {
                                                        __auto_type end_expr = _mv_779.value;
                                                        {
...
void match_emit_inline_for_each_map_kv(context_TranspileContext* ctx, slop_list_types_SExpr_ptr binding_items, slop_list_types_SExpr_ptr items, int64_t len) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_780 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        if (_mv_780.has_value) {
            __auto_type kv_list_expr = _mv_780.value;
            __auto_type _mv_781 = (*kv_list_expr);
            switch (_mv_781.tag) {
                case types_SExpr_lst:
                {
                    __auto_type kv_lst = _mv_781.data.lst;
                    {
                        __auto_type kv_items = kv_lst.items;
                        if (((int64_t)((kv_items).len)) < 2) {
                            context_ctx_add_error(ctx, SLOP_STR("Map for-each needs ((k v) map)"));
                        } else {
                            __auto_type _mv_782 = ({ __auto_type _lst = kv_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_782.has_value) {
                                __auto_type k_expr = _mv_782.value;
                                __auto_type _mv_783 = ({ __auto_type _lst = kv_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_783.has_value) {
                                    __auto_type v_expr = _mv_783.value;
                                    __auto_type _mv_784 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    if (_mv_784.has_value) {
                                        __auto_type map_expr = _mv_784.value;
                                        __auto_type _mv_785 = (*k_expr);
                                        switch (_mv_785.tag) {
                                            case types_SExpr_sym:
                                            {
                                                __auto_type k_sym = _mv_785.data.sym;
                                                __auto_type _mv_786 = (*v_expr);
                                                switch (_mv_786.tag) {
                                                    case types_SExpr_sym:
                                                    {
                                                        __auto_type v_sym = _mv_786.data.sym;
                                                        {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 2) {
            ...
            if (_mv_787.has_value) {
                __auto_type binding_expr = _mv_787.value;
                __auto_type _mv_788 = (*binding_expr);
                switch (_mv_788.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type binding_lst = _mv_788.data.lst;
                        {
                            ...
                            if (binding_len < 2) {
                                ...
                                __auto_type _mv_789 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_789.has_value) {
                                    __auto_type first_elem = _mv_789.value;
                                    __auto_type _mv_790 = (*first_elem);
                                    switch (_mv_790.tag) {
                                        case types_SExpr_lst:
                                        {
                                            __auto_type _ = _mv_790.data.lst;
                                            match_emit_inline_for_each_map_kv(ctx, binding_items, items, len);
                                            break;
                                        }
                                        case types_SExpr_sym:
                                        {
                                            __auto_type var_sym = _mv_790.data.sym;
                                            {
                                                __auto_type var_name = ctype_to_c_name(arena, var_sym.name);
                                                __auto_type _mv_791 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_791.has_value) {
                                                    __auto_type coll_expr = _mv_791.value;
                                                    {
                            ...
                            case types_SExpr_sym:
                            {
                                __auto_type sym = _mv_795.data.sym;
                                {
                                    ...
                                    if (string_eq(op, SLOP_STR("some"))) {
                                        __auto_type _mv_796 = context_ctx_get_current_return_type(ctx);
                                        if (_mv_796.has_value) {
                                            __auto_type ret_type = _mv_796.value;
                                            if (context_ctx_is_option_c_type(ctx, ret_type)) {
                                                if (((int64_t)((items).len)) < 2) {
                                                    match_emit_return_typed(ctx, expr_transpile_expr(ctx, expr));
                                                } else {
                                                    __auto_type _mv_797 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_797.has_value) {
                                                        __auto_type inner_expr = _mv_797.value;
                                                        {
                                                            __auto_type inner_c = expr_transpile_expr(ctx, inner_expr);
                                        ...
                                        __auto_type _mv_798 = context_ctx_get_current_return_type(ctx);
                                        if (_mv_798.has_value) {
                                            __auto_type ret_type = _mv_798.value;
                                            if (context_ctx_is_option_c_type(ctx, ret_type)) {
...
uint8_t match_is_pattern_literal(types_SExpr* expr) {
    ...
    switch (_mv_799.tag) {
        ...
        case types_SExpr_num:
        {
            __auto_type _ = _mv_799.data.num;
            return 1;
        }
        default: {
            return 0;
...
slop_string match_pattern_literal_to_c(types_SExpr* expr) {
    ...
    switch (_mv_800.tag) {
        ...
        case types_SExpr_num:
        {
            __auto_type n = _mv_800.data.num;
            return n.raw;
        }
        default: {
            return SLOP_STR("");
                ...
                for (int64_t i = 1; i < len; i++) {
                    if (!(found)) {
                        ...
                        if (_mv_802.has_value) {
                            __auto_type item = _mv_802.value;
...
uint8_t match_has_literal_in_patterns(slop_list_types_SExpr_ptr patterns) {
    {
        ...
        int64_t i = 0;
        while ((i < len) && !(found)) {
            __auto_type _mv_803 = ({ __auto_type _lst = patterns; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_803.has_value) {
                __auto_type pat_expr = _mv_803.value;
...
slop_string match_build_literal_guard_cond(context_TranspileContext* ctx, slop_string scrutinee_c, slop_string c_tag, slop_string tag_cond, types_SExpr* pattern, uint8_t is_multi) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_804 = (*pattern);
        switch (_mv_804.tag) {
            case types_SExpr_lst:
            {
                __auto_type pat_lst = _mv_804.data.lst;
                {
                    __auto_type pat_items = pat_lst.items;
                    __auto_type pat_len = ((int64_t)((pat_items).len));
                    __auto_type cond = tag_cond;
                    for (int64_t bi = 1; bi < pat_len; bi++) {
                        __auto_type _mv_805 = ({ __auto_type _lst = pat_items; size_t _idx = (size_t)bi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void match_emit_union_literal_bindings(context_TranspileContext* ctx, slop_string scrutinee_c, types_SExpr* pattern, slop_string tag, slop_string union_type_name, slop_string c_tag, uint8_t is_multi) {
    ...
    SLOP_PRE(((pattern != NULL)), "(!= pattern nil)");
    {
        __auto_type arena = (*ctx).arena;
        if (is_multi) {
            __auto_type _mv_806 = (*pattern);
            switch (_mv_806.tag) {
                case types_SExpr_lst:
                {
                    __auto_type pat_lst = _mv_806.data.lst;
                    {
                        __auto_type pat_items = pat_lst.items;
                        __auto_type pat_len = ((int64_t)((pat_items).len));
                        for (int64_t bi = 1; bi < pat_len; bi++) {
                            __auto_type _mv_807 = ({ __auto_type _lst = pat_items; size_t _idx = (size_t)bi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_807.has_value) {
                                __auto_type binding_expr = _mv_807.value;
            ...
            __auto_type _mv_808 = match_extract_binding_name(pattern);
            if (_mv_808.has_value) {
                __auto_type binding_name = _mv_808.value;
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_809.has_value) {
                __auto_type branch = _mv_809.value;
                __auto_type _mv_810 = (*branch);
                switch (_mv_810.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type branch_lst = _mv_810.data.lst;
                        {
                            __auto_type branch_items = branch_lst.items;
                            if (((int64_t)((branch_items).len)) >= 2) {
                                __auto_type _mv_811 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_811.has_value) {
                                    __auto_type pattern = _mv_811.value;
                                    {
                                        __auto_type tag = match_get_pattern_tag(pattern);
                                        if (string_eq(tag, SLOP_STR("else")) || string_eq(tag, SLOP_STR("_"))) {
                                            has_else = 1;
                                            ...
                                            __auto_type _mv_812 = context_ctx_lookup_enum_variant(ctx, tag);
                                            if (_mv_812.has_value) {
                                                __auto_type union_type_name = _mv_812.value;
                                                {
                                                    __auto_type c_tag = ctype_to_c_name(arena, tag);
