    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len < 3)) {
            ...
            context_ctx_indent(ctx);
            {
                int64_t i = 2;
                while ((i < len)) {
                    __auto_type _mv_686 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        switch (_mv_689.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_689.data.lst;
                {
                    __auto_type items = lst.items;
                    if ((((int64_t)((items).len)) >= 2)) {
                        __auto_type _mv_690 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_690.has_value) {
                            __auto_type head = _mv_690.value;
                            __auto_type _mv_691 = (*head);
                            switch (_mv_691.tag) {
                                case types_SExpr_sym:
                                {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len == 5)) {
            ...
            if (_mv_693.has_value) {
                __auto_type target_expr = _mv_693.value;
                __auto_type _mv_694 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_694.has_value) {
                    __auto_type field_expr = _mv_694.value;
                    __auto_type _mv_695 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_695.has_value) {
                        __auto_type type_expr = _mv_695.value;
                        __auto_type _mv_696 = ({ __auto_type _lst = items; size_t _idx = (size_t)4; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_696.has_value) {
                            __auto_type value_expr = _mv_696.value;
                            {
                                ...
                                __auto_type c_type = ctype_to_c_type(arena, type_expr);
                                {
                                    ...
                                    if (strlib_starts_with(c_type, SLOP_STR("slop_option_"))) {
                                        if (match_is_none_form_inline(value_expr)) {
                                            ...
                                            __auto_type _mv_697 = match_get_some_value_inline(value_expr);
                                            if (_mv_697.has_value) {
                                                __auto_type inner_val = _mv_697.value;
                                                {
            ...
            if (_mv_698.has_value) {
                __auto_type target_expr = _mv_698.value;
                ...
                if (_mv_699.has_value) {
                    __auto_type field_expr = _mv_699.value;
                    ...
                    if (_mv_700.has_value) {
                        __auto_type value_expr = _mv_700.value;
                        {
                            __auto_type field_name = match_get_field_name_inline(ctx, field_expr);
            ...
            if (_mv_701.has_value) {
                ...
                if (_mv_702.has_value) {
                    __auto_type val_expr = _mv_702.value;
                    {
                        ...
                        __auto_type _mv_703 = target_type_opt;
                        if (_mv_703.has_value) {
                            __auto_type target_type = _mv_703.value;
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_707.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 2)) {
                    ...
                    __auto_type _mv_708 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_string match_get_deref_inner_inline(context_TranspileContext* ctx, types_SExpr* expr) {
    ...
    switch (_mv_710.tag) {
        case types_SExpr_lst:
        {
            ...
            {
                __auto_type items = lst.items;
                __auto_type _mv_711 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_711.has_value) {
                    __auto_type inner = _mv_711.value;
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len < 2)) {
            ...
            context_ctx_indent(ctx);
            {
                int64_t i = 2;
                while ((i < len)) {
                    __auto_type _mv_714 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_723.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    __auto_type _mv_724 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            ...
                            case types_SExpr_sym:
                            {
                                __auto_type sym = _mv_725.data.sym;
                                {
                                    ...
                                    if (string_eq(op, SLOP_STR("some"))) {
                                        __auto_type _mv_726 = context_ctx_get_current_return_type(ctx);
                                        if (_mv_726.has_value) {
                                            __auto_type ret_type = _mv_726.value;
                                            if (strlib_starts_with(ret_type, SLOP_STR("slop_option_"))) {
                                                if ((((int64_t)((items).len)) < 2)) {
                                                    match_emit_return_typed(ctx, expr_transpile_expr(ctx, expr));
                                                } else {
                                                    __auto_type _mv_727 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
