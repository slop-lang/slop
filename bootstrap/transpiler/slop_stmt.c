            ...
            __auto_type lst = _mv_795.data.lst;
            {
                ...
                while (i < len) {
                    ...
                    if (_mv_796.has_value) {
                        __auto_type item_expr = _mv_796.value;
                        {
                ...
                __auto_type lst = _mv_797.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) >= 3) {
                        ...
                        if (_mv_798.has_value) {
                            __auto_type head_ptr = _mv_798.value;
                            __auto_type _mv_799 = (*head_ptr);
                            switch (_mv_799.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type head_sym = _mv_799.data.sym;
                                    {
                                        __auto_type op = head_sym.name;
                                        if (string_eq(op, SLOP_STR("arena-alloc"))) {
                                            __auto_type _mv_800 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_800.has_value) {
                                                __auto_type size_expr = _mv_800.value;
                                            ...
                                            __auto_type _mv_801 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_801.has_value) {
                                                __auto_type inner_expr = _mv_801.value;
        ...
        switch (_mv_802.tag) {
            case types_SExpr_sym:
            {
                __auto_type sym = _mv_802.data.sym;
                {
                    ...
                    __auto_type _mv_803 = context_ctx_lookup_type(ctx, type_name);
                    if (_mv_803.has_value) {
                        __auto_type entry = _mv_803.value;
                                ...
                                case types_SExpr_sym:
                                {
                                    ...
                                    if (string_eq(head_sym.name, SLOP_STR("sizeof"))) {
                                        ...
                                        if (_mv_806.has_value) {
                                            __auto_type type_expr = _mv_806.value;
                                            {
            ...
            __auto_type lst = _mv_807.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 1) {
                    ...
                    if (_mv_808.has_value) {
                        __auto_type head_expr = _mv_808.value;
                        __auto_type _mv_809 = (*head_expr);
                        switch (_mv_809.tag) {
                            case types_SExpr_sym:
                            {
                ...
                __auto_type lst = _mv_810.data.lst;
                {
                    ...
                    if (len < 2) {
                        ...
                        if (_mv_811.has_value) {
                            __auto_type bindings_expr = _mv_811.value;
                            __auto_type _mv_812 = (*bindings_expr);
                            switch (_mv_812.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type bindings_lst = _mv_812.data.lst;
                        ...
                        }
                        {
                            __auto_type i = 2;
                            while (i < len) {
                                __auto_type _mv_813 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_813.has_value) {
                                    __auto_type body_expr = _mv_813.value;
                                    {
...
void stmt_transpile_bindings(context_TranspileContext* ctx, slop_list_types_SExpr_ptr bindings) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_814 = ({ __auto_type _lst = bindings; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_814.has_value) {
                __auto_type binding_expr = _mv_814.value;
...
void stmt_transpile_single_binding(context_TranspileContext* ctx, types_SExpr* binding) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_815 = (*binding);
        switch (_mv_815.tag) {
            case types_SExpr_lst:
            {
                __auto_type binding_lst = _mv_815.data.lst;
                {
                    ...
                    __auto_type len = ((int64_t)((items).len));
                    {
                        ...
                        if ((len - start_idx) < 2) {
                            ...
                            __auto_type _mv_816 = ({ __auto_type _lst = items; size_t _idx = (size_t)start_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_816.has_value) {
                                __auto_type name_expr = _mv_816.value;
                                __auto_type _mv_817 = (*name_expr);
                                switch (_mv_817.tag) {
                                    case types_SExpr_sym:
                                    {
                                        __auto_type name_sym = _mv_817.data.sym;
                                        {
                                            __auto_type raw_name = name_sym.name;
                                            __auto_type var_name = ctype_to_c_name(arena, raw_name);
                                            if ((len - start_idx) >= 3) {
                                                __auto_type _mv_818 = ({ __auto_type _lst = items; size_t _idx = (size_t)(start_idx + 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_818.has_value) {
                                                    __auto_type type_expr = _mv_818.value;
                                                    __auto_type _mv_819 = ({ __auto_type _lst = items; size_t _idx = (size_t)(start_idx + 2); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_819.has_value) {
                                                        __auto_type init_expr = _mv_819.value;
                                                        {
                                                            __auto_type c_type = context_to_c_type_prefixed(ctx, type_expr);
                                                            {
                                                ...
                                                __auto_type _mv_820 = ({ __auto_type _lst = items; size_t _idx = (size_t)(start_idx + 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_820.has_value) {
                                                    __auto_type init_expr = _mv_820.value;
                                                    {
                                                        ...
                                                        __auto_type _mv_821 = ptr_type_opt;
                                                        if (_mv_821.has_value) {
                                                            __auto_type ptr_type = _mv_821.value;
...
uint8_t stmt_binding_has_mut(slop_list_types_SExpr_ptr items) {
    if (((int64_t)((items).len)) < 1) {
        ...
        if (_mv_822.has_value) {
            __auto_type first = _mv_822.value;
            __auto_type _mv_823 = (*first);
            switch (_mv_823.tag) {
                case types_SExpr_sym:
                {
                ...
                __auto_type lst = _mv_824.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) >= 2) {
                        ...
                        if (_mv_825.has_value) {
                            __auto_type head_expr = _mv_825.value;
                            __auto_type _mv_826 = (*head_expr);
                            switch (_mv_826.tag) {
                                case types_SExpr_sym:
                                {
    ...
    switch (_mv_828.tag) {
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_828.data.lst;
            {
                __auto_type items = lst.items;
                if (((int64_t)((items).len)) == 1) {
                    __auto_type _mv_829 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            ...
            __auto_type lst = _mv_831.data.lst;
            {
                ...
                if (len < 3) {
                    ...
                    if (_mv_832.has_value) {
                        __auto_type cond_expr = _mv_832.value;
                        {
                            ...
                            context_ctx_indent(ctx);
                            __auto_type _mv_833 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_833.has_value) {
                                __auto_type then_expr = _mv_833.value;
                            ...
                            if (len >= 4) {
                                ...
                                context_ctx_indent(ctx);
                                __auto_type _mv_834 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_834.has_value) {
                                    __auto_type else_expr = _mv_834.value;
            ...
            __auto_type lst = _mv_835.data.lst;
            {
                ...
                if (len < 3) {
                    ...
                    if (_mv_836.has_value) {
                        __auto_type cond_expr = _mv_836.value;
                        {
                            __auto_type cond_c = context_ctx_strip_cond_parens(ctx, expr_transpile_expr(ctx, cond_expr));
                            context_ctx_emit(ctx, context_ctx_str3(ctx, SLOP_STR("if ("), cond_c, SLOP_STR(") {")));
                            context_ctx_indent(ctx);
                            {
                                __auto_type i = 2;
                                while (i < len) {
                                    __auto_type _mv_837 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_838.data.lst;
            {
                ...
                if (len < 3) {
                    ...
                    __auto_type _mv_839 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_839.has_value) {
                        __auto_type cond_expr = _mv_839.value;
                        {
                            __auto_type cond_c = context_ctx_strip_cond_parens(ctx, expr_transpile_expr(ctx, cond_expr));
                            ...
                            context_ctx_indent(ctx);
                            {
                                __auto_type i = 2;
                                while (i < len) {
                                    __auto_type _mv_840 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    if (_mv_840.has_value) {
                                        __auto_type body_expr = _mv_840.value;
                                        stmt_transpile_stmt(ctx, body_expr, 0);
                ...
                __auto_type lst = _mv_841.data.lst;
                {
                    ...
                    if (expr_set_is_self_assign(items)) {
                        ...
                        if (_mv_842.has_value) {
                            __auto_type target_expr = _mv_842.value;
                            __auto_type _mv_843 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_843.has_value) {
                                __auto_type value_expr = _mv_843.value;
                                {
                                    ...
                                    __auto_type _mv_844 = target_type_opt;
                                    if (_mv_844.has_value) {
                                        __auto_type target_type = _mv_844.value;
                                        if (strlib_starts_with(target_type, SLOP_STR("slop_option_"))) {
                                            {
                                                ...
                                                if (_mv_845.has_value) {
                                                    __auto_type val_expr = _mv_845.value;
                                                    {
                                        ...
                                        {
                                            __auto_type some_val_opt = stmt_get_some_value(value_expr);
                                            __auto_type _mv_846 = some_val_opt;
                                            if (_mv_846.has_value) {
                                                __auto_type inner_expr = _mv_846.value;
                                                {
                                                ...
                                                if (stmt_is_none_form(value_expr)) {
                                                    __auto_type _mv_847 = context_ctx_get_current_return_type(ctx);
                                                    if (_mv_847.has_value) {
                                                        __auto_type ret_type = _mv_847.value;
...
slop_option_string stmt_get_var_c_type(context_TranspileContext* ctx, types_SExpr* expr) {
    ...
    switch (_mv_848.tag) {
        case types_SExpr_sym:
        {
            ...
            {
                __auto_type name = sym.name;
                __auto_type _mv_849 = context_ctx_lookup_var(ctx, name);
                if (_mv_849.has_value) {
                    __auto_type var_entry = _mv_849.value;
...
uint8_t stmt_is_pointer_target(context_TranspileContext* ctx, types_SExpr* expr) {
    ...
    switch (_mv_850.tag) {
        case types_SExpr_sym:
        {
            ...
            {
                __auto_type name = sym.name;
                __auto_type _mv_851 = context_ctx_lookup_var(ctx, name);
                if (_mv_851.has_value) {
                    __auto_type var_entry = _mv_851.value;
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (_mv_852.has_value) {
            ...
            if (_mv_853.has_value) {
                __auto_type field_expr = _mv_853.value;
                __auto_type _mv_854 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_854.has_value) {
                    __auto_type value_expr = _mv_854.value;
                    {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (_mv_855.has_value) {
            ...
            if (_mv_856.has_value) {
                ...
                __auto_type _mv_857 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_857.has_value) {
                    __auto_type type_expr = _mv_857.value;
                    __auto_type _mv_858 = ({ __auto_type _lst = items; size_t _idx = (size_t)4; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_858.has_value) {
                        __auto_type value_expr = _mv_858.value;
                        {
                            __auto_type field_name = stmt_get_symbol_name(arena, field_expr);
                            __auto_type c_type = ctype_to_c_type(arena, type_expr);
                            {
                                ...
                                if (strlib_starts_with(c_type, SLOP_STR("slop_option_"))) {
                                    if (stmt_is_none_form(value_expr)) {
                                        ...
                                        __auto_type _mv_859 = stmt_get_some_value(value_expr);
                                        if (_mv_859.has_value) {
                                            __auto_type inner_val = _mv_859.value;
                                            {
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_860.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 1) {
                    ...
                    __auto_type _mv_861 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_863.data.lst;
            {
                ...
                if (_mv_864.has_value) {
                    __auto_type inner = _mv_864.value;
                    return inner;
    ...
    switch (_mv_866.tag) {
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_866.data.lst;
            {
                ...
                __auto_type i = 1;
                while (i < len) {
                    __auto_type _mv_867 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                ...
                if (len < 2) {
                ...
                } else {
                    {
                        ...
                        if (is_named && (len < 4)) {
                            ...
                            context_ctx_indent(ctx);
                            context_ctx_push_scope(ctx);
                            __auto_type _mv_869 = ({ __auto_type _lst = items; size_t _idx = (size_t)size_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_869.has_value) {
                                __auto_type size_expr = _mv_869.value;
                                {
                            ...
                            context_ctx_bind_var(ctx, (context_VarEntry){arena_name, arena_name, SLOP_STR("slop_arena*"), SLOP_STR(""), 1, 0, 0, SLOP_STR(""), SLOP_STR("")});
                            {
                                ...
                                while (i < len) {
                                    __auto_type _mv_870 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    if (_mv_870.has_value) {
                                        __auto_type body_expr = _mv_870.value;
                                        {
                                            __auto_type is_last = (i == (len - 1));
                                            stmt_transpile_stmt(ctx, body_expr, (is_return && is_last));
                                        }
            ...
            __auto_type lst = _mv_871.data.lst;
            {
                ...
                while (i < len) {
                    ...
                    if (_mv_872.has_value) {
                        __auto_type clause_expr = _mv_872.value;
                        __auto_type _mv_873 = (*clause_expr);
                        switch (_mv_873.tag) {
                            case types_SExpr_lst:
                            {
                                __auto_type clause_lst = _mv_873.data.lst;
                                {
                                    ...
                                    if (clause_len < 1) {
                                        ...
                                        __auto_type _mv_874 = ({ __auto_type _lst = clause_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_874.has_value) {
                                            __auto_type test_expr = _mv_874.value;
                                            __auto_type _mv_875 = (*test_expr);
                                            switch (_mv_875.tag) {
                                                case types_SExpr_sym:
                                                {
                ...
                __auto_type lst = _mv_877.data.lst;
                {
                    ...
                    if (len < 2) {
                        ...
                        if (_mv_878.has_value) {
                            __auto_type binding_expr = _mv_878.value;
                            __auto_type _mv_879 = (*binding_expr);
                            switch (_mv_879.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type binding_lst = _mv_879.data.lst;
                                    {
                                        ...
                                        if (binding_len < 3) {
                                            ...
                                            __auto_type _mv_880 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_880.has_value) {
                                                __auto_type var_expr = _mv_880.value;
                                                __auto_type _mv_881 = (*var_expr);
                                                switch (_mv_881.tag) {
                                                    case types_SExpr_sym:
                                                    {
                                                        __auto_type var_sym = _mv_881.data.sym;
                                                        {
                                                            __auto_type var_name = ctype_to_c_name(arena, var_sym.name);
                                                            __auto_type _mv_882 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                            if (_mv_882.has_value) {
                                                                __auto_type start_expr = _mv_882.value;
                                                                __auto_type _mv_883 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                                if (_mv_883.has_value) {
                                                                    __auto_type end_expr = _mv_883.value;
                                                                    {
        ...
        context_ctx_bind_var(ctx, (context_VarEntry){var_sym.name, var_name, key_c_type, key_slop_type, 0, 0, 0, SLOP_STR(""), SLOP_STR("")});
        {
            ...
            while (i < len) {
                ...
                if (_mv_886.has_value) {
                    __auto_type body_expr = _mv_886.value;
                    stmt_transpile_stmt(ctx, body_expr, 0);
...
void stmt_transpile_for_each_map_kv(context_TranspileContext* ctx, slop_list_types_SExpr_ptr binding_items, slop_list_types_SExpr_ptr items, int64_t len) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_887 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        if (_mv_887.has_value) {
            __auto_type kv_list_expr = _mv_887.value;
            __auto_type _mv_888 = (*kv_list_expr);
            switch (_mv_888.tag) {
                case types_SExpr_lst:
                {
                    __auto_type kv_lst = _mv_888.data.lst;
                    {
                        __auto_type kv_items = kv_lst.items;
                        if (((int64_t)((kv_items).len)) < 2) {
                            context_ctx_add_error(ctx, SLOP_STR("Map for-each needs ((k v) map)"));
                        } else {
                            __auto_type _mv_889 = ({ __auto_type _lst = kv_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_889.has_value) {
                                __auto_type k_expr = _mv_889.value;
                                __auto_type _mv_890 = ({ __auto_type _lst = kv_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_890.has_value) {
                                    __auto_type v_expr = _mv_890.value;
                                    __auto_type _mv_891 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    if (_mv_891.has_value) {
                                        __auto_type map_expr = _mv_891.value;
                                        __auto_type _mv_892 = (*k_expr);
                                        switch (_mv_892.tag) {
                                            case types_SExpr_sym:
                                            {
                                                __auto_type k_sym = _mv_892.data.sym;
                                                __auto_type _mv_893 = (*v_expr);
                                                switch (_mv_893.tag) {
                                                    case types_SExpr_sym:
                                                    {
                                                        __auto_type v_sym = _mv_893.data.sym;
                                                        {
                                    ...
                                    __auto_type binding_lst = _mv_897.data.lst;
                                    {
                                        ...
                                        if (binding_len < 2) {
                                            ...
                                            if (_mv_898.has_value) {
                                                __auto_type first_elem = _mv_898.value;
                                                __auto_type _mv_899 = (*first_elem);
                                                switch (_mv_899.tag) {
                                                    case types_SExpr_lst:
                                                    {
                                                    ...
                                                    case types_SExpr_sym:
                                                    {
                                                        __auto_type var_sym = _mv_899.data.sym;
                                                        {
                                                            ...
                                                            if (_mv_900.has_value) {
                                                                __auto_type coll_expr = _mv_900.value;
                                                                {
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_902.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 1) {
                    ...
                    __auto_type _mv_903 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_903.has_value) {
                        __auto_type head_expr = _mv_903.value;
                        __auto_type _mv_904 = (*head_expr);
                        switch (_mv_904.tag) {
                            case types_SExpr_sym:
                            {
                                    ...
                                    if (string_eq(op, SLOP_STR("let")) || string_eq(op, SLOP_STR("let*"))) {
                                        ...
                                        if (((int64_t)((items).len)) < 2) {
                                            ...
                                            if (_mv_905.has_value) {
                                                __auto_type val_expr = _mv_905.value;
                            ...
                            case types_SExpr_sym:
                            {
                                __auto_type sym = _mv_908.data.sym;
                                {
                                    ...
                                    if (string_eq(op, SLOP_STR("some"))) {
                                        __auto_type _mv_909 = context_ctx_get_current_return_type(ctx);
                                        if (_mv_909.has_value) {
                                            __auto_type ret_type = _mv_909.value;
                                            if (strlib_starts_with(ret_type, SLOP_STR("slop_option_"))) {
                                                if (((int64_t)((items).len)) < 2) {
                                                    stmt_emit_return_with_typed_none(ctx, expr_transpile_expr(ctx, expr));
                                                } else {
                                                    ...
                                                    if (_mv_910.has_value) {
                                                        __auto_type inner_expr = _mv_910.value;
                                                        {
                                                            __auto_type inner_c = expr_transpile_expr(ctx, inner_expr);
                                        ...
                                        __auto_type _mv_911 = context_ctx_get_current_return_type(ctx);
                                        if (_mv_911.has_value) {
                                            __auto_type ret_type = _mv_911.value;
                                            if (strlib_starts_with(ret_type, SLOP_STR("slop_option_"))) {
...
void stmt_emit_return_with_typed_none(context_TranspileContext* ctx, slop_string code) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (string_eq(code, SLOP_STR("none"))) {
            __auto_type _mv_912 = context_ctx_get_current_return_type(ctx);
            if (_mv_912.has_value) {
                __auto_type ret_type = _mv_912.value;
                if (strlib_starts_with(ret_type, SLOP_STR("slop_option_"))) {
            ...
            __auto_type _mv_913 = context_ctx_get_current_return_type(ctx);
            if (_mv_913.has_value) {
                __auto_type ret_type = _mv_913.value;
                if (strlib_starts_with(ret_type, SLOP_STR("slop_option_"))) {
                    __auto_type _mv_914 = context_ctx_lookup_var(ctx, code);
                    if (_mv_914.has_value) {
                        __auto_type var_entry = _mv_914.value;
                        {
