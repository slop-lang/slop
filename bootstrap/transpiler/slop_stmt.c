            ...
            __auto_type lst = _mv_805.data.lst;
            {
                ...
                while (i < len) {
                    ...
                    if (_mv_806.has_value) {
                        __auto_type item_expr = _mv_806.value;
                        {
                                    ...
                                    __auto_type head_sym = _mv_809.data.sym;
                                    {
                                        ...
                                        if (string_eq(op, SLOP_STR("arena-alloc"))) {
                                            ...
                                            if (_mv_810.has_value) {
                                                __auto_type size_expr = _mv_810.value;
            ...
            __auto_type lst = _mv_817.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 1) {
                    ...
                    if (_mv_818.has_value) {
                        __auto_type head_expr = _mv_818.value;
                        __auto_type _mv_819 = (*head_expr);
                        switch (_mv_819.tag) {
                            case types_SExpr_sym:
                            {
                ...
                __auto_type lst = _mv_820.data.lst;
                {
                    ...
                    if (len < 2) {
                        ...
                        if (_mv_821.has_value) {
                            __auto_type bindings_expr = _mv_821.value;
                            __auto_type _mv_822 = (*bindings_expr);
                            switch (_mv_822.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type bindings_lst = _mv_822.data.lst;
                        ...
                        }
                        {
                            ...
                            while (i < len) {
                                ...
                                if (_mv_823.has_value) {
                                    __auto_type body_expr = _mv_823.value;
                                    {
...
void stmt_transpile_bindings(context_TranspileContext* ctx, slop_list_types_SExpr_ptr bindings) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_824 = ({ __auto_type _lst = bindings; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void stmt_transpile_single_binding(context_TranspileContext* ctx, types_SExpr* binding) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_825 = (*binding);
        switch (_mv_825.tag) {
            case types_SExpr_lst:
            {
                __auto_type binding_lst = _mv_825.data.lst;
                {
                    ...
                    __auto_type len = ((int64_t)((items).len));
                    {
                        ...
                        if ((len - start_idx) < 2) {
                            ...
                            __auto_type _mv_826 = ({ __auto_type _lst = items; size_t _idx = (size_t)start_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_826.has_value) {
                                __auto_type name_expr = _mv_826.value;
                                __auto_type _mv_827 = (*name_expr);
                                switch (_mv_827.tag) {
                                    case types_SExpr_sym:
                                    {
                                        __auto_type name_sym = _mv_827.data.sym;
                                        {
                                            ...
                                            if ((len - start_idx) >= 3) {
                                                ...
                                                if (_mv_828.has_value) {
                                                    __auto_type type_expr = _mv_828.value;
                                                    __auto_type _mv_829 = ({ __auto_type _lst = items; size_t _idx = (size_t)(start_idx + 2); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                ...
                                                __auto_type _mv_830 = ({ __auto_type _lst = items; size_t _idx = (size_t)(start_idx + 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_830.has_value) {
                                                    __auto_type init_expr = _mv_830.value;
                                                    {
                                                        ...
                                                        __auto_type _mv_831 = ptr_type_opt;
                                                        if (_mv_831.has_value) {
                                                            __auto_type ptr_type = _mv_831.value;
...
uint8_t stmt_binding_has_mut(slop_list_types_SExpr_ptr items) {
    if (((int64_t)((items).len)) < 1) {
        ...
        if (_mv_832.has_value) {
            __auto_type first = _mv_832.value;
            __auto_type _mv_833 = (*first);
            switch (_mv_833.tag) {
                case types_SExpr_sym:
                {
                ...
                __auto_type lst = _mv_834.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) >= 2) {
                        ...
                        if (_mv_835.has_value) {
                            __auto_type head_expr = _mv_835.value;
                            __auto_type _mv_836 = (*head_expr);
                            switch (_mv_836.tag) {
                                case types_SExpr_sym:
                                {
            ...
            __auto_type lst = _mv_838.data.lst;
            {
                ...
                if (((int64_t)((items).len)) == 1) {
                    ...
                    if (_mv_839.has_value) {
                        __auto_type head = _mv_839.value;
                        __auto_type _mv_840 = (*head);
                        switch (_mv_840.tag) {
                            case types_SExpr_sym:
                            {
                    ...
                    if (_mv_842.has_value) {
                        __auto_type cond_expr = _mv_842.value;
                        {
                            ...
                            if (_mv_843.has_value) {
                                __auto_type then_expr = _mv_843.value;
                            ...
                            if (len >= 4) {
                                ...
                                context_ctx_indent(ctx);
                                __auto_type _mv_844 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_844.has_value) {
                                    __auto_type else_expr = _mv_844.value;
                    ...
                    if (expr_set_is_self_assign(items)) {
                        ...
                        if (_mv_852.has_value) {
                            ...
                            if (_mv_853.has_value) {
                                __auto_type value_expr = _mv_853.value;
                                {
...
uint8_t stmt_is_pointer_target(context_TranspileContext* ctx, types_SExpr* expr) {
    ...
    switch (_mv_860.tag) {
        case types_SExpr_sym:
        {
            ...
            {
                __auto_type name = sym.name;
                __auto_type _mv_861 = context_ctx_lookup_var(ctx, name);
                if (_mv_861.has_value) {
                    __auto_type var_entry = _mv_861.value;
...
void stmt_transpile_field_set(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (_mv_862.has_value) {
            __auto_type target_expr = _mv_862.value;
            ...
            if (_mv_863.has_value) {
                __auto_type field_expr = _mv_863.value;
        ...
        if (_mv_865.has_value) {
            ...
            if (_mv_866.has_value) {
                ...
                if (_mv_867.has_value) {
                    __auto_type type_expr = _mv_867.value;
                    __auto_type _mv_868 = ({ __auto_type _lst = items; size_t _idx = (size_t)4; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            ...
                            __auto_type c_type = ctype_to_c_type(arena, type_expr);
                            {
                                ...
                                if (context_ctx_is_option_c_type(ctx, c_type)) {
                                    if (stmt_is_none_form(value_expr)) {
                                        ...
                                        __auto_type _mv_869 = stmt_get_some_value(value_expr);
                                        if (_mv_869.has_value) {
                                            __auto_type inner_val = _mv_869.value;
                                            {
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_870.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 1) {
                    ...
                    __auto_type _mv_871 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_873.data.lst;
            {
                ...
                if (_mv_874.has_value) {
                    __auto_type inner = _mv_874.value;
                    return inner;
                ...
                if (len < 2) {
                ...
                } else {
                    {
                        ...
                        if (is_named && (len < 4)) {
                            ...
                            context_ctx_indent(ctx);
                            context_ctx_push_scope(ctx);
                            __auto_type _mv_879 = ({ __auto_type _lst = items; size_t _idx = (size_t)size_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_879.has_value) {
                                __auto_type size_expr = _mv_879.value;
                                {
            ...
            __auto_type lst = _mv_881.data.lst;
            {
                ...
                while (i < len) {
                    ...
                    if (_mv_882.has_value) {
                        __auto_type clause_expr = _mv_882.value;
                        __auto_type _mv_883 = (*clause_expr);
                        switch (_mv_883.tag) {
                            case types_SExpr_lst:
                            {
                                __auto_type clause_lst = _mv_883.data.lst;
                                {
                                    ...
                                    if (clause_len < 1) {
                                        ...
                                        __auto_type _mv_884 = ({ __auto_type _lst = clause_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_884.has_value) {
                                            __auto_type test_expr = _mv_884.value;
                                            __auto_type _mv_885 = (*test_expr);
                                            switch (_mv_885.tag) {
                                                case types_SExpr_sym:
                                                {
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_887.data.lst;
                {
                    ...
                    if (len < 2) {
                        ...
                        __auto_type _mv_888 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_888.has_value) {
                            __auto_type binding_expr = _mv_888.value;
                            __auto_type _mv_889 = (*binding_expr);
                            switch (_mv_889.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type binding_lst = _mv_889.data.lst;
                                    {
                                        ...
                                        if (binding_len < 3) {
                                            ...
                                            __auto_type _mv_890 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_890.has_value) {
                                                __auto_type var_expr = _mv_890.value;
                                                __auto_type _mv_891 = (*var_expr);
                                                switch (_mv_891.tag) {
                                                    case types_SExpr_sym:
                                                    {
                                                        __auto_type var_sym = _mv_891.data.sym;
                                                        {
                                                            __auto_type var_name = ctype_to_c_name(arena, var_sym.name);
                                                            __auto_type _mv_892 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                            if (_mv_892.has_value) {
                                                                __auto_type start_expr = _mv_892.value;
                                                                __auto_type _mv_893 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                                if (_mv_893.has_value) {
                                                                    __auto_type end_expr = _mv_893.value;
                                                                    {
...
void stmt_transpile_for_each_map_kv(context_TranspileContext* ctx, slop_list_types_SExpr_ptr binding_items, slop_list_types_SExpr_ptr items, int64_t len) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_897 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        if (_mv_897.has_value) {
            __auto_type kv_list_expr = _mv_897.value;
            __auto_type _mv_898 = (*kv_list_expr);
            switch (_mv_898.tag) {
                case types_SExpr_lst:
                {
                    __auto_type kv_lst = _mv_898.data.lst;
                    {
                        __auto_type kv_items = kv_lst.items;
                        if (((int64_t)((kv_items).len)) < 2) {
                            context_ctx_add_error(ctx, SLOP_STR("Map for-each needs ((k v) map)"));
                        } else {
                            __auto_type _mv_899 = ({ __auto_type _lst = kv_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_899.has_value) {
                                __auto_type k_expr = _mv_899.value;
                                __auto_type _mv_900 = ({ __auto_type _lst = kv_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_900.has_value) {
                                    __auto_type v_expr = _mv_900.value;
                                    __auto_type _mv_901 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    if (_mv_901.has_value) {
                                        __auto_type map_expr = _mv_901.value;
                                        __auto_type _mv_902 = (*k_expr);
                                        switch (_mv_902.tag) {
                                            case types_SExpr_sym:
                                            {
                                                __auto_type k_sym = _mv_902.data.sym;
                                                __auto_type _mv_903 = (*v_expr);
                                                switch (_mv_903.tag) {
                                                    case types_SExpr_sym:
                                                    {
                                                        __auto_type v_sym = _mv_903.data.sym;
                                                        {
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_905.data.lst;
                {
                    ...
                    if (len < 2) {
                        ...
                        __auto_type _mv_906 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_906.has_value) {
                            __auto_type binding_expr = _mv_906.value;
                            __auto_type _mv_907 = (*binding_expr);
                            switch (_mv_907.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type binding_lst = _mv_907.data.lst;
                                    {
                                        __auto_type binding_items = binding_lst.items;
                                        __auto_type binding_len = ((int64_t)((binding_items).len));
                                        if (binding_len < 2) {
                                            ...
                                            if (_mv_908.has_value) {
                                                __auto_type first_elem = _mv_908.value;
                                                __auto_type _mv_909 = (*first_elem);
                                                switch (_mv_909.tag) {
                                                    case types_SExpr_lst:
                                                    {
                                                        __auto_type _ = _mv_909.data.lst;
                                                        stmt_transpile_for_each_map_kv(ctx, binding_items, items, len);
                                                        break;
                                                    }
                                                    case types_SExpr_sym:
                                                    {
                                                        __auto_type var_sym = _mv_909.data.sym;
                                                        {
                                                            __auto_type var_name = ctype_to_c_name(arena, var_sym.name);
                                                            __auto_type _mv_910 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                            if (_mv_910.has_value) {
                                                                __auto_type coll_expr = _mv_910.value;
                                                                {
            ...
            __auto_type lst = _mv_912.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 1) {
                    ...
                    if (_mv_913.has_value) {
                        __auto_type head_expr = _mv_913.value;
                        __auto_type _mv_914 = (*head_expr);
                        switch (_mv_914.tag) {
                            case types_SExpr_sym:
                            {
                                    ...
                                    if (string_eq(op, SLOP_STR("let")) || string_eq(op, SLOP_STR("let*"))) {
                                        ...
                                        if (((int64_t)((items).len)) < 2) {
                                            ...
                                            if (_mv_915.has_value) {
                                                __auto_type val_expr = _mv_915.value;
                                        ...
                                        if (_mv_919.has_value) {
                                            ...
                                            if (context_ctx_is_option_c_type(ctx, ret_type)) {
                                                if (((int64_t)((items).len)) < 2) {
                                                    ...
                                                    __auto_type _mv_920 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (string_eq(code, SLOP_STR("none"))) {
            ...
            if (_mv_923.has_value) {
                ...
                if (context_ctx_is_option_c_type(ctx, ret_type)) {
                    __auto_type _mv_924 = context_ctx_lookup_var(ctx, code);
                    if (_mv_924.has_value) {
                        __auto_type var_entry = _mv_924.value;
                        {
