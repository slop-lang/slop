    ...
    switch (_mv_702.tag) {
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_702.data.lst;
            {
                ...
                __auto_type i = 0;
                while ((i < len)) {
                    __auto_type _mv_703 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_703.has_value) {
                        __auto_type item_expr = _mv_703.value;
                        {
                ...
                __auto_type lst = _mv_704.data.lst;
                {
                    ...
                    if ((((int64_t)((items).len)) >= 3)) {
                        ...
                        if (_mv_705.has_value) {
                            __auto_type head_ptr = _mv_705.value;
                            __auto_type _mv_706 = (*head_ptr);
                            switch (_mv_706.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type head_sym = _mv_706.data.sym;
                                    if (string_eq(head_sym.name, SLOP_STR("arena-alloc"))) {
                                        ...
                                        if (_mv_707.has_value) {
                                            __auto_type size_expr = _mv_707.value;
        ...
        switch (_mv_708.tag) {
            case types_SExpr_sym:
            {
                __auto_type sym = _mv_708.data.sym;
                {
                    ...
                    __auto_type _mv_709 = context_ctx_lookup_type(ctx, type_name);
                    if (_mv_709.has_value) {
                        __auto_type entry = _mv_709.value;
                                ...
                                case types_SExpr_sym:
                                {
                                    ...
                                    if (string_eq(head_sym.name, SLOP_STR("sizeof"))) {
                                        ...
                                        if (_mv_712.has_value) {
                                            __auto_type type_expr = _mv_712.value;
                                            {
            ...
            __auto_type lst = _mv_713.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    if (_mv_714.has_value) {
                        __auto_type head_expr = _mv_714.value;
                        __auto_type _mv_715 = (*head_expr);
                        switch (_mv_715.tag) {
                            case types_SExpr_sym:
                            {
                ...
                __auto_type lst = _mv_716.data.lst;
                {
                    ...
                    if ((len < 2)) {
                        ...
                        if (_mv_717.has_value) {
                            __auto_type bindings_expr = _mv_717.value;
...
void stmt_transpile_bindings(context_TranspileContext* ctx, slop_list_types_SExpr_ptr bindings) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        __auto_type i = 0;
        while ((i < len)) {
            __auto_type _mv_720 = ({ __auto_type _lst = bindings; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_720.has_value) {
                __auto_type binding_expr = _mv_720.value;
...
void stmt_transpile_single_binding(context_TranspileContext* ctx, types_SExpr* binding) {
    ...
    SLOP_PRE(((binding != NULL)), "(!= binding nil)");
    {
        ...
        switch (_mv_721.tag) {
            case types_SExpr_lst:
            {
                __auto_type binding_lst = _mv_721.data.lst;
                {
                    ...
                    __auto_type len = ((int64_t)((items).len));
                    {
                        ...
                        if (((len - start_idx) < 2)) {
                            ...
                            __auto_type _mv_722 = ({ __auto_type _lst = items; size_t _idx = (size_t)start_idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_722.has_value) {
                                ...
                                switch (_mv_723.tag) {
                                    case types_SExpr_sym:
                                    {
                                        __auto_type name_sym = _mv_723.data.sym;
                                        {
                                            __auto_type raw_name = name_sym.name;
                                            __auto_type var_name = ctype_to_c_name(arena, raw_name);
                                            if (((len - start_idx) >= 3)) {
                                                __auto_type _mv_724 = ({ __auto_type _lst = items; size_t _idx = (size_t)(start_idx + 1); slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_724.has_value) {
                                                    __auto_type type_expr = _mv_724.value;
                                                    __auto_type _mv_725 = ({ __auto_type _lst = items; size_t _idx = (size_t)(start_idx + 2); slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_725.has_value) {
                                                        __auto_type init_expr = _mv_725.value;
                                                        {
                                                            __auto_type c_type = context_to_c_type_prefixed(ctx, type_expr);
                                                            {
                                                ...
                                                __auto_type _mv_726 = ({ __auto_type _lst = items; size_t _idx = (size_t)(start_idx + 1); slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_726.has_value) {
                                                    __auto_type init_expr = _mv_726.value;
                                                    {
                                                        ...
                                                        __auto_type _mv_727 = ptr_type_opt;
                                                        if (_mv_727.has_value) {
                                                            __auto_type ptr_type = _mv_727.value;
...
uint8_t stmt_binding_has_mut(slop_list_types_SExpr_ptr items) {
    if ((((int64_t)((items).len)) < 1)) {
        ...
        __auto_type _mv_728 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        switch (_mv_730.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_730.data.lst;
                {
                    __auto_type items = lst.items;
                    if ((((int64_t)((items).len)) >= 2)) {
                        __auto_type _mv_731 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_731.has_value) {
                            __auto_type head_expr = _mv_731.value;
                            __auto_type _mv_732 = (*head_expr);
                            switch (_mv_732.tag) {
                                case types_SExpr_sym:
                                {
    ...
    switch (_mv_734.tag) {
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_734.data.lst;
            {
                __auto_type items = lst.items;
                if ((((int64_t)((items).len)) == 1)) {
                    __auto_type _mv_735 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                ...
                if ((len < 3)) {
                    ...
                    if (_mv_738.has_value) {
                        __auto_type cond_expr = _mv_738.value;
                        {
                            ...
                            context_ctx_indent(ctx);
                            __auto_type _mv_739 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            ...
                            if ((len >= 4)) {
                                ...
                                context_ctx_indent(ctx);
                                __auto_type _mv_740 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_741.data.lst;
            {
                ...
                if ((len < 3)) {
                    ...
                    __auto_type _mv_742 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_742.has_value) {
                        __auto_type cond_expr = _mv_742.value;
                        {
                            __auto_type cond_c = expr_transpile_expr(ctx, cond_expr);
                            context_ctx_emit(ctx, context_ctx_str3(ctx, SLOP_STR("if ("), cond_c, SLOP_STR(") {")));
                            context_ctx_indent(ctx);
                            {
                                __auto_type i = 2;
                                while ((i < len)) {
                                    __auto_type _mv_743 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                ...
                __auto_type lst = _mv_747.data.lst;
                {
                    ...
                    if ((len == 5)) {
                        ...
                        if (_mv_748.has_value) {
                            ...
                            __auto_type _mv_749 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_749.has_value) {
                                __auto_type value_expr = _mv_749.value;
                                {
                                        ...
                                        if (strlib_starts_with(target_type, SLOP_STR("slop_option_"))) {
                                            {
                                                ...
                                                if (_mv_751.has_value) {
                                                    __auto_type val_expr = _mv_751.value;
                                                    {
...
slop_option_string stmt_get_var_c_type(context_TranspileContext* ctx, types_SExpr* expr) {
    ...
    switch (_mv_754.tag) {
        case types_SExpr_sym:
        {
            ...
            {
                __auto_type name = sym.name;
                __auto_type _mv_755 = context_ctx_lookup_var(ctx, name);
                if (_mv_755.has_value) {
                    __auto_type var_entry = _mv_755.value;
...
void stmt_transpile_field_set(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (_mv_758.has_value) {
            ...
            __auto_type _mv_759 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_759.has_value) {
                __auto_type field_expr = _mv_759.value;
                __auto_type _mv_760 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void stmt_transpile_typed_field_set(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (_mv_761.has_value) {
            ...
            __auto_type _mv_762 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_762.has_value) {
                __auto_type field_expr = _mv_762.value;
                __auto_type _mv_763 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_763.has_value) {
                    __auto_type type_expr = _mv_763.value;
                    __auto_type _mv_764 = ({ __auto_type _lst = items; size_t _idx = (size_t)4; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            ...
                            __auto_type c_type = ctype_to_c_type(arena, type_expr);
                            {
                                ...
                                if (strlib_starts_with(c_type, SLOP_STR("slop_option_"))) {
                                    if (stmt_is_none_form(value_expr)) {
                                        ...
                                        __auto_type _mv_765 = stmt_get_some_value(value_expr);
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_769.data.lst;
            {
                ...
                if (_mv_770.has_value) {
                    __auto_type inner = _mv_770.value;
                    return inner;
                ...
                if ((len < 2)) {
                ...
                } else {
                    {
                        ...
                        if ((is_named && (len < 4))) {
                            ...
                            context_ctx_indent(ctx);
                            context_ctx_push_scope(ctx);
                            __auto_type _mv_775 = ({ __auto_type _lst = items; size_t _idx = (size_t)size_idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_775.has_value) {
                                __auto_type size_expr = _mv_775.value;
                                {
                            ...
                            context_ctx_bind_var(ctx, (context_VarEntry){arena_name, arena_name, SLOP_STR("slop_arena*"), SLOP_STR(""), 1, 0, 0, SLOP_STR(""), SLOP_STR("")});
                            {
                                ...
                                while ((i < len)) {
                                    __auto_type _mv_776 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            ...
                            case types_SExpr_lst:
                            {
                                __auto_type clause_lst = _mv_779.data.lst;
                                {
                                    ...
                                    if ((clause_len < 1)) {
                                        ...
                                        __auto_type _mv_780 = ({ __auto_type _lst = clause_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void stmt_transpile_cond_body(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items, int64_t start, uint8_t is_return) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        __auto_type i = start;
        while ((i < len)) {
            __auto_type _mv_782 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                ...
                __auto_type lst = _mv_783.data.lst;
                {
                    ...
                    if ((len < 2)) {
                        ...
                        if (_mv_784.has_value) {
                            __auto_type binding_expr = _mv_784.value;
                            __auto_type _mv_785 = (*binding_expr);
                            switch (_mv_785.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type binding_lst = _mv_785.data.lst;
                                    {
                                        ...
                                        if ((binding_len < 3)) {
                                            ...
                                            __auto_type _mv_786 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_786.has_value) {
                                                __auto_type var_expr = _mv_786.value;
                                                __auto_type _mv_787 = (*var_expr);
                                                switch (_mv_787.tag) {
                                                    case types_SExpr_sym:
                                                    {
                                                        __auto_type var_sym = _mv_787.data.sym;
                                                        {
                                                            __auto_type var_name = ctype_to_c_name(arena, var_sym.name);
                                                            __auto_type _mv_788 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                            if (_mv_788.has_value) {
                                                                __auto_type start_expr = _mv_788.value;
                                                                __auto_type _mv_789 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                                if (_mv_789.has_value) {
                                                                    __auto_type end_expr = _mv_789.value;
                                                                    {
                ...
                __auto_type lst = _mv_791.data.lst;
                {
                    ...
                    if ((len < 2)) {
                        ...
                        if (_mv_792.has_value) {
                            __auto_type binding_expr = _mv_792.value;
                            __auto_type _mv_793 = (*binding_expr);
                            switch (_mv_793.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type binding_lst = _mv_793.data.lst;
                                    {
                                        ...
                                        if ((binding_len < 2)) {
                                            ...
                                            __auto_type _mv_794 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_794.has_value) {
                                                __auto_type var_expr = _mv_794.value;
                                                __auto_type _mv_795 = (*var_expr);
                                                switch (_mv_795.tag) {
                                                    case types_SExpr_sym:
                                                    {
                                                        __auto_type var_sym = _mv_795.data.sym;
                                                        {
                                                            __auto_type var_name = ctype_to_c_name(arena, var_sym.name);
                                                            __auto_type _mv_796 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                            if (_mv_796.has_value) {
                                                                __auto_type coll_expr = _mv_796.value;
                                                                {
                                                                    ...
                                                                    }
                                                                    {
                                                                        ...
                                                                        while ((i < len)) {
                                                                            ...
                                                                            if (_mv_797.has_value) {
                                                                                __auto_type body_expr = _mv_797.value;
                                                                                stmt_transpile_stmt(ctx, body_expr, 0);
                                    ...
                                    if ((string_eq(op, SLOP_STR("let")) || string_eq(op, SLOP_STR("let*")))) {
                                        ...
                                        if ((((int64_t)((items).len)) < 2)) {
                                            ...
                                            if (_mv_801.has_value) {
                                                __auto_type val_expr = _mv_801.value;
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_802.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    __auto_type _mv_803 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_803.has_value) {
                        __auto_type head = _mv_803.value;
                        __auto_type _mv_804 = (*head);
                        switch (_mv_804.tag) {
                            case types_SExpr_sym:
                            {
                                __auto_type sym = _mv_804.data.sym;
                                {
                                    ...
                                    if (string_eq(op, SLOP_STR("some"))) {
                                        __auto_type _mv_805 = context_ctx_get_current_return_type(ctx);
                                        if (_mv_805.has_value) {
                                            __auto_type ret_type = _mv_805.value;
                                            if (strlib_starts_with(ret_type, SLOP_STR("slop_option_"))) {
                                                if ((((int64_t)((items).len)) < 2)) {
                                                    stmt_emit_return_with_typed_none(ctx, expr_transpile_expr(ctx, expr));
                                                } else {
                                        ...
                                        __auto_type _mv_807 = context_ctx_get_current_return_type(ctx);
                                        if (_mv_807.has_value) {
                                            __auto_type ret_type = _mv_807.value;
                                            if (strlib_starts_with(ret_type, SLOP_STR("slop_option_"))) {
...
void stmt_emit_return_with_typed_none(context_TranspileContext* ctx, slop_string code) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (string_eq(code, SLOP_STR("none"))) {
            ...
            __auto_type _mv_809 = context_ctx_get_current_return_type(ctx);
            if (_mv_809.has_value) {
                __auto_type ret_type = _mv_809.value;
                if (strlib_starts_with(ret_type, SLOP_STR("slop_option_"))) {
                    __auto_type _mv_810 = context_ctx_lookup_var(ctx, code);
