            ...
            __auto_type lst = _mv_825.data.lst;
            {
                ...
                while (i < len) {
                    ...
                    if (_mv_826.has_value) {
                        __auto_type item_expr = _mv_826.value;
                        {
                ...
                __auto_type lst = _mv_827.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) >= 3) {
                        ...
                        if (_mv_828.has_value) {
                            __auto_type head_ptr = _mv_828.value;
                            __auto_type _mv_829 = (*head_ptr);
                            switch (_mv_829.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type head_sym = _mv_829.data.sym;
                                    {
                                        __auto_type op = head_sym.name;
                                        if (string_eq(op, SLOP_STR("arena-alloc"))) {
                                            __auto_type _mv_830 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_830.has_value) {
                                                __auto_type size_expr = _mv_830.value;
        ...
        switch (_mv_832.tag) {
            case types_SExpr_sym:
            {
                __auto_type sym = _mv_832.data.sym;
                {
                    ...
                    __auto_type _mv_833 = context_ctx_lookup_type(ctx, type_name);
                    if (_mv_833.has_value) {
                        __auto_type entry = _mv_833.value;
                ...
                __auto_type lst = _mv_832.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) >= 2) {
                        ...
                        if (_mv_834.has_value) {
                            __auto_type head_ptr = _mv_834.value;
                            __auto_type _mv_835 = (*head_ptr);
                            switch (_mv_835.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type head_sym = _mv_835.data.sym;
                ...
                __auto_type lst = _mv_840.data.lst;
                {
                    ...
                    if (len < 2) {
                        ...
                        if (_mv_841.has_value) {
                            __auto_type bindings_expr = _mv_841.value;
                            __auto_type _mv_842 = (*bindings_expr);
                            switch (_mv_842.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type bindings_lst = _mv_842.data.lst;
...
void stmt_transpile_bindings(context_TranspileContext* ctx, slop_list_types_SExpr_ptr bindings) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_844 = ({ __auto_type _lst = bindings; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                ...
                __auto_type binding_lst = _mv_845.data.lst;
                {
                    ...
                    __auto_type len = ((int64_t)((items).len));
                    {
                        ...
                        if ((len - start_idx) < 2) {
                            ...
                            __auto_type _mv_846 = ({ __auto_type _lst = items; size_t _idx = (size_t)start_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_846.has_value) {
                                __auto_type name_expr = _mv_846.value;
                                __auto_type _mv_847 = (*name_expr);
                                switch (_mv_847.tag) {
                                    case types_SExpr_sym:
                                    {
                                        __auto_type name_sym = _mv_847.data.sym;
                                        {
                                            __auto_type raw_name = name_sym.name;
                                            __auto_type var_name = ctype_to_c_name(arena, raw_name);
                                            if ((len - start_idx) >= 3) {
                                                __auto_type _mv_848 = ({ __auto_type _lst = items; size_t _idx = (size_t)(start_idx + 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_848.has_value) {
                                                    __auto_type type_expr = _mv_848.value;
                                                    __auto_type _mv_849 = ({ __auto_type _lst = items; size_t _idx = (size_t)(start_idx + 2); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_849.has_value) {
                                                        __auto_type init_expr = _mv_849.value;
                                                        {
                                                            __auto_type c_type = context_to_c_type_prefixed(ctx, type_expr);
                                                            {
                                                ...
                                                __auto_type _mv_850 = ({ __auto_type _lst = items; size_t _idx = (size_t)(start_idx + 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_850.has_value) {
                                                    __auto_type init_expr = _mv_850.value;
                                                    {
                                                        ...
                                                        __auto_type _mv_851 = ptr_type_opt;
                                                        if (_mv_851.has_value) {
                                                            __auto_type ptr_type = _mv_851.value;
...
uint8_t stmt_binding_has_mut(slop_list_types_SExpr_ptr items) {
    if (((int64_t)((items).len)) < 1) {
        ...
        if (_mv_852.has_value) {
            __auto_type first = _mv_852.value;
            __auto_type _mv_853 = (*first);
            switch (_mv_853.tag) {
                case types_SExpr_sym:
                {
                ...
                if (len < 3) {
                    ...
                    if (_mv_862.has_value) {
                        __auto_type cond_expr = _mv_862.value;
                        {
                            ...
                            context_ctx_indent(ctx);
                            __auto_type _mv_863 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_863.has_value) {
                                __auto_type then_expr = _mv_863.value;
                            ...
                            if (len >= 4) {
                                ...
                                context_ctx_indent(ctx);
                                __auto_type _mv_864 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_864.has_value) {
                                    __auto_type else_expr = _mv_864.value;
            ...
            __auto_type lst = _mv_868.data.lst;
            {
                ...
                if (len < 3) {
                    ...
                    if (_mv_869.has_value) {
                        __auto_type cond_expr = _mv_869.value;
                        {
                            __auto_type cond_c = context_ctx_strip_cond_parens(ctx, expr_transpile_expr(ctx, cond_expr));
                ...
                __auto_type lst = _mv_871.data.lst;
                {
                    ...
                    if (expr_set_is_self_assign(items)) {
                        ...
                        if (_mv_872.has_value) {
                            __auto_type target_expr = _mv_872.value;
                            __auto_type _mv_873 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_873.has_value) {
                                __auto_type value_expr = _mv_873.value;
                                {
                                    __auto_type target_c = expr_transpile_expr(ctx, target_expr);
                                    __auto_type target_type_opt = stmt_get_var_c_type(ctx, target_expr);
                                    __auto_type _mv_874 = target_type_opt;
                                    if (_mv_874.has_value) {
                                        __auto_type target_type = _mv_874.value;
                                        if (context_ctx_is_option_c_type(ctx, target_type)) {
                                            {
                                                __auto_type some_val_opt = stmt_get_some_value(value_expr);
                                                __auto_type _mv_875 = some_val_opt;
                                        ...
                                        {
                                            __auto_type some_val_opt = stmt_get_some_value(value_expr);
                                            __auto_type _mv_876 = some_val_opt;
...
slop_option_string stmt_get_var_c_type(context_TranspileContext* ctx, types_SExpr* expr) {
    ...
    switch (_mv_878.tag) {
        case types_SExpr_sym:
        {
            ...
            {
                __auto_type name = sym.name;
                __auto_type _mv_879 = context_ctx_lookup_var(ctx, name);
                if (_mv_879.has_value) {
                    __auto_type var_entry = _mv_879.value;
...
uint8_t stmt_is_pointer_target(context_TranspileContext* ctx, types_SExpr* expr) {
    ...
    switch (_mv_880.tag) {
        case types_SExpr_sym:
        {
            ...
            {
                __auto_type name = sym.name;
                __auto_type _mv_881 = context_ctx_lookup_var(ctx, name);
                if (_mv_881.has_value) {
                    __auto_type var_entry = _mv_881.value;
...
void stmt_transpile_field_set(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (_mv_882.has_value) {
            __auto_type target_expr = _mv_882.value;
            __auto_type _mv_883 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_883.has_value) {
                __auto_type field_expr = _mv_883.value;
                __auto_type _mv_884 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void stmt_transpile_typed_field_set(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (_mv_885.has_value) {
            __auto_type target_expr = _mv_885.value;
            __auto_type _mv_886 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_886.has_value) {
                __auto_type field_expr = _mv_886.value;
                __auto_type _mv_887 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_887.has_value) {
                    __auto_type type_expr = _mv_887.value;
                    __auto_type _mv_888 = ({ __auto_type _lst = items; size_t _idx = (size_t)4; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            ...
                            __auto_type c_type = ctype_to_c_type(arena, type_expr);
                            {
                                ...
                                if (context_ctx_is_option_c_type(ctx, c_type)) {
                                    if (stmt_is_none_form(value_expr)) {
                                        ...
                                        __auto_type _mv_889 = stmt_get_some_value(value_expr);
                                        if (_mv_889.has_value) {
                                            __auto_type inner_val = _mv_889.value;
                                            {
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_890.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 1) {
                    ...
                    __auto_type _mv_891 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_893.data.lst;
            {
                ...
                if (_mv_894.has_value) {
                    __auto_type inner = _mv_894.value;
                    return inner;
                ...
                if (len < 2) {
                ...
                } else {
                    {
                        ...
                        if (is_named && (len < 4)) {
                            ...
                            context_ctx_indent(ctx);
                            context_ctx_push_scope(ctx);
                            __auto_type _mv_899 = ({ __auto_type _lst = items; size_t _idx = (size_t)size_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_899.has_value) {
                                __auto_type size_expr = _mv_899.value;
                                {
            ...
            __auto_type lst = _mv_901.data.lst;
            {
                ...
                while (i < len) {
                    ...
                    if (_mv_902.has_value) {
                        __auto_type clause_expr = _mv_902.value;
                        __auto_type _mv_903 = (*clause_expr);
                        switch (_mv_903.tag) {
                            case types_SExpr_lst:
                            {
                                __auto_type clause_lst = _mv_903.data.lst;
                                {
                                    ...
                                    if (clause_len < 1) {
                                        ...
                                        __auto_type _mv_904 = ({ __auto_type _lst = clause_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_904.has_value) {
                                            __auto_type test_expr = _mv_904.value;
                                            __auto_type _mv_905 = (*test_expr);
                                            switch (_mv_905.tag) {
                                                case types_SExpr_sym:
                                                {
                ...
                __auto_type lst = _mv_907.data.lst;
                {
                    ...
                    if (len < 2) {
                        ...
                        if (_mv_908.has_value) {
                            ...
                            __auto_type _mv_909 = (*binding_expr);
                            switch (_mv_909.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type binding_lst = _mv_909.data.lst;
                                    {
                                        ...
                                        if (binding_len < 3) {
                                            ...
                                            __auto_type _mv_910 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_910.has_value) {
                                                __auto_type var_expr = _mv_910.value;
                                                __auto_type _mv_911 = (*var_expr);
                                                switch (_mv_911.tag) {
                                                    case types_SExpr_sym:
                                                    {
                                                        __auto_type var_sym = _mv_911.data.sym;
                                                        {
                                                            __auto_type var_name = ctype_to_c_name(arena, var_sym.name);
                                                            __auto_type _mv_912 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                            if (_mv_912.has_value) {
                                                                __auto_type start_expr = _mv_912.value;
                                                                __auto_type _mv_913 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                                if (_mv_913.has_value) {
                                                                    __auto_type end_expr = _mv_913.value;
                                                                    {
...
void stmt_transpile_for_each_map_keys(context_TranspileContext* ctx, slop_string var_name, types_SExprSymbol var_sym, slop_string coll_c, slop_string resolved_type, slop_list_types_SExpr_ptr items, int64_t len) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        context_ctx_bind_var(ctx, (context_VarEntry){var_sym.name, var_name, key_c_type, key_slop_type, 0, 0, 0, SLOP_STR(""), SLOP_STR("")});
        {
            int64_t i = 2;
            while (i < len) {
                __auto_type _mv_916 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_916.has_value) {
                    __auto_type body_expr = _mv_916.value;
                    stmt_transpile_stmt(ctx, body_expr, 0);
...
void stmt_transpile_for_each_map_kv(context_TranspileContext* ctx, slop_list_types_SExpr_ptr binding_items, slop_list_types_SExpr_ptr items, int64_t len) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_917 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        if (_mv_917.has_value) {
            __auto_type kv_list_expr = _mv_917.value;
            __auto_type _mv_918 = (*kv_list_expr);
            switch (_mv_918.tag) {
                case types_SExpr_lst:
                {
                    __auto_type kv_lst = _mv_918.data.lst;
                    {
                        __auto_type kv_items = kv_lst.items;
                        if (((int64_t)((kv_items).len)) < 2) {
                            context_ctx_add_error(ctx, SLOP_STR("Map for-each needs ((k v) map)"));
                        } else {
                            __auto_type _mv_919 = ({ __auto_type _lst = kv_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_919.has_value) {
                                __auto_type k_expr = _mv_919.value;
                                __auto_type _mv_920 = ({ __auto_type _lst = kv_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_920.has_value) {
                                    __auto_type v_expr = _mv_920.value;
                                    __auto_type _mv_921 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    if (_mv_921.has_value) {
                                        __auto_type map_expr = _mv_921.value;
                                        __auto_type _mv_922 = (*k_expr);
                                        switch (_mv_922.tag) {
                                            case types_SExpr_sym:
                                            {
                                                __auto_type k_sym = _mv_922.data.sym;
                                                __auto_type _mv_923 = (*v_expr);
                                                switch (_mv_923.tag) {
                                                    case types_SExpr_sym:
                                                    {
                                                        __auto_type v_sym = _mv_923.data.sym;
                                                        {
                                                            ...
                                                            context_ctx_bind_var(ctx, (context_VarEntry){v_sym.name, v_name, val_c_type, val_slop_type, 0, 0, 0, SLOP_STR(""), SLOP_STR("")});
                                                            {
                                                                __auto_type i = 2;
                                                                while (i < len) {
                                                                    __auto_type _mv_924 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                                    if (_mv_924.has_value) {
                                                                        __auto_type body_expr = _mv_924.value;
                                                                        stmt_transpile_stmt(ctx, body_expr, 0);
                ...
                __auto_type lst = _mv_925.data.lst;
                {
                    ...
                    if (len < 2) {
                        ...
                        if (_mv_926.has_value) {
                            ...
                            __auto_type _mv_927 = (*binding_expr);
                            switch (_mv_927.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type binding_lst = _mv_927.data.lst;
                                    {
                                        ...
                                        if (binding_len < 2) {
                                            ...
                                            __auto_type _mv_928 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_928.has_value) {
                                                __auto_type first_elem = _mv_928.value;
                                                __auto_type _mv_929 = (*first_elem);
                                                switch (_mv_929.tag) {
                                                    case types_SExpr_lst:
                                                    {
                                                        __auto_type _ = _mv_929.data.lst;
                                                        stmt_transpile_for_each_map_kv(ctx, binding_items, items, len);
                                                        break;
                                                    }
                                                    case types_SExpr_sym:
                                                    {
                                                        __auto_type var_sym = _mv_929.data.sym;
                                                        {
                                                            __auto_type var_name = ctype_to_c_name(arena, var_sym.name);
                                                            __auto_type _mv_930 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                            if (_mv_930.has_value) {
                                                                __auto_type coll_expr = _mv_930.value;
                                                                {
            ...
            __auto_type lst = _mv_932.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 1) {
                    ...
                    if (_mv_933.has_value) {
                        __auto_type head_expr = _mv_933.value;
                        __auto_type _mv_934 = (*head_expr);
                        switch (_mv_934.tag) {
                            case types_SExpr_sym:
                            {
                                    ...
                                    if (string_eq(op, SLOP_STR("let")) || string_eq(op, SLOP_STR("let*"))) {
                                        ...
                                        if (((int64_t)((items).len)) < 2) {
                                            ...
                                            if (_mv_935.has_value) {
                                                __auto_type val_expr = _mv_935.value;
...
void stmt_emit_return_with_typed_none(context_TranspileContext* ctx, slop_string code) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (string_eq(code, SLOP_STR("none"))) {
            __auto_type _mv_942 = context_ctx_get_current_return_type(ctx);
            if (_mv_942.has_value) {
                __auto_type ret_type = _mv_942.value;
                if (context_ctx_is_option_c_type(ctx, ret_type)) {
            ...
            if (_mv_943.has_value) {
                ...
                if (context_ctx_is_option_c_type(ctx, ret_type)) {
                    __auto_type _mv_944 = context_ctx_lookup_var(ctx, code);
                    if (_mv_944.has_value) {
                        __auto_type var_entry = _mv_944.value;
                        {
