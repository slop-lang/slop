            ...
            __auto_type lst = _mv_786.data.lst;
            {
                ...
                while ((i < len)) {
                    ...
                    if (_mv_787.has_value) {
                        __auto_type item_expr = _mv_787.value;
                        {
                ...
                __auto_type lst = _mv_788.data.lst;
                {
                    ...
                    if ((((int64_t)((items).len)) >= 3)) {
                        ...
                        if (_mv_789.has_value) {
                            __auto_type head_ptr = _mv_789.value;
                            __auto_type _mv_790 = (*head_ptr);
                            switch (_mv_790.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type head_sym = _mv_790.data.sym;
                                    {
                                        __auto_type op = head_sym.name;
                                        if (string_eq(op, SLOP_STR("arena-alloc"))) {
                                            __auto_type _mv_791 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_791.has_value) {
                                                __auto_type size_expr = _mv_791.value;
                                            ...
                                            __auto_type _mv_792 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_793.data.lst;
                {
                    ...
                    if ((((int64_t)((items).len)) >= 2)) {
                        __auto_type _mv_795 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_795.has_value) {
                            __auto_type head_ptr = _mv_795.value;
                            __auto_type _mv_796 = (*head_ptr);
                            switch (_mv_796.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type head_sym = _mv_796.data.sym;
                                    if (string_eq(head_sym.name, SLOP_STR("sizeof"))) {
                                        ...
                                        if (_mv_797.has_value) {
                                            __auto_type type_expr = _mv_797.value;
                                            {
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_798.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    __auto_type _mv_799 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_799.has_value) {
                        __auto_type head_expr = _mv_799.value;
                        __auto_type _mv_800 = (*head_expr);
                        switch (_mv_800.tag) {
                            case types_SExpr_sym:
                            {
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_801.data.lst;
                {
                    ...
                    if ((len < 2)) {
                        ...
                        __auto_type _mv_802 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_802.has_value) {
                            __auto_type bindings_expr = _mv_802.value;
                            __auto_type _mv_803 = (*bindings_expr);
                            switch (_mv_803.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type bindings_lst = _mv_803.data.lst;
                        ...
                        }
                        {
                            ...
                            while ((i < len)) {
                                ...
                                if (_mv_804.has_value) {
                                    __auto_type body_expr = _mv_804.value;
                                    {
...
void stmt_transpile_bindings(context_TranspileContext* ctx, slop_list_types_SExpr_ptr bindings) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_805 = ({ __auto_type _lst = bindings; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_805.has_value) {
                __auto_type binding_expr = _mv_805.value;
...
void stmt_transpile_single_binding(context_TranspileContext* ctx, types_SExpr* binding) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_806 = (*binding);
        switch (_mv_806.tag) {
            case types_SExpr_lst:
            {
                __auto_type binding_lst = _mv_806.data.lst;
                {
                    ...
                    __auto_type len = ((int64_t)((items).len));
                    {
                        ...
                        if (((len - start_idx) < 2)) {
                            ...
                            __auto_type _mv_807 = ({ __auto_type _lst = items; size_t _idx = (size_t)start_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_807.has_value) {
                                __auto_type name_expr = _mv_807.value;
                                __auto_type _mv_808 = (*name_expr);
                                switch (_mv_808.tag) {
                                    case types_SExpr_sym:
                                    {
                                        __auto_type name_sym = _mv_808.data.sym;
                                        {
                                            __auto_type raw_name = name_sym.name;
                                            __auto_type var_name = ctype_to_c_name(arena, raw_name);
                                            if (((len - start_idx) >= 3)) {
                                                __auto_type _mv_809 = ({ __auto_type _lst = items; size_t _idx = (size_t)(start_idx + 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_809.has_value) {
                                                    __auto_type type_expr = _mv_809.value;
                                                    __auto_type _mv_810 = ({ __auto_type _lst = items; size_t _idx = (size_t)(start_idx + 2); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_810.has_value) {
                                                        __auto_type init_expr = _mv_810.value;
                                                        {
                                                            __auto_type c_type = context_to_c_type_prefixed(ctx, type_expr);
                                                            {
                                                ...
                                                __auto_type _mv_811 = ({ __auto_type _lst = items; size_t _idx = (size_t)(start_idx + 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_811.has_value) {
                                                    __auto_type init_expr = _mv_811.value;
                                                    {
                                                        ...
                                                        __auto_type _mv_812 = ptr_type_opt;
                                                        if (_mv_812.has_value) {
                                                            __auto_type ptr_type = _mv_812.value;
...
uint8_t stmt_binding_has_mut(slop_list_types_SExpr_ptr items) {
    if ((((int64_t)((items).len)) < 1)) {
        ...
        if (_mv_813.has_value) {
            __auto_type first = _mv_813.value;
            __auto_type _mv_814 = (*first);
            switch (_mv_814.tag) {
                case types_SExpr_sym:
                {
                ...
                __auto_type lst = _mv_815.data.lst;
                {
                    ...
                    if ((((int64_t)((items).len)) >= 2)) {
                        ...
                        if (_mv_816.has_value) {
                            __auto_type head_expr = _mv_816.value;
                            __auto_type _mv_817 = (*head_expr);
                            switch (_mv_817.tag) {
                                case types_SExpr_sym:
                                {
            ...
            __auto_type lst = _mv_826.data.lst;
            {
                ...
                if ((len < 3)) {
                    ...
                    if (_mv_827.has_value) {
                        __auto_type cond_expr = _mv_827.value;
                        {
                            __auto_type cond_c = expr_transpile_expr(ctx, cond_expr);
                            context_ctx_emit(ctx, context_ctx_str3(ctx, SLOP_STR("if ("), cond_c, SLOP_STR(") {")));
                            context_ctx_indent(ctx);
                            {
                                __auto_type i = 2;
                                while ((i < len)) {
                                    __auto_type _mv_828 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            ...
                            if (_mv_834.has_value) {
                                __auto_type value_expr = _mv_834.value;
                                {
                                    ...
                                    if (_mv_835.has_value) {
                                        ...
                                        {
                                            __auto_type some_val_opt = stmt_get_some_value(value_expr);
                                            __auto_type _mv_837 = some_val_opt;
                                            if (_mv_837.has_value) {
                                                __auto_type inner_expr = _mv_837.value;
                                                {
                                                ...
                                                if (stmt_is_none_form(value_expr)) {
                                                    __auto_type _mv_838 = context_ctx_get_current_return_type(ctx);
                                                    if (_mv_838.has_value) {
                                                        __auto_type ret_type = _mv_838.value;
...
uint8_t stmt_is_pointer_target(context_TranspileContext* ctx, types_SExpr* expr) {
    ...
    switch (_mv_841.tag) {
        case types_SExpr_sym:
        {
            ...
            {
                __auto_type name = sym.name;
                __auto_type _mv_842 = context_ctx_lookup_var(ctx, name);
                if (_mv_842.has_value) {
                    __auto_type var_entry = _mv_842.value;
...
void stmt_transpile_field_set(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (_mv_843.has_value) {
            __auto_type target_expr = _mv_843.value;
            __auto_type _mv_844 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_844.has_value) {
                __auto_type field_expr = _mv_844.value;
                __auto_type _mv_845 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_845.has_value) {
                    __auto_type value_expr = _mv_845.value;
                    {
...
void stmt_transpile_typed_field_set(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (_mv_846.has_value) {
            __auto_type target_expr = _mv_846.value;
            ...
            if (_mv_847.has_value) {
                __auto_type field_expr = _mv_847.value;
                ...
                if (_mv_848.has_value) {
                    __auto_type type_expr = _mv_848.value;
                    __auto_type _mv_849 = ({ __auto_type _lst = items; size_t _idx = (size_t)4; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            ...
                            __auto_type c_type = ctype_to_c_type(arena, type_expr);
                            {
                                ...
                                if (strlib_starts_with(c_type, SLOP_STR("slop_option_"))) {
                                    if (stmt_is_none_form(value_expr)) {
                                        ...
                                        __auto_type _mv_850 = stmt_get_some_value(value_expr);
                                        if (_mv_850.has_value) {
                                            __auto_type inner_val = _mv_850.value;
                                            {
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_851.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    __auto_type _mv_852 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_854.data.lst;
            {
                ...
                if (_mv_855.has_value) {
                    __auto_type inner = _mv_855.value;
                    return inner;
                ...
                if ((len < 2)) {
                ...
                } else {
                    {
                        ...
                        if ((is_named && (len < 4))) {
                            ...
                            context_ctx_indent(ctx);
                            context_ctx_push_scope(ctx);
                            __auto_type _mv_860 = ({ __auto_type _lst = items; size_t _idx = (size_t)size_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_860.has_value) {
                                __auto_type size_expr = _mv_860.value;
                                {
    ...
    switch (_mv_862.tag) {
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_862.data.lst;
            {
                ...
                __auto_type first = 1;
                while ((i < len)) {
                    __auto_type _mv_863 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_863.has_value) {
                        __auto_type clause_expr = _mv_863.value;
                        __auto_type _mv_864 = (*clause_expr);
                        switch (_mv_864.tag) {
                            case types_SExpr_lst:
                            {
                                __auto_type clause_lst = _mv_864.data.lst;
                                {
                                    ...
                                    if ((clause_len < 1)) {
                                        ...
                                        __auto_type _mv_865 = ({ __auto_type _lst = clause_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_865.has_value) {
                                            __auto_type test_expr = _mv_865.value;
                                            __auto_type _mv_866 = (*test_expr);
                                            switch (_mv_866.tag) {
                                                case types_SExpr_sym:
                                                {
                ...
                __auto_type lst = _mv_868.data.lst;
                {
                    ...
                    if ((len < 2)) {
                        ...
                        if (_mv_869.has_value) {
                            __auto_type binding_expr = _mv_869.value;
                            __auto_type _mv_870 = (*binding_expr);
                            switch (_mv_870.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type binding_lst = _mv_870.data.lst;
                                    {
                                        ...
                                        if ((binding_len < 3)) {
                                            ...
                                            __auto_type _mv_871 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_871.has_value) {
                                                __auto_type var_expr = _mv_871.value;
                                                __auto_type _mv_872 = (*var_expr);
                                                switch (_mv_872.tag) {
                                                    case types_SExpr_sym:
                                                    {
                                                        __auto_type var_sym = _mv_872.data.sym;
                                                        {
                                                            __auto_type var_name = ctype_to_c_name(arena, var_sym.name);
                                                            __auto_type _mv_873 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                            if (_mv_873.has_value) {
                                                                __auto_type start_expr = _mv_873.value;
                                                                __auto_type _mv_874 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                                if (_mv_874.has_value) {
                                                                    __auto_type end_expr = _mv_874.value;
                                                                    {
        ...
        context_ctx_bind_var(ctx, (context_VarEntry){var_sym.name, var_name, key_c_type, key_slop_type, 0, 0, 0, SLOP_STR(""), SLOP_STR("")});
        {
            ...
            while ((i < len)) {
                ...
                if (_mv_877.has_value) {
                    __auto_type body_expr = _mv_877.value;
                    stmt_transpile_stmt(ctx, body_expr, 0);
...
void stmt_transpile_for_each_map_kv(context_TranspileContext* ctx, slop_list_types_SExpr_ptr binding_items, slop_list_types_SExpr_ptr items, int64_t len) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (_mv_878.has_value) {
            __auto_type kv_list_expr = _mv_878.value;
            __auto_type _mv_879 = (*kv_list_expr);
            switch (_mv_879.tag) {
                case types_SExpr_lst:
                {
                    __auto_type kv_lst = _mv_879.data.lst;
                    {
                        __auto_type kv_items = kv_lst.items;
                        if ((((int64_t)((kv_items).len)) < 2)) {
                            context_ctx_add_error(ctx, SLOP_STR("Map for-each needs ((k v) map)"));
                        } else {
                            __auto_type _mv_880 = ({ __auto_type _lst = kv_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_880.has_value) {
                                __auto_type k_expr = _mv_880.value;
                                __auto_type _mv_881 = ({ __auto_type _lst = kv_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_881.has_value) {
                                    __auto_type v_expr = _mv_881.value;
                                    ...
                                    if (_mv_882.has_value) {
                                        __auto_type map_expr = _mv_882.value;
                                        __auto_type _mv_883 = (*k_expr);
                                        switch (_mv_883.tag) {
                                            case types_SExpr_sym:
                                            {
                                                __auto_type k_sym = _mv_883.data.sym;
                                                __auto_type _mv_884 = (*v_expr);
                                                switch (_mv_884.tag) {
                                                    case types_SExpr_sym:
                                                    {
                                                        __auto_type v_sym = _mv_884.data.sym;
                                                        {
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_886.data.lst;
                {
                    ...
                    if ((len < 2)) {
                        ...
                        __auto_type _mv_887 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_887.has_value) {
                            __auto_type binding_expr = _mv_887.value;
                            __auto_type _mv_888 = (*binding_expr);
                            switch (_mv_888.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type binding_lst = _mv_888.data.lst;
                                    {
                                        __auto_type binding_items = binding_lst.items;
                                        __auto_type binding_len = ((int64_t)((binding_items).len));
                                        if ((binding_len < 2)) {
                                            ...
                                            __auto_type _mv_889 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_889.has_value) {
                                                __auto_type first_elem = _mv_889.value;
                                                __auto_type _mv_890 = (*first_elem);
                                                switch (_mv_890.tag) {
                                                    case types_SExpr_lst:
                                                    {
                                                        __auto_type _ = _mv_890.data.lst;
                                                        stmt_transpile_for_each_map_kv(ctx, binding_items, items, len);
                                                        break;
                                                    }
                                                    case types_SExpr_sym:
                                                    {
                                                        __auto_type var_sym = _mv_890.data.sym;
                                                        {
                                                            __auto_type var_name = ctype_to_c_name(arena, var_sym.name);
                                                            ...
                                                            if (_mv_891.has_value) {
                                                                __auto_type coll_expr = _mv_891.value;
                                                                {
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_893.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    __auto_type _mv_894 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_894.has_value) {
                        __auto_type head_expr = _mv_894.value;
                        __auto_type _mv_895 = (*head_expr);
                        switch (_mv_895.tag) {
                            case types_SExpr_sym:
                            {
                                    ...
                                    if ((string_eq(op, SLOP_STR("let")) || string_eq(op, SLOP_STR("let*")))) {
                                        ...
                                        if ((((int64_t)((items).len)) < 2)) {
                                            ...
                                            if (_mv_896.has_value) {
                                                __auto_type val_expr = _mv_896.value;
                                            ...
                                            if (strlib_starts_with(ret_type, SLOP_STR("slop_option_"))) {
                                                if ((((int64_t)((items).len)) < 2)) {
                                                    ...
                                                    if (_mv_901.has_value) {
                                                        __auto_type inner_expr = _mv_901.value;
                                                        {
                                                            __auto_type inner_c = expr_transpile_expr(ctx, inner_expr);
...
void stmt_emit_return_with_typed_none(context_TranspileContext* ctx, slop_string code) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (string_eq(code, SLOP_STR("none"))) {
            __auto_type _mv_903 = context_ctx_get_current_return_type(ctx);
            if (_mv_903.has_value) {
                __auto_type ret_type = _mv_903.value;
                if (strlib_starts_with(ret_type, SLOP_STR("slop_option_"))) {
            ...
            __auto_type _mv_904 = context_ctx_get_current_return_type(ctx);
            if (_mv_904.has_value) {
                __auto_type ret_type = _mv_904.value;
                if (strlib_starts_with(ret_type, SLOP_STR("slop_option_"))) {
                    __auto_type _mv_905 = context_ctx_lookup_var(ctx, code);
                    if (_mv_905.has_value) {
                        __auto_type var_entry = _mv_905.value;
                        {
