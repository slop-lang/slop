            ...
            __auto_type lst = _mv_793.data.lst;
            {
                ...
                while (i < len) {
                    ...
                    if (_mv_794.has_value) {
                        __auto_type item_expr = _mv_794.value;
                        {
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_795.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) >= 3) {
                        __auto_type _mv_796 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_796.has_value) {
                            __auto_type head_ptr = _mv_796.value;
                            __auto_type _mv_797 = (*head_ptr);
                            switch (_mv_797.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type head_sym = _mv_797.data.sym;
                                    {
                                        __auto_type op = head_sym.name;
                                        if (string_eq(op, SLOP_STR("arena-alloc"))) {
                                            __auto_type _mv_798 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_798.has_value) {
                                                __auto_type size_expr = _mv_798.value;
                                            ...
                                            __auto_type _mv_799 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_799.has_value) {
                                                __auto_type inner_expr = _mv_799.value;
        ...
        switch (_mv_800.tag) {
            case types_SExpr_sym:
            {
                __auto_type sym = _mv_800.data.sym;
                {
                    ...
                    __auto_type _mv_801 = context_ctx_lookup_type(ctx, type_name);
                    if (_mv_801.has_value) {
                        __auto_type entry = _mv_801.value;
                ...
                __auto_type lst = _mv_800.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) >= 2) {
                        ...
                        if (_mv_802.has_value) {
                            __auto_type head_ptr = _mv_802.value;
                            __auto_type _mv_803 = (*head_ptr);
                            switch (_mv_803.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type head_sym = _mv_803.data.sym;
            ...
            __auto_type lst = _mv_805.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 1) {
                    ...
                    if (_mv_806.has_value) {
                        __auto_type head_expr = _mv_806.value;
                        __auto_type _mv_807 = (*head_expr);
                        switch (_mv_807.tag) {
                            case types_SExpr_sym:
                            {
                ...
                __auto_type lst = _mv_808.data.lst;
                {
                    ...
                    if (len < 2) {
                        ...
                        if (_mv_809.has_value) {
                            __auto_type bindings_expr = _mv_809.value;
                            __auto_type _mv_810 = (*bindings_expr);
                            switch (_mv_810.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type bindings_lst = _mv_810.data.lst;
                        ...
                        }
                        {
                            __auto_type i = 2;
                            while (i < len) {
                                __auto_type _mv_811 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_811.has_value) {
                                    __auto_type body_expr = _mv_811.value;
                                    {
...
void stmt_transpile_bindings(context_TranspileContext* ctx, slop_list_types_SExpr_ptr bindings) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_812 = ({ __auto_type _lst = bindings; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_812.has_value) {
                __auto_type binding_expr = _mv_812.value;
...
void stmt_transpile_single_binding(context_TranspileContext* ctx, types_SExpr* binding) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_813 = (*binding);
        switch (_mv_813.tag) {
            case types_SExpr_lst:
            {
                __auto_type binding_lst = _mv_813.data.lst;
                {
                    ...
                    __auto_type len = ((int64_t)((items).len));
                    {
                        ...
                        if ((len - start_idx) < 2) {
                            ...
                            __auto_type _mv_814 = ({ __auto_type _lst = items; size_t _idx = (size_t)start_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_814.has_value) {
                                __auto_type name_expr = _mv_814.value;
                                __auto_type _mv_815 = (*name_expr);
                                switch (_mv_815.tag) {
                                    case types_SExpr_sym:
                                    {
                                        __auto_type name_sym = _mv_815.data.sym;
                                        {
                                            __auto_type raw_name = name_sym.name;
                                            __auto_type var_name = ctype_to_c_name(arena, raw_name);
                                            if ((len - start_idx) >= 3) {
                                                __auto_type _mv_816 = ({ __auto_type _lst = items; size_t _idx = (size_t)(start_idx + 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_816.has_value) {
                                                    __auto_type type_expr = _mv_816.value;
                                                    __auto_type _mv_817 = ({ __auto_type _lst = items; size_t _idx = (size_t)(start_idx + 2); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_817.has_value) {
                                                        __auto_type init_expr = _mv_817.value;
                                                        {
                                                            __auto_type c_type = context_to_c_type_prefixed(ctx, type_expr);
                                                            {
                                                ...
                                                if (_mv_818.has_value) {
                                                    __auto_type init_expr = _mv_818.value;
                                                    {
                                                        ...
                                                        __auto_type _mv_819 = ptr_type_opt;
                                                        if (_mv_819.has_value) {
                                                            __auto_type ptr_type = _mv_819.value;
...
uint8_t stmt_binding_has_mut(slop_list_types_SExpr_ptr items) {
    if (((int64_t)((items).len)) < 1) {
        ...
        if (_mv_820.has_value) {
            __auto_type first = _mv_820.value;
            __auto_type _mv_821 = (*first);
            switch (_mv_821.tag) {
                case types_SExpr_sym:
                {
        ...
        switch (_mv_822.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_822.data.lst;
                {
                    __auto_type items = lst.items;
                    if (((int64_t)((items).len)) >= 2) {
                        __auto_type _mv_823 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_823.has_value) {
                            __auto_type head_expr = _mv_823.value;
                            __auto_type _mv_824 = (*head_expr);
                            switch (_mv_824.tag) {
                                case types_SExpr_sym:
                                {
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_829.data.lst;
            {
                ...
                if (len < 3) {
                    ...
                    __auto_type _mv_830 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_830.has_value) {
                        __auto_type cond_expr = _mv_830.value;
                        {
                            ...
                            context_ctx_indent(ctx);
                            __auto_type _mv_831 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_831.has_value) {
                                __auto_type then_expr = _mv_831.value;
                            ...
                            if (len >= 4) {
                                ...
                                context_ctx_indent(ctx);
                                __auto_type _mv_832 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_832.has_value) {
                                    __auto_type else_expr = _mv_832.value;
                    ...
                    if (_mv_834.has_value) {
                        __auto_type cond_expr = _mv_834.value;
                        {
                            ...
                            context_ctx_indent(ctx);
                            {
                                __auto_type i = 2;
                                while (i < len) {
                                    __auto_type _mv_835 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    ...
                    if (_mv_837.has_value) {
                        __auto_type cond_expr = _mv_837.value;
                        {
                            ...
                            context_ctx_indent(ctx);
                            {
                                __auto_type i = 2;
                                while (i < len) {
                                    __auto_type _mv_838 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                ...
                __auto_type lst = _mv_839.data.lst;
                {
                    ...
                    if (expr_set_is_self_assign(items)) {
                        ...
                        if (_mv_840.has_value) {
                            __auto_type target_expr = _mv_840.value;
                            __auto_type _mv_841 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_841.has_value) {
                                __auto_type value_expr = _mv_841.value;
                                {
                                    __auto_type target_c = expr_transpile_expr(ctx, target_expr);
                                    __auto_type target_type_opt = stmt_get_var_c_type(ctx, target_expr);
                                    __auto_type _mv_842 = target_type_opt;
                                    if (_mv_842.has_value) {
                                        __auto_type target_type = _mv_842.value;
                                        if (strlib_starts_with(target_type, SLOP_STR("slop_option_"))) {
                                            {
                                                __auto_type some_val_opt = stmt_get_some_value(value_expr);
                                                __auto_type _mv_843 = some_val_opt;
                                                if (_mv_843.has_value) {
                                                    __auto_type val_expr = _mv_843.value;
                                                    {
...
slop_option_string stmt_get_var_c_type(context_TranspileContext* ctx, types_SExpr* expr) {
    ...
    switch (_mv_846.tag) {
        case types_SExpr_sym:
        {
            ...
            {
                __auto_type name = sym.name;
                __auto_type _mv_847 = context_ctx_lookup_var(ctx, name);
...
void stmt_transpile_field_set(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (_mv_850.has_value) {
            __auto_type target_expr = _mv_850.value;
            ...
            if (_mv_851.has_value) {
                __auto_type field_expr = _mv_851.value;
                ...
                if (_mv_852.has_value) {
                    __auto_type value_expr = _mv_852.value;
                    {
...
void stmt_transpile_typed_field_set(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (_mv_853.has_value) {
            __auto_type target_expr = _mv_853.value;
            __auto_type _mv_854 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_854.has_value) {
                __auto_type field_expr = _mv_854.value;
                __auto_type _mv_855 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_855.has_value) {
                    __auto_type type_expr = _mv_855.value;
                    __auto_type _mv_856 = ({ __auto_type _lst = items; size_t _idx = (size_t)4; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            ...
                            __auto_type c_type = ctype_to_c_type(arena, type_expr);
                            {
                                ...
                                if (strlib_starts_with(c_type, SLOP_STR("slop_option_"))) {
                                    if (stmt_is_none_form(value_expr)) {
                                        ...
                                        __auto_type _mv_857 = stmt_get_some_value(value_expr);
                                        if (_mv_857.has_value) {
                                            __auto_type inner_val = _mv_857.value;
                                            {
                ...
                if (len < 2) {
                ...
                } else {
                    {
                        ...
                        if (is_named && (len < 4)) {
                            ...
                            context_ctx_indent(ctx);
                            context_ctx_push_scope(ctx);
                            __auto_type _mv_867 = ({ __auto_type _lst = items; size_t _idx = (size_t)size_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_867.has_value) {
                                __auto_type size_expr = _mv_867.value;
                                {
                            ...
                            context_ctx_bind_var(ctx, (context_VarEntry){arena_name, arena_name, SLOP_STR("slop_arena*"), SLOP_STR(""), 1, 0, 0, SLOP_STR(""), SLOP_STR("")});
                            {
                                ...
                                while (i < len) {
                                    __auto_type _mv_868 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    if (_mv_868.has_value) {
                                        __auto_type body_expr = _mv_868.value;
                                        {
                                            __auto_type is_last = (i == (len - 1));
                                            stmt_transpile_stmt(ctx, body_expr, (is_return && is_last));
                                        }
            ...
            __auto_type lst = _mv_869.data.lst;
            {
                ...
                while (i < len) {
                    ...
                    if (_mv_870.has_value) {
                        __auto_type clause_expr = _mv_870.value;
                        __auto_type _mv_871 = (*clause_expr);
                        switch (_mv_871.tag) {
                            case types_SExpr_lst:
                            {
                                __auto_type clause_lst = _mv_871.data.lst;
                                {
                                    ...
                                    if (clause_len < 1) {
                                        ...
                                        __auto_type _mv_872 = ({ __auto_type _lst = clause_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_872.has_value) {
                                            __auto_type test_expr = _mv_872.value;
                                            __auto_type _mv_873 = (*test_expr);
                                            switch (_mv_873.tag) {
                                                case types_SExpr_sym:
                                                {
                ...
                __auto_type lst = _mv_875.data.lst;
                {
                    ...
                    if (len < 2) {
                        ...
                        if (_mv_876.has_value) {
                            __auto_type binding_expr = _mv_876.value;
                            __auto_type _mv_877 = (*binding_expr);
                            switch (_mv_877.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type binding_lst = _mv_877.data.lst;
                                    {
                                        ...
                                        if (binding_len < 3) {
                                            ...
                                            __auto_type _mv_878 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_878.has_value) {
                                                __auto_type var_expr = _mv_878.value;
                                                __auto_type _mv_879 = (*var_expr);
                                                switch (_mv_879.tag) {
                                                    case types_SExpr_sym:
                                                    {
                                                        __auto_type var_sym = _mv_879.data.sym;
                                                        {
                                                            __auto_type var_name = ctype_to_c_name(arena, var_sym.name);
                                                            __auto_type _mv_880 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                            if (_mv_880.has_value) {
                                                                __auto_type start_expr = _mv_880.value;
                                                                __auto_type _mv_881 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                                if (_mv_881.has_value) {
                                                                    __auto_type end_expr = _mv_881.value;
                                                                    {
...
void stmt_transpile_for_each_map_kv(context_TranspileContext* ctx, slop_list_types_SExpr_ptr binding_items, slop_list_types_SExpr_ptr items, int64_t len) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (_mv_885.has_value) {
            __auto_type kv_list_expr = _mv_885.value;
            __auto_type _mv_886 = (*kv_list_expr);
            switch (_mv_886.tag) {
                case types_SExpr_lst:
                {
                    __auto_type kv_lst = _mv_886.data.lst;
                    {
                        __auto_type kv_items = kv_lst.items;
                        if (((int64_t)((kv_items).len)) < 2) {
                            context_ctx_add_error(ctx, SLOP_STR("Map for-each needs ((k v) map)"));
                        } else {
                            __auto_type _mv_887 = ({ __auto_type _lst = kv_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_887.has_value) {
                                __auto_type k_expr = _mv_887.value;
                                __auto_type _mv_888 = ({ __auto_type _lst = kv_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_888.has_value) {
                                    __auto_type v_expr = _mv_888.value;
                                    __auto_type _mv_889 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    if (_mv_889.has_value) {
                                        __auto_type map_expr = _mv_889.value;
                                        __auto_type _mv_890 = (*k_expr);
                                        switch (_mv_890.tag) {
                                            case types_SExpr_sym:
                                            {
                                                __auto_type k_sym = _mv_890.data.sym;
                                                __auto_type _mv_891 = (*v_expr);
                                                switch (_mv_891.tag) {
                                                    case types_SExpr_sym:
                                                    {
                                                        __auto_type v_sym = _mv_891.data.sym;
                                                        {
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_893.data.lst;
                {
                    ...
                    if (len < 2) {
                        ...
                        __auto_type _mv_894 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_894.has_value) {
                            __auto_type binding_expr = _mv_894.value;
                            __auto_type _mv_895 = (*binding_expr);
                            switch (_mv_895.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type binding_lst = _mv_895.data.lst;
                                    {
                                        ...
                                        if (binding_len < 2) {
                                            ...
                                            __auto_type _mv_896 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_896.has_value) {
                                                __auto_type first_elem = _mv_896.value;
                                                __auto_type _mv_897 = (*first_elem);
                                                switch (_mv_897.tag) {
                                                    case types_SExpr_lst:
                                                    {
                                                        __auto_type _ = _mv_897.data.lst;
                                                        stmt_transpile_for_each_map_kv(ctx, binding_items, items, len);
                                                        break;
                                                    }
                                                    case types_SExpr_sym:
                                                    {
                                                        __auto_type var_sym = _mv_897.data.sym;
                                                        {
                                                            __auto_type var_name = ctype_to_c_name(arena, var_sym.name);
                                                            __auto_type _mv_898 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                            if (_mv_898.has_value) {
                                                                __auto_type coll_expr = _mv_898.value;
                                                                {
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_900.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 1) {
                    ...
                    __auto_type _mv_901 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_901.has_value) {
                        __auto_type head_expr = _mv_901.value;
                        __auto_type _mv_902 = (*head_expr);
                        switch (_mv_902.tag) {
                            case types_SExpr_sym:
                            {
                                __auto_type sym = _mv_902.data.sym;
                                {
                                    ...
                                    if (string_eq(op, SLOP_STR("let")) || string_eq(op, SLOP_STR("let*"))) {
                                        ...
                                        if (((int64_t)((items).len)) < 2) {
                                            ...
                                            __auto_type _mv_903 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_903.has_value) {
                                                __auto_type val_expr = _mv_903.value;
                            ...
                            case types_SExpr_sym:
                            {
                                __auto_type sym = _mv_906.data.sym;
                                {
                                    ...
                                    if (string_eq(op, SLOP_STR("some"))) {
                                        __auto_type _mv_907 = context_ctx_get_current_return_type(ctx);
                                        if (_mv_907.has_value) {
                                            __auto_type ret_type = _mv_907.value;
                                            if (strlib_starts_with(ret_type, SLOP_STR("slop_option_"))) {
                                                if (((int64_t)((items).len)) < 2) {
                                                    stmt_emit_return_with_typed_none(ctx, expr_transpile_expr(ctx, expr));
                                                } else {
                                                    __auto_type _mv_908 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_908.has_value) {
                                                        __auto_type inner_expr = _mv_908.value;
                                                        {
                                                            __auto_type inner_c = expr_transpile_expr(ctx, inner_expr);
...
void stmt_emit_return_with_typed_none(context_TranspileContext* ctx, slop_string code) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (string_eq(code, SLOP_STR("none"))) {
            __auto_type _mv_910 = context_ctx_get_current_return_type(ctx);
            if (_mv_910.has_value) {
                __auto_type ret_type = _mv_910.value;
                if (strlib_starts_with(ret_type, SLOP_STR("slop_option_"))) {
            ...
            if (_mv_911.has_value) {
                ...
                if (strlib_starts_with(ret_type, SLOP_STR("slop_option_"))) {
                    __auto_type _mv_912 = context_ctx_lookup_var(ctx, code);
                    if (_mv_912.has_value) {
                        __auto_type var_entry = _mv_912.value;
                        {
