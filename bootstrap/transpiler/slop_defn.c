        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_935.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 1) {
                    ...
                    __auto_type _mv_936 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
uint8_t defn_has_generic_annotation(slop_list_types_SExpr_ptr items) {
    {
        ...
        while ((i < len) && !(found)) {
            ...
            if (_mv_938.has_value) {
                __auto_type item = _mv_938.value;
                __auto_type _mv_939 = (*item);
                switch (_mv_939.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type lst = _mv_939.data.lst;
                        {
                            ...
                            if (((int64_t)((sub_items).len)) > 0) {
                                __auto_type _mv_940 = ({ __auto_type _lst = sub_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_942.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 1) {
                    ...
                    __auto_type _mv_943 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            ...
                            switch (_mv_947.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_947.data.sym;
                                    {
                                        ...
                                        __auto_type _mv_948 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_948.has_value) {
                                            __auto_type type_expr = _mv_948.value;
                                            {
                                                ...
                                                __auto_type _mv_949 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_949.has_value) {
                                                    __auto_type value_expr = _mv_949.value;
        ...
        if (ctype_is_int_type(type_name)) {
        ...
        } else {
            {
                ...
                if (string_eq(type_name, SLOP_STR("String"))) {
                    __auto_type _mv_950 = (*value_expr);
                    switch (_mv_950.tag) {
...
slop_string defn_eval_const_value(context_TranspileContext* ctx, types_SExpr* expr) {
    ...
    SLOP_PRE(((expr != NULL)), "(!= expr nil)");
    {
        ...
        switch (_mv_952.tag) {
            ...
            {
                __auto_type num = _mv_952.data.num;
                return num.raw;
            }
            case types_SExpr_str:
            {
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_953.data.lst;
                {
                    ...
                    __auto_type len = ((int64_t)((items).len));
                    {
                        ...
                        if (len >= (name_idx + 1)) {
                            __auto_type _mv_954 = ({ __auto_type _lst = items; size_t _idx = (size_t)name_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
uint8_t defn_is_string_expr(slop_list_types_SExpr_ptr items, int64_t idx) {
    __auto_type _mv_956 = ({ __auto_type _lst = items; size_t _idx = (size_t)idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    if (_mv_956.has_value) {
        ...
        switch (_mv_957.tag) {
            case types_SExpr_str:
            {
                __auto_type _ = _mv_957.data.str;
                return 1;
            }
            default: {
                return 0;
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_958.data.lst;
                {
                    ...
                    if (len < 3) {
                        ...
                        __auto_type _mv_959 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_959.has_value) {
                            ...
                            switch (_mv_960.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_960.data.sym;
                                    {
                                        __auto_type raw_name = name_sym.name;
                                        __auto_type base_name = ctype_to_c_name(arena, raw_name);
                                        ...
                                        if (_mv_961.has_value) {
                                            __auto_type type_def = _mv_961.value;
...
void defn_dispatch_type_def(context_TranspileContext* ctx, slop_string raw_name, slop_string qualified_name, types_SExpr* type_def) {
    ...
    __auto_type _mv_962 = (*type_def);
    switch (_mv_962.tag) {
        case types_SExpr_lst:
        {
            __auto_type def_lst = _mv_962.data.lst;
            {
        ...
        while ((i < len) && !(found)) {
            ...
            if (_mv_965.has_value) {
                ...
                switch (_mv_966.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type _ = _mv_966.data.lst;
                        found = 1;
                        break;
                    }
                    default: {
...
void defn_emit_record_field(context_TranspileContext* ctx, slop_string raw_type_name, slop_string qualified_type_name, types_SExpr* field) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_969 = (*field);
        switch (_mv_969.tag) {
            case types_SExpr_lst:
            {
                __auto_type field_lst = _mv_969.data.lst;
                {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_974.has_value) {
                __auto_type val_expr = _mv_974.value;
                __auto_type _mv_975 = (*val_expr);
                switch (_mv_975.tag) {
                    case types_SExpr_sym:
                    {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_987.has_value) {
                __auto_type variant_expr = _mv_987.value;
                __auto_type _mv_988 = (*variant_expr);
                switch (_mv_988.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type var_lst = _mv_988.data.lst;
                        {
                            __auto_type var_items = var_lst.items;
                            __auto_type var_len = ((int64_t)((var_items).len));
                            if (var_len >= 2) {
                                __auto_type _mv_989 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_989.has_value) {
                                    __auto_type tag_expr = _mv_989.value;
                                    __auto_type _mv_990 = (*tag_expr);
                                    switch (_mv_990.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type tag_sym = _mv_990.data.sym;
                                            {
                                                __auto_type tag_name = tag_sym.name;
                                                if (var_len == 2) {
                                                    ...
                                                    for (int64_t fi = 1; fi < var_len; fi++) {
                                                        __auto_type _mv_992 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)fi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                ...
                __auto_type lst = _mv_997.data.lst;
                {
                    ...
                    if (len < 3) {
                        ...
                        if (_mv_998.has_value) {
                            __auto_type elem_type_expr = _mv_998.value;
                            __auto_type _mv_999 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_999.has_value) {
                                __auto_type size_expr = _mv_999.value;
                                {
...
slop_string defn_get_number_as_string(types_SExpr* expr) {
    ...
    switch (_mv_1000.tag) {
        case types_SExpr_num:
        {
            __auto_type num = _mv_1000.data.num;
            return num.raw;
        }
        default: {
            return SLOP_STR("0");
                    ...
                    while (i < len) {
                        ...
                        if (_mv_1005.has_value) {
                            ...
                            switch (_mv_1006.tag) {
                                case types_SExpr_num:
                                {
                                    __auto_type num = _mv_1006.data.num;
                                    if (!(found_dots)) {
...
void defn_bind_params_to_scope(context_TranspileContext* ctx, types_SExpr* params_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1013 = (*params_expr);
        switch (_mv_1013.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1013.data.lst;
                {
                    ...
                    while (i < len) {
                        ...
                        if (_mv_1014.has_value) {
                            __auto_type param = _mv_1014.value;
                    ...
                    if (len >= 2) {
                        {
                            ...
                            __auto_type _mv_1016 = ({ __auto_type _lst = items; size_t _idx = (size_t)name_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_1016.has_value) {
                                ...
                                switch (_mv_1017.tag) {
                                    case types_SExpr_sym:
                                    {
                                        ...
                                        __auto_type _mv_1018 = ({ __auto_type _lst = items; size_t _idx = (size_t)type_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                ...
                __auto_type lst = _mv_1022.data.lst;
                {
                    ...
                    while (i < len) {
                        ...
                        if (_mv_1023.has_value) {
                            __auto_type param = _mv_1023.value;
                            {
                ...
                __auto_type lst = _mv_1024.data.lst;
                {
                    ...
                    if (len < 2) {
                    ...
                    } else {
                        {
                            __auto_type has_mode = ((len >= 3) && defn_is_param_mode(items));
                            __auto_type type_idx = ((has_mode) ? 2 : 1);
                            __auto_type _mv_1025 = ({ __auto_type _lst = items; size_t _idx = (size_t)type_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                ...
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_1028.data.sym;
                                    {
                                        ...
                                        if (_mv_1029.has_value) {
                                            __auto_type params_expr = _mv_1029.value;
                                            {
                                                __auto_type result_type_opt = defn_get_result_type_name(ctx, items);
                                                __auto_type raw_return = defn_get_return_type(ctx, items);
                                                {
...
slop_string defn_extract_spec_slop_return_type(context_TranspileContext* ctx, types_SExpr* spec_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1038 = (*spec_expr);
        switch (_mv_1038.tag) {
            case types_SExpr_lst:
            {
                                ...
                                case types_SExpr_lst:
                                {
                                    __auto_type body_lst = _mv_1040.data.lst;
                                    {
                                        ...
                                        if (body_len < 1) {
                                            ...
                                            __auto_type _mv_1041 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)(body_len - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_option_string defn_extract_result_type_name(context_TranspileContext* ctx, types_SExpr* spec_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1044 = (*spec_expr);
        switch (_mv_1044.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1044.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) < 2) {
                        ...
                        if (_mv_1045.has_value) {
                            __auto_type spec_body = _mv_1045.value;
                            __auto_type _mv_1046 = (*spec_body);
                            switch (_mv_1046.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type body_lst = _mv_1046.data.lst;
                                    {
                                        __auto_type body_items = body_lst.items;
                                        __auto_type body_len = ((int64_t)((body_items).len));
                                        if (body_len < 1) {
                                            ...
                                            __auto_type _mv_1047 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)(body_len - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_1047.has_value) {
                                                __auto_type ret_type = _mv_1047.value;
    ...
    SLOP_PRE(((type_expr != NULL)), "(!= type-expr nil)");
    {
        ...
        switch (_mv_1048.tag) {
            case types_SExpr_sym:
            {
                ...
                {
                    __auto_type type_name = sym.name;
                    __auto_type _mv_1049 = context_ctx_lookup_result_type_alias(ctx, type_name);
                    if (_mv_1049.has_value) {
                        __auto_type alias_result = _mv_1049.value;
                        return (slop_option_string){.has_value = 1, .value = alias_result};
                    } else if (!_mv_1049.has_value) {
                        __auto_type _mv_1050 = context_ctx_lookup_type(ctx, type_name);
                        if (_mv_1050.has_value) {
                            __auto_type entry = _mv_1050.value;
                                ...
                                case types_SExpr_sym:
                                {
                                    ...
                                    if (string_eq(sym.name, SLOP_STR("Result"))) {
                                        ...
                                        if (_mv_1053.has_value) {
                                            __auto_type ok_type_expr = _mv_1053.value;
                                            ...
                                            if (_mv_1054.has_value) {
                                                __auto_type err_type_expr = _mv_1054.value;
                                                {
            ...
            __auto_type lst = _mv_1063.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 1) {
                    ...
                    if (_mv_1064.has_value) {
                        __auto_type first = _mv_1064.value;
                        __auto_type _mv_1065 = (*first);
                        switch (_mv_1065.tag) {
                            case types_SExpr_sym:
                            {
                    ...
                    } else {
                        {
                            ...
                            if (len == 2) {
                                ...
                                if (_mv_1067.has_value) {
                                    __auto_type args_expr = _mv_1067.value;
                                    {
...
slop_string defn_build_fn_args_str_for_param(context_TranspileContext* ctx, types_SExpr* args_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1068 = (*args_expr);
        switch (_mv_1068.tag) {
            case types_SExpr_lst:
            {
                __auto_type args_list = _mv_1068.data.lst;
                {
                    ...
                    if (arg_count == 0) {
                    ...
                    } else {
                        {
                            ...
                            __auto_type i = 0;
                            while (i < arg_count) {
                                __auto_type _mv_1069 = ({ __auto_type _lst = arg_items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1069.has_value) {
                                    __auto_type arg_expr = _mv_1069.value;
                                    {
...
uint8_t defn_is_c_name_attr_at(slop_list_types_SExpr_ptr items, int64_t idx) {
    __auto_type _mv_1073 = ({ __auto_type _lst = items; size_t _idx = (size_t)idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                ...
                __auto_type lst = _mv_1094.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) >= 2) {
                        ...
                        if (_mv_1095.has_value) {
                            ...
                            __auto_type _mv_1096 = (*val);
                            switch (_mv_1096.tag) {
                                case types_SExpr_str:
                                {
                                    __auto_type str = _mv_1096.data.str;
                ...
                __auto_type lst = _mv_1098.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) >= 2) {
                        ...
                        if (_mv_1099.has_value) {
                            __auto_type val = _mv_1099.value;
...
void defn_emit_preconditions(context_TranspileContext* ctx, slop_list_types_SExpr_ptr preconditions) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1107 = ({ __auto_type _lst = preconditions; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void defn_emit_postconditions(context_TranspileContext* ctx, slop_list_types_SExpr_ptr postconditions) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1108 = ({ __auto_type _lst = postconditions; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void defn_emit_assumptions(context_TranspileContext* ctx, slop_list_types_SExpr_ptr assumptions) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1109 = ({ __auto_type _lst = assumptions; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
