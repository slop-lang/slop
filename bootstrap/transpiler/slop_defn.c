        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_941.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 1) {
                    ...
                    __auto_type _mv_942 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_944.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 1) {
                    ...
                    __auto_type _mv_945 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
uint8_t defn_has_generic_annotation(slop_list_types_SExpr_ptr items) {
    {
        ...
        while ((i < len) && !(found)) {
            ...
            if (_mv_956.has_value) {
                __auto_type item = _mv_956.value;
                __auto_type _mv_957 = (*item);
                switch (_mv_957.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type lst = _mv_957.data.lst;
                        {
                            ...
                            if (((int64_t)((sub_items).len)) > 0) {
                                __auto_type _mv_958 = ({ __auto_type _lst = sub_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            ...
                            switch (_mv_965.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_965.data.sym;
                                    {
                                        ...
                                        __auto_type _mv_966 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_966.has_value) {
                                            __auto_type type_expr = _mv_966.value;
                                            {
                                                ...
                                                __auto_type _mv_967 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        if (ctype_is_int_type(type_name)) {
        ...
        } else {
            {
                ...
                if (string_eq(type_name, SLOP_STR("String"))) {
                    __auto_type _mv_968 = (*value_expr);
                    switch (_mv_968.tag) {
                        case types_SExpr_str:
                        {
                            __auto_type str = _mv_968.data.str;
...
slop_string defn_eval_const_value(context_TranspileContext* ctx, types_SExpr* expr) {
    ...
    SLOP_PRE(((expr != NULL)), "(!= expr nil)");
    {
        ...
        switch (_mv_970.tag) {
            ...
            {
                __auto_type num = _mv_970.data.num;
                return num.raw;
            }
            case types_SExpr_str:
            {
                __auto_type str = _mv_970.data.str;
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_971.data.lst;
                {
                    ...
                    __auto_type len = ((int64_t)((items).len));
                    {
                        ...
                        if (len >= (name_idx + 1)) {
                            __auto_type _mv_972 = ({ __auto_type _lst = items; size_t _idx = (size_t)name_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
uint8_t defn_is_string_expr(slop_list_types_SExpr_ptr items, int64_t idx) {
    __auto_type _mv_974 = ({ __auto_type _lst = items; size_t _idx = (size_t)idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    if (_mv_974.has_value) {
        __auto_type item = _mv_974.value;
        __auto_type _mv_975 = (*item);
        switch (_mv_975.tag) {
            case types_SExpr_str:
            {
                __auto_type _ = _mv_975.data.str;
                return 1;
            }
            default: {
                return 0;
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_976.data.lst;
                {
                    ...
                    if (len < 3) {
                        ...
                        __auto_type _mv_977 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_977.has_value) {
                            __auto_type name_expr = _mv_977.value;
                            __auto_type _mv_978 = (*name_expr);
                            switch (_mv_978.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_978.data.sym;
                                    {
                                        __auto_type raw_name = name_sym.name;
                                        __auto_type base_name = ctype_to_c_name(arena, raw_name);
                                        ...
                                        if (_mv_979.has_value) {
                                            __auto_type type_def = _mv_979.value;
...
void defn_dispatch_type_def(context_TranspileContext* ctx, slop_string raw_name, slop_string qualified_name, types_SExpr* type_def) {
    ...
    __auto_type _mv_980 = (*type_def);
    switch (_mv_980.tag) {
        case types_SExpr_lst:
        {
            __auto_type def_lst = _mv_980.data.lst;
            {
...
uint8_t defn_has_payload_variants(slop_list_types_SExpr_ptr items) {
    {
        ...
        uint8_t found = 0;
        while ((i < len) && !(found)) {
            __auto_type _mv_983 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_983.has_value) {
                ...
                switch (_mv_984.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type _ = _mv_984.data.lst;
                        found = 1;
                        break;
                    }
                    default: {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_986.has_value) {
                __auto_type field_expr = _mv_986.value;
...
void defn_emit_record_field(context_TranspileContext* ctx, slop_string raw_type_name, slop_string qualified_type_name, types_SExpr* field) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_987 = (*field);
        switch (_mv_987.tag) {
            case types_SExpr_lst:
            {
                __auto_type field_lst = _mv_987.data.lst;
                {
                    ...
                    if (len < 2) {
                        ...
                        __auto_type _mv_988 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void defn_emit_enum_values(context_TranspileContext* ctx, slop_string type_name, slop_list_types_SExpr_ptr items, int64_t start_idx, int64_t len) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = start_idx;
        while (i < len) {
            __auto_type _mv_992 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_992.has_value) {
                __auto_type val_expr = _mv_992.value;
                __auto_type _mv_993 = (*val_expr);
                switch (_mv_993.tag) {
                    case types_SExpr_sym:
                    {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_995.has_value) {
                __auto_type variant_expr = _mv_995.value;
                __auto_type _mv_996 = (*variant_expr);
                switch (_mv_996.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type var_lst = _mv_996.data.lst;
                        {
                            __auto_type var_items = var_lst.items;
                            __auto_type var_len = ((int64_t)((var_items).len));
                            if (var_len >= 1) {
                                __auto_type _mv_997 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_997.has_value) {
                                    __auto_type tag_expr = _mv_997.value;
                                    __auto_type _mv_998 = (*tag_expr);
                                    switch (_mv_998.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type tag_sym = _mv_998.data.sym;
                                            {
                                                __auto_type tag_name = tag_sym.name;
                                                __auto_type c_tag = ctype_to_c_name(arena, tag_name);
                                                if (var_len == 2) {
                                                    __auto_type _mv_999 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    ...
                                                    for (int64_t fi = 1; fi < var_len; fi++) {
                                                        __auto_type _mv_1000 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)fi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                        if (_mv_1000.has_value) {
                                                            __auto_type type_expr = _mv_1000.value;
                                                            {
                                                                __auto_type c_type = context_to_c_type_prefixed(ctx, type_expr);
                                                                {
                                                                    __auto_type actual_type = ((string_eq(c_type, SLOP_STR("void"))) ? SLOP_STR("int") : c_type);
...
void defn_emit_tag_constants(context_TranspileContext* ctx, slop_string type_name, slop_list_types_SExpr_ptr items, int64_t start_idx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t tag_idx = 0;
        while (i < len) {
            __auto_type _mv_1001 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1001.has_value) {
                __auto_type variant_expr = _mv_1001.value;
                __auto_type _mv_1002 = (*variant_expr);
                switch (_mv_1002.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type var_lst = _mv_1002.data.lst;
                        {
                            __auto_type var_items = var_lst.items;
                            if (((int64_t)((var_items).len)) >= 1) {
                                __auto_type _mv_1003 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1003.has_value) {
                                    __auto_type tag_expr = _mv_1003.value;
                                    __auto_type _mv_1004 = (*tag_expr);
                                    switch (_mv_1004.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type tag_sym = _mv_1004.data.sym;
                                            {
                                                __auto_type tag_name = tag_sym.name;
...
void defn_register_union_variant_fields(context_TranspileContext* ctx, slop_string raw_name, slop_string qualified_name, slop_list_types_SExpr_ptr items, int64_t start_idx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = start_idx;
        while (i < len) {
            __auto_type _mv_1005 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1005.has_value) {
                __auto_type variant_expr = _mv_1005.value;
                __auto_type _mv_1006 = (*variant_expr);
                switch (_mv_1006.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type var_lst = _mv_1006.data.lst;
                        {
                            __auto_type var_items = var_lst.items;
                            __auto_type var_len = ((int64_t)((var_items).len));
                            if (var_len >= 2) {
                                __auto_type _mv_1007 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1007.has_value) {
                                    __auto_type tag_expr = _mv_1007.value;
                                    __auto_type _mv_1008 = (*tag_expr);
                                    switch (_mv_1008.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type tag_sym = _mv_1008.data.sym;
                                            {
                                                __auto_type tag_name = tag_sym.name;
                                                if (var_len == 2) {
                                                    __auto_type _mv_1009 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    ...
                                                    for (int64_t fi = 1; fi < var_len; fi++) {
                                                        __auto_type _mv_1010 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)fi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    ...
                                                    __auto_type _mv_1011 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_1011.has_value) {
                                                        __auto_type type_expr = _mv_1011.value;
                                                        {
                                                            __auto_type c_type = context_to_c_type_prefixed(ctx, type_expr);
                                                            __auto_type slop_type_str = parser_pretty_print(arena, type_expr);
                                                            __auto_type is_ptr = defn_is_pointer_type_expr(type_expr);
...
uint8_t defn_is_array_type(types_SExpr* type_expr) {
    SLOP_PRE(((type_expr != NULL)), "(!= type-expr nil)");
    __auto_type _mv_1012 = (*type_expr);
    switch (_mv_1012.tag) {
        case types_SExpr_lst:
        {
...
void defn_emit_array_typedef(context_TranspileContext* ctx, slop_string qualified_name, types_SExpr* type_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1015 = (*type_expr);
        switch (_mv_1015.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1015.data.lst;
                {
                    ...
                    if (len < 3) {
                        ...
                        if (_mv_1016.has_value) {
                            __auto_type elem_type_expr = _mv_1016.value;
                            __auto_type _mv_1017 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_1017.has_value) {
                                __auto_type size_expr = _mv_1017.value;
                                {
        ...
        switch (_mv_1022.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1022.data.lst;
                {
                    ...
                    __auto_type i = 1;
                    while (i < len) {
                        __auto_type _mv_1023 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_1023.has_value) {
                            __auto_type item = _mv_1023.value;
                            __auto_type _mv_1024 = (*item);
                            switch (_mv_1024.tag) {
                                case types_SExpr_num:
                                {
                                    __auto_type num = _mv_1024.data.num;
                                    if (!(found_dots)) {
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1025.data.lst;
                {
                    ...
                    if (len < 3) {
                        ...
                        __auto_type _mv_1026 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            ...
                            switch (_mv_1027.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_1027.data.sym;
                                    {
                                        ...
                                        __auto_type _mv_1028 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void defn_bind_params_to_scope(context_TranspileContext* ctx, types_SExpr* params_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1031 = (*params_expr);
        switch (_mv_1031.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1031.data.lst;
                {
                    ...
                    __auto_type i = 0;
                    while (i < len) {
                        __auto_type _mv_1032 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_1032.has_value) {
                            __auto_type param = _mv_1032.value;
                    ...
                    if (len >= 2) {
                        {
                            ...
                            __auto_type _mv_1034 = ({ __auto_type _lst = items; size_t _idx = (size_t)name_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_1034.has_value) {
                                __auto_type name_expr = _mv_1034.value;
                                __auto_type _mv_1035 = (*name_expr);
                                switch (_mv_1035.tag) {
                                    case types_SExpr_sym:
                                    {
                                        __auto_type name_sym = _mv_1035.data.sym;
                                        __auto_type _mv_1036 = ({ __auto_type _lst = items; size_t _idx = (size_t)type_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_1036.has_value) {
                                            __auto_type type_expr = _mv_1036.value;
                                            {
...
uint8_t defn_is_pointer_type(types_SExpr* type_expr) {
    SLOP_PRE(((type_expr != NULL)), "(!= type-expr nil)");
    __auto_type _mv_1037 = (*type_expr);
    switch (_mv_1037.tag) {
        case types_SExpr_lst:
        {
                ...
                __auto_type lst = _mv_1042.data.lst;
                {
                    ...
                    if (len < 2) {
                    ...
                    } else {
                        {
                            __auto_type has_mode = ((len >= 3) && defn_is_param_mode(items));
                            __auto_type type_idx = ((has_mode) ? 2 : 1);
                            __auto_type _mv_1043 = ({ __auto_type _lst = items; size_t _idx = (size_t)type_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        switch (_mv_1044.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1044.data.lst;
                {
                    ...
                    __auto_type len = ((int64_t)((items).len));
                    if (len >= 3) {
                        __auto_type _mv_1045 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_1045.has_value) {
                            __auto_type name_expr = _mv_1045.value;
                            __auto_type _mv_1046 = (*name_expr);
                            switch (_mv_1046.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_1046.data.sym;
                                    {
                                        __auto_type raw_name = name_sym.name;
                                        __auto_type base_name = ctype_to_c_name(arena, raw_name);
                                        ...
                                        __auto_type _mv_1047 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1049.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 1) {
                    ...
                    __auto_type _mv_1050 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_string defn_extract_spec_return_type(context_TranspileContext* ctx, types_SExpr* spec_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1052 = (*spec_expr);
        switch (_mv_1052.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1052.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) < 2) {
                        ...
                        __auto_type _mv_1053 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_1053.has_value) {
                            __auto_type spec_body = _mv_1053.value;
                            __auto_type _mv_1054 = (*spec_body);
                            switch (_mv_1054.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type body_lst = _mv_1054.data.lst;
                                    {
                                        ...
                                        if (body_len < 1) {
                                            ...
                                            __auto_type _mv_1055 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)(body_len - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_1055.has_value) {
                                                __auto_type ret_type = _mv_1055.value;
...
slop_string defn_extract_spec_slop_return_type(context_TranspileContext* ctx, types_SExpr* spec_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1056 = (*spec_expr);
        switch (_mv_1056.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1056.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) < 2) {
                        ...
                        __auto_type _mv_1057 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_1057.has_value) {
                            __auto_type spec_body = _mv_1057.value;
                            __auto_type _mv_1058 = (*spec_body);
                            switch (_mv_1058.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type body_lst = _mv_1058.data.lst;
                                    {
                                        __auto_type body_items = body_lst.items;
                                        __auto_type body_len = ((int64_t)((body_items).len));
                                        if (body_len < 1) {
                                            ...
                                            __auto_type _mv_1059 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)(body_len - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_1059.has_value) {
                                                __auto_type ret_type = _mv_1059.value;
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_1060.has_value) {
                __auto_type item = _mv_1060.value;
                if (defn_is_spec_form(item)) {
...
slop_option_string defn_get_result_type_name(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while ((i < len) && ({ __auto_type _mv = result; _mv.has_value ? ({ __auto_type _ = _mv.value; 0; }) : (1); })) {
            __auto_type _mv_1061 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_option_string defn_extract_result_type_name(context_TranspileContext* ctx, types_SExpr* spec_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1062 = (*spec_expr);
        switch (_mv_1062.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1062.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) < 2) {
                        ...
                        __auto_type _mv_1063 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_1063.has_value) {
                            __auto_type spec_body = _mv_1063.value;
                            __auto_type _mv_1064 = (*spec_body);
                            switch (_mv_1064.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type body_lst = _mv_1064.data.lst;
                                    {
                                        __auto_type body_items = body_lst.items;
                                        __auto_type body_len = ((int64_t)((body_items).len));
                                        if (body_len < 1) {
                                            ...
                                            __auto_type _mv_1065 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)(body_len - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_1065.has_value) {
                                                __auto_type ret_type = _mv_1065.value;
...
slop_option_string defn_check_result_type(context_TranspileContext* ctx, types_SExpr* type_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1066 = (*type_expr);
        switch (_mv_1066.tag) {
            case types_SExpr_sym:
            {
                ...
                {
                    __auto_type type_name = sym.name;
                    __auto_type _mv_1067 = context_ctx_lookup_result_type_alias(ctx, type_name);
                    if (_mv_1067.has_value) {
                        __auto_type alias_result = _mv_1067.value;
                        return (slop_option_string){.has_value = 1, .value = alias_result};
                    } else if (!_mv_1067.has_value) {
                        __auto_type _mv_1068 = context_ctx_lookup_type(ctx, type_name);
                        if (_mv_1068.has_value) {
                            __auto_type entry = _mv_1068.value;
                            ...
                            switch (_mv_1070.tag) {
                                case types_SExpr_sym:
                                {
                                    ...
                                    if (string_eq(sym.name, SLOP_STR("Result"))) {
                                        __auto_type _mv_1071 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_1071.has_value) {
                                            __auto_type ok_type_expr = _mv_1071.value;
                                            __auto_type _mv_1072 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_1072.has_value) {
                                                __auto_type err_type_expr = _mv_1072.value;
                                                {
...
slop_string defn_build_param_str(context_TranspileContext* ctx, types_SExpr* params_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1073 = (*params_expr);
        switch (_mv_1073.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1073.data.lst;
                {
                    ...
                    __auto_type i = 0;
                    while (i < len) {
                        __auto_type _mv_1074 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_1074.has_value) {
                            __auto_type param = _mv_1074.value;
                            {
                ...
                __auto_type lst = _mv_1075.data.lst;
                {
                    ...
                    if (len < 2) {
                    ...
                    } else {
                        {
                            ...
                            __auto_type _mv_1076 = ({ __auto_type _lst = items; size_t _idx = (size_t)name_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_1076.has_value) {
                                ...
                                switch (_mv_1077.tag) {
                                    case types_SExpr_sym:
                                    {
                                        ...
                                        __auto_type _mv_1078 = ({ __auto_type _lst = items; size_t _idx = (size_t)type_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
uint8_t defn_is_param_mode(slop_list_types_SExpr_ptr items) {
    if (((int64_t)((items).len)) < 1) {
        ...
        if (_mv_1079.has_value) {
            __auto_type first = _mv_1079.value;
            __auto_type _mv_1080 = (*first);
            switch (_mv_1080.tag) {
                case types_SExpr_sym:
                {
...
uint8_t defn_is_fn_type(types_SExpr* type_expr) {
    __auto_type _mv_1081 = (*type_expr);
    switch (_mv_1081.tag) {
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1081.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 1) {
                    ...
                    if (_mv_1082.has_value) {
                        __auto_type first = _mv_1082.value;
                        __auto_type _mv_1083 = (*first);
                        switch (_mv_1083.tag) {
                            case types_SExpr_sym:
                            {
                    ...
                    if (len < 2) {
                    ...
                    } else {
                        {
                            ...
                            if (len == 2) {
                                ...
                                __auto_type _mv_1085 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1085.has_value) {
                                    __auto_type args_expr = _mv_1085.value;
                                    {
...
slop_string defn_build_fn_args_str_for_param(context_TranspileContext* ctx, types_SExpr* args_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1086 = (*args_expr);
        switch (_mv_1086.tag) {
            case types_SExpr_lst:
            {
                __auto_type args_list = _mv_1086.data.lst;
                {
                    ...
                    if (arg_count == 0) {
                    ...
                    } else {
                        {
                            ...
                            __auto_type i = 0;
                            while (i < arg_count) {
                                __auto_type _mv_1087 = ({ __auto_type _lst = arg_items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1087.has_value) {
                                    __auto_type arg_expr = _mv_1087.value;
                                    {
...
uint8_t defn_is_last_body_item(slop_list_types_SExpr_ptr items, int64_t current_i) {
    {
        ...
        while ((i < len) && !(found_body)) {
            __auto_type _mv_1090 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
uint8_t defn_is_c_name_attr_at(slop_list_types_SExpr_ptr items, int64_t idx) {
    __auto_type _mv_1091 = ({ __auto_type _lst = items; size_t _idx = (size_t)idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
int64_t defn_find_body_start(slop_list_types_SExpr_ptr items) {
    {
        ...
        uint8_t found = 0;
        while ((i < len) && !(found)) {
            __auto_type _mv_1092 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1096.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 1) {
                    ...
                    __auto_type _mv_1097 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_1097.has_value) {
                        __auto_type head = _mv_1097.value;
                        __auto_type _mv_1098 = (*head);
                        switch (_mv_1098.tag) {
                            case types_SExpr_sym:
                            {
                ...
                __auto_type lst = _mv_1112.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) >= 2) {
                        ...
                        if (_mv_1113.has_value) {
                            __auto_type val = _mv_1113.value;
                            __auto_type _mv_1114 = (*val);
                            switch (_mv_1114.tag) {
                                case types_SExpr_str:
                                {
                                    __auto_type str = _mv_1114.data.str;
        ...
        switch (_mv_1116.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1116.data.lst;
                {
                    __auto_type items = lst.items;
                    if (((int64_t)((items).len)) >= 2) {
                        __auto_type _mv_1117 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_1117.has_value) {
                            __auto_type val = _mv_1117.value;
        ...
        while (i < len) {
            ...
            if (_mv_1118.has_value) {
                ...
                if (defn_is_pre_form(item)) {
                    __auto_type _mv_1119 = defn_get_annotation_condition(item);
                    if (_mv_1119.has_value) {
                        __auto_type cond = _mv_1119.value;
        ...
        while (i < len) {
            ...
            if (_mv_1120.has_value) {
                ...
                if (defn_is_post_form(item)) {
                    __auto_type _mv_1121 = defn_get_annotation_condition(item);
                    if (_mv_1121.has_value) {
                        __auto_type cond = _mv_1121.value;
                        ({ __auto_type _lst_p = &(result); __auto_type _item = (cond); if (_lst_p->len >= _lst_p->cap) { size_t _new_cap = _lst_p->cap == 0 ? 16 : _lst_p->cap * 2; __typeof__(_lst_p->data) _new_data = (__typeof__(_lst_p->data))slop_arena_alloc(arena, _new_cap * sizeof(*_lst_p->data)); if (_lst_p->len > 0) memcpy(_new_data, _lst_p->data, _lst_p->len * sizeof(*_lst_p->data)); _lst_p->data = _new_data; _lst_p->cap = _new_cap; } _lst_p->data[_lst_p->len++] = _item; (void)0; });
        ...
        while (i < len) {
            ...
            if (_mv_1122.has_value) {
                ...
                if (defn_is_assume_form(item)) {
                    __auto_type _mv_1123 = defn_get_annotation_condition(item);
                    if (_mv_1123.has_value) {
                        __auto_type cond = _mv_1123.value;
                        ({ __auto_type _lst_p = &(result); __auto_type _item = (cond); if (_lst_p->len >= _lst_p->cap) { size_t _new_cap = _lst_p->cap == 0 ? 16 : _lst_p->cap * 2; __typeof__(_lst_p->data) _new_data = (__typeof__(_lst_p->data))slop_arena_alloc(arena, _new_cap * sizeof(*_lst_p->data)); if (_lst_p->len > 0) memcpy(_new_data, _lst_p->data, _lst_p->len * sizeof(*_lst_p->data)); _lst_p->data = _new_data; _lst_p->cap = _new_cap; } _lst_p->data[_lst_p->len++] = _item; (void)0; });
...
void defn_emit_preconditions(context_TranspileContext* ctx, slop_list_types_SExpr_ptr preconditions) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1125 = ({ __auto_type _lst = preconditions; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1125.has_value) {
                __auto_type cond_expr = _mv_1125.value;
                {
...
void defn_emit_postconditions(context_TranspileContext* ctx, slop_list_types_SExpr_ptr postconditions) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1126 = ({ __auto_type _lst = postconditions; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1126.has_value) {
                __auto_type cond_expr = _mv_1126.value;
...
void defn_emit_assumptions(context_TranspileContext* ctx, slop_list_types_SExpr_ptr assumptions) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1127 = ({ __auto_type _lst = assumptions; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1127.has_value) {
                __auto_type cond_expr = _mv_1127.value;
                if (!(defn_is_verification_only_expr(cond_expr))) {
                    {
                        __auto_type cond_c = expr_transpile_expr(ctx, cond_expr);
                        __auto_type expr_str = parser_pretty_print(arena, cond_expr);
