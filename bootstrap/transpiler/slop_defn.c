        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_760.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    __auto_type _mv_761 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_761.has_value) {
                        __auto_type head = _mv_761.value;
                        __auto_type _mv_762 = (*head);
                        switch (_mv_762.tag) {
                            case types_SExpr_sym:
                            {
                                __auto_type sym = _mv_762.data.sym;
...
uint8_t defn_is_const_form(types_SExpr* expr) {
    SLOP_PRE(((expr != NULL)), "(!= expr nil)");
    __auto_type _mv_763 = (*expr);
    switch (_mv_763.tag) {
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_763.data.lst;
            {
                __auto_type items = lst.items;
                if ((((int64_t)((items).len)) < 1)) {
                    return 0;
                } else {
                    __auto_type _mv_764 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_764.has_value) {
                        __auto_type head = _mv_764.value;
                        __auto_type _mv_765 = (*head);
                        switch (_mv_765.tag) {
                            case types_SExpr_sym:
                            {
                                __auto_type sym = _mv_765.data.sym;
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_766.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    __auto_type _mv_767 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_769.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    __auto_type _mv_770 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_770.has_value) {
                        __auto_type head = _mv_770.value;
                        __auto_type _mv_771 = (*head);
                        switch (_mv_771.tag) {
                            case types_SExpr_sym:
                            {
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_772.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    __auto_type _mv_773 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_773.has_value) {
                        __auto_type head = _mv_773.value;
                        __auto_type _mv_774 = (*head);
                        switch (_mv_774.tag) {
                            case types_SExpr_sym:
                            {
                                __auto_type sym = _mv_774.data.sym;
                                ...
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_777.data.sym;
                                    {
                                        ...
                                        if (_mv_778.has_value) {
                                            __auto_type type_expr = _mv_778.value;
                                            {
                                                ...
                                                __auto_type _mv_779 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_779.has_value) {
                                                    __auto_type value_expr = _mv_779.value;
        ...
        if (defn_is_int_type(type_name)) {
        ...
        } else {
            {
                ...
                if (string_eq(type_name, SLOP_STR("String"))) {
                    __auto_type _mv_780 = (*value_expr);
                    switch (_mv_780.tag) {
                        case types_SExpr_str:
                        {
                            __auto_type str = _mv_780.data.str;
...
slop_string defn_eval_const_value(context_TranspileContext* ctx, types_SExpr* expr) {
    ...
    SLOP_PRE(((expr != NULL)), "(!= expr nil)");
    {
        ...
        switch (_mv_782.tag) {
            ...
            {
                __auto_type num = _mv_782.data.num;
                return num.raw;
            }
            case types_SExpr_str:
            {
                __auto_type str = _mv_782.data.str;
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_783.data.lst;
                {
                    ...
                    __auto_type len = ((int64_t)((items).len));
                    {
                        ...
                        if ((len >= (name_idx + 1))) {
                            __auto_type _mv_784 = ({ __auto_type _lst = items; size_t _idx = (size_t)name_idx; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_784.has_value) {
                                __auto_type name_expr = _mv_784.value;
                                __auto_type _mv_785 = (*name_expr);
                                switch (_mv_785.tag) {
                                    case types_SExpr_sym:
                                    {
...
uint8_t defn_is_string_expr(slop_list_types_SExpr_ptr items, int64_t idx) {
    __auto_type _mv_786 = ({ __auto_type _lst = items; size_t _idx = (size_t)idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    if (_mv_786.has_value) {
        __auto_type item = _mv_786.value;
        __auto_type _mv_787 = (*item);
        switch (_mv_787.tag) {
            case types_SExpr_str:
            {
                __auto_type _ = _mv_787.data.str;
                return 1;
            }
            default: {
                return 0;
                            ...
                            switch (_mv_790.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_790.data.sym;
                                    {
                                        ...
                                        __auto_type _mv_791 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_791.has_value) {
                                            __auto_type type_def = _mv_791.value;
...
void defn_dispatch_type_def(context_TranspileContext* ctx, slop_string raw_name, slop_string qualified_name, types_SExpr* type_def) {
    ...
    __auto_type _mv_792 = (*type_def);
    switch (_mv_792.tag) {
        case types_SExpr_lst:
        {
            __auto_type def_lst = _mv_792.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    __auto_type _mv_793 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_793.has_value) {
                        __auto_type head = _mv_793.value;
                        __auto_type _mv_794 = (*head);
                        switch (_mv_794.tag) {
                            case types_SExpr_sym:
                            {
                                __auto_type sym = _mv_794.data.sym;
                                {
...
uint8_t defn_has_payload_variants(slop_list_types_SExpr_ptr items) {
    {
        ...
        while (((i < len) && !(found))) {
            ...
            if (_mv_795.has_value) {
                __auto_type item = _mv_795.value;
                __auto_type _mv_796 = (*item);
                switch (_mv_796.tag) {
                    case types_SExpr_lst:
                    {
...
void defn_emit_record_fields(context_TranspileContext* ctx, slop_string raw_type_name, slop_string qualified_type_name, slop_list_types_SExpr_ptr items, int64_t start_idx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while ((i < len)) {
            __auto_type _mv_798 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_798.has_value) {
                __auto_type field_expr = _mv_798.value;
...
void defn_emit_record_field(context_TranspileContext* ctx, slop_string raw_type_name, slop_string qualified_type_name, types_SExpr* field) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_799 = (*field);
        switch (_mv_799.tag) {
            case types_SExpr_lst:
            {
                __auto_type field_lst = _mv_799.data.lst;
                {
                    ...
                    if ((len < 2)) {
                        ...
                        __auto_type _mv_800 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_800.has_value) {
                            __auto_type name_expr = _mv_800.value;
                            __auto_type _mv_801 = (*name_expr);
                            switch (_mv_801.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_801.data.sym;
                                    __auto_type _mv_802 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    if (_mv_802.has_value) {
                                        __auto_type type_expr = _mv_802.value;
                                        {
...
void defn_emit_enum_values(context_TranspileContext* ctx, slop_string type_name, slop_list_types_SExpr_ptr items, int64_t start_idx, int64_t len) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        __auto_type i = start_idx;
        while ((i < len)) {
            __auto_type _mv_804 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_804.has_value) {
                __auto_type val_expr = _mv_804.value;
                __auto_type _mv_805 = (*val_expr);
                switch (_mv_805.tag) {
                    case types_SExpr_sym:
                    {
...
void defn_transpile_union(context_TranspileContext* ctx, slop_string raw_name, slop_string qualified_name, types_SExpr* expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_806 = (*expr);
        switch (_mv_806.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_806.data.lst;
                {
                    __auto_type items = lst.items;
                    context_ctx_emit(ctx, context_ctx_str3(ctx, SLOP_STR("struct "), qualified_name, SLOP_STR(" {")));
...
void defn_emit_union_variants(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items, int64_t start_idx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        __auto_type i = start_idx;
        while ((i < len)) {
            __auto_type _mv_807 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_807.has_value) {
                __auto_type variant_expr = _mv_807.value;
                __auto_type _mv_808 = (*variant_expr);
                switch (_mv_808.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type var_lst = _mv_808.data.lst;
                        {
                            __auto_type var_items = var_lst.items;
                            __auto_type var_len = ((int64_t)((var_items).len));
                            if ((var_len >= 1)) {
                                __auto_type _mv_809 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)0; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_809.has_value) {
                                    __auto_type tag_expr = _mv_809.value;
                                    __auto_type _mv_810 = (*tag_expr);
                                    switch (_mv_810.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type tag_sym = _mv_810.data.sym;
                                            {
                                                __auto_type tag_name = tag_sym.name;
                                                if ((var_len >= 2)) {
                                                    __auto_type _mv_811 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)1; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_811.has_value) {
                                                        __auto_type type_expr = _mv_811.value;
                                                        {
                                                            __auto_type c_type = context_to_c_type_prefixed(ctx, type_expr);
                                                            {
                                                                ...
                                                                context_ctx_emit(ctx, context_ctx_str5(ctx, SLOP_STR("        "), actual_type, SLOP_STR(" "), tag_name, SLOP_STR(";")));
                                                            }
                                                        }
...
void defn_emit_tag_constants(context_TranspileContext* ctx, slop_string type_name, slop_list_types_SExpr_ptr items, int64_t start_idx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while ((i < len)) {
            __auto_type _mv_812 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_812.has_value) {
                __auto_type variant_expr = _mv_812.value;
                __auto_type _mv_813 = (*variant_expr);
                switch (_mv_813.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type var_lst = _mv_813.data.lst;
                        {
                            __auto_type var_items = var_lst.items;
                            if ((((int64_t)((var_items).len)) >= 1)) {
                                __auto_type _mv_814 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)0; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_814.has_value) {
                                    __auto_type tag_expr = _mv_814.value;
                                    __auto_type _mv_815 = (*tag_expr);
                                    switch (_mv_815.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type tag_sym = _mv_815.data.sym;
                                            {
                                                __auto_type tag_name = tag_sym.name;
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_816.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    __auto_type _mv_817 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_819.data.lst;
                {
                    ...
                    if ((len < 3)) {
                        ...
                        __auto_type _mv_820 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_820.has_value) {
                            __auto_type elem_type_expr = _mv_820.value;
                            __auto_type _mv_821 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_821.has_value) {
                                __auto_type size_expr = _mv_821.value;
                                {
...
slop_string defn_get_number_as_string(types_SExpr* expr) {
    ...
    switch (_mv_822.tag) {
        case types_SExpr_num:
        {
            __auto_type num = _mv_822.data.num;
            return num.raw;
        }
        default: {
            return SLOP_STR("0");
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_823.data.lst;
            {
                ...
                while (((i < len) && !(found_dots))) {
                    __auto_type _mv_824 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_824.has_value) {
                        __auto_type item = _mv_824.value;
                        __auto_type _mv_825 = (*item);
                        switch (_mv_825.tag) {
                            case types_SExpr_sym:
                            {
...
types_RangeBounds defn_parse_range_bounds(types_SExpr* type_expr) {
    SLOP_PRE(((type_expr != NULL)), "(!= type-expr nil)");
    {
        ...
        __auto_type found_dots = 0;
        __auto_type _mv_826 = (*type_expr);
        switch (_mv_826.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_826.data.lst;
                {
                    __auto_type items = lst.items;
                    __auto_type len = ((int64_t)((items).len));
                    __auto_type i = 1;
                    while ((i < len)) {
                        __auto_type _mv_827 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_827.has_value) {
                            __auto_type item = _mv_827.value;
                            __auto_type _mv_828 = (*item);
                            switch (_mv_828.tag) {
                                case types_SExpr_num:
                                {
                                    __auto_type num = _mv_828.data.num;
                                    if (!(found_dots)) {
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_829.data.lst;
                {
                    ...
                    if ((len < 3)) {
                        ...
                        __auto_type _mv_830 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            ...
                            switch (_mv_831.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_831.data.sym;
                                    {
                                        ...
                                        __auto_type _mv_832 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_832.has_value) {
                                            __auto_type params_expr = _mv_832.value;
    ...
    SLOP_PRE(((params_expr != NULL)), "(!= params-expr nil)");
    {
        ...
        __auto_type doc_string = defn_collect_doc_string(arena, items);
        {
            ...
            context_ctx_emit(ctx, SLOP_STR(""));
            {
                ...
                context_ctx_register_func(ctx, (context_FuncEntry){raw_name, fn_name, actual_return, slop_ret_type, 0, string_eq(actual_return, SLOP_STR("slop_string")), param_types});
            }
            context_ctx_clear_current_result_type(ctx);
...
void defn_bind_params_to_scope(context_TranspileContext* ctx, types_SExpr* params_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_835 = (*params_expr);
        switch (_mv_835.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_835.data.lst;
                {
                    ...
                    __auto_type i = 0;
                    while ((i < len)) {
                        __auto_type _mv_836 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_836.has_value) {
                            __auto_type param = _mv_836.value;
                    ...
                    if ((len >= 2)) {
                        {
                            ...
                            __auto_type _mv_838 = ({ __auto_type _lst = items; size_t _idx = (size_t)name_idx; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_838.has_value) {
                                __auto_type name_expr = _mv_838.value;
                                __auto_type _mv_839 = (*name_expr);
                                switch (_mv_839.tag) {
                                    case types_SExpr_sym:
                                    {
                                        __auto_type name_sym = _mv_839.data.sym;
                                        __auto_type _mv_840 = ({ __auto_type _lst = items; size_t _idx = (size_t)type_idx; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_841.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    __auto_type _mv_842 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_list_context_FuncParamType_ptr defn_collect_param_types(context_TranspileContext* ctx, types_SExpr* params_expr) {
    ...
    SLOP_PRE(((params_expr != NULL)), "(!= params-expr nil)");
    {
        ...
        __auto_type _mv_844 = (*params_expr);
        switch (_mv_844.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_844.data.lst;
                {
                    ...
                    __auto_type i = 0;
                    while ((i < len)) {
                        __auto_type _mv_845 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_845.has_value) {
                            __auto_type param = _mv_845.value;
                            {
                ...
                __auto_type lst = _mv_846.data.lst;
                {
                    ...
                    if ((len < 2)) {
                    ...
                    } else {
                        {
                            __auto_type has_mode = ((len >= 3) && defn_is_param_mode(items));
                            __auto_type type_idx = ((has_mode) ? 2 : 1);
                            __auto_type _mv_847 = ({ __auto_type _lst = items; size_t _idx = (size_t)type_idx; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_847.has_value) {
                                __auto_type type_expr = _mv_847.value;
        ...
        switch (_mv_848.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_848.data.lst;
                {
                    ...
                    __auto_type len = ((int64_t)((items).len));
                    if ((len >= 3)) {
                        __auto_type _mv_849 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_849.has_value) {
                            __auto_type name_expr = _mv_849.value;
                            __auto_type _mv_850 = (*name_expr);
                            switch (_mv_850.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_850.data.sym;
                                    {
                                        __auto_type raw_name = name_sym.name;
                                        __auto_type base_name = ctype_to_c_name(arena, raw_name);
                                        __auto_type mangled_name = context_ctx_prefix_type(ctx, base_name);
                                        __auto_type fn_name = context_extract_fn_c_name(arena, items, mangled_name);
                                        __auto_type _mv_851 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_851.has_value) {
                                            __auto_type params_expr = _mv_851.value;
                                            {
                                                __auto_type result_type_opt = defn_get_result_type_name(ctx, items);
                                                __auto_type raw_return = defn_get_return_type(ctx, items);
                                                {
...
slop_string defn_get_return_type(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while ((i < len)) {
            __auto_type _mv_852 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_852.has_value) {
                __auto_type item = _mv_852.value;
...
uint8_t defn_is_spec_form(types_SExpr* expr) {
    ...
    switch (_mv_853.tag) {
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_853.data.lst;
            {
                __auto_type items = lst.items;
                if ((((int64_t)((items).len)) < 1)) {
                    return 0;
                } else {
                    __auto_type _mv_854 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_854.has_value) {
                        __auto_type head = _mv_854.value;
                        __auto_type _mv_855 = (*head);
                        switch (_mv_855.tag) {
                            case types_SExpr_sym:
                            {
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_856.data.lst;
                {
                    ...
                    if ((((int64_t)((items).len)) < 2)) {
                        ...
                        __auto_type _mv_857 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_857.has_value) {
                            __auto_type spec_body = _mv_857.value;
                            __auto_type _mv_858 = (*spec_body);
                            switch (_mv_858.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type body_lst = _mv_858.data.lst;
                                    {
                                        ...
                                        if ((body_len < 1)) {
                                            ...
                                            __auto_type _mv_859 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)(body_len - 1); struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_860.data.lst;
                {
                    ...
                    if ((((int64_t)((items).len)) < 2)) {
                        ...
                        __auto_type _mv_861 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_861.has_value) {
                            __auto_type spec_body = _mv_861.value;
                            __auto_type _mv_862 = (*spec_body);
                            switch (_mv_862.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type body_lst = _mv_862.data.lst;
                                    {
                                        __auto_type body_items = body_lst.items;
                                        __auto_type body_len = ((int64_t)((body_items).len));
                                        if ((body_len < 1)) {
                                            ...
                                            __auto_type _mv_863 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)(body_len - 1); struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_string defn_get_slop_return_type(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while ((i < len)) {
            __auto_type _mv_864 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_864.has_value) {
                __auto_type item = _mv_864.value;
                if (defn_is_spec_form(item)) {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (((i < len) && ({ __auto_type _mv = result; _mv.has_value ? ({ __auto_type _ = _mv.value; 0; }) : (1); }))) {
            ...
            if (_mv_865.has_value) {
                __auto_type item = _mv_865.value;
                if (defn_is_spec_form(item)) {
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_866.data.lst;
                {
                    ...
                    if ((((int64_t)((items).len)) < 2)) {
                        ...
                        __auto_type _mv_867 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_867.has_value) {
                            __auto_type spec_body = _mv_867.value;
                            __auto_type _mv_868 = (*spec_body);
                            switch (_mv_868.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type body_lst = _mv_868.data.lst;
                                    {
                                        __auto_type body_items = body_lst.items;
                                        __auto_type body_len = ((int64_t)((body_items).len));
                                        if ((body_len < 1)) {
                                            ...
                                            __auto_type _mv_869 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)(body_len - 1); struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_869.has_value) {
                                                __auto_type ret_type = _mv_869.value;
    ...
    SLOP_PRE(((type_expr != NULL)), "(!= type-expr nil)");
    {
        ...
        switch (_mv_870.tag) {
            case types_SExpr_sym:
            {
                ...
                {
                    __auto_type type_name = sym.name;
                    __auto_type _mv_871 = context_ctx_lookup_result_type_alias(ctx, type_name);
                    if (_mv_871.has_value) {
                        __auto_type alias_result = _mv_871.value;
                        return (slop_option_string){.has_value = 1, .value = alias_result};
                    } else if (!_mv_871.has_value) {
                        __auto_type _mv_872 = context_ctx_lookup_type(ctx, type_name);
                        if (_mv_872.has_value) {
                            __auto_type entry = _mv_872.value;
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_870.data.lst;
                {
                    ...
                    if ((((int64_t)((items).len)) < 3)) {
                        ...
                        __auto_type _mv_873 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            ...
                            switch (_mv_874.tag) {
                                case types_SExpr_sym:
                                {
                                    ...
                                    if (string_eq(sym.name, SLOP_STR("Result"))) {
                                        __auto_type _mv_875 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_875.has_value) {
                                            __auto_type ok_type_expr = _mv_875.value;
                                            __auto_type _mv_876 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_876.has_value) {
                                                __auto_type err_type_expr = _mv_876.value;
                                                {
...
slop_string defn_build_param_str(context_TranspileContext* ctx, types_SExpr* params_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_877 = (*params_expr);
        switch (_mv_877.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_877.data.lst;
                {
                    ...
                    __auto_type i = 0;
                    while ((i < len)) {
                        __auto_type _mv_878 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_878.has_value) {
                            __auto_type param = _mv_878.value;
                            {
                ...
                __auto_type lst = _mv_879.data.lst;
                {
                    ...
                    if ((len < 2)) {
                    ...
                    } else {
                        {
                            ...
                            __auto_type _mv_880 = ({ __auto_type _lst = items; size_t _idx = (size_t)name_idx; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_880.has_value) {
                                __auto_type name_expr = _mv_880.value;
                                __auto_type _mv_881 = (*name_expr);
                                switch (_mv_881.tag) {
                                    case types_SExpr_sym:
                                    {
                                        __auto_type name_sym = _mv_881.data.sym;
                                        __auto_type _mv_882 = ({ __auto_type _lst = items; size_t _idx = (size_t)type_idx; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_882.has_value) {
                                            __auto_type type_expr = _mv_882.value;
                                            {
...
uint8_t defn_is_param_mode(slop_list_types_SExpr_ptr items) {
    if ((((int64_t)((items).len)) < 1)) {
        ...
        __auto_type _mv_883 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        if (_mv_883.has_value) {
            __auto_type first = _mv_883.value;
            __auto_type _mv_884 = (*first);
            switch (_mv_884.tag) {
                case types_SExpr_sym:
                {
            ...
            __auto_type lst = _mv_885.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    if (_mv_886.has_value) {
                        __auto_type first = _mv_886.value;
                        __auto_type _mv_887 = (*first);
                        switch (_mv_887.tag) {
                            case types_SExpr_sym:
                            {
                    ...
                    } else {
                        {
                            ...
                            if ((len == 2)) {
                                ...
                                if (_mv_889.has_value) {
                                    __auto_type args_expr = _mv_889.value;
                                    {
...
slop_string defn_build_fn_args_str_for_param(context_TranspileContext* ctx, types_SExpr* args_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_890 = (*args_expr);
        switch (_mv_890.tag) {
            case types_SExpr_lst:
            {
                __auto_type args_list = _mv_890.data.lst;
                {
                    ...
                    if ((arg_count == 0)) {
                    ...
                    } else {
                        {
                            ...
                            __auto_type i = 0;
                            while ((i < arg_count)) {
                                __auto_type _mv_891 = ({ __auto_type _lst = arg_items; size_t _idx = (size_t)i; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_891.has_value) {
                                    __auto_type arg_expr = _mv_891.value;
                                    {
...
uint8_t defn_is_c_name_attr(types_SExpr* expr) {
    SLOP_PRE(((expr != NULL)), "(!= expr nil)");
    __auto_type _mv_893 = (*expr);
    switch (_mv_893.tag) {
        case types_SExpr_sym:
        {
            __auto_type sym = _mv_893.data.sym;
...
uint8_t defn_is_c_name_attr_at(slop_list_types_SExpr_ptr items, int64_t idx) {
    __auto_type _mv_895 = ({ __auto_type _lst = items; size_t _idx = (size_t)idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    if (_mv_895.has_value) {
        __auto_type item = _mv_895.value;
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_897.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    __auto_type _mv_898 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_898.has_value) {
                        __auto_type head = _mv_898.value;
                        __auto_type _mv_899 = (*head);
                        switch (_mv_899.tag) {
                            case types_SExpr_sym:
                            {
                                ...
                                {
                                    __auto_type name = sym.name;
                                    return ((string_eq(name, SLOP_STR("@intent"))) || (string_eq(name, SLOP_STR("@spec"))) || (string_eq(name, SLOP_STR("@pre"))) || (string_eq(name, SLOP_STR("@post"))) || (string_eq(name, SLOP_STR("@assume"))) || (string_eq(name, SLOP_STR("@alloc"))) || (string_eq(name, SLOP_STR("@example"))) || (string_eq(name, SLOP_STR("@pure"))) || (string_eq(name, SLOP_STR("@doc"))));
                                }
                            }
                            default: {
                                return 0;
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_900.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    __auto_type _mv_901 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_901.has_value) {
                        __auto_type head = _mv_901.value;
                        __auto_type _mv_902 = (*head);
                        switch (_mv_902.tag) {
                            case types_SExpr_sym:
                            {
                                __auto_type sym = _mv_902.data.sym;
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_903.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    __auto_type _mv_904 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_904.has_value) {
                        __auto_type head = _mv_904.value;
                        __auto_type _mv_905 = (*head);
                        switch (_mv_905.tag) {
                            case types_SExpr_sym:
                            {
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_906.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    __auto_type _mv_907 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_907.has_value) {
                        __auto_type head = _mv_907.value;
                        __auto_type _mv_908 = (*head);
                        switch (_mv_908.tag) {
                            case types_SExpr_sym:
                            {
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_909.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    __auto_type _mv_910 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        switch (_mv_912.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_912.data.lst;
                {
                    __auto_type items = lst.items;
                    if ((((int64_t)((items).len)) >= 2)) {
                        __auto_type _mv_913 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_913.has_value) {
                            __auto_type val = _mv_913.value;
                            __auto_type _mv_914 = (*val);
                            switch (_mv_914.tag) {
                                case types_SExpr_str:
                                {
                                    __auto_type str = _mv_914.data.str;
        ...
        switch (_mv_916.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_916.data.lst;
                {
                    __auto_type items = lst.items;
                    if ((((int64_t)((items).len)) >= 2)) {
                        __auto_type _mv_917 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_917.has_value) {
                            __auto_type val = _mv_917.value;
...
slop_list_types_SExpr_ptr defn_collect_preconditions(slop_arena* arena, slop_list_types_SExpr_ptr items) {
    {
        ...
        __auto_type i = 3;
        while ((i < len)) {
            __auto_type _mv_918 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_918.has_value) {
                __auto_type item = _mv_918.value;
                if (defn_is_pre_form(item)) {
                    __auto_type _mv_919 = defn_get_annotation_condition(item);
                    if (_mv_919.has_value) {
                        __auto_type cond = _mv_919.value;
...
slop_list_types_SExpr_ptr defn_collect_postconditions(slop_arena* arena, slop_list_types_SExpr_ptr items) {
    {
        ...
        __auto_type i = 3;
        while ((i < len)) {
            __auto_type _mv_920 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_920.has_value) {
                __auto_type item = _mv_920.value;
                if (defn_is_post_form(item)) {
                    __auto_type _mv_921 = defn_get_annotation_condition(item);
                    if (_mv_921.has_value) {
                        __auto_type cond = _mv_921.value;
                        ({ __auto_type _lst_p = &(result); __auto_type _item = (cond); if (_lst_p->len >= _lst_p->cap) { size_t _new_cap = _lst_p->cap == 0 ? 16 : _lst_p->cap * 2; __typeof__(_lst_p->data) _new_data = (__typeof__(_lst_p->data))slop_arena_alloc(arena, _new_cap * sizeof(*_lst_p->data)); if (_lst_p->len > 0) memcpy(_new_data, _lst_p->data, _lst_p->len * sizeof(*_lst_p->data)); _lst_p->data = _new_data; _lst_p->cap = _new_cap; } _lst_p->data[_lst_p->len++] = _item; (void)0; });
...
slop_list_types_SExpr_ptr defn_collect_assumptions(slop_arena* arena, slop_list_types_SExpr_ptr items) {
    {
        ...
        __auto_type i = 3;
        while ((i < len)) {
            __auto_type _mv_922 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_922.has_value) {
                __auto_type item = _mv_922.value;
                if (defn_is_assume_form(item)) {
                    __auto_type _mv_923 = defn_get_annotation_condition(item);
                    if (_mv_923.has_value) {
                        __auto_type cond = _mv_923.value;
                        ({ __auto_type _lst_p = &(result); __auto_type _item = (cond); if (_lst_p->len >= _lst_p->cap) { size_t _new_cap = _lst_p->cap == 0 ? 16 : _lst_p->cap * 2; __typeof__(_lst_p->data) _new_data = (__typeof__(_lst_p->data))slop_arena_alloc(arena, _new_cap * sizeof(*_lst_p->data)); if (_lst_p->len > 0) memcpy(_new_data, _lst_p->data, _lst_p->len * sizeof(*_lst_p->data)); _lst_p->data = _new_data; _lst_p->cap = _new_cap; } _lst_p->data[_lst_p->len++] = _item; (void)0; });
...
void defn_emit_preconditions(context_TranspileContext* ctx, slop_list_types_SExpr_ptr preconditions) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        __auto_type i = 0;
        while ((i < len)) {
            __auto_type _mv_925 = ({ __auto_type _lst = preconditions; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_925.has_value) {
                __auto_type cond_expr = _mv_925.value;
                {
...
void defn_emit_postconditions(context_TranspileContext* ctx, slop_list_types_SExpr_ptr postconditions) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        __auto_type i = 0;
        while ((i < len)) {
            __auto_type _mv_926 = ({ __auto_type _lst = postconditions; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void defn_emit_assumptions(context_TranspileContext* ctx, slop_list_types_SExpr_ptr assumptions) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        __auto_type i = 0;
        while ((i < len)) {
            __auto_type _mv_927 = ({ __auto_type _lst = assumptions; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_927.has_value) {
                __auto_type cond_expr = _mv_927.value;
                {
                    __auto_type cond_c_raw = expr_transpile_expr(ctx, cond_expr);
                    __auto_type cond_c = strlib_replace(arena, strlib_replace(arena, cond_c_raw, SLOP_STR("_result"), SLOP_STR("_retval")), SLOP_STR("$result"), SLOP_STR("_retval"));
                    __auto_type expr_str = parser_pretty_print(arena, cond_expr);
