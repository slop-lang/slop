                    ...
                    case types_SExpr_lst:
                    {
                        __auto_type lst = _mv_949.data.lst;
                        {
                            ...
                            if (((int64_t)((sub_items).len)) > 0) {
                                __auto_type _mv_950 = ({ __auto_type _lst = sub_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    ...
                                    __auto_type name_sym = _mv_957.data.sym;
                                    {
                                        ...
                                        if (_mv_958.has_value) {
                                            __auto_type type_expr = _mv_958.value;
                                            {
                                                ...
                                                __auto_type _mv_959 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        if (ctype_is_int_type(type_name)) {
        ...
        } else {
            {
                ...
                if (string_eq(type_name, SLOP_STR("String"))) {
                    __auto_type _mv_960 = (*value_expr);
                    switch (_mv_960.tag) {
                        case types_SExpr_str:
                        {
                            __auto_type str = _mv_960.data.str;
...
slop_string defn_eval_const_value(context_TranspileContext* ctx, types_SExpr* expr) {
    ...
    SLOP_PRE(((expr != NULL)), "(!= expr nil)");
    {
        ...
        switch (_mv_962.tag) {
            ...
            case types_SExpr_str:
            {
                __auto_type str = _mv_962.data.str;
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_963.data.lst;
                {
                    ...
                    __auto_type len = ((int64_t)((items).len));
                    {
                        ...
                        if (len >= (name_idx + 1)) {
                            __auto_type _mv_964 = ({ __auto_type _lst = items; size_t _idx = (size_t)name_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
uint8_t defn_is_string_expr(slop_list_types_SExpr_ptr items, int64_t idx) {
    __auto_type _mv_966 = ({ __auto_type _lst = items; size_t _idx = (size_t)idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    if (_mv_966.has_value) {
        ...
        switch (_mv_967.tag) {
            case types_SExpr_str:
            {
                __auto_type _ = _mv_967.data.str;
                return 1;
            }
            default: {
                return 0;
                ...
                __auto_type lst = _mv_968.data.lst;
                {
                    ...
                    if (len < 3) {
                        ...
                        if (_mv_969.has_value) {
                            __auto_type name_expr = _mv_969.value;
                            __auto_type _mv_970 = (*name_expr);
                            switch (_mv_970.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_970.data.sym;
                                    {
                                        __auto_type raw_name = name_sym.name;
                                        __auto_type base_name = ctype_to_c_name(arena, raw_name);
                                        ...
                                        if (_mv_971.has_value) {
                                            __auto_type type_def = _mv_971.value;
...
void defn_dispatch_type_def(context_TranspileContext* ctx, slop_string raw_name, slop_string qualified_name, types_SExpr* type_def) {
    ...
    __auto_type _mv_972 = (*type_def);
    switch (_mv_972.tag) {
        case types_SExpr_lst:
        {
            __auto_type def_lst = _mv_972.data.lst;
            {
        ...
        while ((i < len) && !(found)) {
            ...
            if (_mv_975.has_value) {
                ...
                switch (_mv_976.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type _ = _mv_976.data.lst;
                        found = 1;
                        break;
                    }
                    default: {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_978.has_value) {
                __auto_type field_expr = _mv_978.value;
...
void defn_emit_record_field(context_TranspileContext* ctx, slop_string raw_type_name, slop_string qualified_type_name, types_SExpr* field) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_979 = (*field);
        switch (_mv_979.tag) {
            case types_SExpr_lst:
            {
                __auto_type field_lst = _mv_979.data.lst;
                {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_984.has_value) {
                __auto_type val_expr = _mv_984.value;
                __auto_type _mv_985 = (*val_expr);
                switch (_mv_985.tag) {
                    case types_SExpr_sym:
                    {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_997.has_value) {
                __auto_type variant_expr = _mv_997.value;
                __auto_type _mv_998 = (*variant_expr);
                switch (_mv_998.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type var_lst = _mv_998.data.lst;
                        {
                            __auto_type var_items = var_lst.items;
                            __auto_type var_len = ((int64_t)((var_items).len));
                            if (var_len >= 2) {
                                __auto_type _mv_999 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_999.has_value) {
                                    __auto_type tag_expr = _mv_999.value;
                                    __auto_type _mv_1000 = (*tag_expr);
                                    switch (_mv_1000.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type tag_sym = _mv_1000.data.sym;
                                            {
                                                __auto_type tag_name = tag_sym.name;
                                                if (var_len == 2) {
                                                    __auto_type _mv_1001 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    ...
                                                    for (int64_t fi = 1; fi < var_len; fi++) {
                                                        __auto_type _mv_1002 = ({ __auto_type _lst = var_items; size_t _idx = (size_t)fi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                ...
                __auto_type lst = _mv_1007.data.lst;
                {
                    ...
                    if (len < 3) {
                        ...
                        if (_mv_1008.has_value) {
                            __auto_type elem_type_expr = _mv_1008.value;
                            __auto_type _mv_1009 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_1009.has_value) {
                                __auto_type size_expr = _mv_1009.value;
                                {
...
slop_string defn_get_number_as_string(types_SExpr* expr) {
    ...
    switch (_mv_1010.tag) {
        case types_SExpr_num:
        {
            __auto_type num = _mv_1010.data.num;
            return num.raw;
        }
        default: {
            return SLOP_STR("0");
                    ...
                    while (i < len) {
                        ...
                        if (_mv_1015.has_value) {
                            ...
                            switch (_mv_1016.tag) {
                                case types_SExpr_num:
                                {
                                    __auto_type num = _mv_1016.data.num;
                                    if (!(found_dots)) {
                            ...
                            switch (_mv_1019.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_1019.data.sym;
                                    {
                                        ...
                                        __auto_type _mv_1020 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_1020.has_value) {
                                            __auto_type params_expr = _mv_1020.value;
                    ...
                    if (len >= 2) {
                        {
                            ...
                            __auto_type _mv_1026 = ({ __auto_type _lst = items; size_t _idx = (size_t)name_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_1026.has_value) {
                                ...
                                switch (_mv_1027.tag) {
                                    case types_SExpr_sym:
                                    {
                                        ...
                                        __auto_type _mv_1028 = ({ __auto_type _lst = items; size_t _idx = (size_t)type_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_list_context_FuncParamType_ptr defn_collect_param_types(context_TranspileContext* ctx, types_SExpr* params_expr) {
    ...
    SLOP_PRE(((params_expr != NULL)), "(!= params-expr nil)");
    {
        ...
        __auto_type _mv_1032 = (*params_expr);
        switch (_mv_1032.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1032.data.lst;
                {
                    ...
                    while (i < len) {
                        ...
                        if (_mv_1033.has_value) {
                            __auto_type param = _mv_1033.value;
                            {
                ...
                __auto_type lst = _mv_1034.data.lst;
                {
                    ...
                    if (len < 2) {
                    ...
                    } else {
                        {
                            __auto_type has_mode = ((len >= 3) && defn_is_param_mode(items));
                            __auto_type type_idx = ((has_mode) ? 2 : 1);
                            __auto_type _mv_1035 = ({ __auto_type _lst = items; size_t _idx = (size_t)type_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    ...
                    if (len >= 3) {
                        ...
                        if (_mv_1037.has_value) {
                            ...
                            switch (_mv_1038.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_1038.data.sym;
                                    {
                                        __auto_type raw_name = name_sym.name;
                                        __auto_type base_name = ctype_to_c_name(arena, raw_name);
                                        ...
                                        if (_mv_1039.has_value) {
                                            __auto_type params_expr = _mv_1039.value;
                                            {
                                                __auto_type result_type_opt = defn_get_result_type_name(ctx, items);
                                                __auto_type raw_return = defn_get_return_type(ctx, items);
                                                {
...
slop_string defn_extract_spec_slop_return_type(context_TranspileContext* ctx, types_SExpr* spec_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1048 = (*spec_expr);
        switch (_mv_1048.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1048.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) < 2) {
                        ...
                        if (_mv_1049.has_value) {
                            __auto_type spec_body = _mv_1049.value;
                            __auto_type _mv_1050 = (*spec_body);
                            switch (_mv_1050.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type body_lst = _mv_1050.data.lst;
                                    {
                                        __auto_type body_items = body_lst.items;
                                        __auto_type body_len = ((int64_t)((body_items).len));
                                        if (body_len < 1) {
                                            ...
                                            __auto_type _mv_1051 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)(body_len - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_1051.has_value) {
                                                __auto_type ret_type = _mv_1051.value;
...
slop_option_string defn_extract_result_type_name(context_TranspileContext* ctx, types_SExpr* spec_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1054 = (*spec_expr);
        switch (_mv_1054.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1054.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) < 2) {
                        ...
                        if (_mv_1055.has_value) {
                            __auto_type spec_body = _mv_1055.value;
                            __auto_type _mv_1056 = (*spec_body);
                            switch (_mv_1056.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type body_lst = _mv_1056.data.lst;
                                    {
                                        __auto_type body_items = body_lst.items;
                                        __auto_type body_len = ((int64_t)((body_items).len));
                                        if (body_len < 1) {
                                            ...
                                            __auto_type _mv_1057 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)(body_len - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_1057.has_value) {
                                                __auto_type ret_type = _mv_1057.value;
    ...
    SLOP_PRE(((type_expr != NULL)), "(!= type-expr nil)");
    {
        ...
        switch (_mv_1058.tag) {
            case types_SExpr_sym:
            {
                ...
                {
                    __auto_type type_name = sym.name;
                    __auto_type _mv_1059 = context_ctx_lookup_result_type_alias(ctx, type_name);
                    if (_mv_1059.has_value) {
                        __auto_type alias_result = _mv_1059.value;
                        return (slop_option_string){.has_value = 1, .value = alias_result};
                    } else if (!_mv_1059.has_value) {
                        __auto_type _mv_1060 = context_ctx_lookup_type(ctx, type_name);
                        if (_mv_1060.has_value) {
                            __auto_type entry = _mv_1060.value;
                                ...
                                case types_SExpr_sym:
                                {
                                    ...
                                    if (string_eq(sym.name, SLOP_STR("Result"))) {
                                        ...
                                        if (_mv_1063.has_value) {
                                            __auto_type ok_type_expr = _mv_1063.value;
                                            ...
                                            if (_mv_1064.has_value) {
                                                __auto_type err_type_expr = _mv_1064.value;
                                                {
...
slop_string defn_build_param_str(context_TranspileContext* ctx, types_SExpr* params_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1065 = (*params_expr);
        switch (_mv_1065.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1065.data.lst;
                {
                    ...
                    while (i < len) {
                        ...
                        if (_mv_1066.has_value) {
                            __auto_type param = _mv_1066.value;
                            {
                ...
                __auto_type lst = _mv_1067.data.lst;
                {
                    ...
                    if (len < 2) {
                    ...
                    } else {
                        {
                            ...
                            __auto_type _mv_1068 = ({ __auto_type _lst = items; size_t _idx = (size_t)name_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
uint8_t defn_is_param_mode(slop_list_types_SExpr_ptr items) {
    if (((int64_t)((items).len)) < 1) {
        ...
        if (_mv_1071.has_value) {
            __auto_type first = _mv_1071.value;
            __auto_type _mv_1072 = (*first);
            switch (_mv_1072.tag) {
                case types_SExpr_sym:
                {
                    ...
                    } else {
                        {
                            ...
                            if (len == 2) {
                                ...
                                if (_mv_1077.has_value) {
                                    __auto_type args_expr = _mv_1077.value;
                                    {
...
slop_string defn_build_fn_args_str_for_param(context_TranspileContext* ctx, types_SExpr* args_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1078 = (*args_expr);
        switch (_mv_1078.tag) {
            case types_SExpr_lst:
            {
                __auto_type args_list = _mv_1078.data.lst;
                {
                    ...
                    if (arg_count == 0) {
                    ...
                    } else {
                        {
                            ...
                            __auto_type i = 0;
                            while (i < arg_count) {
                                __auto_type _mv_1079 = ({ __auto_type _lst = arg_items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1079.has_value) {
                                    __auto_type arg_expr = _mv_1079.value;
                                    {
...
uint8_t defn_is_c_name_attr_at(slop_list_types_SExpr_ptr items, int64_t idx) {
    __auto_type _mv_1083 = ({ __auto_type _lst = items; size_t _idx = (size_t)idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                ...
                __auto_type lst = _mv_1104.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) >= 2) {
                        ...
                        if (_mv_1105.has_value) {
                            ...
                            __auto_type _mv_1106 = (*val);
                            switch (_mv_1106.tag) {
                                case types_SExpr_str:
                                {
                                    __auto_type str = _mv_1106.data.str;
                ...
                __auto_type lst = _mv_1108.data.lst;
                {
                    ...
                    if (((int64_t)((items).len)) >= 2) {
                        ...
                        if (_mv_1109.has_value) {
                            __auto_type val = _mv_1109.value;
        ...
        while (i < len) {
            ...
            if (_mv_1112.has_value) {
                ...
                if (defn_is_post_form(item)) {
                    __auto_type _mv_1113 = defn_get_annotation_condition(item);
                    if (_mv_1113.has_value) {
                        __auto_type cond = _mv_1113.value;
                        ({ __auto_type _lst_p = &(result); __auto_type _item = (cond); if (_lst_p->len >= _lst_p->cap) { size_t _new_cap = _lst_p->cap == 0 ? 16 : _lst_p->cap * 2; __typeof__(_lst_p->data) _new_data = (__typeof__(_lst_p->data))slop_arena_alloc(arena, _new_cap * sizeof(*_lst_p->data)); if (_lst_p->len > 0) memcpy(_new_data, _lst_p->data, _lst_p->len * sizeof(*_lst_p->data)); _lst_p->data = _new_data; _lst_p->cap = _new_cap; } _lst_p->data[_lst_p->len++] = _item; (void)0; });
        ...
        while (i < len) {
            ...
            if (_mv_1114.has_value) {
                ...
                if (defn_is_assume_form(item)) {
                    __auto_type _mv_1115 = defn_get_annotation_condition(item);
                    if (_mv_1115.has_value) {
                        __auto_type cond = _mv_1115.value;
                        ({ __auto_type _lst_p = &(result); __auto_type _item = (cond); if (_lst_p->len >= _lst_p->cap) { size_t _new_cap = _lst_p->cap == 0 ? 16 : _lst_p->cap * 2; __typeof__(_lst_p->data) _new_data = (__typeof__(_lst_p->data))slop_arena_alloc(arena, _new_cap * sizeof(*_lst_p->data)); if (_lst_p->len > 0) memcpy(_new_data, _lst_p->data, _lst_p->len * sizeof(*_lst_p->data)); _lst_p->data = _new_data; _lst_p->cap = _new_cap; } _lst_p->data[_lst_p->len++] = _item; (void)0; });
...
void defn_emit_preconditions(context_TranspileContext* ctx, slop_list_types_SExpr_ptr preconditions) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1117 = ({ __auto_type _lst = preconditions; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1117.has_value) {
                __auto_type cond_expr = _mv_1117.value;
                {
...
void defn_emit_postconditions(context_TranspileContext* ctx, slop_list_types_SExpr_ptr postconditions) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1118 = ({ __auto_type _lst = postconditions; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1118.has_value) {
                __auto_type cond_expr = _mv_1118.value;
...
void defn_emit_assumptions(context_TranspileContext* ctx, slop_list_types_SExpr_ptr assumptions) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1119 = ({ __auto_type _lst = assumptions; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1119.has_value) {
                __auto_type cond_expr = _mv_1119.value;
                if (!(defn_is_verification_only_expr(cond_expr))) {
                    {
                        __auto_type cond_c = expr_transpile_expr(ctx, cond_expr);
                        __auto_type expr_str = parser_pretty_print(arena, cond_expr);
