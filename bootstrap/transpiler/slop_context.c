...
void context_ctx_warn_fallback(context_TranspileContext* ctx, types_SExpr* expr, slop_string desc) {
    {
        ...
        __auto_type _mv_48 = mod_name;
        if (_mv_48.has_value) {
            __auto_type m = _mv_48.value;
...
int64_t context_ctx_report_errors(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < count)) {
            __auto_type _mv_49 = ({ __auto_type _lst = errors; size_t _idx = (size_t)i; slop_option_context_TranspileError _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_49.has_value) {
                __auto_type err = _mv_49.value;
...
uint8_t context_ctx_has_warnings(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    return (((int64_t)(((*ctx).warnings).len)) > 0);
}

int64_t context_ctx_report_warnings(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        __auto_type warns = (*ctx).warnings;
        __auto_type count = ((int64_t)((warns).len));
        __auto_type arena = (*ctx).arena;
        __auto_type current_file = (*ctx).current_file;
        int64_t i = 0;
        while ((i < count)) {
            __auto_type _mv_50 = ({ __auto_type _lst = warns; size_t _idx = (size_t)i; slop_option_context_TranspileError _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_50.has_value) {
                __auto_type err = _mv_50.value;
...
int64_t context_ctx_list_first_col(slop_list_types_SExpr_ptr items) {
    __auto_type _mv_54 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    if (_mv_54.has_value) {
        __auto_type first_expr = _mv_54.value;
...
void context_ctx_pop_scope(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    __auto_type _mv_55 = (*(*ctx).scope).parent;
    if (_mv_55.has_value) {
        __auto_type parent_scope = _mv_55.value;
    ...
    if ((scope == NULL)) {
    ...
    } else {
        {
            ...
            while (((i < len) && ({ __auto_type _mv = result; _mv.has_value ? ({ __auto_type _ = _mv.value; 0; }) : (1); }))) {
                __auto_type _mv_56 = ({ __auto_type _lst = (*scope).vars; size_t _idx = (size_t)i; slop_option_context_VarEntry _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_56.has_value) {
...
slop_option_context_VarEntry context_lookup_var_in_scope_chain(context_Scope* scope, slop_string name) {
    if ((scope == NULL)) {
    ...
    } else {
        {
            ...
            __auto_type _mv_57 = result;
            if (_mv_57.has_value) {
                __auto_type _ = _mv_57.value;
                return result;
            } else if (!_mv_57.has_value) {
                __auto_type _mv_58 = (*scope).parent;
                if (_mv_58.has_value) {
                    __auto_type parent_scope = _mv_58.value;
...
slop_option_context_VarEntry context_find_arena_in_single_scope(context_Scope* scope) {
    if ((scope == NULL)) {
    ...
    } else {
        {
            ...
            slop_option_context_VarEntry result = (slop_option_context_VarEntry){.has_value = false};
            while (((i < len) && ({ __auto_type _mv = result; _mv.has_value ? ({ __auto_type _ = _mv.value; 0; }) : (1); }))) {
                __auto_type _mv_59 = ({ __auto_type _lst = (*scope).vars; size_t _idx = (size_t)i; slop_option_context_VarEntry _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_59.has_value) {
...
slop_option_context_VarEntry context_find_arena_in_scope_chain(context_Scope* scope) {
    if ((scope == NULL)) {
    ...
    } else {
        {
            ...
            __auto_type _mv_60 = result;
            if (_mv_60.has_value) {
                __auto_type _ = _mv_60.value;
                return result;
            } else if (!_mv_60.has_value) {
                __auto_type _mv_61 = (*scope).parent;
                if (_mv_61.has_value) {
                    __auto_type parent_scope = _mv_61.value;
        ...
        if ((len > 0)) {
            {
                ...
                while (((i >= 0) && ({ __auto_type _mv = result; _mv.has_value ? ({ __auto_type _ = _mv.value; 0; }) : (1); }))) {
                    __auto_type _mv_62 = ({ __auto_type _lst = types; size_t _idx = (size_t)((int64_t)(i)); slop_option_context_TypeEntry _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_62.has_value) {
...
slop_option_context_FuncEntry context_ctx_lookup_func(context_TranspileContext* ctx, slop_string name) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = (len - 1);
        __auto_type skip_c_name = (*ctx).current_fn_c_name;
        __auto_type has_skip = (string_len(skip_c_name) > 0);
        ...
        while (((i >= 0) && ({ __auto_type _mv = result; _mv.has_value ? ({ __auto_type _ = _mv.value; 0; }) : (1); }))) {
            __auto_type _mv_63 = ({ __auto_type _lst = funcs; size_t _idx = (size_t)i; slop_option_context_FuncEntry _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_63.has_value) {
...
slop_option_string context_ctx_lookup_field_type(context_TranspileContext* ctx, slop_string type_name, slop_string field_name) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (((i < len) && ({ __auto_type _mv = result; _mv.has_value ? ({ __auto_type _ = _mv.value; 0; }) : (1); }))) {
            __auto_type _mv_65 = ({ __auto_type _lst = fields; size_t _idx = (size_t)i; slop_option_context_FieldEntry _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_65.has_value) {
        ...
        if (({ __auto_type _mv = result; _mv.has_value ? ({ __auto_type _ = _mv.value; 0; }) : (1); })) {
            {
                ...
                if (!(string_eq(stripped, type_name))) {
                    i = 0;
                    while (((i < len) && ({ __auto_type _mv = result; _mv.has_value ? ({ __auto_type _ = _mv.value; 0; }) : (1); }))) {
                        __auto_type _mv_66 = ({ __auto_type _lst = fields; size_t _idx = (size_t)i; slop_option_context_FieldEntry _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_66.has_value) {
...
slop_option_string context_ctx_lookup_field_slop_type(context_TranspileContext* ctx, slop_string type_name, slop_string field_name) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        slop_option_string result = (slop_option_string){.has_value = false};
        while (((i < len) && ({ __auto_type _mv = result; _mv.has_value ? ({ __auto_type _ = _mv.value; 0; }) : (1); }))) {
            __auto_type _mv_68 = ({ __auto_type _lst = fields; size_t _idx = (size_t)i; slop_option_context_FieldEntry _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_68.has_value) {
        ...
        if (({ __auto_type _mv = result; _mv.has_value ? ({ __auto_type _ = _mv.value; 0; }) : (1); })) {
            {
                ...
                if (!(string_eq(stripped, type_name))) {
                    i = 0;
                    while (((i < len) && ({ __auto_type _mv = result; _mv.has_value ? ({ __auto_type _ = _mv.value; 0; }) : (1); }))) {
                        __auto_type _mv_69 = ({ __auto_type _lst = fields; size_t _idx = (size_t)i; slop_option_context_FieldEntry _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_69.has_value) {
...
slop_option_string context_ctx_lookup_field_type_by_index(context_TranspileContext* ctx, slop_string type_name, int64_t index) {
    ...
    SLOP_PRE(((index >= 0)), "(>= index 0)");
    {
        ...
        slop_option_string result = (slop_option_string){.has_value = false};
        while (((i < len) && ({ __auto_type _mv = result; _mv.has_value ? ({ __auto_type _ = _mv.value; 0; }) : (1); }))) {
            __auto_type _mv_70 = ({ __auto_type _lst = fields; size_t _idx = (size_t)i; slop_option_context_FieldEntry _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_70.has_value) {
...
slop_list_context_FieldEntry context_ctx_get_fields_for_type(context_TranspileContext* ctx, slop_string type_name) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_71 = ({ __auto_type _lst = all_fields; size_t _idx = (size_t)i; slop_option_context_FieldEntry _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_71.has_value) {
...
uint8_t context_ctx_is_pointer_var(context_TranspileContext* ctx, slop_string name) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        uint8_t found = 0;
        while (((i < len) && !(found))) {
            __auto_type _mv_72 = ({ __auto_type _lst = vars; size_t _idx = (size_t)i; slop_option_string _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_72.has_value) {
...
void context_ctx_add_include(context_TranspileContext* ctx, slop_string header) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        uint8_t found = 0;
        while (((i < len) && !(found))) {
            __auto_type _mv_74 = ({ __auto_type _lst = (*ctx).includes; size_t _idx = (size_t)i; slop_option_string _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_74.has_value) {
...
uint8_t context_ctx_is_type_emitted(context_TranspileContext* ctx, slop_string type_name) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        uint8_t found = 0;
        while (((i < len) && !(found))) {
            __auto_type _mv_75 = ({ __auto_type _lst = types; size_t _idx = (size_t)i; slop_option_string _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_75.has_value) {
...
slop_option_string context_ctx_lookup_enum_variant(context_TranspileContext* ctx, slop_string variant_name) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        slop_option_string result = (slop_option_string){.has_value = false};
        while (((i < len) && ({ __auto_type _mv = result; _mv.has_value ? ({ __auto_type _ = _mv.value; 0; }) : (1); }))) {
            __auto_type _mv_76 = ({ __auto_type _lst = variants; size_t _idx = (size_t)i; slop_option_context_EnumVariant _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_76.has_value) {
...
slop_list_context_UnionVariantEntry context_ctx_get_union_variants(context_TranspileContext* ctx, slop_string union_name) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_77 = ({ __auto_type _lst = all_variants; size_t _idx = (size_t)i; slop_option_context_UnionVariantEntry _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_77.has_value) {
...
uint8_t context_ctx_has_result_type(context_TranspileContext* ctx, slop_string c_name) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        uint8_t found = 0;
        while (((i < len) && !(found))) {
            __auto_type _mv_78 = ({ __auto_type _lst = types; size_t _idx = (size_t)i; slop_option_context_ResultType _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_78.has_value) {
...
uint8_t context_ctx_has_option_type(context_TranspileContext* ctx, slop_string c_name) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        uint8_t found = 0;
        while (((i < len) && !(found))) {
            __auto_type _mv_79 = ({ __auto_type _lst = types; size_t _idx = (size_t)i; slop_option_context_OptionType _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_79.has_value) {
...
uint8_t context_ctx_has_list_type(context_TranspileContext* ctx, slop_string c_name) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        uint8_t found = 0;
        while (((i < len) && !(found))) {
            __auto_type _mv_80 = ({ __auto_type _lst = types; size_t _idx = (size_t)i; slop_option_context_ListType _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_80.has_value) {
...
uint8_t context_ctx_has_chan_type(context_TranspileContext* ctx, slop_string c_name) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        uint8_t found = 0;
        while (((i < len) && !(found))) {
            __auto_type _mv_81 = ({ __auto_type _lst = types; size_t _idx = (size_t)i; slop_option_context_ChanType _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_81.has_value) {
...
uint8_t context_ctx_has_thread_type(context_TranspileContext* ctx, slop_string c_name) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        uint8_t found = 0;
        while (((i < len) && !(found))) {
            __auto_type _mv_82 = ({ __auto_type _lst = types; size_t _idx = (size_t)i; slop_option_context_ThreadType _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_82.has_value) {
...
slop_option_string context_ctx_lookup_result_type_alias(context_TranspileContext* ctx, slop_string alias_name) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        slop_option_string result = (slop_option_string){.has_value = false};
        while (((i < len) && ({ __auto_type _mv = result; _mv.has_value ? ({ __auto_type _ = _mv.value; 0; }) : (1); }))) {
            __auto_type _mv_83 = ({ __auto_type _lst = aliases; size_t _idx = (size_t)i; slop_option_context_ResultTypeAlias _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_83.has_value) {
...
slop_string context_extract_fn_c_name(slop_arena* arena, slop_list_types_SExpr_ptr items, slop_string default_name) {
    {
        ...
        while ((i < len)) {
            __auto_type _mv_84 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_84.has_value) {
                ...
                switch (_mv_85.tag) {
                    case types_SExpr_sym:
                    {
                        ...
                        if (string_eq(sym.name, SLOP_STR(":c-name"))) {
                            __auto_type _mv_86 = ({ __auto_type _lst = items; size_t _idx = (size_t)(i + 1); slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_86.has_value) {
...
void context_ctx_add_import(context_TranspileContext* ctx, slop_string mod_name) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        uint8_t found = 0;
        while (((i < len) && !(found))) {
            __auto_type _mv_88 = ({ __auto_type _lst = imports; size_t _idx = (size_t)i; slop_option_string _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_88.has_value) {
...
void context_ctx_register_inline_record(context_TranspileContext* ctx, slop_string type_name, slop_string field_body) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        uint8_t found = 0;
        while (((i < len) && !(found))) {
            __auto_type _mv_89 = ({ __auto_type _lst = records; size_t _idx = (size_t)i; slop_option_context_InlineRecord _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_89.has_value) {
...
slop_option_string context_get_array_pointer_type(context_TranspileContext* ctx, types_SExpr* expr) {
    ...
    switch (_mv_92.tag) {
        case types_SExpr_sym:
        {
            __auto_type sym = _mv_92.data.sym;
            {
                __auto_type type_name = sym.name;
                __auto_type _mv_93 = context_ctx_lookup_type(ctx, type_name);
                if (_mv_93.has_value) {
...
slop_string context_to_c_type_prefixed_compound(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len >= 1)) {
            __auto_type _mv_94 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_94.has_value) {
                __auto_type first_expr = _mv_94.value;
                __auto_type _mv_95 = (*first_expr);
                switch (_mv_95.tag) {
                    case types_SExpr_sym:
                    {
                        __auto_type head_sym = _mv_95.data.sym;
                        {
                            ...
                            if (string_eq(head, SLOP_STR("Ptr"))) {
                                if ((len >= 2)) {
                                    ...
                                    if (_mv_96.has_value) {
                                        ...
                                        __auto_type _mv_97 = context_get_array_pointer_type(ctx, inner);
                                        if (_mv_97.has_value) {
                                            __auto_type ptr_type = _mv_97.value;
                                            result = ptr_type;
                            ...
                            } else if (string_eq(head, SLOP_STR("Result"))) {
                                {
                                    ...
                                    if ((len >= 2)) {
                                        __auto_type _mv_100 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_100.has_value) {
                                            __auto_type ok_expr = _mv_100.value;
                                            ok_id = ctype_type_to_identifier(arena, context_to_c_type_prefixed(ctx, ok_expr));
                                        } else if (!_mv_100.has_value) {
                                        }
                                    }
                                    if ((len >= 3)) {
                                        __auto_type _mv_101 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_101.has_value) {
                                            __auto_type err_expr = _mv_101.value;
                                ...
                                if ((len >= 2)) {
                                    __auto_type _mv_102 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                ...
                                if ((len >= 2)) {
                                    __auto_type _mv_103 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                ...
                                if ((len >= 2)) {
                                    __auto_type _mv_104 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            ...
                            } else if (string_eq(head, SLOP_STR("record"))) {
                                {
                                    ...
                                    __auto_type i = 1;
                                    while ((i < len)) {
                                        __auto_type _mv_106 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_106.has_value) {
                                            __auto_type field_expr = _mv_106.value;
                                            __auto_type _mv_107 = (*field_expr);
                                            switch (_mv_107.tag) {
                                                case types_SExpr_lst:
                                                {
                                                    __auto_type field_lst = _mv_107.data.lst;
                                                    {
                                                        __auto_type field_items = field_lst.items;
                                                        if ((((int64_t)((field_items).len)) >= 2)) {
                                                            __auto_type _mv_108 = ({ __auto_type _lst = field_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                            if (_mv_108.has_value) {
                                                                ...
                                                                switch (_mv_109.tag) {
                                                                    case types_SExpr_sym:
                                                                    {
                                                                        __auto_type name_sym = _mv_109.data.sym;
                                                                        __auto_type _mv_110 = ({ __auto_type _lst = field_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            ...
                            } else {
                                {
                                    ...
                                    if (ctype_is_builtin_c_type(base_c_type)) {
                                        ...
                                        __auto_type _mv_111 = context_ctx_lookup_type(ctx, head);
...
slop_string context_build_fn_args_str_prefixed(context_TranspileContext* ctx, types_SExpr* args_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_112 = (*args_expr);
        switch (_mv_112.tag) {
            case types_SExpr_lst:
            {
                __auto_type args_list = _mv_112.data.lst;
                {
                    ...
                    if ((arg_count == 0)) {
                    ...
                    } else {
                        {
                            ...
                            __auto_type i = 0;
                            while ((i < arg_count)) {
                                __auto_type _mv_113 = ({ __auto_type _lst = arg_items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_113.has_value) {
                                    __auto_type arg_expr = _mv_113.value;
                                    {
...
void context_ctx_register_struct_key_type(context_TranspileContext* ctx, slop_string c_type) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        uint8_t found = 0;
        while (((i < len) && !(found))) {
            __auto_type _mv_114 = ({ __auto_type _lst = types; size_t _idx = (size_t)i; slop_option_string _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_114.has_value) {
                __auto_type existing = _mv_114.value;
...
uint8_t context_ctx_has_struct_key_type(context_TranspileContext* ctx, slop_string c_type) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        uint8_t found = 0;
        while (((i < len) && !(found))) {
            __auto_type _mv_115 = ({ __auto_type _lst = types; size_t _idx = (size_t)i; slop_option_string _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_option_string context_ctx_lookup_type_alias(context_TranspileContext* ctx, slop_string name) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        slop_option_string result = (slop_option_string){.has_value = false};
        while (((i < len) && ({ __auto_type _mv = result; _mv.has_value ? ({ __auto_type _ = _mv.value; 0; }) : (1); }))) {
            __auto_type _mv_116 = ({ __auto_type _lst = aliases; size_t _idx = (size_t)i; slop_option_context_TypeAliasEntry _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
uint8_t context_ctx_has_trampoline(context_TranspileContext* ctx, slop_string fn_c_name) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        __auto_type trampolines = (*ctx).fn_trampolines;
        __auto_type len = ((int64_t)((trampolines).len));
        int64_t i = 0;
        uint8_t found = 0;
        while (((i < len) && !(found))) {
            __auto_type _mv_117 = ({ __auto_type _lst = trampolines; size_t _idx = (size_t)i; slop_option_string _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void context_ctx_set_single_output_mode(context_TranspileContext* ctx, uint8_t enabled) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    (*ctx).single_output_mode = enabled;
}

void context_ctx_set_skip_trampoline_generation(context_TranspileContext* ctx, uint8_t skip) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    (*ctx).skip_trampoline_generation = skip;
}

uint8_t context_ctx_skip_trampoline_generation(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    return (*ctx).skip_trampoline_generation;
}

void context_ctx_set_current_fn_c_name(context_TranspileContext* ctx, slop_string name) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    (*ctx).current_fn_c_name = name;
}
...
void context_ctx_flush_function_buffer(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < count)) {
            __auto_type _mv_118 = ({ __auto_type _lst = fn_output; size_t _idx = (size_t)i; slop_option_string _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_118.has_value) {
                __auto_type line = _mv_118.value;
...
uint8_t context_ctx_has_generic_instantiation(context_TranspileContext* ctx, slop_string fn_name, slop_string type_bindings) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        uint8_t found = 0;
        while (((i < len) && !(found))) {
            __auto_type _mv_119 = ({ __auto_type _lst = instances; size_t _idx = (size_t)i; slop_option_context_GenericFuncInstantiation _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_119.has_value) {
                __auto_type inst = _mv_119.value;
