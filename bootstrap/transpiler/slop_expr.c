        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_100.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 2)) {
                    ...
                    __auto_type _mv_101 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_101.has_value) {
                        __auto_type head = _mv_101.value;
                        __auto_type _mv_102 = (*head);
                        switch (_mv_102.tag) {
                            case types_SExpr_sym:
                            {
                                __auto_type head_sym = _mv_102.data.sym;
                                if (string_eq(head_sym.name, SLOP_STR("quote"))) {
                                    __auto_type _mv_103 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    if (_mv_103.has_value) {
                                        __auto_type inner = _mv_103.value;
                                        __auto_type _mv_104 = (*inner);
                                        switch (_mv_104.tag) {
                                            case types_SExpr_sym:
                                            {
                                                __auto_type inner_sym = _mv_104.data.sym;
...
slop_string expr_transpile_literal(context_TranspileContext* ctx, types_SExpr* expr) {
    ...
    switch (_mv_105.tag) {
        ...
        {
            __auto_type num = _mv_105.data.num;
            if (num.is_float) {
                return num.raw;
            } else {
                return num.raw;
        ...
        {
            __auto_type str = _mv_105.data.str;
        ...
        case types_SExpr_lst:
        {
            __auto_type _ = _mv_105.data.lst;
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (string_eq(name, SLOP_STR("true"))) {
        ...
        } else if (strlib_starts_with(name, SLOP_STR("'"))) {
            {
                ...
                __auto_type _mv_106 = context_ctx_lookup_enum_variant(ctx, variant_name);
                if (_mv_106.has_value) {
                    __auto_type enum_name = _mv_106.value;
            ...
            __auto_type _mv_107 = strlib_index_of(name, SLOP_STR("."));
            if (_mv_107.has_value) {
                __auto_type dot_pos = _mv_107.value;
                {
                    ...
                    __auto_type _mv_108 = context_ctx_lookup_var(ctx, base_name);
                    if (_mv_108.has_value) {
                        __auto_type var_entry = _mv_108.value;
                        {
                        ...
                        __auto_type _mv_109 = context_ctx_lookup_type(ctx, base_name);
                        if (_mv_109.has_value) {
                            __auto_type type_info = _mv_109.value;
            ...
            __auto_type _mv_110 = context_ctx_lookup_var(ctx, name);
            if (_mv_110.has_value) {
                __auto_type entry = _mv_110.value;
                return entry.c_name;
            } else if (!_mv_110.has_value) {
                __auto_type _mv_111 = context_ctx_lookup_enum_variant(ctx, name);
                if (_mv_111.has_value) {
                    __auto_type enum_name = _mv_111.value;
                ...
                } else if (!_mv_111.has_value) {
                    {
                        ...
                        __auto_type _mv_112 = context_ctx_lookup_func(ctx, name);
                        if (_mv_112.has_value) {
                            __auto_type func_entry = _mv_112.value;
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len <= (start_idx + 1))) {
        ...
        } else {
            {
                ...
                __auto_type _mv_113 = ({ __auto_type _lst = items; size_t _idx = (size_t)start_idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_113.has_value) {
                    __auto_type first_arg = _mv_113.value;
                ...
                }
                {
                    ...
                    while ((i < len)) {
                        __auto_type _mv_114 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_114.has_value) {
                            __auto_type arg = _mv_114.value;
                            {
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_115.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    __auto_type _mv_116 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_116.has_value) {
                        __auto_type head = _mv_116.value;
                        __auto_type _mv_117 = (*head);
                        switch (_mv_117.tag) {
                            case types_SExpr_sym:
                            {
...
uint8_t expr_is_string_literal(types_SExpr* expr) {
    ...
    switch (_mv_118.tag) {
        case types_SExpr_str:
        {
            __auto_type _ = _mv_118.data.str;
            return 1;
        }
        default: {
            return 0;
        ...
        __auto_type arena = (*ctx).arena;
        {
            ...
            if ((string_len(runtime_name) > 0)) {
            ...
            } else {
                {
                    ...
                    __auto_type _mv_119 = context_ctx_lookup_var(ctx, fn_name);
                    if (_mv_119.has_value) {
                        __auto_type var_entry = _mv_119.value;
...
slop_string expr_transpile_ok(context_TranspileContext* ctx, slop_string value_c) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    __auto_type _mv_121 = context_ctx_get_current_result_type(ctx);
    if (_mv_121.has_value) {
        __auto_type result_type = _mv_121.value;
...
slop_string expr_transpile_error(context_TranspileContext* ctx, slop_string value_c) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    __auto_type _mv_122 = context_ctx_get_current_result_type(ctx);
    if (_mv_122.has_value) {
        __auto_type result_type = _mv_122.value;
...
slop_string expr_infer_option_type(context_TranspileContext* ctx, types_SExpr* val_expr) {
    ...
    __auto_type _mv_123 = (*val_expr);
    switch (_mv_123.tag) {
        case types_SExpr_num:
        {
            __auto_type num = _mv_123.data.num;
            if (num.is_float) {
        ...
        case types_SExpr_str:
        {
            __auto_type _ = _mv_123.data.str;
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_123.data.lst;
...
slop_string expr_c_type_to_option_type_name(context_TranspileContext* ctx, slop_string c_type) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        if (string_eq(c_type, SLOP_STR("int64_t"))) {
            return SLOP_STR("slop_option_int");
        } else if (string_eq(c_type, SLOP_STR("double"))) {
            return SLOP_STR("slop_option_double");
        } else if (string_eq(c_type, SLOP_STR("slop_string"))) {
            ...
            return SLOP_STR("slop_option_u8");
        } else if (string_eq(c_type, SLOP_STR("int8_t"))) {
            return SLOP_STR("slop_option_i8");
        } else if (string_eq(c_type, SLOP_STR("uint16_t"))) {
            return SLOP_STR("slop_option_u16");
        } else if (string_eq(c_type, SLOP_STR("int16_t"))) {
            return SLOP_STR("slop_option_i16");
        } else if (string_eq(c_type, SLOP_STR("uint32_t"))) {
            return SLOP_STR("slop_option_u32");
        } else if (string_eq(c_type, SLOP_STR("int32_t"))) {
            return SLOP_STR("slop_option_i32");
        } else if (string_eq(c_type, SLOP_STR("float"))) {
...
slop_string expr_infer_list_expr_option_type(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len < 1)) {
            ...
            __auto_type _mv_125 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_125.has_value) {
                __auto_type head_expr = _mv_125.value;
                __auto_type _mv_126 = (*head_expr);
                switch (_mv_126.tag) {
                    case types_SExpr_sym:
                    {
                        __auto_type sym = _mv_126.data.sym;
                        {
                            ...
                            if (string_eq(op, SLOP_STR("."))) {
                                if ((len < 3)) {
                                    ...
                                    __auto_type _mv_127 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    if (_mv_127.has_value) {
                                        __auto_type field_expr = _mv_127.value;
                                        __auto_type _mv_128 = (*field_expr);
                                        switch (_mv_128.tag) {
                                            case types_SExpr_sym:
                                            {
                                                __auto_type field_sym = _mv_128.data.sym;
                                                {
                                ...
                                __auto_type _mv_129 = context_ctx_lookup_func(ctx, op);
                                if (_mv_129.has_value) {
                                    __auto_type func_entry = _mv_129.value;
                                    {
            ...
            case types_SExpr_sym:
            {
                __auto_type sym = _mv_130.data.sym;
                {
                    ...
                    if (_mv_131.has_value) {
                        __auto_type var_entry = _mv_131.value;
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_130.data.lst;
                {
                    ...
                    if ((((int64_t)((items).len)) < 3)) {
                        ...
                        __auto_type _mv_132 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_132.has_value) {
                            ...
                            switch (_mv_133.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type head_sym = _mv_133.data.sym;
                                    if (string_eq(head_sym.name, SLOP_STR("."))) {
                                        __auto_type _mv_134 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_134.has_value) {
                                            __auto_type field_expr = _mv_134.value;
...
slop_string expr_infer_field_access_list_type(context_TranspileContext* ctx, types_SExpr* field_expr) {
    ...
    __auto_type _mv_135 = (*field_expr);
    switch (_mv_135.tag) {
        case types_SExpr_sym:
        {
            __auto_type field_sym = _mv_135.data.sym;
            {
                __auto_type field_name = field_sym.name;
...
slop_string expr_slop_value_type_to_c_type(context_TranspileContext* ctx, slop_string slop_type) {
    ...
    if (string_eq(slop_type, SLOP_STR("Int"))) {
        ...
        {
            __auto_type arena = (*ctx).arena;
            __auto_type _mv_136 = context_ctx_lookup_type(ctx, slop_type);
...
slop_string expr_resolve_type_alias_for_map(context_TranspileContext* ctx, slop_string slop_type) {
    ...
    if (strlib_starts_with(slop_type, SLOP_STR("(Map "))) {
        ...
        __auto_type _mv_138 = context_ctx_lookup_type_alias(ctx, slop_type);
        if (_mv_138.has_value) {
            __auto_type alias_def = _mv_138.value;
            return alias_def;
    ...
    SLOP_PRE(((expr != NULL)), "(!= expr nil)");
    {
        ...
        switch (_mv_139.tag) {
            case types_SExpr_sym:
            {
                ...
                {
                    __auto_type name = sym.name;
                    __auto_type _mv_140 = context_ctx_lookup_var(ctx, name);
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_139.data.lst;
                {
                    ...
                    if ((len < 1)) {
                        ...
                        __auto_type _mv_141 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_141.has_value) {
                            __auto_type head = _mv_141.value;
                            __auto_type _mv_142 = (*head);
                            switch (_mv_142.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type head_sym = _mv_142.data.sym;
                                    {
                                        ...
                                        if ((string_eq(op, SLOP_STR(".")) && (len >= 3))) {
                                            ...
                                            if (_mv_143.has_value) {
                                                __auto_type obj_expr = _mv_143.value;
                                                __auto_type _mv_144 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_144.has_value) {
                                                    __auto_type field_expr = _mv_144.value;
                                                    __auto_type _mv_145 = (*field_expr);
                                                    switch (_mv_145.tag) {
                                                        case types_SExpr_sym:
                                                        {
                                                            __auto_type field_sym = _mv_145.data.sym;
                                                            {
                                                                __auto_type field_name = field_sym.name;
                                                                {
                                                                    __auto_type obj_c_type = expr_infer_expr_c_type(ctx, obj_expr);
                                                                    __auto_type _mv_146 = context_ctx_lookup_field_slop_type(ctx, obj_c_type, field_name);
                                                                    if (_mv_146.has_value) {
                                                                    ...
                                                                    } else if (!_mv_146.has_value) {
                                                                        {
                                                                            ...
                                                                            __auto_type _mv_147 = context_ctx_lookup_field_slop_type(ctx, obj_slop_type, field_name);
                                                                            if (_mv_147.has_value) {
                                                                                __auto_type slop_type2 = _mv_147.value;
                                                                                return slop_type2;
                                            ...
                                            if ((len >= 2)) {
                                                __auto_type _mv_148 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_148.has_value) {
                                                    __auto_type type_expr = _mv_148.value;
                                                    __auto_type _mv_149 = (*type_expr);
                                                    switch (_mv_149.tag) {
                                                        case types_SExpr_sym:
                                                        {
                                                            __auto_type type_sym = _mv_149.data.sym;
                                            ...
                                            if ((len >= 4)) {
                                                __auto_type _mv_150 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_150.has_value) {
                                                    __auto_type key_expr = _mv_150.value;
                                                    __auto_type _mv_151 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_151.has_value) {
                                                        __auto_type val_expr = _mv_151.value;
                                                        {
                                            ...
                                            if ((len >= 3)) {
                                                __auto_type _mv_152 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_152.has_value) {
                                                    __auto_type elem_expr = _mv_152.value;
                                                    {
                                            ...
                                            if ((len >= 3)) {
                                                __auto_type _mv_153 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_153.has_value) {
                                                    __auto_type elem_expr = _mv_153.value;
                                                    {
                                                        __auto_type elem_str = ctype_sexpr_to_type_string(arena, elem_expr);
                                            ...
                                            __auto_type _mv_154 = context_ctx_lookup_func(ctx, op);
                                            if (_mv_154.has_value) {
                                                __auto_type func_entry = _mv_154.value;
    ...
    SLOP_PRE(((map_expr != NULL)), "(!= map-expr nil)");
    {
        ...
        switch (_mv_155.tag) {
            case types_SExpr_sym:
            {
                ...
                {
                    __auto_type name = sym.name;
                    __auto_type _mv_156 = context_ctx_lookup_var(ctx, name);
    ...
    SLOP_PRE(((set_expr != NULL)), "(!= set-expr nil)");
    {
        ...
        switch (_mv_157.tag) {
            case types_SExpr_sym:
            {
                ...
                {
                    __auto_type name = sym.name;
                    __auto_type _mv_158 = context_ctx_lookup_var(ctx, name);
    ...
    SLOP_PRE(((map_expr != NULL)), "(!= map-expr nil)");
    {
        ...
        switch (_mv_159.tag) {
            case types_SExpr_sym:
            {
                ...
                {
                    __auto_type name = sym.name;
                    __auto_type _mv_160 = context_ctx_lookup_var(ctx, name);
                            ...
                            if ((string_len(slop_type) > 0)) {
                                {
                                    ...
                                    if ((string_len(value_slop_type) > 0)) {
                                        {
                                            __auto_type resolved_value = expr_resolve_type_alias_for_map(ctx, value_slop_type);
...
slop_string expr_infer_option_inner_slop_type(context_TranspileContext* ctx, types_SExpr* scrutinee) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_161 = (*scrutinee);
        switch (_mv_161.tag) {
            case types_SExpr_sym:
            {
                __auto_type sym = _mv_161.data.sym;
                {
                    __auto_type name = sym.name;
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_161.data.lst;
                {
                    __auto_type items = lst.items;
                    __auto_type len = ((int64_t)((items).len));
                    if ((len < 2)) {
                        ...
                        __auto_type _mv_163 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_163.has_value) {
                            __auto_type head_expr = _mv_163.value;
                            __auto_type _mv_164 = (*head_expr);
                            switch (_mv_164.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type sym = _mv_164.data.sym;
                                    {
                                        ...
                                        if (string_eq(op, SLOP_STR("map-get"))) {
                                            if ((len < 2)) {
                                                ...
                                                __auto_type _mv_165 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_165.has_value) {
                                                    __auto_type map_expr = _mv_165.value;
                                                    __auto_type _mv_166 = (*map_expr);
                                                    switch (_mv_166.tag) {
                                                        case types_SExpr_sym:
                                                        {
                                                            __auto_type map_sym = _mv_166.data.sym;
                                                            {
                                                                __auto_type map_name = map_sym.name;
                                                                __auto_type _mv_167 = context_ctx_lookup_var(ctx, map_name);
                                            ...
                                            if ((len < 2)) {
                                                ...
                                                if (_mv_168.has_value) {
                                                    __auto_type list_expr = _mv_168.value;
                                                    __auto_type _mv_169 = (*list_expr);
                                                    switch (_mv_169.tag) {
                                                        case types_SExpr_sym:
                                                        {
                                                            __auto_type list_sym = _mv_169.data.sym;
                                                            {
                                                                __auto_type list_name = list_sym.name;
                                                                __auto_type _mv_170 = context_ctx_lookup_var(ctx, list_name);
...
slop_string expr_fix_ternary_none(context_TranspileContext* ctx, slop_string other_branch, slop_string this_branch) {
    ...
    if ((string_eq(this_branch, SLOP_STR("none")) && strlib_starts_with(other_branch, SLOP_STR("(slop_option_")))) {
        {
            __auto_type arena = (*ctx).arena;
            __auto_type _mv_171 = expr_extract_option_type(arena, other_branch);
            if (_mv_171.has_value) {
                __auto_type opt_type = _mv_171.value;
...
slop_string expr_transpile_array_index(context_TranspileContext* ctx, types_SExpr* arr_expr, slop_string arr_c, slop_string idx_c) {
    ...
    switch (_mv_172.tag) {
        case types_SExpr_sym:
        {
            ...
            {
                __auto_type name = sym.name;
                __auto_type _mv_173 = context_ctx_lookup_var(ctx, name);
                if (_mv_173.has_value) {
                    __auto_type var_entry = _mv_173.value;
                    {
                        __auto_type c_type = var_entry.c_type;
        ...
        case types_SExpr_sym:
        {
            __auto_type sym = _mv_174.data.sym;
            {
                ...
                if (_mv_175.has_value) {
                    __auto_type var_entry = _mv_175.value;
                    {
                        __auto_type c_type = var_entry.c_type;
            ...
            __auto_type lst = _mv_174.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) >= 1)) {
                    ...
                    if (_mv_176.has_value) {
                        __auto_type head_ptr = _mv_176.value;
                        __auto_type _mv_177 = (*head_ptr);
                        switch (_mv_177.tag) {
                            case types_SExpr_sym:
                            {
                                __auto_type head_sym = _mv_177.data.sym;
                                {
                                    ...
                                    if (string_eq(op, SLOP_STR("deref"))) {
                                        ...
                                        __auto_type _mv_178 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        switch (_mv_179.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_179.data.lst;
                {
                    ...
                    __auto_type len = ((int64_t)((items).len));
                    if ((len >= 2)) {
                        __auto_type _mv_180 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_180.has_value) {
                            __auto_type head_ptr = _mv_180.value;
                            __auto_type _mv_181 = (*head_ptr);
                            switch (_mv_181.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type head_sym = _mv_181.data.sym;
                                    {
                                        __auto_type op = head_sym.name;
                                        if (string_eq(op, SLOP_STR("sizeof"))) {
                                            __auto_type _mv_182 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        ...
                                        } else if ((string_eq(op, SLOP_STR("*")) || (string_eq(op, SLOP_STR("+")) || (string_eq(op, SLOP_STR("-")) || string_eq(op, SLOP_STR("/")))))) {
                                            {
                                                ...
                                                while ((i < len)) {
                                                    __auto_type _mv_183 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_183.has_value) {
                                                        __auto_type arg_expr = _mv_183.value;
                                                        {
...
slop_string expr_transpile_expr(context_TranspileContext* ctx, types_SExpr* expr) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    SLOP_PRE(((expr != NULL)), "(!= expr nil)");
    __auto_type _mv_184 = (*expr);
    switch (_mv_184.tag) {
        case types_SExpr_num:
        {
            __auto_type _ = _mv_184.data.num;
            return expr_transpile_literal(ctx, expr);
        }
        case types_SExpr_str:
        {
            __auto_type _ = _mv_184.data.str;
            return expr_transpile_literal(ctx, expr);
        }
        case types_SExpr_sym:
        {
            __auto_type _ = _mv_184.data.sym;
            return expr_transpile_literal(ctx, expr);
        }
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_184.data.lst;
...
slop_string expr_transpile_list_expr(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len < 1)) {
            ...
            __auto_type _mv_185 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_185.has_value) {
                __auto_type head_expr = _mv_185.value;
                __auto_type _mv_186 = (*head_expr);
                switch (_mv_186.tag) {
                    case types_SExpr_sym:
                    {
                            ...
                            if ((expr_is_binop(op) && (len < 3))) {
                                ...
                                if ((len > 3)) {
                                    ...
                                    if (_mv_187.has_value) {
                                        __auto_type left = _mv_187.value;
                                        ...
                                        if (_mv_188.has_value) {
                                            __auto_type right = _mv_188.value;
                                            {
                                ...
                                if (_mv_189.has_value) {
                                    __auto_type left = _mv_189.value;
                                    ...
                                    if (_mv_190.has_value) {
                                        __auto_type right = _mv_190.value;
                                        {
                                            __auto_type left_c = expr_transpile_expr(ctx, left);
                                            __auto_type right_c = expr_transpile_expr(ctx, right);
                                            return expr_transpile_binop(ctx, op, left_c, right_c);
                                ...
                                if (_mv_192.has_value) {
                                    __auto_type cond_expr = _mv_192.value;
                                    ...
                                    if (_mv_193.has_value) {
                                        __auto_type then_expr = _mv_193.value;
                                        __auto_type _mv_194 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_194.has_value) {
                                            __auto_type else_expr = _mv_194.value;
                                            {
                                ...
                                if (_mv_196.has_value) {
                                    ...
                                    if (_mv_197.has_value) {
                                        ...
                                        switch (_mv_198.tag) {
                                            case types_SExpr_sym:
                                            {
                                                __auto_type field_sym = _mv_198.data.sym;
                                                {
                                ...
                                if (_mv_199.has_value) {
                                    ...
                                    if (_mv_200.has_value) {
                                        __auto_type val_expr = _mv_200.value;
                                        {
                                ...
                                if (_mv_201.has_value) {
                                    __auto_type str_expr = _mv_201.value;
                                    __auto_type _mv_202 = (*str_expr);
                                    switch (_mv_202.tag) {
                                        case types_SExpr_str:
                                        {
                                            __auto_type str = _mv_202.data.str;
                                            return str.value;
                                        }
                                        default: {
                                ...
                                if (_mv_203.has_value) {
                                    __auto_type val_expr = _mv_203.value;
                                    {
                                        __auto_type val_c = expr_transpile_expr(ctx, val_expr);
                                ...
                                if (_mv_206.has_value) {
                                    __auto_type arr_expr = _mv_206.value;
                                    __auto_type _mv_207 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    if (_mv_207.has_value) {
                                        __auto_type idx_expr = _mv_207.value;
                                        {
                                ...
                                __auto_type _mv_208 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_208.has_value) {
                                    __auto_type arena_expr = _mv_208.value;
                                    __auto_type _mv_209 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    if (_mv_209.has_value) {
                                        __auto_type size_expr = _mv_209.value;
                                        {
                                            __auto_type arena_c = expr_transpile_expr(ctx, arena_expr);
                                            __auto_type _mv_210 = (*size_expr);
                                            switch (_mv_210.tag) {
                                                case types_SExpr_sym:
                                                {
                                                    __auto_type sym = _mv_210.data.sym;
                                                    {
                                                        ...
                                                        __auto_type _mv_211 = context_ctx_lookup_type(ctx, type_name);
                                ...
                                if (_mv_212.has_value) {
                                    __auto_type variant_expr = _mv_212.value;
                                    __auto_type _mv_213 = (*variant_expr);
                                    switch (_mv_213.tag) {
                                        case types_SExpr_sym:
                                        {
                                ...
                                if (_mv_214.has_value) {
                                    ...
                                    if (_mv_215.has_value) {
                                        __auto_type tag_expr = _mv_215.value;
                                        __auto_type _mv_216 = (*type_expr);
                                        switch (_mv_216.tag) {
                                            case types_SExpr_sym:
                                            {
                                                __auto_type type_sym = _mv_216.data.sym;
                                                __auto_type _mv_217 = expr_extract_symbol_name(tag_expr);
                                                if (_mv_217.has_value) {
                                                    __auto_type tag_str = _mv_217.value;
                                                    {
                                                        ...
                                                        if ((len >= 4)) {
                                                            __auto_type _mv_218 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                            if (_mv_218.has_value) {
                                                                __auto_type val_expr = _mv_218.value;
                                                                {
                                                                    __auto_type val_c = expr_transpile_expr(ctx, val_expr);
                                ...
                                if (_mv_219.has_value) {
                                    __auto_type val_expr = _mv_219.value;
                                    {
                                        __auto_type val_c = expr_transpile_expr(ctx, val_expr);
                                ...
                                if (_mv_220.has_value) {
                                    __auto_type val_expr = _mv_220.value;
                                    {
                                        __auto_type val_c = expr_transpile_expr(ctx, val_expr);
                                ...
                                __auto_type _mv_221 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_221.has_value) {
                                    __auto_type result_expr = _mv_221.value;
                                    {
                                        __auto_type result_c = expr_transpile_expr(ctx, result_expr);
                                        __auto_type _mv_222 = context_ctx_get_current_result_type(ctx);
                                        if (_mv_222.has_value) {
                                            __auto_type enclosing_type = _mv_222.value;
                                ...
                                if (_mv_223.has_value) {
                                    __auto_type list_expr = _mv_223.value;
                                    {
                                ...
                                if (_mv_224.has_value) {
                                    __auto_type list_expr = _mv_224.value;
                                    __auto_type _mv_225 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    if (_mv_225.has_value) {
                                        __auto_type idx_expr = _mv_225.value;
                                        {
                                            __auto_type list_c = expr_transpile_expr(ctx, list_expr);
                                            __auto_type idx_c = expr_transpile_expr(ctx, idx_expr);
                                ...
                                if (_mv_226.has_value) {
                                    __auto_type list_expr = _mv_226.value;
                                    {
                                        __auto_type list_c = expr_transpile_expr(ctx, list_expr);
                                        __auto_type option_type = expr_infer_list_element_option_type(ctx, list_expr);
                                        if ((string_len(option_type) > 0)) {
                                ...
                                if (_mv_227.has_value) {
                                    __auto_type arena_expr = _mv_227.value;
                                    ...
                                    if (_mv_228.has_value) {
                                        __auto_type type_expr = _mv_228.value;
                                        {
                                            __auto_type arena_c = expr_transpile_expr(ctx, arena_expr);
                                ...
                                if (_mv_229.has_value) {
                                    __auto_type list_expr = _mv_229.value;
                                    ...
                                    if (_mv_230.has_value) {
                                        __auto_type item_expr = _mv_230.value;
                                        {
                                            __auto_type list_c = expr_transpile_expr(ctx, list_expr);
                                ...
                                __auto_type _mv_231 = context_ctx_get_current_return_type(ctx);
                                if (_mv_231.has_value) {
                                    __auto_type ret_type = _mv_231.value;
        ...
        if (string_eq(fn_name, SLOP_STR("println"))) {
            ...
            if ((len < 3)) {
                ...
                if (_mv_235.has_value) {
                    __auto_type a_expr = _mv_235.value;
                    ...
                    if (_mv_236.has_value) {
                        __auto_type b_expr = _mv_236.value;
                        {
            ...
            if ((len < 3)) {
                ...
                if (_mv_237.has_value) {
                    __auto_type a_expr = _mv_237.value;
                    ...
                    if (_mv_238.has_value) {
                        __auto_type b_expr = _mv_238.value;
                        {
                            __auto_type a_c = expr_transpile_expr(ctx, a_expr);
                            __auto_type b_c = expr_transpile_expr(ctx, b_expr);
                            __auto_type s1 = string_concat(arena, SLOP_STR("(("), a_c);
            ...
            if ((len < 3)) {
                ...
                if (_mv_239.has_value) {
                    __auto_type fn_expr = _mv_239.value;
            ...
            if ((len < 3)) {
                context_ctx_add_error_at(ctx, SLOP_STR("send: need channel and value arguments"), context_list_first_line(items), context_list_first_col(items));
                return SLOP_STR("0");
            } else {
                ...
                if (_mv_240.has_value) {
                    __auto_type chan_expr = _mv_240.value;
                    ...
                    if (_mv_241.has_value) {
                        __auto_type value_expr = _mv_241.value;
                        {
                        ...
                        context_ctx_add_error_at(ctx, SLOP_STR("send: missing value argument"), context_list_first_line(items), context_list_first_col(items));
                        return SLOP_STR("0");
                    }
                } else if (!_mv_240.has_value) {
                    context_ctx_add_error_at(ctx, SLOP_STR("send: missing channel argument"), context_list_first_line(items), context_list_first_col(items));
                    return SLOP_STR("0");
                }
            }
        } else if (string_eq(fn_name, SLOP_STR("recv"))) {
            if ((len < 2)) {
                context_ctx_add_error_at(ctx, SLOP_STR("recv: need channel argument"), context_list_first_line(items), context_list_first_col(items));
                return SLOP_STR("0");
            } else {
                ...
                if (_mv_242.has_value) {
                    __auto_type chan_expr = _mv_242.value;
                    {
                        __auto_type chan_c = expr_transpile_expr(ctx, chan_expr);
                        __auto_type chan_c_type = expr_infer_expr_c_type(ctx, chan_expr);
                        {
                    ...
                    context_ctx_add_error_at(ctx, SLOP_STR("recv: missing channel argument"), context_list_first_line(items), context_list_first_col(items));
                    return SLOP_STR("0");
                }
            }
        } else {
            __auto_type _mv_243 = context_ctx_lookup_type(ctx, fn_name);
            if (_mv_243.has_value) {
                __auto_type type_entry = _mv_243.value;
                if (type_entry.is_union) {
                ...
                } else {
                    {
                        ...
                        while ((i < len)) {
                            __auto_type _mv_244 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_244.has_value) {
                                __auto_type arg = _mv_244.value;
                                {
                                    __auto_type arg_c = expr_transpile_expr(ctx, arg);
            ...
            } else if (!_mv_243.has_value) {
                {
                    ...
                    if ((string_len(builtin_c_name) > 0)) {
                        ...
                        __auto_type _mv_245 = context_ctx_lookup_enum_variant(ctx, fn_name);
                        if (_mv_245.has_value) {
                            __auto_type type_name = _mv_245.value;
                            {
                                ...
                                if ((len >= 2)) {
                                    ...
                                    if (_mv_246.has_value) {
                                        __auto_type value_expr = _mv_246.value;
                                        {
                                            __auto_type value_c = expr_transpile_expr(ctx, value_expr);
                                ...
                                if (!_mv_247.has_value) {
                                    {
                                        ...
                                        if (((string_len(runtime_name) == 0) && ({ __auto_type _mv = var_opt; _mv.has_value ? ({ __auto_type _ = _mv.value; 0; }) : (1); }))) {
                                            context_ctx_add_error_at(ctx, context_ctx_str3(ctx, SLOP_STR("undefined function '"), fn_name, SLOP_STR("' - check imports")), context_list_first_line(items), context_list_first_col(items));
                                            return SLOP_STR("0");
                                        } else {
                                            while ((i < len)) {
                                                __auto_type _mv_248 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_248.has_value) {
                                                    __auto_type arg = _mv_248.value;
                                                    {
                                                        __auto_type arg_c = expr_transpile_expr(ctx, arg);
                                                        if (string_eq(args, SLOP_STR(""))) {
                                                            args = arg_c;
                                    ...
                                    __auto_type func_entry = _mv_247.value;
                                    while ((i < len)) {
                                        ...
                                        if (_mv_249.has_value) {
                                            __auto_type arg = _mv_249.value;
                                            {
                                                __auto_type arg_c = expr_transpile_expr(ctx, arg);
                                                __auto_type expected_type = ({ __auto_type _mv = ({ __auto_type _lst = func_entry.param_types; size_t _idx = (size_t)param_idx; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; }); _mv.has_value ? ({ __auto_type p = _mv.value; (*p).c_type; }) : (SLOP_STR("")); });
...
slop_string expr_transpile_print(context_TranspileContext* ctx, types_SExpr* arg, uint8_t newline) {
    ...
    SLOP_PRE(((arg != NULL)), "(!= arg nil)");
    {
        ...
        __auto_type _mv_250 = (*arg);
        switch (_mv_250.tag) {
            case types_SExpr_str:
            {
                __auto_type s = _mv_250.data.str;
                return context_ctx_str5(ctx, SLOP_STR("printf(\"%s"), nl, SLOP_STR("\", \""), s.value, SLOP_STR("\")"));
            }
            case types_SExpr_num:
            {
                __auto_type n = _mv_250.data.num;
            ...
            default: {
                {
                    __auto_type arg_c = expr_transpile_expr(ctx, arg);
                    __auto_type _mv_251 = expr_get_expr_type_hint(ctx, arg);
                    if (_mv_251.has_value) {
                        __auto_type type_hint = _mv_251.value;
...
slop_string expr_transpile_printf_call(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        __auto_type i = 1;
        while ((i < len)) {
            __auto_type _mv_252 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_252.has_value) {
                __auto_type arg = _mv_252.value;
                {
...
slop_option_string expr_get_expr_type_hint(context_TranspileContext* ctx, types_SExpr* expr) {
    __auto_type _mv_253 = (*expr);
    switch (_mv_253.tag) {
        case types_SExpr_sym:
        {
            __auto_type sym = _mv_253.data.sym;
            __auto_type _mv_254 = context_ctx_lookup_var(ctx, sym.name);
            if (_mv_254.has_value) {
                __auto_type entry = _mv_254.value;
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_253.data.lst;
            {
                __auto_type items = lst.items;
                if ((((int64_t)((items).len)) >= 1)) {
                    __auto_type _mv_255 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_255.has_value) {
                        __auto_type head = _mv_255.value;
                        __auto_type _mv_256 = (*head);
                        switch (_mv_256.tag) {
                            case types_SExpr_sym:
                            {
                                __auto_type head_sym = _mv_256.data.sym;
                                {
                                    __auto_type op = head_sym.name;
                                    if ((string_eq(op, SLOP_STR(".")) && (((int64_t)((items).len)) >= 3))) {
                                        __auto_type _mv_257 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_257.has_value) {
                                            __auto_type field_expr = _mv_257.value;
                                            __auto_type _mv_258 = (*field_expr);
                                            switch (_mv_258.tag) {
                                                case types_SExpr_sym:
                                                {
                                                    __auto_type field_sym = _mv_258.data.sym;
                                                    {
                                                        __auto_type field_name = field_sym.name;
                                        ...
                                        if (string_eq(op, SLOP_STR("pretty-print"))) {
                                            ...
                                            __auto_type _mv_259 = context_ctx_lookup_func(ctx, op);
                                            if (_mv_259.has_value) {
                                                __auto_type func_entry = _mv_259.value;
                                                if (func_entry.returns_string) {
                                                    return (slop_option_string){.has_value = 1, .value = SLOP_STR("slop_string")};
                                                } else {
                                                    return (slop_option_string){.has_value = false};
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len < 2)) {
            ...
            if (_mv_260.has_value) {
                __auto_type tag_expr = _mv_260.value;
                __auto_type _mv_261 = (*tag_expr);
                switch (_mv_261.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type tag_list = _mv_261.data.lst;
                        {
                            __auto_type tag_items = tag_list.items;
                            if ((((int64_t)((tag_items).len)) < 1)) {
                                return context_ctx_str3(ctx, SLOP_STR("(("), c_type_name, SLOP_STR("){})"));
                            } else {
                                __auto_type _mv_262 = ({ __auto_type _lst = tag_items; size_t _idx = (size_t)0; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_262.has_value) {
                                    __auto_type tag_name_expr = _mv_262.value;
                                    __auto_type _mv_263 = (*tag_name_expr);
                                    switch (_mv_263.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type tag_sym = _mv_263.data.sym;
                                            {
                                                ...
                                                if ((((int64_t)((tag_items).len)) >= 2)) {
                                                    __auto_type _mv_264 = ({ __auto_type _lst = tag_items; size_t _idx = (size_t)1; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_264.has_value) {
                                                        __auto_type value_expr = _mv_264.value;
                                                        {
                                                            __auto_type value_c = expr_transpile_expr(ctx, value_expr);
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while ((i < len)) {
            ...
            if (_mv_265.has_value) {
                __auto_type clause_expr = _mv_265.value;
                __auto_type _mv_266 = (*clause_expr);
                switch (_mv_266.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type clause_lst = _mv_266.data.lst;
                        {
                            __auto_type clause_items = clause_lst.items;
                            __auto_type clause_len = ((int64_t)((clause_items).len));
                            if ((clause_len >= 2)) {
                                __auto_type _mv_267 = ({ __auto_type _lst = clause_items; size_t _idx = (size_t)0; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_267.has_value) {
                                    __auto_type test_expr = _mv_267.value;
                                    __auto_type _mv_268 = (*test_expr);
                                    switch (_mv_268.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type sym = _mv_268.data.sym;
                                            if (string_eq(sym.name, SLOP_STR("else"))) {
                                                __auto_type _mv_269 = ({ __auto_type _lst = clause_items; size_t _idx = (size_t)(clause_len - 1); struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_269.has_value) {
                                                    __auto_type body_expr = _mv_269.value;
                                                    {
                                            ...
                                            } else {
                                                {
                                                    ...
                                                    __auto_type _mv_270 = ({ __auto_type _lst = clause_items; size_t _idx = (size_t)(clause_len - 1); struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        ...
                                        default: {
                                            {
                                                __auto_type test_c = expr_transpile_expr(ctx, test_expr);
                                                __auto_type _mv_271 = ({ __auto_type _lst = clause_items; size_t _idx = (size_t)(clause_len - 1); struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_271.has_value) {
                                                    __auto_type body_expr = _mv_271.value;
                                                    {
                                                        __auto_type body_c = expr_typed_none(ctx, result_type, expr_transpile_expr(ctx, body_expr));
                                                        result = context_ctx_str(ctx, result, context_ctx_str(ctx, SLOP_STR("("), context_ctx_str(ctx, test_c, context_ctx_str(ctx, SLOP_STR(" ? "), context_ctx_str(ctx, body_c, SLOP_STR(" : "))))));
                                                    }
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len < 3)) {
            ...
            if (_mv_272.has_value) {
                __auto_type scrutinee = _mv_272.value;
                {
...
slop_string expr_get_expr_pattern_tag(types_SExpr* pat_expr) {
    ...
    __auto_type _mv_276 = (*pat_expr);
    switch (_mv_276.tag) {
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_276.data.lst;
            {
                __auto_type items = lst.items;
                if ((((int64_t)((items).len)) < 1)) {
                    return SLOP_STR("");
                } else {
                    __auto_type _mv_277 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_277.has_value) {
                        __auto_type head = _mv_277.value;
                        __auto_type _mv_278 = (*head);
                        switch (_mv_278.tag) {
                            case types_SExpr_sym:
                            {
                                __auto_type sym = _mv_278.data.sym;
                                return sym.name;
                            }
                            default: {
                                return SLOP_STR("");
...
uint8_t expr_is_option_patterns(slop_list_types_SExpr_ptr patterns) {
    {
        ...
        __auto_type i = 0;
        while (((i < len) && !(found))) {
            __auto_type _mv_279 = ({ __auto_type _lst = patterns; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_279.has_value) {
                __auto_type pat = _mv_279.value;
                {
...
uint8_t expr_is_result_patterns(slop_list_types_SExpr_ptr patterns) {
    {
        ...
        __auto_type i = 0;
        while (((i < len) && !(found))) {
            __auto_type _mv_280 = ({ __auto_type _lst = patterns; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_280.has_value) {
                __auto_type pat = _mv_280.value;
                {
                    __auto_type tag = expr_get_expr_pattern_tag(pat);
...
uint8_t expr_is_union_expr_patterns(context_TranspileContext* ctx, slop_list_types_SExpr_ptr patterns) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (((i < len) && !(has_union_variant))) {
            __auto_type _mv_281 = ({ __auto_type _lst = patterns; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_281.has_value) {
                __auto_type pat_expr = _mv_281.value;
                {
                    ...
                    if (((!(string_eq(tag, SLOP_STR("")))) && (!(string_eq(tag, SLOP_STR("some")))) && (!(string_eq(tag, SLOP_STR("none")))) && (!(string_eq(tag, SLOP_STR("ok")))) && (!(string_eq(tag, SLOP_STR("error")))) && (!(string_eq(tag, SLOP_STR("else")))) && (!(string_eq(tag, SLOP_STR("_")))))) {
                        __auto_type _mv_282 = context_ctx_lookup_enum_variant(ctx, tag);
                        if (_mv_282.has_value) {
                            __auto_type _ = _mv_282.value;
                            has_union_variant = 1;
...
slop_option_string expr_get_expr_binding_name(types_SExpr* pat_expr) {
    SLOP_PRE(((pat_expr != NULL)), "(!= pat-expr nil)");
    __auto_type _mv_283 = (*pat_expr);
    switch (_mv_283.tag) {
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_283.data.lst;
            {
                __auto_type items = lst.items;
                if ((((int64_t)((items).len)) < 2)) {
                    return (slop_option_string){.has_value = false};
                } else {
                    __auto_type _mv_284 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_284.has_value) {
                        __auto_type binding = _mv_284.value;
                        __auto_type _mv_285 = (*binding);
                        switch (_mv_285.tag) {
                            case types_SExpr_sym:
                            {
...
slop_string expr_get_match_branch_body(context_TranspileContext* ctx, slop_list_types_SExpr_ptr branch_items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len < 2)) {
            ...
            __auto_type _mv_286 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)(len - 1); slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_286.has_value) {
                __auto_type body_expr = _mv_286.value;
    ...
    SLOP_PRE(((scrutinee != NULL)), "(!= scrutinee nil)");
    {
        ...
        while ((i < len)) {
            ...
            if (_mv_287.has_value) {
                __auto_type branch = _mv_287.value;
                __auto_type _mv_288 = (*branch);
                switch (_mv_288.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type branch_lst = _mv_288.data.lst;
                        {
                            __auto_type branch_items = branch_lst.items;
                            if ((((int64_t)((branch_items).len)) >= 2)) {
                                __auto_type _mv_289 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)0; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_289.has_value) {
                                    __auto_type pattern = _mv_289.value;
                                    {
                                        __auto_type tag = expr_get_expr_pattern_tag(pattern);
                                        if (string_eq(tag, SLOP_STR("some"))) {
                                            __auto_type _mv_290 = expr_get_expr_binding_name(pattern);
                                            if (_mv_290.has_value) {
                                                __auto_type name = _mv_290.value;
                                                some_binding = name;
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len < 2)) {
            ...
            if (_mv_291.has_value) {
                __auto_type first_clause = _mv_291.value;
                __auto_type _mv_292 = (*first_clause);
                switch (_mv_292.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type clause_lst = _mv_292.data.lst;
                        {
                            __auto_type clause_items = clause_lst.items;
                            __auto_type clause_len = ((int64_t)((clause_items).len));
                            if ((clause_len < 2)) {
                                ...
                                __auto_type _mv_293 = ({ __auto_type _lst = clause_items; size_t _idx = (size_t)(clause_len - 1); struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_293.has_value) {
                                    __auto_type body_expr = _mv_293.value;
...
slop_string expr_infer_match_result_c_type(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len < 3)) {
            ...
            __auto_type _mv_294 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_294.has_value) {
                __auto_type first_branch = _mv_294.value;
                __auto_type _mv_295 = (*first_branch);
                switch (_mv_295.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type branch_lst = _mv_295.data.lst;
                        {
                            __auto_type branch_items = branch_lst.items;
                            ...
                            if ((branch_len < 2)) {
                                ...
                                __auto_type _mv_296 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)(branch_len - 1); struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_296.has_value) {
                                    __auto_type body_expr = _mv_296.value;
                                    return expr_infer_expr_c_type(ctx, body_expr);
...
slop_string expr_slop_type_to_c_type(context_TranspileContext* ctx, slop_string slop_type) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_297 = context_ctx_lookup_type(ctx, slop_type);
        if (_mv_297.has_value) {
            __auto_type entry = _mv_297.value;
            return entry.c_name;
...
slop_string expr_infer_expr_c_type(context_TranspileContext* ctx, types_SExpr* expr) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    SLOP_PRE(((expr != NULL)), "(!= expr nil)");
    __auto_type _mv_298 = (*expr);
    switch (_mv_298.tag) {
        case types_SExpr_str:
        {
            __auto_type _ = _mv_298.data.str;
            return SLOP_STR("slop_string");
        }
        case types_SExpr_num:
        {
            __auto_type num = _mv_298.data.num;
            if (num.is_float) {
                return SLOP_STR("double");
            } else {
                return SLOP_STR("int64_t");
        ...
        case types_SExpr_sym:
        {
            __auto_type sym = _mv_298.data.sym;
            {
                __auto_type name = sym.name;
                __auto_type _mv_299 = context_ctx_lookup_var(ctx, name);
                if (_mv_299.has_value) {
                    __auto_type entry = _mv_299.value;
                    {
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_298.data.lst;
            {
                __auto_type items = lst.items;
                if ((((int64_t)((items).len)) < 1)) {
                    return SLOP_STR("int64_t");
                } else {
                    __auto_type _mv_300 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                ...
                                __auto_type sym = _mv_301.data.sym;
                                {
                                    ...
                                    if (({ __auto_type _mv = context_ctx_lookup_func(ctx, op); _mv.has_value ? ({ __auto_type func_entry = _mv.value; func_entry.returns_string; }) : (0); })) {
                                        ...
                                        if ((((int64_t)((items).len)) < 3)) {
                                            ...
                                            __auto_type _mv_302 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_302.has_value) {
                                                __auto_type obj_expr = _mv_302.value;
                                                __auto_type _mv_303 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_303.has_value) {
                                                    __auto_type field_expr = _mv_303.value;
                                                    __auto_type _mv_304 = (*field_expr);
                                                    switch (_mv_304.tag) {
                                                        case types_SExpr_sym:
                                                        {
                                                            __auto_type field_sym = _mv_304.data.sym;
                                                            {
                                                                __auto_type field_name = field_sym.name;
                                                                __auto_type obj_c_type = expr_infer_expr_c_type(ctx, obj_expr);
                                                                __auto_type _mv_305 = context_ctx_lookup_field_type(ctx, obj_c_type, field_name);
                                                                if (_mv_305.has_value) {
                                                                    __auto_type c_type = _mv_305.value;
                                                                    return c_type;
                                                                } else if (!_mv_305.has_value) {
                                                                    __auto_type _mv_306 = context_ctx_lookup_var(ctx, expr_get_var_name_from_expr(obj_expr));
                                                                    if (_mv_306.has_value) {
                                                                        __auto_type var_entry = _mv_306.value;
                                                                        {
                                                                            __auto_type obj_slop_type = var_entry.slop_type;
                                                                            __auto_type _mv_307 = context_ctx_lookup_field_type(ctx, obj_slop_type, field_name);
                                                                            if (_mv_307.has_value) {
                                                                                __auto_type c_type2 = _mv_307.value;
                                                                                return c_type2;
                                        ...
                                        if ((((int64_t)((items).len)) < 3)) {
                                            ...
                                            __auto_type _mv_308 = ({ __auto_type _lst = items; size_t _idx = (size_t)(((int64_t)((items).len)) - 1); struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_308.has_value) {
                                                __auto_type body = _mv_308.value;
                                        ...
                                        if ((((int64_t)((items).len)) < 2)) {
                                            ...
                                            __auto_type _mv_309 = ({ __auto_type _lst = items; size_t _idx = (size_t)(((int64_t)((items).len)) - 1); struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_309.has_value) {
                                                __auto_type last_expr = _mv_309.value;
                                        ...
                                        if ((((int64_t)((items).len)) < 3)) {
                                            ...
                                            __auto_type _mv_310 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_310.has_value) {
                                                __auto_type then_expr = _mv_310.value;
                                        ...
                                        if ((((int64_t)((items).len)) < 2)) {
                                            ...
                                            __auto_type _mv_311 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        ...
                                        __auto_type _mv_312 = context_ctx_get_current_return_type(ctx);
                                        if (_mv_312.has_value) {
                                            __auto_type ret_type = _mv_312.value;
                                            if (strlib_starts_with(ret_type, SLOP_STR("slop_option_"))) {
                                                return ret_type;
                                            } else {
                                                return SLOP_STR("slop_option_int");
                                        ...
                                        if ((((int64_t)((items).len)) < 2)) {
                                            ...
                                            __auto_type _mv_313 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        ...
                                        __auto_type _mv_314 = context_ctx_lookup_type(ctx, op);
                                        if (_mv_314.has_value) {
                                            __auto_type type_entry = _mv_314.value;
                                            return type_entry.c_name;
                                        } else if (!_mv_314.has_value) {
                                            __auto_type _mv_315 = context_ctx_lookup_func(ctx, op);
                                            if (_mv_315.has_value) {
                                                __auto_type func_entry = _mv_315.value;
                                                {
                                                    __auto_type ret_type = func_entry.return_type;
                                                    if (func_entry.returns_string) {
                                                        return SLOP_STR("slop_string");
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while ((i < len)) {
            ...
            if (_mv_316.has_value) {
                __auto_type branch = _mv_316.value;
                __auto_type _mv_317 = (*branch);
                switch (_mv_317.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type branch_lst = _mv_317.data.lst;
                        {
                            __auto_type branch_items = branch_lst.items;
                            if ((((int64_t)((branch_items).len)) >= 2)) {
                                __auto_type _mv_318 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)0; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_318.has_value) {
                                    __auto_type pattern = _mv_318.value;
                                    {
                                        __auto_type tag = expr_get_expr_pattern_tag(pattern);
                                        if (string_eq(tag, SLOP_STR("ok"))) {
                                            __auto_type _mv_319 = expr_get_expr_binding_name(pattern);
                                            if (_mv_319.has_value) {
                                                __auto_type name = _mv_319.value;
                                                ok_binding = name;
                                            ...
                                            __auto_type _mv_320 = expr_get_expr_binding_name(pattern);
                                            if (_mv_320.has_value) {
                                                __auto_type name = _mv_320.value;
                                                err_binding = name;
                ...
                switch (_mv_322.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type branch_lst = _mv_322.data.lst;
                        {
                            __auto_type branch_items = branch_lst.items;
                            if ((((int64_t)((branch_items).len)) >= 2)) {
                                __auto_type _mv_323 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)0; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_string expr_build_union_case_expr(context_TranspileContext* ctx, slop_arena* arena, slop_string cases, types_SExpr* scrutinee, types_SExpr* pattern, slop_list_types_SExpr_ptr branch_items, slop_string result_type) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((string_eq(tag, SLOP_STR("else")) || string_eq(tag, SLOP_STR("_")))) {
            ...
            __auto_type _mv_324 = context_ctx_lookup_enum_variant(ctx, tag);
            if (_mv_324.has_value) {
                __auto_type type_name = _mv_324.value;
                {
                    ...
                    __auto_type _mv_325 = binding_opt;
                    if (_mv_325.has_value) {
                        __auto_type binding_name = _mv_325.value;
                        {
...
slop_string expr_build_ternary_match_expr(context_TranspileContext* ctx, slop_string scrutinee_c, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        __auto_type i = (len - 1);
        while ((i >= 2)) {
            __auto_type _mv_326 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_326.has_value) {
                __auto_type branch = _mv_326.value;
                __auto_type _mv_327 = (*branch);
                switch (_mv_327.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type branch_lst = _mv_327.data.lst;
                        {
                            __auto_type branch_items = branch_lst.items;
                            if ((((int64_t)((branch_items).len)) >= 2)) {
                                __auto_type _mv_328 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)0; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_string expr_transpile_let_expr(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len < 3)) {
            ...
            __auto_type _mv_329 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_329.has_value) {
                __auto_type bindings_expr = _mv_329.value;
                __auto_type _mv_330 = (*bindings_expr);
                switch (_mv_330.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type bindings_lst = _mv_330.data.lst;
                        {
                            __auto_type result = SLOP_STR("({ ");
                            ...
                            while ((bi < bindings_len)) {
                                __auto_type _mv_331 = ({ __auto_type _lst = bindings_items; size_t _idx = (size_t)bi; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_331.has_value) {
                                    __auto_type binding = _mv_331.value;
                                    {
                            ...
                            }
                            {
                                ...
                                __auto_type _mv_333 = ({ __auto_type _lst = items; size_t _idx = (size_t)(len - 1); slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_333.has_value) {
                                    __auto_type last_expr = _mv_333.value;
                                    {
                ...
                __auto_type lst = _mv_334.data.lst;
                {
                    ...
                    if ((len < 2)) {
                    ...
                    } else {
                        {
                            ...
                            __auto_type _mv_335 = ({ __auto_type _lst = items; size_t _idx = (size_t)name_idx; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_335.has_value) {
                                __auto_type name_expr = _mv_335.value;
                                __auto_type _mv_336 = (*name_expr);
                                switch (_mv_336.tag) {
                                    case types_SExpr_sym:
                                    {
                                        __auto_type name_sym = _mv_336.data.sym;
                                        {
                                            ...
                                            if (has_type) {
                                                __auto_type _mv_337 = ({ __auto_type _lst = items; size_t _idx = (size_t)type_idx; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_337.has_value) {
                                                    __auto_type type_expr = _mv_337.value;
                                                    {
                                                        __auto_type c_type = context_to_c_type_prefixed(ctx, type_expr);
                                                        __auto_type _mv_338 = ({ __auto_type _lst = items; size_t _idx = (size_t)init_idx; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                        if (_mv_338.has_value) {
                                                            __auto_type init_expr = _mv_338.value;
                                                            {
                                                    ...
                                                    __auto_type _mv_339 = ({ __auto_type _lst = items; size_t _idx = (size_t)init_idx; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_339.has_value) {
                                                        __auto_type init_expr = _mv_339.value;
                                                        {
                                                ...
                                                __auto_type _mv_340 = ({ __auto_type _lst = items; size_t _idx = (size_t)init_idx; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_340.has_value) {
                                                    __auto_type init_expr = _mv_340.value;
                                                    {
                                                        __auto_type init_c = expr_transpile_expr(ctx, init_expr);
                                                        return context_ctx_str5(ctx, SLOP_STR("__auto_type "), var_name, SLOP_STR(" = "), init_c, SLOP_STR(";"));
                                                    }
...
uint8_t expr_binding_has_mut(slop_list_types_SExpr_ptr items) {
    if ((((int64_t)((items).len)) < 1)) {
        ...
        __auto_type _mv_341 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        if (_mv_341.has_value) {
            __auto_type first = _mv_341.value;
            __auto_type _mv_342 = (*first);
            switch (_mv_342.tag) {
                case types_SExpr_sym:
                {
...
slop_string expr_transpile_typed_init(context_TranspileContext* ctx, types_SExpr* init_expr, slop_string target_type) {
    ...
    __auto_type _mv_343 = (*init_expr);
    switch (_mv_343.tag) {
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_343.data.lst;
            {
                __auto_type items = lst.items;
                if ((((int64_t)((items).len)) < 1)) {
                    return expr_transpile_expr(ctx, init_expr);
                } else {
                    __auto_type _mv_344 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                ...
                                __auto_type sym = _mv_345.data.sym;
                                {
                                    ...
                                    if (string_eq(op, SLOP_STR("some"))) {
                                        if ((((int64_t)((items).len)) < 2)) {
                                            ...
                                            __auto_type _mv_346 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_346.has_value) {
                                                __auto_type val_expr = _mv_346.value;
                                                {
                                                    __auto_type val_c = expr_transpile_expr(ctx, val_expr);
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len < 3)) {
            ...
            if (_mv_347.has_value) {
                __auto_type cond_expr = _mv_347.value;
                {
                    __auto_type cond_c = expr_transpile_expr(ctx, cond_expr);
                    __auto_type body_str = SLOP_STR("");
                    {
                        __auto_type i = 2;
                        while ((i < len)) {
                            __auto_type _mv_348 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_348.has_value) {
                                __auto_type body_expr = _mv_348.value;
                                {
                                    __auto_type body_c = expr_transpile_expr(ctx, body_expr);
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len <= 1)) {
        ...
        } else {
            {
                ...
                __auto_type i = 1;
                while ((i < len)) {
                    __auto_type _mv_349 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_349.has_value) {
                        __auto_type expr = _mv_349.value;
                        {
...
slop_string expr_transpile_when_expr(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len < 2)) {
            ...
            __auto_type _mv_350 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_350.has_value) {
                __auto_type cond_expr = _mv_350.value;
                {
                    __auto_type cond_c = expr_transpile_expr(ctx, cond_expr);
                    __auto_type body_c = SLOP_STR("({ ");
                    {
                        __auto_type i = 2;
                        while ((i < len)) {
                            __auto_type _mv_351 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_351.has_value) {
                                __auto_type body_expr = _mv_351.value;
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len < 3)) {
            ...
            if (_mv_352.has_value) {
                __auto_type target_expr = _mv_352.value;
                ...
                if (_mv_353.has_value) {
                    ...
                    {
                        __auto_type val_c = expr_transpile_expr(ctx, val_expr);
                        __auto_type _mv_354 = (*target_expr);
                        switch (_mv_354.tag) {
                            case types_SExpr_lst:
                            {
                                __auto_type target_lst = _mv_354.data.lst;
                                {
                                    ...
                                    if ((((int64_t)((target_items).len)) < 1)) {
                                        ...
                                        __auto_type _mv_355 = ({ __auto_type _lst = target_items; size_t _idx = (size_t)0; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_355.has_value) {
                                            __auto_type head = _mv_355.value;
                                            __auto_type _mv_356 = (*head);
                                            switch (_mv_356.tag) {
                                                case types_SExpr_sym:
                                                {
                                                    __auto_type sym = _mv_356.data.sym;
                                                    {
                                                        ...
                                                        if (string_eq(op, SLOP_STR("@"))) {
                                                            if ((((int64_t)((target_items).len)) < 3)) {
                                                                ...
                                                                __auto_type _mv_357 = ({ __auto_type _lst = target_items; size_t _idx = (size_t)1; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                                if (_mv_357.has_value) {
                                                                    __auto_type arr_expr = _mv_357.value;
                                                                    __auto_type _mv_358 = ({ __auto_type _lst = target_items; size_t _idx = (size_t)2; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                                    if (_mv_358.has_value) {
                                                                        __auto_type idx_expr = _mv_358.value;
                                                                        {
                                                                            __auto_type arr_c = expr_transpile_expr(ctx, arr_expr);
                                                                            __auto_type idx_c = expr_transpile_expr(ctx, idx_expr);
                            ...
                            case types_SExpr_sym:
                            {
                                __auto_type sym = _mv_354.data.sym;
                                {
...
slop_string expr_get_arena_for_list_push_expr(context_TranspileContext* ctx, types_SExpr* list_expr, slop_string list_c) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    SLOP_PRE(((list_expr != NULL)), "(!= list-expr nil)");
    __auto_type _mv_359 = context_ctx_lookup_var(ctx, SLOP_STR("arena"));
    if (_mv_359.has_value) {
        __auto_type arena_var = _mv_359.value;
        return arena_var.c_name;
    } else if (!_mv_359.has_value) {
        __auto_type _mv_360 = context_ctx_lookup_var(ctx, SLOP_STR("ctx"));
        if (_mv_360.has_value) {
            __auto_type ctx_var = _mv_360.value;
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_361.data.lst;
            {
                ...
                if ((len < 3)) {
                    ...
                    __auto_type _mv_362 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_362.has_value) {
                        ...
                        switch (_mv_363.tag) {
                            case types_SExpr_sym:
                            {
                                __auto_type sym = _mv_363.data.sym;
                                if (string_eq(sym.name, SLOP_STR("."))) {
                                    __auto_type _mv_364 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    if (_mv_364.has_value) {
                                        __auto_type base_expr = _mv_364.value;
...
slop_string expr_get_arena_from_base(context_TranspileContext* ctx, types_SExpr* base_expr) {
    ...
    __auto_type _mv_365 = (*base_expr);
    switch (_mv_365.tag) {
        case types_SExpr_sym:
        {
            __auto_type sym = _mv_365.data.sym;
            {
                __auto_type var_name = sym.name;
                __auto_type _mv_366 = context_ctx_lookup_var(ctx, var_name);
                if (_mv_366.has_value) {
                    __auto_type entry = _mv_366.value;
                    if (entry.is_pointer) {
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_365.data.lst;
            {
                __auto_type items = lst.items;
                if ((((int64_t)((items).len)) < 2)) {
                    return SLOP_STR("arena");
                } else {
                    __auto_type _mv_367 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_367.has_value) {
                        __auto_type head_expr = _mv_367.value;
                        __auto_type _mv_368 = (*head_expr);
                        switch (_mv_368.tag) {
                            case types_SExpr_sym:
                            {
                                __auto_type sym = _mv_368.data.sym;
                                if (string_eq(sym.name, SLOP_STR("deref"))) {
                                    __auto_type _mv_369 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len < 2)) {
            ...
            if (_mv_372.has_value) {
                __auto_type type_expr = _mv_372.value;
                __auto_type _mv_373 = (*type_expr);
                switch (_mv_373.tag) {
                    case types_SExpr_sym:
                    {
                        __auto_type type_sym = _mv_373.data.sym;
                        {
                            __auto_type raw_type_name = type_sym.name;
                    ...
                    case types_SExpr_lst:
                    {
                        __auto_type type_lst = _mv_373.data.lst;
                        {
                            ...
                            if ((((int64_t)((type_items).len)) < 1)) {
                                ...
                                __auto_type _mv_374 = ({ __auto_type _lst = type_items; size_t _idx = (size_t)0; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_374.has_value) {
                                    __auto_type head = _mv_374.value;
                                    __auto_type _mv_375 = (*head);
                                    switch (_mv_375.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type head_sym = _mv_375.data.sym;
...
slop_string expr_transpile_record_fields(context_TranspileContext* ctx, slop_string type_name, slop_list_types_SExpr_ptr items, int64_t start_idx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        __auto_type first = 1;
        while ((i < len)) {
            __auto_type _mv_376 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_376.has_value) {
                ...
                switch (_mv_377.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type field_lst = _mv_377.data.lst;
                        {
                            __auto_type field_items = field_lst.items;
                            if ((((int64_t)((field_items).len)) >= 2)) {
                                __auto_type _mv_378 = ({ __auto_type _lst = field_items; size_t _idx = (size_t)0; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_378.has_value) {
                                    __auto_type name_expr = _mv_378.value;
                                    __auto_type _mv_379 = (*name_expr);
                                    switch (_mv_379.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type name_sym = _mv_379.data.sym;
                                            __auto_type _mv_380 = ({ __auto_type _lst = field_items; size_t _idx = (size_t)1; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_string expr_build_inline_struct_type(context_TranspileContext* ctx, slop_list_types_SExpr_ptr type_items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        __auto_type i = 1;
        while ((i < len)) {
            __auto_type _mv_381 = ({ __auto_type _lst = type_items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_381.has_value) {
                __auto_type field_expr = _mv_381.value;
                __auto_type _mv_382 = (*field_expr);
                switch (_mv_382.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type field_lst = _mv_382.data.lst;
                        {
                            __auto_type field_items = field_lst.items;
                            if ((((int64_t)((field_items).len)) >= 2)) {
                                __auto_type _mv_383 = ({ __auto_type _lst = field_items; size_t _idx = (size_t)0; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_383.has_value) {
                                    ...
                                    switch (_mv_384.tag) {
                                        case types_SExpr_sym:
                                        {
                                            ...
                                            __auto_type _mv_385 = ({ __auto_type _lst = field_items; size_t _idx = (size_t)1; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while ((i < len)) {
            ...
            if (_mv_386.has_value) {
                __auto_type field_expr = _mv_386.value;
                __auto_type _mv_387 = (*field_expr);
                switch (_mv_387.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type field_lst = _mv_387.data.lst;
                        {
                            __auto_type field_items = field_lst.items;
                            if ((((int64_t)((field_items).len)) >= 2)) {
                                __auto_type _mv_388 = ({ __auto_type _lst = field_items; size_t _idx = (size_t)0; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_388.has_value) {
                                    ...
                                    switch (_mv_389.tag) {
                                        case types_SExpr_sym:
                                        {
                                            ...
                                            __auto_type _mv_390 = ({ __auto_type _lst = field_items; size_t _idx = (size_t)1; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_390.has_value) {
                                                __auto_type val_expr = _mv_390.value;
                                                {
                                                    __auto_type field_name = ctype_to_c_name(arena, name_sym.name);
                    ...
                    __auto_type elem_count = (len - 2);
                    {
                        ...
                        while ((i < len)) {
                            ...
                            if (_mv_392.has_value) {
                                __auto_type elem_expr = _mv_392.value;
                                {
...
slop_string expr_get_map_key_c_info(context_TranspileContext* ctx, types_SExpr* key_type_expr) {
    ...
    __auto_type _mv_393 = (*key_type_expr);
    switch (_mv_393.tag) {
        case types_SExpr_sym:
        {
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_393.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    __auto_type _mv_394 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_394.has_value) {
                        __auto_type head = _mv_394.value;
                        __auto_type _mv_395 = (*head);
                        switch (_mv_395.tag) {
                            case types_SExpr_sym:
                            {
...
slop_string expr_get_struct_key_info_by_name(context_TranspileContext* ctx, slop_string name) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    __auto_type _mv_396 = context_ctx_lookup_type(ctx, name);
    if (_mv_396.has_value) {
        __auto_type type_entry = _mv_396.value;
        {
            __auto_type c_name = type_entry.c_name;
            context_ctx_register_struct_key_type(ctx, c_name);
            return expr_build_struct_key_info(ctx, c_name);
        ...
        __auto_type _mv_397 = context_ctx_get_module(ctx);
        if (_mv_397.has_value) {
            __auto_type mod = _mv_397.value;
            {
                __auto_type prefixed = context_ctx_str3(ctx, mod, SLOP_STR("_"), name);
                __auto_type _mv_398 = context_ctx_lookup_type(ctx, prefixed);
                if (_mv_398.has_value) {
                    __auto_type type_entry = _mv_398.value;
                    {
                        __auto_type c_name = type_entry.c_name;
                        context_ctx_register_struct_key_type(ctx, c_name);
                        return expr_build_struct_key_info(ctx, c_name);
        ...
        if ((len < 3)) {
            if ((len < 2)) {
                ...
                if (_mv_399.has_value) {
                    __auto_type arena_expr = _mv_399.value;
                    {
                        __auto_type arena_c = expr_transpile_expr(ctx, arena_expr);
            ...
            if (_mv_400.has_value) {
                __auto_type arena_expr = _mv_400.value;
                __auto_type _mv_401 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_401.has_value) {
                    __auto_type key_type_expr = _mv_401.value;
                    {
                        __auto_type arena_c = expr_transpile_expr(ctx, arena_expr);
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len < 4)) {
            ...
            if (_mv_402.has_value) {
                __auto_type map_expr = _mv_402.value;
                __auto_type _mv_403 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_403.has_value) {
                    __auto_type key_expr = _mv_403.value;
                    __auto_type _mv_404 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len < 3)) {
            ...
            if (_mv_405.has_value) {
                __auto_type map_expr = _mv_405.value;
                __auto_type _mv_406 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_406.has_value) {
                    __auto_type key_expr = _mv_406.value;
                    {
                        __auto_type map_c = expr_transpile_expr(ctx, map_expr);
                        __auto_type key_c = expr_transpile_expr(ctx, key_expr);
                        __auto_type key_ptr = expr_wrap_map_key_as_ptr(ctx, key_c, key_expr, map_expr);
...
slop_string expr_transpile_map_has(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len < 3)) {
            ...
            __auto_type _mv_407 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_407.has_value) {
                __auto_type map_expr = _mv_407.value;
                __auto_type _mv_408 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_408.has_value) {
                    __auto_type key_expr = _mv_408.value;
                    {
                        __auto_type map_c = expr_transpile_expr(ctx, map_expr);
                        __auto_type key_c = expr_transpile_expr(ctx, key_expr);
                        __auto_type key_ptr = expr_wrap_map_key_as_ptr(ctx, key_c, key_expr, map_expr);
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len < 2)) {
            ...
            if (_mv_409.has_value) {
                __auto_type map_expr = _mv_409.value;
                {
                    __auto_type map_c = expr_transpile_expr(ctx, map_expr);
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len < 3)) {
            ...
            if (_mv_410.has_value) {
                __auto_type arena_expr = _mv_410.value;
                __auto_type _mv_411 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_411.has_value) {
                    __auto_type elem_type_expr = _mv_411.value;
                    {
                        __auto_type arena_c = expr_transpile_expr(ctx, arena_expr);
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len < 3)) {
            ...
            if (_mv_412.has_value) {
                __auto_type set_expr = _mv_412.value;
                __auto_type _mv_413 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_413.has_value) {
                    __auto_type elem_expr = _mv_413.value;
                    {
...
slop_string expr_transpile_set_has(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len < 3)) {
            ...
            __auto_type _mv_414 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_414.has_value) {
                __auto_type set_expr = _mv_414.value;
                __auto_type _mv_415 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_415.has_value) {
                    __auto_type elem_expr = _mv_415.value;
                    {
                        __auto_type set_c = expr_transpile_expr(ctx, set_expr);
                        __auto_type elem_c = expr_transpile_expr(ctx, elem_expr);
                        __auto_type elem_ptr = expr_wrap_map_key_as_ptr(ctx, elem_c, elem_expr, set_expr);
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len < 3)) {
            ...
            if (_mv_416.has_value) {
                __auto_type set_expr = _mv_416.value;
                __auto_type _mv_417 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_417.has_value) {
                    __auto_type elem_expr = _mv_417.value;
                    {
                        __auto_type set_c = expr_transpile_expr(ctx, set_expr);
                        __auto_type elem_c = expr_transpile_expr(ctx, elem_expr);
                        __auto_type elem_ptr = expr_wrap_map_key_as_ptr(ctx, elem_c, elem_expr, set_expr);
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len < 2)) {
            ...
            if (_mv_418.has_value) {
                __auto_type set_expr = _mv_418.value;
                {
                    __auto_type set_c = expr_transpile_expr(ctx, set_expr);
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len < 2)) {
            ...
            if (_mv_419.has_value) {
                __auto_type type_expr = _mv_419.value;
                {
                    ...
                    __auto_type result = context_ctx_str(ctx, SLOP_STR("({ slop_map* _s = slop_map_new_ptr(arena, "), context_ctx_str(ctx, int_to_string(arena, init_cap), context_ctx_str(ctx, SLOP_STR(", "), context_ctx_str(ctx, elem_info, SLOP_STR("); ")))));
                    {
                        ...
                        while ((i < len)) {
                            ...
                            if (_mv_420.has_value) {
                                __auto_type elem_expr = _mv_420.value;
                                {
                                    __auto_type elem_c = expr_transpile_expr(ctx, elem_expr);
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len < 2)) {
            ...
            if (_mv_421.has_value) {
                __auto_type binding_expr = _mv_421.value;
                __auto_type _mv_422 = (*binding_expr);
                switch (_mv_422.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type binding_lst = _mv_422.data.lst;
                        {
                            ...
                            if ((binding_len < 3)) {
                                ...
                                __auto_type _mv_423 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)0; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_423.has_value) {
                                    __auto_type var_expr = _mv_423.value;
                                    __auto_type _mv_424 = (*var_expr);
                                    switch (_mv_424.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type var_sym = _mv_424.data.sym;
                                            {
                                                __auto_type var_name = ctype_to_c_name(arena, var_sym.name);
                                                __auto_type _mv_425 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)1; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_425.has_value) {
                                                    __auto_type start_expr = _mv_425.value;
                                                    __auto_type _mv_426 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)2; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_426.has_value) {
                                                        __auto_type end_expr = _mv_426.value;
                                                        {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len < 2)) {
            ...
            if (_mv_428.has_value) {
                __auto_type binding_expr = _mv_428.value;
                __auto_type _mv_429 = (*binding_expr);
                switch (_mv_429.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type binding_lst = _mv_429.data.lst;
                        {
                            __auto_type binding_items = binding_lst.items;
                            __auto_type binding_len = ((int64_t)((binding_items).len));
                            if ((binding_len < 2)) {
                                ...
                                __auto_type _mv_430 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)0; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_430.has_value) {
                                    __auto_type var_expr = _mv_430.value;
                                    __auto_type _mv_431 = (*var_expr);
                                    switch (_mv_431.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type var_sym = _mv_431.data.sym;
                                            {
                                                __auto_type var_name = ctype_to_c_name(arena, var_sym.name);
                                                __auto_type _mv_432 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)1; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_432.has_value) {
                                                    __auto_type coll_expr = _mv_432.value;
                                                    {
                                                        ...
                                                        context_ctx_bind_var(ctx, (context_VarEntry){var_sym.name, var_name, SLOP_STR("auto"), elem_slop_type, 0, 0, 0, SLOP_STR(""), SLOP_STR("")});
                                                        {
                                                            ...
                                                            while ((i < len)) {
                                                                ...
                                                                if (_mv_433.has_value) {
                                                                    __auto_type body_expr = _mv_433.value;
                                                                    {
                                                                        __auto_type body_c = expr_transpile_expr(ctx, body_expr);
                                                                        result = context_ctx_str3(ctx, result, body_c, SLOP_STR("; "));
                                                                    }
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len < 2)) {
            ...
            if (_mv_434.has_value) {
                __auto_type second = _mv_434.value;
                __auto_type _mv_435 = (*second);
                switch (_mv_435.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type params_lst = _mv_435.data.lst;
                        return expr_transpile_lambda_with_params(ctx, items, params_lst.items);
                    }
                    case types_SExpr_sym:
                    {
                        __auto_type _ = _mv_435.data.sym;
...
slop_list_string expr_extract_param_names(slop_arena* arena, slop_list_types_SExpr_ptr params) {
    {
        ...
        __auto_type i = 0;
        while ((i < count)) {
            __auto_type _mv_436 = ({ __auto_type _lst = params; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_436.has_value) {
                __auto_type param_expr = _mv_436.value;
                __auto_type _mv_437 = (*param_expr);
                switch (_mv_437.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type param_lst = _mv_437.data.lst;
                        {
                            __auto_type param_items = param_lst.items;
                            if ((((int64_t)((param_items).len)) >= 1)) {
                                __auto_type _mv_438 = ({ __auto_type _lst = param_items; size_t _idx = (size_t)0; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_string expr_build_closure_struct(context_TranspileContext* ctx, slop_string env_type, slop_list_string free_vars) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        __auto_type i = 0;
        while ((i < count)) {
            __auto_type _mv_440 = ({ __auto_type _lst = free_vars; size_t _idx = (size_t)i; slop_option_string _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_440.has_value) {
                __auto_type var_name = _mv_440.value;
                {
...
void expr_bind_closure_captures(context_TranspileContext* ctx, slop_list_string free_vars) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        __auto_type i = 0;
        while ((i < count)) {
            __auto_type _mv_441 = ({ __auto_type _lst = free_vars; size_t _idx = (size_t)i; slop_option_string _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_441.has_value) {
                __auto_type var_name = _mv_441.value;
                {
                    __auto_type c_name = ctype_to_c_name(arena, var_name);
...
slop_string expr_build_env_initializer(context_TranspileContext* ctx, slop_list_string free_vars) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        __auto_type i = 0;
        while ((i < count)) {
            __auto_type _mv_442 = ({ __auto_type _lst = free_vars; size_t _idx = (size_t)i; slop_option_string _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_442.has_value) {
                __auto_type var_name = _mv_442.value;
                {
                    __auto_type c_name = ctype_to_c_name(arena, var_name);
                    if ((i > 0)) {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((param_count == 0)) {
        ...
        } else {
            {
                ...
                __auto_type i = 0;
                while ((i < param_count)) {
                    __auto_type _mv_443 = ({ __auto_type _lst = params; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_443.has_value) {
                        __auto_type param_expr = _mv_443.value;
                        __auto_type _mv_444 = (*param_expr);
                        switch (_mv_444.tag) {
                            case types_SExpr_lst:
                            {
                                __auto_type param_lst = _mv_444.data.lst;
                                {
                                    __auto_type param_items = param_lst.items;
                                    if ((((int64_t)((param_items).len)) >= 2)) {
                                        __auto_type _mv_445 = ({ __auto_type _lst = param_items; size_t _idx = (size_t)0; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_445.has_value) {
                                            ...
                                            switch (_mv_446.tag) {
                                                case types_SExpr_sym:
                                                {
                                                    ...
                                                    __auto_type _mv_447 = ({ __auto_type _lst = param_items; size_t _idx = (size_t)1; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void expr_bind_lambda_params(context_TranspileContext* ctx, slop_list_types_SExpr_ptr params) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        __auto_type i = 0;
        while ((i < param_count)) {
            __auto_type _mv_448 = ({ __auto_type _lst = params; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_448.has_value) {
                __auto_type param_expr = _mv_448.value;
                __auto_type _mv_449 = (*param_expr);
                switch (_mv_449.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type param_lst = _mv_449.data.lst;
                        {
                            __auto_type param_items = param_lst.items;
                            if ((((int64_t)((param_items).len)) >= 2)) {
                                __auto_type _mv_450 = ({ __auto_type _lst = param_items; size_t _idx = (size_t)0; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_450.has_value) {
                                    ...
                                    switch (_mv_451.tag) {
                                        case types_SExpr_sym:
                                        {
                                            ...
                                            __auto_type _mv_452 = ({ __auto_type _lst = param_items; size_t _idx = (size_t)1; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
uint8_t expr_is_pointer_type_sexpr(types_SExpr* type_expr) {
    __auto_type _mv_453 = (*type_expr);
    switch (_mv_453.tag) {
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_453.data.lst;
            {
                __auto_type items = lst.items;
                if ((((int64_t)((items).len)) < 1)) {
                    return 0;
                } else {
                    __auto_type _mv_454 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_454.has_value) {
                        __auto_type head = _mv_454.value;
                        __auto_type _mv_455 = (*head);
                        switch (_mv_455.tag) {
                            case types_SExpr_sym:
                            {
                                __auto_type sym = _mv_455.data.sym;
                                return (string_eq(sym.name, SLOP_STR("Ptr")) || string_eq(sym.name, SLOP_STR("ScopedPtr")));
                            }
                            default: {
                                return 0;
        ...
        if ((len <= start)) {
            ...
            while ((i < len)) {
                ...
                if (_mv_456.has_value) {
                    __auto_type expr = _mv_456.value;
                    {
                        __auto_type expr_c = expr_transpile_expr(ctx, expr);
                        __auto_type is_last = (i == (len - 1));
                        if (is_last) {
                            result = context_ctx_str(ctx, result, context_ctx_str(ctx, SLOP_STR("("), context_ctx_str(ctx, expr_c, SLOP_STR(", 0); return 0;"))));
                        } else {
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_457.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 2)) {
                    ...
                    __auto_type _mv_458 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        ...
                        switch (_mv_459.tag) {
                            case types_SExpr_sym:
                            {
                                ...
                                if (!(string_eq(sym.name, SLOP_STR("fn")))) {
                                    ...
                                    __auto_type _mv_460 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    if (_mv_460.has_value) {
                                        __auto_type second = _mv_460.value;
                                        __auto_type _mv_461 = (*second);
                                        switch (_mv_461.tag) {
                                            case types_SExpr_lst:
                                            {
                                                __auto_type _ = _mv_461.data.lst;
                                                return 1;
                                            }
                                            default: {
                                                return 0;
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_463.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 2)) {
                    ...
                    __auto_type _mv_464 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_464.has_value) {
                        __auto_type params_expr = _mv_464.value;
                        __auto_type _mv_465 = (*params_expr);
                        switch (_mv_465.tag) {
                            case types_SExpr_lst:
                            {
                                __auto_type params_lst = _mv_465.data.lst;
                                {
...
slop_list_string expr_find_free_vars(context_TranspileContext* ctx, slop_list_string param_names, slop_list_types_SExpr_ptr body_items, int64_t start) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        __auto_type i = start;
        while ((i < len)) {
            __auto_type _mv_467 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_467.has_value) {
                __auto_type expr = _mv_467.value;
        ...
        }
        {
            ...
            __auto_type j = 0;
            while ((j < sym_count)) {
                __auto_type _mv_468 = ({ __auto_type _lst = all_symbols; size_t _idx = (size_t)j; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_468.has_value) {
                    __auto_type sym_name = _mv_468.value;
    ...
    switch (_mv_469.tag) {
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_469.data.lst;
            {
                ...
                __auto_type len = ((int64_t)((items).len));
                if ((len > 0)) {
                    __auto_type _mv_470 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_470.has_value) {
                        __auto_type head = _mv_470.value;
                        __auto_type _mv_471 = (*head);
                        switch (_mv_471.tag) {
                            case types_SExpr_sym:
                            {
                                __auto_type head_sym = _mv_471.data.sym;
                                {
                                    __auto_type op = head_sym.name;
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len >= 2)) {
            ...
            if (_mv_473.has_value) {
                __auto_type bindings_expr = _mv_473.value;
                __auto_type _mv_474 = (*bindings_expr);
                switch (_mv_474.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type bindings_lst = _mv_474.data.lst;
                        {
                            __auto_type bindings = bindings_lst.items;
                            __auto_type binding_count = ((int64_t)((bindings).len));
                            __auto_type i = 0;
                            while ((i < binding_count)) {
                                __auto_type _mv_475 = ({ __auto_type _lst = bindings; size_t _idx = (size_t)i; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_475.has_value) {
                                    __auto_type binding = _mv_475.value;
                                    __auto_type _mv_476 = (*binding);
                                    switch (_mv_476.tag) {
                                        case types_SExpr_lst:
                                        {
                                            __auto_type bind_lst = _mv_476.data.lst;
                                            {
                                                __auto_type bind_items = bind_lst.items;
                                                if ((((int64_t)((bind_items).len)) >= 2)) {
                                                    {
                                                        __auto_type val_idx = ((expr_is_mut_binding(bind_items)) ? 2 : 1);
                                                        __auto_type _mv_477 = ({ __auto_type _lst = bind_items; size_t _idx = (size_t)val_idx; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
uint8_t expr_is_mut_binding(slop_list_types_SExpr_ptr items) {
    if ((((int64_t)((items).len)) < 1)) {
        ...
        __auto_type _mv_478 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        if (_mv_478.has_value) {
            __auto_type first = _mv_478.value;
            __auto_type _mv_479 = (*first);
            switch (_mv_479.tag) {
                case types_SExpr_sym:
                {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len >= 2)) {
            ...
            if (_mv_480.has_value) {
                __auto_type scrutinee = _mv_480.value;
            ...
            }
            {
                ...
                while ((i < len)) {
                    ...
                    if (_mv_481.has_value) {
                        __auto_type clause = _mv_481.value;
                        __auto_type _mv_482 = (*clause);
                        switch (_mv_482.tag) {
                            case types_SExpr_lst:
                            {
                                __auto_type clause_lst = _mv_482.data.lst;
                                {
                                    __auto_type clause_items = clause_lst.items;
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len >= 2)) {
            ...
            if (_mv_483.has_value) {
                __auto_type binding = _mv_483.value;
                __auto_type _mv_484 = (*binding);
                switch (_mv_484.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type bind_lst = _mv_484.data.lst;
                        {
                            __auto_type bind_items = bind_lst.items;
...
uint8_t expr_is_free_var(context_TranspileContext* ctx, slop_list_string param_names, slop_string sym_name) {
    ...
    if (expr_list_contains_string(param_names, sym_name)) {
        ...
        if (expr_is_builtin_op(sym_name)) {
            ...
            __auto_type _mv_485 = context_ctx_lookup_func(ctx, sym_name);
            if (_mv_485.has_value) {
                __auto_type _ = _mv_485.value;
                return 0;
            } else if (!_mv_485.has_value) {
                __auto_type _mv_486 = context_ctx_lookup_type(ctx, sym_name);
                if (_mv_486.has_value) {
                    __auto_type _ = _mv_486.value;
                    return 0;
                } else if (!_mv_486.has_value) {
                    __auto_type _mv_487 = context_ctx_lookup_var(ctx, sym_name);
                    if (_mv_487.has_value) {
                        __auto_type _ = _mv_487.value;
                        return 1;
...
uint8_t expr_list_contains_string(slop_list_string lst, slop_string needle) {
    {
        ...
        __auto_type found = 0;
        while (((i < len) && !(found))) {
            __auto_type _mv_488 = ({ __auto_type _lst = lst; size_t _idx = (size_t)i; slop_option_string _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_488.has_value) {
                __auto_type s = _mv_488.value;
...
slop_string expr_infer_result_ok_slop_type(context_TranspileContext* ctx, types_SExpr* scrutinee) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_489 = (*scrutinee);
        switch (_mv_489.tag) {
            case types_SExpr_sym:
            {
                __auto_type sym = _mv_489.data.sym;
                __auto_type _mv_490 = context_ctx_lookup_var(ctx, sym.name);
                if (_mv_490.has_value) {
                    __auto_type var_entry = _mv_490.value;
                    {
                        __auto_type slop_type = var_entry.slop_type;
...
slop_string expr_infer_result_err_slop_type(context_TranspileContext* ctx, types_SExpr* scrutinee) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_491 = (*scrutinee);
        switch (_mv_491.tag) {
            case types_SExpr_sym:
            {
                __auto_type sym = _mv_491.data.sym;
                __auto_type _mv_492 = context_ctx_lookup_var(ctx, sym.name);
                if (_mv_492.has_value) {
                    __auto_type var_entry = _mv_492.value;
                    {
                        __auto_type slop_type = var_entry.slop_type;
                        if (strlib_starts_with(slop_type, SLOP_STR("(Result "))) {
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_493.data.lst;
                {
                    ...
                    if ((((int64_t)((items).len)) < 1)) {
                        ...
                        __auto_type _mv_494 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_494.has_value) {
                            __auto_type head = _mv_494.value;
                            __auto_type _mv_495 = (*head);
                            switch (_mv_495.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type sym = _mv_495.data.sym;
                                    {
                                        __auto_type op = sym.name;
                                        if (string_eq(op, SLOP_STR("map-keys"))) {
                                            if ((((int64_t)((items).len)) < 2)) {
                                                ...
                                                __auto_type _mv_496 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            ...
                                            if ((((int64_t)((items).len)) < 2)) {
                                                ...
                                                __auto_type _mv_497 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; struct { bool has_value; __typeof__(_lst.data[0]) value; } _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_497.has_value) {
                                                    __auto_type set_expr = _mv_497.value;
                                                    {
                                            ...
                                            if ((((int64_t)((items).len)) < 2)) {
                                                ...
                                                if (_mv_498.has_value) {
                                                    __auto_type map_expr = _mv_498.value;
                                                    {
                                                        __auto_type map_slop_type = expr_infer_expr_slop_type(ctx, map_expr);
                                                        if ((string_len(map_slop_type) > 0)) {
                                                            {
