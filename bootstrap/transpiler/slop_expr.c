...
slop_option_string expr_option_type_for_type_name(context_TranspileContext* ctx, slop_string name) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    __auto_type _mv_169 = context_ctx_lookup_type(ctx, name);
    if (_mv_169.has_value) {
        __auto_type type_entry = _mv_169.value;
...
slop_string expr_option_type_from_ctor_arg(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items, slop_string op) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (_mv_170.has_value) {
            __auto_type type_expr = _mv_170.value;
            __auto_type _mv_171 = (*type_expr);
            switch (_mv_171.tag) {
                case types_SExpr_sym:
                {
                    __auto_type type_sym = _mv_171.data.sym;
                    {
                        __auto_type type_name = type_sym.name;
                        __auto_type _mv_172 = expr_option_type_for_type_name(ctx, type_name);
                        if (_mv_172.has_value) {
                            __auto_type opt_type = _mv_172.value;
                            return opt_type;
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 1) {
            ...
            if (_mv_173.has_value) {
                __auto_type head_expr = _mv_173.value;
                __auto_type _mv_174 = (*head_expr);
                switch (_mv_174.tag) {
                    case types_SExpr_sym:
                    {
                        __auto_type sym = _mv_174.data.sym;
                        {
                            ...
                            if (string_eq(op, SLOP_STR("."))) {
                                ...
                                __auto_type _mv_177 = context_ctx_lookup_func(ctx, op);
                                if (_mv_177.has_value) {
                                    __auto_type func_entry = _mv_177.value;
                                    {
                                    ...
                                    __auto_type _mv_178 = expr_option_type_for_type_name(ctx, op);
                                    if (_mv_178.has_value) {
                                        __auto_type opt_type = _mv_178.value;
                                        return opt_type;
...
slop_string expr_infer_list_element_option_type(context_TranspileContext* ctx, types_SExpr* list_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_179 = ctype_get_node_resolved_type(list_expr);
        if (_mv_179.has_value) {
            __auto_type rt = _mv_179.value;
            __auto_type _mv_180 = (*rt).inner_type;
            if (_mv_180.has_value) {
                __auto_type elem_type = _mv_180.value;
                {
        ...
        if (strlib_ends_with(elem_type, SLOP_STR("_ptr"))) {
            {
                ...
                __auto_type _mv_187 = context_ctx_lookup_type(ctx, base);
            ...
            __auto_type _mv_188 = context_ctx_lookup_type(ctx, elem_type);
...
slop_string expr_slop_value_type_to_c_type(context_TranspileContext* ctx, slop_string slop_type) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (strlib_starts_with(slop_type, SLOP_STR("(Map "))) {
            ...
            __auto_type _mv_189 = context_ctx_lookup_type(ctx, slop_type);
            if (_mv_189.has_value) {
                __auto_type entry = _mv_189.value;
                return entry.c_name;
...
slop_string expr_resolve_type_alias(context_TranspileContext* ctx, slop_string slop_type) {
    ...
    if (strlib_starts_with(slop_type, SLOP_STR("(Map "))) {
        ...
        __auto_type _mv_191 = context_ctx_lookup_type_alias(ctx, slop_type);
        if (_mv_191.has_value) {
            __auto_type alias_def = _mv_191.value;
            return alias_def;
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_192.data.lst;
                {
                    ...
                    if (len < 1) {
                        ...
                        __auto_type _mv_194 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_194.has_value) {
                            __auto_type head = _mv_194.value;
                            __auto_type _mv_195 = (*head);
                            switch (_mv_195.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type head_sym = _mv_195.data.sym;
                                    {
                                        ...
                                        if (string_eq(op, SLOP_STR(".")) && (len >= 3)) {
                                            ...
                                            if (_mv_196.has_value) {
                                                __auto_type obj_expr = _mv_196.value;
                                                __auto_type _mv_197 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                        ...
                                                        case types_SExpr_sym:
                                                        {
                                                            __auto_type field_sym = _mv_198.data.sym;
                                                            {
                                                                __auto_type field_name = field_sym.name;
                                                                {
                                                                    ...
                                                                    __auto_type _mv_199 = context_ctx_lookup_field_slop_type(ctx, obj_c_type, field_name);
                                                                    if (_mv_199.has_value) {
                                                                        __auto_type slop_type = _mv_199.value;
                                                                        return slop_type;
                                                                    } else if (!_mv_199.has_value) {
                                                                        {
                                                                            ...
                                                                            __auto_type _mv_200 = context_ctx_lookup_field_slop_type(ctx, obj_slop_type, field_name);
                                                                            if (_mv_200.has_value) {
                                                                                __auto_type slop_type2 = _mv_200.value;
                                                                                return slop_type2;
                                            ...
                                            if (len >= 2) {
                                                ...
                                                if (_mv_201.has_value) {
                                                    ...
                                                    __auto_type _mv_202 = (*type_expr);
                                                    switch (_mv_202.tag) {
                                                        case types_SExpr_sym:
                                                        {
                                                            __auto_type type_sym = _mv_202.data.sym;
                                            ...
                                            if (len >= 4) {
                                                ...
                                                if (_mv_203.has_value) {
                                                    __auto_type key_expr = _mv_203.value;
                                                    __auto_type _mv_204 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_204.has_value) {
                                                        __auto_type val_expr = _mv_204.value;
                                                        {
                                            ...
                                            if (len >= 3) {
                                                __auto_type _mv_205 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_205.has_value) {
                                                    __auto_type elem_expr = _mv_205.value;
                                                    {
                                            ...
                                            if (len >= 2) {
                                                ...
                                                if (_mv_206.has_value) {
                                                    __auto_type elem_expr = _mv_206.value;
                                                    {
                                                        __auto_type elem_str = ctype_sexpr_to_type_string(arena, elem_expr);
                                                        return context_ctx_str3(ctx, SLOP_STR("(Set "), elem_str, SLOP_STR(")"));
                                                    }
                                            ...
                                            if (len >= 2) {
                                                ...
                                                if (_mv_207.has_value) {
                                                    __auto_type elem_expr = _mv_207.value;
                                                    {
                                                        __auto_type elem_str = ctype_sexpr_to_type_string(arena, elem_expr);
                                            ...
                                            if (len >= 3) {
                                                __auto_type _mv_208 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_208.has_value) {
                                                    __auto_type elem_expr = _mv_208.value;
                                                    {
                                                        __auto_type elem_str = ctype_sexpr_to_type_string(arena, elem_expr);
                                                        return context_ctx_str3(ctx, SLOP_STR("(List "), elem_str, SLOP_STR(")"));
                                                    }
                                            ...
                                            if (len >= 4) {
                                                ...
                                                if (_mv_209.has_value) {
                                                    __auto_type type_expr = _mv_209.value;
                                                    {
                                            ...
                                            if (len >= 3) {
                                                ...
                                                if (_mv_210.has_value) {
                                                    __auto_type type_expr = _mv_210.value;
                                                    {
                                                        __auto_type type_str = ctype_sexpr_to_type_string(arena, type_expr);
                                                        return context_ctx_str3(ctx, SLOP_STR("(Ptr (Chan "), type_str, SLOP_STR("))"));
                                                    }
                                            ...
                                            if (_mv_211.has_value) {
                                                __auto_type inner_expr = _mv_211.value;
                                            ...
                                            __auto_type _mv_212 = context_ctx_lookup_func(ctx, op);
                                            if (_mv_212.has_value) {
                                                __auto_type func_entry = _mv_212.value;
                            ...
                            __auto_type lst = _mv_219.data.lst;
                            {
                                ...
                                if (len < 2) {
                                    ...
                                    if (_mv_220.has_value) {
                                        __auto_type head_expr = _mv_220.value;
                                        __auto_type _mv_221 = (*head_expr);
                                        switch (_mv_221.tag) {
                                            case types_SExpr_sym:
                                            {
                                                    ...
                                                    if (string_eq(op, SLOP_STR("map-get"))) {
                                                        if (len < 2) {
                                                            ...
                                                            if (_mv_222.has_value) {
                                                                __auto_type map_expr = _mv_222.value;
                                                                __auto_type _mv_223 = (*map_expr);
                                                                switch (_mv_223.tag) {
                                                                    case types_SExpr_sym:
                                                                    {
                                                                        __auto_type map_sym = _mv_223.data.sym;
                                                                        {
                                                                            __auto_type map_name = map_sym.name;
                                                                            __auto_type _mv_224 = context_ctx_lookup_var(ctx, map_name);
                                                        ...
                                                        if (len < 2) {
                                                            ...
                                                            if (_mv_225.has_value) {
                                                                __auto_type list_expr = _mv_225.value;
                                                                __auto_type _mv_226 = (*list_expr);
                                                                switch (_mv_226.tag) {
                                                                    case types_SExpr_sym:
                                                                    {
                                                                        __auto_type list_sym = _mv_226.data.sym;
                                                                        {
                                                                            __auto_type list_name = list_sym.name;
                                                                            __auto_type _mv_227 = context_ctx_lookup_var(ctx, list_name);
...
slop_string expr_fix_ternary_none(context_TranspileContext* ctx, types_SExpr* other_expr, slop_string other_branch, slop_string this_branch) {
    ...
    if (string_eq(this_branch, SLOP_STR("none")) && strlib_starts_with(other_branch, SLOP_STR("(slop_option_"))) {
        {
            __auto_type arena = (*ctx).arena;
            __auto_type _mv_228 = expr_extract_option_type(arena, other_branch);
            if (_mv_228.has_value) {
                __auto_type opt_type = _mv_228.value;
...
slop_string expr_transpile_array_index(context_TranspileContext* ctx, types_SExpr* arr_expr, slop_string arr_c, slop_string idx_c) {
    ...
    __auto_type _mv_229 = (*arr_expr);
    switch (_mv_229.tag) {
        case types_SExpr_sym:
        {
            __auto_type sym = _mv_229.data.sym;
            {
                __auto_type name = sym.name;
                __auto_type _mv_230 = context_ctx_lookup_var(ctx, name);
                if (_mv_230.has_value) {
                    __auto_type var_entry = _mv_230.value;
                    {
                        __auto_type c_type = var_entry.c_type;
...
uint8_t expr_is_pointer_expr(context_TranspileContext* ctx, types_SExpr* expr) {
    ...
    switch (_mv_231.tag) {
        case types_SExpr_sym:
        {
            ...
            {
                __auto_type name = sym.name;
                __auto_type _mv_232 = context_ctx_lookup_var(ctx, name);
                if (_mv_232.has_value) {
                    __auto_type var_entry = _mv_232.value;
            ...
            __auto_type lst = _mv_231.data.lst;
            {
                ...
                if (((int64_t)((items).len)) >= 1) {
                    ...
                    if (_mv_233.has_value) {
                        __auto_type head_ptr = _mv_233.value;
                        __auto_type _mv_234 = (*head_ptr);
                        switch (_mv_234.tag) {
                            case types_SExpr_sym:
                            {
                                    ...
                                    __auto_type head_sym = _mv_238.data.sym;
                                    {
                                        ...
                                        if (string_eq(op, SLOP_STR("sizeof"))) {
                                        ...
                                        } else if (string_eq(op, SLOP_STR("*")) || (string_eq(op, SLOP_STR("+")) || (string_eq(op, SLOP_STR("-")) || string_eq(op, SLOP_STR("/"))))) {
                                            {
                                                ...
                                                while (i < len) {
                                                    __auto_type _mv_240 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_240.has_value) {
                                                        __auto_type arg_expr = _mv_240.value;
                                                        {
...
slop_string expr_transpile_expr(context_TranspileContext* ctx, types_SExpr* expr) {
    ...
    switch (_mv_241.tag) {
        case types_SExpr_num:
        {
            __auto_type _ = _mv_241.data.num;
            return expr_transpile_literal(ctx, expr);
        }
        case types_SExpr_str:
        {
            __auto_type _ = _mv_241.data.str;
            return expr_transpile_literal(ctx, expr);
        }
        case types_SExpr_sym:
        {
            __auto_type _ = _mv_241.data.sym;
            return expr_transpile_literal(ctx, expr);
        }
        case types_SExpr_lst:
        {
...
slop_string expr_transpile_list_expr(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 1) {
            ...
            __auto_type _mv_242 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_242.has_value) {
                __auto_type head_expr = _mv_242.value;
                __auto_type _mv_243 = (*head_expr);
                switch (_mv_243.tag) {
                    case types_SExpr_sym:
                    {
                        __auto_type head_sym = _mv_243.data.sym;
                        {
                            __auto_type op = head_sym.name;
                            if (expr_is_binop(op) && (len < 3)) {
                                ...
                                if (len > 3) {
                                    ...
                                    if (_mv_244.has_value) {
                                        __auto_type left = _mv_244.value;
                                        ...
                                        if (_mv_245.has_value) {
                                            __auto_type right = _mv_245.value;
                                            {
                                ...
                                if (_mv_246.has_value) {
                                    __auto_type left = _mv_246.value;
                                    ...
                                    if (_mv_247.has_value) {
                                        __auto_type right = _mv_247.value;
                                        {
                                            __auto_type left_c = expr_transpile_expr(ctx, left);
                                            __auto_type right_c = expr_transpile_expr(ctx, right);
                                ...
                                if (_mv_249.has_value) {
                                    __auto_type cond_expr = _mv_249.value;
                                    ...
                                    if (_mv_250.has_value) {
                                        __auto_type then_expr = _mv_250.value;
                                        __auto_type _mv_251 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_251.has_value) {
                                            __auto_type else_expr = _mv_251.value;
                                            {
                                ...
                                if (_mv_253.has_value) {
                                    ...
                                    if (_mv_254.has_value) {
                                        __auto_type field_expr = _mv_254.value;
                                        __auto_type _mv_255 = (*field_expr);
                                        switch (_mv_255.tag) {
                                            case types_SExpr_sym:
                                            {
                                                __auto_type field_sym = _mv_255.data.sym;
                                                {
                                ...
                                if (_mv_258.has_value) {
                                    __auto_type str_expr = _mv_258.value;
                                    __auto_type _mv_259 = (*str_expr);
                                    switch (_mv_259.tag) {
                                        case types_SExpr_str:
                                        {
                                            __auto_type str = _mv_259.data.str;
                                            return str.value;
                                        }
                                        default: {
                                ...
                                if (_mv_263.has_value) {
                                    __auto_type arr_expr = _mv_263.value;
                                    ...
                                    if (_mv_264.has_value) {
                                        __auto_type idx_expr = _mv_264.value;
                                        {
                                ...
                                if (_mv_265.has_value) {
                                    ...
                                    if (_mv_266.has_value) {
                                        __auto_type size_expr = _mv_266.value;
                                        {
                                            __auto_type arena_c = expr_transpile_expr(ctx, arena_expr);
                                            __auto_type _mv_267 = (*size_expr);
                                            switch (_mv_267.tag) {
                                                case types_SExpr_sym:
                                                {
                                                    __auto_type sym = _mv_267.data.sym;
                                                    {
                                                        ...
                                                        __auto_type _mv_268 = context_ctx_lookup_type(ctx, type_name);
                                                        if (_mv_268.has_value) {
                                                            __auto_type entry = _mv_268.value;
                                                            {
                                ...
                                if (_mv_269.has_value) {
                                    __auto_type size_expr = _mv_269.value;
                                    {
                                        __auto_type size_c = expr_transpile_expr(ctx, size_expr);
                                ...
                                if (_mv_271.has_value) {
                                    ...
                                    __auto_type _mv_272 = (*variant_expr);
                                    switch (_mv_272.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type sym = _mv_272.data.sym;
                                            {
                                ...
                                if (_mv_273.has_value) {
                                    ...
                                    if (_mv_274.has_value) {
                                        __auto_type tag_expr = _mv_274.value;
                                        __auto_type _mv_275 = (*type_expr);
                                        switch (_mv_275.tag) {
                                            case types_SExpr_sym:
                                            {
                                                __auto_type type_sym = _mv_275.data.sym;
                                                __auto_type _mv_276 = expr_extract_symbol_name(tag_expr);
                                                if (_mv_276.has_value) {
                                                    __auto_type tag_str = _mv_276.value;
                                                    {
                                                        ...
                                                        if (len >= 5) {
                                                            {
                                                                ...
                                                                for (int64_t vi = 3; vi < len; vi++) {
                                                                    __auto_type _mv_277 = ({ __auto_type _lst = items; size_t _idx = (size_t)vi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                                    if (_mv_277.has_value) {
                                                                        __auto_type val_expr = _mv_277.value;
                                                                        {
                                                                            __auto_type val_c = expr_transpile_expr(ctx, val_expr);
                                                            ...
                                                            __auto_type _mv_278 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                            if (_mv_278.has_value) {
                                                                __auto_type val_expr = _mv_278.value;
                                                                {
                                                                    __auto_type val_c = expr_transpile_expr(ctx, val_expr);
                                ...
                                if (_mv_280.has_value) {
                                    __auto_type val_expr = _mv_280.value;
                                    {
                                        __auto_type val_c = expr_transpile_expr(ctx, val_expr);
                                ...
                                if (_mv_281.has_value) {
                                    __auto_type result_expr = _mv_281.value;
                                    {
                                        __auto_type result_c = expr_transpile_expr(ctx, result_expr);
                                        __auto_type _mv_282 = context_ctx_get_current_result_type(ctx);
                                        if (_mv_282.has_value) {
                                            __auto_type enclosing_type = _mv_282.value;
                                ...
                                if (_mv_283.has_value) {
                                    __auto_type opt_expr = _mv_283.value;
                                    {
                                ...
                                if (_mv_284.has_value) {
                                    __auto_type list_expr = _mv_284.value;
                                    {
                                ...
                                if (_mv_290.has_value) {
                                    ...
                                    if (_mv_291.has_value) {
                                        __auto_type item_expr = _mv_291.value;
                                        {
                                            __auto_type list_c = expr_transpile_expr(ctx, list_expr);
                                ...
                                if (_mv_292.has_value) {
                                    __auto_type list_expr = _mv_292.value;
                                    ...
                                    if (_mv_293.has_value) {
                                        __auto_type idx_expr = _mv_293.value;
                                        ...
                                        if (_mv_294.has_value) {
                                            __auto_type val_expr = _mv_294.value;
                                            {
                                                __auto_type list_c = expr_transpile_expr(ctx, list_expr);
                                                __auto_type idx_c = expr_transpile_expr(ctx, idx_expr);
                                                __auto_type val_c = expr_transpile_expr(ctx, val_expr);
                                ...
                                __auto_type _mv_295 = context_ctx_get_current_return_type(ctx);
                                if (_mv_295.has_value) {
                                    __auto_type ret_type = _mv_295.value;
        ...
        if (string_eq(fn_name, SLOP_STR("println"))) {
            ...
            if (len < 3) {
                ...
                if (_mv_299.has_value) {
                    __auto_type a_expr = _mv_299.value;
                    ...
                    if (_mv_300.has_value) {
                        __auto_type b_expr = _mv_300.value;
                        {
            ...
            if (len < 3) {
                ...
                if (_mv_301.has_value) {
                    __auto_type a_expr = _mv_301.value;
                    ...
                    if (_mv_302.has_value) {
                        __auto_type b_expr = _mv_302.value;
                        {
                            __auto_type a_c = expr_transpile_expr(ctx, a_expr);
                            __auto_type b_c = expr_transpile_expr(ctx, b_expr);
                            __auto_type s1 = string_concat(arena, SLOP_STR("(("), a_c);
            ...
            if (len < 3) {
                ...
                if (_mv_303.has_value) {
                    __auto_type fn_expr = _mv_303.value;
            ...
            if (len < 4) {
                ...
                if (_mv_304.has_value) {
                    __auto_type type_expr = _mv_304.value;
                    ...
                    if (_mv_305.has_value) {
                        __auto_type arena_expr = _mv_305.value;
                        __auto_type _mv_306 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_306.has_value) {
                            __auto_type cap_expr = _mv_306.value;
                            {
            ...
            if (len < 3) {
                ...
                if (_mv_307.has_value) {
                    __auto_type type_expr = _mv_307.value;
                    ...
                    if (_mv_308.has_value) {
                        __auto_type arena_expr = _mv_308.value;
                        {
                            __auto_type elem_c = context_to_c_type_prefixed(ctx, type_expr);
                            __auto_type elem_id = ctype_type_to_identifier(arena, elem_c);
                            __auto_type chan_type = context_ctx_str(ctx, SLOP_STR("slop_chan_"), elem_id);
            ...
            if (len < 3) {
                ...
                if (_mv_309.has_value) {
                    __auto_type chan_expr = _mv_309.value;
            ...
            if (len < 2) {
                ...
                if (_mv_311.has_value) {
                    __auto_type chan_expr = _mv_311.value;
                    {
                        __auto_type chan_c = expr_transpile_expr(ctx, chan_expr);
                        __auto_type chan_c_type = expr_infer_expr_c_type(ctx, chan_expr);
                        {
        ...
        } else {
            {
                ...
                if (string_len(builtin_c_name) > 0) {
                    ...
                    __auto_type _mv_312 = context_ctx_lookup_type(ctx, fn_name);
                    if (_mv_312.has_value) {
                        __auto_type type_entry = _mv_312.value;
                        ...
                        __auto_type _mv_314 = context_ctx_lookup_enum_variant(ctx, fn_name);
                        if (_mv_314.has_value) {
                            __auto_type type_name = _mv_314.value;
                            {
                                ...
                                if (len > 2) {
                                    {
                                        ...
                                        __auto_type vi = 1;
                                        while (vi < len) {
                                            __auto_type _mv_315 = ({ __auto_type _lst = items; size_t _idx = (size_t)vi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        ...
                        } else if (!_mv_314.has_value) {
                            {
                                ...
                                if (!_mv_317.has_value) {
                                    ...
                                    __auto_type func_entry = _mv_317.value;
                                    while (i < len) {
    ...
    SLOP_PRE(((arg != NULL)), "(!= arg nil)");
    {
        ...
        switch (_mv_320.tag) {
            ...
            default: {
                {
                    __auto_type arg_c = expr_transpile_expr(ctx, arg);
                    __auto_type _mv_321 = expr_get_expr_type_hint(ctx, arg);
                    if (_mv_321.has_value) {
                        __auto_type type_hint = _mv_321.value;
        ...
        if (string_eq(slop_type, SLOP_STR("String"))) {
            ...
            switch (_mv_324.tag) {
                case types_SExpr_sym:
                {
                    ...
                    __auto_type _mv_325 = context_ctx_lookup_var(ctx, sym.name);
                ...
                case types_SExpr_lst:
                {
                    __auto_type lst = _mv_324.data.lst;
                    {
                        __auto_type items = lst.items;
                        if (((int64_t)((items).len)) >= 1) {
                            __auto_type _mv_326 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_326.has_value) {
                                ...
                                switch (_mv_327.tag) {
                                    case types_SExpr_sym:
                                    {
                                        __auto_type head_sym = _mv_327.data.sym;
                                        {
                                            __auto_type op = head_sym.name;
                                            if (string_eq(op, SLOP_STR(".")) && (((int64_t)((items).len)) >= 3)) {
                                                {
                                                    ...
                                                    if (string_eq(c_type, SLOP_STR("slop_string"))) {
                                                        ...
                                                        if (_mv_328.has_value) {
                                                            __auto_type obj_expr = _mv_328.value;
                                                            __auto_type _mv_329 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                            if (_mv_329.has_value) {
                                                                __auto_type field_expr = _mv_329.value;
                                                                __auto_type _mv_330 = (*field_expr);
                                                                switch (_mv_330.tag) {
                                                                    case types_SExpr_sym:
                                                                    {
                                                                        __auto_type field_sym = _mv_330.data.sym;
                                                                        {
                                                                            __auto_type field_name = field_sym.name;
                                                                            __auto_type obj_slop_type = expr_infer_expr_slop_type(ctx, obj_expr);
                                                                            if (string_len(obj_slop_type) > 0) {
                                                                                __auto_type _mv_331 = context_ctx_lookup_field_slop_type(ctx, obj_slop_type, field_name);
                                                                                if (_mv_331.has_value) {
                                                                                    __auto_type fst = _mv_331.value;
                                                ...
                                                __auto_type _mv_332 = context_ctx_lookup_func(ctx, op);
                                                if (_mv_332.has_value) {
                                                    __auto_type func_entry = _mv_332.value;
                                                    if (func_entry.returns_string) {
                                                        return (slop_option_string){.has_value = 1, .value = SLOP_STR("slop_string")};
                                                    } else {
                                                        return (slop_option_string){.has_value = false};
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 2) {
            ...
            if (_mv_333.has_value) {
                __auto_type tag_expr = _mv_333.value;
                __auto_type _mv_334 = (*tag_expr);
                switch (_mv_334.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type tag_list = _mv_334.data.lst;
                        {
                            __auto_type tag_items = tag_list.items;
                            if (((int64_t)((tag_items).len)) < 1) {
                                return context_ctx_str3(ctx, SLOP_STR("(("), c_type_name, SLOP_STR("){})"));
                            } else {
                                __auto_type _mv_335 = ({ __auto_type _lst = tag_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_335.has_value) {
                                    __auto_type tag_name_expr = _mv_335.value;
                                    __auto_type _mv_336 = (*tag_name_expr);
                                    switch (_mv_336.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type tag_sym = _mv_336.data.sym;
                                            {
                                                ...
                                                if (num_tag_items >= 3) {
                                                    {
                                                        ...
                                                        for (int64_t fi = 1; fi < num_tag_items; fi++) {
                                                            __auto_type _mv_337 = ({ __auto_type _lst = tag_items; size_t _idx = (size_t)fi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                            if (_mv_337.has_value) {
                                                                __auto_type value_expr = _mv_337.value;
                                                                {
                                                                    __auto_type value_c = expr_transpile_expr(ctx, value_expr);
                                                    ...
                                                    __auto_type _mv_338 = ({ __auto_type _lst = tag_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    ...
                    case types_SExpr_sym:
                    {
                        __auto_type sym = _mv_334.data.sym;
                        {
...
slop_string expr_transpile_cond_expr(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 1;
        while (i < len) {
            __auto_type _mv_339 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_339.has_value) {
                __auto_type clause_expr = _mv_339.value;
                __auto_type _mv_340 = (*clause_expr);
                switch (_mv_340.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type clause_lst = _mv_340.data.lst;
                        {
                            ...
                            if (clause_len >= 2) {
                                __auto_type _mv_341 = ({ __auto_type _lst = clause_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_341.has_value) {
                                    __auto_type test_expr = _mv_341.value;
                                    __auto_type _mv_342 = (*test_expr);
                                    switch (_mv_342.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type sym = _mv_342.data.sym;
                                            if (string_eq(sym.name, SLOP_STR("else"))) {
                                                __auto_type _mv_343 = ({ __auto_type _lst = clause_items; size_t _idx = (size_t)(clause_len - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            ...
                                            } else {
                                                {
                                                    ...
                                                    __auto_type _mv_344 = ({ __auto_type _lst = clause_items; size_t _idx = (size_t)(clause_len - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        ...
                                        default: {
                                            {
                                                __auto_type test_c = expr_transpile_expr(ctx, test_expr);
                                                __auto_type _mv_345 = ({ __auto_type _lst = clause_items; size_t _idx = (size_t)(clause_len - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_345.has_value) {
                                                    __auto_type body_expr = _mv_345.value;
                                                    {
                                                        __auto_type body_c = expr_typed_none(ctx, result_type, expr_transpile_expr(ctx, body_expr));
                                                        result = context_ctx_str(ctx, result, context_ctx_str(ctx, SLOP_STR("("), context_ctx_str(ctx, test_c, context_ctx_str(ctx, SLOP_STR(" ? "), context_ctx_str(ctx, body_c, SLOP_STR(" : "))))));
                                                    }
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 3) {
            ...
            if (_mv_346.has_value) {
                __auto_type scrutinee = _mv_346.value;
                {
...
uint8_t expr_is_result_patterns(slop_list_types_SExpr_ptr patterns) {
    {
        ...
        int64_t i = 0;
        while ((i < len) && !(found)) {
            __auto_type _mv_354 = ({ __auto_type _lst = patterns; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_354.has_value) {
                __auto_type pat = _mv_354.value;
                {
                    __auto_type tag = expr_get_expr_pattern_tag(pat);
...
uint8_t expr_is_enum_expr_patterns(context_TranspileContext* ctx, slop_list_types_SExpr_ptr patterns) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while ((i < len) && all_symbols) {
            __auto_type _mv_355 = ({ __auto_type _lst = patterns; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_355.has_value) {
                __auto_type pat_expr = _mv_355.value;
                __auto_type _mv_356 = (*pat_expr);
                switch (_mv_356.tag) {
                    case types_SExpr_sym:
                    {
                        __auto_type s = _mv_356.data.sym;
                        {
                            __auto_type name = s.name;
                            if (!(string_eq(name, SLOP_STR("else"))) && !(string_eq(name, SLOP_STR("_")))) {
                                __auto_type _mv_357 = context_ctx_lookup_enum_variant(ctx, name);
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while ((i < len) && !(has_union_variant)) {
            ...
            if (_mv_358.has_value) {
                __auto_type pat_expr = _mv_358.value;
                {
                    ...
                    if ((!(string_eq(tag, SLOP_STR("")))) && (!(string_eq(tag, SLOP_STR("some")))) && (!(string_eq(tag, SLOP_STR("none")))) && (!(string_eq(tag, SLOP_STR("ok")))) && (!(string_eq(tag, SLOP_STR("error")))) && (!(string_eq(tag, SLOP_STR("else")))) && (!(string_eq(tag, SLOP_STR("_"))))) {
                        __auto_type _mv_359 = context_ctx_lookup_enum_variant(ctx, tag);
                        if (_mv_359.has_value) {
                            __auto_type _ = _mv_359.value;
                            has_union_variant = 1;
...
slop_option_string expr_get_expr_binding_name(types_SExpr* pat_expr) {
    ...
    switch (_mv_360.tag) {
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_360.data.lst;
            {
                __auto_type items = lst.items;
                if (((int64_t)((items).len)) < 2) {
                    return (slop_option_string){.has_value = false};
                    ...
                    if (_mv_361.has_value) {
                        __auto_type binding = _mv_361.value;
                        __auto_type _mv_362 = (*binding);
                        switch (_mv_362.tag) {
                            case types_SExpr_sym:
                            {
...
slop_string expr_get_match_branch_body(context_TranspileContext* ctx, slop_list_types_SExpr_ptr branch_items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 2) {
            ...
            __auto_type _mv_363 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)(len - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    ...
                    case types_SExpr_lst:
                    {
                        __auto_type branch_lst = _mv_365.data.lst;
                        {
                            ...
                            if (((int64_t)((branch_items).len)) >= 2) {
                                __auto_type _mv_366 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 2) {
            ...
            if (_mv_368.has_value) {
                __auto_type first_clause = _mv_368.value;
                __auto_type _mv_369 = (*first_clause);
                switch (_mv_369.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type clause_lst = _mv_369.data.lst;
                        {
                            __auto_type clause_items = clause_lst.items;
                            __auto_type clause_len = ((int64_t)((clause_items).len));
                            if (clause_len < 2) {
                                ...
                                __auto_type _mv_370 = ({ __auto_type _lst = clause_items; size_t _idx = (size_t)(clause_len - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_370.has_value) {
                                    __auto_type body_expr = _mv_370.value;
        ...
        case types_SExpr_lst:
        {
            __auto_type branch_lst = _mv_371.data.lst;
            {
                ...
                if (branch_len < 2) {
                    ...
                    __auto_type _mv_372 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)(branch_len - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_string expr_slop_type_to_c_type(context_TranspileContext* ctx, slop_string slop_type) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_374 = context_ctx_lookup_type(ctx, slop_type);
        if (_mv_374.has_value) {
            __auto_type entry = _mv_374.value;
            return entry.c_name;
...
slop_string expr_infer_expr_c_type(context_TranspileContext* ctx, types_SExpr* expr) {
    ...
    SLOP_PRE(((expr != NULL)), "(!= expr nil)");
    {
        ...
        if (string_len(checker_type) > 0) {
            ...
            __auto_type _mv_375 = (*expr);
            switch (_mv_375.tag) {
                case types_SExpr_str:
                {
                    __auto_type _ = _mv_375.data.str;
                    return SLOP_STR("slop_string");
                }
                case types_SExpr_num:
                {
                    __auto_type num = _mv_375.data.num;
                    if (num.is_float) {
                        return SLOP_STR("double");
                    } else {
                        return SLOP_STR("int64_t");
                ...
                case types_SExpr_sym:
                {
                    __auto_type sym = _mv_375.data.sym;
                    {
                        __auto_type name = sym.name;
                        __auto_type _mv_376 = context_ctx_lookup_var(ctx, name);
                        if (_mv_376.has_value) {
                            __auto_type entry = _mv_376.value;
                            {
                ...
                case types_SExpr_lst:
                {
                    __auto_type lst = _mv_375.data.lst;
                    {
                        ...
                        if (((int64_t)((items).len)) < 1) {
                            ...
                            __auto_type _mv_377 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        ...
                                        __auto_type sym = _mv_378.data.sym;
                                        {
                                            ...
                                            if (({ __auto_type _mv = context_ctx_lookup_func(ctx, op); _mv.has_value ? ({ __auto_type func_entry = _mv.value; func_entry.returns_string; }) : (0); })) {
                                                ...
                                                if (((int64_t)((items).len)) < 3) {
                                                    ...
                                                    __auto_type _mv_379 = ({ __auto_type _lst = items; size_t _idx = (size_t)(((int64_t)((items).len)) - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_379.has_value) {
                                                        __auto_type body = _mv_379.value;
                                                ...
                                                if (((int64_t)((items).len)) < 2) {
                                                    ...
                                                    __auto_type _mv_380 = ({ __auto_type _lst = items; size_t _idx = (size_t)(((int64_t)((items).len)) - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_380.has_value) {
                                                        __auto_type last_expr = _mv_380.value;
                                                ...
                                                if (((int64_t)((items).len)) < 3) {
                                                    ...
                                                    __auto_type _mv_381 = ({ __auto_type _lst = items; size_t _idx = (size_t)(((int64_t)((items).len)) - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_381.has_value) {
                                                        __auto_type body = _mv_381.value;
                                                        return expr_infer_expr_c_type(ctx, body);
                                                ...
                                                if (((int64_t)((items).len)) < 3) {
                                                    ...
                                                    if (_mv_382.has_value) {
                                                        __auto_type then_expr = _mv_382.value;
                                                ...
                                                if (((int64_t)((items).len)) < 2) {
                                                    ...
                                                    if (_mv_383.has_value) {
                                                        __auto_type val_expr = _mv_383.value;
                                                        {
                                                            __auto_type val_type = expr_infer_expr_c_type(ctx, val_expr);
                                                ...
                                                __auto_type _mv_384 = context_ctx_get_current_return_type(ctx);
                                                if (_mv_384.has_value) {
                                                    __auto_type ret_type = _mv_384.value;
                                                    if (strlib_starts_with(ret_type, SLOP_STR("slop_option_"))) {
                                                        return ret_type;
                                                    } else {
                                                        return SLOP_STR("slop_option_int");
                                                ...
                                                if (((int64_t)((items).len)) < 2) {
                                                    ...
                                                    if (_mv_386.has_value) {
                                                        __auto_type inner = _mv_386.value;
                                                        {
                                                ...
                                                if (((int64_t)((items).len)) < 2) {
                                                    ...
                                                    if (_mv_388.has_value) {
                                                        __auto_type chan_arg = _mv_388.value;
                                                        {
                                                ...
                                                if (((int64_t)((items).len)) < 3) {
                                                    ...
                                                    if (_mv_390.has_value) {
                                                        __auto_type type_expr = _mv_390.value;
                                                        {
                                                            __auto_type elem_c = context_to_c_type_prefixed(ctx, type_expr);
                                                            __auto_type elem_id = ctype_type_to_identifier((*ctx).arena, elem_c);
                                                            return context_ctx_str3(ctx, SLOP_STR("slop_chan_"), elem_id, SLOP_STR("*"));
                                                ...
                                                if (((int64_t)((items).len)) < 2) {
                                                    ...
                                                    if (_mv_392.has_value) {
                                                        __auto_type list_arg = _mv_392.value;
                                                        {
                                                ...
                                                __auto_type _mv_393 = context_ctx_lookup_type(ctx, op);
                                                if (_mv_393.has_value) {
                                                    __auto_type type_entry = _mv_393.value;
                                                    return type_entry.c_name;
                                                } else if (!_mv_393.has_value) {
                                                    __auto_type _mv_394 = context_ctx_lookup_func(ctx, op);
                                ...
                                if (_mv_397.has_value) {
                                    __auto_type pattern = _mv_397.value;
                                    {
                                        ...
                                        if (string_eq(tag, SLOP_STR("ok"))) {
                                            __auto_type _mv_398 = expr_get_expr_binding_name(pattern);
                                            if (_mv_398.has_value) {
                                                __auto_type name = _mv_398.value;
                                                ok_binding = name;
                                            ...
                                            __auto_type _mv_399 = expr_get_expr_binding_name(pattern);
                                            if (_mv_399.has_value) {
                                                __auto_type name = _mv_399.value;
                                                err_binding = name;
...
slop_string expr_build_enum_case_expr(context_TranspileContext* ctx, slop_arena* arena, slop_string cases, types_SExpr* pattern, slop_list_types_SExpr_ptr branch_items, slop_string result_type) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (string_eq(tag, SLOP_STR("else")) || string_eq(tag, SLOP_STR("_"))) {
            ...
            __auto_type _mv_403 = context_ctx_lookup_enum_variant(ctx, tag);
            if (_mv_403.has_value) {
                __auto_type type_name = _mv_403.value;
                {
...
slop_string expr_wrap_fn_ref_as_closure(context_TranspileContext* ctx, slop_string expected_type, slop_string arg_c, types_SExpr* arg_expr) {
    ...
    if (string_eq(expected_type, SLOP_STR("slop_closure_t"))) {
        __auto_type _mv_407 = (*arg_expr);
        switch (_mv_407.tag) {
            case types_SExpr_sym:
            {
                __auto_type sym = _mv_407.data.sym;
                {
                    __auto_type slop_name = sym.name;
                    __auto_type _mv_408 = context_ctx_lookup_func(ctx, slop_name);
                    if (_mv_408.has_value) {
                        __auto_type func_entry = _mv_408.value;
                        {
        ...
        if (context_ctx_skip_trampoline_generation(ctx)) {
            ...
            if (context_ctx_has_trampoline(ctx, fn_c_name)) {
            ...
            } else {
                {
                    ...
                    int64_t i = 0;
                    while (i < count) {
                        __auto_type _mv_409 = ({ __auto_type _lst = param_types; size_t _idx = (size_t)i; slop_option_context_FuncParamType_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_409.has_value) {
                            __auto_type param_type_ptr = _mv_409.value;
                            {
...
slop_string expr_build_union_case_expr(context_TranspileContext* ctx, slop_arena* arena, slop_string cases, types_SExpr* scrutinee, types_SExpr* pattern, slop_list_types_SExpr_ptr branch_items, slop_string result_type) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (string_eq(tag, SLOP_STR("else")) || string_eq(tag, SLOP_STR("_"))) {
            ...
            __auto_type _mv_410 = context_ctx_lookup_enum_variant(ctx, tag);
            if (_mv_410.has_value) {
                __auto_type type_name = _mv_410.value;
                {
                    __auto_type c_tag = ctype_to_c_name(arena, tag);
                    __auto_type case_label = context_ctx_str4(ctx, type_name, SLOP_STR("_"), c_tag, SLOP_STR(""));
                    __auto_type binding_opt = expr_get_expr_binding_name(pattern);
                    __auto_type _mv_411 = binding_opt;
                    if (_mv_411.has_value) {
                        __auto_type binding_name = _mv_411.value;
                        {
...
slop_string expr_build_ternary_match_expr(context_TranspileContext* ctx, slop_string scrutinee_c, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = (len - 1);
        while (i >= 2) {
            __auto_type _mv_412 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_412.has_value) {
                __auto_type branch = _mv_412.value;
                __auto_type _mv_413 = (*branch);
                switch (_mv_413.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type branch_lst = _mv_413.data.lst;
                        {
                            __auto_type branch_items = branch_lst.items;
                            if (((int64_t)((branch_items).len)) >= 2) {
                                __auto_type _mv_414 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_414.has_value) {
                                    __auto_type pattern = _mv_414.value;
                                    {
                                        __auto_type tag = expr_get_expr_pattern_tag(pattern);
...
uint8_t expr_discard_needs_void(types_SExpr* e) {
    __auto_type _mv_415 = (*e);
    switch (_mv_415.tag) {
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_415.data.lst;
            __auto_type _mv_416 = ({ __auto_type _lst = lst.items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_416.has_value) {
                __auto_type head = _mv_416.value;
                __auto_type _mv_417 = (*head);
                switch (_mv_417.tag) {
                    case types_SExpr_sym:
                    {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 3) {
            ...
            if (_mv_418.has_value) {
                __auto_type bindings_expr = _mv_418.value;
                __auto_type _mv_419 = (*bindings_expr);
                switch (_mv_419.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type bindings_lst = _mv_419.data.lst;
                        context_ctx_push_scope(ctx);
                        {
                            __auto_type result = SLOP_STR("({ ");
                            ...
                            while (bi < bindings_len) {
                                __auto_type _mv_420 = ({ __auto_type _lst = bindings_items; size_t _idx = (size_t)bi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_420.has_value) {
                                    __auto_type binding = _mv_420.value;
                            ...
                            bi = 0;
                            while (bi < bindings_len) {
                                __auto_type _mv_421 = ({ __auto_type _lst = bindings_items; size_t _idx = (size_t)bi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_421.has_value) {
                                    __auto_type binding = _mv_421.value;
                                    {
                    ...
                    if (len >= 2) {
                        {
                            ...
                            __auto_type _mv_424 = ({ __auto_type _lst = items; size_t _idx = (size_t)name_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                ...
                __auto_type lst = _mv_426.data.lst;
                {
                    ...
                    if (len < 2) {
                    ...
                    } else {
                        {
                            __auto_type has_mut = expr_binding_has_mut(items);
                            __auto_type name_idx = ((has_mut) ? 1 : 0);
                            __auto_type _mv_427 = ({ __auto_type _lst = items; size_t _idx = (size_t)name_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_427.has_value) {
                                __auto_type name_expr = _mv_427.value;
                                __auto_type _mv_428 = (*name_expr);
                                switch (_mv_428.tag) {
                                    case types_SExpr_sym:
                                    {
                                        __auto_type name_sym = _mv_428.data.sym;
                                        {
                                            ...
                                            __auto_type init_idx = ((has_mut) ? ((has_type) ? 3 : 2) : ((has_type) ? 2 : 1));
                                            if (has_type) {
                                                __auto_type _mv_429 = ({ __auto_type _lst = items; size_t _idx = (size_t)type_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_429.has_value) {
                                                    __auto_type type_expr = _mv_429.value;
                                                    {
                                                        __auto_type c_type = context_to_c_type_prefixed(ctx, type_expr);
                                                        __auto_type _mv_430 = ({ __auto_type _lst = items; size_t _idx = (size_t)init_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                        if (_mv_430.has_value) {
                                                            __auto_type init_expr = _mv_430.value;
                                                            {
                                                    ...
                                                    __auto_type _mv_431 = ({ __auto_type _lst = items; size_t _idx = (size_t)init_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_431.has_value) {
                                                        __auto_type init_expr = _mv_431.value;
                                                        {
                                                ...
                                                __auto_type _mv_432 = ({ __auto_type _lst = items; size_t _idx = (size_t)init_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_432.has_value) {
                                                    __auto_type init_expr = _mv_432.value;
                                                    {
                                                        __auto_type init_c = expr_transpile_expr(ctx, init_expr);
                                                        return context_ctx_str5(ctx, SLOP_STR("__auto_type "), var_name, SLOP_STR(" = "), init_c, SLOP_STR(";"));
                                                    }
...
uint8_t expr_binding_has_mut(slop_list_types_SExpr_ptr items) {
    if (((int64_t)((items).len)) < 1) {
        ...
        if (_mv_433.has_value) {
            __auto_type first = _mv_433.value;
            __auto_type _mv_434 = (*first);
            switch (_mv_434.tag) {
                case types_SExpr_sym:
                {
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_435.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 1) {
                    ...
                    __auto_type _mv_436 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    ...
                                    if (string_eq(op, SLOP_STR("some"))) {
                                        if (((int64_t)((items).len)) < 2) {
                                            ...
                                            if (_mv_438.has_value) {
                                                __auto_type val_expr = _mv_438.value;
                                                {
                                                    __auto_type val_c = expr_transpile_expr(ctx, val_expr);
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 3) {
            ...
            if (_mv_439.has_value) {
                __auto_type cond_expr = _mv_439.value;
                {
                    __auto_type cond_c = expr_transpile_expr(ctx, cond_expr);
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 2) {
            ...
            if (_mv_442.has_value) {
                __auto_type cond_expr = _mv_442.value;
                {
                    __auto_type cond_c = expr_transpile_expr(ctx, cond_expr);
                    __auto_type body_c = SLOP_STR("({ ");
                    {
                        ...
                        while (i < len) {
                            ...
                            if (_mv_443.has_value) {
                                __auto_type body_expr = _mv_443.value;
...
uint8_t expr_set_is_self_assign(slop_list_types_SExpr_ptr items) {
    if (((int64_t)((items).len)) == 3) {
        ...
        if (_mv_444.has_value) {
            __auto_type target_expr = _mv_444.value;
            __auto_type _mv_445 = (*target_expr);
            switch (_mv_445.tag) {
                case types_SExpr_sym:
                {
                    __auto_type tsym = _mv_445.data.sym;
                    __auto_type _mv_446 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_446.has_value) {
                        __auto_type value_expr = _mv_446.value;
                        __auto_type _mv_447 = (*value_expr);
                        switch (_mv_447.tag) {
                            case types_SExpr_sym:
                            {
                                __auto_type vsym = _mv_447.data.sym;
            ...
            if (len < 3) {
                ...
                if (_mv_448.has_value) {
                    ...
                    if (_mv_449.has_value) {
                        ...
                        {
                            __auto_type val_c = expr_transpile_expr(ctx, val_expr);
                            __auto_type _mv_450 = (*target_expr);
                            switch (_mv_450.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type target_lst = _mv_450.data.lst;
                                    {
                                        ...
                                        if (((int64_t)((target_items).len)) < 1) {
                                            ...
                                            __auto_type _mv_451 = ({ __auto_type _lst = target_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_451.has_value) {
                                                __auto_type head = _mv_451.value;
                                                __auto_type _mv_452 = (*head);
                                                switch (_mv_452.tag) {
                                                    case types_SExpr_sym:
                                                    {
                                                        __auto_type sym = _mv_452.data.sym;
                                                        {
                                                            ...
                                                            if (string_eq(op, SLOP_STR("@"))) {
                                                                if (((int64_t)((target_items).len)) < 3) {
                                                                    ...
                                                                    __auto_type _mv_453 = ({ __auto_type _lst = target_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                                    if (_mv_453.has_value) {
                                                                        __auto_type arr_expr = _mv_453.value;
                                                                        __auto_type _mv_454 = ({ __auto_type _lst = target_items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                                        if (_mv_454.has_value) {
                                                                            __auto_type idx_expr = _mv_454.value;
                                                                            {
                                                                                __auto_type arr_c = expr_transpile_expr(ctx, arr_expr);
                                                                                __auto_type idx_c = expr_transpile_expr(ctx, idx_expr);
...
slop_string expr_resolve_arena_c_name(context_TranspileContext* ctx, slop_string op, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    __auto_type _mv_455 = context_ctx_lookup_var(ctx, SLOP_STR("arena"));
    if (_mv_455.has_value) {
        __auto_type entry = _mv_455.value;
        return entry.c_name;
    } else if (!_mv_455.has_value) {
        __auto_type _mv_456 = context_ctx_find_arena_var(ctx);
...
slop_string expr_get_arena_for_list_push_expr(context_TranspileContext* ctx, types_SExpr* list_expr, slop_string list_c) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    SLOP_PRE(((list_expr != NULL)), "(!= list-expr nil)");
    __auto_type _mv_458 = context_ctx_lookup_var(ctx, SLOP_STR("arena"));
    if (_mv_458.has_value) {
        __auto_type arena_var = _mv_458.value;
        return arena_var.c_name;
    } else if (!_mv_458.has_value) {
        __auto_type _mv_459 = context_ctx_lookup_var(ctx, SLOP_STR("ctx"));
        if (_mv_459.has_value) {
            __auto_type ctx_var = _mv_459.value;
        ...
        } else if (!_mv_459.has_value) {
            {
                ...
                if (string_len(arena_from_field) > 0) {
                    ...
                    if (_mv_460.has_value) {
                        __auto_type arena_entry = _mv_460.value;
...
slop_string expr_get_arena_from_field_access(context_TranspileContext* ctx, types_SExpr* expr) {
    ...
    switch (_mv_461.tag) {
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_461.data.lst;
            {
                __auto_type items = lst.items;
                __auto_type len = ((int64_t)((items).len));
                if (len < 3) {
                            ...
                            case types_SExpr_sym:
                            {
                                ...
                                if (string_eq(sym.name, SLOP_STR("."))) {
                                    ...
                                    if (_mv_464.has_value) {
                                        __auto_type base_expr = _mv_464.value;
...
slop_string expr_get_arena_from_base(context_TranspileContext* ctx, types_SExpr* base_expr) {
    ...
    switch (_mv_465.tag) {
        case types_SExpr_sym:
        {
            ...
            {
                __auto_type var_name = sym.name;
                __auto_type _mv_466 = context_ctx_lookup_var(ctx, var_name);
                            ...
                            case types_SExpr_sym:
                            {
                                ...
                                if (string_eq(sym.name, SLOP_STR("deref"))) {
                                    ...
                                    if (_mv_469.has_value) {
                                        __auto_type ptr_expr = _mv_469.value;
                                        {
...
uint8_t expr_is_ptr_to_ptr_map(context_TranspileContext* ctx, types_SExpr* expr) {
    ...
    switch (_mv_470.tag) {
        case types_SExpr_sym:
        {
            ...
            {
                __auto_type name = sym.name;
                __auto_type _mv_471 = context_ctx_lookup_var(ctx, name);
                if (_mv_471.has_value) {
                    __auto_type entry = _mv_471.value;
                    {
                        __auto_type c_type = entry.c_type;
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 2) {
            ...
            if (_mv_472.has_value) {
                ...
                __auto_type _mv_473 = (*type_expr);
                switch (_mv_473.tag) {
                    case types_SExpr_sym:
                    {
                        __auto_type type_sym = _mv_473.data.sym;
                        {
                            __auto_type raw_type_name = type_sym.name;
                    ...
                    case types_SExpr_lst:
                    {
                        __auto_type type_lst = _mv_473.data.lst;
                        {
                            ...
                            if (((int64_t)((type_items).len)) < 1) {
                                ...
                                __auto_type _mv_474 = ({ __auto_type _lst = type_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_474.has_value) {
                                    __auto_type head = _mv_474.value;
                                    __auto_type _mv_475 = (*head);
                                    switch (_mv_475.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type head_sym = _mv_475.data.sym;
...
slop_string expr_build_inline_struct_type(context_TranspileContext* ctx, slop_list_types_SExpr_ptr type_items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 1;
        while (i < len) {
            __auto_type _mv_481 = ({ __auto_type _lst = type_items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    ...
                                    switch (_mv_484.tag) {
                                        case types_SExpr_sym:
                                        {
                                            ...
                                            if (_mv_485.has_value) {
                                                __auto_type type_expr = _mv_485.value;
                                                {
...
slop_string expr_transpile_inline_record_fields(context_TranspileContext* ctx, slop_string struct_def, slop_list_types_SExpr_ptr items, int64_t start_idx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        uint8_t first = 1;
        while (i < len) {
            __auto_type _mv_486 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_486.has_value) {
                __auto_type field_expr = _mv_486.value;
                __auto_type _mv_487 = (*field_expr);
                switch (_mv_487.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type field_lst = _mv_487.data.lst;
                        {
                            __auto_type field_items = field_lst.items;
                            if (((int64_t)((field_items).len)) >= 2) {
                                __auto_type _mv_488 = ({ __auto_type _lst = field_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_488.has_value) {
                                    __auto_type name_expr = _mv_488.value;
                                    __auto_type _mv_489 = (*name_expr);
                                    switch (_mv_489.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type name_sym = _mv_489.data.sym;
                                            __auto_type _mv_490 = ({ __auto_type _lst = field_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_490.has_value) {
                                                __auto_type val_expr = _mv_490.value;
                                                {
                                                    __auto_type field_name = ctype_to_c_name(arena, name_sym.name);
                    ...
                    __auto_type elem_count = (len - 2);
                    {
                        ...
                        while (i < len) {
                            ...
                            if (_mv_492.has_value) {
                                __auto_type elem_expr = _mv_492.value;
                        ...
                        }
                        {
                            ...
                            __auto_type _mv_493 = arena_var;
                            if (_mv_493.has_value) {
                                __auto_type arena_var = _mv_493.value;
                                {
                                    ...
                                    while (i < ((int64_t)((elem_codes).len))) {
                                        __auto_type _mv_494 = ({ __auto_type _lst = elem_codes; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_494.has_value) {
                                            __auto_type ec = _mv_494.value;
                                            {
                                ...
                                context_ctx_add_warning(ctx, SLOP_STR("list literal uses stack-allocated compound literal (no arena in scope)"));
                                {
                                    ...
                                    i = 0;
                                    while (i < ((int64_t)((elem_codes).len))) {
                                        __auto_type _mv_495 = ({ __auto_type _lst = elem_codes; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_495.has_value) {
                                            __auto_type ec = _mv_495.value;
                                            if (first) {
...
slop_string expr_get_map_key_c_info(context_TranspileContext* ctx, types_SExpr* key_type_expr) {
    ...
    __auto_type _mv_496 = (*key_type_expr);
    switch (_mv_496.tag) {
        case types_SExpr_sym:
        {
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_496.data.lst;
            {
                __auto_type items = lst.items;
                if (((int64_t)((items).len)) < 1) {
                    return SLOP_STR("sizeof(void*), slop_hash_ptr, slop_eq_ptr");
                } else {
                    __auto_type _mv_497 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_497.has_value) {
                        __auto_type head = _mv_497.value;
                        __auto_type _mv_498 = (*head);
                        switch (_mv_498.tag) {
                            case types_SExpr_sym:
                            {
...
slop_string expr_get_struct_key_info_by_name(context_TranspileContext* ctx, slop_string name) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    __auto_type _mv_499 = context_ctx_lookup_type(ctx, name);
    if (_mv_499.has_value) {
        __auto_type type_entry = _mv_499.value;
        {
            __auto_type c_name = type_entry.c_name;
            context_ctx_register_struct_key_type(ctx, c_name);
            return expr_build_struct_key_info(ctx, c_name);
        ...
        __auto_type _mv_500 = context_ctx_get_module(ctx);
        if (_mv_500.has_value) {
            __auto_type mod = _mv_500.value;
            {
                __auto_type prefixed = context_ctx_str3(ctx, mod, SLOP_STR("_"), name);
                __auto_type _mv_501 = context_ctx_lookup_type(ctx, prefixed);
                if (_mv_501.has_value) {
                    __auto_type type_entry = _mv_501.value;
                    {
                        __auto_type c_name = type_entry.c_name;
                        context_ctx_register_struct_key_type(ctx, c_name);
                        return expr_build_struct_key_info(ctx, c_name);
        ...
        if (len < 3) {
            ...
            if (_mv_503.has_value) {
                ...
                if (_mv_504.has_value) {
                    __auto_type key_type_expr = _mv_504.value;
                    {
                        __auto_type arena_c = expr_transpile_expr(ctx, arena_expr);
...
uint8_t expr_key_expr_is_addressable(types_SExpr* key_expr) {
    SLOP_PRE(((key_expr != NULL)), "(!= key-expr nil)");
    __auto_type _mv_505 = (*key_expr);
    switch (_mv_505.tag) {
        case types_SExpr_sym:
        {
            __auto_type _ = _mv_505.data.sym;
            return 1;
        }
        case types_SExpr_lst:
        {
                ...
                if (((int64_t)((items).len)) < 1) {
                    ...
                    if (_mv_506.has_value) {
                        ...
                        switch (_mv_507.tag) {
                            case types_SExpr_sym:
                            {
                                __auto_type head_sym = _mv_507.data.sym;
                                {
                                    __auto_type op = head_sym.name;
        ...
        if (len < 4) {
            ...
            if (_mv_508.has_value) {
                ...
                if (_mv_509.has_value) {
                    ...
                    __auto_type _mv_510 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_510.has_value) {
                        __auto_type val_expr = _mv_510.value;
                        {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 3) {
            ...
            if (_mv_511.has_value) {
                __auto_type map_expr = _mv_511.value;
                ...
                if (_mv_512.has_value) {
                    __auto_type key_expr = _mv_512.value;
                    {
                        __auto_type map_c = expr_resolve_container_c(ctx, map_expr);
                        __auto_type key_c = expr_transpile_expr(ctx, key_expr);
                        __auto_type key_temp = context_ctx_gensym(ctx, SLOP_STR("_key"));
        ...
        if (len < 3) {
            ...
            if (_mv_513.has_value) {
                ...
                if (_mv_514.has_value) {
                    __auto_type key_expr = _mv_514.value;
                    {
                        __auto_type map_c = expr_resolve_container_c(ctx, map_expr);
                        __auto_type key_c = expr_transpile_expr(ctx, key_expr);
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 3) {
            ...
            if (_mv_518.has_value) {
                __auto_type arena_expr = _mv_518.value;
                __auto_type _mv_519 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_519.has_value) {
                    __auto_type elem_type_expr = _mv_519.value;
                    {
                        __auto_type arena_c = expr_transpile_expr(ctx, arena_expr);
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 3) {
            ...
            if (_mv_520.has_value) {
                __auto_type set_expr = _mv_520.value;
                ...
                if (_mv_521.has_value) {
                    __auto_type elem_expr = _mv_521.value;
                    {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 2) {
            ...
            if (_mv_527.has_value) {
                __auto_type type_expr = _mv_527.value;
                {
                    ...
                    __auto_type result = context_ctx_str(ctx, context_ctx_str3(ctx, SLOP_STR("({ slop_map* _s = slop_map_new_ptr("), arena_c, SLOP_STR(", ")), context_ctx_str(ctx, int_to_string(arena, init_cap), context_ctx_str(ctx, SLOP_STR(", "), context_ctx_str(ctx, elem_info, SLOP_STR("); ")))));
                    {
                        ...
                        while (i < len) {
                            ...
                            if (_mv_528.has_value) {
                                __auto_type elem_expr = _mv_528.value;
                                {
                                    __auto_type elem_c = expr_transpile_expr(ctx, elem_expr);
                                    __auto_type elem_temp = context_ctx_gensym(ctx, SLOP_STR("_key"));
                                    {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 2) {
            ...
            if (_mv_529.has_value) {
                __auto_type binding_expr = _mv_529.value;
                __auto_type _mv_530 = (*binding_expr);
                switch (_mv_530.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type binding_lst = _mv_530.data.lst;
                        {
                            ...
                            if (binding_len < 3) {
                                ...
                                if (_mv_531.has_value) {
                                    __auto_type var_expr = _mv_531.value;
                                    __auto_type _mv_532 = (*var_expr);
                                    switch (_mv_532.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type var_sym = _mv_532.data.sym;
                                            {
                                                __auto_type var_name = ctype_to_c_name(arena, var_sym.name);
                                                __auto_type _mv_533 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_533.has_value) {
                                                    __auto_type start_expr = _mv_533.value;
                                                    __auto_type _mv_534 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_534.has_value) {
                                                        __auto_type end_expr = _mv_534.value;
                                                        {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 2) {
            ...
            if (_mv_536.has_value) {
                __auto_type binding_expr = _mv_536.value;
                __auto_type _mv_537 = (*binding_expr);
                switch (_mv_537.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type binding_lst = _mv_537.data.lst;
                        {
                            __auto_type binding_items = binding_lst.items;
                            __auto_type binding_len = ((int64_t)((binding_items).len));
                            if (binding_len < 2) {
                                ...
                                __auto_type _mv_538 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_538.has_value) {
                                    __auto_type first_elem = _mv_538.value;
                                    __auto_type _mv_539 = (*first_elem);
                                    switch (_mv_539.tag) {
                                        case types_SExpr_lst:
                                        {
                                            __auto_type _ = _mv_539.data.lst;
                                            return expr_transpile_for_each_map_kv_as_expr(ctx, binding_items, items, len);
                                        }
                                        case types_SExpr_sym:
                                        {
                                            __auto_type var_sym = _mv_539.data.sym;
                                            {
                                                __auto_type var_name = ctype_to_c_name(arena, var_sym.name);
                                                __auto_type _mv_540 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_540.has_value) {
                                                    __auto_type coll_expr = _mv_540.value;
                                                    {
            ...
            context_ctx_bind_var(ctx, (context_VarEntry){var_sym.name, var_name, elem_c_type, elem_slop_type, 0, 0, 0, SLOP_STR(""), SLOP_STR("")});
            {
                ...
                while (i < len) {
                    ...
                    if (_mv_542.has_value) {
                        __auto_type body_expr = _mv_542.value;
                        {
                            __auto_type body_c = expr_transpile_expr(ctx, body_expr);
                            result = context_ctx_str3(ctx, result, body_c, SLOP_STR("; "));
                        }
...
slop_string expr_transpile_for_each_map_kv_as_expr(context_TranspileContext* ctx, slop_list_types_SExpr_ptr binding_items, slop_list_types_SExpr_ptr items, int64_t len) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (_mv_544.has_value) {
            __auto_type kv_list_expr = _mv_544.value;
            __auto_type _mv_545 = (*kv_list_expr);
            switch (_mv_545.tag) {
                case types_SExpr_lst:
                {
                    __auto_type kv_lst = _mv_545.data.lst;
                    {
                        __auto_type kv_items = kv_lst.items;
                        if (((int64_t)((kv_items).len)) < 2) {
                            return SLOP_STR("({ /* for-each: map binding needs ((k v) map) */ 0; })");
                        } else {
                            __auto_type _mv_546 = ({ __auto_type _lst = kv_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_546.has_value) {
                                __auto_type k_expr = _mv_546.value;
                                __auto_type _mv_547 = ({ __auto_type _lst = kv_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_547.has_value) {
                                    __auto_type v_expr = _mv_547.value;
                                    ...
                                    if (_mv_548.has_value) {
                                        ...
                                        __auto_type _mv_549 = (*k_expr);
                                        switch (_mv_549.tag) {
                                            case types_SExpr_sym:
                                            {
                                                __auto_type k_sym = _mv_549.data.sym;
                                                __auto_type _mv_550 = (*v_expr);
                                                switch (_mv_550.tag) {
                                                    case types_SExpr_sym:
                                                    {
                                                        __auto_type v_sym = _mv_550.data.sym;
                                                        {
...
slop_string expr_transpile_lambda_expr(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 2) {
            ...
            __auto_type _mv_552 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_552.has_value) {
                __auto_type second = _mv_552.value;
                __auto_type _mv_553 = (*second);
                switch (_mv_553.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type params_lst = _mv_553.data.lst;
                        return expr_transpile_lambda_with_params(ctx, items, params_lst.items);
                    }
                    case types_SExpr_sym:
                    {
                        __auto_type _ = _mv_553.data.sym;
...
slop_string expr_build_closure_struct(context_TranspileContext* ctx, slop_string env_type, slop_list_string free_vars) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < count) {
            __auto_type _mv_558 = ({ __auto_type _lst = free_vars; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_558.has_value) {
                __auto_type var_name = _mv_558.value;
                {
...
slop_list_string expr_capture_free_var_accesses(context_TranspileContext* ctx, slop_list_string free_vars) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < count) {
            __auto_type _mv_560 = ({ __auto_type _lst = free_vars; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_560.has_value) {
                __auto_type var_name = _mv_560.value;
                {
                    __auto_type c_name = ctype_to_c_name(arena, var_name);
                    __auto_type var_info = context_ctx_lookup_var(ctx, var_name);
...
slop_string expr_find_arena_ptr_expr(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    __auto_type _mv_561 = context_ctx_lookup_var(ctx, SLOP_STR("_arena"));
    if (_mv_561.has_value) {
        __auto_type entry = _mv_561.value;
        return SLOP_STR("&_arena");
    } else if (!_mv_561.has_value) {
        __auto_type _mv_562 = context_ctx_lookup_var(ctx, SLOP_STR("arena"));
        if (_mv_562.has_value) {
            __auto_type entry = _mv_562.value;
            return entry.c_name;
        } else if (!_mv_562.has_value) {
            __auto_type _mv_563 = context_ctx_find_arena_var(ctx);
            if (_mv_563.has_value) {
                __auto_type entry = _mv_563.value;
                return entry.c_name;
...
void expr_bind_lambda_params(context_TranspileContext* ctx, slop_list_types_SExpr_ptr params) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < param_count) {
            __auto_type _mv_570 = ({ __auto_type _lst = params; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_570.has_value) {
                __auto_type param_expr = _mv_570.value;
                __auto_type _mv_571 = (*param_expr);
                switch (_mv_571.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type param_lst = _mv_571.data.lst;
                        {
                            __auto_type param_items = param_lst.items;
                            if (((int64_t)((param_items).len)) >= 2) {
                                __auto_type _mv_572 = ({ __auto_type _lst = param_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_572.has_value) {
                                    __auto_type name_expr = _mv_572.value;
                                    __auto_type _mv_573 = (*name_expr);
                                    switch (_mv_573.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type name_sym = _mv_573.data.sym;
                                            __auto_type _mv_574 = ({ __auto_type _lst = param_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_574.has_value) {
                                                __auto_type type_expr = _mv_574.value;
                                                {
                            ...
                            case types_SExpr_sym:
                            {
                                ...
                                if (!(string_eq(sym.name, SLOP_STR("fn")))) {
                                    ...
                                    if (_mv_582.has_value) {
                                        __auto_type second = _mv_582.value;
                                        __auto_type _mv_583 = (*second);
                                        switch (_mv_583.tag) {
                                            case types_SExpr_lst:
                                            {
                                                __auto_type _ = _mv_583.data.lst;
                                                return 1;
                                            }
                                            default: {
                                                return 0;
...
slop_string expr_transpile_spawn_closure(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items, types_SExpr* fn_expr) {
    ...
    SLOP_PRE(((fn_expr != NULL)), "(!= fn-expr nil)");
    {
        ...
        if (_mv_584.has_value) {
            __auto_type arena_expr = _mv_584.value;
            {
                __auto_type arena_c = expr_transpile_expr(ctx, arena_expr);
            ...
            __auto_type lst = _mv_585.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 2) {
                    ...
                    if (_mv_586.has_value) {
                        __auto_type params_expr = _mv_586.value;
                        __auto_type _mv_587 = (*params_expr);
                        switch (_mv_587.tag) {
                            case types_SExpr_lst:
                            {
                                __auto_type params_lst = _mv_587.data.lst;
                                {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (((int64_t)((items).len)) < 2) {
            ...
            if (_mv_589.has_value) {
                __auto_type first_arg = _mv_589.value;
                {
...
slop_list_string expr_find_free_vars(context_TranspileContext* ctx, slop_list_string param_names, slop_list_types_SExpr_ptr body_items, int64_t start, slop_list_string pending) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = start;
        while (i < len) {
            __auto_type _mv_590 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_590.has_value) {
                __auto_type expr = _mv_590.value;
        ...
        }
        {
            ...
            int64_t j = 0;
            while (j < sym_count) {
                __auto_type _mv_591 = ({ __auto_type _lst = all_symbols; size_t _idx = (size_t)j; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_591.has_value) {
                    __auto_type sym_name = _mv_591.value;
    ...
    switch (_mv_592.tag) {
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_592.data.lst;
            {
                ...
                __auto_type len = ((int64_t)((items).len));
                if (len > 0) {
                    __auto_type _mv_593 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_593.has_value) {
                        __auto_type head = _mv_593.value;
                        __auto_type _mv_594 = (*head);
                        switch (_mv_594.tag) {
                            case types_SExpr_sym:
                            {
                                __auto_type head_sym = _mv_594.data.sym;
                                {
                                    __auto_type op = head_sym.name;
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_595.has_value) {
                __auto_type item = _mv_595.value;
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len >= 2) {
            ...
            if (_mv_596.has_value) {
                __auto_type bindings_expr = _mv_596.value;
                {
                    ...
                    __auto_type _mv_597 = (*bindings_expr);
                    switch (_mv_597.tag) {
                        case types_SExpr_lst:
                        {
                            __auto_type bindings_lst = _mv_597.data.lst;
                            {
                                __auto_type bindings = bindings_lst.items;
                                __auto_type binding_count = ((int64_t)((bindings).len));
                                __auto_type i = 0;
                                while (i < binding_count) {
                                    __auto_type _mv_598 = ({ __auto_type _lst = bindings; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    ...
                                                    if (((int64_t)((bind_items).len)) >= 2) {
                                                        {
                                                            ...
                                                            __auto_type _mv_600 = ({ __auto_type _lst = bind_items; size_t _idx = (size_t)val_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                            if (_mv_600.has_value) {
                                                                __auto_type val_expr = _mv_600.value;
...
uint8_t expr_is_mut_binding(slop_list_types_SExpr_ptr items) {
    if (((int64_t)((items).len)) < 1) {
        ...
        if (_mv_601.has_value) {
            __auto_type first = _mv_601.value;
            __auto_type _mv_602 = (*first);
            switch (_mv_602.tag) {
                case types_SExpr_sym:
                {
                                        ...
                                        if (((int64_t)((bind_items).len)) >= 1) {
                                            {
                                                ...
                                                __auto_type _mv_606 = ({ __auto_type _lst = bind_items; size_t _idx = (size_t)name_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len >= 2) {
            ...
            if (_mv_608.has_value) {
                __auto_type scrutinee = _mv_608.value;
            ...
            }
            {
                ...
                while (i < len) {
                    ...
                    if (_mv_609.has_value) {
                        __auto_type clause = _mv_609.value;
                        __auto_type _mv_610 = (*clause);
                        switch (_mv_610.tag) {
                            case types_SExpr_lst:
                            {
                                __auto_type clause_lst = _mv_610.data.lst;
                                {
                                    __auto_type clause_items = clause_lst.items;
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len >= 2) {
            ...
            if (_mv_611.has_value) {
                __auto_type binding = _mv_611.value;
                __auto_type _mv_612 = (*binding);
                switch (_mv_612.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type bind_lst = _mv_612.data.lst;
                        {
                            __auto_type bind_items = bind_lst.items;
...
slop_list_string expr_extract_for_loop_var_pending(slop_arena* arena, slop_list_string pending, slop_list_types_SExpr_ptr bind_items) {
    if (((int64_t)((bind_items).len)) < 1) {
        ...
        __auto_type _mv_613 = ({ __auto_type _lst = bind_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        if (_mv_613.has_value) {
            __auto_type var_expr = _mv_613.value;
            __auto_type _mv_614 = (*var_expr);
            switch (_mv_614.tag) {
                case types_SExpr_sym:
                {
                    __auto_type var_sym = _mv_614.data.sym;
                    {
                        __auto_type result = ((slop_list_string){ .data = (slop_string*)slop_arena_alloc(arena, 16 * sizeof(slop_string)), .len = 0, .cap = 16 });
                        ...
                        __auto_type i = 0;
                        while (i < plen) {
                            __auto_type _mv_615 = ({ __auto_type _lst = pending; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_615.has_value) {
                                __auto_type s = _mv_615.value;
        ...
        if (len >= 3) {
            {
                ...
                __auto_type size_idx = ((is_named) ? 3 : 1);
                __auto_type body_start = ((is_named) ? 4 : 2);
                __auto_type _mv_616 = ({ __auto_type _lst = items; size_t _idx = (size_t)size_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_616.has_value) {
                    __auto_type size_expr = _mv_616.value;
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len >= 2) {
            ...
            if (_mv_617.has_value) {
                __auto_type params_expr = _mv_617.value;
                __auto_type _mv_618 = (*params_expr);
                switch (_mv_618.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type params_lst = _mv_618.data.lst;
                        {
                            __auto_type params = params_lst.items;
                            __auto_type param_names = expr_extract_param_names(arena, params);
    ...
    if (expr_list_contains_string(param_names, sym_name)) {
        ...
        if (expr_list_contains_string(pending, sym_name)) {
            ...
            if (expr_is_builtin_op(sym_name)) {
                ...
                __auto_type _mv_619 = context_ctx_lookup_func(ctx, sym_name);
                if (_mv_619.has_value) {
                    __auto_type _ = _mv_619.value;
                    return 0;
                } else if (!_mv_619.has_value) {
                    __auto_type _mv_620 = context_ctx_lookup_type(ctx, sym_name);
                    if (_mv_620.has_value) {
                        __auto_type _ = _mv_620.value;
                        return 0;
                    } else if (!_mv_620.has_value) {
                        __auto_type _mv_621 = context_ctx_lookup_var(ctx, sym_name);
                        if (_mv_621.has_value) {
                            __auto_type _ = _mv_621.value;
                            return 1;
...
uint8_t expr_list_contains_string(slop_list_string lst, slop_string needle) {
    {
        ...
        uint8_t found = 0;
        while ((i < len) && !(found)) {
            __auto_type _mv_622 = ({ __auto_type _lst = lst; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_622.has_value) {
                __auto_type s = _mv_622.value;
...
slop_list_string expr_list_concat(slop_arena* arena, slop_list_string a, slop_list_string b) {
    {
        ...
        int64_t i = 0;
        while (i < len_a) {
            __auto_type _mv_623 = ({ __auto_type _lst = a; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        i = 0;
        while (i < len_b) {
            __auto_type _mv_624 = ({ __auto_type _lst = b; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_string expr_infer_collection_element_slop_type(context_TranspileContext* ctx, types_SExpr* coll_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_625 = (*coll_expr);
        switch (_mv_625.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_625.data.lst;
                {
                    __auto_type items = lst.items;
                    if (((int64_t)((items).len)) < 1) {
                        return SLOP_STR("");
                    } else {
                        __auto_type _mv_626 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_626.has_value) {
                            __auto_type head = _mv_626.value;
                            __auto_type _mv_627 = (*head);
                            switch (_mv_627.tag) {
                                case types_SExpr_sym:
                                {
