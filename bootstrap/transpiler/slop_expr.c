                                    ...
                                    __auto_type head_sym = _mv_185.data.sym;
                                    {
                                        ...
                                        if (string_eq(op, SLOP_STR(".")) && (len >= 3)) {
                                            ...
                                            if (_mv_199.has_value) {
                                                __auto_type inner_expr = _mv_199.value;
                                            ...
                                            if (_mv_200.has_value) {
                                                __auto_type func_entry = _mv_200.value;
                        ...
                        case types_SExpr_lst:
                        {
                            __auto_type lst = _mv_207.data.lst;
                            {
                                ...
                                if (len < 2) {
                                    ...
                                    __auto_type _mv_208 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    if (_mv_208.has_value) {
                                        __auto_type head_expr = _mv_208.value;
                                        __auto_type _mv_209 = (*head_expr);
                                        switch (_mv_209.tag) {
                                            case types_SExpr_sym:
                                            {
                                                    ...
                                                    if (string_eq(op, SLOP_STR("map-get"))) {
                                                        if (len < 2) {
                                                            ...
                                                            if (_mv_210.has_value) {
                                                                __auto_type map_expr = _mv_210.value;
                                                                __auto_type _mv_211 = (*map_expr);
                                                                switch (_mv_211.tag) {
                                                                    case types_SExpr_sym:
                                                                    {
                                                                        __auto_type map_sym = _mv_211.data.sym;
                                                                        {
                                                                            __auto_type map_name = map_sym.name;
                                                                            __auto_type _mv_212 = context_ctx_lookup_var(ctx, map_name);
                                                        ...
                                                        if (len < 2) {
                                                            ...
                                                            if (_mv_213.has_value) {
                                                                ...
                                                                __auto_type _mv_214 = (*list_expr);
                                                                switch (_mv_214.tag) {
                                                                    case types_SExpr_sym:
                                                                    {
                                                                        __auto_type list_sym = _mv_214.data.sym;
                                                                        {
                                                                            __auto_type list_name = list_sym.name;
                                                                            __auto_type _mv_215 = context_ctx_lookup_var(ctx, list_name);
...
slop_string expr_fix_ternary_none(context_TranspileContext* ctx, types_SExpr* other_expr, slop_string other_branch, slop_string this_branch) {
    ...
    if (string_eq(this_branch, SLOP_STR("none")) && strlib_starts_with(other_branch, SLOP_STR("(slop_option_"))) {
        {
            __auto_type arena = (*ctx).arena;
            __auto_type _mv_216 = expr_extract_option_type(arena, other_branch);
            if (_mv_216.has_value) {
                __auto_type opt_type = _mv_216.value;
    ...
    switch (_mv_219.tag) {
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_219.data.lst;
            {
                __auto_type items = lst.items;
                if (((int64_t)((items).len)) >= 1) {
                    __auto_type _mv_221 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            ...
                            case types_SExpr_sym:
                            {
                                __auto_type head_sym = _mv_222.data.sym;
                                {
                                    ...
                                    if (string_eq(op, SLOP_STR("deref"))) {
                                        ...
                                        __auto_type _mv_223 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        switch (_mv_224.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_224.data.lst;
                {
                    ...
                    __auto_type len = ((int64_t)((items).len));
                    if (len >= 2) {
                        __auto_type _mv_225 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_225.has_value) {
                            __auto_type head_ptr = _mv_225.value;
                            __auto_type _mv_226 = (*head_ptr);
                            switch (_mv_226.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type head_sym = _mv_226.data.sym;
                                    {
                                        __auto_type op = head_sym.name;
                                        if (string_eq(op, SLOP_STR("sizeof"))) {
                                            ...
                                            if (_mv_227.has_value) {
                                                __auto_type type_expr = _mv_227.value;
                                        ...
                                        } else if (string_eq(op, SLOP_STR("*")) || (string_eq(op, SLOP_STR("+")) || (string_eq(op, SLOP_STR("-")) || string_eq(op, SLOP_STR("/"))))) {
                                            {
                                                ...
                                                while (i < len) {
                                                    __auto_type _mv_228 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_228.has_value) {
                                                        __auto_type arg_expr = _mv_228.value;
                                                        {
...
slop_string expr_transpile_expr(context_TranspileContext* ctx, types_SExpr* expr) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    SLOP_PRE(((expr != NULL)), "(!= expr nil)");
    __auto_type _mv_229 = (*expr);
    switch (_mv_229.tag) {
        case types_SExpr_num:
        {
            __auto_type _ = _mv_229.data.num;
            return expr_transpile_literal(ctx, expr);
        }
        case types_SExpr_str:
        {
            __auto_type _ = _mv_229.data.str;
            return expr_transpile_literal(ctx, expr);
        }
        case types_SExpr_sym:
        {
            __auto_type _ = _mv_229.data.sym;
            return expr_transpile_literal(ctx, expr);
        }
        case types_SExpr_lst:
        {
        ...
        if (len < 1) {
            ...
            if (_mv_230.has_value) {
                ...
                switch (_mv_231.tag) {
                    case types_SExpr_sym:
                    {
                        __auto_type head_sym = _mv_231.data.sym;
                        {
                            __auto_type op = head_sym.name;
                            if (expr_is_binop(op) && (len < 3)) {
                                ...
                                if (_mv_237.has_value) {
                                    __auto_type cond_expr = _mv_237.value;
                                    ...
                                    if (_mv_238.has_value) {
                                        __auto_type then_expr = _mv_238.value;
                                        __auto_type _mv_239 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_239.has_value) {
                                            __auto_type else_expr = _mv_239.value;
                                            {
                                ...
                                if (_mv_241.has_value) {
                                    ...
                                    if (_mv_242.has_value) {
                                        __auto_type field_expr = _mv_242.value;
                                        __auto_type _mv_243 = (*field_expr);
                                        switch (_mv_243.tag) {
                                            case types_SExpr_sym:
                                            {
                                                __auto_type field_sym = _mv_243.data.sym;
                                                {
                                ...
                                if (_mv_244.has_value) {
                                    __auto_type type_expr = _mv_244.value;
                                ...
                                if (_mv_246.has_value) {
                                    __auto_type str_expr = _mv_246.value;
                                    __auto_type _mv_247 = (*str_expr);
                                    switch (_mv_247.tag) {
                                        case types_SExpr_str:
                                        {
                                            __auto_type str = _mv_247.data.str;
                                            return str.value;
                                        }
                                        default: {
                                ...
                                if (_mv_249.has_value) {
                                    __auto_type type_expr = _mv_249.value;
                                    {
                                        __auto_type c_type = context_to_c_type_prefixed(ctx, type_expr);
                                ...
                                if (_mv_251.has_value) {
                                    __auto_type arr_expr = _mv_251.value;
                                    ...
                                    if (_mv_252.has_value) {
                                        __auto_type idx_expr = _mv_252.value;
                                        {
                                ...
                                if (_mv_253.has_value) {
                                    __auto_type arena_expr = _mv_253.value;
                                    ...
                                    if (_mv_254.has_value) {
                                        __auto_type size_expr = _mv_254.value;
                                        {
                                            ...
                                            __auto_type _mv_255 = (*size_expr);
                                            switch (_mv_255.tag) {
                                                case types_SExpr_sym:
                                                {
                                                    __auto_type sym = _mv_255.data.sym;
                                                    {
                                                        __auto_type type_name = sym.name;
                                                        __auto_type _mv_256 = context_ctx_lookup_type(ctx, type_name);
                                                        if (_mv_256.has_value) {
                                                            __auto_type entry = _mv_256.value;
                                                            {
                                ...
                                if (_mv_258.has_value) {
                                    __auto_type arena_expr = _mv_258.value;
                                    {
                                        __auto_type arena_c = expr_transpile_expr(ctx, arena_expr);
                                ...
                                if (_mv_259.has_value) {
                                    __auto_type variant_expr = _mv_259.value;
                                    __auto_type _mv_260 = (*variant_expr);
                                    switch (_mv_260.tag) {
                                        case types_SExpr_sym:
                                        {
                                ...
                                if (_mv_261.has_value) {
                                    ...
                                    __auto_type _mv_262 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    if (_mv_262.has_value) {
                                        __auto_type tag_expr = _mv_262.value;
                                        __auto_type _mv_263 = (*type_expr);
                                        switch (_mv_263.tag) {
                                            case types_SExpr_sym:
                                            {
                                                __auto_type type_sym = _mv_263.data.sym;
                                                __auto_type _mv_264 = expr_extract_symbol_name(tag_expr);
                                                if (_mv_264.has_value) {
                                                    __auto_type tag_str = _mv_264.value;
                                                    {
                                                        ...
                                                        if (len >= 5) {
                                                            {
                                                                ...
                                                                for (int64_t vi = 3; vi < len; vi++) {
                                                                    __auto_type _mv_265 = ({ __auto_type _lst = items; size_t _idx = (size_t)vi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                            ...
                                                            __auto_type _mv_266 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                ...
                                if (_mv_269.has_value) {
                                    __auto_type result_expr = _mv_269.value;
                                    {
                                        __auto_type result_c = expr_transpile_expr(ctx, result_expr);
                                        __auto_type _mv_270 = context_ctx_get_current_result_type(ctx);
                                        if (_mv_270.has_value) {
                                            __auto_type enclosing_type = _mv_270.value;
                                ...
                                if (_mv_275.has_value) {
                                    __auto_type arena_expr = _mv_275.value;
                                    ...
                                    if (_mv_276.has_value) {
                                        __auto_type type_expr = _mv_276.value;
                                        {
                                            __auto_type arena_c = expr_transpile_expr(ctx, arena_expr);
                                ...
                                if (_mv_277.has_value) {
                                    ...
                                    if (_mv_278.has_value) {
                                        __auto_type item_expr = _mv_278.value;
                                        {
                                            __auto_type list_c = expr_transpile_expr(ctx, list_expr);
                                ...
                                if (_mv_279.has_value) {
                                    __auto_type ret_type = _mv_279.value;
                    ...
                    default: {
                        {
                            ...
                            __auto_type i = 1;
                            while (i < len) {
                                __auto_type _mv_280 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        if (string_eq(fn_name, SLOP_STR("println"))) {
            ...
            if (len < 3) {
                ...
                if (_mv_287.has_value) {
                    __auto_type fn_expr = _mv_287.value;
            ...
            if (len < 4) {
                ...
                if (_mv_288.has_value) {
                    ...
                    if (_mv_289.has_value) {
                        ...
                        __auto_type _mv_290 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_290.has_value) {
                            __auto_type cap_expr = _mv_290.value;
                            {
        ...
        } else {
            {
                ...
                if (string_len(builtin_c_name) > 0) {
                    ...
                    __auto_type _mv_296 = context_ctx_lookup_type(ctx, fn_name);
                    if (_mv_296.has_value) {
                        __auto_type type_entry = _mv_296.value;
                        if (type_entry.is_union) {
                        ...
                        } else {
                            {
                                ...
                                while (i < len) {
                                    __auto_type _mv_297 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        ...
                        __auto_type _mv_298 = context_ctx_lookup_enum_variant(ctx, fn_name);
                        if (_mv_298.has_value) {
                            __auto_type type_name = _mv_298.value;
                            {
                        ...
                        } else if (!_mv_298.has_value) {
                            {
                                ...
                                if (!_mv_301.has_value) {
                                    ...
                                    __auto_type func_entry = _mv_301.value;
                                    while (i < len) {
    ...
    SLOP_PRE(((arg != NULL)), "(!= arg nil)");
    {
        ...
        switch (_mv_304.tag) {
            ...
            default: {
                {
                    __auto_type arg_c = expr_transpile_expr(ctx, arg);
                    __auto_type _mv_305 = expr_get_expr_type_hint(ctx, arg);
                    if (_mv_305.has_value) {
                        __auto_type type_hint = _mv_305.value;
...
slop_option_string expr_get_expr_type_hint(context_TranspileContext* ctx, types_SExpr* expr) {
    ...
    SLOP_PRE(((expr != NULL)), "(!= expr nil)");
    {
        ...
        if (string_eq(slop_type, SLOP_STR("String"))) {
            ...
            __auto_type _mv_308 = (*expr);
            switch (_mv_308.tag) {
                case types_SExpr_sym:
                {
                    __auto_type sym = _mv_308.data.sym;
                    __auto_type _mv_309 = context_ctx_lookup_var(ctx, sym.name);
                    if (_mv_309.has_value) {
                        __auto_type entry = _mv_309.value;
                        {
                ...
                case types_SExpr_lst:
                {
                    __auto_type lst = _mv_308.data.lst;
                    {
                        __auto_type items = lst.items;
                        if (((int64_t)((items).len)) >= 1) {
                            __auto_type _mv_310 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_310.has_value) {
                                __auto_type head = _mv_310.value;
                                __auto_type _mv_311 = (*head);
                                switch (_mv_311.tag) {
                                    case types_SExpr_sym:
                                    {
                                        __auto_type head_sym = _mv_311.data.sym;
                                        {
                                            __auto_type op = head_sym.name;
                                            if (string_eq(op, SLOP_STR(".")) && (((int64_t)((items).len)) >= 3)) {
                                                {
                                                    ...
                                                    if (string_eq(c_type, SLOP_STR("slop_string"))) {
                                                        ...
                                                        if (_mv_312.has_value) {
                                                            __auto_type obj_expr = _mv_312.value;
                                                            ...
                                                            if (_mv_313.has_value) {
                                                                __auto_type field_expr = _mv_313.value;
                                                                __auto_type _mv_314 = (*field_expr);
                                                                switch (_mv_314.tag) {
                                                                    case types_SExpr_sym:
                                                                    {
                                                                        __auto_type field_sym = _mv_314.data.sym;
                                                                        {
                                                                            __auto_type field_name = field_sym.name;
                                                                            __auto_type obj_slop_type = expr_infer_expr_slop_type(ctx, obj_expr);
                                                                            if (string_len(obj_slop_type) > 0) {
                                                                                __auto_type _mv_315 = context_ctx_lookup_field_slop_type(ctx, obj_slop_type, field_name);
                                                                                if (_mv_315.has_value) {
                                                                                    __auto_type fst = _mv_315.value;
                                                ...
                                                __auto_type _mv_316 = context_ctx_lookup_func(ctx, op);
                                                if (_mv_316.has_value) {
                                                    __auto_type func_entry = _mv_316.value;
                                                    if (func_entry.returns_string) {
                                                        return (slop_option_string){.has_value = 1, .value = SLOP_STR("slop_string")};
                                                    } else {
                                                        return (slop_option_string){.has_value = false};
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 2) {
            ...
            if (_mv_317.has_value) {
                __auto_type tag_expr = _mv_317.value;
                __auto_type _mv_318 = (*tag_expr);
                switch (_mv_318.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type tag_list = _mv_318.data.lst;
                        {
                            __auto_type tag_items = tag_list.items;
                            if (((int64_t)((tag_items).len)) < 1) {
                                return context_ctx_str3(ctx, SLOP_STR("(("), c_type_name, SLOP_STR("){})"));
                            } else {
                                __auto_type _mv_319 = ({ __auto_type _lst = tag_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_319.has_value) {
                                    __auto_type tag_name_expr = _mv_319.value;
                                    __auto_type _mv_320 = (*tag_name_expr);
                                    switch (_mv_320.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type tag_sym = _mv_320.data.sym;
                                            {
                                                ...
                                                if (num_tag_items >= 3) {
                                                    {
                                                        ...
                                                        for (int64_t fi = 1; fi < num_tag_items; fi++) {
                                                            __auto_type _mv_321 = ({ __auto_type _lst = tag_items; size_t _idx = (size_t)fi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    ...
                                                    __auto_type _mv_322 = ({ __auto_type _lst = tag_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_323.has_value) {
                __auto_type clause_expr = _mv_323.value;
                __auto_type _mv_324 = (*clause_expr);
                switch (_mv_324.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type clause_lst = _mv_324.data.lst;
                        {
                            __auto_type clause_items = clause_lst.items;
                            __auto_type clause_len = ((int64_t)((clause_items).len));
                            if (clause_len >= 2) {
                                __auto_type _mv_325 = ({ __auto_type _lst = clause_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_325.has_value) {
                                    __auto_type test_expr = _mv_325.value;
                                    __auto_type _mv_326 = (*test_expr);
                                    switch (_mv_326.tag) {
                                        case types_SExpr_sym:
                                        {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 3) {
            ...
            if (_mv_330.has_value) {
                __auto_type scrutinee = _mv_330.value;
                {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_331.has_value) {
                __auto_type branch = _mv_331.value;
                __auto_type _mv_332 = (*branch);
                switch (_mv_332.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type branch_lst = _mv_332.data.lst;
                        {
                            __auto_type branch_items = branch_lst.items;
                            if (((int64_t)((branch_items).len)) >= 1) {
                                __auto_type _mv_333 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    ...
                    case types_SExpr_sym:
                    {
                        __auto_type s = _mv_340.data.sym;
                        {
                            ...
                            if (!(string_eq(name, SLOP_STR("else"))) && !(string_eq(name, SLOP_STR("_")))) {
                                __auto_type _mv_341 = context_ctx_lookup_enum_variant(ctx, name);
            ...
            if (_mv_342.has_value) {
                __auto_type pat_expr = _mv_342.value;
                {
                    ...
                    if ((!(string_eq(tag, SLOP_STR("")))) && (!(string_eq(tag, SLOP_STR("some")))) && (!(string_eq(tag, SLOP_STR("none")))) && (!(string_eq(tag, SLOP_STR("ok")))) && (!(string_eq(tag, SLOP_STR("error")))) && (!(string_eq(tag, SLOP_STR("else")))) && (!(string_eq(tag, SLOP_STR("_"))))) {
                        __auto_type _mv_343 = context_ctx_lookup_enum_variant(ctx, tag);
            ...
            __auto_type lst = _mv_344.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 2) {
                    ...
                    if (_mv_345.has_value) {
                        __auto_type binding = _mv_345.value;
                        __auto_type _mv_346 = (*binding);
                        switch (_mv_346.tag) {
                            case types_SExpr_sym:
                            {
...
slop_string expr_get_match_branch_body(context_TranspileContext* ctx, slop_list_types_SExpr_ptr branch_items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 2) {
            ...
            __auto_type _mv_347 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)(len - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    ...
    SLOP_PRE(((scrutinee != NULL)), "(!= scrutinee nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_348.has_value) {
                __auto_type branch = _mv_348.value;
                __auto_type _mv_349 = (*branch);
                switch (_mv_349.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type branch_lst = _mv_349.data.lst;
                        {
                            __auto_type branch_items = branch_lst.items;
                            if (((int64_t)((branch_items).len)) >= 2) {
                                __auto_type _mv_350 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_350.has_value) {
                                    __auto_type pattern = _mv_350.value;
                                    {
                                        __auto_type tag = expr_get_expr_pattern_tag(pattern);
                                        if (string_eq(tag, SLOP_STR("some"))) {
                                            __auto_type _mv_351 = expr_get_expr_binding_name(pattern);
                                            if (_mv_351.has_value) {
                                                __auto_type name = _mv_351.value;
                                                some_binding = name;
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 2) {
            ...
            if (_mv_352.has_value) {
                __auto_type first_clause = _mv_352.value;
                __auto_type _mv_353 = (*first_clause);
                switch (_mv_353.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type clause_lst = _mv_353.data.lst;
                        {
                            __auto_type clause_items = clause_lst.items;
                            __auto_type clause_len = ((int64_t)((clause_items).len));
                            if (clause_len < 2) {
...
slop_string expr_infer_match_branch_body_type(context_TranspileContext* ctx, types_SExpr* branch) {
    ...
    __auto_type _mv_355 = (*branch);
    switch (_mv_355.tag) {
        case types_SExpr_lst:
        {
            __auto_type branch_lst = _mv_355.data.lst;
            {
                __auto_type branch_items = branch_lst.items;
                ...
                if (branch_len < 2) {
                    ...
                    __auto_type _mv_356 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)(branch_len - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 3) {
            ...
            while ((i < len) && string_eq(result, SLOP_STR("__type_error__"))) {
                __auto_type _mv_357 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_string expr_slop_type_to_c_type(context_TranspileContext* ctx, slop_string slop_type) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_358 = context_ctx_lookup_type(ctx, slop_type);
        if (_mv_358.has_value) {
            __auto_type entry = _mv_358.value;
            return entry.c_name;
...
slop_string expr_infer_expr_c_type(context_TranspileContext* ctx, types_SExpr* expr) {
    ...
    SLOP_PRE(((expr != NULL)), "(!= expr nil)");
    {
        ...
        if (string_len(checker_type) > 0) {
            ...
            __auto_type _mv_359 = (*expr);
            switch (_mv_359.tag) {
                case types_SExpr_str:
                {
                    __auto_type _ = _mv_359.data.str;
                    return SLOP_STR("slop_string");
                }
                case types_SExpr_num:
                {
                    __auto_type num = _mv_359.data.num;
                    if (num.is_float) {
                        return SLOP_STR("double");
                    } else {
                        return SLOP_STR("int64_t");
                ...
                case types_SExpr_sym:
                {
                    ...
                    {
                        __auto_type name = sym.name;
                        __auto_type _mv_360 = context_ctx_lookup_var(ctx, name);
                ...
                case types_SExpr_lst:
                {
                    __auto_type lst = _mv_359.data.lst;
                    {
                        ...
                        if (((int64_t)((items).len)) < 1) {
                            ...
                            __auto_type _mv_361 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_361.has_value) {
                                __auto_type head = _mv_361.value;
                                __auto_type _mv_362 = (*head);
                                switch (_mv_362.tag) {
                                    case types_SExpr_sym:
                                    {
                                            ...
                                            if (({ __auto_type _mv = context_ctx_lookup_func(ctx, op); _mv.has_value ? ({ __auto_type func_entry = _mv.value; func_entry.returns_string; }) : (0); })) {
                                                ...
                                                if (((int64_t)((items).len)) < 3) {
                                                    ...
                                                    if (_mv_363.has_value) {
                                                        __auto_type body = _mv_363.value;
                                                ...
                                                if (((int64_t)((items).len)) < 2) {
                                                    ...
                                                    if (_mv_364.has_value) {
                                                        __auto_type last_expr = _mv_364.value;
                                                ...
                                                if (((int64_t)((items).len)) < 3) {
                                                    ...
                                                    if (_mv_366.has_value) {
                                                        __auto_type then_expr = _mv_366.value;
                                                ...
                                                if (_mv_368.has_value) {
                                                    __auto_type ret_type = _mv_368.value;
                                                    if (strlib_starts_with(ret_type, SLOP_STR("slop_option_"))) {
                                                        return ret_type;
                                                    } else {
                                                        return SLOP_STR("slop_option_int");
                                                ...
                                                if (((int64_t)((items).len)) < 2) {
                                                    ...
                                                    if (_mv_371.has_value) {
                                                        __auto_type inner = _mv_371.value;
                                                ...
                                                if (((int64_t)((items).len)) < 2) {
                                                    ...
                                                    if (_mv_372.has_value) {
                                                        __auto_type chan_arg = _mv_372.value;
                                                        {
                                                ...
                                                if (((int64_t)((items).len)) < 2) {
                                                    ...
                                                    if (_mv_376.has_value) {
                                                        __auto_type list_arg = _mv_376.value;
                                                        {
                                                ...
                                                __auto_type _mv_377 = context_ctx_lookup_type(ctx, op);
                                                if (_mv_377.has_value) {
                                                    __auto_type type_entry = _mv_377.value;
                                                    return type_entry.c_name;
                                                } else if (!_mv_377.has_value) {
                                                    __auto_type _mv_378 = context_ctx_lookup_func(ctx, op);
                ...
                switch (_mv_380.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type branch_lst = _mv_380.data.lst;
                        {
                            __auto_type branch_items = branch_lst.items;
                            if (((int64_t)((branch_items).len)) >= 2) {
                                __auto_type _mv_381 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_381.has_value) {
                                    __auto_type pattern = _mv_381.value;
                                    {
                                        ...
                                        if (string_eq(tag, SLOP_STR("ok"))) {
                                            ...
                                            __auto_type _mv_383 = expr_get_expr_binding_name(pattern);
                                            if (_mv_383.has_value) {
                                                __auto_type name = _mv_383.value;
                                                err_binding = name;
...
slop_string expr_wrap_fn_ref_as_closure(context_TranspileContext* ctx, slop_string expected_type, slop_string arg_c, types_SExpr* arg_expr) {
    ...
    if (string_eq(expected_type, SLOP_STR("slop_closure_t"))) {
        __auto_type _mv_391 = (*arg_expr);
        switch (_mv_391.tag) {
            case types_SExpr_sym:
            {
                __auto_type sym = _mv_391.data.sym;
                {
                    __auto_type slop_name = sym.name;
                    __auto_type _mv_392 = context_ctx_lookup_func(ctx, slop_name);
                    if (_mv_392.has_value) {
                        __auto_type func_entry = _mv_392.value;
                        {
        ...
        if (context_ctx_skip_trampoline_generation(ctx)) {
            ...
            if (context_ctx_has_trampoline(ctx, fn_c_name)) {
            ...
            } else {
                {
                    ...
                    int64_t i = 0;
                    while (i < count) {
                        __auto_type _mv_393 = ({ __auto_type _lst = param_types; size_t _idx = (size_t)i; slop_option_context_FuncParamType_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_393.has_value) {
                            __auto_type param_type_ptr = _mv_393.value;
                            {
        ...
        if (string_eq(tag, SLOP_STR("else")) || string_eq(tag, SLOP_STR("_"))) {
            ...
            if (_mv_394.has_value) {
                __auto_type type_name = _mv_394.value;
                {
                    ...
                    __auto_type _mv_395 = binding_opt;
                    if (_mv_395.has_value) {
                        __auto_type binding_name = _mv_395.value;
                        {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i >= 2) {
            ...
            if (_mv_396.has_value) {
                __auto_type branch = _mv_396.value;
                __auto_type _mv_397 = (*branch);
                switch (_mv_397.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type branch_lst = _mv_397.data.lst;
                        {
                            __auto_type branch_items = branch_lst.items;
                            if (((int64_t)((branch_items).len)) >= 2) {
                                __auto_type _mv_398 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_398.has_value) {
                                    __auto_type pattern = _mv_398.value;
                                    {
                                        __auto_type tag = expr_get_expr_pattern_tag(pattern);
...
uint8_t expr_discard_needs_void(types_SExpr* e) {
    __auto_type _mv_399 = (*e);
    switch (_mv_399.tag) {
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_399.data.lst;
            __auto_type _mv_400 = ({ __auto_type _lst = lst.items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 3) {
            ...
            if (_mv_402.has_value) {
                __auto_type bindings_expr = _mv_402.value;
                __auto_type _mv_403 = (*bindings_expr);
                switch (_mv_403.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type bindings_lst = _mv_403.data.lst;
                        context_ctx_push_scope(ctx);
                        {
                            __auto_type result = SLOP_STR("({ ");
                            ...
                            bi = 0;
                            while (bi < bindings_len) {
                                __auto_type _mv_405 = ({ __auto_type _lst = bindings_items; size_t _idx = (size_t)bi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_405.has_value) {
                                    __auto_type binding = _mv_405.value;
                                    {
                            ...
                            }
                            {
                                ...
                                while (i < (len - 1)) {
                                    ...
                                    if (_mv_406.has_value) {
                                        __auto_type body_expr = _mv_406.value;
                                        {
                                ...
                                switch (_mv_412.tag) {
                                    case types_SExpr_sym:
                                    {
                                        __auto_type name_sym = _mv_412.data.sym;
                                        {
                                            ...
                                            __auto_type init_idx = ((has_mut) ? ((has_type) ? 3 : 2) : ((has_type) ? 2 : 1));
                                            if (has_type) {
                                                __auto_type _mv_413 = ({ __auto_type _lst = items; size_t _idx = (size_t)type_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
uint8_t expr_binding_has_mut(slop_list_types_SExpr_ptr items) {
    if (((int64_t)((items).len)) < 1) {
        ...
        if (_mv_417.has_value) {
            __auto_type first = _mv_417.value;
            __auto_type _mv_418 = (*first);
            switch (_mv_418.tag) {
                case types_SExpr_sym:
                {
        ...
        } else {
            {
                ...
                while (i < len) {
                    ...
                    if (_mv_425.has_value) {
                        __auto_type expr = _mv_425.value;
                        {
...
uint8_t expr_set_is_self_assign(slop_list_types_SExpr_ptr items) {
    if (((int64_t)((items).len)) == 3) {
        ...
        if (_mv_428.has_value) {
            __auto_type target_expr = _mv_428.value;
            __auto_type _mv_429 = (*target_expr);
            switch (_mv_429.tag) {
                case types_SExpr_sym:
                {
                    __auto_type tsym = _mv_429.data.sym;
                    ...
                    if (_mv_430.has_value) {
                        ...
                        __auto_type _mv_431 = (*value_expr);
                        switch (_mv_431.tag) {
                            case types_SExpr_sym:
                            {
                                __auto_type vsym = _mv_431.data.sym;
            ...
            if (len < 3) {
                ...
                if (_mv_432.has_value) {
                    ...
                    if (_mv_433.has_value) {
                        ...
                        {
                            __auto_type val_c = expr_transpile_expr(ctx, val_expr);
                            __auto_type _mv_434 = (*target_expr);
                            switch (_mv_434.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type target_lst = _mv_434.data.lst;
                                    {
                                        ...
                                        if (((int64_t)((target_items).len)) < 1) {
                                            ...
                                            __auto_type _mv_435 = ({ __auto_type _lst = target_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                        ...
                                                        __auto_type sym = _mv_436.data.sym;
                                                        {
                                                            ...
                                                            if (string_eq(op, SLOP_STR("@"))) {
                                                                if (((int64_t)((target_items).len)) < 3) {
                                                                    ...
                                                                    __auto_type _mv_437 = ({ __auto_type _lst = target_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                                    if (_mv_437.has_value) {
                                                                        __auto_type arr_expr = _mv_437.value;
                                                                        __auto_type _mv_438 = ({ __auto_type _lst = target_items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                                        if (_mv_438.has_value) {
                                                                            __auto_type idx_expr = _mv_438.value;
                                                                            {
                                                                                __auto_type arr_c = expr_transpile_expr(ctx, arr_expr);
                                                                                __auto_type idx_c = expr_transpile_expr(ctx, idx_expr);
...
slop_string expr_resolve_arena_c_name(context_TranspileContext* ctx, slop_string op, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    __auto_type _mv_439 = context_ctx_lookup_var(ctx, SLOP_STR("arena"));
    if (_mv_439.has_value) {
        ...
        if (_mv_440.has_value) {
            __auto_type entry = _mv_440.value;
            return entry.c_name;
...
slop_string expr_get_arena_for_list_push_expr(context_TranspileContext* ctx, types_SExpr* list_expr, slop_string list_c) {
    ...
    if (_mv_441.has_value) {
        __auto_type arena_var = _mv_441.value;
        return arena_var.c_name;
    } else if (!_mv_441.has_value) {
        __auto_type _mv_442 = context_ctx_lookup_var(ctx, SLOP_STR("ctx"));
        if (_mv_442.has_value) {
            __auto_type ctx_var = _mv_442.value;
        ...
        } else if (!_mv_442.has_value) {
            {
                ...
                if (string_len(arena_from_field) > 0) {
                    ...
                    if (_mv_443.has_value) {
                        __auto_type arena_entry = _mv_443.value;
                            ...
                            case types_SExpr_sym:
                            {
                                ...
                                if (string_eq(sym.name, SLOP_STR("."))) {
                                    ...
                                    if (_mv_447.has_value) {
                                        __auto_type base_expr = _mv_447.value;
...
slop_string expr_get_arena_from_base(context_TranspileContext* ctx, types_SExpr* base_expr) {
    ...
    switch (_mv_448.tag) {
        case types_SExpr_sym:
        {
            ...
            {
                __auto_type var_name = sym.name;
                __auto_type _mv_449 = context_ctx_lookup_var(ctx, var_name);
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_448.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 2) {
                    ...
                    __auto_type _mv_450 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_450.has_value) {
                        __auto_type head_expr = _mv_450.value;
                        __auto_type _mv_451 = (*head_expr);
                        switch (_mv_451.tag) {
                            case types_SExpr_sym:
                            {
                                ...
                                if (string_eq(sym.name, SLOP_STR("deref"))) {
                                    ...
                                    if (_mv_452.has_value) {
                                        __auto_type ptr_expr = _mv_452.value;
                                        {
...
uint8_t expr_is_ptr_to_ptr_map(context_TranspileContext* ctx, types_SExpr* expr) {
    ...
    switch (_mv_453.tag) {
        case types_SExpr_sym:
        {
            ...
            {
                __auto_type name = sym.name;
                __auto_type _mv_454 = context_ctx_lookup_var(ctx, name);
                if (_mv_454.has_value) {
                    __auto_type entry = _mv_454.value;
                    {
                        __auto_type c_type = entry.c_type;
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 2) {
            ...
            if (_mv_455.has_value) {
                ...
                __auto_type _mv_456 = (*type_expr);
                switch (_mv_456.tag) {
                    case types_SExpr_sym:
                    {
                        __auto_type type_sym = _mv_456.data.sym;
                        {
                            __auto_type raw_type_name = type_sym.name;
                    ...
                    case types_SExpr_lst:
                    {
                        __auto_type type_lst = _mv_456.data.lst;
                        {
                            ...
                            if (((int64_t)((type_items).len)) < 1) {
                                ...
                                __auto_type _mv_457 = ({ __auto_type _lst = type_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_457.has_value) {
                                    ...
                                    switch (_mv_458.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type head_sym = _mv_458.data.sym;
                                    ...
                                    switch (_mv_462.tag) {
                                        case types_SExpr_sym:
                                        {
                                            ...
                                            if (_mv_463.has_value) {
                                                __auto_type val_expr = _mv_463.value;
                                                {
...
slop_string expr_build_inline_struct_type(context_TranspileContext* ctx, slop_list_types_SExpr_ptr type_items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 1;
        while (i < len) {
            __auto_type _mv_464 = ({ __auto_type _lst = type_items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_string expr_transpile_inline_record_fields(context_TranspileContext* ctx, slop_string struct_def, slop_list_types_SExpr_ptr items, int64_t start_idx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        uint8_t first = 1;
        while (i < len) {
            __auto_type _mv_469 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_469.has_value) {
                __auto_type field_expr = _mv_469.value;
                __auto_type _mv_470 = (*field_expr);
                switch (_mv_470.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type field_lst = _mv_470.data.lst;
                        {
                            __auto_type field_items = field_lst.items;
                            if (((int64_t)((field_items).len)) >= 2) {
                                __auto_type _mv_471 = ({ __auto_type _lst = field_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_471.has_value) {
                                    ...
                                    switch (_mv_472.tag) {
                                        case types_SExpr_sym:
                                        {
                                            ...
                                            __auto_type _mv_473 = ({ __auto_type _lst = field_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_473.has_value) {
                                                __auto_type val_expr = _mv_473.value;
                                                {
                                                    __auto_type field_name = ctype_to_c_name(arena, name_sym.name);
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 2) {
            ...
            if (_mv_474.has_value) {
                __auto_type type_expr = _mv_474.value;
                {
                    ...
                    __auto_type elem_count = (len - 2);
                    {
                        ...
                        while (i < len) {
                            ...
                            if (_mv_475.has_value) {
                                __auto_type elem_expr = _mv_475.value;
                        ...
                        }
                        {
                            ...
                            __auto_type _mv_476 = arena_var;
                            if (_mv_476.has_value) {
                                __auto_type arena_var = _mv_476.value;
                                {
                                ...
                                context_ctx_add_warning(ctx, SLOP_STR("list literal uses stack-allocated compound literal (no arena in scope)"));
                                {
                                    ...
                                    i = 0;
                                    while (i < ((int64_t)((elem_codes).len))) {
                                        __auto_type _mv_478 = ({ __auto_type _lst = elem_codes; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_478.has_value) {
                                            __auto_type ec = _mv_478.value;
                                            if (first) {
...
slop_string expr_get_map_key_c_info(context_TranspileContext* ctx, types_SExpr* key_type_expr) {
    ...
    __auto_type _mv_479 = (*key_type_expr);
    switch (_mv_479.tag) {
        case types_SExpr_sym:
        {
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_479.data.lst;
            {
                __auto_type items = lst.items;
                if (((int64_t)((items).len)) < 1) {
                    return SLOP_STR("sizeof(void*), slop_hash_ptr, slop_eq_ptr");
                } else {
                    __auto_type _mv_480 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_string expr_get_struct_key_info_by_name(context_TranspileContext* ctx, slop_string name) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    __auto_type _mv_482 = context_ctx_lookup_type(ctx, name);
    if (_mv_482.has_value) {
        __auto_type type_entry = _mv_482.value;
        {
            __auto_type c_name = type_entry.c_name;
            context_ctx_register_struct_key_type(ctx, c_name);
            return expr_build_struct_key_info(ctx, c_name);
        ...
        __auto_type _mv_483 = context_ctx_get_module(ctx);
        if (_mv_483.has_value) {
            __auto_type mod = _mv_483.value;
            {
                __auto_type prefixed = context_ctx_str3(ctx, mod, SLOP_STR("_"), name);
                __auto_type _mv_484 = context_ctx_lookup_type(ctx, prefixed);
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 3) {
            ...
            if (_mv_486.has_value) {
                __auto_type arena_expr = _mv_486.value;
                ...
                if (_mv_487.has_value) {
                    __auto_type key_type_expr = _mv_487.value;
                    {
                        __auto_type arena_c = expr_transpile_expr(ctx, arena_expr);
        ...
        if (len < 4) {
            ...
            if (_mv_488.has_value) {
                ...
                if (_mv_489.has_value) {
                    ...
                    __auto_type _mv_490 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        if (len < 3) {
            ...
            if (_mv_498.has_value) {
                ...
                if (_mv_499.has_value) {
                    __auto_type elem_type_expr = _mv_499.value;
                    {
                        __auto_type arena_c = expr_transpile_expr(ctx, arena_expr);
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 3) {
            ...
            if (_mv_500.has_value) {
                __auto_type set_expr = _mv_500.value;
                        ...
                        __auto_type binding_lst = _mv_510.data.lst;
                        {
                            ...
                            if (binding_len < 3) {
                                ...
                                if (_mv_511.has_value) {
                                    __auto_type var_expr = _mv_511.value;
                                    __auto_type _mv_512 = (*var_expr);
                                    switch (_mv_512.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type var_sym = _mv_512.data.sym;
                                            {
                                                ...
                                                if (_mv_513.has_value) {
                                                    __auto_type start_expr = _mv_513.value;
                                                    __auto_type _mv_514 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_514.has_value) {
                                                        __auto_type end_expr = _mv_514.value;
                                                        {
                        ...
                        __auto_type binding_lst = _mv_517.data.lst;
                        {
                            ...
                            if (binding_len < 2) {
                                ...
                                if (_mv_518.has_value) {
                                    __auto_type first_elem = _mv_518.value;
                                    __auto_type _mv_519 = (*first_elem);
                                    switch (_mv_519.tag) {
                                        case types_SExpr_lst:
                                        {
                                            __auto_type _ = _mv_519.data.lst;
                                        ...
                                        case types_SExpr_sym:
                                        {
                                            __auto_type var_sym = _mv_519.data.sym;
                                            {
                                                ...
                                                if (_mv_520.has_value) {
                                                    __auto_type coll_expr = _mv_520.value;
                                                    {
...
slop_string expr_transpile_for_each_map_kv_as_expr(context_TranspileContext* ctx, slop_list_types_SExpr_ptr binding_items, slop_list_types_SExpr_ptr items, int64_t len) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_524 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        if (_mv_524.has_value) {
            __auto_type kv_list_expr = _mv_524.value;
            __auto_type _mv_525 = (*kv_list_expr);
            switch (_mv_525.tag) {
                case types_SExpr_lst:
                {
                    __auto_type kv_lst = _mv_525.data.lst;
                    {
                        __auto_type kv_items = kv_lst.items;
                        if (((int64_t)((kv_items).len)) < 2) {
                            return SLOP_STR("({ /* for-each: map binding needs ((k v) map) */ 0; })");
                        } else {
                            __auto_type _mv_526 = ({ __auto_type _lst = kv_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_526.has_value) {
                                __auto_type k_expr = _mv_526.value;
                                __auto_type _mv_527 = ({ __auto_type _lst = kv_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_527.has_value) {
                                    __auto_type v_expr = _mv_527.value;
                                    ...
                                    if (_mv_528.has_value) {
                                        __auto_type map_expr = _mv_528.value;
                                        __auto_type _mv_529 = (*k_expr);
                                        switch (_mv_529.tag) {
                                            case types_SExpr_sym:
                                            {
                                                __auto_type k_sym = _mv_529.data.sym;
                                                __auto_type _mv_530 = (*v_expr);
                                                switch (_mv_530.tag) {
                                                    case types_SExpr_sym:
                                                    {
                                                        __auto_type v_sym = _mv_530.data.sym;
                                                        {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 2) {
            ...
            if (_mv_532.has_value) {
                __auto_type second = _mv_532.value;
                __auto_type _mv_533 = (*second);
                switch (_mv_533.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type params_lst = _mv_533.data.lst;
                        return expr_transpile_lambda_with_params(ctx, items, params_lst.items);
                    }
                    case types_SExpr_sym:
                    {
                        __auto_type _ = _mv_533.data.sym;
...
slop_string expr_find_arena_ptr_expr(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    __auto_type _mv_541 = context_ctx_lookup_var(ctx, SLOP_STR("_arena"));
    if (_mv_541.has_value) {
        __auto_type entry = _mv_541.value;
        return SLOP_STR("&_arena");
    } else if (!_mv_541.has_value) {
        __auto_type _mv_542 = context_ctx_lookup_var(ctx, SLOP_STR("arena"));
