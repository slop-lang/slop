    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while ((i < len) && string_eq(found, SLOP_STR(""))) {
            ...
            if (_mv_134.has_value) {
                __auto_type field = _mv_134.value;
                {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len <= (start_idx + 1)) {
        ...
        } else {
            {
                ...
                __auto_type _mv_135 = ({ __auto_type _lst = items; size_t _idx = (size_t)start_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_135.has_value) {
                    __auto_type first_arg = _mv_135.value;
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_137.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 1) {
                    ...
                    __auto_type _mv_138 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
uint8_t expr_is_string_literal(types_SExpr* expr) {
    SLOP_PRE(((expr != NULL)), "(!= expr nil)");
    __auto_type _mv_140 = (*expr);
    switch (_mv_140.tag) {
        case types_SExpr_str:
        {
            __auto_type _ = _mv_140.data.str;
            return 1;
        }
        default: {
            return 0;
...
uint8_t expr_is_fn_type_expr(types_SExpr* type_expr) {
    ...
    switch (_mv_141.tag) {
        case types_SExpr_lst:
        {
            ...
            __auto_type _mv_142 = ({ __auto_type _lst = lst.items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_142.has_value) {
                __auto_type head = _mv_142.value;
                __auto_type _mv_143 = (*head);
                switch (_mv_143.tag) {
                    case types_SExpr_sym:
                    {
...
uint8_t expr_is_ptr_void_type(types_SExpr* type_expr) {
    SLOP_PRE(((type_expr != NULL)), "(!= type-expr nil)");
    __auto_type _mv_144 = (*type_expr);
    switch (_mv_144.tag) {
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_144.data.lst;
            {
                __auto_type items = lst.items;
...
uint8_t expr_is_closure_typed_expr(context_TranspileContext* ctx, types_SExpr* expr) {
    ...
    switch (_mv_145.tag) {
        case types_SExpr_sym:
        {
            ...
            __auto_type _mv_146 = context_ctx_lookup_var(ctx, sym.name);
            if (_mv_146.has_value) {
                __auto_type entry = _mv_146.value;
...
slop_string expr_fn_type_to_c_fn_ptr(context_TranspileContext* ctx, types_SExpr* fn_expr) {
    ...
    __auto_type _mv_147 = (*fn_expr);
    switch (_mv_147.tag) {
        case types_SExpr_lst:
        {
            __auto_type l = _mv_147.data.lst;
            {
    ...
    switch (_mv_148.tag) {
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_148.data.lst;
            {
                ...
                __auto_type i = 0;
                while (i < count) {
                    __auto_type _mv_149 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_149.has_value) {
                        __auto_type arg_type = _mv_149.value;
                        {
        ...
        __auto_type arena = (*ctx).arena;
        {
            ...
            if (string_len(runtime_name) > 0) {
            ...
            } else {
                {
                    ...
                    __auto_type _mv_150 = context_ctx_lookup_var(ctx, fn_name);
...
slop_string expr_closure_type_to_c(context_TranspileContext* ctx, slop_string slop_type) {
    ...
    if (string_eq(slop_type, SLOP_STR("Int"))) {
        ...
        __auto_type _mv_151 = context_ctx_lookup_type(ctx, slop_type);
        if (_mv_151.has_value) {
            __auto_type type_entry = _mv_151.value;
...
slop_string expr_transpile_enum_variant(context_TranspileContext* ctx, slop_string variant_name) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_152 = context_ctx_lookup_enum_variant(ctx, variant_name);
        if (_mv_152.has_value) {
            __auto_type enum_name = _mv_152.value;
            {
...
slop_string expr_transpile_error(context_TranspileContext* ctx, slop_string value_c) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    __auto_type _mv_154 = context_ctx_get_current_result_type(ctx);
    if (_mv_154.has_value) {
        __auto_type result_type = _mv_154.value;
...
slop_string expr_infer_option_type(context_TranspileContext* ctx, types_SExpr* val_expr) {
    ...
    __auto_type _mv_155 = (*val_expr);
    switch (_mv_155.tag) {
        case types_SExpr_num:
        {
            __auto_type num = _mv_155.data.num;
            if (num.is_float) {
        ...
        case types_SExpr_str:
        {
            __auto_type _ = _mv_155.data.str;
            return SLOP_STR("slop_option_string");
        }
        case types_SExpr_sym:
        {
            __auto_type sym = _mv_155.data.sym;
            __auto_type _mv_156 = ctype_get_node_resolved_type(val_expr);
            if (_mv_156.has_value) {
                __auto_type rt = _mv_156.value;
                {
            ...
            } else if (!_mv_156.has_value) {
                {
                    ...
                    __auto_type _mv_157 = context_ctx_lookup_var(ctx, name);
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 3) {
            ...
            if (_mv_158.has_value) {
                __auto_type obj_expr = _mv_158.value;
                __auto_type _mv_159 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_159.has_value) {
                    __auto_type field_expr = _mv_159.value;
                    __auto_type _mv_160 = (*field_expr);
                    switch (_mv_160.tag) {
                        case types_SExpr_sym:
                        {
                            __auto_type field_sym = _mv_160.data.sym;
                            {
                                __auto_type field_name = field_sym.name;
                                __auto_type obj_c_type = expr_infer_expr_c_type(ctx, obj_expr);
                                __auto_type _mv_161 = context_ctx_lookup_field_type(ctx, obj_c_type, field_name);
                                if (_mv_161.has_value) {
                                    __auto_type c_type = _mv_161.value;
                                    return c_type;
                                } else if (!_mv_161.has_value) {
                                    __auto_type _mv_162 = context_ctx_lookup_var(ctx, expr_get_var_name_from_expr(obj_expr));
                                    if (_mv_162.has_value) {
                                        __auto_type var_entry = _mv_162.value;
                                        {
                                            __auto_type obj_slop_type = var_entry.slop_type;
                                            __auto_type _mv_163 = context_ctx_lookup_field_type(ctx, obj_slop_type, field_name);
                                            if (_mv_163.has_value) {
                                                __auto_type c_type2 = _mv_163.value;
                                                return c_type2;
...
slop_string expr_infer_list_expr_option_type(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 1) {
            ...
            __auto_type _mv_164 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_164.has_value) {
                __auto_type head_expr = _mv_164.value;
                __auto_type _mv_165 = (*head_expr);
                switch (_mv_165.tag) {
                    case types_SExpr_sym:
                    {
                        __auto_type sym = _mv_165.data.sym;
                        {
                            ...
                            if (string_eq(op, SLOP_STR("."))) {
                                if (len < 3) {
                                ...
                                } else {
                                    {
                                        ...
                                        if (!(string_eq(field_c_type, SLOP_STR("__auto_type")))) {
                                            ...
                                            __auto_type _mv_166 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                ...
                                __auto_type _mv_168 = context_ctx_lookup_func(ctx, op);
                                if (_mv_168.has_value) {
                                    __auto_type func_entry = _mv_168.value;
                                    {
...
slop_string expr_infer_list_element_option_type(context_TranspileContext* ctx, types_SExpr* list_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_169 = ctype_get_node_resolved_type(list_expr);
        if (_mv_169.has_value) {
            __auto_type rt = _mv_169.value;
            __auto_type _mv_170 = (*rt).inner_type;
            if (_mv_170.has_value) {
                __auto_type elem_type = _mv_170.value;
                {
    ...
    SLOP_PRE(((list_expr != NULL)), "(!= list-expr nil)");
    {
        ...
        if (strlib_starts_with(list_c_type, SLOP_STR("slop_list_"))) {
            ...
            switch (_mv_171.tag) {
                ...
                case types_SExpr_lst:
                {
                    __auto_type lst = _mv_171.data.lst;
                    {
                        __auto_type items = lst.items;
                        if (((int64_t)((items).len)) < 3) {
                            return SLOP_STR("");
                        } else {
                            __auto_type _mv_173 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_173.has_value) {
                                __auto_type head = _mv_173.value;
                                __auto_type _mv_174 = (*head);
                                switch (_mv_174.tag) {
                                    case types_SExpr_sym:
                                    {
                                        __auto_type head_sym = _mv_174.data.sym;
                                        if (string_eq(head_sym.name, SLOP_STR("."))) {
                                            __auto_type _mv_175 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_175.has_value) {
                                                __auto_type field_expr = _mv_175.value;
...
slop_string expr_infer_field_access_list_type(context_TranspileContext* ctx, types_SExpr* field_expr) {
    ...
    __auto_type _mv_176 = (*field_expr);
    switch (_mv_176.tag) {
        case types_SExpr_sym:
        {
            __auto_type field_sym = _mv_176.data.sym;
            {
                __auto_type field_name = field_sym.name;
        ...
        if (strlib_ends_with(elem_type, SLOP_STR("_ptr"))) {
            {
                ...
                __auto_type _mv_177 = context_ctx_lookup_type(ctx, base);
...
slop_string expr_slop_value_type_to_c_type(context_TranspileContext* ctx, slop_string slop_type) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (strlib_starts_with(slop_type, SLOP_STR("(Map "))) {
            ...
            __auto_type _mv_179 = context_ctx_lookup_type(ctx, slop_type);
            if (_mv_179.has_value) {
                __auto_type entry = _mv_179.value;
                return entry.c_name;
...
slop_string expr_resolve_type_alias(context_TranspileContext* ctx, slop_string slop_type) {
    ...
    if (strlib_starts_with(slop_type, SLOP_STR("(Map "))) {
        ...
        __auto_type _mv_181 = context_ctx_lookup_type_alias(ctx, slop_type);
        if (_mv_181.has_value) {
            __auto_type alias_def = _mv_181.value;
            return alias_def;
...
slop_string expr_infer_expr_slop_type(context_TranspileContext* ctx, types_SExpr* expr) {
    ...
    SLOP_PRE(((expr != NULL)), "(!= expr nil)");
    {
        ...
        switch (_mv_182.tag) {
            case types_SExpr_sym:
            {
                __auto_type sym = _mv_182.data.sym;
                {
                    __auto_type name = sym.name;
                    __auto_type _mv_183 = context_ctx_lookup_var(ctx, name);
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_182.data.lst;
                {
                    ...
                    if (len < 1) {
                        ...
                        __auto_type _mv_184 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_184.has_value) {
                            __auto_type head = _mv_184.value;
                            __auto_type _mv_185 = (*head);
                            switch (_mv_185.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type head_sym = _mv_185.data.sym;
                                    {
                                        __auto_type op = head_sym.name;
                                        if (string_eq(op, SLOP_STR(".")) && (len >= 3)) {
                                            __auto_type _mv_186 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_186.has_value) {
                                                __auto_type obj_expr = _mv_186.value;
                                                __auto_type _mv_187 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                        ...
                                                        case types_SExpr_sym:
                                                        {
                                                            __auto_type field_sym = _mv_188.data.sym;
                                                            {
                                                                __auto_type field_name = field_sym.name;
                                                                {
                                                                    ...
                                                                    __auto_type _mv_189 = context_ctx_lookup_field_slop_type(ctx, obj_c_type, field_name);
                                                                    if (_mv_189.has_value) {
                                                                        __auto_type slop_type = _mv_189.value;
                                                                        return slop_type;
                                                                    } else if (!_mv_189.has_value) {
                                                                        {
                                                                            ...
                                                                            __auto_type _mv_190 = context_ctx_lookup_field_slop_type(ctx, obj_slop_type, field_name);
                                                                            if (_mv_190.has_value) {
                                                                                __auto_type slop_type2 = _mv_190.value;
                                                                                return slop_type2;
                                            ...
                                            if (len >= 2) {
                                                ...
                                                if (_mv_191.has_value) {
                                                    ...
                                                    __auto_type _mv_192 = (*type_expr);
                                                    switch (_mv_192.tag) {
                                                        case types_SExpr_sym:
                                                        {
                                                            __auto_type type_sym = _mv_192.data.sym;
                                            ...
                                            if (len >= 4) {
                                                ...
                                                if (_mv_193.has_value) {
                                                    __auto_type key_expr = _mv_193.value;
                                                    __auto_type _mv_194 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            ...
                                            if (len >= 2) {
                                                ...
                                                if (_mv_196.has_value) {
                                                    __auto_type elem_expr = _mv_196.value;
                                                    {
                                                        __auto_type elem_str = ctype_sexpr_to_type_string(arena, elem_expr);
                                                        return context_ctx_str3(ctx, SLOP_STR("(Set "), elem_str, SLOP_STR(")"));
                                                    }
                                            ...
                                            if (len >= 2) {
                                                ...
                                                if (_mv_197.has_value) {
                                                    __auto_type elem_expr = _mv_197.value;
                                                    {
                                                        __auto_type elem_str = ctype_sexpr_to_type_string(arena, elem_expr);
                                            ...
                                            if (len >= 3) {
                                                ...
                                                if (_mv_198.has_value) {
                                                    __auto_type elem_expr = _mv_198.value;
                                                    {
                                                        __auto_type elem_str = ctype_sexpr_to_type_string(arena, elem_expr);
                                                        return context_ctx_str3(ctx, SLOP_STR("(List "), elem_str, SLOP_STR(")"));
                                                    }
                                            ...
                                            if (len >= 3) {
                                                ...
                                                if (_mv_200.has_value) {
                                                    __auto_type type_expr = _mv_200.value;
                                                    {
                                                        __auto_type type_str = ctype_sexpr_to_type_string(arena, type_expr);
                                                        return context_ctx_str3(ctx, SLOP_STR("(Ptr (Chan "), type_str, SLOP_STR("))"));
                                                    }
                                            ...
                                            if (_mv_201.has_value) {
                                                __auto_type inner_expr = _mv_201.value;
                                            ...
                                            __auto_type _mv_202 = context_ctx_lookup_func(ctx, op);
                                            if (_mv_202.has_value) {
                                                __auto_type func_entry = _mv_202.value;
        ...
        __auto_type arena = (*ctx).arena;
        {
            __auto_type expr_type = expr_infer_expr_slop_type(ctx, scrutinee);
            {
                ...
                if (strlib_starts_with(resolved, SLOP_STR("(Option "))) {
                    ...
                    __auto_type _mv_209 = (*scrutinee);
                    switch (_mv_209.tag) {
                        case types_SExpr_lst:
                        {
                            __auto_type lst = _mv_209.data.lst;
                            {
                                __auto_type items = lst.items;
                                __auto_type len = ((int64_t)((items).len));
                                if (len < 2) {
                                    ...
                                    __auto_type _mv_210 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    if (_mv_210.has_value) {
                                        __auto_type head_expr = _mv_210.value;
                                        __auto_type _mv_211 = (*head_expr);
                                        switch (_mv_211.tag) {
                                            case types_SExpr_sym:
                                            {
                                                __auto_type sym = _mv_211.data.sym;
                                                {
                                                    __auto_type op = sym.name;
                                                    if (string_eq(op, SLOP_STR("map-get"))) {
                                                        if (len < 2) {
                                                            ...
                                                            if (_mv_212.has_value) {
                                                                __auto_type map_expr = _mv_212.value;
                                                                __auto_type _mv_213 = (*map_expr);
                                                                switch (_mv_213.tag) {
                                                                    case types_SExpr_sym:
                                                                    {
                                                                        __auto_type map_sym = _mv_213.data.sym;
                                                                        {
                                                                            __auto_type map_name = map_sym.name;
                                                                            __auto_type _mv_214 = context_ctx_lookup_var(ctx, map_name);
                                                        ...
                                                        if (len < 2) {
                                                            ...
                                                            if (_mv_215.has_value) {
                                                                ...
                                                                __auto_type _mv_216 = (*list_expr);
                                                                switch (_mv_216.tag) {
                                                                    case types_SExpr_sym:
                                                                    {
                                                                        __auto_type list_sym = _mv_216.data.sym;
                                                                        {
                                                                            __auto_type list_name = list_sym.name;
                                                                            __auto_type _mv_217 = context_ctx_lookup_var(ctx, list_name);
...
slop_string expr_fix_ternary_none(context_TranspileContext* ctx, types_SExpr* other_expr, slop_string other_branch, slop_string this_branch) {
    ...
    if (string_eq(this_branch, SLOP_STR("none")) && strlib_starts_with(other_branch, SLOP_STR("(slop_option_"))) {
        {
            __auto_type arena = (*ctx).arena;
            __auto_type _mv_218 = expr_extract_option_type(arena, other_branch);
            if (_mv_218.has_value) {
                __auto_type opt_type = _mv_218.value;
                ...
                __auto_type lst = _mv_226.data.lst;
                {
                    ...
                    if (len >= 2) {
                        ...
                        if (_mv_227.has_value) {
                            __auto_type head_ptr = _mv_227.value;
                            __auto_type _mv_228 = (*head_ptr);
                            switch (_mv_228.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type head_sym = _mv_228.data.sym;
                                    {
                                        ...
                                        if (string_eq(op, SLOP_STR("sizeof"))) {
                                        ...
                                        } else if (string_eq(op, SLOP_STR("*")) || (string_eq(op, SLOP_STR("+")) || (string_eq(op, SLOP_STR("-")) || string_eq(op, SLOP_STR("/"))))) {
                                            {
                                                ...
                                                while (i < len) {
                                                    __auto_type _mv_230 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_230.has_value) {
                                                        __auto_type arg_expr = _mv_230.value;
                                                        {
...
slop_string expr_transpile_expr(context_TranspileContext* ctx, types_SExpr* expr) {
    ...
    switch (_mv_231.tag) {
        case types_SExpr_num:
        {
            __auto_type _ = _mv_231.data.num;
            return expr_transpile_literal(ctx, expr);
        }
        case types_SExpr_str:
        {
            __auto_type _ = _mv_231.data.str;
            return expr_transpile_literal(ctx, expr);
        }
        case types_SExpr_sym:
        {
            __auto_type _ = _mv_231.data.sym;
            return expr_transpile_literal(ctx, expr);
        }
        case types_SExpr_lst:
        {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 1) {
            ...
            if (_mv_232.has_value) {
                __auto_type head_expr = _mv_232.value;
                __auto_type _mv_233 = (*head_expr);
                switch (_mv_233.tag) {
                    case types_SExpr_sym:
                    {
                            ...
                            if (expr_is_binop(op) && (len < 3)) {
                                ...
                                if (len > 3) {
                                    ...
                                    if (_mv_234.has_value) {
                                        __auto_type left = _mv_234.value;
                                        ...
                                        if (_mv_235.has_value) {
                                            __auto_type right = _mv_235.value;
                                            {
                                ...
                                if (_mv_236.has_value) {
                                    __auto_type left = _mv_236.value;
                                    ...
                                    if (_mv_237.has_value) {
                                        __auto_type right = _mv_237.value;
                                        {
                                            __auto_type left_c = expr_transpile_expr(ctx, left);
                                            __auto_type right_c = expr_transpile_expr(ctx, right);
                                ...
                                if (_mv_239.has_value) {
                                    __auto_type cond_expr = _mv_239.value;
                                    ...
                                    if (_mv_240.has_value) {
                                        __auto_type then_expr = _mv_240.value;
                                        __auto_type _mv_241 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_241.has_value) {
                                            __auto_type else_expr = _mv_241.value;
                                            {
                                ...
                                if (_mv_243.has_value) {
                                    ...
                                    if (_mv_244.has_value) {
                                        __auto_type field_expr = _mv_244.value;
                                        __auto_type _mv_245 = (*field_expr);
                                        switch (_mv_245.tag) {
                                            case types_SExpr_sym:
                                            {
                                                __auto_type field_sym = _mv_245.data.sym;
                                                {
                                ...
                                if (_mv_246.has_value) {
                                    ...
                                    __auto_type _mv_247 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                ...
                                if (_mv_248.has_value) {
                                    __auto_type str_expr = _mv_248.value;
                                    __auto_type _mv_249 = (*str_expr);
                                    switch (_mv_249.tag) {
                                        case types_SExpr_str:
                                        {
                                            __auto_type str = _mv_249.data.str;
                                            return str.value;
                                        }
                                        default: {
                                ...
                                if (_mv_250.has_value) {
                                    __auto_type val_expr = _mv_250.value;
                                    {
                                        __auto_type val_c = expr_transpile_expr(ctx, val_expr);
                                ...
                                if (_mv_253.has_value) {
                                    __auto_type arr_expr = _mv_253.value;
                                    ...
                                    if (_mv_254.has_value) {
                                        __auto_type idx_expr = _mv_254.value;
                                        {
                                            ...
                                            switch (_mv_257.tag) {
                                                case types_SExpr_sym:
                                                {
                                                    __auto_type sym = _mv_257.data.sym;
                                                    {
                                                        ...
                                                        __auto_type _mv_258 = context_ctx_lookup_type(ctx, type_name);
                                                        if (_mv_258.has_value) {
                                                            __auto_type entry = _mv_258.value;
                                                            {
                                ...
                                if (_mv_259.has_value) {
                                    __auto_type size_expr = _mv_259.value;
                                    {
                                        __auto_type size_c = expr_transpile_expr(ctx, size_expr);
                                ...
                                if (_mv_261.has_value) {
                                    __auto_type variant_expr = _mv_261.value;
                                    __auto_type _mv_262 = (*variant_expr);
                                    switch (_mv_262.tag) {
                                        case types_SExpr_sym:
                                        {
                                ...
                                __auto_type _mv_263 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_263.has_value) {
                                    __auto_type type_expr = _mv_263.value;
                                    __auto_type _mv_264 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    if (_mv_264.has_value) {
                                        __auto_type tag_expr = _mv_264.value;
                                        __auto_type _mv_265 = (*type_expr);
                                        switch (_mv_265.tag) {
                                            case types_SExpr_sym:
                                            {
                                                __auto_type type_sym = _mv_265.data.sym;
                                                __auto_type _mv_266 = expr_extract_symbol_name(tag_expr);
                                                if (_mv_266.has_value) {
                                                    __auto_type tag_str = _mv_266.value;
                                                    {
                                                        ...
                                                        if (len >= 5) {
                                                            {
                                                                ...
                                                                for (int64_t vi = 3; vi < len; vi++) {
                                                                    __auto_type _mv_267 = ({ __auto_type _lst = items; size_t _idx = (size_t)vi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                            ...
                                                            __auto_type _mv_268 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                            if (_mv_268.has_value) {
                                                                __auto_type val_expr = _mv_268.value;
                                                                {
                                                                    __auto_type val_c = expr_transpile_expr(ctx, val_expr);
                                ...
                                if (_mv_271.has_value) {
                                    __auto_type result_expr = _mv_271.value;
                                    {
                                        __auto_type result_c = expr_transpile_expr(ctx, result_expr);
                                        __auto_type _mv_272 = context_ctx_get_current_result_type(ctx);
                                        if (_mv_272.has_value) {
                                            __auto_type enclosing_type = _mv_272.value;
                                ...
                                SLOP_UNREACHABLE();
                            } else if (((string_eq(op, SLOP_STR("is-none")) || string_eq(op, SLOP_STR("is-some")))) && ((len >= 2)) && (({ __auto_type _mv = context_ctx_lookup_var(ctx, op); _mv.has_value ? ({ __auto_type v = _mv.value; 0; }) : (1); }))) {
                                ...
                                if (_mv_275.has_value) {
                                    ...
                                    if (_mv_276.has_value) {
                                        __auto_type idx_expr = _mv_276.value;
                                        {
                                            __auto_type list_c = expr_transpile_expr(ctx, list_expr);
                                            __auto_type idx_c = expr_transpile_expr(ctx, idx_expr);
                                ...
                                if (_mv_277.has_value) {
                                    __auto_type list_expr = _mv_277.value;
                                    {
                                        __auto_type list_c = expr_transpile_expr(ctx, list_expr);
                                        __auto_type option_type = expr_infer_list_element_option_type(ctx, list_expr);
                                        if (string_len(option_type) > 0) {
                                ...
                                if (_mv_278.has_value) {
                                    __auto_type arena_expr = _mv_278.value;
                                ...
                                if (_mv_280.has_value) {
                                    ...
                                    if (_mv_281.has_value) {
                                        __auto_type item_expr = _mv_281.value;
                                        {
                                            __auto_type list_c = expr_transpile_expr(ctx, list_expr);
                                ...
                                __auto_type _mv_282 = context_ctx_get_current_return_type(ctx);
                                if (_mv_282.has_value) {
                                    __auto_type ret_type = _mv_282.value;
                    ...
                    default: {
                        {
                            ...
                            __auto_type i = 1;
                            while (i < len) {
                                __auto_type _mv_283 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        if (string_eq(fn_name, SLOP_STR("println"))) {
            ...
            if (len < 3) {
                ...
                if (_mv_286.has_value) {
                    __auto_type a_expr = _mv_286.value;
                    ...
                    if (_mv_287.has_value) {
                        __auto_type b_expr = _mv_287.value;
                        {
            ...
            if (len < 3) {
                ...
                if (_mv_288.has_value) {
                    __auto_type a_expr = _mv_288.value;
                    ...
                    if (_mv_289.has_value) {
                        __auto_type b_expr = _mv_289.value;
                        {
                            __auto_type a_c = expr_transpile_expr(ctx, a_expr);
                            __auto_type b_c = expr_transpile_expr(ctx, b_expr);
                            __auto_type s1 = string_concat(arena, SLOP_STR("(("), a_c);
            ...
            if (len < 3) {
                ...
                if (_mv_290.has_value) {
                    __auto_type fn_expr = _mv_290.value;
            ...
            if (len < 4) {
                ...
                if (_mv_291.has_value) {
                    __auto_type type_expr = _mv_291.value;
                    ...
                    if (_mv_292.has_value) {
                        ...
                        __auto_type _mv_293 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_293.has_value) {
                            __auto_type cap_expr = _mv_293.value;
                            {
            ...
            if (len < 3) {
                ...
                if (_mv_294.has_value) {
                    __auto_type type_expr = _mv_294.value;
                    ...
                    if (_mv_295.has_value) {
                        __auto_type arena_expr = _mv_295.value;
                        {
                            __auto_type elem_c = context_to_c_type_prefixed(ctx, type_expr);
                            __auto_type elem_id = ctype_type_to_identifier(arena, elem_c);
                            __auto_type chan_type = context_ctx_str(ctx, SLOP_STR("slop_chan_"), elem_id);
            ...
            if (len < 3) {
                ...
                if (_mv_296.has_value) {
                    __auto_type chan_expr = _mv_296.value;
            ...
            if (len < 2) {
                ...
                if (_mv_298.has_value) {
                    __auto_type chan_expr = _mv_298.value;
                    {
                        __auto_type chan_c = expr_transpile_expr(ctx, chan_expr);
                        __auto_type chan_c_type = expr_infer_expr_c_type(ctx, chan_expr);
                        {
        ...
        } else {
            {
                ...
                if (string_len(builtin_c_name) > 0) {
                    ...
                    __auto_type _mv_299 = context_ctx_lookup_type(ctx, fn_name);
                    if (_mv_299.has_value) {
                        ...
                        __auto_type _mv_301 = context_ctx_lookup_enum_variant(ctx, fn_name);
                        if (_mv_301.has_value) {
                            __auto_type type_name = _mv_301.value;
                            {
                                ...
                                if (len > 2) {
                                    {
                                        ...
                                        __auto_type vi = 1;
                                        while (vi < len) {
                                            __auto_type _mv_302 = ({ __auto_type _lst = items; size_t _idx = (size_t)vi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_302.has_value) {
                                                __auto_type v = _mv_302.value;
                                                {
                                    ...
                                    if (_mv_303.has_value) {
                                        __auto_type value_expr = _mv_303.value;
                                        {
                                            __auto_type value_c = expr_transpile_expr(ctx, value_expr);
                        ...
                        } else if (!_mv_301.has_value) {
                            {
                                ...
                                if (!_mv_304.has_value) {
                                    ...
                                    __auto_type func_entry = _mv_304.value;
                                    while (i < len) {
    ...
    SLOP_PRE(((arg != NULL)), "(!= arg nil)");
    {
        ...
        switch (_mv_307.tag) {
            ...
            default: {
                {
                    __auto_type arg_c = expr_transpile_expr(ctx, arg);
                    __auto_type _mv_308 = expr_get_expr_type_hint(ctx, arg);
                    if (_mv_308.has_value) {
                        __auto_type type_hint = _mv_308.value;
...
slop_string expr_transpile_printf_call(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 1;
        while (i < len) {
            __auto_type _mv_309 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_309.has_value) {
                __auto_type arg = _mv_309.value;
                {
...
slop_string expr_transpile_raw_string_fn_call(context_TranspileContext* ctx, slop_string fn_name, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 1;
        while (i < len) {
            __auto_type _mv_310 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_310.has_value) {
                __auto_type arg = _mv_310.value;
                {
                    __auto_type arg_c = ({ __auto_type _mv = (*arg); slop_string _mr = {0}; switch (_mv.tag) { case types_SExpr_str: { __auto_type s = _mv.data.str; _mr = context_ctx_str3(ctx, SLOP_STR("\""), expr_escape_c_string(ctx, s.value), SLOP_STR("\"")); break; } default: { _mr = expr_transpile_expr(ctx, arg); break; }  } _mr; });
                    if (string_eq(args, SLOP_STR(""))) {
                        args = arg_c;
        ...
        if (string_eq(slop_type, SLOP_STR("String"))) {
            ...
            switch (_mv_311.tag) {
                case types_SExpr_sym:
                {
                    ...
                    __auto_type _mv_312 = context_ctx_lookup_var(ctx, sym.name);
                    if (_mv_312.has_value) {
                        __auto_type entry = _mv_312.value;
                        {
                ...
                case types_SExpr_lst:
                {
                    __auto_type lst = _mv_311.data.lst;
                    {
                        __auto_type items = lst.items;
                        if (((int64_t)((items).len)) >= 1) {
                            __auto_type _mv_313 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_313.has_value) {
                                ...
                                switch (_mv_314.tag) {
                                    case types_SExpr_sym:
                                    {
                                        __auto_type head_sym = _mv_314.data.sym;
                                        {
                                            __auto_type op = head_sym.name;
                                            if (string_eq(op, SLOP_STR(".")) && (((int64_t)((items).len)) >= 3)) {
                                                {
                                                    ...
                                                    if (string_eq(c_type, SLOP_STR("slop_string"))) {
                                                        ...
                                                        if (_mv_315.has_value) {
                                                            __auto_type obj_expr = _mv_315.value;
                                                            ...
                                                            if (_mv_316.has_value) {
                                                                __auto_type field_expr = _mv_316.value;
                                                                __auto_type _mv_317 = (*field_expr);
                                                                switch (_mv_317.tag) {
                                                                    case types_SExpr_sym:
                                                                    {
                                                                        __auto_type field_sym = _mv_317.data.sym;
                                                                        {
                                                                            __auto_type field_name = field_sym.name;
                                                                            __auto_type obj_slop_type = expr_infer_expr_slop_type(ctx, obj_expr);
                                                                            if (string_len(obj_slop_type) > 0) {
                                                                                __auto_type _mv_318 = context_ctx_lookup_field_slop_type(ctx, obj_slop_type, field_name);
                                                                                if (_mv_318.has_value) {
                                                                                    __auto_type fst = _mv_318.value;
                                                ...
                                                __auto_type _mv_319 = context_ctx_lookup_func(ctx, op);
                                                if (_mv_319.has_value) {
                                                    __auto_type func_entry = _mv_319.value;
                                                    if (func_entry.returns_string) {
                                                        return (slop_option_string){.has_value = 1, .value = SLOP_STR("slop_string")};
                                                    } else {
                                                        return (slop_option_string){.has_value = false};
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 2) {
            ...
            if (_mv_320.has_value) {
                __auto_type tag_expr = _mv_320.value;
                __auto_type _mv_321 = (*tag_expr);
                switch (_mv_321.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type tag_list = _mv_321.data.lst;
                        {
                            __auto_type tag_items = tag_list.items;
                            if (((int64_t)((tag_items).len)) < 1) {
                                return context_ctx_str3(ctx, SLOP_STR("(("), c_type_name, SLOP_STR("){})"));
                            } else {
                                __auto_type _mv_322 = ({ __auto_type _lst = tag_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_322.has_value) {
                                    __auto_type tag_name_expr = _mv_322.value;
                                    __auto_type _mv_323 = (*tag_name_expr);
                                    switch (_mv_323.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type tag_sym = _mv_323.data.sym;
                                            {
                                                ...
                                                if (num_tag_items >= 3) {
                                                    {
                                                        ...
                                                        for (int64_t fi = 1; fi < num_tag_items; fi++) {
                                                            __auto_type _mv_324 = ({ __auto_type _lst = tag_items; size_t _idx = (size_t)fi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                            if (_mv_324.has_value) {
                                                                __auto_type value_expr = _mv_324.value;
                                                                {
                                                                    __auto_type value_c = expr_transpile_expr(ctx, value_expr);
                                                    ...
                                                    __auto_type _mv_325 = ({ __auto_type _lst = tag_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_326.has_value) {
                __auto_type clause_expr = _mv_326.value;
                __auto_type _mv_327 = (*clause_expr);
                switch (_mv_327.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type clause_lst = _mv_327.data.lst;
                        {
                            ...
                            if (clause_len >= 2) {
                                ...
                                if (_mv_328.has_value) {
                                    __auto_type test_expr = _mv_328.value;
                                    __auto_type _mv_329 = (*test_expr);
                                    switch (_mv_329.tag) {
                                        case types_SExpr_sym:
                                        {
                                            ...
                                            if (string_eq(sym.name, SLOP_STR("else"))) {
                                            ...
                                            } else {
                                                {
                                                    ...
                                                    __auto_type _mv_331 = ({ __auto_type _lst = clause_items; size_t _idx = (size_t)(clause_len - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        ...
                                        default: {
                                            {
                                                __auto_type test_c = expr_transpile_expr(ctx, test_expr);
                                                __auto_type _mv_332 = ({ __auto_type _lst = clause_items; size_t _idx = (size_t)(clause_len - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 3) {
            ...
            if (_mv_333.has_value) {
                __auto_type scrutinee = _mv_333.value;
                {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_334.has_value) {
                __auto_type branch = _mv_334.value;
                __auto_type _mv_335 = (*branch);
                switch (_mv_335.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type branch_lst = _mv_335.data.lst;
                        {
                            __auto_type branch_items = branch_lst.items;
                            if (((int64_t)((branch_items).len)) >= 1) {
                                __auto_type _mv_336 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_336.has_value) {
                                    __auto_type pattern = _mv_336.value;
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_337.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 1) {
                    ...
                    __auto_type _mv_338 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
uint8_t expr_is_option_patterns(slop_list_types_SExpr_ptr patterns) {
    {
        ...
        int64_t i = 0;
        while ((i < len) && !(found)) {
            __auto_type _mv_340 = ({ __auto_type _lst = patterns; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_340.has_value) {
                __auto_type pat = _mv_340.value;
                {
...
uint8_t expr_is_enum_expr_patterns(context_TranspileContext* ctx, slop_list_types_SExpr_ptr patterns) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while ((i < len) && all_symbols) {
            __auto_type _mv_342 = ({ __auto_type _lst = patterns; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_342.has_value) {
                __auto_type pat_expr = _mv_342.value;
                __auto_type _mv_343 = (*pat_expr);
                switch (_mv_343.tag) {
                    case types_SExpr_sym:
                    {
                        __auto_type s = _mv_343.data.sym;
                        {
                            __auto_type name = s.name;
                            if (!(string_eq(name, SLOP_STR("else"))) && !(string_eq(name, SLOP_STR("_")))) {
                                __auto_type _mv_344 = context_ctx_lookup_enum_variant(ctx, name);
                                if (_mv_344.has_value) {
                                    __auto_type _ = _mv_344.value;
                                    has_enum_variant = 1;
...
uint8_t expr_is_union_expr_patterns(context_TranspileContext* ctx, slop_list_types_SExpr_ptr patterns) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while ((i < len) && !(has_union_variant)) {
            __auto_type _mv_345 = ({ __auto_type _lst = patterns; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_345.has_value) {
                __auto_type pat_expr = _mv_345.value;
                {
                    ...
                    if ((!(string_eq(tag, SLOP_STR("")))) && (!(string_eq(tag, SLOP_STR("some")))) && (!(string_eq(tag, SLOP_STR("none")))) && (!(string_eq(tag, SLOP_STR("ok")))) && (!(string_eq(tag, SLOP_STR("error")))) && (!(string_eq(tag, SLOP_STR("else")))) && (!(string_eq(tag, SLOP_STR("_"))))) {
                        __auto_type _mv_346 = context_ctx_lookup_enum_variant(ctx, tag);
...
slop_option_string expr_get_expr_binding_name(types_SExpr* pat_expr) {
    SLOP_PRE(((pat_expr != NULL)), "(!= pat-expr nil)");
    __auto_type _mv_347 = (*pat_expr);
    switch (_mv_347.tag) {
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_347.data.lst;
            {
                __auto_type items = lst.items;
                if (((int64_t)((items).len)) < 2) {
                    return (slop_option_string){.has_value = false};
                    ...
                    if (_mv_348.has_value) {
                        __auto_type binding = _mv_348.value;
                        __auto_type _mv_349 = (*binding);
                        switch (_mv_349.tag) {
                            case types_SExpr_sym:
                            {
...
slop_string expr_get_match_branch_body(context_TranspileContext* ctx, slop_list_types_SExpr_ptr branch_items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 2) {
            ...
            __auto_type _mv_350 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)(len - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_string expr_build_option_match_expr(context_TranspileContext* ctx, types_SExpr* scrutinee, slop_string scrutinee_c, slop_list_types_SExpr_ptr items) {
    ...
    SLOP_PRE(((scrutinee != NULL)), "(!= scrutinee nil)");
    {
        ...
        int64_t i = 2;
        while (i < len) {
            __auto_type _mv_351 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    ...
                    case types_SExpr_lst:
                    {
                        __auto_type branch_lst = _mv_352.data.lst;
                        {
                            ...
                            if (((int64_t)((branch_items).len)) >= 2) {
                                __auto_type _mv_353 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_353.has_value) {
                                    __auto_type pattern = _mv_353.value;
                                    {
                                        ...
                                        if (string_eq(tag, SLOP_STR("some"))) {
                                            __auto_type _mv_354 = expr_get_expr_binding_name(pattern);
                                            if (_mv_354.has_value) {
                                                __auto_type name = _mv_354.value;
                                                some_binding = name;
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 2) {
            ...
            if (_mv_355.has_value) {
                __auto_type first_clause = _mv_355.value;
                __auto_type _mv_356 = (*first_clause);
                switch (_mv_356.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type clause_lst = _mv_356.data.lst;
                        {
                            __auto_type clause_items = clause_lst.items;
                            __auto_type clause_len = ((int64_t)((clause_items).len));
                            if (clause_len < 2) {
                                ...
                                __auto_type _mv_357 = ({ __auto_type _lst = clause_items; size_t _idx = (size_t)(clause_len - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        case types_SExpr_lst:
        {
            __auto_type branch_lst = _mv_358.data.lst;
            {
                ...
                if (branch_len < 2) {
                    ...
                    __auto_type _mv_359 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)(branch_len - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        if (len < 3) {
            ...
            while ((i < len) && string_eq(result, SLOP_STR("__type_error__"))) {
                ...
                if (_mv_360.has_value) {
                    __auto_type branch = _mv_360.value;
...
slop_string expr_slop_type_to_c_type(context_TranspileContext* ctx, slop_string slop_type) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_361 = context_ctx_lookup_type(ctx, slop_type);
        if (_mv_361.has_value) {
            __auto_type entry = _mv_361.value;
            return entry.c_name;
    ...
    SLOP_PRE(((expr != NULL)), "(!= expr nil)");
    {
        ...
        if (string_len(checker_type) > 0) {
            ...
            switch (_mv_362.tag) {
                ...
                case types_SExpr_num:
                {
                    __auto_type num = _mv_362.data.num;
                    if (num.is_float) {
                        return SLOP_STR("double");
                    } else {
                        return SLOP_STR("int64_t");
                ...
                case types_SExpr_sym:
                {
                    __auto_type sym = _mv_362.data.sym;
                    {
                        __auto_type name = sym.name;
                        __auto_type _mv_363 = context_ctx_lookup_var(ctx, name);
                        if (_mv_363.has_value) {
                            __auto_type entry = _mv_363.value;
                            {
                ...
                case types_SExpr_lst:
                {
                    __auto_type lst = _mv_362.data.lst;
                    {
                        ...
                        if (((int64_t)((items).len)) < 1) {
                            ...
                            __auto_type _mv_364 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_364.has_value) {
                                __auto_type head = _mv_364.value;
                                __auto_type _mv_365 = (*head);
                                switch (_mv_365.tag) {
                                    case types_SExpr_sym:
                                    {
                                        __auto_type sym = _mv_365.data.sym;
                                        {
                                            ...
                                            if (({ __auto_type _mv = context_ctx_lookup_func(ctx, op); _mv.has_value ? ({ __auto_type func_entry = _mv.value; func_entry.returns_string; }) : (0); })) {
                                                ...
                                                if (((int64_t)((items).len)) < 3) {
                                                    ...
                                                    __auto_type _mv_366 = ({ __auto_type _lst = items; size_t _idx = (size_t)(((int64_t)((items).len)) - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_366.has_value) {
                                                        __auto_type body = _mv_366.value;
                                                ...
                                                if (((int64_t)((items).len)) < 2) {
                                                    ...
                                                    __auto_type _mv_367 = ({ __auto_type _lst = items; size_t _idx = (size_t)(((int64_t)((items).len)) - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_367.has_value) {
                                                        __auto_type last_expr = _mv_367.value;
                                                ...
                                                if (((int64_t)((items).len)) < 3) {
                                                    ...
                                                    __auto_type _mv_368 = ({ __auto_type _lst = items; size_t _idx = (size_t)(((int64_t)((items).len)) - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_368.has_value) {
                                                        __auto_type body = _mv_368.value;
                                                        return expr_infer_expr_c_type(ctx, body);
                                                ...
                                                if (((int64_t)((items).len)) < 3) {
                                                    ...
                                                    if (_mv_369.has_value) {
                                                        __auto_type then_expr = _mv_369.value;
                                                ...
                                                if (((int64_t)((items).len)) < 2) {
                                                    ...
                                                    if (_mv_370.has_value) {
                                                        __auto_type val_expr = _mv_370.value;
                                                        {
                                                            __auto_type val_type = expr_infer_expr_c_type(ctx, val_expr);
                                                ...
                                                __auto_type _mv_371 = context_ctx_get_current_return_type(ctx);
                                                if (_mv_371.has_value) {
                                                    __auto_type ret_type = _mv_371.value;
                                                    if (strlib_starts_with(ret_type, SLOP_STR("slop_option_"))) {
                                                        return ret_type;
                                                    } else {
                                                        return SLOP_STR("slop_option_int");
                                                ...
                                                if (((int64_t)((items).len)) < 2) {
                                                    ...
                                                    if (_mv_373.has_value) {
                                                        __auto_type inner = _mv_373.value;
                                                        {
                                                ...
                                                if (((int64_t)((items).len)) < 2) {
                                                    ...
                                                    if (_mv_375.has_value) {
                                                        __auto_type chan_arg = _mv_375.value;
                                                        {
                                                ...
                                                if (((int64_t)((items).len)) < 2) {
                                                    ...
                                                    if (_mv_379.has_value) {
                                                        __auto_type list_arg = _mv_379.value;
                                                        {
                                                ...
                                                __auto_type _mv_380 = context_ctx_lookup_type(ctx, op);
                                                if (_mv_380.has_value) {
                                                    __auto_type type_entry = _mv_380.value;
                                                    return type_entry.c_name;
                                                } else if (!_mv_380.has_value) {
                                                    __auto_type _mv_381 = context_ctx_lookup_func(ctx, op);
                                                    if (_mv_381.has_value) {
                                                        __auto_type func_entry = _mv_381.value;
                                                        {
                                                            __auto_type ret_type = func_entry.return_type;
                                                            if (func_entry.returns_string) {
                                                                return SLOP_STR("slop_string");
                ...
                switch (_mv_383.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type branch_lst = _mv_383.data.lst;
                        {
                            __auto_type branch_items = branch_lst.items;
                            if (((int64_t)((branch_items).len)) >= 2) {
                                __auto_type _mv_384 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_384.has_value) {
                                    __auto_type pattern = _mv_384.value;
                                    {
                                        __auto_type tag = expr_get_expr_pattern_tag(pattern);
                                        if (string_eq(tag, SLOP_STR("ok"))) {
                                            __auto_type _mv_385 = expr_get_expr_binding_name(pattern);
                                            if (_mv_385.has_value) {
                                                __auto_type name = _mv_385.value;
                                                ok_binding = name;
                                            ...
                                            __auto_type _mv_386 = expr_get_expr_binding_name(pattern);
                                            if (_mv_386.has_value) {
                                                __auto_type name = _mv_386.value;
                                                err_binding = name;
...
slop_string expr_build_union_match_expr(context_TranspileContext* ctx, types_SExpr* scrutinee, slop_string scrutinee_c, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 2;
        while (i < len) {
            __auto_type _mv_391 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_391.has_value) {
                __auto_type branch = _mv_391.value;
                __auto_type _mv_392 = (*branch);
                switch (_mv_392.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type branch_lst = _mv_392.data.lst;
                        {
                            __auto_type branch_items = branch_lst.items;
                            if (((int64_t)((branch_items).len)) >= 2) {
                                __auto_type _mv_393 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_393.has_value) {
                                    __auto_type pattern = _mv_393.value;
        ...
        switch (_mv_394.tag) {
            case types_SExpr_sym:
            {
                __auto_type sym = _mv_394.data.sym;
                {
                    ...
                    __auto_type _mv_395 = context_ctx_lookup_func(ctx, slop_name);
                    if (_mv_395.has_value) {
                        __auto_type func_entry = _mv_395.value;
                        {
        ...
        if (context_ctx_skip_trampoline_generation(ctx)) {
            ...
            if (context_ctx_has_trampoline(ctx, fn_c_name)) {
            ...
            } else {
                {
                    ...
                    int64_t i = 0;
                    while (i < count) {
                        __auto_type _mv_396 = ({ __auto_type _lst = param_types; size_t _idx = (size_t)i; slop_option_context_FuncParamType_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_396.has_value) {
                            __auto_type param_type_ptr = _mv_396.value;
                            {
...
slop_string expr_build_union_case_expr(context_TranspileContext* ctx, slop_arena* arena, slop_string cases, types_SExpr* scrutinee, types_SExpr* pattern, slop_list_types_SExpr_ptr branch_items, slop_string result_type) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (string_eq(tag, SLOP_STR("else")) || string_eq(tag, SLOP_STR("_"))) {
            ...
            __auto_type _mv_397 = context_ctx_lookup_enum_variant(ctx, tag);
            if (_mv_397.has_value) {
                __auto_type type_name = _mv_397.value;
                {
                    __auto_type c_tag = ctype_to_c_name(arena, tag);
                    __auto_type case_label = context_ctx_str4(ctx, type_name, SLOP_STR("_"), c_tag, SLOP_STR(""));
                    __auto_type binding_opt = expr_get_expr_binding_name(pattern);
                    __auto_type _mv_398 = binding_opt;
                    if (_mv_398.has_value) {
                        __auto_type binding_name = _mv_398.value;
                        {
...
uint8_t expr_discard_needs_void(types_SExpr* e) {
    __auto_type _mv_402 = (*e);
    switch (_mv_402.tag) {
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_402.data.lst;
            __auto_type _mv_403 = ({ __auto_type _lst = lst.items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 3) {
            ...
            if (_mv_405.has_value) {
                __auto_type bindings_expr = _mv_405.value;
                __auto_type _mv_406 = (*bindings_expr);
                switch (_mv_406.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type bindings_lst = _mv_406.data.lst;
                        context_ctx_push_scope(ctx);
                        {
                            __auto_type result = SLOP_STR("({ ");
                            ...
                            while (bi < bindings_len) {
                                __auto_type _mv_407 = ({ __auto_type _lst = bindings_items; size_t _idx = (size_t)bi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_407.has_value) {
                                    __auto_type binding = _mv_407.value;
                            ...
                            bi = 0;
                            while (bi < bindings_len) {
                                __auto_type _mv_408 = ({ __auto_type _lst = bindings_items; size_t _idx = (size_t)bi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            ...
                            }
                            {
                                ...
                                while (i < (len - 1)) {
                                    ...
                                    if (_mv_409.has_value) {
                                        __auto_type body_expr = _mv_409.value;
                                        {
                    ...
                    if (len >= 2) {
                        {
                            ...
                            __auto_type _mv_411 = ({ __auto_type _lst = items; size_t _idx = (size_t)name_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_411.has_value) {
                                __auto_type name_expr = _mv_411.value;
                                __auto_type _mv_412 = (*name_expr);
                                switch (_mv_412.tag) {
                                    case types_SExpr_sym:
                                    {
                                        __auto_type name_sym = _mv_412.data.sym;
                                        {
                ...
                __auto_type lst = _mv_413.data.lst;
                {
                    ...
                    if (len < 2) {
                    ...
                    } else {
                        {
                            __auto_type has_mut = expr_binding_has_mut(items);
                            __auto_type name_idx = ((has_mut) ? 1 : 0);
                            __auto_type _mv_414 = ({ __auto_type _lst = items; size_t _idx = (size_t)name_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_414.has_value) {
                                __auto_type name_expr = _mv_414.value;
                                __auto_type _mv_415 = (*name_expr);
                                switch (_mv_415.tag) {
                                    case types_SExpr_sym:
                                    {
                                        __auto_type name_sym = _mv_415.data.sym;
                                        {
                                            ...
                                            __auto_type init_idx = ((has_mut) ? ((has_type) ? 3 : 2) : ((has_type) ? 2 : 1));
                                            if (has_type) {
                                                __auto_type _mv_416 = ({ __auto_type _lst = items; size_t _idx = (size_t)type_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_416.has_value) {
                                                    __auto_type type_expr = _mv_416.value;
                                                    {
                                                        __auto_type c_type = context_to_c_type_prefixed(ctx, type_expr);
                                                        __auto_type _mv_417 = ({ __auto_type _lst = items; size_t _idx = (size_t)init_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                        if (_mv_417.has_value) {
                                                            __auto_type init_expr = _mv_417.value;
                                                            {
                                                    ...
                                                    __auto_type _mv_418 = ({ __auto_type _lst = items; size_t _idx = (size_t)init_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_418.has_value) {
                                                        __auto_type init_expr = _mv_418.value;
                                                        {
                                                ...
                                                __auto_type _mv_419 = ({ __auto_type _lst = items; size_t _idx = (size_t)init_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_419.has_value) {
                                                    __auto_type init_expr = _mv_419.value;
                                                    {
                                                        __auto_type init_c = expr_transpile_expr(ctx, init_expr);
                                                        return context_ctx_str5(ctx, SLOP_STR("__auto_type "), var_name, SLOP_STR(" = "), init_c, SLOP_STR(";"));
                                                    }
...
uint8_t expr_binding_has_mut(slop_list_types_SExpr_ptr items) {
    if (((int64_t)((items).len)) < 1) {
        ...
        __auto_type _mv_420 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        if (_mv_420.has_value) {
            __auto_type first = _mv_420.value;
            __auto_type _mv_421 = (*first);
            switch (_mv_421.tag) {
                case types_SExpr_sym:
                {
...
slop_string expr_transpile_typed_init(context_TranspileContext* ctx, types_SExpr* init_expr, slop_string target_type) {
    ...
    __auto_type _mv_422 = (*init_expr);
    switch (_mv_422.tag) {
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_422.data.lst;
            {
                __auto_type items = lst.items;
                if (((int64_t)((items).len)) < 1) {
                    return expr_transpile_expr(ctx, init_expr);
                } else {
                    __auto_type _mv_423 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    ...
                                    if (string_eq(op, SLOP_STR("some"))) {
                                        if (((int64_t)((items).len)) < 2) {
                                            ...
                                            if (_mv_425.has_value) {
                                                __auto_type val_expr = _mv_425.value;
                                                {
                                                    __auto_type val_c = expr_transpile_expr(ctx, val_expr);
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 3) {
            ...
            if (_mv_426.has_value) {
                __auto_type cond_expr = _mv_426.value;
                {
                    __auto_type cond_c = expr_transpile_expr(ctx, cond_expr);
                    __auto_type body_str = SLOP_STR("");
                    {
                        __auto_type i = 2;
                        while (i < len) {
                            __auto_type _mv_427 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        } else {
            {
                ...
                while (i < len) {
                    ...
                    if (_mv_428.has_value) {
                        __auto_type expr = _mv_428.value;
                        {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 2) {
            ...
            if (_mv_429.has_value) {
                __auto_type cond_expr = _mv_429.value;
                {
                    __auto_type cond_c = expr_transpile_expr(ctx, cond_expr);
                    __auto_type body_c = SLOP_STR("({ ");
                    {
                        __auto_type i = 2;
                        while (i < len) {
                            __auto_type _mv_430 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
uint8_t expr_set_is_self_assign(slop_list_types_SExpr_ptr items) {
    if (((int64_t)((items).len)) == 3) {
        ...
        if (_mv_431.has_value) {
            ...
            __auto_type _mv_432 = (*target_expr);
            switch (_mv_432.tag) {
                case types_SExpr_sym:
                {
                    __auto_type tsym = _mv_432.data.sym;
                    ...
                    if (_mv_433.has_value) {
                        __auto_type value_expr = _mv_433.value;
                        __auto_type _mv_434 = (*value_expr);
                        switch (_mv_434.tag) {
                            case types_SExpr_sym:
                            {
                                __auto_type vsym = _mv_434.data.sym;
        ...
        if (expr_set_is_self_assign(items)) {
            ...
            if (len < 3) {
                ...
                if (_mv_435.has_value) {
                    __auto_type target_expr = _mv_435.value;
                    __auto_type _mv_436 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_436.has_value) {
                        __auto_type val_expr = _mv_436.value;
                        {
                            __auto_type val_c = expr_transpile_expr(ctx, val_expr);
                            __auto_type _mv_437 = (*target_expr);
                            switch (_mv_437.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type target_lst = _mv_437.data.lst;
                                    {
                                        ...
                                        if (((int64_t)((target_items).len)) < 1) {
                                            ...
                                            __auto_type _mv_438 = ({ __auto_type _lst = target_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                        ...
                                                        __auto_type sym = _mv_439.data.sym;
                                                        {
                                                            ...
                                                            if (string_eq(op, SLOP_STR("@"))) {
                                                                if (((int64_t)((target_items).len)) < 3) {
                                                                    ...
                                                                    __auto_type _mv_440 = ({ __auto_type _lst = target_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                                    if (_mv_440.has_value) {
                                                                        __auto_type arr_expr = _mv_440.value;
                                                                        __auto_type _mv_441 = ({ __auto_type _lst = target_items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                                        if (_mv_441.has_value) {
                                                                            __auto_type idx_expr = _mv_441.value;
                                                                            {
                                                                                __auto_type arr_c = expr_transpile_expr(ctx, arr_expr);
                                                                                __auto_type idx_c = expr_transpile_expr(ctx, idx_expr);
...
slop_string expr_resolve_arena_c_name(context_TranspileContext* ctx, slop_string op, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    __auto_type _mv_442 = context_ctx_lookup_var(ctx, SLOP_STR("arena"));
    if (_mv_442.has_value) {
        __auto_type entry = _mv_442.value;
        return entry.c_name;
    } else if (!_mv_442.has_value) {
        __auto_type _mv_443 = context_ctx_find_arena_var(ctx);
        if (_mv_443.has_value) {
            __auto_type entry = _mv_443.value;
            return entry.c_name;
...
slop_string expr_get_arena_for_list_push_expr(context_TranspileContext* ctx, types_SExpr* list_expr, slop_string list_c) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    SLOP_PRE(((list_expr != NULL)), "(!= list-expr nil)");
    __auto_type _mv_444 = context_ctx_lookup_var(ctx, SLOP_STR("arena"));
    if (_mv_444.has_value) {
        __auto_type arena_var = _mv_444.value;
        return arena_var.c_name;
    } else if (!_mv_444.has_value) {
        __auto_type _mv_445 = context_ctx_lookup_var(ctx, SLOP_STR("ctx"));
        if (_mv_445.has_value) {
            __auto_type ctx_var = _mv_445.value;
        ...
        } else if (!_mv_445.has_value) {
            {
                ...
                if (string_len(arena_from_field) > 0) {
                    ...
                    __auto_type _mv_446 = context_ctx_find_arena_var(ctx);
                    if (_mv_446.has_value) {
                        __auto_type arena_entry = _mv_446.value;
            ...
            __auto_type lst = _mv_447.data.lst;
            {
                ...
                if (len < 3) {
                    ...
                    if (_mv_448.has_value) {
                        __auto_type head_expr = _mv_448.value;
                        __auto_type _mv_449 = (*head_expr);
                        switch (_mv_449.tag) {
                            case types_SExpr_sym:
                            {
                                ...
                                if (string_eq(sym.name, SLOP_STR("."))) {
                                    ...
                                    if (_mv_450.has_value) {
                                        __auto_type base_expr = _mv_450.value;
...
slop_string expr_get_arena_from_base(context_TranspileContext* ctx, types_SExpr* base_expr) {
    ...
    switch (_mv_451.tag) {
        case types_SExpr_sym:
        {
            ...
            {
                __auto_type var_name = sym.name;
                __auto_type _mv_452 = context_ctx_lookup_var(ctx, var_name);
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_451.data.lst;
            {
                __auto_type items = lst.items;
                if (((int64_t)((items).len)) < 2) {
                    return SLOP_STR("arena");
                } else {
                    __auto_type _mv_453 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_453.has_value) {
                        __auto_type head_expr = _mv_453.value;
                        __auto_type _mv_454 = (*head_expr);
                        switch (_mv_454.tag) {
                            case types_SExpr_sym:
                            {
                                ...
                                if (string_eq(sym.name, SLOP_STR("deref"))) {
                                    ...
                                    if (_mv_455.has_value) {
                                        __auto_type ptr_expr = _mv_455.value;
                                        {
...
uint8_t expr_is_ptr_to_ptr_map(context_TranspileContext* ctx, types_SExpr* expr) {
    ...
    switch (_mv_456.tag) {
        case types_SExpr_sym:
        {
            ...
            {
                __auto_type name = sym.name;
                __auto_type _mv_457 = context_ctx_lookup_var(ctx, name);
                if (_mv_457.has_value) {
                    __auto_type entry = _mv_457.value;
                    {
                        __auto_type c_type = entry.c_type;
...
slop_string expr_transpile_record_new(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 2) {
            ...
            __auto_type _mv_458 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_458.has_value) {
                __auto_type type_expr = _mv_458.value;
                __auto_type _mv_459 = (*type_expr);
                switch (_mv_459.tag) {
                    case types_SExpr_sym:
                    {
                        __auto_type type_sym = _mv_459.data.sym;
                        {
                            __auto_type raw_type_name = type_sym.name;
                    ...
                    case types_SExpr_lst:
                    {
                        __auto_type type_lst = _mv_459.data.lst;
                        {
                            ...
                            if (((int64_t)((type_items).len)) < 1) {
                                ...
                                __auto_type _mv_460 = ({ __auto_type _lst = type_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_460.has_value) {
                                    ...
                                    switch (_mv_461.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type head_sym = _mv_461.data.sym;
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_462.has_value) {
                __auto_type field_expr = _mv_462.value;
                __auto_type _mv_463 = (*field_expr);
                switch (_mv_463.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type field_lst = _mv_463.data.lst;
                        {
                            __auto_type field_items = field_lst.items;
                            if (((int64_t)((field_items).len)) >= 2) {
                                __auto_type _mv_464 = ({ __auto_type _lst = field_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_464.has_value) {
                                    __auto_type name_expr = _mv_464.value;
                                    __auto_type _mv_465 = (*name_expr);
                                    switch (_mv_465.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type name_sym = _mv_465.data.sym;
                                            __auto_type _mv_466 = ({ __auto_type _lst = field_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_466.has_value) {
                                                __auto_type val_expr = _mv_466.value;
                                                {
...
slop_string expr_build_inline_struct_type(context_TranspileContext* ctx, slop_list_types_SExpr_ptr type_items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 1;
        while (i < len) {
            __auto_type _mv_467 = ({ __auto_type _lst = type_items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_467.has_value) {
                __auto_type field_expr = _mv_467.value;
                __auto_type _mv_468 = (*field_expr);
                switch (_mv_468.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type field_lst = _mv_468.data.lst;
                        {
                            __auto_type field_items = field_lst.items;
                            if (((int64_t)((field_items).len)) >= 2) {
                                __auto_type _mv_469 = ({ __auto_type _lst = field_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_469.has_value) {
                                    __auto_type name_expr = _mv_469.value;
                                    __auto_type _mv_470 = (*name_expr);
                                    switch (_mv_470.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type name_sym = _mv_470.data.sym;
                                            __auto_type _mv_471 = ({ __auto_type _lst = field_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_472.has_value) {
                __auto_type field_expr = _mv_472.value;
                __auto_type _mv_473 = (*field_expr);
                switch (_mv_473.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type field_lst = _mv_473.data.lst;
                        {
                            __auto_type field_items = field_lst.items;
                            if (((int64_t)((field_items).len)) >= 2) {
                                __auto_type _mv_474 = ({ __auto_type _lst = field_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_474.has_value) {
                                    ...
                                    switch (_mv_475.tag) {
                                        case types_SExpr_sym:
                                        {
                                            ...
                                            __auto_type _mv_476 = ({ __auto_type _lst = field_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_476.has_value) {
                                                __auto_type val_expr = _mv_476.value;
                                                {
                                                    __auto_type field_name = ctype_to_c_name(arena, name_sym.name);
            ...
            if (_mv_477.has_value) {
                __auto_type type_expr = _mv_477.value;
                {
                    ...
                    __auto_type elem_count = (len - 2);
                    {
                        ...
                        while (i < len) {
                            __auto_type _mv_478 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        ...
                        }
                        {
                            ...
                            __auto_type _mv_479 = arena_var;
                            if (_mv_479.has_value) {
                                __auto_type arena_var = _mv_479.value;
                                {
                                    ...
                                    while (i < ((int64_t)((elem_codes).len))) {
                                        __auto_type _mv_480 = ({ __auto_type _lst = elem_codes; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_480.has_value) {
                                            __auto_type ec = _mv_480.value;
                                            {
                                ...
                                context_ctx_add_warning(ctx, SLOP_STR("list literal uses stack-allocated compound literal (no arena in scope)"));
                                {
                                    ...
                                    i = 0;
                                    while (i < ((int64_t)((elem_codes).len))) {
                                        __auto_type _mv_481 = ({ __auto_type _lst = elem_codes; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_481.has_value) {
                                            __auto_type ec = _mv_481.value;
                                            if (first) {
...
slop_string expr_get_map_key_c_info(context_TranspileContext* ctx, types_SExpr* key_type_expr) {
    ...
    __auto_type _mv_482 = (*key_type_expr);
    switch (_mv_482.tag) {
        case types_SExpr_sym:
        {
            __auto_type sym = _mv_482.data.sym;
            {
                __auto_type name = sym.name;
...
slop_string expr_get_struct_key_info_by_name(context_TranspileContext* ctx, slop_string name) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    __auto_type _mv_485 = context_ctx_lookup_type(ctx, name);
    if (_mv_485.has_value) {
        __auto_type type_entry = _mv_485.value;
        {
            __auto_type c_name = type_entry.c_name;
            context_ctx_register_struct_key_type(ctx, c_name);
            return expr_build_struct_key_info(ctx, c_name);
        ...
        __auto_type _mv_486 = context_ctx_get_module(ctx);
        if (_mv_486.has_value) {
            __auto_type mod = _mv_486.value;
            {
                __auto_type prefixed = context_ctx_str3(ctx, mod, SLOP_STR("_"), name);
                __auto_type _mv_487 = context_ctx_lookup_type(ctx, prefixed);
                if (_mv_487.has_value) {
                    __auto_type type_entry = _mv_487.value;
                    {
                        __auto_type c_name = type_entry.c_name;
                        context_ctx_register_struct_key_type(ctx, c_name);
                        return expr_build_struct_key_info(ctx, c_name);
        ...
        if (len < 3) {
            if (len < 2) {
                ...
                if (_mv_488.has_value) {
                    __auto_type arena_expr = _mv_488.value;
                    {
                        __auto_type arena_c = expr_transpile_expr(ctx, arena_expr);
            ...
            if (_mv_489.has_value) {
                __auto_type arena_expr = _mv_489.value;
                ...
                if (_mv_490.has_value) {
                    __auto_type key_type_expr = _mv_490.value;
                    {
                        __auto_type arena_c = expr_transpile_expr(ctx, arena_expr);
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 4) {
            ...
            if (_mv_491.has_value) {
                __auto_type map_expr = _mv_491.value;
                ...
                if (_mv_492.has_value) {
                    __auto_type key_expr = _mv_492.value;
                    __auto_type _mv_493 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_493.has_value) {
                        __auto_type val_expr = _mv_493.value;
                        {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 3) {
            ...
            if (_mv_496.has_value) {
                ...
                __auto_type _mv_497 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_497.has_value) {
                    __auto_type key_expr = _mv_497.value;
                    {
                        __auto_type map_c = expr_resolve_container_c(ctx, map_expr);
                        __auto_type key_c = expr_transpile_expr(ctx, key_expr);
                        __auto_type key_ptr = expr_wrap_map_key_as_ptr(ctx, key_c, key_expr, map_expr);
        ...
        if (len < 3) {
            ...
            if (_mv_498.has_value) {
                ...
                if (_mv_499.has_value) {
                    __auto_type key_expr = _mv_499.value;
                    {
                        __auto_type map_c = expr_resolve_container_c(ctx, map_expr);
                        __auto_type key_c = expr_transpile_expr(ctx, key_expr);
                        __auto_type key_ptr = expr_wrap_map_key_as_ptr(ctx, key_c, key_expr, map_expr);
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 2) {
            ...
            if (_mv_500.has_value) {
                __auto_type map_expr = _mv_500.value;
                {
                    __auto_type map_c = expr_resolve_container_c(ctx, map_expr);
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 3) {
            ...
            if (_mv_501.has_value) {
                __auto_type arena_expr = _mv_501.value;
                ...
                if (_mv_502.has_value) {
                    __auto_type elem_type_expr = _mv_502.value;
                    {
                        __auto_type arena_c = expr_transpile_expr(ctx, arena_expr);
        ...
        if (len < 3) {
            ...
            if (_mv_505.has_value) {
                ...
                if (_mv_506.has_value) {
                    __auto_type elem_expr = _mv_506.value;
                    {
                        __auto_type set_c = expr_resolve_container_c(ctx, set_expr);
                        __auto_type elem_c = expr_transpile_expr(ctx, elem_expr);
                        __auto_type elem_ptr = expr_wrap_map_key_as_ptr(ctx, elem_c, elem_expr, set_expr);
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 3) {
            ...
            if (_mv_507.has_value) {
                __auto_type set_expr = _mv_507.value;
                __auto_type _mv_508 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_508.has_value) {
                    __auto_type elem_expr = _mv_508.value;
                    {
                        __auto_type set_c = expr_resolve_container_c(ctx, set_expr);
                        __auto_type elem_c = expr_transpile_expr(ctx, elem_expr);
                        __auto_type elem_ptr = expr_wrap_map_key_as_ptr(ctx, elem_c, elem_expr, set_expr);
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 2) {
            ...
            if (_mv_509.has_value) {
                __auto_type set_expr = _mv_509.value;
                {
                    __auto_type set_c = expr_resolve_container_c(ctx, set_expr);
            ...
            if (_mv_510.has_value) {
                __auto_type type_expr = _mv_510.value;
                {
                    ...
                    __auto_type result = context_ctx_str(ctx, context_ctx_str3(ctx, SLOP_STR("({ slop_map* _s = slop_map_new_ptr("), arena_c, SLOP_STR(", ")), context_ctx_str(ctx, int_to_string(arena, init_cap), context_ctx_str(ctx, SLOP_STR(", "), context_ctx_str(ctx, elem_info, SLOP_STR("); ")))));
                    {
                        __auto_type i = 2;
                        while (i < len) {
                            __auto_type _mv_511 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_511.has_value) {
                                __auto_type elem_expr = _mv_511.value;
                                {
                                    __auto_type elem_c = expr_transpile_expr(ctx, elem_expr);
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 2) {
            ...
            if (_mv_512.has_value) {
                __auto_type binding_expr = _mv_512.value;
                __auto_type _mv_513 = (*binding_expr);
                switch (_mv_513.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type binding_lst = _mv_513.data.lst;
                        {
                            ...
                            if (binding_len < 3) {
                                ...
                                __auto_type _mv_514 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_514.has_value) {
                                    __auto_type var_expr = _mv_514.value;
                                    __auto_type _mv_515 = (*var_expr);
                                    switch (_mv_515.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type var_sym = _mv_515.data.sym;
                                            {
                                                __auto_type var_name = ctype_to_c_name(arena, var_sym.name);
                                                __auto_type _mv_516 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_516.has_value) {
                                                    __auto_type start_expr = _mv_516.value;
                                                    __auto_type _mv_517 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_517.has_value) {
                                                        __auto_type end_expr = _mv_517.value;
                                                        {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 2) {
            ...
            if (_mv_519.has_value) {
                __auto_type binding_expr = _mv_519.value;
                __auto_type _mv_520 = (*binding_expr);
                switch (_mv_520.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type binding_lst = _mv_520.data.lst;
                        {
                            __auto_type binding_items = binding_lst.items;
                            __auto_type binding_len = ((int64_t)((binding_items).len));
                            if (binding_len < 2) {
                                ...
                                if (_mv_521.has_value) {
                                    __auto_type first_elem = _mv_521.value;
                                    __auto_type _mv_522 = (*first_elem);
                                    switch (_mv_522.tag) {
                                        case types_SExpr_lst:
                                        {
                                            __auto_type _ = _mv_522.data.lst;
                                            return expr_transpile_for_each_map_kv_as_expr(ctx, binding_items, items, len);
                                        }
                                        case types_SExpr_sym:
                                        {
                                            __auto_type var_sym = _mv_522.data.sym;
                                            {
                                                __auto_type var_name = ctype_to_c_name(arena, var_sym.name);
                                                ...
                                                if (_mv_523.has_value) {
                                                    __auto_type coll_expr = _mv_523.value;
                                                    {
            ...
            context_ctx_bind_var(ctx, (context_VarEntry){var_sym.name, var_name, elem_c_type, elem_slop_type, 0, 0, 0, SLOP_STR(""), SLOP_STR("")});
            {
                ...
                while (i < len) {
                    ...
                    if (_mv_525.has_value) {
                        __auto_type body_expr = _mv_525.value;
                        {
                            __auto_type body_c = expr_transpile_expr(ctx, body_expr);
                            result = context_ctx_str3(ctx, result, body_c, SLOP_STR("; "));
                        }
...
slop_string expr_transpile_for_each_map_kv_as_expr(context_TranspileContext* ctx, slop_list_types_SExpr_ptr binding_items, slop_list_types_SExpr_ptr items, int64_t len) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_527 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        if (_mv_527.has_value) {
            __auto_type kv_list_expr = _mv_527.value;
            __auto_type _mv_528 = (*kv_list_expr);
            switch (_mv_528.tag) {
                case types_SExpr_lst:
                {
                    __auto_type kv_lst = _mv_528.data.lst;
                    {
                        __auto_type kv_items = kv_lst.items;
                        if (((int64_t)((kv_items).len)) < 2) {
                            return SLOP_STR("({ /* for-each: map binding needs ((k v) map) */ 0; })");
                        } else {
                            __auto_type _mv_529 = ({ __auto_type _lst = kv_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_529.has_value) {
                                __auto_type k_expr = _mv_529.value;
                                __auto_type _mv_530 = ({ __auto_type _lst = kv_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_530.has_value) {
                                    __auto_type v_expr = _mv_530.value;
                                    __auto_type _mv_531 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    if (_mv_531.has_value) {
                                        __auto_type map_expr = _mv_531.value;
                                        __auto_type _mv_532 = (*k_expr);
                                        switch (_mv_532.tag) {
                                            case types_SExpr_sym:
                                            {
                                                __auto_type k_sym = _mv_532.data.sym;
                                                __auto_type _mv_533 = (*v_expr);
                                                switch (_mv_533.tag) {
                                                    case types_SExpr_sym:
                                                    {
                                                        __auto_type v_sym = _mv_533.data.sym;
                                                        {
                                                                ...
                                                                context_ctx_bind_var(ctx, (context_VarEntry){v_sym.name, v_name, val_c_type, val_slop_type, 0, 0, 0, SLOP_STR(""), SLOP_STR("")});
                                                                {
                                                                    ...
                                                                    while (i < len) {
                                                                        ...
                                                                        if (_mv_534.has_value) {
                                                                            __auto_type body_expr = _mv_534.value;
                                                                            {
                                                                                __auto_type body_c = expr_transpile_expr(ctx, body_expr);
                                                                                result = context_ctx_str3(ctx, result, body_c, SLOP_STR("; "));
                                                                            }
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len < 2) {
            ...
            if (_mv_535.has_value) {
                __auto_type second = _mv_535.value;
                __auto_type _mv_536 = (*second);
                switch (_mv_536.tag) {
                    case types_SExpr_lst:
                    {
                    ...
                    case types_SExpr_sym:
                    {
                        __auto_type _ = _mv_536.data.sym;
...
slop_string expr_build_closure_struct(context_TranspileContext* ctx, slop_string env_type, slop_list_string free_vars) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < count) {
            __auto_type _mv_541 = ({ __auto_type _lst = free_vars; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_541.has_value) {
                __auto_type var_name = _mv_541.value;
                {
...
slop_string expr_find_arena_ptr_expr(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    __auto_type _mv_544 = context_ctx_lookup_var(ctx, SLOP_STR("_arena"));
    if (_mv_544.has_value) {
        __auto_type entry = _mv_544.value;
        return SLOP_STR("&_arena");
    } else if (!_mv_544.has_value) {
        __auto_type _mv_545 = context_ctx_lookup_var(ctx, SLOP_STR("arena"));
        if (_mv_545.has_value) {
            __auto_type entry = _mv_545.value;
            return entry.c_name;
        } else if (!_mv_545.has_value) {
            __auto_type _mv_546 = context_ctx_find_arena_var(ctx);
            if (_mv_546.has_value) {
                __auto_type entry = _mv_546.value;
                return entry.c_name;
...
slop_string expr_build_env_initializer(context_TranspileContext* ctx, slop_list_string free_vars, slop_list_string captured_accesses) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < count) {
            __auto_type _mv_547 = ({ __auto_type _lst = free_vars; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_547.has_value) {
                __auto_type var_name = _mv_547.value;
                {
                    __auto_type c_name = ctype_to_c_name(arena, var_name);
...
void expr_bind_lambda_params(context_TranspileContext* ctx, slop_list_types_SExpr_ptr params) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < param_count) {
            __auto_type _mv_553 = ({ __auto_type _lst = params; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_553.has_value) {
                __auto_type param_expr = _mv_553.value;
                __auto_type _mv_554 = (*param_expr);
                switch (_mv_554.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type param_lst = _mv_554.data.lst;
                        {
                            __auto_type param_items = param_lst.items;
                            if (((int64_t)((param_items).len)) >= 2) {
                                __auto_type _mv_555 = ({ __auto_type _lst = param_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_555.has_value) {
                                    ...
                                    switch (_mv_556.tag) {
                                        case types_SExpr_sym:
                                        {
                                            ...
                                            __auto_type _mv_557 = ({ __auto_type _lst = param_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        if (len <= start) {
            ...
            while (i < len) {
                ...
                if (_mv_561.has_value) {
                    __auto_type expr = _mv_561.value;
                    {
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_562.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 2) {
                    ...
                    __auto_type _mv_563 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_563.has_value) {
                        __auto_type head = _mv_563.value;
                        __auto_type _mv_564 = (*head);
                        switch (_mv_564.tag) {
                            case types_SExpr_sym:
                            {
                                ...
                                if (!(string_eq(sym.name, SLOP_STR("fn")))) {
                                    ...
                                    if (_mv_565.has_value) {
                                        __auto_type second = _mv_565.value;
                                        __auto_type _mv_566 = (*second);
                                        switch (_mv_566.tag) {
                                            case types_SExpr_lst:
                                            {
                                                __auto_type _ = _mv_566.data.lst;
                                                return 1;
                                            }
                                            default: {
                                                return 0;
...
slop_string expr_transpile_spawn_closure(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items, types_SExpr* fn_expr) {
    ...
    SLOP_PRE(((fn_expr != NULL)), "(!= fn-expr nil)");
    {
        ...
        if (_mv_567.has_value) {
            __auto_type arena_expr = _mv_567.value;
            {
                __auto_type arena_c = expr_transpile_expr(ctx, arena_expr);
            ...
            __auto_type lst = _mv_568.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 2) {
                    ...
                    if (_mv_569.has_value) {
                        __auto_type params_expr = _mv_569.value;
                        __auto_type _mv_570 = (*params_expr);
                        switch (_mv_570.tag) {
                            case types_SExpr_lst:
                            {
                                __auto_type params_lst = _mv_570.data.lst;
                                {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (((int64_t)((items).len)) < 2) {
            ...
            if (_mv_572.has_value) {
                __auto_type first_arg = _mv_572.value;
                {
...
slop_list_string expr_find_free_vars(context_TranspileContext* ctx, slop_list_string param_names, slop_list_types_SExpr_ptr body_items, int64_t start, slop_list_string pending) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = start;
        while (i < len) {
            __auto_type _mv_573 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        }
        {
            ...
            int64_t j = 0;
            while (j < sym_count) {
                __auto_type _mv_574 = ({ __auto_type _lst = all_symbols; size_t _idx = (size_t)j; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_574.has_value) {
                    __auto_type sym_name = _mv_574.value;
...
void expr_collect_symbols_in_expr(context_TranspileContext* ctx, slop_list_string* symbols, slop_list_string pending, types_SExpr* expr) {
    ...
    switch (_mv_575.tag) {
        case types_SExpr_sym:
        {
            __auto_type sym = _mv_575.data.sym;
            {
                __auto_type name = sym.name;
            ...
            __auto_type lst = _mv_575.data.lst;
            {
                ...
                if (len > 0) {
                    ...
                    if (_mv_576.has_value) {
                        __auto_type head = _mv_576.value;
                        __auto_type _mv_577 = (*head);
                        switch (_mv_577.tag) {
                            case types_SExpr_sym:
                            {
                                __auto_type head_sym = _mv_577.data.sym;
                                {
                                    __auto_type op = head_sym.name;
...
void expr_collect_symbols_in_list(context_TranspileContext* ctx, slop_list_string* symbols, slop_list_string pending, slop_list_types_SExpr_ptr items, int64_t start) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = start;
        while (i < len) {
            __auto_type _mv_578 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_578.has_value) {
                __auto_type item = _mv_578.value;
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len >= 2) {
            ...
            if (_mv_579.has_value) {
                __auto_type bindings_expr = _mv_579.value;
                {
                    ...
                    __auto_type _mv_580 = (*bindings_expr);
                    switch (_mv_580.tag) {
                        case types_SExpr_lst:
                        {
                            __auto_type bindings_lst = _mv_580.data.lst;
                            {
                                __auto_type bindings = bindings_lst.items;
                                __auto_type binding_count = ((int64_t)((bindings).len));
                                __auto_type i = 0;
                                while (i < binding_count) {
                                    __auto_type _mv_581 = ({ __auto_type _lst = bindings; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    if (_mv_581.has_value) {
                                        __auto_type binding = _mv_581.value;
                                        __auto_type _mv_582 = (*binding);
                                        switch (_mv_582.tag) {
                                            case types_SExpr_lst:
                                            {
                                                __auto_type bind_lst = _mv_582.data.lst;
                                                {
                                                    __auto_type bind_items = bind_lst.items;
                                                    if (((int64_t)((bind_items).len)) >= 2) {
                                                        {
                                                            __auto_type val_idx = ((expr_is_mut_binding(bind_items)) ? 2 : 1);
                                                            __auto_type _mv_583 = ({ __auto_type _lst = bind_items; size_t _idx = (size_t)val_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                            if (_mv_583.has_value) {
                                                                __auto_type val_expr = _mv_583.value;
...
uint8_t expr_is_mut_binding(slop_list_types_SExpr_ptr items) {
    if (((int64_t)((items).len)) < 1) {
        ...
        if (_mv_584.has_value) {
            __auto_type first = _mv_584.value;
            __auto_type _mv_585 = (*first);
            switch (_mv_585.tag) {
                case types_SExpr_sym:
                {
...
slop_list_string expr_extract_let_binding_names(slop_arena* arena, types_SExpr* bindings_expr) {
    ...
    {
        __auto_type names = ((slop_list_string){ .data = (slop_string*)slop_arena_alloc(arena, 16 * sizeof(slop_string)), .len = 0, .cap = 16 });
        __auto_type _mv_586 = (*bindings_expr);
        switch (_mv_586.tag) {
            case types_SExpr_lst:
            {
                __auto_type bindings_lst = _mv_586.data.lst;
                {
                    __auto_type bindings = bindings_lst.items;
                    __auto_type binding_count = ((int64_t)((bindings).len));
                    __auto_type i = 0;
                    while (i < binding_count) {
                        __auto_type _mv_587 = ({ __auto_type _lst = bindings; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        ...
                                        if (((int64_t)((bind_items).len)) >= 1) {
                                            {
                                                ...
                                                __auto_type _mv_589 = ({ __auto_type _lst = bind_items; size_t _idx = (size_t)name_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_589.has_value) {
                                                    __auto_type name_expr = _mv_589.value;
                                                    __auto_type _mv_590 = (*name_expr);
                                                    switch (_mv_590.tag) {
                                                        case types_SExpr_sym:
                                                        {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len >= 2) {
            ...
            if (_mv_591.has_value) {
                __auto_type scrutinee = _mv_591.value;
            ...
            }
            {
                ...
                while (i < len) {
                    ...
                    if (_mv_592.has_value) {
                        __auto_type clause = _mv_592.value;
                        __auto_type _mv_593 = (*clause);
                        switch (_mv_593.tag) {
                            case types_SExpr_lst:
                            {
                                __auto_type clause_lst = _mv_593.data.lst;
                                {
                                    __auto_type clause_items = clause_lst.items;
        ...
        if (len >= 2) {
            ...
            if (_mv_594.has_value) {
                ...
                switch (_mv_595.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type bind_lst = _mv_595.data.lst;
                        {
                            __auto_type bind_items = bind_lst.items;
...
slop_list_string expr_extract_for_loop_var_pending(slop_arena* arena, slop_list_string pending, slop_list_types_SExpr_ptr bind_items) {
    if (((int64_t)((bind_items).len)) < 1) {
        ...
        __auto_type _mv_596 = ({ __auto_type _lst = bind_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        if (_mv_596.has_value) {
            __auto_type var_expr = _mv_596.value;
            __auto_type _mv_597 = (*var_expr);
            switch (_mv_597.tag) {
                case types_SExpr_sym:
                {
                    __auto_type var_sym = _mv_597.data.sym;
                    {
                        __auto_type result = ((slop_list_string){ .data = (slop_string*)slop_arena_alloc(arena, 16 * sizeof(slop_string)), .len = 0, .cap = 16 });
                        ...
                        __auto_type i = 0;
                        while (i < plen) {
                            __auto_type _mv_598 = ({ __auto_type _lst = pending; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        if (len >= 3) {
            {
                ...
                __auto_type size_idx = ((is_named) ? 3 : 1);
                __auto_type body_start = ((is_named) ? 4 : 2);
                __auto_type _mv_599 = ({ __auto_type _lst = items; size_t _idx = (size_t)size_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_599.has_value) {
                    __auto_type size_expr = _mv_599.value;
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len >= 2) {
            ...
            if (_mv_600.has_value) {
                __auto_type params_expr = _mv_600.value;
                __auto_type _mv_601 = (*params_expr);
                switch (_mv_601.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type params_lst = _mv_601.data.lst;
                        {
                            __auto_type params = params_lst.items;
                            __auto_type param_names = expr_extract_param_names(arena, params);
    ...
    if (expr_list_contains_string(param_names, sym_name)) {
        ...
        if (expr_list_contains_string(pending, sym_name)) {
            ...
            if (expr_is_builtin_op(sym_name)) {
                ...
                __auto_type _mv_602 = context_ctx_lookup_func(ctx, sym_name);
                if (_mv_602.has_value) {
                    __auto_type _ = _mv_602.value;
                    return 0;
                } else if (!_mv_602.has_value) {
                    __auto_type _mv_603 = context_ctx_lookup_type(ctx, sym_name);
                    if (_mv_603.has_value) {
                        __auto_type _ = _mv_603.value;
                        return 0;
                    } else if (!_mv_603.has_value) {
                        __auto_type _mv_604 = context_ctx_lookup_var(ctx, sym_name);
                        if (_mv_604.has_value) {
                            __auto_type _ = _mv_604.value;
                            return 1;
...
uint8_t expr_list_contains_string(slop_list_string lst, slop_string needle) {
    {
        ...
        uint8_t found = 0;
        while ((i < len) && !(found)) {
            __auto_type _mv_605 = ({ __auto_type _lst = lst; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_605.has_value) {
                __auto_type s = _mv_605.value;
...
slop_list_string expr_list_concat(slop_arena* arena, slop_list_string a, slop_list_string b) {
    {
        ...
        int64_t i = 0;
        while (i < len_a) {
            __auto_type _mv_606 = ({ __auto_type _lst = a; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_606.has_value) {
                __auto_type s = _mv_606.value;
                ({ __auto_type _lst_p = &(result); __auto_type _item = (s); if (_lst_p->len >= _lst_p->cap) { size_t _new_cap = _lst_p->cap == 0 ? 16 : _lst_p->cap * 2; __typeof__(_lst_p->data) _new_data = (__typeof__(_lst_p->data))slop_arena_alloc(arena, _new_cap * sizeof(*_lst_p->data)); if (_lst_p->len > 0) memcpy(_new_data, _lst_p->data, _lst_p->len * sizeof(*_lst_p->data)); _lst_p->data = _new_data; _lst_p->cap = _new_cap; } _lst_p->data[_lst_p->len++] = _item; (void)0; });
        ...
        i = 0;
        while (i < len_b) {
            __auto_type _mv_607 = ({ __auto_type _lst = b; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_607.has_value) {
                __auto_type s = _mv_607.value;
                ({ __auto_type _lst_p = &(result); __auto_type _item = (s); if (_lst_p->len >= _lst_p->cap) { size_t _new_cap = _lst_p->cap == 0 ? 16 : _lst_p->cap * 2; __typeof__(_lst_p->data) _new_data = (__typeof__(_lst_p->data))slop_arena_alloc(arena, _new_cap * sizeof(*_lst_p->data)); if (_lst_p->len > 0) memcpy(_new_data, _lst_p->data, _lst_p->len * sizeof(*_lst_p->data)); _lst_p->data = _new_data; _lst_p->cap = _new_cap; } _lst_p->data[_lst_p->len++] = _item; (void)0; });
                                    ...
                                    __auto_type sym = _mv_610.data.sym;
                                    {
                                        ...
                                        if (string_eq(op, SLOP_STR("map-keys"))) {
                                            if (((int64_t)((items).len)) < 2) {
                                                ...
                                                __auto_type _mv_611 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_611.has_value) {
                                                    __auto_type map_expr = _mv_611.value;
                                                    {
                                                        __auto_type map_slop_type = expr_infer_expr_slop_type(ctx, map_expr);
                                            ...
                                            if (((int64_t)((items).len)) < 2) {
                                                ...
                                                if (_mv_612.has_value) {
                                                    __auto_type set_expr = _mv_612.value;
                                                    {
                                            ...
                                            if (((int64_t)((items).len)) < 2) {
                                                ...
                                                if (_mv_613.has_value) {
                                                    __auto_type map_expr = _mv_613.value;
                                                    {
                                                        __auto_type map_slop_type = expr_infer_expr_slop_type(ctx, map_expr);
                                                        if (string_len(map_slop_type) > 0) {
                                                            {
