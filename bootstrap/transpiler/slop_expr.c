            ...
            __auto_type lst = _mv_116.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 2)) {
                    ...
                    if (_mv_117.has_value) {
                        __auto_type head = _mv_117.value;
                        __auto_type _mv_118 = (*head);
                        switch (_mv_118.tag) {
                            case types_SExpr_sym:
                            {
                                __auto_type head_sym = _mv_118.data.sym;
                                if (string_eq(head_sym.name, SLOP_STR("quote"))) {
                                    __auto_type _mv_119 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    if (_mv_119.has_value) {
                                        __auto_type inner = _mv_119.value;
                                        __auto_type _mv_120 = (*inner);
                                        switch (_mv_120.tag) {
                                            case types_SExpr_sym:
                                            {
                                                __auto_type inner_sym = _mv_120.data.sym;
...
slop_string expr_transpile_literal(context_TranspileContext* ctx, types_SExpr* expr) {
    ...
    switch (_mv_121.tag) {
        ...
        {
            __auto_type str = _mv_121.data.str;
        ...
        case types_SExpr_lst:
        {
            __auto_type _ = _mv_121.data.lst;
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (string_eq(name, SLOP_STR("true"))) {
        ...
        } else if (strlib_starts_with(name, SLOP_STR("'"))) {
            {
                ...
                __auto_type _mv_122 = context_ctx_lookup_enum_variant(ctx, variant_name);
                if (_mv_122.has_value) {
                    __auto_type enum_name = _mv_122.value;
            ...
            __auto_type _mv_123 = strlib_index_of(name, SLOP_STR("."));
            if (_mv_123.has_value) {
                __auto_type dot_pos = _mv_123.value;
                {
                    ...
                    __auto_type _mv_124 = context_ctx_lookup_var(ctx, base_name);
                    if (_mv_124.has_value) {
                        __auto_type var_entry = _mv_124.value;
                        {
                        ...
                        __auto_type _mv_125 = context_ctx_lookup_type(ctx, base_name);
                        if (_mv_125.has_value) {
                            __auto_type type_info = _mv_125.value;
            ...
            __auto_type _mv_126 = context_ctx_lookup_var(ctx, name);
            if (_mv_126.has_value) {
                __auto_type entry = _mv_126.value;
                return entry.c_name;
            } else if (!_mv_126.has_value) {
                __auto_type _mv_127 = context_ctx_lookup_enum_variant(ctx, name);
                if (_mv_127.has_value) {
                    __auto_type enum_name = _mv_127.value;
                ...
                } else if (!_mv_127.has_value) {
                    {
                        ...
                        __auto_type _mv_128 = context_ctx_lookup_func(ctx, name);
                        if (_mv_128.has_value) {
                            __auto_type func_entry = _mv_128.value;
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len <= (start_idx + 1))) {
        ...
        } else {
            {
                ...
                __auto_type _mv_129 = ({ __auto_type _lst = items; size_t _idx = (size_t)start_idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_129.has_value) {
                    __auto_type first_arg = _mv_129.value;
                ...
                }
                {
                    ...
                    while ((i < len)) {
                        __auto_type _mv_130 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_130.has_value) {
                            __auto_type arg = _mv_130.value;
                            {
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_131.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    __auto_type _mv_132 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_132.has_value) {
                        __auto_type head = _mv_132.value;
                        __auto_type _mv_133 = (*head);
                        switch (_mv_133.tag) {
                            case types_SExpr_sym:
                            {
...
uint8_t expr_is_fn_type_expr(types_SExpr* type_expr) {
    ...
    switch (_mv_135.tag) {
        case types_SExpr_lst:
        {
            ...
            __auto_type _mv_136 = ({ __auto_type _lst = lst.items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
uint8_t expr_is_closure_typed_expr(context_TranspileContext* ctx, types_SExpr* expr) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    SLOP_PRE(((expr != NULL)), "(!= expr nil)");
    __auto_type _mv_139 = (*expr);
    switch (_mv_139.tag) {
        case types_SExpr_sym:
        {
            __auto_type sym = _mv_139.data.sym;
            __auto_type _mv_140 = context_ctx_lookup_var(ctx, sym.name);
...
slop_string expr_fn_type_to_c_fn_ptr(context_TranspileContext* ctx, types_SExpr* fn_expr) {
    ...
    __auto_type _mv_141 = (*fn_expr);
    switch (_mv_141.tag) {
        case types_SExpr_lst:
        {
            __auto_type l = _mv_141.data.lst;
            {
    ...
    switch (_mv_142.tag) {
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_142.data.lst;
            {
                ...
                __auto_type i = 0;
                while ((i < count)) {
                    __auto_type _mv_143 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_143.has_value) {
                        __auto_type arg_type = _mv_143.value;
                        {
        ...
        __auto_type arena = (*ctx).arena;
        {
            ...
            if ((string_len(runtime_name) > 0)) {
            ...
            } else {
                {
                    ...
                    __auto_type _mv_144 = context_ctx_lookup_var(ctx, fn_name);
                    if (_mv_144.has_value) {
                        __auto_type var_entry = _mv_144.value;
...
slop_string expr_closure_type_to_c(context_TranspileContext* ctx, slop_string slop_type) {
    ...
    if (string_eq(slop_type, SLOP_STR("Int"))) {
        ...
        __auto_type _mv_145 = context_ctx_lookup_type(ctx, slop_type);
        if (_mv_145.has_value) {
            __auto_type type_entry = _mv_145.value;
...
slop_string expr_transpile_enum_variant(context_TranspileContext* ctx, slop_string variant_name) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_146 = context_ctx_lookup_enum_variant(ctx, variant_name);
        if (_mv_146.has_value) {
            __auto_type enum_name = _mv_146.value;
            {
...
slop_string expr_transpile_ok(context_TranspileContext* ctx, slop_string value_c) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    __auto_type _mv_147 = context_ctx_get_current_result_type(ctx);
    if (_mv_147.has_value) {
        __auto_type result_type = _mv_147.value;
...
slop_string expr_transpile_error(context_TranspileContext* ctx, slop_string value_c) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    __auto_type _mv_148 = context_ctx_get_current_result_type(ctx);
    if (_mv_148.has_value) {
        __auto_type result_type = _mv_148.value;
...
slop_string expr_infer_option_type(context_TranspileContext* ctx, types_SExpr* val_expr) {
    ...
    __auto_type _mv_149 = (*val_expr);
    switch (_mv_149.tag) {
        case types_SExpr_num:
        {
            __auto_type num = _mv_149.data.num;
            if (num.is_float) {
        ...
        case types_SExpr_str:
        {
            __auto_type _ = _mv_149.data.str;
            return SLOP_STR("slop_option_string");
        }
        case types_SExpr_sym:
        {
            __auto_type sym = _mv_149.data.sym;
            __auto_type _mv_150 = ctype_get_node_resolved_type(val_expr);
            if (_mv_150.has_value) {
                __auto_type rt = _mv_150.value;
                {
...
slop_string expr_infer_field_c_type_from_items(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len < 3)) {
            ...
            __auto_type _mv_152 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_152.has_value) {
                __auto_type obj_expr = _mv_152.value;
                __auto_type _mv_153 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_153.has_value) {
                    __auto_type field_expr = _mv_153.value;
                    __auto_type _mv_154 = (*field_expr);
                    switch (_mv_154.tag) {
                        case types_SExpr_sym:
                        {
                            __auto_type field_sym = _mv_154.data.sym;
                            {
                                __auto_type field_name = field_sym.name;
                                __auto_type obj_c_type = expr_infer_expr_c_type(ctx, obj_expr);
                                __auto_type _mv_155 = context_ctx_lookup_field_type(ctx, obj_c_type, field_name);
                                if (_mv_155.has_value) {
                                    __auto_type c_type = _mv_155.value;
                                    return c_type;
                                } else if (!_mv_155.has_value) {
                                    __auto_type _mv_156 = context_ctx_lookup_var(ctx, expr_get_var_name_from_expr(obj_expr));
                                    if (_mv_156.has_value) {
                                        __auto_type var_entry = _mv_156.value;
                                        {
                                            __auto_type obj_slop_type = var_entry.slop_type;
                                            __auto_type _mv_157 = context_ctx_lookup_field_type(ctx, obj_slop_type, field_name);
                                            if (_mv_157.has_value) {
                                                __auto_type c_type2 = _mv_157.value;
                                                return c_type2;
...
slop_string expr_infer_list_expr_option_type(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len < 1)) {
            ...
            __auto_type _mv_158 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_158.has_value) {
                __auto_type head_expr = _mv_158.value;
                __auto_type _mv_159 = (*head_expr);
                switch (_mv_159.tag) {
                    case types_SExpr_sym:
                    {
                        __auto_type sym = _mv_159.data.sym;
                        {
                            ...
                            if (string_eq(op, SLOP_STR("."))) {
                                if ((len < 3)) {
                                ...
                                } else {
                                    {
                                        ...
                                        if (!(string_eq(field_c_type, SLOP_STR("__auto_type")))) {
                                            ...
                                            __auto_type _mv_160 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_160.has_value) {
                                                __auto_type field_expr = _mv_160.value;
                                                __auto_type _mv_161 = (*field_expr);
                                                switch (_mv_161.tag) {
                                                    case types_SExpr_sym:
                                                    {
                                                        __auto_type field_sym = _mv_161.data.sym;
                                                        {
                                                            __auto_type field_name = field_sym.name;
                                ...
                                __auto_type _mv_162 = context_ctx_lookup_func(ctx, op);
                                if (_mv_162.has_value) {
                                    __auto_type func_entry = _mv_162.value;
                                    {
...
slop_string expr_infer_list_element_option_type(context_TranspileContext* ctx, types_SExpr* list_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_163 = ctype_get_node_resolved_type(list_expr);
        if (_mv_163.has_value) {
            __auto_type rt = _mv_163.value;
            __auto_type _mv_164 = (*rt).inner_type;
            if (_mv_164.has_value) {
                __auto_type elem_type = _mv_164.value;
                {
                ...
                case types_SExpr_lst:
                {
                    __auto_type lst = _mv_165.data.lst;
                    {
                        ...
                        if ((((int64_t)((items).len)) < 3)) {
                            ...
                            __auto_type _mv_167 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_167.has_value) {
                                __auto_type head = _mv_167.value;
                                __auto_type _mv_168 = (*head);
                                switch (_mv_168.tag) {
                                    case types_SExpr_sym:
                                    {
                                        __auto_type head_sym = _mv_168.data.sym;
                                        if (string_eq(head_sym.name, SLOP_STR("."))) {
                                            __auto_type _mv_169 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_169.has_value) {
                                                __auto_type field_expr = _mv_169.value;
...
slop_string expr_infer_field_access_list_type(context_TranspileContext* ctx, types_SExpr* field_expr) {
    ...
    __auto_type _mv_170 = (*field_expr);
    switch (_mv_170.tag) {
        case types_SExpr_sym:
        {
            __auto_type field_sym = _mv_170.data.sym;
            {
                __auto_type field_name = field_sym.name;
        ...
        if (strlib_ends_with(elem_type, SLOP_STR("_ptr"))) {
            {
                ...
                __auto_type _mv_171 = context_ctx_lookup_type(ctx, base);
            ...
            __auto_type _mv_172 = context_ctx_lookup_type(ctx, elem_type);
...
slop_string expr_slop_value_type_to_c_type(context_TranspileContext* ctx, slop_string slop_type) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (strlib_starts_with(slop_type, SLOP_STR("(Map "))) {
            ...
            __auto_type _mv_173 = context_ctx_lookup_type(ctx, slop_type);
...
slop_string expr_get_var_name_from_expr(types_SExpr* expr) {
    ...
    switch (_mv_174.tag) {
        case types_SExpr_sym:
        {
            __auto_type sym = _mv_174.data.sym;
            return sym.name;
        }
        default: {
            return SLOP_STR("");
...
slop_string expr_resolve_type_alias(context_TranspileContext* ctx, slop_string slop_type) {
    ...
    if (strlib_starts_with(slop_type, SLOP_STR("(Map "))) {
        ...
        __auto_type _mv_175 = context_ctx_lookup_type_alias(ctx, slop_type);
        if (_mv_175.has_value) {
            __auto_type alias_def = _mv_175.value;
            return alias_def;
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_176.data.lst;
                {
                    ...
                    if ((len < 1)) {
                        ...
                        __auto_type _mv_178 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    ...
                                    __auto_type head_sym = _mv_179.data.sym;
                                    {
                                        ...
                                        if ((string_eq(op, SLOP_STR(".")) && (len >= 3))) {
                                            ...
                                            if (_mv_180.has_value) {
                                                __auto_type obj_expr = _mv_180.value;
                                                ...
                                                if (_mv_181.has_value) {
                                                    __auto_type field_expr = _mv_181.value;
                                                    __auto_type _mv_182 = (*field_expr);
                                                    switch (_mv_182.tag) {
                                                        case types_SExpr_sym:
                                                        {
                                                            __auto_type field_sym = _mv_182.data.sym;
                                                            {
                                                                __auto_type field_name = field_sym.name;
                                                                {
                                                                    __auto_type obj_c_type = expr_infer_expr_c_type(ctx, obj_expr);
                                                                    __auto_type _mv_183 = context_ctx_lookup_field_slop_type(ctx, obj_c_type, field_name);
                                                                    if (_mv_183.has_value) {
                                                                        __auto_type slop_type = _mv_183.value;
                                                                        return slop_type;
                                                                    } else if (!_mv_183.has_value) {
                                                                        {
                                                                            __auto_type obj_slop_type = expr_infer_expr_slop_type(ctx, obj_expr);
                                                                            __auto_type _mv_184 = context_ctx_lookup_field_slop_type(ctx, obj_slop_type, field_name);
                                                                            if (_mv_184.has_value) {
                                                                                __auto_type slop_type2 = _mv_184.value;
                                                                                return slop_type2;
                                            ...
                                            if ((len >= 2)) {
                                                ...
                                                if (_mv_185.has_value) {
                                                    __auto_type type_expr = _mv_185.value;
                                                    __auto_type _mv_186 = (*type_expr);
                                                    switch (_mv_186.tag) {
                                                        case types_SExpr_sym:
                                                        {
                                                            __auto_type type_sym = _mv_186.data.sym;
                                            ...
                                            if ((len >= 4)) {
                                                ...
                                                if (_mv_187.has_value) {
                                                    __auto_type key_expr = _mv_187.value;
                                                    __auto_type _mv_188 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_188.has_value) {
                                                        __auto_type val_expr = _mv_188.value;
                                                        {
                                            ...
                                            if ((len >= 3)) {
                                                __auto_type _mv_189 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_189.has_value) {
                                                    __auto_type elem_expr = _mv_189.value;
                                                    {
                                            ...
                                            if ((len >= 3)) {
                                                ...
                                                if (_mv_190.has_value) {
                                                    __auto_type elem_expr = _mv_190.value;
                                                    {
                                                        __auto_type elem_str = ctype_sexpr_to_type_string(arena, elem_expr);
                                            ...
                                            if ((len >= 4)) {
                                                ...
                                                if (_mv_191.has_value) {
                                                    __auto_type type_expr = _mv_191.value;
                                                    {
                                            ...
                                            __auto_type _mv_193 = context_ctx_lookup_func(ctx, op);
                                            if (_mv_193.has_value) {
                                                __auto_type func_entry = _mv_193.value;
...
slop_string expr_infer_map_key_c_type(context_TranspileContext* ctx, types_SExpr* map_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_194 = (*map_expr);
        switch (_mv_194.tag) {
            case types_SExpr_sym:
            {
                __auto_type sym = _mv_194.data.sym;
                {
                    __auto_type name = sym.name;
                    __auto_type _mv_195 = context_ctx_lookup_var(ctx, name);
                    if (_mv_195.has_value) {
                        __auto_type var_entry = _mv_195.value;
                        {
                            __auto_type slop_type = var_entry.slop_type;
                            if ((string_len(slop_type) > 0)) {
                                {
    ...
    SLOP_PRE(((set_expr != NULL)), "(!= set-expr nil)");
    {
        ...
        switch (_mv_196.tag) {
            case types_SExpr_sym:
            {
                ...
                {
                    __auto_type name = sym.name;
                    __auto_type _mv_197 = context_ctx_lookup_var(ctx, name);
                    if (_mv_197.has_value) {
                        __auto_type var_entry = _mv_197.value;
                        {
                            __auto_type slop_type = var_entry.slop_type;
                            if ((string_len(slop_type) > 0)) {
                                {
                            ...
                            __auto_type lst = _mv_200.data.lst;
                            {
                                ...
                                if ((len < 2)) {
                                    ...
                                    if (_mv_201.has_value) {
                                        __auto_type head_expr = _mv_201.value;
                                        __auto_type _mv_202 = (*head_expr);
                                        switch (_mv_202.tag) {
                                            case types_SExpr_sym:
                                            {
                                                    ...
                                                    if (string_eq(op, SLOP_STR("map-get"))) {
                                                        if ((len < 2)) {
                                                            ...
                                                            if (_mv_203.has_value) {
                                                                __auto_type map_expr = _mv_203.value;
                                                                __auto_type _mv_204 = (*map_expr);
                                                                switch (_mv_204.tag) {
                                                                    case types_SExpr_sym:
                                                                    {
                                                                        __auto_type map_sym = _mv_204.data.sym;
                                                                        {
                                                                            __auto_type map_name = map_sym.name;
                                                                            __auto_type _mv_205 = context_ctx_lookup_var(ctx, map_name);
                                                                            if (_mv_205.has_value) {
                                                                                __auto_type var_entry = _mv_205.value;
                                                                                {
                                                                                    __auto_type slop_type = var_entry.slop_type;
                                                                                    if ((string_len(slop_type) > 0)) {
                                                                                        {
                                                        ...
                                                        if ((len < 2)) {
                                                            ...
                                                            if (_mv_206.has_value) {
                                                                __auto_type list_expr = _mv_206.value;
                                                                __auto_type _mv_207 = (*list_expr);
                                                                switch (_mv_207.tag) {
                                                                    case types_SExpr_sym:
                                                                    {
                                                                        __auto_type list_sym = _mv_207.data.sym;
                                                                        {
                                                                            __auto_type list_name = list_sym.name;
                                                                            __auto_type _mv_208 = context_ctx_lookup_var(ctx, list_name);
...
slop_string expr_fix_ternary_none(context_TranspileContext* ctx, slop_string other_branch, slop_string this_branch) {
    ...
    if ((string_eq(this_branch, SLOP_STR("none")) && strlib_starts_with(other_branch, SLOP_STR("(slop_option_")))) {
        {
            __auto_type arena = (*ctx).arena;
            __auto_type _mv_209 = expr_extract_option_type(arena, other_branch);
            if (_mv_209.has_value) {
                __auto_type opt_type = _mv_209.value;
    ...
    switch (_mv_212.tag) {
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_212.data.lst;
            {
                __auto_type items = lst.items;
                if ((((int64_t)((items).len)) >= 1)) {
                    __auto_type _mv_214 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_214.has_value) {
                        __auto_type head_ptr = _mv_214.value;
                        __auto_type _mv_215 = (*head_ptr);
                        switch (_mv_215.tag) {
                            case types_SExpr_sym:
                            {
                                __auto_type head_sym = _mv_215.data.sym;
                                {
                                    __auto_type op = head_sym.name;
                                    ...
                                    __auto_type head_sym = _mv_219.data.sym;
                                    {
                                        ...
                                        if (string_eq(op, SLOP_STR("sizeof"))) {
                                        ...
                                        } else if ((string_eq(op, SLOP_STR("*")) || (string_eq(op, SLOP_STR("+")) || (string_eq(op, SLOP_STR("-")) || string_eq(op, SLOP_STR("/")))))) {
                                            {
                                                ...
                                                while ((i < len)) {
                                                    __auto_type _mv_221 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_221.has_value) {
                                                        __auto_type arg_expr = _mv_221.value;
                                                        {
...
slop_string expr_transpile_expr(context_TranspileContext* ctx, types_SExpr* expr) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    SLOP_PRE(((expr != NULL)), "(!= expr nil)");
    __auto_type _mv_222 = (*expr);
    switch (_mv_222.tag) {
        case types_SExpr_num:
        {
            __auto_type _ = _mv_222.data.num;
            return expr_transpile_literal(ctx, expr);
        }
        case types_SExpr_str:
        {
            __auto_type _ = _mv_222.data.str;
            return expr_transpile_literal(ctx, expr);
        }
        case types_SExpr_sym:
        {
            __auto_type _ = _mv_222.data.sym;
            return expr_transpile_literal(ctx, expr);
        }
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_222.data.lst;
...
slop_string expr_transpile_list_expr(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len < 1)) {
            ...
            __auto_type _mv_223 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_223.has_value) {
                __auto_type head_expr = _mv_223.value;
                __auto_type _mv_224 = (*head_expr);
                switch (_mv_224.tag) {
                    case types_SExpr_sym:
                    {
                        __auto_type head_sym = _mv_224.data.sym;
                        {
                            __auto_type op = head_sym.name;
                            if ((expr_is_binop(op) && (len < 3))) {
                                ...
                                if ((len > 3)) {
                                    ...
                                    if (_mv_225.has_value) {
                                        __auto_type left = _mv_225.value;
                                        ...
                                        if (_mv_226.has_value) {
                                            __auto_type right = _mv_226.value;
                                            {
                                ...
                                if (_mv_227.has_value) {
                                    __auto_type left = _mv_227.value;
                                    ...
                                    if (_mv_228.has_value) {
                                        __auto_type right = _mv_228.value;
                                        {
                                            __auto_type left_c = expr_transpile_expr(ctx, left);
                                            __auto_type right_c = expr_transpile_expr(ctx, right);
                                            return expr_transpile_binop(ctx, op, left_c, right_c);
                                ...
                                if (_mv_230.has_value) {
                                    __auto_type cond_expr = _mv_230.value;
                                    ...
                                    if (_mv_231.has_value) {
                                        __auto_type then_expr = _mv_231.value;
                                        __auto_type _mv_232 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_232.has_value) {
                                            __auto_type else_expr = _mv_232.value;
                                            {
                                ...
                                if (_mv_234.has_value) {
                                    ...
                                    if (_mv_235.has_value) {
                                        __auto_type field_expr = _mv_235.value;
                                        __auto_type _mv_236 = (*field_expr);
                                        switch (_mv_236.tag) {
                                            case types_SExpr_sym:
                                            {
                                                __auto_type field_sym = _mv_236.data.sym;
                                                {
                                ...
                                if (_mv_237.has_value) {
                                    ...
                                    if (_mv_238.has_value) {
                                        __auto_type val_expr = _mv_238.value;
                                        {
                                ...
                                if (_mv_239.has_value) {
                                    __auto_type str_expr = _mv_239.value;
                                    __auto_type _mv_240 = (*str_expr);
                                    switch (_mv_240.tag) {
                                        case types_SExpr_str:
                                        {
                                ...
                                if (_mv_244.has_value) {
                                    __auto_type arr_expr = _mv_244.value;
                                    ...
                                    if (_mv_245.has_value) {
                                        __auto_type idx_expr = _mv_245.value;
                                        {
                                ...
                                if (_mv_246.has_value) {
                                    __auto_type arena_expr = _mv_246.value;
                                    __auto_type _mv_247 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    if (_mv_247.has_value) {
                                        __auto_type size_expr = _mv_247.value;
                                        {
                                            __auto_type arena_c = expr_transpile_expr(ctx, arena_expr);
                                            __auto_type _mv_248 = (*size_expr);
                                            switch (_mv_248.tag) {
                                                case types_SExpr_sym:
                                                {
                                                    __auto_type sym = _mv_248.data.sym;
                                                    {
                                                        __auto_type type_name = sym.name;
                                                        __auto_type _mv_249 = context_ctx_lookup_type(ctx, type_name);
                                ...
                                if (_mv_251.has_value) {
                                    __auto_type arena_expr = _mv_251.value;
                                    {
                                        __auto_type arena_c = expr_transpile_expr(ctx, arena_expr);
                                ...
                                if (_mv_252.has_value) {
                                    __auto_type variant_expr = _mv_252.value;
                                    __auto_type _mv_253 = (*variant_expr);
                                    switch (_mv_253.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type sym = _mv_253.data.sym;
                                            {
                                ...
                                if (_mv_254.has_value) {
                                    ...
                                    __auto_type _mv_255 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    if (_mv_255.has_value) {
                                        __auto_type tag_expr = _mv_255.value;
                                        __auto_type _mv_256 = (*type_expr);
                                        switch (_mv_256.tag) {
                                            case types_SExpr_sym:
                                            {
                                                __auto_type type_sym = _mv_256.data.sym;
                                                __auto_type _mv_257 = expr_extract_symbol_name(tag_expr);
                                                if (_mv_257.has_value) {
                                                    __auto_type tag_str = _mv_257.value;
                                                    {
                                                        ...
                                                        if ((len >= 4)) {
                                                            __auto_type _mv_258 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                            if (_mv_258.has_value) {
                                                                __auto_type val_expr = _mv_258.value;
                                                                {
                                                                    __auto_type val_c = expr_transpile_expr(ctx, val_expr);
                                ...
                                if (_mv_259.has_value) {
                                    __auto_type val_expr = _mv_259.value;
                                    {
                                        __auto_type val_c = expr_transpile_expr(ctx, val_expr);
                                ...
                                if (_mv_260.has_value) {
                                    __auto_type val_expr = _mv_260.value;
                                    {
                                        __auto_type val_c = expr_transpile_expr(ctx, val_expr);
                                ...
                                __auto_type _mv_261 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_261.has_value) {
                                    __auto_type result_expr = _mv_261.value;
                                    {
                                        __auto_type result_c = expr_transpile_expr(ctx, result_expr);
                                        __auto_type _mv_262 = context_ctx_get_current_result_type(ctx);
                                        if (_mv_262.has_value) {
                                            __auto_type enclosing_type = _mv_262.value;
                                ...
                                if (_mv_263.has_value) {
                                    __auto_type list_expr = _mv_263.value;
                                    {
                                ...
                                if (_mv_264.has_value) {
                                    __auto_type list_expr = _mv_264.value;
                                    ...
                                    if (_mv_265.has_value) {
                                        __auto_type idx_expr = _mv_265.value;
                                        {
                                            __auto_type list_c = expr_transpile_expr(ctx, list_expr);
                                            __auto_type idx_c = expr_transpile_expr(ctx, idx_expr);
                                ...
                                if (_mv_267.has_value) {
                                    __auto_type arena_expr = _mv_267.value;
                                ...
                                if (_mv_269.has_value) {
                                    ...
                                    if (_mv_270.has_value) {
                                        __auto_type item_expr = _mv_270.value;
                                        {
                                            __auto_type list_c = expr_transpile_expr(ctx, list_expr);
                                ...
                                __auto_type _mv_271 = context_ctx_get_current_return_type(ctx);
                                if (_mv_271.has_value) {
                                    __auto_type ret_type = _mv_271.value;
                    ...
                    default: {
                        {
                            ...
                            __auto_type i = 1;
                            while ((i < len)) {
                                __auto_type _mv_272 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_272.has_value) {
                                    __auto_type arg = _mv_272.value;
                                    {
        ...
        if (string_eq(fn_name, SLOP_STR("println"))) {
            ...
            if ((len < 3)) {
                ...
                if (_mv_275.has_value) {
                    __auto_type a_expr = _mv_275.value;
                    __auto_type _mv_276 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_276.has_value) {
                        __auto_type b_expr = _mv_276.value;
                        {
            ...
            if ((len < 3)) {
                ...
                if (_mv_277.has_value) {
                    __auto_type a_expr = _mv_277.value;
                    ...
                    if (_mv_278.has_value) {
                        __auto_type b_expr = _mv_278.value;
                        {
                            __auto_type a_c = expr_transpile_expr(ctx, a_expr);
                            __auto_type b_c = expr_transpile_expr(ctx, b_expr);
                            __auto_type s1 = string_concat(arena, SLOP_STR("(("), a_c);
            ...
            if ((len < 3)) {
                ...
                if (_mv_279.has_value) {
                    __auto_type fn_expr = _mv_279.value;
            ...
            if ((len < 4)) {
                ...
                if (_mv_280.has_value) {
                    __auto_type type_expr = _mv_280.value;
                    ...
                    if (_mv_281.has_value) {
                        __auto_type arena_expr = _mv_281.value;
                        __auto_type _mv_282 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_282.has_value) {
                            __auto_type cap_expr = _mv_282.value;
                            {
            ...
            if ((len < 3)) {
                ...
                if (_mv_285.has_value) {
                    __auto_type chan_expr = _mv_285.value;
                    ...
                    if (_mv_286.has_value) {
                        __auto_type value_expr = _mv_286.value;
                        {
            ...
            if ((len < 2)) {
                ...
                __auto_type _mv_287 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_287.has_value) {
                    __auto_type chan_expr = _mv_287.value;
                    {
                        __auto_type chan_c = expr_transpile_expr(ctx, chan_expr);
                        __auto_type chan_c_type = expr_infer_expr_c_type(ctx, chan_expr);
                        {
        ...
        } else {
            {
                ...
                if ((string_len(builtin_c_name) > 0)) {
                    ...
                    __auto_type _mv_288 = context_ctx_lookup_type(ctx, fn_name);
                    if (_mv_288.has_value) {
                        __auto_type type_entry = _mv_288.value;
                        if (type_entry.is_union) {
                        ...
                        } else {
                            {
                                ...
                                while ((i < len)) {
                                    __auto_type _mv_289 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    if (_mv_289.has_value) {
                                        __auto_type arg = _mv_289.value;
                                        {
                                            __auto_type arg_c = expr_transpile_expr(ctx, arg);
                        ...
                        __auto_type _mv_290 = context_ctx_lookup_enum_variant(ctx, fn_name);
                        if (_mv_290.has_value) {
                            __auto_type type_name = _mv_290.value;
                            {
                                ...
                                if (!_mv_292.has_value) {
                                    {
                                        ...
                                        if (((string_len(runtime_name) == 0) && ({ __auto_type _mv = var_opt; _mv.has_value ? ({ __auto_type _ = _mv.value; 0; }) : (1); }))) {
                                            ...
                                            while ((i < len)) {
                                                __auto_type _mv_293 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    ...
                                    __auto_type func_entry = _mv_292.value;
                                    while ((i < len)) {
...
slop_string expr_transpile_print(context_TranspileContext* ctx, types_SExpr* arg, uint8_t newline) {
    ...
    SLOP_PRE(((arg != NULL)), "(!= arg nil)");
    {
        ...
        __auto_type _mv_295 = (*arg);
        switch (_mv_295.tag) {
            case types_SExpr_str:
            {
                __auto_type s = _mv_295.data.str;
                return context_ctx_str5(ctx, SLOP_STR("printf(\"%s"), nl, SLOP_STR("\", \""), s.value, SLOP_STR("\")"));
            }
            case types_SExpr_num:
            {
                __auto_type n = _mv_295.data.num;
            ...
            default: {
                {
                    __auto_type arg_c = expr_transpile_expr(ctx, arg);
                    __auto_type _mv_296 = expr_get_expr_type_hint(ctx, arg);
                    if (_mv_296.has_value) {
                        __auto_type type_hint = _mv_296.value;
...
slop_option_string expr_get_expr_type_hint(context_TranspileContext* ctx, types_SExpr* expr) {
    ...
    SLOP_PRE(((expr != NULL)), "(!= expr nil)");
    {
        ...
        if (string_eq(slop_type, SLOP_STR("String"))) {
            ...
            __auto_type _mv_299 = (*expr);
            switch (_mv_299.tag) {
                case types_SExpr_sym:
                {
                    __auto_type sym = _mv_299.data.sym;
                    __auto_type _mv_300 = context_ctx_lookup_var(ctx, sym.name);
                    if (_mv_300.has_value) {
                        __auto_type entry = _mv_300.value;
                        {
                ...
                case types_SExpr_lst:
                {
                    __auto_type lst = _mv_299.data.lst;
                    {
                        __auto_type items = lst.items;
                        if ((((int64_t)((items).len)) >= 1)) {
                            __auto_type _mv_301 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_301.has_value) {
                                __auto_type head = _mv_301.value;
                                __auto_type _mv_302 = (*head);
                                switch (_mv_302.tag) {
                                    case types_SExpr_sym:
                                    {
                                        __auto_type head_sym = _mv_302.data.sym;
                                        {
                                            __auto_type op = head_sym.name;
                                            if ((string_eq(op, SLOP_STR(".")) && (((int64_t)((items).len)) >= 3))) {
                                                {
                                                    ...
                                                    if (string_eq(c_type, SLOP_STR("slop_string"))) {
                                                        ...
                                                        __auto_type _mv_303 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                        if (_mv_303.has_value) {
                                                            __auto_type obj_expr = _mv_303.value;
                                                            __auto_type _mv_304 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                            if (_mv_304.has_value) {
                                                                __auto_type field_expr = _mv_304.value;
                                                                __auto_type _mv_305 = (*field_expr);
                                                                switch (_mv_305.tag) {
                                                                    case types_SExpr_sym:
                                                                    {
                                                                        __auto_type field_sym = _mv_305.data.sym;
                                                                        {
                                                                            __auto_type field_name = field_sym.name;
                                                                            __auto_type obj_slop_type = expr_infer_expr_slop_type(ctx, obj_expr);
                                                                            if ((string_len(obj_slop_type) > 0)) {
                                                                                __auto_type _mv_306 = context_ctx_lookup_field_slop_type(ctx, obj_slop_type, field_name);
                                                                                if (_mv_306.has_value) {
                                                                                    __auto_type fst = _mv_306.value;
                                                ...
                                                __auto_type _mv_307 = context_ctx_lookup_func(ctx, op);
                                                if (_mv_307.has_value) {
                                                    __auto_type func_entry = _mv_307.value;
                                                    if (func_entry.returns_string) {
                                                        return (slop_option_string){.has_value = 1, .value = SLOP_STR("slop_string")};
                                                    } else {
                                                        return (slop_option_string){.has_value = false};
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len < 2)) {
            ...
            if (_mv_308.has_value) {
                __auto_type tag_expr = _mv_308.value;
                __auto_type _mv_309 = (*tag_expr);
                switch (_mv_309.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type tag_list = _mv_309.data.lst;
                        {
                            __auto_type tag_items = tag_list.items;
                            if ((((int64_t)((tag_items).len)) < 1)) {
                                return context_ctx_str3(ctx, SLOP_STR("(("), c_type_name, SLOP_STR("){})"));
                            } else {
                                __auto_type _mv_310 = ({ __auto_type _lst = tag_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_310.has_value) {
                                    __auto_type tag_name_expr = _mv_310.value;
                                    __auto_type _mv_311 = (*tag_name_expr);
                                    switch (_mv_311.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type tag_sym = _mv_311.data.sym;
                                            {
                                                ...
                                                if ((((int64_t)((tag_items).len)) >= 2)) {
                                                    __auto_type _mv_312 = ({ __auto_type _lst = tag_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_312.has_value) {
                                                        __auto_type value_expr = _mv_312.value;
                                                        {
                                                            __auto_type value_c = expr_transpile_expr(ctx, value_expr);
...
slop_string expr_transpile_cond_expr(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 1;
        while ((i < len)) {
            __auto_type _mv_313 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_313.has_value) {
                __auto_type clause_expr = _mv_313.value;
                __auto_type _mv_314 = (*clause_expr);
                switch (_mv_314.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type clause_lst = _mv_314.data.lst;
                        {
                            __auto_type clause_items = clause_lst.items;
                            __auto_type clause_len = ((int64_t)((clause_items).len));
                            if ((clause_len >= 2)) {
                                __auto_type _mv_315 = ({ __auto_type _lst = clause_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_315.has_value) {
                                    __auto_type test_expr = _mv_315.value;
                                    __auto_type _mv_316 = (*test_expr);
                                    switch (_mv_316.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type sym = _mv_316.data.sym;
                                            if (string_eq(sym.name, SLOP_STR("else"))) {
                                                __auto_type _mv_317 = ({ __auto_type _lst = clause_items; size_t _idx = (size_t)(clause_len - 1); slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            ...
                                            } else {
                                                {
                                                    ...
                                                    __auto_type _mv_318 = ({ __auto_type _lst = clause_items; size_t _idx = (size_t)(clause_len - 1); slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_318.has_value) {
                                                        __auto_type body_expr = _mv_318.value;
                                                        {
                                        ...
                                        default: {
                                            {
                                                __auto_type test_c = expr_transpile_expr(ctx, test_expr);
                                                __auto_type _mv_319 = ({ __auto_type _lst = clause_items; size_t _idx = (size_t)(clause_len - 1); slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_319.has_value) {
                                                    __auto_type body_expr = _mv_319.value;
                                                    {
                                                        __auto_type body_c = expr_typed_none(ctx, result_type, expr_transpile_expr(ctx, body_expr));
                                                        result = context_ctx_str(ctx, result, context_ctx_str(ctx, SLOP_STR("("), context_ctx_str(ctx, test_c, context_ctx_str(ctx, SLOP_STR(" ? "), context_ctx_str(ctx, body_c, SLOP_STR(" : "))))));
                                                    }
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len < 3)) {
            ...
            if (_mv_320.has_value) {
                __auto_type scrutinee = _mv_320.value;
                {
...
slop_list_types_SExpr_ptr expr_collect_match_patterns(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 2;
        while ((i < len)) {
            __auto_type _mv_321 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_321.has_value) {
                __auto_type branch = _mv_321.value;
                __auto_type _mv_322 = (*branch);
                switch (_mv_322.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type branch_lst = _mv_322.data.lst;
                        {
                            __auto_type branch_items = branch_lst.items;
                            if ((((int64_t)((branch_items).len)) >= 1)) {
                                __auto_type _mv_323 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_323.has_value) {
                                    __auto_type pattern = _mv_323.value;
...
slop_string expr_get_expr_pattern_tag(types_SExpr* pat_expr) {
    ...
    __auto_type _mv_324 = (*pat_expr);
    switch (_mv_324.tag) {
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_324.data.lst;
            {
                __auto_type items = lst.items;
                if ((((int64_t)((items).len)) < 1)) {
                    return SLOP_STR("");
                } else {
                    __auto_type _mv_325 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_325.has_value) {
                        __auto_type head = _mv_325.value;
                        __auto_type _mv_326 = (*head);
                        switch (_mv_326.tag) {
                            case types_SExpr_sym:
                            {
...
uint8_t expr_is_option_patterns(slop_list_types_SExpr_ptr patterns) {
    {
        ...
        int64_t i = 0;
        while (((i < len) && !(found))) {
            __auto_type _mv_327 = ({ __auto_type _lst = patterns; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_327.has_value) {
                __auto_type pat = _mv_327.value;
                {
...
uint8_t expr_is_result_patterns(slop_list_types_SExpr_ptr patterns) {
    {
        ...
        int64_t i = 0;
        while (((i < len) && !(found))) {
            __auto_type _mv_328 = ({ __auto_type _lst = patterns; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_328.has_value) {
                __auto_type pat = _mv_328.value;
                {
                    __auto_type tag = expr_get_expr_pattern_tag(pat);
...
uint8_t expr_is_union_expr_patterns(context_TranspileContext* ctx, slop_list_types_SExpr_ptr patterns) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (((i < len) && !(has_union_variant))) {
            __auto_type _mv_329 = ({ __auto_type _lst = patterns; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_329.has_value) {
                __auto_type pat_expr = _mv_329.value;
                {
                    ...
                    if (((!(string_eq(tag, SLOP_STR("")))) && (!(string_eq(tag, SLOP_STR("some")))) && (!(string_eq(tag, SLOP_STR("none")))) && (!(string_eq(tag, SLOP_STR("ok")))) && (!(string_eq(tag, SLOP_STR("error")))) && (!(string_eq(tag, SLOP_STR("else")))) && (!(string_eq(tag, SLOP_STR("_")))))) {
                        __auto_type _mv_330 = context_ctx_lookup_enum_variant(ctx, tag);
...
slop_option_string expr_get_expr_binding_name(types_SExpr* pat_expr) {
    SLOP_PRE(((pat_expr != NULL)), "(!= pat-expr nil)");
    __auto_type _mv_331 = (*pat_expr);
    switch (_mv_331.tag) {
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_331.data.lst;
            {
                __auto_type items = lst.items;
                if ((((int64_t)((items).len)) < 2)) {
                    return (slop_option_string){.has_value = false};
                    ...
                    if (_mv_332.has_value) {
                        __auto_type binding = _mv_332.value;
                        __auto_type _mv_333 = (*binding);
                        switch (_mv_333.tag) {
                            case types_SExpr_sym:
                            {
...
slop_string expr_get_match_branch_body(context_TranspileContext* ctx, slop_list_types_SExpr_ptr branch_items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len < 2)) {
            ...
            __auto_type _mv_334 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)(len - 1); slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_string expr_build_option_match_expr(context_TranspileContext* ctx, types_SExpr* scrutinee, slop_string scrutinee_c, slop_list_types_SExpr_ptr items) {
    ...
    SLOP_PRE(((scrutinee != NULL)), "(!= scrutinee nil)");
    {
        ...
        int64_t i = 2;
        while ((i < len)) {
            __auto_type _mv_335 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_335.has_value) {
                __auto_type branch = _mv_335.value;
                __auto_type _mv_336 = (*branch);
                switch (_mv_336.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type branch_lst = _mv_336.data.lst;
                        {
                            __auto_type branch_items = branch_lst.items;
                            if ((((int64_t)((branch_items).len)) >= 2)) {
                                __auto_type _mv_337 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_337.has_value) {
                                    __auto_type pattern = _mv_337.value;
                                    {
                                        __auto_type tag = expr_get_expr_pattern_tag(pattern);
                                        if (string_eq(tag, SLOP_STR("some"))) {
                                            __auto_type _mv_338 = expr_get_expr_binding_name(pattern);
                                            if (_mv_338.has_value) {
                                                __auto_type name = _mv_338.value;
                                                some_binding = name;
...
slop_string expr_infer_cond_result_c_type(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len < 2)) {
            ...
            __auto_type _mv_339 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_339.has_value) {
                __auto_type first_clause = _mv_339.value;
                __auto_type _mv_340 = (*first_clause);
                switch (_mv_340.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type clause_lst = _mv_340.data.lst;
                        {
                            __auto_type clause_items = clause_lst.items;
                            __auto_type clause_len = ((int64_t)((clause_items).len));
                            if ((clause_len < 2)) {
                                ...
                                __auto_type _mv_341 = ({ __auto_type _lst = clause_items; size_t _idx = (size_t)(clause_len - 1); slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_341.has_value) {
                                    __auto_type body_expr = _mv_341.value;
        ...
        case types_SExpr_lst:
        {
            __auto_type branch_lst = _mv_342.data.lst;
            {
                ...
                if ((branch_len < 2)) {
                    ...
                    __auto_type _mv_343 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)(branch_len - 1); slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_string expr_slop_type_to_c_type(context_TranspileContext* ctx, slop_string slop_type) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_345 = context_ctx_lookup_type(ctx, slop_type);
        if (_mv_345.has_value) {
            __auto_type entry = _mv_345.value;
            return entry.c_name;
    ...
    SLOP_PRE(((expr != NULL)), "(!= expr nil)");
    {
        ...
        if ((string_len(checker_type) > 0)) {
            ...
            switch (_mv_346.tag) {
                case types_SExpr_str:
                {
                    __auto_type _ = _mv_346.data.str;
                    return SLOP_STR("slop_string");
                }
                case types_SExpr_num:
                {
                    __auto_type num = _mv_346.data.num;
                    if (num.is_float) {
                        return SLOP_STR("double");
                    } else {
                        return SLOP_STR("int64_t");
                ...
                case types_SExpr_sym:
                {
                    ...
                    {
                        __auto_type name = sym.name;
                        __auto_type _mv_347 = context_ctx_lookup_var(ctx, name);
                ...
                case types_SExpr_lst:
                {
                    __auto_type lst = _mv_346.data.lst;
                    {
                        ...
                        if ((((int64_t)((items).len)) < 1)) {
                            ...
                            __auto_type _mv_348 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        ...
                                        __auto_type sym = _mv_349.data.sym;
                                        {
                                            ...
                                            if (({ __auto_type _mv = context_ctx_lookup_func(ctx, op); _mv.has_value ? ({ __auto_type func_entry = _mv.value; func_entry.returns_string; }) : (0); })) {
                                                ...
                                                if ((((int64_t)((items).len)) < 3)) {
                                                    ...
                                                    __auto_type _mv_350 = ({ __auto_type _lst = items; size_t _idx = (size_t)(((int64_t)((items).len)) - 1); slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_350.has_value) {
                                                        __auto_type body = _mv_350.value;
                                                ...
                                                if ((((int64_t)((items).len)) < 2)) {
                                                    ...
                                                    __auto_type _mv_351 = ({ __auto_type _lst = items; size_t _idx = (size_t)(((int64_t)((items).len)) - 1); slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_351.has_value) {
                                                        __auto_type last_expr = _mv_351.value;
                                                ...
                                                if ((((int64_t)((items).len)) < 3)) {
                                                    ...
                                                    __auto_type _mv_352 = ({ __auto_type _lst = items; size_t _idx = (size_t)(((int64_t)((items).len)) - 1); slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_352.has_value) {
                                                        __auto_type body = _mv_352.value;
                                                        return expr_infer_expr_c_type(ctx, body);
                                                ...
                                                if ((((int64_t)((items).len)) < 3)) {
                                                    ...
                                                    __auto_type _mv_353 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_353.has_value) {
                                                        __auto_type then_expr = _mv_353.value;
                                                ...
                                                if ((((int64_t)((items).len)) < 2)) {
                                                    ...
                                                    __auto_type _mv_354 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                ...
                                                __auto_type _mv_355 = context_ctx_get_current_return_type(ctx);
                                                if (_mv_355.has_value) {
                                                    __auto_type ret_type = _mv_355.value;
                                                    if (strlib_starts_with(ret_type, SLOP_STR("slop_option_"))) {
                                                        return ret_type;
                                                    } else {
                                                        return SLOP_STR("slop_option_int");
                                                ...
                                                if ((((int64_t)((items).len)) < 2)) {
                                                    ...
                                                    __auto_type _mv_356 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                ...
                                                if ((((int64_t)((items).len)) < 2)) {
                                                    ...
                                                    __auto_type _mv_358 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                ...
                                                if ((((int64_t)((items).len)) < 2)) {
                                                    ...
                                                    if (_mv_359.has_value) {
                                                        __auto_type chan_arg = _mv_359.value;
                                                        {
                                                ...
                                                __auto_type _mv_364 = context_ctx_lookup_type(ctx, op);
                                                if (_mv_364.has_value) {
                                                    __auto_type type_entry = _mv_364.value;
                                                    return type_entry.c_name;
                                                } else if (!_mv_364.has_value) {
                                                    __auto_type _mv_365 = context_ctx_lookup_func(ctx, op);
                                                    if (_mv_365.has_value) {
                                                        __auto_type func_entry = _mv_365.value;
                                                        {
                                                            __auto_type ret_type = func_entry.return_type;
                                                            if (func_entry.returns_string) {
                                                                return SLOP_STR("slop_string");
...
slop_string expr_build_result_match_expr(context_TranspileContext* ctx, types_SExpr* scrutinee, slop_string scrutinee_c, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 2;
        while ((i < len)) {
            __auto_type _mv_366 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_366.has_value) {
                __auto_type branch = _mv_366.value;
                __auto_type _mv_367 = (*branch);
                switch (_mv_367.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type branch_lst = _mv_367.data.lst;
                        {
                            __auto_type branch_items = branch_lst.items;
                            if ((((int64_t)((branch_items).len)) >= 2)) {
                                __auto_type _mv_368 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_368.has_value) {
                                    __auto_type pattern = _mv_368.value;
                                    {
                                        __auto_type tag = expr_get_expr_pattern_tag(pattern);
                                        if (string_eq(tag, SLOP_STR("ok"))) {
                                            __auto_type _mv_369 = expr_get_expr_binding_name(pattern);
                                            if (_mv_369.has_value) {
                                                __auto_type name = _mv_369.value;
                                                ok_binding = name;
                                            ...
                                            __auto_type _mv_370 = expr_get_expr_binding_name(pattern);
                                            if (_mv_370.has_value) {
                                                __auto_type name = _mv_370.value;
                                                err_binding = name;
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while ((i < len)) {
            ...
            if (_mv_371.has_value) {
                __auto_type branch = _mv_371.value;
                __auto_type _mv_372 = (*branch);
                switch (_mv_372.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type branch_lst = _mv_372.data.lst;
                        {
                            __auto_type branch_items = branch_lst.items;
                            if ((((int64_t)((branch_items).len)) >= 2)) {
                                __auto_type _mv_373 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_373.has_value) {
                                    __auto_type pattern = _mv_373.value;
        ...
        switch (_mv_374.tag) {
            case types_SExpr_sym:
            {
                __auto_type sym = _mv_374.data.sym;
                {
                    ...
                    __auto_type _mv_375 = context_ctx_lookup_func(ctx, slop_name);
                    if (_mv_375.has_value) {
                        __auto_type func_entry = _mv_375.value;
                        {
        ...
        if (context_ctx_skip_trampoline_generation(ctx)) {
            ...
            if (context_ctx_has_trampoline(ctx, fn_c_name)) {
            ...
            } else {
                {
                    ...
                    int64_t i = 0;
                    while ((i < count)) {
                        __auto_type _mv_376 = ({ __auto_type _lst = param_types; size_t _idx = (size_t)i; slop_option_context_FuncParamType_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_376.has_value) {
                            __auto_type param_type_ptr = _mv_376.value;
                            {
...
slop_string expr_build_union_case_expr(context_TranspileContext* ctx, slop_arena* arena, slop_string cases, types_SExpr* scrutinee, types_SExpr* pattern, slop_list_types_SExpr_ptr branch_items, slop_string result_type) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((string_eq(tag, SLOP_STR("else")) || string_eq(tag, SLOP_STR("_")))) {
            ...
            __auto_type _mv_377 = context_ctx_lookup_enum_variant(ctx, tag);
            if (_mv_377.has_value) {
                __auto_type type_name = _mv_377.value;
                {
                    ...
                    __auto_type _mv_378 = binding_opt;
                    if (_mv_378.has_value) {
                        __auto_type binding_name = _mv_378.value;
                        {
...
slop_string expr_build_ternary_match_expr(context_TranspileContext* ctx, slop_string scrutinee_c, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = (len - 1);
        while ((i >= 2)) {
            __auto_type _mv_379 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_379.has_value) {
                __auto_type branch = _mv_379.value;
                ...
                switch (_mv_380.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type branch_lst = _mv_380.data.lst;
                        {
                            __auto_type branch_items = branch_lst.items;
                            if ((((int64_t)((branch_items).len)) >= 2)) {
                                __auto_type _mv_381 = ({ __auto_type _lst = branch_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_381.has_value) {
                                    __auto_type pattern = _mv_381.value;
                                    {
                                        __auto_type tag = expr_get_expr_pattern_tag(pattern);
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len < 3)) {
            ...
            if (_mv_382.has_value) {
                __auto_type bindings_expr = _mv_382.value;
                __auto_type _mv_383 = (*bindings_expr);
                switch (_mv_383.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type bindings_lst = _mv_383.data.lst;
                        context_ctx_push_scope(ctx);
                        {
                            __auto_type result = SLOP_STR("({ ");
                            ...
                            while ((bi < bindings_len)) {
                                __auto_type _mv_384 = ({ __auto_type _lst = bindings_items; size_t _idx = (size_t)bi; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_384.has_value) {
                                    __auto_type binding = _mv_384.value;
                            ...
                            bi = 0;
                            while ((bi < bindings_len)) {
                                __auto_type _mv_385 = ({ __auto_type _lst = bindings_items; size_t _idx = (size_t)bi; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_385.has_value) {
                                    __auto_type binding = _mv_385.value;
                                    {
                            ...
                            }
                            {
                                __auto_type i = 2;
                                while ((i < (len - 1))) {
                                    __auto_type _mv_386 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    if (_mv_386.has_value) {
                                        __auto_type body_expr = _mv_386.value;
                                        {
                                            __auto_type body_c = expr_transpile_expr(ctx, body_expr);
                    ...
                    if ((len >= 2)) {
                        {
                            ...
                            __auto_type _mv_388 = ({ __auto_type _lst = items; size_t _idx = (size_t)name_idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_388.has_value) {
                                __auto_type name_expr = _mv_388.value;
                                __auto_type _mv_389 = (*name_expr);
                                switch (_mv_389.tag) {
                                    case types_SExpr_sym:
                                    {
                                        __auto_type name_sym = _mv_389.data.sym;
                                        {
                                ...
                                switch (_mv_392.tag) {
                                    case types_SExpr_sym:
                                    {
                                        __auto_type name_sym = _mv_392.data.sym;
                                        {
                                            ...
                                            __auto_type init_idx = ((has_mut) ? ((has_type) ? 3 : 2) : ((has_type) ? 2 : 1));
                                            if (has_type) {
                                                __auto_type _mv_393 = ({ __auto_type _lst = items; size_t _idx = (size_t)type_idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_393.has_value) {
                                                    __auto_type type_expr = _mv_393.value;
                                                    {
                                                        __auto_type c_type = context_to_c_type_prefixed(ctx, type_expr);
                                                        __auto_type _mv_394 = ({ __auto_type _lst = items; size_t _idx = (size_t)init_idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                        if (_mv_394.has_value) {
                                                            __auto_type init_expr = _mv_394.value;
                                                            {
                                                    ...
                                                    __auto_type _mv_395 = ({ __auto_type _lst = items; size_t _idx = (size_t)init_idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_395.has_value) {
                                                        __auto_type init_expr = _mv_395.value;
                                                        {
                                                ...
                                                __auto_type _mv_396 = ({ __auto_type _lst = items; size_t _idx = (size_t)init_idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_396.has_value) {
                                                    __auto_type init_expr = _mv_396.value;
                                                    {
                                                        __auto_type init_c = expr_transpile_expr(ctx, init_expr);
                                                        return context_ctx_str5(ctx, SLOP_STR("__auto_type "), var_name, SLOP_STR(" = "), init_c, SLOP_STR(";"));
                                                    }
...
uint8_t expr_binding_has_mut(slop_list_types_SExpr_ptr items) {
    if ((((int64_t)((items).len)) < 1)) {
        ...
        __auto_type _mv_397 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        if (_mv_397.has_value) {
            __auto_type first = _mv_397.value;
            __auto_type _mv_398 = (*first);
            switch (_mv_398.tag) {
                case types_SExpr_sym:
                {
                    __auto_type sym = _mv_398.data.sym;
...
slop_string expr_transpile_typed_init(context_TranspileContext* ctx, types_SExpr* init_expr, slop_string target_type) {
    ...
    __auto_type _mv_399 = (*init_expr);
    switch (_mv_399.tag) {
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_399.data.lst;
            {
                __auto_type items = lst.items;
                if ((((int64_t)((items).len)) < 1)) {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len < 3)) {
            ...
            if (_mv_403.has_value) {
                __auto_type cond_expr = _mv_403.value;
                {
                    __auto_type cond_c = expr_transpile_expr(ctx, cond_expr);
                    __auto_type body_str = SLOP_STR("");
                    {
                        __auto_type i = 2;
                        while ((i < len)) {
                            __auto_type _mv_404 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        } else {
            {
                ...
                while ((i < len)) {
                    ...
                    if (_mv_405.has_value) {
                        __auto_type expr = _mv_405.value;
                        {
...
slop_string expr_transpile_set_expr(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len < 3)) {
            ...
            __auto_type _mv_408 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_408.has_value) {
                __auto_type target_expr = _mv_408.value;
                __auto_type _mv_409 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_409.has_value) {
                    __auto_type val_expr = _mv_409.value;
                    {
                        __auto_type val_c = expr_transpile_expr(ctx, val_expr);
                        __auto_type _mv_410 = (*target_expr);
                        switch (_mv_410.tag) {
                            case types_SExpr_lst:
                            {
                                __auto_type target_lst = _mv_410.data.lst;
                                {
                                    ...
                                    if ((((int64_t)((target_items).len)) < 1)) {
                                        ...
                                        __auto_type _mv_411 = ({ __auto_type _lst = target_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    ...
                                                    __auto_type sym = _mv_412.data.sym;
                                                    {
                                                        ...
                                                        if (string_eq(op, SLOP_STR("@"))) {
                                                            if ((((int64_t)((target_items).len)) < 3)) {
                                                                ...
                                                                __auto_type _mv_413 = ({ __auto_type _lst = target_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                                if (_mv_413.has_value) {
                                                                    __auto_type arr_expr = _mv_413.value;
                                                                    __auto_type _mv_414 = ({ __auto_type _lst = target_items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            ...
                            case types_SExpr_sym:
                            {
                                __auto_type sym = _mv_410.data.sym;
                                {
...
slop_string expr_get_arena_for_list_push_expr(context_TranspileContext* ctx, types_SExpr* list_expr, slop_string list_c) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    SLOP_PRE(((list_expr != NULL)), "(!= list-expr nil)");
    __auto_type _mv_415 = context_ctx_lookup_var(ctx, SLOP_STR("arena"));
    if (_mv_415.has_value) {
        __auto_type arena_var = _mv_415.value;
        return arena_var.c_name;
    } else if (!_mv_415.has_value) {
        __auto_type _mv_416 = context_ctx_lookup_var(ctx, SLOP_STR("ctx"));
        if (_mv_416.has_value) {
            __auto_type ctx_var = _mv_416.value;
...
slop_string expr_get_arena_from_field_access(context_TranspileContext* ctx, types_SExpr* expr) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    SLOP_PRE(((expr != NULL)), "(!= expr nil)");
    __auto_type _mv_417 = (*expr);
    switch (_mv_417.tag) {
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_417.data.lst;
            {
                __auto_type items = lst.items;
                __auto_type len = ((int64_t)((items).len));
                if ((len < 3)) {
                    ...
                    __auto_type _mv_418 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_418.has_value) {
                        __auto_type head_expr = _mv_418.value;
                        __auto_type _mv_419 = (*head_expr);
                        switch (_mv_419.tag) {
                            case types_SExpr_sym:
                            {
                                __auto_type sym = _mv_419.data.sym;
                                if (string_eq(sym.name, SLOP_STR("."))) {
                                    __auto_type _mv_420 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    if (_mv_420.has_value) {
                                        __auto_type base_expr = _mv_420.value;
...
slop_string expr_get_arena_from_base(context_TranspileContext* ctx, types_SExpr* base_expr) {
    ...
    __auto_type _mv_421 = (*base_expr);
    switch (_mv_421.tag) {
        case types_SExpr_sym:
        {
            __auto_type sym = _mv_421.data.sym;
            {
                __auto_type var_name = sym.name;
                __auto_type _mv_422 = context_ctx_lookup_var(ctx, var_name);
                if (_mv_422.has_value) {
                    __auto_type entry = _mv_422.value;
                    if (entry.is_pointer) {
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_421.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 2)) {
                    ...
                    __auto_type _mv_423 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_423.has_value) {
                        __auto_type head_expr = _mv_423.value;
                        __auto_type _mv_424 = (*head_expr);
                        switch (_mv_424.tag) {
                            case types_SExpr_sym:
                            {
                                __auto_type sym = _mv_424.data.sym;
                                if (string_eq(sym.name, SLOP_STR("deref"))) {
                                    __auto_type _mv_425 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    if (_mv_425.has_value) {
                                        __auto_type ptr_expr = _mv_425.value;
                                        {
...
uint8_t expr_is_ptr_to_ptr_map(context_TranspileContext* ctx, types_SExpr* expr) {
    ...
    switch (_mv_426.tag) {
        case types_SExpr_sym:
        {
            ...
            {
                __auto_type name = sym.name;
                __auto_type _mv_427 = context_ctx_lookup_var(ctx, name);
                if (_mv_427.has_value) {
                    __auto_type entry = _mv_427.value;
                    {
                        __auto_type c_type = entry.c_type;
                        return strlib_ends_with(c_type, SLOP_STR("**"));
                    }
...
slop_string expr_transpile_record_new(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len < 2)) {
            ...
            __auto_type _mv_428 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_428.has_value) {
                __auto_type type_expr = _mv_428.value;
                __auto_type _mv_429 = (*type_expr);
                switch (_mv_429.tag) {
                    case types_SExpr_sym:
                    {
                        __auto_type type_sym = _mv_429.data.sym;
                        {
                            __auto_type raw_type_name = type_sym.name;
                    ...
                    case types_SExpr_lst:
                    {
                        __auto_type type_lst = _mv_429.data.lst;
                        {
                            ...
                            if ((((int64_t)((type_items).len)) < 1)) {
                                ...
                                __auto_type _mv_430 = ({ __auto_type _lst = type_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_430.has_value) {
                                    __auto_type head = _mv_430.value;
                                    __auto_type _mv_431 = (*head);
                                    switch (_mv_431.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type head_sym = _mv_431.data.sym;
...
slop_string expr_transpile_record_fields(context_TranspileContext* ctx, slop_string type_name, slop_list_types_SExpr_ptr items, int64_t start_idx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        uint8_t first = 1;
        while ((i < len)) {
            __auto_type _mv_432 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_432.has_value) {
                ...
                switch (_mv_433.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type field_lst = _mv_433.data.lst;
                        {
                            __auto_type field_items = field_lst.items;
                            if ((((int64_t)((field_items).len)) >= 2)) {
                                __auto_type _mv_434 = ({ __auto_type _lst = field_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_434.has_value) {
                                    __auto_type name_expr = _mv_434.value;
                                    __auto_type _mv_435 = (*name_expr);
                                    switch (_mv_435.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type name_sym = _mv_435.data.sym;
                                            __auto_type _mv_436 = ({ __auto_type _lst = field_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_436.has_value) {
                                                __auto_type val_expr = _mv_436.value;
                                                {
...
slop_string expr_build_inline_struct_type(context_TranspileContext* ctx, slop_list_types_SExpr_ptr type_items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 1;
        while ((i < len)) {
            __auto_type _mv_437 = ({ __auto_type _lst = type_items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_437.has_value) {
                __auto_type field_expr = _mv_437.value;
                __auto_type _mv_438 = (*field_expr);
                switch (_mv_438.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type field_lst = _mv_438.data.lst;
                        {
                            __auto_type field_items = field_lst.items;
                            if ((((int64_t)((field_items).len)) >= 2)) {
                                __auto_type _mv_439 = ({ __auto_type _lst = field_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_439.has_value) {
                                    __auto_type name_expr = _mv_439.value;
                                    __auto_type _mv_440 = (*name_expr);
                                    switch (_mv_440.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type name_sym = _mv_440.data.sym;
                                            __auto_type _mv_441 = ({ __auto_type _lst = field_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_441.has_value) {
                                                __auto_type type_expr = _mv_441.value;
                                                {
...
slop_string expr_transpile_inline_record_fields(context_TranspileContext* ctx, slop_string struct_def, slop_list_types_SExpr_ptr items, int64_t start_idx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        uint8_t first = 1;
        while ((i < len)) {
            __auto_type _mv_442 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_442.has_value) {
                ...
                switch (_mv_443.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type field_lst = _mv_443.data.lst;
                        {
                            __auto_type field_items = field_lst.items;
                            if ((((int64_t)((field_items).len)) >= 2)) {
                                __auto_type _mv_444 = ({ __auto_type _lst = field_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_444.has_value) {
                                    __auto_type name_expr = _mv_444.value;
                                    __auto_type _mv_445 = (*name_expr);
                                    switch (_mv_445.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type name_sym = _mv_445.data.sym;
                                            __auto_type _mv_446 = ({ __auto_type _lst = field_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len < 2)) {
            ...
            if (_mv_447.has_value) {
                __auto_type type_expr = _mv_447.value;
                {
                    ...
                    __auto_type elem_count = (len - 2);
                    {
                        ...
                        __auto_type first = 1;
                        while ((i < len)) {
                            __auto_type _mv_448 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_448.has_value) {
                                __auto_type elem_expr = _mv_448.value;
                                {
...
slop_string expr_get_map_key_c_info(context_TranspileContext* ctx, types_SExpr* key_type_expr) {
    ...
    __auto_type _mv_449 = (*key_type_expr);
    switch (_mv_449.tag) {
        case types_SExpr_sym:
        {
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_449.data.lst;
            {
                __auto_type items = lst.items;
                if ((((int64_t)((items).len)) < 1)) {
                    return SLOP_STR("sizeof(void*), slop_hash_ptr, slop_eq_ptr");
                } else {
                    __auto_type _mv_450 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_450.has_value) {
                        __auto_type head = _mv_450.value;
                        __auto_type _mv_451 = (*head);
                        switch (_mv_451.tag) {
                            case types_SExpr_sym:
                            {
                                __auto_type sym = _mv_451.data.sym;
                                {
...
slop_string expr_get_struct_key_info_by_name(context_TranspileContext* ctx, slop_string name) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    __auto_type _mv_452 = context_ctx_lookup_type(ctx, name);
    if (_mv_452.has_value) {
        __auto_type type_entry = _mv_452.value;
        {
            __auto_type c_name = type_entry.c_name;
            context_ctx_register_struct_key_type(ctx, c_name);
            return expr_build_struct_key_info(ctx, c_name);
        ...
        __auto_type _mv_453 = context_ctx_get_module(ctx);
        if (_mv_453.has_value) {
            __auto_type mod = _mv_453.value;
            {
                __auto_type prefixed = context_ctx_str3(ctx, mod, SLOP_STR("_"), name);
                __auto_type _mv_454 = context_ctx_lookup_type(ctx, prefixed);
                if (_mv_454.has_value) {
                    __auto_type type_entry = _mv_454.value;
                    {
                        __auto_type c_name = type_entry.c_name;
                        context_ctx_register_struct_key_type(ctx, c_name);
                        return expr_build_struct_key_info(ctx, c_name);
        ...
        if ((len < 3)) {
            if ((len < 2)) {
                ...
                if (_mv_455.has_value) {
                    __auto_type arena_expr = _mv_455.value;
                    {
                        __auto_type arena_c = expr_transpile_expr(ctx, arena_expr);
            ...
            __auto_type _mv_456 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_456.has_value) {
                __auto_type arena_expr = _mv_456.value;
                __auto_type _mv_457 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_457.has_value) {
                    __auto_type key_type_expr = _mv_457.value;
                    {
                        __auto_type arena_c = expr_transpile_expr(ctx, arena_expr);
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len < 4)) {
            ...
            if (_mv_458.has_value) {
                __auto_type map_expr = _mv_458.value;
                __auto_type _mv_459 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_459.has_value) {
                    __auto_type key_expr = _mv_459.value;
                    __auto_type _mv_460 = ({ __auto_type _lst = items; size_t _idx = (size_t)3; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len < 3)) {
            ...
            if (_mv_461.has_value) {
                __auto_type map_expr = _mv_461.value;
                __auto_type _mv_462 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_462.has_value) {
                    __auto_type key_expr = _mv_462.value;
                    {
                        __auto_type map_c = expr_transpile_expr(ctx, map_expr);
                        __auto_type key_c = expr_transpile_expr(ctx, key_expr);
                        __auto_type key_ptr = expr_wrap_map_key_as_ptr(ctx, key_c, key_expr, map_expr);
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len < 3)) {
            ...
            if (_mv_463.has_value) {
                __auto_type map_expr = _mv_463.value;
                ...
                if (_mv_464.has_value) {
                    __auto_type key_expr = _mv_464.value;
                    {
                        __auto_type map_c = expr_transpile_expr(ctx, map_expr);
                        __auto_type key_c = expr_transpile_expr(ctx, key_expr);
                        __auto_type key_ptr = expr_wrap_map_key_as_ptr(ctx, key_c, key_expr, map_expr);
...
slop_string expr_transpile_set_new(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len < 3)) {
            ...
            __auto_type _mv_466 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_466.has_value) {
                __auto_type arena_expr = _mv_466.value;
                __auto_type _mv_467 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_467.has_value) {
                    __auto_type elem_type_expr = _mv_467.value;
                    {
                        __auto_type arena_c = expr_transpile_expr(ctx, arena_expr);
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len < 3)) {
            ...
            if (_mv_468.has_value) {
                __auto_type set_expr = _mv_468.value;
                ...
                if (_mv_469.has_value) {
                    __auto_type elem_expr = _mv_469.value;
                    {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len < 3)) {
            ...
            if (_mv_470.has_value) {
                __auto_type set_expr = _mv_470.value;
                ...
                if (_mv_471.has_value) {
                    __auto_type elem_expr = _mv_471.value;
                    {
                        __auto_type set_c = expr_transpile_expr(ctx, set_expr);
                        __auto_type elem_c = expr_transpile_expr(ctx, elem_expr);
                        __auto_type elem_ptr = expr_wrap_map_key_as_ptr(ctx, elem_c, elem_expr, set_expr);
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len < 3)) {
            ...
            if (_mv_472.has_value) {
                __auto_type set_expr = _mv_472.value;
                ...
                if (_mv_473.has_value) {
                    __auto_type elem_expr = _mv_473.value;
                    {
                        __auto_type set_c = expr_transpile_expr(ctx, set_expr);
                        __auto_type elem_c = expr_transpile_expr(ctx, elem_expr);
                        __auto_type elem_ptr = expr_wrap_map_key_as_ptr(ctx, elem_c, elem_expr, set_expr);
...
slop_string expr_transpile_set_elements(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len < 2)) {
            ...
            __auto_type _mv_474 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_474.has_value) {
                __auto_type set_expr = _mv_474.value;
                {
                    __auto_type set_c = expr_transpile_expr(ctx, set_expr);
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len < 2)) {
            ...
            if (_mv_475.has_value) {
                __auto_type type_expr = _mv_475.value;
                {
                    ...
                    __auto_type result = context_ctx_str(ctx, SLOP_STR("({ slop_map* _s = slop_map_new_ptr(arena, "), context_ctx_str(ctx, int_to_string(arena, init_cap), context_ctx_str(ctx, SLOP_STR(", "), context_ctx_str(ctx, elem_info, SLOP_STR("); ")))));
                    {
                        __auto_type i = 2;
                        while ((i < len)) {
                            __auto_type _mv_476 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        if ((len < 2)) {
            ...
            if (_mv_477.has_value) {
                ...
                switch (_mv_478.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type binding_lst = _mv_478.data.lst;
                        {
                            ...
                            if ((binding_len < 3)) {
                                ...
                                __auto_type _mv_479 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_479.has_value) {
                                    __auto_type var_expr = _mv_479.value;
                                    __auto_type _mv_480 = (*var_expr);
                                    switch (_mv_480.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type var_sym = _mv_480.data.sym;
                                            {
                                                __auto_type var_name = ctype_to_c_name(arena, var_sym.name);
                                                __auto_type _mv_481 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_481.has_value) {
                                                    __auto_type start_expr = _mv_481.value;
                                                    __auto_type _mv_482 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_482.has_value) {
                                                        __auto_type end_expr = _mv_482.value;
                                                        {
                                                            ...
                                                            context_ctx_bind_var(ctx, (context_VarEntry){var_sym.name, var_name, SLOP_STR("int64_t"), SLOP_STR(""), 0, 0, 0, SLOP_STR(""), SLOP_STR("")});
                                                            {
                                                                ...
                                                                while ((i < len)) {
                                                                    ...
                                                                    if (_mv_483.has_value) {
                                                                        __auto_type body_expr = _mv_483.value;
                                                                        {
                                                                            __auto_type body_c = expr_transpile_expr(ctx, body_expr);
                                                                            result = context_ctx_str3(ctx, result, body_c, SLOP_STR("; "));
                                                                        }
                        ...
                        __auto_type binding_lst = _mv_485.data.lst;
                        {
                            ...
                            if ((binding_len < 2)) {
                                ...
                                if (_mv_486.has_value) {
                                    __auto_type first_elem = _mv_486.value;
                                    __auto_type _mv_487 = (*first_elem);
                                    switch (_mv_487.tag) {
                                        case types_SExpr_lst:
                                        {
                                            __auto_type _ = _mv_487.data.lst;
                                        ...
                                        case types_SExpr_sym:
                                        {
                                            __auto_type var_sym = _mv_487.data.sym;
                                            {
                                                ...
                                                if (_mv_488.has_value) {
                                                    __auto_type coll_expr = _mv_488.value;
                                                    {
...
slop_string expr_transpile_for_each_list_as_expr(context_TranspileContext* ctx, slop_string var_name, types_SExprSymbol var_sym, types_SExpr* coll_expr, slop_list_types_SExpr_ptr items, int64_t len) {
    ...
    SLOP_PRE(((coll_expr != NULL)), "(!= coll-expr nil)");
    {
        ...
        context_ctx_bind_var(ctx, (context_VarEntry){var_sym.name, var_name, SLOP_STR("auto"), elem_slop_type, 0, 0, 0, SLOP_STR(""), SLOP_STR("")});
        {
            int64_t i = 2;
            while ((i < len)) {
                __auto_type _mv_489 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    ...
    SLOP_PRE(((coll_expr != NULL)), "(!= coll-expr nil)");
    {
        ...
        __auto_type key_c_type = expr_slop_value_type_to_c_type(ctx, key_slop_type);
        {
            ...
            context_ctx_bind_var(ctx, (context_VarEntry){var_sym.name, var_name, key_c_type, key_slop_type, 0, 0, 0, SLOP_STR(""), SLOP_STR("")});
            {
                int64_t i = 2;
                while ((i < len)) {
                    __auto_type _mv_491 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_string expr_transpile_for_each_map_kv_as_expr(context_TranspileContext* ctx, slop_list_types_SExpr_ptr binding_items, slop_list_types_SExpr_ptr items, int64_t len) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_492 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        if (_mv_492.has_value) {
            __auto_type kv_list_expr = _mv_492.value;
            __auto_type _mv_493 = (*kv_list_expr);
            switch (_mv_493.tag) {
                case types_SExpr_lst:
                {
                    __auto_type kv_lst = _mv_493.data.lst;
                    {
                        __auto_type kv_items = kv_lst.items;
                        if ((((int64_t)((kv_items).len)) < 2)) {
                            return SLOP_STR("({ /* for-each: map binding needs ((k v) map) */ 0; })");
                        } else {
                            __auto_type _mv_494 = ({ __auto_type _lst = kv_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_494.has_value) {
                                __auto_type k_expr = _mv_494.value;
                                __auto_type _mv_495 = ({ __auto_type _lst = kv_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_495.has_value) {
                                    __auto_type v_expr = _mv_495.value;
                                    __auto_type _mv_496 = ({ __auto_type _lst = binding_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    if (_mv_496.has_value) {
                                        __auto_type map_expr = _mv_496.value;
                                        __auto_type _mv_497 = (*k_expr);
                                        switch (_mv_497.tag) {
                                            case types_SExpr_sym:
                                            {
                                                __auto_type k_sym = _mv_497.data.sym;
                                                __auto_type _mv_498 = (*v_expr);
                                                switch (_mv_498.tag) {
                                                    case types_SExpr_sym:
                                                    {
                                                        __auto_type v_sym = _mv_498.data.sym;
                                                        {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len < 2)) {
            ...
            if (_mv_500.has_value) {
                __auto_type second = _mv_500.value;
                __auto_type _mv_501 = (*second);
                switch (_mv_501.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type params_lst = _mv_501.data.lst;
                        return expr_transpile_lambda_with_params(ctx, items, params_lst.items);
                    }
                    case types_SExpr_sym:
                    {
                        __auto_type _ = _mv_501.data.sym;
...
slop_list_string expr_extract_param_names(slop_arena* arena, slop_list_types_SExpr_ptr params) {
    {
        ...
        int64_t i = 0;
        while ((i < count)) {
            __auto_type _mv_502 = ({ __auto_type _lst = params; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_502.has_value) {
                __auto_type param_expr = _mv_502.value;
                __auto_type _mv_503 = (*param_expr);
                switch (_mv_503.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type param_lst = _mv_503.data.lst;
                        {
                            __auto_type param_items = param_lst.items;
                            if ((((int64_t)((param_items).len)) >= 1)) {
                                __auto_type _mv_504 = ({ __auto_type _lst = param_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_string expr_build_closure_struct(context_TranspileContext* ctx, slop_string env_type, slop_list_string free_vars) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < count)) {
            __auto_type _mv_506 = ({ __auto_type _lst = free_vars; size_t _idx = (size_t)i; slop_option_string _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_506.has_value) {
                __auto_type var_name = _mv_506.value;
                {
...
void expr_bind_closure_captures(context_TranspileContext* ctx, slop_list_string free_vars) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < count)) {
            __auto_type _mv_507 = ({ __auto_type _lst = free_vars; size_t _idx = (size_t)i; slop_option_string _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_507.has_value) {
                __auto_type var_name = _mv_507.value;
                {
                    __auto_type c_name = ctype_to_c_name(arena, var_name);
                    __auto_type var_info = context_ctx_lookup_var(ctx, var_name);
                    __auto_type is_mut = ({ __auto_type _mv = var_info; _mv.has_value ? ({ __auto_type entry = _mv.value; entry.is_mutable; }) : (0); });
...
slop_list_string expr_capture_free_var_accesses(context_TranspileContext* ctx, slop_list_string free_vars) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < count)) {
            __auto_type _mv_508 = ({ __auto_type _lst = free_vars; size_t _idx = (size_t)i; slop_option_string _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_508.has_value) {
                __auto_type var_name = _mv_508.value;
                {
                    __auto_type c_name = ctype_to_c_name(arena, var_name);
                    __auto_type var_info = context_ctx_lookup_var(ctx, var_name);
...
slop_string expr_find_arena_ptr_expr(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    __auto_type _mv_509 = context_ctx_lookup_var(ctx, SLOP_STR("_arena"));
    if (_mv_509.has_value) {
        __auto_type entry = _mv_509.value;
        return SLOP_STR("&_arena");
    } else if (!_mv_509.has_value) {
        __auto_type _mv_510 = context_ctx_lookup_var(ctx, SLOP_STR("arena"));
        if (_mv_510.has_value) {
            __auto_type entry = _mv_510.value;
            return entry.c_name;
...
slop_string expr_build_env_initializer(context_TranspileContext* ctx, slop_list_string free_vars, slop_list_string captured_accesses) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < count)) {
            __auto_type _mv_511 = ({ __auto_type _lst = free_vars; size_t _idx = (size_t)i; slop_option_string _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_511.has_value) {
                __auto_type var_name = _mv_511.value;
                {
                    __auto_type c_name = ctype_to_c_name(arena, var_name);
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((param_count == 0)) {
        ...
        } else {
            {
                ...
                int64_t i = 0;
                while ((i < param_count)) {
                    __auto_type _mv_512 = ({ __auto_type _lst = params; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_512.has_value) {
                        __auto_type param_expr = _mv_512.value;
                        __auto_type _mv_513 = (*param_expr);
                        switch (_mv_513.tag) {
                            case types_SExpr_lst:
                            {
                                __auto_type param_lst = _mv_513.data.lst;
                                {
                                    __auto_type param_items = param_lst.items;
                                    if ((((int64_t)((param_items).len)) >= 2)) {
                                        __auto_type _mv_514 = ({ __auto_type _lst = param_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_514.has_value) {
                                            __auto_type name_expr = _mv_514.value;
                                            __auto_type _mv_515 = (*name_expr);
                                            switch (_mv_515.tag) {
                                                case types_SExpr_sym:
                                                {
                                                    __auto_type name_sym = _mv_515.data.sym;
                                                    __auto_type _mv_516 = ({ __auto_type _lst = param_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_516.has_value) {
                                                        __auto_type type_expr = _mv_516.value;
                                                        {
...
void expr_bind_lambda_params(context_TranspileContext* ctx, slop_list_types_SExpr_ptr params) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < param_count)) {
            __auto_type _mv_517 = ({ __auto_type _lst = params; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_517.has_value) {
                __auto_type param_expr = _mv_517.value;
                __auto_type _mv_518 = (*param_expr);
                switch (_mv_518.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type param_lst = _mv_518.data.lst;
                        {
                            __auto_type param_items = param_lst.items;
                            if ((((int64_t)((param_items).len)) >= 2)) {
                                __auto_type _mv_519 = ({ __auto_type _lst = param_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_519.has_value) {
                                    __auto_type name_expr = _mv_519.value;
                                    __auto_type _mv_520 = (*name_expr);
                                    switch (_mv_520.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type name_sym = _mv_520.data.sym;
                                            __auto_type _mv_521 = ({ __auto_type _lst = param_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
uint8_t expr_is_pointer_type_sexpr(types_SExpr* type_expr) {
    __auto_type _mv_522 = (*type_expr);
    switch (_mv_522.tag) {
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_522.data.lst;
            {
                __auto_type items = lst.items;
                if ((((int64_t)((items).len)) < 1)) {
                    return 0;
                } else {
                    __auto_type _mv_523 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_523.has_value) {
                        __auto_type head = _mv_523.value;
                        __auto_type _mv_524 = (*head);
                        switch (_mv_524.tag) {
                            case types_SExpr_sym:
                            {
                                __auto_type sym = _mv_524.data.sym;
                                return (string_eq(sym.name, SLOP_STR("Ptr")) || string_eq(sym.name, SLOP_STR("ScopedPtr")));
                            }
                            default: {
                                return 0;
...
slop_string expr_transpile_lambda_body(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items, int64_t start, slop_string return_type) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len <= start)) {
            ...
            while ((i < len)) {
                __auto_type _mv_525 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_525.has_value) {
                    __auto_type expr = _mv_525.value;
                    {
                        __auto_type expr_c = expr_transpile_expr(ctx, expr);
                        __auto_type is_last = (i == (len - 1));
                        if (is_last) {
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_526.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 2)) {
                    ...
                    __auto_type _mv_527 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            ...
                            case types_SExpr_sym:
                            {
                                ...
                                if (!(string_eq(sym.name, SLOP_STR("fn")))) {
                                    ...
                                    if (_mv_529.has_value) {
                                        __auto_type second = _mv_529.value;
                                        __auto_type _mv_530 = (*second);
                                        switch (_mv_530.tag) {
                                            case types_SExpr_lst:
                                            {
                                                __auto_type _ = _mv_530.data.lst;
                                                return 1;
                                            }
                                            default: {
                                                return 0;
...
slop_string expr_transpile_spawn_closure(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items, types_SExpr* fn_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_531 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        if (_mv_531.has_value) {
            __auto_type arena_expr = _mv_531.value;
            {
                __auto_type arena_c = expr_transpile_expr(ctx, arena_expr);
...
uint8_t expr_lambda_has_captures(context_TranspileContext* ctx, types_SExpr* fn_expr) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    SLOP_PRE(((fn_expr != NULL)), "(!= fn-expr nil)");
    __auto_type _mv_532 = (*fn_expr);
    switch (_mv_532.tag) {
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_532.data.lst;
            {
                __auto_type items = lst.items;
                __auto_type arena = (*ctx).arena;
                if ((((int64_t)((items).len)) < 2)) {
                    ...
                    __auto_type _mv_533 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_533.has_value) {
                        __auto_type params_expr = _mv_533.value;
                        __auto_type _mv_534 = (*params_expr);
                        switch (_mv_534.tag) {
                            case types_SExpr_lst:
                            {
                                __auto_type params_lst = _mv_534.data.lst;
                                {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((((int64_t)((items).len)) < 2)) {
            ...
            if (_mv_536.has_value) {
                __auto_type first_arg = _mv_536.value;
                {
...
slop_list_string expr_find_free_vars(context_TranspileContext* ctx, slop_list_string param_names, slop_list_types_SExpr_ptr body_items, int64_t start, slop_list_string pending) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = start;
        while ((i < len)) {
            __auto_type _mv_537 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_537.has_value) {
                __auto_type expr = _mv_537.value;
        ...
        }
        {
            ...
            int64_t j = 0;
            while ((j < sym_count)) {
                __auto_type _mv_538 = ({ __auto_type _lst = all_symbols; size_t _idx = (size_t)j; slop_option_string _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_538.has_value) {
                    __auto_type sym_name = _mv_538.value;
                ...
                if ((len > 0)) {
                    ...
                    if (_mv_540.has_value) {
                        ...
                        switch (_mv_541.tag) {
                            case types_SExpr_sym:
                            {
                                __auto_type head_sym = _mv_541.data.sym;
                                {
                                    __auto_type op = head_sym.name;
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while ((i < len)) {
            ...
            if (_mv_542.has_value) {
                __auto_type item = _mv_542.value;
        ...
        if ((len >= 2)) {
            ...
            if (_mv_543.has_value) {
                __auto_type bindings_expr = _mv_543.value;
                {
                    ...
                    __auto_type _mv_544 = (*bindings_expr);
                    switch (_mv_544.tag) {
                        case types_SExpr_lst:
                        {
                            __auto_type bindings_lst = _mv_544.data.lst;
                            {
                                __auto_type bindings = bindings_lst.items;
                                __auto_type binding_count = ((int64_t)((bindings).len));
                                __auto_type i = 0;
                                while ((i < binding_count)) {
                                    __auto_type _mv_545 = ({ __auto_type _lst = bindings; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    if (_mv_545.has_value) {
                                        __auto_type binding = _mv_545.value;
                                        __auto_type _mv_546 = (*binding);
                                        switch (_mv_546.tag) {
                                            case types_SExpr_lst:
                                            {
                                                __auto_type bind_lst = _mv_546.data.lst;
                                                {
                                                    __auto_type bind_items = bind_lst.items;
                                                    if ((((int64_t)((bind_items).len)) >= 2)) {
                                                        {
                                                            __auto_type val_idx = ((expr_is_mut_binding(bind_items)) ? 2 : 1);
                                                            __auto_type _mv_547 = ({ __auto_type _lst = bind_items; size_t _idx = (size_t)val_idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                            if (_mv_547.has_value) {
                                                                __auto_type val_expr = _mv_547.value;
...
uint8_t expr_is_mut_binding(slop_list_types_SExpr_ptr items) {
    if ((((int64_t)((items).len)) < 1)) {
        ...
        __auto_type _mv_548 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        if (_mv_548.has_value) {
            __auto_type first = _mv_548.value;
            __auto_type _mv_549 = (*first);
            switch (_mv_549.tag) {
                case types_SExpr_sym:
                {
                    __auto_type sym = _mv_549.data.sym;
                    return string_eq(sym.name, SLOP_STR("mut"));
                }
                default: {
                    return 0;
...
slop_list_string expr_extract_let_binding_names(slop_arena* arena, types_SExpr* bindings_expr) {
    ...
    {
        __auto_type names = ((slop_list_string){ .data = (slop_string*)slop_arena_alloc(arena, 16 * sizeof(slop_string)), .len = 0, .cap = 16 });
        __auto_type _mv_550 = (*bindings_expr);
        switch (_mv_550.tag) {
            case types_SExpr_lst:
            {
                __auto_type bindings_lst = _mv_550.data.lst;
                {
                    __auto_type bindings = bindings_lst.items;
                    __auto_type binding_count = ((int64_t)((bindings).len));
                    __auto_type i = 0;
                    while ((i < binding_count)) {
                        __auto_type _mv_551 = ({ __auto_type _lst = bindings; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_551.has_value) {
                            __auto_type binding = _mv_551.value;
                            __auto_type _mv_552 = (*binding);
                            switch (_mv_552.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type bind_lst = _mv_552.data.lst;
                                    {
                                        __auto_type bind_items = bind_lst.items;
                                        if ((((int64_t)((bind_items).len)) >= 1)) {
                                            {
                                                __auto_type name_idx = ((expr_is_mut_binding(bind_items)) ? 1 : 0);
                                                __auto_type _mv_553 = ({ __auto_type _lst = bind_items; size_t _idx = (size_t)name_idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_553.has_value) {
                                                    ...
                                                    switch (_mv_554.tag) {
                                                        case types_SExpr_sym:
                                                        {
                                                            __auto_type sym = _mv_554.data.sym;
...
void expr_collect_symbols_in_match(context_TranspileContext* ctx, slop_list_string* symbols, slop_list_string pending, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        __auto_type len = ((int64_t)((items).len));
        if ((len >= 2)) {
            __auto_type _mv_555 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_555.has_value) {
                __auto_type scrutinee = _mv_555.value;
            ...
            }
            {
                ...
                while ((i < len)) {
                    ...
                    if (_mv_556.has_value) {
                        __auto_type clause = _mv_556.value;
                        __auto_type _mv_557 = (*clause);
                        switch (_mv_557.tag) {
                            case types_SExpr_lst:
                            {
                                __auto_type clause_lst = _mv_557.data.lst;
                                {
                                    __auto_type clause_items = clause_lst.items;
...
void expr_collect_symbols_in_for(context_TranspileContext* ctx, slop_list_string* symbols, slop_list_string pending, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        __auto_type len = ((int64_t)((items).len));
        if ((len >= 2)) {
            __auto_type _mv_558 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_list_string expr_extract_for_loop_var_pending(slop_arena* arena, slop_list_string pending, slop_list_types_SExpr_ptr bind_items) {
    if ((((int64_t)((bind_items).len)) < 1)) {
        ...
        __auto_type _mv_560 = ({ __auto_type _lst = bind_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        if (_mv_560.has_value) {
            __auto_type var_expr = _mv_560.value;
            __auto_type _mv_561 = (*var_expr);
            switch (_mv_561.tag) {
                case types_SExpr_sym:
                {
                    __auto_type var_sym = _mv_561.data.sym;
                    {
                        __auto_type result = ((slop_list_string){ .data = (slop_string*)slop_arena_alloc(arena, 16 * sizeof(slop_string)), .len = 0, .cap = 16 });
                        ...
                        __auto_type i = 0;
                        while ((i < plen)) {
                            __auto_type _mv_562 = ({ __auto_type _lst = pending; size_t _idx = (size_t)i; slop_option_string _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_562.has_value) {
                                __auto_type s = _mv_562.value;
        ...
        if ((len >= 3)) {
            {
                ...
                __auto_type size_idx = ((is_named) ? 3 : 1);
                __auto_type body_start = ((is_named) ? 4 : 2);
                __auto_type _mv_563 = ({ __auto_type _lst = items; size_t _idx = (size_t)size_idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_563.has_value) {
                    __auto_type size_expr = _mv_563.value;
...
void expr_collect_nested_lambda_free_vars(context_TranspileContext* ctx, slop_list_string* symbols, slop_list_string pending, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        __auto_type len = ((int64_t)((items).len));
        if ((len >= 2)) {
            __auto_type _mv_564 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_564.has_value) {
                __auto_type params_expr = _mv_564.value;
                __auto_type _mv_565 = (*params_expr);
                switch (_mv_565.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type params_lst = _mv_565.data.lst;
                        {
                            __auto_type params = params_lst.items;
                            __auto_type param_names = expr_extract_param_names(arena, params);
    ...
    if (expr_list_contains_string(param_names, sym_name)) {
        ...
        if (expr_list_contains_string(pending, sym_name)) {
            ...
            if (expr_is_builtin_op(sym_name)) {
                ...
                __auto_type _mv_566 = context_ctx_lookup_func(ctx, sym_name);
                if (_mv_566.has_value) {
                    __auto_type _ = _mv_566.value;
                    return 0;
                } else if (!_mv_566.has_value) {
                    __auto_type _mv_567 = context_ctx_lookup_type(ctx, sym_name);
                    if (_mv_567.has_value) {
                        __auto_type _ = _mv_567.value;
                        return 0;
                    } else if (!_mv_567.has_value) {
                        __auto_type _mv_568 = context_ctx_lookup_var(ctx, sym_name);
                        if (_mv_568.has_value) {
                            __auto_type _ = _mv_568.value;
                            return 1;
...
uint8_t expr_list_contains_string(slop_list_string lst, slop_string needle) {
    {
        ...
        uint8_t found = 0;
        while (((i < len) && !(found))) {
            __auto_type _mv_569 = ({ __auto_type _lst = lst; size_t _idx = (size_t)i; slop_option_string _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_list_string expr_list_concat(slop_arena* arena, slop_list_string a, slop_list_string b) {
    {
        ...
        int64_t i = 0;
        while ((i < len_a)) {
            __auto_type _mv_570 = ({ __auto_type _lst = a; size_t _idx = (size_t)i; slop_option_string _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_570.has_value) {
                __auto_type s = _mv_570.value;
                ({ __auto_type _lst_p = &(result); __auto_type _item = (s); if (_lst_p->len >= _lst_p->cap) { size_t _new_cap = _lst_p->cap == 0 ? 16 : _lst_p->cap * 2; __typeof__(_lst_p->data) _new_data = (__typeof__(_lst_p->data))slop_arena_alloc(arena, _new_cap * sizeof(*_lst_p->data)); if (_lst_p->len > 0) memcpy(_new_data, _lst_p->data, _lst_p->len * sizeof(*_lst_p->data)); _lst_p->data = _new_data; _lst_p->cap = _new_cap; } _lst_p->data[_lst_p->len++] = _item; (void)0; });
        ...
        i = 0;
        while ((i < len_b)) {
            __auto_type _mv_571 = ({ __auto_type _lst = b; size_t _idx = (size_t)i; slop_option_string _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_571.has_value) {
                __auto_type s = _mv_571.value;
                ({ __auto_type _lst_p = &(result); __auto_type _item = (s); if (_lst_p->len >= _lst_p->cap) { size_t _new_cap = _lst_p->cap == 0 ? 16 : _lst_p->cap * 2; __typeof__(_lst_p->data) _new_data = (__typeof__(_lst_p->data))slop_arena_alloc(arena, _new_cap * sizeof(*_lst_p->data)); if (_lst_p->len > 0) memcpy(_new_data, _lst_p->data, _lst_p->len * sizeof(*_lst_p->data)); _lst_p->data = _new_data; _lst_p->cap = _new_cap; } _lst_p->data[_lst_p->len++] = _item; (void)0; });
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_572.data.lst;
                {
                    ...
                    if ((((int64_t)((items).len)) < 1)) {
                        ...
                        __auto_type _mv_573 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        ...
                                        if (string_eq(op, SLOP_STR("map-keys"))) {
                                            if ((((int64_t)((items).len)) < 2)) {
                                                ...
                                                if (_mv_575.has_value) {
                                                    __auto_type map_expr = _mv_575.value;
                                                    {
                                                        __auto_type map_slop_type = expr_infer_expr_slop_type(ctx, map_expr);
                                            ...
                                            if ((((int64_t)((items).len)) < 2)) {
                                                ...
                                                __auto_type _mv_576 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_576.has_value) {
                                                    __auto_type set_expr = _mv_576.value;
                                                    {
                                            ...
                                            if ((((int64_t)((items).len)) < 2)) {
                                                ...
                                                __auto_type _mv_577 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_577.has_value) {
                                                    __auto_type map_expr = _mv_577.value;
                                                    {
                                                        __auto_type map_slop_type = expr_infer_expr_slop_type(ctx, map_expr);
                                                        if ((string_len(map_slop_type) > 0)) {
                                                            {
