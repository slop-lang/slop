                    ...
                    case types_SExpr_lst:
                    {
                        __auto_type lst = _mv_1107.data.lst;
                        {
                            ...
                            if (((int64_t)((sub_items).len)) >= 1) {
                                __auto_type _mv_1108 = ({ __auto_type _lst = sub_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        ...
                                        case types_SExpr_sym:
                                        {
                                            ...
                                            if (string_eq(sym.name, SLOP_STR("@generic"))) {
                                                if (((int64_t)((sub_items).len)) >= 2) {
                                                    __auto_type _mv_1110 = ({ __auto_type _lst = sub_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                        ...
                                                        switch (_mv_1111.tag) {
                                                            case types_SExpr_lst:
                                                            {
                                                                __auto_type params_lst = _mv_1111.data.lst;
                                                                {
                                                                    ...
                                                                    __auto_type j = 0;
                                                                    while (j < param_len) {
                                                                        __auto_type _mv_1112 = ({ __auto_type _lst = param_items; size_t _idx = (size_t)j; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                                        if (_mv_1112.has_value) {
                                                                            __auto_type param = _mv_1112.value;
                                                                            __auto_type _mv_1113 = (*param);
                                                                            switch (_mv_1113.tag) {
                                                                                case types_SExpr_sym:
                                                                                {
                                                                                    __auto_type param_sym = _mv_1113.data.sym;
                                                            ...
                                                            case types_SExpr_sym:
                                                            {
                                                                __auto_type single_sym = _mv_1111.data.sym;
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1115.data.lst;
            {
                ...
                if (((int64_t)((items).len)) >= 1) {
                    __auto_type _mv_1116 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            ...
                            __auto_type c_name = ((context_ctx_prefixing_enabled(ctx)) ? ({ __auto_type _mv = context_ctx_get_module(ctx); _mv.has_value ? ({ __auto_type mod_name = _mv.value; context_ctx_str(ctx, ctype_to_c_name(arena, mod_name), context_ctx_str(ctx, SLOP_STR("_"), base_c_name)); }) : (base_c_name); }) : base_c_name);
                            {
                                ...
                                if (is_record || is_union) {
                                    if (((int64_t)((items).len)) >= 3) {
                                        ...
                                        if (_mv_1120.has_value) {
                                            __auto_type def_expr = _mv_1120.value;
                                            __auto_type _mv_1121 = (*def_expr);
                                            switch (_mv_1121.tag) {
                                                case types_SExpr_lst:
                                                {
                                ...
                                if (((int64_t)((items).len)) >= 3) {
                                    ...
                                    if (_mv_1122.has_value) {
                                        __auto_type body_expr = _mv_1122.value;
                                ...
                                switch (_mv_1126.tag) {
                                    ...
                                    case types_SExpr_lst:
                                    {
                                        ...
                                        if (((int64_t)((variant_lst.items).len)) > 0) {
                                            __auto_type _mv_1127 = ({ __auto_type _lst = variant_lst.items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                        ...
                                                        switch (_mv_1134.tag) {
                                                            case types_SExpr_sym:
                                                            {
                                                                __auto_type name_sym = _mv_1134.data.sym;
                                                                {
                                                                    ...
                                                                    context_ctx_register_enum_variant(ctx, variant_name, union_name);
                                                                    __auto_type _mv_1135 = ({ __auto_type _lst = vl_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                                    if (_mv_1135.has_value) {
                                                                        __auto_type type_expr = _mv_1135.value;
                                                                        {
                                                                    ...
                                                                    if (vl_len >= 3) {
                                                                        ...
                                                                        for (int64_t fi = 1; fi < vl_len; fi++) {
                                                                            __auto_type _mv_1136 = ({ __auto_type _lst = vl_items; size_t _idx = (size_t)fi; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                ...
                switch (_mv_1142.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type lst = _mv_1142.data.lst;
                        {
                            __auto_type sub_items = lst.items;
                            if (((int64_t)((sub_items).len)) >= 2) {
                                __auto_type _mv_1143 = ({ __auto_type _lst = sub_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    ...
                                    switch (_mv_1144.tag) {
                                        case types_SExpr_sym:
                                        {
                                            ...
                                            if (string_eq(sym.name, SLOP_STR("@spec"))) {
                                                __auto_type _mv_1145 = ({ __auto_type _lst = sub_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    ...
                                                    switch (_mv_1146.tag) {
                                                        case types_SExpr_lst:
                                                        {
                                                            __auto_type body_lst = _mv_1146.data.lst;
                                                            {
                                                                ...
                                                                if (body_len >= 1) {
                                                                    __auto_type _mv_1147 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)(body_len - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                ...
                switch (_mv_1150.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type lst = _mv_1150.data.lst;
                        {
                            __auto_type sub_items = lst.items;
                            if (((int64_t)((sub_items).len)) >= 2) {
                                __auto_type _mv_1151 = ({ __auto_type _lst = sub_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1151.has_value) {
                                    ...
                                    switch (_mv_1152.tag) {
                                        case types_SExpr_sym:
                                        {
                                            ...
                                            if (string_eq(sym.name, SLOP_STR("@spec"))) {
                                                __auto_type _mv_1153 = ({ __auto_type _lst = sub_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    ...
                                                    switch (_mv_1154.tag) {
                                                        case types_SExpr_lst:
                                                        {
                                                            __auto_type body_lst = _mv_1154.data.lst;
                                                            {
                                                                ...
                                                                __auto_type body_len = ((int64_t)((body_items).len));
                                                                if (body_len >= 1) {
                                                                    __auto_type _mv_1155 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)(body_len - 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            ...
            switch (_mv_1157.tag) {
                case types_SExpr_lst:
                {
                    __auto_type params_lst = _mv_1157.data.lst;
                    {
                        ...
                        __auto_type i = 0;
                        while (i < param_count) {
                            __auto_type _mv_1158 = ({ __auto_type _lst = params; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    ...
                                    case types_SExpr_lst:
                                    {
                                        __auto_type param_lst = _mv_1159.data.lst;
                                        {
                                            ...
                                            if (((int64_t)((param_items).len)) >= 2) {
                                                __auto_type _mv_1160 = ({ __auto_type _lst = param_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                ...
                __auto_type lst = _mv_1164.data.lst;
                {
                    ...
                    if (len < 2) {
                    ...
                    } else {
                        {
                            ...
                            __auto_type _mv_1165 = ({ __auto_type _lst = items; size_t _idx = (size_t)type_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void transpiler_prescan_fn_for_struct_keys(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 3;
        while (i < len) {
            __auto_type _mv_1181 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    ...
                                    } else {
                                        {
                                            ...
                                            while (i < len) {
                                                ...
                                                if (_mv_1189.has_value) {
                                                    __auto_type child = _mv_1189.value;
            ...
            case types_SExpr_sym:
            {
                __auto_type sym = _mv_1191.data.sym;
                {
                    ...
                    if (!(transpiler_is_builtin_map_key_type(name))) {
                        __auto_type _mv_1192 = context_ctx_lookup_type(ctx, name);
                        if (_mv_1192.has_value) {
                            ...
                            __auto_type _mv_1193 = context_ctx_get_module(ctx);
                            if (_mv_1193.has_value) {
                                __auto_type mod = _mv_1193.value;
                                {
                                    __auto_type prefixed = context_ctx_str3(ctx, mod, SLOP_STR("_"), name);
                                    __auto_type _mv_1194 = context_ctx_lookup_type(ctx, prefixed);
...
void transpiler_check_and_register_result_alias(context_TranspileContext* ctx, slop_string alias_name, types_SExpr* body_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1195 = (*body_expr);
        switch (_mv_1195.tag) {
            case types_SExpr_lst:
            {
                                ...
                                case types_SExpr_sym:
                                {
                                    ...
                                    if (string_eq(sym.name, SLOP_STR("Result"))) {
                                        ...
                                        if (_mv_1198.has_value) {
                                            __auto_type ok_type_expr = _mv_1198.value;
                                            ...
                                            if (_mv_1199.has_value) {
                                                __auto_type err_type_expr = _mv_1199.value;
                                                {
                                                    __auto_type ok_c_type = context_to_c_type_prefixed(ctx, ok_type_expr);
                                                    __auto_type err_c_type = context_to_c_type_prefixed(ctx, err_type_expr);
                                                    __auto_type result_name = transpiler_build_result_type_name(ctx, ok_c_type, err_c_type);
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len >= 2) {
            ...
            if (_mv_1200.has_value) {
                __auto_type header_expr = _mv_1200.value;
                __auto_type _mv_1201 = (*header_expr);
                switch (_mv_1201.tag) {
                    case types_SExpr_str:
                    {
                        __auto_type str = _mv_1201.data.str;
            ...
            }
            {
                ...
                while (i < len) {
                    ...
                    if (_mv_1202.has_value) {
                        __auto_type func_decl = _mv_1202.value;
...
void transpiler_prescan_import(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    ...
    if (((int64_t)((items).len)) >= 3) {
        ...
        if (_mv_1203.has_value) {
            __auto_type mod_expr = _mv_1203.value;
            __auto_type _mv_1204 = (*mod_expr);
            switch (_mv_1204.tag) {
                case types_SExpr_sym:
                {
                    __auto_type mod_sym = _mv_1204.data.sym;
                    {
                        ...
                        if (_mv_1205.has_value) {
                            __auto_type symbols_expr = _mv_1205.value;
                            __auto_type _mv_1206 = (*symbols_expr);
                            switch (_mv_1206.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type symbols_lst = _mv_1206.data.lst;
                                    {
                                        __auto_type syms = symbols_lst.items;
                                        __auto_type sym_len = ((int64_t)((syms).len));
                                        __auto_type j = 0;
                                        while (j < sym_len) {
                                            __auto_type _mv_1207 = ({ __auto_type _lst = syms; size_t _idx = (size_t)j; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_1207.has_value) {
                                                __auto_type sym_item = _mv_1207.value;
                                                __auto_type _mv_1208 = (*sym_item);
                                                switch (_mv_1208.tag) {
                                                    case types_SExpr_sym:
                                                    {
                                                        __auto_type s = _mv_1208.data.sym;
                                                        {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (((int64_t)((items).len)) >= 3) {
            ...
            if (_mv_1209.has_value) {
                __auto_type name_expr = _mv_1209.value;
                __auto_type _mv_1210 = (*name_expr);
                switch (_mv_1210.tag) {
                    case types_SExpr_sym:
                    {
...
void transpiler_register_ffi_function(context_TranspileContext* ctx, types_SExpr* func_decl) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1211 = (*func_decl);
        switch (_mv_1211.tag) {
            case types_SExpr_lst:
            {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (((int64_t)((items).len)) >= 2) {
            ...
            if (_mv_1214.has_value) {
                __auto_type params_expr = _mv_1214.value;
                __auto_type _mv_1215 = (*params_expr);
                switch (_mv_1215.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type params_lst = _mv_1215.data.lst;
                        {
                            __auto_type params = params_lst.items;
                            __auto_type param_count = ((int64_t)((params).len));
                            __auto_type i = 0;
                            while (i < param_count) {
                                __auto_type _mv_1216 = ({ __auto_type _lst = params; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1216.has_value) {
                                    __auto_type param_expr = _mv_1216.value;
                                    {
                                        __auto_type c_type = transpiler_prescan_get_param_c_type(ctx, param_expr);
                                        __auto_type param_info = ((context_FuncParamType*)(({ __auto_type _alloc = (context_FuncParamType*)slop_arena_alloc(arena, sizeof(context_FuncParamType)); if (_alloc == NULL) { fprintf(stderr, "SLOP: arena alloc failed at %s:%d\n", __FILE__, __LINE__); abort(); } _alloc; })));
                                        (*param_info).c_type = c_type;
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_1217.has_value) {
                __auto_type item_expr = _mv_1217.value;
                __auto_type _mv_1218 = (*item_expr);
                switch (_mv_1218.tag) {
                    case types_SExpr_sym:
                    {
                        __auto_type sym = _mv_1218.data.sym;
                        if (string_eq(sym.name, SLOP_STR(":c-name"))) {
                            __auto_type _mv_1219 = ({ __auto_type _lst = items; size_t _idx = (size_t)(i + 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_1219.has_value) {
                                __auto_type c_name_expr = _mv_1219.value;
                                __auto_type _mv_1220 = (*c_name_expr);
                                switch (_mv_1220.tag) {
                                    case types_SExpr_sym:
                                    {
                                        __auto_type c_sym = _mv_1220.data.sym;
                                        c_name = c_sym.name;
                                        found_c_name = 1;
                                        break;
                                    }
        ...
        if (len >= 2) {
            {
                ...
                if (has_header) {
                    __auto_type _mv_1221 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_1221.has_value) {
                        __auto_type header_expr = _mv_1221.value;
                        __auto_type _mv_1222 = (*header_expr);
                        switch (_mv_1222.tag) {
                            case types_SExpr_str:
                            {
                ...
                if (len >= (name_idx + 1)) {
                    __auto_type _mv_1223 = ({ __auto_type _lst = items; size_t _idx = (size_t)name_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_string transpiler_get_ffi_struct_c_name(slop_arena* arena, slop_list_types_SExpr_ptr items, int64_t name_idx, slop_string default_name) {
    {
        ...
        if (len >= (modifier_idx + 2)) {
            __auto_type _mv_1225 = ({ __auto_type _lst = items; size_t _idx = (size_t)modifier_idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1225.has_value) {
                ...
                switch (_mv_1226.tag) {
                    case types_SExpr_sym:
                    {
                        ...
                        if (string_eq(sym.name, SLOP_STR(":c-name"))) {
                            __auto_type _mv_1227 = ({ __auto_type _lst = items; size_t _idx = (size_t)(modifier_idx + 1); slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_1227.has_value) {
                                __auto_type cname_expr = _mv_1227.value;
                                __auto_type _mv_1228 = (*cname_expr);
                                switch (_mv_1228.tag) {
                                    case types_SExpr_str:
                                    {
...
uint8_t transpiler_is_ffi_string_item(slop_list_types_SExpr_ptr items, int64_t idx) {
    __auto_type _mv_1229 = ({ __auto_type _lst = items; size_t _idx = (size_t)idx; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    if (_mv_1229.has_value) {
        ...
        switch (_mv_1230.tag) {
            case types_SExpr_str:
            {
                __auto_type _ = _mv_1230.data.str;
                return 1;
            }
            default: {
                return 0;
...
slop_string transpiler_get_array_c_type(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items, slop_string default_c_type) {
    ...
    if (((int64_t)((items).len)) < 3) {
        ...
        if (_mv_1243.has_value) {
            __auto_type body_expr = _mv_1243.value;
                ...
                case types_SExpr_lst:
                {
                    __auto_type body_lst = _mv_1244.data.lst;
                    {
                        ...
                        if (((int64_t)((body_items).len)) < 2) {
                            ...
                            __auto_type _mv_1245 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                ...
                                switch (_mv_1246.tag) {
                                    case types_SExpr_sym:
                                    {
                                        ...
                                        if (string_eq(sym.name, SLOP_STR("Array"))) {
                                            __auto_type _mv_1247 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_1247.has_value) {
                                                __auto_type elem_expr = _mv_1247.value;
                                                {
            ...
            __auto_type lst = _mv_1250.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 3) {
                    ...
                    if (_mv_1251.has_value) {
                        __auto_type def_expr = _mv_1251.value;
                        __auto_type _mv_1252 = (*def_expr);
                        switch (_mv_1252.tag) {
                            case types_SExpr_lst:
                            {
                                __auto_type def_lst = _mv_1252.data.lst;
                                {
                                    __auto_type def_items = def_lst.items;
                                    if (((int64_t)((def_items).len)) < 1) {
                                        return 0;
                                    } else {
                                        __auto_type _mv_1253 = ({ __auto_type _lst = def_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void transpiler_transpile_module(context_TranspileContext* ctx, types_SExpr* module_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1262 = (*module_expr);
        switch (_mv_1262.tag) {
            case types_SExpr_lst:
            {
...
int64_t transpiler_get_body_start(slop_list_types_SExpr_ptr items) {
    if (((int64_t)((items).len)) < 3) {
        ...
        if (_mv_1265.has_value) {
            __auto_type third = _mv_1265.value;
            __auto_type _mv_1266 = (*third);
            switch (_mv_1266.tag) {
                case types_SExpr_lst:
                {
                                            ...
                                            if (string_eq(sym.name, SLOP_STR("export"))) {
                                                {
                                                    ...
                                                    __auto_type j = 1;
                                                    while (j < export_len) {
                                                        __auto_type _mv_1273 = ({ __auto_type _lst = sub_items; size_t _idx = (size_t)j; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                        if (_mv_1273.has_value) {
                                                            ...
                                                            switch (_mv_1274.tag) {
                                                                case types_SExpr_sym:
                                                                {
                                                                    __auto_type name_sym = _mv_1274.data.sym;
...
uint8_t transpiler_list_contains_str(slop_list_string lst, slop_string needle) {
    {
        ...
        uint8_t found = 0;
        while ((i < len) && !(found)) {
            __auto_type _mv_1275 = ({ __auto_type _lst = lst; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1275.has_value) {
                __auto_type s = _mv_1275.value;
                                        ...
                                        if (string_eq(op, SLOP_STR("Option"))) {
                                            ...
                                            if (len >= 3) {
                                                ...
                                                if (_mv_1283.has_value) {
                                                    __auto_type ok_type = _mv_1283.value;
                                                    ...
                                                    if (_mv_1284.has_value) {
                                                        __auto_type err_type = _mv_1284.value;
                                                        {
                                            ...
                                            if (len >= 2) {
                                                ...
                                                if (_mv_1286.has_value) {
                                                    __auto_type result = _mv_1286.value;
                                                    {
                                            ...
                                            if (len >= 3) {
                                                ...
                                                if (_mv_1287.has_value) {
                                                    __auto_type key_type = _mv_1287.value;
                                                    {
                                                        ...
                                                        if (_mv_1288.has_value) {
                                                            __auto_type val_type = _mv_1288.value;
                                                            {
                                            ...
                                            if (len >= 2) {
                                                ...
                                                if (_mv_1289.has_value) {
                                                    __auto_type elem_type = _mv_1289.value;
                                                    {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_1290.has_value) {
                __auto_type field_expr = _mv_1290.value;
                __auto_type _mv_1291 = (*field_expr);
                switch (_mv_1291.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type field_lst = _mv_1291.data.lst;
                        {
                            __auto_type field_items = field_lst.items;
                            if (((int64_t)((field_items).len)) >= 2) {
                                __auto_type _mv_1292 = ({ __auto_type _lst = field_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void transpiler_emit_ffi_includes(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1293 = ({ __auto_type _lst = includes; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1293.has_value) {
                __auto_type header = _mv_1293.value;
...
void transpiler_emit_header_guard_open(context_TranspileContext* ctx) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1295 = context_ctx_get_module(ctx);
        if (_mv_1295.has_value) {
            __auto_type mod_name = _mv_1295.value;
            {
...
void transpiler_emit_header_dependency_includes(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1296 = ({ __auto_type _lst = imports; size_t _idx = (size_t)i; slop_option_string _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        while (i < len) {
            ...
            if (_mv_1297.has_value) {
                ...
                if (transpiler_is_type_def(item) && transpiler_is_struct_type_def(item)) {
                    __auto_type _mv_1298 = transpiler_get_type_name(item);
                    if (_mv_1298.has_value) {
                        __auto_type type_name = _mv_1298.value;
                        {
                            ...
                            case types_SExpr_lst:
                            {
                                __auto_type def_lst = _mv_1301.data.lst;
                                {
                                    ...
                                    if (((int64_t)((def_items).len)) < 1) {
                                        ...
                                        __auto_type _mv_1302 = ({ __auto_type _lst = def_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        while ((i < len) && !(found)) {
            ...
            if (_mv_1304.has_value) {
                ...
                switch (_mv_1305.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type _ = _mv_1305.data.lst;
                        found = 1;
                        break;
                    }
                    default: {
            ...
            __auto_type lst = _mv_1306.data.lst;
            {
                ...
                if (((int64_t)((items).len)) < 3) {
                    ...
                    if (_mv_1307.has_value) {
                        __auto_type def_expr = _mv_1307.value;
                        __auto_type _mv_1308 = (*def_expr);
                        switch (_mv_1308.tag) {
                            case types_SExpr_sym:
                            {
                                __auto_type _ = _mv_1308.data.sym;
                                return 1;
                            }
                            case types_SExpr_lst:
                            {
                                __auto_type def_lst = _mv_1308.data.lst;
                                {
                                    __auto_type def_items = def_lst.items;
                                    if (((int64_t)((def_items).len)) < 1) {
                                        return 0;
                                    } else {
                                        __auto_type _mv_1309 = ({ __auto_type _lst = def_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                ...
                __auto_type lst = _mv_1323.data.lst;
                {
                    ...
                    if (len < 3) {
                        ...
                        if (_mv_1324.has_value) {
                            __auto_type elem_type_expr = _mv_1324.value;
                            ...
                            if (_mv_1325.has_value) {
                                __auto_type size_expr = _mv_1325.value;
                                {
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1327.data.lst;
            {
                ...
                while ((i < len) && !(found_dots)) {
                    __auto_type _mv_1328 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
transpiler_RangeBoundsHeader transpiler_parse_range_bounds_header(types_SExpr* body_expr) {
    SLOP_PRE(((body_expr != NULL)), "(!= body-expr nil)");
    {
        ...
        __auto_type _mv_1330 = (*body_expr);
        switch (_mv_1330.tag) {
            case types_SExpr_lst:
            {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (i < len) {
            ...
            if (_mv_1333.has_value) {
                ...
                if (transpiler_is_type_def(item) && transpiler_is_struct_type_def(item)) {
                    __auto_type _mv_1334 = transpiler_get_type_name(item);
                    if (_mv_1334.has_value) {
                        __auto_type type_name = _mv_1334.value;
                        {
...
void transpiler_emit_c_name_aliases(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (len > 0) {
            ...
            while (i < len) {
                __auto_type _mv_1337 = ({ __auto_type _lst = aliases; size_t _idx = (size_t)i; slop_option_context_FuncCNameAlias _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_1337.has_value) {
                    __auto_type alias = _mv_1337.value;
                                ...
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_1340.data.sym;
                                    {
                                        ...
                                        if (_mv_1341.has_value) {
                                            __auto_type params_expr = _mv_1341.value;
                                            {
...
void transpiler_emit_result_types(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1349 = ({ __auto_type _lst = result_types; size_t _idx = (size_t)i; slop_option_context_ResultType _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1349.has_value) {
                __auto_type rt = _mv_1349.value;
...
void transpiler_emit_inline_records_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while (i < len) {
            __auto_type _mv_1351 = ({ __auto_type _lst = inline_records; size_t _idx = (size_t)i; slop_option_context_InlineRecord _r = {0}; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1351.has_value) {
                __auto_type ir = _mv_1351.value;
                {
                                        ...
                                        if (string_eq(kind, SLOP_STR("Ptr"))) {
                                            ...
                                            if (((int64_t)((items).len)) >= 2) {
                                                ...
                                                if (_mv_1413.has_value) {
                                                    __auto_type inner = _mv_1413.value;
                                                    {
                                                        __auto_type inner_str = transpiler_get_field_type_string(ctx, inner);
                                                        if (string_eq(inner_str, SLOP_STR(""))) {
                                                            return SLOP_STR("");
