...
transpiler_GenericInfo transpiler_extract_generic_info(slop_arena* arena, slop_list_types_SExpr_ptr items) {
    {
        ...
        while ((i < len)) {
            __auto_type _mv_1049 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    ...
                    case types_SExpr_lst:
                    {
                        __auto_type lst = _mv_1050.data.lst;
                        {
                            ...
                            if ((((int64_t)((sub_items).len)) >= 1)) {
                                __auto_type _mv_1051 = ({ __auto_type _lst = sub_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1051.has_value) {
                                    __auto_type head = _mv_1051.value;
                                    __auto_type _mv_1052 = (*head);
                                    switch (_mv_1052.tag) {
                                        case types_SExpr_sym:
                                        {
                                            ...
                                            if (string_eq(sym.name, SLOP_STR("@generic"))) {
                                                if ((((int64_t)((sub_items).len)) >= 2)) {
                                                    __auto_type _mv_1053 = ({ __auto_type _lst = sub_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_1053.has_value) {
                                                        __auto_type params_expr = _mv_1053.value;
                                                        __auto_type _mv_1054 = (*params_expr);
                                                        switch (_mv_1054.tag) {
                                                            case types_SExpr_lst:
                                                            {
                                                                __auto_type params_lst = _mv_1054.data.lst;
                                                                {
                                                                    __auto_type param_items = params_lst.items;
                                                                    __auto_type param_len = ((int64_t)((param_items).len));
                                                                    __auto_type j = 0;
                                                                    while ((j < param_len)) {
                                                                        __auto_type _mv_1055 = ({ __auto_type _lst = param_items; size_t _idx = (size_t)j; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                                        if (_mv_1055.has_value) {
                                                                            ...
                                                                            switch (_mv_1056.tag) {
                                                                                case types_SExpr_sym:
                                                                                {
                                                                                    __auto_type param_sym = _mv_1056.data.sym;
                                                            ...
                                                            case types_SExpr_sym:
                                                            {
                                                                __auto_type single_sym = _mv_1054.data.sym;
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1058.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) >= 1)) {
                    __auto_type _mv_1059 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_1059.has_value) {
                        __auto_type head = _mv_1059.value;
                        __auto_type _mv_1060 = (*head);
                        switch (_mv_1060.tag) {
                            case types_SExpr_sym:
                            {
...
void transpiler_prescan_type(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((((int64_t)((items).len)) >= 2)) {
            __auto_type _mv_1061 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1061.has_value) {
                __auto_type name_expr = _mv_1061.value;
                __auto_type _mv_1062 = (*name_expr);
                switch (_mv_1062.tag) {
                    case types_SExpr_sym:
                    {
                            ...
                            __auto_type c_name = ((context_ctx_prefixing_enabled(ctx)) ? ({ __auto_type _mv = context_ctx_get_module(ctx); _mv.has_value ? ({ __auto_type mod_name = _mv.value; context_ctx_str(ctx, ctype_to_c_name(arena, mod_name), context_ctx_str(ctx, SLOP_STR("_"), base_c_name)); }) : (base_c_name); }) : base_c_name);
                            {
                                ...
                                if ((is_record || is_union)) {
                                    if ((((int64_t)((items).len)) >= 3)) {
                                        __auto_type _mv_1063 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_1063.has_value) {
                                            __auto_type def_expr = _mv_1063.value;
                                            __auto_type _mv_1064 = (*def_expr);
                                            switch (_mv_1064.tag) {
                                                case types_SExpr_lst:
                                                {
                                                    __auto_type def_lst = _mv_1064.data.lst;
                                ...
                                if ((((int64_t)((items).len)) >= 3)) {
                                    ...
                                    if (_mv_1065.has_value) {
                                        __auto_type body_expr = _mv_1065.value;
...
void transpiler_register_enum_variants(context_TranspileContext* ctx, slop_string enum_name, slop_list_types_SExpr_ptr items) {
    ...
    if ((((int64_t)((items).len)) >= 3)) {
        ...
        if (_mv_1066.has_value) {
            __auto_type def_expr = _mv_1066.value;
            __auto_type _mv_1067 = (*def_expr);
            switch (_mv_1067.tag) {
                case types_SExpr_lst:
                {
                    __auto_type def_lst = _mv_1067.data.lst;
                    {
                        __auto_type def_items = def_lst.items;
                        __auto_type len = ((int64_t)((def_items).len));
                        __auto_type i = 1;
                        while ((i < len)) {
                            __auto_type _mv_1068 = ({ __auto_type _lst = def_items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_1068.has_value) {
                                __auto_type variant_expr = _mv_1068.value;
                                __auto_type _mv_1069 = (*variant_expr);
                                switch (_mv_1069.tag) {
                                    case types_SExpr_sym:
                                    {
                                    ...
                                    case types_SExpr_lst:
                                    {
                                        __auto_type variant_lst = _mv_1069.data.lst;
                                        if ((((int64_t)((variant_lst.items).len)) > 0)) {
                                            __auto_type _mv_1070 = ({ __auto_type _lst = variant_lst.items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_1070.has_value) {
                                                ...
                                                switch (_mv_1071.tag) {
                                                    case types_SExpr_sym:
                                                    {
                                                        __auto_type name_sym = _mv_1071.data.sym;
                ...
                switch (_mv_1073.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type def_lst = _mv_1073.data.lst;
                        {
                            ...
                            __auto_type i = 1;
                            while ((i < len)) {
                                __auto_type _mv_1074 = ({ __auto_type _lst = def_items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1074.has_value) {
                                    __auto_type variant_expr = _mv_1074.value;
                                    __auto_type _mv_1075 = (*variant_expr);
                                    switch (_mv_1075.tag) {
                                        case types_SExpr_sym:
                                        {
                                        ...
                                        case types_SExpr_lst:
                                        {
                                            __auto_type variant_lst = _mv_1075.data.lst;
                                            {
                                                __auto_type vl_items = variant_lst.items;
                                                if ((((int64_t)((vl_items).len)) >= 2)) {
                                                    __auto_type _mv_1076 = ({ __auto_type _lst = vl_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                        ...
                                                        switch (_mv_1077.tag) {
                                                            case types_SExpr_sym:
                                                            {
                                                                __auto_type name_sym = _mv_1077.data.sym;
                                                                {
                                                                    ...
                                                                    context_ctx_register_enum_variant(ctx, variant_name, union_name);
                                                                    __auto_type _mv_1078 = ({ __auto_type _lst = vl_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                                    if (_mv_1078.has_value) {
                                                                        __auto_type type_expr = _mv_1078.value;
                                                                        {
...
void transpiler_prescan_fn(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        __auto_type arena = (*ctx).arena;
        if ((((int64_t)((items).len)) >= 2)) {
            __auto_type _mv_1079 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
uint8_t transpiler_fn_returns_string(slop_list_types_SExpr_ptr items) {
    {
        ...
        uint8_t result = 0;
        while (((i < len) && !(result))) {
            __auto_type _mv_1081 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1081.has_value) {
                __auto_type item = _mv_1081.value;
                __auto_type _mv_1082 = (*item);
                switch (_mv_1082.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type lst = _mv_1082.data.lst;
                        {
                            __auto_type sub_items = lst.items;
                            if ((((int64_t)((sub_items).len)) >= 2)) {
                                __auto_type _mv_1083 = ({ __auto_type _lst = sub_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    ...
                                    switch (_mv_1084.tag) {
                                        case types_SExpr_sym:
                                        {
                                            ...
                                            if (string_eq(sym.name, SLOP_STR("@spec"))) {
                                                __auto_type _mv_1085 = ({ __auto_type _lst = sub_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_1085.has_value) {
                                                    __auto_type spec_body = _mv_1085.value;
                                                    __auto_type _mv_1086 = (*spec_body);
                                                    switch (_mv_1086.tag) {
                                                        case types_SExpr_lst:
                                                        {
                                                            __auto_type body_lst = _mv_1086.data.lst;
                                                            {
                                                                __auto_type body_items = body_lst.items;
                                                                __auto_type body_len = ((int64_t)((body_items).len));
                                                                if ((body_len >= 1)) {
                                                                    __auto_type _mv_1087 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)(body_len - 1); slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                                    if (_mv_1087.has_value) {
                                                                        __auto_type ret_type = _mv_1087.value;
                                                                        __auto_type _mv_1088 = (*ret_type);
                                                                        switch (_mv_1088.tag) {
                                                                            case types_SExpr_sym:
                                                                            {
                                                                                __auto_type ret_sym = _mv_1088.data.sym;
...
slop_string transpiler_fn_return_type(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (((i < len) && string_eq(result, SLOP_STR("")))) {
            __auto_type _mv_1089 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                ...
                switch (_mv_1090.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type lst = _mv_1090.data.lst;
                        {
                            __auto_type sub_items = lst.items;
                            if ((((int64_t)((sub_items).len)) >= 2)) {
                                __auto_type _mv_1091 = ({ __auto_type _lst = sub_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1091.has_value) {
                                    __auto_type head = _mv_1091.value;
                                    __auto_type _mv_1092 = (*head);
                                    switch (_mv_1092.tag) {
                                        case types_SExpr_sym:
                                        {
                                            __auto_type sym = _mv_1092.data.sym;
                                            if (string_eq(sym.name, SLOP_STR("@spec"))) {
                                                __auto_type _mv_1093 = ({ __auto_type _lst = sub_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_1093.has_value) {
                                                    __auto_type spec_body = _mv_1093.value;
                                                    __auto_type _mv_1094 = (*spec_body);
                                                    switch (_mv_1094.tag) {
                                                        case types_SExpr_lst:
                                                        {
                                                            __auto_type body_lst = _mv_1094.data.lst;
                                                            {
                                                                __auto_type body_items = body_lst.items;
                                                                __auto_type body_len = ((int64_t)((body_items).len));
                                                                if ((body_len >= 1)) {
                                                                    __auto_type _mv_1095 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)(body_len - 1); slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                                    if (_mv_1095.has_value) {
                                                                        __auto_type ret_type = _mv_1095.value;
...
void transpiler_prescan_fn_params(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    if ((((int64_t)((items).len)) >= 3)) {
        __auto_type _mv_1096 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    ...
                    __auto_type params_lst = _mv_1097.data.lst;
                    {
                        ...
                        while ((i < param_count)) {
                            ...
                            if (_mv_1098.has_value) {
                                ...
                                __auto_type _mv_1099 = (*param_expr);
                                switch (_mv_1099.tag) {
                                    case types_SExpr_lst:
                                    {
                                        __auto_type param_lst = _mv_1099.data.lst;
                                        {
                                            __auto_type param_items = param_lst.items;
                                            if ((((int64_t)((param_items).len)) >= 2)) {
                                                __auto_type _mv_1100 = ({ __auto_type _lst = param_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_list_context_FuncParamType_ptr transpiler_prescan_collect_param_types(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((((int64_t)((items).len)) >= 3)) {
            __auto_type _mv_1101 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1101.has_value) {
                __auto_type params_expr = _mv_1101.value;
                __auto_type _mv_1102 = (*params_expr);
                switch (_mv_1102.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type params_lst = _mv_1102.data.lst;
                        {
                            __auto_type params = params_lst.items;
                            __auto_type param_count = ((int64_t)((params).len));
                            __auto_type i = 0;
                            while ((i < param_count)) {
                                __auto_type _mv_1103 = ({ __auto_type _lst = params; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1103.has_value) {
                                    __auto_type param_expr = _mv_1103.value;
                                    {
                ...
                __auto_type lst = _mv_1104.data.lst;
                {
                    ...
                    if ((len < 2)) {
                    ...
                    } else {
                        {
                            ...
                            __auto_type _mv_1105 = ({ __auto_type _lst = items; size_t _idx = (size_t)type_idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void transpiler_prescan_fn_result_type(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 3;
        while ((i < len)) {
            __auto_type _mv_1108 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1109.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    __auto_type _mv_1110 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        switch (_mv_1112.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1112.data.lst;
                {
                    __auto_type items = lst.items;
                    if ((((int64_t)((items).len)) >= 2)) {
                        __auto_type _mv_1113 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            ...
                            switch (_mv_1114.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type body_lst = _mv_1114.data.lst;
                                    {
                                        ...
                                        __auto_type body_len = ((int64_t)((body_items).len));
                                        if ((body_len >= 1)) {
                                            __auto_type _mv_1115 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)(body_len - 1); slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        switch (_mv_1116.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1116.data.lst;
                {
                    __auto_type items = lst.items;
                    if ((((int64_t)((items).len)) >= 3)) {
                        __auto_type _mv_1117 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            ...
                            switch (_mv_1118.tag) {
                                case types_SExpr_sym:
                                {
                                    ...
                                    if (string_eq(sym.name, SLOP_STR("Result"))) {
                                        __auto_type _mv_1119 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_1119.has_value) {
                                            __auto_type ok_type_expr = _mv_1119.value;
                                            __auto_type _mv_1120 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void transpiler_prescan_fn_for_struct_keys(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 3;
        while ((i < len)) {
            __auto_type _mv_1121 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1121.has_value) {
                __auto_type item = _mv_1121.value;
    ...
    switch (_mv_1122.tag) {
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1122.data.lst;
            {
                ...
                __auto_type len = ((int64_t)((items).len));
                if ((len >= 1)) {
                    __auto_type _mv_1123 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    ...
                                    if (string_eq(name, SLOP_STR("map-new"))) {
                                        if ((len >= 3)) {
                                            ...
                                            if (_mv_1125.has_value) {
                                                __auto_type key_type_expr = _mv_1125.value;
                                        ...
                                        if ((len >= 3)) {
                                            ...
                                            if (_mv_1126.has_value) {
                                                __auto_type elem_type_expr = _mv_1126.value;
                                        ...
                                        if ((len >= 4)) {
                                            __auto_type _mv_1127 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_1127.has_value) {
                                                __auto_type type_expr = _mv_1127.value;
                                                {
                                    ...
                                    } else {
                                        {
                                            __auto_type i = 0;
                                            while ((i < len)) {
                                                __auto_type _mv_1129 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_1129.has_value) {
                                                    __auto_type child = _mv_1129.value;
                            ...
                            default: {
                                {
                                    ...
                                    while ((i < len)) {
                                        ...
                                        if (_mv_1130.has_value) {
                                            __auto_type child = _mv_1130.value;
                                            transpiler_prescan_expr_for_struct_keys(ctx, child);
            ...
            case types_SExpr_sym:
            {
                __auto_type sym = _mv_1131.data.sym;
                {
                    ...
                    if (!(transpiler_is_builtin_map_key_type(name))) {
                        __auto_type _mv_1132 = context_ctx_lookup_type(ctx, name);
                        if (_mv_1132.has_value) {
                            __auto_type type_entry = _mv_1132.value;
                            context_ctx_register_struct_key_type(ctx, type_entry.c_name);
                        } else if (!_mv_1132.has_value) {
                            __auto_type _mv_1133 = context_ctx_get_module(ctx);
                            if (_mv_1133.has_value) {
                                __auto_type mod = _mv_1133.value;
                                {
                                    __auto_type prefixed = context_ctx_str3(ctx, mod, SLOP_STR("_"), name);
                                    __auto_type _mv_1134 = context_ctx_lookup_type(ctx, prefixed);
        ...
        switch (_mv_1135.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1135.data.lst;
                {
                    __auto_type items = lst.items;
                    if ((((int64_t)((items).len)) >= 3)) {
                        __auto_type _mv_1136 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_1136.has_value) {
                            ...
                            switch (_mv_1137.tag) {
                                case types_SExpr_sym:
                                {
                                    ...
                                    if (string_eq(sym.name, SLOP_STR("Result"))) {
                                        __auto_type _mv_1138 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_1138.has_value) {
                                            __auto_type ok_type_expr = _mv_1138.value;
                                            __auto_type _mv_1139 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_1139.has_value) {
                                                __auto_type err_type_expr = _mv_1139.value;
                                                {
                                                    __auto_type ok_c_type = context_to_c_type_prefixed(ctx, ok_type_expr);
                                                    __auto_type err_c_type = context_to_c_type_prefixed(ctx, err_type_expr);
                                                    __auto_type result_name = transpiler_build_result_type_name(ctx, ok_c_type, err_c_type);
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len >= 2)) {
            ...
            if (_mv_1140.has_value) {
                __auto_type header_expr = _mv_1140.value;
                __auto_type _mv_1141 = (*header_expr);
                switch (_mv_1141.tag) {
                    case types_SExpr_str:
                    {
                        __auto_type str = _mv_1141.data.str;
            ...
            }
            {
                ...
                while ((i < len)) {
                    ...
                    if (_mv_1142.has_value) {
                        __auto_type func_decl = _mv_1142.value;
...
void transpiler_prescan_import(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    if ((((int64_t)((items).len)) >= 3)) {
        __auto_type _mv_1143 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        if (_mv_1143.has_value) {
            __auto_type mod_expr = _mv_1143.value;
            __auto_type _mv_1144 = (*mod_expr);
            switch (_mv_1144.tag) {
                case types_SExpr_sym:
                {
                    __auto_type mod_sym = _mv_1144.data.sym;
                    {
                        ...
                        __auto_type _mv_1145 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_1145.has_value) {
                            __auto_type symbols_expr = _mv_1145.value;
                            __auto_type _mv_1146 = (*symbols_expr);
                            switch (_mv_1146.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type symbols_lst = _mv_1146.data.lst;
                                    {
                                        __auto_type syms = symbols_lst.items;
                                        __auto_type sym_len = ((int64_t)((syms).len));
                                        __auto_type j = 0;
                                        while ((j < sym_len)) {
                                            __auto_type _mv_1147 = ({ __auto_type _lst = syms; size_t _idx = (size_t)j; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_1147.has_value) {
                                                __auto_type sym_item = _mv_1147.value;
                                                __auto_type _mv_1148 = (*sym_item);
                                                switch (_mv_1148.tag) {
                                                    case types_SExpr_sym:
                                                    {
                                                        __auto_type s = _mv_1148.data.sym;
                                                        {
...
void transpiler_register_ffi_function(context_TranspileContext* ctx, types_SExpr* func_decl) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1149 = (*func_decl);
        switch (_mv_1149.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1149.data.lst;
                {
                    ...
                    __auto_type len = ((int64_t)((items).len));
                    if ((len >= 1)) {
                        __auto_type _mv_1150 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((((int64_t)((items).len)) >= 2)) {
            ...
            if (_mv_1152.has_value) {
                __auto_type params_expr = _mv_1152.value;
                __auto_type _mv_1153 = (*params_expr);
                switch (_mv_1153.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type params_lst = _mv_1153.data.lst;
                        {
                            __auto_type params = params_lst.items;
                            __auto_type param_count = ((int64_t)((params).len));
                            __auto_type i = 0;
                            while ((i < param_count)) {
                                __auto_type _mv_1154 = ({ __auto_type _lst = params; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1154.has_value) {
                                    __auto_type param_expr = _mv_1154.value;
                                    {
                                        __auto_type c_type = transpiler_prescan_get_param_c_type(ctx, param_expr);
                                        __auto_type param_info = ((context_FuncParamType*)(({ __auto_type _alloc = (uint8_t*)slop_arena_alloc(arena, 64); if (_alloc == NULL) { fprintf(stderr, "SLOP: arena alloc failed at %s:%d\n", __FILE__, __LINE__); abort(); } _alloc; })));
                                        (*param_info).c_type = c_type;
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while ((i < len)) {
            ...
            if (_mv_1155.has_value) {
                __auto_type item_expr = _mv_1155.value;
                __auto_type _mv_1156 = (*item_expr);
                switch (_mv_1156.tag) {
                    case types_SExpr_sym:
                    {
                        __auto_type sym = _mv_1156.data.sym;
                        if (string_eq(sym.name, SLOP_STR(":c-name"))) {
                            __auto_type _mv_1157 = ({ __auto_type _lst = items; size_t _idx = (size_t)(i + 1); slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_1157.has_value) {
                                __auto_type c_name_expr = _mv_1157.value;
                                __auto_type _mv_1158 = (*c_name_expr);
                                switch (_mv_1158.tag) {
                                    case types_SExpr_sym:
                                    {
                                        __auto_type c_sym = _mv_1158.data.sym;
                                        c_name = c_sym.name;
                                        found_c_name = 1;
                                        break;
                                    }
        ...
        if ((len >= 2)) {
            {
                ...
                if (has_header) {
                    __auto_type _mv_1159 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_1159.has_value) {
                        __auto_type header_expr = _mv_1159.value;
                        __auto_type _mv_1160 = (*header_expr);
                        switch (_mv_1160.tag) {
                            case types_SExpr_str:
                            {
                                __auto_type str = _mv_1160.data.str;
                                context_ctx_add_include(ctx, str.value);
                                break;
                            }
                            default: {
                ...
                if ((len >= (name_idx + 1))) {
                    __auto_type _mv_1161 = ({ __auto_type _lst = items; size_t _idx = (size_t)name_idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_1161.has_value) {
                        __auto_type name_expr = _mv_1161.value;
                        __auto_type _mv_1162 = (*name_expr);
                        switch (_mv_1162.tag) {
                            case types_SExpr_sym:
                            {
...
slop_string transpiler_get_ffi_struct_c_name(slop_arena* arena, slop_list_types_SExpr_ptr items, int64_t name_idx, slop_string default_name) {
    {
        ...
        if ((len >= (modifier_idx + 2))) {
            __auto_type _mv_1163 = ({ __auto_type _lst = items; size_t _idx = (size_t)modifier_idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1163.has_value) {
                __auto_type mod_expr = _mv_1163.value;
                __auto_type _mv_1164 = (*mod_expr);
                switch (_mv_1164.tag) {
                    case types_SExpr_sym:
                    {
                        __auto_type sym = _mv_1164.data.sym;
                        if (string_eq(sym.name, SLOP_STR(":c-name"))) {
                            __auto_type _mv_1165 = ({ __auto_type _lst = items; size_t _idx = (size_t)(modifier_idx + 1); slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_1165.has_value) {
                                __auto_type cname_expr = _mv_1165.value;
                                __auto_type _mv_1166 = (*cname_expr);
                                switch (_mv_1166.tag) {
                                    case types_SExpr_str:
                                    {
                                        __auto_type str = _mv_1166.data.str;
...
uint8_t transpiler_is_ffi_string_item(slop_list_types_SExpr_ptr items, int64_t idx) {
    __auto_type _mv_1167 = ({ __auto_type _lst = items; size_t _idx = (size_t)idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    if (_mv_1167.has_value) {
        __auto_type item = _mv_1167.value;
        __auto_type _mv_1168 = (*item);
        switch (_mv_1168.tag) {
            case types_SExpr_str:
            {
                __auto_type _ = _mv_1168.data.str;
                return 1;
            }
            default: {
                return 0;
                ...
                case types_SExpr_lst:
                {
                    __auto_type def_lst = _mv_1170.data.lst;
                    {
                        ...
                        if ((((int64_t)((def_items).len)) < 1)) {
                            ...
                            __auto_type _mv_1171 = ({ __auto_type _lst = def_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
uint8_t transpiler_is_record_def(slop_list_types_SExpr_ptr items) {
    if ((((int64_t)((items).len)) < 3)) {
        ...
        __auto_type _mv_1173 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        if (_mv_1173.has_value) {
            __auto_type def_expr = _mv_1173.value;
            __auto_type _mv_1174 = (*def_expr);
            switch (_mv_1174.tag) {
                case types_SExpr_lst:
                {
                    __auto_type def_lst = _mv_1174.data.lst;
                    {
                        __auto_type def_items = def_lst.items;
                        if ((((int64_t)((def_items).len)) < 1)) {
                            return 0;
                        } else {
                            __auto_type _mv_1175 = ({ __auto_type _lst = def_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
uint8_t transpiler_is_union_def(slop_list_types_SExpr_ptr items) {
    if ((((int64_t)((items).len)) < 3)) {
        ...
        __auto_type _mv_1177 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        if (_mv_1177.has_value) {
            __auto_type def_expr = _mv_1177.value;
            __auto_type _mv_1178 = (*def_expr);
            switch (_mv_1178.tag) {
                case types_SExpr_lst:
                {
                    __auto_type def_lst = _mv_1178.data.lst;
                    {
                        __auto_type def_items = def_lst.items;
                        if ((((int64_t)((def_items).len)) < 1)) {
                            return 0;
                        } else {
                            __auto_type _mv_1179 = ({ __auto_type _lst = def_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_string transpiler_get_array_c_type(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items, slop_string default_c_type) {
    ...
    if ((((int64_t)((items).len)) < 3)) {
        ...
        __auto_type _mv_1181 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        if (_mv_1181.has_value) {
            __auto_type body_expr = _mv_1181.value;
            __auto_type _mv_1182 = (*body_expr);
            switch (_mv_1182.tag) {
                case types_SExpr_lst:
                {
                    __auto_type body_lst = _mv_1182.data.lst;
                    {
                        __auto_type body_items = body_lst.items;
                        if ((((int64_t)((body_items).len)) < 2)) {
                            return default_c_type;
                        } else {
                            __auto_type _mv_1183 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                ...
                                switch (_mv_1184.tag) {
                                    case types_SExpr_sym:
                                    {
                                        ...
                                        if (string_eq(sym.name, SLOP_STR("Array"))) {
                                            __auto_type _mv_1185 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_1185.has_value) {
                                                __auto_type elem_expr = _mv_1185.value;
                                                {
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1197.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    __auto_type _mv_1198 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void transpiler_transpile_module(context_TranspileContext* ctx, types_SExpr* module_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1200 = (*module_expr);
        switch (_mv_1200.tag) {
            case types_SExpr_lst:
            {
...
int64_t transpiler_get_body_start(slop_list_types_SExpr_ptr items) {
    if ((((int64_t)((items).len)) < 3)) {
        ...
        if (_mv_1203.has_value) {
            __auto_type third = _mv_1203.value;
            __auto_type _mv_1204 = (*third);
            switch (_mv_1204.tag) {
                case types_SExpr_lst:
                {
                    __auto_type lst = _mv_1204.data.lst;
                    {
                        __auto_type sub_items = lst.items;
                        if ((((int64_t)((sub_items).len)) < 1)) {
                            return 2;
                        } else {
                            __auto_type _mv_1205 = ({ __auto_type _lst = sub_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_1205.has_value) {
                                __auto_type head = _mv_1205.value;
                                __auto_type _mv_1206 = (*head);
                                switch (_mv_1206.tag) {
                                    case types_SExpr_sym:
                                    {
                ...
                switch (_mv_1208.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type lst = _mv_1208.data.lst;
                        {
                            __auto_type sub_items = lst.items;
                            if ((((int64_t)((sub_items).len)) >= 1)) {
                                __auto_type _mv_1209 = ({ __auto_type _lst = sub_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            ...
                                            if (string_eq(sym.name, SLOP_STR("export"))) {
                                                {
                                                    ...
                                                    __auto_type j = 1;
                                                    while ((j < export_len)) {
                                                        __auto_type _mv_1211 = ({ __auto_type _lst = sub_items; size_t _idx = (size_t)j; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                        if (_mv_1211.has_value) {
                                                            ...
                                                            switch (_mv_1212.tag) {
                                                                case types_SExpr_sym:
                                                                {
                                                                    __auto_type name_sym = _mv_1212.data.sym;
...
uint8_t transpiler_list_contains_str(slop_list_string lst, slop_string needle) {
    {
        ...
        uint8_t found = 0;
        while (((i < len) && !(found))) {
            __auto_type _mv_1213 = ({ __auto_type _lst = lst; size_t _idx = (size_t)i; slop_option_string _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1213.has_value) {
                __auto_type s = _mv_1213.value;
        ...
        switch (_mv_1215.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1215.data.lst;
                {
                    ...
                    __auto_type len = ((int64_t)((items).len));
                    if ((len >= 1)) {
                        __auto_type _mv_1216 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                ...
                                case types_SExpr_sym:
                                {
                                    __auto_type sym = _mv_1217.data.sym;
                                    {
                                        ...
                                        if (string_eq(op, SLOP_STR("Option"))) {
                                            if ((len >= 2)) {
                                                __auto_type _mv_1218 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            ...
                                            if ((len >= 2)) {
                                                ...
                                                if (_mv_1219.has_value) {
                                                    __auto_type elem = _mv_1219.value;
                                                    {
                                            ...
                                            if ((len >= 3)) {
                                                ...
                                                if (_mv_1221.has_value) {
                                                    __auto_type ok_type = _mv_1221.value;
                                                    ...
                                                    if (_mv_1222.has_value) {
                                                        __auto_type err_type = _mv_1222.value;
                                                        {
                                            ...
                                            if ((len >= 2)) {
                                                ...
                                                if (_mv_1223.has_value) {
                                                    __auto_type elem = _mv_1223.value;
                                                    {
                                                        __auto_type elem_c = context_to_c_type_prefixed(ctx, elem);
                                                        __auto_type elem_id = ctype_type_to_identifier(arena, elem_c);
                                                        __auto_type c_name = context_ctx_str(ctx, SLOP_STR("slop_chan_"), elem_id);
                                            ...
                                            if ((len >= 2)) {
                                                ...
                                                if (_mv_1224.has_value) {
                                                    __auto_type result = _mv_1224.value;
                                                    {
                                            ...
                                            if ((len >= 3)) {
                                                ...
                                                if (_mv_1225.has_value) {
                                                    __auto_type key_type = _mv_1225.value;
                                                    {
                                                        ...
                                                        __auto_type _mv_1226 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                        if (_mv_1226.has_value) {
                                                            __auto_type val_type = _mv_1226.value;
                                            ...
                                            if ((len >= 2)) {
                                                ...
                                                if (_mv_1227.has_value) {
                                                    __auto_type elem_type = _mv_1227.value;
                                                    {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while ((i < len)) {
            ...
            if (_mv_1228.has_value) {
                __auto_type field_expr = _mv_1228.value;
                __auto_type _mv_1229 = (*field_expr);
                switch (_mv_1229.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type field_lst = _mv_1229.data.lst;
                        {
                            __auto_type field_items = field_lst.items;
                            if ((((int64_t)((field_items).len)) >= 2)) {
                                __auto_type _mv_1230 = ({ __auto_type _lst = field_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void transpiler_emit_ffi_includes(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1231 = ({ __auto_type _lst = includes; size_t _idx = (size_t)i; slop_option_string _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1231.has_value) {
                __auto_type header = _mv_1231.value;
...
void transpiler_emit_ffi_includes_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1232 = ({ __auto_type _lst = includes; size_t _idx = (size_t)i; slop_option_string _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1232.has_value) {
                __auto_type header = _mv_1232.value;
...
void transpiler_emit_header_guard_open(context_TranspileContext* ctx) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1233 = context_ctx_get_module(ctx);
        if (_mv_1233.has_value) {
            __auto_type mod_name = _mv_1233.value;
            {
...
void transpiler_emit_header_dependency_includes(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1234 = ({ __auto_type _lst = imports; size_t _idx = (size_t)i; slop_option_string _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1234.has_value) {
                __auto_type mod_name = _mv_1234.value;
                {
                    __auto_type c_name = ctype_to_c_name(arena, mod_name);
...
void transpiler_emit_forward_decls(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items, int64_t start) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while ((i < len)) {
            __auto_type _mv_1235 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1235.has_value) {
                __auto_type item = _mv_1235.value;
                if ((transpiler_is_type_def(item) && transpiler_is_struct_type_def(item))) {
                    __auto_type _mv_1236 = transpiler_get_type_name(item);
                    if (_mv_1236.has_value) {
                        __auto_type type_name = _mv_1236.value;
                        {
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1237.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 3)) {
                    ...
                    __auto_type _mv_1238 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_1238.has_value) {
                        __auto_type def_expr = _mv_1238.value;
                        __auto_type _mv_1239 = (*def_expr);
                        switch (_mv_1239.tag) {
                            case types_SExpr_lst:
                            {
                                __auto_type def_lst = _mv_1239.data.lst;
                                {
                                    __auto_type def_items = def_lst.items;
                                    if ((((int64_t)((def_items).len)) < 1)) {
                                        return 0;
                                    } else {
                                        __auto_type _mv_1240 = ({ __auto_type _lst = def_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
uint8_t transpiler_has_enum_payload_variants(slop_list_types_SExpr_ptr items) {
    {
        ...
        uint8_t found = 0;
        while (((i < len) && !(found))) {
            __auto_type _mv_1242 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1242.has_value) {
                ...
                switch (_mv_1243.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type _ = _mv_1243.data.lst;
                        found = 1;
                        break;
                    }
                    default: {
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1244.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 3)) {
                    ...
                    __auto_type _mv_1245 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_1245.has_value) {
                        __auto_type def_expr = _mv_1245.value;
                        __auto_type _mv_1246 = (*def_expr);
                        switch (_mv_1246.tag) {
                            case types_SExpr_sym:
                            {
                                __auto_type _ = _mv_1246.data.sym;
                                return 1;
                            }
                            case types_SExpr_lst:
                            {
                                __auto_type def_lst = _mv_1246.data.lst;
                                {
                                    __auto_type def_items = def_lst.items;
                                    if ((((int64_t)((def_items).len)) < 1)) {
                                        return 0;
                                    } else {
                                        __auto_type _mv_1247 = ({ __auto_type _lst = def_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            ...
            __auto_type lst = _mv_1249.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 3)) {
                    ...
                    if (_mv_1250.has_value) {
                        __auto_type def_expr = _mv_1250.value;
                        __auto_type _mv_1251 = (*def_expr);
                        switch (_mv_1251.tag) {
                            case types_SExpr_lst:
                            {
                                __auto_type def_lst = _mv_1251.data.lst;
                                {
                                    __auto_type def_items = def_lst.items;
                                    if ((((int64_t)((def_items).len)) < 1)) {
                                        return 0;
                                    } else {
                                        __auto_type _mv_1252 = ({ __auto_type _lst = def_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        switch (_mv_1254.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1254.data.lst;
                {
                    __auto_type items = lst.items;
                    if ((((int64_t)((items).len)) >= 3)) {
                        __auto_type _mv_1255 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            ...
                            switch (_mv_1256.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_1256.data.sym;
                                    {
                                        ...
                                        __auto_type _mv_1257 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_1257.has_value) {
                                            __auto_type body_expr = _mv_1257.value;
...
uint8_t transpiler_is_array_type_body(types_SExpr* body_expr) {
    SLOP_PRE(((body_expr != NULL)), "(!= body-expr nil)");
    __auto_type _mv_1258 = (*body_expr);
    switch (_mv_1258.tag) {
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1258.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    __auto_type _mv_1259 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_1259.has_value) {
                        __auto_type head = _mv_1259.value;
                        __auto_type _mv_1260 = (*head);
                        switch (_mv_1260.tag) {
                            case types_SExpr_sym:
                            {
...
void transpiler_emit_array_typedef_to_header(context_TranspileContext* ctx, slop_string c_name, types_SExpr* body_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1261 = (*body_expr);
        switch (_mv_1261.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1261.data.lst;
                {
                    ...
                    if ((len < 3)) {
                        ...
                        if (_mv_1262.has_value) {
                            __auto_type elem_type_expr = _mv_1262.value;
                            ...
                            if (_mv_1263.has_value) {
                                __auto_type size_expr = _mv_1263.value;
                                {
...
slop_string transpiler_get_array_size_string(types_SExpr* expr) {
    SLOP_PRE(((expr != NULL)), "(!= expr nil)");
    __auto_type _mv_1264 = (*expr);
    switch (_mv_1264.tag) {
        case types_SExpr_num:
        {
            __auto_type num = _mv_1264.data.num;
            return num.raw;
        }
        default: {
            return SLOP_STR("0");
...
uint8_t transpiler_is_range_type_body(types_SExpr* body_expr) {
    SLOP_PRE(((body_expr != NULL)), "(!= body-expr nil)");
    __auto_type _mv_1265 = (*body_expr);
    switch (_mv_1265.tag) {
        case types_SExpr_lst:
        {
...
transpiler_RangeBoundsHeader transpiler_parse_range_bounds_header(types_SExpr* body_expr) {
    SLOP_PRE(((body_expr != NULL)), "(!= body-expr nil)");
    {
        ...
        __auto_type _mv_1268 = (*body_expr);
        switch (_mv_1268.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1268.data.lst;
                {
                    ...
                    while ((i < len)) {
                        ...
                        if (_mv_1269.has_value) {
                            ...
                            __auto_type _mv_1270 = (*item);
                            switch (_mv_1270.tag) {
                                case types_SExpr_num:
                                {
                                    __auto_type num = _mv_1270.data.num;
                                    if (!(found_dots)) {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while ((i < len)) {
            ...
            if (_mv_1271.has_value) {
                ...
                if ((transpiler_is_type_def(item) && transpiler_is_struct_type_def(item))) {
                    __auto_type _mv_1272 = transpiler_get_type_name(item);
                    if (_mv_1272.has_value) {
                        __auto_type type_name = _mv_1272.value;
                        {
...
void transpiler_emit_fn_forward_decls_header(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items, int64_t start) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        uint8_t emitted_any = 0;
        while ((i < len)) {
            __auto_type _mv_1274 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void transpiler_emit_c_name_aliases(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len > 0)) {
            ...
            while ((i < len)) {
                __auto_type _mv_1275 = ({ __auto_type _lst = aliases; size_t _idx = (size_t)i; slop_option_context_FuncCNameAlias _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_1275.has_value) {
                    __auto_type alias = _mv_1275.value;
                ...
                __auto_type lst = _mv_1276.data.lst;
                {
                    ...
                    if ((len >= 3)) {
                        ...
                        if (_mv_1277.has_value) {
                            __auto_type name_expr = _mv_1277.value;
                            __auto_type _mv_1278 = (*name_expr);
                            switch (_mv_1278.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_1278.data.sym;
                                    {
                                        ...
                                        if (_mv_1279.has_value) {
                                            __auto_type params_expr = _mv_1279.value;
                                            {
...
void transpiler_emit_result_types(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1287 = ({ __auto_type _lst = result_types; size_t _idx = (size_t)i; slop_option_context_ResultType _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1287.has_value) {
                __auto_type rt = _mv_1287.value;
...
void transpiler_emit_result_types_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1288 = ({ __auto_type _lst = result_types; size_t _idx = (size_t)i; slop_option_context_ResultType _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1288.has_value) {
                __auto_type rt = _mv_1288.value;
...
void transpiler_emit_inline_records_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1289 = ({ __auto_type _lst = inline_records; size_t _idx = (size_t)i; slop_option_context_InlineRecord _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1289.has_value) {
                __auto_type ir = _mv_1289.value;
                {
...
void transpiler_emit_option_types_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1290 = ({ __auto_type _lst = option_types; size_t _idx = (size_t)i; slop_option_context_OptionType _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1290.has_value) {
                __auto_type ot = _mv_1290.value;
...
void transpiler_emit_value_option_types_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1291 = ({ __auto_type _lst = option_types; size_t _idx = (size_t)i; slop_option_context_OptionType _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1291.has_value) {
                __auto_type ot = _mv_1291.value;
...
void transpiler_emit_list_types_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1293 = ({ __auto_type _lst = list_types; size_t _idx = (size_t)i; slop_option_context_ListType _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1293.has_value) {
                __auto_type lt = _mv_1293.value;
...
void transpiler_emit_primitive_option_types_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1295 = ({ __auto_type _lst = option_types; size_t _idx = (size_t)i; slop_option_context_OptionType _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1295.has_value) {
                __auto_type ot = _mv_1295.value;
...
void transpiler_emit_complex_value_list_types_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1300 = ({ __auto_type _lst = list_types; size_t _idx = (size_t)i; slop_option_context_ListType _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1300.has_value) {
                __auto_type lt = _mv_1300.value;
...
void transpiler_emit_union_payload_hash_eq(context_TranspileContext* ctx, slop_list_context_UnionVariantEntry variants) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1301 = ({ __auto_type _lst = variants; size_t _idx = (size_t)i; slop_option_context_UnionVariantEntry _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1301.has_value) {
                __auto_type variant = _mv_1301.value;
                {
...
void transpiler_emit_record_field_dependencies(context_TranspileContext* ctx, slop_list_context_FieldEntry fields) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1302 = ({ __auto_type _lst = fields; size_t _idx = (size_t)i; slop_option_context_FieldEntry _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1302.has_value) {
                __auto_type field = _mv_1302.value;
                {
...
uint8_t transpiler_is_range_type_alias(context_TranspileContext* ctx, slop_string slop_type) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    __auto_type _mv_1303 = context_ctx_lookup_type_alias(ctx, slop_type);
    if (_mv_1303.has_value) {
        __auto_type underlying = _mv_1303.value;
...
void transpiler_emit_union_hash_fn(context_TranspileContext* ctx, slop_string c_type, slop_list_context_UnionVariantEntry variants) {
    ...
    context_ctx_emit_header(ctx, SLOP_STR("    switch (_k->tag) {"));
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1304 = ({ __auto_type _lst = variants; size_t _idx = (size_t)i; slop_option_context_UnionVariantEntry _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1304.has_value) {
                __auto_type variant = _mv_1304.value;
...
void transpiler_emit_union_eq_fn(context_TranspileContext* ctx, slop_string c_type, slop_list_context_UnionVariantEntry variants) {
    ...
    context_ctx_emit_header(ctx, SLOP_STR("    switch (_a->tag) {"));
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1305 = ({ __auto_type _lst = variants; size_t _idx = (size_t)i; slop_option_context_UnionVariantEntry _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1305.has_value) {
                __auto_type variant = _mv_1305.value;
...
void transpiler_emit_struct_hash_fn(context_TranspileContext* ctx, slop_string c_type, slop_list_context_FieldEntry fields) {
    ...
    context_ctx_emit_header(ctx, SLOP_STR("    uint64_t hash = 14695981039346656037ULL;"));
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1306 = ({ __auto_type _lst = fields; size_t _idx = (size_t)i; slop_option_context_FieldEntry _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1306.has_value) {
                __auto_type field = _mv_1306.value;
    ...
    context_ctx_emit_header(ctx, context_ctx_str(ctx, context_ctx_str4(ctx, SLOP_STR("    const "), c_type, SLOP_STR("* _b = (const "), c_type), SLOP_STR("*)b;")));
    {
        ...
        if ((len == 0)) {
            ...
            context_ctx_emit_header(ctx, SLOP_STR("    return true"));
            {
                int64_t i = 0;
                while ((i < len)) {
                    __auto_type _mv_1307 = ({ __auto_type _lst = fields; size_t _idx = (size_t)i; slop_option_context_FieldEntry _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_1307.has_value) {
                        __auto_type field = _mv_1307.value;
...
void transpiler_emit_struct_key_types_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while ((i < ((int64_t)((struct_key_types).len)))) {
            __auto_type _mv_1308 = ({ __auto_type _lst = struct_key_types; size_t _idx = (size_t)i; slop_option_string _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1308.has_value) {
                __auto_type c_type = _mv_1308.value;
                {
                    __auto_type guard_name = context_ctx_str3(ctx, transpiler_uppercase_name(ctx, c_type), SLOP_STR("_HASH_EQ_DEFINED"), SLOP_STR(""));
...
void transpiler_emit_chan_types_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1309 = ({ __auto_type _lst = chan_types; size_t _idx = (size_t)i; slop_option_context_ChanType _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1309.has_value) {
                __auto_type ct = _mv_1309.value;
                {
...
void transpiler_emit_chan_funcs_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1310 = ({ __auto_type _lst = chan_types; size_t _idx = (size_t)i; slop_option_context_ChanType _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1310.has_value) {
                __auto_type ct = _mv_1310.value;
                {
                    __auto_type elem_type = ct.elem_type;
                    __auto_type c_name = ct.c_name;
...
void transpiler_emit_thread_types_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1311 = ({ __auto_type _lst = thread_types; size_t _idx = (size_t)i; slop_option_context_ThreadType _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1311.has_value) {
                __auto_type tt = _mv_1311.value;
                {
...
void transpiler_emit_pending_container_deps(context_TranspileContext* ctx, types_SExpr* type_def) {
    ...
    SLOP_PRE(((type_def != NULL)), "(!= type-def nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1323 = ({ __auto_type _lst = field_types; size_t _idx = (size_t)i; slop_option_string _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1323.has_value) {
                __auto_type field_type = _mv_1323.value;
...
void transpiler_emit_option_by_c_name(context_TranspileContext* ctx, slop_string c_name) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1324 = ({ __auto_type _lst = option_types; size_t _idx = (size_t)i; slop_option_context_OptionType _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1324.has_value) {
                __auto_type ot = _mv_1324.value;
...
void transpiler_emit_list_by_c_name(context_TranspileContext* ctx, slop_string c_name) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1325 = ({ __auto_type _lst = list_types; size_t _idx = (size_t)i; slop_option_context_ListType _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1325.has_value) {
                __auto_type lt = _mv_1325.value;
...
uint8_t transpiler_index_in_list(slop_list_int lst, int64_t idx) {
    {
        ...
        uint8_t found = 0;
        while (((i < len) && !(found))) {
            __auto_type _mv_1327 = ({ __auto_type _lst = lst; size_t _idx = (size_t)i; slop_option_int _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1327.has_value) {
                __auto_type v = _mv_1327.value;
                if ((v == idx)) {
                    found = 1;
                }
...
uint8_t transpiler_type_deps_satisfied(context_TranspileContext* ctx, types_SExpr* type_def) {
    ...
    SLOP_PRE(((type_def != NULL)), "(!= type-def nil)");
    {
        ...
        while (((i < len) && all_satisfied)) {
            __auto_type _mv_1328 = ({ __auto_type _lst = field_types; size_t _idx = (size_t)i; slop_option_string _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1328.has_value) {
                __auto_type field_type = _mv_1328.value;
        ...
        switch (_mv_1329.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1329.data.lst;
                {
                    __auto_type items = lst.items;
                    if ((((int64_t)((items).len)) >= 3)) {
                        __auto_type _mv_1330 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            ...
                            switch (_mv_1331.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type def_lst = _mv_1331.data.lst;
                                    {
                                        ...
                                        if ((def_len > 0)) {
                                            __auto_type _mv_1332 = ({ __auto_type _lst = def_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_list_string transpiler_extract_record_field_types(context_TranspileContext* ctx, slop_list_types_SExpr_ptr def_items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 1;
        while ((i < len)) {
            __auto_type _mv_1334 = ({ __auto_type _lst = def_items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1334.has_value) {
                __auto_type field_expr = _mv_1334.value;
                __auto_type _mv_1335 = (*field_expr);
                switch (_mv_1335.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type field_lst = _mv_1335.data.lst;
                        if ((((int64_t)((field_lst.items).len)) >= 2)) {
                            __auto_type _mv_1336 = ({ __auto_type _lst = field_lst.items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_list_string transpiler_extract_union_variant_types(context_TranspileContext* ctx, slop_list_types_SExpr_ptr def_items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 1;
        while ((i < len)) {
            __auto_type _mv_1337 = ({ __auto_type _lst = def_items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1337.has_value) {
                __auto_type variant_expr = _mv_1337.value;
                __auto_type _mv_1338 = (*variant_expr);
                switch (_mv_1338.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type variant_lst = _mv_1338.data.lst;
                        if ((((int64_t)((variant_lst.items).len)) >= 2)) {
                            __auto_type _mv_1339 = ({ __auto_type _lst = variant_lst.items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_1339.has_value) {
                                __auto_type type_expr = _mv_1339.value;
                                {
                                    __auto_type type_str = transpiler_get_field_type_string(ctx, type_expr);
                                    if (!(string_eq(type_str, SLOP_STR("")))) {
                                        ({ __auto_type _lst_p = &(result); __auto_type _item = (type_str); if (_lst_p->len >= _lst_p->cap) { size_t _new_cap = _lst_p->cap == 0 ? 16 : _lst_p->cap * 2; __typeof__(_lst_p->data) _new_data = (__typeof__(_lst_p->data))slop_arena_alloc(arena, _new_cap * sizeof(*_lst_p->data)); if (_lst_p->len > 0) memcpy(_new_data, _lst_p->data, _lst_p->len * sizeof(*_lst_p->data)); _lst_p->data = _new_data; _lst_p->cap = _new_cap; } _lst_p->data[_lst_p->len++] = _item; (void)0; });
            ...
            case types_SExpr_sym:
            {
                __auto_type sym = _mv_1340.data.sym;
                {
                    ...
                    if (_mv_1341.has_value) {
                        __auto_type entry = _mv_1341.value;
                        return entry.c_name;
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1340.data.lst;
                {
                    ...
                    if ((((int64_t)((items).len)) < 1)) {
                        ...
                        __auto_type _mv_1342 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_1342.has_value) {
                            __auto_type head = _mv_1342.value;
                            __auto_type _mv_1343 = (*head);
                            switch (_mv_1343.tag) {
                                case types_SExpr_sym:
                                {
                                        ...
                                        if (string_eq(kind, SLOP_STR("Ptr"))) {
                                            ...
                                            if ((((int64_t)((items).len)) >= 2)) {
                                                ...
                                                if (_mv_1344.has_value) {
                                                    __auto_type inner = _mv_1344.value;
                                                    {
                                            ...
                                            if ((((int64_t)((items).len)) >= 2)) {
                                                __auto_type _mv_1345 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_1345.has_value) {
                                                    __auto_type inner = _mv_1345.value;
                                                    {
                                                        __auto_type inner_str = transpiler_get_field_type_string(ctx, inner);
                                                        if (string_eq(inner_str, SLOP_STR(""))) {
                                                            return SLOP_STR("");
                    ...
                    if (_mv_1347.has_value) {
                        ...
                        switch (_mv_1348.tag) {
                            case types_SExpr_sym:
                            {
                                ...
                                {
                                    __auto_type name = sym.name;
                                    __auto_type _mv_1349 = context_ctx_lookup_type(ctx, name);
                                    if (_mv_1349.has_value) {
                                        __auto_type entry = _mv_1349.value;
                                        return entry.c_name;
        ...
        if (!(found)) {
            {
                ...
                int64_t j = 0;
                while (((j < len2) && !(found))) {
                    __auto_type _mv_1353 = ({ __auto_type _lst = option_types; size_t _idx = (size_t)j; slop_option_context_OptionType _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
uint8_t transpiler_is_imported_type(context_TranspileContext* ctx, slop_string type_name) {
    ...
    if ((strlib_starts_with(type_name, SLOP_STR("slop_list_")) || strlib_starts_with(type_name, SLOP_STR("slop_option_")))) {
        ...
        __auto_type _mv_1358 = context_ctx_get_module(ctx);
        if (_mv_1358.has_value) {
            __auto_type current_mod = _mv_1358.value;
            {
                __auto_type arena = (*ctx).arena;
    ...
    if (strlib_starts_with(inner_type, SLOP_STR("slop_list_"))) {
        {
            ...
            int64_t i = 0;
            while ((i < len)) {
                __auto_type _mv_1359 = ({ __auto_type _lst = list_types; size_t _idx = (size_t)i; slop_option_context_ListType _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
uint8_t transpiler_struct_uses_list_type(context_TranspileContext* ctx, types_SExpr* type_def, slop_string list_type_name) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1361 = (*type_def);
        switch (_mv_1361.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1361.data.lst;
                {
                    __auto_type items = lst.items;
                    if ((((int64_t)((items).len)) < 3)) {
                        return 0;
                        ...
                        if (_mv_1362.has_value) {
                            __auto_type body_expr = _mv_1362.value;
...
uint8_t transpiler_type_body_uses_typename(context_TranspileContext* ctx, types_SExpr* body_expr, slop_string typename) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1363 = (*body_expr);
        switch (_mv_1363.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1363.data.lst;
                {
                    ...
                    while (((i < len) && !(found))) {
                        ...
                        if (_mv_1364.has_value) {
                            __auto_type field_expr = _mv_1364.value;
...
uint8_t transpiler_field_uses_typename(context_TranspileContext* ctx, types_SExpr* field_expr, slop_string typename) {
    ...
    __auto_type _mv_1365 = (*field_expr);
    switch (_mv_1365.tag) {
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1365.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 2)) {
                    ...
                    if (_mv_1366.has_value) {
                        __auto_type type_expr = _mv_1366.value;
                        {
                            __auto_type c_type = context_to_c_type_prefixed(ctx, type_expr);
                ...
                __auto_type lst = _mv_1367.data.lst;
                {
                    ...
                    if ((len >= 3)) {
                        ...
                        if (_mv_1368.has_value) {
                            __auto_type name_expr = _mv_1368.value;
                            __auto_type _mv_1369 = (*name_expr);
                            switch (_mv_1369.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_1369.data.sym;
                                    {
                                        __auto_type type_name = name_sym.name;
                                        __auto_type base_name = ctype_to_c_name(arena, type_name);
                                        __auto_type c_name = ((context_ctx_prefixing_enabled(ctx)) ? ({ __auto_type _mv = context_ctx_get_module(ctx); _mv.has_value ? ({ __auto_type mod_name = _mv.value; context_ctx_str(ctx, ctype_to_c_name(arena, mod_name), context_ctx_str(ctx, SLOP_STR("_"), base_name)); }) : (base_name); }) : base_name);
                                        ...
                                        if (_mv_1370.has_value) {
                                            __auto_type body_expr = _mv_1370.value;
...
void transpiler_emit_type_body_to_header(context_TranspileContext* ctx, slop_string raw_type_name, slop_string c_name, types_SExpr* body_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1371 = (*body_expr);
        switch (_mv_1371.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1371.data.lst;
                {
                    __auto_type items = lst.items;
                    if ((((int64_t)((items).len)) < 1)) {
                    } else {
                        __auto_type _mv_1372 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_1372.has_value) {
                            __auto_type kind_expr = _mv_1372.value;
                            __auto_type _mv_1373 = (*kind_expr);
                            switch (_mv_1373.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type kind_sym = _mv_1373.data.sym;
                                    {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while ((i < len)) {
            ...
            if (_mv_1374.has_value) {
                __auto_type variant_expr = _mv_1374.value;
                __auto_type _mv_1375 = (*variant_expr);
                switch (_mv_1375.tag) {
                    case types_SExpr_sym:
                    {
                        __auto_type variant_sym = _mv_1375.data.sym;
                        {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while ((i < len)) {
            ...
            if (_mv_1376.has_value) {
                __auto_type field_expr = _mv_1376.value;
...
void transpiler_emit_field_to_header(context_TranspileContext* ctx, slop_string raw_type_name, slop_string c_type_name, types_SExpr* field_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1377 = (*field_expr);
        switch (_mv_1377.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1377.data.lst;
                {
                    __auto_type items = lst.items;
                    if ((((int64_t)((items).len)) >= 2)) {
                        __auto_type _mv_1378 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_1378.has_value) {
                            ...
                            switch (_mv_1379.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_1379.data.sym;
                                    {
                                        __auto_type field_name = name_sym.name;
                                        __auto_type c_field_name = ctype_to_c_name(arena, field_name);
                                        __auto_type _mv_1380 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_1380.has_value) {
                                            __auto_type type_expr = _mv_1380.value;
                                            {
                                                __auto_type c_type = context_to_c_type_prefixed(ctx, type_expr);
...
void transpiler_emit_union_to_header(context_TranspileContext* ctx, slop_string c_name, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        context_ctx_emit_header(ctx, SLOP_STR("typedef enum {"));
        {
            int64_t i = 1;
            while ((i < len)) {
                __auto_type _mv_1384 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_1384.has_value) {
                    __auto_type variant_expr = _mv_1384.value;
                    {
        ...
        context_ctx_emit_header(ctx, SLOP_STR("    union {"));
        {
            ...
            while ((i < len)) {
                ...
                if (_mv_1385.has_value) {
                    __auto_type variant_expr = _mv_1385.value;
...
slop_string transpiler_get_variant_name(types_SExpr* variant_expr) {
    ...
    __auto_type _mv_1386 = (*variant_expr);
    switch (_mv_1386.tag) {
        case types_SExpr_sym:
        {
...
void transpiler_emit_union_variant_to_header(context_TranspileContext* ctx, types_SExpr* variant_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1389 = (*variant_expr);
        switch (_mv_1389.tag) {
            case types_SExpr_sym:
            {
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1389.data.lst;
                {
                    __auto_type items = lst.items;
                    if ((((int64_t)((items).len)) >= 2)) {
                        __auto_type _mv_1390 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_1390.has_value) {
                            __auto_type name_expr = _mv_1390.value;
                            __auto_type _mv_1391 = (*name_expr);
                            switch (_mv_1391.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_1391.data.sym;
                                    {
                                        __auto_type variant_name = name_sym.name;
...
void transpiler_emit_module_consts_header(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items, int64_t start, slop_list_string exports) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        uint8_t emitted_any = 0;
        while ((i < len)) {
            __auto_type _mv_1397 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1398.data.lst;
            {
                ...
                if ((((int64_t)((const_items).len)) < 4)) {
                    ...
                    __auto_type _mv_1399 = ({ __auto_type _lst = const_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            ...
                            case types_SExpr_sym:
                            {
                                __auto_type name_sym = _mv_1400.data.sym;
                                {
                                    ...
                                    if (!(transpiler_list_contains_str(exports, raw_name))) {
                                        ...
                                        __auto_type _mv_1401 = ({ __auto_type _lst = const_items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void transpiler_emit_all_lambdas(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((count > 0)) {
            while ((i < count)) {
                __auto_type _mv_1403 = ({ __auto_type _lst = lambdas; size_t _idx = (size_t)i; slop_option_string _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_1403.has_value) {
                    __auto_type lambda_code = _mv_1403.value;
...
slop_string transpiler_generate_c_output(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        int64_t i = 0;
        while ((i < len)) {
            __auto_type _mv_1404 = ({ __auto_type _lst = output_lines; size_t _idx = (size_t)i; slop_option_string _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1404.has_value) {
                __auto_type line = _mv_1404.value;
...
void transpiler_transpile_file(context_TranspileContext* ctx, slop_list_types_SExpr_ptr exprs) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (((len > 0) && transpiler_is_module_expr(exprs))) {
            __auto_type _mv_1405 = ({ __auto_type _lst = exprs; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1405.has_value) {
                __auto_type module_expr = _mv_1405.value;
...
uint8_t transpiler_is_module_expr(slop_list_types_SExpr_ptr exprs) {
    if ((((int64_t)((exprs).len)) < 1)) {
        ...
        __auto_type _mv_1406 = ({ __auto_type _lst = exprs; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        if (_mv_1406.has_value) {
            __auto_type first = _mv_1406.value;
            __auto_type _mv_1407 = (*first);
            switch (_mv_1407.tag) {
                case types_SExpr_lst:
                {
