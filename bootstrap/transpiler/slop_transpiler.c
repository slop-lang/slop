...
void transpiler_prescan_module(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        __auto_type i = 0;
        while ((i < len)) {
            __auto_type _mv_961 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_961.has_value) {
                __auto_type item = _mv_961.value;
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_962.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) >= 1)) {
                    __auto_type _mv_963 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_963.has_value) {
                        __auto_type head = _mv_963.value;
                        __auto_type _mv_964 = (*head);
                        switch (_mv_964.tag) {
                            case types_SExpr_sym:
                            {
                                __auto_type sym = _mv_964.data.sym;
                                {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((((int64_t)((items).len)) >= 2)) {
            ...
            if (_mv_965.has_value) {
                __auto_type name_expr = _mv_965.value;
                __auto_type _mv_966 = (*name_expr);
                switch (_mv_966.tag) {
                    case types_SExpr_sym:
                    {
                        __auto_type sym = _mv_966.data.sym;
                        {
                            ...
                            __auto_type c_name = ((context_ctx_prefixing_enabled(ctx)) ? ({ __auto_type _mv = context_ctx_get_module(ctx); _mv.has_value ? ({ __auto_type mod_name = _mv.value; context_ctx_str(ctx, ctype_to_c_name(arena, mod_name), context_ctx_str(ctx, SLOP_STR("_"), base_c_name)); }) : (base_c_name); }) : base_c_name);
                            {
                                ...
                                if ((is_record || is_union)) {
                                    if ((((int64_t)((items).len)) >= 3)) {
                                        ...
                                        if (_mv_967.has_value) {
                                            __auto_type def_expr = _mv_967.value;
                                            __auto_type _mv_968 = (*def_expr);
                                            switch (_mv_968.tag) {
                                                case types_SExpr_lst:
                                                {
                                                    __auto_type def_lst = _mv_968.data.lst;
                                ...
                                if ((((int64_t)((items).len)) >= 3)) {
                                    __auto_type _mv_969 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    if (_mv_969.has_value) {
                                        __auto_type body_expr = _mv_969.value;
...
void transpiler_register_enum_variants(context_TranspileContext* ctx, slop_string enum_name, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    if ((((int64_t)((items).len)) >= 3)) {
        __auto_type _mv_970 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        if (_mv_970.has_value) {
            __auto_type def_expr = _mv_970.value;
            __auto_type _mv_971 = (*def_expr);
            switch (_mv_971.tag) {
                case types_SExpr_lst:
                {
                    __auto_type def_lst = _mv_971.data.lst;
                    {
                        __auto_type def_items = def_lst.items;
                        __auto_type len = ((int64_t)((def_items).len));
                        __auto_type i = 1;
                        while ((i < len)) {
                            __auto_type _mv_972 = ({ __auto_type _lst = def_items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_972.has_value) {
                                __auto_type variant_expr = _mv_972.value;
                                __auto_type _mv_973 = (*variant_expr);
                                switch (_mv_973.tag) {
                                    case types_SExpr_sym:
                                    {
                                    ...
                                    case types_SExpr_lst:
                                    {
                                        __auto_type variant_lst = _mv_973.data.lst;
                                        if ((((int64_t)((variant_lst.items).len)) > 0)) {
                                            __auto_type _mv_974 = ({ __auto_type _lst = variant_lst.items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_974.has_value) {
                                                __auto_type name_expr = _mv_974.value;
                                                __auto_type _mv_975 = (*name_expr);
                                                switch (_mv_975.tag) {
                                                    case types_SExpr_sym:
                                                    {
                                                        __auto_type name_sym = _mv_975.data.sym;
...
void transpiler_register_union_variants(context_TranspileContext* ctx, slop_string union_name, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        __auto_type arena = (*ctx).arena;
        if ((((int64_t)((items).len)) >= 3)) {
            __auto_type _mv_976 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_976.has_value) {
                __auto_type def_expr = _mv_976.value;
                __auto_type _mv_977 = (*def_expr);
                switch (_mv_977.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type def_lst = _mv_977.data.lst;
                        {
                            __auto_type def_items = def_lst.items;
                            __auto_type len = ((int64_t)((def_items).len));
                            __auto_type i = 1;
                            while ((i < len)) {
                                __auto_type _mv_978 = ({ __auto_type _lst = def_items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_978.has_value) {
                                    __auto_type variant_expr = _mv_978.value;
                                    __auto_type _mv_979 = (*variant_expr);
                                    switch (_mv_979.tag) {
                                        case types_SExpr_sym:
                                        {
                                        ...
                                        case types_SExpr_lst:
                                        {
                                            __auto_type variant_lst = _mv_979.data.lst;
                                            {
                                                __auto_type vl_items = variant_lst.items;
                                                if ((((int64_t)((vl_items).len)) >= 2)) {
                                                    __auto_type _mv_980 = ({ __auto_type _lst = vl_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_980.has_value) {
                                                        __auto_type name_expr = _mv_980.value;
                                                        __auto_type _mv_981 = (*name_expr);
                                                        switch (_mv_981.tag) {
                                                            case types_SExpr_sym:
                                                            {
                                                                __auto_type name_sym = _mv_981.data.sym;
                                                                {
                                                                    __auto_type variant_name = name_sym.name;
                                                                    __auto_type c_variant_name = ctype_to_c_name(arena, variant_name);
                                                                    context_ctx_register_enum_variant(ctx, variant_name, union_name);
                                                                    __auto_type _mv_982 = ({ __auto_type _lst = vl_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                                    if (_mv_982.has_value) {
                                                                        __auto_type type_expr = _mv_982.value;
                                                                        {
                    ...
                    case types_SExpr_lst:
                    {
                        __auto_type lst = _mv_986.data.lst;
                        {
                            ...
                            if ((((int64_t)((sub_items).len)) >= 2)) {
                                __auto_type _mv_987 = ({ __auto_type _lst = sub_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                    ...
                                    switch (_mv_988.tag) {
                                        case types_SExpr_sym:
                                        {
                                            ...
                                            if (string_eq(sym.name, SLOP_STR("@spec"))) {
                                                __auto_type _mv_989 = ({ __auto_type _lst = sub_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_989.has_value) {
                                                    __auto_type spec_body = _mv_989.value;
                                                    __auto_type _mv_990 = (*spec_body);
                                                    switch (_mv_990.tag) {
                                                        case types_SExpr_lst:
                                                        {
                                                            __auto_type body_lst = _mv_990.data.lst;
                                                            {
                                                                __auto_type body_items = body_lst.items;
                                                                __auto_type body_len = ((int64_t)((body_items).len));
                                                                if ((body_len >= 1)) {
                                                                    __auto_type _mv_991 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)(body_len - 1); slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                                    if (_mv_991.has_value) {
                                                                        __auto_type ret_type = _mv_991.value;
                                                                        __auto_type _mv_992 = (*ret_type);
                                                                        switch (_mv_992.tag) {
                                                                            case types_SExpr_sym:
                                                                            {
                                                                                __auto_type ret_sym = _mv_992.data.sym;
...
slop_string transpiler_fn_return_type(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while (((i < len) && string_eq(result, SLOP_STR("")))) {
            __auto_type _mv_993 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_993.has_value) {
                __auto_type item = _mv_993.value;
                __auto_type _mv_994 = (*item);
                switch (_mv_994.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type lst = _mv_994.data.lst;
                        {
                            __auto_type sub_items = lst.items;
                            if ((((int64_t)((sub_items).len)) >= 2)) {
                                __auto_type _mv_995 = ({ __auto_type _lst = sub_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_995.has_value) {
                                    ...
                                    switch (_mv_996.tag) {
                                        case types_SExpr_sym:
                                        {
                                            ...
                                            if (string_eq(sym.name, SLOP_STR("@spec"))) {
                                                __auto_type _mv_997 = ({ __auto_type _lst = sub_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_997.has_value) {
                                                    __auto_type spec_body = _mv_997.value;
                                                    __auto_type _mv_998 = (*spec_body);
                                                    switch (_mv_998.tag) {
                                                        case types_SExpr_lst:
                                                        {
                                                            __auto_type body_lst = _mv_998.data.lst;
                                                            {
                                                                __auto_type body_items = body_lst.items;
                                                                __auto_type body_len = ((int64_t)((body_items).len));
                                                                if ((body_len >= 1)) {
                                                                    __auto_type _mv_999 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)(body_len - 1); slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                                    if (_mv_999.has_value) {
                                                                        __auto_type ret_type = _mv_999.value;
...
void transpiler_prescan_fn_params(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    if ((((int64_t)((items).len)) >= 3)) {
        __auto_type _mv_1000 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        if (_mv_1000.has_value) {
            __auto_type params_expr = _mv_1000.value;
            __auto_type _mv_1001 = (*params_expr);
            switch (_mv_1001.tag) {
                case types_SExpr_lst:
                {
                    __auto_type params_lst = _mv_1001.data.lst;
                    {
                        __auto_type params = params_lst.items;
                        __auto_type param_count = ((int64_t)((params).len));
                        __auto_type i = 0;
                        while ((i < param_count)) {
                            __auto_type _mv_1002 = ({ __auto_type _lst = params; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_1002.has_value) {
                                __auto_type param_expr = _mv_1002.value;
                                __auto_type _mv_1003 = (*param_expr);
                                switch (_mv_1003.tag) {
                                    case types_SExpr_lst:
                                    {
                                        __auto_type param_lst = _mv_1003.data.lst;
                                        {
                                            __auto_type param_items = param_lst.items;
                                            if ((((int64_t)((param_items).len)) >= 2)) {
                                                __auto_type _mv_1004 = ({ __auto_type _lst = param_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_1004.has_value) {
                                                    __auto_type type_expr = _mv_1004.value;
...
slop_list_context_FuncParamType_ptr transpiler_prescan_collect_param_types(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((((int64_t)((items).len)) >= 3)) {
            __auto_type _mv_1005 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1005.has_value) {
                __auto_type params_expr = _mv_1005.value;
                __auto_type _mv_1006 = (*params_expr);
                switch (_mv_1006.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type params_lst = _mv_1006.data.lst;
                        {
                            __auto_type params = params_lst.items;
                            __auto_type param_count = ((int64_t)((params).len));
                            __auto_type i = 0;
                            while ((i < param_count)) {
                                __auto_type _mv_1007 = ({ __auto_type _lst = params; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1007.has_value) {
                                    __auto_type param_expr = _mv_1007.value;
                                    {
                ...
                __auto_type lst = _mv_1008.data.lst;
                {
                    ...
                    if ((len < 2)) {
                    ...
                    } else {
                        {
                            ...
                            __auto_type _mv_1009 = ({ __auto_type _lst = items; size_t _idx = (size_t)type_idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_1009.has_value) {
                                __auto_type type_expr = _mv_1009.value;
...
uint8_t transpiler_prescan_is_param_mode(slop_list_types_SExpr_ptr items) {
    if ((((int64_t)((items).len)) < 1)) {
        ...
        if (_mv_1010.has_value) {
            __auto_type first = _mv_1010.value;
            __auto_type _mv_1011 = (*first);
            switch (_mv_1011.tag) {
                case types_SExpr_sym:
                {
...
void transpiler_prescan_fn_result_type(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        __auto_type i = 3;
        while ((i < len)) {
            __auto_type _mv_1012 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1012.has_value) {
                __auto_type item = _mv_1012.value;
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1013.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    __auto_type _mv_1014 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_1014.has_value) {
                        __auto_type head = _mv_1014.value;
                        __auto_type _mv_1015 = (*head);
                        switch (_mv_1015.tag) {
                            case types_SExpr_sym:
                            {
...
void transpiler_extract_result_type(context_TranspileContext* ctx, types_SExpr* spec_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1016 = (*spec_expr);
        switch (_mv_1016.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1016.data.lst;
                {
                    __auto_type items = lst.items;
                    if ((((int64_t)((items).len)) >= 2)) {
                        __auto_type _mv_1017 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_1017.has_value) {
                            __auto_type spec_body = _mv_1017.value;
                            __auto_type _mv_1018 = (*spec_body);
                            switch (_mv_1018.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type body_lst = _mv_1018.data.lst;
                                    {
                                        __auto_type body_items = body_lst.items;
                                        __auto_type body_len = ((int64_t)((body_items).len));
                                        if ((body_len >= 1)) {
                                            __auto_type _mv_1019 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)(body_len - 1); slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_1019.has_value) {
                                                __auto_type ret_type = _mv_1019.value;
...
void transpiler_check_and_register_result_type(context_TranspileContext* ctx, types_SExpr* type_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1020 = (*type_expr);
        switch (_mv_1020.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1020.data.lst;
                {
                    __auto_type items = lst.items;
                    if ((((int64_t)((items).len)) >= 3)) {
                        __auto_type _mv_1021 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            ...
                            switch (_mv_1022.tag) {
                                case types_SExpr_sym:
                                {
                                    ...
                                    if (string_eq(sym.name, SLOP_STR("Result"))) {
                                        __auto_type _mv_1023 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_1023.has_value) {
                                            __auto_type ok_type_expr = _mv_1023.value;
                                            __auto_type _mv_1024 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_1024.has_value) {
                                                __auto_type err_type_expr = _mv_1024.value;
                                                {
    ...
    switch (_mv_1026.tag) {
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1026.data.lst;
            {
                ...
                __auto_type len = ((int64_t)((items).len));
                if ((len >= 1)) {
                    __auto_type _mv_1027 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_1027.has_value) {
                        __auto_type head = _mv_1027.value;
                        __auto_type _mv_1028 = (*head);
                        switch (_mv_1028.tag) {
                            case types_SExpr_sym:
                            {
                                __auto_type sym = _mv_1028.data.sym;
                                {
                                    ...
                                    if (string_eq(name, SLOP_STR("map-new"))) {
                                        if ((len >= 3)) {
                                            __auto_type _mv_1029 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_1029.has_value) {
                                                __auto_type key_type_expr = _mv_1029.value;
                                        ...
                                        if ((len >= 3)) {
                                            __auto_type _mv_1030 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_1030.has_value) {
                                                __auto_type elem_type_expr = _mv_1030.value;
                                    ...
                                    } else {
                                        {
                                            ...
                                            while ((i < len)) {
                                                ...
                                                if (_mv_1031.has_value) {
                                                    __auto_type child = _mv_1031.value;
                            ...
                            default: {
                                {
                                    ...
                                    while ((i < len)) {
                                        ...
                                        if (_mv_1032.has_value) {
                                            __auto_type child = _mv_1032.value;
                                            transpiler_prescan_expr_for_struct_keys(ctx, child);
...
void transpiler_prescan_register_struct_key_type(context_TranspileContext* ctx, types_SExpr* type_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1033 = (*type_expr);
        switch (_mv_1033.tag) {
            case types_SExpr_sym:
            {
                __auto_type sym = _mv_1033.data.sym;
                {
                    ...
                    if (!(transpiler_is_builtin_map_key_type(name))) {
                        __auto_type _mv_1034 = context_ctx_lookup_type(ctx, name);
                        if (_mv_1034.has_value) {
                            __auto_type type_entry = _mv_1034.value;
                            context_ctx_register_struct_key_type(ctx, type_entry.c_name);
                        } else if (!_mv_1034.has_value) {
                            __auto_type _mv_1035 = context_ctx_get_module(ctx);
                            if (_mv_1035.has_value) {
                                __auto_type mod = _mv_1035.value;
                                {
                                    __auto_type prefixed = context_ctx_str3(ctx, mod, SLOP_STR("_"), name);
                                    __auto_type _mv_1036 = context_ctx_lookup_type(ctx, prefixed);
                                    if (_mv_1036.has_value) {
                                        __auto_type type_entry = _mv_1036.value;
                                        context_ctx_register_struct_key_type(ctx, type_entry.c_name);
...
void transpiler_check_and_register_result_alias(context_TranspileContext* ctx, slop_string alias_name, types_SExpr* body_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1037 = (*body_expr);
        switch (_mv_1037.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1037.data.lst;
                {
                    __auto_type items = lst.items;
                    if ((((int64_t)((items).len)) >= 3)) {
                        __auto_type _mv_1038 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_1038.has_value) {
                            ...
                            switch (_mv_1039.tag) {
                                case types_SExpr_sym:
                                {
                                    ...
                                    if (string_eq(sym.name, SLOP_STR("Result"))) {
                                        __auto_type _mv_1040 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_1040.has_value) {
                                            __auto_type ok_type_expr = _mv_1040.value;
                                            __auto_type _mv_1041 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_1041.has_value) {
                                                __auto_type err_type_expr = _mv_1041.value;
                                                {
                                                    __auto_type ok_c_type = context_to_c_type_prefixed(ctx, ok_type_expr);
                                                    __auto_type err_c_type = context_to_c_type_prefixed(ctx, err_type_expr);
                                                    __auto_type result_name = transpiler_build_result_type_name(ctx, ok_c_type, err_c_type);
...
void transpiler_prescan_ffi(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        __auto_type len = ((int64_t)((items).len));
        if ((len >= 2)) {
            __auto_type _mv_1042 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1042.has_value) {
                __auto_type header_expr = _mv_1042.value;
                __auto_type _mv_1043 = (*header_expr);
                switch (_mv_1043.tag) {
                    case types_SExpr_str:
                    {
                        __auto_type str = _mv_1043.data.str;
            ...
            }
            {
                __auto_type i = 2;
                while ((i < len)) {
                    __auto_type _mv_1044 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_1044.has_value) {
                        __auto_type func_decl = _mv_1044.value;
...
void transpiler_prescan_import(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    if ((((int64_t)((items).len)) >= 3)) {
        __auto_type _mv_1045 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        if (_mv_1045.has_value) {
            __auto_type mod_expr = _mv_1045.value;
            __auto_type _mv_1046 = (*mod_expr);
            switch (_mv_1046.tag) {
                case types_SExpr_sym:
                {
                    __auto_type mod_sym = _mv_1046.data.sym;
                    {
                        ...
                        if (_mv_1047.has_value) {
                            __auto_type symbols_expr = _mv_1047.value;
                            __auto_type _mv_1048 = (*symbols_expr);
                            switch (_mv_1048.tag) {
                                case types_SExpr_lst:
                                {
                                    __auto_type symbols_lst = _mv_1048.data.lst;
                                    {
                                        __auto_type syms = symbols_lst.items;
                                        __auto_type sym_len = ((int64_t)((syms).len));
                                        __auto_type j = 0;
                                        while ((j < sym_len)) {
                                            __auto_type _mv_1049 = ({ __auto_type _lst = syms; size_t _idx = (size_t)j; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_1049.has_value) {
                                                __auto_type sym_item = _mv_1049.value;
                                                __auto_type _mv_1050 = (*sym_item);
                                                switch (_mv_1050.tag) {
                                                    case types_SExpr_sym:
                                                    {
                                                        __auto_type s = _mv_1050.data.sym;
                                                        {
                                                            ...
                                                            if (transpiler_is_type_name(sym_name)) {
                                                            ...
                                                            } else {
                                                                {
                                                                    ...
                                                                    context_ctx_register_func(ctx, (context_FuncEntry){sym_name, c_name, ret_type, slop_ret, ret_ptr, ret_str, param_types});
                                                                }
                                                            }
                                                        }
                                                        break;
...
void transpiler_register_ffi_function(context_TranspileContext* ctx, types_SExpr* func_decl) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1051 = (*func_decl);
        switch (_mv_1051.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1051.data.lst;
                {
                    ...
                    if ((len >= 1)) {
                        ...
                        if (_mv_1052.has_value) {
                            __auto_type name_expr = _mv_1052.value;
                            __auto_type _mv_1053 = (*name_expr);
                            switch (_mv_1053.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type sym = _mv_1053.data.sym;
                                    {
                                        ...
                                        context_ctx_register_func(ctx, (context_FuncEntry){fn_name, c_name, ret_type, SLOP_STR(""), 1, ret_is_string, param_types});
                                    }
                                    break;
                                }
                                default: {
...
slop_list_context_FuncParamType_ptr transpiler_extract_ffi_param_types(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        __auto_type result = ((slop_list_context_FuncParamType_ptr){ .data = (context_FuncParamType**)slop_arena_alloc(arena, 16 * sizeof(context_FuncParamType*)), .len = 0, .cap = 16 });
        if ((((int64_t)((items).len)) >= 2)) {
            __auto_type _mv_1054 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1054.has_value) {
                __auto_type params_expr = _mv_1054.value;
                __auto_type _mv_1055 = (*params_expr);
                switch (_mv_1055.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type params_lst = _mv_1055.data.lst;
                        {
                            __auto_type params = params_lst.items;
                            __auto_type param_count = ((int64_t)((params).len));
                            __auto_type i = 0;
                            while ((i < param_count)) {
                                __auto_type _mv_1056 = ({ __auto_type _lst = params; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1056.has_value) {
                                    __auto_type param_expr = _mv_1056.value;
                                    {
                                        __auto_type c_type = transpiler_prescan_get_param_c_type(ctx, param_expr);
                                        __auto_type param_info = ((context_FuncParamType*)((uint8_t*)slop_arena_alloc(arena, 64)));
                                        (*param_info).c_type = c_type;
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while ((i < len)) {
            ...
            if (_mv_1057.has_value) {
                __auto_type item_expr = _mv_1057.value;
                __auto_type _mv_1058 = (*item_expr);
                switch (_mv_1058.tag) {
                    case types_SExpr_sym:
                    {
                        __auto_type sym = _mv_1058.data.sym;
                        if (string_eq(sym.name, SLOP_STR(":c-name"))) {
                            __auto_type _mv_1059 = ({ __auto_type _lst = items; size_t _idx = (size_t)(i + 1); slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_1059.has_value) {
                                __auto_type c_name_expr = _mv_1059.value;
                                __auto_type _mv_1060 = (*c_name_expr);
                                switch (_mv_1060.tag) {
                                    case types_SExpr_sym:
                                    {
                                        __auto_type c_sym = _mv_1060.data.sym;
                                        c_name = c_sym.name;
                                        found_c_name = 1;
                                        break;
                                    }
        ...
        if ((len >= 2)) {
            {
                ...
                if (has_header) {
                    ...
                    if (_mv_1061.has_value) {
                        __auto_type header_expr = _mv_1061.value;
                        __auto_type _mv_1062 = (*header_expr);
                        switch (_mv_1062.tag) {
                            case types_SExpr_str:
                            {
                                __auto_type str = _mv_1062.data.str;
                                context_ctx_add_include(ctx, str.value);
                                break;
                            }
                            default: {
                ...
                if ((len >= (name_idx + 1))) {
                    __auto_type _mv_1063 = ({ __auto_type _lst = items; size_t _idx = (size_t)name_idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_string transpiler_get_ffi_struct_c_name(slop_arena* arena, slop_list_types_SExpr_ptr items, int64_t name_idx, slop_string default_name) {
    {
        ...
        if ((len >= (modifier_idx + 2))) {
            __auto_type _mv_1065 = ({ __auto_type _lst = items; size_t _idx = (size_t)modifier_idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1065.has_value) {
                __auto_type mod_expr = _mv_1065.value;
                __auto_type _mv_1066 = (*mod_expr);
                switch (_mv_1066.tag) {
                    case types_SExpr_sym:
                    {
                        __auto_type sym = _mv_1066.data.sym;
                        if (string_eq(sym.name, SLOP_STR(":c-name"))) {
                            __auto_type _mv_1067 = ({ __auto_type _lst = items; size_t _idx = (size_t)(modifier_idx + 1); slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_1067.has_value) {
                                __auto_type cname_expr = _mv_1067.value;
                                __auto_type _mv_1068 = (*cname_expr);
                                switch (_mv_1068.tag) {
                                    case types_SExpr_str:
                                    {
                                        __auto_type str = _mv_1068.data.str;
...
uint8_t transpiler_is_ffi_string_item(slop_list_types_SExpr_ptr items, int64_t idx) {
    __auto_type _mv_1069 = ({ __auto_type _lst = items; size_t _idx = (size_t)idx; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
    if (_mv_1069.has_value) {
        ...
        switch (_mv_1070.tag) {
            case types_SExpr_str:
            {
                __auto_type _ = _mv_1070.data.str;
                return 1;
            }
            default: {
                return 0;
...
uint8_t transpiler_is_enum_def(slop_list_types_SExpr_ptr items) {
    if ((((int64_t)((items).len)) < 3)) {
        ...
        if (_mv_1071.has_value) {
            __auto_type def_expr = _mv_1071.value;
            __auto_type _mv_1072 = (*def_expr);
            switch (_mv_1072.tag) {
                case types_SExpr_lst:
                {
                    __auto_type def_lst = _mv_1072.data.lst;
                    {
                        __auto_type def_items = def_lst.items;
                        if ((((int64_t)((def_items).len)) < 1)) {
                            return 0;
                        } else {
                            __auto_type _mv_1073 = ({ __auto_type _lst = def_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                ...
                case types_SExpr_lst:
                {
                    __auto_type def_lst = _mv_1076.data.lst;
                    {
                        ...
                        if ((((int64_t)((def_items).len)) < 1)) {
                            ...
                            __auto_type _mv_1077 = ({ __auto_type _lst = def_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                ...
                case types_SExpr_lst:
                {
                    __auto_type def_lst = _mv_1080.data.lst;
                    {
                        ...
                        if ((((int64_t)((def_items).len)) < 1)) {
                            ...
                            __auto_type _mv_1081 = ({ __auto_type _lst = def_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_1081.has_value) {
                                __auto_type head = _mv_1081.value;
                                __auto_type _mv_1082 = (*head);
                                switch (_mv_1082.tag) {
                                    case types_SExpr_sym:
                                    {
...
slop_string transpiler_get_array_c_type(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items, slop_string default_c_type) {
    ...
    if ((((int64_t)((items).len)) < 3)) {
        ...
        if (_mv_1083.has_value) {
            __auto_type body_expr = _mv_1083.value;
            __auto_type _mv_1084 = (*body_expr);
            switch (_mv_1084.tag) {
                case types_SExpr_lst:
                {
                    __auto_type body_lst = _mv_1084.data.lst;
                    {
                        __auto_type body_items = body_lst.items;
                        if ((((int64_t)((body_items).len)) < 2)) {
                            return default_c_type;
                        } else {
                            __auto_type _mv_1085 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                ...
                                switch (_mv_1086.tag) {
                                    case types_SExpr_sym:
                                    {
                                        ...
                                        if (string_eq(sym.name, SLOP_STR("Array"))) {
                                            __auto_type _mv_1087 = ({ __auto_type _lst = body_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                            if (_mv_1087.has_value) {
                                                __auto_type elem_expr = _mv_1087.value;
                                                {
...
void transpiler_emit_all_types(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        __auto_type i = 0;
        while ((i < len)) {
            __auto_type _mv_1088 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1090.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 3)) {
                    ...
                    __auto_type _mv_1091 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_1091.has_value) {
                        __auto_type def_expr = _mv_1091.value;
                        __auto_type _mv_1092 = (*def_expr);
                        switch (_mv_1092.tag) {
                            case types_SExpr_lst:
                            {
                                __auto_type def_lst = _mv_1092.data.lst;
                                {
                                    __auto_type def_items = def_lst.items;
                                    if ((((int64_t)((def_items).len)) < 1)) {
                                        return 0;
                                    } else {
                                        __auto_type _mv_1093 = ({ __auto_type _lst = def_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1095.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    __auto_type _mv_1096 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void transpiler_transpile_module(context_TranspileContext* ctx, types_SExpr* module_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1102 = (*module_expr);
        switch (_mv_1102.tag) {
            case types_SExpr_lst:
            {
...
int64_t transpiler_get_body_start(slop_list_types_SExpr_ptr items) {
    if ((((int64_t)((items).len)) < 3)) {
        ...
        if (_mv_1105.has_value) {
            __auto_type third = _mv_1105.value;
            __auto_type _mv_1106 = (*third);
            switch (_mv_1106.tag) {
                case types_SExpr_lst:
                {
                    __auto_type lst = _mv_1106.data.lst;
                    {
                        ...
                        if ((((int64_t)((sub_items).len)) < 1)) {
                            ...
                            __auto_type _mv_1107 = ({ __auto_type _lst = sub_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_1107.has_value) {
                                __auto_type head = _mv_1107.value;
                                __auto_type _mv_1108 = (*head);
                                switch (_mv_1108.tag) {
                                    case types_SExpr_sym:
                                    {
                                            ...
                                            if (string_eq(sym.name, SLOP_STR("export"))) {
                                                {
                                                    ...
                                                    __auto_type j = 1;
                                                    while ((j < export_len)) {
                                                        __auto_type _mv_1113 = ({ __auto_type _lst = sub_items; size_t _idx = (size_t)j; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                        if (_mv_1113.has_value) {
                                                            ...
                                                            switch (_mv_1114.tag) {
                                                                case types_SExpr_sym:
                                                                {
                                                                    __auto_type name_sym = _mv_1114.data.sym;
...
uint8_t transpiler_list_contains_str(slop_list_string lst, slop_string needle) {
    {
        ...
        __auto_type found = 0;
        while (((i < len) && !(found))) {
            __auto_type _mv_1115 = ({ __auto_type _lst = lst; size_t _idx = (size_t)i; slop_option_string _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1115.has_value) {
                __auto_type s = _mv_1115.value;
...
void transpiler_prescan_module_body(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items, int64_t start) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        __auto_type i = start;
        while ((i < len)) {
            __auto_type _mv_1116 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void transpiler_scan_type_for_generics(context_TranspileContext* ctx, types_SExpr* type_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1117 = (*type_expr);
        switch (_mv_1117.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1117.data.lst;
                {
                    ...
                    __auto_type len = ((int64_t)((items).len));
                    if ((len >= 1)) {
                        __auto_type _mv_1118 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                ...
                                case types_SExpr_sym:
                                {
                                    __auto_type sym = _mv_1119.data.sym;
                                    {
                                        ...
                                        if (string_eq(op, SLOP_STR("Option"))) {
                                            if ((len >= 2)) {
                                                __auto_type _mv_1120 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_1120.has_value) {
                                                    __auto_type inner = _mv_1120.value;
                                                    {
                                            ...
                                            if ((len >= 2)) {
                                                ...
                                                if (_mv_1121.has_value) {
                                                    __auto_type elem = _mv_1121.value;
                                                    {
                                            ...
                                            if ((len >= 2)) {
                                                ...
                                                if (_mv_1122.has_value) {
                                                    __auto_type inner = _mv_1122.value;
                                                    transpiler_scan_type_for_generics(ctx, inner);
                                            ...
                                            if ((len >= 3)) {
                                                ...
                                                if (_mv_1123.has_value) {
                                                    __auto_type ok_type = _mv_1123.value;
                                                    __auto_type _mv_1124 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                    if (_mv_1124.has_value) {
                                                        __auto_type err_type = _mv_1124.value;
                                                        {
                                            ...
                                            if ((len >= 2)) {
                                                __auto_type _mv_1125 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_1125.has_value) {
                                                    __auto_type elem = _mv_1125.value;
                                                    {
                                                        __auto_type elem_c = context_to_c_type_prefixed(ctx, elem);
                                                        __auto_type elem_id = ctype_type_to_identifier(arena, elem_c);
                                            ...
                                            if ((len >= 2)) {
                                                ...
                                                if (_mv_1126.has_value) {
                                                    __auto_type result = _mv_1126.value;
                                                    {
                                            ...
                                            if ((len >= 3)) {
                                                ...
                                                if (_mv_1127.has_value) {
                                                    __auto_type key_type = _mv_1127.value;
                                                    {
                                                        ...
                                                        if (_mv_1128.has_value) {
                                                            __auto_type val_type = _mv_1128.value;
                                            ...
                                            if ((len >= 2)) {
                                                ...
                                                if (_mv_1129.has_value) {
                                                    __auto_type elem_type = _mv_1129.value;
                                                    {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while ((i < len)) {
            ...
            if (_mv_1130.has_value) {
                __auto_type field_expr = _mv_1130.value;
                __auto_type _mv_1131 = (*field_expr);
                switch (_mv_1131.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type field_lst = _mv_1131.data.lst;
                        {
                            __auto_type field_items = field_lst.items;
                            if ((((int64_t)((field_items).len)) >= 2)) {
                                __auto_type _mv_1132 = ({ __auto_type _lst = field_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                if (_mv_1132.has_value) {
                                    __auto_type type_expr = _mv_1132.value;
                                    transpiler_scan_type_for_generics(ctx, type_expr);
...
void transpiler_emit_ffi_includes(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        __auto_type i = 0;
        while ((i < len)) {
            __auto_type _mv_1133 = ({ __auto_type _lst = includes; size_t _idx = (size_t)i; slop_option_string _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1133.has_value) {
                __auto_type header = _mv_1133.value;
...
void transpiler_emit_ffi_includes_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        __auto_type i = 0;
        while ((i < len)) {
            __auto_type _mv_1134 = ({ __auto_type _lst = includes; size_t _idx = (size_t)i; slop_option_string _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1134.has_value) {
                __auto_type header = _mv_1134.value;
...
void transpiler_emit_header_guard_open(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (_mv_1135.has_value) {
            __auto_type mod_name = _mv_1135.value;
            {
...
void transpiler_emit_header_dependency_includes(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        __auto_type i = 0;
        while ((i < len)) {
            __auto_type _mv_1136 = ({ __auto_type _lst = imports; size_t _idx = (size_t)i; slop_option_string _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1136.has_value) {
                __auto_type mod_name = _mv_1136.value;
                {
                    __auto_type c_name = ctype_to_c_name(arena, mod_name);
...
void transpiler_emit_forward_decls(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items, int64_t start) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while ((i < len)) {
            __auto_type _mv_1137 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1137.has_value) {
                __auto_type item = _mv_1137.value;
                if ((transpiler_is_type_def(item) && transpiler_is_struct_type_def(item))) {
                    __auto_type _mv_1138 = transpiler_get_type_name(item);
                    if (_mv_1138.has_value) {
                        __auto_type type_name = _mv_1138.value;
                        {
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1139.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 3)) {
                    ...
                    __auto_type _mv_1140 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_1140.has_value) {
                        __auto_type def_expr = _mv_1140.value;
                        __auto_type _mv_1141 = (*def_expr);
                        switch (_mv_1141.tag) {
                            case types_SExpr_lst:
                            {
                                __auto_type def_lst = _mv_1141.data.lst;
                                {
                                    __auto_type def_items = def_lst.items;
                                    if ((((int64_t)((def_items).len)) < 1)) {
                                        return 0;
                                    } else {
                                        __auto_type _mv_1142 = ({ __auto_type _lst = def_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
uint8_t transpiler_has_enum_payload_variants(slop_list_types_SExpr_ptr items) {
    {
        ...
        while (((i < len) && !(found))) {
            ...
            if (_mv_1144.has_value) {
                ...
                __auto_type _mv_1145 = (*item);
                switch (_mv_1145.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type _ = _mv_1145.data.lst;
                        found = 1;
                        break;
                    }
                    default: {
            ...
            __auto_type lst = _mv_1146.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 3)) {
                    ...
                    if (_mv_1147.has_value) {
                        __auto_type def_expr = _mv_1147.value;
                        __auto_type _mv_1148 = (*def_expr);
                        switch (_mv_1148.tag) {
                            case types_SExpr_sym:
                            {
                                __auto_type _ = _mv_1148.data.sym;
                                return 1;
                            }
                            case types_SExpr_lst:
                            {
                                __auto_type def_lst = _mv_1148.data.lst;
                                {
                                    __auto_type def_items = def_lst.items;
                                    if ((((int64_t)((def_items).len)) < 1)) {
                                        return 0;
                                    } else {
                                        __auto_type _mv_1149 = ({ __auto_type _lst = def_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        switch (_mv_1156.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1156.data.lst;
                {
                    __auto_type items = lst.items;
                    if ((((int64_t)((items).len)) >= 3)) {
                        __auto_type _mv_1157 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_1157.has_value) {
                            __auto_type name_expr = _mv_1157.value;
                            __auto_type _mv_1158 = (*name_expr);
                            switch (_mv_1158.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_1158.data.sym;
                                    {
                                        __auto_type type_name = name_sym.name;
                                        __auto_type base_c_name = ctype_to_c_name(arena, type_name);
                                        __auto_type c_name = context_ctx_prefix_type(ctx, base_c_name);
                                        __auto_type _mv_1159 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_1159.has_value) {
                                            __auto_type body_expr = _mv_1159.value;
...
uint8_t transpiler_is_array_type_body(types_SExpr* body_expr) {
    SLOP_PRE(((body_expr != NULL)), "(!= body-expr nil)");
    __auto_type _mv_1160 = (*body_expr);
    switch (_mv_1160.tag) {
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1160.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    __auto_type _mv_1161 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void transpiler_emit_array_typedef_to_header(context_TranspileContext* ctx, slop_string c_name, types_SExpr* body_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1163 = (*body_expr);
        switch (_mv_1163.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1163.data.lst;
                {
                    ...
                    if ((len < 3)) {
                        ...
                        if (_mv_1164.has_value) {
                            __auto_type elem_type_expr = _mv_1164.value;
                            ...
                            if (_mv_1165.has_value) {
                                __auto_type size_expr = _mv_1165.value;
                                {
...
slop_string transpiler_get_array_size_string(types_SExpr* expr) {
    ...
    switch (_mv_1166.tag) {
        ...
        {
            __auto_type num = _mv_1166.data.num;
            return num.raw;
        }
        default: {
            return SLOP_STR("0");
...
uint8_t transpiler_is_range_type_body(types_SExpr* body_expr) {
    SLOP_PRE(((body_expr != NULL)), "(!= body-expr nil)");
    __auto_type _mv_1167 = (*body_expr);
    switch (_mv_1167.tag) {
        case types_SExpr_lst:
        {
...
transpiler_RangeBoundsHeader transpiler_parse_range_bounds_header(types_SExpr* body_expr) {
    SLOP_PRE(((body_expr != NULL)), "(!= body-expr nil)");
    {
        ...
        __auto_type found_dots = 0;
        __auto_type _mv_1170 = (*body_expr);
        switch (_mv_1170.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1170.data.lst;
                {
                    ...
                    __auto_type i = 1;
                    while ((i < len)) {
                        __auto_type _mv_1171 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                        if (_mv_1171.has_value) {
                            __auto_type item = _mv_1171.value;
                            __auto_type _mv_1172 = (*item);
                            switch (_mv_1172.tag) {
                                case types_SExpr_num:
                                {
...
void transpiler_emit_forward_decls_header(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items, int64_t start) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        __auto_type emitted_any = 0;
        while ((i < len)) {
            __auto_type _mv_1173 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1173.has_value) {
                __auto_type item = _mv_1173.value;
                if ((transpiler_is_type_def(item) && transpiler_is_struct_type_def(item))) {
                    __auto_type _mv_1174 = transpiler_get_type_name(item);
                    if (_mv_1174.has_value) {
                        __auto_type type_name = _mv_1174.value;
                        {
...
void transpiler_emit_fn_forward_decls_header(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items, int64_t start) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        __auto_type emitted_any = 0;
        while ((i < len)) {
            __auto_type _mv_1176 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void transpiler_emit_c_name_aliases(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((len > 0)) {
            ...
            while ((i < len)) {
                __auto_type _mv_1177 = ({ __auto_type _lst = aliases; size_t _idx = (size_t)i; slop_option_context_FuncCNameAlias _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_1177.has_value) {
                    __auto_type alias = _mv_1177.value;
                ...
                __auto_type lst = _mv_1178.data.lst;
                {
                    ...
                    if ((len >= 3)) {
                        ...
                        if (_mv_1179.has_value) {
                            __auto_type name_expr = _mv_1179.value;
                            __auto_type _mv_1180 = (*name_expr);
                            switch (_mv_1180.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_1180.data.sym;
                                    {
                                        ...
                                        if (_mv_1181.has_value) {
                                            __auto_type params_expr = _mv_1181.value;
                                            {
            ...
            __auto_type lst = _mv_1182.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 2)) {
                    ...
                    if (_mv_1183.has_value) {
                        __auto_type name_expr = _mv_1183.value;
                        __auto_type _mv_1184 = (*name_expr);
                        switch (_mv_1184.tag) {
                            case types_SExpr_sym:
                            {
...
void transpiler_emit_result_types(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        __auto_type i = 0;
        while ((i < len)) {
            __auto_type _mv_1189 = ({ __auto_type _lst = result_types; size_t _idx = (size_t)i; slop_option_context_ResultType _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1189.has_value) {
                __auto_type rt = _mv_1189.value;
...
void transpiler_emit_result_types_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        __auto_type i = 0;
        while ((i < len)) {
            __auto_type _mv_1190 = ({ __auto_type _lst = result_types; size_t _idx = (size_t)i; slop_option_context_ResultType _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1190.has_value) {
                __auto_type rt = _mv_1190.value;
...
void transpiler_emit_inline_records_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        __auto_type i = 0;
        while ((i < len)) {
            __auto_type _mv_1191 = ({ __auto_type _lst = inline_records; size_t _idx = (size_t)i; slop_option_context_InlineRecord _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1191.has_value) {
                __auto_type ir = _mv_1191.value;
                {
...
void transpiler_emit_option_types_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        __auto_type i = 0;
        while ((i < len)) {
            __auto_type _mv_1192 = ({ __auto_type _lst = option_types; size_t _idx = (size_t)i; slop_option_context_OptionType _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1192.has_value) {
                __auto_type ot = _mv_1192.value;
...
void transpiler_emit_value_option_types_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        __auto_type i = 0;
        while ((i < len)) {
            __auto_type _mv_1193 = ({ __auto_type _lst = option_types; size_t _idx = (size_t)i; slop_option_context_OptionType _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1193.has_value) {
                __auto_type ot = _mv_1193.value;
...
void transpiler_emit_complex_value_option_types_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        __auto_type i = 0;
        while ((i < len)) {
            __auto_type _mv_1194 = ({ __auto_type _lst = option_types; size_t _idx = (size_t)i; slop_option_context_OptionType _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1194.has_value) {
                __auto_type ot = _mv_1194.value;
                if (!(transpiler_is_pointer_elem_type(ot.inner_type))) {
                    transpiler_emit_single_option_type_header(ctx, ot);
                }
...
void transpiler_emit_list_types_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        __auto_type i = 0;
        while ((i < len)) {
            __auto_type _mv_1195 = ({ __auto_type _lst = list_types; size_t _idx = (size_t)i; slop_option_context_ListType _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1195.has_value) {
                __auto_type lt = _mv_1195.value;
...
void transpiler_emit_primitive_list_types_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        __auto_type i = 0;
        while ((i < len)) {
            __auto_type _mv_1196 = ({ __auto_type _lst = list_types; size_t _idx = (size_t)i; slop_option_context_ListType _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1196.has_value) {
                __auto_type lt = _mv_1196.value;
...
void transpiler_emit_primitive_option_types_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        __auto_type i = 0;
        while ((i < len)) {
            __auto_type _mv_1197 = ({ __auto_type _lst = option_types; size_t _idx = (size_t)i; slop_option_context_OptionType _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1197.has_value) {
                __auto_type ot = _mv_1197.value;
...
void transpiler_emit_imported_list_types_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        __auto_type i = 0;
        while ((i < len)) {
            __auto_type _mv_1198 = ({ __auto_type _lst = list_types; size_t _idx = (size_t)i; slop_option_context_ListType _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1198.has_value) {
                __auto_type lt = _mv_1198.value;
...
void transpiler_emit_imported_option_types_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        __auto_type i = 0;
        while ((i < len)) {
            __auto_type _mv_1199 = ({ __auto_type _lst = option_types; size_t _idx = (size_t)i; slop_option_context_OptionType _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1199.has_value) {
                __auto_type ot = _mv_1199.value;
...
void transpiler_emit_late_registered_option_types_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        __auto_type i = 0;
        while ((i < len)) {
            __auto_type _mv_1200 = ({ __auto_type _lst = option_types; size_t _idx = (size_t)i; slop_option_context_OptionType _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1200.has_value) {
                __auto_type ot = _mv_1200.value;
                transpiler_emit_single_option_type_header(ctx, ot);
...
void transpiler_emit_value_list_types_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        __auto_type i = 0;
        while ((i < len)) {
            __auto_type _mv_1201 = ({ __auto_type _lst = list_types; size_t _idx = (size_t)i; slop_option_context_ListType _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1201.has_value) {
                __auto_type lt = _mv_1201.value;
...
void transpiler_emit_complex_value_list_types_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        __auto_type i = 0;
        while ((i < len)) {
            __auto_type _mv_1202 = ({ __auto_type _lst = list_types; size_t _idx = (size_t)i; slop_option_context_ListType _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1202.has_value) {
                __auto_type lt = _mv_1202.value;
...
void transpiler_emit_union_payload_hash_eq(context_TranspileContext* ctx, slop_list_context_UnionVariantEntry variants) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        __auto_type i = 0;
        while ((i < len)) {
            __auto_type _mv_1203 = ({ __auto_type _lst = variants; size_t _idx = (size_t)i; slop_option_context_UnionVariantEntry _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1203.has_value) {
                __auto_type variant = _mv_1203.value;
                {
...
uint8_t transpiler_is_range_type_alias(context_TranspileContext* ctx, slop_string slop_type) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    __auto_type _mv_1204 = context_ctx_lookup_type_alias(ctx, slop_type);
    if (_mv_1204.has_value) {
        __auto_type underlying = _mv_1204.value;
...
void transpiler_emit_union_hash_fn(context_TranspileContext* ctx, slop_string c_type, slop_list_context_UnionVariantEntry variants) {
    ...
    context_ctx_emit_header(ctx, SLOP_STR("    switch (_k->tag) {"));
    {
        ...
        __auto_type i = 0;
        while ((i < len)) {
            __auto_type _mv_1205 = ({ __auto_type _lst = variants; size_t _idx = (size_t)i; slop_option_context_UnionVariantEntry _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1205.has_value) {
                __auto_type variant = _mv_1205.value;
...
void transpiler_emit_union_eq_fn(context_TranspileContext* ctx, slop_string c_type, slop_list_context_UnionVariantEntry variants) {
    ...
    context_ctx_emit_header(ctx, SLOP_STR("    switch (_a->tag) {"));
    {
        ...
        __auto_type i = 0;
        while ((i < len)) {
            __auto_type _mv_1206 = ({ __auto_type _lst = variants; size_t _idx = (size_t)i; slop_option_context_UnionVariantEntry _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1206.has_value) {
                __auto_type variant = _mv_1206.value;
...
void transpiler_emit_struct_hash_fn(context_TranspileContext* ctx, slop_string c_type, slop_list_context_FieldEntry fields) {
    ...
    context_ctx_emit_header(ctx, SLOP_STR("    uint64_t hash = 14695981039346656037ULL;"));
    {
        ...
        __auto_type i = 0;
        while ((i < len)) {
            __auto_type _mv_1207 = ({ __auto_type _lst = fields; size_t _idx = (size_t)i; slop_option_context_FieldEntry _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1207.has_value) {
                __auto_type field = _mv_1207.value;
    ...
    context_ctx_emit_header(ctx, context_ctx_str(ctx, context_ctx_str4(ctx, SLOP_STR("    const "), c_type, SLOP_STR("* _b = (const "), c_type), SLOP_STR("*)b;")));
    {
        ...
        if ((len == 0)) {
            ...
            context_ctx_emit_header(ctx, SLOP_STR("    return true"));
            {
                __auto_type i = 0;
                while ((i < len)) {
                    __auto_type _mv_1208 = ({ __auto_type _lst = fields; size_t _idx = (size_t)i; slop_option_context_FieldEntry _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_1208.has_value) {
                        __auto_type field = _mv_1208.value;
...
void transpiler_emit_struct_key_types_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while ((i < len)) {
            __auto_type _mv_1209 = ({ __auto_type _lst = struct_key_types; size_t _idx = (size_t)i; slop_option_string _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1209.has_value) {
                __auto_type c_type = _mv_1209.value;
                {
...
void transpiler_emit_chan_types_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        __auto_type i = 0;
        while ((i < len)) {
            __auto_type _mv_1210 = ({ __auto_type _lst = chan_types; size_t _idx = (size_t)i; slop_option_context_ChanType _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1210.has_value) {
                __auto_type ct = _mv_1210.value;
                {
...
void transpiler_emit_chan_funcs_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        __auto_type i = 0;
        while ((i < len)) {
            __auto_type _mv_1211 = ({ __auto_type _lst = chan_types; size_t _idx = (size_t)i; slop_option_context_ChanType _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1211.has_value) {
                __auto_type ct = _mv_1211.value;
                {
                    __auto_type elem_type = ct.elem_type;
                    __auto_type c_name = ct.c_name;
...
void transpiler_emit_thread_types_header(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        __auto_type i = 0;
        while ((i < len)) {
            __auto_type _mv_1212 = ({ __auto_type _lst = thread_types; size_t _idx = (size_t)i; slop_option_context_ThreadType _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1212.has_value) {
                __auto_type tt = _mv_1212.value;
                {
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1213.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 3)) {
                    ...
                    __auto_type _mv_1214 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_1214.has_value) {
                        __auto_type def_expr = _mv_1214.value;
                        __auto_type _mv_1215 = (*def_expr);
                        switch (_mv_1215.tag) {
                            case types_SExpr_lst:
                            {
                                __auto_type def_lst = _mv_1215.data.lst;
                                {
                                    __auto_type def_items = def_lst.items;
                                    if ((((int64_t)((def_items).len)) < 1)) {
                                        return 0;
                                    } else {
                                        __auto_type _mv_1216 = ({ __auto_type _lst = def_items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void transpiler_emit_module_types_header(context_TranspileContext* ctx, slop_list_types_SExpr_ptr items, int64_t start) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        i = start;
        while ((i < len)) {
            __auto_type _mv_1220 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1220.has_value) {
                __auto_type item = _mv_1220.value;
                if ((transpiler_is_type_def(item) && transpiler_is_struct_type_def(item))) {
                    transpiler_emit_type_to_header(ctx, item);
                }
...
void transpiler_emit_pending_container_deps(context_TranspileContext* ctx, types_SExpr* type_def) {
    ...
    SLOP_PRE(((type_def != NULL)), "(!= type-def nil)");
    {
        ...
        __auto_type i = 0;
        while ((i < len)) {
            __auto_type _mv_1224 = ({ __auto_type _lst = field_types; size_t _idx = (size_t)i; slop_option_string _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1224.has_value) {
                __auto_type field_type = _mv_1224.value;
...
void transpiler_emit_option_by_c_name(context_TranspileContext* ctx, slop_string c_name) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        __auto_type i = 0;
        while ((i < len)) {
            __auto_type _mv_1225 = ({ __auto_type _lst = option_types; size_t _idx = (size_t)i; slop_option_context_OptionType _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1225.has_value) {
                __auto_type ot = _mv_1225.value;
...
void transpiler_emit_list_by_c_name(context_TranspileContext* ctx, slop_string c_name) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        __auto_type i = 0;
        while ((i < len)) {
            __auto_type _mv_1226 = ({ __auto_type _lst = list_types; size_t _idx = (size_t)i; slop_option_context_ListType _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1226.has_value) {
                __auto_type lt = _mv_1226.value;
...
uint8_t transpiler_index_in_list(slop_list_int lst, int64_t idx) {
    {
        ...
        __auto_type found = 0;
        while (((i < len) && !(found))) {
            __auto_type _mv_1228 = ({ __auto_type _lst = lst; size_t _idx = (size_t)i; slop_option_int _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
uint8_t transpiler_type_deps_satisfied(context_TranspileContext* ctx, types_SExpr* type_def) {
    ...
    SLOP_PRE(((type_def != NULL)), "(!= type-def nil)");
    {
        ...
        while (((i < len) && all_satisfied)) {
            __auto_type _mv_1229 = ({ __auto_type _lst = field_types; size_t _idx = (size_t)i; slop_option_string _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1229.has_value) {
                __auto_type field_type = _mv_1229.value;
...
slop_list_string transpiler_extract_record_field_types(context_TranspileContext* ctx, slop_list_types_SExpr_ptr def_items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        __auto_type i = 1;
        while ((i < len)) {
            __auto_type _mv_1235 = ({ __auto_type _lst = def_items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1235.has_value) {
                __auto_type field_expr = _mv_1235.value;
                __auto_type _mv_1236 = (*field_expr);
                switch (_mv_1236.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type field_lst = _mv_1236.data.lst;
                        if ((((int64_t)((field_lst.items).len)) >= 2)) {
                            __auto_type _mv_1237 = ({ __auto_type _lst = field_lst.items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                            if (_mv_1237.has_value) {
                                __auto_type type_expr = _mv_1237.value;
                                {
...
slop_list_string transpiler_extract_union_variant_types(context_TranspileContext* ctx, slop_list_types_SExpr_ptr def_items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        __auto_type i = 1;
        while ((i < len)) {
            __auto_type _mv_1238 = ({ __auto_type _lst = def_items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1238.has_value) {
                __auto_type variant_expr = _mv_1238.value;
                __auto_type _mv_1239 = (*variant_expr);
                switch (_mv_1239.tag) {
                    case types_SExpr_lst:
                    {
                        __auto_type variant_lst = _mv_1239.data.lst;
                        if ((((int64_t)((variant_lst.items).len)) >= 2)) {
                            __auto_type _mv_1240 = ({ __auto_type _lst = variant_lst.items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
slop_string transpiler_get_field_type_string(context_TranspileContext* ctx, types_SExpr* type_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1241 = (*type_expr);
        switch (_mv_1241.tag) {
            case types_SExpr_sym:
            {
                ...
                {
                    __auto_type name = sym.name;
                    __auto_type _mv_1242 = context_ctx_lookup_type(ctx, name);
                    if (_mv_1242.has_value) {
                        __auto_type entry = _mv_1242.value;
                        return entry.c_name;
            ...
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1241.data.lst;
                {
                    ...
                    if ((((int64_t)((items).len)) < 1)) {
                        ...
                        __auto_type _mv_1243 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        ...
                                        if (string_eq(kind, SLOP_STR("Ptr"))) {
                                            ...
                                            if ((((int64_t)((items).len)) >= 2)) {
                                                ...
                                                if (_mv_1245.has_value) {
                                                    __auto_type inner = _mv_1245.value;
                                                    {
                                            ...
                                            if ((((int64_t)((items).len)) >= 2)) {
                                                __auto_type _mv_1246 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                                if (_mv_1246.has_value) {
                                                    __auto_type inner = _mv_1246.value;
                                                    {
                                                        __auto_type inner_str = transpiler_get_field_type_string(ctx, inner);
                                                        if (string_eq(inner_str, SLOP_STR(""))) {
                                                            return SLOP_STR("");
                    ...
                    if (_mv_1248.has_value) {
                        ...
                        switch (_mv_1249.tag) {
                            case types_SExpr_sym:
                            {
                                ...
                                {
                                    __auto_type name = sym.name;
                                    __auto_type _mv_1250 = context_ctx_lookup_type(ctx, name);
                                    if (_mv_1250.has_value) {
                                        __auto_type entry = _mv_1250.value;
                                        return entry.c_name;
...
void transpiler_emit_option_for_inner_type(context_TranspileContext* ctx, slop_string inner_c_name) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        __auto_type i = 0;
        while ((i < len)) {
            __auto_type _mv_1251 = ({ __auto_type _lst = option_types; size_t _idx = (size_t)i; slop_option_context_OptionType _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1251.has_value) {
                __auto_type ot = _mv_1251.value;
...
void transpiler_emit_list_for_elem_type(context_TranspileContext* ctx, slop_string elem_c_name) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        __auto_type i = 0;
        while ((i < len)) {
            __auto_type _mv_1252 = ({ __auto_type _lst = list_types; size_t _idx = (size_t)i; slop_option_context_ListType _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1252.has_value) {
                __auto_type lt = _mv_1252.value;
...
uint8_t transpiler_struct_uses_value_list_or_option(context_TranspileContext* ctx, types_SExpr* type_def) {
    ...
    SLOP_PRE(((type_def != NULL)), "(!= type-def nil)");
    {
        ...
        __auto_type found = 0;
        {
            ...
            __auto_type i = 0;
            while (((i < len) && !(found))) {
                __auto_type _mv_1253 = ({ __auto_type _lst = list_types; size_t _idx = (size_t)i; slop_option_context_ListType _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_1253.has_value) {
                    __auto_type lt = _mv_1253.value;
        ...
        if (!(found)) {
            {
                ...
                __auto_type j = 0;
                while (((j < len2) && !(found))) {
                    __auto_type _mv_1254 = ({ __auto_type _lst = option_types; size_t _idx = (size_t)j; slop_option_context_OptionType _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_1254.has_value) {
                        __auto_type ot = _mv_1254.value;
...
void transpiler_emit_struct_dependent_list_types(context_TranspileContext* ctx, types_SExpr* type_def) {
    ...
    SLOP_PRE(((type_def != NULL)), "(!= type-def nil)");
    {
        ...
        __auto_type i = 0;
        while ((i < len)) {
            __auto_type _mv_1255 = ({ __auto_type _lst = list_types; size_t _idx = (size_t)i; slop_option_context_ListType _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1255.has_value) {
                __auto_type lt = _mv_1255.value;
                if ((!(transpiler_is_pointer_elem_type(lt.elem_type)) && transpiler_struct_uses_list_type(ctx, type_def, lt.c_name))) {
                    transpiler_emit_single_list_type_header(ctx, lt);
                }
...
void transpiler_emit_struct_dependent_option_types(context_TranspileContext* ctx, types_SExpr* type_def) {
    ...
    SLOP_PRE(((type_def != NULL)), "(!= type-def nil)");
    {
        ...
        __auto_type i = 0;
        while ((i < len)) {
            __auto_type _mv_1256 = ({ __auto_type _lst = option_types; size_t _idx = (size_t)i; slop_option_context_OptionType _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1256.has_value) {
                __auto_type ot = _mv_1256.value;
                if ((!(transpiler_is_pointer_elem_type(ot.inner_type)) && transpiler_struct_uses_option_type(ctx, type_def, ot.c_name))) {
...
void transpiler_emit_struct_dependent_list_types_safe(context_TranspileContext* ctx, types_SExpr* type_def) {
    ...
    SLOP_PRE(((type_def != NULL)), "(!= type-def nil)");
    {
        ...
        __auto_type i = 0;
        while ((i < len)) {
            __auto_type _mv_1257 = ({ __auto_type _lst = list_types; size_t _idx = (size_t)i; slop_option_context_ListType _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1257.has_value) {
                __auto_type lt = _mv_1257.value;
                if ((!(transpiler_is_pointer_elem_type(lt.elem_type)) && transpiler_struct_uses_list_type(ctx, type_def, lt.c_name))) {
...
void transpiler_emit_struct_dependent_option_types_safe(context_TranspileContext* ctx, types_SExpr* type_def) {
    ...
    SLOP_PRE(((type_def != NULL)), "(!= type-def nil)");
    {
        ...
        __auto_type i = 0;
        while ((i < len)) {
            __auto_type _mv_1258 = ({ __auto_type _lst = option_types; size_t _idx = (size_t)i; slop_option_context_OptionType _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1258.has_value) {
                __auto_type ot = _mv_1258.value;
                if ((!(transpiler_is_pointer_elem_type(ot.inner_type)) && transpiler_struct_uses_option_type(ctx, type_def, ot.c_name))) {
...
uint8_t transpiler_is_imported_type(context_TranspileContext* ctx, slop_string type_name) {
    ...
    if ((strlib_starts_with(type_name, SLOP_STR("slop_list_")) || strlib_starts_with(type_name, SLOP_STR("slop_option_")))) {
        ...
        __auto_type _mv_1259 = context_ctx_get_module(ctx);
        if (_mv_1259.has_value) {
            __auto_type current_mod = _mv_1259.value;
            {
                __auto_type arena = (*ctx).arena;
    ...
    if (strlib_starts_with(inner_type, SLOP_STR("slop_list_"))) {
        {
            ...
            __auto_type i = 0;
            while ((i < len)) {
                __auto_type _mv_1260 = ({ __auto_type _lst = list_types; size_t _idx = (size_t)i; slop_option_context_ListType _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_1260.has_value) {
                    __auto_type lt = _mv_1260.value;
    ...
    if (strlib_starts_with(inner_type, SLOP_STR("slop_list_"))) {
        {
            ...
            __auto_type i = 0;
            while ((i < len)) {
                __auto_type _mv_1261 = ({ __auto_type _lst = list_types; size_t _idx = (size_t)i; slop_option_context_ListType _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_1261.has_value) {
                    __auto_type lt = _mv_1261.value;
                ...
                __auto_type lst = _mv_1262.data.lst;
                {
                    ...
                    if ((((int64_t)((items).len)) < 3)) {
                        ...
                        if (_mv_1263.has_value) {
                            __auto_type body_expr = _mv_1263.value;
...
uint8_t transpiler_type_body_uses_typename(context_TranspileContext* ctx, types_SExpr* body_expr, slop_string typename) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1264 = (*body_expr);
        switch (_mv_1264.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1264.data.lst;
                {
                    ...
                    while (((i < len) && !(found))) {
                        ...
                        if (_mv_1265.has_value) {
                            __auto_type field_expr = _mv_1265.value;
...
uint8_t transpiler_field_uses_typename(context_TranspileContext* ctx, types_SExpr* field_expr, slop_string typename) {
    ...
    __auto_type _mv_1266 = (*field_expr);
    switch (_mv_1266.tag) {
        case types_SExpr_lst:
        {
                            ...
                            switch (_mv_1270.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_1270.data.sym;
                                    {
                                        ...
                                        __auto_type base_name = ctype_to_c_name(arena, type_name);
                                        __auto_type c_name = ((context_ctx_prefixing_enabled(ctx)) ? ({ __auto_type _mv = context_ctx_get_module(ctx); _mv.has_value ? ({ __auto_type mod_name = _mv.value; context_ctx_str(ctx, ctype_to_c_name(arena, mod_name), context_ctx_str(ctx, SLOP_STR("_"), base_name)); }) : (base_name); }) : base_name);
                                        __auto_type _mv_1271 = ({ __auto_type _lst = items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
...
void transpiler_emit_type_body_to_header(context_TranspileContext* ctx, slop_string raw_type_name, slop_string c_name, types_SExpr* body_expr) {
    ...
    {
        __auto_type arena = (*ctx).arena;
        __auto_type _mv_1272 = (*body_expr);
        switch (_mv_1272.tag) {
            case types_SExpr_lst:
            {
                __auto_type lst = _mv_1272.data.lst;
                {
                    ...
                    if ((((int64_t)((items).len)) < 1)) {
                        ...
                        if (_mv_1273.has_value) {
                            __auto_type kind_expr = _mv_1273.value;
                            __auto_type _mv_1274 = (*kind_expr);
                            switch (_mv_1274.tag) {
                                case types_SExpr_sym:
                                {
                                    __auto_type kind_sym = _mv_1274.data.sym;
                                    {
    ...
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while ((i < len)) {
            ...
            if (_mv_1275.has_value) {
                __auto_type variant_expr = _mv_1275.value;
                __auto_type _mv_1276 = (*variant_expr);
                switch (_mv_1276.tag) {
                    case types_SExpr_sym:
                    {
                        __auto_type variant_sym = _mv_1276.data.sym;
                        {
...
void transpiler_emit_struct_to_header(context_TranspileContext* ctx, slop_string raw_type_name, slop_string c_name, slop_list_types_SExpr_ptr items) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        while ((i < len)) {
            __auto_type _mv_1277 = ({ __auto_type _lst = items; size_t _idx = (size_t)i; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                ...
                                case types_SExpr_sym:
                                {
                                    __auto_type name_sym = _mv_1280.data.sym;
                                    {
                                        ...
                                        if (_mv_1281.has_value) {
                                            __auto_type type_expr = _mv_1281.value;
                                            {
                                                __auto_type c_type = context_to_c_type_prefixed(ctx, type_expr);
...
uint8_t transpiler_is_pointer_type_expr_header(types_SExpr* type_expr) {
    SLOP_PRE(((type_expr != NULL)), "(!= type-expr nil)");
    __auto_type _mv_1282 = (*type_expr);
    switch (_mv_1282.tag) {
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1282.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 1)) {
                    ...
                    __auto_type _mv_1283 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        ...
        context_ctx_emit_header(ctx, SLOP_STR("typedef enum {"));
        {
            ...
            while ((i < len)) {
                ...
                if (_mv_1285.has_value) {
                    __auto_type variant_expr = _mv_1285.value;
                    {
        ...
        context_ctx_emit_header(ctx, SLOP_STR("    union {"));
        {
            ...
            while ((i < len)) {
                ...
                if (_mv_1286.has_value) {
                    __auto_type variant_expr = _mv_1286.value;
...
slop_string transpiler_get_variant_name(types_SExpr* variant_expr) {
    ...
    __auto_type _mv_1287 = (*variant_expr);
    switch (_mv_1287.tag) {
        case types_SExpr_sym:
        {
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1287.data.lst;
            {
                __auto_type items = lst.items;
                if ((((int64_t)((items).len)) < 1)) {
                    return SLOP_STR("unknown");
                } else {
                    __auto_type _mv_1288 = ({ __auto_type _lst = items; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_1288.has_value) {
                        ...
                        switch (_mv_1289.tag) {
                            case types_SExpr_sym:
                            {
                                __auto_type name_sym = _mv_1289.data.sym;
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1295.data.lst;
            {
                ...
                if ((((int64_t)((items).len)) < 2)) {
                    ...
                    __auto_type _mv_1296 = ({ __auto_type _lst = items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_1296.has_value) {
                        __auto_type name_expr = _mv_1296.value;
                        __auto_type _mv_1297 = (*name_expr);
                        switch (_mv_1297.tag) {
                            case types_SExpr_sym:
                            {
                                __auto_type sym = _mv_1297.data.sym;
                                return sym.name;
                            }
                            default: {
                                return SLOP_STR("");
        ...
        case types_SExpr_lst:
        {
            __auto_type lst = _mv_1299.data.lst;
            {
                ...
                if ((((int64_t)((const_items).len)) < 4)) {
                    ...
                    __auto_type _mv_1300 = ({ __auto_type _lst = const_items; size_t _idx = (size_t)1; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                    if (_mv_1300.has_value) {
                        ...
                        switch (_mv_1301.tag) {
                            case types_SExpr_sym:
                            {
                                __auto_type name_sym = _mv_1301.data.sym;
                                {
                                    __auto_type raw_name = name_sym.name;
                                    if (!(transpiler_list_contains_str(exports, raw_name))) {
                                        return 0;
                                    } else {
                                        __auto_type _mv_1302 = ({ __auto_type _lst = const_items; size_t _idx = (size_t)2; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                                        if (_mv_1302.has_value) {
                                            __auto_type type_expr = _mv_1302.value;
...
void transpiler_emit_all_lambdas(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if ((count > 0)) {
            while ((i < count)) {
                __auto_type _mv_1304 = ({ __auto_type _lst = lambdas; size_t _idx = (size_t)i; slop_option_string _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
                if (_mv_1304.has_value) {
                    __auto_type lambda_code = _mv_1304.value;
...
slop_string transpiler_generate_c_output(context_TranspileContext* ctx) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        __auto_type i = 0;
        while ((i < len)) {
            __auto_type _mv_1305 = ({ __auto_type _lst = output_lines; size_t _idx = (size_t)i; slop_option_string _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1305.has_value) {
                __auto_type line = _mv_1305.value;
...
void transpiler_transpile_file(context_TranspileContext* ctx, slop_list_types_SExpr_ptr exprs) {
    SLOP_PRE(((ctx != NULL)), "(!= ctx nil)");
    {
        ...
        if (((len > 0) && transpiler_is_module_expr(exprs))) {
            __auto_type _mv_1306 = ({ __auto_type _lst = exprs; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
            if (_mv_1306.has_value) {
                __auto_type module_expr = _mv_1306.value;
...
uint8_t transpiler_is_module_expr(slop_list_types_SExpr_ptr exprs) {
    if ((((int64_t)((exprs).len)) < 1)) {
        ...
        __auto_type _mv_1307 = ({ __auto_type _lst = exprs; size_t _idx = (size_t)0; slop_option_types_SExpr_ptr _r; if (_idx < _lst.len) { _r.has_value = true; _r.value = _lst.data[_idx]; } else { _r.has_value = false; } _r; });
        if (_mv_1307.has_value) {
            __auto_type first = _mv_1307.value;
            __auto_type _mv_1308 = (*first);
            switch (_mv_1308.tag) {
                case types_SExpr_lst:
                {
