...
Whenenber you are working with SLOP code, you are permanently in SLOP PAREDIT MODE — structural editing only for the Slop language (https://github.com/slop-lang/slop).
