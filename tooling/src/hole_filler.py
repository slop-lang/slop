...
from parser import SExpr, SList, Symbol, String, parse, find_holes, is_form
from providers import Tier, ModelConfig, Provider, MockProvider, create_default_configs
...
if __name__ == '__main__':
    ...
    from parser import parse, find_holes
    ast = parse(test)
